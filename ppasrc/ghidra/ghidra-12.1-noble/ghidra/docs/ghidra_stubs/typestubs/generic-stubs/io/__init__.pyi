...
class JarWriter(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, jarOut: java.util.jar.JarOutputStream) -> None:
        """
    ...
    @typing.overload
    def __init__(self, jarOut: java.util.jar.JarOutputStream, excludedExtensions: jpype.JArray[java.lang.String]) -> None:
        ...
...
__all__ = ["JarWriter", "NullPrintWriter", "NullWriter"]
