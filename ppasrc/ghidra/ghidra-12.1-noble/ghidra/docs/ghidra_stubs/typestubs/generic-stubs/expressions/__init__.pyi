...
class ExpressionEvaluator(java.lang.Object):
    ...
    class LookAheadTokenizer(java.lang.Object):
        ...
        def advance(self, count: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, assumeHex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, evaluator: java.util.function.Function[java.lang.String, ExpressionValue]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, assumeHex: typing.Union[jpype.JBoolean, bool], evaluator: java.util.function.Function[java.lang.String, ExpressionValue]) -> None:
        """
    ...
    def setAssumeHex(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
__all__ = ["ExpressionElement", "ExpressionGrouper", "ExpressionEvaluator", "ExpressionValue", "ExpressionException", "ExpressionOperator", "LongExpressionValue"]
