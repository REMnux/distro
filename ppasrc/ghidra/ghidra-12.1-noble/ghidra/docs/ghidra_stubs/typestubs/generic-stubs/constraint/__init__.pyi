...
class Constraint(java.lang.Object, typing.Generic[T]):
    ...
    def loadConstraintData(self, data: ConstraintData) -> None:
        """
...
class ConstraintData(java.lang.Object):
    ...
    def __init__(self, mappings: collections.abc.Mapping) -> None:
        ...
...
class Decision(java.lang.Object):
    ...
    def __init__(self, value: typing.Union[java.lang.String, str], decisionPath: java.util.List[java.lang.String], source: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DecisionNode(java.lang.Object, typing.Generic[T]):
    ...
    def __init__(self, constraint: Constraint[T], parent: DecisionNode[T]) -> None:
        ...
    ...
    def setProperty(self, propertyName: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str], source: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DecisionTree(java.lang.Object, typing.Generic[T]):
    ...
    @typing.overload
    def loadConstraints(self, name: typing.Union[java.lang.String, str], stream: java.io.InputStream) -> None:
        """
    ...
    def registerConstraintType(self, name: typing.Union[java.lang.String, str], constraintClass: java.lang.Class[Constraint[T]]) -> None:
        """
    ...
    def registerPropertyName(self, propertyName: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["Constraint", "ConstraintData", "Decision", "DecisionNode", "DecisionSet", "DecisionTree", "RootDecisionNode"]
