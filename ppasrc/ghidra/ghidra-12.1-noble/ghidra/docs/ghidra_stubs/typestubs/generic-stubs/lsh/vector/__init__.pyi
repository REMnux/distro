...
class HashEntry(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, h: typing.Union[jpype.JInt, int], tcnt: typing.Union[jpype.JInt, int], weight: typing.Union[jpype.JDouble, float]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, h: typing.Union[jpype.JInt, int], tcnt: typing.Union[jpype.JInt, int], dcnt: typing.Union[jpype.JInt, int], w: WeightFactory) -> None:
        """
    ...
    @typing.overload
    def restoreXml(self, parser: ghidra.xml.XmlPullParser, w: WeightFactory) -> None:
        ...

    @typing.overload
    def restoreXml(self, parser: ghidra.xml.XmlPullParser, w: WeightFactory, lookup: IDFLookup) -> None:
        """
    ...
    def saveBase64(self, buffer: jpype.JArray[jpype.JChar], offset: typing.Union[jpype.JInt, int], encoder: jpype.JArray[jpype.JChar]) -> None:
        ...

    def saveSQL(self, buf: java.lang.StringBuilder) -> None:
        ...
...
class WeightFactory(java.lang.Object):
    ...
    def set(self, weightArray: jpype.JArray[jpype.JDouble]) -> None:
        """
    ...
    def setLogarithmicTFWeights(self) -> None:
        ...
...
class IDFLookup(java.lang.Object):
    ...
    def set(self, hashCountPair: jpype.JArray[jpype.JInt]) -> None:
        """
...
class LSHCosineVector(LSHVector):
    ...
    @typing.overload
    def __init__(self, feature: jpype.JArray[jpype.JInt], wfactory: WeightFactory, idflookup: IDFLookup) -> None:
        """
    ...
    def setHashEntries(self, entries: jpype.JArray[HashEntry]) -> None:
        """
...
class LSHVector(java.lang.Object):
    ...
    def compareCounts(self, op2: LSHVector, data: VectorCompare) -> None:
        ...
    ...
    def restoreBase64(self, input: java.io.Reader, buffer: jpype.JArray[jpype.JChar], wfactory: WeightFactory, idflookup: IDFLookup, decode: jpype.JArray[jpype.JInt]) -> None:
        ...

    def restoreSQL(self, sql: typing.Union[java.lang.String, str], weightFactory: WeightFactory, idfLookup: IDFLookup) -> None:
        ...

    def restoreXml(self, parser: ghidra.xml.XmlPullParser, weightFactory: WeightFactory, idfLookup: IDFLookup) -> None:
        ...

    def saveBase64(self, buffer: java.lang.StringBuilder, encoder: jpype.JArray[jpype.JChar]) -> None:
        ...
...
class LSHCosineVectorAccum(LSHCosineVector):
    ...
    class Entry(java.lang.Comparable[LSHCosineVectorAccum.Entry]):
        ...
        def __init__(self, hash: typing.Union[jpype.JInt, int], weight: typing.Union[jpype.JDouble, float]) -> None:
            ...
    ...
    def addHash(self, h: typing.Union[jpype.JInt, int], w: typing.Union[jpype.JDouble, float]) -> None:
        ...
...
class LSHVectorFactory(java.lang.Object):
    ...
    def readWeights(self, parser: ghidra.xml.XmlPullParser) -> None:
        """
    ...
    def set(self, wFactory: WeightFactory, iLookup: IDFLookup, settings: typing.Union[jpype.JInt, int]) -> None:
        """
...
__all__ = ["HashEntry", "WeightFactory", "IDFLookup", "LSHCosineVector", "LSHVector", "VectorCompare", "LSHCosineVectorAccum", "LSHVectorFactory", "WeightedLSHCosineVectorFactory"]
