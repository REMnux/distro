...
class JSONToken(java.lang.Object):
    ...
    def __init__(self, type: JSONType, start: typing.Union[jpype.JInt, int], end: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setEnd(self, end: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setSize(self, size: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setStart(self, start: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setType(self, type: JSONType) -> None:
        ...
...
class Json(org.apache.commons.lang3.builder.ToStringStyle):
    ...
    class InclusiveReflectionToStringBuilder(org.apache.commons.lang3.builder.ReflectionToStringBuilder):
        ...
        def __init__(self, object: java.lang.Object) -> None:
            ...
...
__all__ = ["JSONError", "JSONParser", "JSONToken", "JSONType", "Json"]
