...
class ExpiringSwingTimer(GhidraSwingTimer):
    ...
    def __init__(self, delay: typing.Union[jpype.JInt, int], expireMs: typing.Union[jpype.JInt, int], isReady: java.util.function.BooleanSupplier, runnable: java.lang.Runnable) -> None:
        """
        Constructor
    ...
    @staticmethod
    @typing.overload
    def runWhen(isReady: java.util.function.BooleanSupplier, runnable: java.lang.Runnable) -> ExpiringSwingTimer:
        """
        Runs the given client runnable when the given condition returns true.  The returned timer
        will be running.
        ...
        The timer's expiration is set to the default value of 
        750.
...
class GhidraSwingTimer(GhidraTimer, java.awt.event.ActionListener):
    ...
    @typing.overload
    def __init__(self, delay: typing.Union[jpype.JInt, int], callback: TimerCallback) -> None:
        ...

    @typing.overload
    def __init__(self, initialDelay: typing.Union[jpype.JInt, int], delay: typing.Union[jpype.JInt, int], callback: TimerCallback) -> None:
        ...
...
class GhidraTimer(java.lang.Object):
    ...
    def setDelay(self, delay: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setInitialDelay(self, initialDelay: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setRepeats(self, repeats: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setTimerCallback(self, callback: TimerCallback) -> None:
        ...
...
__all__ = ["ExpiringSwingTimer", "GhidraSwingTimer", "GhidraTimer", "TimerCallback", "GhidraSwinglessTimer", "GhidraTimerFactory"]
