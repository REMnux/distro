...
class ApplicationModule(java.lang.Comparable[ApplicationModule]):
    ...
    def __init__(self, applicationRoot: jpype.protocol.SupportsPath, moduleDir: jpype.protocol.SupportsPath) -> None:
        ...
...
class ClassModuleTree(java.lang.Object):
    ...
    class FileNode(java.lang.Comparable[ClassModuleTree.FileNode]):
        ...
        def __init__(self, parent: ClassModuleTree.FileNode, name: typing.Union[java.lang.String, str]) -> None:
            ...
        ...
        def setModule(self, moduleName: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, treeFile: ResourceFile) -> None:
        ...

    def addNode(self, path: typing.Union[java.lang.String, str], moduleName: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def printRecursively(self) -> None:
        ...

    def saveFile(self, outputFile: jpype.protocol.SupportsPath) -> None:
        ...
...
class ResourceFile(java.lang.Comparable[ResourceFile]):
    ...
    @typing.overload
    def __init__(self, resourceFile: ResourceFile, path: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, absolutePath: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, absolutePath: typing.Union[java.lang.String, str], filter: JarEntryFilter) -> None:
        """
        Constructs a Resource file from string path that can be either a file path or a jar url.
...
class JarResource(Resource):
    ...
    @typing.overload
    def __init__(self, jarFile: jpype.protocol.SupportsPath, filter: JarEntryFilter) -> None:
        ...

    @typing.overload
    def __init__(self, parent: JarResource, path: typing.Union[java.lang.String, str]) -> None:
        ...
...
class JarEntryRootNode(JarEntryNode):
    ...
    def __init__(self, file: jpype.protocol.SupportsPath, filter: JarEntryFilter) -> None:
        ...
...
class GClassLoader(java.net.URLClassLoader):
    ...
    def __init__(self, moduleDirs: java.util.List[java.io.File]) -> None:
        ...



__all__ = ["ApplicationModule", "ClassModuleTree", "ResourceFile", "Resource", "JarResource", "JarEntryFilter", "ResourceFileFilter", "JarEntryRootNode", "JarEntryNode", "FileResource", "GClassLoader"]
