...
class Utils(java.lang.Object):
    ...
    def byte_swap(val: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int]) -> int:
        ...
        :param jpype.JLong or int val: the value whose bytes to swap
        :param jpype.JInt or int size: the number of least-signifcant bytes to swap
    ...
    def signbit_negative(val: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int]) -> bool:
        ...
        :param jpype.JLong or int val: the raw value as a long
        :param jpype.JInt or int size: the actual size (in bytes) of the value
        """
...
__all__ = ["SlaFormat", "AddressUtils", "MessageFormattingUtils", "Utils"]
