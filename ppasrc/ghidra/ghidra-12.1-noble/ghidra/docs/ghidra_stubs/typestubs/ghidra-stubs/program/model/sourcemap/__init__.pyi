...
class SourceFileManager(java.lang.Object):
    ...
    def transferSourceMapEntries(self, source: ghidra.program.database.sourcemap.SourceFile, target: ghidra.program.database.sourcemap.SourceFile) -> None:
        """
...
class SourcePathTransformer(java.lang.Object):
    ...
    def addDirectoryTransform(self, sourceDir: typing.Union[java.lang.String, str], targetDir: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def addFileTransform(self, sourceFile: ghidra.program.database.sourcemap.SourceFile, path: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def removeDirectoryTransform(self, sourceDir: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def removeFileTransform(self, sourceFile: ghidra.program.database.sourcemap.SourceFile) -> None:
        """
...
class SourcePathTransformRecord(java.lang.Record):
    ...
    def __init__(self, source: typing.Union[java.lang.String, str], sourceFile: ghidra.program.database.sourcemap.SourceFile, target: typing.Union[java.lang.String, str]) -> None:
        ...
...
__all__ = ["SourceFileManager", "SourceMapEntry", "SourceMapEntryIterator", "SourcePathTransformer", "SourcePathTransformRecord", "DummySourceFileManager"]
