...
class SFQueryInfo(java.lang.Object):
    ...
    def __init__(self, functions: java.util.Set[ghidra.program.database.symbol.FunctionSymbol]) -> None:
        """
    ...
    def setFunctions(self, functions: java.util.Set[ghidra.program.database.symbol.FunctionSymbol]) -> None:
        """
    ...
    def setMaximumResults(self, maximumResults: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setSignificanceThreshold(self, significanceThreshold: typing.Union[jpype.JDouble, float]) -> None:
        """
    ...
    def setSimilarityThreshold(self, similarityThreshold: typing.Union[jpype.JDouble, float]) -> None:
        """
...
class SimilarFunctionQueryService(java.lang.AutoCloseable):
    ...
    def initializeDatabase(self, serverURLString: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def setNumberOfStages(self, val: typing.Union[jpype.JInt, int]) -> None:
        ...

    def updateProgram(self, newProgram: ghidra.program.model.listing.Program) -> None:
        ...
...
class QueryDatabaseException(java.lang.Exception):
    ...
    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], e: java.lang.Exception) -> None:
        ...
...
class SFOverviewInfo(java.lang.Object):
    ...
    def setVectorMax(self, max: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class SFResultsUpdateListener(java.lang.Object, typing.Generic[R]):
    ...
    def resultAdded(self, partialResponse: ghidra.features.bsim.query.protocol.QueryResponseRecord) -> None:
        """
    ...
    def setFinalResult(self, result: R) -> None:
        """
...
class DatabaseInfo(java.lang.Object):
    ...
    def __init__(self, serverURL: typing.Union[java.lang.String, str], databaseInformation: ghidra.features.bsim.query.description.DatabaseInformation) -> None:
        ...
...
class FunctionSymbolIterator(java.util.Iterator[ghidra.program.model.listing.Function]):
    ...
    def __init__(self, iter: java.util.Iterator[ghidra.program.database.symbol.FunctionSymbol]) -> None:
        ...



__all__ = ["SFQueryServiceFactory", "SFQueryInfo", "SimilarFunctionQueryService", "QueryDatabaseException", "SFOverviewInfo", "SFResultsUpdateListener", "SFQueryResult", "DatabaseInfo", "DefaultSFQueryServiceFactory", "FunctionSymbolIterator"]
