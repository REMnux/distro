...
class AnalysisOptionsUpdater(java.lang.Object):
    ...
    * 
    ...
    @typing.overload
    def registerReplacement(self, newOptionName: typing.Union[java.lang.String, str], oldOptionName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def registerReplacement(self, newOptionName: typing.Union[java.lang.String, str], oldOptionName: typing.Union[java.lang.String, str], replacer: java.util.function.Function[java.lang.Object, java.lang.Object]) -> None:
        """
...
class AutoAnalysisManager(java.lang.Object):
    ...
    def addListener(self, listener: AutoAnalysisManagerListener) -> None:
        ...

    def addTool(self, tool: ghidra.framework.plugintool.PluginTool) -> None:
        ...

    def blockAdded(self, set: ghidra.program.model.address.AddressSetView) -> None:
        ...
    ...
    @typing.overload
    def codeDefined(self, addr: ghidra.program.model.address.Address) -> None:
        ...

    @typing.overload
    def codeDefined(self, set: ghidra.program.model.address.AddressSetView) -> None:
        ...

    @typing.overload
    def createFunction(self, target: ghidra.program.model.address.Address, findFunctionStart: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def createFunction(self, targetSet: ghidra.program.model.address.AddressSetView, findFunctionStarts: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def createFunction(self, targetSet: ghidra.program.model.address.AddressSetView, findFunctionStarts: typing.Union[jpype.JBoolean, bool], priority: ghidra.app.services.AnalysisPriority) -> None:
        ...

    def dataDefined(self, set: ghidra.program.model.address.AddressSetView) -> None:
        ...

    @typing.overload
    def disassemble(self, target: ghidra.program.model.address.Address) -> None:
        ...

    @typing.overload
    def disassemble(self, targetSet: ghidra.program.model.address.AddressSetView) -> None:
        ...

    @typing.overload
    def disassemble(self, targetSet: ghidra.program.model.address.AddressSetView, priority: ghidra.app.services.AnalysisPriority) -> None:
        ...

    def dispose(self) -> None:
        ...

    def externalAdded(self, extAddr: ghidra.program.model.address.Address) -> None:
        """
    ...
    @typing.overload
    def functionDefined(self, addr: ghidra.program.model.address.Address) -> None:
        ...

    @typing.overload
    def functionDefined(self, set: ghidra.program.model.address.AddressSetView) -> None:
        ...

    @typing.overload
    def functionModifierChanged(self, addr: ghidra.program.model.address.Address) -> None:
        ...

    @typing.overload
    def functionModifierChanged(self, set: ghidra.program.model.address.AddressSetView) -> None:
        ...

    @typing.overload
    def functionSignatureChanged(self, addr: ghidra.program.model.address.Address) -> None:
        ...

    @typing.overload
    def functionSignatureChanged(self, set: ghidra.program.model.address.AddressSetView) -> None:
        ...
    ...
    def getTaskTime(self, map: collections.abc.Mapping, taskName: typing.Union[java.lang.String, str]) -> int:
        """
        :return: the time taken by a named task, or ``-1`` if the named task could not be found
        :rtype: int
        
         
        
        The names of tasks that have run can be retrieved using :meth:`getTimedTasks() <.getTimedTasks>`.
    ...
    @typing.overload
    def initializeOptions(self, options: ghidra.framework.options.Options) -> None:
        ...
    ...
    def reAnalyzeAll(self, restrictSet: ghidra.program.model.address.AddressSetView) -> None:
        """
    ...
    def removeListener(self, listener: AutoAnalysisManagerListener) -> None:
        ...

    def removeTool(self, tool: ghidra.framework.plugintool.PluginTool) -> None:
        ...

    def restoreDefaultOptions(self) -> None:
        ...

    def scheduleOneTimeAnalysis(self, analyzer: ghidra.app.services.Analyzer, set: ghidra.program.model.address.AddressSetView) -> None:
        ...
    ...
    def setDebug(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setProtectedLocation(self, addr: ghidra.program.model.address.Address) -> None:
        """
    ...
    def setProtectedLocations(self, set: ghidra.program.model.address.AddressSet) -> None:
        """
    ...
    @typing.overload
    def startAnalysis(self, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def startAnalysis(self, monitor: ghidra.util.task.TaskMonitor, printTaskTimes: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Start auto-analysis in the current thread if it is ENABLED and not yet running.
        WARNING! If auto analysis is actively running or is DISABLED/SUSPENDED, this method will return immediately.
        NOTE: If invoked directly or indirectly by an Analyzer a yield will be
    ...
    def waitForAnalysis(self, limitPriority: typing.Union[java.lang.Integer, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class AnalysisTaskList(java.lang.Object):
    ...
    def __init__(self, analysisMgr: AutoAnalysisManager, name: typing.Union[java.lang.String, str]) -> None:
        ...

    def add(self, analyzer: ghidra.app.services.Analyzer) -> None:
        ...
    ...
    @typing.overload
    def notifyAdded(self, addr: ghidra.program.model.address.Address) -> None:
        ...

    @typing.overload
    def notifyAdded(self, set: ghidra.program.model.address.AddressSetView) -> None:
        ...

    def notifyAnalysisEnded(self, program: ghidra.program.model.listing.Program) -> None:
        """
        Notifies each analyzer in the list that the analysis session has ended.
        """

    @typing.overload
    def notifyRemoved(self, set: ghidra.program.model.address.AddressSetView) -> None:
        ...

    @typing.overload
    def notifyRemoved(self, addr: ghidra.program.model.address.Address) -> None:
        ...
...
class AutoAnalysisManagerListener(java.lang.Object):
    ...
    def analysisEnded(self, manager: AutoAnalysisManager, isCancelled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class AbstractDemanglerAnalyzer(ghidra.app.services.AbstractAnalyzer):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str]) -> None:
        ...
...
class AnalysisBackgroundCommand(ghidra.framework.cmd.MergeableBackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, mgr: AutoAnalysisManager, markAsAnalyzed: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AnalysisEnablementTableModel(docking.widgets.table.GDynamicColumnTableModel[AnalyzerEnablementState, java.lang.Object]):
    ...
    def __init__(self, panel: AnalysisPanel, analyzerStates: java.util.List[AnalyzerEnablementState]) -> None:
        ...

    def setData(self, analyzerStates: java.util.List[AnalyzerEnablementState]) -> None:
        ...
...
class AnalyzerEnablementState(java.lang.Object):
    ...
    def __init__(self, analyzer: ghidra.app.services.Analyzer, enabled: typing.Union[jpype.JBoolean, bool], defaultEnablement: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setEnabled(self, enabled: typing.Union[java.lang.Boolean, bool]) -> None:
        """
...
class AnalysisPanel(javax.swing.JPanel, java.beans.PropertyChangeListener):
    ...
    def setToLastUsedAnalysisOptionsIfProgramNotAnalyzed(self) -> None:
        ...

    def updateOptionForAllPrograms(self, analyzerName: typing.Union[java.lang.String, str], enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AnalysisTask(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, scheduler: AnalysisScheduler, log: ghidra.app.util.importer.MessageLog) -> None:
        ...
...
class AnalyzeAllOpenProgramsTask(ghidra.util.task.Task):
    ...
    class MyAnalysisBackgroundCommand(AnalysisBackgroundCommand):
        ...
        def __init__(self, mgr: AutoAnalysisManager) -> None:
            ...
...
class AutoAnalysisPlugin(ghidra.framework.plugintool.Plugin, AutoAnalysisManagerListener):
    ...
    class OneShotAnalyzerAction(ghidra.app.context.ListingContextAction):
        ...
        def __init__(self, analyzer: ghidra.app.services.Analyzer) -> None:
            ...
...
class ConstantPropagationAnalyzer(ghidra.app.services.AbstractAnalyzer):
    ...
    @typing.overload
    def __init__(self, processorName: typing.Union[java.lang.String, str], type: ghidra.app.services.AnalyzerType) -> None:
        ...
    ...
    def analyzeSet(self, program: ghidra.program.model.listing.Program, todoSet: ghidra.program.model.address.AddressSet, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @staticmethod
    def claimProcessor(processorName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def createData(self, program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def markDataAsConstant(self, data: ghidra.program.model.listing.Data) -> None:
        ...
...
class ConstantPropagationContextEvaluator(ghidra.program.util.ContextEvaluatorAdapter):
    ...
    @typing.overload
    def __init__(self, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    @typing.overload
    def __init__(self, monitor: ghidra.util.task.TaskMonitor, trustMemoryWrite: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, monitor: ghidra.util.task.TaskMonitor, trustWriteMemOption: typing.Union[jpype.JBoolean, bool], minStoreLoadRefAddress: typing.Union[jpype.JLong, int], minSpeculativeRefAddress: typing.Union[jpype.JLong, int], maxSpeculativeRefAddress: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class OperandReferenceAnalyzer(ghidra.app.services.AbstractAnalyzer):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], analyzerType: ghidra.app.services.AnalyzerType) -> None:
        ...
...
class FindReferencesTableModel(ghidra.app.util.query.AlignedObjectBasedPreviewTableModel[ReferenceAddressPair]):
    ...
    @typing.overload
    def __init__(self, fromAddr: ghidra.program.model.address.Address, provider: ghidra.framework.plugintool.ServiceProvider, prog: ghidra.program.model.listing.Program) -> None:
        ...

    @typing.overload
    def __init__(self, fromAddresses: ghidra.program.model.address.AddressSetView, tool: ghidra.framework.plugintool.PluginTool, prog: ghidra.program.model.listing.Program) -> None:
        ...
...
class UpdateAlignmentAction(docking.action.ToggleDockingAction, ghidra.app.util.query.AddressAlignmentListener):
    ...
    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, model: FindReferencesTableModel, alignment: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class GolangSymbolAnalyzer(ghidra.app.services.AbstractAnalyzer):
    """
    Analyzes Go binaries for RTTI and function symbol information by following references from
    ...
    class FixupDuffAlternateEntryPointsBackgroundCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
        ...
        def __init__(self, funcData: ghidra.app.util.bin.format.golang.rtti.GoFuncData, duffFunc: ghidra.program.model.listing.Function) -> None:
            ...
    ...
    class FixGcWriteBarrierFlagBackgroundCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
        ...
        def __init__(self, goBinary: ghidra.app.util.bin.format.golang.rtti.GoRttiMapper, markupSession: ghidra.app.util.bin.format.golang.structmapping.MarkupSession) -> None:
            ...
    ...
    class FixClosureFuncArgsBackgroundCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
        ...
        def __init__(self, goBinary: ghidra.app.util.bin.format.golang.rtti.GoRttiMapper) -> None:
            ...
    ...
    class PropagateRttiBackgroundCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
        ...
        class RttiFuncInfo(java.lang.Record):
            ...
            def __init__(self, funcName: typing.Union[java.lang.String, str], rttiParamIndex: typing.Union[jpype.JInt, int], returnTypeMapper: java.util.function.Function[ghidra.app.util.bin.format.golang.rtti.types.GoType, ghidra.program.model.data.DataType]) -> None:
                ...
    ...
    class GolangAnalyzerOptions(java.lang.Object):
        ...
        fallbackGoVer: java.lang.String
    ...
    def isAlreadyAnalyzed(program: ghidra.program.model.listing.Program) -> bool:
        """
        Returns true if Go analysis has already been performed for the specified program.
...
class ObjcTypeMetadataAnalyzer(ghidra.app.services.AbstractAnalyzer):
...
class OneShotAnalysisCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, analyzer: ghidra.app.services.Analyzer, set: ghidra.program.model.address.AddressSetView, log: ghidra.app.util.importer.MessageLog) -> None:
        ...
...
class ProjectPathChooserEditor(java.beans.PropertyEditorSupport):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], filter: ghidra.framework.model.DomainFileFilter) -> None:
        ...
...
class StoredAnalyzerTimes(ghidra.framework.options.CustomOption):
    ...
    def addTime(self, taskName: typing.Union[java.lang.String, str], t: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def clear(self, taskName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    def setStoredAnalyzerTimes(program: ghidra.program.model.listing.Program, times: StoredAnalyzerTimes) -> None:
        """
...
class TransientProgramProperties(java.lang.Object):
    ...
    @staticmethod
    def removeProgramProperties(program: ghidra.program.model.listing.Program) -> None:
        """
...
class ReferenceAddressPair(java.lang.Object):
    ...
    def __init__(self, source: ghidra.program.model.address.Address, destination: ghidra.program.model.address.Address) -> None:
        ...
...
class ObjcMessageAnalyzer(ghidra.app.services.AbstractAnalyzer):
    """
    Analyzes ``_objc_msgSend`` information
    """

    @typing.type_check_only
    class DataTypes(java.lang.Record):

        class_: typing.ClassVar[java.lang.Class]

        def classT(self) -> ghidra.program.model.data.DataType:
            ...
        ...
        def id(self) -> ghidra.program.model.data.DataType:
            ...

        def messageRef(self) -> ghidra.program.model.data.DataType:
            ...

        def messageRefPtr(self) -> ghidra.program.model.data.DataType:
            ...

        def objcSuper(self) -> ghidra.program.model.data.DataType:
            ...

        def objcSuperPtr(self) -> ghidra.program.model.data.DataType:
            ...

        def ptr(self) -> ghidra.program.model.data.DataType:
            ...

        def sel(self) -> ghidra.program.model.data.DataType:
            ...
    ...
    @typing.type_check_only
    class Message(java.lang.Record):
...
class SwitchAnalysisDecompileConfigurer(ghidra.app.decompiler.parallel.DecompileConfigurer):
    ...
    def __init__(self, p: ghidra.program.model.listing.Program) -> None:
        ...



__all__ = ["AnalysisOptionsUpdater", "AutoAnalysisManager", "DefaultDataTypeManagerService", "AnalysisTaskList", "AutoAnalysisManagerListener", "AnalysisWorker", "AnalysisScheduler", "AbstractDemanglerAnalyzer", "AnalysisBackgroundCommand", "AnalysisEnablementTableModel", "AnalyzerEnablementState", "AnalysisPanel", "AnalysisOptionsDialog", "AnalysisOptionsEditor", "AnalysisTask", "AnalyzeAllOpenProgramsTask", "AnalyzeProgramStrategy", "ApplyDataArchiveAnalyzer", "ArmSymbolAnalyzer", "AutoAnalysisPlugin", "CliMetadataTokenAnalyzer", "ConstantPropagationAnalyzer", "ConstantPropagationContextEvaluator", "DWARFAnalyzer", "DataOperandReferenceAnalyzer", "OperandReferenceAnalyzer", "ElfScalarOperandAnalyzer", "ScalarOperandAnalyzer", "EmbeddedMediaAnalyzer", "ExternalSymbolResolverAnalyzer", "FindNoReturnFunctionsAnalyzer", "FindPossibleReferencesPlugin", "FindReferencesTableModel", "UpdateAlignmentAction", "GolangStringAnalyzer", "GolangSymbolAnalyzer", "MachoFunctionStartsAnalyzer", "MingwRelocationAnalyzer", "MinGWPseudoRelocList", "MinGWPseudoRelocationHandler", "NoReturnFunctionAnalyzer", "NonReturningFunctionNames", "ObjcTypeMetadataAnalyzer", "OneShotAnalysisCommand", "PefAnalyzer", "PefDebugAnalyzer", "ProjectPathChooserEditor", "RegisterContextBuilder", "SegmentedCallingConventionAnalyzer", "StoredAnalyzerTimes", "StoredAnalyzerTimesPropertyEditor", "SwiftTypeMetadataAnalyzer", "TransientProgramProperties", "ReferenceAddressPair", "ConventionAnalysisDecompileConfigurer", "DecompilerCallConventionAnalyzer", "DecompilerFunctionAnalyzer", "DecompilerSwitchAnalyzer", "ObjcMessageAnalyzer", "SwitchAnalysisDecompileConfigurer"]
