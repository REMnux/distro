...
class GGlassPane(javax.swing.JComponent):
    ...
    def addPainter(self, painter: GGlassPanePainter) -> None:
        """
    ...
    def removePainter(self, painter: GGlassPanePainter) -> None:
        ...

    @staticmethod
    def setAllGlassPanesBusy(isBusy: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setBusy(self, isBusy: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def showBusyCursor(self, showBusyCursor: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class GGlassPanePainter(java.lang.Object):
    ...
    def paint(self, glassPane: GGlassPane, graphics: java.awt.Graphics) -> None:
        ...



__all__ = ["GGlassPane", "GGlassPanePainter"]
