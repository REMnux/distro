...
class AssemblyParser(java.lang.Object):
    ...
    def __init__(self, grammar: ghidra.app.plugin.assembler.sleigh.grammars.AssemblyGrammar) -> None:
        """
...
class AssemblyFirstFollow(java.lang.Object):
    ...
    def __init__(self, grammar: ghidra.app.plugin.assembler.sleigh.grammars.AbstractAssemblyGrammar[typing.Any, typing.Any]) -> None:
        """
...
class AssemblyParseState(java.lang.Comparable[AssemblyParseState]):
    ...
    @typing.overload
    def __init__(self, grammar: ghidra.app.plugin.assembler.sleigh.grammars.AssemblyGrammar, item: AssemblyParseStateItem) -> None:
        """
...
class AssemblyParseTransitionTable(java.lang.Object):
    ...
    def forEach(self, consumer: java.util.function.Consumer[ghidra.app.plugin.assembler.sleigh.util.TableEntry[java.lang.Integer]]) -> None:
        """
...
class AssemblyParseActionGotoTable(java.lang.Object):
    ...
    class ShiftAction(AssemblyParseActionGotoTable.Action):
        ...
        def __init__(self, newStateNum: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    class ReduceAction(AssemblyParseActionGotoTable.Action):
        ...
        def __init__(self, prod: ghidra.app.plugin.assembler.sleigh.grammars.AssemblyProduction) -> None:
            ...
...
class AssemblyParseStateItem(java.lang.Comparable[AssemblyParseStateItem]):
    ...
    @typing.overload
    def __init__(self, prod: ghidra.app.plugin.assembler.sleigh.grammars.AssemblyProduction, pos: typing.Union[jpype.JInt, int]) -> None:
        """
...
class AssemblyParseMachine(java.lang.Comparable[AssemblyParseMachine]):
    ...
    def __init__(self, parser: AssemblyParser, input: typing.Union[java.lang.String, str], pos: typing.Union[jpype.JInt, int], lastTok: ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseToken, symbols: ghidra.app.plugin.assembler.sleigh.symbol.AssemblyNumericSymbols) -> None:
        """
...
__all__ = ["AssemblyParseResult", "AssemblyParseAcceptResult", "AssemblyParseErrorResult", "AssemblyParser", "AssemblyFirstFollow", "AssemblyParseState", "AssemblyParseTransitionTable", "AssemblyParseActionGotoTable", "AssemblyParseStateItem", "AssemblyParseMachine"]
