...
class ProjectDataTablePanel(javax.swing.JPanel):
    ...
    class ProjectDataTable(docking.widgets.table.GTable):
        ...
        def __init__(self, m: docking.widgets.table.threaded.ThreadedTableModel[DomainFileInfo, typing.Any]) -> None:
            ...
    ...
    def setFilter(self, filterText: typing.Union[java.lang.String, str]) -> None:
        ...

    def setHelpLocation(self, helpLocation: ghidra.util.HelpLocation) -> None:
        ...

    def setProjectData(self, name: typing.Union[java.lang.String, str], projectData: ghidra.framework.model.ProjectData) -> None:
        ...

    def setSelectedDomainFiles(self, files: java.util.Set[ghidra.framework.model.DomainFile]) -> None:
        ...
...
class ProjectDataTableModel(docking.widgets.table.threaded.ThreadedTableModel[DomainFileInfo, ghidra.framework.model.ProjectData]):
    ...
    def setEditing(self, on: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DomainFileType(java.lang.Comparable[DomainFileType], docking.widgets.table.DisplayStringProvider):
    ...
    def __init__(self, contentType: typing.Union[java.lang.String, str], icon: javax.swing.Icon, isVersioned: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["ProjectDataTablePanel", "FrontendProjectTreeAction", "ProjectDataContext", "DomainFileContext", "ProjectTreeAction", "ProjectTreeContext", "ProjectDataContextToggleAction", "DomainFileProviderContextAction", "ProjectDataTableModel", "DomainFileInfo", "ProjectDataColumn", "DomainFileType"]
