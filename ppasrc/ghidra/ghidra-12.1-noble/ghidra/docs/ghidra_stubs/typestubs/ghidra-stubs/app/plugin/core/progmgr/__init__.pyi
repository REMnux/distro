...
class AbstractProgramNameSwitchingAction(docking.action.DockingAction):
    ...
    def __init__(self, plugin: ProgramManagerPlugin, name: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class ProgramManagerPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.ProgramManager, ghidra.framework.options.OptionsChangeListener):
    ...
    def openPrograms(self, filesToOpen: java.util.List[ghidra.framework.model.DomainFile]) -> None:
        ...
...
class ProgramCache(ghidra.util.timer.GTimerCache[ProgramLocator, ghidra.program.model.listing.Program]):
    ...
    def __init__(self, duration: java.time.Duration, capacity: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ProgramLocator(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, domainFile: ghidra.framework.model.DomainFile, version: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ProgramSaveManager(java.lang.Object):
    ...
    def saveChangedPrograms(self) -> None:
        """
...
class UndoAction(AbstractUndoRedoAction):
    ...
    def __init__(self, plugin: ProgramManagerPlugin, tool: ghidra.framework.plugintool.PluginTool) -> None:
        ...
...
class AbstractUndoRedoAction(docking.menu.MultiActionDockingAction):
    ...
    class RepeatedAction(docking.action.DockingAction):
        ...
        def __init__(self, name: typing.Union[java.lang.String, str], repeatCount: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, plugin: ProgramManagerPlugin, name: typing.Union[java.lang.String, str], iconId: typing.Union[java.lang.String, str], keyBinding: typing.Union[java.lang.String, str], subGroup: typing.Union[java.lang.String, str]) -> None:
        ...
...
class CloseProgramAction(AbstractProgramNameSwitchingAction):
    ...
    def __init__(self, plugin: ProgramManagerPlugin, group: typing.Union[java.lang.String, str], subGroup: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class MultiTabListener(java.lang.Object):
    ...
    def objectAdded(self, obj: java.lang.Object) -> None:
        """
    ...
    def objectSelected(self, obj: java.lang.Object) -> None:
        """
...
class MultiTabPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.model.TransactionListener, ghidra.framework.model.DomainObjectListener, ghidra.framework.options.OptionsChangeListener):
    """
    Plugin to show a "tab" for each open program; the selected tab is the activated program.
    """

    @typing.type_check_only
    class TabContextListener(docking.DockingContextListener):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
class ProgramOptionsAction(AbstractProgramNameSwitchingAction):
    ...
    def __init__(self, plugin: ProgramManagerPlugin) -> None:
        ...
...
class ProgramTabActionContext(docking.DefaultActionContext):
    ...
    def __init__(self, provider: docking.ComponentProvider, program: ghidra.program.model.listing.Program, source: java.awt.Component) -> None:
        ...
...
__all__ = ["AbstractProgramNameSwitchingAction", "MultiProgramManager", "ProgramManagerPlugin", "ProgramCache", "ProgramLocator", "ProgramSaveManager", "UndoAction", "AbstractUndoRedoAction", "RedoAction", "TransactionMonitor", "CloseProgramAction", "MultiTabListener", "MultiTabPlugin", "ProgramOptionsAction", "ProgramTabActionContext", "SaveAsProgramAction", "SaveProgramAction"]
