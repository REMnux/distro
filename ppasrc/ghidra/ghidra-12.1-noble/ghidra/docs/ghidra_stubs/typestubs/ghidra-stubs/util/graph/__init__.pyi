...
class AbstractDependencyGraph(java.lang.Object, typing.Generic[T]):
    ...
    class DependencyNode(java.lang.Object):
        ...
        def addNodeThatDependsOnMe(self, node: AbstractDependencyGraph.DependencyNode) -> None:
            ...
        ...
        def releaseDependencies(self) -> None:
            ...
    ...
    def addDependency(self, value1: T, value2: T) -> None:
        """
...
class AddableLongDoubleHashtable(ghidra.util.datastruct.LongDoubleHashtable):
    ...
    def add(self, key: typing.Union[jpype.JLong, int], value: typing.Union[jpype.JDouble, float]) -> None:
        """
...
class AddableLongIntHashtable(ghidra.util.datastruct.LongIntHashtable):
    ...
    def add(self, key: typing.Union[jpype.JLong, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DependencyGraph(AbstractDependencyGraph[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, other: DependencyGraph[T]) -> None:
        """
        Copy constructor
...
class DepthFirstSearch(java.lang.Object):
    ...
    def __init__(self, graph: DirectedGraph, initialSeeds: jpype.JArray[Vertex], getAdditionalSeedsIfNeeded: typing.Union[jpype.JBoolean, bool], goForward: typing.Union[jpype.JBoolean, bool], goBackward: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DirectedGraph(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, vertexCapacity: typing.Union[jpype.JInt, int], edgeCapacity: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def intersectionWith(self, otherGraph: DirectedGraph) -> None:
        """
    ...
    def unionWith(self, otherGraph: DirectedGraph) -> None:
        """
...
class Vertex(KeyedObject, java.lang.Comparable[Vertex]):
    ...
    def __init__(self, referent: java.lang.Object) -> None:
        """
...
class Edge(KeyedObject, java.lang.Comparable[Edge]):
    ...
    def __init__(self, from_: Vertex, to: Vertex) -> None:
        """
...
class VertexSet(KeyIndexableSet[Vertex]):
    ...
    def __init__(self, parent: DirectedGraph, capacity: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
...
class DeterministicDependencyGraph(AbstractDependencyGraph[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, other: DeterministicDependencyGraph[T]) -> None:
        """
        Copy constructor
...
class Dominator(DirectedGraph):
    ...
    @typing.overload
    def __init__(self, cg: DirectedGraph) -> None:
        ...
    ...
    def setCallingParent(self, v: Vertex, parent: Vertex) -> None:
        ...

    def setColor(self, v: Vertex, color: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def setType(self, v: Vertex, type: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def setWeight(self, v: Vertex, weight: typing.Union[jpype.JDouble, float]) -> None:
        ...

    @typing.overload
    def setWeight(self, e: Edge, weight: typing.Union[jpype.JDouble, float]) -> None:
        ...

    def whitenChildren(self, v: Vertex) -> None:
        """
...
class SimpleWeightedDigraph(WeightedDigraph):
    ...
    @typing.overload
    def __init__(self, vertexCapacity: typing.Union[jpype.JInt, int], edgeCapacity: typing.Union[jpype.JInt, int], defaultEdgeWeight: typing.Union[jpype.JDouble, float], loopsAllowed: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, vertexCapacity: typing.Union[jpype.JInt, int], edgeCapacity: typing.Union[jpype.JInt, int], defaultEdgeWeight: typing.Union[jpype.JDouble, float]) -> None:
        """
        Constructor for SimpleWeightedDigraph. 
...
__all__ = ["AbstractDependencyGraph", "AddableLongDoubleHashtable", "AddableLongIntHashtable", "DependencyGraph", "DepthFirstSearch", "DirectedGraph", "Vertex", "KeyedObject", "Edge", "KeyedObjectFactory", "VertexSet", "KeyIndexableSet", "EdgeSet", "GraphIterator", "DeterministicDependencyGraph", "Dominator", "Path", "SimpleWeightedDigraph", "WeightedDigraph"]
