...
class CodeManager(db.util.ErrorHandler, ghidra.program.database.ManagerDB):
    ...
    def clearCodeUnits(self, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address, clearContext: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def clearData(self, dataTypeIDs: java.util.Set[java.lang.Long], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def setComment(self, address: ghidra.program.model.address.Address, commentType: ghidra.program.model.listing.CommentType, comment: typing.Union[java.lang.String, str]) -> None:
        """
...
class CodeUnitDB(ghidra.program.database.DatabaseObject, ghidra.program.model.listing.CodeUnit, ghidra.program.model.lang.ProcessorContext):
    ...
    def __init__(self, codeMgr: CodeManager, cache: ghidra.program.database.DBObjectCache[CodeUnitDB], cacheKey: typing.Union[jpype.JLong, int], address: ghidra.program.model.address.Address, addr: typing.Union[jpype.JLong, int], length: typing.Union[jpype.JInt, int]) -> None:
        """
...
class InstructionDB(CodeUnitDB, ghidra.program.model.listing.Instruction, ghidra.program.model.lang.InstructionContext):
    ...
    def __init__(self, codeMgr: CodeManager, cache: ghidra.program.database.DBObjectCache[CodeUnitDB], address: ghidra.program.model.address.Address, addr: typing.Union[jpype.JLong, int], proto: ghidra.program.model.lang.InstructionPrototype, flags: typing.Union[jpype.JByte, int]) -> None:
        """
...
class ProtoDBAdapter(java.lang.Object):
    ...
    def createRecord(self, protoID: typing.Union[jpype.JInt, int], addr: typing.Union[jpype.JLong, int], b: jpype.JArray[jpype.JByte], inDelaySlot: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class CodeUnitKeyIterator(ghidra.program.model.listing.CodeUnitIterator):
    ...
    def __init__(self, codeMgr: CodeManager, it: ghidra.program.database.map.AddressKeyIterator, forward: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class CommentTypeFilterAddressIterator(ghidra.program.model.address.AddressIterator):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, it: ghidra.program.model.address.AddressIterator, commentType: ghidra.program.model.listing.CommentType) -> None:
        """
...
class CommentTypeFilterIterator(ghidra.program.model.listing.CodeUnitIterator):
    ...
    def __init__(self, it: ghidra.program.model.listing.CodeUnitIterator, commentType: ghidra.program.model.listing.CommentType) -> None:
        """
...
class CommentsDBAdapterV0(CommentsDBAdapter):
    ...
    def __init__(self, handle: db.DBHandle, addrMap: ghidra.program.database.map.AddressMap) -> None:
        """
        Constructor
        """
...
class DataComponent(DataDB):
    ...
    def __init__(self, codeMgr: CodeManager, componentCache: ghidra.program.database.DBObjectCache[DataDB], address: ghidra.program.model.address.Address, addr: typing.Union[jpype.JLong, int], parent: DataDB, component: ghidra.program.model.data.DataTypeComponent) -> None:
        """
...
class DataDBAdapterV0(DataDBAdapter):
    ...
    def __init__(self, handle: db.DBHandle, addrMap: ghidra.program.database.map.AddressMap, create: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
        """
...
class DataFilteredCodeUnitIterator(ghidra.program.model.listing.DataIterator):
    ...
    def __init__(self, it: ghidra.program.model.listing.CodeUnitIterator) -> None:
        """
...
class DataKeyIterator(ghidra.program.model.listing.DataIterator):
    ...
    def __init__(self, codeMgr: CodeManager, addrMap: ghidra.program.database.map.AddressMap, it: db.DBLongIterator) -> None:
        """
...
class DataRecordIterator(ghidra.program.model.listing.DataIterator):
    ...
    def __init__(self, codeMgr: CodeManager, it: db.RecordIterator, forward: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class StringDiffUtils(java.lang.Object):
    ...
    class Line(java.lang.Object):
        ...
        def __init__(self, line: typing.Union[java.lang.String, str], start: typing.Union[jpype.JInt, int]) -> None:
            ...
...
__all__ = ["CodeManager", "CommentsDBAdapter", "DataDBAdapter", "InstDBAdapter", "CommentHistoryAdapter", "PrototypeManager", "CodeUnitDB", "InstructionDB", "DataDB", "ProtoDBAdapter", "CodeUnitKeyIterator", "CodeUnitRecordIterator", "CommentHistoryAdapterNoTable", "CommentHistoryAdapterV0", "CommentTypeFilterAddressIterator", "CommentTypeFilterIterator", "CommentsDBAdapterV0", "CommentsDBAdapterV1", "DataComponent", "DataDBAdapterV0", "DataFilteredCodeUnitIterator", "DataKeyIterator", "DataRecordIterator", "EmptyCodeUnitIterator", "InstDBAdapterV0", "InstDBAdapterV1", "InstructionRecordIterator", "ProtoDBAdapterV0", "ProtoDBAdapterV1", "StringDiff", "StringDiffUtils"]
