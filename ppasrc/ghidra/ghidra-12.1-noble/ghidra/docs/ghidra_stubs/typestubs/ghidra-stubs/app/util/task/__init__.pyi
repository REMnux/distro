...
class OpenProgramRequest(java.lang.Object):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, locator: ghidra.app.plugin.core.progmgr.ProgramLocator, consumer: java.lang.Object) -> None:
        ...
...
class OpenProgramTask(ghidra.util.task.Task):
    ...
    @typing.overload
    def __init__(self, programLocatorList: java.util.List[ghidra.app.plugin.core.progmgr.ProgramLocator], consumer: java.lang.Object) -> None:
        """
    ...
    @typing.overload
    def __init__(self, locator: ghidra.app.plugin.core.progmgr.ProgramLocator, consumer: java.lang.Object) -> None:
        """
    ...
    @typing.overload
    def __init__(self, domainFile: ghidra.framework.model.DomainFile, version: typing.Union[jpype.JInt, int], consumer: java.lang.Object) -> None:
        """
        Construct a task for opening a program
    ...
    @typing.overload
    def __init__(self, domainFile: ghidra.framework.model.DomainFile, consumer: java.lang.Object) -> None:
        """
    ...
    @typing.overload
    def __init__(self, ghidraURL: java.net.URL, consumer: java.lang.Object) -> None:
        """
    ...
    def setOpenPromptText(self, text: typing.Union[java.lang.String, str]) -> None:
        """
...
class ProgramOpener(java.lang.Object):
    ...
    def __init__(self, consumer: java.lang.Object) -> None:
        """
    ...
    def setPromptText(self, text: typing.Union[java.lang.String, str]) -> None:
        """
        Sets the text to use for the base action type for various prompts that can appear
        when opening programs. (The default is "Open".) For example, you may want to override
        this so be something like "Open Source", or "Open target".
...
__all__ = ["OpenProgramRequest", "OpenProgramTask", "ProgramOpener"]
