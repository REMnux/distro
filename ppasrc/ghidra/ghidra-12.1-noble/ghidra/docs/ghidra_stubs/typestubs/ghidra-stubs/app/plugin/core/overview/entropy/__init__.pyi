...
class EntropyRecord(java.lang.Object):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], center: typing.Union[jpype.JDouble, float], width: typing.Union[jpype.JDouble, float]) -> None:
        """
        Constructor
...
class OverviewPalette(java.lang.Object):
    ...
    def __init__(self, sz: typing.Union[jpype.JInt, int], uninit: java.awt.Color) -> None:
        ...

    def addKnot(self, name: typing.Union[java.lang.String, str], knot: java.awt.Color, start: typing.Union[jpype.JInt, int], point: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def setBase(self, lo: java.awt.Color, hi: java.awt.Color) -> None:
        ...
...
class EntropyOverviewOptionsManager(ghidra.framework.options.OptionsChangeListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, service: EntropyOverviewColorService) -> None:
        ...
...
class KnotRecord(java.lang.Object):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], color: java.awt.Color, start: typing.Union[jpype.JInt, int], end: typing.Union[jpype.JInt, int], point: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
...
class KnotLabelPanel(javax.swing.JPanel):
    ...
    def __init__(self, topBottomMargin: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setPalette(self, palette: OverviewPalette) -> None:
        ...
...
class LegendPanel(javax.swing.JPanel):
    ...
    def setPalette(self, pal: OverviewPalette) -> None:
        ...
...
__all__ = ["EntropyChunkSize", "EntropyKnot", "EntropyRecord", "EntropyOverviewColorService", "OverviewPalette", "EntropyOverviewOptionsManager", "KnotRecord", "KnotLabelPanel", "LegendPanel", "PalettePanel"]
