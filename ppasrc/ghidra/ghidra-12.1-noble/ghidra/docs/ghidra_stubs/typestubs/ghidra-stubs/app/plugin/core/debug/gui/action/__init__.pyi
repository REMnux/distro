...
class DebuggerReadsMemoryTrait(java.lang.Object):
    ...
    class RefreshSelectedMemoryAction(ghidra.app.plugin.core.debug.gui.DebuggerResources.AbstractRefreshSelectedMemoryAction):
        ...
        def updateEnabled(self, context: docking.ActionContext) -> None:
            ...
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, plugin: ghidra.framework.plugintool.Plugin, provider: docking.ComponentProvider) -> None:
        ...
    ...
    def setAutoSpec(self, autoSpec: ghidra.debug.api.action.AutoReadMemorySpec) -> None:
        ...
...
class DebuggerGoToTrait(java.lang.Object):
    ...
    class GoToResult(java.lang.Record):
        ...
        def __init__(self, address: ghidra.program.model.address.Address, success: typing.Union[java.lang.Boolean, bool]) -> None:
            ...
...
class DebuggerGoToDialog(ghidra.app.plugin.core.debug.gui.breakpoint.AbstractDebuggerSleighInputDialog):
    ...
    def __init__(self, trait: DebuggerGoToTrait) -> None:
        ...

    def setOffset(self, offset: typing.Union[java.lang.String, str]) -> None:
        ...

    def show(self, factory: ghidra.program.model.address.AddressFactory, defaultInput: ghidra.debug.api.action.GoToInput) -> None:
        ...
...
class DebuggerTrackLocationTrait(java.lang.Object):
    ...
    def setSpec(self, spec: ghidra.debug.api.action.LocationTrackingSpec) -> None:
        ...
...
class WatchLocationTrackingSpec(ghidra.debug.api.action.LocationTrackingSpec):
    ...
    def __init__(self, expression: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["DebuggerReadsMemoryTrait", "BasicAutoReadMemorySpec", "BasicAutoReadMemorySpecFactory", "BasicLocationTrackingSpecFactory", "ByModuleAutoMapSpec", "ByRegionAutoMapSpec", "BySectionAutoMapSpec", "DebuggerAutoReadMemoryAction", "DebuggerGoToTrait", "DebuggerGoToDialog", "DebuggerProgramLocationActionContext", "DebuggerTrackLocationAction", "DebuggerTrackLocationTrait", "NoneAutoMapSpec", "NoneLocationTrackingSpec", "OneToOneAutoMapSpec", "PCByRegisterLocationTrackingSpec", "RegisterLocationTrackingSpec", "PCByStackLocationTrackingSpec", "PCLocationTrackingSpec", "SPLocationTrackingSpec", "WatchLocationTrackingSpec", "WatchLocationTrackingSpecFactory"]
