...
class DiffLines(java.util.ArrayList[ghidra.app.util.html.ValidatableLine]):
    ...
    @typing.overload
    def __init__(self, input: DataTypeDiffInput) -> None:
        ...

    @typing.overload
    def __init__(self, input: DataTypeDiffInput, validatedLines: java.util.List[ghidra.app.util.html.ValidatableLine]) -> None:
        ...
...
class DataTypeDiffBuilder(java.lang.Object):
    ...
    @staticmethod
    def highlightDifferences(left: java.util.List[ghidra.app.util.html.ValidatableLine], right: java.util.List[ghidra.app.util.html.ValidatableLine]) -> None:
        ...

    @staticmethod
    def padLines(leftLines: DiffLines, rightLines: DiffLines) -> None:
        ...
...
__all__ = ["DataTypeDiffInput", "DataTypeDiff", "DiffLines", "DataTypeDiffBuilder", "DiffLinesValidator"]
