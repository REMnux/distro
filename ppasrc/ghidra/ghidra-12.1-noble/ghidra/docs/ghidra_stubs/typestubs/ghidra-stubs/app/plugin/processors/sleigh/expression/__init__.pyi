...
class OperandValue(PatternValue):
    ...
    @typing.overload
    def __init__(self, i: typing.Union[jpype.JInt, int], c: ghidra.app.plugin.processors.sleigh.Constructor) -> None:
        ...
...
class ConstantValue(PatternValue):
    ...
    @typing.overload
    def __init__(self, b: typing.Union[jpype.JLong, int]) -> None:
        ...
...
__all__ = ["PatternExpression", "OperandValue", "PatternValue", "ContextField", "ConstantValue", "TokenField", "BinaryExpression", "UnaryExpression", "AndExpression", "DivExpression", "EndInstructionValue", "LeftShiftExpression", "MinusExpression", "MultExpression", "Next2InstructionValue", "NotExpression", "OrExpression", "RightShiftExpression", "PlusExpression", "SubExpression", "XorExpression", "StartInstructionValue"]
