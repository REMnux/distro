...
class AttributedStringPcodeFormatter(AbstractPcodeFormatter[java.util.List[docking.widgets.fieldpanel.field.AttributedString], AttributedStringPcodeFormatter.ToAttributedStringsAppender]):
    ...
    class ToAttributedStringsAppender(AbstractAppender[java.util.List[docking.widgets.fieldpanel.field.AttributedString]]):
        ...
        def __init__(self, language: ghidra.program.model.lang.Language, indent: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def setOptions(self, maxDisplayLines: typing.Union[jpype.JInt, int], displayRawPcode: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class StringPcodeFormatter(AbstractPcodeFormatter[java.lang.String, StringPcodeFormatter.ToStringAppender]):
    ...
    class ToStringAppender(AbstractAppender[java.lang.String]):
        ...
        def __init__(self, language: ghidra.program.model.lang.Language, labeled: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
...
class Appender(java.lang.Object, typing.Generic[T]):
    ...
    def appendAddressWordOffcut(self, wordOffset: typing.Union[jpype.JLong, int], offcut: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def appendCharacter(self, c: typing.Union[jpype.JChar, int, str]) -> None:
        """
        Append a character
    ...
    def appendLabel(self, label: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def appendLineLabel(self, label: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def appendLineLabelRef(self, label: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def appendMnemonic(self, opcode: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def appendRawVarnode(self, space: ghidra.program.model.address.AddressSpace, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def appendScalar(self, value: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def appendUnique(self, offset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def appendUserop(self, id: typing.Union[jpype.JInt, int]) -> None:
        """
...
class PcodeFormatter(java.lang.Object, typing.Generic[T]):
    ...
    @staticmethod
    def getPcodeOpTemplateLog(addrFactory: ghidra.program.model.address.AddressFactory, pcodeOp: ghidra.program.model.pcode.PcodeOp) -> ghidra.app.plugin.processors.sleigh.template.OpTpl:
        """
        ...
        :param ghidra.program.model.pcode.PcodeOp pcodeOp: the p-code op to convert
        :return: p-code op template
        :rtype: ghidra.app.plugin.processors.sleigh.template.OpTpl
        """
    ...
    @staticmethod
    def getPcodeOpTemplatesLog(addrFactory: ghidra.program.model.address.AddressFactory, pcodeOps: java.util.List[ghidra.program.model.pcode.PcodeOp]) -> java.util.List[ghidra.app.plugin.processors.sleigh.template.OpTpl]:
        """
    ...
    @staticmethod
    def getVarnodeTpl(addrFactory: ghidra.program.model.address.AddressFactory, v: ghidra.program.model.pcode.Varnode) -> ghidra.app.plugin.processors.sleigh.template.VarnodeTpl:
        ...



__all__ = ["AttributedStringPcodeFormatter", "StringPcodeFormatter", "AbstractAppender", "Appender", "AbstractPcodeFormatter", "PcodeFormatter"]
