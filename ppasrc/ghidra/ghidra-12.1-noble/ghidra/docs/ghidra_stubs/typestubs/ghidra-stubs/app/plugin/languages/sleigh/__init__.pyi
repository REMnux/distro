...
class SleighPcodeTraversal(VisitorResults):
    ...
    def __init__(self, cons: ghidra.app.plugin.processors.sleigh.Constructor) -> None:
        """
...
class SleighLanguages(java.lang.Object):
    ...
    class ConsVisitForPcode(ConstructorEntryVisitor):
        ...
        def __init__(self, visitor: PcodeOpEntryVisitor) -> None:
            """
...
class SleighSubtableTraversal(VisitorResults):
    ...
    def __init__(self, sub: ghidra.app.plugin.processors.sleigh.symbol.SubtableSymbol) -> None:
        """
...
__all__ = ["ConstructorEntryVisitor", "VisitorResults", "InputContextScraper", "PcodeOpEntryVisitor", "SleighConstructorTraversal", "SubtableEntryVisitor", "SleighPcodeTraversal", "SleighLanguages", "SleighSubtableTraversal"]
