...
class FieldFactory(ghidra.util.classfinder.ExtensionPoint):
    ...
    def displayOptionsChanged(self, options: ghidra.framework.options.Options, optionName: typing.Union[java.lang.String, str], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    def fieldOptionsChanged(self, options: ghidra.framework.options.Options, optionName: typing.Union[java.lang.String, str], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    def setEnabled(self, state: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setStartX(self, x: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setWidth(self, w: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DummyFieldFactory(FieldFactory):
    ...
    def __init__(self, mgr: ghidra.app.util.viewer.format.FormatManager) -> None:
        ...
...
class BrowserCodeUnitFormat(ghidra.program.model.listing.CodeUnitFormat):
    ...
    @typing.overload
    def __init__(self, serviceProvider: ghidra.framework.plugintool.ServiceProvider, autoUpdate: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AnnotatedStringHandler(ghidra.util.classfinder.ExtensionPoint):
    ...
    def modify(self, text: jpype.JArray[java.lang.String], program: ghidra.program.model.listing.Program) -> jpype.JArray[java.lang.String]:
        """
        ...
        :param jpype.JArray[java.lang.String] text: the array of annotation parts to modify
...
class ListingColors(java.lang.Object):
    ...
    COLLAPSED_CODE: typing.Final[generic.theme.GColor]
...
class FieldStringInfo(java.lang.Object):
    ...
    def __init__(self, parentString: typing.Union[java.lang.String, str], fieldString: typing.Union[java.lang.String, str], offset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class EolExtraCommentsOption(ghidra.framework.options.CustomOption):
    ...
    def setAutoData(self, priority: EolEnablement) -> None:
        ...

    def setAutoFunction(self, priority: EolEnablement) -> None:
        ...

    def setRefRepeatable(self, priority: EolEnablement) -> None:
        ...

    def setRepeatable(self, priority: EolEnablement) -> None:
        ...

    def setUseAbbreviatedComments(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class AbstractOffsetFieldFactory(FieldFactory):
    ...
    def __init__(self, offsetDescription: typing.Union[java.lang.String, str]) -> None:
        """
...
class AbstractOpenCloseField(ListingField):
    """
    ...
    def __init__(self, factory: FieldFactory, proxy: ghidra.app.util.viewer.proxy.ProxyObj[typing.Any], metrics: java.awt.FontMetrics, x: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
    ...
    def setStartY(self, startY: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setYPos(self, yPos: typing.Union[jpype.JInt, int], heightAbove: typing.Union[jpype.JInt, int], heightBelow: typing.Union[jpype.JInt, int]) -> None:
        """
...
class AddressFieldOptionsWrappedOption(ghidra.framework.options.CustomOption):
    ...
    def setMinimumHexDigits(self, numDigits: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setPadWithZeros(self, padWithZeros: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setRightJustify(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShowBlockName(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class Annotation(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, annotationText: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, annotationParts: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, annotationText: typing.Union[java.lang.String, str], program: ghidra.program.model.listing.Program) -> None:
        """
        Deprecated.  Use :meth:`Annotation(String) <.Annotation>`.
        
        :param java.lang.String or str annotationText: the complete annotation text
        :param ghidra.program.model.listing.Program program: ignored
        """
...
class ArrayElementFieldLocation(ghidra.program.util.OperandFieldLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], displayValue: typing.Union[java.lang.String, str], elementIndex: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ArrayElementWrappedOption(ghidra.framework.options.CustomOption):
    ...
    def setArrayElementsPerLine(self, arrayElementsPerLine: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setShowMultipleArrayElementPerLine(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class CollapsedCodeFieldFactory(FieldFactory):
    """
    Generates field to indicate collapsed function for areas of hidden code.
    """

    class_: typing.ClassVar[java.lang.Class]
    FIELD_NAME: typing.Final = "Collapsed Code"

    def __init__(self) -> None:
        ...


class CollapsedCodeFieldMouseHandler(FieldMouseHandlerExtension):
    """
    A handler to process :obj:`CollapsedCodeLocation` mouse clicks.
    """
...
class ErrorListingField(ListingTextField):
    ...
    def __init__(self, ff: FieldFactory, proxy: ghidra.app.util.viewer.proxy.ProxyObj[typing.Any], varWidth: typing.Union[jpype.JInt, int], t: java.lang.Throwable) -> None:
        ...
...
class ListingFieldHighlightFactoryAdapter(docking.widgets.fieldpanel.support.FieldHighlightFactory):
    ...
    def __init__(self, provider: ghidra.app.util.ListingHighlightProvider) -> None:
        """
        Constructor
...
class FunctionCallFixupFieldFactory(FieldFactory):
    ...
    @typing.overload
    def __init__(self, model: ghidra.app.util.viewer.format.FieldFormatModel, hlProvider: ghidra.app.util.ListingHighlightProvider, displayOptions: ghidra.framework.options.Options, fieldOptions: ghidra.framework.options.Options) -> None:
        """
        Constructor
...
class FunctionOpenCloseField(AbstractOpenCloseField):
    """
...
class FunctionOpenCloseFieldFactory(FieldFactory):
    """
...
class FunctionSignatureFieldFactory(FieldFactory):
    ...
    @typing.overload
    def __init__(self, model: ghidra.app.util.viewer.format.FieldFormatModel, hlProvider: ghidra.app.util.ListingHighlightProvider, displayOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> None:
        """
        Constructor
...
class ImageFactoryField(docking.widgets.fieldpanel.field.SimpleImageField, ListingField):
    ...
    @typing.overload
    def __init__(self, factory: FieldFactory, icon: javax.swing.Icon, proxy: ghidra.app.util.viewer.proxy.ProxyObj[typing.Any], metrics: java.awt.FontMetrics, x: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, factory: FieldFactory, icon: javax.swing.Icon, proxy: ghidra.app.util.viewer.proxy.ProxyObj[typing.Any], metrics: java.awt.FontMetrics, x: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], center: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
...
class IndentField(ListingField):
    ...
    def __init__(self, factory: FieldFactory, proxy: ghidra.app.util.viewer.proxy.ProxyObj, indentLevel: typing.Union[jpype.JInt, int], metrics: java.awt.FontMetrics, x: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], isLast: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
...
class InvalidAnnotatedStringHandler(AnnotatedStringHandler):
    ...
    @typing.overload
    def __init__(self, errorText: typing.Union[java.lang.String, str]) -> None:
        ...
...
class LabelCodeUnitFormat(BrowserCodeUnitFormat):
    ...
    def __init__(self, fieldOptions: ghidra.framework.options.ToolOptions) -> None:
        ...
...
class NamespaceWrappedOption(ghidra.framework.options.CustomOption):
    ...
    def setLocalPrefixText(self, localPrefixText: typing.Union[java.lang.String, str]) -> None:
        ...

    def setShowLibraryInNamespace(self, showLibraryInNamespace: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShowLocalNamespace(self, showLocalNamespace: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShowNonLocalNamespace(self, showNonLocalNamespace: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setUseLocalPrefixOverride(self, useLocalPrefixOverride: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class OpenCloseField(AbstractOpenCloseField):
    """
    FactoryField class for displaying the open/close field.
    """
    ...
    def __init__(self, factory: FieldFactory, proxy: ghidra.app.util.viewer.proxy.ProxyObj[typing.Any], indentLevel: typing.Union[jpype.JInt, int], metrics: java.awt.FontMetrics, x: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], isLast: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
...
class OperandFieldHelper(FieldFactory):
    ...
    class ColorStyleAttributes(java.lang.Object):
        ...
        def with_(self, color: java.awt.Color) -> OperandFieldHelper.ColorStyleAttributes:
            ...
    ...
    @typing.type_check_only
    class OpFieldResults(java.lang.Object):
        """
...
class OptionsBasedDataTypeDisplayOptions(ghidra.program.model.data.DataTypeDisplayOptions):
    ...
    def __init__(self, options: ghidra.framework.options.Options) -> None:
        ...
...
class SpacerFieldFactory(FieldFactory):
    ...
    @typing.overload
    def __init__(self, text: typing.Union[java.lang.String, str], model: ghidra.app.util.viewer.format.FieldFormatModel, hsProvider: ghidra.app.util.ListingHighlightProvider, displayOptions: ghidra.framework.options.Options, fieldOptions: ghidra.framework.options.Options) -> None:
        """
        Constructor
...
class SubDataFieldFactory(OperandFieldFactory):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], path: jpype.JArray[jpype.JInt]) -> None:
        """
        Constructor
...
class VariableOpenCloseField(AbstractOpenCloseField):
    """
...
class VariableXRefFieldFactory(XRefFieldFactory):
    ...
    @typing.overload
    def __init__(self, model: ghidra.app.util.viewer.format.FieldFormatModel, hlProvider: ghidra.app.util.ListingHighlightProvider, displayOptions: ghidra.framework.options.Options, fieldOptions: ghidra.framework.options.ToolOptions) -> None:
        """
        Constructor
...
class XRefFieldFactory(FieldFactory):
    ...
    class XrefAttributedString(docking.widgets.fieldpanel.field.CompositeAttributedString):
        ...
        @typing.overload
        def __init__(self, xref: ghidra.program.model.symbol.Reference, content: docking.widgets.fieldpanel.field.AttributedString) -> None:
            ...

        @typing.overload
        def __init__(self, xref: ghidra.program.model.symbol.Reference, content: docking.widgets.fieldpanel.field.AttributedString, delimiter: docking.widgets.fieldpanel.field.AttributedString) -> None:
            ...
    ...
    class XrefFieldElement(docking.widgets.fieldpanel.field.TextFieldElement):
        ...
        def __init__(self, xrefString: XRefFieldFactory.XrefAttributedString, row: typing.Union[jpype.JInt, int], column: typing.Union[jpype.JInt, int]) -> None:
            ...
...
class VariablesOpenCloseFieldFactory(FieldFactory):
    """
    Generates Open/Close Fields for variables under functions.
    """
...
__all__ = ["ListingField", "FieldFactory", "DummyFieldFactory", "BrowserCodeUnitFormat", "FieldMouseHandler", "AnnotatedStringHandler", "AnnotatedMouseHandler", "AnnotationException", "ListingColors", "FieldStringInfo", "ResourceFieldLocation", "EolExtraCommentsOption", "EolEnablement", "AbstractOffsetFieldFactory", "AbstractOpenCloseField", "AbstractVariableFieldFactory", "AddressAnnotatedStringHandler", "AddressFieldFactory", "AddressFieldOptionsPropertyEditor", "AddressFieldOptionsWrappedOption", "AnnotatedStringFieldMouseHandler", "FieldMouseHandlerExtension", "Annotation", "AnnotationCommentPart", "CommentPart", "ArrayElementFieldLocation", "ArrayElementPropertyEditor", "ArrayElementWrappedOption", "ArrayValuesFieldFactory", "AssignedVariableFieldFactory", "BrowserCodeUnitFormatOptions", "BytesFieldFactory", "CollapsedCodeFieldFactory", "CollapsedCodeFieldMouseHandler", "CommentFieldMouseHandler", "CommentUtils", "EolCommentFieldFactory", "EolExtraCommentsPropertyEditor", "ErrorFieldMouseHandler", "ErrorListingField", "ListingTextField", "ListingFieldHighlightFactoryAdapter", "FieldNameFieldFactory", "FileOffsetFieldFactory", "FunctionCallFixupFieldFactory", "FunctionOffsetFieldFactory", "FunctionOpenCloseField", "FunctionOpenCloseFieldFactory", "FunctionPurgeFieldFactory", "FunctionRepeatableCommentFieldFactory", "FunctionRepeatableCommentFieldMouseHandler", "FunctionSignatureFieldFactory", "FunctionSignatureSourceFieldFactory", "FunctionTagFieldFactory", "GhidraLocalURLAnnotatedStringHandler", "URLAnnotatedStringHandler", "GhidraServerURLAnnotatedStringHandler", "ImageFactoryField", "ImageFactoryFieldMouseHandler", "ImagebaseOffsetFieldFactory", "IndentField", "InstructionMaskValueFieldFactory", "InvalidAnnotatedStringHandler", "LabelCodeUnitFormat", "LabelFieldFactory", "ListingFieldDescriptionProvider", "MemoryBlockOffsetFieldFactory", "MemoryBlockStartFieldFactory", "MnemonicFieldFactory", "MnemonicFieldMouseHandler", "NamespacePropertyEditor", "NamespaceWrappedOption", "OpenCloseField", "OpenCloseFieldFactory", "OpenCloseFieldMouseHandler", "OperandFieldFactory", "OperandFieldHelper", "OperandFieldMouseHandler", "OptionsBasedDataTypeDisplayOptions", "ParallelInstructionFieldFactory", "PcodeFieldMouseHandler", "PlateFieldFactory", "PostCommentFieldFactory", "PreCommentFieldFactory", "ProgramAnnotatedStringHandler", "RegisterFieldFactory", "RegisterTransitionFieldFactory", "SeparatorFieldFactory", "SourceMapFieldFactory", "SpaceFieldFactory", "SpacerFieldFactory", "StringCommentPart", "SubDataFieldFactory", "SymbolAnnotatedStringHandler", "ThunkedFunctionFieldFactory", "ThunkedFunctionFieldMouseHandler", "VariableCommentFieldFactory", "VariableCommentFieldMouseHandler", "VariableLocFieldFactory", "VariableNameFieldFactory", "VariableOpenCloseField", "VariableTypeFieldFactory", "VariableXRefFieldFactory", "XRefFieldFactory", "VariableXRefFieldMouseHandler", "XRefFieldMouseHandler", "VariableXRefHeaderFieldFactory", "VariablesOpenCloseFieldFactory", "XRefHeaderFieldFactory"]
