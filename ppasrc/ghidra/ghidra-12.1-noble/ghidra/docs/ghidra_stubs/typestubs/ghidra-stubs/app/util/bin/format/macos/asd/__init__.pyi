...
class EntryDescriptor(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, entryID: typing.Union[jpype.JInt, int], offset: typing.Union[jpype.JInt, int], length: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["Entry", "EntryDescriptor", "AppleSingleDouble", "EntryDescriptorID", "EntryFactory"]
