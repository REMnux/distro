...
class ServiceManager(java.lang.Object):
    ...
    def addService(self, interfaceClass: java.lang.Class[T], service: T) -> None:
        """
    ...
    def removeService(self, interfaceClass: java.lang.Class[typing.Any], service: java.lang.Object) -> None:
        """
    ...
    def setServiceAddedNotificationsOn(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class OptionsManager(docking.options.OptionsService, ghidra.framework.options.OptionsChangeListener):
    ...
    def getConfigState(self) -> org.jdom2.Element:
        """
    ...
    def registerOptionNameChanged(self, oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setConfigState(self, root: org.jdom2.Element) -> None:
        """
        Restore Options objects using the given XML Element.
        
        :param org.jdom2.Element root: element to use to restore the Options objects
        """
    ...
    @property
    def configState(self) -> org.jdom2.Element:
        ...

    @configState.setter
    def configState(self, value: org.jdom2.Element):
        ...
...
class EventManager(java.lang.Object):
    ...
    def addEventListener(self, eventClass: java.lang.Class[ghidra.framework.plugintool.PluginEvent], listener: ghidra.framework.plugintool.util.PluginEventListener) -> None:
        """
    ...
    def addEventProducer(self, eventClass: java.lang.Class[ghidra.framework.plugintool.PluginEvent]) -> None:
        """
    ...
    @typing.overload
    def removeEventListener(self, eventClass: java.lang.Class[ghidra.framework.plugintool.PluginEvent], listener: ghidra.framework.plugintool.util.PluginEventListener) -> None:
        """
    ...
    @typing.overload
    def removeEventListener(self, className: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def removeEventProducer(self, eventClass: java.lang.Class[ghidra.framework.plugintool.PluginEvent]) -> None:
        """
...
class ToolTaskManager(java.lang.Runnable):
    ...
    def executeCommand(self, cmd: ghidra.framework.cmd.BackgroundCommand[T], obj: T) -> None:
        """
    ...
    def taskCompleted(self, obj: T, task: BackgroundCommandTask[T], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def taskFailed(self, obj: T, taskCmd: ghidra.framework.cmd.BackgroundCommand[T], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class BackgroundCommandTask(ghidra.util.task.Task, ghidra.framework.model.AbortedTransactionListener, typing.Generic[T]):
    ...
    def __init__(self, taskMgr: ToolTaskManager, obj: T, cmd: ghidra.framework.cmd.BackgroundCommand[T]) -> None:
        """
        Constructor
...
class ToolTaskMonitor(ghidra.util.task.TaskMonitorComponent, ghidra.util.task.TaskListener):
    ...
    def updateTaskCmd(self, cmd: ghidra.framework.cmd.BackgroundCommand[typing.Any]) -> None:
        ...
...
__all__ = ["ServiceManager", "OptionsManager", "EventManager", "DialogManager", "ToolTaskManager", "BackgroundCommandTask", "ToolTaskMonitor", "Counter"]
