...
class DBTraceVariableSnapProgramView(DBTraceProgramView, ghidra.trace.model.program.TraceVariableSnapProgramView):
    ...
    def __init__(self, trace: ghidra.trace.database.DBTrace, snap: typing.Union[jpype.JLong, int], compilerSpec: ghidra.program.model.lang.CompilerSpec) -> None:
        ...
...
class DBTraceProgramView(ghidra.trace.model.program.TraceProgramView):
    ...
    class EventTranslator(ghidra.trace.util.TypedEventDispatcher, ghidra.trace.database.DBTraceDirectChangeListener):
        ...
        def fireSymbolAdded(self, queues: ghidra.framework.data.DomainObjectEventQueues, symbol: ghidra.trace.model.symbol.TraceSymbol) -> None:
            ...
    ...
    class OverlappingAddressRangeKeyIteratorMerger(ghidra.util.PairingIteratorMerger[java.util.Map.Entry[ghidra.program.model.address.AddressRange, T], java.util.Map.Entry[ghidra.program.model.address.AddressRange, T], java.util.Map.Entry[ghidra.program.model.address.AddressRange, T]], typing.Generic[T]):
        ...
        def __init__(self, left: java.util.Iterator[java.util.Map.Entry[ghidra.program.model.address.AddressRange, T]], right: java.util.Iterator[java.util.Map.Entry[ghidra.program.model.address.AddressRange, T]]) -> None:
            ...
    ...
    def updateBytesChanged(self, range: ghidra.program.model.address.AddressRange) -> None:
        ...

    def updateMemoryAddRegionBlock(self, region: ghidra.trace.model.memory.TraceMemoryRegion) -> None:
        ...

    def updateMemoryAddSpaceBlock(self, space: ghidra.program.model.address.AddressSpace) -> None:
        ...

    def updateMemoryChangeRegionBlockFlags(self, region: ghidra.trace.model.memory.TraceMemoryRegion, lifespan: ghidra.trace.model.Lifespan) -> None:
        ...

    def updateMemoryChangeRegionBlockLifespan(self, region: ghidra.trace.model.memory.TraceMemoryRegion, oldLifespan: ghidra.trace.model.Lifespan, newLifespan: ghidra.trace.model.Lifespan) -> None:
        ...

    def updateMemoryChangeRegionBlockName(self, region: ghidra.trace.model.memory.TraceMemoryRegion) -> None:
        ...

    def updateMemoryChangeRegionBlockRange(self, region: ghidra.trace.model.memory.TraceMemoryRegion, oldRange: ghidra.program.model.address.AddressRange, newRange: ghidra.program.model.address.AddressRange) -> None:
        ...

    def updateMemoryDeleteRegionBlock(self, region: ghidra.trace.model.memory.TraceMemoryRegion) -> None:
        ...

    def updateMemoryDeleteSpaceBlock(self, space: ghidra.program.model.address.AddressSpace) -> None:
        ...
...
class DBTraceProgramViewBookmarkManager(ghidra.trace.model.program.TraceProgramViewBookmarkManager):
    ...
    def __init__(self, program: DBTraceProgramView) -> None:
        ...
...
class DBTraceProgramViewMemory(AbstractDBTraceProgramViewMemory):
    ...
    class RegionEntry(java.lang.Object):
        ...
        def __init__(self, region: ghidra.trace.model.memory.TraceMemoryRegion, snap: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    def updateAddSpaceBlock(self, space: ghidra.program.model.address.AddressSpace) -> None:
        ...

    def updateBytesChanged(self, range: ghidra.program.model.address.AddressRange) -> None:
        ...

    def updateDeleteSpaceBlock(self, space: ghidra.program.model.address.AddressSpace) -> None:
        ...
...
class AbstractDBTraceProgramViewListing(ghidra.trace.model.program.TraceProgramViewListing):
    ...
    def __init__(self, program: DBTraceProgramView, codeOperations: ghidra.trace.model.listing.TraceCodeOperations) -> None:
        ...
...
class DBTraceProgramViewPropertyMapManager(ghidra.program.model.util.PropertyMapManager):
    ...
    class AbstractDBTraceProgramViewPropertyMap(ghidra.program.model.util.PropertyMap[T], typing.Generic[T]):
        ...
        def __init__(self, map: ghidra.trace.model.property.TracePropertyMap[T], name: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class DBTraceProgramViewIntPropertyMap(DBTraceProgramViewPropertyMapManager.AbstractDBTraceProgramViewPropertyMap[java.lang.Integer], ghidra.program.model.util.IntPropertyMap):
        ...
        def __init__(self, map: ghidra.trace.model.property.TracePropertyMap[java.lang.Integer], name: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class DBTraceProgramViewLongPropertyMap(DBTraceProgramViewPropertyMapManager.AbstractDBTraceProgramViewPropertyMap[java.lang.Long], ghidra.program.model.util.LongPropertyMap):
        ...
        def __init__(self, map: ghidra.trace.model.property.TracePropertyMap[java.lang.Long], name: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class DBTraceProgramViewStringPropertyMap(DBTraceProgramViewPropertyMapManager.AbstractDBTraceProgramViewPropertyMap[java.lang.String], ghidra.program.model.util.StringPropertyMap):
        ...
        def __init__(self, map: ghidra.trace.model.property.TracePropertyMap[java.lang.String], name: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class DBTraceProgramViewVoidPropertyMap(DBTraceProgramViewPropertyMapManager.AbstractDBTraceProgramViewPropertyMap[java.lang.Boolean], ghidra.program.model.util.VoidPropertyMap):
        ...
        def __init__(self, map: ghidra.trace.model.property.TracePropertyMap[java.lang.Boolean], name: typing.Union[java.lang.String, str]) -> None:
            ...
...
class DBTraceProgramViewSymbolTable(ghidra.program.model.symbol.SymbolTable):
    ...
    class PrimarySymbolIterator(generic.util.AbstractPeekableIterator[ghidra.program.model.symbol.Symbol], ghidra.program.model.symbol.SymbolIterator):
        ...
        def __init__(self, it: java.util.Iterator[ghidra.program.model.symbol.Symbol]) -> None:
            ...
...
class DBTraceProgramViewRootModule(ghidra.program.model.listing.ProgramModule):
    ...
    def __init__(self, listing: AbstractDBTraceProgramViewListing) -> None:
        ...
...
class DBTraceProgramViewFragment(ghidra.program.model.listing.ProgramFragment):
    ...
    def __init__(self, listing: AbstractDBTraceProgramViewListing, region: ghidra.trace.model.memory.TraceMemoryRegion, snap: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class DBTraceProgramViewMemoryRegionBlock(AbstractDBTraceProgramViewMemoryBlock):
    ...
    def __init__(self, program: DBTraceProgramView, region: ghidra.trace.model.memory.TraceMemoryRegion, snap: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class DBTraceProgramViewMemorySpaceBlock(AbstractDBTraceProgramViewMemoryBlock):
    ...
    def __init__(self, program: DBTraceProgramView, space: ghidra.program.model.address.AddressSpace) -> None:
        ...
...
class ByteCache(java.lang.Object):
    ...
    class Page(java.lang.Object):
        ...
        def invalidate(self, range: ghidra.program.model.address.AddressRange) -> None:
            ...
    ...
    def __init__(self, pageCount: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DBTraceProgramViewEquate(ghidra.program.model.symbol.Equate):
    ...
    def __init__(self, program: DBTraceProgramView, equate: ghidra.trace.database.symbol.DBTraceEquate) -> None:
        ...



__all__ = ["DBTraceVariableSnapProgramView", "DBTraceProgramView", "DBTraceProgramViewBookmarkManager", "DBTraceProgramViewEquateTable", "DBTraceProgramViewFunctionManager", "DBTraceProgramViewListing", "DBTraceProgramViewMemory", "AbstractDBTraceProgramViewListing", "AbstractDBTraceProgramViewMemory", "DBTraceProgramViewProgramContext", "DBTraceProgramViewPropertyMapManager", "DBTraceProgramViewReferenceManager", "AbstractDBTraceProgramViewReferenceManager", "DBTraceProgramViewSymbolTable", "DBTraceProgramViewChangeSet", "DBTraceProgramViewRootModule", "DBTraceProgramViewFragment", "DBTraceProgramViewMemoryRegionBlock", "AbstractDBTraceProgramViewMemoryBlock", "DBTraceProgramViewMemorySpaceBlock", "ByteCache", "DBTraceProgramViewEquate"]
