...
class Sequence(java.lang.Object):
    ...
    def __init__(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int], stringDataType: ghidra.program.model.data.AbstractStringDataType, nullTerminated: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class MinLengthCharSequenceMatcher(java.lang.Object):
    ...
    def __init__(self, minimumSequenceLength: typing.Union[jpype.JInt, int], charSet: CharSetRecognizer, alignment: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class MultiByteCharMatcher(ByteStreamCharMatcher):
    ...
    def __init__(self, minLength: typing.Union[jpype.JInt, int], charSet: CharSetRecognizer, charWidth: CharWidth, endian: ghidra.program.model.lang.Endian, alignment: typing.Union[jpype.JInt, int], offset: typing.Union[jpype.JInt, int]) -> None:
        ...



__all__ = ["ByteStreamCharMatcher", "CharSetRecognizer", "Sequence", "AsciiCharSetRecognizer", "CharWidth", "MinLengthCharSequenceMatcher", "MultiByteCharMatcher"]
