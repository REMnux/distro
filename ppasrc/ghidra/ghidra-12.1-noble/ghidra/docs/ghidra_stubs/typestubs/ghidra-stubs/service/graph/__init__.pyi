...
class AttributedGraphExporter(ghidra.util.classfinder.ExtensionPoint):
    ...
    def exportGraph(self, graph: AttributedGraph, file: jpype.protocol.SupportsPath) -> None:
        """
...
class GraphDisplayListener(java.lang.Object):
    ...
    def locationFocusChanged(self, vertex: AttributedVertex) -> None:
        """
    ...
    def selectionChanged(self, vertices: java.util.Set[AttributedVertex]) -> None:
        """
...
class GraphDisplay(java.lang.Object):
    ...
    def selectVertices(self, vertexSet: java.util.Set[AttributedVertex], eventTrigger: docking.widgets.EventTrigger) -> None:
        """
    ...
    def setFocusedVertex(self, vertex: AttributedVertex, eventTrigger: docking.widgets.EventTrigger) -> None:
        """
    ...
    def setGraph(self, graph: AttributedGraph, title: typing.Union[java.lang.String, str], append: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def setGraph(self, graph: AttributedGraph, options: GraphDisplayOptions, title: typing.Union[java.lang.String, str], append: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Sets the graph to be displayed or consumed by this graph display
    ...
    def setGraphDisplayListener(self, listener: GraphDisplayListener) -> None:
        """
    ...
    def updateVertexName(self, vertex: AttributedVertex, newName: typing.Union[java.lang.String, str]) -> None:
        """
...
class EdgeGraphActionContext(GraphActionContext):
    ...
    def __init__(self, componentProvider: docking.ComponentProvider, graph: AttributedGraph, selectedVertices: java.util.Set[AttributedVertex], locatedVertex: AttributedVertex, clickedEdge: AttributedEdge) -> None:
        ...
...
class GraphActionContext(docking.DefaultActionContext):
    ...
    def __init__(self, componentProvider: docking.ComponentProvider, graph: AttributedGraph, selectedVertices: java.util.Set[AttributedVertex], locatedVertex: AttributedVertex) -> None:
        ...
...
class VertexGraphActionContext(GraphActionContext):
    ...
    def __init__(self, componentProvider: docking.ComponentProvider, graph: AttributedGraph, selectedVertices: java.util.Set[AttributedVertex], locatedVertex: AttributedVertex, clickedVertex: AttributedVertex) -> None:
        ...
...
class Attributed(java.lang.Object):
    ...
    def putAttributes(self, map: collections.abc.Mapping) -> None:
        """
...
class AttributedEdge(Attributed):
    ...
    def setEdgeType(self, edgeType: typing.Union[java.lang.String, str]) -> None:
        """
...
class AttributedGraph(org.jgrapht.graph.AbstractBaseGraph[AttributedVertex, AttributedEdge]):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], type: GraphType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], type: GraphType, description: typing.Union[java.lang.String, str]) -> None:
        """
        Create a new empty AttributedGraph that automatically collapses duplicate edges
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], type: GraphType, description: typing.Union[java.lang.String, str], collapseDuplicateEdges: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AttributedVertex(Attributed):
    ...
    @typing.overload
    def __init__(self, id: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setVertexType(self, vertexType: typing.Union[java.lang.String, str]) -> None:
        """
...
class GraphType(java.lang.Object):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], vertexTypes: java.util.List[java.lang.String], edgeTypes: java.util.List[java.lang.String]) -> None:
        """
...
class GraphDisplayOptions(ghidra.framework.options.OptionsChangeListener):
    ...
    def __init__(self, graphType: GraphType) -> None:
        """
    ...
    def setArrowLength(self, length: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def setDefaultEdgeColor(self, themeColorId: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setDefaultLayoutAlgorithmName(self, defaultLayout: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setDefaultVertexColor(self, themeColorId: typing.Union[java.lang.String, str]) -> None:
        """
        Sets the default color to be used by vertices that don't have a vertex type set. The
        color is set via a themeColorId, which means the client defined a theme color for this.
    ...
    def setDefaultVertexShape(self, shape: VertexShape) -> None:
        """
    ...
    @typing.overload
    def setEdgeColor(self, edgeType: typing.Union[java.lang.String, str], themeColorId: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setEdgeColor(self, edgeType: typing.Union[java.lang.String, str], color: java.awt.Color) -> None:
        """
    ...
    def setEdgeColorOverrideAttributeKey(self, attributeKey: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setEdgeSelectionColor(self, themeColorId: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setFavoredEdgeType(self, favoredEdgeType: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setFont(self, themeFontId: typing.Union[java.lang.String, str]) -> None:
        ...

    def setLabelPosition(self, labelPosition: GraphLabelPosition) -> None:
        """
    ...
    def setMaxNodeCount(self, maxNodeCount: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setUsesIcons(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def setVertexColor(self, vertexType: typing.Union[java.lang.String, str], color: java.awt.Color) -> None:
        """
    ...
    @typing.overload
    def setVertexColor(self, vertexType: typing.Union[java.lang.String, str], themeColorId: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setVertexColorOverrideAttributeKey(self, attributeKey: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setVertexLabelOverrideAttributeKey(self, attributeKey: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setVertexSelectionColor(self, themeColorId: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setVertexShape(self, vertexType: typing.Union[java.lang.String, str], vertexShape: VertexShape) -> None:
        """
    ...
    def setVertexShapeOverrideAttributeKey(self, attributeKey: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["AttributedGraphExporter", "DummyGraphDisplayListener", "GraphDisplayListener", "GraphDisplay", "EdgeGraphActionContext", "GraphActionContext", "GraphDisplayProvider", "VertexGraphActionContext", "Attributed", "AttributedEdge", "AttributedGraph", "AttributedVertex", "GraphType", "DefaultGraphDisplayOptions", "GraphDisplayOptions", "VertexShape", "GraphLabelPosition", "EmptyGraphType", "GraphDisplayOptionsBuilder", "GraphTypeBuilder", "LayoutAlgorithmNames"]
