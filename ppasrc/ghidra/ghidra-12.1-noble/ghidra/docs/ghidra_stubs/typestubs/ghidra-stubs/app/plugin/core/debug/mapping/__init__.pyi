...
class AbstractDebuggerPlatformMapper(ghidra.debug.api.platform.DebuggerPlatformMapper):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, trace: ghidra.trace.model.Trace) -> None:
        ...
...
class AbstractDebuggerPlatformOffer(DebuggerPlatformOffer):
    ...
    def __init__(self, description: typing.Union[java.lang.String, str], cSpec: ghidra.program.model.lang.CompilerSpec) -> None:
        ...
...
class DefaultDebuggerPlatformMapper(AbstractDebuggerPlatformMapper):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, trace: ghidra.trace.model.Trace, cSpec: ghidra.program.model.lang.CompilerSpec) -> None:
        ...
...
__all__ = ["DebuggerPlatformOffer", "AbstractDebuggerPlatformMapper", "AbstractDebuggerPlatformOffer", "AbstractDebuggerPlatformOpinion", "DebuggerPlatformOpinion", "DefaultDebuggerPlatformMapper", "HostDebuggerPlatformOpinion"]
