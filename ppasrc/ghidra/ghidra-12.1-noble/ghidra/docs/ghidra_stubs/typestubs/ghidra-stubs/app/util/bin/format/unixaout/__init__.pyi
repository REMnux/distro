...
class UnixAoutHeader(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, provider: ghidra.app.util.bin.ByteProvider, isLittleEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def markup(self, program: ghidra.program.model.listing.Program, headerAddress: ghidra.program.model.address.Address) -> None:
        ...
...
class UnixAoutRelocation(java.lang.Object):
    ...
    def __init__(self, address: typing.Union[jpype.JLong, int], flags: typing.Union[jpype.JLong, int], bigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class UnixAoutSymbolTable(java.lang.Iterable[UnixAoutSymbol], ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, fileOffset: typing.Union[jpype.JLong, int], fileSize: typing.Union[jpype.JLong, int], strtab: UnixAoutStringTable, log: ghidra.app.util.importer.MessageLog) -> None:
        ...

    def get(self, symbolNum: typing.Union[jpype.JInt, int]) -> UnixAoutSymbol:
        ...

    def markup(self, program: ghidra.program.model.listing.Program, block: ghidra.program.model.mem.MemoryBlock) -> None:
        ...
...
class UnixAoutSymbol(java.lang.Object):
    ...
    def __init__(self, nameStringOffset: typing.Union[jpype.JLong, int], typeByte: typing.Union[jpype.JByte, int], otherByte: typing.Union[jpype.JByte, int], desc: typing.Union[jpype.JShort, int], value: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class UnixAoutStringTable(java.lang.Object):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, fileOffset: typing.Union[jpype.JLong, int], fileSize: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class UnixAoutRelocationTable(java.lang.Iterable[UnixAoutRelocation], ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, fileOffset: typing.Union[jpype.JLong, int], fileSize: typing.Union[jpype.JLong, int], symtab: UnixAoutSymbolTable) -> None:
        ...
...
__all__ = ["UnixAoutHeader", "UnixAoutMachineType", "UnixAoutRelocation", "UnixAoutSymbolTable", "UnixAoutSymbol", "UnixAoutStringTable", "UnixAoutRelocationTable"]
