...
class ExtensionDetails(java.lang.Comparable[ExtensionDetails]):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], author: typing.Union[java.lang.String, str], createdOn: typing.Union[java.lang.String, str], version: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor.
    ...
    def setArchivePath(self, path: typing.Union[java.lang.String, str]) -> None:
        ...

    def setAuthor(self, author: typing.Union[java.lang.String, str]) -> None:
        ...

    def setCreatedOn(self, date: typing.Union[java.lang.String, str]) -> None:
        ...

    def setDescription(self, description: typing.Union[java.lang.String, str]) -> None:
        ...

    def setInstallDir(self, installDir: jpype.protocol.SupportsPath) -> None:
        ...

    def setName(self, name: typing.Union[java.lang.String, str]) -> None:
        ...

    def setVersion(self, version: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ExtensionModuleClassLoader(java.net.URLClassLoader):
    ...
    def __init__(self, extensionDir: ExtensionDetails) -> None:
        ...
...
__all__ = ["ExtensionDetails", "ExtensionModuleClassLoader", "ExtensionUtils", "Extensions"]
