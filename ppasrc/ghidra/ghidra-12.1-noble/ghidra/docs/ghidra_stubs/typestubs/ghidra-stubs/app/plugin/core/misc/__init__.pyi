...
class RegisterField(javax.swing.JTextField):
    ...
    @typing.overload
    def __init__(self, bitSize: typing.Union[jpype.JInt, int], initialValue: typing.Union[java.lang.Long, int]) -> None:
        ...

    @typing.overload
    def __init__(self, bitSize: typing.Union[jpype.JInt, int], initialValue: typing.Union[java.lang.Long, int], useNoValue: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setNoValueColor(self, c: java.awt.Color) -> None:
        ...

    def setValue(self, value: typing.Union[java.lang.Long, int]) -> None:
        ...

    def setValueColor(self, c: java.awt.Color) -> None:
        ...
...
__all__ = ["RegisterField", "FontAdjustPlugin", "MyProgramChangesDisplayPlugin", "RecoverySnapshotMgrPlugin"]
