...
class PcodeFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], model: ghidra.app.util.viewer.format.FieldFormatModel, highlightProvider: ghidra.app.util.ListingHighlightProvider, displayOptions: ghidra.framework.options.Options, fieldOptions: ghidra.framework.options.Options) -> None:
        ...


class MemoryBlockDefinition(java.lang.Object):
    """
    :obj:`MemoryBlockDefinition` provides a default memory block specification.
    """

    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, element: ghidra.xml.XmlElement) -> None:
        ...

    def createBlock(self, program: ghidra.program.model.listing.Program) -> ghidra.program.model.mem.MemoryBlock:
        """
    ...
    def fixupBlock(self, program: ghidra.program.database.ProgramDB) -> ghidra.program.model.mem.MemoryBlock:
        """
        Create or fixup existing block found within specified program.
        
        :param ghidra.program.database.ProgramDB program: target program
        :return: new or adjusted memory block
        :rtype: ghidra.program.model.mem.MemoryBlock
        :raises LockException: if program does not have exclusive access
        :raises MemoryBlockException: if failed to create or fixup default memory block
        """
...
class BinaryExpression(OperandValue, ExpressionValue):
    ...
    def __init__(self, op: typing.Union[jpype.JInt, int], l: ExpressionTerm, r: ExpressionTerm, c: ghidra.program.model.address.AddressSpace) -> None:
        ...

    def linkRelativeOffsets(self, opHash: java.util.Hashtable[java.lang.String, Operand]) -> None:
        """
...
class OperandValue(java.io.Serializable):
    ...
    def getAllHandles(self, handles: java.util.ArrayList[Handle], position: Position, offset: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def toList(self, list: java.util.ArrayList[Handle], position: Position, off: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ExpressionTerm(java.io.Serializable):
    ...
    def __init__(self, v: ExpressionValue, off: Offset) -> None:
        ...
...
class ConstructorInfo(java.lang.Object):
    ...
    def __init__(self, ln: typing.Union[jpype.JInt, int], fl: typing.Union[jpype.JInt, int]) -> None:
        ...

    def addLength(self, l: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class Operand(java.io.Serializable):
    ...
    def __init__(self, n: typing.Union[java.lang.String, str], o: OperandValue, off: Offset) -> None:
        ...

    def dynamic(self) -> bool:
        ...

    def getAllHandles(self, handles: java.util.ArrayList[Handle], position: Position, off: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class Position(java.lang.Object):
    ...
    def __init__(self, b: ghidra.program.model.mem.MemBuffer, start: ghidra.program.model.address.Address, next: ghidra.program.model.address.Address, c: ghidra.program.model.lang.ProcessorContext) -> None:
        ...
...
class Handle(java.io.Serializable):
    ...
    def __init__(self, p: ghidra.program.model.pcode.Varnode, sp: typing.Union[jpype.JInt, int], sz: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class Offset(java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, off: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, off: typing.Union[jpype.JInt, int], rel: Operand) -> None:
        ...
    ...
    def setRelativeOffset(self, opHash: java.util.Hashtable[java.lang.String, Operand]) -> None:
        """
...
class Constant(ExpressionValue):
    ...
    def __init__(self, v: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class ConstantTemplate(java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, val: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def __init__(self, t: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, o: Operand, sel1: typing.Union[jpype.JInt, int], sel2: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, o: Operand, sel1: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ConstructorPcodeTemplate(java.io.Serializable):
    ...
    def addPcodeOpTemplate(self, opT: java.lang.Object) -> None:
        ...
...
class HandleTemplate(java.io.Serializable):
    ...
    def __init__(self, sp: ConstantTemplate, p: VarnodeTemplate, sz: ConstantTemplate) -> None:
        ...
...
class OpTemplate(java.io.Serializable):
    ...
    def __init__(self, opc: typing.Union[jpype.JInt, int], in_: jpype.JArray[VarnodeTemplate], out: VarnodeTemplate, af: ghidra.program.model.address.AddressFactory) -> None:
        ...
    ...
    def setOmit(self, ref: Operand) -> None:
        ...
...
class VarnodeTemplate(java.io.Serializable):
    ...
    def __init__(self, space: ConstantTemplate, offset: ConstantTemplate, size: ConstantTemplate, addressFactory: ghidra.program.model.address.AddressFactory, ou: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setDef(self, opTemplate: OpTemplate) -> None:
        """
        Method setDef.
    ...
    def setReplace(self, op: Operand, load: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class LanguageFixupUtil(java.lang.Object):
    """
    :obj:`LanguageFixupUtil` provides utility method intended for internal language upgrade
    situations.
    """
    ...
    @staticmethod
    def applyPSpecFixups(programDB: ghidra.program.database.ProgramDB, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        ...
        :param ghidra.program.database.ProgramDB programDB: target program
        :param ghidra.util.task.TaskMonitor monitor: task monitor
        :raises CancelledException: if fixup task is cancelled
        """
...
__all__ = ["PcodeFieldFactory", "MemoryBlockDefinition", "BinaryExpression", "OperandValue", "ExpressionValue", "ExpressionTerm", "SledException", "ConstructorInfo", "Operand", "Position", "Handle", "Offset", "Constant", "ConstantTemplate", "ConstructorPcodeTemplate", "HandleTemplate", "OpTemplate", "VarnodeTemplate", "Label", "LanguageFixupUtil", "UnimplementedConstructor"]
