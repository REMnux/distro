...
class TraceStack(ghidra.trace.model.TraceUniqueObject, ghidra.trace.model.target.iface.TraceObjectInterface):
    ...
    def setDepth(self, snap: typing.Union[jpype.JLong, int], depth: typing.Union[jpype.JInt, int], atInner: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class TraceStackFrame(ghidra.trace.model.target.iface.TraceObjectInterface):
    ...
    def setProgramCounter(self, span: ghidra.trace.model.Lifespan, pc: ghidra.program.model.address.Address) -> None:
        """
...
__all__ = ["TraceStackManager", "TraceStack", "TraceStackFrame"]
