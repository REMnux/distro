...
class DefaultNavigatableLocationMemento(ghidra.app.nav.LocationMemento):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, location: ghidra.program.util.ProgramLocation, tool: ghidra.framework.plugintool.PluginTool) -> None:
        ...
...
class GoToQueryResultsTableModel(ghidra.app.util.query.ProgramLocationPreviewTableModel):
    ...
    def __init__(self, prog: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider, locations: java.util.List[ghidra.program.util.ProgramLocation], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
__all__ = ["GoToHelper", "DefaultNavigatableLocationMemento", "GoToQueryResultsTableModel", "GoToServicePlugin"]
