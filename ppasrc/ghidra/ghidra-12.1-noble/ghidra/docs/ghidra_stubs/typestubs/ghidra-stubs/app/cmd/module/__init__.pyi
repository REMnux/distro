...
class AbstractModularizationCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], path: ghidra.program.util.GroupPath, treeName: typing.Union[java.lang.String, str], selection: ghidra.program.util.ProgramSelection, blockModel: ghidra.program.model.block.CodeBlockModel) -> None:
        ...
...
class ComplexityDepthModularizationCmd(AbstractModularizationCmd):
    ...
    def __init__(self, path: ghidra.program.util.GroupPath, treeName: typing.Union[java.lang.String, str], selection: ghidra.program.util.ProgramSelection, blockModel: ghidra.program.model.block.CodeBlockModel) -> None:
        ...
...
class CreateDefaultTreeCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, treeName: typing.Union[java.lang.String, str]) -> None:
        """
...
class CreateFolderCommand(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, treeName: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], parentName: typing.Union[java.lang.String, str]) -> None:
        """
...
class MergeFolderCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, treeName: typing.Union[java.lang.String, str], folderName: typing.Union[java.lang.String, str], parentName: typing.Union[java.lang.String, str]) -> None:
        """
...
class ModuleAlgorithmCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, path: ghidra.program.util.GroupPath, treeName: typing.Union[java.lang.String, str], blockModelService: ghidra.app.services.BlockModelService, partitioningModelName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class RenameCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, treeName: typing.Union[java.lang.String, str], isModule: typing.Union[jpype.JBoolean, bool], oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str], ignoreDuplicateName: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, treeName: typing.Union[java.lang.String, str], isModule: typing.Union[jpype.JBoolean, bool], oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
        Construct a new RenameCmd.
...
class RenameTreeCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
...
class ReorderModuleCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, treeName: typing.Union[java.lang.String, str], parentModuleName: typing.Union[java.lang.String, str], childName: typing.Union[java.lang.String, str], index: typing.Union[jpype.JInt, int]) -> None:
        """
...
class SubroutineModelCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, groupPath: ghidra.program.util.GroupPath, treeName: typing.Union[java.lang.String, str], blockModelService: ghidra.app.services.BlockModelService, modelName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
__all__ = ["AbstractModularizationCmd", "ComplexityDepthModularizationCmd", "CreateDefaultTreeCmd", "CreateFolderCommand", "CreateFragmentCmd", "DeleteTreeCmd", "DominanceModularizationCmd", "MergeFolderCmd", "ModuleAlgorithmCmd", "RenameCmd", "RenameTreeCmd", "ReorderModuleCmd", "SubroutineModelCmd"]
