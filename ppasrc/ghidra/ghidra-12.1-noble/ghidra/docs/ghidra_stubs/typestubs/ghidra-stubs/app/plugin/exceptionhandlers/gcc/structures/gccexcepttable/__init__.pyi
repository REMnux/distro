...
class LSDACallSiteRecord(ghidra.app.plugin.exceptionhandlers.gcc.GccAnalysisClass):
    ...
    def __init__(self, monitor: ghidra.util.task.TaskMonitor, program: ghidra.program.model.listing.Program, region: ghidra.app.plugin.exceptionhandlers.gcc.RegionDescriptor) -> None:
        """
...
class LSDAActionRecord(ghidra.app.plugin.exceptionhandlers.gcc.GccAnalysisClass):
    ...
    def __init__(self, monitor: ghidra.util.task.TaskMonitor, program: ghidra.program.model.listing.Program, region: ghidra.app.plugin.exceptionhandlers.gcc.RegionDescriptor, lsdaActionTable: LSDAActionTable) -> None:
        """
...
__all__ = ["LSDACallSiteRecord", "LSDATable", "LSDACallSiteTable", "LSDAActionTable", "LSDATypeTable", "LSDAActionRecord", "LSDAHeader"]
