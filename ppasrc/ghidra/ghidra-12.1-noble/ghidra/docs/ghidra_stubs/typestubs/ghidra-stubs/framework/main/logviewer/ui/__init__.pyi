...
class FileWatcher(java.lang.Object):
    ...
    def __init__(self, file: jpype.protocol.SupportsPath, eventListener: ghidra.framework.main.logviewer.event.FVEventListener) -> None:
        """
...
class FVSlider(javax.swing.JSlider, javax.swing.event.ChangeListener, java.awt.event.MouseMotionListener, java.awt.event.MouseListener):
    ...
    def __init__(self, scrollPane: javax.swing.JScrollPane, table: FVTable, viewportUtility: ViewportUtility, model: ghidra.framework.main.logviewer.model.ChunkModel, reader: ghidra.framework.main.logviewer.model.ChunkReader, eventListener: ghidra.framework.main.logviewer.event.FVEventListener) -> None:
        """
    ...
    def setMaximum(self, fileSize: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setValue(self, filePos: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ViewportUtility(java.util.Observer):
    ...
    def __init__(self, eventListener: ghidra.framework.main.logviewer.event.FVEventListener) -> None:
        ...
    ...
    def moveViewportDown(self, rows: typing.Union[jpype.JInt, int], selection: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def moveViewportUp(self, rows: typing.Union[jpype.JInt, int], selection: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def scrollViewportTo(self, row: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setTable(self, table: FVTable) -> None:
        """
...
class FVTable(docking.widgets.table.GTable, java.awt.event.MouseMotionListener, java.awt.event.MouseListener):
    ...
    def __init__(self, reader: ghidra.framework.main.logviewer.model.ChunkReader, viewportUtility: ViewportUtility, model: ghidra.framework.main.logviewer.model.ChunkModel, eventListener: ghidra.framework.main.logviewer.event.FVEventListener) -> None:
        """
        Ctor.
    ...
    def addRow(self, row: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def addRows(self, rows: java.util.List[java.lang.String]) -> None:
        """
    ...
    def decrementAndAddSelection(self, rows: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def decrementSelection(self, rows: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def incrementAndAddSelection(self, rows: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def incrementSelection(self, rows: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setMouseDragging(self, isMouseDragging: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShiftDown(self, isDown: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class FVSliderUI(javax.swing.plaf.basic.BasicSliderUI):
    ...
    def __init__(self, slider: javax.swing.JSlider, scrollPane: javax.swing.JScrollPane, table: javax.swing.JTable, reader: ghidra.framework.main.logviewer.model.ChunkReader, model: ghidra.framework.main.logviewer.model.ChunkModel) -> None:
        """
        Constructor.
...
class FVTableModel(javax.swing.table.AbstractTableModel):
    ...
    @typing.overload
    def addRow(self, row: typing.Union[java.lang.String, str], notify: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def addRow(self, row: typing.Union[java.lang.String, str], index: typing.Union[jpype.JInt, int], notify: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Adds a row to the model
    ...
    def addRowsToBottom(self, rows: java.util.List[java.lang.String]) -> None:
        """
    ...
    def addRowsToTop(self, rows: java.util.List[java.lang.String]) -> None:
        """
        Adds a list of rows to the model and fires off a notification.
    ...
    def removeRowsFromBottom(self, count: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeRowsFromTop(self, count: typing.Union[jpype.JInt, int]) -> None:
        """
...
class FVToolBar(javax.swing.JToolBar):
    ...
    def setScrollLockOn(self, lock: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class FileViewer(javax.swing.JPanel, java.util.Observer):
    ...
    def __init__(self, reader: ghidra.framework.main.logviewer.model.ChunkReader, model: ghidra.framework.main.logviewer.model.ChunkModel, eventListener: ghidra.framework.main.logviewer.event.FVEventListener) -> None:
        """
        Constructor.
...
__all__ = ["FileWatcher", "FVSlider", "ViewportUtility", "FVTable", "FVSliderUI", "FVTableModel", "FVToolBar", "FileViewer", "LogLevelTableCellRenderer", "ReloadDialog"]
