...
class AbstractInstructionTable(ghidra.util.table.GhidraTable):
    ...
    def __init__(self, columns: typing.Union[jpype.JInt, int], dialog: InstructionSearchDialog) -> None:
        ...
...
class InstructionSearchDialog(docking.ReusableDialogComponentProvider, java.util.Observer):
    ...
    def __init__(self, plugin: ghidra.app.plugin.core.instructionsearch.InstructionSearchPlugin, title: typing.Union[java.lang.String, str], taskMonitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Constructor
    ...
    def addToInstructions(self, selection: ghidra.program.util.ProgramSelection, plugin: ghidra.app.plugin.core.instructionsearch.InstructionSearchPlugin) -> None:
        """
    ...
    def displayMessage(self, message: typing.Union[java.lang.String, str], status: java.awt.Color) -> None:
        """
    ...
    def displaySearchResults(self, searchResults: java.util.List[ghidra.app.plugin.core.instructionsearch.model.InstructionMetadata]) -> None:
        """
    ...
    @typing.overload
    def loadBytes(self, bytes: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def loadBytes(self, addrSet: ghidra.program.model.address.AddressSet) -> None:
        """
    ...
    @typing.overload
    def loadInstructions(self, plugin: ghidra.app.plugin.core.instructionsearch.InstructionSearchPlugin) -> None:
        """
    ...
    @typing.overload
    def loadInstructions(self, selection: ghidra.program.util.ProgramSelection, plugin: ghidra.app.plugin.core.instructionsearch.InstructionSearchPlugin) -> None:
        """
    ...
    def populateSearchData(self, currentProgram: ghidra.program.model.listing.Program, selection: ghidra.program.util.ProgramSelection) -> None:
        """
    ...
    def showDialog(self, provider: docking.ComponentProvider) -> None:
        """
    ...
    def update(self, o: java.util.Observable, arg: java.lang.Object) -> None:
        """
...
class InstructionSearchMainPanel(javax.swing.JPanel):
    ...
    def __init__(self, plugin: ghidra.app.plugin.core.instructionsearch.InstructionSearchPlugin, dialog: InstructionSearchDialog) -> None:
        """
        Constructor.
...
class MessagePanel(javax.swing.JPanel):
    ...
    def setMessageText(self, text: typing.Union[java.lang.String, str], foregroundColor: java.awt.Color) -> None:
        """
...
class InstructionTablePanel(javax.swing.JPanel):
    ...
    def __init__(self, numColumns: typing.Union[jpype.JInt, int], plugin: ghidra.app.plugin.core.instructionsearch.InstructionSearchPlugin, dialog: InstructionSearchDialog) -> None:
        ...
...
class PreviewTablePanel(javax.swing.JPanel):
    ...
    def __init__(self, columns: typing.Union[jpype.JInt, int], plugin: ghidra.app.plugin.core.instructionsearch.InstructionSearchPlugin, dialog: InstructionSearchDialog) -> None:
        ...
...
class SelectionModeWidget(ControlPanelWidget):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], parent: InsertBytesWidget) -> None:
        """
        Constructor.
    ...
    def setInputMode(self, mode: SelectionModeWidget.InputMode) -> None:
        """
...
class PreviewTable(AbstractInstructionTable):
    ...
    class BinaryAction(javax.swing.AbstractAction):
        ...
        def __init__(self, text: typing.Union[java.lang.String, str], icon: javax.swing.Icon, desc: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    def addPreviewString(self, previewText: typing.Union[java.lang.String, str], index: typing.Union[java.lang.Integer, int]) -> None:
        """
    ...
    def buildPreviewStrings(self) -> None:
        """
    ...
    def setPreviewText(self, row: typing.Union[jpype.JInt, int], val: typing.Union[java.lang.String, str]) -> None:
        """
...
class InsertBytesWidget(docking.ReusableDialogComponentProvider, java.awt.event.KeyListener):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, dialog: InstructionSearchDialog) -> None:
        """
        Constructor.
    ...
    def keyReleased(self, e: java.awt.event.KeyEvent) -> None:
        """
    ...
    def setInputString(self, input: typing.Union[java.lang.String, str]) -> None:
        ...
...
class SelectionScopeWidget(ControlPanelWidget):
    ...
    def __init__(self, plugin: ghidra.app.plugin.core.instructionsearch.InstructionSearchPlugin, title: typing.Union[java.lang.String, str], dialog: InstructionSearchDialog) -> None:
        """
...
class SearchDirectionWidget(ControlPanelWidget):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], dialog: InstructionSearchDialog) -> None:
        """
...
__all__ = ["AbstractInstructionTable", "InstructionSearchDialog", "InstructionSearchMainPanel", "ControlPanel", "MessagePanel", "InstructionTablePanel", "PreviewTablePanel", "SelectionModeWidget", "PreviewTable", "ControlPanelWidget", "InsertBytesWidget", "HintTextArea", "EndianFlipWidget", "InstructionTable", "SelectionScopeWidget", "SearchDirectionWidget", "InstructionTableCellRenderer", "SearchAllInstructionsTask", "SearchInstructionsTask"]
