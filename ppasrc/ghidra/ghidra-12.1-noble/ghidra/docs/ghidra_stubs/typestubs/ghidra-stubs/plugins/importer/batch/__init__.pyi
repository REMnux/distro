...
class BatchGroup(java.lang.Object):
    ...
    def __init__(self, criteria: BatchSegregatingCriteria) -> None:
        """
    ...
    def add(self, provider: ghidra.app.util.bin.ByteProvider, loadSpecs: collections.abc.Sequence, fsrl: ghidra.formats.gfilesystem.FSRL, uasi: UserAddedSourceInfo) -> None:
        """
    ...
    def setSelectedBatchGroupLoadSpec(self, selectedBatchGroupLoadSpec: BatchGroupLoadSpec) -> None:
        """
...
class BatchSegregatingCriteria(java.lang.Object):
    ...
    * Set of LanguageCompilerSpecs and preferred flags (ie. :obj:`BatchGroupLoadSpec`)
    ...
    def __init__(self, loader: ghidra.app.util.opinion.Loader, loadSpecs: collections.abc.Sequence, provider: ghidra.app.util.bin.ByteProvider) -> None:
        ...
...
class BatchGroupLoadSpec(java.lang.Comparable[BatchGroupLoadSpec]):
    ...
    def __init__(self, loadSpec: ghidra.app.util.opinion.LoadSpec) -> None:
        ...
...
class UserAddedSourceInfo(java.lang.Object):
    ...
    def setContainerCount(self, containerCount: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setFileCount(self, fileCount: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setMaxNestLevel(self, maxNestLevel: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setRawFileCount(self, rawFileCount: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setRecurseTerminatedEarly(self, recurseTerminatedEarly: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class BatchImportDialog(docking.DialogComponentProvider):
    ...
    @staticmethod
    def showAndImport(tool: ghidra.framework.plugintool.PluginTool, batchInfo: BatchInfo, initialFiles: java.util.List[ghidra.formats.gfilesystem.FSRL], defaultFolder: ghidra.framework.model.DomainFolder, programManager: ghidra.app.services.ProgramManager) -> None:
        """
...
class BatchInfo(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, maxDepth: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setMaxDepth(self, newMaxDepth: typing.Union[jpype.JInt, int]) -> None:
        """
...
class BatchImportTableModel(docking.widgets.table.AbstractSortedTableModel[BatchGroup]):
    ...
    def __init__(self, ibi: BatchInfo) -> None:
        ...
...
class BatchProjectDestinationPanel(javax.swing.JPanel):
    ...
    def __init__(self, parent: javax.swing.JComponent, defaultFolder: ghidra.framework.model.DomainFolder) -> None:
        ...

    def getFolder(self) -> ghidra.framework.model.DomainFolder:
        ...

    def onProjectDestinationChange(self, newDomainFolder: ghidra.framework.model.DomainFolder) -> None:
        ...

    def setFolder(self, folder: ghidra.framework.model.DomainFolder) -> None:
        ...
...
__all__ = ["BatchGroup", "BatchSegregatingCriteria", "BatchGroupLoadSpec", "UserAddedSourceInfo", "BatchImportDialog", "BatchInfo", "BatchImportTableModel", "BatchProjectDestinationPanel"]
