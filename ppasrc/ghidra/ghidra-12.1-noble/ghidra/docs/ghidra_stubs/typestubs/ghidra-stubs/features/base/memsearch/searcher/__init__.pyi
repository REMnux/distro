...
class MemoryMatch(java.lang.Comparable[MemoryMatch[T]], typing.Generic[T]):
    """
    ...
    @typing.overload
    def __init__(self, address: ghidra.program.model.address.Address, bytes: jpype.JArray[jpype.JByte], pattern: T) -> None:
        ...
    ...
    def updateBytes(self, newBytes: jpype.JArray[jpype.JByte]) -> None:
        ...
...
class MemorySearcher(java.lang.Object, typing.Generic[T]):
    """
    ...
    @typing.overload
    def __init__(self, byteSource: ghidra.features.base.memsearch.bytesource.AddressableByteSource, matcher: ghidra.features.base.memsearch.matcher.ByteMatcher[T], addresses: ghidra.program.model.address.AddressSetView, searchLimit: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
        
        :param ghidra.features.base.memsearch.bytesource.AddressableByteSource byteSource: the source of the bytes to be searched
        :param ghidra.features.base.memsearch.matcher.ByteMatcher[T] matcher: the matcher that can find matches in a byte sequence
    ...
    @typing.overload
    def __init__(self, byteSource: ghidra.features.base.memsearch.bytesource.AddressableByteSource, matcher: ghidra.features.base.memsearch.matcher.ByteMatcher[T], addresses: ghidra.program.model.address.AddressSetView, searchLimit: typing.Union[jpype.JInt, int], chunkSize: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
    ...
    def findAll(self, accumulator: ghidra.util.datastruct.Accumulator[MemoryMatch[T]], monitor: ghidra.util.task.TaskMonitor) -> bool:
        """
        ...
        :param ghidra.util.datastruct.Accumulator[MemoryMatch[T]] accumulator: the accumulator for found matches
    ...
    def findNext(self, start: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> MemoryMatch[T]:
        """
    ...
    def findOnce(self, start: ghidra.program.model.address.Address, forward: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> MemoryMatch[T]:
        """
    ...
    def findPrevious(self, start: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> MemoryMatch[T]:
        """
    ...
    def setMatchFilter(self, filter: java.util.function.Predicate[MemoryMatch[T]]) -> None:
        """
        ...
        :param java.util.function.Predicate[MemoryMatch[T]] filter: the predicate to use to filter search results
        """


class AlignmentFilter(java.util.function.Predicate[MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]]):
    """
    ...
    def __init__(self, alignment: typing.Union[jpype.JInt, int]) -> None:
        ...


class CodeUnitFilter(java.util.function.Predicate[MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]]):
    """
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, includeInstructions: typing.Union[jpype.JBoolean, bool], includeDefinedData: typing.Union[jpype.JBoolean, bool], includeUndefinedData: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
...
__all__ = ["MemoryMatch", "MemorySearcher", "AlignmentFilter", "CodeUnitFilter"]
