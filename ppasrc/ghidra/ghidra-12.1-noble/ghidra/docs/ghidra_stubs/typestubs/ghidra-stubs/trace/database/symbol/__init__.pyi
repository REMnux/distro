...
class DBTraceEquateSpace(ghidra.trace.database.space.DBTraceSpaceBased, ghidra.trace.model.symbol.TraceEquateSpace):
    ...
    class DBTraceEquateReference(ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree.AbstractDBTraceAddressSnapRangePropertyMapData[DBTraceEquateSpace.DBTraceEquateReference]):
        ...
        def __init__(self, space: DBTraceEquateSpace, tree: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree[DBTraceEquateSpace.DBTraceEquateReference, typing.Any], store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
            ...
    ...
    def __init__(self, manager: DBTraceEquateManager, dbh: db.DBHandle, space: ghidra.program.model.address.AddressSpace, ent: ghidra.trace.database.space.AbstractDBTraceSpaceBasedManager.DBTraceSpaceEntry) -> None:
        ...
...
class DBTraceReferenceSpace(ghidra.trace.database.space.DBTraceSpaceBased, ghidra.trace.model.symbol.TraceReferenceSpace):
    ...
    class DBTraceReferenceEntry(ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree.AbstractDBTraceAddressSnapRangePropertyMapData[DBTraceReferenceSpace.DBTraceReferenceEntry], ghidra.trace.database.address.DBTraceOverlaySpaceAdapter.DecodesAddresses):
        ...
        * 0: Initial version and previous unversioned implementation
        ...
        def __init__(self, space: DBTraceReferenceSpace, tree: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree[DBTraceReferenceSpace.DBTraceReferenceEntry, typing.Any], store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
            ...
        ...
        def setEndSnap(self, endSnap: typing.Union[jpype.JLong, int]) -> None:
            ...

        def setPrimary(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setRefType(self, refType: ghidra.program.model.symbol.RefType) -> None:
            ...

        def setSymbolId(self, symbolId: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    class DBTraceXRefEntry(ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree.AbstractDBTraceAddressSnapRangePropertyMapData[DBTraceReferenceSpace.DBTraceXRefEntry]):
        ...
        def __init__(self, space: DBTraceReferenceSpace, tree: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree[DBTraceReferenceSpace.DBTraceXRefEntry, typing.Any], store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
            ...
    ...
    def __init__(self, manager: DBTraceReferenceManager, dbh: db.DBHandle, space: ghidra.program.model.address.AddressSpace, ent: ghidra.trace.database.space.AbstractDBTraceSpaceBasedManager.DBTraceSpaceEntry) -> None:
        ...
...
class DBTraceSymbolManager(ghidra.trace.model.symbol.TraceSymbolManager, ghidra.trace.database.DBTraceManager):
    ...
    class DBTraceSymbolIDEntry(ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree.AbstractDBTraceAddressSnapRangePropertyMapData[java.lang.Long]):
        ...
        def __init__(self, tree: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree[java.lang.Long, typing.Any], store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
            ...
    ...
    class VariableStorageDBFieldCodec(ghidra.util.database.DBCachedObjectStoreFactory.AbstractDBFieldCodec[ghidra.program.model.listing.VariableStorage, DBTraceSymbolManager.DBTraceVariableStorageEntry, db.StringField]):
        ...
        def __init__(self, objectType: java.lang.Class[DBTraceSymbolManager.DBTraceVariableStorageEntry], field: java.lang.reflect.Field, column: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    class DBTraceVariableStorageEntry(ghidra.util.database.DBAnnotatedObject):
        ...
        def __init__(self, manager: DBTraceSymbolManager, store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
            ...
...
class DBTraceReference(ghidra.trace.model.symbol.TraceReference):
    ...
    def __init__(self, ent: DBTraceReferenceSpace.DBTraceReferenceEntry) -> None:
        ...
...
class DBTraceEquate(ghidra.util.database.DBAnnotatedObject, ghidra.trace.model.symbol.TraceEquate):
    ...
    def __init__(self, manager: DBTraceEquateManager, store: ghidra.util.database.DBCachedObjectStore[DBTraceEquate], record: db.DBRecord) -> None:
        ...
...
class DBTraceLabelSymbolView(AbstractDBTraceSymbolSingleTypeWithLocationView[DBTraceLabelSymbol], ghidra.trace.model.symbol.TraceLabelSymbolView):
    ...
    def __init__(self, manager: DBTraceSymbolManager) -> None:
        ...
...
class AbstractDBTraceSymbolSingleTypeWithLocationView(AbstractDBTraceSymbolSingleTypeView[T], typing.Generic[T]):
    ...
    class GetSymbolsKey(ghidra.trace.database.DBTraceCacheForContainingQueries.GetKey):
        ...
        def __init__(self, thread: ghidra.trace.model.thread.TraceThread, snap: typing.Union[jpype.JLong, int], addr: ghidra.program.model.address.Address, includeDynamic: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def __init__(self, manager: DBTraceSymbolManager, typeID: typing.Union[jpype.JByte, int], store: ghidra.util.database.DBCachedObjectStore[T]) -> None:
        ...
...
class DBTraceSymbolMultipleTypesView(ghidra.trace.model.symbol.TraceSymbolView[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, manager: DBTraceSymbolManager, parts: collections.abc.Sequence) -> None:
        ...

    @typing.overload
    def __init__(self, manager: DBTraceSymbolManager, *parts: AbstractDBTraceSymbolSingleTypeView[T]) -> None:
        ...
...
class DBTraceOffsetReference(DBTraceReference, ghidra.trace.model.symbol.TraceOffsetReference):
    ...
    def __init__(self, ent: DBTraceReferenceSpace.DBTraceReferenceEntry, isExternalBlockReference: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DBTraceSymbolMultipleTypesWithAddressNoDuplicatesView(DBTraceSymbolMultipleTypesWithAddressView[T], ghidra.trace.model.symbol.TraceSymbolWithAddressNoDuplicatesView[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, manager: DBTraceSymbolManager, *parts: AbstractDBTraceSymbolSingleTypeWithAddressView[T]) -> None:
        ...
...
class DBTraceSymbolMultipleTypesWithLocationView(DBTraceSymbolMultipleTypesView[T], ghidra.trace.model.symbol.TraceSymbolWithLocationView[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, manager: DBTraceSymbolManager, *parts: AbstractDBTraceSymbolSingleTypeWithLocationView[T]) -> None:
        ...



__all__ = ["DBTraceEquateManager", "DBTraceEquateSpace", "DBTraceReferenceSpace", "DBTraceReferenceManager", "DBTraceSymbolManager", "DBTraceNamespaceSymbol", "AbstractDBTraceSymbol", "DBTraceReference", "DBTraceEquate", "DBTraceLabelSymbol", "DBTraceClassSymbol", "DBTraceLabelSymbolView", "AbstractDBTraceSymbolSingleTypeWithLocationView", "AbstractDBTraceSymbolSingleTypeView", "DBTraceNamespaceSymbolView", "DBTraceClassSymbolView", "DBTraceSymbolMultipleTypesView", "DBTraceSymbolMultipleTypesNoDuplicatesView", "DBTraceOffsetReference", "DBTraceShiftedReference", "AbstractDBTraceSymbolSingleTypeWithAddressView", "DBTraceSnapSelectedReferenceSpace", "DBTraceStackReference", "DBTraceSymbolMultipleTypesWithAddressNoDuplicatesView", "DBTraceSymbolMultipleTypesWithAddressView", "DBTraceSymbolMultipleTypesWithLocationView"]
