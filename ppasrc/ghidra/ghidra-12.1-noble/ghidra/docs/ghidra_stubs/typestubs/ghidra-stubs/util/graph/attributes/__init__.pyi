...
class AttributeManager(java.lang.Object, typing.Generic[T]):
    ...
    def __init__(self, attributedSet: ghidra.util.graph.KeyIndexableSet[T]) -> None:
        """
        Constructor.
    ...
    def removeAttribute(self, attributeName: typing.Union[java.lang.String, str]) -> None:
        """
...
class IntegerAttribute(Attribute[T], typing.Generic[T]):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], set: ghidra.util.graph.KeyIndexableSet[T]) -> None:
        """
        Constructor.
    ...
    def setValue(self, o: T, value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class LongAttribute(Attribute[T], typing.Generic[T]):
    ...
    def setValue(self, o: ghidra.util.graph.KeyedObject, value: typing.Union[jpype.JLong, int]) -> None:
        """
        Set the value of this attribute for the specified KeyedObject.
...
__all__ = ["AttributeManager", "IntegerAttribute", "Attribute", "ObjectAttribute", "DoubleAttribute", "StringAttribute", "LongAttribute"]
