...
class CliMetadataDirectory(ghidra.app.util.bin.format.pe.DataDirectory, ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, ntHeader: ghidra.app.util.bin.format.pe.NTHeader, reader: ghidra.app.util.bin.BinaryReader) -> None:
        ...
...
class CliMetadataRoot(ghidra.app.util.bin.StructConverter, ghidra.app.util.bin.format.pe.PeMarkupable):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, rva: typing.Union[jpype.JInt, int]) -> None:
        """
...
class CliStreamHeader(ghidra.app.util.bin.StructConverter, ghidra.app.util.bin.format.pe.PeMarkupable):
    ...
    def __init__(self, metadataRoot: CliMetadataRoot, reader: ghidra.app.util.bin.BinaryReader) -> None:
        """
...
__all__ = ["CliRepresentable", "CliMetadataDirectory", "CliMetadataRoot", "CliStreamHeader"]
