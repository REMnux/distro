...
class AbstractTraceDisassembleAction(docking.action.DockingAction):
    ...
    def __init__(self, plugin: DebuggerDisassemblerPlugin, name: typing.Union[java.lang.String, str]) -> None:
        ...
...
class CurrentPlatformTraceDisassembleCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.trace.model.program.TraceProgramView]):
    ...
    class Reqs(java.lang.Record):
        ...
        def __init__(self, mapper: ghidra.debug.api.platform.DebuggerPlatformMapper, thread: ghidra.trace.model.thread.TraceThread, object: ghidra.trace.model.target.TraceObject, view: ghidra.trace.model.program.TraceProgramView) -> None:
            ...
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, set: ghidra.program.model.address.AddressSetView, reqs: CurrentPlatformTraceDisassembleCommand.Reqs, address: ghidra.program.model.address.Address) -> None:
        ...
...
class CurrentPlatformTraceDisassembleAction(docking.action.DockingAction):
    ...
    def __init__(self, plugin: DebuggerDisassemblerPlugin) -> None:
        ...
...
class TracePatchDataAction(ghidra.app.plugin.core.assembler.PatchDataAction):
    ...
    class PatchDataCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.trace.model.program.TraceProgramView]):
        ...
        def __init__(self, encoded: jpype.JArray[jpype.JByte]) -> None:
            ...
...
class DisassemblyInject(ghidra.util.classfinder.ExtensionPoint):
    ...
    def post(self, tool: ghidra.framework.plugintool.PluginTool, platform: ghidra.trace.model.guest.TracePlatform, snap: typing.Union[jpype.JLong, int], disassembled: ghidra.program.model.address.AddressSetView) -> None:
        """
    ...
    def pre(self, tool: ghidra.framework.plugintool.PluginTool, command: TraceDisassembleCommand, platform: ghidra.trace.model.guest.TracePlatform, snap: typing.Union[jpype.JLong, int], thread: ghidra.trace.model.thread.TraceThread, startSet: ghidra.program.model.address.AddressSetView, restricted: ghidra.program.model.address.AddressSetView) -> None:
        """
...
class TraceDisassembleCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.trace.model.program.TraceProgramView]):
    ...
    def __init__(self, platform: ghidra.trace.model.guest.TracePlatform, start: ghidra.program.model.address.Address, restrictedSet: ghidra.program.model.address.AddressSetView) -> None:
        ...

    def getDisassembledAddressSet(self) -> ghidra.program.model.address.AddressSetView:
        ...

    def setInitialContext(self, initialContext: ghidra.program.model.lang.RegisterValue) -> None:
        ...
...
class FixedPlatformTraceDisassembleAction(AbstractTraceDisassembleAction):
    ...
    def __init__(self, plugin: DebuggerDisassemblerPlugin, altLangID: ghidra.program.model.lang.LanguageID, platform: ghidra.trace.model.guest.TracePlatform) -> None:
        ...
...
__all__ = ["AbstractTraceDisassembleAction", "DebuggerDisassemblerPlugin", "CurrentPlatformTraceDisassembleCommand", "CurrentPlatformTraceDisassembleAction", "CurrentPlatformTracePatchInstructionAction", "AbstractTracePatchInstructionAction", "TracePatchDataAction", "DisassemblyInject", "TraceDisassembleCommand", "FixedPlatformTraceDisassembleAction", "FixedPlatformTracePatchInstructionAction"]
