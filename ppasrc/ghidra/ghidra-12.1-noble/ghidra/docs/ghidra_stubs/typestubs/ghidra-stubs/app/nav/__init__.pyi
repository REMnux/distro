...
class Navigatable(java.lang.Object):
    ...
    def addNavigatableListener(self, listener: NavigatableRemovalListener) -> None:
        """
    ...
    def removeNavigatableListener(self, listener: NavigatableRemovalListener) -> None:
        """
    ...
    def setMemento(self, memento: LocationMemento) -> None:
        """
...
class NavigatableRemovalListener(java.lang.Object):
    ...
    def navigatableRemoved(self, navigatable: Navigatable) -> None:
        ...
...
class DecoratorPanel(javax.swing.JPanel):
    ...
    def __init__(self, component: javax.swing.JComponent, isConnected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setConnected(self, isConnected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ListingPanelContainer(javax.swing.JPanel):
    ...
    @typing.overload
    def __init__(self, leftListingPanel: javax.swing.JComponent, isConnected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, leftListingPanel: javax.swing.JComponent, rightListingPanel: javax.swing.JComponent, leftTitle: typing.Union[java.lang.String, str], rightTitle: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def setConnnected(self, isConnected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setNorthPanel(self, comp: javax.swing.JComponent) -> None:
        ...

    def setOrientation(self, isSideBySide: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setOtherPanel(self, rightListingPanel: javax.swing.JComponent, leftTitle: typing.Union[java.lang.String, str], rightTitle: typing.Union[java.lang.String, str]) -> None:
        ...

    def updateTitle(self, newTitle: typing.Union[java.lang.String, str]) -> None:
        ...
...
class NavigatableRegistry(java.lang.Object):
    ...
    @staticmethod
    def registerNavigatable(tool: ghidra.framework.plugintool.PluginTool, navigatable: Navigatable) -> None:
        ...

    @staticmethod
    def unregisterNavigatable(tool: ghidra.framework.plugintool.PluginTool, navigatable: Navigatable) -> None:
        ...
...
class NavigationUtils(java.lang.Object):
    ...
    @staticmethod
    def setSelection(tool: ghidra.framework.plugintool.PluginTool, navigatable: Navigatable, selection: ghidra.program.util.ProgramSelection) -> None:
        ...
...
class NextRangeAction(ghidra.app.context.NavigatableContextAction):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], navOptions: ghidra.app.plugin.core.navigation.NavigationOptions) -> None:
        ...
...
__all__ = ["Navigatable", "LocationMemento", "NavigatableRemovalListener", "DecoratorPanel", "ListingPanelContainer", "NavigatableIconFactory", "NavigatableRegistry", "NavigationUtils", "NextRangeAction", "PreviousRangeAction"]
