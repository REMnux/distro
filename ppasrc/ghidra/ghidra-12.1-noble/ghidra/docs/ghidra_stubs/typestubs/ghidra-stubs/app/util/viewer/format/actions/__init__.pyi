...
class AddAllFieldAction(docking.action.DockingAction):
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], panel: ghidra.app.util.viewer.format.FieldHeader) -> None:
        """
...
class AddFieldAction(docking.action.DockingAction):
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], fieldFactory: ghidra.app.util.viewer.field.FieldFactory, panel: ghidra.app.util.viewer.format.FieldHeader, formatModel: ghidra.app.util.viewer.format.FieldFormatModel) -> None:
        ...
...
class ResetAllFormatsAction(docking.action.DockingAction):
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], formatMgr: ghidra.app.util.viewer.format.FormatManager, panel: ghidra.app.util.viewer.format.FieldHeader) -> None:
        """
        Constructor takes the CodeBrowserPlugin that created it and the header
        component so that it can be repainted when fields are added.
...
__all__ = ["AddAllFieldAction", "AddFieldAction", "AddSpacerFieldAction", "DisableFieldAction", "EnableFieldAction", "InsertRowAction", "RemoveAllFieldsAction", "RemoveFieldAction", "RemoveRowAction", "ResetAllFormatsAction", "ResetFormatAction", "SetSpacerTextAction"]
