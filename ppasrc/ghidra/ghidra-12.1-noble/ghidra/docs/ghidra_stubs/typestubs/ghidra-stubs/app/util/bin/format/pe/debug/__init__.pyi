...
class DebugCOFFSymbol(ghidra.app.util.bin.StructConverter):
    ...
    @typing.overload
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, index: typing.Union[jpype.JInt, int], symbolTable: DebugCOFFSymbolTable) -> None:
        ...

    @typing.overload
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, index: typing.Union[jpype.JInt, int], stringTableIndex: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class DebugCOFFSymbolTable(java.lang.Object):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, coffHeader: DebugCOFFSymbolsHeader, offset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DebugCOFFLineNumber(java.lang.Object):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, index: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DebugDirectory(ghidra.app.util.bin.StructConverter, ghidra.app.util.bin.ByteArrayConverter):
    ...
    def updatePointers(self, offset: typing.Union[jpype.JInt, int], postOffset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DebugDirectoryParser(ghidra.app.util.bin.format.pe.OffsetValidator):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, ptr: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], sizeOfImage: typing.Union[jpype.JLong, int]) -> None:
        """
...
__all__ = ["DebugCOFFSymbol", "DebugCOFFSymbolAux", "DebugCOFFSymbolTable", "DebugCOFFSymbolsHeader", "DebugCOFFLineNumber", "DebugDirectory", "DebugDirectoryParser", "DebugCodeView", "OMFSrcModuleFile", "OMFSrcModuleLine", "DebugFixup", "DebugMisc", "DebugFixupElement", "DebugCodeViewSymbolTable", "OMFDirHeader", "OMFDirEntry", "OMFModule", "OMFGlobal", "OMFSegMap", "OMFSrcModule", "OMFFileIndex", "OMFAlignSym", "OMFLibrary", "OMFSegMapDesc", "DebugSymbol", "OMFSegDesc", "DataSym32", "DataSym32_new", "DebugCodeViewConstants", "DebugSymbolSelector", "PrimitiveTypeListing", "S_ALIGN", "S_BLOCK32", "S_BPREL32_NEW", "S_COMPILE", "S_CONSTANT32", "S_DATAREF", "S_END", "S_GDATA32_NEW", "S_GPROC32_NEW", "S_LABEL32", "S_LDATA32_NEW", "S_OBJNAME", "S_PROCREF", "S_UDT32", "S_UDT32_NEW", "UnknownSymbol"]
