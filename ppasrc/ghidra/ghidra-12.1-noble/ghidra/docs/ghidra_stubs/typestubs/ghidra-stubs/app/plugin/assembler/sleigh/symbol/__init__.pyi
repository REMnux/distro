...
class AssemblyStringTerminal(AssemblyTerminal):
    ...
    def __init__(self, str: typing.Union[java.lang.String, str], defsym: ghidra.app.plugin.processors.sleigh.symbol.VarnodeSymbol) -> None:
        """
...
class AssemblyExtendedNonTerminal(AssemblyNonTerminal):
    ...
    def __init__(self, start: typing.Union[jpype.JInt, int], nt: AssemblyNonTerminal, end: typing.Union[jpype.JInt, int]) -> None:
        """
...
class AssemblyNumericTerminal(AssemblyTerminal):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], bitsize: typing.Union[jpype.JInt, int], space: ghidra.program.model.address.AddressSpace) -> None:
        """
...
class AssemblyNumericMapTerminal(AssemblyNumericTerminal):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], map: collections.abc.Mapping) -> None:
        """
...
class AssemblyStringMapTerminal(AssemblyTerminal):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], map: org.apache.commons.collections4.MultiValuedMap[java.lang.String, java.lang.Integer]) -> None:
        """
        Construct a terminal with the given name, accepting only the keys of a given map
...
__all__ = ["AssemblyNonTerminal", "AssemblySymbol", "AssemblyStringTerminal", "AssemblyTerminal", "AssemblyNumericSymbols", "AssemblyExtendedNonTerminal", "AssemblyEOI", "AssemblyFixedNumericTerminal", "AssemblyNumericTerminal", "AssemblyNumericMapTerminal", "AssemblyStringMapTerminal"]
