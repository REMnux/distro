...
class CliStreamGuid(CliAbstractStream):
    ...
    def __init__(self, header: ghidra.app.util.bin.format.pe.cli.CliStreamHeader, offset: typing.Union[jpype.JLong, int], rva: typing.Union[jpype.JInt, int], reader: ghidra.app.util.bin.BinaryReader) -> None:
        """
...
class CliAbstractStream(ghidra.app.util.bin.StructConverter, ghidra.app.util.bin.format.pe.PeMarkupable):
    ...
    def markup(self, program: ghidra.program.model.listing.Program, isBinary: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor, log: ghidra.app.util.importer.MessageLog, ntHeader: ghidra.app.util.bin.format.pe.NTHeader) -> None:
        """
...
class CliStreamUserStrings(CliStreamBlob):
    ...
    def __init__(self, header: ghidra.app.util.bin.format.pe.cli.CliStreamHeader, fileOffset: typing.Union[jpype.JLong, int], rva: typing.Union[jpype.JInt, int], reader: ghidra.app.util.bin.BinaryReader) -> None:
        """
...
__all__ = ["CliStreamGuid", "CliAbstractStream", "CliStreamUserStrings", "CliStreamBlob", "CliStreamStrings", "CliStreamMetadata"]
