...
class SwiftTypeMetadataStructure(ghidra.app.util.bin.StructConverter):
    ...
    class_: typing.ClassVar[java.lang.Class]
    CATEGORY: typing.Final = "/SwiftTypeMetadata"
    CATEGORY_PATH: typing.Final[ghidra.program.model.data.CategoryPath]

    def __init__(self, base: typing.Union[jpype.JLong, int]) -> None:
        """
        Creates a new :obj:`SwiftTypeMetadataStructure`
        
        :param jpype.JLong or int base: The base "address" of this :obj:`SwiftTypeMetadataStructure`
        """
    ...
    def getTrailingObjects(self) -> java.util.List[SwiftTypeMetadataStructure]:
        """
        :return: a :obj:`List` of :obj:`structures <SwiftTypeMetadataStructure>` that trail this 
        :obj:`structure <SwiftTypeMetadataStructure>`
        :rtype: java.util.List[SwiftTypeMetadataStructure]
        """

    @property
    def trailingObjects(self) -> java.util.List[SwiftTypeMetadataStructure]:
        ...
...
class SwiftUtils(java.lang.Object):
    ...
    PTR_RELATIVE: typing.Final[ghidra.program.model.data.TypeDef]
    """
    A :obj:`pointer <TypeDef>` to a relative 4-byte offset
    """

    PTR_RELATIVE_MASKED: typing.Final[ghidra.program.model.data.TypeDef]
    """
    A :obj:`pointer <TypeDef>` to a relative 4-byte offset (low bit masked off)
    """
    ...
    def isSwift(sectionNames: java.util.List[java.lang.String]) -> bool:
        """
        :return: true if the given :obj:`List` of section names contains a Swift section name;
        otherwise, false
        :rtype: bool
...
__all__ = ["SwiftTypeMetadata", "SwiftTypeMetadataStructure", "SwiftSection", "SwiftUtils"]
