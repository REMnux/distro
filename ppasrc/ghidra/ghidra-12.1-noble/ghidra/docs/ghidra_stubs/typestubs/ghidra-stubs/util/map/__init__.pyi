...
class ValueMap(java.io.Serializable, typing.Generic[T]):
    ...
    def moveRange(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int], newStart: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def saveProperties(self, oos: java.io.ObjectOutputStream, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ValueStoragePageIndex(java.io.Serializable):
    ...
    def add(self, pageID: typing.Union[jpype.JLong, int]) -> None:
        """
...
class IntValueMap(ValueMap[java.lang.Integer]):
    ...
    def putInt(self, index: typing.Union[jpype.JLong, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ObjectStorageAdapter(ghidra.util.ObjectStorage):
    ...
    def __init__(self, table: ghidra.util.datastruct.DataTable, row: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ObjectValueMap(ValueMap[T], typing.Generic[T]):
    ...
    def putObject(self, index: typing.Union[jpype.JLong, int], value: T) -> None:
        """
...
__all__ = ["ValueMap", "ValueStoragePageIndex", "ValueStoragePage", "TypeMismatchException", "IntValueMap", "LongIteratorImpl", "ObjectStorageAdapter", "ObjectValueMap"]
