...
class AlignedObjectBasedPreviewTableModel(ghidra.util.table.AddressBasedTableModel[ROW_TYPE], typing.Generic[ROW_TYPE]):
    ...
    def addAlignmentListener(self, alignmentListener: AddressAlignmentListener) -> None:
        ...

    def getAlignment(self) -> int:
        ...

    def removeAlignmentListener(self, alignmentListener: AddressAlignmentListener) -> None:
        ...
...
__all__ = ["AlignedObjectBasedPreviewTableModel", "AddressAlignmentListener", "TableService", "ProgramLocationPreviewTableModel"]
