...
import org.apache.commons.collections4.collection # type: ignore
...
class LRUMap(java.util.Map[K, V], typing.Generic[K, V]):
    ...
    def __init__(self, cacheSize: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class AbstractWeakValueNavigableMap(AbstractWeakValueMap[K, V], java.util.NavigableMap[K, V], typing.Generic[K, V]):
    ...
    class NavigableView(AbstractWeakValueNavigableMap[K, V], typing.Generic[K, V]):
        ...
        def __init__(self, map: AbstractWeakValueNavigableMap[K, V], sub: java.util.NavigableMap[K, AbstractWeakValueMap.WeakValueRef[K, V]]) -> None:
            ...
...
class AccumulatorSizeException(java.lang.RuntimeException):
    ...
    def __init__(self, maxSize: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class Array(java.lang.Object):
    ...
    def copyDataTo(self, index: typing.Union[jpype.JInt, int], table: DataTable, toIndex: typing.Union[jpype.JInt, int], toCol: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def remove(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DataTable(java.io.Serializable):
    ...
    def copyRowTo(self, row: typing.Union[jpype.JInt, int], table: DataTable, toRow: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def putBoolean(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def putByte(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JByte, int]) -> None:
        """
    ...
    def putByteArray(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def putDouble(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JDouble, float]) -> None:
        """
    ...
    def putDoubleArray(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JDouble]) -> None:
        """
    ...
    def putFloat(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JFloat, float]) -> None:
        """
    ...
    def putFloatArray(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JFloat]) -> None:
        """
    ...
    def putInt(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def putIntArray(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JInt]) -> None:
        """
    ...
    def putLong(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def putLongArray(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JLong]) -> None:
        """
    ...
    def putObject(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: java.lang.Object) -> None:
        """
    ...
    def putShort(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    def putShortArray(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JShort]) -> None:
        """
    ...
    def putString(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def putStringArray(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], value: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    def removeRow(self, row: typing.Union[jpype.JInt, int]) -> None:
        """
...
class BitTree(ShortKeySet, java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, maxKey: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, maxKey: typing.Union[jpype.JShort, int], isFull: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        The BitTree constructor takes the maximum key value. The legal
        keys for this set range from 0 to maxKey.
    ...
    def put(self, key: typing.Union[jpype.JShort, int]) -> None:
        """
...
class BooleanArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ByteArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JByte, int]) -> None:
        """
...
class ByteArrayArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JByte]) -> None:
        """
...
class CallbackAccumulator(Accumulator[T], typing.Generic[T]):
    ...
    def __init__(self, consumer: java.util.function.Consumer[T]) -> None:
        """
        Constructor
...
class Counter(org.apache.commons.lang3.mutable.MutableInt):
    ...
    @typing.overload
    def __init__(self, value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ListenerErrorHandler(java.lang.Object):
    ...
    def handleError(self, listener: java.lang.Object, t: java.lang.Throwable) -> None:
        """
...
class DoubleArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JDouble, float]) -> None:
        """
...
class DoubleArrayArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JDouble]) -> None:
        """
        Puts the given double value in the double array at
        the given index
...
class FilteringAccumulatorWrapper(Accumulator[T], typing.Generic[T]):
    ...
    def __init__(self, accumulator: Accumulator[T], passesFilterPredicate: java.util.function.Predicate[T]) -> None:
        """
        Constructor.
...
class FixedSizeHashMap(java.util.LinkedHashMap[K, V], typing.Generic[K, V]):
    ...
    @typing.overload
    def __init__(self, initialSize: typing.Union[jpype.JInt, int], maxSize: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class Stack(java.lang.Iterable[E], typing.Generic[E]):
    ...
    **Note: This implementation is not synchronized!**
    ...
    @typing.overload
    def __init__(self, initialCapacity: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, stack: Stack[E]) -> None:
        """
        Copy Constructor.
...
class FloatArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JFloat, float]) -> None:
        """
...
class FloatArrayArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JFloat]) -> None:
        """
        Puts the given float value in the float array at
        the given index
...
class FullKeySet(ShortKeySet, java.io.Serializable):
    ...
    def __init__(self, numKeys: typing.Union[jpype.JInt, int]) -> None:
        """
...
class IntArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class IntArrayArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JInt]) -> None:
        """
        Puts the given int value in the int array at
        the given index
...
class IntArrayList(java.io.Serializable, ghidra.util.Saveable):
    ...
    @typing.overload
    def __init__(self, useZeroSize: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, arr: jpype.JArray[jpype.JInt]) -> None:
        """
    ...
    @typing.overload
    def add(self, value: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def add(self, index: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
        Puts the given int value in the int array at
        the given index
    ...
    def removeValue(self, value: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeValueAt(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def set(self, index: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class IntIndexManager(java.io.Serializable):
    ...
    def deallocate(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
...
class IntIntHashtable(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, capacity: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def put(self, key: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class IntListIndexer(java.io.Serializable):
    ...
    def __init__(self, numLists: typing.Union[jpype.JInt, int], capacity: typing.Union[jpype.JInt, int]) -> None:
        """
        The constructor
    ...
    def growCapacity(self, newCapacity: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def growNumLists(self, newListSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def remove(self, listID: typing.Union[jpype.JInt, int], index: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeAll(self, listID: typing.Union[jpype.JInt, int]) -> None:
        """
...
class IntObjectHashtable(java.io.Serializable, typing.Generic[T]):
    ...
    def put(self, key: typing.Union[jpype.JInt, int], value: T) -> None:
        """
        Adds a key/value pair to the hashtable. If the key is already in the table,
        the old value is replaced with the new value.  If the hashtable is already
        full, the hashtable will attempt to approximately double in size
...
class IntSet(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, values: jpype.JArray[jpype.JInt]) -> None:
        """
...
class LRUSet(LRUMap[T, T], java.lang.Iterable[T], typing.Generic[T]):
    ...
    def __init__(self, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def toList(self) -> java.util.List[T]:
        """
...
class ListAccumulator(Accumulator[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, list: java.util.List[T]) -> None:
        ...
...
class ListenerSet(java.lang.Object, typing.Generic[T]):
    ...
    * The insertion order of listeners is not maintained, which means that event notification may
    ...
    def __init__(self, iface: java.lang.Class[T], isWeak: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setErrorHandler(self, errorHandler: ListenerErrorHandler) -> None:
        ...
...
class LongArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JLong, int]) -> None:
        """
...
class LongArrayArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JLong]) -> None:
        """
...
class LongArrayList(java.util.List[java.lang.Long], java.util.RandomAccess):
    ...
    class LongArraySubList(java.util.List[java.lang.Long]):
        ...
        @typing.overload
        def add(self, value: typing.Union[jpype.JLong, int]) -> None:
            ...

        @typing.overload
        def add(self, index: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JLong, int]) -> None:
            ...

        def getIndex(self, value: typing.Union[jpype.JLong, int]) -> int:
            ...

        def set(self, index: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, arr: jpype.JArray[jpype.JLong]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, list: LongArrayList) -> None:
        """
...
class LongArrayListIterator(java.util.ListIterator[java.lang.Long]):
    ...
    def __init__(self, list: java.util.List[java.lang.Long], startIndex: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class LongDoubleHashtable(java.io.Serializable):
    ...
    def put(self, key: typing.Union[jpype.JLong, int], value: typing.Union[jpype.JDouble, float]) -> None:
        """
        Adds a key/value pair to the hashtable. If the key is already in the table,
        the old value is replaced with the new value.  If the hashtable is already
        full, the hashtable will attempt to approximately double in size
...
class LongIntHashtable(java.io.Serializable):
    ...
    def put(self, key: typing.Union[jpype.JLong, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
        Adds a key/value pair to the hashtable. If the key is already in the table,
        the old value is replaced with the new value.  If the hashtable is already
        full, the hashtable will attempt to approximately double in size
...
class LongLongHashtable(java.io.Serializable):
    ...
    def put(self, key: typing.Union[jpype.JLong, int], value: typing.Union[jpype.JLong, int]) -> None:
        """
        Adds a key/value pair to the hashtable. If the key is already in the table,
        the old value is replaced with the new value.  If the hashtable is already
        full, the hashtable will attempt to approximately double in size
...
class LongObjectHashtable(java.io.Serializable, typing.Generic[T]):
    ...
    def put(self, key: typing.Union[jpype.JLong, int], value: T) -> None:
        """
        Adds a key/value pair to the hashtable. If the key is already in the table,
        the old value is replaced with the new value.  If the hashtable is already
        full, the hashtable will attempt to approximately double in size
...
class ObjectArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: java.lang.Object) -> None:
        """
...
class ObjectCache(java.lang.Object, typing.Generic[T]):
    ...
    def put(self, key: typing.Union[jpype.JLong, int], obj: T) -> None:
        """
    ...
    def remove(self, key: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ObjectIntHashtable(java.lang.Object, typing.Generic[T]):
    ...
    def put(self, key: T, value: typing.Union[jpype.JInt, int]) -> None:
        """
        Adds a key/value pair to the hashtable. If the key is already in the table,
        the old value is replaced with the new value.  If the hashtable is already
        full, the hashtable will attempt to approximately double in size
...
class ObjectLongHashtable(java.lang.Object, typing.Generic[T]):
    ...
    def put(self, key: T, value: typing.Union[jpype.JLong, int]) -> None:
        """
        Adds a key/value pair to the hashtable. If the key is already in the table,
        the old value is replaced with the new value.  If the hashtable is already
        full, the hashtable will attempt to approximately double in size
...
class ObjectRangeMap(java.lang.Object, typing.Generic[T]):
    ...
    def clearRange(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setObject(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int], object: T) -> None:
        """
...
class ObjectValueRange(java.lang.Comparable[ObjectValueRange[T]], typing.Generic[T]):
    ...
    def __init__(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int], value: T) -> None:
        """
...
class PriorityQueue(java.lang.Object, typing.Generic[T]):
    ...
    def add(self, obj: T, priority: typing.Union[jpype.JInt, int]) -> None:
        """
...
class PropertySetIndexRangeIterator(IndexRangeIterator):
    ...
    def __init__(self, set: ghidra.util.map.ValueMap, start: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ShortKeyIndexer(java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, capacity: typing.Union[jpype.JShort, int]) -> None:
        """
...
class ShortListIndexer(java.io.Serializable):
    ...
    def __init__(self, numLists: typing.Union[jpype.JShort, int], capacity: typing.Union[jpype.JShort, int]) -> None:
        """
        The constructor
    ...
    def growCapacity(self, newCapacity: typing.Union[jpype.JShort, int]) -> None:
        """
        Increases the index resource pool.
    ...
    def growNumLists(self, newListSize: typing.Union[jpype.JShort, int]) -> None:
        """
        Increases the number of managed linked lists.
    ...
    def remove(self, listID: typing.Union[jpype.JShort, int], index: typing.Union[jpype.JShort, int]) -> None:
        """
        Remove the index resource from the linked list indexed by listID.
    ...
    def removeAll(self, listID: typing.Union[jpype.JShort, int]) -> None:
        """
        Removes all indexes from the specified list.
...
class RedBlackLongKeySet(java.io.Serializable):
    ...
    def put(self, key: typing.Union[jpype.JLong, int]) -> None:
        """
...
class RangeMap(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, defaultValue: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def paintRange(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ValueRange(java.lang.Comparable[ValueRange]):
    ...
    def __init__(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor for numeric range with an associated value.
...
class RedBlackKeySet(ShortKeySet, java.io.Serializable):
    ...
    def __init__(self, n: typing.Union[jpype.JShort, int]) -> None:
        """
...
class RedBlackTree(java.lang.Iterable[RedBlackEntry[K, V]], typing.Generic[K, V]):
    ...
    def deleteEntry(self, p: RedBlackEntry[K, V]) -> None:
        """
    ...
    def removeNode(self, node: RedBlackEntry[K, V]) -> None:
        ...
...
class SetAccumulator(Accumulator[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, set: java.util.Set[T]) -> None:
        ...
...
class ShortArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JShort, int]) -> None:
        """
...
class ShortArrayArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: jpype.JArray[jpype.JShort]) -> None:
        """
...
class ShortLongHashtable(java.io.Serializable):
    ...
    def put(self, key: typing.Union[jpype.JShort, int], value: typing.Union[jpype.JLong, int]) -> None:
        """
        Adds a key/value pair to the hashtable. If the key is already in the table,
        the old value is replaced with the new value.  If the hashtable is already
        full, the hashtable will attempt to approximately double in size
...
class ShortObjectHashtable(java.io.Serializable):
    ...
    def put(self, key: typing.Union[jpype.JShort, int], value: java.lang.Object) -> None:
        """
        Adds a key/value pair to the hashtable. If the key is already in the table,
        the old value is replaced with the new value.  If the hashtable is already
        full, the hashtable will attempt to approximately double in size
...
class ShortStringHashtable(java.io.Serializable):
    ...
    def put(self, key: typing.Union[jpype.JShort, int], value: typing.Union[java.lang.String, str]) -> None:
        """
        Adds a key/value pair to the hashtable. If the key is already in the table,
        the old value is replaced with the new value.  If the hashtable is already
        full, the hashtable will attempt to approximately double in size
...
class SizeLimitedAccumulatorWrapper(Accumulator[T], typing.Generic[T]):
    ...
    def __init__(self, accumulator: Accumulator[T], maxSize: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor.
...
class SortedRangeList(java.lang.Iterable[Range]):
    ...
    @typing.overload
    def __init__(self, list: SortedRangeList) -> None:
        """
    ...
    def addRange(self, min: typing.Union[jpype.JInt, int], max: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def remove(self, other: SortedRangeList) -> None:
        """
    ...
    def removeRange(self, min: typing.Union[jpype.JInt, int], max: typing.Union[jpype.JInt, int]) -> None:
        """
...
class StringArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: typing.Union[java.lang.String, str]) -> None:
        """
...
class StringArrayArray(Array, java.io.Serializable):
    ...
    def put(self, index: typing.Union[jpype.JInt, int], value: jpype.JArray[java.lang.String]) -> None:
        """
...
class StringIntHashtable(java.io.Serializable):
    ...
    def put(self, key: typing.Union[java.lang.String, str], value: typing.Union[jpype.JInt, int]) -> None:
        """
        Adds a key/value pair to the hashtable. If the key is already in the table,
        the old value is replaced with the new value.  If the hashtable is already
        full, the hashtable will attempt to approximately double in size
...
class WeakStore(java.lang.Object, typing.Generic[T]):
    ...
    class Link(java.lang.ref.WeakReference[T], typing.Generic[T]):
        ...
        def __init__(self, previous: WeakStore.Link[T], value: T, next: WeakStore.Link[T], refQueue: java.lang.ref.ReferenceQueue[T]) -> None:
            ...
...
class WeakValueHashMap(AbstractWeakValueMap[K, V], typing.Generic[K, V]):
    ...
    @typing.overload
    def __init__(self, initialSize: typing.Union[jpype.JInt, int]) -> None:
        """
...
class WeakValueTreeMap(AbstractWeakValueNavigableMap[K, V], typing.Generic[K, V]):
    ...
    @typing.overload
    def __init__(self, comparator: java.util.Comparator[K]) -> None:
        """
...
class Duo(java.lang.Object, typing.Generic[T]):
    ...
    def each(self, c: java.util.function.Consumer[T]) -> None:
        """
...
class CollectionChangeListener(java.lang.Object, typing.Generic[E]):

    class_: typing.ClassVar[java.lang.Class]

    def elementAdded(self, element: E) -> None:
        ...

    def elementModified(self, element: E) -> None:
        ...

    def elementRemoved(self, element: E) -> None:
        ...

    @staticmethod
    def of(cls: java.lang.Class[E]) -> java.lang.Class[CollectionChangeListener[E]]:
        ...


class DefaultObservableCollection(org.apache.commons.collections4.collection.AbstractCollectionDecorator[E], ObservableCollection[E, L], typing.Generic[E, L]):

    @typing.type_check_only
    class Change(java.lang.Enum[DefaultObservableCollection.Change]):

        class_: typing.ClassVar[java.lang.Class]
        ADDED: typing.Final[DefaultObservableCollection.Change]
        REMOVED: typing.Final[DefaultObservableCollection.Change]
        MODIFIED: typing.Final[DefaultObservableCollection.Change]

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> DefaultObservableCollection.Change:
            ...

        @staticmethod
        def values() -> jpype.JArray[DefaultObservableCollection.Change]:
            ...


    @typing.type_check_only
    class ChangeSet(CollectionChangeListener[E]):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class DefaultChangeAggregator(ObservableCollection.ChangeAggregator):
...
class ObservableCollection(java.util.Collection[E], typing.Generic[E, L]):

    class ChangeAggregator(java.lang.AutoCloseable):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    def addChangeListener(self, listener: L) -> None:
        ...

    def aggregateChanges(self) -> ObservableCollection.ChangeAggregator:
        ...

    def notifyModified(self, element: E) -> None:
        ...

    def removeChangeListener(self, listener: L) -> None:
        ...


class PrivatelyQueuedListener(java.lang.Object, typing.Generic[P]):
    """
    ...
    class ListenerHandler(java.lang.reflect.InvocationHandler):
        ...
        def __init__(self, iface: java.lang.Class[P]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, iface: java.lang.Class[P], executor: java.util.concurrent.Executor, out: P) -> None:
        """
        Create a new privately-queued listener which will invoke the given "output" listener
        
         
        
        Invoking the listener methods of :obj:`.in` will cause that invocation to be queued and
        eventually delivered to the given output listener. Note, as a result, it is assumed all
        listener methods return type ``void``, since returning a value would require waiting on
        the invocation to complete, which defeats the purpose of the private queue. The invocations
        on :obj:`.in` will always return ``null``, which will cause an exception if the return
        type is a different primitive.
        
        :param java.lang.Class[P] iface: the interface of the listener
        :param java.util.concurrent.Executor executor: the executor representing the processing queue
        :param P out: the listener to receive the queued invocations
        """

    @typing.overload
    def __init__(self, iface: java.lang.Class[P], threadNamePattern: typing.Union[java.lang.String, str], out: P) -> None:
        """
        Create a new single-threaded privately-queued listener
        
        :param java.lang.Class[P] iface: the interface of the listener
        :param java.lang.String or str threadNamePattern: a pattern for naming the single thread
        :param P out: the listener to receive the queued invocations
        """
...
__all__ = ["LRUMap", "WeakSet", "AbstractWeakValueMap", "AbstractWeakValueNavigableMap", "Accumulator", "AccumulatorSizeException", "Array", "DataTable", "BitTree", "ShortKeySet", "BooleanArray", "ByteArray", "ByteArrayArray", "CallbackAccumulator", "CaseInsensitiveDuplicateStringComparator", "CopyOnReadWeakSet", "CopyOnWriteWeakSet", "Counter", "DataStructureErrorHandlerFactory", "ListenerErrorHandlerFactory", "ListenerErrorHandler", "DoubleArray", "DoubleArrayArray", "FilteringAccumulatorWrapper", "FixedSizeHashMap", "FixedSizeStack", "Stack", "FloatArray", "FloatArrayArray", "FullKeySet", "IndexRange", "IndexRangeIterator", "IntArray", "IntArrayArray", "IntArrayList", "IntIndexManager", "IntIntHashtable", "IntKeyIndexer", "IntListIndexer", "IntObjectHashtable", "IntSet", "LRUSet", "ListAccumulator", "ListenerSet", "ThreadSafeListenerStorage", "LongArray", "LongArrayArray", "LongArrayList", "LongArrayListIterator", "LongComparator", "LongDoubleHashtable", "LongKeyIndexer", "LongIntHashtable", "LongLongHashtable", "LongObjectHashtable", "ManagedDataTable", "NoSuchIndexException", "ObjectArray", "ObjectCache", "ObjectIntHashtable", "ObjectKeyIndexer", "ObjectLongHashtable", "ObjectRangeMap", "ObjectValueRange", "Prime", "PriorityQueue", "PropertySetIndexRangeIterator", "ShortKeyIndexer", "ShortListIndexer", "RedBlackLongKeySet", "QueueStub", "RangeMap", "ValueRange", "RedBlackEntry", "RedBlackKeySet", "RedBlackTree", "SetAccumulator", "ShortArray", "ShortArrayArray", "ShortLongHashtable", "ShortObjectHashtable", "ShortStringHashtable", "SizeLimitedAccumulatorWrapper", "SizeRestrictedAccumulatorWrapper", "SoftCacheMap", "SortedRangeList", "StringArray", "StringArrayArray", "StringIntHashtable", "StringKeyIndexer", "SynchronizedListAccumulator", "ThreadUnsafeWeakSet", "WeakDataStructureFactory", "WeakStore", "WeakValueHashMap", "WeakValueTreeMap", "Duo", "Range", "CollectionChangeListener", "DefaultObservableCollection", "ObservableCollection", "PrivatelyQueuedListener"]
