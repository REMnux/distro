...
class AbstractPatchAction(docking.action.DockingAction):
    ...
    def __init__(self, owner: ghidra.framework.plugintool.Plugin, name: typing.Union[java.lang.String, str]) -> None:
        """
...
class AssemblyDualTextField(java.lang.Object):
    ...
    class AssemblyCompletion(java.lang.Comparable[AssemblyDualTextField.AssemblyCompletion]):
        ...
        def __init__(self, text: typing.Union[java.lang.String, str], display: typing.Union[java.lang.String, str], color: java.awt.Color, order: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    class AssemblySuggestion(AssemblyDualTextField.AssemblyCompletion):
        ...
        def __init__(self, text: typing.Union[java.lang.String, str], display: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class ContextChanges(ghidra.program.model.lang.DisassemblerContextAdapter):
        ...
        def __init__(self, contextIn: ghidra.program.model.lang.RegisterValue) -> None:
            ...

        def addFlow(self, progCtx: ghidra.program.model.listing.ProgramContext, after: ghidra.program.model.address.Address) -> None:
            ...
    ...
    class AssemblyError(AssemblyDualTextField.AssemblyCompletion):
        ...
        **NOTE:** not used until error descriptions improve
        ...
        def __init__(self, text: typing.Union[java.lang.String, str], desc: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class AssemblyAutocompleter(docking.widgets.autocomplete.TextFieldAutocompleter[AssemblyDualTextField.AssemblyCompletion], docking.widgets.autocomplete.AutocompletionListener[AssemblyDualTextField.AssemblyCompletion]):
        ...
        def __init__(self, model: docking.widgets.autocomplete.AutocompletionModel[AssemblyDualTextField.AssemblyCompletion]) -> None:
            ...
    ...
    def addKeyListener(self, listener: java.awt.event.KeyListener) -> None:
        """
    ...
    def getExhaustButton(self) -> javax.swing.JButton:
        """
    ...
    def setAssembler(self, assembler: ghidra.app.plugin.assembler.Assembler) -> None:
        """
    ...
    def setExisting(self, existing: ghidra.program.model.listing.Instruction) -> None:
        """
    ...
    def setVisible(self, visibility: AssemblyDualTextField.VisibilityMode) -> None:
        """
    ...
    @property
    def exhaustButton(self) -> javax.swing.JButton:
        ...
...
class PatchInstructionAction(AbstractPatchAction):
    ...
    def accept(self, ins: AssemblyDualTextField.AssemblyInstruction) -> None:
        """
...
__all__ = ["AbstractPatchAction", "AssemblerPlugin", "AssemblyDualTextField", "PatchInstructionAction", "PatchDataAction"]
