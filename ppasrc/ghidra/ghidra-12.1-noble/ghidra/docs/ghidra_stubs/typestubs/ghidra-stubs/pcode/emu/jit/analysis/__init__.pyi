...
class JitControlFlowModel(java.lang.Object):
    ...
    **NOTE:** It is technically possible for a userop to branch, but this analysis does not
    ...
    class BlockFlow(java.lang.Record):
        ...
        def __init__(self, from_: JitControlFlowModel.JitBlock, to: JitControlFlowModel.JitBlock, branch: ghidra.pcode.emu.jit.JitPassage.IntBranch) -> None:
            ...
    ...
    class JitBlock(ghidra.pcode.exec_.PcodeProgram):
        ...
        def __init__(self, program: ghidra.pcode.exec_.PcodeProgram, code: java.util.List[ghidra.program.model.pcode.PcodeOp]) -> None:
            """
    ...
    class BlockSplitter(java.lang.Object):
        ...
        def __init__(self, program: ghidra.pcode.exec_.PcodeProgram) -> None:
            """
        ...
        def addBranches(self, branches: collections.abc.Sequence) -> None:
            """
    ...
    def __init__(self, context: JitAnalysisContext) -> None:
        """
...
class JitType(java.lang.Object):
    ...
    class LeggedJitType(JitType, typing.Generic[T, LT]):
        """
        ...
        def castLegsLE(self, opnd: ghidra.pcode.emu.jit.gen.opnd.Opnd[JitType.LeggedJitType[typing.Any, typing.Any]]) -> java.util.List[ghidra.pcode.emu.jit.gen.opnd.SimpleOpnd[T, LT]]:
            """
            Cast the given operand's legs as having this type's leg type.
             
            
            This is (sadly) necessary because of the loss of type information in :obj:`Opnd` when it
            has a legged type.
            
            :param ghidra.pcode.emu.jit.gen.opnd.Opnd[JitType.LeggedJitType[typing.Any, typing.Any]] opnd: the operand whose legs to cast
            :return: the legs in little-endian order.
            :rtype: java.util.List[ghidra.pcode.emu.jit.gen.opnd.SimpleOpnd[T, LT]]
            """


    class SimpleJitType(JitType.LeggedJitType[T, JT], typing.Generic[T, JT]):
        """
        ...
        def asInt(self) -> JitType.SimpleJitType[typing.Any, typing.Any]:
            """
            ...
            :rtype: JitType.SimpleJitType[typing.Any, typing.Any]
            """
        ...
        @staticmethod
        def forJavaType(cls: java.lang.Class[typing.Any]) -> JT:
            """
    ...
    class IntJitType(java.lang.Record, JitType.SimpleJitType[ghidra.pcode.emu.jit.gen.util.Types.TInt, JitType.IntJitType]):
        """
    ...
    class LongJitType(java.lang.Record, JitType.SimpleJitType[ghidra.pcode.emu.jit.gen.util.Types.TLong, JitType.LongJitType]):
        """
        ...
        I1: typing.Final[JitType.LongJitType]
        I2: typing.Final[JitType.LongJitType]
        I3: typing.Final[JitType.LongJitType]
        I4: typing.Final[JitType.LongJitType]
    ...
    class FloatJitType(java.lang.Enum[JitType.FloatJitType], JitType.SimpleJitType[ghidra.pcode.emu.jit.gen.util.Types.TFloat, JitType.FloatJitType]):
        """
    ...
    class DoubleJitType(java.lang.Enum[JitType.DoubleJitType], JitType.SimpleJitType[ghidra.pcode.emu.jit.gen.util.Types.TDouble, JitType.DoubleJitType]):
        """
    ...
    class MpIntJitType(java.lang.Record, JitType.LeggedJitType[ghidra.pcode.emu.jit.gen.util.Types.TInt, JitType.IntJitType]):
        """
        ...
        def __init__(self, size: typing.Union[jpype.JInt, int], legTypesBE: java.util.List[JitType.IntJitType], legTypesLE: java.util.List[JitType.IntJitType]) -> None:
            ...
        ...
        def legTypesBE(self) -> java.util.List[JitType.IntJitType]:
            ...

        def legTypesLE(self) -> java.util.List[JitType.IntJitType]:
            ...
    ...
    class MpFloatJitType(java.lang.Record, JitType.LeggedJitType[ghidra.pcode.emu.jit.gen.util.Types.TInt, JitType.IntJitType]):
        """
    ...
    def legTypesBE(self) -> java.util.List[JitType.SimpleJitType[typing.Any, typing.Any]]:
        """
        Get the p-code type that describes the part of the variable in each leg
         
         
        
        Each whole leg will have the type :obj:`IntJitType.I4`, and the partial leg, if applicable,
        will have its appropriate smaller integer type.
        
        :return: the list of types, each fitting in a JVM int, in big-endian order.
        :rtype: java.util.List[JitType.SimpleJitType[typing.Any, typing.Any]]
        """

    def legTypesLE(self) -> java.util.List[JitType.SimpleJitType[typing.Any, typing.Any]]:
        """
        Get the p-code type that describes the part of the variable in each leg
    ...
    @staticmethod
    def unify(a: JitType, b: JitType) -> JitType:
        """
        ...
        :param JitType a: the first type
        :param JitType b: the second type
        :return: the uniform type
        :rtype: JitType
        """

    @staticmethod
    def unifyLeast(a: JitType, b: JitType) -> JitType:
        """
        Similar to :meth:`unify(JitType, JitType) <.unify>`, except that it takes the lesser size.
...
class JitAnalysisContext(java.lang.Object):
    ...
    def __init__(self, config: ghidra.pcode.emu.jit.JitConfiguration, passage: ghidra.pcode.emu.jit.JitPassage) -> None:
        """
...
class JitDataFlowModel(java.lang.Object):
    ...
    ********************
    ...
    class GraphvizExporter(JitOpUpwardVisitor):
        ...
        def __init__(self, outFile: jpype.protocol.SupportsPath) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, context: JitAnalysisContext, cfm: JitControlFlowModel) -> None:
        """
    ...
    def exportGraphviz(self, file: jpype.protocol.SupportsPath) -> None:
        """
...
class JitVarScopeModel(java.lang.Object):
    ...
    class ScopeInfo(java.lang.Object):
        ...
        def __init__(self, block: JitControlFlowModel.JitBlock) -> None:
            """
    ...
    def __init__(self, cfm: JitControlFlowModel, dfm: JitDataFlowModel) -> None:
        """
        Construct the model
...
class JitTypeModel(java.lang.Object):
    ...
    ***************************
    ...
    ``double``. **TODO**: The JIT translator does not currently support floating-point types
    ...
    **TODO**: Prove that this algorithm always terminates.
    ...
    class Contest(java.lang.Record):
        ...
        def vote(self, candidate: JitTypeBehavior) -> None:
            """
    ...
    def __init__(self, dfm: JitDataFlowModel) -> None:
        """
...
class JitAllocationModel(java.lang.Object):
    ...
    ****************
    ...
    class TypeContest(java.lang.Record):
        ...
        def vote(self, type: JitType) -> None:
            """
    ...
    def __init__(self, context: JitAnalysisContext, dfm: JitDataFlowModel, vsm: JitVarScopeModel, tm: JitTypeModel) -> None:
        """
    ...
    def allLocals(self) -> java.util.Collection[ghidra.pcode.emu.jit.alloc.JvmLocal[typing.Any, typing.Any]]:
        """
        Get all of the locals allocated
        
        :return: the locals
        :rtype: java.util.Collection[ghidra.pcode.emu.jit.alloc.JvmLocal[typing.Any, typing.Any]]
        """

    def allocate(self, scope: ghidra.pcode.emu.jit.gen.util.Scope) -> None:
        """
        Perform the actual allocations
        
        :param ghidra.pcode.emu.jit.gen.util.Scope scope: the (probably root) scope for declaring the locals
        """

    def getHandler(self, v: ghidra.pcode.emu.jit.var.JitVal) -> ghidra.pcode.emu.jit.alloc.VarHandler:
        """
    ...
    def localsForVn(self, vn: ghidra.program.model.pcode.Varnode) -> java.util.Collection[ghidra.pcode.emu.jit.alloc.JvmLocal[typing.Any, typing.Any]]:
        """
    ...
    @property
    def handler(self) -> ghidra.pcode.emu.jit.alloc.VarHandler:
        ...
...
class JitDataFlowState(ghidra.pcode.exec_.PcodeExecutorState[ghidra.pcode.emu.jit.var.JitVal]):
    ...
    class MiniDFState(java.lang.Object):
        ...
        def set(self, varnode: ghidra.program.model.pcode.Varnode, val: ghidra.pcode.emu.jit.var.JitVal) -> None:
            """
...
class JitOpUseModel(java.lang.Object):
    ...
    * Errors - e.g., :obj:`unimplemented <JitUnimplementedOp>`, :obj:`missing userop <JitCallOtherMissingOp>`.
    ...
    def __init__(self, context: JitAnalysisContext, cfm: JitControlFlowModel, dfm: JitDataFlowModel, vsm: JitVarScopeModel) -> None:
        """
...
class JitDataFlowArithmetic(ghidra.pcode.exec_.PcodeArithmetic[ghidra.pcode.emu.jit.var.JitVal]):
    ...
    def __init__(self, context: JitAnalysisContext, dfm: JitDataFlowModel) -> None:
        """
    ...
    @staticmethod
    def subPieceVn(endian: ghidra.program.model.lang.Endian, whole: ghidra.program.model.pcode.Varnode, offset: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int]) -> ghidra.program.model.pcode.Varnode:
        """
        Compute the varnode representing a :obj:`subpiece <JitSubPieceOp>` of the given varnode
        
        :param ghidra.program.model.lang.Endian endian: the endianness of the emulation target
        :param ghidra.program.model.pcode.Varnode whole: the whole varnode
        :param jpype.JInt or int offset: the number of least-significant bytes to remove
        :param jpype.JInt or int size: the size of the subpiece (maximum, since truncation may occur)
        :return: the resulting subpiece.
        :rtype: ghidra.program.model.pcode.Varnode
        """

    def subpiece(self, v: ghidra.pcode.emu.jit.var.JitVal, offset: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int]) -> ghidra.pcode.emu.jit.var.JitVal:
        """
    ...
    def truncVnFromLeft(self, vn: ghidra.program.model.pcode.Varnode, amt: typing.Union[jpype.JInt, int]) -> ghidra.program.model.pcode.Varnode:
        """
    ...
    def truncVnFromRight(self, vn: ghidra.program.model.pcode.Varnode, amt: typing.Union[jpype.JInt, int]) -> ghidra.program.model.pcode.Varnode:
        """
...
class JitDataFlowUseropLibrary(ghidra.pcode.exec_.PcodeUseropLibrary[ghidra.pcode.emu.jit.var.JitVal]):
    ...
    * Direct: The direct invocation of the userop's defining Java method in the generated
    ...
    class WrappedUseropDefinition(ghidra.pcode.exec_.PcodeUseropLibrary.PcodeUseropDefinition[ghidra.pcode.emu.jit.var.JitVal]):
        ...
        def __init__(self, decOp: ghidra.pcode.exec_.PcodeUseropLibrary.PcodeUseropDefinition[java.lang.Object]) -> None:
            ...
...
class JitOpVisitor(java.lang.Object):
    ...
    def visitBinOp(self, binOp: ghidra.pcode.emu.jit.op.JitBinOp) -> None:
        """
    ...
    def visitBranchIndOp(self, branchIndOp: ghidra.pcode.emu.jit.op.JitBranchIndOp) -> None:
        """
    ...
    def visitBranchOp(self, branchOp: ghidra.pcode.emu.jit.op.JitBranchOp) -> None:
        """
    ...
    def visitCBranchOp(self, cBranchOp: ghidra.pcode.emu.jit.op.JitCBranchOp) -> None:
        """
    ...
    def visitCallOtherDefOp(self, otherOp: ghidra.pcode.emu.jit.op.JitCallOtherDefOp) -> None:
        """
    ...
    def visitCallOtherMissingOp(self, otherOp: ghidra.pcode.emu.jit.op.JitCallOtherMissingOp) -> None:
        """
    ...
    def visitCallOtherOp(self, otherOp: ghidra.pcode.emu.jit.op.JitCallOtherOp) -> None:
        """
    ...
    def visitCatenateOp(self, catOp: ghidra.pcode.emu.jit.op.JitCatenateOp) -> None:
        """
    ...
    def visitConstVal(self, constVal: ghidra.pcode.emu.jit.var.JitConstVal) -> None:
        """
    ...
    def visitDirectMemoryVar(self, dirMemVar: ghidra.pcode.emu.jit.var.JitDirectMemoryVar) -> None:
        """
    ...
    def visitFailVal(self, failVal: ghidra.pcode.emu.jit.var.JitFailVal) -> None:
        """
    ...
    def visitIndirectMemoryVar(self, indMemVar: ghidra.pcode.emu.jit.var.JitIndirectMemoryVar) -> None:
        """
    ...
    def visitInputVar(self, inputVar: ghidra.pcode.emu.jit.var.JitInputVar) -> None:
        """
    ...
    def visitLoadOp(self, loadOp: ghidra.pcode.emu.jit.op.JitLoadOp) -> None:
        """
    ...
    def visitMissingVar(self, missingVar: ghidra.pcode.emu.jit.var.JitMissingVar) -> None:
        """
    ...
    def visitNopOp(self, nopOp: ghidra.pcode.emu.jit.op.JitNopOp) -> None:
        """
    ...
    def visitOp(self, op: ghidra.pcode.emu.jit.op.JitOp) -> None:
        """
        Visit an op node
    ...
    def visitOutVar(self, outVar: ghidra.pcode.emu.jit.var.JitOutVar) -> None:
        """
    ...
    def visitPhiOp(self, phiOp: ghidra.pcode.emu.jit.op.JitPhiOp) -> None:
        """
    ...
    def visitStoreOp(self, storeOp: ghidra.pcode.emu.jit.op.JitStoreOp) -> None:
        """
    ...
    def visitSubPieceOp(self, pieceOp: ghidra.pcode.emu.jit.op.JitSynthSubPieceOp) -> None:
        """
    ...
    def visitUnOp(self, unOp: ghidra.pcode.emu.jit.op.JitUnOp) -> None:
        """
        Visit a :obj:`JitUnOp`
    ...
    def visitUnimplementedOp(self, unimplOp: ghidra.pcode.emu.jit.op.JitUnimplementedOp) -> None:
        """
    ...
    def visitVal(self, v: ghidra.pcode.emu.jit.var.JitVal) -> None:
        """
        Visit a :obj:`JitVal`
    ...
    def visitVar(self, v: ghidra.pcode.emu.jit.var.JitVar) -> None:
        """
        Visit a :obj:`JitVar`
...
__all__ = ["JitControlFlowModel", "JitType", "JitAnalysisContext", "JitDataFlowModel", "JitVarScopeModel", "JitTypeModel", "JitAllocationModel", "JitDataFlowState", "JitOpUseModel", "JitTypeBehavior", "JitDataFlowArithmetic", "JitDataFlowUseropLibrary", "JitDataFlowBlockAnalyzer", "JitDataFlowExecutor", "JitOpUpwardVisitor", "JitOpVisitor"]
