...
class DefaultMemoryMapper(MemoryMapper):
    ...
    def __init__(self, id: ghidra.program.model.lang.LanguageID) -> None:
        ...
...
class ProtobufSocket(java.lang.Object, typing.Generic[T]):
    ...
    def __init__(self, channel: java.nio.channels.SocketChannel, decoder: ProtobufSocket.Decoder[T]) -> None:
        ...
...
class RmiClient(java.lang.Object):
    ...
    class RequestResult(java.util.concurrent.CompletableFuture[java.lang.Object]):
        ...
        def __init__(self, req: ghidra.rmi.trace.TraceRmi.RootMessage) -> None:
            ...
    ...
    def __init__(self, channel: java.nio.channels.SocketChannel, description: typing.Union[java.lang.String, str]) -> None:
        ...

    def activate(self, traceId: typing.Union[jpype.JInt, int], path: typing.Union[java.lang.String, str]) -> None:
        ...

    def close(self) -> None:
        ...

    def closeTrace(self, id: typing.Union[jpype.JInt, int]) -> None:
        ...

    def createOverlaySpace(self, traceId: typing.Union[jpype.JInt, int], base: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
        ...

    def createRootObject(self, traceId: typing.Union[jpype.JInt, int], schemContext: ghidra.trace.model.target.schema.SchemaContext, schema: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def deleteBytes(self, traceId: typing.Union[jpype.JInt, int], snap: typing.Union[jpype.JLong, int], range: ghidra.program.model.address.AddressRange) -> None:
        ...

    def deleteRegisters(self, traceId: typing.Union[jpype.JInt, int], snap: typing.Union[jpype.JLong, int], ppath: typing.Union[java.lang.String, str], names: jpype.JArray[java.lang.String]) -> None:
        ...

    def disassemble(self, traceId: typing.Union[jpype.JInt, int], snap: typing.Union[jpype.JLong, int], start: ghidra.program.model.address.Address) -> None:
        ...

    def endTx(self, traceId: typing.Union[jpype.JInt, int], txId: typing.Union[jpype.JInt, int], abort: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def getObject(self, traceId: typing.Union[jpype.JInt, int], path: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    @typing.overload
    def insertObject(self, traceId: typing.Union[jpype.JInt, int], path: typing.Union[java.lang.String, str], span: ghidra.trace.model.Lifespan, r: ghidra.rmi.trace.TraceRmi.Resolution) -> None:
        ...

    @typing.overload
    def insertObject(self, traceId: typing.Union[jpype.JInt, int], id: typing.Union[jpype.JLong, int], span: ghidra.trace.model.Lifespan, r: ghidra.rmi.trace.TraceRmi.Resolution) -> None:
        ...
    ...
    def negotiate(self, desc: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def putBytes(self, traceId: typing.Union[jpype.JInt, int], snap: typing.Union[jpype.JLong, int], start: ghidra.program.model.address.Address, data: jpype.JArray[jpype.JByte]) -> None:
        ...

    def putRegisters(self, traceId: typing.Union[jpype.JInt, int], snap: typing.Union[jpype.JLong, int], ppath: typing.Union[java.lang.String, str], values: jpype.JArray[ghidra.program.model.lang.RegisterValue]) -> None:
        ...

    @typing.overload
    def removeObject(self, traceId: typing.Union[jpype.JInt, int], path: typing.Union[java.lang.String, str], span: ghidra.trace.model.Lifespan, tree: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def removeObject(self, traceId: typing.Union[jpype.JInt, int], id: typing.Union[jpype.JLong, int], span: ghidra.trace.model.Lifespan, tree: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def retainValues(self, traceId: typing.Union[jpype.JInt, int], ppath: typing.Union[java.lang.String, str], span: ghidra.trace.model.Lifespan, kinds: ghidra.rmi.trace.TraceRmi.ValueKinds, keys: java.util.Set[java.lang.String]) -> None:
        ...

    def saveTrace(self, id: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setMemoryState(self, traceId: typing.Union[jpype.JInt, int], snap: typing.Union[jpype.JLong, int], range: ghidra.program.model.address.AddressRange, state: ghidra.rmi.trace.TraceRmi.MemoryState) -> None:
        ...

    def setRegistry(self, methodRegistry: RmiMethodRegistry) -> None:
        ...

    def setValue(self, traceId: typing.Union[jpype.JInt, int], ppath: typing.Union[java.lang.String, str], span: ghidra.trace.model.Lifespan, key: typing.Union[java.lang.String, str], value: java.lang.Object, resolution: typing.Union[java.lang.String, str]) -> None:
        ...

    def snapshot(self, traceId: typing.Union[jpype.JInt, int], desc: typing.Union[java.lang.String, str], datetime: typing.Union[java.lang.String, str], snap: typing.Union[jpype.JLong, int]) -> None:
        ...

    def startBatch(self) -> RmiBatch:
        ...

    def startTx(self, traceId: typing.Union[jpype.JInt, int], desc: typing.Union[java.lang.String, str], undoable: typing.Union[jpype.JBoolean, bool], txId: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class RmiBatch(java.lang.AutoCloseable):
    ...
    def __init__(self, client: RmiClient) -> None:
        ...

    def append(self, f: RmiClient.RequestResult) -> None:
        ...
...
class RmiTrace(java.lang.Object):
    ...
    def __init__(self, client: RmiClient, id: typing.Union[jpype.JInt, int], createResult: RmiClient.RequestResult) -> None:
        ...

    def activate(self, path: typing.Union[java.lang.String, str]) -> None:
        ...

    def checkResult(self, timeoutMs: typing.Union[jpype.JLong, int]) -> None:
        ...
    ...
    @typing.overload
    def createOverlaySpace(self, base: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def createOverlaySpace(self, repl: ghidra.program.model.address.Address, orig: ghidra.program.model.address.Address) -> None:
        ...

    def createRootObject(self, schemaContext: ghidra.trace.model.target.schema.SchemaContext, schema: typing.Union[java.lang.String, str]) -> None:
        ...

    def deleteBytes(self, range: ghidra.program.model.address.AddressRange, snap: typing.Union[java.lang.Long, int]) -> None:
        ...

    def deleteRegisters(self, ppath: typing.Union[java.lang.String, str], names: jpype.JArray[java.lang.String], snap: typing.Union[java.lang.Long, int]) -> None:
        ...

    def disassemble(self, start: ghidra.program.model.address.Address, snap: typing.Union[java.lang.Long, int]) -> None:
        ...

    def endTx(self, txid: typing.Union[jpype.JInt, int], abort: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def insertObject(self, path: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def putBytes(self, addr: ghidra.program.model.address.Address, data: jpype.JArray[jpype.JByte], snap: typing.Union[java.lang.Long, int]) -> None:
        ...

    def putRegisters(self, ppath: typing.Union[java.lang.String, str], values: jpype.JArray[ghidra.program.model.lang.RegisterValue], snap: typing.Union[java.lang.Long, int]) -> None:
        ...

    def retainValues(self, ppath: typing.Union[java.lang.String, str], keys: java.util.Set[java.lang.String], kinds: ghidra.rmi.trace.TraceRmi.ValueKinds) -> None:
        ...

    def save(self) -> None:
        ...

    def setMemoryState(self, range: ghidra.program.model.address.AddressRange, state: ghidra.rmi.trace.TraceRmi.MemoryState, snap: typing.Union[java.lang.Long, int]) -> None:
        ...

    def setSnap(self, snap: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setValue(self, ppath: typing.Union[java.lang.String, str], key: typing.Union[java.lang.String, str], value: java.lang.Object) -> None:
        ...
...
class RmiReplyHandlerThread(java.lang.Thread):
    ...
    def __init__(self, client: RmiClient, socket: ProtobufSocket[ghidra.rmi.trace.TraceRmi.RootMessage]) -> None:
        ...
...
class RmiMethodRegistry(java.lang.Object):
    ...
    def putMethod(self, key: typing.Union[java.lang.String, str], value: RmiRemoteMethod) -> None:
        ...
...
class RmiTraceObject(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, trace: RmiTrace, path: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, trace: RmiTrace, id: typing.Union[java.lang.Long, int], path: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def retainValues(self, keys: java.util.Set[java.lang.String], snap: typing.Union[jpype.JLong, int], kinds: ghidra.rmi.trace.TraceRmi.ValueKinds) -> None:
        ...

    def setValue(self, key: typing.Union[java.lang.String, str], value: java.lang.Object, snap: typing.Union[jpype.JLong, int], resolution: typing.Union[java.lang.String, str]) -> None:
        ...
...
class RmiRemoteMethodParameter(java.lang.Object):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], schema: ghidra.trace.model.target.schema.TraceObjectSchema, required: typing.Union[jpype.JBoolean, bool], defaultValue: java.lang.Object, display: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str]) -> None:
        ...
...
class RmiTransaction(java.lang.AutoCloseable):
    ...
    def __init__(self, trace: RmiTrace, id: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class RmiTraceObjectValue(java.lang.Record):
    ...
    def __init__(self, parent: RmiTraceObject, span: ghidra.trace.model.Lifespan, key: typing.Union[java.lang.String, str], value: java.lang.Object, schema: ghidra.trace.model.target.schema.TraceObjectSchema) -> None:
        ...
...
__all__ = ["DefaultMemoryMapper", "MemoryMapper", "DefaultRegisterMapper", "RegisterMapper", "ProtobufSocket", "RmiClient", "RmiBatch", "RmiTrace", "RmiReplyHandlerThread", "RmiMethodRegistry", "RmiTraceObject", "RmiRemoteMethod", "RmiRemoteMethodParameter", "RmiMethods", "RmiTransaction", "RmiTraceObjectValue"]
