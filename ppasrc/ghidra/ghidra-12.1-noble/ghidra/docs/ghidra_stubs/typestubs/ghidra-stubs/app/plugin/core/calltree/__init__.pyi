...
class CallNode(docking.widgets.tree.GTreeSlowLoadingNode):
    ...
    def __init__(self, callTreeOptions: CallTreeOptions) -> None:
        ...
...
class CallTreeProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    class ExpandToDepthTask(docking.widgets.tree.tasks.GTreeExpandAllTask):
        ...
        def __init__(self, tree: docking.widgets.tree.GTree, node: docking.widgets.tree.GTreeNode, maxDepth: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def __init__(self, plugin: CallTreePlugin, isPrimary: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def getRecurseDepth(self) -> int:
        ...

    def setIncomingFilter(self, text: typing.Union[java.lang.String, str]) -> None:
        ...

    def setOutgoingFilter(self, text: typing.Union[java.lang.String, str]) -> None:
        ...

    def setRecurseDepth(self, depth: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["CallNode", "CallTreeOptions", "CallTreePlugin", "CallTreeProvider", "DeadEndNode", "ExternalCallNode", "IncomingCallNode", "IncomingCallsRootNode", "OutgoingCallNode", "OutgoingCallsRootNode"]
