...
class RelativeJumpTableSwitch(Switch):
    ...
    def __init__(self, jumpBase: ghidra.program.model.address.Address, offset: TableEntry) -> None:
        ...
...
__all__ = ["ComputedTableOffset", "MySwitchAnalyzer", "RelativeJumpTableSwitch", "Switch", "TableEntry", "TableEntryAddress"]
