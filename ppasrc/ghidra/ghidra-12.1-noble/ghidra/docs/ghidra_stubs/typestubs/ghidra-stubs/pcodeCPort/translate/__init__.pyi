...
class Translate(BasicSpaceProvider):
    ...
    def addSpacebase(self, basespace: ghidra.pcodeCPort.space.AddrSpace, spc: ghidra.pcodeCPort.space.AddrSpace, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def getUserOpNames(self, res: generic.stl.VectorSTL[java.lang.String]) -> None:
        ...
    ...
    def insertSpace(self, spc: ghidra.pcodeCPort.space.AddrSpace) -> None:
        ...
    ...
    def setDefaultSpace(self, index: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setLanguage(self, processorFile: typing.Union[java.lang.String, str]) -> None:
        ...
...
class BadDataError(ghidra.pcodeCPort.error.LowlevelError):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str]) -> None:
        ...
...
class UnimplError(ghidra.pcodeCPort.error.LowlevelError):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str], instruction_length: typing.Union[jpype.JInt, int]) -> None:
        ...



__all__ = ["Translate", "BasicSpaceProvider", "BadDataError", "UnimplError"]
