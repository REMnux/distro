...
class GUID(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, guidString: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, data1: typing.Union[jpype.JInt, int], data2: typing.Union[jpype.JShort, int], data3: typing.Union[jpype.JShort, int], data4: jpype.JArray[jpype.JByte]) -> None:
        """
...
class DataApplyOptions(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, dataApplyOptions: DataApplyOptions) -> None:
        """
        Copy constructor
    ...
    def setClearDefinedData(self, clearDefinedData: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setClearInstructions(self, clearInstructions: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setCreateBookmarks(self, createBookmarks: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setCreateComments(self, createComments: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setCreateFunction(self, createFunction: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setCreateLabel(self, createLabel: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setFollowData(self, followData: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DataValidationOptions(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, validationOptions: DataValidationOptions) -> None:
        """
        Copy constructor
    ...
    def setIgnoreDefinedData(self, ignoreDefinedData: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setIgnoreInstructions(self, ignoreInstructions: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setValidateReferredToData(self, validateReferredToData: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class GuidInfo(java.lang.Object):
    ...
    def __init__(self, guidString: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], type: GuidUtil.GuidType) -> None:
        ...
...
class NewGuid(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, conv: ghidra.util.DataConverter, GUID: typing.Union[java.lang.String, str], delim: typing.Union[java.lang.String, str], type: GuidUtil.GuidType, hasVersion: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Creates a GUID data type.
        """

    @typing.overload
    def __init__(self, conv: ghidra.util.DataConverter, bytes: jpype.JArray[jpype.JByte], offset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class RTTI2DataType(RTTIDataType):
    ...
    @typing.overload
    def __init__(self, rtti1Count: typing.Union[jpype.JLong, int]) -> None:
        """
        Creates a dynamic Base Class Array data type.
    ...
    @typing.overload
    def __init__(self, rtti1Count: typing.Union[jpype.JLong, int], dtm: ghidra.program.model.data.DataTypeManager) -> None:
        """
        Creates a dynamic Base Class Array data type.
...
class ThreadEnvironmentBlock(java.lang.Object):
    ...
    class LayDown(java.lang.Object):
        ...
        def __init__(self, is64: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def addEntry(self, off32: typing.Union[jpype.JInt, int], off64: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str], dat: ghidra.program.model.data.DataType) -> None:
            """
    ...
    class LayDownFlat(ThreadEnvironmentBlock.LayDown):
        ...
        def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, is64: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def __init__(self, prog: ghidra.program.model.listing.Program, version: ThreadEnvironmentBlock.WinVersion) -> None:
        ...
...
class VersionedGuidInfo(GuidInfo):
    ...
    def __init__(self, guidString: typing.Union[java.lang.String, str], version: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], type: GuidUtil.GuidType) -> None:
        ...
...
__all__ = ["GUID", "DataApplyOptions", "DataValidationOptions", "GroupIconResourceDataType", "GuidDataType", "GuidUtil", "GuidInfo", "HTMLResourceDataType", "MSDataTypeUtils", "MUIResourceDataType", "NewGuid", "RTTI0DataType", "RTTIDataType", "RTTI1DataType", "RTTI3DataType", "RTTI2DataType", "RTTI4DataType", "ThreadEnvironmentBlock", "VersionedGuidInfo", "WEVTResourceDataType"]
