...
class AddressTable(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, topAddress: ghidra.program.model.address.Address, tableElements: jpype.JArray[ghidra.program.model.address.Address], addrByteSize: typing.Union[jpype.JInt, int], skipAmount: typing.Union[jpype.JInt, int], shiftedAddr: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def changeEntry(self, i: typing.Union[jpype.JInt, int], address: ghidra.program.model.address.Address) -> None:
        """
    ...
    def createTableIndex(self, program: ghidra.program.model.listing.Program) -> None:
        """
    ...
    def fixupFunctionBody(self, program: ghidra.program.model.listing.Program, start_inst: ghidra.program.model.listing.Instruction, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def labelTable(self, program: ghidra.program.model.listing.Program, start_inst: ghidra.program.model.listing.Instruction, switchLabelList: java.util.ArrayList[ghidra.app.cmd.label.AddLabelCmd], tableNameLabel: ghidra.app.cmd.label.AddLabelCmd) -> None:
        ...
    ...
    def setNegativeTable(self, isNegative: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def truncate(self, tableLen: typing.Union[jpype.JInt, int]) -> None:
        """
...
class AddressTableDialog(docking.ReusableDialogComponentProvider):
    ...
    def __init__(self, plugin: AutoTableDisassemblerPlugin) -> None:
        ...

    def setSelectedRows(self, selectedRows: jpype.JArray[jpype.JInt]) -> None:
        ...
...
class AutoTableDisassemblerModel(ghidra.util.table.AddressBasedTableModel[AddressTable]):
    ...
    class AddressTableStorage(java.lang.Object):
        ...
        def put(self, address: ghidra.program.model.address.Address, table: AddressTable) -> None:
            ...
...
class ArmDisassembleAction(ghidra.app.context.ListingContextAction):
    ...
    def __init__(self, plugin: DisassemblerPlugin, groupName: typing.Union[java.lang.String, str], disassembleThumb: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DisassemblerPlugin(ghidra.framework.plugintool.Plugin):
    ...
    def disassembleArmCallback(self, context: ghidra.app.context.ListingActionContext, thumbMode: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def disassembleHcs12Callback(self, context: ghidra.app.context.ListingActionContext, xgMode: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def disassembleMipsCallback(self, context: ghidra.app.context.ListingActionContext, mips16: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def disassemblePPCCallback(self, context: ghidra.app.context.ListingActionContext, vle: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def disassembleX86_64Callback(self, context: ghidra.app.context.ListingActionContext, size32Mode: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setDefaultContext(self, context: ghidra.app.context.ListingActionContext) -> None:
        ...
...
class CallFixupAnalyzer(ghidra.app.services.AbstractAnalyzer):
    ...
    class SubMonitor(ghidra.util.task.TaskMonitorAdapter):
        ...
        def __init__(self, parentMonitor: ghidra.util.task.TaskMonitor) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], analyzerType: ghidra.app.services.AnalyzerType, supportsOneTimeAnalysis: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ContextAction(ghidra.app.context.ListingContextAction):
    ...
    def __init__(self, plugin: DisassemblerPlugin, groupName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class Hcs12DisassembleAction(ghidra.app.context.ListingContextAction):
    ...
    def __init__(self, plugin: DisassemblerPlugin, groupName: typing.Union[java.lang.String, str], disassembleXgate: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class MipsDisassembleAction(ghidra.app.context.ListingContextAction):
    ...
    def __init__(self, plugin: DisassemblerPlugin, groupName: typing.Union[java.lang.String, str], disassembleMIPS16: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class PowerPCDisassembleAction(ghidra.app.context.ListingContextAction):
    ...
    def __init__(self, plugin: DisassemblerPlugin, groupName: typing.Union[java.lang.String, str], disassemblePPC: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def initializeContextMenu(self) -> None:
        ...
...
class ProcessorStateDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, programContext: ghidra.program.model.listing.ProgramContext) -> None:
        ...
...
class X86_64DisassembleAction(ghidra.app.context.ListingContextAction):
    ...
    def __init__(self, plugin: DisassemblerPlugin, groupName: typing.Union[java.lang.String, str], disassemble32Bit: typing.Union[jpype.JBoolean, bool]) -> None:
        ...



__all__ = ["AddressTable", "AddressTableAnalyzer", "AddressTableDialog", "AutoTableDisassemblerPlugin", "AutoTableDisassemblerModel", "ArmDisassembleAction", "DisassemblerPlugin", "CallFixupAnalyzer", "CallFixupChangeAnalyzer", "ContextAction", "DisassembleAction", "DisassembledViewPlugin", "EntryPointAnalyzer", "Hcs12DisassembleAction", "MipsDisassembleAction", "PowerPCDisassembleAction", "ProcessorStateDialog", "RestrictedDisassembleAction", "SetFlowOverrideAction", "SetFlowOverrideDialog", "SetLengthOverrideAction", "StaticDisassembleAction", "X86_64DisassembleAction"]
