...
class AbstractFunctionMerger(ListingMergeConstants):
    ...
    def __init__(self, mergeManager: ghidra.app.merge.ProgramMultiUserMergeManager, programs: jpype.JArray[ghidra.program.model.listing.Program]) -> None:
        ...
...
class VerticalChoicesPanel(ConflictPanel):
    ...
    class MyRadioButton(docking.widgets.button.GRadioButton):
        ...
        def __init__(self, text: typing.Union[java.lang.String, str], option: typing.Union[jpype.JInt, int]) -> None:
            """
    ...
    @typing.overload
    def __init__(self, isDoubleBuffered: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ConflictPanel(ChoiceComponent):
    ...
    @typing.overload
    def __init__(self, layout: java.awt.LayoutManager, isDoubleBuffered: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, layout: java.awt.LayoutManager) -> None:
        ...
...
class ListingMerger(java.lang.Object):
    ...
    def autoMerge(self, progressMin: typing.Union[jpype.JInt, int], progressMax: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def mergeConflicts(self, listingPanel: ghidra.app.merge.tool.ListingMergePanel, addr: ghidra.program.model.address.Address, conflictOption: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class ExternalFunctionMerger(AbstractFunctionMerger, ListingMerger):
    ...
    def __init__(self, listingMergeManager: ListingMergeManager, showListingPanel: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def mergeConflicts(self, chosenConflictOption: typing.Union[jpype.JInt, int], listingConflictInfoPanel: ConflictInfoPanel, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def mergeConflictsForAdd(self, externalLocations: jpype.JArray[ghidra.program.model.symbol.ExternalLocation], chosenConflictOption: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    def mergeFunction(self, externalLocations: jpype.JArray[ghidra.program.model.symbol.ExternalLocation], currentChosenOption: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    def refreshResultPanel(self, externalLocations: jpype.JArray[ghidra.program.model.symbol.ExternalLocation]) -> None:
        ...
...
class CodeUnitMerger(AbstractListingMerger):
    ...
    * code units and equates
    ...
    def mergeConflicts(self, listingPanel: ghidra.app.merge.tool.ListingMergePanel, chosenConflictOption: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class FunctionMerger(AbstractFunctionMerger, ListingMerger):
    ...
    def mergeThunks(self, listingPanel: ghidra.app.merge.tool.ListingMergePanel, currentConflictOption: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class SymbolMerger(AbstractListingMerger):
    ...
    def merge(self, progressMinimum: typing.Union[jpype.JInt, int], progressMaximum: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class FunctionTagListingMerger(AbstractListingMerger):
    ...
    def __init__(self, listingMergeMgr: ListingMergeManager) -> None:
        """
        Constructor.
    ...
    def setConflictResolution(self, option: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ExternalProgramMerger(ghidra.app.merge.MergeResolver, ListingMergeConstants):
    ...
    def mergeConflicts(self, chosenConflictOption: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Performs a manual merge of external program conflicts.
    ...
    def mergeExternalProgramName(self, program1: ghidra.program.model.listing.Program, program2: ghidra.program.model.listing.Program, idGroup: ExternalProgramMerger.IDGroup, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class OffsetRanges(java.lang.Object):
    ...
    def addRangeList(self, firstUse: typing.Union[jpype.JInt, int], commonSrl: ghidra.util.datastruct.SortedRangeList) -> None:
        """
...
__all__ = ["AbstractFunctionMerger", "ListingMergeConstants", "ListingMergeManager", "VerticalChoicesPanel", "ConflictPanel", "ChoiceComponent", "VariousChoicesPanel", "ScrollingListChoicesPanel", "FunctionVariableStorageConflicts", "ListChoice", "ListingMerger", "ExternalFunctionMerger", "CodeUnitMerger", "AbstractListingMerger", "EquateMerger", "UserDefinedPropertyMerger", "FunctionMerger", "ReferenceMerger", "CommentMerger", "BookmarkMerger", "SymbolMerger", "FunctionTagListingMerger", "ConflictInfoPanel", "ExternalAddConflictPanel", "ExternalConflictInfoPanel", "ExternalsAddressTranslator", "CodeUnitDetails", "ExternalProgramMerger", "FunctionTagMerger", "OffsetRanges", "ProgramContextMergeManager", "RegisterMergeManager", "ResolveConflictChangeEvent", "ListChoiceTable", "UserDefinedPropertyPanel"]
