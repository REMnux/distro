...
class DWARFFunctionFixup(ghidra.util.classfinder.ExtensionPoint):
    ...
    def fixupDWARFFunction(self, dfunc: ghidra.app.util.bin.format.dwarf.DWARFFunction) -> None:
        ...
        :raises DWARFException: if error fixing function
        """
...
__all__ = ["DWARFFunctionFixup", "OutputParamCheckDWARFFunctionFixup", "ParamNameDWARFFunctionFixup", "ParamSpillDWARFFunctionFixup", "RustDWARFFunctionFixup", "SanityCheckDWARFFunctionFixup", "StorageVerificationDWARFFunctionFixup", "ThisCallingConventionDWARFFunctionFixup"]
