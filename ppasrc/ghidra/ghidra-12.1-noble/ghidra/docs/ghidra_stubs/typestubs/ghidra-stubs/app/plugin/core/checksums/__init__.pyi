...
class Adler32ChecksumAlgorithm(ChecksumAlgorithm):
    ...
    def updateChecksum(self, memory: ghidra.program.model.mem.Memory, addrSet: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor, onesComp: typing.Union[jpype.JBoolean, bool], twosComp: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ChecksumAlgorithm(ghidra.util.classfinder.ExtensionPoint):
    ...
    @typing.overload
    def updateChecksum(self, memory: ghidra.program.model.mem.Memory, addrSet: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor, provider: ComputeChecksumsProvider) -> None:
        """
    ...
    @typing.overload
    def updateChecksum(self, memory: ghidra.program.model.mem.Memory, addrSet: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Updates (or generates) the checksum for this algorithm over the given address range.
...
class ComputeChecksumsProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, plugin: ComputeChecksumsPlugin) -> None:
        """
...
class ChecksumTableModel(docking.widgets.table.GDynamicColumnTableModel[ChecksumAlgorithm, java.lang.Object]):
    ...
    def __init__(self, serviceProvider: ghidra.framework.plugintool.ServiceProvider, checksumAlgorithms: java.util.List[ChecksumAlgorithm]) -> None:
        """
...
class BasicChecksumAlgorithm(ChecksumAlgorithm):
    ...
    def __init__(self, size: BasicChecksumAlgorithm.SupportedByteSize) -> None:
        """
...
class ComputeChecksumTask(ghidra.util.task.Task):
    ...
    def __init__(self, provider: ComputeChecksumsProvider, memory: ghidra.program.model.mem.Memory, set: ghidra.program.model.address.AddressSetView) -> None:
        ...
...
__all__ = ["Adler32ChecksumAlgorithm", "ChecksumAlgorithm", "ComputeChecksumsProvider", "ComputeChecksumsPlugin", "ChecksumTableModel", "BasicChecksumAlgorithm", "CRC16CCITTChecksumAlgorithm", "CRC16ChecksumAlgorithm", "CRC32ChecksumAlgorithm", "Checksum16ChecksumAlgorithm", "Checksum32ChecksumAlgorithm", "Checksum8ChecksumAlgorithm", "ComputeChecksumTask", "DigestChecksumAlgorithm", "MD2DigestChecksumAlgorithm", "MD5DigestChecksumAlgorithm", "MemoryInputStream", "SHA1DigestChecksumAlgorithm", "SHA256DigestChecksumAlgorithm", "SHA384DigestChecksumAlgorithm", "SHA512DigestChecksumAlgorithm"]
