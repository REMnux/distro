...
class TraceRmiLaunchDialog(ghidra.app.plugin.core.debug.gui.AbstractDebuggerParameterDialog[ghidra.debug.api.tracermi.LaunchParameter[typing.Any]]):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, title: typing.Union[java.lang.String, str], buttonText: typing.Union[java.lang.String, str], buttonIcon: javax.swing.Icon) -> None:
        ...
...
class ScriptAttributesParser(java.lang.Object):
    ...
    class ParseException(java.lang.Exception):
        ...
        def __init__(self, loc: ScriptAttributesParser.Location, message: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    def parseComment(self, loc: ScriptAttributesParser.Location, comment: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    def processArguments(commandLine: java.util.List[java.lang.String], env: collections.abc.Mapping, script: jpype.protocol.SupportsPath, parameters: collections.abc.Mapping, args: collections.abc.Mapping, dependencies: java.util.Set[java.lang.String], address: java.net.SocketAddress) -> None:
        """
...
class AbstractScriptTraceRmiLaunchOffer(AbstractTraceRmiLaunchOffer):
    ...
    def __init__(self, plugin: TraceRmiLauncherServicePlugin, program: ghidra.program.model.listing.Program, script: jpype.protocol.SupportsPath, configName: typing.Union[java.lang.String, str], attrs: ScriptAttributesParser.ScriptAttributes) -> None:
        ...
...
class AbstractTraceRmiLaunchOffer(ghidra.debug.api.tracermi.TraceRmiLaunchOffer):
    ...
    class TerminateSessionTask(ghidra.util.task.Task):
        ...
        def __init__(self, session: ghidra.debug.api.tracermi.TerminalSession) -> None:
            ...
    ...
    class ImageParamSetter(java.lang.Object):
        ...
        def setImage(self, map: collections.abc.Mapping, program: ghidra.program.model.listing.Program) -> None:
            ...
    ...
    class StringImageParamSetter(AbstractTraceRmiLaunchOffer.ImageParamSetter):
        ...
        def __init__(self, param: ghidra.debug.api.tracermi.LaunchParameter[java.lang.String]) -> None:
            ...
    ...
    class FileImageParamSetter(AbstractTraceRmiLaunchOffer.ImageParamSetter):
        ...
        def __init__(self, param: ghidra.debug.api.tracermi.LaunchParameter[ghidra.framework.plugintool.AutoConfigState.PathIsFile]) -> None:
            ...
    ...
    def __init__(self, plugin: TraceRmiLauncherServicePlugin, program: ghidra.program.model.listing.Program) -> None:
        ...
...
class TraceRmiLauncherServicePlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.TraceRmiLauncherService, ghidra.framework.options.OptionsChangeListener):
    ...
    class AbstractLaunchTask(ghidra.util.task.Task):
        ...
        def __init__(self, offer: ghidra.debug.api.tracermi.TraceRmiLaunchOffer) -> None:
            ...
    ...
    class FieldIndex(java.lang.Object):
        ...
        def __init__(self, dt: ghidra.program.model.data.Composite) -> None:
            ...
...
class LaunchAction(docking.menu.MultiActionDockingAction):
    ...
    def __init__(self, plugin: TraceRmiLauncherServicePlugin) -> None:
        ...
...
class ScriptPathsPropertyEditor(docking.widgets.pathmanager.AbstractTypedPropertyEditor[java.lang.String]):
    ...
    class ScriptPathsPanel(docking.widgets.pathmanager.PathnameTablePanel):
        ...
        def __init__(self, paths: jpype.JArray[java.lang.String], resetCallback: utility.function.Callback) -> None:
            ...
...
__all__ = ["TraceRmiLaunchDialog", "ScriptAttributesParser", "AbstractScriptTraceRmiLaunchOffer", "LaunchFailureDialog", "AbstractTraceRmiLaunchOffer", "TraceRmiLauncherServicePlugin", "TraceRmiBackEnd", "LaunchAction", "AbstractTraceRmiLaunchOpinion", "BatchScriptTraceRmiLaunchOffer", "BatchScriptTraceRmiLaunchOpinion", "PowerShellScriptTraceRmiLaunchOffer", "PowerShellScriptTraceRmiLaunchOpinion", "ScriptPathsPropertyEditor", "UnixShellScriptTraceRmiLaunchOffer", "UnixShellScriptTraceRmiLaunchOpinion"]
