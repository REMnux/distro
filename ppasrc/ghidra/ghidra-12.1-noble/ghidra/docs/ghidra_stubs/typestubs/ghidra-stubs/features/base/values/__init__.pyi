...
class GhidraValuesMap(docking.widgets.values.GValuesMap):
    ...
    def setAddress(self, name: typing.Union[java.lang.String, str], address: ghidra.program.model.address.Address) -> None:
        """
    ...
    def setLanguage(self, name: typing.Union[java.lang.String, str], value: ghidra.program.model.lang.LanguageCompilerSpecPair) -> None:
        """
    ...
    def setProgram(self, name: typing.Union[java.lang.String, str], program: ghidra.program.model.listing.Program) -> None:
        """
    ...
    def setProjectFile(self, name: typing.Union[java.lang.String, str], file: ghidra.framework.model.DomainFile) -> None:
        """
    ...
    def setProjectFolder(self, name: typing.Union[java.lang.String, str], folder: ghidra.framework.model.DomainFolder) -> None:
        """
...
class AddressValue(docking.widgets.values.AbstractValue[ghidra.program.model.address.Address]):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], defaultValue: ghidra.program.model.address.Address, program: ghidra.program.model.listing.Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], defaultValue: ghidra.program.model.address.Address, factory: ghidra.program.model.address.AddressFactory) -> None:
        """
...
class LanguageValue(docking.widgets.values.AbstractValue[ghidra.program.model.lang.LanguageCompilerSpecPair]):
    ...
    class LangaugeValuePanel(javax.swing.JPanel):
        ...
        def setLanguage(self, value: ghidra.program.model.lang.LanguageCompilerSpecPair) -> None:
            ...

        def setText(self, val: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], defaultValue: ghidra.program.model.lang.LanguageCompilerSpecPair) -> None:
        """
...
class ProgramFileValue(ProjectFileValue):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], startingPath: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], project: ghidra.framework.model.Project, startingPath: typing.Union[java.lang.String, str]) -> None:
        """
...
class ProjectFileValue(docking.widgets.values.AbstractValue[ghidra.framework.model.DomainFile]):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], projectFileClass: java.lang.Class[ghidra.framework.model.DomainObject]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], project: ghidra.framework.model.Project, startingPath: typing.Union[java.lang.String, str], projectFileClass: java.lang.Class[ghidra.framework.model.DomainObject]) -> None:
        """
        Constructor for ProgramValue when wanting to pick from a different project than the
        active project, such as a read-only project.
...
class ProjectFolderValue(docking.widgets.values.AbstractValue[ghidra.framework.model.DomainFolder]):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], defaultValuePath: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], project: ghidra.framework.model.Project, defaultValuePath: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["GhidraValuesMap", "AddressValue", "LanguageValue", "ProgramFileValue", "ProjectFileValue", "ProjectFolderValue", "AbstractProjectBrowserPanel"]
