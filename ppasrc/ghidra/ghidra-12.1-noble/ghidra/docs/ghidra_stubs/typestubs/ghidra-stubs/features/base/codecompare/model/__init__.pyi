...
class FunctionComparisonModel(java.lang.Object):
    ...
    def addFunctionComparisonModelListener(self, listener: FunctionComparisonModelListener) -> None:
        """
    ...
    def removeFunctionComparisonModelListener(self, listener: FunctionComparisonModelListener) -> None:
        """
    ...
    @typing.overload
    def removeFunctions(self, functions: collections.abc.Sequence) -> None:
        """
...
class AnyToAnyFunctionComparisonModel(AbstractFunctionComparisonModel):
    ...
    @typing.overload
    def __init__(self, functions: collections.abc.Sequence) -> None:
        ...

    @typing.overload
    def __init__(self, left: ghidra.program.model.listing.Function, right: ghidra.program.model.listing.Function) -> None:
        ...

    @typing.overload
    def __init__(self, *functions: ghidra.program.model.listing.Function) -> None:
        ...

    def addFunction(self, function: ghidra.program.model.listing.Function) -> None:
        ...

    def addFunctions(self, additionalFunctions: collections.abc.Sequence) -> None:
        ...
...
__all__ = ["FunctionComparisonModel", "FunctionComparisonModelListener", "AbstractFunctionComparisonModel", "AnyToAnyFunctionComparisonModel", "MatchedFunctionComparisonModel"]
