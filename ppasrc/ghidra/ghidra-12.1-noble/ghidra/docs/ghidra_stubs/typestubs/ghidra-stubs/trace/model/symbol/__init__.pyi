...
class TraceEquateOperations(java.lang.Object):
    ...
    @typing.overload
    def clearReferences(self, span: ghidra.trace.model.Lifespan, asv: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    @typing.overload
    def clearReferences(self, span: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class TraceReferenceOperations(java.lang.Object):
    ...
    def clearReferencesFrom(self, span: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange) -> None:
        """
    ...
    def clearReferencesTo(self, span: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange) -> None:
        """
...
class TraceSymbolWithLifespan(TraceSymbol):
    ...
    def setEndSnap(self, snap: typing.Union[jpype.JLong, int]) -> None:
        """
...
class TraceReference(ghidra.program.model.symbol.Reference):
    ...
    def setAssociatedSymbol(self, symbol: ghidra.program.model.symbol.Symbol) -> None:
        """
    ...
    def setPrimary(self, primary: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setReferenceType(self, refType: ghidra.program.model.symbol.RefType) -> None:
        """
...
__all__ = ["TraceEquateManager", "TraceEquateOperations", "TraceReferenceManager", "TraceReferenceOperations", "TraceSymbolManager", "TraceLabelSymbol", "TraceSymbolWithLifespan", "TraceSymbol", "TraceReference", "TraceNamespaceSymbol", "TraceLabelSymbolView", "TraceSymbolWithLocationView", "TraceSymbolView", "TraceNamespaceSymbolView", "TraceSymbolNoDuplicatesView", "TraceClassSymbolView", "TraceClassSymbol", "TraceReferenceSpace", "TraceOffsetReference", "TraceShiftedReference", "TraceEquateSpace", "TraceEquate", "TraceEquateReference", "TraceStackReference", "TraceSymbolWithAddressView", "TraceSymbolWithAddressNoDuplicatesView"]
