...
class ResourceHeader(ghidra.app.util.bin.format.macos.asd.Entry, ghidra.app.util.bin.StructConverter):
    ...
    @typing.overload
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, entry: ghidra.app.util.bin.format.macos.asd.EntryDescriptor) -> None:
        ...
...
__all__ = ["ResourceHeader", "ResourceType", "ResourceMap", "ReferenceListEntry", "ResourceTypeFactory", "ResourceTypes", "SingleResourceData"]
