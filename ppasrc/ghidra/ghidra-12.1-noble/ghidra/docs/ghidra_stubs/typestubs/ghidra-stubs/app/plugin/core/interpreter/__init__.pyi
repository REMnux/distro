...
class AnsiParser(java.lang.Object):
    ...
    class AnsiParserHandler(java.lang.Object):
        ...
        def handleCSI(self, param: typing.Union[java.lang.String, str], inter: typing.Union[java.lang.String, str], finalChar: typing.Union[java.lang.String, str]) -> None:
            """
        ...
        def handleOSC(self, param: typing.Union[java.lang.String, str]) -> None:
            """
        ...
        def handleString(self, text: typing.Union[java.lang.String, str]) -> None:
            """
    ...
    def __init__(self, handler: AnsiParser.AnsiParserHandler) -> None:
        """
    ...
    def processString(self, text: typing.Union[java.lang.String, str]) -> None:
        """
...
class AnsiRenderer(java.lang.Object):
    ...
    def renderString(self, document: javax.swing.text.StyledDocument, text: typing.Union[java.lang.String, str], attributes: javax.swing.text.MutableAttributeSet) -> None:
        """
...
class CodeCompletionWindow(javax.swing.JDialog):
    ...
    def __init__(self, parent: java.awt.Window, cp: InterpreterPanel, textField: javax.swing.JTextPane) -> None:
        ...
    ...
    def processKeyEvent(self, e: java.awt.event.KeyEvent) -> None:
        """
    ...
    def updateCompletionList(self, list: java.util.List[ghidra.app.plugin.core.console.CodeCompletion]) -> None:
        """
    ...
    def updateLocation(self, caretLocation: java.awt.Point) -> None:
        ...
...
class InterpreterPanel(javax.swing.JPanel, ghidra.framework.options.OptionsChangeListener):
    ...
    @typing.type_check_only
    class InterpreterPrintWriter(ghidra.app.script.DecoratingPrintWriter):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class InterpreterConsoleWriter(java.io.Writer):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, type: InterpreterPanel.TextType) -> None:
            ...
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, interpreter: InterpreterConnection) -> None:
        ...
    ...
    def insertCompletion(self, completion: ghidra.app.plugin.core.console.CodeCompletion) -> None:
        ...

    def isInputPermitted(self) -> bool:
        ...

    def setInputPermitted(self, permitted: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setPrompt(self, prompt: typing.Union[java.lang.String, str]) -> None:
        ...

    def setTextPaneFont(self, textPane: javax.swing.JTextPane, font: java.awt.Font) -> None:
        ...
...
class HistoryManager(java.lang.Object):
    ...
    def addHistory(self, command: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def setRetention(self, retention: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class CodeCompletionListModel(javax.swing.ListModel[ghidra.app.plugin.core.console.CodeCompletion]):
    ...
    def __init__(self, completion_list: java.util.List[ghidra.app.plugin.core.console.CodeCompletion]) -> None:
        ...
...
class CodeCompletionListSelectionModel(javax.swing.DefaultListSelectionModel):
    ...
    def __init__(self, l: java.util.List[ghidra.app.plugin.core.console.CodeCompletion]) -> None:
        """
    ...
    def setSelectionInterval(self, index0: typing.Union[jpype.JInt, int], index1: typing.Union[jpype.JInt, int]) -> None:
        """
...
class InterpreterComponentProvider(ghidra.framework.plugintool.ComponentProviderAdapter, InterpreterConsole):
    ...
    def __init__(self, plugin: InterpreterPanelPlugin, interpreter: InterpreterConnection, visible: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class InterpreterConsole(ghidra.util.Disposable):
    ...
    def addFirstActivationCallback(self, activationCallback: utility.function.Callback) -> None:
        """
...
__all__ = ["AnsiParser", "AnsiRenderer", "CodeCompletionWindow", "InterpreterPanel", "InterpreterConnection", "HistoryManager", "CompletionWindowTrigger", "CodeCompletionListModel", "CodeCompletionListSelectionModel", "CodeCompletionListCellRenderer", "HistoryManagerImpl", "InterpreterComponentProvider", "InterpreterConsole", "InterpreterPanelPlugin", "InterpreterPanelService"]
