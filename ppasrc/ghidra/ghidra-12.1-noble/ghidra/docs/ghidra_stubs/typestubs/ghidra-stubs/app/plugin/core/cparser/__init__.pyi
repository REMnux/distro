...
class CParserTask(ghidra.util.task.Task):
    ...
    def __init__(self, plugin: CParserPlugin, dataTypeManager: ghidra.program.model.data.DataTypeManager) -> None:
        """
...
__all__ = ["CParserPlugin", "ParseDialog", "CParserTask", "IncludeFileFinder"]
