...
class ReferenceDBManager(ghidra.program.model.symbol.ReferenceManager, ghidra.program.database.ManagerDB, db.util.ErrorHandler):
    ...
    def isExternalEntryPoint(self, toAddr: ghidra.program.model.address.Address) -> bool:
        ...
        :param ghidra.program.model.address.Address toAddr: the memory address to test for external entry point
...
class RecordAdapter(java.lang.Object):
    ...
    def putRecord(self, record: db.DBRecord) -> None:
        """
    ...
    def removeRecord(self, key: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ToAdapter(RecordAdapter):
    ...
    def putRecord(self, key: typing.Union[jpype.JLong, int], numRefs: typing.Union[jpype.JInt, int], refData: jpype.JArray[jpype.JByte]) -> None:
        ...
...
class ExternalReferenceDB(ReferenceDB, ghidra.program.model.symbol.ExternalReference):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, fromAddr: ghidra.program.model.address.Address, toAddr: ghidra.program.model.address.Address, refType: ghidra.program.model.symbol.RefType, opIndex: typing.Union[jpype.JInt, int], sourceType: ghidra.program.model.symbol.SourceType) -> None:
        ...
...
class RefListFlagsV0(java.lang.Object):
    ...
    def __init__(self, isPrimary: typing.Union[jpype.JBoolean, bool], isOffsetRef: typing.Union[jpype.JBoolean, bool], hasSymbolID: typing.Union[jpype.JBoolean, bool], isShiftRef: typing.Union[jpype.JBoolean, bool], source: ghidra.program.model.symbol.SourceType) -> None:
        ...
    ...
    def setHasSymbolID(self, hasSymbolID: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setPrimary(self, isPrimary: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ToAdapterV1(ToAdapter):
    ...
    class MyAddressKeyAddressIterator(ghidra.program.model.address.AddressIterator):
        ...
        def __init__(self, keyIter: db.DBLongIterator) -> None:
            ...
...
__all__ = ["ReferenceDBManager", "OldStackRefDBAdpater", "FromAdapter", "RecordAdapter", "ToAdapter", "RefList", "ReferenceDB", "BigRefListV0", "EmptyMemReferenceIterator", "EntryPointReferenceDB", "ExternalReferenceDB", "FromAdapterSharedTable", "FromAdapterV0", "MemReferenceDB", "OffsetReferenceDB", "RefListFlagsV0", "RefListV0", "ShiftedReferenceDB", "StackReferenceDB", "ToAdapterSharedTable", "ToAdapterV0", "ToAdapterV1"]
