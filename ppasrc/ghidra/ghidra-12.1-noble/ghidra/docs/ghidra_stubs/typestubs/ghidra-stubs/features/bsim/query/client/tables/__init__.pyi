...
class ExeTable(SQLComplexTable):
    ...
    def __init__(self, archtable: SQLStringTable, compilertable: SQLStringTable, repositorytable: SQLStringTable, pathtable: SQLStringTable, exeCategoryTable: ExeToCategoryTable) -> None:
        """
        Constructor
    ...
    def updateExecutable(self, rec: ghidra.features.bsim.query.description.ExecutableRecord.Update) -> None:
        """
...
class SQLComplexTable(java.lang.Object):
    ...
    def __init__(self, tableName: typing.Union[java.lang.String, str], idColumnName: typing.Union[java.lang.String, str]) -> None:
        ...

    def close(self) -> None:
        ...

    def create(self, st: java.sql.Statement) -> None:
        """
    ...
    def drop(self, st: java.sql.Statement) -> None:
        """
    ...
    def setConnection(self, db: java.sql.Connection) -> None:
        ...
...
class SQLStringTable(java.lang.Object):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], maxloaded: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ExeToCategoryTable(SQLComplexTable):
    ...
    def __init__(self, catstringtable: SQLStringTable) -> None:
        """
        Constructor
    ...
    def storeExecutableCategories(self, erec: ghidra.features.bsim.query.description.ExecutableRecord) -> None:
        """
...
class CachedStatement(java.lang.Object, typing.Generic[S]):
    ...
    def setStatement(self, s: S) -> None:
        """
...
class DescriptionTable(SQLComplexTable):
    ...
    def __init__(self, exeTable: ExeTable) -> None:
        ...
    ...
    def convertDescriptionRows(self, descList: java.util.List[ghidra.features.bsim.query.description.FunctionDescription], rowList: java.util.List[DescriptionTable.DescriptionRow], executable: ghidra.features.bsim.query.description.ExecutableRecord, descManager: ghidra.features.bsim.query.description.DescriptionManager, sigRecord: ghidra.features.bsim.query.description.SignatureRecord) -> None:
        """
    ...
    @staticmethod
    def extractDescriptionRow(resultSet: java.sql.ResultSet, descRow: DescriptionTable.DescriptionRow) -> None:
        """
...
class IdfLookupTable(SQLComplexTable):
    ...
    def recoverIDFLookup(self, lookup: generic.lsh.vector.IDFLookup) -> None:
        """
...
class WeightTable(SQLComplexTable):
    ...
    def recoverWeights(self, factory: generic.lsh.vector.WeightFactory) -> None:
        """
...
class KeyValueTable(SQLComplexTable):
    ...
    def writeBasicInfo(self, info: ghidra.features.bsim.query.description.DatabaseInformation) -> None:
        """
    ...
    def writeExecutableCategories(self, info: ghidra.features.bsim.query.description.DatabaseInformation) -> None:
        """
    ...
    def writeFunctionTags(self, info: ghidra.features.bsim.query.description.DatabaseInformation) -> None:
        """
...
class OptionalTable(java.lang.Object):
    ...
    def __init__(self, nm: typing.Union[java.lang.String, str], kType: typing.Union[jpype.JInt, int], vType: typing.Union[jpype.JInt, int], d: java.sql.Connection) -> None:
        """
    ...
    def deleteValue(self, key: java.lang.Object) -> None:
        """
    ...
    def writeValue(self, key: java.lang.Object, value: java.lang.Object) -> None:
        """
...
__all__ = ["ExeTable", "SQLComplexTable", "SQLStringTable", "ExeToCategoryTable", "CachedStatement", "StatementSupplier", "CallgraphTable", "DescriptionTable", "IdfLookupTable", "WeightTable", "KeyValueTable", "OptionalTable"]
