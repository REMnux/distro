...
class FieldMatcher(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, dataType: ghidra.program.model.data.DataType, fieldName: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, dataType: ghidra.program.model.data.DataType, offset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class AnalysisPriority(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, priority: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], priority: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DataTypeManagerService(DataTypeQueryService, DataTypeArchiveService):
    ...
    @typing.overload
    def edit(self, composite: ghidra.program.model.data.Composite, fieldName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setCategorySelected(self, category: ghidra.program.model.data.Category) -> None:
        """
...
class BlockModelService(java.lang.Object):
    ...
    def addListener(self, listener: BlockModelServiceListener) -> None:
        """
    ...
    def registerModel(self, modelClass: java.lang.Class[ghidra.program.model.block.CodeBlockModel], modelName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def removeListener(self, listener: BlockModelServiceListener) -> None:
        """
    ...
    def unregisterModel(self, modelClass: java.lang.Class[ghidra.program.model.block.CodeBlockModel]) -> None:
        """
        Deregister a model.
...
class BlockModelServiceListener(java.lang.Object):
    ...
    def modelAdded(self, modeName: typing.Union[java.lang.String, str], modelType: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def modelRemoved(self, modeName: typing.Union[java.lang.String, str], modelType: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ProgramManager(java.lang.Object):
    ...
    @typing.overload
    def openProgram(self, program: ghidra.program.model.listing.Program, state: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def releaseProgram(self, program: ghidra.program.model.listing.Program, persistentOwner: java.lang.Object) -> None:
        """
...
class HoverService(java.lang.Object):
    ...
    def scroll(self, amount: typing.Union[jpype.JInt, int]) -> None:
        """
...
class MarkerService(java.lang.Object):
    ...
    def removeMarker(self, markerSet: MarkerSet, program: ghidra.program.model.listing.Program) -> None:
        """
    ...
    def removeMarkerForGroup(self, groupName: typing.Union[java.lang.String, str], markerSet: MarkerSet, program: ghidra.program.model.listing.Program) -> None:
        """
    ...
    def setMarkerForGroup(self, groupName: typing.Union[java.lang.String, str], markerSet: MarkerSet, program: ghidra.program.model.listing.Program) -> None:
        """
...
class MarkerSet(java.lang.Comparable[MarkerSet]):
    ...
    def getOwnerId(self) -> ghidra.util.UniversalID:
        """
    ...
    def setActive(self, state: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setColoringBackground(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setMarkerDescriptor(self, markerDescriptor: MarkerDescriptor) -> None:
        """
    ...
    @property
    def ownerId(self) -> ghidra.util.UniversalID:
        ...

    @ownerId.setter
    def ownerId(self, value: ghidra.util.UniversalID):
        ...
...
class ListingMarginProviderService(java.lang.Object):
    """
    ...
    def createMarginProvider(self) -> ghidra.app.util.viewer.listingpanel.ListingMarginProvider:
        """
        Creates a new margin provider.
        
        :return: the provider
        :rtype: ghidra.app.util.viewer.listingpanel.ListingMarginProvider
        """

    def isOwner(self, provider: ghidra.app.util.viewer.listingpanel.ListingMarginProvider) -> bool:
        """
        True if this service is the owner of the given provider.
        
        :param ghidra.app.util.viewer.listingpanel.ListingMarginProvider provider: the provider to check
        :return: true if the owner
        :rtype: bool
        """

    @property
    def owner(self) -> jpype.JBoolean:
        ...


class ListingOverviewProviderService(java.lang.Object):

    class_: typing.ClassVar[java.lang.Class]

    def createOverviewProvider(self) -> ghidra.app.util.viewer.listingpanel.ListingOverviewProvider:
        """
        Creates a new overview provider.
        
        :return: the provider
        :rtype: ghidra.app.util.viewer.listingpanel.ListingOverviewProvider
        """

    def isOwner(self, provider: ghidra.app.util.viewer.listingpanel.ListingOverviewProvider) -> bool:
        """
        True if this service is the owner of the given provider.
        
        :param ghidra.app.util.viewer.listingpanel.ListingOverviewProvider provider: the provider to check
        :return: true if the owner
        :rtype: bool
        """
...
class GoToService(java.lang.Object):
    ...
    def setOverrideService(self, override: GoToOverrideService) -> None:
        ...
...
class QueryData(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, queryString: typing.Union[java.lang.String, str], caseSensitive: typing.Union[jpype.JBoolean, bool], includeDynamicLables: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, queryString: typing.Union[java.lang.String, str], caseSensitive: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class GoToServiceListener(java.lang.Object):
    ...
    def gotoCompleted(self, queryString: typing.Union[java.lang.String, str], foundResults: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ClipboardService(java.lang.Object):
    ...
    def deRegisterClipboardContentProvider(self, service: ClipboardContentProviderService) -> None:
        ...

    def registerClipboardContentProvider(self, service: ClipboardContentProviderService) -> None:
        ...
...
class ViewManagerService(ViewService):
    ...
    def setCurrentViewProvider(self, viewName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def viewNameChanged(self, vps: ghidra.app.plugin.core.programtree.ViewProviderService, oldName: typing.Union[java.lang.String, str]) -> None:
        """
...
class BookmarkService(java.lang.Object):
    ...
    def setBookmarksVisible(self, visible: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class CodeViewerService(java.lang.Object):
    ...
    def addButtonPressedListener(self, listener: ButtonPressedListener) -> None:
        """
        Add a listener that is notified when a mouse button is pressed.
        
        :param ButtonPressedListener listener: the listener
        """
    ...
    def addMarginProvider(self, marginProvider: ghidra.app.util.viewer.listingpanel.ListingMarginProvider) -> None:
        """
        Add a provider that shows markers in a program for the portion 
        that is visible.
        
        :param ghidra.app.util.viewer.listingpanel.ListingMarginProvider marginProvider: provider to add
        
        .. deprecated::
        
        clients that wish to be margin providers should now create a 
        :obj:`ListingMarginProviderService`.
        """

    def addOverviewProvider(self, overviewProvider: ghidra.app.util.viewer.listingpanel.ListingOverviewProvider) -> None:
        """
        ...
        :obj:`ListingOverviewProviderService` implementation instead of using this method.
        
        :param ghidra.app.util.viewer.listingpanel.ListingOverviewProvider overviewProvider: provider to add
        """
    ...
    @deprecated("use getListingPanel() to get the field panel")
    def getFieldPanel(self) -> docking.widgets.fieldpanel.FieldPanel:
        ...
        use :meth:`getListingPanel() <.getListingPanel>` to get the field panel
        """
    ...
    def removeButtonPressedListener(self, listener: ButtonPressedListener) -> None:
        """
    ...
    def removeListingPanel(self, listingPanel: ghidra.app.util.viewer.listingpanel.ListingPanel) -> None:
        ...
        :param ghidra.app.util.viewer.listingpanel.ListingPanel listingPanel: the listing panel
        """
    ...
    @deprecated("clients that wish to be margin providers should now create a \n ListingMarginProviderService.")
    def removeMarginProvider(self, marginProvider: ghidra.app.util.viewer.listingpanel.ListingMarginProvider) -> None:
        """
        Remove a provider that shows markers in a program for the portion 
        that is visible.
        
        :param ghidra.app.util.viewer.listingpanel.ListingMarginProvider marginProvider: provider to remove
    ...
    def removeOverviewProvider(self, overviewProvider: ghidra.app.util.viewer.listingpanel.ListingOverviewProvider) -> None:
        """
        Remove a provider that shows an overview of the program.
        
        :param ghidra.app.util.viewer.listingpanel.ListingOverviewProvider overviewProvider: provider to remove
        
        .. seealso::
        
            | :obj:`CodeViewerService.addOverviewProvider(ListingOverviewProvider)`
        """
    ...
    def setCoordinatedListingPanelListener(self, listener: CoordinatedListingPanelListener) -> None:
        """
...
class ConsoleService(java.lang.Object):
    ...
    def addErrorMessage(self, originator: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def addException(self, originator: typing.Union[java.lang.String, str], exc: java.lang.Exception) -> None:
        """
    ...
    def addMessage(self, originator: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def print(self, msg: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def printError(self, errmsg: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def println(self, msg: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def printlnError(self, errmsg: typing.Union[java.lang.String, str]) -> None:
        """
...
class EclipseIntegrationService(java.lang.Object):
    ...
    def handleEclipseError(self, error: typing.Union[java.lang.String, str], askAboutOptions: typing.Union[jpype.JBoolean, bool], t: java.lang.Throwable) -> None:
        """
...
class ProgramTreeService(java.lang.Object):
    ...
    def setGroupSelection(self, *groupPaths: ghidra.program.util.GroupPath) -> None:
        """
    ...
    def setViewedTree(self, treeName: typing.Union[java.lang.String, str]) -> None:
        """
...
class GhidraScriptService(java.lang.Object):
    ...
    def runScript(self, scriptName: typing.Union[java.lang.String, str], listener: ghidra.util.task.TaskListener) -> None:
        ...
...
class StringTranslationService(java.lang.Object):
    ...
    class TranslateOptions(java.lang.Record):
        ...
        def __init__(self, autoTranslate: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def translate(self, program: ghidra.program.model.listing.Program, stringLocations: java.util.List[ghidra.program.util.ProgramLocation], options: StringTranslationService.TranslateOptions) -> None:
        """
...
class StringValidatorQuery(java.lang.Record):
    ...
    @typing.overload
    def __init__(self, stringValue: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, stringValue: typing.Union[java.lang.String, str], stringCharInfo: ghidra.app.plugin.core.strings.StringInfo) -> None:
        ...
...
class StringValidityScore(java.lang.Record):
    ...
    def __init__(self, originalString: typing.Union[java.lang.String, str], transformedString: typing.Union[java.lang.String, str], score: typing.Union[jpype.JDouble, float], threshold: typing.Union[jpype.JDouble, float]) -> None:
        ...
...
class Terminal(java.lang.AutoCloseable):
    ...
    @typing.overload
    def injectDisplayOutput(self, arr: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    @typing.overload
    def setFixedSize(self, cols: typing.Union[jpype.JShort, int], rows: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    @typing.overload
    def setFixedSize(self, cols: typing.Union[jpype.JInt, int], rows: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setMaxScrollBackRows(self, rows: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setSubTitle(self, title: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def terminated(self, exitcode: typing.Union[jpype.JInt, int]) -> None:
        """
...
class VSCodeIntegrationService(java.lang.Object):
    ...
    def addToVSCodeWorkspace(self, workspaceFile: jpype.protocol.SupportsPath, projectDir: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def createVSCodeModuleProject(self, projectDir: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def handleVSCodeError(self, error: typing.Union[java.lang.String, str], askAboutOptions: typing.Union[jpype.JBoolean, bool], t: java.lang.Throwable) -> None:
        """
    ...
    def launchVSCode(self, file: jpype.protocol.SupportsPath) -> None:
        """
...
class AnalyzerAdapter(AbstractAnalyzer):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], priority: AnalysisPriority) -> None:
        ...
...
class DataTypeReference(java.lang.Object):
    ...
    def __init__(self, dataType: ghidra.program.model.data.DataType, fieldName: typing.Union[java.lang.String, str], function: ghidra.program.model.listing.Function, address: ghidra.program.model.address.Address, context: docking.widgets.search.SearchLocationContext) -> None:
        ...

    def getAddress(self) -> ghidra.program.model.address.Address:
        ...

    def getContext(self) -> docking.widgets.search.SearchLocationContext:
        ...
    ...
    @property
    def context(self) -> docking.widgets.search.SearchLocationContext:
        ...
...
class DataTypeReferenceFinder(ghidra.util.classfinder.ExtensionPoint):
    ...
    @typing.overload
    def findReferences(self, program: ghidra.program.model.listing.Program, dataType: ghidra.program.model.data.DataType, callback: java.util.function.Consumer[DataTypeReference], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def findReferences(self, program: ghidra.program.model.listing.Program, dataType: ghidra.program.model.data.DataType, fieldName: typing.Union[java.lang.String, str], callback: java.util.function.Consumer[DataTypeReference], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def findReferences(self, program: ghidra.program.model.listing.Program, fieldMatcher: FieldMatcher, callback: java.util.function.Consumer[DataTypeReference], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Finds references in the current program to specific field of the given :obj:`Composite` type
        in a manner appropriate with the given implementation.
...
class FileImporterService(java.lang.Object):
    ...
    def importFile(self, folder: ghidra.framework.model.DomainFolder, file: jpype.protocol.SupportsPath) -> None:
        """
        Imports the given file into the specified Ghidra project folder.
        
        :param ghidra.framework.model.DomainFolder folder: the folder to use as the destination for the import.  If the value is null, 
    ...
    def importFiles(self, folder: ghidra.framework.model.DomainFolder, files: java.util.List[java.io.File]) -> None:
        """
        Imports the given files into the specified Ghidra project folder.
        
        :param ghidra.framework.model.DomainFolder folder: the Ghidra project folder to store the imported files.  The folder to use as
...
class FunctionComparisonService(java.lang.Object):
    ...
    @typing.overload
    def addToComparison(self, functions: collections.abc.Sequence) -> None:
        """
    ...
    @typing.overload
    def createComparison(self, functions: collections.abc.Sequence) -> None:
        """
...
class MemorySearchService(java.lang.Object):
    ...
    def createMemorySearchProvider(self, navigatable: ghidra.app.nav.Navigatable, input: typing.Union[java.lang.String, str], settings: ghidra.features.base.memsearch.gui.SearchSettings, useSelection: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ProgramLocationPair(java.lang.Object):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, location: ghidra.program.util.ProgramLocation) -> None:
        ...
...
class DebuggerAutoMappingService(java.lang.Object):
    ...
    def setAutoMapSpec(self, spec: ghidra.debug.api.action.AutoMapSpec) -> None:
        """
...
class DebuggerStaticMappingService(java.lang.Object):
    ...
    class MappedAddressRange(java.lang.Comparable[DebuggerStaticMappingService.MappedAddressRange]):
        ...
        def __init__(self, srcRange: ghidra.program.model.address.AddressRange, dstRange: ghidra.program.model.address.AddressRange) -> None:
            ...
    ...
    def addChangeListener(self, l: ghidra.debug.api.modules.DebuggerStaticMappingChangeListener) -> None:
        """
    ...
    def addIdentityMapping(self, from_: ghidra.trace.model.Trace, toProgram: ghidra.program.model.listing.Program, lifespan: ghidra.trace.model.Lifespan, truncateExisting: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def addMapping(self, from_: ghidra.trace.model.TraceLocation, to: ghidra.program.util.ProgramLocation, length: typing.Union[jpype.JLong, int], truncateExisting: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def addMapping(self, entry: ghidra.debug.api.modules.MapEntry[typing.Any, typing.Any], truncateExisting: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def addMappings(self, entries: collections.abc.Sequence, monitor: ghidra.util.task.TaskMonitor, truncateExisting: typing.Union[jpype.JBoolean, bool], description: typing.Union[java.lang.String, str]) -> None:
        ...

    def addModuleMappings(self, entries: collections.abc.Sequence, monitor: ghidra.util.task.TaskMonitor, truncateExisting: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def addRegionMappings(self, entries: collections.abc.Sequence, monitor: ghidra.util.task.TaskMonitor, truncateExisting: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Add several static mappings (relocations)
    ...
    def addSectionMappings(self, entries: collections.abc.Sequence, monitor: ghidra.util.task.TaskMonitor, truncateExisting: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Add several static mappings (relocations)
    ...
    def removeChangeListener(self, l: ghidra.debug.api.modules.DebuggerStaticMappingChangeListener) -> None:
        """
...
class DebuggerConsoleService(java.lang.Object):
    ...
    def addResolutionAction(self, action: docking.action.DockingActionIf) -> None:
        """
    ...
    @typing.overload
    def log(self, icon: javax.swing.Icon, message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def log(self, icon: javax.swing.Icon, message: typing.Union[java.lang.String, str], error: java.lang.Throwable) -> None:
        """
    ...
    @typing.overload
    def log(self, icon: javax.swing.Icon, message: typing.Union[java.lang.String, str], context: docking.ActionContext) -> None:
        """
    ...
    @typing.overload
    def log(self, icon: javax.swing.Icon, message: typing.Union[java.lang.String, str], error: java.lang.Throwable, context: docking.ActionContext) -> None:
        """
    ...
    def removeFromLog(self, context: docking.ActionContext) -> None:
        """
    ...
    def removeResolutionAction(self, action: docking.action.DockingActionIf) -> None:
        """
        Remove an action
...
class DebuggerControlService(java.lang.Object):
    ...
    class ControlModeChangeListener(java.lang.Object):
        ...
        def modeChanged(self, trace: ghidra.trace.model.Trace, mode: ghidra.debug.api.control.ControlMode) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def addModeChangeListener(self, listener: DebuggerControlService.ControlModeChangeListener) -> None:
        ...
    ...
    def removeModeChangeListener(self, listener: DebuggerControlService.ControlModeChangeListener) -> None:
        ...

    def setCurrentMode(self, trace: ghidra.trace.model.Trace, mode: ghidra.debug.api.control.ControlMode) -> None:
        ...
...
class DebuggerTraceManagerService(java.lang.Object):
    ...
    class BooleanChangeAdapter(ghidra.util.TriConsumer[java.lang.Boolean, java.lang.Boolean, java.lang.Void]):
        ...
        def changed(self, value: typing.Union[java.lang.Boolean, bool]) -> None:
            """
    ...
    @typing.overload
    def activate(self, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> None:
        """
    ...
    @typing.overload
    def activate(self, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates, cause: DebuggerTraceManagerService.ActivationCause) -> None:
        """
    ...
    def activateFrame(self, frameLevel: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def activateObject(self, object: ghidra.trace.model.target.TraceObject) -> None:
        """
    ...
    def activatePath(self, path: ghidra.trace.model.target.path.KeyPath) -> None:
        """
    ...
    def activatePlatform(self, platform: ghidra.trace.model.guest.TracePlatform) -> None:
        """
    ...
    def activateSnap(self, snap: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def activateTarget(self, target: ghidra.debug.api.target.Target) -> None:
        """
    ...
    def activateThread(self, thread: ghidra.trace.model.thread.TraceThread) -> None:
        """
    ...
    def activateTime(self, time: ghidra.trace.model.time.schedule.TraceSchedule) -> None:
        """
    ...
    def activateTrace(self, trace: ghidra.trace.model.Trace) -> None:
        """
    ...
    def addAutoCloseOnTerminateChangeListener(self, listener: DebuggerTraceManagerService.BooleanChangeAdapter) -> None:
        """
    ...
    def addSaveTracesByDefaultChangeListener(self, listener: DebuggerTraceManagerService.BooleanChangeAdapter) -> None:
        """
    ...
    def closeOtherTraces(self, keep: ghidra.trace.model.Trace) -> None:
        """
    ...
    def closeTrace(self, trace: ghidra.trace.model.Trace) -> None:
        """
    ...
    def closeTraceNoConfirm(self, trace: ghidra.trace.model.Trace) -> None:
        """
    ...
    @typing.overload
    def openTrace(self, trace: ghidra.trace.model.Trace) -> None:
        """
        Open a trace
    ...
    def removeAutoCloseOnTerminateChangeListener(self, listener: DebuggerTraceManagerService.BooleanChangeAdapter) -> None:
        """
    ...
    def removeSaveTracesByDefaultChangeListener(self, listener: DebuggerTraceManagerService.BooleanChangeAdapter) -> None:
        """
    ...
    def setAutoCloseOnTerminate(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setSaveTracesByDefault(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DebuggerEmulationService(java.lang.Object):
    ...
    class RecordEmulationResult(java.lang.Record, DebuggerEmulationService.EmulationResult):
        ...
        def __init__(self, schedule: ghidra.trace.model.time.schedule.TraceSchedule, snapshot: typing.Union[jpype.JLong, int], error: java.lang.Throwable) -> None:
            ...
    ...
    class CachedEmulator(java.lang.Record):
        ...
        @typing.overload
        def __init__(self, trace: ghidra.trace.model.Trace, emulator: ghidra.pcode.emu.PcodeMachine[typing.Any], writer: ghidra.pcode.exec_.trace.TraceEmulationIntegration.Writer) -> None:
            ...

        @typing.overload
        def __init__(self, trace: ghidra.trace.model.Trace, emulator: ghidra.pcode.emu.PcodeMachine[typing.Any], writer: ghidra.pcode.exec_.trace.TraceEmulationIntegration.Writer, version: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    class EmulatorStateListener(java.lang.Object):
        ...
        def running(self, emu: DebuggerEmulationService.CachedEmulator) -> None:
            """
        ...
        def stopped(self, emu: DebuggerEmulationService.CachedEmulator) -> None:
            """
    ...
    def addStateListener(self, listener: DebuggerEmulationService.EmulatorStateListener) -> None:
        """
    ...
    def removeStateListener(self, listener: DebuggerEmulationService.EmulatorStateListener) -> None:
        """
    ...
    def setEmulatorFactory(self, factory: ghidra.debug.api.emulation.EmulatorFactory) -> None:
        """
...
class DebuggerListingService(CodeViewerService):
    ...
    class LocationTrackingSpecChangeListener(java.lang.Object):
        ...
        def locationTrackingSpecChanged(self, spec: ghidra.debug.api.action.LocationTrackingSpec) -> None:
            """
    ...
    def addTrackingSpecChangeListener(self, listener: DebuggerListingService.LocationTrackingSpecChangeListener) -> None:
        """
    ...
    def removeTrackingSpecChangeListener(self, listener: DebuggerListingService.LocationTrackingSpecChangeListener) -> None:
        """
...
class DebuggerLogicalBreakpointService(java.lang.Object):
    ...
    def addChangeListener(self, l: ghidra.debug.api.breakpoint.LogicalBreakpointsChangeListener) -> None:
        """
    ...
    def removeChangeListener(self, l: ghidra.debug.api.breakpoint.LogicalBreakpointsChangeListener) -> None:
        """
...
class DebuggerPlatformService(java.lang.Object):
    ...
    def setCurrentMapperFor(self, trace: ghidra.trace.model.Trace, focus: ghidra.trace.model.target.TraceObject, mapper: ghidra.debug.api.platform.DebuggerPlatformMapper, snap: typing.Union[jpype.JLong, int]) -> None:
        """
...
class DebuggerTargetService(java.lang.Object):
    ...
    def addTargetPublicationListener(self, listener: ghidra.debug.api.target.TargetPublicationListener) -> None:
        """
    ...
    def publishTarget(self, target: ghidra.debug.api.target.Target) -> None:
        """
    ...
    def removeTargetPublicationListener(self, listener: ghidra.debug.api.target.TargetPublicationListener) -> None:
        """
    ...
    def withdrawTarget(self, target: ghidra.debug.api.target.Target) -> None:
        """
...
class DebuggerWatchesService(java.lang.Object):
    ...
    def removeWatch(self, watch: ghidra.debug.api.watch.WatchRow) -> None:
        """
        Remove a watch
...
class ProgressService(java.lang.Object):
    ...
    def addProgressListener(self, listener: ghidra.debug.api.progress.ProgressListener) -> None:
        """
    ...
    def removeProgressListener(self, listener: ghidra.debug.api.progress.ProgressListener) -> None:
        """
...
class TraceRmiService(java.lang.Object):
    ...
    def addTraceServiceListener(self, listener: ghidra.debug.api.tracermi.TraceRmiServiceListener) -> None:
        """
    ...
    def removeTraceServiceListener(self, listener: ghidra.debug.api.tracermi.TraceRmiServiceListener) -> None:
        """
    ...
    def setServerAddress(self, serverAddress: java.net.SocketAddress) -> None:
        """
...
__all__ = ["FieldMatcher", "AbstractAnalyzer", "Analyzer", "AnalyzerType", "AnalysisPriority", "DataTypeArchiveService", "DataTypeManagerService", "DataTypeQueryService", "BlockModelService", "BlockModelServiceListener", "ProgramManager", "CodeFormatService", "HoverService", "ButtonPressedListener", "MarkerService", "MarkerSet", "ListingMarginProviderService", "ListingOverviewProviderService", "MarkerDescriptor", "GoToService", "QueryData", "GoToServiceListener", "GoToOverrideService", "CoordinatedListingPanelListener", "ClipboardContentProviderService", "ClipboardService", "FieldMouseHandlerService", "ViewManagerService", "ViewService", "BookmarkService", "CodeViewerService", "ConsoleService", "DataService", "EclipseIntegrationService", "GraphDisplayBroker", "ProgramTreeService", "NavigationHistoryService", "GhidraScriptService", "StringTranslationService", "StringValidatorService", "StringValidatorQuery", "StringValidityScore", "Terminal", "TerminalService", "VSCodeIntegrationService", "AnalyzerAdapter", "DataTypeReference", "DataTypeReferenceFinder", "FileImporterService", "FileSystemBrowserService", "FunctionComparisonService", "MemorySearchService", "ProgramLocationPair", "DebuggerAutoMappingService", "DebuggerStaticMappingService", "DebuggerConsoleService", "DebuggerControlService", "DebuggerTraceManagerService", "DebuggerEmulationService", "DebuggerListingService", "DebuggerLogicalBreakpointService", "DebuggerPlatformService", "DebuggerTargetService", "DebuggerWatchesService", "ProgressService", "TraceRmiLauncherService", "TraceRmiService", "InternalTraceRmiService"]
