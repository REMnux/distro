...
class FunctionDatabase(java.lang.AutoCloseable):
    ...
    class BSimError(java.lang.Object):
        ...
        def __init__(self, cat: FunctionDatabase.ErrorCategory, msg: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    @staticmethod
    def checkSettingsForQuery(manage: ghidra.features.bsim.query.description.DescriptionManager, info: ghidra.features.bsim.query.description.DatabaseInformation) -> None:
        ...
...
class BSimServerInfo(java.lang.Comparable[BSimServerInfo]):
    ...
    @typing.overload
    def __init__(self, dbType: BSimServerInfo.DBType, userinfo: typing.Union[java.lang.String, str], host: typing.Union[java.lang.String, str], port: typing.Union[jpype.JInt, int], dbName: typing.Union[java.lang.String, str]) -> None:
        """
        ...
        :param jpype.JInt or int port: port number (ignored for :obj:`DBType.file`, -1 for default)
    ...
    @typing.overload
    def __init__(self, dbType: BSimServerInfo.DBType, host: typing.Union[java.lang.String, str], port: typing.Union[jpype.JInt, int], dbName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dbName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setUserInfo(self, bds: org.apache.commons.dbcp2.BasicDataSource) -> None:
        ...
...
class BSimPostgresDBConnectionManager(java.lang.Object):
    ...
    class BSimPostgresDataSource(BSimJDBCDataSource):
        ...
        def initializeFrom(self, otherDs: BSimPostgresDBConnectionManager.BSimPostgresDataSource) -> None:
            ...

        def setPassword(self, username: typing.Union[java.lang.String, str], newPassword: jpype.JArray[jpype.JChar]) -> None:
            """
        ...
        def setPreferredUserName(self, userName: typing.Union[java.lang.String, str]) -> None:
            ...
...
class GenSignatures(java.lang.Object):
    ...
    def __init__(self, callgraph: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def addDateColumnName(self, name: typing.Union[java.lang.String, str]) -> None:
        ...

    def addExecutableCategories(self, names: java.util.List[java.lang.String]) -> None:
        ...

    def addFunctionTags(self, names: java.util.List[java.lang.String]) -> None:
        ...
    ...
    def openProgram(self, prog: ghidra.program.model.listing.Program, nmover: typing.Union[java.lang.String, str], archover: typing.Union[java.lang.String, str], compover: typing.Union[java.lang.String, str], repo: typing.Union[java.lang.String, str], path: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def scanFunction(self, func: ghidra.program.model.listing.Function) -> None:
        """
    ...
    def scanFunctions(self, functions: java.util.Iterator[ghidra.program.model.listing.Function], countestimate: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def scanFunctionsMetadata(self, iter: java.util.Iterator[ghidra.program.model.listing.Function], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def setVectorFactory(self, vFactory: generic.lsh.vector.LSHVectorFactory) -> None:
        ...
...
class DecompileFunctionTask(java.lang.Object):
    ...
    def decompile(self, func: ghidra.program.model.listing.Function, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    def initializeGlobal(self, program: ghidra.program.model.listing.Program) -> None:
        ...
...
class ParallelDecompileTask(java.lang.Object):
    ...
    def __init__(self, prog: ghidra.program.model.listing.Program, mon: ghidra.util.task.TaskMonitor, ftask: DecompileFunctionTask) -> None:
        ...

    def decompile(self, iter: java.util.Iterator[ghidra.program.model.listing.Function], functionCount: typing.Union[jpype.JInt, int]) -> None:
        ...


class BSimDBConnectTaskManager(java.lang.Object):
    """
    ...
    def __init__(self, serverInfo: BSimServerInfo) -> None:
        ...

    def getConnection(self, connectionSupplier: BSimDBConnectTaskManager.DBConnectionSupplier) -> java.sql.Connection:
        """
        Initiate a DB connection.
        
        :param BSimDBConnectTaskManager.DBConnectionSupplier connectionSupplier: DB connection supplier
        :return: DB connection
        :rtype: java.sql.Connection
        :raises SQLException: if a database connection error occurred
...
class BSimClientFactory(java.lang.Object):
    ...
    @staticmethod
    def checkBSimServerURL(url: java.net.URL) -> None:
        """
...
class BSimControlLaunchable(ghidra.GhidraLaunchable):
    ...
    class IOThread(java.lang.Thread):
        ...
        def __init__(self, input: java.io.InputStream, suppressOut: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def run(self, params: jpype.JArray[java.lang.String]) -> None:
        """
...
class ChildMatchRecord(java.lang.Comparable[ChildMatchRecord]):
    ...
    def __init__(self, match: ghidra.features.bsim.gui.search.results.BSimMatchResult, vec: generic.lsh.vector.LSHVector) -> None:
        ...
    ...
    def setSignificanceWithChildren(self, newSignif: typing.Union[jpype.JDouble, float]) -> None:
        ...

    def setSimilarityWithChildren(self, newSim: typing.Union[jpype.JDouble, float]) -> None:
        ...
...
class CompareSignatures(java.lang.Object):
    ...
    def __init__(self, vFactory: generic.lsh.vector.LSHVectorFactory) -> None:
        ...
    ...
    def run(self, args: jpype.JArray[java.lang.String]) -> None:
        ...
...
class ServerConfig(java.lang.Object):
    ...
    class ConfigLine(java.lang.Object):
        ...
        def parseUptoKey(self, line: typing.Union[java.lang.String, str]) -> None:
            ...

        def parseValue(self, line: typing.Union[java.lang.String, str]) -> None:
            ...

        def skipValueParseComment(self, line: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class ConnectLine(java.lang.Comparable[ServerConfig.ConnectLine]):
        ...
        def emit(self, writer: java.io.Writer) -> None:
            """
        ...
        def parse(self, line: typing.Union[java.lang.String, str]) -> None:
            """
        ...
        def restoreXml(self, el: ghidra.xml.XmlElement) -> None:
            """
    ...
    class IdentLine(java.lang.Object):
        ...
        @typing.overload
        def __init__(self, mName: typing.Union[java.lang.String, str], sysName: typing.Union[java.lang.String, str], rName: typing.Union[java.lang.String, str]) -> None:
            ...
        ...
        def setSystemName(self, sysName: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    def addKey(self, key: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def patchConfig(self, inFile: jpype.protocol.SupportsPath, outFile: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def patchConnect(self, inFile: jpype.protocol.SupportsPath, outFile: jpype.protocol.SupportsPath) -> None:
        """
    ...
    @staticmethod
    def patchIdent(inFile: jpype.protocol.SupportsPath, outFile: jpype.protocol.SupportsPath, mapName: typing.Union[java.lang.String, str], systemName: typing.Union[java.lang.String, str], roleName: typing.Union[java.lang.String, str], addUser: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def scanConfig(self, inFile: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def scanConnect(self, inFile: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def setHostAuthentication(self, val: typing.Union[java.lang.String, str], options: typing.Union[java.lang.String, str]) -> None:
        ...

    def setLocalAuthentication(self, val: typing.Union[java.lang.String, str], options: typing.Union[java.lang.String, str]) -> None:
        ...
...
__all__ = ["FunctionDatabase", "BSimServerInfo", "BSimPostgresDBConnectionManager", "GenSignatures", "LSHException", "SQLFunctionDatabase", "BSimJDBCDataSource", "DecompileFunctionTask", "ParallelDecompileTask", "BSimDBConnectTaskManager", "BSimClientFactory", "BSimControlLaunchable", "BSimInitializer", "BsimPluginPackage", "ChildMatchRecord", "CompareSignatures", "MinimalErrorLogger", "ServerConfig"]
