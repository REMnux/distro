...
class LayeredColorModel(ghidra.app.util.viewer.listingpanel.ListingBackgroundColorModel):
    ...
    def __init__(self, primary: ghidra.app.util.viewer.listingpanel.ListingBackgroundColorModel, secondary: ghidra.app.util.viewer.listingpanel.ListingBackgroundColorModel) -> None:
        ...
...
class CodeViewerProvider(ghidra.framework.plugintool.NavigatableComponentProviderAdapter, ghidra.app.util.viewer.listingpanel.ProgramLocationListener, ghidra.app.util.viewer.listingpanel.ProgramSelectionListener, docking.dnd.Draggable, docking.dnd.Droppable, javax.swing.event.ChangeListener, ghidra.app.util.viewer.listingpanel.StringSelectionListener, docking.actions.PopupActionProvider):
    ...
    def __init__(self, plugin: CodeBrowserPluginInterface, formatMgr: ghidra.app.util.viewer.format.FormatManager, isConnected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def addMarginService(self, service: ghidra.app.services.ListingMarginProviderService) -> None:
        ...

    def addOverviewProvider(self, overviewProvider: ghidra.app.util.viewer.listingpanel.ListingOverviewProvider) -> None:
        ...

    def addOverviewService(self, service: ghidra.app.services.ListingOverviewProviderService) -> None:
        ...
    ...
    def setClipboardService(self, service: ghidra.app.services.ClipboardService) -> None:
        ...
    ...
    def setOtherPanel(self, lp: ghidra.app.util.viewer.listingpanel.ListingPanel) -> None:
        ...
...
class CodeBrowserPluginInterface(java.lang.Object):
    ...
    def broadcastHighlightChanged(self, provider: CodeViewerProvider, highlight: ghidra.program.util.ProgramSelection) -> None:
        ...

    def broadcastLocationChanged(self, provider: CodeViewerProvider, loc: ghidra.program.util.ProgramLocation) -> None:
        ...

    def broadcastSelectionChanged(self, provider: CodeViewerProvider, selection: ghidra.program.util.ProgramSelection) -> None:
        ...
    ...
    def getViewManager(self, provider: CodeViewerProvider) -> ghidra.app.services.ViewManagerService:
        ...

    def isDisposed(self) -> bool:
        ...

    def providerClosed(self, provider: CodeViewerProvider) -> None:
        ...
...
class ListingMiddleMouseHighlightProvider(ghidra.app.services.ButtonPressedListener, ghidra.framework.options.OptionsChangeListener, ghidra.app.util.ListingHighlightProvider):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, repaintComponent: java.awt.Component) -> None:
        ...
...
class AddressRangeInfo(java.lang.Record):
    ...
    def __init__(self, min: ghidra.program.model.address.Address, max: ghidra.program.model.address.Address, size: typing.Union[jpype.JLong, int], isSameByte: typing.Union[jpype.JBoolean, bool], numRefsTo: typing.Union[jpype.JInt, int], numRefsFrom: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class SelectEndpointsAction(docking.action.DockingAction):
    ...
    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, program: ghidra.program.model.listing.Program, model: AddressRangeTableModel, endpoint: SelectEndpointsAction.RangeEndpoint) -> None:
        """
...
class CodeViewerActionContext(ghidra.app.context.ListingActionContext):
    ...
    @typing.overload
    def __init__(self, provider: CodeViewerProvider) -> None:
        ...

    @typing.overload
    def __init__(self, provider: CodeViewerProvider, location: ghidra.program.util.ProgramLocation) -> None:
        ...
...
class CodeViewerLocationMemento(ghidra.app.nav.LocationMemento):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, location: ghidra.program.util.ProgramLocation, cursorOffset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class MarkAndSelectionAction(docking.action.ToggleDockingAction):
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], group: typing.Union[java.lang.String, str], subGroup: typing.Union[java.lang.String, str]) -> None:
        ...
...
class MarkerServiceBackgroundColorModel(ghidra.app.util.viewer.listingpanel.ListingBackgroundColorModel):
    ...
    @typing.overload
    def __init__(self, markerService: ghidra.app.services.MarkerService, program: ghidra.program.model.listing.Program, indexMap: ghidra.app.util.viewer.util.AddressIndexMap) -> None:
        ...

    @typing.overload
    def __init__(self, markerService: ghidra.app.services.MarkerService, indexMap: ghidra.app.util.viewer.util.AddressIndexMap) -> None:
        ...
...
__all__ = ["LayeredColorModel", "CodeViewerProvider", "CodeBrowserPluginInterface", "ListingMiddleMouseHighlightProvider", "AbstractCodeBrowserPlugin", "AddressRangeBytesTableColumn", "AddressRangeInfo", "AddressRangeCodeUnitTableColumn", "AddressRangeTableModel", "CodeBrowserPlugin", "SelectEndpointsAction", "CodeBrowserSelectionPlugin", "CodeViewerActionContext", "CodeViewerLocationMemento", "MarkAndSelectionAction", "MarkerServiceBackgroundColorModel", "OtherPanelContext"]
