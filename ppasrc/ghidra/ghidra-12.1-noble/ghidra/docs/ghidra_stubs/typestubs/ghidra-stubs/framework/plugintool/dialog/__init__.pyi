...
class ManagePluginsDialog(docking.ReusableDialogComponentProvider):
    ...
    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, addSaveActions: typing.Union[jpype.JBoolean, bool], isNewTool: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, pluginConfigurationModel: ghidra.framework.plugintool.PluginConfigurationModel, addSaveActions: typing.Union[jpype.JBoolean, bool], isNewTool: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class KeyBindingsPanel(javax.swing.JPanel):
    ...
    @typing.type_check_only
    class KeyBindingsTableModel(docking.widgets.table.GDynamicColumnTableModel[docking.action.DockingActionIf, java.lang.Object]):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, actions: java.util.List[docking.action.DockingActionIf]) -> None:
            ...
...
class PluginInstallerDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], tool: ghidra.framework.plugintool.PluginTool, model: ghidra.framework.plugintool.PluginConfigurationModel, pluginDescriptions: java.util.List[ghidra.framework.plugintool.util.PluginDescription]) -> None:
        """
...
class SaveToolConfigDialog(docking.DialogComponentProvider, javax.swing.event.ListSelectionListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, toolServices: ghidra.framework.model.ToolServices) -> None:
        ...

    def didCancel(self) -> bool:
        ...

    def show(self, name: typing.Union[java.lang.String, str], newDefaultName: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["ManagePluginsDialog", "PluginManagerComponent", "AbstractDetailsPanel", "IconMap", "KeyBindingsPanel", "PluginDetailsPanel", "PluginInstallerTableModel", "PluginInstallerDialog", "SaveToolConfigDialog", "ToolIconUrlRenderer"]
