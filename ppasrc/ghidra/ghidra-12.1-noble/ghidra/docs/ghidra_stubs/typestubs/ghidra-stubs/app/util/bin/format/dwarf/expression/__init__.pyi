...
class DWARFExpressionException(java.lang.Exception):
    ...
    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], expr: DWARFExpression, instrIndex: typing.Union[jpype.JInt, int], cause: java.lang.Throwable) -> None:
        ...
    ...
    def setExpression(self, expr: DWARFExpression) -> None:
        ...

    def setInstructionIndex(self, instrIndex: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DWARFExpressionInstruction(java.lang.Object):
    ...
    def __init__(self, op: DWARFExpressionOpCode, operandTypes: jpype.JArray[DWARFExpressionOperandType], operands: jpype.JArray[jpype.JLong], blob: jpype.JArray[jpype.JByte], offset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DWARFExpressionEvaluator(java.lang.Object):
    ...
    def __init__(self, cu: ghidra.app.util.bin.format.dwarf.DWARFCompilationUnit) -> None:
        ...

    @typing.overload
    def evaluate(self, exprBytes: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    @typing.overload
    def evaluate(self, exprBytes: jpype.JArray[jpype.JByte], *stackArgs: typing.Union[jpype.JLong, int]) -> None:
        """
        Executes the instructions found in the expression.
    ...
    @typing.overload
    def evaluate(self, expr: DWARFExpression, *stackArgs: typing.Union[jpype.JLong, int]) -> None:
        """
        Executes the instructions found in the expression.
    ...
    @typing.overload
    def evaluate(self, expr: DWARFExpression) -> None:
        ...
    ...
    @typing.overload
    def push(self, addr: ghidra.program.model.address.Address) -> None:
        ...

    @typing.overload
    def push(self, reg: ghidra.program.model.lang.Register) -> None:
        ...

    @typing.overload
    def push(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def push(self, l: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def push(self, val: java.lang.Object) -> None:
        ...
    ...
    def setFrameBaseStackLocation(self, offset: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setFrameBaseVal(self, frameBaseVal: ghidra.program.model.pcode.Varnode) -> None:
        ...

    def setMaxStepCount(self, maxStepCount: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setValReader(self, valReader: DWARFExpressionEvaluator.ValueReader) -> None:
        ...
...
class DWARFExpressionTerminalDerefException(DWARFExpressionUnsupportedOpException):
    ...
    def __init__(self, op: DWARFExpressionInstruction, varnode: ghidra.program.model.pcode.Varnode) -> None:
        ...
...
class DWARFExpressionUnsupportedOpException(DWARFExpressionException):
    ...
    def __init__(self, instr: DWARFExpressionInstruction) -> None:
        ...
...
__all__ = ["DWARFExpressionException", "DWARFExpressionOperandType", "DWARFExpressionOpCode", "DWARFExpression", "DWARFExpressionInstruction", "DWARFExpressionEvaluator", "DWARFExpressionValueException", "DWARFExpressionTerminalDerefException", "DWARFExpressionUnsupportedOpException"]
