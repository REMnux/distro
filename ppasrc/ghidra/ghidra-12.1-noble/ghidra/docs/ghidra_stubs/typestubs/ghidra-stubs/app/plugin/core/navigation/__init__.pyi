...
class FindAppliedDataTypesService(java.lang.Object):
    ...
    @typing.overload
    def findAndDisplayAppliedDataTypeAddresses(self, dataType: ghidra.program.model.data.DataType) -> None:
        """
    ...
    @typing.overload
    def findAndDisplayAppliedDataTypeAddresses(self, dataType: ghidra.program.model.data.DataType, fieldName: typing.Union[java.lang.String, str]) -> None:
        """
        Tells this service to find all places where the given datatype is applied **and** will
        display the results of the search.
    ...
    @typing.overload
    def findAndDisplayAppliedDataTypeAddresses(self, dataType: ghidra.program.model.data.DataType, fieldMatcher: ghidra.app.services.FieldMatcher) -> None:
        """
        Tells this service to find all places where the given datatype is applied **and** will
        display the results of the search.
...
class NavigationOptions(ghidra.framework.options.OptionsChangeListener):
    ...
    @typing.overload
    def __init__(self, optionsService: docking.options.OptionsService) -> None:
        ...
...
class AbstractNextPreviousAction(ghidra.app.context.NavigatableContextAction):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], subGroup: typing.Union[java.lang.String, str]) -> None:
        ...
...
class NavigationHistoryPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.NavigationHistoryService, ghidra.app.nav.NavigatableRemovalListener, ghidra.framework.options.OptionsChangeListener):
    ...
    def writeDataState(self, saveState: ghidra.framework.options.SaveState, navigatable: ghidra.app.nav.Navigatable, historyList: NavigationHistoryPlugin.HistoryList) -> None:
        ...
...
class NextHighlightedRangeAction(ghidra.app.nav.NextRangeAction):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, owner: typing.Union[java.lang.String, str], navOptions: NavigationOptions) -> None:
        ...
...
class NextPrevCodeUnitPlugin(ghidra.framework.plugintool.Plugin):
    ...
    * Next-Previous Bookmark
    ...
    class InvertStateAction(docking.action.ToggleDockingAction):
        ...
        def __init__(self, subGroup: typing.Union[java.lang.String, str]) -> None:
            ...
...
class NextPreviousBookmarkAction(docking.menu.MultiStateDockingAction[java.lang.String]):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, owner: typing.Union[java.lang.String, str], subGroup: typing.Union[java.lang.String, str]) -> None:
        ...

    def setDirection(self, isForward: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setInverted(self, isInverted: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class NextSelectedRangeAction(ghidra.app.nav.NextRangeAction):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, ownerName: typing.Union[java.lang.String, str], navOptions: NavigationOptions) -> None:
        ...
...
__all__ = ["FindAppliedDataTypesService", "GoToAddressLabelPlugin", "NavigationOptions", "AbstractNextPreviousAction", "FunctionUtils", "NavigationHistoryPlugin", "NextHighlightedRangeAction", "NextPrevAddressPlugin", "NextPrevCodeUnitPlugin", "NextPreviousBookmarkAction", "NextPreviousSameBytesAction", "NextPrevHighlightRangePlugin", "PreviousHighlightedRangeAction", "NextPrevSelectedRangePlugin", "NextSelectedRangeAction", "PreviousSelectedRangeAction", "NextPreviousDefinedDataAction", "NextPreviousFunctionAction", "NextPreviousInstructionAction", "NextPreviousLabelAction", "NextPreviousUndefinedAction", "ProgramStartingLocationOptions", "ProgramStartingLocationPlugin", "ProviderNavigationPlugin"]
