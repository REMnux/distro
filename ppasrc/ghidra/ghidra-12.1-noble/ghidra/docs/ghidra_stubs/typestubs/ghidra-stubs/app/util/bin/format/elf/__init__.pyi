...
class ElfDynamicType(java.lang.Object):
    ...
    def __init__(self, value: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], valueType: ElfDynamicType.ElfDynamicValueType) -> None:
        ...

    @staticmethod
    def addDefaultTypes(dynamicTypeMap: collections.abc.Mapping) -> None:
        ...

    @staticmethod
    def addDynamicType(type: ElfDynamicType, dynamicTypeMap: collections.abc.Mapping) -> None:
        """
...
class ElfHeader(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, provider: ghidra.app.util.bin.ByteProvider, errorConsumer: java.util.function.Consumer[java.lang.String]) -> None:
        """
    ...
    def parseSectionHeaders(self) -> None:
        ...
...
class ElfDynamic(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, elf: ElfHeader) -> None:
        """
    ...
    @typing.overload
    def __init__(self, tag: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JLong, int], elf: ElfHeader) -> None:
        """
    ...
    @typing.overload
    def __init__(self, tag: ElfDynamicType, value: typing.Union[jpype.JLong, int], elf: ElfHeader) -> None:
        """
...
class ElfProgramHeaderType(java.lang.Object):
    ...
    def __init__(self, value: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str]) -> None:
        ...

    @staticmethod
    def addDefaultTypes(programHeaderTypeMap: collections.abc.Mapping) -> None:
        ...

    @staticmethod
    def addProgramHeaderType(type: ElfProgramHeaderType, programHeaderTypeMap: collections.abc.Mapping) -> None:
        """
...
class ElfSectionHeaderType(java.lang.Object):
    ...
    @staticmethod
    def addSectionHeaderType(type: ElfSectionHeaderType, sectionHeaderTypeMap: collections.abc.Mapping) -> None:
        """
...
class ElfSectionHeader(ghidra.app.util.bin.StructConverter, ghidra.app.util.bin.format.MemoryLoadable):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, header: ElfHeader) -> None:
        """
    ...
    def setAddress(self, addr: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ElfStringTable(ElfFileSection):
    ...
    def __init__(self, header: ElfHeader, stringTableSection: ElfSectionHeader, fileOffset: typing.Union[jpype.JLong, int], addrOffset: typing.Union[jpype.JLong, int], length: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ElfDynamicTable(ElfFileSection):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, header: ElfHeader, fileOffset: typing.Union[jpype.JLong, int], addrOffset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def addDynamic(self, dyn: ElfDynamic, index: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ElfSymbol(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, symbolIndex: typing.Union[jpype.JInt, int], symbolTable: ElfSymbolTable, header: ElfHeader) -> None:
        """
    ...
    def initSymbolName(self, reader: ghidra.app.util.bin.BinaryReader, stringTable: ElfStringTable) -> None:
        """
...
class ElfLoadHelper(java.lang.Object):
    ...
    @typing.overload
    def log(self, msg: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setElfSymbolAddress(self, elfSymbol: ElfSymbol, address: ghidra.program.model.address.Address) -> None:
        """
...
class ElfRelocation(ghidra.app.util.bin.StructConverter):
    ...
    def setType(self, typeId: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ElfDefaultGotPltMarkup(java.lang.Object):
    ...
    def __init__(self, elfLoadHelper: ElfLoadHelper) -> None:
        ...
    ...
    def processLinkageTable(self, pltName: typing.Union[java.lang.String, str], minAddress: ghidra.program.model.address.Address, maxAddress: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
__all__ = ["ElfDynamicType", "ElfRelocationTable", "ElfHeader", "ElfFileSection", "ElfDynamic", "ElfProgramHeaderType", "ElfSectionHeaderType", "ElfSectionHeader", "ElfProgramHeader", "ElfStringTable", "ElfSymbolTable", "ElfDynamicTable", "ElfException", "ElfSymbol", "ElfLoadHelper", "ElfCompressedSectionHeader", "ElfRelocation", "AndroidElfRelocationData", "AndroidElfRelocationGroup", "AndroidElfRelocationOffset", "AndroidElfRelocationTableDataType", "ElfConstants", "ElfDefaultGotPltMarkup", "ElfProgramHeaderConstants", "ElfRelrRelocationTableDataType", "ElfSectionHeaderConstants", "GnuConstants", "GnuVerdaux", "GnuVerdef", "GnuVernaux", "GnuVerneed"]
