...
class ElfLoadAdapter(java.lang.Object):
    ...
    def addDynamicTypes(self, dynamicTypeMap: collections.abc.Mapping) -> None:
        """
    ...
    def addLoadOptions(self, elf: ghidra.app.util.bin.format.elf.ElfHeader, options: java.util.List[ghidra.app.util.Option]) -> None:
        """
    ...
    def addProgramHeaderTypes(self, programHeaderTypeMap: collections.abc.Mapping) -> None:
        """
    ...
    def addSectionHeaderTypes(self, sectionHeaderTypeMap: java.util.HashMap[java.lang.Integer, ghidra.app.util.bin.format.elf.ElfSectionHeaderType]) -> None:
        """
...
__all__ = ["ElfLoadAdapter", "ElfExtension", "ElfExtensionFactory"]
