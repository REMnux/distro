...
class PopupRegulator(java.lang.Object, typing.Generic[V, E]):
    ...
    def __init__(self, popupSupplier: PopupSource[V, E]) -> None:
        ...
    ...
    def setPopupDelay(self, delayMs: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ToolTipInfo(java.lang.Object, typing.Generic[T]):
    ...
    def __init__(self, event: java.awt.event.MouseEvent, t: T) -> None:
        ...
...
__all__ = ["PopupRegulator", "ToolTipInfo", "PopupSource"]
