...
class RangeFilterTextField(docking.widgets.textfield.IntegerTextField):
    ...
    * Allows hex input of the form "0x...." for hex values
    ...
    def __init__(self, filterType: RangeFilterTextField.FilterType, program: ghidra.program.model.listing.Program) -> None:
        ...
...
class ScalarColumnConstraintProvider(docking.widgets.table.constraint.ColumnConstraintProvider):
    ...
    class ScalarMappedColumnConstraint(docking.widgets.table.constraint.MappedColumnConstraint[ghidra.program.model.scalar.Scalar, java.lang.Long]):
        ...
        def __init__(self, mapper: docking.widgets.table.constraint.ColumnTypeMapper[ghidra.program.model.scalar.Scalar, java.lang.Long], delegate: docking.widgets.table.constraint.ColumnConstraint[java.lang.Long]) -> None:
            ...
...
class ScalarSearchDialog(docking.DialogComponentProvider):
    ...
    def setFilterValues(self, minFilterValue: typing.Union[jpype.JLong, int], maxFilterValue: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setSearchAScalar(self) -> None:
        ...

    def setSpecificScalarValue(self, value: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["RangeFilterTextField", "ScalarColumnConstraintProvider", "ScalarRowObject", "ScalarRowObjectToAddressTableRowMapper", "ScalarRowObjectToProgramLocationTableRowMapper", "ScalarSearchContext", "ScalarSearchProvider", "ScalarSearchPlugin", "ScalarSearchModel", "ScalarSearchDialog"]
