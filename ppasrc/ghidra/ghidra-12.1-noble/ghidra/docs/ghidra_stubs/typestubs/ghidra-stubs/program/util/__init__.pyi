...
class ProgramSelection(ghidra.program.model.address.AddressSetView):
    ...
    @typing.overload
    def __init__(self, from_: ghidra.program.model.address.Address, to: ghidra.program.model.address.Address) -> None:
        """
        Constructor.
    ...
    @typing.overload
    def __init__(self, setView: ghidra.program.model.address.AddressSetView) -> None:
        """
    ...
    @typing.overload
    def __init__(self, sel: InteriorSelection) -> None:
        """
    ...
    def __init__(self, addressFactory: ghidra.program.model.address.AddressFactory) -> None:
        """
        Construct a new empty ProgramSelection.
    ...
    def __init__(self, addressFactory: ghidra.program.model.address.AddressFactory, from_: ghidra.program.model.address.Address, to: ghidra.program.model.address.Address) -> None:
        """
        Constructor.
    ...
    def __init__(self, addressFactory: ghidra.program.model.address.AddressFactory, setView: ghidra.program.model.address.AddressSetView) -> None:
        """
        Construct a new ProgramSelection
    ...
    def __init__(self, addressFactory: ghidra.program.model.address.AddressFactory, sel: InteriorSelection) -> None:
        """
        Construct a new ProgramSelection from the indicated interior selection.
...
class InteriorSelection(java.lang.Object):
    ...
    def __init__(self, from_: ProgramLocation, to: ProgramLocation, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address) -> None:
        """
...
class DataTypeCleaner(java.io.Closeable):
    ...
    def __init__(self, targetDtm: ghidra.program.model.data.DataTypeManager, retainExistingComposites: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class SymbolicPropogator(java.lang.Object):
    ...
    class SavedFlowState(java.lang.Record):
        ...
        @typing.overload
        def __init__(self, vContext: VarnodeContext, flowType: ghidra.program.model.symbol.FlowType, source: ghidra.program.model.address.Address, destination: ghidra.program.model.address.Address, continueAfterHittingFlow: typing.Union[jpype.JInt, int]) -> None:
            ...

        @typing.overload
        def __init__(self, vContext: VarnodeContext, flowType: ghidra.program.model.symbol.FlowType, source: ghidra.program.model.address.Address, destination: ghidra.program.model.address.Address, pcodeIndex: typing.Union[jpype.JInt, int], continueAfterHittingFlow: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, recordStartEndState: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setDebug(self, debug: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setParamPointerRefCheck(self, checkParamRefsOption: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setParamRefCheck(self, checkParamRefsOption: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setReturnRefCheck(self, checkReturnRefsOption: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setStoredRefCheck(self, checkStoredRefsOption: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class VarnodeContext(ghidra.program.model.lang.ProcessorContext):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, programContext: ghidra.program.model.listing.ProgramContext, spaceProgramContext: ghidra.program.model.listing.ProgramContext, recordStartEndState: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def copy(self, out: ghidra.program.model.pcode.Varnode, in_: ghidra.program.model.pcode.Varnode, mustClearAll: typing.Union[jpype.JBoolean, bool], evaluator: ContextEvaluator) -> None:
        """
    ...
    def flowStart(self, toAddr: ghidra.program.model.address.Address) -> None:
        """
    ...
    def propogateResults(self, clearContext: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def pushMemState(self, saveTempUniques: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Save the current memory state
        
        :param jpype.JBoolean or bool saveTempUniques: - if internal branching, must save the tempUniques as well
    ...
    def putValue(self, out: ghidra.program.model.pcode.Varnode, result: ghidra.program.model.pcode.Varnode, mustClear: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setDebug(self, debugOn: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class MarkerLocation(java.io.Serializable):
    ...
    def __init__(self, markers: ghidra.app.services.MarkerSet, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, x: typing.Union[jpype.JInt, int], y: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def getMarkerSet(self) -> ghidra.app.services.MarkerSet:
        """
    ...
    @property
    def markerSet(self) -> ghidra.app.services.MarkerSet:
        ...
...
class ProgramMerge(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, resultProgram: ghidra.program.model.listing.Program, originProgram: ghidra.program.model.listing.Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, originToResultTranslator: AddressTranslator) -> None:
        """
    ...
    def applyFunctionTagChanges(self, originAddressSet: ghidra.program.model.address.AddressSetView, setting: typing.Union[jpype.JInt, int], discardTags: java.util.Set[ghidra.program.model.listing.FunctionTag], keepTags: java.util.Set[ghidra.program.model.listing.FunctionTag], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def applySourceMapDifferences(self, originAddrs: ghidra.program.model.address.AddressSet, settings: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def mergeBookmark(self, originAddress: ghidra.program.model.address.Address, type: typing.Union[java.lang.String, str], category: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def mergeBytes(self, originAddressSet: ghidra.program.model.address.AddressSetView, overwriteInstructions: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def mergeCodeUnits(self, originAddressSet: ghidra.program.model.address.AddressSetView, byteDiffs: ghidra.program.model.address.AddressSetView, mergeDataBytes: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def mergeComment(self, originAddressSet: ghidra.program.model.address.AddressSet, type: typing.Union[jpype.JInt, int], both: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def mergeCommentType(self, originAddressSet: ghidra.program.model.address.AddressSetView, type: typing.Union[jpype.JInt, int], setting: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def mergeComments(self, commentType: ghidra.program.model.listing.CommentType, originAddress: ghidra.program.model.address.Address) -> None:
        """
    ...
    def mergeEquate(self, originAddress: ghidra.program.model.address.Address, opIndex: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def mergeLabels(self, originAddressSet: ghidra.program.model.address.AddressSetView, setting: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def mergeReferences(self, originAddressSet: ghidra.program.model.address.AddressSetView, onlyKeepDefaults: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def mergeUserProperty(self, userPropertyName: typing.Union[java.lang.String, str], originAddress: ghidra.program.model.address.Address) -> None:
        """
    ...
    def replaceComment(self, commentType: ghidra.program.model.listing.CommentType, originAddress: ghidra.program.model.address.Address) -> None:
        """
    ...
    def replaceFunctionParameterComment(self, originEntryPoint: ghidra.program.model.address.Address, ordinal: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def replaceFunctionParameterDataType(self, originEntryPoint: ghidra.program.model.address.Address, ordinal: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def replaceFunctionParameterName(self, originEntryPoint: ghidra.program.model.address.Address, ordinal: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def replaceLabels(self, originAddressSet: ghidra.program.model.address.AddressSet, replaceFunction: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def replaceReferences(self, originAddressSet: ghidra.program.model.address.AddressSetView, onlyKeepDefaults: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        ``replaceReferences`` replaces all references in
        program1 for the specified address set with the references from program2.
        If an equivalent reference already exists then it is updated to match the
    ...
    @typing.overload
    def replaceReferences(self, originAddress: ghidra.program.model.address.Address, operandIndex: typing.Union[jpype.JInt, int]) -> None:
        """
        ``replaceReferences`` replaces all references in
    ...
    def replaceVariables(self, originEntryPoint: ghidra.program.model.address.Address, varList: java.util.List[ghidra.program.model.listing.Variable], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class FunctionMerge(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def replaceFunctionsNames(pgmMerge: ProgramMerge, addressSet: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class AddressTranslationException(java.lang.RuntimeException):
    ...
    @typing.overload
    def __init__(self, address: ghidra.program.model.address.Address, translator: AddressTranslator) -> None:
        """
...
class ProgramDiff(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, program1: ghidra.program.model.listing.Program, program2: ghidra.program.model.listing.Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program1: ghidra.program.model.listing.Program, program2: ghidra.program.model.listing.Program, checkAddressSet: ghidra.program.model.address.AddressSetView) -> None:
        """
        ``ProgramDiff`` is used to determine the addresses where
        there are differences between two programs.
        Possible differences are:
    ...
    def printKnownDifferences(self, type: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def printKnownDifferencesByType(self, type: typing.Union[jpype.JInt, int]) -> None:
        """
        Print the differences matching the types indicated that were found thus
    ...
    def setFilter(self, filter: ProgramDiffFilter) -> None:
        """
...
class ProgramDiffFilter(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, filter: ProgramDiffFilter) -> None:
        """
    ...
    def addToFilter(self, filter: ProgramDiffFilter) -> None:
        """
    ...
    def setFilter(self, type: typing.Union[jpype.JInt, int], filter: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ProgramMergeFilter(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, filter: ProgramMergeFilter) -> None:
        """
        Creates new ProgramMergeFilter that is equal to the specified ProgramMergeFilter.
        """

    @typing.overload
    def __init__(self, type: typing.Union[jpype.JInt, int], filter: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setFilter(self, type: typing.Union[jpype.JInt, int], filter: typing.Union[jpype.JInt, int]) -> None:
        """
...
class GroupView(java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, paths: jpype.JArray[GroupPath]) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, path: GroupPath) -> None:
        """
    ...
    def addPath(self, path: GroupPath) -> None:
        """
...
class MultiAddressIterator(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, iters: jpype.JArray[ghidra.program.model.address.AddressIterator]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, iters: jpype.JArray[ghidra.program.model.address.AddressIterator], forward: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ListingDiff(java.lang.Object):
    ...
    def setCorrelation(self, correlation: ListingAddressCorrelation) -> None:
        """
    ...
    def setIgnoreByteDiffs(self, ignore: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setIgnoreConstants(self, ignore: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setIgnoreRegisters(self, ignore: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AddressIteratorConverter(ghidra.program.model.address.AddressIterator):
    ...
    def __init__(self, iteratorsProgram: ghidra.program.model.listing.Program, iterator: ghidra.program.model.address.AddressIterator, otherProgram: ghidra.program.model.listing.Program) -> None:
        ...
...
class AddressRangeIteratorConverter(ghidra.program.model.address.AddressRangeIterator):
    ...
    def __init__(self, iterator: ghidra.program.model.address.AddressRangeIterator, program: ghidra.program.model.listing.Program) -> None:
        ...
...
class CombinedAddressRangeIterator(ghidra.program.model.address.AddressRangeIterator):
    ...
    def __init__(self, it1: ghidra.program.model.address.AddressRangeIterator, it2: ghidra.program.model.address.AddressRangeIterator) -> None:
        ...
...
class DefaultAddressTranslator(AddressTranslator):
    ...
    def __init__(self, destinationProgram: ghidra.program.model.listing.Program, sourceProgram: ghidra.program.model.listing.Program) -> None:
        ...
...
class ExternalSymbolResolver(java.io.Closeable):
    ...
    def __init__(self, projectData: ghidra.framework.model.ProjectData, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
    ...
    @typing.overload
    def addProgramToFixup(self, loaded: ghidra.app.util.opinion.Loaded[ghidra.program.model.listing.Program]) -> None:
        """
    ...
    def logInfo(self, logger: java.util.function.Consumer[java.lang.String], shortSummary: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class FunctionUtility(java.lang.Object):
    ...
    @staticmethod
    def applySignature(destinationFunction: ghidra.program.model.listing.Function, sourceFunction: ghidra.program.model.listing.Function, applyEmptyComposites: typing.Union[jpype.JBoolean, bool], conflictHandler: ghidra.program.model.data.DataTypeConflictHandler) -> None:
        """
    ...
    @staticmethod
    def setUniqueParameterNames(function: ghidra.program.model.listing.Function, parameters: java.util.List[ghidra.program.model.listing.Parameter]) -> None:
        """
...
class MemoryBlockDiff(java.lang.Object):
    ...
    def __init__(self, block1: ghidra.program.model.mem.MemoryBlock, block2: ghidra.program.model.mem.MemoryBlock) -> None:
        """
...
class MemoryDiff(java.lang.Object):
    ...
    def __init__(self, p1: ghidra.program.model.listing.Program, p2: ghidra.program.model.listing.Program) -> None:
        """
...
class MemoryRangeDiff(MemoryBlockDiff):
    ...
    def __init__(self, memory1: ghidra.program.model.mem.Memory, memory2: ghidra.program.model.mem.Memory, range: ghidra.program.model.address.AddressRange) -> None:
        """
...
class MultiAddressRangeIterator(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, iters: jpype.JArray[ghidra.program.model.address.AddressRangeIterator]) -> None:
        """
        Constructor of a multi address iterator for multiple forward address iterators.
    ...
    @typing.overload
    def __init__(self, iters: jpype.JArray[ghidra.program.model.address.AddressRangeIterator], forward: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class MultiCodeUnitIterator(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, listings: jpype.JArray[ghidra.program.model.listing.Listing], addr: ghidra.program.model.address.Address, forward: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, listings: jpype.JArray[ghidra.program.model.listing.Listing], addrs: ghidra.program.model.address.AddressSetView, forward: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor of a multi-code unit iterator.
...
class ProgramDiffDetails(java.lang.Object):
    ...
    def getAllDetails(self, p1DiffAddress: ghidra.program.model.address.Address, doc: javax.swing.text.StyledDocument, prefixString: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def getDetails(self, p1DiffAddress: ghidra.program.model.address.Address, filter: ProgramDiffFilter, doc: javax.swing.text.StyledDocument, prefixString: typing.Union[java.lang.String, str]) -> None:
        """
        Determine the detailed differences between the two programs at the
        indicated address. The differences are determined for the extent of the
        code units in the two programs at the indicated address.
...
class ProgramMergeManager(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, program1: ghidra.program.model.listing.Program, program2: ghidra.program.model.listing.Program, p1LimitedAddressSet: ghidra.program.model.address.AddressSetView) -> None:
        """
        ``ProgramMergeManager`` allows the merging of differences from program1
        or program2 into the merged program.
    ...
    def setDiffFilter(self, filter: ProgramDiffFilter) -> None:
        """
    ...
    def setMergeFilter(self, filter: ProgramMergeFilter) -> None:
        """
        Set the filter that indicates which parts of the Program should be 
...
class OffsetAddressSpace(ghidra.program.model.address.GenericAddressSpace):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], size: typing.Union[jpype.JInt, int], type: typing.Union[jpype.JInt, int], unique: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class FunctionChangeRecord(ProgramChangeRecord):
    ...
    def __init__(self, function: ghidra.program.model.listing.Function, changeType: FunctionChangeRecord.FunctionChangeType) -> None:
        """
...
class ChangeManager(java.lang.Object):
    ...
    @typing.overload
    def setChanged(self, eventType: ProgramEvent, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    @typing.overload
    def setChanged(self, eventType: ProgramEvent, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
        Mark the state of a Program as having changed and generate
        the event of the specified type.  Any or all parameters may be null.
    ...
    @typing.overload
    def setObjChanged(self, eventType: ProgramEvent, affected: java.lang.Object, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
        Mark the state of a Program as having changed and generate
        the event of the specified type.  Any or all parameters may be null.
    ...
    @typing.overload
    def setObjChanged(self, eventType: ProgramEvent, addr: ghidra.program.model.address.Address, affected: java.lang.Object, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
        Mark the state of a Program as having changed and generate
        the event of the specified type.  Any or all parameters may be null.
    ...
    def setPropertyChanged(self, propertyName: typing.Union[java.lang.String, str], codeUnitAddr: ghidra.program.model.address.Address, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
        Mark the state of a Program as having changed and generate
    ...
    def setPropertyRangeRemoved(self, propertyName: typing.Union[java.lang.String, str], start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address) -> None:
        """
...
class ProgramChangeRecord(ghidra.framework.model.DomainObjectChangeRecord):
    ...
    @typing.overload
    def __init__(self, eventType: ProgramEvent, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address, affected: java.lang.Object, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    @typing.overload
    def __init__(self, eventType: ProgramEvent, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        ...
...
class ProgramLocation(java.lang.Cloneable, java.lang.Comparable[ProgramLocation]):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], refAddr: ghidra.program.model.address.Address, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address) -> None:
        """
        Construct a new ProgramLocation for the given address. The address will be adjusted to the
        beginning of the :obj:`code unit <CodeUnit>` containing that address (if it exists). The
        original address can be retrieved using the :meth:`getByteAddress() <.getByteAddress>` method.
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a new ProgramLocation for the given address. The address will be adjusted to the
        beginning of the :obj:`code unit <CodeUnit>` containing that address (if it exists). The
        original address can be retrieved using the :meth:`getByteAddress() <.getByteAddress>` method.
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, refAddr: ghidra.program.model.address.Address) -> None:
        """
        Construct a new ProgramLocation for the given address. The address will be adjusted to the
        beginning of the :obj:`code unit <CodeUnit>` containing that address (if it exists). The
        original address can be retrieved using the :meth:`getByteAddress() <.getByteAddress>` method.
    ...
    def restoreState(self, newProgram: ghidra.program.model.listing.Program, obj: ghidra.framework.options.SaveState) -> None:
        """
...
class GroupPath(java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, groupName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, groupNames: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    def updateGroupPath(self, oldname: typing.Union[java.lang.String, str], newname: typing.Union[java.lang.String, str]) -> None:
        """
...
class ProgramContextImpl(AbstractStoredProgramContext):
    ...
    def __init__(self, language: ghidra.program.model.lang.Language) -> None:
        """
...
class RangeMapAdapter(java.lang.Object):
    ...
    def set(self, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address, bytes: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def setLanguage(self, translator: LanguageTranslator, mapReg: ghidra.program.model.lang.Register, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class RegisterValueStore(java.lang.Object):
    ...
    def __init__(self, register: ghidra.program.model.lang.Register, rangeMap: RangeMapAdapter, enableRangeWriteCache: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AddressCorrelationRange(java.lang.Object):
    ...
    def __init__(self, range: ghidra.program.model.address.AddressRange, correlatorName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class AddressEvaluator(generic.expressions.ExpressionEvaluator):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, assumeHex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, factory: ghidra.program.model.address.AddressFactory, assumeHex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, defaultSpace: ghidra.program.model.address.AddressSpace, assumeHex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs an AddressEvalutor for the given program and in the specified hex/decimal mode.
    ...
    def setPreferredAddressSpace(self, space: ghidra.program.model.address.AddressSpace) -> None:
        """
...
class AddressFieldLocation(CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], addrRepresentation: typing.Union[java.lang.String, str], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class CodeUnitLocation(ProgramLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class AssignedVariableLocation(ProgramLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, row: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class CommentFieldLocation(CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], comment: jpype.JArray[java.lang.String], type: ghidra.program.model.listing.CommentType, row: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class BlockStartLocation(CommentFieldLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], row: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int], comment: jpype.JArray[java.lang.String], commentRow: typing.Union[jpype.JInt, int]) -> None:
        """
...
class BytesFieldLocation(CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, byteAddress: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], columnInByte: typing.Union[jpype.JInt, int]) -> None:
        """
...
class CodeUnitContainer(java.lang.Object):
    ...
    def __init__(self, codeUnit: ghidra.program.model.listing.CodeUnit) -> None:
        ...
...
class CodeUnitLCS(generic.algorithms.Lcs[CodeUnitContainer]):
    ...
    def __init__(self, xList: java.util.List[CodeUnitContainer], yList: java.util.List[CodeUnitContainer]) -> None:
        ...
...
class CodeUnitPropertyChangeRecord(ProgramChangeRecord):
    ...
    @typing.overload
    def __init__(self, type: ProgramEvent, propertyName: typing.Union[java.lang.String, str], address: ghidra.program.model.address.Address, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    @typing.overload
    def __init__(self, type: ProgramEvent, propertyName: typing.Union[java.lang.String, str], start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address) -> None:
        """
...
class CodeUnitUserDataChangeRecord(ghidra.framework.model.DomainObjectChangeRecord):
    ...
    def __init__(self, propertyName: typing.Union[java.lang.String, str], codeUnitAddr: ghidra.program.model.address.Address, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
        Constructor
...
class CollapsedCodeLocation(ProgramLocation):
    """
...
class CommentChangeRecord(ProgramChangeRecord):
    ...
    def __init__(self, commentType: ghidra.program.model.listing.CommentType, address: ghidra.program.model.address.Address, oldValue: typing.Union[java.lang.String, str], newValue: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class DefinedDataIterator(ghidra.program.model.listing.DataIterator):
    ...
    class DataComponentIterator(ghidra.program.model.listing.DataIterator):
        ...
        def __init__(self, data: ghidra.program.model.listing.Data) -> None:
            ...
...
class DefinedStringIterator(ghidra.program.model.listing.DataIterator):
    ...
    class StructDtcIterator(ghidra.program.model.listing.DataIterator):
        ...
        def __init__(self, data: ghidra.program.model.listing.Data, compDT: ghidra.program.model.data.Composite) -> None:
            ...
...
class DividerLocation(ProgramLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, groupPath: GroupPath, charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
        Create a new DividerLocation.
...
class EquateInfo(java.lang.Object):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int], refAddr: ghidra.program.model.address.Address, opIndex: typing.Union[jpype.JInt, int], dynamicHash: typing.Union[jpype.JLong, int]) -> None:
        """
        Constructor.
...
class FieldNameFieldLocation(CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], fieldName: typing.Union[java.lang.String, str], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class FunctionCallFixupFieldLocation(FunctionLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, callFixupName: typing.Union[java.lang.String, str], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class FunctionCallingConventionFieldLocation(FunctionSignatureFieldLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, charOffset: typing.Union[jpype.JInt, int], signature: typing.Union[java.lang.String, str]) -> None:
        """
...
class FunctionSignatureFieldLocation(FunctionLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, functionAddr: ghidra.program.model.address.Address, col: typing.Union[jpype.JInt, int], signature: typing.Union[java.lang.String, str]) -> None:
        """
        Construct a new FunctionSignatureFieldLocation object.
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, functionAddr: ghidra.program.model.address.Address) -> None:
        """
...
class FunctionNameFieldLocation(FunctionSignatureFieldLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, charOffset: typing.Union[jpype.JInt, int], signature: typing.Union[java.lang.String, str], functionName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, functionAddr: ghidra.program.model.address.Address, col: typing.Union[jpype.JInt, int], signature: typing.Union[java.lang.String, str], functionName: typing.Union[java.lang.String, str]) -> None:
        """
        Construct a new FunctionNameFieldLocation object.
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, functionName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class FunctionNoReturnFieldLocation(FunctionSignatureFieldLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, charOffset: typing.Union[jpype.JInt, int], signature: typing.Union[java.lang.String, str], noreturn: typing.Union[java.lang.String, str]) -> None:
        """
...
class FunctionOpenCloseLocation(CodeUnitLocation):
    """
...
class FunctionParameterFieldLocation(FunctionSignatureFieldLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, charOffset: typing.Union[jpype.JInt, int], signature: typing.Union[java.lang.String, str], parameter: ghidra.program.model.listing.Parameter) -> None:
        """
...
class FunctionPurgeFieldLocation(ProgramLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, charOffset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class FunctionRepeatableCommentFieldLocation(FunctionLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, comment: jpype.JArray[java.lang.String], row: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, functionAddr: ghidra.program.model.address.Address, comment: jpype.JArray[java.lang.String], row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a new FunctionRepeatableCommentFieldLocation object.
...
class FunctionReturnTypeFieldLocation(FunctionSignatureFieldLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, charOffset: typing.Union[jpype.JInt, int], signature: typing.Union[java.lang.String, str], returnType: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, functionAddr: ghidra.program.model.address.Address, col: typing.Union[jpype.JInt, int], signature: typing.Union[java.lang.String, str], returnType: typing.Union[java.lang.String, str]) -> None:
        """
        Construct a new FunctionReturnTypeFieldLocation object.
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, functionAddr: ghidra.program.model.address.Address, returnType: typing.Union[java.lang.String, str]) -> None:
        """
...
class FunctionSignatureSourceFieldLocation(FunctionLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, source: typing.Union[java.lang.String, str], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a new FunctionSignatureFieldLocation object.
...
class FunctionTagFieldLocation(FunctionLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, tags: typing.Union[java.lang.String, str], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class IndentFieldLocation(CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt]) -> None:
        """
...
class LabelFieldLocation(CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, label: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, label: typing.Union[java.lang.String, str], namespace: ghidra.program.model.symbol.Namespace, row: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a new LabelFieldLocation.
    ...
    @typing.overload
    def __init__(self, s: ghidra.program.model.symbol.Symbol) -> None:
        """
    ...
    @typing.overload
    def __init__(self, s: ghidra.program.model.symbol.Symbol, row: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
        Creates a label field location using the specified symbol
...
class TemporaryCompilerSpec(ghidra.program.model.lang.CompilerSpec):
    ...
    def __init__(self, translator: LanguageTranslator, oldCompilerSpecID: ghidra.program.model.lang.CompilerSpecID) -> None:
        ...

    def getDefaultStackAlignment(self) -> int:
        ...

    def reloadCompilerSpec(self) -> None:
        ...
...
class LanguageTranslatorFactory(java.lang.Object):
    ...
    * Default translators can be instantiated for languages whose address spaces map to one-another.
    ...
    @staticmethod
    def registerLanguageTranslatorFactoryMinion(minion: LanguageTranslatorFactoryMinion) -> None:
        ...
...
class LinearDataAddressCorrelation(AddressCorrelation):
    ...
    def __init__(self, sourceData: ghidra.program.model.listing.Data, destinationData: ghidra.program.model.listing.Data) -> None:
        ...
...
class LinearFunctionAddressCorrelation(AddressCorrelation):
    ...
    def __init__(self, sourceFunction: ghidra.program.model.listing.Function, destinationFunction: ghidra.program.model.listing.Function) -> None:
        ...
...
class MnemonicFieldLocation(CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], mnemonicString: typing.Union[java.lang.String, str], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, refAddr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], mnemonicString: typing.Union[java.lang.String, str], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a new MnemonicFieldLocation.
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address) -> None:
        """
...
class OffsetFieldLocation(CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], charOffset: typing.Union[jpype.JInt, int], type: OffsetFieldType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, type: OffsetFieldType) -> None:
        """
...
class OldLanguageFactory(java.lang.Object):
    ...
    @staticmethod
    def createOldLanguageFile(lang: ghidra.program.model.lang.Language, file: jpype.protocol.SupportsPath) -> None:
        """
...
class PcodeFieldLocation(ProgramLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, pcodeStrings: java.util.List[java.lang.String], row: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class PostCommentFieldLocation(CommentFieldLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], comment: jpype.JArray[java.lang.String], displayableCommentRow: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ProgramUtilities(java.lang.Object):
    ...
    def convertFunctionWrappedExternalPointer(functionSymbol: ghidra.program.model.symbol.Symbol) -> None:
        ...
        :param ghidra.program.model.symbol.Symbol functionSymbol: old fake IAT function to be migrated
        """
    ...
    def parseAddress(program: ghidra.program.model.listing.Program, addressString: typing.Union[java.lang.String, str]) -> ghidra.program.model.address.Address:
        """
        Parse an :obj:`Address` string which corresponds to the specified program.  
        Supported addresses include (order also indicates precedence):
         
        * Default loaded memory space (hex-offset only or with space-name, e.g., 'abcd', '0xabcd')
        ...
        * Stack address (e.g., Stack[0xa], Stack[-0xa], Stack[10], Stack[-10])
        ...
        1. Specifying only a hex offset should be restricted to a valid default address space offset
        to avoid having an arbitrary address space address returned.  A non-default space address
        should include the appropriate address space name prefix.
        2. If an external address is returned it does not indicate that it is defined by the 
        program.
        
        
        :param ghidra.program.model.listing.Program program: program whose memory spaces should be considered
        :param java.lang.String or str addressString: address string to be parsed (use of address space name prefix is
        case-sensitive).
...
class RefRepeatCommentFieldLocation(CommentFieldLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], comment: jpype.JArray[java.lang.String], row: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int], currentCommentRow: typing.Union[jpype.JInt, int], refRepeatAddress: ghidra.program.model.address.Address) -> None:
        """
...
class RegisterFieldLocation(ProgramLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, registerNames: jpype.JArray[java.lang.String], registerStrings: jpype.JArray[java.lang.String], row: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class RegisterTransitionFieldLocation(ProgramLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, registerNames: jpype.JArray[java.lang.String], row: typing.Union[jpype.JInt, int], column: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class SourceMapFieldLocation(ProgramLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, row: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int], sourceMapEntry: ghidra.program.model.sourcemap.SourceMapEntry) -> None:
        ...
...
class SpaceFieldLocation(CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, path: GroupPath, componentPath: jpype.JArray[jpype.JInt], row: typing.Union[jpype.JInt, int]) -> None:
        """
...
class SpacerFieldLocation(CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], charOffset: typing.Union[jpype.JInt, int], text: typing.Union[java.lang.String, str]) -> None:
        """
...
class ThunkedFunctionFieldLocation(FunctionLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, thunkedFunctionAddr: ghidra.program.model.address.Address, charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class UserDataChangeRecord(ghidra.framework.model.DomainObjectChangeRecord):
    ...
    @typing.overload
    def __init__(self, propertyName: typing.Union[java.lang.String, str], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, propertyName: typing.Union[java.lang.String, str]) -> None:
        """
...
class VariableCommentFieldLocation(VariableLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, var: ghidra.program.model.listing.Variable, charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, var: ghidra.program.model.listing.Variable, charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a new VariableCommentFieldLocation object.
...
class VariableLocation(FunctionLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, var: ghidra.program.model.listing.Variable, index: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, var: ghidra.program.model.listing.Variable, index: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
        Create a new VariableLocation.
...
class VariableStorageConflicts(java.lang.Object):
    ...
    def __init__(self, variablesList1: java.util.List[ghidra.program.model.listing.Variable], variablesList2: java.util.List[ghidra.program.model.listing.Variable], ignoreParamToParamConflicts: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class VariableXRefFieldLocation(VariableLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, var: ghidra.program.model.listing.Variable, refAddr: ghidra.program.model.address.Address, index: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class VariableXRefHeaderFieldLocation(VariableXRefFieldLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, var: ghidra.program.model.listing.Variable, charOffset: typing.Union[jpype.JInt, int], refAddr: ghidra.program.model.address.Address) -> None:
        """
...
class XRefFieldLocation(CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], refAddr: ghidra.program.model.address.Address, index: typing.Union[jpype.JInt, int], charOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class XRefHeaderFieldLocation(XRefFieldLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], charOffset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["ProgramSelection", "InteriorSelection", "DataTypeCleaner", "SymbolicPropogator", "ContextEvaluator", "VarnodeContext", "MarkerLocation", "ProgramMerge", "AddressTranslator", "SymbolMerge", "FunctionMerge", "AddressTranslationException", "ProgramDiff", "ProgramConflictException", "ProgramDiffFilter", "ProgramMemoryComparator", "ProgramMergeFilter", "ContextEvaluatorAdapter", "GroupView", "MultiAddressIterator", "ListingDiff", "AddressIteratorConverter", "AddressRangeIteratorConverter", "CombinedAddressRangeIterator", "DefaultAddressTranslator", "DiffUtility", "ExternalSymbolResolver", "FunctionUtility", "GhidraProgramUtilities", "MemoryBlockDiff", "MemoryDiff", "MemoryRangeDiff", "MultiAddressRangeIterator", "MultiCodeUnitIterator", "ProgramDiffDetails", "ProgramMemoryUtil", "ProgramMergeManager", "OffsetAddressFactory", "OffsetAddressSpace", "ProgramEvent", "FunctionChangeRecord", "ChangeManager", "ProgramChangeRecord", "LanguageTranslator", "ProgramLocation", "GroupPath", "ProgramContextImpl", "AbstractStoredProgramContext", "AbstractProgramContext", "RangeMapAdapter", "RegisterValueStore", "ListingAddressCorrelation", "LanguageTranslatorAdapter", "AddressCorrelation", "AddressCorrelationRange", "AddressCorrelator", "AddressEvaluator", "AddressExpressionValue", "AddressFieldLocation", "CodeUnitLocation", "AssignedVariableLocation", "AutomaticCommentFieldLocation", "CommentFieldLocation", "BlockStartLocation", "BytesFieldLocation", "ChangeManagerAdapter", "CodeUnitContainer", "CodeUnitLCS", "CodeUnitPropertyChangeRecord", "CodeUnitUserDataChangeRecord", "CollapsedCodeLocation", "CommentChangeRecord", "CommentTypeUtils", "CyclomaticComplexity", "DataTypeArchiveChangeManager", "DefaultLanguageService", "DefinedDataIterator", "DefinedStringIterator", "DiscoverableAddressCorrelator", "DividerLocation", "DummyListingAddressCorrelation", "EolCommentFieldLocation", "EquateInfo", "EquateOperandFieldLocation", "OperandFieldLocation", "FieldNameFieldLocation", "FunctionCallFixupFieldLocation", "FunctionLocation", "FunctionCallingConventionFieldLocation", "FunctionSignatureFieldLocation", "FunctionEndParametersFieldLocation", "FunctionInlineFieldLocation", "FunctionNameFieldLocation", "FunctionNoReturnFieldLocation", "FunctionOpenCloseLocation", "FunctionParameterFieldLocation", "FunctionParameterNameFieldLocation", "FunctionPurgeFieldLocation", "FunctionRepeatableCommentFieldLocation", "FunctionReturnTypeFieldLocation", "FunctionSignatureSourceFieldLocation", "FunctionStartParametersFieldLocation", "FunctionTagFieldLocation", "FunctionThunkFieldLocation", "IndentFieldLocation", "InstructionMaskValueFieldLocation", "InstructionUtils", "LabelFieldLocation", "LanguagePostUpgradeInstructionHandler", "TemporaryCompilerSpec", "LanguageTranslatorFactory", "LanguageTranslatorFactoryMinion", "FactoryLanguageTranslator", "LinearDataAddressCorrelation", "LinearFunctionAddressCorrelation", "MemoryBlockStartFieldLocation", "MnemonicFieldLocation", "OffsetFieldLocation", "OffsetFieldType", "OldLanguage", "OldLanguageFactory", "ParallelInstructionLocation", "PcodeFieldLocation", "PlateFieldLocation", "PostCommentFieldLocation", "ProgramLocationComparator", "ProgramTask", "ProgramUtilities", "RefRepeatCommentFieldLocation", "RegisterFieldLocation", "RegisterTransitionFieldLocation", "RepeatableCommentFieldLocation", "SimpleDiffUtility", "SimpleLanguageTranslator", "SourceMapFieldLocation", "SpaceFieldLocation", "SpacerFieldLocation", "StackDepthFieldLocation", "SubDataFieldLocation", "ThunkedFunctionFieldLocation", "UserDataChangeRecord", "VariableCommentFieldLocation", "VariableLocation", "VariableLocFieldLocation", "VariableNameFieldLocation", "VariableStorageConflicts", "VariableTypeFieldLocation", "VariableXRefFieldLocation", "VariableXRefHeaderFieldLocation", "VariablesOpenCloseLocation", "XRefFieldLocation", "XRefHeaderFieldLocation"]
