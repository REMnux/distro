...
class GoToAddressLabelDialog(docking.ReusableDialogComponentProvider, ghidra.app.services.GoToServiceListener):
    ...
    def __init__(self, gotoService: ghidra.app.services.GoToService, plugin: ghidra.framework.plugintool.Plugin) -> None:
        ...
    ...
    def setCStyleInput(self, cStyleInput: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setCaseSensitive(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setMemory(self, goToMemory: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class GoToServiceImpl(ghidra.app.services.GoToService):
    ...
    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, defaultNavigatable: ghidra.app.nav.Navigatable) -> None:
        ...
...
class GoToSymbolSearchTask(ghidra.util.task.Task):
    ...
    def __init__(self, queryData: ghidra.app.services.QueryData, searchPrograms: java.util.List[ghidra.program.model.listing.Program], limit: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class SymbolSearcher(java.lang.Object):
    ...
    def __init__(self, data: ghidra.app.services.QueryData, limit: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
__all__ = ["GoToAddressLabelDialog", "GoToServiceImpl", "GoToQuery", "GoToSymbolSearchTask", "SymbolMatcher", "SymbolSearcher"]
