...
class CommentsDialog(docking.ReusableDialogComponentProvider, java.awt.event.KeyListener):
    ...
    class AnnotationAdapterWrapper(java.lang.Comparable[CommentsDialog.AnnotationAdapterWrapper]):
        ...
        def __init__(self, handler: ghidra.app.util.viewer.field.AnnotatedStringHandler) -> None:
            ...
    ...
    def setEnterMode(self, enterMode: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["CommentHistoryDialog", "CommentHistoryPanel", "CommentsActionFactory", "CommentsDialog", "CommentsPlugin", "DecompilerCommentsActionFactory"]
