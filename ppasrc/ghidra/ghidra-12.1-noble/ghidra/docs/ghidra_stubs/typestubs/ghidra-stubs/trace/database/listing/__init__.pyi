    ...
    * Defined Units - Instructions, Defined Data
    ...
    class DBTraceCodePrototypeEntry(ghidra.util.database.DBAnnotatedObject, ghidra.trace.database.address.DBTraceOverlaySpaceAdapter.DecodesAddresses):
        ...
        * 0: Initial version and previous unversioned implementation
        ...
        def __init__(self, manager: DBTraceCodeManager, store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
            ...
    ...
    class ProtoProcessorContext(ghidra.program.model.lang.ProcessorContext):
        ...
        def __init__(self, baseContextValue: ghidra.program.model.lang.RegisterValue) -> None:
            ...
    ...
    def __init__(self, dbh: db.DBHandle, openMode: ghidra.framework.data.OpenMode, lock: java.util.concurrent.locks.ReadWriteLock, monitor: ghidra.util.task.TaskMonitor, baseLanguage: ghidra.program.model.lang.Language, trace: ghidra.trace.database.DBTrace, threadManager: ghidra.trace.database.thread.DBTraceThreadManager, platformManager: ghidra.trace.database.guest.DBTracePlatformManager, dataTypeManager: ghidra.trace.database.data.DBTraceDataTypeManager, overlayAdapter: ghidra.trace.database.address.DBTraceOverlaySpaceAdapter, referenceManager: ghidra.trace.database.symbol.DBTraceReferenceManager) -> None:
        ...

    def clearData(self, deletedDataTypeIds: java.util.Set[java.lang.Long], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    def clearPlatform(self, span: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange, guest: ghidra.trace.database.guest.DBTraceGuestPlatform, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    def deleteLangauge(self, guest: ghidra.trace.database.guest.DBTraceGuestPlatform.DBTraceGuestLanguage, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    def deletePlatform(self, guest: ghidra.trace.database.guest.DBTraceGuestPlatform, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class DBTraceCodeSpace(ghidra.trace.model.listing.TraceCodeSpace, ghidra.trace.database.space.DBTraceSpaceBased):
    ...
    def __init__(self, manager: DBTraceCodeManager, dbh: db.DBHandle, space: ghidra.program.model.address.AddressSpace, ent: ghidra.trace.database.space.AbstractDBTraceSpaceBasedManager.DBTraceSpaceEntry) -> None:
        """
        Construct a space
    ...
    def bytesChanged(self, changed: java.util.Set[ghidra.trace.model.TraceAddressSnapRange], snap: typing.Union[jpype.JLong, int], start: ghidra.program.model.address.Address, oldBytes: jpype.JArray[jpype.JByte], newBytes: jpype.JArray[jpype.JByte]) -> None:
        """
...
class DBTraceCommentAdapter(ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMap[DBTraceCommentAdapter.DBTraceCommentEntry, DBTraceCommentAdapter.DBTraceCommentEntry]):
    ...
    class DBTraceCommentEntry(ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree.AbstractDBTraceAddressSnapRangePropertyMapData[DBTraceCommentAdapter.DBTraceCommentEntry]):
        ...
        def __init__(self, tree: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree[DBTraceCommentAdapter.DBTraceCommentEntry, typing.Any], store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
            ...
    ...
    def clearComments(self, span: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange, commentType: ghidra.program.model.listing.CommentType) -> None:
        """
    ...
    def setComment(self, lifespan: ghidra.trace.model.Lifespan, address: ghidra.program.model.address.Address, commentType: ghidra.program.model.listing.CommentType, comment: typing.Union[java.lang.String, str]) -> None:
        """
...
class UndefinedDBTraceData(DBTraceDataAdapter, ghidra.trace.util.TraceSpaceMixin):
    ...
    def __init__(self, trace: ghidra.trace.database.DBTrace, snap: typing.Union[jpype.JLong, int], address: ghidra.program.model.address.Address, thread: ghidra.trace.model.thread.TraceThread, frameLevel: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DBTraceCodeUnitsMemoryView(AbstractWithUndefinedDBTraceCodeUnitsMemoryView[DBTraceCodeUnitAdapter, DBTraceCodeUnitsView], ghidra.trace.model.listing.TraceCodeUnitsView, InternalBaseCodeUnitsView[ghidra.trace.model.listing.TraceCodeUnit]):
    ...
    def __init__(self, manager: DBTraceCodeManager) -> None:
        """
        Construct the view
...
class AbstractComposedDBTraceCodeUnitsView(AbstractBaseDBTraceCodeUnitsView[T], typing.Generic[T, P]):
    ...
    def __init__(self, space: DBTraceCodeSpace, parts: collections.abc.Sequence) -> None:
        """
        Construct a view
...
class DBTraceInstruction(AbstractDBTraceCodeUnit[DBTraceInstruction], ghidra.trace.model.listing.TraceInstruction, ghidra.trace.util.InstructionAdapterFromPrototype, ghidra.program.model.lang.InstructionContext):
    ...
    def __init__(self, space: DBTraceCodeSpace, tree: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree[DBTraceInstruction, typing.Any], store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
        """
...
class AbstractDBTraceCodeUnit(ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree.AbstractDBTraceAddressSnapRangePropertyMapData[T], DBTraceCodeUnitAdapter, typing.Generic[T]):
    ...
    def __init__(self, space: DBTraceCodeSpace, tree: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree[T, typing.Any], store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
        """
...
class AbstractBaseDBTraceDefinedUnitsView(AbstractSingleDBTraceCodeUnitsView[T], typing.Generic[T]):
    ...
    def __init__(self, space: DBTraceCodeSpace, mapSpace: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapSpace[T, T]) -> None:
        """
        Construct the view
    ...
    def clear(self, span: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange, clearContext: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class DBTraceData(AbstractDBTraceCodeUnit[DBTraceData], DBTraceDefinedDataAdapter):
    ...
    def __init__(self, space: DBTraceCodeSpace, tree: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree[DBTraceData, typing.Any], store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
        """
...
class AbstractDBTraceDataComponent(DBTraceDefinedDataAdapter):
    ...
    def __init__(self, root: DBTraceData, parent: DBTraceDefinedDataAdapter, index: typing.Union[jpype.JInt, int], address: ghidra.program.model.address.Address, dataType: ghidra.program.model.data.DataType, length: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DBTraceDataCompositeFieldComponent(AbstractDBTraceDataComponent):
    ...
    def __init__(self, root: DBTraceData, parent: DBTraceDefinedDataAdapter, address: ghidra.program.model.address.Address, dtc: ghidra.program.model.data.DataTypeComponent) -> None:
        """
        Create a field
...
__all__ = ["DBTraceCodeManager", "DBTraceCodeSpace", "DBTraceCommentAdapter", "UndefinedDBTraceData", "DBTraceDataAdapter", "DBTraceCodeUnitAdapter", "DBTraceCodeUnitsMemoryView", "AbstractWithUndefinedDBTraceCodeUnitsMemoryView", "AbstractBaseDBTraceCodeUnitsMemoryView", "InternalBaseCodeUnitsView", "DBTraceCodeUnitsView", "AbstractComposedDBTraceCodeUnitsView", "AbstractBaseDBTraceCodeUnitsView", "AbstractSingleDBTraceCodeUnitsView", "DBTraceInstructionsMemoryView", "InternalTraceBaseDefinedUnitsView", "DBTraceInstruction", "AbstractDBTraceCodeUnit", "DBTraceInstructionsView", "AbstractBaseDBTraceDefinedUnitsView", "DBTraceDataMemoryView", "DBTraceDataView", "DBTraceDefinedDataMemoryView", "InternalTraceDefinedDataView", "DBTraceData", "DBTraceDefinedDataAdapter", "DBTraceDefinedDataView", "DBTraceUndefinedDataMemoryView", "DBTraceUndefinedDataView", "DBTraceDefinedUnitsMemoryView", "DBTraceDefinedUnitsView", "AbstractDBTraceDataComponent", "DBTraceDataArrayElementComponent", "DBTraceDataCompositeFieldComponent"]
