...
class FunctionManagerDB(ghidra.program.model.listing.FunctionManager):
    ...
    def __init__(self, dbHandle: db.DBHandle, addrMap: ghidra.program.database.map.AddressMap, openMode: ghidra.framework.data.OpenMode, lock: ghidra.util.Lock, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def createExternalFunction(self, extSpaceAddr: ghidra.program.model.address.Address, name: typing.Union[java.lang.String, str], nameSpace: ghidra.program.model.symbol.Namespace, originalImportName: typing.Union[java.lang.String, str], externalProgramAddress: ghidra.program.model.address.Address, source: ghidra.program.model.symbol.SourceType) -> FunctionDB:
        """
        ...
        The :meth:`original imported name <ExternalLocation.getOriginalImportedName>` will initially 
        be null.
        ...
        :param ghidra.program.model.address.Address externalProgramAddress: the external program address (may be null)
        :param java.lang.String or str originalImportName: the original imported name if different from name (may be null)
    ...
    def functionNamespaceChanged(self, key: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class FunctionDB(ghidra.program.database.DatabaseObject, ghidra.program.model.listing.Function):
    ...
    def setValidationEnabled(self, state: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class OverlappingFunctionException(java.lang.Exception):
    ...
    @typing.overload
    def __init__(self, entryPoint: ghidra.program.model.address.Address, e: ghidra.program.database.symbol.OverlappingNamespaceException) -> None:
        ...

    @typing.overload
    def __init__(self, entryPoint: ghidra.program.model.address.Address) -> None:
        ...
...
class FunctionTagDB(ghidra.program.database.DatabaseObject, ghidra.program.model.listing.FunctionTag):
    ...
    def __init__(self, mgr: FunctionTagManagerDB, cache: ghidra.program.database.DBObjectCache[FunctionTagDB], record: db.DBRecord) -> None:
        ...
...
__all__ = ["FunctionManagerDB", "FunctionDB", "FunctionAdapter", "ThunkFunctionAdapter", "FunctionTagManagerDB", "OverlappingFunctionException", "FunctionTagAdapter", "FunctionTagMappingAdapter", "FunctionTagDB", "FunctionStackFrame", "VariableDB", "ReturnParameterDB", "ParameterDB", "FunctionAdapterV0", "FunctionAdapterV1", "FunctionAdapterV2", "FunctionAdapterV3", "FunctionTagAdapterV0", "FunctionTagMappingAdapterNoTable", "FunctionTagMappingAdapterV0", "LocalVariableDB", "ThunkFunctionAdapterV0"]
