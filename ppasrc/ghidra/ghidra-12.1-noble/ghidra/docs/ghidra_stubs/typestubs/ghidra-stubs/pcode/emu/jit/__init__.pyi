...
class JitBytesPcodeExecutorStatePiece(ghidra.pcode.exec_.AbstractBytesPcodeExecutorStatePiece[JitBytesPcodeExecutorStatePiece.JitBytesPcodeExecutorStateSpace]):
    ...
    class JitBytesPcodeExecutorStateSpace(ghidra.pcode.exec_.BytesPcodeExecutorStateSpace):
        """
        ...
        def __init__(self, language: ghidra.program.model.lang.Language, space: ghidra.program.model.address.AddressSpace, piece: ghidra.pcode.exec_.AbstractBytesPcodeExecutorStatePiece[typing.Any]) -> None:
            """
            ...
            :param ghidra.pcode.exec_.AbstractBytesPcodeExecutorStatePiece[typing.Any] piece: the owning piece
            """
        ...
        def write(self, offset: typing.Union[jpype.JLong, int], val: jpype.JArray[jpype.JByte], srcOffset: typing.Union[jpype.JInt, int], length: typing.Union[jpype.JInt, int]) -> None:
            """
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, cb: ghidra.pcode.exec_.PcodeStateCallbacks) -> None:
        """
        Construct a state piece
        
        :param ghidra.program.model.lang.Language language: the emulation target language
        :param ghidra.pcode.exec_.PcodeStateCallbacks cb: callbacks to receive emulation events. Note that many accesses by the JIT are
...
class JitCompiler(java.lang.Object):
    ...
    ***************
    ...
    def __init__(self, config: JitConfiguration) -> None:
        """
...
class JitConfiguration(java.lang.Record):
    ...
    class Opt(java.lang.Enum[JitConfiguration.Opt]):
        """
        Fluent specifiers for the boolean options of :obj:`JitConfiguration`
        """

        class_: typing.ClassVar[java.lang.Class]
        REMOVE_UNUSED_OPERATIONS: typing.Final[JitConfiguration.Opt]
        """
        ...
        EMIT_COUNTERS: typing.Final[JitConfiguration.Opt]
        """
        Causes the translator to emit a call to :meth:`JitPcodeThread.count(int, int) <JitPcodeThread.count>` at the
        start of each basic block.
        """

        LOG_STACK_TRACES: typing.Final[JitConfiguration.Opt]
        """
        ...
        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> JitConfiguration.Opt:
            ...

        @staticmethod
        def values() -> jpype.JArray[JitConfiguration.Opt]:
            ...
    ...
    @typing.overload
    def __init__(self, opts: java.util.Set[JitConfiguration.Opt]) -> None:
        """
        Construct a configuration with default maxes and the given boolean options
        
        :param java.util.Set[JitConfiguration.Opt] opts: the options
        """

    @typing.overload
    def __init__(self, *opts: JitConfiguration.Opt) -> None:
        """
        Construct a configuration with default maxes and the given boolean options
        
        :param jpype.JArray[JitConfiguration.Opt] opts: the options
        """

    @typing.overload
    def __init__(self, maxPassageInstructions: typing.Union[jpype.JInt, int], maxPassageOps: typing.Union[jpype.JInt, int], maxPassageStrides: typing.Union[jpype.JInt, int], removeUnusedOperations: typing.Union[jpype.JBoolean, bool], emitCounters: typing.Union[jpype.JBoolean, bool], logStackTraces: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class JitPassage(ghidra.pcode.exec_.PcodeProgram):
    ...
    class AddrCtx(java.lang.Comparable[JitPassage.AddrCtx]):
        ...
        def __init__(self, ctx: ghidra.program.model.lang.RegisterValue, address: ghidra.program.model.address.Address) -> None:
            """
    ...
    class SIntBranch(java.lang.Record, JitPassage.IntBranch, JitPassage.SBranch):
        ...
        def __init__(self, from_: ghidra.program.model.pcode.PcodeOp, to: ghidra.program.model.pcode.PcodeOp, isFall: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    class RIntBranch(java.lang.Record, JitPassage.IntBranch, JitPassage.RBranch):
        ...
        def __init__(self, from_: ghidra.program.model.pcode.PcodeOp, to: ghidra.program.model.pcode.PcodeOp, isFall: typing.Union[jpype.JBoolean, bool], reach: JitPassage.Reachability) -> None:
            ...
    ...
    class SExtBranch(java.lang.Record, JitPassage.ExtBranch, JitPassage.SBranch):
        ...
        def __init__(self, from_: ghidra.program.model.pcode.PcodeOp, to: JitPassage.AddrCtx) -> None:
            ...
    ...
    class RExtBranch(java.lang.Record, JitPassage.ExtBranch, JitPassage.RBranch):
        ...
        def __init__(self, from_: ghidra.program.model.pcode.PcodeOp, to: JitPassage.AddrCtx, reach: JitPassage.Reachability) -> None:
            ...
    ...
    class SIndBranch(java.lang.Record, JitPassage.IndBranch, JitPassage.SBranch):
        ...
        def __init__(self, from_: ghidra.program.model.pcode.PcodeOp, flowCtx: ghidra.program.model.lang.RegisterValue) -> None:
            ...
    ...
    class RIndBranch(java.lang.Record, JitPassage.IndBranch, JitPassage.RBranch):
        ...
        def __init__(self, from_: ghidra.program.model.pcode.PcodeOp, flowCtx: ghidra.program.model.lang.RegisterValue, reach: JitPassage.Reachability) -> None:
            ...
    ...
    class ErrBranch(java.lang.Record, JitPassage.SBranch, JitPassage.PBranch):
        ...
        * A :obj:`call <PcodeOp.CALLOTHER>` to an undefined userop
        ...
        def __init__(self, from_: ghidra.program.model.pcode.PcodeOp, message: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class DecodedPcodeOp(ghidra.program.model.pcode.PcodeOp):
        ...
        def __init__(self, at: JitPassage.AddrCtx, original: ghidra.program.model.pcode.PcodeOp) -> None:
            """
    ...
    class EntryPcodeOp(ghidra.program.model.pcode.PcodeOp):
        ...
        def __init__(self, entry: JitPassage.AddrCtx) -> None:
            """
    ...
    class NopPcodeOp(JitPassage.DecodedPcodeOp):
        ...
        * A p-code branch to the end of an instruction. Most often a slaspec author that means to
        ...
        def __init__(self, at: JitPassage.AddrCtx, seq: typing.Union[jpype.JInt, int]) -> None:
            """
    ...
    class DecodeErrorPcodeOp(JitPassage.DecodedPcodeOp):
        ...
        def __init__(self, at: JitPassage.AddrCtx) -> None:
            """
    ...
    class DecodeErrorInstruction(ghidra.app.util.PseudoInstruction):
        ...
        class DecodeErrorProcessorContext(ghidra.program.model.lang.ProcessorContext):
            ...
            def __init__(self, language: ghidra.program.model.lang.Language, ctx: ghidra.program.model.lang.RegisterValue) -> None:
                ...


        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, language: ghidra.program.model.lang.Language, address: ghidra.program.model.address.Address, ctx: ghidra.program.model.lang.RegisterValue, message: typing.Union[java.lang.String, str]) -> None:
            """
...
class JitPcodeThread(ghidra.pcode.emu.BytesPcodeThread):
    ...
    *******
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], machine: JitPcodeEmulator) -> None:
        """
        Create a thread
    ...
    def count(self, instructions: typing.Union[jpype.JInt, int], trailingOps: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setCounterAndContext(self, counter: ghidra.program.model.address.Address, context: ghidra.program.model.lang.RegisterValue) -> None:
        """
    ...
    def writeCounterAndContext(self, counter: ghidra.program.model.address.Address, context: ghidra.program.model.lang.RegisterValue) -> None:
        """
...
class JitPcodeEmulator(ghidra.pcode.emu.PcodeEmulator):
    ...
    configuration, and some annotations you might add to a :obj:`PcodeUseropLibrary`, you can simply
    replace ``new PcodeEmulator()`` with ``new JitPcodeEmulator(...)``.
    ...
    *****************
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, config: JitConfiguration, lookup: java.lang.invoke.MethodHandles.Lookup) -> None:
        """
...
class JitThreadBytesPcodeExecutorState(ghidra.pcode.emu.ThreadPcodeExecutorState[jpype.JArray[jpype.JByte]], JitBytesPcodeExecutorState):
    ...
    def __init__(self, sharedState: JitDefaultBytesPcodeExecutorState, localState: JitDefaultBytesPcodeExecutorState) -> None:
        """
...
class JitDefaultBytesPcodeExecutorState(ghidra.pcode.exec_.DefaultPcodeExecutorState[jpype.JArray[jpype.JByte]], JitBytesPcodeExecutorState):
    ...
    **NOTE**: This is distinct from :obj:`JitDataFlowState`, which is used during the
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, cb: ghidra.pcode.exec_.PcodeStateCallbacks) -> None:
        ...
        :param ghidra.program.model.lang.Language language: the emulation target language
        :param ghidra.pcode.exec_.PcodeStateCallbacks cb: callbacks to receive emulation events. Because the JIT often accesses state
...
class JitJvmTypeUtils(java.lang.Enum[JitJvmTypeUtils]):
    ...
    **WARNING:** It seems to me, the internal representation of signatures as accepted by the ASM
    ...
    @staticmethod
    def erase(type: java.lang.reflect.Type) -> java.lang.Class[typing.Any]:
        """
    ...
    @staticmethod
    def eraseBounds(bounds: jpype.JArray[java.lang.reflect.Type]) -> java.lang.Class[typing.Any]:
        """
        Compute the erasure of a type variable with the given upper bounds
        
        :param jpype.JArray[java.lang.reflect.Type] bounds: the upper bounds
        :return: the erasure
        :rtype: java.lang.Class[typing.Any]
        """
...
__all__ = ["JitBytesPcodeExecutorStatePiece", "JitBytesPcodeExecutorState", "JitCompiler", "JitConfiguration", "JitPassage", "JitPcodeThread", "JitPcodeEmulator", "JitThreadBytesPcodeExecutorState", "JitDefaultBytesPcodeExecutorState", "JitJvmTypeUtils"]
