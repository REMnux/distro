...
class BSimSearchService(java.lang.Object):
    ...
    def performOverview(self, severCache: BSimServerCache, settings: BSimSearchSettings) -> None:
        """
    ...
    def search(self, severCache: BSimServerCache, settings: BSimSearchSettings, functions: java.util.Set[ghidra.program.database.symbol.FunctionSymbol]) -> None:
        """
...
class BSimServerCache(java.lang.Object):
    ...
    def __init__(self, severInfo: ghidra.features.bsim.query.BSimServerInfo) -> None:
        ...
...
class BSimSearchSettings(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, similarity: typing.Union[jpype.JDouble, float], confidence: typing.Union[jpype.JDouble, float], maxResults: typing.Union[jpype.JInt, int], filterSet: BSimFilterSet) -> None:
        ...
...
class BSimFilterSet(java.lang.Object):
    ...
    def addEntry(self, filterType: ghidra.features.bsim.gui.filters.BSimFilterType, values: java.util.List[java.lang.String]) -> None:
        """
    ...
    def removeAll(self, filterType: ghidra.features.bsim.gui.filters.BSimFilterType) -> None:
        """
...
class BSimFilterPanel(javax.swing.JPanel):
    ...
    @typing.overload
    def __init__(self, changeListener: utility.function.Callback) -> None:
        """
    ...
    @typing.overload
    def __init__(self, filters: java.util.List[ghidra.features.bsim.gui.filters.BSimFilterType], filterSet: BSimFilterSet, changeListener: utility.function.Callback) -> None:
        """
    ...
    def setFilterSet(self, filterSet: BSimFilterSet) -> None:
        """
    ...
    def setFilters(self, filters: java.util.List[ghidra.features.bsim.gui.filters.BSimFilterType]) -> None:
        """
...
class FilterWidget(javax.swing.JPanel):
    ...
    def __init__(self, filterTypes: java.util.List[ghidra.features.bsim.gui.filters.BSimFilterType], removeConsumer: java.util.function.Consumer[FilterWidget], changeListener: utility.function.Callback) -> None:
        """
    ...
    def setFilter(self, filter: ghidra.features.bsim.gui.filters.BSimFilterType, values: java.util.List[java.lang.String]) -> None:
        ...
...
class BSimOverviewDialog(AbstractBSimSearchDialog):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, service: BSimSearchService, serverManager: ghidra.features.bsim.gui.BSimServerManager) -> None:
        ...
...
class BSimSearchDialog(AbstractBSimSearchDialog):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, service: BSimSearchService, serverManager: ghidra.features.bsim.gui.BSimServerManager, functions: java.util.Set[ghidra.program.database.symbol.FunctionSymbol]) -> None:
        ...
...
class BSimServerDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, serverManager: ghidra.features.bsim.gui.BSimServerManager) -> None:
        ...
...
class BSimServerTableModel(docking.widgets.table.GDynamicColumnTableModel[ghidra.features.bsim.query.BSimServerInfo, java.lang.Object]):
    ...
    def __init__(self, serverManager: ghidra.features.bsim.gui.BSimServerManager) -> None:
        ...
...
class CreateBsimServerInfoDialog(docking.DialogComponentProvider):
    ...
    class NotifyingTextField(javax.swing.JTextField):
        ...
        @typing.overload
        def __init__(self, initialText: typing.Union[java.lang.String, str]) -> None:
            ...
...
class SelectedFunctionsTableDialog(docking.DialogComponentProvider):
    ...
    @typing.overload
    def __init__(self, functionSymbols: java.util.Set[ghidra.program.database.symbol.FunctionSymbol], gotoService: ghidra.app.services.GoToService, help: ghidra.util.HelpLocation) -> None:
        ...

    @typing.overload
    def __init__(self, functionSymbols: java.util.Set[ghidra.program.database.symbol.FunctionSymbol], gotoService: ghidra.app.services.GoToService, help: ghidra.util.HelpLocation, matchCounts: collections.abc.Mapping) -> None:
        ...



__all__ = ["BSimSearchService", "BSimServerCache", "BSimSearchSettings", "BSimFilterSet", "BSimServerManagerListener", "AbstractBSimSearchDialog", "BSimFilterPanel", "FilterWidget", "BSimOverviewDialog", "BSimSearchDialog", "BSimServerDialog", "BSimServerTableModel", "ConnectionPoolStatus", "CreateBsimServerInfoDialog", "FunctionSymbolToFunctionTableRowMapper", "SelectedFunctionsTableDialog"]
