...
class AddressMapDBAdapter(java.lang.Object):
    ...
    class AddressMapEntry(java.lang.Object):
        ...
        def __init__(self, index: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str], segment: typing.Union[jpype.JInt, int], deleted: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
...
class AddressMapDB(AddressMap):
    ...
    def __init__(self, handle: db.DBHandle, openMode: ghidra.framework.data.OpenMode, factory: ghidra.program.model.address.AddressFactory, baseImageOffset: typing.Union[jpype.JLong, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def deleteOverlaySpace(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def renameOverlaySpace(self, oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
...
class NormalizedAddressSet(ghidra.program.model.address.AddressSetView):
    ...
    def __init__(self, addrMap: AddressMap) -> None:
        """
...
class AddressKeyIterator(db.DBLongIterator):
    ...
    @typing.overload
    def __init__(self, table: db.Table, addrMap: AddressMap, before: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, table: db.Table, addrMap: AddressMap, startAddr: ghidra.program.model.address.Address, before: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, table: db.Table, addrMap: AddressMap, minAddr: ghidra.program.model.address.Address, maxAddr: ghidra.program.model.address.Address, startAddr: ghidra.program.model.address.Address, before: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, table: db.Table, addrMap: AddressMap, set: ghidra.program.model.address.AddressSetView, startAddr: ghidra.program.model.address.Address, before: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AddressIndexKeyIterator(db.DBLongIterator):
    ...
    @typing.overload
    def __init__(self, table: db.Table, indexCol: typing.Union[jpype.JInt, int], addrMap: AddressMap, atStart: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, table: db.Table, indexCol: typing.Union[jpype.JInt, int], addrMap: AddressMap, minAddr: ghidra.program.model.address.Address, maxAddr: ghidra.program.model.address.Address, atStart: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, table: db.Table, indexCol: typing.Union[jpype.JInt, int], addrMap: AddressMap, set: ghidra.program.model.address.AddressSetView, atStart: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, table: db.Table, indexCol: typing.Union[jpype.JInt, int], addrMap: AddressMap, absolute: typing.Union[jpype.JBoolean, bool], set: ghidra.program.model.address.AddressSetView, atStart: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new AddressIndexKeyIterator for a set of addresses
    ...
    @typing.overload
    def __init__(self, table: db.Table, indexCol: typing.Union[jpype.JInt, int], addrMap: AddressMap, start: ghidra.program.model.address.Address, before: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AddressKeyAddressIterator(ghidra.program.model.address.AddressIterator):
    ...
    def __init__(self, keyIter: db.DBLongIterator, forward: typing.Union[jpype.JBoolean, bool], addrMap: AddressMap, errHandler: db.util.ErrorHandler) -> None:
        """
        Constructor.
...
class AddressKeyRecordIterator(db.RecordIterator):
    ...
    @typing.overload
    def __init__(self, table: db.Table, addrMap: AddressMap) -> None:
        """
...
__all__ = ["AddressMap", "AddressMapDBAdapter", "AddressMapDB", "NormalizedAddressSet", "AddressKeyIterator", "AddressIndexKeyIterator", "AddressIndexPrimaryKeyIterator", "AddressKeyAddressIterator", "AddressKeyRecordIterator", "AddressMapDBAdapterNoTable", "AddressMapDBAdapterV0", "AddressMapDBAdapterV1", "AddressRecordDeleter"]
