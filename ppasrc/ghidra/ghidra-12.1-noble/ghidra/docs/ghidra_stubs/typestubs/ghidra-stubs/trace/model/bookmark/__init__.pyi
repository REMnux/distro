...
class TraceBookmarkType(ghidra.program.model.listing.BookmarkType):
    ...
    def setMarkerPriority(self, priority: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["TraceBookmarkManager", "TraceBookmarkOperations", "TraceBookmarkSpace", "TraceBookmarkType", "TraceBookmark"]
