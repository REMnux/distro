...
class ContextState(java.lang.Object):
    ...
    class MemoryByteVarnode(ghidra.program.model.pcode.Varnode):
        ...
        def __init__(self, val: typing.Union[jpype.JByte, int]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, entryPt: ghidra.program.model.address.Address, program: ghidra.program.model.listing.Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, entryPt: ghidra.program.model.address.Address, programCtx: ghidra.program.model.listing.ProgramContext, program: ghidra.program.model.listing.Program) -> None:
        """
        Constructs an empty state.
    ...
    @typing.overload
    def __init__(self, pcodeEntry: ghidra.program.model.pcode.SequenceNumber, previousState: ContextState) -> None:
        """
...
class SequenceRange(java.lang.Object):
    ...
    def __init__(self, start: ghidra.program.model.pcode.SequenceNumber, end: ghidra.program.model.pcode.SequenceNumber) -> None:
        ...
...
class VarnodeOperation(ghidra.program.model.pcode.Varnode):
    ...
    def __init__(self, pcodeOp: ghidra.program.model.pcode.PcodeOp, inputValues: jpype.JArray[ghidra.program.model.pcode.Varnode]) -> None:
        ...
    ...
    def setSimplified(self, simplified: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class FunctionAnalyzer(java.lang.Object):
    ...
    def dataReference(self, op: ghidra.program.model.pcode.PcodeOp, instrOpIndex: typing.Union[jpype.JInt, int], storageVarnode: ghidra.program.model.pcode.Varnode, refType: ghidra.program.model.symbol.RefType, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def stackReference(self, op: ghidra.program.model.pcode.PcodeOp, instrOpIndex: typing.Union[jpype.JInt, int], computedStackOffset: VarnodeOperation, size: typing.Union[jpype.JInt, int], storageSpaceID: typing.Union[jpype.JInt, int], refType: ghidra.program.model.symbol.RefType, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class ResultsState(java.lang.Object):
    ...
    class InlineCallException(java.lang.Exception):
        ...
        def __init__(self, destAddr: ghidra.program.model.address.Address) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, entryPt: ghidra.program.model.address.Address, analyzer: FunctionAnalyzer, program: ghidra.program.model.listing.Program, maintainInstructionResults: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def __init__(self, flowList: java.util.LinkedList[ghidra.program.model.pcode.SequenceNumber], analyzer: FunctionAnalyzer, entryState: ContextState, maintainInstructionResults: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def assume(self, register: ghidra.program.model.lang.Register, value: typing.Union[jpype.JLong, int]) -> None:
        """
...
__all__ = ["ContextState", "SequenceRange", "VarnodeOperation", "FunctionAnalyzer", "ResultsState"]
