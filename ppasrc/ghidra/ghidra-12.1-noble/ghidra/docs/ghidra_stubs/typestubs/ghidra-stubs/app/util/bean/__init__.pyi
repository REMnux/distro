...
class FixedBitSizeValueField(javax.swing.JPanel):
    ...
    def __init__(self, bitSize: typing.Union[jpype.JInt, int], includeFormatButton: typing.Union[jpype.JBoolean, bool], leftJustify: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setFormat(self, radix: typing.Union[jpype.JInt, int], signed: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setMinMax(self, min: java.math.BigInteger, max: java.math.BigInteger) -> None:
        ...
...
class SetEquateDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, program: ghidra.program.model.listing.Program, value: ghidra.program.model.scalar.Scalar) -> None:
        """
        Constructor
...
class SetEquateTableModel(docking.widgets.table.GDynamicColumnTableModel[SetEquateDialog.EquateRowObject, ghidra.program.model.listing.Program]):
    ...
    def __init__(self, serviceProvider: ghidra.framework.plugintool.ServiceProvider, data: java.util.List[SetEquateDialog.EquateRowObject], program: ghidra.program.model.listing.Program) -> None:
        ...
...
class SelectLanguagePanel(javax.swing.JPanel):
    ...
    def __init__(self, service: ghidra.program.model.lang.LanguageService) -> None:
        """
    ...
    def setShowVersion(self, enable: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
__all__ = ["FixedBitSizeValueField", "SetEquateDialog", "SetEquateTableModel", "SelectLanguagePanel", "SelectLanguagePanelListener"]
