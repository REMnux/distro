...
class ClientUtil(java.lang.Object):
    ...
    @staticmethod
    def changePassword(parent: java.awt.Component, handle: ghidra.framework.remote.RepositoryServerHandle, serverInfo: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    def checkGhidraServer(host: typing.Union[java.lang.String, str], port: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @staticmethod
    def clearRepositoryAdapter(host: typing.Union[java.lang.String, str], port: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def handleException(repository: RepositoryAdapter, exc: java.lang.Exception, operation: typing.Union[java.lang.String, str], mustRetry: typing.Union[jpype.JBoolean, bool], parent: java.awt.Component) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def handleException(repository: RepositoryAdapter, exc: java.lang.Exception, operation: typing.Union[java.lang.String, str], parent: java.awt.Component) -> None:
        """
        Displays an error dialog appropriate for the given exception. If the exception is a
        ConnectException or NotConnectedException, a prompt to reconnect to the Ghidra Server
    ...
    @staticmethod
    def promptForReconnect(repository: RepositoryAdapter, parent: java.awt.Component) -> None:
        """
    ...
    @staticmethod
    def setClientAuthenticator(authenticator: ClientAuthenticator) -> None:
        """
...
class RepositoryServerAdapter(java.lang.Object):
    ...
    def addListener(self, listener: RemoteAdapterListener) -> None:
        """
    ...
    def removeListener(self, listener: RemoteAdapterListener) -> None:
        """
...
class RepositoryAdapter(RemoteAdapterListener):
    ...
    def __init__(self, serverAdapter: RepositoryServerAdapter, name: typing.Union[java.lang.String, str]) -> None:
        """
        Construct.
    ...
    def connectionStateChanged(self, adapter: java.lang.Object) -> None:
        """
    ...
    def createDataFile(self, parentPath: typing.Union[java.lang.String, str], itemName: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def getServerInfo(self) -> ghidra.framework.model.ServerInfo:
        ...
        :rtype: ghidra.framework.model.ServerInfo
        """
    ...
    def setUserList(self, users: jpype.JArray[ghidra.framework.remote.User], anonymousAccessAllowed: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        ...
        :raises UserAccessException: user is not a repository Admin
        :raises IOException: if an IO error occurs
        :raises NotConnectedException: if server/repository connection is down (user already informed)
    ...
    def terminateCheckout(self, folderPath: typing.Union[java.lang.String, str], itemName: typing.Union[java.lang.String, str], checkoutId: typing.Union[jpype.JLong, int], notify: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class RepositoryChangeDispatcher(java.lang.Runnable):
    ...
    def setFileChangeListener(self, changeListener: ghidra.framework.store.FileSystemListener) -> None:
        ...
...
class HeadlessClientAuthenticator(ClientAuthenticator):
    ...
    @staticmethod
    def installHeadlessClientAuthenticator(username: typing.Union[java.lang.String, str], keystorePath: typing.Union[java.lang.String, str], allowPasswordPrompt: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class PasswordClientAuthenticator(ClientAuthenticator):
    ...
    @typing.overload
    def __init__(self, password: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, username: typing.Union[java.lang.String, str], password: typing.Union[java.lang.String, str]) -> None:
        ...
...
__all__ = ["ClientAuthenticator", "ClientUtil", "RepositoryServerAdapter", "RepositoryAdapter", "RemoteAdapterListener", "RepositoryChangeDispatcher", "RepositoryNotFoundException", "NotConnectedException", "DefaultClientAuthenticator", "HeadlessClientAuthenticator", "PasswordClientAuthenticator", "ServerConnectTask"]
