...
class NavigatableComponentProviderAdapter(ComponentProviderAdapter, ghidra.app.nav.Navigatable):
    ...
    def __init__(self, tool: PluginTool, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], contextType: java.lang.Class[typing.Any]) -> None:
        ...
...
class PluginTool(docking.AbstractDockingTool):
    ...
    @typing.overload
    def __init__(self, project: ghidra.framework.model.Project, template: ghidra.framework.model.ToolTemplate) -> None:
        """
    ...
    @typing.overload
    def __init__(self, project: ghidra.framework.model.Project, name: typing.Union[java.lang.String, str], isDockable: typing.Union[jpype.JBoolean, bool], hasStatus: typing.Union[jpype.JBoolean, bool], isModal: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a new PluginTool.
    ...
    def addEventListener(self, eventClass: java.lang.Class[PluginEvent], listener: ghidra.framework.plugintool.util.PluginEventListener) -> None:
        ...
    ...
    @typing.overload
    def addPlugin(self, className: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def addPlugin(self, p: Plugin) -> None:
        ...

    @typing.overload
    @deprecated("use addPlugins(Collection)")
    def addPlugins(self, classNames: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def addPlugins(self, classNames: collections.abc.Sequence) -> None:
        """
        Add plugins to the tool.
    ...
    def addStatusComponent(self, c: javax.swing.JComponent, addBorder: typing.Union[jpype.JBoolean, bool], rightSide: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def execute(self, commandName: typing.Union[java.lang.String, str], domainObject: T, r: java.lang.Runnable) -> None:
        """
        Execute the given command in the foreground.  Required domain object transaction will be
        started with delayed end to ensure that any follow-on analysis starts prior to transaction 
        end.
    ...
    @typing.overload
    def execute(self, task: ghidra.util.task.Task, delay: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def executeBackgroundCommand(self, cmd: ghidra.framework.cmd.BackgroundCommand[T], obj: T) -> None:
        """
    ...
    def firePluginEvent(self, event: PluginEvent) -> None:
        ...
    ...
    def processToolEvent(self, toolEvent: PluginEvent) -> None:
        ...

    def putInstanceName(self, newInstanceName: typing.Union[java.lang.String, str]) -> None:
        ...

    def registerDefaultContextProvider(self, type: java.lang.Class[docking.ActionContext], provider: docking.action.ActionContextProvider) -> None:
        """
    ...
    def registerOptionsNameChange(self, oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def removeEventListener(self, eventClass: java.lang.Class[PluginEvent], listener: ghidra.framework.plugintool.util.PluginEventListener) -> None:
        ...
    ...
    def removePlugins(self, plugins: jpype.JArray[Plugin]) -> None:
        """
    ...
    @typing.overload
    def removePlugins(self, plugins: java.util.List[Plugin]) -> None:
        """
        Remove the array of plugins from the tool.
    ...
    def removePreferenceState(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def restoreDataStateFromXml(self, root: org.jdom2.Element) -> None:
        ...

    def restoreWindowingDataFromXml(self, element: org.jdom2.Element) -> None:
        ...

    def saveDataStateToXml(self, savingProject: typing.Union[jpype.JBoolean, bool]) -> org.jdom2.Element:
        ...

    def saveToXml(self, includeConfigState: typing.Union[jpype.JBoolean, bool]) -> org.jdom2.Element:
        ...
    ...
    def scheduleFollowOnCommand(self, cmd: ghidra.framework.cmd.BackgroundCommand[T], obj: T) -> None:
        """
    ...
    def setLocation(self, x: typing.Union[jpype.JInt, int], y: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setSize(self, width: typing.Union[jpype.JInt, int], height: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setToolName(self, name: typing.Union[java.lang.String, str]) -> None:
        ...

    def setUnconfigurable(self) -> None:
        ...

    def setWindowsOnTop(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def showComponentHeader(self, provider: docking.ComponentProvider, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def showConfig(self, addSaveActions: typing.Union[jpype.JBoolean, bool], isNewTool: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def unregisterDefaultContextProvider(self, type: java.lang.Class[docking.ActionContext], provider: docking.action.ActionContextProvider) -> None:
        """
...
class PluginsConfiguration(java.lang.Object):
    ...
    def getPluginClassNames(self, element: org.jdom2.Element) -> java.util.Set[java.lang.String]:
        ...
    ...
    def savePluginsToXml(self, root: org.jdom2.Element, plugins: java.util.List[Plugin]) -> None:
        ...
...
class PluginEvent(java.lang.Object):
    ...
    def setSourceName(self, s: typing.Union[java.lang.String, str]) -> None:
        ...

    def setTriggerEvent(self, triggerEvent: PluginEvent) -> None:
        ...
...
class Plugin(ghidra.util.classfinder.ExtensionPoint, ghidra.framework.plugintool.util.PluginEventListener, ghidra.framework.plugintool.util.ServiceListener):
    ...
    * :obj:`ProgramaticUseOnly` - marks this Plugin as special and not for user configuration.
    ...
    def restoreTransientState(self, state: java.lang.Object) -> None:
        """
    ...
    def restoreUndoRedoState(self, domainObject: ghidra.framework.model.DomainObject, state: java.lang.Object) -> None:
        """
    ...
    def serviceAdded(self, interfaceClass: java.lang.Class[typing.Any], service: java.lang.Object) -> None:
        """
    ...
    def serviceRemoved(self, interfaceClass: java.lang.Class[typing.Any], service: java.lang.Object) -> None:
        """
...
class ServiceInterfaceImplementationPair(java.lang.Object):
    ...
    def __init__(self, interfaceClass: java.lang.Class[typing.Any], provider: java.lang.Object) -> None:
        ...
...
class PluginConfigurationModel(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, pluginInstaller: PluginInstaller, pluginPackagingProvider: PluginPackagingProvider) -> None:
        ...
...
class PluginInstaller(java.lang.Object):
    ...
    def addPlugins(self, pluginClassNames: java.util.List[java.lang.String]) -> None:
        """
...
class ComponentProviderAdapter(docking.ComponentProvider):
    ...
    @typing.overload
    def __init__(self, tool: PluginTool, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str]) -> None:
        """
...
class DefaultPluginPackagingProvider(PluginPackagingProvider):
    """
...
class PluginToolAccessUtils(java.lang.Object):
    ...
    @staticmethod
    def dispose(tool: PluginTool) -> None:
        """
        Disposes the tool.
...
class PluginToolMacQuitHandler(java.lang.Object):
    ...
    @staticmethod
    def install(tool: PluginTool) -> None:
        """
...
class ProjectPluginEvent(PluginEvent):
    ...
    def __init__(self, sourceName: typing.Union[java.lang.String, str], project: ghidra.framework.model.Project) -> None:
        """
        Constructor
...
class SettableApplicationInformationDisplayFactory(docking.framework.ApplicationInformationDisplayFactory):
    ...
    def setWindowsIcons(self, windowsIcons: java.util.List[java.awt.Image]) -> None:
        ...
...
class StandAloneApplication(GenericStandAloneApplication):
    ...
    @typing.type_check_only
    class StandAloneToolServices(ToolServicesAdapter):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    @typing.overload
    def __init__(self, propertiesFilename: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], version: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, applicationLayout: utility.application.ApplicationLayout) -> None:
        """
...
class StandAlonePluginTool(PluginTool):
    ...
    def __init__(self, app: GenericStandAloneApplication, name: typing.Union[java.lang.String, str], hasStatus: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ServiceProvider(java.lang.Object):
    ...
    def removeServiceListener(self, listener: ghidra.framework.plugintool.util.ServiceListener) -> None:
        ...
        :param ghidra.framework.plugintool.util.ServiceListener listener: The listener to remove
        """
...
class ServiceProviderDecorator(ServiceProvider):
    ...
    def overrideService(self, serviceClass: java.lang.Class[T], service: java.lang.Object) -> None:
        """
...
class AutoConfigState(java.lang.Object):

    class ConfigFieldCodec(java.lang.Object, typing.Generic[T]):

        class_: typing.ClassVar[java.lang.Class]

        def read(self, state: ghidra.framework.options.SaveState, name: typing.Union[java.lang.String, str], current: T) -> T:
            ...

        def write(self, state: ghidra.framework.options.SaveState, name: typing.Union[java.lang.String, str], value: T) -> None:
            ...


    class BooleanConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.lang.Boolean]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.BooleanConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class ByteConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.lang.Byte]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.ByteConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class ShortConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.lang.Short]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.ShortConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class IntConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.lang.Integer]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.IntConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class LongConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.lang.Long]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.LongConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class FloatConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.lang.Float]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.FloatConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class DoubleConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.lang.Double]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.DoubleConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class StringConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.lang.String]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.StringConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class BooleanArrayConfigFieldCodec(AutoConfigState.ConfigFieldCodec[jpype.JArray[jpype.JBoolean]]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.BooleanArrayConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class ByteArrayConfigFieldCodec(AutoConfigState.ConfigFieldCodec[jpype.JArray[jpype.JByte]]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.ByteArrayConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class ShortArrayConfigFieldCodec(AutoConfigState.ConfigFieldCodec[jpype.JArray[jpype.JShort]]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.ShortArrayConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class IntArrayConfigFieldCodec(AutoConfigState.ConfigFieldCodec[jpype.JArray[jpype.JInt]]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.IntArrayConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class LongArrayConfigFieldCodec(AutoConfigState.ConfigFieldCodec[jpype.JArray[jpype.JLong]]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.LongArrayConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class FloatArrayConfigFieldCodec(AutoConfigState.ConfigFieldCodec[jpype.JArray[jpype.JFloat]]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.FloatArrayConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class DoubleArrayConfigFieldCodec(AutoConfigState.ConfigFieldCodec[jpype.JArray[jpype.JDouble]]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.DoubleArrayConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class StringArrayConfigFieldCodec(AutoConfigState.ConfigFieldCodec[jpype.JArray[java.lang.String]]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.StringArrayConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class BigIntegerConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.math.BigInteger]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.BigIntegerConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class FileConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.io.File]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.FileConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class PathConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.nio.file.Path]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.PathConfigFieldCodec]
    ...
    class PathIsDir(java.lang.Record):
        ...
        def __init__(self, path: jpype.protocol.SupportsPath) -> None:
            ...
        ...
        @staticmethod
        def fromString(string: typing.Union[java.lang.String, str]) -> AutoConfigState.PathIsDir:
            ...
    ...
    class PathIsDirConfigFieldCodec(AutoConfigState.ConfigFieldCodec[AutoConfigState.PathIsDir]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.PathIsDirConfigFieldCodec]
    ...
    class PathIsFile(java.lang.Record):
        ...
        @staticmethod
        def fromString(string: typing.Union[java.lang.String, str]) -> AutoConfigState.PathIsFile:
            ...
    ...
    class PathIsFileConfigFieldCodec(AutoConfigState.ConfigFieldCodec[AutoConfigState.PathIsFile]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.PathIsFileConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class EnumConfigFieldCodec(AutoConfigState.ConfigFieldCodec[java.lang.Enum[typing.Any]]):

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[AutoConfigState.EnumConfigFieldCodec]

        def __init__(self) -> None:
            ...


    class GenericAsyncConfigFieldCodec(AutoConfigState.ConfigFieldCodec[ghidra.async_.AsyncReference[T, typing.Any]], typing.Generic[T]):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, codec: AutoConfigState.ConfigFieldCodec[T]) -> None:
            ...


    class BooleanAsyncConfigFieldCodec(AutoConfigState.GenericAsyncConfigFieldCodec[java.lang.Boolean]):
    ...
    class ConfigStateField(java.lang.Object, typing.Generic[T]):

        class_: typing.ClassVar[java.lang.Class]

        @staticmethod
        def getCodecByType(cls: java.lang.Class[T]) -> AutoConfigState.ConfigFieldCodec[T]:
            ...

        @staticmethod
        def getState(state: ghidra.framework.options.SaveState, type: java.lang.Class[T], name: typing.Union[java.lang.String, str]) -> T:
            """
            Get an object from a :obj:`SaveState` using a known codec
             
             
            
            This seems like something that should be in SaveState itself.
            
            :param T: the type of the value:param ghidra.framework.options.SaveState state: the state to read from
            :param java.lang.Class[T] type: the expected type of the value
            :param java.lang.String or str name: the name of the name-value pair
            :return: the value of the name-value pair
            :rtype: T
            """

        @staticmethod
        def putState(state: ghidra.framework.options.SaveState, type: java.lang.Class[T], name: typing.Union[java.lang.String, str], value: T) -> None:
            """
            Put an object into a :obj:`SaveState` using a known codec
            ...
            :param T: the type of the value:param ghidra.framework.options.SaveState state: the state to write into
            :param java.lang.Class[T] type: the type of the value
            :param java.lang.String or str name: the name of the name-value pair
            :param T value: the value of the name-value pair
            """


    class ClassHandler(java.lang.Object, typing.Generic[T]):

        class_: typing.ClassVar[java.lang.Class]

        def readConfigState(self, into: T, from_: ghidra.framework.options.SaveState) -> None:
            ...

        def writeConfigState(self, from_: T, into: ghidra.framework.options.SaveState) -> None:
            ...
    ...
    @staticmethod
    def wireHandler(cls: java.lang.Class[T], lookup: java.lang.invoke.MethodHandles.Lookup) -> AutoConfigState.ClassHandler[T]:
        """
        ...
        :param T: the type of the class whose fields are annotated by :obj:`AutoConfigStateField`:param java.lang.Class[T] cls: the class whose fields are annotated
        :param java.lang.invoke.MethodHandles.Lookup lookup: a lookup from within the class, granting access to the annotated fields
        :return: the handler
        :rtype: AutoConfigState.ClassHandler[T]
        """


class AutoService(java.lang.Object):
    ...
    class WiringImpl(AutoService.Wiring):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, listener: ghidra.framework.plugintool.util.AutoServiceListener[typing.Any]) -> None:
            ...
    ...
    @staticmethod
    def registerServicesProvided(plugin: Plugin, cls: java.lang.Class[typing.Any], provider: java.lang.Object) -> None:
        ...

    @staticmethod
    @typing.overload
    def wireServicesConsumed(tool: PluginTool, receiver: java.lang.Object) -> AutoService.Wiring:
        ...

    @staticmethod
    @typing.overload
    def wireServicesConsumed(plugin: Plugin, receiver: java.lang.Object) -> AutoService.Wiring:
        ...

    @staticmethod
    def wireServicesProvidedAndConsumed(plugin: Plugin) -> AutoService.Wiring:
        ...


class PluginToolUtils(java.lang.Enum[PluginToolUtils]):

    class_: typing.ClassVar[java.lang.Class]

    @staticmethod
    def getServiceFromRunningCompatibleTool(tool: PluginTool, serviceClass: java.lang.Class[T]) -> T:
        """
        ...
        :param T: the type of the service:param PluginTool tool: the front-end tool
        :param java.lang.Class[T] serviceClass: the class of the service
        :return: the found service, or ``null`` if no running tool has it
        :rtype: T
        """

    @staticmethod
    def inRunningToolsPreferringActive(tool: PluginTool, action: java.util.function.Function[PluginTool, T]) -> T:
        """
        ...
        :param T: the type of result:param PluginTool tool: the front-end tool, whose running plugin tools to try
        :param java.util.function.Function[PluginTool, T] action: the action to apply to each plugin tool
        :return: the first non-null result of the action, or null if all plugin tools were exhausted
        :rtype: T
        """

    @staticmethod
    def openInMostRecentOrLaunchedCompatibleTool(tool: PluginTool, domainFile: ghidra.framework.model.DomainFile) -> PluginTool:
        """
        ...
        :param PluginTool tool: the front-end tool
        :param ghidra.framework.model.DomainFile domainFile: the domain file to open (may not be null)
        :return: the (possibly new) plugin tool which accepted the domain file
        :rtype: PluginTool
        """

    @staticmethod
    def valueOf(name: typing.Union[java.lang.String, str]) -> PluginToolUtils:
        ...

    @staticmethod
    def values() -> jpype.JArray[PluginToolUtils]:
        ...



__all__ = ["NavigatableComponentProviderAdapter", "PluginTool", "PluginManager", "PluginsConfiguration", "PluginEvent", "Plugin", "ServiceInterfaceImplementationPair", "PluginConfigurationModel", "PluginInstaller", "PluginPackagingProvider", "BusyToolException", "ComponentProviderAdapter", "DefaultPluginInstaller", "DefaultPluginPackagingProvider", "GenericStandAloneApplication", "ModalPluginTool", "PluginToolAccessUtils", "PluginToolMacAboutHandler", "PluginToolMacQuitHandler", "ProjectPluginEvent", "SettableApplicationInformationDisplayFactory", "StandAloneApplication", "StandAlonePluginTool", "ToolServicesAdapter", "ServiceProvider", "ServiceProviderDecorator", "ServiceProviderStub", "AutoConfigState", "AutoService", "PluginToolUtils"]
