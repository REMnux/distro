...
class TableChooserDialog(docking.DialogComponentProvider, ghidra.app.nav.NavigatableRemovalListener):
    ...
    class TableChooserDialogPanel(ghidra.util.table.GhidraThreadedTablePanel[AddressableRowObject]):
        ...
        def __init__(self, model: docking.widgets.table.threaded.ThreadedTableModel[AddressableRowObject, typing.Any]) -> None:
            ...
    ...
    class TableChooserDialogGhidraTable(ghidra.util.table.GhidraTable):
        ...
        def __init__(self, tm: docking.widgets.table.threaded.ThreadedTableModel[AddressableRowObject, typing.Any]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, executor: TableChooserExecutor, program: ghidra.program.model.listing.Program, title: typing.Union[java.lang.String, str], navigatable: ghidra.app.nav.Navigatable, isModal: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, executor: TableChooserExecutor, program: ghidra.program.model.listing.Program, title: typing.Union[java.lang.String, str], navigatable: ghidra.app.nav.Navigatable) -> None:
        ...

    def add(self, rowObject: AddressableRowObject) -> None:
        """
    ...
    def addCustomColumn(self, columnDisplay: ColumnDisplay[typing.Any]) -> None:
        ...
    ...
    def remove(self, rowObject: AddressableRowObject) -> None:
        """
    ...
    def selectRows(self, *rows: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def setSortColumn(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
...
class TableChooserTableModel(ghidra.util.table.AddressBasedTableModel[AddressableRowObject]):
    ...
    def addCustomColumn(self, columnDisplay: ColumnDisplay[T]) -> None:
        ...
...
class ColumnDisplayDynamicTableColumnAdapter(ghidra.util.table.field.AbstractProgramBasedDynamicTableColumn[AddressableRowObject, COLUMN_TYPE], java.util.Comparator[AddressableRowObject], typing.Generic[COLUMN_TYPE]):
    ...
    def __init__(self, display: ColumnDisplay[COLUMN_TYPE]) -> None:
        ...
...
__all__ = ["AddressableRowObject", "TableChooserDialog", "TableChooserExecutor", "TableChooserTableModel", "ColumnDisplay", "AbstractColumnDisplay", "AbstractComparableColumnDisplay", "AddressableRowObjectToAddressTableRowMapper", "AddressableRowObjectToFunctionTableRowMapper", "AddressableRowObjectToProgramLocationTableRowMapper", "ColumnDisplayDynamicTableColumnAdapter", "StringColumnDisplay"]
