...
class ExtensionFileFilter(GhidraFileFilter):
    ...
    @typing.overload
    def __init__(self, extension: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, filters: jpype.JArray[java.lang.String], description: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["ExtensionFileFilter", "GhidraFileFilter", "GhidraFileChooserModel"]
