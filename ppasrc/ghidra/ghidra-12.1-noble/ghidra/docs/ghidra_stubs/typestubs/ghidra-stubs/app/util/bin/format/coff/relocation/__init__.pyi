...
class CoffRelocationContext(java.lang.Object):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, header: ghidra.app.util.bin.format.coff.CoffFileHeader, symbolsMap: collections.abc.Mapping) -> None:
        """
    ...
    def putContextValue(self, key: typing.Union[java.lang.String, str], value: java.lang.Object) -> None:
        """
...
__all__ = ["CoffRelocationContext", "CoffRelocationHandler", "CoffRelocationHandlerFactory"]
