...
class DataTypeManager(java.lang.Object):
    ...
    def addDataTypeManagerListener(self, l: DataTypeManagerChangeListener) -> None:
        """
    ...
    def addDataTypes(self, dataTypes: collections.abc.Sequence, handler: DataTypeConflictHandler, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def addInvalidatedListener(self, listener: InvalidatedListener) -> None:
        """
    ...
    def associateDataTypeWithArchive(self, datatype: DataType, archive: SourceArchive) -> None:
        """
    ...
    def disassociate(self, datatype: DataType) -> None:
        """
    ...
    @typing.overload
    def findDataTypes(self, name: typing.Union[java.lang.String, str], list: java.util.List[DataType]) -> None:
        """
        ...
        ``.conflict`` extension will be ignored and thus included in the results.
    ...
    @typing.overload
    def findDataTypes(self, name: typing.Union[java.lang.String, str], list: java.util.List[DataType], caseSensitive: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        ...
        Unlike :meth:`findDataTypes(String, List) <.findDataTypes>`, data types with a ``.conflict`` extension 
    ...
    def findEnumValueNames(self, value: typing.Union[jpype.JLong, int], enumValueNames: java.util.Set[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def getAllDataTypes(self, list: java.util.List[DataType]) -> None:
        """
    ...
    def getProgramArchitectureSummary(self) -> str:
        ...
        data type manager.  If :meth:`getProgramArchitecture() <.getProgramArchitecture>` returns null this method
    ...
    def getUniqueName(self, path: CategoryPath, baseName: typing.Union[java.lang.String, str]) -> str:
        ...
        to be used when generating an artificial data type name only (e.g., ``temp_1``,
    ...
    @typing.overload
    def remove(self, dataType: DataType) -> bool:
        """
    ...
    def remove(self, dataType: DataType, monitor: ghidra.util.task.TaskMonitor) -> bool:
        ...
        use :meth:`remove(DataType) <.remove>`
        """

    @typing.overload
    def remove(self, dataTypes: java.util.List[DataType], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Remove the given data types from this manager.
         
        
        NOTE: Any use of the specified data types within a :obj:`FunctionDefinition` will be 
        converted to the :obj:`default 'undefined' datatype <DataType.DEFAULT>`.  Any use within
        a :obj:`Structure` or :obj:`Union` will be converted to the :obj:`BadDataType` as
        a placeholder to retain the component's field name and length (the comment will be prefixed
        with a message indicating the removal of the old datatype.
        
        :param java.util.List[DataType] dataTypes: the data types to be removed
        :param ghidra.util.task.TaskMonitor monitor: the monitor
        :raises CancelledException: if the user cancels
        """

    def removeDataTypeManagerListener(self, l: DataTypeManagerChangeListener) -> None:
        """
    ...
    def removeInvalidatedListener(self, listener: InvalidatedListener) -> None:
        """
    ...
    def removeSourceArchive(self, sourceArchive: SourceArchive) -> None:
        """
    ...
    def replaceDataType(self, existingDt: DataType, replacementDt: DataType, updateCategoryPath: typing.Union[jpype.JBoolean, bool]) -> DataType:
        ...
        :raises java.lang.IllegalArgumentException: if an invalid replacement datatype is specified.
        """
    ...
    def resolve(self, dataType: DataType, handler: DataTypeConflictHandler) -> DataType:
        ...
        :param DataType dataType: the dataType to be resolved.
        :param DataTypeConflictHandler handler: used to resolve conflicts with existing data types.
        :return: an equivalent dataType that "belongs" to this dataTypeManager.
        :rtype: DataType
        """
    ...
    def setFavorite(self, datatype: DataType, isFavorite: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setName(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def withTransaction(self, description: typing.Union[java.lang.String, str], callback: utility.function.ExceptionalCallback[E]) -> None:
        """
...
class CategoryPath(java.lang.Comparable[CategoryPath]):
    ...
    @typing.overload
    def __init__(self, parent: CategoryPath, *subPathElements: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, parent: CategoryPath, subPathElements: java.util.List[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, path: typing.Union[java.lang.String, str]) -> None:
        """
...
class DataType(java.lang.Object):
    ...
    def addParent(self, dt: DataType) -> None:
        """
    ...
    def dataTypeAlignmentChanged(self, dt: DataType) -> None:
        """
    ...
    def dataTypeDeleted(self, dt: DataType) -> None:
        """
    ...
    def dataTypeNameChanged(self, dt: DataType, oldName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def dataTypeReplaced(self, oldDt: DataType, newDt: DataType) -> None:
        """
    ...
    def dataTypeSizeChanged(self, dt: DataType) -> None:
        """
    ...
    def getLength(self) -> int:
        ...
        NOTE: Other than the :obj:`VoidDataType`, no datatype should ever return 0, even if 
        :meth:`isZeroLength() <.isZeroLength>`, and :obj:`Dynamic`/:obj:`FactoryDataType` datatypes 
        must return -1.  If :meth:`isZeroLength() <.isZeroLength>` is true a length of 1 should be returned. 
        Where a zero-length datatype can be handled (e.g., :obj:`Composite`) the 
        :meth:`isZeroLength() <.isZeroLength>` method should be checked for this condition.
    ...
    def removeParent(self, dt: DataType) -> None:
        """
    ...
    def replaceWith(self, dataType: DataType) -> None:
        """
    ...
    def setCategoryPath(self, path: CategoryPath) -> None:
        """
    ...
    def setDescription(self, description: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setLastChangeTime(self, lastChangeTime: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setLastChangeTimeInSourceArchive(self, lastChangeTimeInSourceArchive: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setNameAndCategory(self, path: CategoryPath, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setSourceArchive(self, archive: SourceArchive) -> None:
        """
...
class Structure(Composite):
    ...
    class BitOffsetComparator(java.util.Comparator[java.lang.Object]):
        ...
        def __init__(self, bigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def clearAtOffset(self, offset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def clearComponent(self, ordinal: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def deleteAtOffset(self, offset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def growStructure(self, amount: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def insertAtOffset(self, offset: typing.Union[jpype.JInt, int], dataType: DataType, length: typing.Union[jpype.JInt, int], componentName: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> DataTypeComponent:
        """
        Inserts a new datatype at the specified offset into this structure. Inserting a component
        will cause any conflicting components to shift down to the extent necessary to avoid a
        ...
        :param jpype.JInt or int length: the length to associate with the dataType. For fixed length types a length
                    <= 0 will use the length of the resolved dataType.
        :param java.lang.String or str componentName: the field name to associate with this component. (may be null)
    ...
    @typing.overload
    def replace(self, ordinal: typing.Union[jpype.JInt, int], dataType: DataType, length: typing.Union[jpype.JInt, int], componentName: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> DataTypeComponent:
        """
        Replaces the component at the specified ordinal with a new component using the 
        specified datatype, length, name and comment.  In the case of a packed structure 
        a 1-for-1 replacement will occur.  In the case of a non-packed structure certain
    ...
    def replaceAtOffset(self, offset: typing.Union[jpype.JInt, int], dataType: DataType, length: typing.Union[jpype.JInt, int], componentName: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> DataTypeComponent:
        """
    ...
    def setLength(self, length: typing.Union[jpype.JInt, int]) -> None:
        """
...
class Composite(DataType):
    ...
    @typing.overload
    def add(self, dataType: DataType, componentName: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> DataTypeComponent:
        """
        Adds a new datatype to the end of this composite.
        ...
        :param java.lang.String or str componentName: the field name to associate with this component. (may be null)
                    The name may be sanitized to convert all whitespace characters to an underscore.
        :param java.lang.String or str comment: the comment to associate with this component. (may be null)
        :return: the componentDataType created.
        :rtype: DataTypeComponent
        :raises java.lang.IllegalArgumentException: if the specified data type is not
        allowed to be added to this composite data type.
    ...
    @typing.overload
    def add(self, dataType: DataType, length: typing.Union[jpype.JInt, int], componentName: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> DataTypeComponent:
        """
        Adds a new datatype to the end of this composite.
    ...
    def align(self, minAlignment: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def delete(self, ordinal: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def delete(self, ordinals: java.util.Set[java.lang.Integer]) -> None:
        """
    ...
    def findComponent(self, fieldName: typing.Union[java.lang.String, str]) -> DataTypeComponent:
        """
        ...
        the :meth:`findComponents(String) <.findComponents>` method should be used.  Only components with an explicit 
        non-default field name will be considered.  The name specified may be sanitized to be 
        consistent with those permitted by :obj:`Composite` data types.
        
        :param java.lang.String or str fieldName: field name
        :return: first data type component whose field name matches or null if not found
        :rtype: DataTypeComponent
        """

    def findComponents(self, name: typing.Union[java.lang.String, str]) -> java.util.List[DataTypeComponent]:
        """
        ...
        :param java.lang.String or str name: field name
    ...
    @typing.overload
    def insert(self, ordinal: typing.Union[jpype.JInt, int], dataType: DataType, length: typing.Union[jpype.JInt, int], componentName: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> DataTypeComponent:
        """
        Inserts a new datatype at the specified ordinal position in this composite.
    ...
    def pack(self, packingValue: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setDescription(self, desc: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setExplicitMinimumAlignment(self, minAlignment: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setExplicitPackingValue(self, packingValue: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setPackingEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class FunctionDefinition(DataType, ghidra.program.model.listing.FunctionSignature):
    ...
    def replaceArgument(self, ordinal: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str], dt: DataType, comment: typing.Union[java.lang.String, str], source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    def setArguments(self, *args: ParameterDefinition) -> None:
        """
    ...
    def setCallingConvention(self, conventionName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setComment(self, comment: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setGenericCallingConvention(self, genericCallingConvention: GenericCallingConvention) -> None:
        """
    ...
    def setNoReturn(self, hasNoReturn: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setReturnType(self, type: DataType) -> None:
        """
    ...
    def setVarArgs(self, hasVarArgs: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DataTypePath(java.lang.Comparable[DataTypePath]):
    ...
    @typing.overload
    def __init__(self, categoryPath: typing.Union[java.lang.String, str], dataTypeName: typing.Union[java.lang.String, str]) -> None:
        """
        Create DatatypePath
    ...
    @typing.overload
    def __init__(self, categoryPath: CategoryPath, dataTypeName: typing.Union[java.lang.String, str]) -> None:
        """
        Create DatatypePath
...
class Category(java.lang.Comparable[Category]):
    ...
    def moveCategory(self, category: Category, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def moveDataType(self, type: DataType, handler: DataTypeConflictHandler) -> None:
        """
...
class DataTypeManagerChangeListener(java.lang.Object):
    ...
    def categoryAdded(self, dtm: DataTypeManager, path: CategoryPath) -> None:
        """
    ...
    def categoryMoved(self, dtm: DataTypeManager, oldPath: CategoryPath, newPath: CategoryPath) -> None:
        """
    ...
    def categoryRemoved(self, dtm: DataTypeManager, path: CategoryPath) -> None:
        """
    ...
    def categoryRenamed(self, dtm: DataTypeManager, oldPath: CategoryPath, newPath: CategoryPath) -> None:
        """
    ...
    def dataTypeAdded(self, dtm: DataTypeManager, path: DataTypePath) -> None:
        """
    ...
    def dataTypeChanged(self, dtm: DataTypeManager, path: DataTypePath) -> None:
        """
    ...
    def dataTypeMoved(self, dtm: DataTypeManager, oldPath: DataTypePath, newPath: DataTypePath) -> None:
        """
    ...
    def dataTypeRemoved(self, dtm: DataTypeManager, path: DataTypePath) -> None:
        """
    ...
    def dataTypeRenamed(self, dtm: DataTypeManager, oldPath: DataTypePath, newPath: DataTypePath) -> None:
        """
    ...
    def dataTypeReplaced(self, dtm: DataTypeManager, oldPath: DataTypePath, newPath: DataTypePath, newDataType: DataType) -> None:
        """
    ...
    def favoritesChanged(self, dtm: DataTypeManager, path: DataTypePath, isFavorite: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def programArchitectureChanged(self, dataTypeManager: DataTypeManager) -> None:
        """
    ...
    def restored(self, dataTypeManager: DataTypeManager) -> None:
        """
    ...
    def sourceArchiveAdded(self, dataTypeManager: DataTypeManager, sourceArchive: SourceArchive) -> None:
        """
    ...
    def sourceArchiveChanged(self, dataTypeManager: DataTypeManager, sourceArchive: SourceArchive) -> None:
        """
...
class InvalidatedListener(java.lang.Object):
    ...
    def dataTypeManagerInvalidated(self, dataTypeManager: DataTypeManager) -> None:
        """
...
class SourceArchive(java.lang.Object):
    ...
    def setDirtyFlag(self, dirty: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setLastSyncTime(self, time: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ProgramBasedDataTypeManager(DomainFileBasedDataTypeManager):
    ...
    def moveAddressRange(self, fromAddr: ghidra.program.model.address.Address, toAddr: ghidra.program.model.address.Address, length: typing.Union[jpype.JLong, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class BitFieldDataType(AbstractDataType):
    ...
    @staticmethod
    def checkBaseDataType(baseDataType: DataType) -> None:
        """
    ...
    def getEffectiveBitSize(declaredBitSize: typing.Union[jpype.JInt, int], baseTypeByteSize: typing.Union[jpype.JInt, int]) -> int:
        ...
        :param jpype.JInt or int declaredBitSize: declare bitfield size
        :param jpype.JInt or int baseTypeByteSize: base datatype size in bytes
    ...
    def getStorageSize(self) -> int:
        ...
        :meth:`isZeroLength() <.isZeroLength>` will return true.  This is consistent with other datatypes which 
        support a zero-length :obj:`DataTypeComponent` such as a zero-element Array.
...
class StringRenderParser(java.lang.Object):
    ...
    class StringParseException(ghidra.util.exception.UsrException):
        ...
        @typing.overload
        def __init__(self, pos: typing.Union[jpype.JInt, int], expected: java.util.Set[java.lang.Character], got: typing.Union[jpype.JChar, int, str]) -> None:
            ...

        @typing.overload
        def __init__(self, pos: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def __init__(self, quoteChar: typing.Union[jpype.JChar, int, str], endian: ghidra.program.model.lang.Endian, charsetName: typing.Union[java.lang.String, str], includeBOM: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a parser
...
class AbstractIntegerDataType(BuiltIn, ArrayStringable):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], dtm: DataTypeManager) -> None:
        """
        Constructor
...
class BuiltIn(DataTypeImpl, BuiltInDataType):
    ...
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str], dataMgr: DataTypeManager) -> None:
        ...
...
class Enum(DataType):
    ...
    @typing.overload
    def add(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int]) -> None:
        """
        Add a enum entry.
    ...
    @typing.overload
    def add(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int], comment: typing.Union[java.lang.String, str]) -> None:
        """
        Add a enum entry.
    ...
    def remove(self, name: typing.Union[java.lang.String, str]) -> None:
        """
...
class MissingBuiltInDataType(DataTypeImpl, Dynamic):
    ...
    def __init__(self, path: CategoryPath, missingBuiltInName: typing.Union[java.lang.String, str], missingBuiltInClassPath: typing.Union[java.lang.String, str], dtm: DataTypeManager) -> None:
        """
        ...
        :param DataTypeManager dtm: datatype manager
        """
...
class InternalDataTypeComponent(DataTypeComponent):
    ...
    @staticmethod
    def cleanupFieldName(name: typing.Union[java.lang.String, str]) -> str:
        """
        ...
        :param java.lang.String or str name: original field name (may be null)
    ...
    def update(self, ordinal: typing.Union[jpype.JInt, int], offset: typing.Union[jpype.JInt, int], length: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DataTypeComponent(java.lang.Object):
    ...
    def isDefaultFieldName(self, s: typing.Union[java.lang.String, str]) -> bool:
        """
        Returns true if the given string represents the default field name for this data type 
        component.  This value returned from :meth:`getDefaultFieldName() <.getDefaultFieldName>` may not be a default name
        when this method returns true.
        
        :param java.lang.String or str s: the string to check
    ...
    def setComment(self, comment: typing.Union[java.lang.String, str]) -> DataTypeComponent:
        """
    ...
    def setFieldName(self, fieldName: typing.Union[java.lang.String, str]) -> DataTypeComponent:
        """
...
class PaddingSettingsDefinition(ghidra.docking.settings.EnumSettingsDefinition):
    ...
    def setPadded(self, settings: ghidra.docking.settings.Settings, isPadded: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class EndianSettingsDefinition(ghidra.docking.settings.EnumSettingsDefinition):
    ...
    def setBigEndian(self, settings: ghidra.docking.settings.Settings, isBigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class TypeDefSettingsDefinition(ghidra.docking.settings.SettingsDefinition):
    ...
    @staticmethod
    def concat(settings: jpype.JArray[TypeDefSettingsDefinition], *additional: TypeDefSettingsDefinition) -> jpype.JArray[TypeDefSettingsDefinition]:
        """
        Create a new list of :obj:`TypeDefSettingsDefinition`s by concat'ing a base list with
        a var-arg'ish additional list of setting defs.  Any additional duplicates are discarded.
        
        :param jpype.JArray[TypeDefSettingsDefinition] settings: List of settings defs.
        :param jpype.JArray[TypeDefSettingsDefinition] additional: More settings defs to add
...
class DataTypeEncodeException(ghidra.util.exception.UsrException):
    ...
    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], value: java.lang.Object, dt: DataType) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], value: java.lang.Object, dt: DataType, cause: java.lang.Throwable) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, value: java.lang.Object, dt: DataType, cause: java.lang.Throwable) -> None:
        """
        Constructor
...
class ParameterDefinition(java.lang.Comparable[ParameterDefinition]):
    ...
    def setDataType(self, type: DataType) -> None:
        """
...
class VoidDataType(BuiltIn):
    ...
    @typing.overload
    def __init__(self, dtm: DataTypeManager) -> None:
        ...
...
class DataOrganizationImpl(DataOrganization):
    ...
    @staticmethod
    def save(dataOrg: DataOrganization, dataMap: ghidra.program.database.DBStringMapAdapter, keyPrefix: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setAbsoluteMaxAlignment(self, absoluteMaxAlignment: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setBigEndian(self, bigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Set data endianness
    ...
    def setBitFieldPacking(self, bitFieldPacking: BitFieldPackingImpl) -> None:
        """
    ...
    def setCharIsSigned(self, signed: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setCharSize(self, charSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setDefaultAlignment(self, defaultAlignment: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setDefaultPointerAlignment(self, defaultPointerAlignment: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setDoubleSize(self, doubleSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setFloatSize(self, floatSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setIntegerSize(self, integerSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setLongDoubleSize(self, longDoubleSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setLongLongSize(self, longLongSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setLongSize(self, longSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setMachineAlignment(self, machineAlignment: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setPointerShift(self, pointerShift: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setPointerSize(self, pointerSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setShortSize(self, shortSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setSizeAlignment(self, size: typing.Union[jpype.JInt, int], alignment: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setWideCharSize(self, wideCharSize: typing.Union[jpype.JInt, int]) -> None:
        """
...
class BitFieldPackingImpl(BitFieldPacking):
    ...
    def setTypeAlignmentEnabled(self, typeAlignmentEnabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setUseMSConvention(self, useMSConvention: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setZeroLengthBoundary(self, zeroLengthBoundary: typing.Union[jpype.JInt, int]) -> None:
        """
...
class PointerTypedefBuilder(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, baseDataType: DataType, pointerSize: typing.Union[jpype.JInt, int], dtm: DataTypeManager) -> None:
        """
    ...
    @typing.overload
    def __init__(self, pointerDataType: Pointer, dtm: DataTypeManager) -> None:
        """
        Construct a :obj:`Pointer` - :obj:`TypeDef` builder.
...
class PointerTypedef(GenericDataType, TypeDef):
    ...
    @typing.overload
    def __init__(self, typeDefName: typing.Union[java.lang.String, str], referencedDataType: DataType, pointerSize: typing.Union[jpype.JInt, int], dtm: DataTypeManager, space: ghidra.program.model.address.AddressSpace) -> None:
        """
    ...
    @typing.overload
    def __init__(self, typeDefName: typing.Union[java.lang.String, str], referencedDataType: DataType, pointerSize: typing.Union[jpype.JInt, int], dtm: DataTypeManager, type: PointerType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, typeDefName: typing.Union[java.lang.String, str], referencedDataType: DataType, pointerSize: typing.Union[jpype.JInt, int], dtm: DataTypeManager, componentOffset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, typeDefName: typing.Union[java.lang.String, str], referencedDataType: DataType, pointerSize: typing.Union[jpype.JInt, int], dtm: DataTypeManager) -> None:
        """
    ...
    @typing.overload
    def __init__(self, typeDefName: typing.Union[java.lang.String, str], pointerDataType: Pointer, dtm: DataTypeManager) -> None:
        """
        Constructs a pointer-typedef without any settings
...
class TypedefDataType(GenericDataType, TypeDef):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dt: DataType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str], dt: DataType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str], dt: DataType, dtm: DataTypeManager) -> None:
        """
        Construct a new typedef.
    ...
    @typing.overload
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str], dt: DataType, universalID: ghidra.util.UniversalID, sourceArchive: SourceArchive, lastChangeTime: typing.Union[jpype.JLong, int], lastChangeTimeInSourceArchive: typing.Union[jpype.JLong, int], dtm: DataTypeManager) -> None:
        """
        Construct a new typedef.
    ...
    @staticmethod
    def copyTypeDefSettings(src: TypeDef, dest: TypeDef, clearBeforeCopy: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class StandAloneDataTypeManager(ghidra.program.database.data.DataTypeManagerDB, java.io.Closeable):
    ...
    @typing.overload
    def __init__(self, rootName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, rootName: typing.Union[java.lang.String, str], dataOrganzation: DataOrganization) -> None:
        """
    ...
    def setProgramArchitecture(self, language: ghidra.program.model.lang.Language, compilerSpecId: ghidra.program.model.lang.CompilerSpecID, updateOption: StandAloneDataTypeManager.LanguageUpdateOption, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class FileDataTypeManager(StandAloneDataTypeManager, FileArchiveBasedDataTypeManager):
    ...
    @staticmethod
    @typing.overload
    def delete(packedDbfile: jpype.protocol.SupportsPath) -> None:
        ...
    ...
    @typing.overload
    def saveAs(self, saveFile: jpype.protocol.SupportsPath, newUniversalId: ghidra.util.UniversalID) -> None:
        """
    ...
    @typing.overload
    def saveAs(self, saveFile: jpype.protocol.SupportsPath) -> None:
        """
...
class BitGroup(java.lang.Object):
    ...
    def merge(self, bitGroup: BitGroup) -> None:
        """
...
class AbstractColorDataType(AbstractUnsignedIntegerDataType):
    """
    :obj:`AbstractColorDataType` provides an abstract color datatype whose value corresponds to an 
    approriate Color decode of the bytes at a memory location.  This datatype is a fixed-length
    unsigned integer type which is rendered with a Color block when applied as :obj:`Data`.
     
    
    The :meth:`getValue(MemBuffer, Settings, int) <.getValue>` method returns :obj:`ColorIcon` instance.
    ...
    via a default Setting (See :meth:`getTypeDefSettingsDefinitions() <.getTypeDefSettingsDefinitions>`).
    """

    @typing.type_check_only
    class ComponentValue(java.lang.Record):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], dtm: DataTypeManager) -> None:
        ...
        :param java.lang.String or str name: datatype name
        :param DataTypeManager dtm: datatype manager
        """
...
class ColorIcon(javax.swing.Icon):
    """
    :obj:`ColorIcon` provides a color icon patch to convey a specified color with 
    Alpha transparancy.  This implementation was created in support of color 
    data types (see :obj:`AbstractColorDataType`).
    """

    class_: typing.ClassVar[java.lang.Class]

    def getRGBValue(self) -> int:
        """
...
class AbstractComplexDataType(BuiltIn):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], floats: AbstractFloatDataType, dtm: DataTypeManager) -> None:
        ...
...
class AbstractFloatDataType(BuiltIn):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], encodedLength: typing.Union[jpype.JInt, int], dtm: DataTypeManager) -> None:
        """
...
class AbstractLeb128DataType(BuiltIn, Dynamic):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], signed: typing.Union[jpype.JBoolean, bool], dtm: DataTypeManager) -> None:
        """
...
class CharsetSettingsDefinition(ghidra.docking.settings.EnumSettingsDefinition):
    ...
    def setCharset(self, settings: ghidra.docking.settings.Settings, charset: typing.Union[java.lang.String, str]) -> None:
        ...

    @staticmethod
    def setStaticEncodingMappingValues(mappingValues: collections.abc.Mapping) -> None:
        """
...
class TranslationSettingsDefinition(ghidra.docking.settings.JavaEnumSettingsDefinition[TranslationSettingsDefinition.TRANSLATION_ENUM]):
    ...
    def setShowTranslated(self, settings: ghidra.docking.settings.Settings, shouldShowTranslatedValue: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setTranslatedValue(self, data: ghidra.program.model.listing.Data, translatedValue: typing.Union[java.lang.String, str]) -> None:
        """
...
class StringDataInstance(java.lang.Object):
    ...
    class StaticStringInstance(StringDataInstance):
        ...
        def __init__(self, fakeStr: typing.Union[java.lang.String, str], fakeLen: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    class AdjustedCharsetInfo(java.lang.Object):
        ...
        def __init__(self, charsetName: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, dataType: DataType, settings: ghidra.docking.settings.Settings, buf: ghidra.program.model.mem.MemBuffer, length: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dataType: DataType, settings: ghidra.docking.settings.Settings, buf: ghidra.program.model.mem.MemBuffer, length: typing.Union[jpype.JInt, int], isArrayElement: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Creates a string instance using the data in the :obj:`MemBuffer` and the settings pulled
        from the :obj:`string data type <AbstractStringDataType>`.
...
class ArrayDataType(DataTypeImpl, Array):
    ...
    @typing.overload
    def __init__(self, dataType: DataType, numElements: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dataType: DataType, numElements: typing.Union[jpype.JInt, int], elementLength: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dataType: DataType, numElements: typing.Union[jpype.JInt, int], elementLength: typing.Union[jpype.JInt, int], dataMgr: DataTypeManager) -> None:
        """
...
class BitmapResource(java.lang.Object):
    ...
    def __init__(self, buf: ghidra.program.model.mem.MemBuffer) -> None:
        ...
...
class CompositeDataTypeImpl(GenericDataType, CompositeInternal):
    ...
    def setValue(self, buf: ghidra.program.model.mem.MemBuffer, settings: ghidra.docking.settings.Settings, length: typing.Union[jpype.JInt, int], value: java.lang.Object) -> None:
        ...
...
class DataTypeComponentImpl(InternalDataTypeComponent, java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, dataType: DataType, parent: CompositeDataTypeImpl, length: typing.Union[jpype.JInt, int], ordinal: typing.Union[jpype.JInt, int], offset: typing.Union[jpype.JInt, int], fieldName: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> None:
        """
        ...
        :param java.lang.String or str fieldName: the name associated with this component or null
        :param java.lang.String or str comment: the comment associated with this component or null
        """

    @typing.overload
    def __init__(self, dataType: DataType, parent: CompositeDataTypeImpl, length: typing.Union[jpype.JInt, int], ordinal: typing.Union[jpype.JInt, int], offset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    def checkDefaultFieldName(fieldName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class CountedDynamicDataType(DynamicDataType):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], header: DataType, baseStruct: DataType, counterOffset: typing.Union[jpype.JLong, int], counterSize: typing.Union[jpype.JInt, int], mask: typing.Union[jpype.JLong, int]) -> None:
        """
...
class CustomFormat(java.lang.Object):
    ...
    def __init__(self, dataType: DataType, format: jpype.JArray[jpype.JByte]) -> None:
        """
        Constructor
...
class CycleGroup(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dataTypes: jpype.JArray[DataType], keyStroke: javax.swing.KeyStroke) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dt: DataType, keyStroke: javax.swing.KeyStroke) -> None:
        """
    ...
    def addDataType(self, dt: DataType) -> None:
        """
    ...
    def addFirst(self, dt: DataType) -> None:
        """
    ...
    def removeDataType(self, dt: DataType) -> None:
        """
...
class DataTypeWriter(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, dtm: DataTypeManager, writer: java.io.Writer) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dtm: DataTypeManager, writer: java.io.Writer, cppStyleComments: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new instance of this class using the given writer. The default annotation
        handler is used.
    ...
    @typing.overload
    def __init__(self, dtm: DataTypeManager, writer: java.io.Writer, annotator: AnnotationHandler) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dtm: DataTypeManager, writer: java.io.Writer, annotator: AnnotationHandler, cppStyleComments: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new instance of this class using the given writer and annotation handler
    ...
    @typing.overload
    def write(self, dataTypeManager: DataTypeManager, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def write(self, category: Category, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def write(self, dataTypes: jpype.JArray[DataType], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def write(self, dataTypes: java.util.List[DataType], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def write(self, dataTypes: java.util.List[DataType], monitor: ghidra.util.task.TaskMonitor, throwExceptionOnInvalidType: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DataUtilities(java.lang.Object):
    ...
    def createData(program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, newType: DataType, length: typing.Union[jpype.JInt, int], clearMode: DataUtilities.ClearDataMode) -> ghidra.program.model.listing.Data:
        ...
        :param DataUtilities.ClearDataMode clearMode: the :obj:`ClearDataMode`
...
class StructureDataType(CompositeDataTypeImpl, StructureInternal):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int], dtm: DataTypeManager) -> None:
        """
    ...
    @typing.overload
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int], dtm: DataTypeManager) -> None:
        """
    ...
    @typing.overload
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int], universalID: ghidra.util.UniversalID, sourceArchive: SourceArchive, lastChangeTime: typing.Union[jpype.JLong, int], lastChangeTimeInSourceArchive: typing.Union[jpype.JLong, int], dtm: DataTypeManager) -> None:
        """
...
class EnumDataType(GenericDataType, Enum):
    ...
    def setLength(self, newLength: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class LEB128(java.lang.Object):
    ...
    @staticmethod
    def encode(value: typing.Union[jpype.JLong, int], isSigned: typing.Union[jpype.JBoolean, bool]) -> jpype.JArray[jpype.JByte]:
        """
        Encodes a value into a sequence of LEB128 bytes.
        
        :param jpype.JLong or int value: to encode
        :param jpype.JBoolean or bool isSigned: boolean flag, if true value is encoded as a signed value, if false value is
    ...
    @staticmethod
    def write(value: typing.Union[jpype.JLong, int], os: java.io.OutputStream, isSigned: typing.Union[jpype.JBoolean, bool]) -> int:
        """
        Writes a value to the stream as a sequence of LEB128 bytes.
        
        :param jpype.JLong or int value: to write
        :param java.io.OutputStream os: :obj:`OutputStream` to write to
        :param jpype.JBoolean or bool isSigned: boolean flag, if true value is encoded as a signed value, if false value is
        encoded as an unsigned value
        :return: count of bytes written to stream
        :rtype: int
        :raises IOException: if error writing to stream
        """

    @staticmethod
    def writeSigned(value: typing.Union[jpype.JLong, int], os: java.io.OutputStream) -> int:
        """
        Writes a value to the stream as a sequence of LEB128 bytes.
    ...
    @staticmethod
    def writeUnsigned(value: typing.Union[jpype.JLong, int], os: java.io.OutputStream) -> int:
        """
        Writes a value to the stream as a sequence of LEB128 bytes.
...
class FunctionDefinitionDataType(GenericDataType, FunctionDefinition):
    ...
    @typing.overload
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str], dtm: DataTypeManager) -> None:
        ...

    @typing.overload
    def __init__(self, sig: ghidra.program.model.listing.FunctionSignature) -> None:
        ...

    @typing.overload
    def __init__(self, sig: ghidra.program.model.listing.FunctionSignature, dtm: DataTypeManager) -> None:
        ...

    @typing.overload
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str], sig: ghidra.program.model.listing.FunctionSignature) -> None:
        ...

    @typing.overload
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str], sig: ghidra.program.model.listing.FunctionSignature, dtm: DataTypeManager) -> None:
        ...
    ...
    @typing.overload
    def __init__(self, function: ghidra.program.model.listing.Function, formalSignature: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class MemBufferImageInputStream(javax.imageio.stream.ImageInputStreamImpl):
    ...
    def __init__(self, buf: ghidra.program.model.mem.MemBuffer, byteOrder: java.nio.ByteOrder) -> None:
        ...
...
class NoisyStructureBuilder(java.lang.Object):
    ...
    def addDataType(self, offset: typing.Union[jpype.JLong, int], dt: DataType) -> None:
        """
    ...
    def addReference(self, offset: typing.Union[jpype.JLong, int], dt: DataType) -> None:
        """
    ...
    def populateOriginalStructure(self, dt: Structure) -> None:
        """
    ...
    def setMinimumSize(self, size: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ParameterDefinitionImpl(ParameterDefinition):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], dataType: DataType, comment: typing.Union[java.lang.String, str]) -> None:
        """
...
class PointerDataType(BuiltIn, Pointer):
    ...
    @typing.overload
    def __init__(self, referencedDataType: DataType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, referencedDataType: DataType, length: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, referencedDataType: DataType, dtm: DataTypeManager) -> None:
        """
    ...
    @typing.overload
    def __init__(self, referencedDataType: DataType, length: typing.Union[jpype.JInt, int], dtm: DataTypeManager) -> None:
        """
        Construct a pointer of a specified length to a referencedDataType. Note: It
        is preferred to use default sized pointers when possible (i.e., length=-1,
...
class PointerTypeSettingsDefinition(ghidra.docking.settings.EnumSettingsDefinition, TypeDefSettingsDefinition):
    ...
    def setDisplayChoice(self, settings: ghidra.docking.settings.Settings, choice: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setType(self, settings: ghidra.docking.settings.Settings, type: PointerType) -> None:
        ...
...
class ProgramArchitectureTranslator(ghidra.program.util.LanguageTranslatorAdapter):
    ...
    @typing.overload
    def __init__(self, oldLanguage: ghidra.program.model.lang.Language, oldCompilerSpecId: ghidra.program.model.lang.CompilerSpecID, newLanguage: ghidra.program.model.lang.Language, newCompilerSpecId: ghidra.program.model.lang.CompilerSpecID) -> None:
        ...

    @typing.overload
    def __init__(self, oldLanguageId: ghidra.program.model.lang.LanguageID, oldLanguageVersion: typing.Union[jpype.JInt, int], oldCompilerSpecId: ghidra.program.model.lang.CompilerSpecID, newLanguage: ghidra.program.model.lang.Language, newCompilerSpecId: ghidra.program.model.lang.CompilerSpecID) -> None:
        ...
...
class RGB16EncodingSettingsDefinition(ghidra.docking.settings.EnumSettingsDefinition, TypeDefSettingsDefinition):
    """
    The typedef settings definition which specifies a 16-bit RGB Color Encoding
    """

    class RGB16Encoding(java.lang.Enum[RGB16EncodingSettingsDefinition.RGB16Encoding]):

        class_: typing.ClassVar[java.lang.Class]
        RGB_565: typing.Final[RGB16EncodingSettingsDefinition.RGB16Encoding]
        RGB_555: typing.Final[RGB16EncodingSettingsDefinition.RGB16Encoding]
        ARGB_1555: typing.Final[RGB16EncodingSettingsDefinition.RGB16Encoding]

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> RGB16EncodingSettingsDefinition.RGB16Encoding:
            ...

        @staticmethod
        def values() -> jpype.JArray[RGB16EncodingSettingsDefinition.RGB16Encoding]:
            ...


    class_: typing.ClassVar[java.lang.Class]
    DEFAULT_ENCODING: typing.Final[RGB16EncodingSettingsDefinition.RGB16Encoding]
    DEF: typing.Final[RGB16EncodingSettingsDefinition]

    def getDisplayChoice(self, settings: ghidra.docking.settings.Settings) -> str:
        ...

    def getRGBEncoding(self, settings: ghidra.docking.settings.Settings) -> RGB16EncodingSettingsDefinition.RGB16Encoding:
        """
        ...
        if no setting has been made.
        :rtype: RGB16EncodingSettingsDefinition.RGB16Encoding
        """
    ...
    def setRGBEncoding(self, settings: ghidra.docking.settings.Settings, encoding: RGB16EncodingSettingsDefinition.RGB16Encoding) -> None:
        ...

    @property
    def rGBEncoding(self) -> RGB16EncodingSettingsDefinition.RGB16Encoding:
        ...
...
class RGB16ColorDataType(AbstractColorDataType):
    """
    :obj:`RGB16ColorDataType` provides a base implementation for 16-bit RGB Color values.  
    While this base implementation defaults to RGB_565 encoding a :obj:`TypeDef`
    may be established with a different 16-bit encoding specified via a default setting of 
    :obj:`RGB16EncodingSettingsDefinition`.
    """

    class_: typing.ClassVar[java.lang.Class]
    datatype: typing.ClassVar[RGB16ColorDataType]
    ...
    @staticmethod
    def createRGB16Typedef(rgb16Encoding: RGB16EncodingSettingsDefinition.RGB16Encoding) -> TypedefDataType:
        """
        Generate a 16-bit RGB typedef with a specific encoding
        
        :param RGB16EncodingSettingsDefinition.RGB16Encoding rgb16Encoding: 16-bit RGB encoding
        :return: RGB16 typedef
        :rtype: TypedefDataType
        """


class RGB32EncodingSettingsDefinition(ghidra.docking.settings.EnumSettingsDefinition, TypeDefSettingsDefinition):
    """
    The typedef settings definition which specifies a 32-bit RGB Color Encoding
    """

    class RGB32Encoding(java.lang.Enum[RGB32EncodingSettingsDefinition.RGB32Encoding]):

        class_: typing.ClassVar[java.lang.Class]
        ARGB_8888: typing.Final[RGB32EncodingSettingsDefinition.RGB32Encoding]
        RGBA_8888: typing.Final[RGB32EncodingSettingsDefinition.RGB32Encoding]
        BGRA_8888: typing.Final[RGB32EncodingSettingsDefinition.RGB32Encoding]
        ABGR_8888: typing.Final[RGB32EncodingSettingsDefinition.RGB32Encoding]

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> RGB32EncodingSettingsDefinition.RGB32Encoding:
            ...

        @staticmethod
        def values() -> jpype.JArray[RGB32EncodingSettingsDefinition.RGB32Encoding]:
            ...


    class_: typing.ClassVar[java.lang.Class]
    DEFAULT_ENCODING: typing.Final[RGB32EncodingSettingsDefinition.RGB32Encoding]
    DEF: typing.Final[RGB32EncodingSettingsDefinition]

    def getDisplayChoice(self, settings: ghidra.docking.settings.Settings) -> str:
        ...

    def getRGBEncoding(self, settings: ghidra.docking.settings.Settings) -> RGB32EncodingSettingsDefinition.RGB32Encoding:
        """
        Returns the RGB encoding standard based on the specified settings
        ...
        :return: the RGB encoding standard.  The default encoding will be returned
        if no setting has been made.
        :rtype: RGB32EncodingSettingsDefinition.RGB32Encoding
        """
    ...
    def setRGBEncoding(self, settings: ghidra.docking.settings.Settings, encoding: RGB32EncodingSettingsDefinition.RGB32Encoding) -> None:
        ...

    @property
    def rGBEncoding(self) -> RGB32EncodingSettingsDefinition.RGB32Encoding:
        ...
...
class RGB32ColorDataType(AbstractColorDataType):
    """
    :obj:`RGB32ColorDataType` provides a base implementation for 32-bit RGB Color values with 
    an Alpha channel.  While this base implementation defaults to ARGB_8888 encoding a :obj:`TypeDef`
    may be established with a different 32-bit encoding specified via a default setting of 
    :obj:`RGB32EncodingSettingsDefinition`.
    """

    class_: typing.ClassVar[java.lang.Class]
    datatype: typing.ClassVar[RGB32ColorDataType]
    ...
    @staticmethod
    def createRGB32Typedef(rgb32Encoding: RGB32EncodingSettingsDefinition.RGB32Encoding) -> TypedefDataType:
        """
        Generate a 32-bit RGB typedef with a specific encoding
        
        :param RGB32EncodingSettingsDefinition.RGB32Encoding rgb32Encoding: 32-bit RGB encoding
...
class ReadOnlyDataTypeComponent(DataTypeComponent, java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, dataType: DataType, parent: DynamicDataType, length: typing.Union[jpype.JInt, int], ordinal: typing.Union[jpype.JInt, int], offset: typing.Union[jpype.JInt, int], fieldName: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> None:
        """
        Create a new DataTypeComponent
    ...
    @typing.overload
    def __init__(self, dataType: DataType, parent: DynamicDataType, length: typing.Union[jpype.JInt, int], ordinal: typing.Union[jpype.JInt, int], offset: typing.Union[jpype.JInt, int]) -> None:
        """
        Create a new DataTypeComponent
...
class RepeatedDynamicDataType(DynamicDataType):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], header: DataType, baseStruct: DataType, terminatorValue: typing.Union[jpype.JLong, int], terminatorSize: typing.Union[jpype.JInt, int], dtm: DataTypeManager) -> None:
        """
...
class StringRenderBuilder(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, cs: java.nio.charset.Charset, charSize: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, cs: java.nio.charset.Charset, charSize: typing.Union[jpype.JInt, int], quoteChar: typing.Union[jpype.JChar, int, str]) -> None:
        ...

    def addEscapedCodePoint(self, codePoint: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def decodeBytesUsingCharset(self, bb: java.nio.ByteBuffer, renderSetting: RenderUnicodeSettingsDefinition.RENDER_ENUM, trimTrailingNulls: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class StructuredDynamicDataType(DynamicDataType):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], dtm: DataTypeManager) -> None:
        """
    ...
    def add(self, data: DataType, componentName: typing.Union[java.lang.String, str], componentDescription: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setComponents(self, components: java.util.List[DataType], componentNames: java.util.List[java.lang.String], componentDescs: java.util.List[java.lang.String]) -> None:
        """
...
class TerminatedSettingsDefinition(ghidra.docking.settings.EnumSettingsDefinition):
    ...
    def setTerminated(self, settings: ghidra.docking.settings.Settings, isTerminated: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class UnionDataType(CompositeDataTypeImpl, UnionInternal):
    ...
    @typing.overload
    def __init__(self, path: CategoryPath, name: typing.Union[java.lang.String, str], universalID: ghidra.util.UniversalID, sourceArchive: SourceArchive, lastChangeTime: typing.Union[jpype.JLong, int], lastChangeTimeInSourceArchive: typing.Union[jpype.JLong, int], dtm: DataTypeManager) -> None:
        """
...
__all__ = ["DataTypeManager", "CategoryPath", "DataType", "DataTypeConflictHandler", "Structure", "Composite", "FunctionDefinition", "DataTypeDependencyException", "DataTypePath", "Category", "DataTypeManagerChangeListener", "InvalidatedListener", "Pointer", "SourceArchive", "ArchiveType", "DataOrganization", "DataTypeManagerDomainObject", "ProgramBasedDataTypeManager", "DomainFileBasedDataTypeManager", "FileBasedDataTypeManager", "DataTypeDisplayOptions", "DataTypeManagerChangeListenerHandler", "BitFieldDataType", "AbstractDataType", "StringRenderParser", "AbstractIntegerDataType", "BuiltIn", "DataTypeImpl", "BuiltInDataType", "ArrayStringable", "Enum", "TypeDef", "Array", "StructureInternal", "CompositeInternal", "UnionInternal", "Union", "MissingBuiltInDataType", "Dynamic", "InternalDataTypeComponent", "DataTypeComponent", "PackingType", "AlignmentType", "InvalidDataTypeException", "PaddingSettingsDefinition", "EndianSettingsDefinition", "DataTypeMnemonicSettingsDefinition", "TypeDefSettingsDefinition", "DataTypeEncodeException", "ParameterDefinition", "VoidDataType", "CharDataType", "DataTypeWithCharset", "DataOrganizationImpl", "BitFieldPackingImpl", "BitFieldPacking", "PointerTypedefBuilder", "PointerTypedef", "GenericDataType", "PointerType", "TypedefDataType", "GenericCallingConvention", "StandAloneDataTypeManager", "ProjectArchiveBasedDataTypeManager", "FileDataTypeManager", "FileArchiveBasedDataTypeManager", "BitGroup", "AlignedStructurePacker", "AIFFDataType", "AUDataType", "AbstractColorDataType", "AbstractUnsignedIntegerDataType", "ColorIcon", "AbstractComplexDataType", "AbstractFloatDataType", "AbstractLeb128DataType", "AbstractPointerTypedefBuiltIn", "AbstractSignedIntegerDataType", "CharsetSettingsDefinition", "RenderUnicodeSettingsDefinition", "TranslationSettingsDefinition", "AbstractStringDataType", "StringLayoutEnum", "StringDataInstance", "AddressSpaceSettingsDefinition", "AlignedComponentPacker", "AlignedStructureInspector", "AlignmentDataType", "AnnotationHandler", "ArrayDataType", "AudioPlayer", "Playable", "BadDataType", "BitmapResource", "DataImage", "BitmapResourceDataType", "DynamicDataType", "Resource", "BooleanDataType", "BuiltInDataTypeClassExclusionFilter", "BuiltInDataTypeManager", "ByteDataType", "SignedByteDataType", "Complex16DataType", "Complex32DataType", "Complex8DataType", "ComponentOffsetSettingsDefinition", "CompositeAlignmentHelper", "CompositeDataTypeImpl", "DataTypeComponentImpl", "CountedDynamicDataType", "CustomFormat", "CustomOrganization", "CycleGroup", "DWordDataType", "SignedDWordDataType", "DataTypeArchiveIdDumper", "DataTypeComparator", "DataTypeInstance", "DataTypeManagerChangeListenerAdapter", "DataTypeNameComparator", "DataTypeObjectComparator", "DataTypeTransferable", "DataTypeWriter", "DataUtilities", "DefaultAnnotationHandler", "DefaultDataType", "DialogResourceDataType", "StructureDataType", "DoubleComplexDataType", "DoubleDataType", "EnumDataType", "EnumValuePartitioner", "FactoryDataType", "FactoryStructureDataType", "FileTimeDataType", "Float10DataType", "Float16DataType", "Float2DataType", "LEB128", "Float4DataType", "Float8DataType", "FloatComplexDataType", "FloatDataType", "FunctionDefinitionDataType", "GIFResource", "MemBufferImageInputStream", "GifDataType", "IBO32DataType", "IBO64DataType", "ICategory", "IconMaskResourceDataType", "IconResourceDataType", "IconResource", "IllegalRenameException", "IndexedDynamicDataType", "Integer16DataType", "UnsignedInteger16DataType", "Integer3DataType", "UnsignedInteger3DataType", "Integer5DataType", "UnsignedInteger5DataType", "Integer6DataType", "UnsignedInteger6DataType", "Integer7DataType", "UnsignedInteger7DataType", "IntegerDataType", "UnsignedIntegerDataType", "JPEGDataType", "LongDataType", "UnsignedLongDataType", "LongDoubleComplexDataType", "LongDoubleDataType", "LongLongDataType", "UnsignedLongLongDataType", "MIDIDataType", "MacintoshTimeStampDataType", "MenuResourceDataType", "MetaDataType", "MutabilitySettingsDefinition", "NoisyStructureBuilder", "OffsetMaskSettingsDefinition", "OffsetShiftSettingsDefinition", "ParameterDefinitionImpl", "PascalString255DataType", "PascalStringDataType", "PascalUnicodeDataType", "PngDataType", "PngResource", "Pointer16DataType", "PointerDataType", "Pointer24DataType", "Pointer32DataType", "Pointer40DataType", "Pointer48DataType", "Pointer56DataType", "Pointer64DataType", "Pointer8DataType", "PointerTypeSettingsDefinition", "ProgramArchitectureTranslator", "QWordDataType", "SignedQWordDataType", "RGB16EncodingSettingsDefinition", "RGB16ColorDataType", "RGB32EncodingSettingsDefinition", "RGB32ColorDataType", "ReadOnlyDataTypeComponent", "RepeatCountDataType", "RepeatedDynamicDataType", "RepeatedStringDataType", "ScorePlayer", "SegmentedCodePointerDataType", "ShiftedAddressDataType", "ShortDataType", "UnsignedShortDataType", "SignedCharDataType", "SignedLeb128DataType", "SignedWordDataType", "WordDataType", "StringDataType", "StringRenderBuilder", "StringUTF8DataType", "StructureFactory", "StructuredDynamicDataType", "TerminatedSettingsDefinition", "TerminatedStringDataType", "TerminatedUnicode32DataType", "TerminatedUnicodeDataType", "Undefined", "Undefined1DataType", "Undefined2DataType", "Undefined3DataType", "Undefined4DataType", "Undefined5DataType", "Undefined6DataType", "Undefined7DataType", "Undefined8DataType", "Unicode32DataType", "UnicodeDataType", "UnionDataType", "UnsignedCharDataType", "UnsignedLeb128DataType", "WAVEDataType", "WideChar16DataType", "WideChar32DataType", "WideCharDataType"]
