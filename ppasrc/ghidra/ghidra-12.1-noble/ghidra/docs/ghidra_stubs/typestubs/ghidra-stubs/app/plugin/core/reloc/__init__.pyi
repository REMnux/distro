...
class RelocationFixupCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, handler: RelocationFixupHandler, oldImageBase: ghidra.program.model.address.Address, newImageBase: ghidra.program.model.address.Address) -> None:
        ...
...
class RelocationTableModel(ghidra.util.table.AddressBasedTableModel[RelocationTableModel.RelocationRowObject]):
    ...
    class RelocationRowObject(java.lang.Object):
        ...
        def __init__(self, r: ghidra.program.model.reloc.Relocation, relocationIndex: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def __init__(self, serviceProvider: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
__all__ = ["ElfRelocationFixupHandler", "RelocationFixupHandler", "GenericRefernenceBaseRelocationFixupHandler", "InstructionStasher", "Pe32RelocationFixupHandler", "Pe64RelocationFixupHandler", "RelocationFixupCommand", "RelocationFixupPlugin", "RelocationTableModel", "RelocationProvider", "RelocationTablePlugin", "RelocationToAddressTableRowMapper"]
