...
class FoundString(java.lang.Comparable[FoundString]):
    ...
    @typing.overload
    def __init__(self, address: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int], stringDataType: ghidra.program.model.data.DataType, definedState: FoundString.DefinedState) -> None:
        ...
    ...
    def setDefinedState(self, newState: FoundString.DefinedState) -> None:
        ...
...
class FoundStringCallback(java.lang.Object):
    ...
    def stringFound(self, foundString: FoundString) -> None:
        ...
...
class PascalStringSearcher(AbstractStringSearcher):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, minimumStringSize: typing.Union[jpype.JInt, int], alignment: typing.Union[jpype.JInt, int], includePascalUnicode: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, charSet: ghidra.util.ascii.CharSetRecognizer, minimumStringSize: typing.Union[jpype.JInt, int], alignment: typing.Union[jpype.JInt, int], includePascalUnicode: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class StringSearcher(AbstractStringSearcher):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, minimumStringSize: typing.Union[jpype.JInt, int], alignment: typing.Union[jpype.JInt, int], allCharSizes: typing.Union[jpype.JBoolean, bool], requireNullTermination: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, charSet: ghidra.util.ascii.CharSetRecognizer, minimumStringSize: typing.Union[jpype.JInt, int], alignment: typing.Union[jpype.JInt, int], allCharSizes: typing.Union[jpype.JBoolean, bool], requireNullTermination: typing.Union[jpype.JBoolean, bool]) -> None:
        ...



__all__ = ["FoundString", "AbstractStringSearcher", "FoundStringCallback", "PascalStringSearcher", "PascalUtil", "StringSearcher"]
