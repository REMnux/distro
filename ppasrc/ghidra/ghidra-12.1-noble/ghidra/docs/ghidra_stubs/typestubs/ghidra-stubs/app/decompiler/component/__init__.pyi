...
class DecompilerPanel(javax.swing.JPanel, docking.widgets.fieldpanel.listener.FieldMouseListener, docking.widgets.fieldpanel.listener.FieldLocationListener, docking.widgets.fieldpanel.listener.FieldSelectionListener, ClangHighlightListener, docking.widgets.fieldpanel.listener.LayoutListener):
    ...
    class DecompilerFieldPanel(docking.widgets.fieldpanel.FieldPanel):
        ...
        def __init__(self, model: docking.widgets.fieldpanel.LayoutModel) -> None:
            ...
    ...
    @typing.overload
    def addHighlights(self, varnodes: java.util.Set[ghidra.program.model.pcode.Varnode], colorProvider: ColorProvider) -> None:
        ...

    @typing.overload
    def addHighlights(self, ops: java.util.Set[ghidra.program.model.pcode.PcodeOp], hlColor: java.awt.Color) -> None:
        ...
    ...
    def clearSearchResults(self, searchResults: ghidra.app.plugin.core.decompile.actions.DecompilerSearchResults) -> None:
        ...

    def cloneHighlights(self, sourcePanel: DecompilerPanel) -> None:
        """
    ...
    def getActiveSearchLocation(self) -> ghidra.app.plugin.core.decompile.actions.DecompilerSearchLocation:
        ...
    ...
    def setDecompilerHoverProvider(self, provider: DecompilerHoverProvider) -> None:
        ...

    def setHighlightController(self, highlightController: ClangHighlightController) -> None:
        ...
    ...
    def setSearchResults(self, searchResults: ghidra.app.plugin.core.decompile.actions.DecompilerSearchResults) -> None:
        ...

    def setViewerPosition(self, viewerPosition: docking.widgets.fieldpanel.support.ViewerPosition) -> None:
        ...

    def tokenRenamed(self, token: ghidra.app.decompiler.ClangToken, newName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @property
    def activeSearchLocation(self) -> ghidra.app.plugin.core.decompile.actions.DecompilerSearchLocation:
        ...
...
class DecompilerController(java.lang.Object):
    ...
    def __init__(self, serviceProvider: ghidra.framework.plugintool.ServiceProvider, handler: DecompilerCallbackHandler, options: ghidra.app.decompiler.DecompileOptions, clipboard: ghidra.app.plugin.core.decompile.DecompilerClipboardProvider) -> None:
        ...

    def addToCache(self, data: DecompileData) -> None:
        """
        Adds the given data to the cache.  Meant for internal use only.
        
        :param DecompileData data: the data
        """
    ...
    def refreshDisplay(self, program: ghidra.program.model.listing.Program, location: ghidra.program.util.ProgramLocation, debugFile: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def setDecompileData(self, decompileData: DecompileData) -> None:
        """
    ...
    def setMouseNavigationEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setStatusMessage(self, message: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ClangLayoutController(docking.widgets.fieldpanel.LayoutModel, docking.widgets.fieldpanel.listener.LayoutModelListener):
    ...
    def __init__(self, opt: ghidra.app.decompiler.DecompileOptions, decompilerPanel: DecompilerPanel, met: java.awt.FontMetrics, hlFactory: docking.widgets.fieldpanel.support.FieldHighlightFactory) -> None:
        ...

    def buildLayouts(self, function: ghidra.program.model.listing.Function, doc: ghidra.app.decompiler.ClangTokenGroup, errmsg: typing.Union[java.lang.String, str], display: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ClangHighlightController(java.lang.Object):
    ...
    * Service Highlights - triggered by clients of the :obj:`DecompilerHighlightService`; they
    ...
    def addHighlighter(self, highlighter: ClangDecompilerHighlighter) -> None:
        ...

    def addHighlighterHighlights(self, highlighter: ghidra.app.decompiler.DecompilerHighlighter, tokens: java.util.function.Supplier[java.util.Collection[ghidra.app.decompiler.ClangToken]], colorProvider: ColorProvider) -> None:
        ...

    def addListener(self, listener: ClangHighlightListener) -> None:
        ...

    @typing.overload
    def addPrimaryHighlights(self, parentNode: ghidra.app.decompiler.ClangNode, ops: java.util.Set[ghidra.program.model.pcode.PcodeOp], hlColor: java.awt.Color) -> None:
        ...

    @typing.overload
    def addPrimaryHighlights(self, parentNode: ghidra.app.decompiler.ClangNode, colorProvider: ColorProvider) -> None:
        ...
    ...
    def reapplyAllHighlights(self, function: ghidra.program.model.listing.Function) -> None:
        ...
    ...
    def removeListener(self, listener: ClangHighlightListener) -> None:
        ...
    ...
    def togglePrimaryHighlights(self, hlColor: java.awt.Color, tokens: java.util.function.Supplier[java.util.List[ghidra.app.decompiler.ClangToken]]) -> None:
        """
...
class TokenHighlightColors(java.lang.Object):
    ...
    def setColor(self, text: typing.Union[java.lang.String, str], color: java.awt.Color) -> None:
        ...
...
class TokenHighlights(java.lang.Iterable[HighlightToken]):
    ...
    def add(self, t: HighlightToken) -> None:
        """
...
class HighlightToken(java.lang.Object):
    ...
    def __init__(self, token: ghidra.app.decompiler.ClangToken, color: java.awt.Color) -> None:
        ...
...
class TokenKey(java.lang.Object):
    ...
    def __init__(self, t: HighlightToken) -> None:
        ...
...
class DecompilerCallbackHandler(java.lang.Object):
    ...
    def annotationClicked(self, annotation: ghidra.util.bean.field.AnnotatedTextFieldElement, newWindow: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def contextChanged(self) -> None:
        ...

    def decompileDataChanged(self, decompileData: DecompileData) -> None:
        ...
    ...
    def goToAddress(self, addr: ghidra.program.model.address.Address, newWindow: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def goToFunction(self, function: ghidra.program.model.listing.Function, newWindow: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def goToLabel(self, labelName: typing.Union[java.lang.String, str], newWindow: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def goToScalar(self, value: typing.Union[jpype.JLong, int], newWindow: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DecompilerProgramListener(ghidra.framework.model.DomainObjectListener):
    ...
    @typing.overload
    def __init__(self, controller: DecompilerController, callback: java.lang.Runnable) -> None:
        """
    ...
    @typing.overload
    def __init__(self, controller: DecompilerController, updater: ghidra.util.task.SwingUpdateManager) -> None:
        """
...
class DecompilerManager(java.lang.Object):
    ...
    def __init__(self, decompilerController: DecompilerController, options: ghidra.app.decompiler.DecompileOptions) -> None:
        ...
...
class DecompileRunnable(ghidra.util.task.SwingRunnable):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, location: ghidra.program.util.ProgramLocation, debugFile: jpype.protocol.SupportsPath, viewerPosition: docking.widgets.fieldpanel.support.ViewerPosition, decompilerManager: DecompilerManager) -> None:
        """
        ...
        :param docking.widgets.fieldpanel.support.ViewerPosition viewerPosition: the viewer's position
        :param DecompilerManager decompilerManager: the decompile manager
        """
...
class ClangFieldElement(docking.widgets.fieldpanel.field.AbstractTextFieldElement):
    ...
    def __init__(self, token: ghidra.app.decompiler.ClangToken, as_: docking.widgets.fieldpanel.field.AttributedString, col: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DecompilerFindDialog(docking.widgets.FindDialog):
    ...
    def __init__(self, decompilerPanel: DecompilerPanel) -> None:
        ...
...
__all__ = ["DecompilerPanel", "ClangHighlightListener", "DecompilerController", "ClangLayoutController", "ClangHighlightController", "DecompileData", "DecompilerHoverProvider", "TokenHighlightColors", "TokenHighlights", "HighlightToken", "ColorProvider", "ClangDecompilerHighlighter", "ClangTextField", "TokenKey", "DecompilerCallbackHandler", "DecompilerProgramListener", "UserHighlights", "DecompilerManager", "Decompiler", "DecompileRunnable", "ClangFieldElement", "DecompileResultsListener", "DecompilerCallbackHandlerAdapter", "DecompilerFindDialog", "DecompilerUtils", "DefaultColorProvider", "EmptyDecompileData", "LocationClangHighlightController", "NameTokenMatcher", "NullClangHighlightController"]
