...
class AssemblyProduction(AbstractAssemblyProduction[ghidra.app.plugin.assembler.sleigh.symbol.AssemblyNonTerminal]):
    ...
    def __init__(self, lhs: ghidra.app.plugin.assembler.sleigh.symbol.AssemblyNonTerminal, rhs: AssemblySentential[ghidra.app.plugin.assembler.sleigh.symbol.AssemblyNonTerminal]) -> None:
        ...
...
class AbstractAssemblyProduction(java.lang.Comparable[AbstractAssemblyProduction[NT]], typing.Generic[NT]):
    ...
    def __init__(self, lhs: NT, rhs: AssemblySentential[NT]) -> None:
        """
...
class AbstractAssemblyGrammar(java.lang.Iterable[P], typing.Generic[NT, P]):
    ...
    @typing.overload
    def addProduction(self, lhs: NT, rhs: AssemblySentential[NT]) -> None:
        """
    ...
    @typing.overload
    def addProduction(self, prod: P) -> None:
        """
        Add a production to the grammar
    ...
    def combine(self, that: AbstractAssemblyGrammar[NT, P]) -> None:
        """
    ...
    def setStartName(self, startName: typing.Union[java.lang.String, str]) -> None:
        """
        Change the start symbol for the grammar
...
class AssemblySentential(java.lang.Comparable[AssemblySentential[NT]], java.lang.Iterable[ghidra.app.plugin.assembler.sleigh.symbol.AssemblySymbol], typing.Generic[NT]):
    ...
    class WhiteSpaceParseToken(ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseToken):
        ...
        def __init__(self, grammar: AssemblyGrammar, term: ghidra.app.plugin.assembler.sleigh.symbol.AssemblyTerminal, str: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class TruncatedWhiteSpaceParseToken(AssemblySentential.WhiteSpaceParseToken):
        ...
        def __init__(self, grammar: AssemblyGrammar, term: ghidra.app.plugin.assembler.sleigh.symbol.AssemblyTerminal) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, symbols: java.util.List[ghidra.app.plugin.assembler.sleigh.symbol.AssemblySymbol]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, *syms: ghidra.app.plugin.assembler.sleigh.symbol.AssemblySymbol) -> None:
        """
    ...
    def addSeparatorPart(self, str: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def addSeparators(self, str: typing.Union[java.lang.String, str]) -> None:
        """
...
class AssemblyExtendedProduction(AbstractAssemblyProduction[ghidra.app.plugin.assembler.sleigh.symbol.AssemblyExtendedNonTerminal]):
    ...
    def __init__(self, lhs: ghidra.app.plugin.assembler.sleigh.symbol.AssemblyExtendedNonTerminal, rhs: AssemblySentential[ghidra.app.plugin.assembler.sleigh.symbol.AssemblyExtendedNonTerminal], finalState: typing.Union[jpype.JInt, int], ancestor: AssemblyProduction) -> None:
        """
...
__all__ = ["AssemblyProduction", "AbstractAssemblyProduction", "AssemblyGrammar", "AbstractAssemblyGrammar", "AssemblySentential", "AssemblyGrammarException", "AssemblyExtendedGrammar", "AssemblyExtendedProduction"]
