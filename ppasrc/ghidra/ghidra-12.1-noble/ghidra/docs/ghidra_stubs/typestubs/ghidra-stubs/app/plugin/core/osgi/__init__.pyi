...
class BuildError(java.lang.Object):
    ...
    def __init__(self, sourceFile: generic.jar.ResourceFile) -> None:
        """
    ...
    def append(self, s: typing.Union[java.lang.String, str]) -> None:
        """
...
class BundleHost(java.lang.Object):
    ...
    *  bundle lifecycle is simplified to "active"(same as OSGi "active" state) and "inactive" 
    ...
    def activateAll(self, bundles: collections.abc.Sequence, monitor: ghidra.util.task.TaskMonitor, console: java.io.PrintWriter) -> None:
        """
    ...
    def activateInStages(self, bundles: collections.abc.Sequence, monitor: ghidra.util.task.TaskMonitor, console: java.io.PrintWriter) -> None:
        """
    ...
    @typing.overload
    def activateSynchronously(self, bundle: org.osgi.framework.Bundle) -> None:
        """
    ...
    @typing.overload
    def activateSynchronously(self, bundleLocation: typing.Union[java.lang.String, str]) -> None:
        """
        Activate a bundle. Either an exception is thrown or the bundle will be in "ACTIVE" state.
    ...
    def addListener(self, bundleHostListener: BundleHostListener) -> None:
        """
    ...
    @typing.overload
    def deactivateSynchronously(self, bundle: org.osgi.framework.Bundle) -> None:
        """
    ...
    @typing.overload
    def deactivateSynchronously(self, bundleLocation: typing.Union[java.lang.String, str]) -> None:
        """
        Deactivate a bundle. Either an exception is thrown or the bundle will be in "UNINSTALLED" 
        state.
    ...
    @typing.overload
    def remove(self, bundleFile: generic.jar.ResourceFile) -> None:
        """
    ...
    @typing.overload
    def remove(self, bundleLocation: typing.Union[java.lang.String, str]) -> None:
        """
        Remove a bundle from the list of managed bundles.
    ...
    @typing.overload
    def remove(self, bundle: GhidraBundle) -> None:
        """
        Remove a bundle from the list of managed bundles.
    ...
    @typing.overload
    def remove(self, bundles: collections.abc.Sequence) -> None:
        """
    ...
    def removeListener(self, bundleHostListener: BundleHostListener) -> None:
        """
    ...
    def restoreManagedBundleState(self, saveState: ghidra.framework.options.SaveState, tool: ghidra.framework.plugintool.PluginTool) -> None:
        """
    ...
    def saveManagedBundleState(self, saveState: ghidra.framework.options.SaveState) -> None:
        """
...
class BundleMap(java.lang.Object):
    ...
    def add(self, bundle: GhidraBundle) -> None:
        """
    ...
    def addAll(self, bundles: collections.abc.Sequence) -> None:
        """
    ...
    def removeAll(self, bundles: collections.abc.Sequence) -> None:
        """
...
class BundleHostListener(java.lang.Object):
    ...
    def bundleActivationChange(self, bundle: GhidraBundle, newActivation: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def bundleAdded(self, bundle: GhidraBundle) -> None:
        """
    ...
    def bundleBuilt(self, bundle: GhidraBundle, summary: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def bundleEnablementChange(self, bundle: GhidraBundle, newEnablement: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def bundleException(self, exception: GhidraBundleException) -> None:
        """
    ...
    def bundleRemoved(self, bundle: GhidraBundle) -> None:
        """
    ...
    def bundlesAdded(self, bundles: collections.abc.Sequence) -> None:
        """
    ...
    def bundlesRemoved(self, bundles: collections.abc.Sequence) -> None:
        """
...
class GhidraBundleException(OSGiException):
    ...
    @typing.overload
    def __init__(self, bundle: org.osgi.framework.Bundle, msg: typing.Union[java.lang.String, str], cause: org.osgi.framework.BundleException) -> None:
        """
    ...
    @typing.overload
    def __init__(self, bundleLocation: typing.Union[java.lang.String, str], msg: typing.Union[java.lang.String, str], cause: org.osgi.framework.BundleException) -> None:
        """
    ...
    @typing.overload
    def __init__(self, bundleLocation: typing.Union[java.lang.String, str], msg: typing.Union[java.lang.String, str]) -> None:
        """
        Construct a new exception originating with the bundle having location identifier ``bundleLocation``.
...
class BundleStatus(java.lang.Comparable[BundleStatus]):
    ...
    def setActive(self, isActive: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setSummary(self, summary: typing.Union[java.lang.String, str]) -> None:
        """
...
class BundleStatusChangeRequestListener(java.lang.Object):
    ...
    def bundleActivationChangeRequest(self, status: BundleStatus, newValue: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def bundleEnablementChangeRequest(self, status: BundleStatus, newValue: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class BundleStatusComponentProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, owner: typing.Union[java.lang.String, str], bundleHost: BundleHost) -> None:
        """
    ...
    def setBundleFilesForTesting(self, bundleFiles: java.util.List[generic.jar.ResourceFile]) -> None:
        """
...
class BundleStatusTableModel(docking.widgets.table.GDynamicColumnTableModel[BundleStatus, java.util.List[BundleStatus]]):
    ...
    @typing.type_check_only
    class BundleLocationId(BundleStatusTableModel.Column[java.lang.String]):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    def addListener(self, listener: BundleStatusChangeRequestListener) -> None:
        """
    ...
    def removeListener(self, listener: BundleStatusChangeRequestListener) -> None:
        """
...
class GhidraJarBundle(GhidraBundle):
    ...
    def __init__(self, bundleHost: BundleHost, file: generic.jar.ResourceFile, enabled: typing.Union[jpype.JBoolean, bool], systemBundle: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class GhidraSourceBundle(GhidraBundle):
    ...
    class DiscrepancyCallback(java.lang.Object):
        ...
        def found(self, sourceFile: generic.jar.ResourceFile, classFiles: collections.abc.Sequence) -> None:
            """
    ...
    def __init__(self, bundleHost: BundleHost, sourceDirectory: generic.jar.ResourceFile, enabled: typing.Union[jpype.JBoolean, bool], systemBundle: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
__all__ = ["BuildError", "BundleHost", "BundleMap", "BundleHostListener", "GhidraBundle", "GhidraBundleException", "OSGiException", "BundleStatus", "BundleStatusChangeRequestListener", "BundleStatusComponentProvider", "BundleStatusTableModel", "GhidraBundleActivator", "GhidraJarBundle", "GhidraPlaceholderBundle", "GhidraSourceBundle", "OSGiParallelLock", "OSGiUtils"]
