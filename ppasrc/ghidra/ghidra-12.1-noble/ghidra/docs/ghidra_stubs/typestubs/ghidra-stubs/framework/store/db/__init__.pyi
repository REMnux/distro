...
class PackedDBHandle(db.DBHandle):
    ...
    def __init__(self, contentType: typing.Union[java.lang.String, str]) -> None:
        """
...
class PackedDatabase(db.Database):
    ...
    @staticmethod
    def packDatabase(dbh: db.DBHandle, itemName: typing.Union[java.lang.String, str], contentType: typing.Union[java.lang.String, str], outputFile: jpype.protocol.SupportsPath, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @staticmethod
    def unpackDatabase(bfMgr: db.buffers.BufferFileManager, checkinId: typing.Union[jpype.JLong, int], packedFile: jpype.protocol.SupportsPath, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class PrivateDatabase(db.Database):
    ...
    @typing.overload
    def __init__(self, dbDir: jpype.protocol.SupportsPath) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dbDir: jpype.protocol.SupportsPath, srcFile: db.buffers.BufferFile, resetDatabaseId: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dbDir: jpype.protocol.SupportsPath, packedFile: jpype.protocol.SupportsPath, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def dbMoved(self, dir: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def output(self, outputFile: jpype.protocol.SupportsPath, name: typing.Union[java.lang.String, str], filetype: typing.Union[jpype.JInt, int], contentType: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def setIsCheckoutCopy(self, state: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def updateCheckoutCopy(self, srcFile: db.buffers.ManagedBufferFile, oldVersion: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def updateCheckoutFrom(self, otherDb: PrivateDatabase) -> None:
        """
...
class VersionedDBListener(java.lang.Object):
    ...
    def checkinCompleted(self, checkoutId: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def versionDeleted(self, version: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def versionsChanged(self, minVersion: typing.Union[jpype.JInt, int], currentVersion: typing.Union[jpype.JInt, int]) -> None:
        """
...
class VersionedDatabase(db.Database):
    ...
    @typing.overload
    def __init__(self, dbDir: jpype.protocol.SupportsPath, verDBListener: VersionedDBListener) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dbDir: jpype.protocol.SupportsPath, srcFile: db.buffers.BufferFile, verDBListener: VersionedDBListener, checkoutId: typing.Union[jpype.JLong, int], comment: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dbDir: jpype.protocol.SupportsPath, packedFile: jpype.protocol.SupportsPath, verDBListener: VersionedDBListener, checkoutId: typing.Union[jpype.JLong, int], comment: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def dbMoved(self, dbDir: jpype.protocol.SupportsPath) -> None:
        """
        Following a move of the database directory,
        this method should be invoked if this instance will
        continue to be used.
    ...
    def output(self, version: typing.Union[jpype.JInt, int], outputFile: jpype.protocol.SupportsPath, name: typing.Union[java.lang.String, str], filetype: typing.Union[jpype.JInt, int], contentType: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Output the current version of this database to a packed storage file.
...
__all__ = ["PackedDBHandle", "PackedDatabaseCache", "PackedDatabase", "PrivateDatabase", "VersionedDBListener", "VersionedDatabase"]
