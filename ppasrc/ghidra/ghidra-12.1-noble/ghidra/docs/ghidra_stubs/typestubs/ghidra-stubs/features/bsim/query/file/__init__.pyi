...
class BSimVectorStoreManager(java.lang.Object):
    ...
    @staticmethod
    def remove(serverInfo: ghidra.features.bsim.query.BSimServerInfo) -> None:
        ...
...
class VectorStore(java.lang.Iterable[VectorStoreEntry]):
    ...
    def __init__(self, serverInfo: ghidra.features.bsim.query.BSimServerInfo) -> None:
        ...

    def delete(self, id: typing.Union[jpype.JLong, int]) -> None:
        ...
    ...
    @typing.overload
    def update(self, entry: VectorStoreEntry) -> None:
        ...

    @typing.overload
    def update(self, id: typing.Union[jpype.JLong, int], count: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class VectorStoreEntry(java.lang.Record):
    ...
    def __init__(self, id: typing.Union[jpype.JLong, int], vec: generic.lsh.vector.LSHVector, count: typing.Union[jpype.JInt, int], selfSig: typing.Union[jpype.JDouble, float]) -> None:
        ...
...
class H2FileFunctionDatabase(ghidra.features.bsim.query.client.AbstractSQLFunctionDatabase[ghidra.features.bsim.query.elastic.Base64VectorFactory]):
    ...
    @typing.overload
    def __init__(self, bsimURL: java.net.URL) -> None:
        """
...
class H2VectorTable(ghidra.features.bsim.query.client.tables.SQLComplexTable):
    ...
    def __init__(self, vectorFactory: ghidra.features.bsim.query.elastic.Base64VectorFactory, vectorStore: VectorStore) -> None:
        ...
...
__all__ = ["BSimH2FileDBConnectionManager", "BSimVectorStoreManager", "VectorStore", "VectorStoreEntry", "H2FileFunctionDatabase", "H2VectorTable"]
