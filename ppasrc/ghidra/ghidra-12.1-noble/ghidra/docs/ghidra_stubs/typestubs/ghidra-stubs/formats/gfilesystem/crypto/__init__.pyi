...
class CryptoProvider(java.lang.Object):
    ...
    class Session(java.lang.Object):
        ...
        def setStateValue(self, cryptoProvider: CryptoProvider, value: java.lang.Object) -> None:
            """
...
class CryptoProviders(java.lang.Object):
    ...
    class CryptoProviderSessionImpl(CryptoProvider.Session, CryptoSession):
        ...
        def __init__(self, providers: java.util.List[CryptoProvider]) -> None:
            ...
    ...
    def registerCryptoProvider(self, provider: CryptoProvider) -> None:
        """
    ...
    def unregisterCryptoProvider(self, provider: CryptoProvider) -> None:
        """
...
class CryptoProviderSessionChildImpl(CryptoSession):
    ...
    def __init__(self, parentSession: CryptoSession) -> None:
        ...
...
__all__ = ["CryptoSession", "CachedPasswordProvider", "PasswordProvider", "CryptoProvider", "CryptoProviders", "CmdLinePasswordProvider", "CryptoProviderSessionChildImpl", "PasswordDialog", "PopupGUIPasswordProvider"]
