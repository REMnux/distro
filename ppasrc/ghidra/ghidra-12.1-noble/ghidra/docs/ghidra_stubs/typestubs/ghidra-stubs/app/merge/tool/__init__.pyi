...
class ListingMergePanelPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.main.ProgramaticUseOnly):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, mergePanel: ListingMergePanel) -> None:
        """
        Constructor
...
class ListingMergePanel(javax.swing.JPanel, ghidra.app.merge.MergeConstants, java.awt.event.FocusListener, ghidra.app.services.CodeFormatService):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, original: ghidra.program.model.listing.Program, result: ghidra.program.model.listing.Program, myChanges: ghidra.program.model.listing.Program, latest: ghidra.program.model.listing.Program, showListings: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def emptyViewForProgram(self, programIndex: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    @typing.overload
    def goTo(self, addr: ghidra.program.model.address.Address, programIndex: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def goTo(self, loc: ghidra.program.util.ProgramLocation, centerOnScreen: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setViewToProgram(self, programIndex: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ListingMergePanelProvider(ghidra.framework.plugintool.ComponentProviderAdapter, docking.actions.PopupActionProvider):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, plugin: ghidra.framework.plugintool.Plugin, owner: typing.Union[java.lang.String, str], mergePanel: ListingMergePanel) -> None:
        ...
...
class ViewInstructionDetailsAction(ghidra.app.context.ListingContextAction):
    ...
    def __init__(self, listingMergePanelPlugin: ListingMergePanelPlugin) -> None:
        ...



__all__ = ["ListingMergePanelPlugin", "ListingMergePanel", "ListingMergePanelProvider", "LockComponent", "ViewInstructionDetailsAction"]
