...
class TaintDebuggerRegisterColumnFactory(ghidra.app.plugin.core.debug.gui.register.DebuggerRegisterColumnFactory):
    ...
    class TaintDebuggerRegisterCellRenderer(ghidra.util.table.column.AbstractGColumnRenderer[java.lang.String]):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class TaintDebuggerRegisterColumn(docking.widgets.table.AbstractDynamicTableColumn[ghidra.app.plugin.core.debug.gui.register.RegisterRow, java.lang.String, java.lang.Void]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
class TaintFieldLocation(ghidra.program.util.CodeUnitLocation):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, charOffset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["TaintDebuggerRegisterColumnFactory", "TaintFieldFactory", "TaintFieldLocation"]
