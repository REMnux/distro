...
class FunctionEditorDialog(docking.DialogComponentProvider, ModelChangeListener):
    ...
    @typing.overload
    def __init__(self, service: ghidra.app.services.DataTypeManagerService, function: ghidra.program.model.listing.Function) -> None:
        """
    ...
    @typing.overload
    def __init__(self, model: FunctionEditorModel, hasOptionalSignatureCommit: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class FunctionEditorModel(java.lang.Object):
    ...
    def setCallingConventionName(self, callingConventionName: typing.Union[java.lang.String, str]) -> None:
        ...

    def setFormalReturnType(self, formalReturnType: ghidra.program.model.data.DataType) -> bool:
        ...

    def setFunctionData(self, functionDefinition: ghidra.program.model.data.FunctionDefinitionDataType) -> None:
        ...

    def setModelUnchanged(self) -> None:
        """
    ...
    def setParameterStorage(self, param: ParamInfo, storage: ghidra.program.model.listing.VariableStorage) -> None:
        ...

    def setReturnStorage(self, storage: ghidra.program.model.listing.VariableStorage) -> None:
        ...

    def setSelectedParameterRows(self, selectedRows: jpype.JArray[jpype.JInt]) -> None:
        ...

    def setUseCustomizeStorage(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ParameterTableModel(docking.widgets.table.AbstractGTableModel[FunctionVariableData]):
    ...
    class ParamCol(java.lang.Object):
        ...
        def __init__(self, name: typing.Union[java.lang.String, str], preferredSize: typing.Union[jpype.JInt, int], classType: java.lang.Class[typing.Any], isEditable: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
        ...
        def setValue(self, rowData: FunctionVariableData, aValue: java.lang.Object) -> None:
            ...
    ...
    def setAllowStorageEditing(self, canCustomizeStorage: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setParameters(self, parameterList: java.util.List[ParamInfo], returnDataType: ghidra.program.model.data.DataType, returnStorage: ghidra.program.model.listing.VariableStorage) -> None:
        ...
...
class FunctionVariableData(java.lang.Object):
    ...
    def setStorage(self, storage: ghidra.program.model.listing.VariableStorage) -> None:
        ...
...
class RegisterDropDownSelectionDataModel(docking.widgets.DropDownTextFieldDataModel[ghidra.program.model.lang.Register]):
    ...
    def __init__(self, registers: java.util.List[ghidra.program.model.lang.Register]) -> None:
        ...
...
class StorageAddressEditorDialog(docking.DialogComponentProvider, ModelChangeListener):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, service: ghidra.app.services.DataTypeManagerService, storage: ghidra.program.model.listing.VariableStorage, variableData: FunctionVariableData) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, service: ghidra.app.services.DataTypeManagerService, var: ghidra.program.model.listing.Variable, ordinal: typing.Union[jpype.JInt, int]) -> None:
        """
...
class VarnodeTableModel(docking.widgets.table.AbstractGTableModel[VarnodeInfo]):
    ...
    class VarnodeCol(java.lang.Object):
        ...
        def setValue(self, varnode: VarnodeInfo, aValue: java.lang.Object) -> None:
            ...
...
class VarnodeInfo(java.lang.Object):
    ...
    @typing.overload
    def setVarnode(self, address: ghidra.program.model.address.Address, size: typing.Union[java.lang.Integer, int]) -> None:
        ...

    @typing.overload
    def setVarnode(self, varnode: ghidra.program.model.pcode.Varnode) -> None:
        ...

    def setVarnodeType(self, type: VarnodeType) -> None:
        ...
...
class StorageTableCellEditor(javax.swing.AbstractCellEditor, javax.swing.table.TableCellEditor):
    ...
    def __init__(self, model: FunctionEditorModel) -> None:
        ...
...
__all__ = ["FunctionData", "FunctionDataView", "ParamInfo", "FunctionEditorDialog", "ModelChangeListener", "FunctionEditorModel", "ParameterTableModel", "FunctionVariableData", "FunctionSignatureTextField", "ParameterDataTypeCellEditor", "RegisterDropDownSelectionDataModel", "StorageAddressEditorDialog", "StorageAddressModel", "VarnodeTableModel", "VarnodeInfo", "VarnodeType", "StorageTableCellEditor", "VarnodeLocationCellEditor", "VarnodeLocationTableCellRenderer", "VarnodeSizeCellEditor", "VarnodeTypeCellEditor"]
