...
class DBTraceObjectValueRStarTree(ghidra.util.database.spatial.hyper.AbstractHyperRStarTree[ValueTriple, ValueShape, DBTraceObjectValueData, ValueBox, DBTraceObjectValueNode, DBTraceObjectValueData, TraceObjectValueQuery]):
    ...
    class DBTraceObjectValueMap(ghidra.util.database.spatial.hyper.AbstractHyperRStarTree.AsSpatialMap[ValueShape, DBTraceObjectValueData, ValueBox, DBTraceObjectValueData, TraceObjectValueQuery]):
        ...
        def __init__(self, tree: ghidra.util.database.spatial.AbstractConstraintsTree[ValueShape, DBTraceObjectValueData, ValueBox, typing.Any, DBTraceObjectValueData, TraceObjectValueQuery], query: TraceObjectValueQuery, factory: ghidra.program.model.address.AddressFactory, lock: java.util.concurrent.locks.ReadWriteLock) -> None:
            ...
...
class DBTraceObjectManager(ghidra.trace.model.target.TraceObjectManager, ghidra.trace.database.DBTraceManager):
    ...
    class DBTraceObjectSchemaDBFieldCodec(ghidra.util.database.DBCachedObjectStoreFactory.AbstractDBFieldCodec[ghidra.trace.model.target.schema.SchemaContext, DBTraceObjectManager.DBTraceObjectSchemaEntry, db.StringField]):
        ...
        def __init__(self, objectType: java.lang.Class[DBTraceObjectManager.DBTraceObjectSchemaEntry], field: java.lang.reflect.Field, column: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    class DBTraceObjectSchemaEntry(ghidra.util.database.DBAnnotatedObject):
        ...
        def __init__(self, store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
            ...
    ...
    def __init__(self, dbh: db.DBHandle, openMode: ghidra.framework.data.OpenMode, lock: java.util.concurrent.locks.ReadWriteLock, monitor: ghidra.util.task.TaskMonitor, baseLanguage: ghidra.program.model.lang.Language, trace: ghidra.trace.database.DBTrace) -> None:
        ...
...
class ValueTriple(java.lang.Record, ghidra.util.database.spatial.hyper.HyperPoint):
    ...
    def __init__(self, parentKey: typing.Union[jpype.JLong, int], childKey: typing.Union[jpype.JLong, int], entryKey: typing.Union[java.lang.String, str], snap: typing.Union[jpype.JLong, int], address: ghidra.util.database.DBCachedObjectStoreFactory.RecAddress) -> None:
        ...
...
class DBTraceObjectValueData(ghidra.util.database.spatial.DBTreeDataRecord[ValueShape, ValueBox, DBTraceObjectValueData], TraceObjectValueStorage, ValueShape):
    ...
    def __init__(self, manager: DBTraceObjectManager, tree: DBTraceObjectValueRStarTree, store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
        ...
...
class TraceObjectValueStorage(java.lang.Object):
    ...
    def doSetLifespan(self, lifespan: ghidra.trace.model.Lifespan) -> None:
        """
...
class DBTraceObjectValueNode(ghidra.util.database.spatial.DBTreeNodeRecord[ValueBox], ValueBox):
    ...
    def __init__(self, tree: DBTraceObjectValueRStarTree, store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
        ...
...
class TraceObjectValueQuery(ghidra.util.database.spatial.hyper.AbstractHyperBoxQuery[ValueTriple, ValueShape, ValueBox, TraceObjectValueQuery]):
    ...
    def __init__(self, ls: ValueBox, us: ValueBox, direction: ghidra.util.database.spatial.hyper.HyperDirection) -> None:
        ...
...
class CachePerDBTraceObject(java.lang.Object):
    ...
    class Cached(java.lang.Record, typing.Generic[T]):
        ...
        def __init__(self, isMiss: typing.Union[jpype.JBoolean, bool], value: T) -> None:
            ...
    ...
    def notifyValueCreated(self, value: DBTraceObjectValue) -> None:
        ...

    def notifyValueDeleted(self, value: DBTraceObjectValue) -> None:
        ...
...
class DBTraceObjectValue(ghidra.trace.model.target.TraceObjectValue):
    ...
    class ValueLifespanSetter(ghidra.trace.database.DBTraceUtils.LifespanMapSetter[DBTraceObjectValue, java.lang.Object]):
        ...
        @typing.overload
        def __init__(self, range: ghidra.trace.model.Lifespan, value: java.lang.Object) -> None:
            ...

        @typing.overload
        def __init__(self, range: ghidra.trace.model.Lifespan, value: java.lang.Object, keep: DBTraceObjectValue) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, manager: DBTraceObjectManager, wrapped: TraceObjectValueStorage) -> None:
        ...
...
class DBTraceObject(ghidra.util.database.DBAnnotatedObject, ghidra.trace.model.target.TraceObject):
    ...
    class ObjectPathDBFieldCodec(ghidra.util.database.DBCachedObjectStoreFactory.AbstractDBFieldCodec[ghidra.trace.model.target.path.KeyPath, ghidra.util.database.DBAnnotatedObject, db.StringField]):
        ...
        def __init__(self, objectType: java.lang.Class[ghidra.util.database.DBAnnotatedObject], field: java.lang.reflect.Field, column: typing.Union[jpype.JInt, int]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, manager: DBTraceObjectManager, store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
        ...
...
class DBTraceObjectValueWriteBehindCache(java.lang.Object):
    ...
    def __init__(self, manager: DBTraceObjectManager) -> None:
        ...
    ...
    def remove(self, value: DBTraceObjectValueBehind) -> None:
        ...
...
class DBTraceObjectValueBehind(TraceObjectValueStorage):
    ...
    def __init__(self, manager: DBTraceObjectManager, parent: DBTraceObject, entryKey: typing.Union[java.lang.String, str], lifespan: ghidra.trace.model.Lifespan, value: java.lang.Object) -> None:
        ...
...
class DBTraceObjectInterface(ghidra.trace.model.target.iface.TraceObjectInterface, ghidra.trace.model.TraceUniqueObject):
    ...
    class Translator(java.lang.Object, typing.Generic[T]):
        ...
        def __init__(self, spaceValueKey: typing.Union[java.lang.String, str], object: DBTraceObject, iface: T) -> None:
            ...
...
class DBTraceObjectDBFieldCodec(ghidra.util.database.DBCachedObjectStoreFactory.AbstractDBFieldCodec[DBTraceObject, OV, db.LongField], typing.Generic[OV]):
    ...
    def __init__(self, objectType: java.lang.Class[OV], field: java.lang.reflect.Field, column: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DBTraceObjectValueMapAddressSetView(ghidra.util.AbstractAddressSetView):
    ...
    def __init__(self, factory: ghidra.program.model.address.AddressFactory, lock: java.util.concurrent.locks.ReadWriteLock, map: ghidra.util.database.spatial.SpatialMap[ValueShape, DBTraceObjectValueData, TraceObjectValueQuery], predicate: java.util.function.Predicate[DBTraceObjectValueData]) -> None:
        """
...
class ImmutableValueBox(java.lang.Record, ValueBox):
    ...
    def __init__(self, box: ValueBox) -> None:
        ...
...
class ImmutableValueShape(java.lang.Record, ValueShape):
    ...
    @typing.overload
    def __init__(self, parent: DBTraceObject, value: java.lang.Object, entryKey: typing.Union[java.lang.String, str], lifespan: ghidra.trace.model.Lifespan) -> None:
        ...

    @typing.overload
    def __init__(self, shape: ValueShape) -> None:
        ...

    @typing.overload
    def __init__(self, parent: DBTraceObject, child: DBTraceObject, entryKey: typing.Union[java.lang.String, str], lifespan: ghidra.trace.model.Lifespan, addressSpaceId: typing.Union[jpype.JInt, int], minAddressOffset: typing.Union[jpype.JLong, int], maxAddressOffset: typing.Union[jpype.JLong, int]) -> None:
        ...
...
__all__ = ["ValueSpace", "DBTraceObjectValueRStarTree", "DBTraceObjectManager", "ValueTriple", "ValueShape", "ValueBox", "DBTraceObjectValueData", "TraceObjectValueStorage", "DBTraceObjectValueNode", "TraceObjectValueQuery", "CachePerDBTraceObject", "DBTraceObjectValue", "DBTraceObject", "DBTraceObjectValueWriteBehindCache", "DBTraceObjectValueBehind", "DBTraceObjectValPath", "DBTraceObjectInterface", "DBTraceObjectDBFieldCodec", "DBTraceObjectValueMapAddressSetView", "ImmutableValueBox", "ImmutableValueShape"]
