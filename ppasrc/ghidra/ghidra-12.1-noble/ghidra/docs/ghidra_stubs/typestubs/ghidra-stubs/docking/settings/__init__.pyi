...
class Settings(java.lang.Object):
    ...
    def clearSetting(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def isImmutableSettings(self) -> bool:
        """
    ...
    def setValue(self, name: typing.Union[java.lang.String, str], value: java.lang.Object) -> None:
        """
    ...
    @property
    def immutableSettings(self) -> jpype.JBoolean:
        ...
...
class SettingsDefinition(java.lang.Object):
    ...
    def clear(self, settings: Settings) -> None:
        """
    ...
    def copySetting(self, srcSettings: Settings, destSettings: Settings) -> None:
        """
...
class StringSettingsDefinition(SettingsDefinition):
    ...
    def setValue(self, settings: Settings, value: typing.Union[java.lang.String, str]) -> None:
        """
...
class FormatSettingsDefinition(EnumSettingsDefinition):
    ...
    def setDisplayChoice(self, settings: Settings, choice: typing.Union[java.lang.String, str]) -> None:
        """
...
class EnumSettingsDefinition(SettingsDefinition):
    ...
    def setChoice(self, settings: Settings, value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class IntegerSignednessFormattingModeSettingsDefinition(EnumSettingsDefinition):
    ...
    def setFormatMode(self, settings: Settings, mode: ghidra.util.SignednessFormatMode) -> None:
        """
...
class FloatingPointPrecisionSettingsDefinition(EnumSettingsDefinition):
    ...
    def setPrecision(self, settings: Settings, digits: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class BooleanSettingsDefinition(SettingsDefinition):
    ...
    def setValue(self, settings: Settings, value: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Sets the given value into the given settings object using this settingsDefinition as the key.
...
class JavaEnumSettingsDefinition(EnumSettingsDefinition, typing.Generic[T]):
    ...
    def __init__(self, settingName: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], defaultValue: T) -> None:
        """
    ...
    def setEnumValue(self, settings: Settings, enumValue: T) -> None:
        """
...
class NumberSettingsDefinition(SettingsDefinition):
    ...
    def setValue(self, settings: Settings, value: typing.Union[jpype.JLong, int]) -> None:
        """
        Sets the given value into the given settings object using this settingsDefinition as the key.
...
class SettingsImpl(Settings, java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, allowedSettingPredicate: java.util.function.Predicate[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, immutable: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a new SettingsImpl.
    ...
    @typing.overload
    def __init__(self, listener: javax.swing.event.ChangeListener, changeSourceObj: java.lang.Object) -> None:
        """
    ...
    def setDefaultSettings(self, settings: Settings) -> None:
        ...



__all__ = ["Settings", "SettingsDefinition", "StringSettingsDefinition", "FormatSettingsDefinition", "EnumSettingsDefinition", "IntegerSignednessFormattingModeSettingsDefinition", "FloatingPointPrecisionSettingsDefinition", "BooleanSettingsDefinition", "JavaEnumSettingsDefinition", "NumberSettingsDefinition", "SettingsImpl"]
