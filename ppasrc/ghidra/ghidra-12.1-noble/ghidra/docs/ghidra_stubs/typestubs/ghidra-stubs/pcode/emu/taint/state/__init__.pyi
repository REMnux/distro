...
class TaintPcodeExecutorState(ghidra.pcode.exec_.PairedPcodeExecutorState[jpype.JArray[jpype.JByte], ghidra.taint.model.TaintVec]):
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, concrete: ghidra.pcode.exec_.BytesPcodeExecutorStatePiece, cb: ghidra.pcode.exec_.PcodeStateCallbacks) -> None:
        """
...
class TaintPcodeExecutorStatePiece(ghidra.pcode.exec_.AbstractLongOffsetPcodeExecutorStatePiece[jpype.JArray[jpype.JByte], ghidra.taint.model.TaintVec, TaintSpace]):
    ...
    @typing.overload
    def __init__(self, language: ghidra.program.model.lang.Language, addressArithmetic: ghidra.pcode.exec_.PcodeArithmetic[jpype.JArray[jpype.JByte]], arithmetic: ghidra.pcode.exec_.PcodeArithmetic[ghidra.taint.model.TaintVec], cb: ghidra.pcode.exec_.PcodeStateCallbacks) -> None:
        """
    ...
    @typing.overload
    def __init__(self, language: ghidra.program.model.lang.Language, addressArithmetic: ghidra.pcode.exec_.PcodeArithmetic[jpype.JArray[jpype.JByte]], cb: ghidra.pcode.exec_.PcodeStateCallbacks) -> None:
        """
...
class TaintSpace(java.lang.Object):
    ...
    def __init__(self, space: ghidra.program.model.address.AddressSpace, piece: TaintPcodeExecutorStatePiece) -> None:
        ...

    def clear(self) -> None:
        ...

    def get(self, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], reason: ghidra.pcode.exec_.PcodeExecutorStatePiece.Reason, cb: ghidra.pcode.exec_.PcodeStateCallbacks) -> ghidra.taint.model.TaintVec:
        """
        Retrieve the taint sets for the variable at the given offset
         
         
        
        This works the same as :meth:`getInto(long, TaintVec, Reason, PcodeStateCallbacks) <.getInto>`, but
    ...
    def getInto(self, offset: typing.Union[jpype.JLong, int], buf: ghidra.taint.model.TaintVec, reason: ghidra.pcode.exec_.PcodeExecutorStatePiece.Reason, cb: ghidra.pcode.exec_.PcodeStateCallbacks) -> None:
        """
        Retrieve the taint sets for the variable at the given offset
    ...
    def set(self, offset: typing.Union[jpype.JLong, int], val: ghidra.taint.model.TaintVec, cb: ghidra.pcode.exec_.PcodeStateCallbacks) -> None:
        """
...
__all__ = ["TaintPcodeExecutorState", "TaintPcodeExecutorStatePiece", "TaintPieceHandler", "TaintSpace"]
