...
class ByteTrieIfc(java.lang.Object, typing.Generic[T]):
    ...
    def inorder(self, monitor: ghidra.util.task.TaskMonitor, op: Op[T]) -> None:
        """
...
class Op(java.lang.Object, typing.Generic[T]):
    ...
    def op(self, node: ByteTrieNodeIfc[T]) -> None:
        """
...
__all__ = ["ByteTrieIfc", "SearchResult", "ByteTrieNodeIfc", "Op", "ByteTrie", "ByteTrieNode", "CaseInsensitiveByteTrie", "CaseInsensitiveByteTrieNode"]
