...
class ColorizingService(java.lang.Object):
    ...
    @typing.overload
    def clearBackgroundColor(self, min: ghidra.program.model.address.Address, max: ghidra.program.model.address.Address) -> None:
        """
    ...
    @typing.overload
    def clearBackgroundColor(self, set: ghidra.program.model.address.AddressSetView) -> None:
        """
    ...
    @typing.overload
    def setBackgroundColor(self, min: ghidra.program.model.address.Address, max: ghidra.program.model.address.Address, color: java.awt.Color) -> None:
        """
    ...
    @typing.overload
    def setBackgroundColor(self, set: ghidra.program.model.address.AddressSetView, color: java.awt.Color) -> None:
        """
...
class NextColorRangeAction(ghidra.app.nav.NextRangeAction):
    ...
    def __init__(self, plugin: ColorizingPlugin, tool: ghidra.framework.plugintool.PluginTool, navOptions: ghidra.app.plugin.core.navigation.NavigationOptions) -> None:
        ...
...
__all__ = ["ClearColorCommand", "ColorizingService", "ColorizingPlugin", "ColorizingServiceProvider", "NextColorRangeAction", "PreviousColorRangeAction", "SetColorCommand"]
