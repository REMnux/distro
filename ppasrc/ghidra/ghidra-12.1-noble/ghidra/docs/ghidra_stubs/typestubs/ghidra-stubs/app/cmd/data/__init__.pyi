...
class CreateArrayCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, addr: ghidra.program.model.address.Address, numElements: typing.Union[jpype.JInt, int], dt: ghidra.program.model.data.DataType, elementLength: typing.Union[jpype.JInt, int]) -> None:
        """
...
class CreateArrayInStructureCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, addr: ghidra.program.model.address.Address, numElements: typing.Union[jpype.JInt, int], dt: ghidra.program.model.data.DataType, compPath: jpype.JArray[jpype.JInt]) -> None:
        """
...
class CreateDataBackgroundCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, addrSet: ghidra.program.model.address.AddressSetView, dataType: ghidra.program.model.data.DataType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addrSet: ghidra.program.model.address.AddressSetView, dataType: ghidra.program.model.data.DataType, stackPointers: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class CreateDataCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, force: typing.Union[jpype.JBoolean, bool], dataType: ghidra.program.model.data.DataType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, force: typing.Union[jpype.JBoolean, bool], stackPointers: typing.Union[jpype.JBoolean, bool], dataType: ghidra.program.model.data.DataType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, dataType: ghidra.program.model.data.DataType) -> None:
        """
        Constructs a command for creating data at an address.
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, dataType: ghidra.program.model.data.DataType, isCycle: typing.Union[jpype.JBoolean, bool], stackPointers: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, dataType: ghidra.program.model.data.DataType, stackPointers: typing.Union[jpype.JBoolean, bool], clearMode: ghidra.program.model.data.DataUtilities.ClearDataMode) -> None:
        """
...
class CreateDataInStructureBackgroundCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, startPath: jpype.JArray[jpype.JInt], length: typing.Union[jpype.JInt, int], dt: ghidra.program.model.data.DataType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, startPath: jpype.JArray[jpype.JInt], length: typing.Union[jpype.JInt, int], dt: ghidra.program.model.data.DataType, stackPointers: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class CreateDataInStructureCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], dt: ghidra.program.model.data.DataType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, componentPath: jpype.JArray[jpype.JInt], dt: ghidra.program.model.data.DataType, stackPointers: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class CreateStringCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, stringDataType: ghidra.program.model.data.AbstractStringDataType, length: typing.Union[jpype.JInt, int], clearMode: ghidra.program.model.data.DataUtilities.ClearDataMode) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int], unicode: typing.Union[jpype.JBoolean, bool], clearMode: ghidra.program.model.data.DataUtilities.ClearDataMode) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int], unicode: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct command for creating fixed-length ASCII or Unicode string Data.
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int]) -> None:
        """
...
class CreateStructureCmd(AbstractCreateStructureCmd):
    ...
    @typing.overload
    def __init__(self, address: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], address: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructs a new command for creating a new structure and applying it to
        the browser.
    ...
    @typing.overload
    def __init__(self, newStructure: ghidra.program.model.data.Structure, address: ghidra.program.model.address.Address) -> None:
        """
...
class CreateStructureInStructureCmd(AbstractCreateStructureCmd):
    ...
    @typing.overload
    def __init__(self, address: ghidra.program.model.address.Address, fromPath: jpype.JArray[jpype.JInt], toPath: jpype.JArray[jpype.JInt]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], addr: ghidra.program.model.address.Address, fromPath: jpype.JArray[jpype.JInt], toPath: jpype.JArray[jpype.JInt]) -> None:
        """
        Constructs a new command for creating structures inside other structures.
    ...
    @typing.overload
    def __init__(self, newStructure: ghidra.program.model.data.Structure, address: ghidra.program.model.address.Address, fromPath: jpype.JArray[jpype.JInt], toPath: jpype.JArray[jpype.JInt]) -> None:
        ...


class RenameDataFieldCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    """
    Command to rename a component in a :obj:`Composite` data type.
    """

    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, comp: ghidra.program.model.data.DataTypeComponent, newName: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["AbstractCreateStructureCmd", "CreateArrayCmd", "CreateArrayInStructureCmd", "CreateDataBackgroundCmd", "CreateDataCmd", "CreateDataInStructureBackgroundCmd", "CreateDataInStructureCmd", "CreateStringCmd", "CreateStructureCmd", "CreateStructureInStructureCmd", "RenameDataFieldCmd"]
