...
class CoffArchiveHeader(ghidra.app.util.bin.StructConverter):
    ...
    def isMatch(provider: ghidra.app.util.bin.ByteProvider) -> bool:
        ...
        :param ghidra.app.util.bin.ByteProvider provider: :obj:`ByteProvider` stream
...
class FirstLinkerMember(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, header: CoffArchiveMemberHeader, skip: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class LongNamesMember(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, header: CoffArchiveMemberHeader) -> None:
        ...
...
__all__ = ["CoffArchiveHeader", "FirstLinkerMember", "SecondLinkerMember", "LongNamesMember", "CoffArchiveMemberHeader", "CoffArchiveConstants"]
