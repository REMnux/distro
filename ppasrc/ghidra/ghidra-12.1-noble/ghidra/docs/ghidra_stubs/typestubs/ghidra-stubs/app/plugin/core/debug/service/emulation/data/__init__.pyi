...
class AbstractPcodeDebuggerAccess(ghidra.pcode.exec_.trace.data.AbstractPcodeTraceAccess[S, L], ghidra.debug.api.emulation.PcodeDebuggerAccess, typing.Generic[S, L]):
    ...
    @typing.overload
    def __init__(self, provider: ghidra.framework.plugintool.ServiceProvider, target: ghidra.debug.api.target.Target, platform: ghidra.trace.model.guest.TracePlatform, snap: typing.Union[jpype.JLong, int]) -> None:
        """
        Construct a shim
    ...
    @typing.overload
    def __init__(self, provider: ghidra.framework.plugintool.ServiceProvider, target: ghidra.debug.api.target.Target, platform: ghidra.trace.model.guest.TracePlatform, snap: typing.Union[jpype.JLong, int], threadsSnap: typing.Union[jpype.JLong, int]) -> None:
        """
        Construct a shim
...
__all__ = ["AbstractPcodeDebuggerAccess", "DefaultPcodeDebuggerAccess", "DefaultPcodeDebuggerMemoryAccess", "InternalPcodeDebuggerDataAccess", "DefaultPcodeDebuggerRegistersAccess", "DefaultPcodeDebuggerPropertyAccess"]
