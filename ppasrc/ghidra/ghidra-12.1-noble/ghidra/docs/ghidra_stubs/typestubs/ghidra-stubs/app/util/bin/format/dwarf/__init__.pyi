...
class DWARFImportOptions(java.lang.Object):
    ...
    class MacroEnumSetting(java.lang.Enum[DWARFImportOptions.MacroEnumSetting]):
        """
        Used to control which macro info entries are used to create enums.
        """

        class_: typing.ClassVar[java.lang.Class]
        NONE: typing.Final[DWARFImportOptions.MacroEnumSetting]
        IGNORE_COMMAND_LINE: typing.Final[DWARFImportOptions.MacroEnumSetting]
        ALL: typing.Final[DWARFImportOptions.MacroEnumSetting]

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> DWARFImportOptions.MacroEnumSetting:
            ...

        @staticmethod
        def values() -> jpype.JArray[DWARFImportOptions.MacroEnumSetting]:
            ...
    ...
    def getCharset(self, defaultCharset: java.nio.charset.Charset) -> java.nio.charset.Charset:
        ...
    ...
    def getMacroEnumSetting(self) -> DWARFImportOptions.MacroEnumSetting:
        ...
    ...
    def isShowVariableStorageInfo(self) -> bool:
        ...
    ...
    def isUseStaticStackFrameRegisterValue(self) -> bool:
        ...
    ...
    def setCharsetName(self, charsetName: typing.Union[java.lang.String, str]) -> None:
        ...

    def setCopyExternalDebugFileSymbols(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setCopyRenameAnonTypes(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Option to control a feature that copies anonymous types into a structure's "namespace"
    ...
    def setCreateFuncSignatures(self, createFuncSignatures: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Option to control creating FunctionSignature datatypes for each function defintion
        found in the DWARF debug data.
    ...
    def setDefaultCC(self, defaultCC: typing.Union[java.lang.String, str]) -> None:
        ...

    def setElideTypedefsWithSameName(self, elide_typedefs_with_same_name: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Option to control eliding typedef creation if the dest type has the same name.
    ...
    def setIgnoreParamStorage(self, ignoreParamStorage: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setImportDataTypes(self, importDataTypes: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Option to turn on/off the import of data types.
    ...
    def setImportFuncs(self, output_Funcs: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setImportLocalVariables(self, importLocalVariables: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setMacroEnumSetting(self, setting: DWARFImportOptions.MacroEnumSetting) -> None:
        ...

    def setMaxSourceMapEntryLength(self, maxLength: typing.Union[jpype.JLong, int]) -> None:
        """
        Option to control the maximum length of a source map entry.  If a longer length is calculated
        it will be replaced with 0.
    ...
    def setOrganizeTypesBySourceFile(self, organizeTypesBySourceFile: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Option to organize imported datatypes into sub-folders based on their source file name.
    ...
    def setOutputDIEInfo(self, output_DWARF_die_info: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Option to control tagging data types and functions with their DWARF DIE
        record number.
    ...
    def setOutputInlineFuncComments(self, output_InlineFunc_comments: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setOutputLexicalBlockComments(self, output_LexicalBlock_comments: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Option to control tagging lexical blocks with Ghidra comments.
    ...
    def setOutputSourceLineInfo(self, outputSourceLineInfo: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Option to control whether source map info from DWARF is stored in the Program.
    ...
    def setOutputSourceLocationInfo(self, output_DWARF_location_info: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Option to control tagging data types and functions with their source code
        location (ie. filename : line number ) if the information is present in the DWARF record.
    ...
    def setShowVariableStorageInfo(self, showVariableStorageInfo: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setSpecialCaseSizedBaseTypes(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Option to recognize named base types that have an explicit size in the name (eg "int32_t)
        and use statically sized data types instead of compiler-dependent data types.
    ...
    def setTryPackDataTypes(self, tryPackStructs: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setUseStaticStackFrameRegisterValue(self, useStaticStackFrameRegisterValue: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    @property
    def useStaticStackFrameRegisterValue(self) -> jpype.JBoolean:
        ...

    @useStaticStackFrameRegisterValue.setter
    def useStaticStackFrameRegisterValue(self, value: jpype.JBoolean):
        ...
    ...
    @property
    def showVariableStorageInfo(self) -> jpype.JBoolean:
        ...

    @showVariableStorageInfo.setter
    def showVariableStorageInfo(self, value: jpype.JBoolean):
        ...
    ...
    @property
    def macroEnumSetting(self) -> DWARFImportOptions.MacroEnumSetting:
        ...

    @macroEnumSetting.setter
    def macroEnumSetting(self, value: DWARFImportOptions.MacroEnumSetting):
        ...
    ...
    @charsetName.setter
    def charsetName(self, value: java.lang.String):
        ...
...
class DIEAggregate(java.lang.Object):
    ...
    def findAncestor(self, ancestorType: DWARFTag) -> DIEAggregate:
        """
        Returns the first ancestor (parent, grandparent, etc) that matches the specified DIE
        tag type.
        
        :param DWARFTag ancestorType: :obj:`DWARFTag` DIE type
        :return: :obj:`DIEAggregate` containing requested ancestor, or null if not found
        :rtype: DIEAggregate
        """

    def findAttribute(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId) -> ghidra.app.util.bin.format.dwarf.attribs.DWARFAttribute:
        """
        :return: the matching attribute, by id, or null if not found
        :rtype: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttribute
        
        
        :param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attrId: :obj:`DWARFAttributeId` DW_AT_xyz
        """

    def findAttributeInChildren(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId, childTag: DWARFTag, clazz: java.lang.Class[T]) -> T:
        """
        Return an attribute that is present in this :obj:`DIEAggregate`, or in any of its
        direct children (of a specific type)
        
        :param T: attribute value type:param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attrId: the attribute to find
    ...
    @typing.overload
    def findValue(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId, valueClass: java.lang.Class[T]) -> T:
        """
        Finds a :obj:`attribute value <DWARFAttributeValue>` with a matching 
        :obj:`DWARFAttributeId` id.
        ...
        :param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attrId: See :obj:`DWARFAttributeId`
        :param java.lang.Class[T] valueClass: must be derived from :obj:`DWARFAttributeValue`
        :return: DWARFAttributeValue or subclass as specified by the valueClass, or null if not found
        :rtype: T
        """

    @typing.overload
    def findValue(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId) -> ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeValue:
        """
        Finds a :obj:`attribute value <DWARFAttributeValue>` with a matching
        :obj:`DWARFAttributeId` id.
    ...
    def getBool(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId, defaultValue: typing.Union[jpype.JBoolean, bool]) -> bool:
        """
        Returns the boolean value of the requested attribute, or -defaultValue- if
        the attribute is missing or not the correct type.
        
        :param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attrId: :obj:`DWARFAttributeId` id
    ...
    def getDIEContainer(self) -> DIEContainer:
        """
        :return: the program's single :obj:`DIEContainer`
        :rtype: DIEContainer
        """
    ...
    def getLocation(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId, pc: typing.Union[jpype.JLong, int]) -> DWARFLocation:
        """
        Parses a location attribute value, and returns the :obj:`DWARFLocation` instance that
        covers the specified pc.
        
        :param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attrId: typically :obj:`DWARFAttributeId.DW_AT_location`
    ...
    def getLocationList(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId) -> DWARFLocationList:
        """
    ...
    def getLong(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId, defaultValue: typing.Union[jpype.JLong, int]) -> int:
        """
    ...
    def getName(self) -> str:
        """
        Returns the string value of the :obj:`DW_AT_name <DWARFAttributeId.DW_AT_name>` attribute,
    ...
    def getRangeList(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId) -> DWARFRangeList:
        """
        Parses a range list.
        
        :param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attrId: attribute eg :obj:`DWARFAttributeId.DW_AT_ranges`
        :return: list of ranges, or null if attribute is not present
        :rtype: DWARFRangeList
        :raises IOException: if an I/O error occurs
        """

    def getRef(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId) -> DIEAggregate:
        """
    ...
    def getString(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId, defaultValue: typing.Union[java.lang.String, str]) -> str:
        """
    ...
    def getUnsignedLong(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId, defaultValue: typing.Union[jpype.JLong, int]) -> int:
        """
    ...
    def hasAttribute(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId) -> bool:
        """
        Returns true if the specified attribute is present.
        
        :param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attrId: attribute id
    ...
    def parseDataMemberOffset(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId, defaultValue: typing.Union[jpype.JInt, int]) -> int:
        """
    ...
    def parseInt(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId, defaultValue: typing.Union[jpype.JInt, int]) -> int:
        """
    ...
    def parseUnsignedLong(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId, defaultValue: typing.Union[jpype.JLong, int]) -> int:
        """
        Returns the unsigned integer value of the requested attribute after resolving
        any DWARF expression opcodes.
    ...
    @property
    def dIEContainer(self) -> DIEContainer:
        ...
...
class DebugInfoEntry(java.lang.Object):
    ...
    def __init__(self, cu: DWARFCompilationUnit, offset: typing.Union[jpype.JLong, int], dieIndex: typing.Union[jpype.JInt, int], abbreviation: DWARFAbbreviation, attrOffsets: jpype.JArray[jpype.JInt]) -> None:
        """
        Creates a DIE.
    ...
    def findAttribute(self, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId) -> ghidra.app.util.bin.format.dwarf.attribs.DWARFAttribute:
        ...
        :param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attrId: :obj:`DWARFAttributeId`
        :return: :obj:`DWARFAttribute`, or null if not found
        :rtype: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttribute
        """
    ...
    def getAttribute(self, index: typing.Union[jpype.JInt, int]) -> ghidra.app.util.bin.format.dwarf.attribs.DWARFAttribute:
        """
        :return: the specified DWARFAttribute, by index
        :rtype: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttribute
        
        
        :param jpype.JInt or int index: 0..count
        """
    ...
    def getAttributeDef(self, index: typing.Union[jpype.JInt, int]) -> ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId.AttrDef:
        """
        :return: the DWARFAttributeDef of the specified attribute, by index
        :rtype: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId.AttrDef
    ...
    def getContainer(self) -> DIEContainer:
        ...
    ...
    def getPositionInParent(self, dwTagFilter: java.util.function.Predicate[DWARFTag]) -> int:
        ...
    ...
    def setAttributeValue(self, index: typing.Union[jpype.JInt, int], attrVal: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeValue) -> None:
        ...

    @property
    def container(self) -> DIEContainer:
        ...
    ...
    @property
    def attributeDef(self) -> ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId.AttrDef:
        ...
    ...
    @property
    def attribute(self) -> ghidra.app.util.bin.format.dwarf.attribs.DWARFAttribute:
        ...
...
class DWARFCompilationUnit(DWARFUnitHeader):
    ...
    def __init__(self, dieContainer: DIEContainer, startOffset: typing.Union[jpype.JLong, int], endOffset: typing.Union[jpype.JLong, int], intSize: typing.Union[jpype.JInt, int], dwarfVersion: typing.Union[jpype.JShort, int], pointerSize: typing.Union[jpype.JByte, int], unitNumber: typing.Union[jpype.JInt, int], firstDIEOffset: typing.Union[jpype.JLong, int], codeToAbbreviationMap: collections.abc.Mapping) -> None:
        ...
        :param jpype.JInt or int unitNumber: this compunit's ordinal in the file
    ...
    def getMacros(self) -> ghidra.app.util.bin.format.dwarf.macro.DWARFMacroHeader:
        ...
    ...
    def init(self, rootDIE: DebugInfoEntry) -> None:
        """
    ...
    @staticmethod
    def readV4(partial: DWARFUnitHeader, reader: ghidra.app.util.bin.BinaryReader) -> DWARFCompilationUnit:
        """
    ...
    @staticmethod
    def readV5(partial: DWARFUnitHeader, reader: ghidra.app.util.bin.BinaryReader) -> DWARFCompilationUnit:
        """
        Creates a new :obj:`DWARFCompilationUnit` by reading a compilationUnit's header data
        from the debug_info section.
    ...
    @property
    def macros(self) -> ghidra.app.util.bin.format.dwarf.macro.DWARFMacroHeader:
        ...
...
class DWARFUnitHeader(java.lang.Object):
    ...
    @staticmethod
    def read(dieContainer: DIEContainer, reader: ghidra.app.util.bin.BinaryReader, unitNumber: typing.Union[jpype.JInt, int]) -> DWARFUnitHeader:
        """
        Reads the initial fields found in a unit header.
        
        :param DIEContainer dieContainer: :obj:`DIEContainer`
...
class DWARFProgram(java.io.Closeable):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, importOptions: DWARFImportOptions, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, importOptions: DWARFImportOptions, sectionProvider: ghidra.app.util.bin.format.dwarf.sectionprovider.DWARFSectionProvider) -> None:
        """
    ...
    def getSectionProvider(self) -> ghidra.app.util.bin.format.dwarf.sectionprovider.DWARFSectionProvider:
        ...
    ...
    def isZeroDataAddress(self, addr: ghidra.program.model.address.Address) -> bool:
        ...

    def logWarningAt(self, addr: ghidra.program.model.address.Address, addrName: typing.Union[java.lang.String, str], msg: typing.Union[java.lang.String, str]) -> None:
        ...

    def setProgramBaseAddressFixup(self, programBaseAddressFixup: typing.Union[jpype.JLong, int]) -> None:
        ...
    ...
    @property
    def zeroDataAddress(self) -> jpype.JBoolean:
        ...
    ...
    @property
    def sectionProvider(self) -> ghidra.app.util.bin.format.dwarf.sectionprovider.DWARFSectionProvider:
        ...
    ...
    @programBaseAddressFixup.setter
    def programBaseAddressFixup(self, value: jpype.JLong):
        ...
...
class DIEContainer(java.lang.Iterable[DebugInfoEntry]):
    """
    Provides access to a set of DIE records (and associated bits and bobs)
    """

    @typing.type_check_only
    class DIEHeadIterator(DIEContainer.DIEIterator):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class DIEIterator(java.util.Iterator[DebugInfoEntry], java.lang.Iterable[DebugInfoEntry]):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    def __init__(self, dprog: DWARFProgram) -> None:
        ...
    ...
    def getAbbrevs(self, abbrevOffset: typing.Union[jpype.JLong, int]) -> java.util.Map[java.lang.Integer, DWARFAbbreviation]:
        ...
    ...
    def getChildCount(self, dieIndex: typing.Union[jpype.JInt, int]) -> int:
        ...
    ...
    def getDIE(self, form: ghidra.app.util.bin.format.dwarf.attribs.DWARFForm, rawOffset: typing.Union[jpype.JLong, int], cu: DWARFCompilationUnit) -> DebugInfoEntry:
        """
        ...
        :param jpype.JLong or int rawOffset: index / offset from the numeric attribute
        :param DWARFCompilationUnit cu: compilation unit containing the value
        :return: :obj:`DebugInfoEntry`, or null if doesn't exist
        :rtype: DebugInfoEntry
        :raises IOException: if unsupported format for reference
        """
    ...
    def getDebugLineReader(self) -> ghidra.app.util.bin.BinaryReader:
        ...

    @typing.overload
    def getLine(self, diea: DIEAggregate, attribute: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId) -> ghidra.app.util.bin.format.dwarf.line.DWARFLine:
        """
        Returns the DWARFLine info pointed to by the specified attribute.
        
        :param DIEAggregate diea: :obj:`DIEAggregate`
        :param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attribute: attribute id that points to the line info
    ...
    @typing.overload
    def getLine(self, offset: typing.Union[jpype.JLong, int], cu: DWARFCompilationUnit, readIfMissing: typing.Union[jpype.JBoolean, bool]) -> ghidra.app.util.bin.format.dwarf.line.DWARFLine:
        ...

    def getLineDataSize(self) -> int:
        ...

    def getLocationList(self, diea: DIEAggregate, attrId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId) -> DWARFLocationList:
        """
        Returns the :obj:`DWARFLocationList` pointed to by the specified attribute value.
        
        :param DIEAggregate diea: :obj:`DIEAggregate`
        :param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attrId: attribute id that points to the location list
    ...
    def getMacroEntries(self, macroHeader: ghidra.app.util.bin.format.dwarf.macro.DWARFMacroHeader) -> java.util.List[ghidra.app.util.bin.format.dwarf.macro.entry.DWARFMacroInfoEntry]:
        ...

    def getMacroHeader(self, offset: typing.Union[jpype.JLong, int], cu: DWARFCompilationUnit) -> ghidra.app.util.bin.format.dwarf.macro.DWARFMacroHeader:
        ...
    ...
    def getPositionInParent(self, die: DebugInfoEntry, dwTagFilter: java.util.function.Predicate[DWARFTag]) -> int:
        ...

    def getProgram(self) -> DWARFProgram:
        ...

    def getRangeList(self, diea: DIEAggregate, attribute: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId) -> DWARFRangeList:
        """
        Returns the :obj:`DWARFRangeList` pointed at by the specified attribute.
        
        :param DIEAggregate diea: :obj:`DIEAggregate`
        :param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attribute: attribute id to find in the DIEA
    ...
    def getStringTable(self) -> StringTable:
        ...
    ...
    def indexData(self, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Reads and indexes the DIE records found in the section.
        
        :param ghidra.util.task.TaskMonitor monitor: :obj:`TaskMonitor`
        :raises CancelledException: if cancelled
        :raises DWARFException: if error
    ...
    def unreferencedDIEs(self) -> DIEContainer.DIEIterator:
        ...

    @property
    def abbrevs(self) -> java.util.Map[java.lang.Integer, DWARFAbbreviation]:
        ...
    ...
    @property
    def macroEntries(self) -> java.util.List[ghidra.app.util.bin.format.dwarf.macro.entry.DWARFMacroInfoEntry]:
        ...
    ...
    @property
    def lineDataSize(self) -> jpype.JLong:
        ...

    @property
    def debugLineReader(self) -> ghidra.app.util.bin.BinaryReader:
        ...
...
class DWARFLocationList(java.lang.Object):
    ...
    def __init__(self, list: java.util.List[DWARFLocation]) -> None:
        ...
...
class DWARFLocation(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int], expr: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addressRange: DWARFRange, expr: jpype.JArray[jpype.JByte]) -> None:
        ...
    ...
    def getResolvedValue(self) -> ghidra.program.model.pcode.Varnode:
        ...

    def isWildcard(self) -> bool:
        ...

    def setResolvedValue(self, resolvedValue: ghidra.program.model.pcode.Varnode) -> None:
        ...
    ...
    @property
    def resolvedValue(self) -> ghidra.program.model.pcode.Varnode:
        ...

    @resolvedValue.setter
    def resolvedValue(self, value: ghidra.program.model.pcode.Varnode):
        ...
...
class DWARFRangeList(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, singleRange: DWARFRange) -> None:
        ...

    @typing.overload
    def __init__(self, ranges: java.util.List[DWARFRange]) -> None:
        ...
...
class DWARFRange(java.lang.Comparable[DWARFRange]):
    ...
    def __init__(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int]) -> None:
        """
...
class DWARFRegisterMappings(java.lang.Object):
    ...
    def __init__(self, regmap: collections.abc.Mapping, callFrameCFA: typing.Union[java.lang.Integer, int], stackPointerIndex: typing.Union[jpype.JInt, int], stackFrameRegister: ghidra.program.model.lang.Register, stackFrameRegisterOffset: typing.Union[jpype.JInt, int], useFPS: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def getStackFrameRegister(self) -> ghidra.program.model.lang.Register:
        ...

    def getStackFrameRegisterOffset(self) -> int:
        ...

    def getStackRegister(self) -> ghidra.program.model.lang.Register:
        ...

    def hasStaticCFA(self) -> bool:
        ...
    ...
    @property
    def stackFrameRegisterOffset(self) -> jpype.JInt:
        ...

    @property
    def callFrameCFA(self) -> jpype.JInt:
        ...

    @property
    def stackFrameRegister(self) -> ghidra.program.model.lang.Register:
        ...
...
class DWARFAbbreviation(java.lang.Object):
    ...
    def __init__(self, abbreviationCode: typing.Union[jpype.JInt, int], tagId: typing.Union[jpype.JInt, int], hasChildren: typing.Union[jpype.JBoolean, bool], attributes: jpype.JArray[ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId.AttrDef]) -> None:
        ...

    def findAttribute(self, attributeId: ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId) -> ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId.AttrDef:
        """
        Get the attribute with the given attribute key.
        
        :param ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId attributeId: attribute key
    ...
    def getAttributeAt(self, index: typing.Union[jpype.JInt, int]) -> ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId.AttrDef:
        """
    ...
    def getAttributes(self) -> jpype.JArray[ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId.AttrDef]:
        """
        Return a live list of the attributes.
        
        :return: list of attributes
        :rtype: jpype.JArray[ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId.AttrDef]
        """
    ...
    @staticmethod
    def read(reader: ghidra.app.util.bin.BinaryReader, dieContainer: DIEContainer) -> DWARFAbbreviation:
        """
    ...
    @staticmethod
    def readAbbreviations(reader: ghidra.app.util.bin.BinaryReader, dieContainer: DIEContainer) -> java.util.Map[java.lang.Integer, DWARFAbbreviation]:
        """
    ...
    @property
    def attributeAt(self) -> ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId.AttrDef:
        ...
    ...
    @property
    def attributes(self) -> jpype.JArray[ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeId.AttrDef]:
        ...
...
class DWARFIndirectTable(java.lang.Object):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, baseOffsetFunc: java.util.function.Function[DWARFCompilationUnit, java.lang.Long]) -> None:
        """
    ...
    def bootstrap(self, msg: typing.Union[java.lang.String, str], headerReader: DWARFIndirectTable.CheckedIOFunction[ghidra.app.util.bin.BinaryReader, DWARFIndirectTableHeader], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class StringTable(java.lang.Object):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, charset: java.nio.charset.Charset) -> None:
        """
        Creates a StringTable
        
        :param ghidra.app.util.bin.BinaryReader reader: :obj:`BinaryReader` .debug_str or .debug_line_str
        :param java.nio.charset.Charset charset: :obj:`Charset` of strings in table
        """
    ...
    @staticmethod
    def of(reader: ghidra.app.util.bin.BinaryReader, charset: java.nio.charset.Charset) -> StringTable:
        """
...
class DWARFIndirectTableHeader(java.lang.Object):
    ...
    def __init__(self, startOffset: typing.Union[jpype.JLong, int], endOffset: typing.Union[jpype.JLong, int], firstElementOffset: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class DWARFDataTypeImporter(java.lang.Object):
    ...
    def __init__(self, prog: DWARFProgram, dwarfDTM: DWARFDataTypeManager) -> None:
        """
    ...
    def getDataType(self, diea: DIEAggregate, defaultValue: DWARFDataTypeImporter.DWARFDataType) -> DWARFDataTypeImporter.DWARFDataType:
        ...
        :raises IOException: if error
        :raises DWARFExpressionException: if error with dwarf expression
        """
...
class DWARFDataTypeManager(java.lang.Object):
    ...
    def __init__(self, prog: DWARFProgram, dataTypeManager: ghidra.program.model.data.DataTypeManager) -> None:
        """
    ...
    def addDataType(self, offset: typing.Union[jpype.JLong, int], dataType: ghidra.program.model.data.DataType, dsi: DWARFSourceInfo) -> None:
        ...
    ...
    def forAllConflicts(self, dtp: ghidra.program.model.data.DataTypePath) -> java.lang.Iterable[ghidra.program.model.data.DataType]:
        ...
        :param ghidra.program.model.data.DataTypePath dtp: :obj:`DataTypePath`
        :return: :obj:`Iterable` of DataTypes that match
    ...
    def getBaseType(self, name: typing.Union[java.lang.String, str], dwarfSize: typing.Union[jpype.JInt, int], dwarfEncoding: typing.Union[jpype.JInt, int], isBigEndian: typing.Union[jpype.JBoolean, bool], isExplictSize: typing.Union[jpype.JBoolean, bool]) -> ghidra.program.model.data.DataType:
        ...
        :param java.lang.String or str name: name of DWARF base type
        :param jpype.JInt or int dwarfSize: size of DWARF base type
        :param jpype.JInt or int dwarfEncoding: from :obj:`DWARFEncoding` const 'enum'
        :param jpype.JBoolean or bool isBigEndian: boolean flag, true = BE, false = LE
    ...
    def getOffsetType(self, size: typing.Union[jpype.JInt, int]) -> ghidra.program.model.data.DataType:
        ...
        :param jpype.JInt or int size: (in bytes) of desired offset type
    ...
    def getUnspecifiedArrayType(self) -> ghidra.program.model.data.DataType:
        ...
    ...
    @property
    def unspecifiedArrayType(self) -> ghidra.program.model.data.DataType:
        ...
...
class DWARFFunction(java.lang.Object):
    ...
    funcEntryFrameBaseLoc: DWARFLocation
    ...
    def commitLocalVariable(self, dvar: DWARFVariable) -> None:
        ...
...
class DWARFVariable(java.lang.Object):
    ...
    def addRamStorage(self, offset: typing.Union[jpype.JLong, int]) -> None:
        ...

    def addRegisterStorage(self, registers: java.util.List[ghidra.program.model.lang.Register]) -> None:
        ...

    def addStackStorage(self, offset: typing.Union[jpype.JLong, int], length: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def readLocalVariable(diea: DIEAggregate, dfunc: DWARFFunction, offsetFromFuncStart: typing.Union[jpype.JLong, int]) -> DWARFVariable:
        ...
        :meth:`isMissingStorage() <.isMissingStorage>` to determine if there was an error getting storage info
        :rtype: DWARFVariable
        """
    ...
    def setRamStorage(self, offset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setRegisterStorage(self, registers: java.util.List[ghidra.program.model.lang.Register]) -> None:
        """
    ...
    def setStackStorage(self, offset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setStorage(self, varnode: ghidra.program.model.pcode.Varnode) -> None:
        ...

    def setVarnodes(self, newStorage: java.util.List[ghidra.program.model.pcode.Varnode]) -> None:
        ...
...
class DWARFSourceInfo(java.lang.Record):
    ...
    def __init__(self, filename: typing.Union[java.lang.String, str], lineNum: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DWARFAddressListHeader(DWARFIndirectTableHeader):
    ...
    def __init__(self, startOffset: typing.Union[jpype.JLong, int], endOffset: typing.Union[jpype.JLong, int], firstElementOffset: typing.Union[jpype.JLong, int], addressSize: typing.Union[jpype.JInt, int], segmentSelectorSize: typing.Union[jpype.JInt, int], addrCount: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DWARFFunctionImporter(java.lang.Object):
    ...
    def __init__(self, prog: DWARFProgram, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class DWARFImporter(java.lang.Object):
    ...
    def performImport(self) -> DWARFImportSummary:
        ...
        :return: A :obj:`DWARFImportSummary`
        :rtype: DWARFImportSummary
        :raises IOException: if an IO-related error occurred
        :raises DWARFException: if a DWARF-related error occurred
...
class DWARFLengthValue(java.lang.Record):
    ...
    def __init__(self, length: typing.Union[jpype.JLong, int], intSize: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DWARFLocationListHeader(DWARFIndirectTableHeader):
    ...
    in the :obj:`.debug_loclists <DWARFSectionId.DEBUG_LOCLISTS>` section.
    """
...
class DWARFMacroEnumCreator(java.lang.Object):
    """
    ...
    class_: typing.ClassVar[java.lang.Class]
    ENUM_PATH: typing.Final = "_DEFINES_"

    def __init__(self, dprog: DWARFProgram) -> None:
        """
        Constructor
        
        :param DWARFProgram dprog: DWARF Program
        """

    def createEnumsFromMacroInfo(self, includeCommandLineDefines: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        ...
        :param jpype.JBoolean or bool includeCommandLineDefines: if false, macros passed on the command line are ignored
        :param ghidra.util.task.TaskMonitor monitor: monitor
        :raises CancelledException: if user cancels
        :raises IOException: if error reading macro info
        """
...
class DWARFRangeListHeader(DWARFIndirectTableHeader):
    ...
    in the :obj:`.debug_rnglists <DWARFSectionId.DEBUG_RNGLISTS>` section.
    """
...
class DWARFRegisterMappingsManager(java.lang.Object):
    ...
    @staticmethod
    def readMappingFrom(rootElem: org.jdom2.Element, lang: ghidra.program.model.lang.Language) -> DWARFRegisterMappings:
        """
        Creates a new :obj:`DWARFRegisterMappings` from the data present in the
        xml element.
        
        :param org.jdom2.Element rootElem: JDom XML element containing the <dwarf> root
...
class DWARFStringOffsetTableHeader(DWARFIndirectTableHeader):
    ...
    :obj:`.debug_str_offsets <DWARFSectionId.DEBUG_STROFFSETS>` section.
    ...
    :obj:`DWARFAttributeId.DW_AT_str_offsets_base` value.
    """

    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, startOffset: typing.Union[jpype.JLong, int], endOffset: typing.Union[jpype.JLong, int], firstElementOffset: typing.Union[jpype.JLong, int], intSize: typing.Union[jpype.JInt, int], count: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def readV5(reader: ghidra.app.util.bin.BinaryReader, defaultIntSize: typing.Union[jpype.JInt, int]) -> DWARFStringOffsetTableHeader:
        ...
        :param jpype.JInt or int defaultIntSize: size in bytes of integers
...
class DWARFUtil(java.lang.Object):
    ...
    @staticmethod
    def appendComment(program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, commentType: ghidra.program.model.listing.CommentType, prefix: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str], sep: typing.Union[java.lang.String, str]) -> None:
        ...

    @staticmethod
    @typing.overload
    def appendDescription(dt: ghidra.program.model.data.DataType, description: typing.Union[java.lang.String, str], sep: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def appendDescription(dtc: ghidra.program.model.data.DataTypeComponent, description: typing.Union[java.lang.String, str], sep: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def findLinkageNameInChildren(die: DebugInfoEntry) -> java.util.List[java.lang.String]:
        ...
        :param DebugInfoEntry die: :obj:`DebugInfoEntry` record
    ...
    def getLanguageExternalNameValue(lang: ghidra.program.model.lang.Language, name: typing.Union[java.lang.String, str]) -> str:
        ...
        :return: String value
        :rtype: str
        :raises IOException: if invalid language or multiple values with same name
        """
    ...
    @staticmethod
    def isConstVarnode(varnode: ghidra.program.model.pcode.Varnode) -> bool:
        ...
    ...
    def parseMangledNestings(s: typing.Union[java.lang.String, str]) -> java.util.List[java.lang.String]:
        ...
        :param java.lang.String or str s: mangled string
    ...
    def toString(clazz: java.lang.Class[typing.Any], value: typing.Union[jpype.JLong, int]) -> str:
        ...
        :param java.lang.Class[typing.Any] clazz: 'enum' class that contains the "public static final" values
        :param jpype.JLong or int value: value to lookup
...
class DataTypeGraphComparator(java.lang.Object):
    ...
    @staticmethod
    def compare(preDT: ghidra.program.model.data.DataType, postDT: ghidra.program.model.data.DataType, observer: DataTypeGraphComparator.DataTypePairObserver) -> None:
        """
...
class ExternalDebugFileSymbolImporter(java.lang.Object):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, externalDebugProgram: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    def importSymbols(self, log: ghidra.app.util.importer.MessageLog) -> None:
        ...
...
class NameDeduper(java.lang.Object):
    ...
    def addReservedNames(self, additionalReservedNames: collections.abc.Sequence) -> None:
        """
    ...
    def addUsedNames(self, alreadyUsedNames: collections.abc.Sequence) -> None:
        """
...
__all__ = ["DWARFImportOptions", "DWARFTag", "DIEAggregate", "DebugInfoEntry", "DWARFCompilationUnit", "DWARFUnitHeader", "DWARFProgram", "DIEContainer", "DWARFException", "DWARFLocationListEntry", "DWARFLocationList", "DWARFLocation", "DWARFRangeListEntry", "DWARFRangeList", "DWARFRange", "DWARFRegisterMappings", "DWARFAbbreviation", "DWARFIndirectTable", "StringTable", "DWARFImportSummary", "DWARFIndirectTableHeader", "DWARFDataTypeImporter", "DWARFDataTypeManager", "DWARFName", "DWARFFunction", "DWARFVariable", "DWARFSourceInfo", "NamespacePath", "DWARFAccessibility", "DWARFAddressListHeader", "DWARFChildren", "DWARFDataInstanceHelper", "DWARFDataTypeConflictHandler", "DWARFEncoding", "DWARFEndianity", "DWARFFunctionImporter", "DWARFIdentifierCase", "DWARFImporter", "DWARFInline", "DWARFLengthValue", "DWARFLocationListHeader", "DWARFMacroEnumCreator", "DWARFRangeListHeader", "DWARFRegisterMappingsManager", "DWARFSourceLanguage", "DWARFStringOffsetTableHeader", "DWARFUnitType", "DWARFUtil", "DataTypeGraphComparator", "ExternalDebugFileSymbolImporter", "NameDeduper"]
