...
class ObjectTableModel(AbstractQueryTableModel[ObjectTableModel.ValueRow]):
    ...
    class ValueDerivedProperty(ObjectTableModel.ValueProperty[T], typing.Generic[T]):
        ...
        def __init__(self, row: ObjectTableModel.ValueRow, type: java.lang.Class[T]) -> None:
            ...
    ...
    class ValueAddressProperty(ObjectTableModel.ValueDerivedProperty[ghidra.program.model.address.Address]):
        ...
        def __init__(self, row: ObjectTableModel.ValueRow) -> None:
            ...
    ...
    class ValueAttribute(java.lang.Record, ObjectTableModel.ValueProperty[T], typing.Generic[T]):
        ...
        def __init__(self, row: ObjectTableModel.ValueRow, name: typing.Union[java.lang.String, str], type: java.lang.Class[T]) -> None:
            ...
    ...
    class AbstractValueRow(ObjectTableModel.ValueRow):
        ...
        def __init__(self, value: ghidra.trace.model.target.TraceObjectValue) -> None:
            ...
    ...
    class AutoAttributeColumn(ghidra.app.plugin.core.debug.gui.model.columns.TraceValueObjectAttributeColumn[T], typing.Generic[T]):
        ...
        def __init__(self, attributeName: typing.Union[java.lang.String, str], attributeType: java.lang.Class[T], hidden: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def setColumnValueForRow(self, t: ObjectTableModel.ValueRow, aValue: java.lang.Object, columnIndex: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class AbstractQueryTablePanel(javax.swing.JPanel, typing.Generic[T, M]):
    ...
    class CellActivationListener(java.lang.Object):
        ...
        def cellActivated(self, table: javax.swing.JTable) -> None:
            ...
    ...
    def addCellActivationListener(self, listener: AbstractQueryTablePanel.CellActivationListener) -> None:
        ...

    def addSeekListener(self, listener: docking.widgets.table.RangeCursorTableHeaderRenderer.SeekListener) -> None:
        ...

    def addSelectionListener(self, listener: javax.swing.event.ListSelectionListener) -> None:
        ...
    ...
    def goToCoordinates(self, coords: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> None:
        ...
    ...
    def removeCellActivationListener(self, listener: AbstractQueryTablePanel.CellActivationListener) -> None:
        ...

    def removeSelectionListener(self, listener: javax.swing.event.ListSelectionListener) -> None:
        ...

    def setDiffColor(self, diffColor: java.awt.Color) -> None:
        ...

    def setDiffColorSel(self, diffColorSel: java.awt.Color) -> None:
        ...

    def setLimitToSnap(self, limitToSnap: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setQuery(self, query: ModelQuery) -> None:
        ...

    def setSelectedItem(self, item: T) -> None:
        ...

    def setSelectedItems(self, items: collections.abc.Sequence) -> None:
        ...

    def setSelectionMode(self, selectionMode: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setShowHidden(self, showHidden: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    @typing.overload
    def trySelect(self, objects: collections.abc.Sequence) -> None:
        ...
...
class AbstractObjectsTableBasedPanel(ObjectsTablePanel, javax.swing.event.ListSelectionListener, AbstractQueryTablePanel.CellActivationListener, ObjectDefaultActionsMixin, typing.Generic[U]):
    ...
    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, provider: docking.ComponentProvider, objType: java.lang.Class[U]) -> None:
        ...
...
class PathTableModel(AbstractQueryTableModel[PathTableModel.PathRow]):
    ...
    class PathRow(java.lang.Object):
        ...
        def __init__(self, path: ghidra.trace.model.target.TraceObjectValPath) -> None:
            ...
...
class ObjectDefaultActionsMixin(java.lang.Object):
    ...
    @typing.overload
    def goToAddress(self, listingService: ghidra.app.services.DebuggerListingService, address: ghidra.program.model.address.Address) -> None:
        ...

    @typing.overload
    def goToAddress(self, address: ghidra.program.model.address.Address) -> None:
        ...

    def goToRange(self, range: ghidra.program.model.address.AddressRange) -> None:
        ...
    ...
    def toggleObject(self, object: ghidra.trace.model.target.TraceObject) -> None:
        ...
...
class AbstractQueryTableModel(docking.widgets.table.threaded.ThreadedTableModel[T, ghidra.trace.model.Trace], DisplaysModified, typing.Generic[T]):
    ...
    def setCurrentObject(self, curObject: ghidra.trace.model.target.TraceObject) -> None:
        ...
    ...
    def setDiffSnap(self, diffSnap: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setDiffTrace(self, diffTrace: ghidra.trace.model.Trace) -> None:
        """
    ...
    def setSpan(self, span: ghidra.trace.model.Lifespan) -> None:
        ...
...
class ModelQuery(java.lang.Object):
    ...
    def __init__(self, filter: ghidra.trace.model.target.path.PathFilter) -> None:
        """
...
class ObjectTreeModel(DisplaysModified):
    ...
    class ListenerForChanges(ghidra.trace.model.TraceDomainObjectListener, ghidra.framework.model.DomainObjectClosedListener):
        ...
        def domainObjectRestored(self, rec: ghidra.framework.model.DomainObjectChangeRecord) -> None:
            ...
    ...
    class AbstractNode(docking.widgets.tree.GTreeLazyNode):
        ...
        def addNodeSorted(self, node: ObjectTreeModel.AbstractNode) -> None:
            ...
    ...
    def setShowMethods(self, showMethods: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShowPrimitives(self, showPrimitives: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DebuggerModelProvider(docking.ComponentProvider, ghidra.app.plugin.core.debug.gui.MultiProviderSaveBehavior.SaveableProvider):
    ...
    class ObjectsTreeListener(DebuggerModelProvider.MyMixin, Adapters.FocusListener, Adapters.TreeExpansionListener, Adapters.MouseListener, Adapters.KeyListener):
        ...
        def selectionChanged(self, evt: docking.widgets.tree.support.GTreeSelectionEvent) -> None:
            ...
    ...
    class ElementsTableListener(DebuggerModelProvider.MyMixin, Adapters.FocusListener, AbstractQueryTablePanel.CellActivationListener):
        ...
        def selectionChanged(self, evt: javax.swing.event.ListSelectionEvent) -> None:
            ...
    ...
    def __init__(self, plugin: DebuggerModelPlugin, isClone: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def coordinatesActivated(self, coords: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> None:
        ...
    ...
    def setLimitToCurrentSnap(self, limitToSnap: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setPath(self, path: ghidra.trace.model.target.path.KeyPath) -> None:
        ...

    def setShowAttributesTable(self, showAttributesTable: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShowElementsTable(self, showElementsTable: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShowHidden(self, showHidden: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShowMethodsInTree(self, showMethodsInTree: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShowObjectsTree(self, showObjectsTree: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShowPrimitivesInTree(self, showPrimitivesInTree: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ObjectsTreePanel(javax.swing.JPanel):
    ...
    class ObjectGTree(docking.widgets.tree.GTree):
        ...
        def __init__(self, root: docking.widgets.tree.GTreeNode) -> None:
            ...
    ...
    class DelayedSwingHack(java.lang.Runnable):
        ...
        def __init__(self, delay: typing.Union[jpype.JInt, int], runnable: java.lang.Runnable) -> None:
            ...

        @staticmethod
        def runWayLater(delay: typing.Union[jpype.JInt, int], runnable: java.lang.Runnable) -> None:
            ...
    ...
    def addTreeSelectionListener(self, listener: docking.widgets.tree.support.GTreeSelectionListener) -> None:
        ...
    ...
    def removeTreeSelectionListener(self, listener: docking.widgets.tree.support.GTreeSelectionListener) -> None:
        ...
    ...
    @typing.overload
    def setSelectedKeyPaths(self, keyPaths: collections.abc.Sequence, origin: docking.widgets.tree.support.GTreeSelectionEvent.EventOrigin) -> None:
        ...

    @typing.overload
    def setSelectedKeyPaths(self, keyPaths: collections.abc.Sequence) -> None:
        ...

    def setSelectedObject(self, object: ghidra.trace.model.target.TraceObject) -> None:
        ...
...
__all__ = ["ObjectTableModel", "AbstractQueryTablePanel", "AbstractObjectsTableBasedPanel", "ObjectsTablePanel", "PathTableModel", "ObjectDefaultActionsMixin", "AbstractQueryTableModel", "DisplaysModified", "ModelQuery", "DisplaysObjectValues", "ColorsModified", "Adapters", "DebuggerModelPlugin", "ObjectTreeModel", "DebuggerModelProvider", "ObjectsTreePanel", "PathsTablePanel", "KeepTreeState"]
