...
class IntelHexExporter(Exporter):
    ...
    class RecordSizeOption(ghidra.app.util.Option):
        ...
        def setDropBytes(self, dropBytes: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setRecordSize(self, recordSize: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    class RecordSizeComponent(javax.swing.JPanel):
        ...
        * dropCb: a :obj:`JCheckBox` for specifying a setting that enforces that every line in 
        ...
        def __init__(self, recordSize: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, recordSize: typing.Union[jpype.JInt, int], dropBytes: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ReferenceLineDispenser(AbstractLineDispenser):
    ...
    @typing.type_check_only
    class XrefItem(java.lang.Object):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    @staticmethod
    def getXRefList(cu: ghidra.program.model.listing.CodeUnit) -> java.util.List[ghidra.program.model.symbol.Reference]:
        ...
...
class StringComparer(java.lang.Object):
    ...
    @typing.type_check_only
    class FilePrinter(java.lang.Object):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    @staticmethod
    def compareLines(expectedList: java.util.List[java.lang.String], actualFile: jpype.protocol.SupportsPath) -> None:
        ...
...
__all__ = ["Exporter", "ExporterException", "AbstractLineDispenser", "AsciiExporter", "ProgramTextOptions", "BinaryExporter", "CommentLineDispenser", "GdtExporter", "GzfExporter", "HtmlExporter", "IntelHexExporter", "OriginalFileExporter", "ProgramTextWriter", "ReferenceLineDispenser", "StringComparer", "XmlExporter", "CppExporter"]
