...
class TraceObject(ghidra.trace.model.TraceUniqueObject):
    ...
    * "Session" : :obj:`TraceObject`    
    ...
    def remove(self, span: ghidra.trace.model.Lifespan) -> None:
        """
    ...
    def removeTree(self, span: ghidra.trace.model.Lifespan) -> None:
        """
...
class TraceObjectValue(java.lang.Object):
    ...
    @typing.overload
    def setLifespan(self, lifespan: ghidra.trace.model.Lifespan) -> None:
        """
    ...
    @typing.overload
    def setLifespan(self, span: ghidra.trace.model.Lifespan, resolution: TraceObject.ConflictResolution) -> None:
        """
    ...
    def setMaxSnap(self, maxSnap: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setMinSnap(self, minSnap: typing.Union[jpype.JLong, int]) -> None:
        """
...
class DuplicateKeyException(java.lang.RuntimeException):
    ...
    def __init__(self, key: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["TraceObjectManager", "TraceObject", "TraceObjectValPath", "TraceObjectValue", "DuplicateKeyException"]
