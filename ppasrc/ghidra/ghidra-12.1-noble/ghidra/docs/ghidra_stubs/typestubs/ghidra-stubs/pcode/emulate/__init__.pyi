...
class BreakTableCallBack(BreakTable):
    ...
    * registerAddressCallback()
    ...
    def registerAddressCallback(self, addr: ghidra.program.model.address.Address, func: BreakCallBack) -> None:
        """
    ...
    def registerPcodeCallback(self, name: typing.Union[java.lang.String, str], func: BreakCallBack) -> None:
        """
    ...
    def unregisterPcodeCallback(self, name: typing.Union[java.lang.String, str]) -> None:
        """
...
class InstructionDecodeException(ghidra.pcode.error.LowlevelError):
    ...
    def __init__(self, reason: typing.Union[java.lang.String, str], pc: ghidra.program.model.address.Address) -> None:
        ...
...
@deprecated("Use PcodeMachine.inject(Address, String). By injecting a userop invocation,\n  you can receive a callback in a AnnotatedPcodeUseropLibrary.")
class BreakCallBack(java.lang.Object):
    ...
    * addressCallback()
    ...
    Use :meth:`PcodeMachine.inject(Address, String) <PcodeMachine.inject>`. By injecting a userop invocation,
    you can receive a callback in a :obj:`AnnotatedPcodeUseropLibrary`.
    """
...
class Emulate(java.lang.Object):
    ...
    def __init__(self, lang: ghidra.app.plugin.processors.sleigh.SleighLanguage, s: ghidra.pcode.memstate.MemoryState, b: BreakTable) -> None:
        """
...
class EmulateMemoryStateBuffer(ghidra.program.model.mem.MemBuffer):
    ...
    def __init__(self, memState: ghidra.pcode.memstate.MemoryState, addr: ghidra.program.model.address.Address) -> None:
        ...
...
@deprecated("Use PcodeUseropLibrary or AnnotatedPcodeUseropLibrary instead")
class EmulateInstructionStateModifier(java.lang.Object):
    ...
    Use :obj:`PcodeUseropLibrary` or :obj:`AnnotatedPcodeUseropLibrary` instead
    """
    ...
    def initialExecuteCallback(self, emulate: Emulate, current_address: ghidra.program.model.address.Address, contextRegisterValue: ghidra.program.model.lang.RegisterValue) -> None:
        """
    ...
    def postExecuteCallback(self, emulate: Emulate, lastExecuteAddress: ghidra.program.model.address.Address, lastExecutePcode: jpype.JArray[ghidra.program.model.pcode.PcodeOp], lastPcodeIndex: typing.Union[jpype.JInt, int], currentAddress: ghidra.program.model.address.Address) -> None:
        """
...
class EmulateDisassemblerContext(ghidra.program.model.lang.DisassemblerContext):
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, initialContextValue: ghidra.program.model.lang.RegisterValue) -> None:
        ...
...
class UnimplementedCallOtherException(ghidra.pcode.error.LowlevelError):
    ...
    def __init__(self, op: ghidra.pcode.pcoderaw.PcodeOpRaw, opName: typing.Union[java.lang.String, str]) -> None:
        ...
...
__all__ = ["BreakTableCallBack", "BreakTable", "InstructionDecodeException", "EmulateExecutionState", "BreakCallBack", "Emulate", "EmulateMemoryStateBuffer", "EmulateInstructionStateModifier", "EmulateDisassemblerContext", "UnimplementedCallOtherException", "UnimplementedInstructionException"]
