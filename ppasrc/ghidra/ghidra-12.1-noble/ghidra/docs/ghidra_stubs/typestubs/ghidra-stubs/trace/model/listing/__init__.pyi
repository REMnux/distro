...
class TraceCodeUnit(ghidra.program.model.listing.CodeUnit):
    ...
    def setProperty(self, name: typing.Union[java.lang.String, str], valueClass: java.lang.Class[T], value: T) -> None:
        """
    ...
    def setTypedProperty(self, name: typing.Union[java.lang.String, str], value: T) -> None:
        """
...
class TraceBaseDefinedUnitsView(TraceBaseCodeUnitsView[T], typing.Generic[T]):
    ...
    @typing.overload
    def clear(self, span: ghidra.trace.model.Lifespan, register: ghidra.program.model.lang.Register, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def clear(self, platform: ghidra.trace.model.guest.TracePlatform, span: ghidra.trace.model.Lifespan, register: ghidra.program.model.lang.Register, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
__all__ = ["TraceCodeManager", "TraceCodeOperations", "TraceCodeUnit", "TraceCodeSpace", "TraceCodeUnitsView", "TraceBaseCodeUnitsView", "TraceInstructionsView", "TraceBaseDefinedUnitsView", "TraceInstruction", "TraceDataView", "TraceData", "TraceDefinedDataView", "TraceUndefinedDataView", "TraceDefinedUnitsView"]
