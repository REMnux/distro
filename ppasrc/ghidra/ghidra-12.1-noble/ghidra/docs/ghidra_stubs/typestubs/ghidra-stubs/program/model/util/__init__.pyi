...
class IntPropertyMap(PropertyMap[java.lang.Integer]):
    ...
    def add(self, addr: ghidra.program.model.address.Address, value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class PropertyMap(java.lang.Object, typing.Generic[T]):
    ...
    def add(self, addr: ghidra.program.model.address.Address, value: java.lang.Object) -> None:
        """
...
class LongPropertyMap(PropertyMap[java.lang.Long]):
    ...
    def add(self, addr: ghidra.program.model.address.Address, value: typing.Union[jpype.JLong, int]) -> None:
        """
...
class StringPropertyMap(PropertyMap[java.lang.String]):
    ...
    def add(self, addr: ghidra.program.model.address.Address, value: typing.Union[java.lang.String, str]) -> None:
        """
...
class ObjectPropertyMap(PropertyMap[T], typing.Generic[T]):
    ...
    def add(self, addr: ghidra.program.model.address.Address, value: T) -> None:
        """
...
class PropertySet(java.lang.Object):
    ...
    @typing.overload
    def setProperty(self, name: typing.Union[java.lang.String, str], value: T) -> None:
        """
...
class AcyclicCallGraphBuilder(java.lang.Object):
    ...
    class VisitStack(java.lang.Object):
        ...
        def __init__(self, functionEntry: ghidra.program.model.address.Address) -> None:
            ...
        ...
        def push(self, address: ghidra.program.model.address.Address) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, killThunks: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, set: ghidra.program.model.address.AddressSetView, killThunks: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, functions: collections.abc.Sequence, killThunks: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class CompositeDataTypeElementInfo(DataTypeInfo):
    ...
    @typing.overload
    def __init__(self, dataTypeHandle: java.lang.Object, dataTypeOffset: typing.Union[jpype.JInt, int], dataTypeLength: typing.Union[jpype.JInt, int], dataTypeAlignment: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dataTypeInfo: DataTypeInfo, dataTypeOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DataTypeInfo(java.lang.Object):
    ...
    def __init__(self, dataTypeHandle: java.lang.Object, dataTypeLength: typing.Union[jpype.JInt, int], dataTypeAlignment: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DefaultPropertyMap(PropertyMap[T], typing.Generic[T]):
    ...
    def __init__(self, propertyMgr: ghidra.util.map.ValueMap[T]) -> None:
        """
...
class MemoryByteIterator(java.lang.Object):
    ...
    def __init__(self, mem: ghidra.program.model.mem.Memory, set: ghidra.program.model.address.AddressSetView) -> None:
        """
...
__all__ = ["ProcessorSymbolType", "AddressSetPropertyMap", "PropertyMapManager", "IntPropertyMap", "PropertyMap", "LongPropertyMap", "StringPropertyMap", "ObjectPropertyMap", "VoidPropertyMap", "PropertySet", "CodeUnitInsertionException", "AcyclicCallGraphBuilder", "CompositeDataTypeElementInfo", "DataTypeInfo", "DefaultIntPropertyMap", "DefaultPropertyMap", "DeletedException", "MemoryByteIterator", "SettingsPropertyMap"]
