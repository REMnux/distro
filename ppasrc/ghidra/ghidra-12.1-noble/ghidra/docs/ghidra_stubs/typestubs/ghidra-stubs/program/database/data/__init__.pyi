...
class DataTypeManagerDB(ghidra.program.model.data.DataTypeManager):
    ...
    * It is important that the use of :meth:`DataType.clone(DataTypeManager) <DataType.clone>`
    ...
    def dataTypeChanged(self, dt: ghidra.program.model.data.DataType, isAutoChange: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class SettingsCache(java.lang.Object, typing.Generic[K]):
    ...
    def remove(self, id: K, name: typing.Union[java.lang.String, str]) -> None:
        """
...
class SourceArchiveDB(ghidra.program.database.DatabaseObject, ghidra.program.model.data.SourceArchive):
    ...
    def __init__(self, dtMgr: DataTypeManagerDB, cache: ghidra.program.database.DBObjectCache[SourceArchiveDB], adapter: SourceArchiveAdapter, record: db.DBRecord) -> None:
        ...
...
class CompositeDB(DataTypeDB, ghidra.program.model.data.CompositeInternal):
    """
    :obj:`CompositeDB` provides an abstract database implementation for a structure or union.
    """
...
class ArrayDB(DataTypeDB, ghidra.program.model.data.Array):
    ...
    def __init__(self, dataMgr: DataTypeManagerDB, cache: ghidra.program.database.DBObjectCache[DataTypeDB], adapter: ArrayDBAdapter, record: db.DBRecord) -> None:
        """
        Constructor
...
class ArrayDBAdapterV0(ArrayDBAdapter):
    ...
    def __init__(self, handle: db.DBHandle) -> None:
        """
...
class ArrayDBAdapterV1(ArrayDBAdapter):
    ...
    def __init__(self, handle: db.DBHandle, tablePrefix: typing.Union[java.lang.String, str], create: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DataTypeArchiveTransformer(ghidra.GhidraLaunchable):
    ...
    @staticmethod
    def transform(oldFile: jpype.protocol.SupportsPath, newFile: jpype.protocol.SupportsPath, destinationFile: jpype.protocol.SupportsPath, useOldFileID: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class DataTypeUtilities(java.lang.Object):
    ...
    @staticmethod
    def checkAncestry(dataType: ghidra.program.model.data.DataType, componentDataType: ghidra.program.model.data.DataType) -> None:
        """
        ...
        :param ghidra.program.model.data.DataType componentDataType: component data type
        :raises DataTypeDependencyException: if ancestry check fails
        """

    @staticmethod
    def checkValidReplacement(replacedDt: ghidra.program.model.data.DataType, replacementDt: ghidra.program.model.data.DataType) -> None:
        """
        Check if the specified replacement data type pair is invalid.
        
        :param ghidra.program.model.data.DataType replacedDt: existing data type being replaced
        :param ghidra.program.model.data.DataType replacementDt: replacement data type
        :raises java.lang.IllegalArgumentException: if an invalid replaced/replacement data type pair is specified.
        """
    ...
    @staticmethod
    def getMerger(dt1: ghidra.program.model.data.DataType, dt2: ghidra.program.model.data.DataType) -> ghidra.program.database.data.merge.DataTypeMerger[typing.Any]:
        """
        ...
        :param ghidra.program.model.data.DataType dt1: the first datatype to be merged
        :param ghidra.program.model.data.DataType dt2: the second datatype to be merged
        :return: A merger to be used to merge the two data types.
        :rtype: ghidra.program.database.data.merge.DataTypeMerger[typing.Any]
        :raises DataTypeMergeException: if the two datatypes are not the same type or their type
    ...
    @staticmethod
    def supportsMerge(dataType: ghidra.program.model.data.DataType) -> bool:
        """
        Returns true if there is a :obj:`DataTypeMerger` that can handle the given datatype. Currently, only structures
        unions, and enums are supported.
        
        :param ghidra.program.model.data.DataType dataType: the dataType to check
...
class FunctionDefinitionDBAdapterV1(FunctionDefinitionDBAdapter, db.RecordTranslator):
    ...
    def __init__(self, handle: db.DBHandle, tablePrefix: typing.Union[java.lang.String, str], callConvAdapter: CallingConventionDBAdapter) -> None:
        """
...
class ParentChildDBAdapterV0(ParentChildAdapter):
    ...
    def setNeedsInitializing(self) -> None:
        ...
...
class PointerDB(DataTypeDB, ghidra.program.model.data.Pointer):
    ...
    def __init__(self, dataMgr: DataTypeManagerDB, cache: ghidra.program.database.DBObjectCache[DataTypeDB], adapter: PointerDBAdapter, record: db.DBRecord) -> None:
        """
        Constructor
...
class SourceArchiveUpgradeMap(java.lang.Object):
    ...
    class SourceArchiveImpl(ghidra.program.model.data.SourceArchive):
        ...
        @typing.overload
        def __init__(self, id: ghidra.util.UniversalID, archiveName: typing.Union[java.lang.String, str]) -> None:
            ...
...
class StructureDB(CompositeDB, ghidra.program.model.data.StructureInternal):
    ...
    def __init__(self, dataMgr: DataTypeManagerDB, cache: ghidra.program.database.DBObjectCache[DataTypeDB], compositeAdapter: CompositeDBAdapter, componentAdapter: ComponentDBAdapter, record: db.DBRecord) -> None:
        ...
...
class TypedefDB(DataTypeDB, ghidra.program.model.data.TypeDef):
    ...
    def __init__(self, dataMgr: DataTypeManagerDB, cache: ghidra.program.database.DBObjectCache[DataTypeDB], adapter: TypedefDBAdapter, record: db.DBRecord) -> None:
        """
...
__all__ = ["ProgramDataTypeManager", "ProgramBasedDataTypeManagerDB", "DataTypeManagerDB", "SettingsDBAdapter", "SettingsCache", "SettingDB", "BuiltinDBAdapter", "ComponentDBAdapter", "CompositeDBAdapter", "ArrayDBAdapter", "PointerDBAdapter", "TypedefDBAdapter", "CategoryDBAdapter", "FunctionDefinitionDBAdapter", "FunctionParameterAdapter", "EnumDBAdapter", "EnumValueDBAdapter", "ParentChildAdapter", "SourceArchiveAdapter", "CallingConventionDBAdapter", "CategoryDB", "DataTypeDB", "SourceArchiveDB", "CompositeDB", "DataTypeComponentDB", "EnumSignedState", "LazyLoadingCachingMap", "ArrayDB", "ArrayDBAdapterV0", "ArrayDBAdapterV1", "BitFieldDBDataType", "BuiltinDBAdapterV0", "CallingConventionDBAdapterNoTable", "CallingConventionDBAdapterV0", "CategoryDBAdapterV0", "ComponentDBAdapterV0", "CompositeDBAdapterV0", "CompositeDBAdapterV1", "CompositeDBAdapterV2V4", "CompositeDBAdapterV5V6", "DataTypeArchiveTransformer", "DataTypeArchiveTransformerPanel", "DataTypeIDConverter", "CategoryCache", "DataTypeProxyComponentDB", "DataTypeSettingsDB", "DataTypeUtilities", "EnumDB", "EnumDBAdapterNoTable", "EnumDBAdapterV0", "EnumDBAdapterV1", "EnumValueDBAdapterNoTable", "EnumValueDBAdapterV0", "EnumValueDBAdapterV1", "FunctionDefinitionDB", "ParameterDefinitionDB", "FunctionDefinitionDBAdapterNoTable", "FunctionDefinitionDBAdapterV0", "FunctionDefinitionDBAdapterV1", "FunctionDefinitionDBAdapterV2", "FunctionParameterAdapterNoTable", "FunctionParameterAdapterV0", "FunctionParameterAdapterV1", "ParentChildDBAdapterNoTable", "ParentChildDBAdapterV0", "PointerDB", "PointerDBAdapterV0", "PointerDBAdapterV1", "PointerDBAdapterV2", "PointerTypedefInspector", "SettingsDBAdapterV0", "SettingsDBAdapterV1", "SourceArchiveAdapterNoTable", "SourceArchiveAdapterV0", "SourceArchiveUpgradeMap", "StructureDB", "TypedefDB", "TypedefDBAdapterV0", "TypedefDBAdapterV1", "TypedefDBAdapterV2", "UnionDB"]
