...
class JitPassageDecoder(java.lang.Object):
    ...
    ******************
    ...
    def __init__(self, thread: ghidra.pcode.emu.jit.JitPcodeThread) -> None:
        """
...
class DecoderUseropLibrary(ghidra.pcode.exec_.AnnotatedPcodeUseropLibrary[java.lang.Object]):
    ...
    class WrappedUseropDefinition(ghidra.pcode.exec_.PcodeUseropLibrary.PcodeUseropDefinition[java.lang.Object]):
        ...
        def __init__(self, rtOp: ghidra.pcode.exec_.PcodeUseropLibrary.PcodeUseropDefinition[jpype.JArray[jpype.JByte]]) -> None:
            """
    ...
    def __init__(self, rtLib: ghidra.pcode.exec_.PcodeUseropLibrary[jpype.JArray[jpype.JByte]]) -> None:
        """
    ...
    def emu_exec_decoded(self, executor: ghidra.pcode.exec_.PcodeExecutor[java.lang.Object]) -> None:
        """
    ...
    def emu_skip_decoded(self, executor: ghidra.pcode.exec_.PcodeExecutor[java.lang.Object]) -> None:
        """
...
class DecoderExecutor(ghidra.pcode.exec_.PcodeExecutor[java.lang.Object], ghidra.program.model.lang.DisassemblerContextAdapter):
    ...
    def execute(self, program: ghidra.pcode.exec_.PcodeProgram) -> None:
        """
...
class DecoderForOneStride(java.lang.Object):
    ...
    def __init__(self, decoder: JitPassageDecoder, passage: DecoderForOnePassage, start: ghidra.pcode.emu.jit.JitPassage.AddrCtx) -> None:
        """
...
__all__ = ["JitPassageDecoder", "DecoderUseropLibrary", "DecodedStride", "DecoderExecutor", "DecoderForOneStride", "DecoderForOnePassage"]
