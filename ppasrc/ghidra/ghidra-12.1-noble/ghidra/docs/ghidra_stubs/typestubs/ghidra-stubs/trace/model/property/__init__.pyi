...
class TracePropertyMapOperations(java.lang.Object, typing.Generic[T]):
    ...
    @typing.overload
    def set(self, lifespan: ghidra.trace.model.Lifespan, address: ghidra.program.model.address.Address, value: T) -> None:
        """
    ...
    @typing.overload
    def set(self, lifespan: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange, value: T) -> None:
        """
...
class TracePropertyMapSpace(TracePropertyMapOperations[T], typing.Generic[T]):
    ...
    def clear(self, span: ghidra.trace.model.Lifespan, register: ghidra.program.model.lang.Register) -> None:
        """
    ...
    @typing.overload
    def set(self, platform: ghidra.trace.model.guest.TracePlatform, lifespan: ghidra.trace.model.Lifespan, register: ghidra.program.model.lang.Register, value: T) -> None:
        """
    ...
    @typing.overload
    def set(self, lifespan: ghidra.trace.model.Lifespan, register: ghidra.program.model.lang.Register, value: T) -> None:
        """
        Set a property on the given register for the given lifespan
...
__all__ = ["TraceAddressPropertyManager", "TracePropertyMap", "TracePropertyMapOperations", "TracePropertyMapSpace"]
