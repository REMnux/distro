...
class FSRL(java.lang.Object):
    ...
    * file://dir/subdir/example.zip?MD5=1234567|zip://readme.txt?MD5=987654 --
    ...
    @staticmethod
    def writeToProgramInfo(program: ghidra.program.model.listing.Program, fsrl: FSRL) -> None:
        """
...
class FileCache(java.lang.Object):
    ...
    class RefPinningByteArrayProvider(ghidra.app.util.bin.ByteArrayProvider):
        ...
        def __init__(self, fce: FileCache.FileCacheEntry, fsrl: FSRL) -> None:
            ...
    ...
    def __init__(self, cacheDir: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def performCacheMaintOnOldDirIfNeeded(oldCacheDir: jpype.protocol.SupportsPath) -> None:
        """
...
class FileSystemService(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, fscacheDir: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def getRefdFile(self, fsrl: FSRL, monitor: ghidra.util.task.TaskMonitor) -> RefdFile:
        ...
        :obj:`FileSystemRef` that needs to be closed, never ``null``
        :rtype: RefdFile
        :raises CancelledException: if the user cancels
        :raises IOException: if file not found or there was a file io problem
        """
    ...
    def releaseFileCache(self, fsrl: FSRL) -> None:
        """
    ...
    def releaseFileSystemImmediate(self, fsRef: FileSystemRef) -> None:
        """
...
class LocalFileSystem(GFileSystem, GFileHashProvider):
    ...
    def getGFile(self, f: jpype.protocol.SupportsPath) -> GFile:
        ...
...
class GFileSystem(java.io.Closeable, java.lang.Iterable[GFile], ghidra.util.classfinder.ExtensionPoint):
    ...
    def getFileType(self, f: GFile, monitor: ghidra.util.task.TaskMonitor) -> ghidra.formats.gfilesystem.fileinfo.FileType:
        """
        Returns the :obj:`FileType` of the specified file.
        
        :param GFile f: :obj:`GFile` to query
        :param ghidra.util.task.TaskMonitor monitor: :obj:`TaskMonitor`
        :return: :obj:`FileType` of the specified file
        :rtype: ghidra.formats.gfilesystem.fileinfo.FileType
        """
    ...
    def resolveSymlinks(self, file: GFile) -> GFile:
        ...
        :return: destination of symlink, or original file if not a symlink, or ``null`` if symlink
        destination was invalid
        :rtype: GFile
        :raises IOException: if error following symlink path, typically because of recursive paths
        """
...
class FileSystemInstanceManager(FileSystemEventListener):
    ...
    def __init__(self, rootFS: GFileSystem) -> None:
        """
    ...
    def add(self, fs: GFileSystem) -> None:
        """
    ...
    def releaseImmediate(self, ref: FileSystemRef) -> None:
        """
...
class FileSystemEventListener(java.lang.Object):
    ...
    def onFilesystemClose(self, fs: GFileSystem) -> None:
        """
    ...
    def onFilesystemRefChange(self, fs: GFileSystem, refManager: FileSystemRefManager) -> None:
        """
...
class FileCacheNameIndex(java.lang.Object):
    ...
    def add(self, parentMD5: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], fileMD5: typing.Union[java.lang.String, str]) -> None:
        """
...
class RefdFile(java.io.Closeable):
    ...
    def __init__(self, fsRef: FileSystemRef, file: GFile) -> None:
        """
...
class FileSystemRefManager(java.lang.Object):
    ...
    def __init__(self, fs: GFileSystem) -> None:
        """
    ...
    def addListener(self, listener: FileSystemEventListener) -> None:
        """
    ...
    def release(self, ref: FileSystemRef) -> None:
        """
    ...
    def removeListener(self, listener: FileSystemEventListener) -> None:
        """
...
class AbstractFileExtractorTask(ghidra.util.task.Task):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], canCancel: typing.Union[jpype.JBoolean, bool], hasProgress: typing.Union[jpype.JBoolean, bool], isModal: typing.Union[jpype.JBoolean, bool], rootOutputDir: jpype.protocol.SupportsPath) -> None:
        """
...
class FileSystemIndexHelper(java.lang.Object, typing.Generic[METADATATYPE]):
    ...
    def __init__(self, fs: GFileSystem, fsFSRL: FSRLRoot) -> None:
        """
    ...
    def getSymlinkPath(self, file: GFile) -> str:
        ...
    ...
    def setMetadata(self, f: GFile, metaData: METADATATYPE) -> None:
        """
    ...
    def updateFSRL(self, file: GFile, newFSRL: FSRL) -> None:
        """
    ...
    @property
    def symlinkPath(self) -> java.lang.String:
        ...
...
class GFileImpl(GFile):
    ...
    def setLength(self, length: typing.Union[jpype.JLong, int]) -> None:
        ...


class AbstractSinglePayloadFileSystem(GFileSystem):
    """
    ...
    @typing.overload
    def __init__(self, fsFSRL: FSRLRoot, payloadProvider: ghidra.app.util.bin.ByteProvider, payloadFilename: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, fsFSRL: FSRLRoot, payloadProvider: ghidra.app.util.bin.ByteProvider, payloadFilename: typing.Union[java.lang.String, str], payloadAttrs: ghidra.formats.gfilesystem.fileinfo.FileAttributes) -> None:
        ...
...
class SingleFileSystemIndexHelper(java.lang.Object):
    ...
    def __init__(self, fs: GFileSystem, fsFSRL: FSRLRoot, payloadFilename: typing.Union[java.lang.String, str], length: typing.Union[jpype.JLong, int], payloadMD5: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def getFileAttributes(self, file: GFile) -> ghidra.formats.gfilesystem.fileinfo.FileAttributes:
        ...
    ...
    def setPayloadFileAttributes(self, attrs: ghidra.formats.gfilesystem.fileinfo.FileAttributes) -> None:
        ...
...
class FSUtilities(java.lang.Object):
    ...
    @staticmethod
    def displayException(originator: java.lang.Object, parent: java.awt.Component, title: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str], throwable: java.lang.Throwable) -> None:
        """
    ...
    @staticmethod
    def mirroredProjectPath(path: typing.Union[java.lang.String, str]) -> str:
        """
        ...
        :param java.lang.String or str path: The path to convert
    ...
    @staticmethod
    def splitPath(path: typing.Union[java.lang.String, str]) -> jpype.JArray[java.lang.String]:
        """
        ...
        :param java.lang.String or str path: The path to split
    ...
    @staticmethod
    def uncheckedClose(c: java.lang.AutoCloseable, msg: typing.Union[java.lang.String, str]) -> None:
        """
...
class GFileSystemBase(GFileSystem):
    ...
    def setFSRL(self, fsrl: FSRLRoot) -> None:
        ...

    def setFilesystemService(self, fsService: FileSystemService) -> None:
        ...
...
class GFileSystemIterator(java.util.Iterator[GFile]):
    ...
    @typing.overload
    def __init__(self, dir: GFile) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dir: GFile, fileFilter: java.util.function.Predicate[GFile]) -> None:
        """
        Creates a new :obj:`GFileSystemIterator` at the given :obj:`directory <GFile>`
...
class RefdByteProvider(ghidra.app.util.bin.ByteProvider):
    ...
    def __init__(self, fsRef: FileSystemRef, provider: ghidra.app.util.bin.ByteProvider, fsrl: FSRL) -> None:
        """
...
class RefdInputStream(java.io.InputStream):
    ...
    def __init__(self, fsRef: FileSystemRef, delegate: java.io.InputStream) -> None:
        """
...
__all__ = ["FSRL", "FSRLRoot", "FileCache", "FileSystemService", "LocalFileSystem", "GFileSystem", "GFileHashProvider", "GFile", "FileSystemInstanceManager", "FileSystemEventListener", "FileCacheNameIndex", "FileSystemRef", "RefdFile", "FileSystemProbeConflictResolver", "FileSystemRefManager", "AbstractFileExtractorTask", "AbstractFileSystem", "FileSystemIndexHelper", "GFileImpl", "AbstractSinglePayloadFileSystem", "SingleFileSystemIndexHelper", "FSUtilities", "GFileSystemBase", "GFileSystemIterator", "GFileSystemProgramProvider", "GIconProvider", "RefdByteProvider", "RefdInputStream"]
