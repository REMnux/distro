...
import ghidra.app.util.bin.format.pe.dvrt
...
class PortableExecutable(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, bp: ghidra.app.util.bin.ByteProvider, layout: PortableExecutable.SectionLayout) -> None:
        """
    ...
    @typing.overload
    def __init__(self, bp: ghidra.app.util.bin.ByteProvider, layout: PortableExecutable.SectionLayout, advancedProcess: typing.Union[jpype.JBoolean, bool], parseCliHeaders: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new Portable Executable using the specified byte provider and layout.
...
class FileHeader(ghidra.app.util.bin.StructConverter):
    ...
    def addSection(self, block: ghidra.program.model.mem.MemoryBlock, optionalHeader: OptionalHeader) -> None:
        """
...
class NTHeader(ghidra.app.util.bin.StructConverter, OffsetValidator):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, index: typing.Union[jpype.JInt, int], layout: PortableExecutable.SectionLayout, parseCliHeaders: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class OptionalHeader(ghidra.app.util.bin.StructConverter):
    ...
    def processDataDirectories(self, log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def setSizeOfCode(self, size: typing.Union[jpype.JLong, int]) -> None:
        """
        Sets the combined total size of all sections with the IMAGE_SCN_CNT_CODE attribute.
        
        :param jpype.JLong or int size: The size to set
        """

    def setSizeOfHeaders(self, size: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setSizeOfImage(self, size: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setSizeOfInitializedData(self, size: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setSizeOfUninitializedData(self, size: typing.Union[jpype.JLong, int]) -> None:
        """
...
class PeMarkupable(java.lang.Object):
    ...
    def markup(self, program: ghidra.program.model.listing.Program, isBinary: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor, log: ghidra.app.util.importer.MessageLog, ntHeader: NTHeader) -> None:
        """
...
class DataDirectory(PeMarkupable):
    ...
    def setVirtualAddress(self, addr: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def writeBytes(self, raf: java.io.RandomAccessFile, dc: ghidra.util.DataConverter, template: PortableExecutable) -> None:
        """
...
class SectionHeader(ghidra.app.util.bin.StructConverter, ghidra.app.util.bin.ByteArrayConverter):
    ...
    def getDataByteProvider(self) -> ghidra.app.util.bin.ByteProvider:
        """
    ...
    def setSizeOfRawData(self, size: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setVirtualSize(self, size: typing.Union[jpype.JInt, int]) -> None:
        ...

    def writeBytes(self, raf: java.io.RandomAccessFile, rafIndex: typing.Union[jpype.JInt, int], dc: ghidra.util.DataConverter, block: ghidra.program.model.mem.MemoryBlock, useBlockBytes: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @property
    def dataByteProvider(self) -> ghidra.app.util.bin.ByteProvider:
        ...
...
class BaseRelocation(ghidra.app.util.bin.StructConverter, ghidra.app.util.bin.ByteArrayConverter):
    ...
    class TypeOffset(ghidra.app.util.bin.StructConverter):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    def addRelocation(self, type: typing.Union[jpype.JInt, int], offset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def getName(self, type: typing.Union[jpype.JInt, int]) -> str:
        ...
    ...
    def getTypeOffset(self, index: typing.Union[jpype.JInt, int]) -> BaseRelocation.TypeOffset:
        """
        Returns the :obj:`TypeOffset`
        
        :param jpype.JInt or int index: the ith relocation
        :return: the :obj:`TypeOffset` of the relocation
        :rtype: BaseRelocation.TypeOffset
        """
    ...
    def markup(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, isBinary: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor, log: ghidra.app.util.importer.MessageLog, ntHeader: NTHeader) -> None:
        ...
    ...
    @property
    def typeOffset(self) -> BaseRelocation.TypeOffset:
        ...
...
class BaseRelocationDataDirectory(DataDirectory, ghidra.app.util.bin.ByteArrayConverter):
    ...
    def addBaseRelocation(self, reloc: BaseRelocation) -> None:
        """
...
class BoundImportDataDirectory(DataDirectory):
    ...
    def addDescriptor(self, bid: BoundImportDescriptor) -> None:
        ...
...
class BoundImportDescriptor(ghidra.app.util.bin.StructConverter, ghidra.app.util.bin.ByteArrayConverter):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], timeDateStamp: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class LoadConfigDirectory(ghidra.app.util.bin.StructConverter):
    ...
    class GuardFlags(ghidra.app.util.bin.StructConverter):
        ...
        def __init__(self, flags: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def getDynamicRelocationTable(self) -> ghidra.app.util.bin.format.pe.dvrt.ImageDynamicRelocationTable:
        """
        :return: the Dynamic Value Relocation Table (could be ``null`` if DVRT is not being 
        used)
        :rtype: ghidra.app.util.bin.format.pe.dvrt.ImageDynamicRelocationTable
        """
    ...
    @property
    def dynamicRelocationTable(self) -> ghidra.app.util.bin.format.pe.dvrt.ImageDynamicRelocationTable:
        ...
...
class ControlFlowGuard(java.lang.Object):
    ...
    @staticmethod
    def markup(lcd: LoadConfigDirectory, program: ghidra.program.model.listing.Program, log: ghidra.app.util.importer.MessageLog, ntHeader: NTHeader) -> None:
        """
...
class ThunkData(ghidra.app.util.bin.StructConverter, ghidra.app.util.bin.ByteArrayConverter):
    ...
    **``winnt.h``**.
    ...
    def setValue(self, value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ImportByName(ghidra.app.util.bin.StructConverter, ghidra.app.util.bin.ByteArrayConverter):
    ...
    def __init__(self, hint: typing.Union[jpype.JShort, int], name: typing.Union[java.lang.String, str]) -> None:
        """
...
class ImageRuntimeFunctionEntries(java.lang.Object):
    ...
    def markup(self, program: ghidra.program.model.listing.Program, start: ghidra.program.model.address.Address, log: ghidra.app.util.importer.MessageLog) -> None:
        """
...
class ImageRuntimeFunctionEntries_ARM(ImageRuntimeFunctionEntries):
    ...
    @typing.type_check_only
    class ImageRuntimeFunctionEntry_ARM(java.lang.Record, ghidra.app.util.bin.StructConverter):
        """
        ...
        def markup(self, program: ghidra.program.model.listing.Program, log: ghidra.app.util.importer.MessageLog) -> None:
            """
            Marks up this entry
...
class ImageRuntimeFunctionEntries_X86(ImageRuntimeFunctionEntries):
    ...
    @typing.type_check_only
    class ImageRuntimeFunctionEntry_X86(java.lang.Record, ghidra.app.util.bin.StructConverter):
        """
...
class PEx64UnwindInfo(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, offset: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class ImportDescriptor(ghidra.app.util.bin.StructConverter, ghidra.app.util.bin.ByteArrayConverter):
    ...
    def setFirstThunk(self, i: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setForwarderChain(self, i: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setName(self, i: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setOriginalFirstThunk(self, i: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setTimeDateStamp(self, i: typing.Union[jpype.JInt, int]) -> None:
        """
...
class PeUtils(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def createData(program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, datatype: ghidra.program.model.data.DataType, datatypeLength: typing.Union[jpype.JInt, int], log: ghidra.app.util.importer.MessageLog) -> None:
        ...
...
class SeparateDebugHeader(OffsetValidator):
    ...
    def __init__(self, bp: ghidra.app.util.bin.ByteProvider) -> None:
        """
...
__all__ = ["PortableExecutable", "FileHeader", "NTHeader", "OffsetValidator", "ImageCor20Header", "OptionalHeader", "PeMarkupable", "InvalidNTHeaderException", "DataDirectory", "DefaultDataDirectory", "SectionHeader", "RichHeader", "RichTable", "ImportInfo", "ArchitectureDataDirectory", "BaseRelocation", "BaseRelocationDataDirectory", "BoundImportDataDirectory", "BoundImportDescriptor", "BoundImportForwarderRef", "COMDescriptorDataDirectory", "Constants", "LoadConfigDirectory", "ControlFlowGuard", "DebugDataDirectory", "DelayImportDataDirectory", "DelayImportDescriptor", "ThunkData", "ImportByName", "DllCharacteristics", "ExceptionDataDirectory", "ImageRuntimeFunctionEntries", "ExportDataDirectory", "ExportInfo", "GlobalPointerDataDirectory", "ImageRuntimeFunctionEntries_ARM", "ImageRuntimeFunctionEntries_X86", "PEx64UnwindInfo", "ImportAddressTableDataDirectory", "ImportDataDirectory", "ImportDescriptor", "LoadConfigDataDirectory", "MachineConstants", "MachineName", "OptionalHeaderROM", "PEx64UnwindInfoDataType", "PeSubsystem", "PeUtils", "ROMHeader", "ResourceDataDirectory", "SectionFlags", "SecurityCertificate", "SecurityDataDirectory", "SeparateDebugHeader", "TLSDataDirectory", "TLSDirectory"]
