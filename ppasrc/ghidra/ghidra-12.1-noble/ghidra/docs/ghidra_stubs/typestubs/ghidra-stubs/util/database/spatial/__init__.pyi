...
class AbstractConstraintsTree(java.lang.Object, typing.Generic[DS, DR, NS, NR, T, Q]):
    ...
    def __init__(self, storeFactory: ghidra.util.database.DBCachedObjectStoreFactory, tableName: typing.Union[java.lang.String, str], dataType: java.lang.Class[DR], nodeType: java.lang.Class[NR], upgradable: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DBTreeRecord(ghidra.util.database.DBAnnotatedObject, typing.Generic[RS, NS]):
    ...
    def setParentKey(self, parentKey: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setShape(self, shape: RS) -> None:
        ...
...
class AbstractConstraintsTreeSpatialMap(SpatialMap[DS, T, Q], typing.Generic[DS, DR, NS, T, Q]):
    ...
    class ToArrayConsumer(java.util.function.Consumer[T], typing.Generic[A, T, U]):
        ...
        def __init__(self, arr: jpype.JArray[A]) -> None:
            ...
    ...
    class ToListConsumer(java.util.function.Consumer[T], typing.Generic[A, T, U]):
        ...
        def __init__(self, list: java.util.List[A]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, tree: AbstractConstraintsTree[DS, DR, NS, typing.Any, T, Q], query: Q) -> None:
        ...
...
class AbstractRStarConstraintsTree(AbstractConstraintsTree[DS, DR, NS, NR, T, Q], typing.Generic[DS, DR, NS, NR, T, Q]):
    ...
    class LeastAreaEnlargementThenLeastArea(java.lang.Comparable[AbstractRStarConstraintsTree.LeastAreaEnlargementThenLeastArea]):
        ...
        def __init__(self, node: NR, bounds: NS) -> None:
            ...
    ...
    class LeastDistanceFromCenterToPoint(java.lang.Comparable[AbstractRStarConstraintsTree.LeastDistanceFromCenterToPoint]):
        ...
        def __init__(self, record: DBTreeRecord[typing.Any, NS], parentBounds: NS) -> None:
            ...
    ...
    class LevelInfo(java.lang.Object):
        ...
        def __init__(self, dstLevel: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def __init__(self, storeFactory: ghidra.util.database.DBCachedObjectStoreFactory, tableName: typing.Union[java.lang.String, str], dataType: java.lang.Class[DR], nodeType: java.lang.Class[NR], upgradable: typing.Union[jpype.JBoolean, bool], maxChildren: typing.Union[jpype.JInt, int]) -> None:
        ...



__all__ = ["DBTreeNodeRecord", "Query", "AbstractConstraintsTree", "DBTreeRecord", "BoundedShape", "BoundingShape", "DBTreeDataRecord", "AbstractConstraintsTreeSpatialMap", "SpatialMap", "AbstractRStarConstraintsTree"]
