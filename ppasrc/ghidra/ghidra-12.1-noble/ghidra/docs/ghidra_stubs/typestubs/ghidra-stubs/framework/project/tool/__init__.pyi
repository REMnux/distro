...
class GhidraToolTemplate(ghidra.framework.model.ToolTemplate):
    ...
    @typing.overload
    def __init__(self, root: org.jdom2.Element, path: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor.
        
        :param org.jdom2.Element root: XML element that contains the tool template data
        :param java.lang.String or str path: the path of the template
        """

    @typing.overload
    def __init__(self, iconURL: docking.util.image.ToolIconURL, toolElement: org.jdom2.Element, supportedDataTypes: jpype.JArray[java.lang.Class[typing.Any]]) -> None:
        ...
...
class ToolManagerImpl(ghidra.framework.model.ToolManager, java.beans.PropertyChangeListener):
    ...
    def restoreFromXml(self, root: org.jdom2.Element) -> None:
        ...
        :param org.jdom2.Element root: root element of saved XML state
        """
    ...
    def toolSaved(self, tool: ghidra.framework.plugintool.PluginTool, toolChanged: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ToolConnectionImpl(ghidra.framework.model.ToolConnection, ghidra.framework.model.ToolListener):
    ...
    def restoreFromXml(self, root: org.jdom2.Element) -> None:
        ...
        :param org.jdom2.Element root: XML element to restore ToolConnection from.
        """
...
class WorkspaceImpl(ghidra.framework.model.Workspace):
    ...
    def restoreFromXml(self, root: org.jdom2.Element) -> None:
        ...
        :param org.jdom2.Element root: an XML element to restore from
        """
...
class GhidraTool(ghidra.framework.plugintool.PluginTool):
    ...
    @typing.overload
    def __init__(self, project: ghidra.framework.model.Project, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, project: ghidra.framework.model.Project, template: GhidraToolTemplate) -> None:
        """
...
class SelectChangedToolDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, toolList: java.util.List[ghidra.framework.plugintool.PluginTool]) -> None:
        ...



__all__ = ["GhidraToolTemplate", "ToolManagerImpl", "ToolServicesImpl", "ToolConnectionImpl", "WorkspaceImpl", "ConnectionDescriptor", "ExtensionManager", "GhidraPluginsConfiguration", "GhidraTool", "OpenFileDropHandlerFactory", "SelectChangedToolDialog"]
