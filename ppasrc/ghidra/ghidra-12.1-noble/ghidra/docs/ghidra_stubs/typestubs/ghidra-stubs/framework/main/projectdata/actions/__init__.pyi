...
class ProjectDataPasteLinkAction(ghidra.framework.main.datatable.ProjectTreeAction):
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], group: typing.Union[java.lang.String, str], relative: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ProjectDataExpandAction(docking.action.ContextSpecificAction[T], typing.Generic[T]):
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], group: typing.Union[java.lang.String, str], contextClass: java.lang.Class[T]) -> None:
        ...
...
class VersionControlAction(ghidra.framework.main.datatable.DomainFileProviderContextAction):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], tool: ghidra.framework.plugintool.PluginTool) -> None:
        ...
...
class VersionControlCheckInAction(VersionControlAction):
    ...
    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, parent: java.awt.Component) -> None:
        """
    ...
    def checkIn(self, fileList: java.util.List[ghidra.framework.model.DomainFile]) -> None:
        """
...
class FindCheckoutsAction(ghidra.framework.main.datatable.ProjectTreeAction):
    """
    :obj:`FindCheckoutsAction` provide the ability to initiate the show checkout status for
    files selected within the :obj:`ProjectDataTreePanel`.  Since link-files cannot be checked-out
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], plugin: ghidra.framework.plugintool.Plugin) -> None:
        ...
...
class DeleteProjectFilesTask(ghidra.util.task.Task):
    ...
    def __init__(self, folders: java.util.Set[ghidra.framework.model.DomainFolder], files: java.util.Set[ghidra.framework.model.DomainFile], fileCount: typing.Union[jpype.JInt, int], parent: java.awt.Component) -> None:
        """
...
class FileCountStatistics(java.lang.Object):
    ...
    def incrementCheckedOutVersioned(self) -> None:
        ...

    def incrementDeleted(self) -> None:
        ...

    def incrementFileCount(self, size: typing.Union[jpype.JInt, int]) -> None:
        ...

    def incrementFileInUse(self) -> None:
        ...

    def incrementGeneralFailure(self) -> None:
        ...

    def incrementReadOnly(self) -> None:
        ...

    def incrementVersioned(self) -> None:
        ...

    def showReport(self, parent: java.awt.Component) -> None:
        ...
...
class CheckoutsDialog(docking.DialogComponentProvider, ghidra.framework.model.ProjectListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, user: ghidra.framework.remote.User, domainFile: ghidra.framework.model.DomainFile, checkouts: jpype.JArray[ghidra.framework.store.ItemCheckoutStatus]) -> None:
        ...
...
class CountDomainFilesTask(ghidra.util.task.Task):
    ...
    def __init__(self, folders: java.util.Set[ghidra.framework.model.DomainFolder], files: java.util.Set[ghidra.framework.model.DomainFile]) -> None:
        ...
...
class ProjectDataDeleteTask(ghidra.util.task.Task):
    ...
    def __init__(self, files: java.util.List[ghidra.framework.model.DomainFile], folders: java.util.List[ghidra.framework.model.DomainFolder], parentComponent: java.awt.Component) -> None:
        """
...
class ProjectDataOpenToolAction(ghidra.framework.main.datatable.FrontendProjectTreeAction):
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], group: typing.Union[java.lang.String, str], toolName: typing.Union[java.lang.String, str], icon: javax.swing.Icon) -> None:
        ...



__all__ = ["ProjectDataCutAction", "ProjectDataCopyCutBaseAction", "ProjectDataCopyAction", "ProjectDataPasteAction", "ProjectDataPasteLinkAction", "ProjectDataRenameAction", "ProjectDataOpenDefaultToolAction", "ProjectDataExpandAction", "ProjectDataCollapseAction", "ProjectDataSelectAction", "ProjectDataReadOnlyAction", "ProjectDataRefreshAction", "ProjectDataNewFolderAction", "ProjectDataDeleteAction", "VersionControlAddAction", "VersionControlAction", "VersionControlUpdateAction", "VersionControlCheckInAction", "VersionControlCheckOutAction", "VersionControlUndoCheckOutAction", "VersionControlShowHistoryAction", "VersionControlViewCheckOutAction", "VersionControlUndoHijackAction", "FindCheckoutsAction", "DeleteProjectFilesTask", "FileCountStatistics", "CheckoutsActionContext", "CheckoutsDialog", "CountDomainFilesTask", "ProjectDataDeleteTask", "ProjectDataOpenToolAction"]
