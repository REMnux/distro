...
class AddressRangeMapDB(db.DBListener):
    ...
    * The VALUE_COL column of the record stores the value for the range.
    ...
    def __init__(self, dbHandle: db.DBHandle, addressMap: ghidra.program.database.map.AddressMap, lock: ghidra.util.Lock, name: typing.Union[java.lang.String, str], errHandler: db.util.ErrorHandler, valueField: db.Field, indexed: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class SharedRangeMapDB(java.lang.Object):
    ...
    def __init__(self, dbHandle: db.DBHandle, name: typing.Union[java.lang.String, str], errHandler: db.util.ErrorHandler, create: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def add(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int], value: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def remove(self, value: typing.Union[jpype.JLong, int]) -> None:
        """
...
class QueryRecordIterator(db.RecordIterator):
    ...
    @typing.overload
    def __init__(self, iter: db.RecordIterator, query: Query) -> None:
        """
    ...
    @typing.overload
    def __init__(self, iter: db.RecordIterator, query: Query, forward: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
...
class DatabaseTableUtils(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def updateAddressKey(table: db.Table, addrMap: ghidra.program.database.map.AddressMap, fromAddr: ghidra.program.model.address.Address, toAddr: ghidra.program.model.address.Address, length: typing.Union[jpype.JLong, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class FieldMatchQuery(Query):
    ...
    def __init__(self, column: typing.Union[jpype.JInt, int], value: db.Field) -> None:
        """
...
class FieldRangeQuery(Query):
    ...
    def __init__(self, column: typing.Union[jpype.JInt, int], min: db.Field, max: db.Field) -> None:
        """
...
class IndexedAddressIterator(ghidra.program.model.address.AddressIterator):
    ...
    def __init__(self, iter: db.DBFieldIterator, addrMap: ghidra.program.database.map.AddressMap, colIndex: typing.Union[jpype.JInt, int], errHandler: db.util.ErrorHandler) -> None:
        """
        Constructor
...
class NotQuery(Query):
    ...
    def __init__(self, q1: Query) -> None:
        """
...
class StringMatchQuery(Query):
    ...
    def __init__(self, col: typing.Union[jpype.JInt, int], searchString: typing.Union[java.lang.String, str], caseSensitive: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class SynchronizedAddressSetCollection(ghidra.program.model.address.AddressSetCollection):
    ...
    def __init__(self, sync: java.lang.Object, *addressSetViews: ghidra.program.model.address.AddressSetView) -> None:
        ...



__all__ = ["AddressSetPropertyMapDB", "DBRecordAdapter", "AddressRangeMapDB", "SharedRangeMapDB", "DatabaseVersionException", "RecordFilter", "QueryRecordIterator", "Query", "AddressRangeMapIterator", "AndQuery", "DBFieldAdapter", "DBKeyAdapter", "DatabaseTableUtils", "EmptyRecordIterator", "FieldMatchQuery", "FieldRangeQuery", "IndexedAddressIterator", "NotQuery", "OrQuery", "StringMatchQuery", "SynchronizedAddressSetCollection"]
