...
class ConstTpl(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, op2: ConstTpl) -> None:
        ...

    @typing.overload
    def __init__(self, tp: ConstTpl.const_type) -> None:
        ...

    @typing.overload
    def __init__(self, tp: ConstTpl.const_type, val: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def __init__(self, tp: ConstTpl.const_type, ht: typing.Union[jpype.JInt, int], vf: ConstTpl.v_field) -> None:
        ...

    @typing.overload
    def __init__(self, tp: ConstTpl.const_type, ht: typing.Union[jpype.JInt, int], vf: ConstTpl.v_field, plus: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def __init__(self, sid: ghidra.pcodeCPort.space.AddrSpace) -> None:
        ...

    def changeHandleIndex(self, handmap: generic.stl.VectorSTL[java.lang.Integer]) -> None:
        ...
    ...
    def transfer(self, params: generic.stl.VectorSTL[HandleTpl]) -> None:
        ...
...
class ConstructTpl(java.lang.Object):
    ...
    def __init__(self, loc: ghidra.sleigh.grammar.Location) -> None:
        ...
    ...
    def deleteOps(self, indices: generic.stl.VectorSTL[java.lang.Integer]) -> None:
        ...

    def dispose(self) -> None:
        ...

    def encode(self, encoder: ghidra.program.model.pcode.Encoder, sectionid: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def setInput(self, vn: VarnodeTpl, index: typing.Union[jpype.JInt, int], slot: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setNumLabels(self, val: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setOpvec(self, opvec: generic.stl.VectorSTL[OpTpl]) -> None:
        ...

    def setOutput(self, vn: VarnodeTpl, index: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setResult(self, t: HandleTpl) -> None:
        ...
...
class OpTpl(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, oc: ghidra.pcodeCPort.opcodes.OpCode) -> None:
        ...
    ...
    def removeInput(self, index: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setInput(self, vt: VarnodeTpl, slot: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setOpcode(self, o: ghidra.pcodeCPort.opcodes.OpCode) -> None:
        ...
...
class HandleTpl(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, vn: VarnodeTpl) -> None:
        ...

    @typing.overload
    def __init__(self, spc: ConstTpl, sz: ConstTpl, vn: VarnodeTpl, t_space: ghidra.pcodeCPort.space.AddrSpace, t_offset: typing.Union[jpype.JLong, int]) -> None:
        ...
    ...
    def setPtrOffset(self, val: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setPtrSize(self, sz: ConstTpl) -> None:
        ...

    def setSize(self, sz: ConstTpl) -> None:
        ...

    def setTempOffset(self, val: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class VarnodeTpl(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, hand: typing.Union[jpype.JInt, int], zerosize: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, sp: ConstTpl, off: ConstTpl, sz: ConstTpl) -> None:
        ...

    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, vn: VarnodeTpl) -> None:
        ...
    ...
    def setOffset(self, constVal: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setRelative(self, constVal: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setSize(self, sz: ConstTpl) -> None:
        ...

    def setUnnamed(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class PcodeBuilder(java.lang.Object):
    ...
    def __init__(self, lbcnt: typing.Union[jpype.JInt, int]) -> None:
        ...

    def appendBuild(self, bld: OpTpl, secnum: typing.Union[jpype.JInt, int]) -> None:
        ...

    def appendCrossBuild(self, bld: OpTpl, secnum: typing.Union[jpype.JInt, int]) -> None:
        ...

    def build(self, construct: ConstructTpl, secnum: typing.Union[jpype.JInt, int]) -> None:
        ...

    def delaySlot(self, op: OpTpl) -> None:
        ...
    ...
    def setLabel(self, op: OpTpl) -> None:
        ...
...
__all__ = ["ConstTpl", "ConstructTpl", "OpTpl", "HandleTpl", "VarnodeTpl", "PcodeBuilder"]
