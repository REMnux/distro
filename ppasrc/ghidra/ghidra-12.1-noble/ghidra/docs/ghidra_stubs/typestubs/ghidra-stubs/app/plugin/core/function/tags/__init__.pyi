...
class AllFunctionsPanel(javax.swing.JPanel):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, provider: ghidra.framework.plugintool.ComponentProviderAdapter) -> None:
        """
        Constructor
    ...
    @typing.overload
    def refresh(self, selectedTags: java.util.Set[ghidra.program.model.listing.FunctionTag]) -> None:
        """
    ...
    def setSelectedTags(self, tags: java.util.Set[ghidra.program.model.listing.FunctionTag]) -> None:
        """
...
class FunctionTableModel(ghidra.util.table.AddressBasedTableModel[ghidra.program.model.listing.Function]):
    ...
    def setTags(self, tags: java.util.Set[ghidra.program.model.listing.FunctionTag]) -> None:
        """
...
class EditFunctionTagsAction(ghidra.app.context.ListingContextAction):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], plugin: FunctionTagPlugin) -> None:
        """
        Constructor.
...
class FunctionTagProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.framework.model.DomainObjectListener):
    ...
    * Remove tags from the currently selected function
    ...
    def __init__(self, plugin: FunctionTagPlugin, program: ghidra.program.model.listing.Program) -> None:
        """
        Constructor
    ...
    def locationChanged(self, loc: ghidra.program.util.ProgramLocation) -> None:
        """
    ...
    def programActivated(self, activatedProgram: ghidra.program.model.listing.Program) -> None:
        ...

    def programDeactivated(self, deactivatedProgram: ghidra.program.model.listing.Program) -> None:
        ...

    def selectionChanged(self, panel: TagListPanel) -> None:
        """
...
class SourceTagsPanel(TagListPanel):
    ...
    def __init__(self, provider: FunctionTagProvider, tool: ghidra.framework.plugintool.PluginTool) -> None:
        """
        Constructor
...
class TagListPanel(javax.swing.JPanel):
    ...
    def __init__(self, provider: FunctionTagProvider, tool: ghidra.framework.plugintool.PluginTool, name: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
    ...
    def refresh(self, newFunction: ghidra.program.model.listing.Function) -> None:
        """
...
class FunctionTagButtonPanel(javax.swing.JPanel):
    ...
    def __init__(self, sourcePanel: SourceTagsPanel, targetPanel: TargetTagsPanel) -> None:
        """
        Constructor.
    ...
    def sourcePanelSelectionChanged(self, validFunction: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def targetPanelSelectionChanged(self, validFunction: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class FunctionTagTable(ghidra.util.table.GhidraTable):
    ...
    def __init__(self, model: FunctionTagTableModel) -> None:
        """
        Constructor
...
__all__ = ["AllFunctionsPanel", "FunctionTableModel", "EditFunctionTagsAction", "FunctionTagPlugin", "FunctionTagProvider", "SourceTagsPanel", "TagListPanel", "TargetTagsPanel", "FunctionTagButtonPanel", "FunctionTagTableModel", "FunctionTagRowObject", "FunctionTagTable", "FunctionTagLoader", "InMemoryFunctionTag"]
