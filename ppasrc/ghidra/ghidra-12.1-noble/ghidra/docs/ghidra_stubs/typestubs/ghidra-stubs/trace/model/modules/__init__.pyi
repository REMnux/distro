...
class TraceConflictedMappingException(java.lang.RuntimeException):
    ...
    def __init__(self, message: typing.Union[java.lang.String, str], conflicts: collections.abc.Sequence) -> None:
        ...
...
class TraceModule(ghidra.trace.model.TraceUniqueObject, ghidra.trace.model.target.iface.TraceObjectInterface):
    ...
    def setBase(self, snap: typing.Union[jpype.JLong, int], base: ghidra.program.model.address.Address) -> None:
        """
...
__all__ = ["TraceModuleManager", "TraceModuleOperations", "TraceStaticMappingManager", "TraceStaticMapping", "TraceConflictedMappingException", "TraceModule", "TraceSection", "TraceModuleSpace"]
