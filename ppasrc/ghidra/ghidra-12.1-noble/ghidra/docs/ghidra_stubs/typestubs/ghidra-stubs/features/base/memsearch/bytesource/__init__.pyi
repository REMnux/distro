...
class AddressableByteSource(java.lang.Object):
    ...
    @staticmethod
    def generateProgramLocation(pgm: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address) -> ghidra.program.util.ProgramLocation:
        ...
    ...
    def getCanonicalLocation(self, address: ghidra.program.model.address.Address) -> ghidra.program.util.ProgramLocation:
        """
        Convert byte source address to the canonical (static) location
        
        :param ghidra.program.model.address.Address address: address to be converted
    ...
    def rebaseFromCanonical(self, location: ghidra.program.util.ProgramLocation) -> ghidra.program.model.address.Address:
        """
        Rebase a canonical location in the current byte source
        
        :param ghidra.program.util.ProgramLocation location: location to be rebased
    ...
    @property
    def canonicalLocation(self) -> ghidra.program.util.ProgramLocation:
        ...
...
__all__ = ["AddressableByteSource", "SearchRegion", "EmptyByteSource", "ProgramByteSource", "ProgramSearchRegion"]
