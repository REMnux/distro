...
class CompositeFieldQuickFix(ghidra.features.base.quickfix.QuickFix):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, composite: ghidra.program.model.data.Composite, ordinal: typing.Union[jpype.JInt, int], original: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class RenameCategoryQuickFix(ghidra.features.base.replace.RenameQuickFix):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, category: ghidra.program.model.data.Category, newName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class RenameDataTypeQuickFix(ghidra.features.base.replace.RenameQuickFix):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, dataType: ghidra.program.model.data.DataType, newName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class RenameEnumValueQuickFix(ghidra.features.base.replace.RenameQuickFix):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, enumDt: ghidra.program.model.data.Enum, valueName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class RenameMemoryBlockQuickFix(ghidra.features.base.replace.RenameQuickFix):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, block: ghidra.program.model.mem.MemoryBlock, newName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class RenameProgramTreeGroupQuickFix(ghidra.features.base.replace.RenameQuickFix):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, group: ghidra.program.model.listing.Group, newName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class RenameSymbolQuickFix(ghidra.features.base.replace.RenameQuickFix):
    ...
    def __init__(self, symbol: ghidra.program.model.symbol.Symbol, newName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class UpdateCommentQuickFix(ghidra.features.base.quickfix.QuickFix):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, type: ghidra.program.model.listing.CommentType, comment: typing.Union[java.lang.String, str], newComment: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class UpdateDataTypeDescriptionQuickFix(ghidra.features.base.quickfix.QuickFix):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, dataType: ghidra.program.model.data.DataType, newDescription: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class UpdateEnumCommentQuickFix(ghidra.features.base.quickfix.QuickFix):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, enumDt: ghidra.program.model.data.Enum, valueName: typing.Union[java.lang.String, str], newComment: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class UpdateFieldCommentQuickFix(CompositeFieldQuickFix):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, composite: ghidra.program.model.data.Composite, fieldName: typing.Union[java.lang.String, str], ordinal: typing.Union[jpype.JInt, int], original: typing.Union[java.lang.String, str], newComment: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
__all__ = ["CompositeFieldQuickFix", "RenameCategoryQuickFix", "RenameDataTypeQuickFix", "RenameEnumValueQuickFix", "RenameFieldQuickFix", "RenameMemoryBlockQuickFix", "RenameProgramTreeGroupQuickFix", "RenameSymbolQuickFix", "UpdateCommentQuickFix", "UpdateDataTypeDescriptionQuickFix", "UpdateEnumCommentQuickFix", "UpdateFieldCommentQuickFix"]
