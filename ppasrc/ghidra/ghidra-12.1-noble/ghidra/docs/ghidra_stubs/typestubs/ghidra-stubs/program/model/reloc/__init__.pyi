...
class Relocation(java.lang.Object):
    ...
    def __init__(self, addr: ghidra.program.model.address.Address, status: Relocation.Status, type: typing.Union[jpype.JInt, int], values: jpype.JArray[jpype.JLong], bytes: jpype.JArray[jpype.JByte], symbolName: typing.Union[java.lang.String, str]) -> None:
        """
...
class RelocationHandler(ghidra.util.classfinder.ExtensionPoint):
    ...
    def performRelocation(self, program: ghidra.program.model.listing.Program, relocation: Relocation, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class RelocationResult(java.lang.Record):
    ...
    def __init__(self, status: Relocation.Status, byteLength: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["Relocation", "RelocationTable", "RelocationHandler", "RelocationResult", "RelocationUtil"]
