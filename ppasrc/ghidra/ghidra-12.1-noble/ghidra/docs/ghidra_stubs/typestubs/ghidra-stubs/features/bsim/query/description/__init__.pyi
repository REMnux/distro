...
class FunctionDescription(java.lang.Comparable[FunctionDescription]):
    ...
    def __init__(self, ex: ExecutableRecord, name: typing.Union[java.lang.String, str], addr: typing.Union[jpype.JLong, int]) -> None:
        ...
    ...
    def setSignatureRecord(self, srec: SignatureRecord) -> None:
        ...
...
class DescriptionManager(java.lang.Object):
    ...
    def attachSignature(self, fd: FunctionDescription, srec: SignatureRecord) -> None:
        """
    ...
    def cacheExecutableByRow(self, erec: ExecutableRecord, rowKey: RowKey) -> None:
        """
    ...
    def generateFunctionIdMap(self, funcmap: collections.abc.Mapping) -> None:
        """
    ...
    def makeCallgraphLink(self, src: FunctionDescription, dest: FunctionDescription, lhash: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def matchAndSetXrefs(self, manage: DescriptionManager) -> None:
        """
    ...
    def overrideRepository(self, repo: typing.Union[java.lang.String, str], path: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setExeAlreadyStored(self, erec: ExecutableRecord) -> None:
        """
    ...
    def setExeCategories(self, erec: ExecutableRecord, cats: java.util.List[CategoryRecord]) -> None:
        """
    ...
    def setExeRowId(self, erec: ExecutableRecord, id: RowKey) -> None:
        """
    ...
    def setFunctionDescriptionFlags(self, fd: FunctionDescription, fl: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setFunctionDescriptionId(self, fd: FunctionDescription, id: RowKey) -> None:
        """
    ...
    def setSettings(self, set: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def setSignatureId(self, frec: FunctionDescription, id: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def setSignatureId(self, sigrec: SignatureRecord, id: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setVersion(self, maj: typing.Union[jpype.JShort, int], min: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    def transferSettings(self, op2: DescriptionManager) -> None:
        """
...
class ExecutableRecord(java.lang.Comparable[ExecutableRecord]):
    ...
    @typing.overload
    def __init__(self, md5: typing.Union[java.lang.String, str], execName: typing.Union[java.lang.String, str], compilerName: typing.Union[java.lang.String, str], architecture: typing.Union[java.lang.String, str], date: java.util.Date, id: RowKey, repo: typing.Union[java.lang.String, str], path: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, enm: typing.Union[java.lang.String, str], arc: typing.Union[java.lang.String, str], id: RowKey) -> None:
        """
...
class CategoryRecord(java.lang.Comparable[CategoryRecord]):
    ...
    def __init__(self, t: typing.Union[java.lang.String, str], c: typing.Union[java.lang.String, str]) -> None:
        ...
...
class SignatureRecord(java.lang.Object):
    ...
    def __init__(self, v: generic.lsh.vector.LSHVector) -> None:
        ...
    ...
    @staticmethod
    def restoreXml(parser: ghidra.xml.XmlPullParser, vectorFactory: generic.lsh.vector.LSHVectorFactory, man: DescriptionManager, fdesc: FunctionDescription, count: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class CallgraphEntry(java.lang.Comparable[CallgraphEntry]):
    ...
    def __init__(self, d: FunctionDescription, lhash: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    @staticmethod
    def restoreXml(parser: ghidra.xml.XmlPullParser, man: DescriptionManager, src: FunctionDescription) -> None:
        ...

    def saveXml(self, src: FunctionDescription, fwrite: java.io.Writer) -> None:
        ...
...
class VectorResult(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, vid: typing.Union[jpype.JLong, int], cnt: typing.Union[jpype.JInt, int], sm: typing.Union[jpype.JDouble, float], sg: typing.Union[jpype.JDouble, float], v: generic.lsh.vector.LSHVector) -> None:
        ...
...
class FunctionDescriptionMapper(java.lang.Object):
    ...
    def handleExecutable(self, erec: ExecutableRecord) -> None:
        ...

    def handleFunction(self, fdesc: FunctionDescription, rnum: typing.Union[jpype.JInt, int]) -> None:
        ...

    def processFile(self, parser: ghidra.xml.XmlPullParser, vectorFactory: generic.lsh.vector.LSHVectorFactory) -> None:
        ...



__all__ = ["DatabaseInformation", "FunctionDescription", "DescriptionManager", "ExecutableRecord", "RowKey", "CategoryRecord", "SignatureRecord", "CallgraphEntry", "VectorResult", "FunctionDescriptionMapper"]
