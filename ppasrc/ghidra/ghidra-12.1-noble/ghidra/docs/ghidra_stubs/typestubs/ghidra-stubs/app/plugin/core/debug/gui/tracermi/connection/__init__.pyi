...
class TraceRmiConnectDialog(ghidra.app.plugin.core.debug.gui.tracermi.launcher.TraceRmiLaunchDialog):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, title: typing.Union[java.lang.String, str], buttonText: typing.Union[java.lang.String, str]) -> None:
        ...
...
class TraceRmiConnectionManagerProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, plugin: TraceRmiConnectionManagerPlugin) -> None:
        ...
...
class TraceRmiManagerActionContext(docking.DefaultActionContext):
    ...
    def __init__(self, provider: TraceRmiConnectionManagerProvider, path: javax.swing.tree.TreePath, tree: docking.widgets.tree.GTree) -> None:
        ...
...
__all__ = ["TraceRmiConnectDialog", "TraceRmiConnectionManagerPlugin", "TraceRmiConnectionManagerProvider", "TraceRmiManagerActionContext"]
