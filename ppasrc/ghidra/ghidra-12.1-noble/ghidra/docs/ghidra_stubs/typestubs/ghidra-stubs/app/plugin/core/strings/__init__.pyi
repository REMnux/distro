...
class DefinedStringsContext(docking.DefaultActionContext, ghidra.app.context.DataLocationListContext, ghidra.app.context.ProgramLocationSupplierContext):
...
class DefinedStringsProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    """
    ...
    def getModel(self) -> DefinedStringsTableModel:
        ...
    ...
    def showProgramLocation(self, loc: ghidra.program.util.ProgramLocation) -> None:
        ...

    @property
    def model(self) -> DefinedStringsTableModel:
        ...
...
@typing.type_check_only
class DefinedStringsTableModel(ghidra.util.table.AddressBasedTableModel[ghidra.program.util.ProgramLocation]):
    """
    ...
    class COLUMNS(java.lang.Enum[DefinedStringsTableModel.COLUMNS]):
        """
        Columns defined by this table (useful for enum.ordinal())
        """

        class_: typing.ClassVar[java.lang.Class]
        ADDRESS_COL: typing.Final[DefinedStringsTableModel.COLUMNS]
        STRING_VALUE_COL: typing.Final[DefinedStringsTableModel.COLUMNS]
        STRING_REP_COL: typing.Final[DefinedStringsTableModel.COLUMNS]
        DATA_TYPE_COL: typing.Final[DefinedStringsTableModel.COLUMNS]
        IS_ASCII_COL: typing.Final[DefinedStringsTableModel.COLUMNS]
        CHARSET_COL: typing.Final[DefinedStringsTableModel.COLUMNS]
        HAS_ENCODING_ERROR: typing.Final[DefinedStringsTableModel.COLUMNS]
        UNICODE_SCRIPT: typing.Final[DefinedStringsTableModel.COLUMNS]
        TRANSLATED_VALUE: typing.Final[DefinedStringsTableModel.COLUMNS]
        LENGTH_COL: typing.Final[DefinedStringsTableModel.COLUMNS]

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> DefinedStringsTableModel.COLUMNS:
            ...

        @staticmethod
        def values() -> jpype.JArray[DefinedStringsTableModel.COLUMNS]:
            ...
    ...
    @typing.type_check_only
    class StringLengthColumn(ghidra.util.table.field.AbstractProgramLocationTableColumn[ghidra.program.util.ProgramLocation, java.lang.Integer]):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    def addDataInstance(self, localProgram: ghidra.program.model.listing.Program, data: ghidra.program.model.listing.Data) -> None:
        ...

    def findEquivProgramLocation(self, pl: ghidra.program.util.ProgramLocation) -> ghidra.program.util.ProgramLocation:
        ...

    def reload(self, newProgram: ghidra.program.model.listing.Program) -> None:
        ...

    def removeDataInstanceAt(self, addr: ghidra.program.model.address.Address) -> None:
        ...


class DefinedStringsPlugin(ghidra.app.plugin.ProgramPlugin, ghidra.framework.model.DomainObjectListener):
    """
...
class EncodedStringsDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, plugin: EncodedStringsPlugin, program: ghidra.program.model.listing.Program, selectedAddresses: ghidra.program.model.address.AddressSetView) -> None:
        ...
    ...
    def programClosed(self, p: ghidra.program.model.listing.Program) -> None:
        ...

    def setAllowAnyScriptOption(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        For test/screen shot use
    ...
    def setAllowCommonScriptOption(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        For test/screen shot use
    ...
    def setAllowLatinScriptOption(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        For test/screen shot use
    ...
    def setExcludeCodecErrors(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        For test/screen shot use
    ...
    def setExcludeNonStdCtrlChars(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        For test/screen shot use
    ...
    def setRequireValidStringOption(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        For test/screen shot use
    ...
    def setRequiredScript(self, requiredScript: java.lang.Character.UnicodeScript) -> None:
        """
        For test/screen shot use
    ...
    def setSelectedCharset(self, charsetName: typing.Union[java.lang.String, str]) -> None:
        """
        For test/screen shot use
    ...
    def setShowAdvancedOptions(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        For test/screen shot use
    ...
    def setShowScriptOptions(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        For test/screen shot use
...
class EncodedStringsTableModel(ghidra.util.table.AddressBasedTableModel[EncodedStringsRow]):
    ...
    def removeRows(self, rows: java.util.List[EncodedStringsRow]) -> None:
        ...

    def setOptions(self, options: EncodedStringsOptions) -> None:
        ...
...
class StringInfo(java.lang.Record):
    ...
    def __init__(self, stringValue: typing.Union[java.lang.String, str], scripts: java.util.Set[java.lang.Character.UnicodeScript], stringFeatures: java.util.Set[StringInfoFeature]) -> None:
        ...
...
class EncodedStringsThreadedTablePanel(ghidra.util.table.GhidraThreadedTablePanel[T], typing.Generic[T]):
    ...
    def __init__(self, model: docking.widgets.table.threaded.ThreadedTableModel[T, typing.Any], minUpdateDelay: typing.Union[jpype.JInt, int], emptyTableOverlayComponent: java.awt.Component) -> None:
        ...

    def showEmptyTableOverlay(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class TrigramStringValidator(ghidra.app.services.StringValidatorService):
    ...
    def __init__(self, trigramLogs: collections.abc.Mapping, totalNumTrigrams: typing.Union[jpype.JLong, int], modelValueTransformer: java.util.function.Function[java.lang.String, java.lang.String], thresholds: jpype.JArray[jpype.JDouble], sourceFile: generic.jar.ResourceFile) -> None:
        ...
...
class EncodedStringsFilterStats(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, other: EncodedStringsFilterStats) -> None:
        ...
...
class Trigram(java.lang.Record, java.lang.Comparable[Trigram]):
    ...
    def __init__(self, codePoints: jpype.JArray[jpype.JInt]) -> None:
        ...
...
__all__ = ["CharacterScriptUtils", "DefinedStringsContext", "DefinedStringsProvider", "DefinedStringsTableModel", "DefinedStringsPlugin", "DoesNotHaveTranslationValueColumnConstraint", "HasTranslationValueColumnConstraint", "StringDataInstanceColumnConstraint", "EncodedStringsDialog", "EncodedStringsPlugin", "EncodedStringsTableModel", "EncodedStringsRow", "StringInfo", "StringInfoFeature", "EncodedStringsThreadedTablePanel", "EncodedStringsOptions", "TrigramStringValidator", "EncodedStringsFilterStats", "Trigram", "StringTrigramIterator", "HasEncodingErrorColumnConstraint", "IsAsciiColumnConstraint", "IsNotAsciiColumnConstraint", "UndefinedStringIterator", "ViewStringsColumnConstraintProvider"]
