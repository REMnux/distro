...
class SourceArchivePanel(javax.swing.JPanel):
    ...
    def setSourceArchive(self, sourceArchive: ghidra.program.model.data.SourceArchive) -> None:
        ...



__all__ = ["CategoryConflictPanel", "CategoryMergePanel", "DataTypeMergeManager", "SourceArchiveMergePanel", "DataTypeMergePanel", "DataTypePanel", "SourceArchivePanel"]
