...
class CoffFileHeader(ghidra.app.util.bin.StructConverter):
    ...
    def parse(self, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class CoffSectionHeader(ghidra.app.util.bin.StructConverter):
    ...
    def move(self, offset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class CoffMachineType(java.lang.Object):
    ...
    IMAGE_FILE_MACHINE_M68KAUX: typing.Final = 336
    """
...
__all__ = ["CoffException", "CoffFileHeader", "CoffSectionHeader", "CoffRelocation", "CoffLineNumber", "AoutHeader", "CoffSymbol", "CoffSymbolAux", "AoutHeaderFactory", "AoutHeaderMIPS", "AoutHeaderMagic", "BigEndianUnitSizeByteSwapperInputStream", "CoffConstants", "CoffFileHeaderFlag", "CoffFileHeaderTargetID", "CoffMachineType", "CoffSectionHeader1", "CoffSectionHeader2", "CoffSectionHeader3", "CoffSectionHeaderFactory", "CoffSectionHeaderFlags", "CoffSectionHeaderReserved", "CoffSymbolAuxArray", "CoffSymbolAuxBeginningOfBlock", "CoffSymbolAuxDefault", "CoffSymbolAuxEndOfBlock", "CoffSymbolAuxEndOfStruct", "CoffSymbolAuxFactory", "CoffSymbolAuxFilename", "CoffSymbolAuxFunction", "CoffSymbolAuxName", "CoffSymbolAuxSection", "CoffSymbolAuxTagName", "CoffSymbolSectionNumber", "CoffSymbolSpecial", "CoffSymbolStorageClass", "CoffSymbolType"]
