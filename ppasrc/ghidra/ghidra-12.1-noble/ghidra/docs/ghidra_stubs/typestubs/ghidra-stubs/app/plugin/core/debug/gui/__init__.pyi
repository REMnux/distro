...
class AbstractDebuggerParameterDialog(docking.DialogComponentProvider, java.beans.PropertyChangeListener, typing.Generic[P]):
    ...
    class BigIntEditor(java.beans.PropertyEditorSupport):
        ...
        def setValueNoAsText(self, value: java.lang.Object) -> None:
            ...
    ...
    class FileChooserPanel(javax.swing.JPanel):
        ...
        def __init__(self, propertyChange: java.lang.Runnable) -> None:
            ...

        def setValue(self, file: jpype.protocol.SupportsPath) -> None:
            ...
    ...
    class ChoicesPropertyEditor(java.beans.PropertyEditor):
        ...
        def __init__(self, choices: collections.abc.Sequence) -> None:
            ...
    ...
    def setDescription(self, htmlDescription: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DebuggerByteSource(ghidra.features.base.memsearch.bytesource.AddressableByteSource):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, view: ghidra.trace.model.program.TraceProgramView, target: ghidra.debug.api.target.Target, readsMem: ghidra.app.plugin.core.debug.gui.action.DebuggerReadsMemoryTrait) -> None:
        ...
...
class DebuggerResources(java.lang.Object):
    ...
    class AbstractConnectAction(docking.action.DockingAction):
        ...
        @staticmethod
        def styleButton(button: javax.swing.JButton) -> None:
            ...
    ...
    class ToToggleSelectionListener(ghidra.app.services.DebuggerTraceManagerService.BooleanChangeAdapter):
        ...
        def __init__(self, action: docking.action.ToggleDockingAction) -> None:
            ...
    ...
    @staticmethod
    @typing.overload
    def setSelectedRows(sel: java.util.Set[V], rowMapper: java.util.function.Function[V, R], table: docking.widgets.table.GTable, model: docking.widgets.table.RowObjectTableModel[R], filterPanel: docking.widgets.table.GTableFilterPanel[R]) -> None:
        ...

    @staticmethod
    @typing.overload
    def setSelectedRows(sel: java.util.Set[V], getter: java.util.function.Function[R, V], table: docking.widgets.table.GTable, filterPanel: docking.widgets.table.GTableFilterPanel[R]) -> None:
        ...
    ...
    @staticmethod
    def tableRowActivationAction(table: docking.widgets.table.GTable, runnable: java.lang.Runnable) -> None:
        ...
...
class DebuggerLocationLabel(javax.swing.JLabel):
    ...
    def goToCoordinates(self, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> None:
        ...
...
class DebuggerSearchRegionFactory(java.lang.Enum[DebuggerSearchRegionFactory]):
    ...
    READABLE: typing.Final[DebuggerSearchRegionFactory]
    WRITABLE: typing.Final[DebuggerSearchRegionFactory]
    EXECUTABLE: typing.Final[DebuggerSearchRegionFactory]
...
class InvokeActionEntryAction(docking.action.DockingAction):
    ...
    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, entry: ghidra.debug.api.target.Target.ActionEntry) -> None:
        ...
...
__all__ = ["AbstractDebuggerMapProposalDialog", "AbstractDebuggerParameterDialog", "DebuggerBlockChooserDialog", "DebuggerByteSource", "DebuggerResources", "DebuggerLocationLabel", "DebuggerProvider", "DebuggerSearchRegionFactory", "DebuggerSnapActionContext", "InvokeActionEntryAction", "MultiProviderSaveBehavior", "PasteIntoTargetMixin"]
