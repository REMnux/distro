...
class ViewProviderService(ghidra.app.services.ViewService):
    ...
    def setHasFocus(self, hasFocus: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ProgramDnDTree(DragNDropTree):
    ...
    def __init__(self, treeName: typing.Union[java.lang.String, str], model: javax.swing.tree.DefaultTreeModel, plugin: ProgramTreePlugin) -> None:
        """
    ...
    def expandPaths(self, list: java.util.List[javax.swing.tree.TreePath]) -> None:
        """
    ...
    def fireTreeExpanded(self, path: javax.swing.tree.TreePath) -> None:
        """
...
class DragNDropTree(javax.swing.JTree, docking.dnd.Draggable, docking.dnd.Droppable, java.awt.dnd.Autoscroll):
    ...
    def __init__(self, model: javax.swing.tree.DefaultTreeModel) -> None:
        ...
...
class TreeListener(java.lang.Object):
    ...
    def treeViewChanged(self, e: javax.swing.event.ChangeEvent) -> None:
        """
...
class ViewManagerComponentProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.app.services.ViewManagerService, ViewChangeListener):
    ...
    def addViewChangeListener(self, l: ViewChangeListener) -> None:
        ...

    def dispose(self) -> None:
        ...

    def removeViewChangeListener(self, l: ViewChangeListener) -> None:
        ...

    def setCurrentProgram(self, program: ghidra.program.model.listing.Program) -> None:
        ...

    def setCurrentViewProvider(self, vps: ViewProviderService) -> None:
        ...
...
class ViewChangeListener(java.lang.Object):
    ...
    def viewChanged(self, addrSet: ghidra.program.model.address.AddressSetView) -> None:
        """
...
class TreeViewProvider(ViewProviderService):
    ...
    def __init__(self, treeName: typing.Union[java.lang.String, str], plugin: ProgramTreePlugin) -> None:
        ...
...
class ProgramTreeActionContext(ghidra.app.context.ProgramActionContext):
    ...
    def __init__(self, provider: ViewManagerComponentProvider, program: ghidra.program.model.listing.Program, viewPanel: ViewPanel, contextObject: java.lang.Object) -> None:
        ...
...
class TreeDragSrcAdapter(docking.dnd.DragSrcAdapter):
    ...
    def __init__(self, dragComponent: docking.dnd.Draggable) -> None:
        ...
...
class GroupTransferable(java.awt.datatransfer.Transferable):
    ...
    @typing.overload
    def __init__(self, g: ghidra.program.model.listing.Group) -> None:
        """
        Constructor
        """
...
class ProgramTreeModelListener(javax.swing.event.TreeModelListener):
    ...
    def treeNodesChanged(self, e: javax.swing.event.TreeModelEvent) -> None:
        """
        Called when a node changes; update the Group name for the node being changed.
        """

    def treeNodesInserted(self, e: javax.swing.event.TreeModelEvent) -> None:
        """
...
__all__ = ["ViewProviderService", "DnDMoveManager", "ProgramDnDTree", "DragNDropTree", "ReorderManager", "ProgramNode", "ProgramTreeActionManager", "TreeListener", "ProgramTreePlugin", "ViewManagerComponentProvider", "ViewChangeListener", "TreeViewProvider", "ProgramListener", "ProgramTreePanel", "ViewPanel", "PasteManager", "ProgramTreeActionContext", "TreeDragSrcAdapter", "DnDTreeCellRenderer", "ProgramTreeTransferable", "GroupTransferable", "ProgramTreeAction", "ProgramTreeModelListener", "ProgramTreeModularizationPlugin"]
