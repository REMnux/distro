...
class KeyPath(java.lang.Comparable[KeyPath], java.lang.Iterable[java.lang.String]):
    ...
    class PathParser(java.lang.Object):
        ...
        def __init__(self, path: java.lang.CharSequence, sepRE: typing.Union[java.lang.String, str]) -> None:
            ...
...
class PathPattern(PathFilter):
    ...
    def __init__(self, pattern: KeyPath) -> None:
        """
...
__all__ = ["KeyPath", "PathFilter", "PathPattern", "PathMatcher"]
