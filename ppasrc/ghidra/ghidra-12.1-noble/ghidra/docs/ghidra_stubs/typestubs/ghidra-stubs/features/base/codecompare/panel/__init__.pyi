...
class CodeComparisonActionContext(docking.DefaultActionContext, CodeComparisonViewActionContext):
    ...
    def __init__(self, provider: docking.ComponentProvider, comparisonProvider: CodeComparisonView, component: java.awt.Component) -> None:
        """
        Constructor
...
class CodeComparisonView(javax.swing.JPanel, ghidra.util.classfinder.ExtensionPoint):
    ...
    def loadComparisons(self, left: ComparisonData, right: ComparisonData) -> None:
        """
    ...
    def setOrientationChangedCallback(self, callback: utility.function.Callback) -> None:
        ...

    def setSaveState(self, saveState: ghidra.framework.options.SaveState) -> None:
        ...

    def setShowDataTitles(self, showTitles: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setSideBySide(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setSynchronizedScrolling(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setTitlePrefixes(self, leftTitlePrefix: typing.Union[java.lang.String, str], rightTitlePrefix: typing.Union[java.lang.String, str]) -> None:
        """
...
class FunctionComparisonPanel(javax.swing.JPanel, javax.swing.event.ChangeListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, owner: typing.Union[java.lang.String, str], state: FunctionComparisonState) -> None:
        """
        Constructor
    ...
    def getView(self, name: typing.Union[java.lang.String, str]) -> CodeComparisonView:
        ...
    ...
    def setActiveView(self, name: typing.Union[java.lang.String, str]) -> bool:
        """
    ...
    def setScrollingSyncState(self, syncScrolling: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Sets whether or not scrolling is synchronized
    ...
    @property
    def view(self) -> CodeComparisonView:
        ...
    ...
    @property
    def activeViewName(self) -> java.lang.String:
        ...
...
class FunctionComparisonState(java.lang.Object):
    ...
    def addUpdateCallback(self, callback: utility.function.Callback) -> None:
        """
...
class DataComparisonData(ComparisonData):
    ...
    def __init__(self, data: ghidra.program.model.listing.Data, otherLength: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["CodeComparisonActionContext", "CodeComparisonViewActionContext", "ComparisonData", "CodeComparisonView", "FunctionComparisonPanel", "FunctionComparisonState", "CodeComparisonViewState", "AddressSetComparisonData", "DataComparisonData", "EmptyComparisonData", "FunctionComparisonData"]
