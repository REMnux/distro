...
class AddressesReadTracePcodeExecutorStatePiece(ghidra.pcode.exec_.AbstractLongOffsetPcodeExecutorStatePiece[jpype.JArray[jpype.JByte], ghidra.program.model.address.AddressSetView, ghidra.program.model.address.AddressSpace], ghidra.pcode.exec_.PcodeExecutorStatePiece[jpype.JArray[jpype.JByte], ghidra.program.model.address.AddressSetView]):
    ...
    def __init__(self, data: ghidra.pcode.exec_.trace.data.PcodeTraceDataAccess) -> None:
        """
...
class TraceEmulationIntegration(java.lang.Enum[TraceEmulationIntegration]):
    ...
    class Writer(ghidra.pcode.emu.PcodeEmulationCallbacks[java.lang.Object]):
        ...
        def putHandler(self, handler: TraceEmulationIntegration.PieceHandler[typing.Any, typing.Any]) -> None:
            """
        ...
        @typing.overload
        def writeDown(self, into: ghidra.pcode.exec_.trace.data.PcodeTraceAccess) -> None:
            """
        ...
        @typing.overload
        def writeDown(self, snap: typing.Union[jpype.JLong, int]) -> None:
            """
    ...
    class PieceHandler(java.lang.Object, typing.Generic[A, T]):
        ...
        def abstractReadUninit(self, acc: ghidra.pcode.exec_.trace.data.PcodeTraceDataAccess, thread: ghidra.pcode.emu.PcodeThread[typing.Any], piece: ghidra.pcode.exec_.PcodeExecutorStatePiece[A, T], space: ghidra.program.model.address.AddressSpace, offset: A, length: typing.Union[jpype.JInt, int], reason: ghidra.pcode.exec_.PcodeExecutorStatePiece.Reason) -> int:
            """
        ...
        def writeDown(self, into: ghidra.pcode.exec_.trace.data.PcodeTraceDataAccess, thread: ghidra.pcode.emu.PcodeThread[typing.Any], piece: ghidra.pcode.exec_.PcodeExecutorStatePiece[A, T], written: ghidra.program.model.address.AddressSetView) -> None:
            """
    ...
    class TraceWriter(TraceEmulationIntegration.Writer):
        ...
        def __init__(self, access: ghidra.pcode.exec_.trace.data.PcodeTraceAccess) -> None:
            """
...
class UnknownStatePcodeExecutionException(ghidra.pcode.exec_.AccessPcodeExecutionException):
    ...
    @typing.overload
    def __init__(self, language: ghidra.program.model.lang.Language, address: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], language: ghidra.program.model.lang.Language, address: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["AddressesReadTracePcodeExecutorStatePiece", "TraceEmulationIntegration", "TraceMemoryStatePcodeArithmetic", "TraceMemoryStatePcodeExecutorStatePiece", "TraceSleighUtils", "UnknownStatePcodeExecutionException"]
