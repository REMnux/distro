...
class PropertyDeleteCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, propName: typing.Union[java.lang.String, str], restrictedView: ghidra.program.model.address.AddressSetView) -> None:
        """
...
class PropertyManagerProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, plugin: PropertyManagerPlugin) -> None:
        ...
...
class PropertyManagerTableModel(javax.swing.table.AbstractTableModel):
    ...
    def update(self, program: ghidra.program.model.listing.Program, addrSet: ghidra.program.model.address.AddressSetView) -> None:
        """
...
__all__ = ["PropertyDeleteCmd", "PropertyManagerPlugin", "PropertyManagerProvider", "PropertyManagerTableModel"]
