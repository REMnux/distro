...
class ProjectAccessStep(docking.wizard.WizardStep[ProjectWizardData]):
    ...
    def __init__(self, model: docking.wizard.WizardModel[ProjectWizardData], tool: ghidra.framework.plugintool.PluginTool) -> None:
        ...
...
class ProjectWizardData(java.lang.Object):
    ...
    def setAllowAnonymousAccess(self, allowAnonymousAccess: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setIsNewRepository(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setIsSharedProject(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setProjectLocator(self, locator: ghidra.framework.model.ProjectLocator) -> None:
        ...

    def setProjectUsers(self, projectUsers: jpype.JArray[ghidra.framework.remote.User]) -> None:
        ...

    def setRepository(self, repository: ghidra.framework.client.RepositoryAdapter) -> None:
        ...

    def setRepositoryName(self, repositoryName: typing.Union[java.lang.String, str]) -> None:
        ...

    def setServer(self, server: ghidra.framework.client.RepositoryServerAdapter) -> None:
        ...

    def setServerInfo(self, serverInfo: ghidra.framework.model.ServerInfo) -> None:
        ...
...
class ProjectChooseRepositoryWizardModel(docking.wizard.WizardModel[ProjectWizardData]):
    ...
    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, title: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, title: typing.Union[java.lang.String, str], server: ghidra.framework.model.ServerInfo) -> None:
        ...
...
class RepositoryPanel(javax.swing.JPanel):
    ...
    def __init__(self, statusChangedCallback: utility.function.Callback, repositoryNames: jpype.JArray[java.lang.String], readOnlyServerAccess: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class SelectProjectPanel(javax.swing.JPanel):
    ...
    def __init__(self, statusChangedCallback: utility.function.Callback) -> None:
        """
...
__all__ = ["ProjectAccessStep", "ProjectWizardData", "ProjectChooseRepositoryWizardModel", "ProjectTypePanel", "ProjectTypeStep", "ProjectWizardModel", "RepositoryPanel", "RepositoryStep", "SelectProjectPanel", "SelectProjectStep", "ServerInfoPanel", "ServerStep"]
