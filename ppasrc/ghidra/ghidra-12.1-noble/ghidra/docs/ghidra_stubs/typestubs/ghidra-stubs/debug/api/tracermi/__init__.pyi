...
class TraceRmiLaunchOffer(java.lang.Object):
    ...
    class LaunchResult(java.lang.Record, java.lang.AutoCloseable):
        ...
        def __init__(self, program: ghidra.program.model.listing.Program, sessions: collections.abc.Mapping, acceptor: TraceRmiAcceptor, connection: TraceRmiConnection, trace: ghidra.trace.model.Trace, exception: java.lang.Throwable) -> None:
            ...
...
class TraceRmiAcceptor(java.lang.Object):
    ...
    def setTimeout(self, millis: typing.Union[jpype.JInt, int]) -> None:
        """
        Set the timeout
...
class TraceRmiConnection(java.lang.AutoCloseable):
    ...
    def forceCloseTrace(self, trace: ghidra.trace.model.Trace) -> None:
        """
    ...
    def forciblyCloseTransactions(self, target: ghidra.debug.api.target.Target) -> None:
        """
...
class LaunchParameter(java.lang.Record, typing.Generic[T]):
    ...
    def set(self, arguments: collections.abc.Mapping, value: ghidra.debug.api.ValStr[T]) -> None:
        ...
...
class RemoteMethod(java.lang.Object):
    ...
    @staticmethod
    def checkType(paramName: typing.Union[java.lang.String, str], schName: ghidra.trace.model.target.schema.TraceObjectSchema.SchemaName, sch: ghidra.trace.model.target.schema.TraceObjectSchema, arg: java.lang.Object) -> None:
        """
...
class TraceRmiServiceListener(java.lang.Object):
    ...
    def acceptCancelled(self, acceptor: TraceRmiAcceptor) -> None:
        """
    ...
    def acceptFailed(self, acceptor: TraceRmiAcceptor, e: java.lang.Exception) -> None:
        """
    ...
    def connected(self, connection: TraceRmiConnection, mode: TraceRmiServiceListener.ConnectMode, acceptor: TraceRmiAcceptor) -> None:
        """
    ...
    def disconnected(self, connection: TraceRmiConnection) -> None:
        """
    ...
    def serverStarted(self, address: java.net.SocketAddress) -> None:
        """
    ...
    def targetPublished(self, connection: TraceRmiConnection, target: ghidra.debug.api.target.Target) -> None:
        """
    ...
    def transactionClosed(self, connection: TraceRmiConnection, target: ghidra.debug.api.target.Target, aborted: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def transactionOpened(self, connection: TraceRmiConnection, target: ghidra.debug.api.target.Target) -> None:
        """
    ...
    def waitingAccept(self, acceptor: TraceRmiAcceptor) -> None:
        """
...
__all__ = ["TraceRmiLaunchOffer", "TerminalSession", "TraceRmiAcceptor", "TraceRmiConnection", "LaunchParameter", "RemoteMethodRegistry", "RemoteMethod", "RemoteParameter", "RemoteAsyncResult", "TraceRmiServiceListener", "TraceRmiError"]
