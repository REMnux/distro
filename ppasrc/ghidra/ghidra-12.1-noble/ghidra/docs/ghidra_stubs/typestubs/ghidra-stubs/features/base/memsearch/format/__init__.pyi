...
class SearchFormat(java.lang.Object):
    ...
    def parse(self, input: typing.Union[java.lang.String, str], settings: ghidra.features.base.memsearch.gui.SearchSettings) -> ghidra.features.base.memsearch.matcher.UserInputByteMatcher:
        """
        ...
        :rtype: ghidra.features.base.memsearch.matcher.UserInputByteMatcher
        """
...
__all__ = ["SearchFormat", "BinarySearchFormat", "DecimalSearchFormat", "NumberParseResult", "FloatSearchFormat", "HexSearchFormat", "RegExSearchFormat", "StringSearchFormat"]
