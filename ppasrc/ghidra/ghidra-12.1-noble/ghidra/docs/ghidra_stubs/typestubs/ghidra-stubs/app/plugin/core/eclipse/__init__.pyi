...
class EclipseConnection(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, process: java.lang.Process, socket: java.net.Socket) -> None:
        """
...
class EclipseConnectorTask(ghidra.util.task.Task):
    ...
    def __init__(self, eclipseService: ghidra.app.services.EclipseIntegrationService, port: typing.Union[jpype.JInt, int]) -> None:
        """
...
__all__ = ["EclipseConnection", "EclipseConnectorTask", "EclipseIntegrationOptionsPlugin", "EclipseIntegrationPlugin"]
