...
class Lifespan(generic.Span[java.lang.Long, Lifespan], java.lang.Iterable[java.lang.Long]):
    ...
    class Impl(java.lang.Record, Lifespan):
        ...
        def __init__(self, lmin: typing.Union[jpype.JLong, int], lmax: typing.Union[jpype.JLong, int]) -> None:
            ...
...
class Trace(ghidra.program.model.data.DataTypeManagerDomainObject):
    ...
    class TraceProgramViewListener(java.lang.Object):
        ...
        def viewCreated(self, view: ghidra.trace.model.program.TraceProgramView) -> None:
            ...
    ...
    def addProgramViewListener(self, listener: Trace.TraceProgramViewListener) -> None:
        ...
    ...
    def removeProgramViewListener(self, listener: Trace.TraceProgramViewListener) -> None:
        ...

    def setEmulatorCacheVersion(self, version: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class TraceTimeViewport(java.lang.Object):
    ...
    class Occlusion(java.lang.Object, typing.Generic[T]):
        ...
        def remove(self, object: T, remains: ghidra.program.model.address.AddressSet, span: Lifespan) -> None:
            ...
    ...
    class QueryOcclusion(TraceTimeViewport.Occlusion[T], typing.Generic[T]):
        ...
        def removeItem(self, remains: ghidra.program.model.address.AddressSet, t: T, snap: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    def addChangeListener(self, l: java.lang.Runnable) -> None:
        """
    ...
    def removeChangeListener(self, l: java.lang.Runnable) -> None:
        """
...
class DefaultAddressSnap(AddressSnap):
    ...
    def __init__(self, address: ghidra.program.model.address.Address, snap: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class DefaultTraceLocation(TraceLocation):
    ...
    def __init__(self, trace: Trace, thread: ghidra.trace.model.thread.TraceThread, lifespan: Lifespan, address: ghidra.program.model.address.Address) -> None:
        ...
...
class DefaultTraceSpan(TraceSpan):
    ...
    def __init__(self, trace: Trace, span: Lifespan) -> None:
        ...
...
class ImmutableTraceAddressSnapRange(TraceAddressSnapRange):
    ...
    @typing.overload
    def __init__(self, minAddress: ghidra.program.model.address.Address, maxAddress: ghidra.program.model.address.Address, minSnap: typing.Union[jpype.JLong, int], maxSnap: typing.Union[jpype.JLong, int], space: TraceAddressSnapSpace) -> None:
        ...

    @typing.overload
    def __init__(self, minAddress: ghidra.program.model.address.Address, maxAddress: ghidra.program.model.address.Address, minSnap: typing.Union[jpype.JLong, int], maxSnap: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def __init__(self, range: ghidra.program.model.address.AddressRange, lifespan: Lifespan) -> None:
        ...

    @typing.overload
    def __init__(self, range: ghidra.program.model.address.AddressRange, snap: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def __init__(self, minAddress: ghidra.program.model.address.Address, maxAddress: ghidra.program.model.address.Address, lifespan: Lifespan, space: ghidra.util.database.spatial.rect.EuclideanSpace2D[ghidra.program.model.address.Address, java.lang.Long]) -> None:
        ...

    @typing.overload
    def __init__(self, minAddress: ghidra.program.model.address.Address, maxAddress: ghidra.program.model.address.Address, lifespan: Lifespan) -> None:
        ...

    @typing.overload
    def __init__(self, address: ghidra.program.model.address.Address, lifespan: Lifespan) -> None:
        ...
...
class TraceOptionsManager(java.lang.Object):
    ...
    def setPlatform(self, platform: typing.Union[java.lang.String, str]) -> None:
        ...
...
__all__ = ["Lifespan", "TraceUniqueObject", "Trace", "TraceTimeViewport", "TraceAddressSnapRange", "TraceExecutionState", "TraceChangeSet", "TraceUserData", "AddressSnap", "TraceDomainObjectListener", "DefaultAddressSnap", "DefaultTraceLocation", "TraceLocation", "DefaultTraceSpan", "TraceSpan", "ImmutableTraceAddressSnapRange", "TraceAddressSnapSpace", "TraceClosedException", "TraceOptionsManager"]
