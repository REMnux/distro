...
class MemoryBlock(java.io.Serializable, java.lang.Comparable[MemoryBlock]):
    ...
    def putByte(self, addr: ghidra.program.model.address.Address, b: typing.Union[jpype.JByte, int]) -> None:
        """
    ...
    def setArtificial(self, a: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setExecute(self, e: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setName(self, name: typing.Union[java.lang.String, str]) -> None:
        """
        Set the name for this block (See :meth:`Memory.isValidMemoryBlockName(String) <Memory.isValidMemoryBlockName>` for naming
    ...
    def setPermissions(self, read: typing.Union[jpype.JBoolean, bool], write: typing.Union[jpype.JBoolean, bool], execute: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setRead(self, r: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setSourceName(self, sourceName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setVolatile(self, v: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setWrite(self, w: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class MemoryBlockException(MemoryAccessException):
    ...
    def __init__(self, msg: typing.Union[java.lang.String, str], cause: java.lang.Throwable) -> None:
        ...
        :param java.lang.String or str msg: detailed message
        :param java.lang.Throwable cause: original cause of this exception
        """
...
class Memory(ghidra.program.model.address.AddressSetView):
    ...
    * Bit-Mapped - a memory block whose bytes are mapped to a corresponding bit in another
    ...
    def convertToUninitialized(self, initializedBlock: MemoryBlock) -> MemoryBlock:
        """
        ...
        :param MemoryBlock initializedBlock: uninitialized block to convert
        :return: the converted block
        :rtype: MemoryBlock
        :raises LockException: if exclusive lock not in place (see haveLock())
        :raises MemoryBlockException: if there is no block in memory
    ...
    def getAllInitializedAddressSet(self) -> ghidra.program.model.address.AddressSetView:
        ...
        This includes initialized memory blocks that contain data from
    ...
    def getBlocks(self) -> jpype.JArray[MemoryBlock]:
        ...
        :rtype: jpype.JArray[MemoryBlock]
        """
    ...
    @deprecated("Use getLoadedAndInitializedAddressSet instead")
    def getInitializedAddressSet(self) -> ghidra.program.model.address.AddressSetView:
        ...
        initialized data.
        :rtype: ghidra.program.model.address.AddressSetView
        This does not include initialized memory blocks that contain data from
    ...
    def moveBlock(self, block: MemoryBlock, newStartAddr: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def removeBlock(self, block: MemoryBlock, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def setByte(self, addr: ghidra.program.model.address.Address, value: typing.Union[jpype.JByte, int]) -> None:
        """
        Write byte at addr.
    ...
    @typing.overload
    def setBytes(self, addr: ghidra.program.model.address.Address, source: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    @typing.overload
    def setBytes(self, addr: ghidra.program.model.address.Address, source: jpype.JArray[jpype.JByte], sIndex: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def setInt(self, addr: ghidra.program.model.address.Address, value: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def setInt(self, addr: ghidra.program.model.address.Address, value: typing.Union[jpype.JInt, int], bigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def setLong(self, addr: ghidra.program.model.address.Address, value: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def setLong(self, addr: ghidra.program.model.address.Address, value: typing.Union[jpype.JLong, int], bigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def setShort(self, addr: ghidra.program.model.address.Address, value: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    @typing.overload
    def setShort(self, addr: ghidra.program.model.address.Address, value: typing.Union[jpype.JShort, int], bigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def split(self, block: MemoryBlock, addr: ghidra.program.model.address.Address) -> None:
        """
...
class DumbMemBufferImpl(MemoryBufferImpl):
    ...
    def __init__(self, mem: Memory, addr: ghidra.program.model.address.Address) -> None:
        """
...
class MemoryBufferImpl(MutableMemBuffer):
    ...
    @typing.overload
    def __init__(self, mem: Memory, addr: ghidra.program.model.address.Address, bufSize: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a new MemoryBufferImpl
...
class MutableMemBuffer(MemBuffer):
    ...
    def advance(self, displacement: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ByteMemBufferImpl(MemBuffer):
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, bytes: jpype.JArray[jpype.JByte], isBigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, memory: Memory, addr: ghidra.program.model.address.Address, bytes: jpype.JArray[jpype.JByte], isBigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a ByteMemBufferImpl object
...
class MemBufferInputStream(java.io.InputStream):
    ...
    @typing.overload
    def __init__(self, membuf: MemBuffer) -> None:
        """
    ...
    @typing.overload
    def __init__(self, membuf: MemBuffer, initialPosition: typing.Union[jpype.JInt, int], length: typing.Union[jpype.JInt, int]) -> None:
        """
...
class MemoryBlockListener(java.lang.Object):
    ...
    def commentChanged(self, block: MemoryBlock, oldComment: typing.Union[java.lang.String, str], newComment: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def dataChanged(self, block: MemoryBlock, addr: ghidra.program.model.address.Address, oldData: jpype.JArray[jpype.JByte], newData: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def executeStatusChanged(self, block: MemoryBlock, isExecute: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def nameChanged(self, block: MemoryBlock, oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def readStatusChanged(self, block: MemoryBlock, isRead: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def sourceChanged(self, block: MemoryBlock, oldSource: typing.Union[java.lang.String, str], newSource: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def sourceOffsetChanged(self, block: MemoryBlock, oldOffset: typing.Union[jpype.JLong, int], newOffset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def writeStatusChanged(self, block: MemoryBlock, isWrite: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class WrappedMemBuffer(MemBuffer):
    ...
    @typing.overload
    def __init__(self, buf: MemBuffer, baseOffset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, buf: MemBuffer, bufferSize: typing.Union[jpype.JInt, int], baseOffset: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a wrapped MemBuffer with an adjustable base offset
...
__all__ = ["MemBuffer", "InvalidAddressException", "MemoryBlock", "MemoryBlockException", "MemoryAccessException", "MemoryBlockType", "MemoryConflictException", "MemoryBlockSourceInfo", "Memory", "DumbMemBufferImpl", "MemoryBufferImpl", "MutableMemBuffer", "ByteMemBufferImpl", "MemBufferInputStream", "MemBufferMixin", "MemoryBlockListener", "MemoryBlockStub", "MemoryConstants", "StubMemory", "WrappedMemBuffer"]
