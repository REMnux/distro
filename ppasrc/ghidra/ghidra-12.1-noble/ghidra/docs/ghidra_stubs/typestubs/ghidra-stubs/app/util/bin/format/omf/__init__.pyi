...
class Omf2or4(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, length: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JLong, int]) -> None:
        """
...
class OmfIndex(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, length: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class OmfObsoleteRecord(OmfRecord):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, recordTypesClass: java.lang.Class[typing.Any]) -> None:
        """
...
class OmfString(ghidra.app.util.bin.StructConverter):
    ...
    @typing.overload
    def __init__(self, length: typing.Union[jpype.JInt, int], str: typing.Union[java.lang.String, str]) -> None:
        """
        Creates a new small :obj:`OmfString`
    ...
    @typing.overload
    def __init__(self, length: typing.Union[jpype.JInt, int], str: typing.Union[java.lang.String, str], isBig: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Creates a new :obj:`OmfString`
        
        :param jpype.JInt or int length: The length of the string
        :param java.lang.String or str str: The string
        :param jpype.JBoolean or bool isBig: True if this is a big string; otherwise, false
        """
...
class OmfUtils(java.lang.Object):
    ...
    @staticmethod
    def readBigString(reader: ghidra.app.util.bin.BinaryReader) -> OmfString:
        """
    ...
    @staticmethod
    def readRecords(factory: AbstractOmfRecordFactory, log: ghidra.app.util.importer.MessageLog) -> java.util.List[OmfRecord]:
        """
...
__all__ = ["AbstractOmfRecordFactory", "OmfRecord", "OmfException", "Omf2or4", "OmfIndex", "OmfObsoleteRecord", "OmfString", "OmfUnknownRecord", "OmfUnsupportedRecord", "OmfUtils"]
