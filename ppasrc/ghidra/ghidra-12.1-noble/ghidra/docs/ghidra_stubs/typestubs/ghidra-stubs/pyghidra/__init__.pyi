...
class PyGhidraPlugin(ghidra.app.plugin.ProgramPlugin):
    ...
    @staticmethod
    def setInitializer(initializer: java.util.function.Consumer[PyGhidraPlugin]) -> None:
        """
...
class PyGhidraProject(ghidra.framework.project.DefaultProject):
    ...
    def __init__(self, projectManager: PyGhidraProjectManager, projectData: ghidra.framework.model.ProjectData) -> None:
        ...
...
class PyGhidraScriptProvider(ghidra.app.script.AbstractPythonScriptProvider):
    ...
    class PyGhidraGhidraScript(ghidra.app.script.GhidraScript, PythonFieldExposer):
        ...
        class ExposedField(PythonFieldExposer.ExposedField):
            ...
            def __init__(self, name: typing.Union[java.lang.String, str], type: java.lang.Class[typing.Any]) -> None:
                ...
    ...
    @staticmethod
    def setScriptRunner(scriptRunner: java.util.function.Consumer[ghidra.app.script.GhidraScript]) -> None:
        """
...
class PyGhidraTaskMonitor(ghidra.util.task.TaskMonitor):
    ...
    def __init__(self, timeoutSecs: typing.Union[java.lang.Integer, int], changeCallback: org.apache.commons.lang3.function.TriConsumer[java.lang.String, java.lang.Long, java.lang.Long]) -> None:
        """
...
class PythonFieldExposer(java.lang.Object):
    ...
    class ExposedField(java.lang.Object):
        ...
        def fset(self, self_: java.lang.Object, value: java.lang.Object) -> None:
            """
...
__all__ = ["PyGhidraPlugin", "PyGhidraProject", "PyGhidraProjectManager", "PyGhidraScriptProvider", "PyGhidraTaskMonitor", "PythonFieldExposer"]
