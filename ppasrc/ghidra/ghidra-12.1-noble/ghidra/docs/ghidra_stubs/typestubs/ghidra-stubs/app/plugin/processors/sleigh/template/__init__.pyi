...
class ConstructTpl(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, opvec: jpype.JArray[OpTpl]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, opvec: jpype.JArray[OpTpl], res: HandleTpl, nmLabels: typing.Union[jpype.JInt, int]) -> None:
        """
...
class OpTpl(java.lang.Object):
    ...
    def __init__(self, opcode: typing.Union[jpype.JInt, int], output: VarnodeTpl, inputs: jpype.JArray[VarnodeTpl]) -> None:
        ...
...
class VarnodeTpl(java.lang.Object):
    ...
    def __init__(self, space: ConstTpl, offset: ConstTpl, size: ConstTpl) -> None:
        ...
...
class ConstTpl(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, tp: typing.Union[jpype.JInt, int], val: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def __init__(self, tp: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, spc: ghidra.program.model.address.AddressSpace) -> None:
        ...

    @typing.overload
    def __init__(self, tp: typing.Union[jpype.JInt, int], ht: typing.Union[jpype.JInt, int], vf: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, tp: typing.Union[jpype.JInt, int], val: typing.Union[jpype.JLong, int], spc: ghidra.program.model.address.AddressSpace, ht: typing.Union[jpype.JInt, int], sel: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class HandleTpl(java.lang.Object):
    ...
    def __init__(self, spc: ConstTpl, sz: ConstTpl, ptrspc: ConstTpl, ptroff: ConstTpl, ptrsz: ConstTpl, tmpspc: ConstTpl, tmpoff: ConstTpl) -> None:
        ...
    ...
    def fixPrintPiece(self, hand: ghidra.app.plugin.processors.sleigh.FixedHandle, walker: ghidra.app.plugin.processors.sleigh.ParserWalker, handleIndex: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["ConstructTpl", "OpTpl", "VarnodeTpl", "ConstTpl", "HandleTpl"]
