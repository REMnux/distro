...
class PyGhidraInterpreter(ghidra.util.Disposable, ghidra.app.plugin.core.interpreter.InterpreterConnection):
    ...
    def __init__(self, plugin: ghidra.pyghidra.PyGhidraPlugin, isPythonAvailable: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def init(self, pythonSideConsole: PyGhidraConsole) -> None:
        """
...
__all__ = ["CancelAction", "InterpreterGhidraScript", "InterpreterTaskMonitor", "PyGhidraConsole", "PyGhidraInterpreter", "ResetAction"]
