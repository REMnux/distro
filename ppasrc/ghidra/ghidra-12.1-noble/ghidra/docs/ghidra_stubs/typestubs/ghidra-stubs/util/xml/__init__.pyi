...
import org.jdom2.input # type: ignore
import org.jdom2.output # type: ignore
...
class XmlTestHelper(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, tmpDirPath: typing.Union[java.lang.String, str], gp: ghidra.base.project.GhidraProject) -> None:
        ...

    @typing.overload
    def __init__(self, tmpDirPath: typing.Union[java.lang.String, str]) -> None:
        ...

    def add(self, xml: typing.Union[java.lang.String, str]) -> None:
        ...

    @staticmethod
    @typing.overload
    def assertXMLFilesEquals(expectedXMLFile: jpype.protocol.SupportsPath, testXMLFile: jpype.protocol.SupportsPath) -> None:
        ...
    ...
    def compareXml(self, file: jpype.protocol.SupportsPath) -> None:
        ...
    ...
    def loadXmlResource(self, pkg: java.lang.Package, name: typing.Union[java.lang.String, str]) -> None:
        """
...
class GenericXMLOutputter(java.lang.Object):
    """
    Gets a :obj:`XMLOutputter` that sets default settings to fix common bugs
    """
    ...
    @staticmethod
    def getInstance() -> org.jdom2.output.XMLOutputter:
        """
...
class SpecXmlUtils(java.lang.Object):
    ...
    @staticmethod
    def encodeBooleanAttribute(buf: java.lang.StringBuilder, nm: typing.Union[java.lang.String, str], val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @staticmethod
    def encodeDoubleAttribute(buf: java.lang.StringBuilder, nm: typing.Union[java.lang.String, str], val: typing.Union[jpype.JDouble, float]) -> None:
        ...
    ...
    @staticmethod
    def encodeSignedIntegerAttribute(buf: java.lang.StringBuilder, nm: typing.Union[java.lang.String, str], val: typing.Union[jpype.JLong, int]) -> None:
        ...

    @staticmethod
    def encodeStringAttribute(buf: java.lang.StringBuilder, nm: typing.Union[java.lang.String, str], val: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    @staticmethod
    def encodeUnsignedIntegerAttribute(buf: java.lang.StringBuilder, nm: typing.Union[java.lang.String, str], val: typing.Union[jpype.JLong, int]) -> None:
        ...
    ...
    @staticmethod
    def xmlEscape(buf: java.lang.StringBuilder, val: typing.Union[java.lang.String, str]) -> None:
        ...

    @staticmethod
    def xmlEscapeAttribute(buf: java.lang.StringBuilder, nm: typing.Union[java.lang.String, str], val: typing.Union[java.lang.String, str]) -> None:
        ...

    @staticmethod
    def xmlEscapeWriter(writer: java.io.Writer, val: typing.Union[java.lang.String, str]) -> None:
        ...
...
class XmlAttributes(java.lang.Object):
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JFloat, float]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JDouble, float]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JByte, int]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JByte, int], hex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JShort, int], hex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JInt, int], hex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int], hex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def addAttribute(self, name: typing.Union[java.lang.String, str], value: java.math.BigInteger, hex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class XmlParserElement(java.lang.Object):
    ...
    def setAttribute(self, name: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        """
...
class XmlUtilities(java.lang.Object):
    ...
    @staticmethod
    def byteArrayToXml(bytes: jpype.JArray[jpype.JByte]) -> org.jdom2.Element:
        """
    ...
    @staticmethod
    def createSecureSAXBuilder(validate: typing.Union[jpype.JBoolean, bool], needsDTD: typing.Union[jpype.JBoolean, bool]) -> org.jdom2.input.SAXBuilder:
        """
        ...
        :rtype: org.jdom2.input.SAXBuilder
        """
    ...
    @staticmethod
    def fromString(s: typing.Union[java.lang.String, str]) -> org.jdom2.Element:
        """
    ...
    @staticmethod
    def getChildren(ele: org.jdom2.Element, childName: typing.Union[java.lang.String, str]) -> java.util.List[org.jdom2.Element]:
        """
        Type-safe way of getting a list of :obj:`Element`s from JDom.
        
        :param org.jdom2.Element ele: the parent element
        :param java.lang.String or str childName: the name of the children elements to return
        :return: List<Element> of elements
        :rtype: java.util.List[org.jdom2.Element]
        """
    ...
    @staticmethod
    def parseBoundedIntAttr(ele: org.jdom2.Element, attrName: typing.Union[java.lang.String, str], minValue: typing.Union[jpype.JInt, int], maxValue: typing.Union[jpype.JInt, int]) -> int:
        """
        Parses the required attribute as a decimal number, returning its integer
        value.
        
        :param org.jdom2.Element ele: JDom element that contains the attribute
    ...
    @staticmethod
    def parseBoundedLongAttr(ele: org.jdom2.Element, attrName: typing.Union[java.lang.String, str], minValue: typing.Union[jpype.JLong, int], maxValue: typing.Union[jpype.JLong, int]) -> int:
        """
    ...
    @staticmethod
    def parseOptionalBooleanAttr(ele: org.jdom2.Element, attrName: typing.Union[java.lang.String, str], defaultValue: typing.Union[jpype.JBoolean, bool]) -> bool:
        """
    ...
    @staticmethod
    def parseOptionalBoundedIntAttr(ele: org.jdom2.Element, attrName: typing.Union[java.lang.String, str], defaultValue: typing.Union[jpype.JInt, int], minValue: typing.Union[jpype.JInt, int], maxValue: typing.Union[jpype.JInt, int]) -> int:
        """
    ...
    @staticmethod
    def parseOptionalBoundedLongAttr(ele: org.jdom2.Element, attrName: typing.Union[java.lang.String, str], defaultValue: typing.Union[jpype.JLong, int], minValue: typing.Union[jpype.JLong, int], maxValue: typing.Union[jpype.JLong, int]) -> int:
        """
        Parses the required attribute as a decimal number, returning its long
        integer value.
    ...
    @staticmethod
    @typing.overload
    def readDocFromFile(f: generic.jar.ResourceFile) -> org.jdom2.Document:
        """
        Read a File and convert to jdom xml doc.
    ...
    @staticmethod
    def requireStringAttr(ele: org.jdom2.Element, attrName: typing.Union[java.lang.String, str]) -> str:
        """
        Throws an :obj:`IOException` with a verbose explanation if the requested
        attribute is not present or is empty.
        
        :param org.jdom2.Element ele: JDOM :obj:`Element` that contains the attribute
    ...
    @staticmethod
    def setIntAttr(ele: org.jdom2.Element, attrName: typing.Union[java.lang.String, str], attrValue: typing.Union[jpype.JInt, int]) -> None:
        """
        Sets an integer attribute on the specified element.
        
        :param org.jdom2.Element ele: JDom element
        :param java.lang.String or str attrName: name of attribute
        :param jpype.JInt or int attrValue: value of attribute
        """

    @staticmethod
    def setStringAttr(ele: org.jdom2.Element, attrName: typing.Union[java.lang.String, str], attrValue: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    def toString(root: org.jdom2.Element) -> str:
        """
        Converts the specified XML element into a String.
        
        :param org.jdom2.Element root: the root element
    ...
    @staticmethod
    def writeDocToFile(doc: org.jdom2.Document, dest: jpype.protocol.SupportsPath) -> None:
        """
        Writes a JDOM XML :obj:`Document` to a :obj:`File`.
        
        :param org.jdom2.Document doc: JDOM XML :obj:`Document` to write.
        :param jpype.protocol.SupportsPath dest: :obj:`File` to write to.
        :raises IOException: if error when writing file.
        """

    @staticmethod
    def writePrettyDocToFile(doc: org.jdom2.Document, dest: jpype.protocol.SupportsPath) -> None:
        """
    ...
    @staticmethod
    def xmlToByteArray(root: org.jdom2.Element) -> jpype.JArray[jpype.JByte]:
        """
...
class XmlWriter(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, file: jpype.protocol.SupportsPath, dtdName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, out: java.io.OutputStream, dtdName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructs a new XML writer.
    ...
    def endElement(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def startElement(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def startElement(self, name: typing.Union[java.lang.String, str], attrs: XmlAttributes) -> None:
        """
    ...
    def writeDTD(self, dtdName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def writeElement(self, name: typing.Union[java.lang.String, str], attrs: XmlAttributes) -> None:
        """
    ...
    @typing.overload
    def writeElement(self, name: typing.Union[java.lang.String, str], attrs: XmlAttributes, text: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["XmlSummary", "XmlTestHelper", "Counter", "GenericXMLOutputter", "SpecXmlUtils", "XmlAttributeException", "XmlAttributes", "XmlParserElement", "XmlUtilities", "XmlWriter"]
