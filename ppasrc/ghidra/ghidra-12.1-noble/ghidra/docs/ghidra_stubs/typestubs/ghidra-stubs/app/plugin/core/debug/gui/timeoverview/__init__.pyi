...
class TimeOverviewColorComponent(javax.swing.JPanel, ghidra.app.util.viewer.listingpanel.ListingOverviewProvider):
    """
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, overviewColorService: TimeOverviewColorService) -> None:
        """
        Constructor
    ...
    def setLifeSet(self, set: java.util.TreeSet[java.lang.Long]) -> None:
        ...

    def setLifespan(self, bounds: ghidra.trace.model.Lifespan) -> None:
        ...

    def setPlugin(self, plugin: TimeOverviewColorPlugin) -> None:
        ...
...
class TimeOverviewColorService(ghidra.util.classfinder.ExtensionPoint):
    ...
    def initialize(self, tool: ghidra.framework.plugintool.PluginTool) -> None:
        """
    ...
    def setBounds(self, bounds: ghidra.trace.model.Lifespan) -> None:
        """
    ...
    def setIndices(self, set: java.util.TreeSet[java.lang.Long]) -> None:
        """
    ...
    def setOverviewComponent(self, component: TimeOverviewColorComponent) -> None:
        """
...
class TimeOverviewColorPlugin(ghidra.app.plugin.core.debug.AbstractDebuggerPlugin):
    ...
    class OverviewToggleAction(docking.action.ToggleDockingAction):
        ...
        def __init__(self, owner: typing.Union[java.lang.String, str], service: TimeOverviewColorService) -> None:
            ...
    ...
    def gotoSnap(self, offset: typing.Union[java.lang.Long, int]) -> None:
        ...

    def installOverview(self, overviewColorService: TimeOverviewColorService) -> None:
        """
    ...
    def setLifespan(self, span: ghidra.trace.model.Lifespan) -> None:
        ...
...
class TimeOverviewEventListener(ghidra.trace.model.TraceDomainObjectListener):
    ...
    def __init__(self, plugin: TimeOverviewColorPlugin) -> None:
        ...
...
__all__ = ["TimeOverviewColorComponent", "TimeOverviewColorService", "TimeOverviewColorPlugin", "TimeOverviewEventListener"]
