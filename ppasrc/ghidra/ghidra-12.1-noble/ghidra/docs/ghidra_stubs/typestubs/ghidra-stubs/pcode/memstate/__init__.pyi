...
class MemoryState(java.lang.Object):
    ...
    def setChunk(self, val: jpype.JArray[jpype.JByte], spc: ghidra.program.model.address.AddressSpace, off: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setInitialized(self, initialized: typing.Union[jpype.JBoolean, bool], spc: ghidra.program.model.address.AddressSpace, off: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def setValue(self, vn: ghidra.program.model.pcode.Varnode, cval: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def setValue(self, reg: ghidra.program.model.lang.Register, cval: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def setValue(self, nm: typing.Union[java.lang.String, str], cval: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def setValue(self, spc: ghidra.program.model.address.AddressSpace, off: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], cval: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def setValue(self, vn: ghidra.program.model.pcode.Varnode, cval: java.math.BigInteger) -> None:
        """
        A convenience method for setting a value directly on a varnode rather than
        breaking out the components
    ...
    @typing.overload
    def setValue(self, reg: ghidra.program.model.lang.Register, cval: java.math.BigInteger) -> None:
        """
        A convenience method for setting a value directly on a register rather than
        breaking out the components
    ...
    @typing.overload
    def setValue(self, nm: typing.Union[java.lang.String, str], cval: java.math.BigInteger) -> None:
        """
        This is a convenience method for setting registers by name.
        Any register name known to the language can be used as a write location.
        The associated address space, offset, and size is looked up and automatically
    ...
    @typing.overload
    def setValue(self, spc: ghidra.program.model.address.AddressSpace, off: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], cval: java.math.BigInteger) -> None:
        """
        This is the main interface for writing values to the MemoryState.
        If there is no registered MemoryBank for the desired address space, or
        if there is some other error, an exception is thrown.
...
class MemoryBank(java.lang.Object):
    ...
    def __init__(self, spc: ghidra.program.model.address.AddressSpace, isBigEndian: typing.Union[jpype.JBoolean, bool], ps: typing.Union[jpype.JInt, int], faultHandler: MemoryFaultHandler) -> None:
        """
    ...
    @staticmethod
    def deconstructValue(ptr: jpype.JArray[jpype.JByte], offset: typing.Union[jpype.JInt, int], val: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], bigendian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setChunk(self, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], val: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def setInitialized(self, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], initialized: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class MemoryPage(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, pageSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def setInitialized(self, pageOffset: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int], maskUpdate: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    @typing.overload
    def setInitialized(self, pageOffset: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def setInitialized(initializedMask: jpype.JArray[jpype.JByte], pageOffset: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int]) -> None:
        """
        Mark specified page region as initialized.
    ...
    @typing.overload
    def setUninitialized(self, pageOffset: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def setUninitialized(initializedMask: jpype.JArray[jpype.JByte], pageOffset: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int]) -> None:
        """
        Mark specified page region as uninitialized.
...
class UniqueMemoryBank(MemoryBank):
    ...
    class WordInfo(java.lang.Object):
        ...
        def getWord(self, buffer: jpype.JArray[jpype.JByte]) -> None:
            """
        ...
        def setByte(self, val: typing.Union[jpype.JByte, int], index: typing.Union[jpype.JInt, int]) -> None:
            """
    ...
    def __init__(self, spc: ghidra.program.model.address.AddressSpace, isBigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class MemoryPageOverlay(MemoryPageBank):
    ...
    def __init__(self, spc: ghidra.program.model.address.AddressSpace, ul: MemoryBank, faultHandler: MemoryFaultHandler) -> None:
        """
...
__all__ = ["MemoryState", "DefaultMemoryState", "AbstractMemoryState", "MemoryFaultHandler", "MemoryBank", "MemoryPage", "UniqueMemoryBank", "MemoryPageBank", "MemoryPageOverlay"]
