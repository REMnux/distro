...
class DBTraceDelegatingManager(java.lang.Object, typing.Generic[M]):
    ...
    def delegateDeleteV(self, space: ghidra.program.model.address.AddressSpace, func: DBTraceDelegatingManager.ExcConsumer[M, E]) -> None:
        ...
    ...
    def delegateWriteAll(self, spaces: collections.abc.Sequence, func: DBTraceDelegatingManager.ExcConsumer[M, E]) -> None:
        ...

    def delegateWriteI(self, space: ghidra.program.model.address.AddressSpace, func: java.util.function.ToIntFunction[M]) -> int:
        ...

    def delegateWriteV(self, space: ghidra.program.model.address.AddressSpace, func: DBTraceDelegatingManager.ExcConsumer[M, E]) -> None:
        ...
...
class DBTraceSpaceBased(ghidra.trace.util.TraceSpaceMixin):
    ...
    @typing.overload
    def assertInSpace(self, range: ghidra.program.model.address.AddressRange) -> None:
        ...
...
__all__ = ["AbstractDBTraceSpaceBasedManager", "DBTraceDelegatingManager", "DBTraceSpaceBased"]
