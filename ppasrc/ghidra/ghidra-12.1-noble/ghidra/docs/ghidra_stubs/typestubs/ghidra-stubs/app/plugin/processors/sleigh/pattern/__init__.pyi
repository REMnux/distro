...
class PatternBlock(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, list: java.util.ArrayList[typing.Any]) -> None:
        ...
...
__all__ = ["PatternBlock", "DisjointPattern", "Pattern", "CombinePattern", "ContextPattern", "InstructionPattern", "OrPattern"]
