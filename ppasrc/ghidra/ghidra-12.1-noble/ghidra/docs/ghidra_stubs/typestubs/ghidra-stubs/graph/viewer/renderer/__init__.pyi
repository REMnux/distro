...
class MouseDebugPaintable(edu.uci.ics.jung.visualization.VisualizationServer.Paintable):
    ...
    def addShape(self, shape: PaintableShape, graphViewer: ghidra.graph.viewer.GraphViewer[typing.Any, typing.Any]) -> None:
        ...
...
class MouseDraggedPaintableShape(PaintableShape):
    ...
    def __init__(self, start: java.awt.Point, end: java.awt.Point, tx: typing.Union[jpype.JDouble, float], ty: typing.Union[jpype.JDouble, float]) -> None:
        ...
...
class PaintableShape(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, s: java.awt.Shape) -> None:
        ...

    @typing.overload
    def __init__(self, s: java.awt.Shape, c: java.awt.Color) -> None:
        ...

    @typing.overload
    def __init__(self, s: java.awt.Shape, c: java.awt.Color, stroke: java.awt.Stroke) -> None:
        ...
...
class DebugShape(edu.uci.ics.jung.visualization.VisualizationServer.Paintable, typing.Generic[V, E]):
    ...
    def __init__(self, viewer: edu.uci.ics.jung.visualization.VisualizationServer[V, E], drawingIterationCounter: java.util.concurrent.atomic.AtomicInteger, text: typing.Union[java.lang.String, str], shape: java.awt.Shape, color: java.awt.Color) -> None:
        ...
...
class GridPainter(java.lang.Object):
    ...
    def __init__(self, gridCoordinates: ghidra.graph.viewer.layout.GridCoordinates) -> None:
        ...

    def paintLayoutGridCells(self, renderContext: edu.uci.ics.jung.visualization.RenderContext[typing.Any, typing.Any], layout: edu.uci.ics.jung.algorithms.layout.Layout[typing.Any, typing.Any]) -> None:
        ...
...
class MouseClickedPaintableShape(PaintableShape):
    ...
    @typing.overload
    def __init__(self, p: java.awt.Point, tx: typing.Union[jpype.JDouble, float], ty: typing.Union[jpype.JDouble, float]) -> None:
        ...

    @typing.overload
    def __init__(self, p: java.awt.Point, tx: typing.Union[jpype.JDouble, float], ty: typing.Union[jpype.JDouble, float], color: java.awt.Color) -> None:
        ...
...
class VisualGraphEdgeLabelRenderer(edu.uci.ics.jung.visualization.renderers.DefaultEdgeLabelRenderer):
    ...
    def __init__(self, pickedColor: java.awt.Color) -> None:
        ...
...
class VisualGraphRenderer(edu.uci.ics.jung.visualization.renderers.BasicRenderer[V, E], typing.Generic[V, E]):
    ...
    def __init__(self, edgeLabelRenderer: edu.uci.ics.jung.visualization.renderers.Renderer.EdgeLabel[V, E]) -> None:
        ...

    @staticmethod
    def setGridPainter(gridPainter: GridPainter) -> None:
        """
...
__all__ = ["MouseDebugPaintable", "MouseDraggedPaintableShape", "PaintableShape", "MouseDraggedLinePaintableShape", "ArticulatedEdgeRenderer", "DebugShape", "GridPainter", "MouseClickedPaintableShape", "VisualGraphEdgeLabelRenderer", "VisualGraphRenderer", "VisualVertexSatelliteRenderer"]
