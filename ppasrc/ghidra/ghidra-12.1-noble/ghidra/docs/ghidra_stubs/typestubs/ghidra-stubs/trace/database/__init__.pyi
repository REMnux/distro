...
class DBTrace(ghidra.util.database.DBCachedDomainObjectAdapter, ghidra.trace.model.Trace, ghidra.trace.util.TraceChangeManager):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], baseCompilerSpec: ghidra.program.model.lang.CompilerSpec, consumer: java.lang.Object) -> None:
        ...
    ...
    def addDirectChangeListener(self, listener: DBTraceDirectChangeListener) -> None:
        ...

    def assertValidAddress(self, pc: ghidra.program.model.address.Address) -> None:
        ...

    def assertValidSpace(self, as_: ghidra.program.model.address.AddressSpace) -> None:
        ...

    def categoryAdded(self, addedID: typing.Union[jpype.JLong, int], addedCategory: ghidra.program.model.data.Category) -> None:
        ...

    def categoryDeleted(self, deletedID: typing.Union[jpype.JLong, int], deletedPath: ghidra.program.model.data.CategoryPath) -> None:
        ...

    def categoryMoved(self, movedID: typing.Union[jpype.JLong, int], oldPath: ghidra.program.model.data.CategoryPath, newPath: ghidra.program.model.data.CategoryPath) -> None:
        ...

    def categoryRenamed(self, renamedID: typing.Union[jpype.JLong, int], oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        ...

    def dataTypeAdded(self, addedID: typing.Union[jpype.JLong, int], addedType: ghidra.program.model.data.DataType) -> None:
        ...

    def dataTypeChanged(self, changedID: typing.Union[jpype.JLong, int], changedType: ghidra.program.model.data.DataType) -> None:
        ...

    def dataTypeDeleted(self, deletedID: typing.Union[jpype.JLong, int], deletedPath: ghidra.program.model.data.DataTypePath) -> None:
        ...

    def dataTypeMoved(self, movedID: typing.Union[jpype.JLong, int], oldPath: ghidra.program.model.data.DataTypePath, newPath: ghidra.program.model.data.DataTypePath) -> None:
        ...

    def dataTypeNameChanged(self, renamedID: typing.Union[jpype.JLong, int], oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        ...

    def dataTypeReplaced(self, replacedID: typing.Union[jpype.JLong, int], replacedPath: ghidra.program.model.data.DataTypePath, newPath: ghidra.program.model.data.DataTypePath) -> None:
        ...
    ...
    def removeDirectChangeListener(self, listener: DBTraceDirectChangeListener) -> None:
        ...

    def setExecutablePath(self, path: typing.Union[java.lang.String, str]) -> None:
        ...

    def sourceArchiveAdded(self, sourceArchiveID: ghidra.util.UniversalID) -> None:
        ...

    def sourceArchiveChanged(self, sourceArchiveID: ghidra.util.UniversalID) -> None:
        ...

    def updateViewportsSnapshotAdded(self, snapshot: ghidra.trace.model.time.TraceSnapshot) -> None:
        ...

    def updateViewportsSnapshotChanged(self, snapshot: ghidra.trace.model.time.TraceSnapshot) -> None:
        ...

    def updateViewportsSnapshotDeleted(self, snapshot: ghidra.trace.model.time.TraceSnapshot) -> None:
        ...

    def updateViewsAddRegionBlock(self, region: ghidra.trace.model.memory.TraceMemoryRegion) -> None:
        ...

    def updateViewsAddSpaceBlock(self, space: ghidra.program.model.address.AddressSpace) -> None:
        ...

    def updateViewsBytesChanged(self, range: ghidra.program.model.address.AddressRange) -> None:
        ...

    def updateViewsChangeRegionBlockFlags(self, region: ghidra.trace.model.memory.TraceMemoryRegion, lifespan: ghidra.trace.model.Lifespan) -> None:
        ...

    def updateViewsChangeRegionBlockLifespan(self, region: ghidra.trace.model.memory.TraceMemoryRegion, oldLifespan: ghidra.trace.model.Lifespan, newLifespan: ghidra.trace.model.Lifespan) -> None:
        ...

    def updateViewsChangeRegionBlockName(self, region: ghidra.trace.model.memory.TraceMemoryRegion) -> None:
        ...

    def updateViewsChangeRegionBlockRange(self, region: ghidra.trace.model.memory.TraceMemoryRegion, oldRange: ghidra.program.model.address.AddressRange, newRange: ghidra.program.model.address.AddressRange) -> None:
        ...

    def updateViewsDeleteRegionBlock(self, region: ghidra.trace.model.memory.TraceMemoryRegion) -> None:
        ...

    def updateViewsDeleteSpaceBlock(self, space: ghidra.program.model.address.AddressSpace) -> None:
        ...
...
class DBTraceUtils(java.lang.Enum[DBTraceUtils]):
    ...
    class OffsetSnap(java.lang.Object):
        ...
        def __init__(self, offset: typing.Union[jpype.JLong, int], snap: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    class URLDBFieldCodec(ghidra.util.database.DBCachedObjectStoreFactory.AbstractDBFieldCodec[java.net.URL, OT, db.StringField], typing.Generic[OT]):
        ...
        def __init__(self, objectType: java.lang.Class[OT], field: java.lang.reflect.Field, column: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    @staticmethod
    def makeWay(data: DR, span: ghidra.trace.model.Lifespan, lifespanSetter: java.util.function.BiConsumer[DR, ghidra.trace.model.Lifespan], deleter: java.util.function.Consumer[DR]) -> None:
        """
...
class DBTraceDirectChangeListener(java.lang.Object):
    ...
    def changed(self, rec: ghidra.framework.model.DomainObjectChangeRecord) -> None:
        ...
...
class DBTraceUserData(ghidra.framework.data.DomainObjectAdapterDB, ghidra.trace.model.TraceUserData):
    ...
    def __init__(self, dbh: db.DBHandle, trace: DBTrace, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class DBTraceCacheForContainingQueries(java.lang.Object, typing.Generic[K, V, T]):
    ...
    class GetKey(java.lang.Object):
        ...
        def __init__(self, snap: typing.Union[jpype.JLong, int], addr: ghidra.program.model.address.Address) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, snapBreadth: typing.Union[jpype.JInt, int], addressBreadth: typing.Union[jpype.JInt, int], maxPoints: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def notifyEntryRemoved(self, lifespan: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange, item: T) -> None:
        ...

    def notifyEntryShapeChanged(self, lifespan: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange, item: T) -> None:
        ...

    def notifyNewEntries(self, lifespan: ghidra.trace.model.Lifespan, addresses: ghidra.program.model.address.AddressSetView, item: T) -> None:
        ...

    @typing.overload
    def notifyNewEntry(self, lifespan: ghidra.trace.model.Lifespan, address: ghidra.program.model.address.Address, item: T) -> None:
        ...

    @typing.overload
    def notifyNewEntry(self, lifespan: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange, item: T) -> None:
        ...
...
class DBTraceCacheForSequenceQueries(java.lang.Object, typing.Generic[T]):
    ...
    class CachedRegion(java.lang.Object):
        ...
        def __init__(self, snap: typing.Union[jpype.JLong, int], range: ghidra.program.model.address.AddressRange) -> None:
            ...
        ...
        def load(self, entries: java.util.ArrayList[java.util.Map.Entry[ghidra.trace.model.TraceAddressSnapRange, T]]) -> None:
            ...
    ...
    def __init__(self, maxRegions: typing.Union[jpype.JInt, int], addressBreadth: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def notifyNewEntry(self, lifespan: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRangeImpl, item: T) -> None:
        ...
...
__all__ = ["DBTrace", "DBTraceManager", "DBTraceUtils", "DBTraceChangeSet", "DBTraceTimeViewport", "DBTraceDirectChangeListener", "DBTraceUserData", "DBTraceCacheForContainingQueries", "DBTraceCacheForSequenceQueries", "DBTraceContentHandler", "DBTraceLinkContentHandler"]
