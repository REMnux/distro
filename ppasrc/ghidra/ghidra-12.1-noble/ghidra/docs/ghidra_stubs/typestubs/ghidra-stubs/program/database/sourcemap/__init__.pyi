...
class SourceFileManagerDB(ghidra.program.model.sourcemap.SourceFileManager, ghidra.program.database.ManagerDB, db.util.ErrorHandler):
    ...
    def __init__(self, dbh: db.DBHandle, addrMap: ghidra.program.database.map.AddressMapDB, openMode: ghidra.framework.data.OpenMode, lock: ghidra.util.Lock, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Constructor
...
class SourceFile(java.lang.Comparable[SourceFile]):
    ...
    @typing.overload
    def __init__(self, path: typing.Union[java.lang.String, str], type: SourceFileIdType, identifier: jpype.JArray[jpype.JByte]) -> None:
        """
...
class UserDataPathTransformer(ghidra.program.model.sourcemap.SourcePathTransformer, ghidra.framework.model.DomainObjectClosedListener):
    ...
    @staticmethod
    def validateDirectoryPath(directory: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["SourceFileManagerDB", "SourceFileAdapter", "SourceMapAdapter", "SourceFile", "SourceFileIdType", "SourceFileAdapterV0", "SourceMapAdapterV0", "SourceMapEntryDB", "SourceMapEntryIteratorDB", "UserDataPathTransformer"]
