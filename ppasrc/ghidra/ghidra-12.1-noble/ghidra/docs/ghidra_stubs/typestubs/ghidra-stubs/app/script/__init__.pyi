...
class DecoratingPrintWriter(java.io.PrintWriter):
    """
    ...
    def print(self, s: typing.Union[java.lang.String, str], c: java.awt.Color) -> None:
        """
        Print text with the given color.
        
        :param java.lang.String or str s: the text
        :param java.awt.Color c: the color
        """

    def println(self, s: typing.Union[java.lang.String, str], c: java.awt.Color) -> None:
        """
...
class ResourceFileJavaFileObject(javax.tools.JavaFileObject):
    ...
    def __init__(self, sourceRoot: generic.jar.ResourceFile, file: generic.jar.ResourceFile, kind: javax.tools.JavaFileObject.Kind) -> None:
        """
...
class ScriptInfo(java.lang.Object):
    ...
    def setCompileErrors(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setDuplicate(self, isDuplicate: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class GhidraScriptProvider(ghidra.util.classfinder.ExtensionPoint, java.lang.Comparable[GhidraScriptProvider]):
    ...
    **NOTE:** ALL GhidraScriptProvider CLASSES MUST END IN "ScriptProvider". If not, the
    ...
    def createNewScript(self, newScript: generic.jar.ResourceFile, category: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def getScriptInstance(self, sourceFile: generic.jar.ResourceFile, errorWriter: java.io.PrintWriter) -> GhidraScript:
        """
        Returns a GhidraScript instance for the specified source file.
        
        :param generic.jar.ResourceFile sourceFile: the source file
        :param java.io.PrintWriter errorWriter: the print writer to write warning/error messages. If the error prevents
...
class GhidraScript(ghidra.program.flatapi.FlatProgramAPI):
    ...
    **************************
    ...
    def cleanup(self, success: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    @deprecated("Use execute(GhidraState, ScriptControls) instead to also set a \n   PrintWriter for ")
    def execute(self, runState: GhidraState, runMonitor: ghidra.util.task.TaskMonitor, runWriter: java.io.PrintWriter) -> None:
        """
        Execute/run script and :obj:`.doCleanup` afterwards.
         
        
        This method will use the given :obj:`PrintWriter` for both ``stdout`` and 
        ``stderr``.
        
        :param GhidraState runState: state object
        :param ghidra.util.task.TaskMonitor runMonitor: the monitor to use during run
        :param java.io.PrintWriter runWriter: the target of script "print" statements (may be null)
        :raises java.lang.Exception: if the script excepts
        
        .. deprecated::
        
        Use :meth:`execute(GhidraState, ScriptControls) <.execute>` instead to also set a 
        :obj:`PrintWriter` for ``stderr``
        """

    @typing.overload
    def execute(self, runState: GhidraState, runControls: ScriptControls) -> None:
        """
        Execute/run script with the given :obj:`state <GhidraState>` and 
        :obj:`controls <ScriptControls>` and :obj:`.doCleanup` afterwards. 
         
        
        NOTE: This method is not intended to be called by script writers.
        
        :param GhidraState runState: state object
        :param ScriptControls runControls: controls object
        :raises java.lang.Exception: if the script excepts
        """
    ...
    def getControls(self) -> ScriptControls:
        """
        :return: the current script controls
        :rtype: ScriptControls
        """
    ...
    @deprecated("Use DemanglerUtil.demangle(Program, String, Address) instead")
    def getDemangled(self, mangled: typing.Union[java.lang.String, str]) -> str:
        ...
        Use :meth:`DemanglerUtil.demangle(Program, String, Address) <DemanglerUtil.demangle>` instead
        """
    ...
    def importFile(self, file: jpype.protocol.SupportsPath) -> ghidra.program.model.listing.Program:
        ...
        null is returned.  For more control over the import process, :obj:`ProgramLoader` may be
        directly used.
    ...
    def importFileAsBinary(self, file: jpype.protocol.SupportsPath, language: ghidra.program.model.lang.Language, compilerSpec: ghidra.program.model.lang.CompilerSpec) -> ghidra.program.model.listing.Program:
        ...
        :obj:`ProgramLoader` may be directly used.
    ...
    def popup(self, message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def print(self, message: typing.Union[java.lang.String, str], color: java.awt.Color) -> None:
        """
        Prints the undecorated message with no newline to this script's ``stdout`` 
        :obj:`PrintWriter`, which is set by :meth:`set(GhidraState, ScriptControls) <.set>`.
        ...
        :param java.awt.Color color: the color for the text
        """

    @typing.overload
    def print(self, message: typing.Union[java.lang.String, str]) -> None:
        """
        Prints the undecorated message with no newline to this script's ``stdout`` 
        :obj:`PrintWriter`, which is set by :meth:`set(GhidraState, ScriptControls) <.set>`.
    ...
    def printerr(self, message: typing.Union[java.lang.String, str]) -> None:
        """
        Prints the :obj:`optionally <.decorateOutput>` :meth:`decorated <.decorate>` message
        followed by a line feed to this script's ``stderr`` :obj:`PrintWriter`, which is set by 
        :meth:`set(GhidraState, ScriptControls) <.set>`.
         
        
        Additionally, the always :meth:`decorated <.decorate>` message is written to Ghidra's 
        log as an error.
        
        :param java.lang.String or str message: the message to print
        """

    def printf(self, message: typing.Union[java.lang.String, str], *args: java.lang.Object) -> None:
        """
        Prints the undecorated :obj:`formatted message <java.util.Formatter>` to this script's 
        ``stdout`` :obj:`PrintWriter`, which is set by 
        :meth:`set(GhidraState, ScriptControls) <.set>`.
        ...
        :param jpype.JArray[java.lang.Object] args: C-like ``printf`` formatter arguments
        """

    @typing.overload
    def println(self) -> None:
        """
        Prints a newline to this script's ``stdout`` :obj:`PrintWriter`, which is set by 
        :meth:`set(GhidraState, ScriptControls) <.set>`.
    ...
    @typing.overload
    def println(self, message: typing.Union[java.lang.String, str]) -> None:
        """
        Prints the :obj:`optionally <.decorateOutput>` :meth:`decorated <.decorate>` message
        followed by a line feed to this script's ``stdout`` :obj:`PrintWriter`, which is set by 
        :meth:`set(GhidraState, ScriptControls) <.set>`.
    ...
    @typing.overload
    def println(self, message: typing.Union[java.lang.String, str], color: java.awt.Color) -> None:
        """
        Prints the :obj:`optionally <.decorateOutput>` :meth:`decorated <.decorate>` message
        followed by a line feed to this script's ``stdout`` :obj:`PrintWriter`, which is set by 
        :meth:`set(GhidraState, ScriptControls) <.set>`.
    ...
    def resetAnalysisOption(self, program: ghidra.program.model.listing.Program, analysisOption: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def resetAnalysisOptions(self, program: ghidra.program.model.listing.Program, analysisOptions: java.util.List[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def runScript(self, scriptName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def runScript(self, scriptName: typing.Union[java.lang.String, str], scriptArguments: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def runScript(self, scriptName: typing.Union[java.lang.String, str], scriptState: GhidraState) -> None:
        """
    ...
    @typing.overload
    def runScript(self, scriptName: typing.Union[java.lang.String, str], scriptArguments: jpype.JArray[java.lang.String], scriptState: GhidraState) -> None:
        """
    ...
    @typing.overload
    @deprecated("Use set(GhidraState) or set(GhidraState, ScriptControls)\n   instead")
    def set(self, state: GhidraState, monitor: ghidra.util.task.TaskMonitor, writer: java.io.PrintWriter) -> None:
        """
        ...
        :param java.io.PrintWriter writer: the target of script "print" statements (may be null)
        
        .. deprecated::
        
        Use :meth:`set(GhidraState) <.set>` or :meth:`set(GhidraState, ScriptControls) <.set>`
        instead
        """

    @typing.overload
    def set(self, state: GhidraState) -> None:
        """
        Set the context for this script.
        
        :param GhidraState state: the new state
        """

    @typing.overload
    def set(self, state: GhidraState, controls: ScriptControls) -> None:
        """
        Set the state and controls for this script.
        
        :param GhidraState state: the new state
        :param ScriptControls controls: new the controls
        """

    def setAnalysisOption(self, program: ghidra.program.model.listing.Program, optionName: typing.Union[java.lang.String, str], optionValue: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setAnalysisOptions(self, program: ghidra.program.model.listing.Program, analysisSettings: collections.abc.Mapping) -> None:
        """
    ...
    def setPotentialPropertiesFileLocations(self, locations: java.util.List[generic.jar.ResourceFile]) -> None:
        """
    ...
    def setPropertiesFile(self, propertiesFile: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def setPropertiesFileLocation(self, dirLocation: typing.Union[java.lang.String, str], basename: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setReusePreviousChoices(self, reuse: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setScriptArgs(self, scriptArgs: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    def setToolStatusMessage(self, msg: typing.Union[java.lang.String, str], beep: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def show(self, addresses: jpype.JArray[ghidra.program.model.address.Address]) -> None:
        """
    ...
    @typing.overload
    def show(self, title: typing.Union[java.lang.String, str], addresses: ghidra.program.model.address.AddressSetView) -> None:
        """
    ...
    @property
    def controls(self) -> ScriptControls:
        ...
...
class GhidraState(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, project: ghidra.framework.model.Project, program: ghidra.program.model.listing.Program, location: ghidra.program.util.ProgramLocation, selection: ghidra.program.util.ProgramSelection, highlight: ghidra.program.util.ProgramSelection) -> None:
        """
    ...
    @typing.overload
    def __init__(self, state: GhidraState) -> None:
        ...

    @typing.overload
    def addEnvironmentVar(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JByte, int]) -> None:
        ...

    @typing.overload
    def addEnvironmentVar(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JShort, int]) -> None:
        ...

    @typing.overload
    def addEnvironmentVar(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def addEnvironmentVar(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def addEnvironmentVar(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JFloat, float]) -> None:
        ...

    @typing.overload
    def addEnvironmentVar(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JDouble, float]) -> None:
        ...

    @typing.overload
    def addEnvironmentVar(self, name: typing.Union[java.lang.String, str], value: java.lang.Object) -> None:
        ...
    ...
    def removeEnvironmentVar(self, name: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ScriptControls(java.lang.Object):
    """
    Class to encapsulate :obj:`GhidraScript` control mechanisms such as stdout/stderr writers and
    other feedback to the user
    """

    class_: typing.ClassVar[java.lang.Class]
    NONE: typing.Final[ScriptControls]
    """
    A :obj:`ScriptControls` that does nothing
    """


    @typing.overload
    def __init__(self, writer: java.io.PrintWriter, errorWriter: java.io.PrintWriter, decorateOutput: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Creates a new :obj:`ScriptControls`
        
        :param java.io.PrintWriter writer: The target of script "print" statements (may be null)
        :param java.io.PrintWriter errorWriter: The target of script "printerr" statements (may be null)
        :param jpype.JBoolean or bool decorateOutput: True to decorate the writer output with a script name prefix; 
        otherwise, false (see :meth:`GhidraScript.decorate(String) <GhidraScript.decorate>`
        :param ghidra.util.task.TaskMonitor monitor: A cancellable monitor
        """

    @typing.overload
    def __init__(self, writer: java.io.PrintWriter, errorWriter: java.io.PrintWriter, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Creates a new :obj:`ScriptControls` with no decorated output
    ...
    @typing.overload
    def __init__(self, stream: java.io.OutputStream, errorStream: java.io.OutputStream, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Creates a new :obj:`ScriptControls` with no decorated output
        
        :param java.io.OutputStream stream: The target of script "print" statements (may be null)
        :param java.io.OutputStream errorStream: The target of script "printerr" statements (may be null)
        otherwise, false (see :meth:`GhidraScript.decorate(String) <GhidraScript.decorate>`
        :param ghidra.util.task.TaskMonitor monitor: A cancellable monitor
        """

    @typing.overload
    def __init__(self, console: ghidra.app.services.ConsoleService, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Creates a new :obj:`ScriptControls` with no decorated output
        
        :param ghidra.app.services.ConsoleService console: The target of script "print" and "printerr" statements
        :param ghidra.util.task.TaskMonitor monitor: A cancellable monitor
        """

    @typing.overload
    def __init__(self, console: ghidra.app.plugin.core.interpreter.InterpreterConsole, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Creates a new :obj:`ScriptControls` with no decorated output
        
        :param ghidra.app.plugin.core.interpreter.InterpreterConsole console: The target of script "print" and "printerr" statements
        :param ghidra.util.task.TaskMonitor monitor: A cancellable monitor
        """

    def getErrorWriter(self) -> java.io.PrintWriter:
        """
    ...
    def shouldDecorateOutput(self) -> bool:
        """
        ...
        .. seealso::
            ...
            | :obj:`GhidraScript.decorate(String)`
        """

    @property
    def errorWriter(self) -> java.io.PrintWriter:
        ...
...
class AskDialog(docking.DialogComponentProvider, typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, dialogTitle: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str], type: typing.Union[jpype.JInt, int], defaultValue: java.lang.Object) -> None:
        ...

    @typing.overload
    def __init__(self, parent: java.awt.Component, title: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str], type: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, parent: java.awt.Component, title: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str], type: typing.Union[jpype.JInt, int], choices: java.util.List[T], defaultValue: java.lang.Object) -> None:
        ...
...
class GhidraScriptUtil(java.lang.Object):
    ...
    def getProviders() -> java.util.List[GhidraScriptProvider]:
        ...
        NOTE: The list is :meth:`priority-sorted <ExtensionPointProperties.priority>`
        ...
        .. admonition:: API Note
            ...
            this method is synchronized so that two threads do not try to create the list when 
            null
        """
...
class JythonStubScriptProvider(AbstractPythonScriptProvider):
    """
    A stub :obj:`GhidraScriptProvider` used to give feedback to a user trying to run a Jython
    script when the Jython Extension is not installed.
     
    
    Uses a sub-:obj:`default <ExtensionPointProperties.DEFAULT_PRIORITY>` priority so the Jython 
    Extension can get prioritized over this if it's installed.
    """

    class JythonStubException(GhidraScriptLoadException):
        """
        A special type of :obj:`GhidraScriptLoadException` used to indicate that the Jython
        ...
        def __init__(self) -> None:
            """
            Construct an new :obj:`JythonStubException`
            """
...
class SelectAllCheckBox(java.awt.event.ActionListener):
    ...
    def addCheckBox(self, newCB: javax.swing.JCheckBox) -> None:
        ...

    def setSelectAllCheckBox(self, selAllCB: javax.swing.JCheckBox) -> None:
        ...
...
class ResourceFileJavaFileManager(javax.tools.JavaFileManager):
    ...
    def __init__(self, sourceDirs: java.util.List[generic.jar.ResourceFile], filesToAvoid: java.util.Set[generic.jar.ResourceFile]) -> None:
        """
...
class ScriptMessage(org.apache.logging.log4j.message.StringFormattedMessage):
    """
    ...
    NOTE: :meth:`Message.getFormat() <Message.getFormat>` was deprecated in log4j 2.24.0, and the behavior of 
    ``useRawMsg`` changed to only work with certain classes that implement the :obj:`Message`
    interface, such as :obj:`StringFormattedMessage`. Implementing our own :obj:`Message`
    resulted in ``useRawMsg`` not calling :meth:`getFormat() <.getFormat>`. See
    `logging-log4j2/pull/2773 <https://github.com/apache/logging-log4j2/pull/2773>`_ for
    more info.
    """
...
class SelectLanguageDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], approveButtonText: typing.Union[java.lang.String, str]) -> None:
        ...
...
class UnsupportedScriptProvider(GhidraScriptProvider):
    ...
    @typing.overload
    def __init__(self, baseProvider: GhidraScriptProvider) -> None:
        """
...
__all__ = ["DecoratingPrintWriter", "ResourceFileJavaFileObject", "GhidraScriptInfoManager", "ScriptInfo", "GhidraScriptProvider", "GhidraScript", "GhidraScriptLoadException", "GhidraState", "GhidraScriptProperties", "ScriptControls", "ImproperUseException", "StringTransformer", "AbstractPythonScriptProvider", "AskDialog", "GhidraScriptConstants", "GhidraScriptUnsupportedClassVersionError", "GhidraScriptUtil", "JavaScriptProvider", "JythonStubScriptProvider", "MultipleOptionsDialog", "SelectAllCheckBox", "ResourceFileJavaFileManager", "ScriptMessage", "SelectLanguageDialog", "UnsupportedScriptProvider"]
