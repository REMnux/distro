...
class HelpModuleCollection(help.TOCItemProvider):
    ...
    **external, pre-built** help sources (i.e., jar file or directory).
    ...
    def addGeneratedHelpLocation(self, file: jpype.protocol.SupportsPath) -> None:
        ...
...
__all__ = ["HelpModuleCollection", "HelpModuleLocation", "DirectoryHelpModuleLocation", "GeneratedDirectoryHelpModuleLocation", "JarHelpModuleLocation"]
