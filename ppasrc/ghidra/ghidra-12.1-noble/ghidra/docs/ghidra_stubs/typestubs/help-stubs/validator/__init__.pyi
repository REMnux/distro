...
class LinkDatabase(java.lang.Object):
    ...
    def __init__(self, helpCollection: help.validator.location.HelpModuleCollection) -> None:
        ...

    def generateTOCOutputFile(self, outputFile: jpype.protocol.SupportsPath, file: help.validator.model.GhidraTOCFile) -> None:
        ...
...
class AnchorManager(java.lang.Object):
    ...
    def addAnchor(self, file: jpype.protocol.SupportsPath, anchorName: typing.Union[java.lang.String, str], srcLineNo: typing.Union[jpype.JInt, int]) -> None:
        ...

    def addAnchorRef(self, href: help.validator.model.HREF) -> None:
        ...

    def addImageRef(self, ref: help.validator.model.IMG) -> None:
        ...
...
class TagProcessor(java.lang.Object):
    ...
    def startOfFile(self, htmlFile: jpype.protocol.SupportsPath) -> None:
        ...
...
class HTMLFileParser(java.lang.Object):
    ...
    @staticmethod
    def scanHtmlFile(file: jpype.protocol.SupportsPath, tagProcessor: TagProcessor) -> None:
        ...
...
class JavaHelpValidator(java.lang.Object):
    ...
    def __init__(self, moduleName: typing.Union[java.lang.String, str], help: help.validator.location.HelpModuleCollection) -> None:
        ...

    def setDebugEnabled(self, debug: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ReferenceTagProcessor(TagProcessor):
    ...
    def __init__(self, help: help.validator.location.HelpModuleLocation, anchorManager: AnchorManager) -> None:
        ...
...
class UnusedHelpImageFileFinder(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, helpCollections: collections.abc.Sequence) -> None:
        ...

    @typing.overload
    def __init__(self, helpCollections: collections.abc.Sequence, debugEnabled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["LinkDatabase", "DuplicateAnchorCollection", "AnchorManager", "TagProcessor", "DuplicateAnchorCollectionByHelpFile", "DuplicateAnchorCollectionByHelpTopic", "HTMLFileParser", "JavaHelpValidator", "ReferenceTagProcessor", "UnusedHelpImageFileFinder"]
