...
class WizardDialog(docking.DialogComponentProvider):
    ...
    @typing.overload
    def __init__(self, model: WizardModel[typing.Any]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, model: WizardModel[typing.Any], modal: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class WizardStep(java.lang.Object, typing.Generic[T]):
    ...
    * isApplicable(T data) - this method is called to see if a step is applicable based
    ...
    def populateData(self, data: T) -> None:
        """
...
__all__ = ["WizardDialog", "WizardModel", "WizardStep"]
