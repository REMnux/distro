...
class DragDropManager(java.lang.Object):
    ...
    def add(self, destNode: DragDropNode, data: java.lang.Object, chosen: java.awt.datatransfer.DataFlavor, dropAction: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def move(self, sourceNodes: jpype.JArray[DragDropNode]) -> None:
        """
...
class DragDropTableSelectionMouseListener(java.awt.event.MouseAdapter):
    ...
    def __init__(self, table: docking.widgets.table.GTable) -> None:
        ...
...
class DragDropTreeTransferable(java.awt.datatransfer.Transferable, java.awt.datatransfer.ClipboardOwner):
    ...
    def __init__(self, nodes: jpype.JArray[DragDropNode]) -> None:
        """
...
class DragGestureAdapter(java.awt.dnd.DragGestureListener):
    ...
    def __init__(self, dragComponent: Draggable) -> None:
        """
...
class Draggable(java.lang.Object):
    ...
    def dragFinished(self, cancelled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DropTgtAdapter(java.awt.dnd.DropTargetListener):
    ...
    def __init__(self, dropComponent: Droppable, acceptableDropActions: typing.Union[jpype.JInt, int], acceptableDropFlavors: jpype.JArray[java.awt.datatransfer.DataFlavor]) -> None:
        """
        Constructor
    ...
    def setAcceptableDropFlavors(self, dropFlavors: jpype.JArray[java.awt.datatransfer.DataFlavor]) -> None:
        """
...
class Droppable(java.lang.Object):
    ...
    def add(self, obj: java.lang.Object, e: java.awt.dnd.DropTargetDropEvent, f: java.awt.datatransfer.DataFlavor) -> None:
        """
...
class GTableDragProvider(java.awt.dnd.DragSourceListener, java.awt.dnd.DragGestureListener, typing.Generic[ROW_OBJECT]):
    ...
    def __init__(self, table: docking.widgets.table.GTable, model: docking.widgets.table.RowObjectTableModel[ROW_OBJECT]) -> None:
        ...
...
class GenericDataFlavor(java.awt.datatransfer.DataFlavor):
    ...
    @typing.overload
    def __init__(self, representationClass: java.lang.Class[typing.Any], humanPresentableName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, mimeType: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, mimeType: typing.Union[java.lang.String, str], humanPresentableName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, mimeType: typing.Union[java.lang.String, str], humanPresentableName: typing.Union[java.lang.String, str], classLoader: java.lang.ClassLoader) -> None:
        """
        Construct a GenericDataFlavor that represents a MimeType 
        If the mimeType is 
        ``"application/x-java-serialized-object; class=<representation class>", the result is the same as calling new GenericDataFlavor(Class:forName(<representation class>).``
...
class ImageTransferable(java.awt.datatransfer.Transferable):
    ...
    def __init__(self, img: java.awt.Image) -> None:
        ...
...
class StringTransferable(java.awt.datatransfer.Transferable):
    ...
    def __init__(self, data: typing.Union[java.lang.String, str]) -> None:
        ...

    def removeOuterQuotesAndStandardStringPrefix(self) -> None:
        """
...
__all__ = ["DragDropManager", "DragDropNode", "DragDropTableSelectionMouseListener", "DragDropTreeTransferable", "DragGestureAdapter", "Draggable", "DragSrcAdapter", "DropTgtAdapter", "Droppable", "GClipboard", "GTableDragProvider", "GenericDataFlavor", "ImageTransferable", "StringTransferable"]
