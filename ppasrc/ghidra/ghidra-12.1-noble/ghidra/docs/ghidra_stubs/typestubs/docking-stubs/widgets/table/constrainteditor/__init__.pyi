...
class ColumnConstraintEditor(java.lang.Object, typing.Generic[T]):
    ...
    def addChangeListener(self, constraintEditorChangeListener: javax.swing.event.ChangeListener) -> None:
        """
    ...
    def removeChangeListener(self, constraintEditorChangeListener: javax.swing.event.ChangeListener) -> None:
        """
    ...
    def setValue(self, value: docking.widgets.table.constraint.ColumnConstraint[T]) -> None:
        """
...
class AutocompletingStringConstraintEditor(DataLoadingConstraintEditor[java.lang.String]):
    ...
    class AutocompleteDataModel(docking.widgets.DropDownTextFieldDataModel[java.lang.String]):
        ...
        def collect(self, value: typing.Union[java.lang.String, str]) -> None:
            ...

        def loadCancelled(self) -> None:
            ...
    ...
    class AutocompleteListCellRenderer(docking.widgets.list.GListCellRenderer[java.lang.String]):
        ...
        def __init__(self, autocompleteDataModel: AutocompletingStringConstraintEditor.AutocompleteDataModel) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, constraint: docking.widgets.table.constraint.StringColumnConstraint, columnDataSource: docking.widgets.table.constraint.ColumnData[java.lang.String]) -> None:
        """
        Constructor.
...
class DataLoadingConstraintEditor(AbstractColumnConstraintEditor[T], ghidra.util.task.TaskListener, typing.Generic[T]):
    ...
    def __init__(self, delegateConstraint: docking.widgets.table.constraint.ColumnConstraint[T], columnDataSource: docking.widgets.table.constraint.ColumnData[T]) -> None:
        """
        Constructor.
...
class BooleanConstraintEditor(AbstractColumnConstraintEditor[java.lang.Boolean]):
    ...
    def __init__(self, constraint: docking.widgets.table.constraint.BooleanMatchColumnConstraint) -> None:
        """
        Constructor.
...
class BoundedSpinnerNumberModel(javax.swing.SpinnerNumberModel):
    ...
    @typing.overload
    def __init__(self, value: java.lang.Number, minimum: java.lang.Comparable[java.lang.Number], maximum: java.lang.Comparable[java.lang.Number], stepSize: java.lang.Number) -> None:
        ...

    @typing.overload
    def __init__(self, value: typing.Union[jpype.JInt, int], minimum: typing.Union[jpype.JInt, int], maximum: typing.Union[jpype.JInt, int], stepSize: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, value: typing.Union[jpype.JDouble, float], minimum: typing.Union[jpype.JDouble, float], maximum: typing.Union[jpype.JDouble, float], stepSize: typing.Union[jpype.JDouble, float]) -> None:
        ...
...
class DateRangeConstraintEditor(AbstractColumnConstraintEditor[java.time.LocalDate]):
    ...
    def __init__(self, constraint: docking.widgets.table.constraint.ColumnConstraint[java.time.LocalDate]) -> None:
        """
        Constructor.
...
class DateSpinner(java.lang.Object):
    ...
    def __init__(self, spinnerModel: LocalDateSpinnerModel, pattern: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setValue(self, newValue: java.time.LocalDate) -> None:
        """
...
class LocalDateSpinnerModel(javax.swing.AbstractSpinnerModel):
    ...
    def __init__(self, value: java.time.LocalDate, minDate: java.time.LocalDate, maxDate: java.time.LocalDate, calendarField: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
    ...
    def setCalendarField(self, calendarField: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DoNothingColumnConstraintEditor(AbstractColumnConstraintEditor[T], typing.Generic[T]):
    ...
    def __init__(self, constraint: docking.widgets.table.constraint.ColumnConstraint[T]) -> None:
        ...
...
class DoubleRangeConstraintEditor(AbstractColumnConstraintEditor[java.lang.Double]):
    ...
    def __init__(self, constraint: docking.widgets.table.constraint.ColumnConstraint[java.lang.Double]) -> None:
        """
        Constructor.
...
class EnumConstraintEditor(AbstractColumnConstraintEditor[T], typing.Generic[T]):
    ...
    def __init__(self, constraint: docking.widgets.table.constraint.EnumColumnConstraint[T]) -> None:
        """
        Constructor.
...
class IntegerConstraintEditor(AbstractColumnConstraintEditor[T], typing.Generic[T]):
    ...
    def __init__(self, constraint: docking.widgets.table.constraint.ColumnConstraint[T], converter: LongConverter[T]) -> None:
        """
        Constructor.
...
class MappedColumnConstraintEditor(ColumnConstraintEditor[T], typing.Generic[T, M]):
    ...
    def __init__(self, constraint: docking.widgets.table.constraint.MappedColumnConstraint[T, M], delegateEditor: ColumnConstraintEditor[M]) -> None:
        """
        Constructor.
...
class StringConstraintEditor(AbstractColumnConstraintEditor[java.lang.String]):
    ...
    def __init__(self, constraint: docking.widgets.table.constraint.StringColumnConstraint, errorMessage: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor.
...
class UnsignedLongConstraintEditor(AbstractColumnConstraintEditor[java.math.BigInteger]):
    ...
    def __init__(self, constraint: docking.widgets.table.constraint.ColumnConstraint[java.math.BigInteger]) -> None:
        """
        Constructor.
...
__all__ = ["ColumnConstraintEditor", "LongConverter", "AbstractColumnConstraintEditor", "AutocompletingStringConstraintEditor", "DataLoadingConstraintEditor", "BooleanConstraintEditor", "BoundedSpinnerNumberModel", "DateRangeConstraintEditor", "DateSpinner", "LocalDateSpinnerModel", "DateValueConstraintEditor", "DoNothingColumnConstraintEditor", "DoubleRangeConstraintEditor", "DoubleValueConstraintEditor", "DummyConstraintEditor", "EnumConstraintEditor", "IntegerConstraintEditor", "IntegerRangeConstraintEditor", "MappedColumnConstraintEditor", "StringConstraintEditor", "UnsignedLongConstraintEditor", "UnsignedLongConstraintEditorProvider", "UnsignedLongRangeConstraintEditor", "UnsignedLongRangeEditorProvider"]
