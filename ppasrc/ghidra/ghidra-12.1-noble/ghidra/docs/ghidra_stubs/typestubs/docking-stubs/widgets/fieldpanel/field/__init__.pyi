...
class Field(java.lang.Object):
    ...
    def rowHeightChanged(self, heightAbove: typing.Union[jpype.JInt, int], heightBelow: typing.Union[jpype.JInt, int]) -> None:
        """
...
class FieldElement(java.lang.Object):
    ...
    def paint(self, c: javax.swing.JComponent, g: java.awt.Graphics, x: typing.Union[jpype.JInt, int], y: typing.Union[jpype.JInt, int]) -> None:
        """
...
class AttributedString(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, text: typing.Union[java.lang.String, str], textColor: java.awt.Color, fontMetrics: java.awt.FontMetrics) -> None:
        """
    ...
    @typing.overload
    def __init__(self, text: typing.Union[java.lang.String, str], textColor: java.awt.Color, fontMetrics: java.awt.FontMetrics, underline: typing.Union[jpype.JBoolean, bool], underlineColor: java.awt.Color) -> None:
        """
        Creates an attributed string with the given text, color and metrics with
    ...
    @typing.overload
    def __init__(self, icon: javax.swing.Icon, text: typing.Union[java.lang.String, str], textColor: java.awt.Color, fontMetrics: java.awt.FontMetrics, underline: typing.Union[jpype.JBoolean, bool], underlineColor: java.awt.Color) -> None:
        """
...
class ClippingTextField(TextField):
    ...
    @typing.overload
    def __init__(self, startX: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], textElement: FieldElement, hlFactory: docking.widgets.fieldpanel.support.FieldHighlightFactory) -> None:
        """
    ...
    @typing.overload
    def __init__(self, startX: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], textElement: FieldElement, numDataRows: typing.Union[jpype.JInt, int], hlFactory: docking.widgets.fieldpanel.support.FieldHighlightFactory) -> None:
        """
        Constructs a new ClippingTextField that allows the cursor beyond the end
        of the line.
...
class TextField(Field):
    ...
    def setPrimary(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class CompositeAttributedString(AttributedString):
    ...
    @typing.overload
    def __init__(self, stringList: java.util.List[AttributedString]) -> None:
        ...

    @typing.overload
    def __init__(self, *attributedStrings: AttributedString) -> None:
        ...
...
class CompositeFieldElement(FieldElement):
    ...
    @typing.overload
    def __init__(self, elements: java.util.List[FieldElement]) -> None:
        ...

    @typing.overload
    def __init__(self, fieldElements: jpype.JArray[FieldElement]) -> None:
        ...
...
class CompositeVerticalLayoutTextField(TextField):
    ...
    def __init__(self, fields: java.util.List[TextField], startX: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], maxLines: typing.Union[jpype.JInt, int], hlFactory: docking.widgets.fieldpanel.support.FieldHighlightFactory) -> None:
        ...
...
class EmptyTextField(Field):
    ...
    def __init__(self, heightAbove: typing.Union[jpype.JInt, int], heightBelow: typing.Union[jpype.JInt, int], startX: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setPrimary(self, state: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class FlowLayoutTextField(VerticalLayoutTextField):
    ...
    def __init__(self, textElements: jpype.JArray[FieldElement], startX: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], maxLines: typing.Union[jpype.JInt, int], hlFactory: docking.widgets.fieldpanel.support.FieldHighlightFactory) -> None:
        """
    ...
    @typing.overload
    def __init__(self, elements: java.util.List[FieldElement], startX: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], maxLines: typing.Union[jpype.JInt, int], hlFactory: docking.widgets.fieldpanel.support.FieldHighlightFactory) -> None:
        """
        This constructor will create a text field that will render one line of text. If
        ``metrics.stringWidth(text) > width``, then the text will be wrapped.
        If ``text`` contains the highlight string, then it will be highlighted using the
...
class VerticalLayoutTextField(TextField):
    ...
    @typing.overload
    def __init__(self, textElements: java.util.List[FieldElement], startX: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], maxLines: typing.Union[jpype.JInt, int], hlFactory: docking.widgets.fieldpanel.support.FieldHighlightFactory) -> None:
        """
        This constructor will create a text field from an array of FieldElements, putting each
        element on its own line.
...
class SimpleImageField(Field):
    ...
    @typing.overload
    def __init__(self, icon: javax.swing.Icon, metrics: java.awt.FontMetrics, startX: typing.Union[jpype.JInt, int], startY: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, icon: javax.swing.Icon, metrics: java.awt.FontMetrics, startX: typing.Union[jpype.JInt, int], startY: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], center: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new field for displaying an image.
...
class SimpleTextField(Field):
    ...
    def __init__(self, text: typing.Union[java.lang.String, str], fontMetrics: java.awt.FontMetrics, startX: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], allowCursorAtEnd: typing.Union[jpype.JBoolean, bool], hlFactory: docking.widgets.fieldpanel.support.FieldHighlightFactory) -> None:
        """
...
class StrutFieldElement(FieldElement):
    ...
    def __init__(self, baseElement: FieldElement, width: typing.Union[jpype.JInt, int]) -> None:
        """
...
class TextFieldElement(AbstractTextFieldElement):
    ...
    def __init__(self, attributedString: AttributedString, row: typing.Union[jpype.JInt, int], column: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class WrappingVerticalLayoutTextField(VerticalLayoutTextField):
    ...
    @typing.overload
    def __init__(self, textElement: FieldElement, startX: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], maxLines: typing.Union[jpype.JInt, int], hlFactory: docking.widgets.fieldpanel.support.FieldHighlightFactory) -> None:
        """
    ...
    @typing.overload
    def __init__(self, textElement: FieldElement, startX: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], maxLines: typing.Union[jpype.JInt, int], hlFactory: docking.widgets.fieldpanel.support.FieldHighlightFactory, breakOnWhiteSpace: typing.Union[jpype.JBoolean, bool], rowSeparator: typing.Union[java.lang.String, str]) -> None:
        """
        This constructor will create a text field from an single AttributedString.  The string will
        be word wrapped.
        ...
        :param java.lang.String or str rowSeparator: The string used to space lines of text when concatenated by the
                getText() method.
        """



__all__ = ["Field", "AbstractTextFieldElement", "FieldElement", "AttributedString", "ClippingTextField", "TextField", "CompositeAttributedString", "CompositeFieldElement", "CompositeVerticalLayoutTextField", "EmptyTextField", "FlowLayoutTextField", "VerticalLayoutTextField", "ReverseClippingTextField", "SimpleImageField", "SimpleTextField", "StrutFieldElement", "TextFieldElement", "WrappingVerticalLayoutTextField"]
