...
class LayoutModelListener(java.lang.Object):
    ...
    def dataChanged(self, start: java.math.BigInteger, end: java.math.BigInteger) -> None:
        """
    ...
    def modelSizeChanged(self, indexMapper: IndexMapper) -> None:
        """
...
class FieldInputListener(java.lang.Object):
    ...
    def keyPressed(self, ev: java.awt.event.KeyEvent, index: java.math.BigInteger, fieldNum: typing.Union[jpype.JInt, int], row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], field: docking.widgets.fieldpanel.field.Field) -> None:
        """
...
class LayoutListener(java.lang.Object):
    ...
    def layoutsChanged(self, layouts: java.util.List[docking.widgets.fieldpanel.support.AnchoredLayout]) -> None:
        ...
...
class ViewListener(java.lang.Object):
    ...
    def viewChanged(self, fp: docking.widgets.fieldpanel.FieldPanel, index: java.math.BigInteger, xOffset: typing.Union[jpype.JInt, int], yOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class FieldListener(java.lang.Object):
    ...
    def dataChanged(self, min: typing.Union[jpype.JInt, int], max: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def widthChanged(self, width: typing.Union[jpype.JInt, int]) -> None:
        """
...
class FieldOverlayListener(java.lang.Object):
    ...
    def fieldOverlayRemoved(self, comp: javax.swing.JComponent) -> None:
        """
...
__all__ = ["LayoutModelListener", "FieldMouseListener", "FieldInputListener", "FieldLocationListener", "LayoutListener", "ViewListener", "FieldSelectionListener", "IndexMapper", "FieldListener", "FieldOverlayListener"]
