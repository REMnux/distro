...
class GhidraFileChooser(docking.ReusableDialogComponentProvider, java.io.FileFilter):
    ...
    class UpdateMyComputerJob(GhidraFileChooser.FileChooserJob):
        ...
        def __init__(self, myComputerFile: jpype.protocol.SupportsPath, forceUpdate: typing.Union[jpype.JBoolean, bool], addToHistory: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    class FileList(java.lang.Object):
        ...
        def setFile(self, file: jpype.protocol.SupportsPath) -> None:
            ...

        def setFiles(self, newFiles: java.util.List[java.io.File]) -> None:
            ...
    ...
    @typing.type_check_only
    class KeyBindingChangeListener(java.beans.PropertyChangeListener):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class GfcActionPlaceholder(docking.actions.SharedDockingActionPlaceholder):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    def __init__(self, parent: java.awt.Component) -> None:
        """
    ...
    def addFileFilter(self, f: ghidra.util.filechooser.GhidraFileFilter) -> None:
        """
    ...
    @staticmethod
    def registerSharedActions(tool: docking.Tool, toolActions: docking.actions.ToolActions) -> None:
        ...
    ...
    def setApproveButtonText(self, buttonText: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setApproveButtonToolTipText(self, tooltipText: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setCurrentDirectory(self, directory: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def setFileFilter(self, filter: ghidra.util.filechooser.GhidraFileFilter) -> None:
        """
    ...
    def setFileSelectionMode(self, mode: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def setFileSelectionMode(self, mode: GhidraFileChooserMode) -> None:
        """
    ...
    def setLastDirectoryPreference(self, newKey: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setMultiSelectionEnabled(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setSelectedFile(self, file: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def setSelectedFileFilter(self, filter: ghidra.util.filechooser.GhidraFileFilter) -> None:
        """
    ...
    def setShowDetails(self, showDetails: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class RecentGhidraFile(GhidraFile):
    ...
    def __init__(self, path: typing.Union[java.lang.String, str], separator: typing.Union[jpype.JChar, int, str]) -> None:
        ...
...
class GhidraFile(java.io.File):
    ...
    @typing.overload
    def __init__(self, parent: typing.Union[java.lang.String, str], child: typing.Union[java.lang.String, str], separator: typing.Union[jpype.JChar, int, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, parent: jpype.protocol.SupportsPath, name: typing.Union[java.lang.String, str], separator: typing.Union[jpype.JChar, int, str]) -> None:
        """
        Construct a new GhidraFile.
...
class FileChooserToggleButton(javax.swing.JToggleButton):
    ...
    @typing.type_check_only
    class FocusedBorder(javax.swing.border.CompoundBorder):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    def __init__(self, text: typing.Union[java.lang.String, str], fileChooser: GhidraFileChooser) -> None:
        ...
...
class FileDropDownSelectionDataModel(docking.widgets.DropDownTextFieldDataModel[java.io.File]):
    ...
    def __init__(self, chooser: GhidraFileChooser) -> None:
        ...
...
class GhidraFileChooserPanel(javax.swing.JPanel, docking.dnd.Droppable):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], propertyName: typing.Union[java.lang.String, str], defaultFileName: typing.Union[java.lang.String, str], createBorder: typing.Union[jpype.JBoolean, bool], mode: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def addDocumentListener(self, dl: javax.swing.event.DocumentListener) -> None:
        """
    ...
    def setFileName(self, path: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setListener(self, listener: GhidraFileChooserPanelListener) -> None:
        """
        Sets the listener.
...
class GhidraFileChooserPanelListener(java.lang.Object):
    ...
    def fileChanged(self, file: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def fileDropped(self, file: jpype.protocol.SupportsPath) -> None:
        """
...
__all__ = ["GhidraFileChooser", "GhidraFileChooserMode", "RecentGhidraFile", "GhidraFile", "FileChooserToggleButton", "DirectoryTableModel", "DirectoryTable", "GhidraFileChooserDirectoryModelIf", "DirectoryListModel", "DirectoryList", "FileChooserActionManager", "GFileChooserOptionsDialog", "FileEditor", "FileComparator", "FileDropDownSelectionDataModel", "FileListCellRenderer", "FileTableCellRenderer", "GhidraFileChooserPanel", "GhidraFileChooserPanelListener", "LocalFileChooserModel"]
