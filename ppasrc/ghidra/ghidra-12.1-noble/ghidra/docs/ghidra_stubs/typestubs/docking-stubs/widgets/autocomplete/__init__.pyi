...
class AutocompletionCellRenderer(javax.swing.ListCellRenderer[T], typing.Generic[T]):
    ...
    def __init__(self, owner: TextFieldAutocompleter[T]) -> None:
        """
...
class TextFieldAutocompleter(java.lang.Object, typing.Generic[T]):
    ...
    class MyListener(java.awt.event.FocusListener, java.awt.event.KeyListener, javax.swing.event.DocumentListener, java.awt.event.MouseListener, javax.swing.event.CaretListener, javax.swing.event.ListSelectionListener):
        ...
        def fakeFocusGained(self, field: javax.swing.JTextField) -> None:
            ...
    ...
    def __init__(self, model: AutocompletionModel[T]) -> None:
        """
    ...
    def addAutocompletionListener(self, l: AutocompletionListener[T]) -> None:
        """
    ...
    def removeAutocompletionListener(self, l: AutocompletionListener[T]) -> None:
        """
    ...
    def select(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setCompletionListVisible(self, visible: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def startCompletion(self, field: javax.swing.JTextField) -> None:
        """
    ...
    def updateDisplayLocation(self) -> None:
        """
...
class AutocompletionListener(java.lang.Object, typing.Generic[T]):
    ...
    def completionActivated(self, e: AutocompletionEvent[T]) -> None:
        """
    ...
    def completionSelected(self, ev: AutocompletionEvent[T]) -> None:
        """
...
class AutocompletionEvent(java.lang.Object, typing.Generic[T]):
    ...
    def __init__(self, sel: T, field: javax.swing.JTextField) -> None:
        """
...
__all__ = ["AutocompletionCellRenderer", "TextFieldAutocompleter", "AutocompletionModel", "AutocompletionListener", "AutocompletionEvent"]
