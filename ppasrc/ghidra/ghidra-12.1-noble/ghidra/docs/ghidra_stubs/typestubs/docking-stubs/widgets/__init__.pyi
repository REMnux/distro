...
class GComponent(java.lang.Object):
    ...
    def setHTMLRenderingEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @staticmethod
    def setHTMLRenderingFlag(comp: javax.swing.JComponent, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @staticmethod
    def warnAboutHtmlText(text: typing.Union[java.lang.String, str]) -> None:
        """
...
class EmptyBorderButton(javax.swing.JButton):
    ...
    @typing.overload
    def __init__(self, a: javax.swing.Action) -> None:
        """
    ...
    @typing.overload
    def __init__(self, text: typing.Union[java.lang.String, str], icon: javax.swing.Icon) -> None:
        """
...
class VariableHeightPanel(javax.swing.JPanel, javax.swing.Scrollable):
    ...
    def __init__(self, pack: typing.Union[jpype.JBoolean, bool], hgap: typing.Union[jpype.JInt, int], vgap: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setUseSingleLineLayout(self, singleLineLayout: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AutoLookup(java.lang.Object):
    ...
    def keyTyped(self, e: java.awt.event.KeyEvent) -> None:
        """
    ...
    def matchFound(self, row: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setColumn(self, column: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setTimeout(self, timeout: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setTimeoutPredicate(self, p: java.util.function.Predicate[java.lang.Long]) -> None:
        """
...
class DropDownSelectionTextField(DropDownTextField[T], typing.Generic[T]):
    ...
    * Pressing ESCAPE with the drop-down list not showing will trigger an 
    ...
    def __init__(self, dataModel: DropDownTextFieldDataModel[T]) -> None:
        ...
...
class DropDownTextFieldDataModel(java.lang.Object, typing.Generic[T]):
    ...
    class SearchMode(java.lang.Enum[DropDownTextFieldDataModel.SearchMode]):

        class_: typing.ClassVar[java.lang.Class]
        CONTAINS: typing.Final[DropDownTextFieldDataModel.SearchMode]
        """
        Matches when any line of data contains the search text
        """

        STARTS_WITH: typing.Final[DropDownTextFieldDataModel.SearchMode]
        """
        Matches when any line of data starts with the search text
        """

        WILDCARD: typing.Final[DropDownTextFieldDataModel.SearchMode]
        """
        Matches when any line of data contains the search text using globbing characters
        """

        UNKNOWN: typing.Final[DropDownTextFieldDataModel.SearchMode]
        """
        Used internally
        """


        def createPattern(self, input: typing.Union[java.lang.String, str]) -> java.util.regex.Pattern:
            """
            ...
            :param java.lang.String or str input: the input for which to search
            :return: the pattern
        ...
        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> DropDownTextFieldDataModel.SearchMode:
            ...

        @staticmethod
        def values() -> jpype.JArray[DropDownTextFieldDataModel.SearchMode]:
            ...
    ...
    def getMatchingData(self, searchText: typing.Union[java.lang.String, str]) -> java.util.List[T]:
        """
        Returns a list of data that matches the given ``searchText``.  A list is returned to
        allow for multiple matches.  The type of matching performed is determined by the current
        :meth:`search mode <.getSupportedSearchModes>`.  If the implementation of this model does not
        ...
        .. seealso::
            ...
            | :obj:`.getMatchingData(String, SearchMode)`
        """

    @typing.overload
    def getMatchingData(self, searchText: typing.Union[java.lang.String, str], searchMode: DropDownTextFieldDataModel.SearchMode) -> java.util.List[T]:
        """
        Returns a list of data that matches the given ``searchText``.  A list is returned to
        allow for multiple matches.  The type of matching performed is determined by the current
        :meth:`search mode <.getSupportedSearchModes>`.  If the implementation of this model does not
        ...
        :param java.lang.String or str searchText: the text used to find matches.
        :param DropDownTextFieldDataModel.SearchMode searchMode: the search mode to use
        :return: a list of items matching the given text.
        :rtype: java.util.List[T]
        :raises IllegalArgumentException: if the given search mode is not supported
    ...
    def getSupportedSearchModes(self) -> java.util.List[DropDownTextFieldDataModel.SearchMode]:
        """
        ...
        :rtype: java.util.List[DropDownTextFieldDataModel.SearchMode]
        """
    ...
    @property
    def supportedSearchModes(self) -> java.util.List[DropDownTextFieldDataModel.SearchMode]:
        ...
...
class DropDownTextField(javax.swing.JTextField, GComponent, typing.Generic[T]):
    ...
    * Ignore the ENTER key press completely (see :meth:`setIgnoreEnterKeyPress(boolean) <.setIgnoreEnterKeyPress>`
    ...
    @typing.type_check_only
    class SearchModeMouseListener(java.awt.event.MouseAdapter):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class SearchModeHelpLocation(ghidra.util.DynamicHelpLocation):
        ...
        class_: typing.ClassVar[java.lang.Class]


    class SearchModeBounds(java.lang.Object):
        """
        ...
        def getHoverAreaBounds(self) -> java.awt.Rectangle:
            ...

        @property
        def hoverAreaBounds(self) -> java.awt.Rectangle:
            ...
    ...
    @typing.overload
    def __init__(self, dataModel: DropDownTextFieldDataModel[T], updateMinDelay: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor.
    ...
    def addCellEditorListener(self, listener: javax.swing.event.CellEditorListener) -> None:
        """
    ...
    def addDropDownSelectionChoiceListener(self, listener: DropDownSelectionChoiceListener[T]) -> None:
        """
    ...
    def closeDropDownWindow(self) -> None:
        """
        Closes the drop down window
        """

    def getSearchMode(self) -> DropDownTextFieldDataModel.SearchMode:
        ...

    def getSearchModeBounds(self) -> DropDownTextField.SearchModeBounds:
        """
        ...
        :rtype: DropDownTextField.SearchModeBounds
        """
    ...
    def removeCellEditorListener(self, listener: javax.swing.event.CellEditorListener) -> None:
        """
    ...
    def setConsumeEnterKeyPress(self, consume: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setIgnoreEnterKeyPress(self, ignore: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setMatchingWindowHeight(self, height: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setSearchMode(self, newMode: DropDownTextFieldDataModel.SearchMode) -> None:
        ...

    def setSelectedValue(self, value: T) -> None:
        """
    ...
    def setShowMatchingListOnEmptyText(self, show: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def showMatchingList(self) -> None:
        """
    ...
    @property
    def searchModeBounds(self) -> DropDownTextField.SearchModeBounds:
        ...

    @property
    def searchMode(self) -> DropDownTextFieldDataModel.SearchMode:
        ...

    @searchMode.setter
    def searchMode(self, value: DropDownTextFieldDataModel.SearchMode):
        ...
...
class DropDownSelectionChoiceListener(java.lang.Object, typing.Generic[T]):
    ...
    def selectionChanged(self, t: T) -> None:
        ...
...
class DropDownWindowVisibilityListener(java.lang.Object, typing.Generic[T]):
    ...
    def windowHidden(self, field: DropDownTextField[T]) -> None:
        ...

    def windowShown(self, field: DropDownTextField[T]) -> None:
        ...
...
class ScrollableTextArea(javax.swing.JScrollPane):
    ...
    @typing.overload
    def __init__(self, rows: typing.Union[jpype.JInt, int], columns: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, text: typing.Union[java.lang.String, str], rows: typing.Union[jpype.JInt, int], columns: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, doc: javax.swing.text.Document) -> None:
        """
    ...
    @typing.overload
    def __init__(self, doc: javax.swing.text.Document, text: typing.Union[java.lang.String, str], rows: typing.Union[jpype.JInt, int], columns: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def insert(self, text: typing.Union[java.lang.String, str], position: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def replaceRange(self, text: typing.Union[java.lang.String, str], start: typing.Union[jpype.JInt, int], end: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setCaretPosition(self, position: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def setTabSize(self, tabSize: typing.Union[jpype.JInt, int]) -> None:
        """
...
class JTreeMouseListenerDelegate(java.awt.event.MouseAdapter):
    ...
    def __init__(self, tree: javax.swing.JTree) -> None:
        ...

    def addMouseListener(self, listener: java.awt.event.MouseListener) -> None:
        ...

    def addMouseListeners(self, listenerList: java.util.List[java.awt.event.MouseListener]) -> None:
        ...
...
class AbstractGCellRenderer(docking.widgets.label.GDHtmlLabel, generic.theme.laf.FontChangeListener):
    ...
    def firePropertyChange(self, propertyName: typing.Union[java.lang.String, str], oldValue: typing.Union[jpype.JBoolean, bool], newValue: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def repaint(self, tm: typing.Union[jpype.JLong, int], x: typing.Union[jpype.JInt, int], y: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], height: typing.Union[jpype.JInt, int]) -> None:
        """
        See :obj:`DefaultTableCellRenderer` class header javadoc for more info.
        """
    ...
    def setBaseFontId(self, fontId: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setDropRow(self, dropRow: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setFixedWidthFontId(self, fontId: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setShouldAlternateRowBackgroundColors(self, alternate: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class FindDialog(docking.ReusableDialogComponentProvider):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], searcher: docking.widgets.search.FindDialogSearcher) -> None:
        ...

    def getSearchText(self) -> str:
        ...

    def getSearcher(self) -> docking.widgets.search.FindDialogSearcher:
        ...
    ...
    def setClosedCallback(self, c: utility.function.Callback) -> None:
        ...

    def setFindAllEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setHistory(self, history: java.util.List[java.lang.String]) -> None:
        ...

    def setSearchText(self, text: typing.Union[java.lang.String, str]) -> None:
        ...

    @property
    def searcher(self) -> docking.widgets.search.FindDialogSearcher:
        ...
...
class SearchLocation(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, startIndexInclusive: typing.Union[jpype.JInt, int], endIndexInclusive: typing.Union[jpype.JInt, int], text: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, startIndexInclusive: typing.Union[jpype.JInt, int], endIndexInclusive: typing.Union[jpype.JInt, int], text: typing.Union[java.lang.String, str], lineNumber: typing.Union[jpype.JInt, int], context: docking.widgets.search.SearchLocationContext) -> None:
        ...

    def contains(self, pos: typing.Union[jpype.JInt, int]) -> bool:
        ...
...
class CursorPosition(java.lang.Object):
    ...
    def __init__(self, position: typing.Union[jpype.JInt, int]) -> None:
        ...

    def getPosition(self) -> int:
        ...

    def setOffset(self, offset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DefaultDropDownSelectionDataModel(DropDownTextFieldDataModel[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, data: java.util.List[T], searchConverter: DataToStringConverter[T]) -> None:
        ...

    @typing.overload
    def __init__(self, data: java.util.List[T], searchConverter: DataToStringConverter[T], descriptionConverter: DataToStringConverter[T]) -> None:
        ...
...
class OkDialog(OptionDialog):
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str], messageType: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str], icon: javax.swing.Icon) -> None:
        """
        Construct a simple informational dialog with a single OK button
    ...
    @staticmethod
    def show(title: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    def showError(title: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    def showInfo(title: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str]) -> None:
        """
...
class DialogRememberOption(java.lang.Object):
    ...
    def __init__(self, description: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def rememberResult(self, choice: typing.Union[jpype.JInt, int]) -> None:
        """
...
class OptionDialogBuilder(java.lang.Object):
    ...
    :obj:`DialogRememberOption` object and that it has a remembered result, and if so, will just 
    ...
    hold onto the builder and use the :meth:`show() <.show>` method to get the same behavior.
    """
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str]) -> None:
        """
        Constructs an OptionDialogBuilder with not even the minimal information required. If
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str]) -> None:
        """
...
class DropDownMultiSelectionChoiceListener(java.lang.Object, typing.Generic[T]):
    ...
    def selectionChanged(self, t: java.util.List[T]) -> None:
        """
...
class DropDownMultiSelectionTextField(DropDownSelectionTextField[T], typing.Generic[T]):
    ...
    * display all selected items in the drop down text field as a comma-delimited list
    ...
    def addDropDownSelectionChoiceListener(self, listener: DropDownMultiSelectionChoiceListener[T]) -> None:
        """
...
class FindDialogResultsProvider(docking.ComponentProvider, javax.swing.event.TableModelListener):

    @typing.type_check_only
    class FindResultsModel(docking.widgets.table.GDynamicColumnTableModel[SearchLocation, java.lang.Object]):

        @typing.type_check_only
        class LineNumberColumn(docking.widgets.table.AbstractDynamicTableColumnStub[SearchLocation, java.lang.Integer]):
            ...
            class_: typing.ClassVar[java.lang.Class]


        @typing.type_check_only
        class ContextColumn(docking.widgets.table.AbstractDynamicTableColumnStub[SearchLocation, docking.widgets.search.SearchLocationContext]):
            ...
            class_: typing.ClassVar[java.lang.Class]
    ...
    def getResults(self) -> java.util.List[SearchLocation]:
        ...
    ...
    @property
    def results(self) -> java.util.List[SearchLocation]:
        ...
...
class GHyperlinkComponent(javax.swing.JPanel):
    ...
    def addLink(self, text: typing.Union[java.lang.String, str], linkActivatedCallback: utility.function.Callback) -> None:
        """
...
class GenericDateCellRenderer(docking.widgets.table.GTableCellRenderer):
    ...
    @typing.overload
    def __init__(self, toolTip: typing.Union[java.lang.String, str]) -> None:
        ...
...
class HyperlinkComponent(javax.swing.JPanel):
    ...
    def __init__(self, htmlTextWithHyperlinks: typing.Union[java.lang.String, str]) -> None:
        ...

    def addHyperlinkListener(self, anchorName: typing.Union[java.lang.String, str], listener: javax.swing.event.HyperlinkListener) -> None:
        """
    ...
    def removeHyperlinkListener(self, anchorName: typing.Union[java.lang.String, str], listener: javax.swing.event.HyperlinkListener) -> None:
        ...
...
class InlineComponentTitledBorder(javax.swing.border.TitledBorder):
    ...
    **This class should not be used outside InlineComponentTitledPanel.**
    ...
    @typing.overload
    def __init__(self, component: javax.swing.JComponent) -> None:
        ...

    @typing.overload
    def __init__(self, border: javax.swing.border.Border) -> None:
        ...

    @typing.overload
    def __init__(self, border: javax.swing.border.Border, component: javax.swing.JComponent) -> None:
        ...

    @typing.overload
    def __init__(self, border: javax.swing.border.Border, component: javax.swing.JComponent, titleJustification: typing.Union[jpype.JInt, int], titlePosition: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def setTitleComponent(self, component: javax.swing.JComponent) -> None:
        ...
...
class InlineComponentTitledPanel(javax.swing.JPanel):
    ...
    @typing.overload
    def __init__(self, titleComponent: javax.swing.JComponent) -> None:
        """
    ...
    @typing.overload
    def __init__(self, titleComponent: javax.swing.JComponent, otherBorder: javax.swing.border.Border) -> None:
        """
        Create a panel with ``titleComponent`` in the top, left corner
    ...
    @typing.overload
    def __init__(self, titleComponent: javax.swing.JComponent, titleJustification: typing.Union[jpype.JInt, int], titlePosition: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, titleComponent: javax.swing.JComponent, titleJustification: typing.Union[jpype.JInt, int], titlePosition: typing.Union[jpype.JInt, int], otherBorder: javax.swing.border.Border) -> None:
        """
    ...
    def setBorder(self, otherBorder: javax.swing.border.Border) -> None:
        """
    ...
    def setOtherBorder(self, otherBorder: javax.swing.border.Border) -> None:
        ...
...
class ListSelectionDialog(docking.DialogComponentProvider, typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str], data: java.util.List[T], searchConverter: DataToStringConverter[T]) -> None:
        ...

    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str], data: java.util.List[T], searchConverter: DataToStringConverter[T], descriptionConverter: DataToStringConverter[T]) -> None:
        ...
    ...
    def setSearchMode(self, mode: DropDownTextFieldDataModel.SearchMode) -> None:
        ...
...
class ListSelectionTableDialog(docking.DialogComponentProvider, typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], list: java.util.List[T]) -> None:
        ...

    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], model: docking.widgets.table.RowObjectTableModel[T]) -> None:
        ...
    ...
    def setMultiSelectionMode(self, enable: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class MultiLineLabel(javax.swing.JPanel):
    ...
    class VerticalAlignment(java.lang.Enum[MultiLineLabel.VerticalAlignment]):
        """
        Values for controlling vertical alignment of the text
        """

        class_: typing.ClassVar[java.lang.Class]
        TOP: typing.Final[MultiLineLabel.VerticalAlignment]
        MIDDLE: typing.Final[MultiLineLabel.VerticalAlignment]

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> MultiLineLabel.VerticalAlignment:
            ...

        @staticmethod
        def values() -> jpype.JArray[MultiLineLabel.VerticalAlignment]:
            ...
    ...
    @typing.overload
    def __init__(self, label: typing.Union[java.lang.String, str], margin_width: typing.Union[jpype.JInt, int], margin_height: typing.Union[jpype.JInt, int], alignment: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, label: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setAlignment(self, a: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def setLabel(self, label: typing.Union[java.lang.String, str]) -> None:
        """
        Set a new label to display.
        
        :param java.lang.String or str label: String to display
        """

    @typing.overload
    def setLabel(self, text: jpype.JArray[java.lang.String]) -> None:
        """
        Set the label text.
    ...
    def setMarginHeight(self, mh: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setMarginWidth(self, mw: typing.Union[jpype.JInt, int]) -> None:
        """
        Set margin width.
    ...
    def setVerticalAlignment(self, alignment: MultiLineLabel.VerticalAlignment) -> None:
        """
        Sets the vertical alignment of the text.  The default is :obj:`VerticalAlignment.MIDDLE`.
        
        :param MultiLineLabel.VerticalAlignment alignment: the alignment
        """
...
class PasswordChangeDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], serverType: typing.Union[java.lang.String, str], serverName: typing.Union[java.lang.String, str], userID: typing.Union[java.lang.String, str]) -> None:
        ...
...
class PasswordDialog(docking.DialogComponentProvider):
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], serverType: typing.Union[java.lang.String, str], serverName: typing.Union[java.lang.String, str], passPrompt: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], serverType: typing.Union[java.lang.String, str], serverName: typing.Union[java.lang.String, str], passPrompt: typing.Union[java.lang.String, str], hasMessages: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a new PasswordDialog which only prompts for a password for a specified server
        type and name.  The dialog will not include a User ID display, although server fields 
    ...
    @staticmethod
    def getPreferredUserIdPreferenceKey(serverType: typing.Union[java.lang.String, str], serverName: typing.Union[java.lang.String, str]) -> str:
        """
        Get the :obj:`Preferences` key used to retain the last used user ID for a specific server.
        Values supplied must match those used to instantiate password dialog.
        
        :param java.lang.String or str serverType: server type string
        :param java.lang.String or str serverName: server name (e.g., hostname, IP address).
    ...
    def setErrorText(self, text: typing.Union[java.lang.String, str]) -> None:
        """
...
class PopupWindow(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, displayComponent: javax.swing.JComponent) -> None:
        ...

    @typing.overload
    def __init__(self, sourceComponent: java.awt.Component, displayComponent: javax.swing.JComponent) -> None:
        ...

    @typing.overload
    def __init__(self, parentWindow: java.awt.Window, displayComponent: javax.swing.JComponent) -> None:
        ...

    def addComponentListener(self, listener: java.awt.event.ComponentListener) -> None:
        ...
    ...
    def setCloseWindowDelay(self, delayInMillis: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setWindowName(self, name: typing.Union[java.lang.String, str]) -> None:
        ...

    def showOffsetPopup(self, e: java.awt.event.MouseEvent, keepVisibleArea: java.awt.Rectangle, forceShow: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def showPopup(self, e: java.awt.event.MouseEvent, forceShow: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def showPopup(self, component: java.awt.Component, location: java.awt.Point, forceShow: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Shows this popup window unless popups are disabled as reported by 
        :meth:`DockingUtils.isTipWindowEnabled() <DockingUtils.isTipWindowEnabled>`.  If ``forceShow`` is true, then the popup 
        will be shown regardless of the state returned by :meth:`DockingUtils.isTipWindowEnabled() <DockingUtils.isTipWindowEnabled>`.
    ...
    @typing.overload
    def showPopup(self, e: java.awt.event.MouseEvent) -> None:
        """
        Shows this popup window unless popups are disabled as reported by 
...
class SelectFromListDialog(docking.DialogComponentProvider, typing.Generic[T]):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], prompt: typing.Union[java.lang.String, str], list: java.util.List[T], toStringFunc: java.util.function.Function[T, java.lang.String]) -> None:
        ...
    ...
    def setSelectedObject(self, obj: T) -> None:
        ...
...
class SideKickVerticalScrollbar(javax.swing.JScrollBar):
    ...
    def __init__(self, sideKick: java.awt.Component, viewport: javax.swing.JViewport) -> None:
        ...
...
class SmallBorderButton(javax.swing.JButton):
    ...
    def setOverrideBorder(self, overrideBorder: javax.swing.border.Border) -> None:
        """
...
class TitledPanel(javax.swing.JPanel):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], panel: javax.swing.JComponent, margin: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setTitleName(self, name: typing.Union[java.lang.String, str]) -> None:
        ...
...
__all__ = ["GComponent", "EmptyBorderButton", "VariableHeightPanel", "EventTrigger", "AutoLookup", "DropDownSelectionTextField", "DropDownTextFieldDataModel", "DropDownTextField", "DropDownSelectionChoiceListener", "DropDownWindowVisibilityListener", "ScrollableTextArea", "JTreeMouseListenerDelegate", "AbstractGCellRenderer", "FindDialog", "SearchLocation", "CursorPosition", "DefaultDropDownSelectionDataModel", "DataToStringConverter", "OkDialog", "OptionDialog", "DialogRememberOption", "OptionDialogBuilder", "DropDownMultiSelectionChoiceListener", "DropDownMultiSelectionTextField", "FindDialogResultsProvider", "GHyperlinkComponent", "GenericDateCellRenderer", "HyperlinkComponent", "InlineComponentTitledBorder", "InlineComponentTitledPanel", "ListSelectionDialog", "ListSelectionTableDialog", "MultiLineLabel", "PasswordChangeDialog", "PasswordDialog", "PopupKeyStorePasswordProvider", "PopupWindow", "SelectFromListDialog", "SideKickVerticalScrollbar", "SmallBorderButton", "TitledPanel", "VariableHeightLayoutManager", "SingleRowLayoutManager"]
