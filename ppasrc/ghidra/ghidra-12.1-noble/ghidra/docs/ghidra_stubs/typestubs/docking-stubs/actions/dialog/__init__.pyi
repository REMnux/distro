...
class ActionChooserDialog(docking.DialogComponentProvider):
    ...
    @typing.overload
    def __init__(self, model: ActionsModel) -> None:
        """
    ...
    @typing.overload
    def __init__(self, tool: docking.Tool, provider: docking.ComponentProvider, context: docking.ActionContext) -> None:
        """
    ...
    @typing.overload
    def __init__(self, tool: docking.Tool, dialog: docking.DialogComponentProvider, context: docking.ActionContext) -> None:
        """
    ...
    def setActionDisplayLevel(self, level: ActionDisplayLevel) -> None:
        """
...
class ActionsModel(docking.widgets.searchlist.DefaultSearchListModel[docking.action.DockingActionIf]):
    ...
    def setDisplayLevel(self, level: ActionDisplayLevel) -> None:
        """
...
__all__ = ["ActionChooserDialog", "ActionGroup", "ActionsModel", "ActionDisplayLevel"]
