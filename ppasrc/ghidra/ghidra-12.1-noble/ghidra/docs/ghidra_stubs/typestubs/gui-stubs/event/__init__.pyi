...
class MouseBinding(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, button: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, button: typing.Union[jpype.JInt, int], modifiers: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a binding with the given button number of the desired mouse button (e.g., 1, 2,...)
