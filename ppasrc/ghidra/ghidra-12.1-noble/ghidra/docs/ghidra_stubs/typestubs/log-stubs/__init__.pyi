...
class Log4jDevelopmentPatternConverter(org.apache.logging.log4j.core.pattern.LogEventPatternConverter):
    ...
    def format(self, event: org.apache.logging.log4j.core.LogEvent, toAppendTo: java.lang.StringBuilder) -> None:
        """
...
class LogListener(java.lang.Object):
    ...
    def messageLogged(self, message: typing.Union[java.lang.String, str], isError: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class LogPanelAppender(org.apache.logging.log4j.core.appender.AbstractAppender):
    ...
    def setLogListener(self, listener: LogListener) -> None:
        ...



__all__ = ["Log4jDevelopmentPatternConverter", "LogListener", "LogPanelAppender"]
