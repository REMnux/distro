...
class DataBuffer(db.Buffer, java.io.Externalizable):
    ...
    def copy(self, offset: typing.Union[jpype.JInt, int], buf: DataBuffer, bufOffset: typing.Union[jpype.JInt, int], length: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    def enableCompressedSerializationOutput(enable: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def move(self, src: typing.Union[jpype.JInt, int], dest: typing.Union[jpype.JInt, int], length: typing.Union[jpype.JInt, int]) -> None:
        """
...
class LocalBufferFile(BufferFile):
    ...
    class LocalOutputBlockStream(OutputBlockStream):
        ...
        def __init__(self, blockCount: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, file: jpype.protocol.SupportsPath, bufferSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    def cleanupOldPreSaveFiles(dir: jpype.protocol.SupportsPath, beforeNow: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def clone(self, destinationFile: jpype.protocol.SupportsPath, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @staticmethod
    def copyFile(srcFile: BufferFile, destFile: BufferFile, changeMap: ChangeMap, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @staticmethod
    def poke(file: jpype.protocol.SupportsPath, bufferIndex: typing.Union[jpype.JInt, int], buf: DataBuffer) -> None:
        """
...
class BufferMgr(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, requestedBufferSize: typing.Union[jpype.JInt, int], approxCacheSize: typing.Union[jpype.JLong, int], maxUndos: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, sourceFile: BufferFile) -> None:
        """
    ...
    @typing.overload
    def __init__(self, sourceFile: BufferFile, approxCacheSize: typing.Union[jpype.JLong, int], maxUndos: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a buffer manager for a given source file using default
        cache size and maximum undo count.
    ...
    @staticmethod
    def cleanupOldCacheFiles() -> None:
        ...

    def clearCheckpoints(self) -> None:
        """
        Clear all checkpoints and re-baseline buffers
        """

    def clearRecoveryFiles(self) -> None:
        """
    ...
    def deleteBuffer(self, id: typing.Union[jpype.JInt, int]) -> None:
        """
        Delete buffer.
    ...
    @typing.overload
    def dispose(self, keepRecoveryData: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Dispose of all buffer manager resources including any source
        buffer file.
        This method should be called when this buffer manager instance
    ...
    def releaseBuffer(self, buf: DataBuffer) -> None:
        """
    ...
    def resetCacheStatistics(self) -> None:
        ...

    def save(self, comment: typing.Union[java.lang.String, str], changeSet: db.DBChangeSet, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def saveAs(self, outFile: BufferFile, associateWithNewFile: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def setCorruptedState(self) -> None:
        """
    ...
    def setDBVersionedSourceFile(self, versionedSourceBufferFile: LocalManagedBufferFile) -> None:
        """
...
class BufferFile(java.lang.Object):
    ...
    def put(self, buf: DataBuffer, index: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setFreeIndexes(self, indexes: jpype.JArray[jpype.JInt]) -> None:
        """
    ...
    def setParameter(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class BufferFileManager(java.lang.Object):
    ...
    def updateEnded(self, checkinId: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def versionCreated(self, version: typing.Union[jpype.JInt, int], comment: typing.Union[java.lang.String, str], checkinId: typing.Union[jpype.JLong, int]) -> None:
        """
...
class LocalManagedBufferFile(LocalBufferFile, ManagedBufferFile):
    ...
    @typing.overload
    def __init__(self, bufferSize: typing.Union[jpype.JInt, int], bfManager: BufferFileManager, checkinId: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, bfManager: BufferFileManager, versionUpdateEnabled: typing.Union[jpype.JBoolean, bool], minChangeDataVer: typing.Union[jpype.JInt, int], checkinId: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, bfManager: BufferFileManager, version: typing.Union[jpype.JInt, int], minChangeDataVer: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def createNewVersion(self, destFile: ManagedBufferFile, fileComment: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def updateFrom(self, versionedBufferFile: ManagedBufferFile, oldVersion: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class ManagedBufferFile(BufferFile):
    ...
    def saveCompleted(self, commit: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setVersionComment(self, comment: typing.Union[java.lang.String, str]) -> None:
        """
...
class OutputBlockStream(BlockStream):
    ...
    def writeBlock(self, block: BufferFileBlock) -> None:
        """
...
class BufferFileBlock(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, blockIndex: typing.Union[jpype.JInt, int], buffer: jpype.JArray[jpype.JByte]) -> None:
        """
...
class ChangeMap(java.lang.Object):
    ...
    def __init__(self, mapData: jpype.JArray[jpype.JByte]) -> None:
        """
        Constructor.
...
class BufferFileAdapter(BufferFile):
    ...
    def __init__(self, remoteBufferFile: BufferFileHandle) -> None:
        """
        Constructor.
...
class ManagedBufferFileAdapter(BufferFileAdapter, ManagedBufferFile):
    ...
    def __init__(self, remoteManagedBufferFile: ManagedBufferFileHandle) -> None:
        """
        Constructor.
...
class RemoteBufferFileHandle(BufferFileHandle, java.rmi.Remote):
    ...
    IMPORTANT: Methods from :obj:`BufferFileHandle` **must** be re-declared here 
...
class RemoteManagedBufferFileHandle(ManagedBufferFileHandle, java.rmi.Remote):
    ...
    IMPORTANT: Methods from :obj:`BufferFileHandle` and :obj:`ManagedBufferFile` **must** 
...
__all__ = ["DataBuffer", "LocalBufferFile", "BufferMgr", "BufferFile", "RecoveryMgr", "BufferNode", "IndexProvider", "RecoveryFile", "BufferFileManager", "LocalManagedBufferFile", "ManagedBufferFile", "VersionFileHandler", "VersionFile", "ChangeMapFile", "OutputBlockStream", "BlockStream", "InputBlockStream", "BufferFileBlock", "ChangeMap", "BlockStreamHandle", "BufferFileAdapter", "BufferFileHandle", "ManagedBufferFileAdapter", "ManagedBufferFileHandle", "RemoteBufferFileHandle", "RemoteManagedBufferFileHandle"]
