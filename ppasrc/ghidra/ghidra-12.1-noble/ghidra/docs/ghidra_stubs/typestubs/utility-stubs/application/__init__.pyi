...
class ApplicationLayout(java.lang.Object):
    ...
    def getApplicationRootDirs(self) -> java.util.SequencedCollection[generic.jar.ResourceFile]:
        """
        Gets the application root directories from the application layout.
        
        :return: A :obj:`SequencedCollection` of application root directories (or null if not set).
        :rtype: java.util.SequencedCollection[generic.jar.ResourceFile]
        """
    ...
    def getExtensionInstallationDirs(self) -> java.util.List[generic.jar.ResourceFile]:
        ...
        * ``[application root dirs]/Extensions``
    ...
    @property
    def applicationRootDirs(self) -> java.util.SequencedCollection[generic.jar.ResourceFile]:
        ...
...
class ApplicationUtilities(java.lang.Object):
    ...
    @staticmethod
    def findDefaultApplicationRootDirs() -> java.util.SequencedCollection[generic.jar.ResourceFile]:
        """
    ...
    @staticmethod
    def getJavaUserHomeDir() -> java.io.File:
        """
        Gets Java's user home directory in absolute form
        
        :return: Java's user home directory in absolute form
        :rtype: java.io.File
        :raises FileNotFoundException: if Java's user home directory is not defined or it is not an
        absolute path
        """
...
class XdgUtils(java.lang.Object):
    ...
    XDG_CACHE_HOME_DEFAULT_SUBDIRNAME: typing.Final = ".cache"
...
__all__ = ["ApplicationLayout", "ApplicationUtilities", "XdgUtils", "AppCleaner", "ApplicationSettings", "DummyApplicationLayout"]
