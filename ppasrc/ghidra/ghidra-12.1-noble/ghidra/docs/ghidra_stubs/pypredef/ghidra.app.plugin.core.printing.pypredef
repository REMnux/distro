...
class CodeUnitPrintable(java.awt.print.Printable):
    ...
    @typing.overload
    def __init__(self, lm: docking.widgets.fieldpanel.LayoutModel, startIndex: typing.Union[jpype.JInt, int], endIndex: typing.Union[jpype.JInt, int], scaleAmount: typing.Union[jpype.JDouble, float], monitor: ghidra.util.task.TaskMonitor, pod: PrintOptionsDialog, book: java.awt.print.Book, job: java.awt.print.PrinterJob, startDate: java.util.Date) -> None:
        ...
...
class PrintOptionsDialog(docking.ReusableDialogComponentProvider):
    ...
    def setSelectionEnabled(self, selectionEnabled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["CodeUnitPrintable", "PrintOptionsDialog", "PrintingPlugin"]
