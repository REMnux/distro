...
class ListingCodeComparisonView(ghidra.features.base.codecompare.panel.CodeComparisonView, ghidra.app.util.viewer.format.FormatModelListener, ghidra.framework.options.OptionsChangeListener):
    """
    UI that displays two listings for comparison.
    """

    @typing.type_check_only
    class NavigateType(java.lang.Enum[ListingCodeComparisonView.NavigateType]):

        class_: typing.ClassVar[java.lang.Class]
        ALL: typing.Final[ListingCodeComparisonView.NavigateType]
        UNMATCHED: typing.Final[ListingCodeComparisonView.NavigateType]
        DIFF: typing.Final[ListingCodeComparisonView.NavigateType]

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> ListingCodeComparisonView.NavigateType:
            ...

        @staticmethod
        def values() -> jpype.JArray[ListingCodeComparisonView.NavigateType]:
            ...
...
class ListingDisplay(ListingDiffChangeListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, owner: typing.Union[java.lang.String, str], listingDiff: ghidra.program.util.ListingDiff, comparsionOptions: ListingCodeComparisonOptions, side: ghidra.util.datastruct.Duo.Side) -> None:
        ...
    ...
    def setDiffHighlightProvider(self, newDiffHighlights: ListingDiffHighlightProvider) -> None:
        ...
    ...
    def setProgramView(self, program: ghidra.program.model.listing.Program, view: ghidra.program.model.address.AddressSetView, name: typing.Union[java.lang.String, str]) -> None:
        ...
...
@typing.type_check_only
class ListingDisplaySynchronizer(java.lang.Object):
    """
...
class ListingDiffActionManager(java.lang.Object):
    ...
    def __init__(self, listingDiff: ghidra.program.util.ListingDiff) -> None:
        """
    ...
    def updateActionEnablement(self, isShowing: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ListingDiffHighlightProvider(ghidra.app.util.ListingHighlightProvider):
    ...
    def __init__(self, listingDiff: ghidra.program.util.ListingDiff, side: ghidra.util.datastruct.Duo.Side, comparisonOptions: ListingCodeComparisonOptions) -> None:
        """
...
class LinearAddressCorrelation(ghidra.program.util.ListingAddressCorrelation):
    ...
    def __init__(self, comparisonData: ghidra.util.datastruct.Duo[ghidra.features.base.codecompare.panel.ComparisonData]) -> None:
        ...
...
class ListingComparisonActionContext(ghidra.features.base.codecompare.panel.CodeComparisonActionContext):
    ...
    def __init__(self, provider: docking.ComponentProvider, panel: ListingCodeComparisonView) -> None:
        """
        ...
        :param ListingCodeComparisonView panel: the ListingCodeComparisonPanel that generated this context
        """

    def getCodeComparisonView(self) -> ListingCodeComparisonView:
        """
        Returns the :obj:`ListingCodeComparisonView` that generated this context
        
        :return: the listing comparison panel that generated this context
        :rtype: ListingCodeComparisonView
        """

    @property
    def codeComparisonView(self) -> ListingCodeComparisonView:
        ...
...
__all__ = ["ListingCodeComparisonView", "ListingCodeComparisonOptions", "ListingDisplay", "ListingDiffChangeListener", "ListingDisplaySynchronizer", "ListingDiffActionManager", "ListingDiffHighlightProvider", "LinearAddressCorrelation", "ListingComparisonActionContext", "ListingDisplayToggleAction", "ListingDisplayGoToService", "ListingDisplayNavigator"]
