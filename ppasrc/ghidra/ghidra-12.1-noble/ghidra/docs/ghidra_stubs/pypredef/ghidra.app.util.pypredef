...
class CodeUnitInfo(java.lang.Object):
    ...
    def __init__(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setComment(self, commentType: ghidra.program.model.listing.CommentType, comment: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    def setSymbols(self, symbols: jpype.JArray[ghidra.program.model.symbol.Symbol]) -> None:
        """
...
class Option(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], value: java.lang.Object) -> None:
        """
    ...
    @typing.overload
    def __init__(self, group: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], value: java.lang.Object) -> None:
        """
        Construct a new Option.
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], valueClass: java.lang.Class[typing.Any]) -> None:
        """
        Construct a new Option.
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], value: java.lang.Object, valueClass: java.lang.Class[typing.Any], arg: typing.Union[java.lang.String, str]) -> None:
        """
        Construct a new Option
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], valueClass: java.lang.Class[typing.Any], value: java.lang.Object, arg: typing.Union[java.lang.String, str], group: typing.Union[java.lang.String, str]) -> None:
        """
        Construct a new Option
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], valueClass: java.lang.Class[typing.Any], value: java.lang.Object, arg: typing.Union[java.lang.String, str], group: typing.Union[java.lang.String, str], stateKey: typing.Union[java.lang.String, str], hidden: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a new Option
    ...
    def setOptionListener(self, listener: OptionListener) -> None:
        ...

    def setValue(self, object: java.lang.Object) -> None:
        """
...
class OptionListener(java.lang.Object):
    ...
    def optionChanged(self, option: Option) -> None:
        """
...
class ProgramDropProvider(java.lang.Object):
    ...
    def add(self, contextObj: java.lang.Object, data: java.lang.Object, flavor: java.awt.datatransfer.DataFlavor) -> None:
        """
...
class ByteCopier(java.lang.Object):
    ...
    class ProgrammingByteStringTransferable(java.awt.datatransfer.Transferable):
        ...
        def __init__(self, byteString: typing.Union[java.lang.String, str], flavor: java.awt.datatransfer.DataFlavor) -> None:
            ...
    ...
    class ByteStringTransferable(java.awt.datatransfer.Transferable):
        ...
        @typing.overload
        def __init__(self, byteString: typing.Union[java.lang.String, str]) -> None:
            ...

        @typing.overload
        def __init__(self, byteString: typing.Union[java.lang.String, str], stringRepresentation: typing.Union[java.lang.String, str]) -> None:
            ...
...
class ClipboardType(java.lang.Object):
    ...
    def __init__(self, flavor: java.awt.datatransfer.DataFlavor, typeName: typing.Union[java.lang.String, str]) -> None:
        """
...
class CodeUnitInfoTransferable(java.awt.datatransfer.Transferable, java.awt.datatransfer.ClipboardOwner):
    ...
    def __init__(self, list: java.util.List[CodeUnitInfo]) -> None:
        """
...
class OptionException(java.lang.Exception):
    ...
    @typing.overload
    def __init__(self, msg: typing.Union[java.lang.String, str], isInfo: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AddressInput(javax.swing.JPanel, docking.widgets.table.FocusableEditor):
    ...
    @typing.overload
    def __init__(self, addressChangedConsumer: java.util.function.Consumer[ghidra.program.model.address.Address]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, factory: ghidra.program.model.address.AddressFactory) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addressChangedConsumer: java.util.function.Consumer[ghidra.program.model.address.Address]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, factory: ghidra.program.model.address.AddressFactory, addressChangedConsumer: java.util.function.Consumer[ghidra.program.model.address.Address]) -> None:
        """
        Constructs an AddressInput field with a consumer to be notified when the address field
    ...
    def setAddressErrorConsumer(self, addressErrorConsumer: java.util.function.Consumer[java.lang.String]) -> None:
        """
    ...
    def setAddressSpace(self, addressSpace: ghidra.program.model.address.AddressSpace) -> None:
        """
    ...
    def setAddressSpaceEditable(self, state: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setAddressSpaceFilter(self, spaceFilter: java.util.function.Predicate[ghidra.program.model.address.AddressSpace]) -> None:
        """
    ...
    def setAssumeHex(self, hexMode: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setComponentBorders(self, border: javax.swing.border.Border) -> None:
        """
    ...
    def setEditable(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def setProgram(self, program: ghidra.program.model.listing.Program, addessSpaceFilter: java.util.function.Predicate[ghidra.program.model.address.AddressSpace]) -> None:
        """
    ...
    def simulateAddressChanged(self, addr: ghidra.program.model.address.Address) -> None:
        """
...
class SymbolInspector(ghidra.framework.options.OptionsChangeListener):
    ...
    @typing.overload
    def __init__(self, serviceProvider: ghidra.framework.plugintool.ServiceProvider, repaintComp: java.awt.Component) -> None:
        """
    ...
    @typing.overload
    def __init__(self, options: ghidra.framework.options.ToolOptions, repaintComp: java.awt.Component) -> None:
        """
        Constructs a new symbol inspector
...
class AddEditDialog(docking.ReusableDialogComponentProvider):
    ...
    class NamespaceWrapper(java.lang.Object):
        ...
        def __init__(self, namespace: ghidra.program.model.symbol.Namespace) -> None:
            ...
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], tool: ghidra.framework.plugintool.PluginTool) -> None:
        ...
    ...
    def getNamespaceComboBox(self) -> javax.swing.JComboBox[typing.Any]:
        ...

    def setReusable(self, isReusable: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @property
    def namespaceComboBox(self) -> javax.swing.JComboBox[typing.Any]:
        ...
...
class SelectionTransferData(java.lang.Object):
    ...
    def __init__(self, set: ghidra.program.model.address.AddressSetView, programPath: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class AddressSetEditorPanel(javax.swing.JPanel):
    ...
    class AddressSetListModel(javax.swing.AbstractListModel[ghidra.program.model.address.AddressRange]):
        ...
        def setData(self, list: java.util.List[ghidra.program.model.address.AddressRange]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, addressFactory: ghidra.program.model.address.AddressFactory, addressSet: ghidra.program.model.address.AddressSetView) -> None:
        ...
...
class EolComments(java.lang.Object):
    ...
    def __init__(self, cu: ghidra.program.model.listing.CodeUnit, operandsShowReferences: typing.Union[jpype.JBoolean, bool], maxDisplayComments: typing.Union[jpype.JInt, int], extraCommentsOption: ghidra.app.util.viewer.field.EolExtraCommentsOption) -> None:
        ...
...
class FunctionXrefsTableModel(ghidra.util.table.ReferencesFromTableModel):
    ...
    class ThunkIncomingReferenceEndpoint(ghidra.util.table.field.IncomingReferenceEndpoint):
        ...
        def __init__(self, r: ghidra.program.model.symbol.Reference, isOffcut: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def __init__(self, function: ghidra.program.model.listing.Function, directRefs: java.util.function.Supplier[java.util.Collection[ghidra.program.model.symbol.Reference]], sp: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program) -> None:
        ...
...
class HexLong(java.lang.Number):
    ...
    def __init__(self, longValue: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class MemoryBlockUtils(java.lang.Object):
    ...
    def addExternalBlock(program: ghidra.program.model.listing.Program, size: typing.Union[jpype.JLong, int], log: ghidra.app.util.importer.MessageLog) -> ghidra.program.model.address.Address:
        """
        Adds the :obj:`EXTERNAL block <MemoryBlock.EXTERNAL_BLOCK_NAME>` to memory at the 
        :meth:`next available address <.getNextAvailableAddress>`, or adds to an
        existing one
    ...
    @staticmethod
    def adjustFragment(program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, name: typing.Union[java.lang.String, str]) -> None:
        """
...
class NamespaceCache(java.lang.Object):
    """
    Static class for remember the last few namespaces used for a program.
    """

    class_: typing.ClassVar[java.lang.Class]
    MAX_RECENTS: typing.Final = 10

    def __init__(self) -> None:
        ...

    @staticmethod
    def add(program: ghidra.program.model.listing.Program, namespace: ghidra.program.model.symbol.Namespace) -> None:
        """
        Adds a recently used namespace for a program.
        
        :param ghidra.program.model.listing.Program program: the program to add a recently namespace
        :param ghidra.program.model.symbol.Namespace namespace: the recently used namespace to remember
        """

    @staticmethod
    def get(program: ghidra.program.model.listing.Program) -> java.util.List[ghidra.program.model.symbol.Namespace]:
        """
        Returns the list of recently used namespaces for the given program.
        
        :param ghidra.program.model.listing.Program program: the program to get namespaces for
...
class NamespaceChooserDialog(docking.DialogComponentProvider):
    """
    Class for choosing a namespace
    """

    @typing.type_check_only
    class GatherNamespacesTask(ghidra.util.task.Task):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
class NamespaceDropDownModel(docking.widgets.DropDownTextFieldDataModel[ghidra.program.model.symbol.Namespace]):
    """
    This is the drop down text field model for namespaces.
    """

    @typing.type_check_only
    class MappedList(java.util.AbstractList[T], typing.Generic[S, T]):
        """
        ...
        def __init__(self, sourceList: java.util.List[S], transformer: java.util.function.Function[S, T]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def setNamespaces(self, namespaces: java.util.List[ghidra.program.model.symbol.Namespace]) -> None:
        ...
...
class OptionsDialog(docking.DialogComponentProvider, OptionListener):
    ...
    def __init__(self, originalOptions: java.util.List[Option], validator: OptionValidator, addressFactoryService: AddressFactoryService) -> None:
        """
...
class OptionsEditorPanel(javax.swing.JPanel):
    ...
    def __init__(self, options: java.util.List[Option], addressFactoryService: AddressFactoryService) -> None:
        """
...
class Permissions(java.lang.Object):
    ...
    def __init__(self, read: typing.Union[jpype.JBoolean, bool], write: typing.Union[jpype.JBoolean, bool], execute: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class SelectionTransferable(java.awt.datatransfer.Transferable, java.awt.datatransfer.ClipboardOwner):
    ...
    def __init__(self, selectionData: SelectionTransferData) -> None:
        """
...
class XReferenceUtil(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def getVariableRefs(var: ghidra.program.model.listing.Variable, xrefs: java.util.List[ghidra.program.model.symbol.Reference], offcuts: java.util.List[ghidra.program.model.symbol.Reference]) -> None:
        """
    ...
    @staticmethod
    def showAllXrefs(navigatable: ghidra.app.nav.Navigatable, serviceProvider: ghidra.framework.plugintool.ServiceProvider, service: ghidra.app.util.query.TableService, location: ghidra.program.util.ProgramLocation, xrefs: java.util.Set[ghidra.program.model.symbol.Reference]) -> None:
        """
...
class XReferenceUtils(java.lang.Object):
    ...
    class DeleteXrefsAction(docking.action.DockingAction):
        ...
        def __init__(self, provider: ghidra.app.plugin.core.table.TableComponentProvider[ghidra.util.table.field.ReferenceEndpoint], tableModel: ghidra.util.table.ReferencesFromTableModel, program: ghidra.program.model.listing.Program) -> None:
            ...
    ...
    @staticmethod
    @typing.overload
    def getVariableRefs(var: ghidra.program.model.listing.Variable, xrefs: java.util.List[ghidra.program.model.symbol.Reference], offcuts: java.util.List[ghidra.program.model.symbol.Reference], max: typing.Union[jpype.JInt, int]) -> None:
        """
        Populates the provided lists with the direct and offcut xrefs to the specified variable
    ...
    def showXrefs(navigatable: ghidra.app.nav.Navigatable, serviceProvider: ghidra.framework.plugintool.ServiceProvider, service: ghidra.app.util.query.TableService, location: ghidra.program.util.ProgramLocation, xrefs: collections.abc.Sequence) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def showXrefs(navigatable: ghidra.app.nav.Navigatable, serviceProvider: ghidra.framework.plugintool.ServiceProvider, service: ghidra.app.util.query.TableService, location: ghidra.program.util.ProgramLocation, xrefs: java.util.function.Supplier[java.util.Collection[ghidra.program.model.symbol.Reference]]) -> None:
        """
        Shows all xrefs to the given location in a new table.
...
class SymbolPath(java.lang.Comparable[SymbolPath]):
    ...
    * :meth:`getPath() <.getPath>` will return "foo::bar::baz".
    ...
    @typing.overload
    def __init__(self, symbolPathString: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, symbolPath: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, symbolList: java.util.List[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, symbol: ghidra.program.model.symbol.Symbol) -> None:
        """
    ...
    @typing.overload
    def __init__(self, symbol: ghidra.program.model.symbol.Symbol, excludeLibrary: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, parent: SymbolPath, name: typing.Union[java.lang.String, str]) -> None:
        """
...
class PseudoCodeUnit(ghidra.program.model.listing.CodeUnit):
    ...
    def addOperandReference(self, opIndex: typing.Union[jpype.JInt, int], refAddr: ghidra.program.model.address.Address, type: ghidra.program.model.symbol.RefType, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    def removeOperandReference(self, opIndex: typing.Union[jpype.JInt, int], refAddr: ghidra.program.model.address.Address) -> None:
        """
        Remove a user defined reference to the operand at opIndex.
        """

    def removeProperty(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def removeStackReference(self, opIndex: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setComment(self, commentType: ghidra.program.model.listing.CommentType, comment: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setCommentAsArray(self, commentType: ghidra.program.model.listing.CommentType, comment: jpype.JArray[java.lang.String]) -> None:
        """
        Set the comment for the given type.
    ...
    def setMemoryReference(self, opIndex: typing.Union[jpype.JInt, int], refAddr: ghidra.program.model.address.Address, refType: ghidra.program.model.symbol.RefType) -> None:
        ...

    @typing.overload
    def setProperty(self, name: typing.Union[java.lang.String, str], value: ghidra.util.Saveable) -> None:
        """
    ...
    @typing.overload
    def setProperty(self, name: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        """
        Set the property name with the given value for this code unit.
    ...
    @typing.overload
    def setProperty(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JInt, int]) -> None:
        """
        Set the property name with the given value for this code unit.
    ...
    @typing.overload
    def setProperty(self, name: typing.Union[java.lang.String, str]) -> None:
        """
...
class PseudoData(PseudoCodeUnit, ghidra.program.model.listing.Data):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, dataType: ghidra.program.model.data.DataType, memBuffer: ghidra.program.model.mem.MemBuffer) -> None:
        ...

    @typing.overload
    def __init__(self, address: ghidra.program.model.address.Address, dataType: ghidra.program.model.data.DataType, memBuffer: ghidra.program.model.mem.MemBuffer) -> None:
        ...
...
class PseudoDisassembler(java.lang.Object):
    ...
    def disassemble(self, addr: ghidra.program.model.address.Address, disassemblerContext: PseudoDisassemblerContext, isInDelaySlot: typing.Union[jpype.JBoolean, bool]) -> PseudoInstruction:
        ...
        :param ghidra.program.model.address.Address addr: location to disassemble
        :param PseudoDisassemblerContext disassemblerContext: context for disassembly
        :param jpype.JBoolean or bool isInDelaySlot: true if instruction to be disassembled is in a delaySlot
    ...
    def setMaxInstructions(self, maxNumInstructions: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setRespectExecuteFlag(self, respect: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class PseudoInstruction(PseudoCodeUnit, ghidra.program.model.listing.Instruction, ghidra.program.model.lang.InstructionContext):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, prototype: ghidra.program.model.lang.InstructionPrototype, memBuffer: ghidra.program.model.mem.MemBuffer, procContext: ghidra.program.model.lang.ProcessorContext) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addrFactory: ghidra.program.model.address.AddressFactory, addr: ghidra.program.model.address.Address, prototype: ghidra.program.model.lang.InstructionPrototype, memBuffer: ghidra.program.model.mem.MemBuffer, procContext: ghidra.program.model.lang.ProcessorContext) -> None:
        """
        Construct a new PseudoInstruction within a program.
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, prototype: ghidra.program.model.lang.InstructionPrototype, memBuffer: ghidra.program.model.mem.MemBuffer, procContext: ghidra.program.model.lang.ProcessorContext) -> None:
        """
...
class PseudoDisassemblerContext(ghidra.program.model.lang.DisassemblerContext):
    ...
    def __init__(self, context: ghidra.program.model.listing.ProgramContext) -> None:
        ...
    ...
    def setValue(self, register: ghidra.program.model.lang.Register, addr: ghidra.program.model.address.Address, value: java.math.BigInteger) -> None:
        ...
...
class RepeatInstructionByteTracker(java.lang.Object):
    ...
    def __init__(self, repeatPatternLimit: typing.Union[jpype.JInt, int], repeatPatternLimitIgnoredRegion: ghidra.program.model.address.AddressSetView) -> None:
        """
        Constructor.
    ...
    def setRepeatPatternLimit(self, maxInstructions: typing.Union[jpype.JInt, int]) -> None:
        """
...
class FileOpenDataFlavorHandler(java.lang.Object):
    ...
    def handle(self, tool: ghidra.framework.plugintool.PluginTool, obj: java.lang.Object, e: java.awt.dnd.DropTargetDropEvent, f: java.awt.datatransfer.DataFlavor) -> None:
        ...
...
class FileOpenDropHandler(docking.DropTargetHandler, docking.dnd.Droppable, java.awt.event.ContainerListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, component: java.awt.Component) -> None:
        """
    ...
    @staticmethod
    def addDataFlavorHandler(dataFlavor: java.awt.datatransfer.DataFlavor, handler: FileOpenDataFlavorHandler) -> None:
        ...
...
class DecompilerConcurrentQ(java.lang.Object, typing.Generic[I, R]):
    ...
    * For non-blocking usage, simply call
    ...
    @typing.overload
    def __init__(self, callback: generic.concurrent.QCallback[I, R], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    @typing.overload
    def __init__(self, callback: generic.concurrent.QCallback[I, R], threadPoolName: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    @typing.overload
    def __init__(self, callback: generic.concurrent.QCallback[I, R], pool: generic.concurrent.GThreadPool, collectResults: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    def add(self, i: I) -> None:
        ...

    @typing.overload
    def addAll(self, collection: collections.abc.Sequence) -> None:
        ...

    @typing.overload
    def addAll(self, iterator: java.util.Iterator[I]) -> None:
        ...
    ...
    @typing.overload
    def dispose(self, timeoutSeconds: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def process(self, functions: java.util.Iterator[I], consumer: java.util.function.Consumer[R]) -> None:
        """
...
class DataTypeDependencyOrderer(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, dtManager: ghidra.program.model.data.DataTypeManager) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dtManager: ghidra.program.model.data.DataTypeManager, dtlist: java.util.ArrayList[ghidra.program.model.data.DataType]) -> None:
        """
    ...
    def addTypeList(self, dtlist: java.util.ArrayList[ghidra.program.model.data.DataType]) -> None:
        """
...
__all__ = ["ListingHighlightProvider", "CodeUnitInfo", "Option", "OptionListener", "ProgramDropProvider", "ByteCopier", "ClipboardType", "CodeUnitInfoTransferable", "AddressFactoryService", "DomainObjectService", "OptionException", "AddressInput", "SymbolInspector", "ColorAndStyle", "AddEditDialog", "EditFieldNameDialog", "SelectionTransferData", "AddressSetEditorPanel", "CommentTypes", "DataTypeNamingUtil", "EolComments", "RefRepeatComment", "FunctionXrefsTableModel", "GhidraFileOpenDataFlavorHandlerService", "HelpTopics", "HexLong", "MemoryBlockUtils", "NamespaceCache", "NamespaceChooserDialog", "NamespaceDropDownModel", "OptionUtils", "OptionValidator", "OptionsDialog", "OptionsEditorPanel", "ImporterDocumentListener", "Permissions", "ProcessorInfo", "SearchConstants", "SelectionTransferable", "ToolTipUtils", "XReferenceUtil", "XReferenceUtils", "NamespaceUtils", "SymbolPath", "PseudoCodeUnit", "PseudoData", "PseudoDataComponent", "PseudoDisassembler", "PseudoInstruction", "PseudoDisassemblerContext", "PseudoFlowProcessor", "RepeatInstructionByteTracker", "SymbolPathParser", "FileOpenDataFlavorHandler", "FileOpenDropHandler", "GenericHelpTopics", "DecompilerConcurrentQ", "DataTypeDependencyOrderer"]
