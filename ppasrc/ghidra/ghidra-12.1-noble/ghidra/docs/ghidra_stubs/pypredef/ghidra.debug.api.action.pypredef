...
class AutoMapSpec(ghidra.util.classfinder.ExtensionPoint):
    ...
    def runTask(self, tool: ghidra.framework.plugintool.PluginTool, trace: ghidra.trace.model.Trace, snap: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class GoToInput(java.lang.Record):
    ...
    def __init__(self, space: typing.Union[java.lang.String, str], offset: typing.Union[java.lang.String, str]) -> None:
        ...
...
class InstanceUtils(java.lang.Object):
    ...
    @staticmethod
    def collectUniqueInstances(cls: java.lang.Class[T], map: collections.abc.Mapping, keyFunc: java.util.function.Function[T, java.lang.String]) -> None:
        ...
...
__all__ = ["AutoMapSpec", "LocationTrackingSpec", "AutoReadMemorySpec", "LocationTracker", "GoToInput", "ActionSource", "AutoReadMemorySpecFactory", "InstanceUtils", "LocationTrackingSpecFactory"]
