...
class RestoreDialog(docking.ReusableDialogComponentProvider):
    ...
    def __init__(self, plugin: ArchivePlugin) -> None:
        ...
    ...
    def showDialog(self, pathName: typing.Union[java.lang.String, str], projectLocator: ghidra.framework.model.ProjectLocator) -> bool:
        ...
        :param ghidra.framework.model.ProjectLocator projectLocator: The project locator of the location to which the restore archive will be
                extracted.
...
__all__ = ["ArchiveDialog", "ArchivePlugin", "RestoreDialog", "ArchiveTask", "RestoreTask"]
