...
class AbstractHighlightPluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, sourceName: typing.Union[java.lang.String, str], eventName: typing.Union[java.lang.String, str], highlight: ghidra.program.util.ProgramSelection, program: ghidra.program.model.listing.Program) -> None:
        """
...
class AbstractSelectionPluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, sourceName: typing.Union[java.lang.String, str], eventName: typing.Union[java.lang.String, str], selection: ghidra.program.util.ProgramSelection, program: ghidra.program.model.listing.Program) -> None:
        """
...
class CloseProgramPluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, source: typing.Union[java.lang.String, str], p: ghidra.program.model.listing.Program, ignoreChanges: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a new plugin event.
...
class ExternalProgramLocationPluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, src: typing.Union[java.lang.String, str], loc: ghidra.program.util.ProgramLocation, program: ghidra.program.model.listing.Program) -> None:
        """
...
class ExternalProgramSelectionPluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, src: typing.Union[java.lang.String, str], sel: ghidra.program.util.ProgramSelection, program: ghidra.program.model.listing.Program) -> None:
        """
        Construct a new event.
...
class ExternalReferencePluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, src: typing.Union[java.lang.String, str], extLoc: ghidra.program.model.symbol.ExternalLocation, programPath: typing.Union[java.lang.String, str]) -> None:
        """
        Construct a new plugin event.
...
class FirstTimeAnalyzedPluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, sourceName: typing.Union[java.lang.String, str], program: ghidra.program.model.listing.Program) -> None:
        """
        Constructor
...
class OpenProgramPluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, source: typing.Union[java.lang.String, str], p: ghidra.program.model.listing.Program) -> None:
        """
        Construct a new plugin event.
...
class ProgramActivatedPluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, source: typing.Union[java.lang.String, str], activeProgram: ghidra.program.model.listing.Program) -> None:
        """
        Construct a new plugin event.
...
class ProgramHighlightPluginEvent(AbstractHighlightPluginEvent):
    ...
    def __init__(self, src: typing.Union[java.lang.String, str], hl: ghidra.program.util.ProgramSelection, program: ghidra.program.model.listing.Program) -> None:
        """
        Construct a new event.
...
class ProgramVisibilityChangePluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, source: typing.Union[java.lang.String, str], p: ghidra.program.model.listing.Program, isVisible: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a new plugin event.
...
class TreeSelectionPluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, source: typing.Union[java.lang.String, str], treeName: typing.Union[java.lang.String, str], groupPaths: jpype.JArray[ghidra.program.util.GroupPath]) -> None:
        """
...
class ViewChangedPluginEvent(ghidra.framework.plugintool.PluginEvent):
    ...
    def __init__(self, source: typing.Union[java.lang.String, str], treeName: typing.Union[java.lang.String, str], viewSet: ghidra.program.model.address.AddressSet) -> None:
        """
...
__all__ = ["AbstractHighlightPluginEvent", "AbstractLocationPluginEvent", "AbstractSelectionPluginEvent", "CloseProgramPluginEvent", "ExternalProgramLocationPluginEvent", "ExternalProgramSelectionPluginEvent", "ExternalReferencePluginEvent", "FirstTimeAnalyzedPluginEvent", "OpenProgramPluginEvent", "ProgramActivatedPluginEvent", "ProgramClosedPluginEvent", "ProgramHighlightPluginEvent", "ProgramLocationPluginEvent", "ProgramOpenedPluginEvent", "ProgramPostActivatedPluginEvent", "ProgramSelectionPluginEvent", "ProgramVisibilityChangePluginEvent", "TreeSelectionPluginEvent", "ViewChangedPluginEvent"]
