...
class StructuredSleigh(java.lang.Object):
    ...
    * Calling one Structured Sleigh userop from another still requires a "external declaration" of
    ...
    class WrapIf(java.lang.Object):
        ...
        def _else(self, body: java.lang.Runnable) -> None:
            """
    ...
    @typing.overload
    def generate(self, into: collections.abc.Mapping) -> None:
        """
...
class BlockStmt(AbstractStmt):
    ...
    def addChild(self, child: AbstractStmt) -> None:
        """
...
class StringTree(java.lang.Object):
    ...
    class Node(java.lang.Object):
        ...
        def walk(self, buf: java.lang.StringBuffer) -> None:
            ...
    ...
    class Leaf(StringTree.Node):
        ...
        def __init__(self, seq: java.lang.CharSequence) -> None:
            ...
    ...
    @typing.overload
    def append(self, tree: StringTree) -> None:
        ...
...
class AssignStmt(AbstractStmt, RValInternal, StructuredSleigh.StmtWithVal):
    ...
    def __init__(self, ctx: StructuredSleigh, lhs: StructuredSleigh.LVal, rhs: StructuredSleigh.RVal) -> None:
        ...
...
class LoopStmt(ConditionalStmt):
    ...
    def __init__(self, ctx: StructuredSleigh, cond: StructuredSleigh.RVal, stmt: StructuredSleigh.Stmt) -> None:
        ...
...
class DefaultUseropDecl(StructuredSleigh.UseropDecl):
    ...
    def __init__(self, ctx: StructuredSleigh, retType: ghidra.program.model.data.DataType, name: typing.Union[java.lang.String, str], paramTypes: java.util.List[ghidra.program.model.data.DataType]) -> None:
        ...
...
class InvExpr(UnExpr):
    ...
    def __init__(self, ctx: StructuredSleigh, u: StructuredSleigh.RVal) -> None:
        ...
...
__all__ = ["DefaultVar", "StructuredSleigh", "LValInternal", "RValInternal", "BlockStmt", "AbstractStmt", "Expr", "IfStmt", "ConditionalStmt", "RoutineStmt", "StringTree", "AssignStmt", "ArithBinExpr", "BinExpr", "BreakStmt", "LoopTruncateStmt", "LoopStmt", "CallExpr", "CmpExpr", "ContinueStmt", "DeclStmt", "LocalVar", "DefaultUseropDecl", "DerefExpr", "FieldExpr", "ForStmt", "GotoStmt", "IndexExpr", "InvExpr", "UnExpr", "LangVar", "LiteralExpr", "LiteralFloatExpr", "LiteralLongExpr", "NotExpr", "RawExpr", "RawStmt", "ResultStmt", "ReturnStmt", "VoidExprStmt", "WhileStmt"]
