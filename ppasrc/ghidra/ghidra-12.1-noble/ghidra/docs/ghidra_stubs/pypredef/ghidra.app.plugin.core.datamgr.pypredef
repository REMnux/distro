...
class DataTypesActionContext(ghidra.app.context.ProgramActionContext, ghidra.framework.main.datatable.DomainFileContext):
    ...
    @typing.overload
    def __init__(self, provider: DataTypesProvider, program: ghidra.program.model.listing.Program, archiveGTree: ghidra.app.plugin.core.datamgr.tree.DataTypeArchiveGTree, clickedNode: docking.widgets.tree.GTreeNode) -> None:
        ...

    @typing.overload
    def __init__(self, provider: DataTypesProvider, program: ghidra.program.model.listing.Program, archiveGTree: ghidra.app.plugin.core.datamgr.tree.DataTypeArchiveGTree, clickedNode: docking.widgets.tree.GTreeNode, isToolbarAction: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DataTypesProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    class ProgramNodeUpdateListener(ghidra.app.plugin.core.datamgr.tree.ArchiveRootNodeListener):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    @typing.overload
    def __init__(self, plugin: DataTypeManagerPlugin, providerName: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, plugin: DataTypeManagerPlugin, providerName: typing.Union[java.lang.String, str], isTransient: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def editNode(self, node: docking.widgets.tree.GTreeNode) -> None:
        ...
    ...
    def setFilterOnNameOnly(self, newValue: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setFilterOnNameOnlyCallback(self, newValue: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setFilterState(self, filterState: ghidra.app.plugin.core.datamgr.tree.DtFilterState) -> None:
        ...

    def setFilterText(self, text: typing.Union[java.lang.String, str]) -> None:
        ...

    def setIncludeDataTypeMembersInFilter(self, newValue: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setIncludeDataTypeMembersInFilterCallback(self, newValue: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setPreviewWindowVisible(self, visible: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DataTypeManagerPlugin(ghidra.app.plugin.ProgramPlugin, ghidra.framework.model.DomainObjectListener, ghidra.app.services.DataTypeManagerService, docking.actions.PopupActionProvider):
    ...
    def addRecentlyOpenedArchiveFile(self, file: generic.jar.ResourceFile) -> None:
        ...

    @typing.overload
    def addRecentlyOpenedProjectArchive(self, projectName: typing.Union[java.lang.String, str], pathname: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def addRecentlyOpenedProjectArchive(self, pa: ghidra.app.plugin.core.datamgr.archive.ProjectArchive) -> None:
        """
    ...
    def disassociate(self, dataTypes: ghidra.program.model.data.DataType) -> None:
        ...
...
class FilterOnNameOnlyAction(docking.action.ToggleDockingAction):
    ...
    def __init__(self, plugin: DataTypeManagerPlugin, provider: DataTypesProvider, menuSubGroup: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DataTypeSyncListener(java.lang.Object):
    ...
    def dataTypeSelected(self, syncInfo: DataTypeSyncInfo) -> None:
        """
...
class DataTypeSyncInfo(java.lang.Object):
    ...
    def __init__(self, refDt: ghidra.program.model.data.DataType, sourceDTM: ghidra.program.model.data.DataTypeManager) -> None:
        ...
...
class DataTypeSynchronizer(java.lang.Object):
    ...
    def __init__(self, dataTypeManagerHandler: ghidra.app.plugin.core.datamgr.archive.DataTypeManagerHandler, dataTypeManager: ghidra.program.model.data.DataTypeManager, source: ghidra.program.model.data.SourceArchive) -> None:
        """
    ...
    @staticmethod
    def disassociate(dataType: ghidra.program.model.data.DataType) -> None:
        """
...
class NextPreviousDataTypeAction(docking.menu.MultiActionDockingAction):
    ...
    def __init__(self, provider: DataTypesProvider, owner: typing.Union[java.lang.String, str], isNext: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["DataTypesActionContext", "DataTypesProvider", "DataTypeManagerPlugin", "FilterOnNameOnlyAction", "DataTypePropertyManager", "DataTypeComparePanel", "DataTypeSyncDialog", "DataTypeSyncListener", "DataTypeSyncPanel", "DataTypeSyncInfo", "DataTypeSyncState", "DataTypeSyncTableModel", "RowData", "DataTypeSynchronizer", "NextPreviousDataTypeAction", "OpenDomainFileTask"]
