...
class AssemblyResolution(java.lang.Comparable[AssemblyResolution]):
    ...
    def collectAllRight(self, into: collections.abc.Sequence) -> None:
        ...
...
class AssemblyConstructorSemantic(java.lang.Comparable[AssemblyConstructorSemantic]):
    ...
    def __init__(self, factory: AbstractAssemblyResolutionFactory[typing.Any, typing.Any], cons: ghidra.app.plugin.processors.sleigh.Constructor, indices: java.util.List[java.lang.Integer]) -> None:
        """
    ...
    @typing.overload
    def addPattern(self, pat: AssemblyResolvedPatterns) -> None:
        """
        Record a pattern that would select the constructor
...
class AbstractAssemblyResolutionFactory(java.lang.Object, typing.Generic[RP, BF]):
    ...
    class AbstractAssemblyResolutionBuilder(java.lang.Object, typing.Generic[B, T]):
        ...
        def copyFromDefault(self, ar: AbstractAssemblyResolution) -> None:
            ...
    ...
    class AbstractAssemblyResolvedPatternsBuilder(AbstractAssemblyResolutionFactory.AbstractAssemblyResolutionBuilder[AbstractAssemblyResolutionFactory.AbstractAssemblyResolvedPatternsBuilder[RP], RP], typing.Generic[RP]):
        ...
        def copyFromDefault(self, rp: DefaultAssemblyResolvedPatterns) -> None:
            ...
...
class AssemblyResolutionResults(org.apache.commons.collections4.set.AbstractSetDecorator[AssemblyResolution]):
    ...
    def absorb(self, that: AssemblyResolutionResults) -> None:
        """
...
class AssemblyDefaultContext(ghidra.program.model.lang.DisassemblerContext, ghidra.program.model.listing.DefaultProgramContext):
    ...
    def __init__(self, lang: ghidra.app.plugin.processors.sleigh.SleighLanguage) -> None:
        """
    ...
    @typing.overload
    def setContextRegister(self, val: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    @typing.overload
    def setContextRegister(self, ctx: AssemblyPatternBlock) -> None:
        ...
...
class AssemblyContextGraph(ghidra.graph.GImplicitDirectedGraph[AssemblyContextGraph.Vertex, AssemblyContextGraph.Edge]):
    ...
    class Edge(ghidra.graph.GEdge[AssemblyContextGraph.Vertex], java.lang.Comparable[AssemblyContextGraph.Edge]):
        ...
        def __init__(self, sem: AssemblyConstructorSemantic, op: typing.Union[jpype.JInt, int], start: AssemblyContextGraph.Vertex, end: AssemblyContextGraph.Vertex) -> None:
            """
    ...
    def __init__(self, factory: AbstractAssemblyResolutionFactory[typing.Any, typing.Any], lang: ghidra.app.plugin.processors.sleigh.SleighLanguage, grammar: ghidra.app.plugin.assembler.sleigh.grammars.AssemblyGrammar) -> None:
        """
...
class AbstractAssemblyStateGenerator(java.lang.Object, typing.Generic[N]):
    ...
    class GeneratorContext(java.lang.Object):
        ...
        def __init__(self, path: java.util.List[AssemblyConstructorSemantic], shift: typing.Union[jpype.JInt, int]) -> None:
            """
            Construct a context
    ...
    def __init__(self, resolver: AbstractAssemblyTreeResolver[typing.Any], node: N, fromLeft: AssemblyResolvedPatterns) -> None:
        """
...
class AbstractAssemblyTreeResolver(java.lang.Object, typing.Generic[RP]):
    ...
    def __init__(self, factory: AbstractAssemblyResolutionFactory[RP, typing.Any], lang: ghidra.app.plugin.processors.sleigh.SleighLanguage, at: ghidra.program.model.address.Address, tree: ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseBranch, context: AssemblyPatternBlock, ctxGraph: AssemblyContextGraph) -> None:
        """
        Construct a resolver for the given parse tree
        
        :param AbstractAssemblyResolutionFactory[RP, typing.Any] factory: a factory for assembly results
        :param ghidra.app.plugin.processors.sleigh.SleighLanguage lang: the language
    ...
    def getFactory(self) -> AbstractAssemblyResolutionFactory[RP, typing.Any]:
        ...
        :rtype: AbstractAssemblyResolutionFactory[RP, typing.Any]
        """
...
class AssemblyGeneratedPrototype(java.lang.Object):
    ...
    def __init__(self, state: AbstractAssemblyState, patterns: AssemblyResolvedPatterns) -> None:
        ...
...
class AssemblyConstructState(AbstractAssemblyState):
    ...
    def __init__(self, resolver: AbstractAssemblyTreeResolver[typing.Any], path: java.util.List[AssemblyConstructorSemantic], shift: typing.Union[jpype.JInt, int], sem: AssemblyConstructorSemantic, children: java.util.List[AbstractAssemblyState]) -> None:
        """
...
class AssemblyConstructStateGenerator(AbstractAssemblyStateGenerator[ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseBranch]):
    ...
    def __init__(self, resolver: AbstractAssemblyTreeResolver[typing.Any], node: ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseBranch, fromLeft: AssemblyResolvedPatterns) -> None:
        """
...
class AssemblyHiddenConstructStateGenerator(AssemblyConstructStateGenerator):
    ...
    def __init__(self, resolver: AbstractAssemblyTreeResolver[typing.Any], subtableSym: ghidra.app.plugin.processors.sleigh.symbol.SubtableSymbol, fromLeft: AssemblyResolvedPatterns) -> None:
        """
...
class AssemblyNopState(AbstractAssemblyState):
    ...
    def __init__(self, resolver: AbstractAssemblyTreeResolver[typing.Any], path: java.util.List[AssemblyConstructorSemantic], shift: typing.Union[jpype.JInt, int], opSym: ghidra.app.plugin.processors.sleigh.symbol.OperandSymbol) -> None:
        ...
...
class AssemblyNopStateGenerator(AbstractAssemblyStateGenerator[ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseNumericToken]):
    ...
    def __init__(self, resolver: AbstractAssemblyTreeResolver[typing.Any], opSym: ghidra.app.plugin.processors.sleigh.symbol.OperandSymbol, fromLeft: AssemblyResolvedPatterns) -> None:
        """
...
class AssemblyOperandStateGenerator(AbstractAssemblyStateGenerator[ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseNumericToken]):
    ...
    def __init__(self, resolver: AbstractAssemblyTreeResolver[typing.Any], node: ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseNumericToken, opSym: ghidra.app.plugin.processors.sleigh.symbol.OperandSymbol, fromLeft: AssemblyResolvedPatterns) -> None:
        """
...
class AssemblyStringStateGenerator(AbstractAssemblyStateGenerator[ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseToken]):
    ...
    def __init__(self, resolver: AbstractAssemblyTreeResolver[typing.Any], node: ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseToken, opSym: ghidra.app.plugin.processors.sleigh.symbol.OperandSymbol, fromLeft: AssemblyResolvedPatterns) -> None:
        ...
...
__all__ = ["AssemblyResolvedPatterns", "AssemblyResolution", "AssemblyPatternBlock", "AssemblyResolvedBackfill", "AssemblyConstructorSemantic", "AbstractAssemblyResolutionFactory", "AssemblyResolvedError", "AssemblyResolutionResults", "DefaultAssemblyResolvedPatterns", "AbstractAssemblyResolution", "AssemblyDefaultContext", "AssemblyContextGraph", "AbstractAssemblyStateGenerator", "AbstractAssemblyTreeResolver", "AssemblyGeneratedPrototype", "AbstractAssemblyState", "AssemblyTreeResolver", "AssemblyConstructState", "AssemblyConstructStateGenerator", "AssemblyHiddenConstructStateGenerator", "AssemblyNopState", "AssemblyNopStateGenerator", "AssemblyOperandState", "AssemblyOperandStateGenerator", "AssemblyStringStateGenerator", "DefaultAssemblyResolutionFactory", "DefaultAssemblyResolvedBackfill", "DefaultAssemblyResolvedError"]
