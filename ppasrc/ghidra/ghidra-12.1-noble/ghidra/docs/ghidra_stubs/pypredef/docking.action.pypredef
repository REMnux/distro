...
class DockingActionIf(help.HelpDescriptor):
    ...
    def setContextClass(self, type: java.lang.Class[docking.ActionContext], supportsDefaultContext: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setEnabled(self, newValue: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setKeyBindingData(self, keyBindingData: KeyBindingData) -> None:
        """
    ...
    def setUnvalidatedKeyBindingData(self, newKeyBindingData: KeyBindingData) -> None:
        """
...
class ToggleDockingActionIf(DockingActionIf):
    ...
    def setSelected(self, newValue: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ToolBarData(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, icon: javax.swing.Icon, toolBarGroup: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, icon: javax.swing.Icon, toolBarGroup: typing.Union[java.lang.String, str], toolBarSubGroup: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def setToolBarGroup(self, newGroup: typing.Union[java.lang.String, str]) -> None:
        ...

    def setToolBarSubGroup(self, newSubGroup: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DockingAction(DockingActionIf):
    ...
    **
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], kbType: KeyBindingType) -> None:
        ...

    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], supportsKeyBindings: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def addToWindowWhen(self, addToWindowContextClass: java.lang.Class[docking.ActionContext]) -> None:
        """
    ...
    def enabledWhen(self, predicate: java.util.function.Predicate[docking.ActionContext]) -> None:
        """
    ...
    def firePropertyChanged(self, propertyName: typing.Union[java.lang.String, str], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        ...
    ...
    def popupWhen(self, predicate: java.util.function.Predicate[docking.ActionContext]) -> None:
        """
    ...
    def setAddToAllWindows(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setDescription(self, newDescription: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setMenuBarData(self, newMenuData: MenuData) -> None:
        """
    ...
    def setPopupMenuData(self, newMenuData: MenuData) -> None:
        """
    ...
    def setToolBarData(self, newToolBarData: ToolBarData) -> None:
        """
    ...
    def validContextWhen(self, predicate: java.util.function.Predicate[docking.ActionContext]) -> None:
        """
...
class KeyBindingData(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, c: typing.Union[jpype.JChar, int, str], modifiers: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, keyCode: typing.Union[jpype.JInt, int], modifiers: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    @typing.overload
    def __init__(self, keyStrokeString: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, actionTrigger: ghidra.framework.options.ActionTrigger) -> None:
        """
    ...
    @typing.overload
    def __init__(self, keyStroke: javax.swing.KeyStroke, precedence: docking.KeyBindingPrecedence) -> None:
        ...
...
class MenuData(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, menuPath: jpype.JArray[java.lang.String]) -> None:
        ...

    @typing.overload
    def __init__(self, menuPath: jpype.JArray[java.lang.String], group: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, menuPath: jpype.JArray[java.lang.String], icon: javax.swing.Icon) -> None:
        ...

    @typing.overload
    def __init__(self, menuPath: jpype.JArray[java.lang.String], icon: javax.swing.Icon, menuGroup: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, menuPath: jpype.JArray[java.lang.String], icon: javax.swing.Icon, menuGroup: typing.Union[java.lang.String, str], mnemonic: typing.Union[jpype.JInt, int], menuSubGroup: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, menuData: MenuData) -> None:
        ...

    def clearMnemonic(self) -> None:
        ...
    ...
    @staticmethod
    @typing.overload
    def getMnemonic(menuPath: jpype.JArray[java.lang.String]) -> int:
        ...

    @staticmethod
    @typing.overload
    def getMnemonic(menuName: typing.Union[java.lang.String, str]) -> int:
        """
        Parses the mnemonic key from the menu items text.
        
        :param java.lang.String or str menuName: the menu item text
    ...
    def setMenuGroup(self, newGroup: typing.Union[java.lang.String, str]) -> None:
        ...

    def setMenuItemName(self, newMenuItemName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setMenuItemNamePlain(self, newMenuItemName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setMenuPath(self, newPath: jpype.JArray[java.lang.String]) -> None:
        ...

    def setMenuSubGroup(self, newSubGroup: typing.Union[java.lang.String, str]) -> None:
        ...

    def setMnemonic(self, newMnemonic: typing.Union[java.lang.Character, int, str]) -> None:
        ...

    def setParentMenuGroup(self, newParentMenuGroup: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    def stripMnemonicAmp(menuItemName: typing.Union[java.lang.String, str]) -> str:
        """
        Removes any single ``'&'`` characters used to set the mnemonic from the menu item name.  
        The ``'&'`` character can be included in the name by escaping with another ``'&'`` 
        character.
        
        :param java.lang.String or str menuItemName: the name that may include mnemonic information
...
class KeyBindingsManager(java.beans.PropertyChangeListener):
    ...
    def __init__(self, tool: docking.Tool) -> None:
        ...

    def addAction(self, optionalProvider: docking.ComponentProvider, action: DockingActionIf) -> None:
        ...

    def addSystemAction(self, action: DockingActionIf) -> None:
        ...
    ...
    def removeAction(self, action: DockingActionIf) -> None:
        ...
...
class AbstractHelpAction(DockingAction):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], keyStroke: javax.swing.KeyStroke, isPrimary: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ComponentThemeInspectorAction(DockingAction):
    ...
    class Entry(java.lang.Object):
        ...
        def toString(self, buffy: java.lang.StringBuilder, indent: typing.Union[jpype.JInt, int]) -> None:
            ...
...
class ContextSpecificAction(DockingAction, typing.Generic[T]):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], contextClass: java.lang.Class[T]) -> None:
        """
        Constructor
...
class GlobalFocusTraversalAction(DockingAction):
    ...
    def __init__(self, keybinding: javax.swing.KeyStroke, forward: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class HelpAction(AbstractHelpAction):
    ...
    def __init__(self, keyStroke: javax.swing.KeyStroke, isPrimary: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class HelpInfoAction(AbstractHelpAction):
    ...
    def __init__(self, keybinding: javax.swing.KeyStroke) -> None:
        ...
...
class MultipleKeyAction(docking.DockingKeyBindingAction):
    ...
    Actions are ordered in a way that mimics how the :obj:`KeyBindingOverrideKeyEventDispatcher` 
    ...
    def __init__(self, tool: docking.Tool, provider: docking.ComponentProvider, action: DockingActionIf, keyStroke: javax.swing.KeyStroke) -> None:
        """
    ...
    def addAction(self, provider: docking.ComponentProvider, action: DockingActionIf) -> None:
        ...
...
class ToggleDockingAction(DockingAction, ToggleDockingActionIf):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], keyBindingType: KeyBindingType) -> None:
        ...
...
__all__ = ["ActionContextProvider", "DockingActionIf", "ToggleDockingActionIf", "MultiActionDockingActionIf", "ToolBarData", "DockingAction", "KeyBindingType", "KeyBindingData", "MenuBarData", "MenuData", "PopupMenuData", "KeyBindingsManager", "AbstractHelpAction", "ComponentBasedDockingAction", "ComponentThemeInspectorAction", "ContextSpecificAction", "DockingActionProviderIf", "GlobalFocusTraversalAction", "HelpAction", "HelpInfoAction", "MultipleKeyAction", "NextPreviousWindowAction", "ShowActionChooserDialogAction", "ShowContextMenuAction", "ShowFocusCycleAction", "ShowFocusInfoAction", "SystemKeyBindingAction", "ToggleDockingAction"]
