...
class ClearOptions(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, defaultClearState: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShouldClear(self, type: ClearOptions.ClearType, shouldClear: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ClearCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, cu: ghidra.program.model.listing.CodeUnit, options: ClearOptions) -> None:
        """
    ...
    @typing.overload
    def __init__(self, view: ghidra.program.model.address.AddressSetView, options: ClearOptions) -> None:
        """
    ...
    @typing.overload
    def __init__(self, view: ghidra.program.model.address.AddressSetView) -> None:
        """
...
class ClearDialog(docking.DialogComponentProvider):
    ...
    def setProgramActionContext(self, context: ghidra.app.context.ListingActionContext) -> None:
        ...
...
class ClearFlowAndRepairCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, startAddr: ghidra.program.model.address.Address, clearData: typing.Union[jpype.JBoolean, bool], clearLabels: typing.Union[jpype.JBoolean, bool], repair: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, startAddrs: ghidra.program.model.address.AddressSetView, clearData: typing.Union[jpype.JBoolean, bool], clearLabels: typing.Union[jpype.JBoolean, bool], repair: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, startAddrs: ghidra.program.model.address.AddressSetView, protectedSet: ghidra.program.model.address.AddressSetView, clearData: typing.Union[jpype.JBoolean, bool], clearLabels: typing.Union[jpype.JBoolean, bool], repair: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @staticmethod
    @typing.overload
    def clearBadBookmarks(program: ghidra.program.model.listing.Program, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    @staticmethod
    @typing.overload
    def clearBadBookmarks(program: ghidra.program.model.listing.Program, set: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
__all__ = ["ClearOptions", "ClearCmd", "ClearDialog", "ClearPlugin", "ClearFlowAndRepairCmd", "ClearFlowDialog"]
