...
class AddFunctionTagCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, tagName: typing.Union[java.lang.String, str], entryPoint: ghidra.program.model.address.Address) -> None:
        """
        Constructor
...
class AddMemoryParameterCommand(AddParameterCommand):
    ...
    def __init__(self, function: ghidra.program.model.listing.Function, memAddr: ghidra.program.model.address.Address, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, ordinal: typing.Union[jpype.JInt, int], source: ghidra.program.model.symbol.SourceType) -> None:
        ...
...
class AddParameterCommand(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, function: ghidra.program.model.listing.Function, parameter: ghidra.program.model.listing.Parameter, ordinal: typing.Union[jpype.JInt, int], source: ghidra.program.model.symbol.SourceType) -> None:
        ...
...
class AddMemoryVarCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, memAddr: ghidra.program.model.address.Address, firstUseAddr: ghidra.program.model.address.Address, name: typing.Union[java.lang.String, str], source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, memAddr: ghidra.program.model.address.Address, firstUseAddr: ghidra.program.model.address.Address, name: typing.Union[java.lang.String, str], dt: ghidra.program.model.data.DataType, source: ghidra.program.model.symbol.SourceType) -> None:
        """
        Constructs a new command to add a memory variable to a function.
...
class AddRegisterParameterCommand(AddParameterCommand):
    ...
    def __init__(self, function: ghidra.program.model.listing.Function, register: ghidra.program.model.lang.Register, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, ordinal: typing.Union[jpype.JInt, int], source: ghidra.program.model.symbol.SourceType) -> None:
        ...
...
class AddRegisterVarCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, reg: ghidra.program.model.lang.Register, name: typing.Union[java.lang.String, str], source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, reg: ghidra.program.model.lang.Register, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, source: ghidra.program.model.symbol.SourceType) -> None:
        """
        Constructs a new command to add a register variable to a function.
...
class AddStackParameterCommand(AddParameterCommand):
    ...
    def __init__(self, function: ghidra.program.model.listing.Function, stackOffset: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, ordinal: typing.Union[jpype.JInt, int], source: ghidra.program.model.symbol.SourceType) -> None:
        ...
...
class AddStackVarCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, addr: ghidra.program.model.address.Address, stackOffset: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, source: ghidra.program.model.symbol.SourceType) -> None:
        """
...
class ApplyFunctionDataTypesCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, managers: java.util.List[ghidra.program.model.data.DataTypeManager], set: ghidra.program.model.address.AddressSetView, source: ghidra.program.model.symbol.SourceType, alwaysReplace: typing.Union[jpype.JBoolean, bool], createBookmarksEnabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, sourceCategory: ghidra.program.model.data.Category, set: ghidra.program.model.address.AddressSetView, source: ghidra.program.model.symbol.SourceType, alwaysReplace: typing.Union[jpype.JBoolean, bool], createBookmarksEnabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new command to apply all function signature data types
...
class ApplyFunctionSignatureCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, entry: ghidra.program.model.address.Address, signature: ghidra.program.model.listing.FunctionSignature, source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, entry: ghidra.program.model.address.Address, signature: ghidra.program.model.listing.FunctionSignature, source: ghidra.program.model.symbol.SourceType, preserveCallingConvention: typing.Union[jpype.JBoolean, bool], forceSetName: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new command for applying a signature to an existing function.
    ...
    @typing.overload
    def __init__(self, entry: ghidra.program.model.address.Address, signature: ghidra.program.model.listing.FunctionSignature, source: ghidra.program.model.symbol.SourceType, preserveCallingConvention: typing.Union[jpype.JBoolean, bool], functionRenameOption: FunctionRenameOption) -> None:
        """
        Constructs a new command for applying a signature to an existing function.
...
class CallDepthChangeInfo(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, func: ghidra.program.model.listing.Function) -> None:
        """
    ...
    @typing.overload
    def __init__(self, func: ghidra.program.model.listing.Function, storeDepthAtEachInstuction: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a new CallDepthChangeInfo object.
    ...
    @typing.overload
    def __init__(self, func: ghidra.program.model.listing.Function, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Construct a new CallDepthChangeInfo object.
    ...
    @typing.overload
    def __init__(self, function: ghidra.program.model.listing.Function, restrictSet: ghidra.program.model.address.AddressSetView, frameReg: ghidra.program.model.lang.Register, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Construct a new CallDepthChangeInfo object.
    ...
    @staticmethod
    def setStackDepthChange(program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, stackDepthChange: typing.Union[jpype.JInt, int]) -> None:
        """
...
class CaptureFunctionDataTypesCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, dtm: ghidra.program.model.data.DataTypeManager, set: ghidra.program.model.address.AddressSetView, listener: CaptureFunctionDataTypesListener) -> None:
        """
...
class CaptureFunctionDataTypesListener(java.lang.Object):
    ...
    def captureFunctionDataTypesCompleted(self, cmd: CaptureFunctionDataTypesCmd) -> None:
        """
...
class ChangeFunctionTagCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, tagName: typing.Union[java.lang.String, str], newVal: typing.Union[java.lang.String, str], field: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
...
class CreateExternalFunctionCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, extSymbol: ghidra.program.model.symbol.Symbol) -> None:
        """
    ...
    @typing.overload
    def __init__(self, libraryName: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], address: ghidra.program.model.address.Address, source: ghidra.program.model.symbol.SourceType) -> None:
        """
        Create an external function
    ...
    @typing.overload
    def __init__(self, externalParentNamespace: ghidra.program.model.symbol.Namespace, name: typing.Union[java.lang.String, str], address: ghidra.program.model.address.Address, source: ghidra.program.model.symbol.SourceType) -> None:
        """
...
class CreateFunctionCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], entry: ghidra.program.model.address.Address, body: ghidra.program.model.address.AddressSetView, source: ghidra.program.model.symbol.SourceType, findEntryPoint: typing.Union[jpype.JBoolean, bool], recreateFunction: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new command for creating a function.  The default name
        for a function is the name associated with the current primary symbol which
        will be removed.
    ...
    @typing.overload
    def __init__(self, entries: ghidra.program.model.address.AddressSetView, findEntryPoint: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, entries: ghidra.program.model.address.AddressSetView) -> None:
        """
        Constructs a new command for creating functions that automatically computes
        the body of each function.
    ...
    @typing.overload
    def __init__(self, entries: ghidra.program.model.address.AddressSetView, source: ghidra.program.model.symbol.SourceType) -> None:
        """
        Constructs a new command for creating functions that automatically computes
        the body of each function.
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], entry: ghidra.program.model.address.Address, body: ghidra.program.model.address.AddressSetView, source: ghidra.program.model.symbol.SourceType) -> None:
        ...

    @typing.overload
    def __init__(self, entry: ghidra.program.model.address.Address) -> None:
        """
    ...
    @typing.overload
    def __init__(self, entry: ghidra.program.model.address.Address, findEntryPoint: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class CreateFunctionDefinitionCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, entry: ghidra.program.model.address.Address, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> None:
        """
...
class CreateFunctionTagCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class CreateMultipleFunctionsCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, selection: ghidra.program.model.address.AddressSetView, source: ghidra.program.model.symbol.SourceType) -> None:
        ...
...
class CreateThunkFunctionCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, entry: ghidra.program.model.address.Address, body: ghidra.program.model.address.AddressSetView, referencedFunctionAddr: ghidra.program.model.address.Address, referringThunkAddresses: java.util.List[ghidra.program.model.address.Address]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, entry: ghidra.program.model.address.Address, body: ghidra.program.model.address.AddressSetView, referencedFunctionAddr: ghidra.program.model.address.Address) -> None:
        """
        Constructs a new command for creating a thunk function.
    ...
    @typing.overload
    def __init__(self, entry: ghidra.program.model.address.Address, body: ghidra.program.model.address.AddressSetView, referencedSymbol: ghidra.program.model.symbol.Symbol) -> None:
        """
        Constructs a new command for creating a thunk function.
    ...
    @typing.overload
    def __init__(self, entry: ghidra.program.model.address.Address, checkForSideEffects: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DeleteFunctionCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, entry: ghidra.program.model.address.Address, ignoreMissingFunction: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DeleteFunctionTagCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, tagName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class DeleteVariableCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, var: ghidra.program.model.listing.Variable) -> None:
        ...
...
class FunctionResultStateStackAnalysisCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, entries: ghidra.program.model.address.AddressSetView, forceProcessing: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new command for analyzing the Stack.
    ...
    @typing.overload
    def __init__(self, entry: ghidra.program.model.address.Address, forceProcessing: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new command for analyzing the Stack.
...
class FunctionStackAnalysisCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, entries: ghidra.program.model.address.AddressSetView, doParameterAnalysis: typing.Union[jpype.JBoolean, bool], doLocalAnalysis: typing.Union[jpype.JBoolean, bool], forceProcessing: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class NewFunctionStackAnalysisCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, entries: ghidra.program.model.address.AddressSetView, createStackParams: typing.Union[jpype.JBoolean, bool], createLocalStackVars: typing.Union[jpype.JBoolean, bool], forceProcessing: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class SetFunctionNameCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, entry: ghidra.program.model.address.Address, newName: typing.Union[java.lang.String, str], source: ghidra.program.model.symbol.SourceType) -> None:
        """
...
class SetFunctionPurgeCommand(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, function: ghidra.program.model.listing.Function, newPurge: typing.Union[jpype.JInt, int]) -> None:
        """
...
class SetFunctionRepeatableCommentCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, entry: ghidra.program.model.address.Address, newRepeatableComment: typing.Union[java.lang.String, str]) -> None:
        """
...
class SetFunctionVarArgsCommand(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, function: ghidra.program.model.listing.Function, hasVarArgs: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class SetReturnDataTypeCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, entry: ghidra.program.model.address.Address, dataType: ghidra.program.model.data.DataType, source: ghidra.program.model.symbol.SourceType) -> None:
        """
...
class SetStackDepthChangeCommand(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, address: ghidra.program.model.address.Address, newStackDepthChange: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class SetVariableCommentCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, var: ghidra.program.model.listing.Variable, newComment: typing.Union[java.lang.String, str]) -> None:
        """
...
class SetVariableDataTypeCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, var: ghidra.program.model.listing.Variable, dataType: ghidra.program.model.data.DataType, source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, fnEntry: ghidra.program.model.address.Address, varName: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, source: ghidra.program.model.symbol.SourceType) -> None:
        """
        Constructs a new command for setting the datatype on a stack/reg variable.
        Conflicting stack variables will be removed.
    ...
    @typing.overload
    def __init__(self, fnEntry: ghidra.program.model.address.Address, varName: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, align: typing.Union[jpype.JBoolean, bool], force: typing.Union[jpype.JBoolean, bool], source: ghidra.program.model.symbol.SourceType) -> None:
        """
        Constructs a new command for setting the datatype on a stack/reg variable
...
class SetVariableNameCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, var: ghidra.program.model.listing.Variable, newName: typing.Union[java.lang.String, str], source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, fnEntry: ghidra.program.model.address.Address, varName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str], source: ghidra.program.model.symbol.SourceType) -> None:
        """
        Constructs a new command to rename a stack/reg variable.
...
class DecompilerParallelConventionAnalysisCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, func: ghidra.program.model.listing.Function, decompilerInterface: ghidra.app.decompiler.DecompInterface, decompilerTimeoutSecs: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DecompilerSwitchAnalysisCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, decompileResults: ghidra.app.decompiler.DecompileResults) -> None:
        ...
...
__all__ = ["AddFunctionTagCmd", "AddMemoryParameterCommand", "AddParameterCommand", "AddMemoryVarCmd", "AddRegisterParameterCommand", "AddRegisterVarCmd", "AddStackParameterCommand", "AddStackVarCmd", "ApplyFunctionDataTypesCmd", "ApplyFunctionSignatureCmd", "FunctionRenameOption", "CallDepthChangeInfo", "CaptureFunctionDataTypesCmd", "CaptureFunctionDataTypesListener", "ChangeFunctionTagCmd", "CreateExternalFunctionCmd", "CreateFunctionCmd", "CreateFunctionDefinitionCmd", "CreateFunctionTagCmd", "CreateMultipleFunctionsCmd", "CreateThunkFunctionCmd", "DeleteFunctionCmd", "DeleteFunctionTagCmd", "DeleteVariableCmd", "FunctionPurgeAnalysisCmd", "FunctionResultStateStackAnalysisCmd", "FunctionStackAnalysisCmd", "NewFunctionStackAnalysisCmd", "RemoveFunctionTagCmd", "RemoveStackDepthChangeCommand", "SetFunctionNameCmd", "SetFunctionPurgeCommand", "SetFunctionRepeatableCommentCmd", "SetFunctionVarArgsCommand", "SetReturnDataTypeCmd", "SetStackDepthChangeCommand", "SetVariableCommentCmd", "SetVariableDataTypeCmd", "SetVariableNameCmd", "UpdateFunctionCommand", "DecompilerParallelConventionAnalysisCmd", "DecompilerParameterIdCmd", "DecompilerSwitchAnalysisCmd"]
