...
class DWARFMacroOpcode(java.lang.Enum[DWARFMacroOpcode]):
    ...
    class Def(ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeDef[DWARFMacroOpcode]):
        ...
        def __init__(self, opcode: DWARFMacroOpcode, rawOpcode: typing.Union[jpype.JInt, int], form: ghidra.app.util.bin.format.dwarf.attribs.DWARFForm) -> None:
            ...
