...
class DebuggerStaticMappingUtils(java.lang.Enum[DebuggerStaticMappingUtils]):
    ...
    class Extrema(java.lang.Object):
        ...
        @typing.overload
        def consider(self, min: ghidra.program.model.address.Address, max: ghidra.program.model.address.Address) -> None:
            ...

        @typing.overload
        def consider(self, range: ghidra.program.model.address.AddressRange) -> None:
            ...

        @typing.overload
        def consider(self, address: ghidra.program.model.address.Address) -> None:
            ...
    ...
    @staticmethod
    def addIdentityMapping(from_: ghidra.trace.model.Trace, toProgram: ghidra.program.model.listing.Program, lifespan: ghidra.trace.model.Lifespan, truncateExisting: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @staticmethod
    @typing.overload
    def addMapping(from_: ghidra.trace.model.TraceLocation, to: ghidra.program.util.ProgramLocation, length: typing.Union[jpype.JLong, int], truncateExisting: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def addMapping(entry: ghidra.debug.api.modules.MapEntry[typing.Any, typing.Any], truncateExisting: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class AbstractMapEntry(ghidra.debug.api.modules.MapEntry[T, P], typing.Generic[T, P]):
    ...
    def __init__(self, fromTrace: ghidra.trace.model.Trace, fromObject: T, snap: typing.Union[jpype.JLong, int], toProgram: ghidra.program.model.listing.Program, toObject: P) -> None:
        ...
...
class AbstractMapProposal(ghidra.debug.api.modules.MapProposal[T, P, E], typing.Generic[T, P, E]):
    ...
    class MatcherMap(java.lang.Object, typing.Generic[K, T, P, M]):
        ...
        def __init__(self, snap: typing.Union[jpype.JLong, int]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, trace: ghidra.trace.model.Trace, program: ghidra.program.model.listing.Program) -> None:
        ...
...
class ProgramModuleIndexer(ghidra.framework.model.DomainFolderChangeListener):
    ...
    @staticmethod
    def addModulePaths(program: ghidra.program.model.listing.Program, moduleNames: collections.abc.Sequence) -> None:
        ...
    ...
    @staticmethod
    def setModulePaths(program: ghidra.program.model.listing.Program, moduleNames: collections.abc.Sequence) -> None:
        ...
...
class DebuggerStaticMappingProposals(java.lang.Enum[DebuggerStaticMappingProposals]):
    ...
    class ModuleMapProposalGenerator(DebuggerStaticMappingProposals.ProposalGenerator[ghidra.trace.model.modules.TraceModule, ghidra.program.model.listing.Program, ghidra.debug.api.modules.ModuleMapProposal]):
        ...
        def __init__(self, indexer: ProgramModuleIndexer) -> None:
            ...
...
class DebuggerStaticMappingServicePlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.DebuggerStaticMappingService, ghidra.framework.model.DomainFolderChangeListener):
    ...
    class ChangeCollector(java.lang.Record, java.lang.AutoCloseable):
        ...
        def __init__(self, plugin: DebuggerStaticMappingServicePlugin) -> None:
            ...
        ...
        def programAffected(self, program: ghidra.program.model.listing.Program) -> None:
            ...
        ...
        def traceAffected(self, trace: ghidra.trace.model.Trace) -> None:
            ...
...
class MappingEntry(java.lang.Object):
    ...
    def __init__(self, mapping: ghidra.trace.model.modules.TraceStaticMapping) -> None:
        ...
...
class DefaultRegionMapProposal(AbstractMapProposal[ghidra.trace.model.memory.TraceMemoryRegion, ghidra.program.model.mem.MemoryBlock, ghidra.debug.api.modules.RegionMapProposal.RegionMapEntry], ghidra.debug.api.modules.RegionMapProposal):
    ...
    class DefaultRegionMapEntry(AbstractMapEntry[ghidra.trace.model.memory.TraceMemoryRegion, ghidra.program.model.mem.MemoryBlock], ghidra.debug.api.modules.RegionMapProposal.RegionMapEntry):
        ...
        def __init__(self, region: ghidra.trace.model.memory.TraceMemoryRegion, snap: typing.Union[jpype.JLong, int], program: ghidra.program.model.listing.Program, block: ghidra.program.model.mem.MemoryBlock) -> None:
            ...
    ...
    class RegionMatcher(AbstractMapProposal.Matcher[ghidra.trace.model.memory.TraceMemoryRegion, ghidra.program.model.mem.MemoryBlock]):
        ...
        def __init__(self, region: ghidra.trace.model.memory.TraceMemoryRegion, snap: typing.Union[jpype.JLong, int], block: ghidra.program.model.mem.MemoryBlock) -> None:
            ...
...
class DefaultSectionMapProposal(AbstractMapProposal[ghidra.trace.model.modules.TraceSection, ghidra.program.model.mem.MemoryBlock, ghidra.debug.api.modules.SectionMapProposal.SectionMapEntry], ghidra.debug.api.modules.SectionMapProposal):
    ...
    class SectionMatcher(AbstractMapProposal.Matcher[ghidra.trace.model.modules.TraceSection, ghidra.program.model.mem.MemoryBlock]):
        ...
        def __init__(self, section: ghidra.trace.model.modules.TraceSection, snap: typing.Union[jpype.JLong, int], block: ghidra.program.model.mem.MemoryBlock) -> None:
            ...
...
class DynamicStaticSynchronizationPlugin(ghidra.framework.plugintool.Plugin):
    ...
    def setSyncLocations(self, sync: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setSyncSelections(self, sync: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class MapModulesBackgroundCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.trace.model.Trace]):
    ...
    def __init__(self, service: ghidra.app.services.DebuggerStaticMappingService, entries: collections.abc.Sequence) -> None:
        ...
...
class PeekOpenedDomainObject(java.lang.AutoCloseable):
    ...
    def __init__(self, df: ghidra.framework.model.DomainFile) -> None:
        ...



__all__ = ["DebuggerStaticMappingUtils", "AbstractMapEntry", "AbstractMapProposal", "ProgramModuleIndexer", "DebuggerStaticMappingProposals", "DebuggerStaticMappingServicePlugin", "InfoPerTrace", "InfoPerProgram", "MappingEntry", "DefaultModuleMapProposal", "ModuleRegionMatcher", "DefaultRegionMapProposal", "DefaultSectionMapProposal", "DynamicStaticSynchronizationPlugin", "MapModulesBackgroundCommand", "MapRegionsBackgroundCommand", "MapSectionsBackgroundCommand", "PeekOpenedDomainObject"]
