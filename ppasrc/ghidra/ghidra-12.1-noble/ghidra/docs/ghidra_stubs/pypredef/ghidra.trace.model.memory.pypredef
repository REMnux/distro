...
class TraceMemoryManager(TraceMemoryOperations):
    ...
    def deleteOverlayAddressSpace(self, name: typing.Union[java.lang.String, str]) -> None:
        """
...
class TraceMemoryOperations(java.lang.Object):
    ...
    def removeBytes(self, snap: typing.Union[jpype.JLong, int], start: ghidra.program.model.address.Address, len: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def removeValue(self, platform: ghidra.trace.model.guest.TracePlatform, snap: typing.Union[jpype.JLong, int], register: ghidra.program.model.lang.Register) -> None:
        """
    ...
    @typing.overload
    def removeValue(self, snap: typing.Union[jpype.JLong, int], register: ghidra.program.model.lang.Register) -> None:
        """
    ...
    @typing.overload
    def setState(self, snap: typing.Union[jpype.JLong, int], range: ghidra.program.model.address.AddressRange, state: TraceMemoryState) -> None:
        """
    ...
    @typing.overload
    def setState(self, snap: typing.Union[jpype.JLong, int], address: ghidra.program.model.address.Address, state: TraceMemoryState) -> None:
        """
    ...
    @typing.overload
    def setState(self, snap: typing.Union[jpype.JLong, int], start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address, state: TraceMemoryState) -> None:
        """
    ...
    @typing.overload
    def setState(self, snap: typing.Union[jpype.JLong, int], set: ghidra.program.model.address.AddressSetView, state: TraceMemoryState) -> None:
        """
    ...
    @typing.overload
    def setState(self, platform: ghidra.trace.model.guest.TracePlatform, snap: typing.Union[jpype.JLong, int], register: ghidra.program.model.lang.Register, state: TraceMemoryState) -> None:
        """
    ...
    @typing.overload
    def setState(self, snap: typing.Union[jpype.JLong, int], register: ghidra.program.model.lang.Register, state: TraceMemoryState) -> None:
        """
        Set the state of a given register at a given time
...
class TraceMemoryRegion(ghidra.trace.model.TraceUniqueObject, ghidra.trace.model.target.iface.TraceObjectInterface):
    ...
    @typing.overload
    def addFlags(self, lifespan: ghidra.trace.model.Lifespan, flags: collections.abc.Sequence) -> None:
        """
    ...
    @typing.overload
    def addFlags(self, snap: typing.Union[jpype.JLong, int], flags: collections.abc.Sequence) -> None:
        """
        Add the given flags, e.g., permissions, to this region
    ...
    @typing.overload
    def addFlags(self, snap: typing.Union[jpype.JLong, int], *flags: TraceMemoryFlag) -> None:
        """
        Add the given flags, e.g., permissions, to this region
    ...
    @typing.overload
    def clearFlags(self, lifespan: ghidra.trace.model.Lifespan, flags: collections.abc.Sequence) -> None:
        """
    ...
    @typing.overload
    def clearFlags(self, snap: typing.Union[jpype.JLong, int], flags: collections.abc.Sequence) -> None:
        """
        Remove the given flags, e.g., permissions, from this region
    ...
    @typing.overload
    def clearFlags(self, snap: typing.Union[jpype.JLong, int], *flags: TraceMemoryFlag) -> None:
        """
        Remove the given flags, e.g., permissions, from this region
    ...
    def remove(self, snap: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setExecute(self, snap: typing.Union[jpype.JLong, int], execute: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def setFlags(self, lifespan: ghidra.trace.model.Lifespan, flags: collections.abc.Sequence) -> None:
        """
    ...
    @typing.overload
    def setFlags(self, snap: typing.Union[jpype.JLong, int], flags: collections.abc.Sequence) -> None:
        """
        Set the flags, e.g., permissions, of this region
    ...
    @typing.overload
    def setFlags(self, snap: typing.Union[jpype.JLong, int], *flags: TraceMemoryFlag) -> None:
        """
        Set the flags, e.g., permissions, of this region
    ...
    def setLength(self, snap: typing.Union[jpype.JLong, int], length: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setMaxAddress(self, snap: typing.Union[jpype.JLong, int], max: ghidra.program.model.address.Address) -> None:
        """
    ...
    def setMinAddress(self, snap: typing.Union[jpype.JLong, int], min: ghidra.program.model.address.Address) -> None:
        """
    ...
    @typing.overload
    def setName(self, lifespan: ghidra.trace.model.Lifespan, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setName(self, snap: typing.Union[jpype.JLong, int], name: typing.Union[java.lang.String, str]) -> None:
        """
        Set the "short name" of this region
    ...
    @typing.overload
    def setRange(self, lifespan: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange) -> None:
        """
    ...
    @typing.overload
    def setRange(self, snap: typing.Union[jpype.JLong, int], range: ghidra.program.model.address.AddressRange) -> None:
        """
        Set the virtual memory address range of this region
    ...
    def setRead(self, snap: typing.Union[jpype.JLong, int], read: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setVolatile(self, snap: typing.Union[jpype.JLong, int], vol: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setWrite(self, snap: typing.Union[jpype.JLong, int], write: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class TraceOverlappedRegionException(ghidra.util.exception.UsrException):
    ...
    def __init__(self, conflicts: collections.abc.Sequence) -> None:
        ...
...
class RegisterValueConverter(java.lang.Object):
    ...
    def __init__(self, registerValue: ghidra.trace.model.target.TraceObjectValue) -> None:
        ...
...
class TraceRegister(ghidra.trace.model.target.iface.TraceObjectInterface):
    ...
    def setState(self, lifespan: ghidra.trace.model.Lifespan, state: TraceMemoryState) -> None:
        ...

    def setValue(self, lifespan: ghidra.trace.model.Lifespan, value: jpype.JArray[jpype.JByte]) -> None:
        ...
...
class TraceMemorySpaceInputStream(java.io.InputStream):
    ...
    def __init__(self, program: ghidra.trace.model.program.TraceProgramView, space: TraceMemorySpace, range: ghidra.program.model.address.AddressRange) -> None:
        ...



__all__ = ["TraceMemoryState", "TraceMemoryManager", "TraceMemoryOperations", "TraceMemoryFlag", "TraceMemoryRegion", "TraceOverlappedRegionException", "TraceMemorySpace", "TraceRegisterContainer", "RegisterValueConverter", "RegisterValueException", "TraceMemory", "TraceRegister", "TraceMemorySpaceInputStream"]
