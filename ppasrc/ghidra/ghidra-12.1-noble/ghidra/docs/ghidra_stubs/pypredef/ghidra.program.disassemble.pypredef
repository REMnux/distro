...
class Disassembler(DisassemblerConflictHandler):
    ...
    def setSeedContext(self, seedContext: DisassemblerContextImpl) -> None:
        """
...
class DisassemblerContextImpl(ghidra.program.model.lang.DisassemblerContext):
    ...
    @typing.overload
    def setValue(self, register: ghidra.program.model.lang.Register, address: ghidra.program.model.address.Address, newValue: java.math.BigInteger) -> None:
        """
    ...
    @typing.overload
    def setValue(self, register: ghidra.program.model.lang.Register, fromAddr: ghidra.program.model.address.Address, toAddr: ghidra.program.model.address.Address, newValue: java.math.BigInteger) -> None:
        """
        Sets the value for the given register to be used when the flow advances to the given address
        using either the flowTo() or flowStart() methods.  The new value has precedence over any
        existing value.
...
class DisassemblerMessageListener(java.lang.Object):
    ...
    def disassembleMessageReported(self, msg: typing.Union[java.lang.String, str]) -> None:
        """
...
class ReDisassembler(java.lang.Object):
    ...
    class ReDisBlock(java.lang.Object):
        ...
        def __init__(self, state: ReDisassembler.ReDisState, entry: ReDisassembler.Flow) -> None:
            ...
    ...
    class ReDisassemblerContext(ghidra.program.model.lang.DisassemblerContextAdapter):
        ...
        def __init__(self, state: ReDisassembler.ReDisState, flow: ReDisassembler.Flow) -> None:
            ...
...
__all__ = ["Disassembler", "DisassemblerConflictHandler", "DisassemblerContextImpl", "DisassemblerMessageListener", "DisassemblerQueue", "ReDisassembler"]
