...
class BSimOverviewProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, plugin: ghidra.features.bsim.gui.BSimSearchPlugin, serverInfo: ghidra.features.bsim.query.BSimServerInfo, program: ghidra.program.model.listing.Program, vFactory: generic.lsh.vector.LSHVectorFactory, settings: ghidra.features.bsim.gui.search.dialog.BSimSearchSettings) -> None:
        ...

    def getProgram(self) -> ghidra.program.model.listing.Program:
        ...

    def overviewResultAdded(self, result: ghidra.features.bsim.query.protocol.ResponseNearestVector) -> None:
        ...

    def setFinalOverviewResults(self, result: ghidra.features.bsim.query.protocol.ResponseNearestVector) -> None:
        ...
...
class BSimOverviewRowObject(java.lang.Object):
    ...
    def __init__(self, result: ghidra.features.bsim.query.protocol.SimilarityVectorResult, ad: ghidra.program.model.address.Address, vectorFactory: generic.lsh.vector.LSHVectorFactory, program: ghidra.program.model.listing.Program) -> None:
        """
        Constructor.
...
__all__ = ["BSimOverviewProvider", "BSimOverviewModel", "BSimOverviewRowObject", "BSimOverviewRowObjectToAddressTableRowMapper"]
