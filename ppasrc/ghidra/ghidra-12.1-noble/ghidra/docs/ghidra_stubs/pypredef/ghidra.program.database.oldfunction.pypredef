...
class OldFunctionManager(db.util.ErrorHandler):
    ...
    **NOTE: Programmers should not use this class!**
    ...
    def __init__(self, dbHandle: db.DBHandle, errHandler: db.util.ErrorHandler, addrMap: ghidra.program.database.map.AddressMap) -> None:
        """
...
__all__ = ["OldFunctionManager", "OldFunctionMapDB", "OldFunctionDBAdapter", "OldStackVariableDBAdapter", "OldRegisterVariableDBAdapter", "OldFunctionDataDB", "OldStackFrameDB", "OldFunctionDBAdapterV0", "OldFunctionDBAdapterV1", "OldFunctionParameter", "OldRegisterVariableDBAdapterV0", "OldStackVariableDBAdapterV0", "OldStackVariableDBAdapterV1"]
