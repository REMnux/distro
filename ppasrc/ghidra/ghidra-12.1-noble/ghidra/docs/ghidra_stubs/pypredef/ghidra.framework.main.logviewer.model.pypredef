...
class Pair(java.lang.Object):
    ...
    def setEnd(self, end: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setStart(self, start: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class ChunkModel(java.lang.Iterable[Chunk]):
    ...
    @typing.overload
    def add(self, index: typing.Union[jpype.JInt, int], chunk: Chunk) -> None:
        """
...
class ChunkReader(java.lang.Object):
    ...
    def __init__(self, file: jpype.protocol.SupportsPath, model: ChunkModel) -> None:
        """
...
class ReverseLineReader(java.lang.Object):
    ...
    def __init__(self, encoding: typing.Union[java.lang.String, str], raf: java.io.RandomAccessFile) -> None:
        """
    ...
    def setFilePos(self, position: typing.Union[jpype.JLong, int]) -> None:
        """
...
__all__ = ["Chunk", "Pair", "ChunkModel", "ChunkReader", "ReverseLineReader"]
