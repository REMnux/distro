...
class AbstractDebuggerSleighInputDialog(docking.DialogComponentProvider):
    ...
    class SleighTextPane(javax.swing.JTextPane):
        ...
        def __init__(self, document: javax.swing.text.StyledDocument) -> None:
            ...
...
class BreakpointLocationRow(java.lang.Object):
    ...
    def __init__(self, provider: DebuggerBreakpointsProvider, loc: ghidra.trace.model.breakpoint.TraceBreakpointLocation) -> None:
        ...
    ...
    def setState(self, state: ghidra.debug.api.breakpoint.LogicalBreakpoint.State) -> None:
        ...
...
class DebuggerBreakpointsProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.debug.api.breakpoint.LogicalBreakpointsChangeListener, ghidra.app.services.DebuggerControlService.ControlModeChangeListener):
    ...
    class LogicalBreakpointTableModel(docking.widgets.table.RowWrappedEnumeratedColumnTableModel[DebuggerBreakpointsProvider.LogicalBreakpointTableColumns, ghidra.debug.api.breakpoint.LogicalBreakpoint, LogicalBreakpointRow, ghidra.debug.api.breakpoint.LogicalBreakpoint]):
        ...
        def __init__(self, provider: DebuggerBreakpointsProvider) -> None:
            ...
    ...
    class GenericSetBreakpointAction(ghidra.app.plugin.core.debug.gui.InvokeActionEntryAction):
        ...
        def __init__(self, entry: ghidra.debug.api.target.Target.ActionEntry) -> None:
            ...
    ...
    def __init__(self, plugin: DebuggerBreakpointsPlugin) -> None:
        ...
    ...
    def setSelectedBreakpoints(self, sel: java.util.Set[ghidra.debug.api.breakpoint.LogicalBreakpoint]) -> None:
        ...

    def setSelectedLocations(self, sel: java.util.Set[ghidra.trace.model.breakpoint.TraceBreakpointLocation]) -> None:
        ...
...
class LogicalBreakpointRow(java.lang.Object):
    ...
    def __init__(self, provider: DebuggerBreakpointsProvider, lb: ghidra.debug.api.breakpoint.LogicalBreakpoint) -> None:
        ...
...
class BreakpointsDecompilerMarginProvider(javax.swing.JPanel, ghidra.app.decompiler.component.margin.DecompilerMarginProvider, docking.widgets.fieldpanel.listener.LayoutModelListener):
    ...
    def __init__(self, plugin: DebuggerBreakpointMarkerPlugin) -> None:
        ...
...
class DebuggerBreakpointMarkerPlugin(ghidra.framework.plugintool.Plugin):
    ...
    class DualMarkerSet(java.lang.Object):
        ...
        def remove(self, service: ghidra.app.services.MarkerService, program: ghidra.program.model.listing.Program) -> None:
            ...

        def setColoringBackground(self, coloringBackground: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    class BreakpointMarkerSets(java.lang.Object):
        ...
        def setDisabledColoringBackground(self, coloringBackground: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setEnabledColoringBackground(self, coloringBackground: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setIneffectiveDisabledColoringBackground(self, coloringBackground: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setIneffectiveEnabledColoringBackground(self, coloringBackground: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    class AbstractToggleBreakpointAction(docking.action.DockingAction):
        ...
        def __init__(self, owner: ghidra.framework.plugintool.Plugin) -> None:
            ...
    ...
    class SetBreakpointAction(ghidra.app.plugin.core.debug.gui.DebuggerResources.AbstractSetBreakpointAction):
        ...
        def __init__(self, kinds: java.util.Set[ghidra.trace.model.breakpoint.TraceBreakpointKind]) -> None:
            ...
...
class DebuggerBreakpointLocationsActionContext(docking.DefaultActionContext):
    ...
    def __init__(self, selection: collections.abc.Sequence) -> None:
        ...
...
class DebuggerBreakpointStateTableCellEditor(javax.swing.AbstractCellEditor, javax.swing.table.TableCellEditor, java.awt.event.ActionListener, typing.Generic[T]):
    ...
    def __init__(self, filterPanel: docking.widgets.table.GTableFilterPanel[T]) -> None:
        ...
...
__all__ = ["AbstractDebuggerSleighInputDialog", "BreakpointLocationRow", "DebuggerBreakpointsProvider", "LogicalBreakpointRow", "DebuggerBreakpointsPlugin", "DebuggerMakeBreakpointsEffectiveActionContext", "BreakpointsDecompilerMarginProvider", "DebuggerBreakpointMarkerPlugin", "DebuggerPlaceBreakpointDialog", "DebuggerBreakpointLocationsActionContext", "DebuggerBreakpointStateTableCellEditor", "DebuggerBreakpointStateTableCellRenderer", "DebuggerLogicalBreakpointsActionContext", "DebuggerSleighExpressionInputDialog", "DebuggerSleighSemanticInputDialog"]
