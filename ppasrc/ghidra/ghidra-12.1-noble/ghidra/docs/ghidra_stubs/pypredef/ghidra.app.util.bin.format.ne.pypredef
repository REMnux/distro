...
class NewExecutable(java.lang.Object):
    ...
    def __init__(self, bp: ghidra.app.util.bin.ByteProvider, baseAddr: ghidra.program.model.address.SegmentedAddress) -> None:
        """
...
class WindowsHeader(java.lang.Object):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, baseAddr: ghidra.program.model.address.SegmentedAddress, index: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
        ...
        :param jpype.JInt or int index: the index where the windows headers begins
...
__all__ = ["EntryPoint", "EntryTableBundle", "EntryTable", "ImportedNameTable", "LengthStringSet", "InformationBlock", "InvalidWindowsHeaderException", "LengthStringOrdinalSet", "ModuleReferenceTable", "NewExecutable", "WindowsHeader", "SegmentTable", "ResourceTable", "ResidentNameTable", "NonResidentNameTable", "ResourceType", "ResourceName", "Resource", "Segment", "SegmentRelocation", "RelocationImportedName", "RelocationImportedOrdinal", "RelocationInternalRef", "RelocationOSFixup", "ResourceStringTable"]
