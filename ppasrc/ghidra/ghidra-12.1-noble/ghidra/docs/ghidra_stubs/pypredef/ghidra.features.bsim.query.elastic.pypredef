...
class IDElasticResolution(java.lang.Object):
    ...
    def resolve(self, database: ElasticDatabase, exe: ghidra.features.bsim.query.description.ExecutableRecord) -> None:
        ...
...
class ElasticEffects(java.lang.Object):
    ...
    def addChildId(self, id: typing.Union[java.lang.String, str]) -> None:
        ...

    def addDateParam(self, key: typing.Union[java.lang.String, str], date: java.util.Date) -> None:
        ...

    def addDocValue(self, val: typing.Union[java.lang.String, str]) -> None:
        ...

    def addFuncParam(self, key: typing.Union[java.lang.String, str], val: typing.Union[java.lang.String, str]) -> None:
        ...

    def addFunctionFilter(self, flag: typing.Union[jpype.JInt, int], val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def addParam(self, key: typing.Union[java.lang.String, str], val: typing.Union[java.lang.String, str]) -> None:
        ...

    def addScriptElement(self, filter: ghidra.features.bsim.gui.filters.BSimFilterType, value: typing.Union[java.lang.String, str]) -> None:
        ...

    def addStandalone(self, filter: ghidra.features.bsim.gui.filters.BSimFilterType, value: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ElasticDatabase(ghidra.features.bsim.query.FunctionDatabase):
    ...
    def __init__(self, baseURL: java.net.URL) -> None:
        """
...
class ElasticConnection(java.lang.Object):
    ...
    def __init__(self, url: typing.Union[java.lang.String, str], repo: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def executeStatementNoResponse(self, command: typing.Union[java.lang.String, str], path: typing.Union[java.lang.String, str], body: typing.Union[java.lang.String, str]) -> None:
        """
...
class RowKeyElastic(ghidra.features.bsim.query.description.RowKey):
    ...
    @typing.overload
    def __init__(self, a: typing.Union[jpype.JInt, int], b: typing.Union[jpype.JInt, int], c: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, md5: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def generateFunctionId(self, buffer: java.lang.StringBuilder, func: ghidra.features.bsim.query.description.FunctionDescription) -> None:
        """
    ...
    def generateLibraryFunctionId(self, buffer: java.lang.StringBuilder, funcName: typing.Union[java.lang.String, str]) -> None:
        """
...
class Base64Lite(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def encodeLongBase64(buf: java.lang.StringBuilder, val: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @staticmethod
    def encodeLongBase64Padded(buf: java.lang.StringBuilder, val: typing.Union[jpype.JLong, int]) -> None:
        """
...
__all__ = ["IDElasticResolution", "ElasticEffects", "ElasticException", "ElasticDatabase", "ElasticConnection", "Base64VectorFactory", "RowKeyElastic", "Base64Lite", "ElasticUtilities", "Handler"]
