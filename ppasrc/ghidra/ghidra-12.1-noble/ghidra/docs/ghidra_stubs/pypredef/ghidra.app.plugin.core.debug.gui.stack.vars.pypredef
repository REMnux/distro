...
class VariableValueRow(java.lang.Object):
    ...
    class FrameRow(java.lang.Record, VariableValueRow):
        ...
        def __init__(self, frame: ghidra.app.plugin.core.debug.stack.UnwoundFrame[typing.Any]) -> None:
            ...
    ...
    class StorageRow(java.lang.Record, VariableValueRow):
        ...
        def __init__(self, storage: ghidra.program.model.listing.VariableStorage) -> None:
            ...
    ...
    class InstructionRow(java.lang.Record, VariableValueRow):
        ...
        def __init__(self, instruction: ghidra.program.model.listing.Instruction) -> None:
            ...
    ...
    class LocationRow(java.lang.Record, VariableValueRow):
        ...
        def __init__(self, locString: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class BytesRow(java.lang.Record, VariableValueRow):
        ...
        @typing.overload
        def __init__(self, value: ghidra.pcode.exec_.DebuggerPcodeUtils.WatchValue) -> None:
            """
        ...
        @typing.overload
        def __init__(self, bytes: ghidra.pcode.exec_.DebuggerPcodeUtils.PrettyBytes, state: ghidra.trace.model.memory.TraceMemoryState) -> None:
            ...
    ...
    class IntegerRow(java.lang.Record, VariableValueRow):
        ...
        @typing.overload
        def __init__(self, bytes: VariableValueRow.BytesRow) -> None:
            """
    ...
    class ValueRow(java.lang.Record, VariableValueRow):
        ...
        def __init__(self, value: typing.Union[java.lang.String, str], state: ghidra.trace.model.memory.TraceMemoryState) -> None:
            ...
    ...
    class StatusRow(java.lang.Record, VariableValueRow):
        ...
        def __init__(self, status: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class WarningsRow(java.lang.Record, VariableValueRow):
        ...
        def __init__(self, warnings: ghidra.app.plugin.core.debug.stack.StackUnwindWarningSet) -> None:
            ...
    ...
    class ErrorRow(java.lang.Record, VariableValueRow):
        ...
        def __init__(self, error: java.lang.Throwable) -> None:
            ...
...
class VariableValueUtils(java.lang.Enum[VariableValueUtils]):
    ...
    class DefaultSpaceSettings(ghidra.docking.settings.Settings):
        ...
        def __init__(self, delegate: ghidra.docking.settings.Settings, space: ghidra.program.model.address.AddressSpace) -> None:
            ...
    ...
    class VariableEvaluator(java.lang.Object):
        ...
        def __init__(self, tool: ghidra.framework.plugintool.PluginTool, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> None:
            """
...
class VariableValueHoverService(ghidra.app.plugin.core.hover.AbstractConfigurableHover, ghidra.app.plugin.core.codebrowser.hover.ListingHoverService, ghidra.app.decompiler.component.hover.DecompilerHoverService):
    ...
    class TableFiller(java.lang.Object):
        ...
        def __init__(self, table: VariableValueTable, tool: ghidra.framework.plugintool.PluginTool, current: ghidra.debug.api.tracemgr.DebuggerCoordinates, eval: VariableValueUtils.VariableEvaluator, warnings: ghidra.app.plugin.core.debug.stack.StackUnwindWarningSet) -> None:
            ...
...
class VariableValueTable(java.lang.Object):
    ...
    def add(self, row: VariableValueRow) -> None:
        """
    ...
    def remove(self, key: VariableValueRow.RowKey) -> None:
        """
...
__all__ = ["VariableValueHoverPlugin", "VariableValueRow", "VariableValueUtils", "VariableValueHoverService", "VariableValueTable"]
