...
class PopupWindowPlacer(java.lang.Object):
    ...
    class EdgePopupPlacer(PopupWindowPlacer):
        ...
        def __init__(self, major: Location, minorBegin: Location, minorEnd: Location) -> None:
            ...
    ...
    class PositionableDimension(java.awt.Dimension):
        ...
        def __init__(self, dimension: java.awt.Dimension) -> None:
            ...
    ...
    class PositionableRectangle(java.awt.Rectangle):
        ...
        def __init__(self, rectangle: java.awt.Rectangle) -> None:
            ...

        def set(self, majorCoordinate: typing.Union[jpype.JInt, int], minorCoordinate: typing.Union[jpype.JInt, int], dimension: PopupWindowPlacer.PositionableDimension) -> None:
            ...
...
__all__ = ["PopupWindowPlacer", "Location", "PopupWindowPlacerBuilder"]
