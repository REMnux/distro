...
class AbstractWorker(java.lang.Object, typing.Generic[T]):
    ...
    @typing.overload
    def clearAllJobs(self, p: java.util.function.Predicate[T]) -> None:
        """
        Clears any pending jobs and currently executing jobs that match the given predicate.
        
        :param java.util.function.Predicate[T] p: the predicate
        """
    ...
    def waitUntilNoJobsScheduled(self, maxWait: typing.Union[jpype.JInt, int]) -> None:
        """
...
class PriorityWorker(AbstractWorker[PriorityJob]):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], isPersistentThread: typing.Union[jpype.JBoolean, bool], useSharedThreadPool: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
__all__ = ["AbstractWorker", "Job", "PriorityJob", "PriorityWorker", "Worker"]
