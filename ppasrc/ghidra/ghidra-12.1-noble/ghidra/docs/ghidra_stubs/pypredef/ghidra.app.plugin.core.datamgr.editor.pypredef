...
class DataTypeEditorManager(ghidra.app.plugin.core.compositeeditor.EditorListener):
    ...
    def closed(self, editor: ghidra.app.plugin.core.compositeeditor.EditorProvider) -> None:
        """
    ...
    def createNewEnum(self, category: ghidra.program.model.data.Category) -> None:
        ...

    def createNewFunctionDefinition(self, cat: ghidra.program.model.data.Category) -> None:
        ...

    def createNewStructure(self, category: ghidra.program.model.data.Category, isPacked: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def createNewUnion(self, category: ghidra.program.model.data.Category, isPacked: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def dismissEditors(self, dtMgr: ghidra.program.model.data.DataTypeManager) -> None:
        """
    ...
    @typing.overload
    def edit(self, dataType: ghidra.program.model.data.DataType) -> None:
        """
    ...
    def editFunctionSignature(self, functionDefinition: ghidra.program.model.data.FunctionDefinition) -> None:
        ...
...
class EnumEditorPanel(javax.swing.JPanel):
    ...
    class RangeValidator(docking.widgets.textfield.GValidatedTextField.LongField.LongValidator):
        ...
        def setOriginalValue(self, originalLong: typing.Union[jpype.JLong, int]) -> None:
            ...
...
class EnumEntry(java.lang.Object):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int], comment: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def setComment(self, newComment: typing.Union[java.lang.String, str]) -> None:
        ...
...
class EnumEditorProvider(ghidra.framework.plugintool.ComponentProviderAdapter, javax.swing.event.ChangeListener, ghidra.app.plugin.core.compositeeditor.EditorProvider):
    ...
    def __init__(self, plugin: ghidra.app.plugin.core.datamgr.DataTypeManagerPlugin, enumDT: ghidra.program.model.data.Enum) -> None:
        """
...
__all__ = ["DataTypeEditorManager", "EditorOptionManager", "EnumEditorPanel", "EnumTableModel", "EnumEntry", "EnumEditorProvider", "FindReferencesToEnumFieldAction"]
