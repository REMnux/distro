...
class JitVal(java.lang.Object):
    ...
    class ValUse(java.lang.Record):
        ...
        def __init__(self, op: ghidra.pcode.emu.jit.op.JitOp, position: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def addUse(self, op: ghidra.pcode.emu.jit.op.JitOp, position: typing.Union[jpype.JInt, int]) -> None:
        """
        Add a use.
    ...
    def removeUse(self, op: ghidra.pcode.emu.jit.op.JitOp, position: typing.Union[jpype.JInt, int]) -> None:
        """
        Remove a use.
...
class JitOutVar(JitVarnodeVar):
    ...
    def setDefinition(self, definition: ghidra.pcode.emu.jit.op.JitDefOp) -> None:
        """
...
class JitDirectMemoryVar(AbstractJitVarnodeVar, JitMemoryVar):
    ...
    def __init__(self, id: typing.Union[jpype.JInt, int], varnode: ghidra.program.model.pcode.Varnode) -> None:
        """
...
class AbstractJitVar(AbstractJitVal, JitVar):
    ...
    def __init__(self, id: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int]) -> None:
        """
...
class JitConstVal(AbstractJitVal):
    ...
    def __init__(self, size: typing.Union[jpype.JInt, int], value: java.math.BigInteger) -> None:
        """
...
class JitInputVar(AbstractJitVarnodeVar):
    ...
    def __init__(self, varnode: ghidra.program.model.pcode.Varnode) -> None:
        """
        Construct a variable.
...
__all__ = ["JitVar", "JitVal", "JitOutVar", "JitVarnodeVar", "JitDirectMemoryVar", "AbstractJitVarnodeVar", "AbstractJitVar", "AbstractJitVal", "JitMemoryVar", "JitIndirectMemoryVar", "JitConstVal", "JitFailVal", "JitInputVar", "JitMissingVar", "JitLocalOutVar", "AbstractJitOutVar", "JitMemoryOutVar"]
