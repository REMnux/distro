...
class StackUnwindWarning(java.lang.Object):
    ...
    class NoReturnPathStackUnwindWarning(java.lang.Record, StackUnwindWarning):
        ...
        def __init__(self, pc: ghidra.program.model.address.Address) -> None:
            ...
    ...
    class OpaqueReturnPathStackUnwindWarning(java.lang.Record, StackUnwindWarning):
        ...
        def __init__(self, pc: ghidra.program.model.address.Address, last: java.lang.Exception) -> None:
            ...
    ...
    class UnknownPurgeStackUnwindWarning(java.lang.Record, StackUnwindWarning, StackUnwindWarning.Combinable[StackUnwindWarning.UnknownPurgeStackUnwindWarning]):
        ...
        def __init__(self, function: ghidra.program.model.listing.Function) -> None:
            ...
    ...
    class MultipleHighCallsStackUnwindWarning(java.lang.Record, StackUnwindWarning):
        ...
        def __init__(self, found: java.util.List[ghidra.program.model.pcode.PcodeOpAST]) -> None:
            ...
    ...
    class UnexpectedTargetTypeStackUnwindWarning(java.lang.Record, StackUnwindWarning):
        ...
        def __init__(self, type: ghidra.program.model.data.DataType) -> None:
            ...
    ...
    class NoHighVariableFromTargetPointerTypeUnwindWarning(java.lang.Record, StackUnwindWarning):
        ...
        def __init__(self, vn: ghidra.program.model.pcode.VarnodeAST) -> None:
            ...
    ...
    class CouldNotRecoverSignatureStackUnwindWarning(java.lang.Record, StackUnwindWarning):
        ...
        def __init__(self, op: ghidra.program.model.pcode.PcodeOpAST) -> None:
            ...
...
class StackUnwindWarningSet(java.util.Collection[StackUnwindWarning]):
    ...
    @typing.overload
    def __init__(self, *warnings: StackUnwindWarning) -> None:
        """
    ...
    @typing.overload
    def __init__(self, warnings: collections.abc.Sequence) -> None:
        """
        Copy the given set
...
class FakeUnwoundFrame(AbstractUnwoundFrame[T], typing.Generic[T]):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates, state: ghidra.pcode.exec_.PcodeExecutorState[T]) -> None:
        """
...
class AbstractUnwoundFrame(UnwoundFrame[T], typing.Generic[T]):
    ...
    class ArithmeticFrameVarnodeEvaluator(ghidra.pcode.eval.ArithmeticVarnodeEvaluator[U], typing.Generic[U]):
        ...
        def __init__(self, arithmetic: ghidra.pcode.exec_.PcodeArithmetic[U]) -> None:
            ...
    ...
    class FrameVarnodeEvaluator(AbstractUnwoundFrame.ArithmeticFrameVarnodeEvaluator[U], typing.Generic[U]):
        ...
        def __init__(self, arithmetic: ghidra.pcode.exec_.PcodeArithmetic[U], symbolStorage: ghidra.program.model.address.AddressSetView) -> None:
            """
...
class SavedRegisterMap(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, saved: java.util.TreeMap[ghidra.program.model.address.Address, SavedRegisterMap.SavedEntry]) -> None:
        """
    ...
    @typing.overload
    def put(self, from_: ghidra.program.model.lang.Register, stackVar: ghidra.program.model.pcode.Varnode) -> None:
        """
    ...
    @typing.overload
    def put(self, from_: ghidra.program.model.address.AddressRange, to: ghidra.program.model.address.AddressRange) -> None:
        """
    ...
    @typing.overload
    def put(self, from_: ghidra.program.model.address.AddressRange, to: ghidra.program.model.address.Address) -> None:
        """
...
class ListingUnwoundFrame(AbstractUnwoundFrame[ghidra.pcode.exec_.DebuggerPcodeUtils.WatchValue]):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates, frame: ghidra.trace.model.listing.TraceData) -> None:
        """
...
class StackUnwinder(java.lang.Object):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, platform: ghidra.trace.model.guest.TracePlatform) -> None:
        """
...
class UnwindInfo(java.lang.Record):
    ...
    def mapSavedRegisters(self, base: ghidra.program.model.address.Address, map: SavedRegisterMap) -> None:
        """
    ...
    def restoreRegisters(self, base: ghidra.program.model.address.Address, state: ghidra.pcode.exec_.PcodeExecutorState[T]) -> None:
        """
...
class Sym(java.lang.Object):
    ...
    * *a:Register(reg==SP) => Deref(offset=0)
    ...
    class RegisterSym(java.lang.Record, Sym):
        ...
        def __init__(self, register: ghidra.program.model.lang.Register, mask: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    class StackDerefSym(java.lang.Record, Sym):
        ...
        def __init__(self, offset: typing.Union[jpype.JLong, int], mask: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int]) -> None:
            ...
...
class SymPcodeArithmetic(ghidra.pcode.exec_.PcodeArithmetic[Sym]):
    ...
    def __init__(self, cSpec: ghidra.program.model.lang.CompilerSpec) -> None:
        """
...
class SymPcodeExecutor(ghidra.pcode.exec_.PcodeExecutor[Sym]):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, cSpec: ghidra.program.model.lang.CompilerSpec, language: ghidra.app.plugin.processors.sleigh.SleighLanguage, arithmetic: SymPcodeArithmetic, state: SymPcodeExecutorState, reason: ghidra.pcode.exec_.PcodeExecutorStatePiece.Reason, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class SymStateSpace(java.lang.Object):
    ...
    def dump(self, prefix: typing.Union[java.lang.String, str], language: ghidra.program.model.lang.Language) -> None:
        ...
    ...
    def set(self, address: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int], sym: Sym) -> None:
        """
...
class UnwindAnalysis(java.lang.Object):
    ...
    class AnalysisForPC(java.lang.Object):
        ...
        def __init__(self, pc: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> None:
            """
        ...
        def executeBlock(self, exec_: SymPcodeExecutor, block: ghidra.program.model.block.CodeBlock) -> None:
            """
        ...
        def executeBlockFrom(self, exec_: SymPcodeExecutor, block: ghidra.program.model.block.CodeBlock, from_: ghidra.program.model.address.Address) -> None:
            """
        ...
        def executeBlockTo(self, exec_: SymPcodeExecutor, block: ghidra.program.model.block.CodeBlock, to: ghidra.program.model.address.Address) -> None:
            """
        ...
        def executePathFrom(self, exec_: SymPcodeExecutor, from_: java.util.Deque[UnwindAnalysis.BlockEdge]) -> None:
            """
        ...
        def executePathTo(self, exec_: SymPcodeExecutor, to: java.util.Deque[UnwindAnalysis.BlockEdge]) -> None:
            """
        ...
        def executeSet(self, exec_: SymPcodeExecutor, set: ghidra.program.model.address.AddressSetView) -> None:
            """
...
class UnwindStackCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.trace.model.Trace]):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, where: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> None:
        ...



__all__ = ["StackUnwindWarning", "StackUnwindWarningSet", "UnwoundFrame", "FakeUnwoundFrame", "AbstractUnwoundFrame", "SavedRegisterMap", "ListingUnwoundFrame", "AnalysisUnwoundFrame", "StackUnwinder", "UnwindInfo", "DynamicMappingException", "EvaluationException", "FrameStructureBuilder", "Sym", "SymPcodeArithmetic", "SymPcodeExecutor", "SymStateSpace", "SymPcodeExecutorState", "UnwindAnalysis", "UnwindException", "UnwindStackCommand"]
