...
class GTimerCache(java.lang.Object, typing.Generic[K, V]):
    ...
    def __init__(self, lifetime: java.time.Duration, capacity: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setCapacity(self, capacity: typing.Union[jpype.JInt, int]) -> None:
        """
...
class Watchdog(java.io.Closeable):
    ...
    def __init__(self, defaultTimeoutMS: typing.Union[jpype.JLong, int], timeoutMethod: java.lang.Runnable) -> None:
        """
...
__all__ = ["GTimerMonitor", "GTimer", "GTimerCache", "Watchdog"]
