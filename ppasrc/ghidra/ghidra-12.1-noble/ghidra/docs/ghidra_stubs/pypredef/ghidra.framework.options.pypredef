...
class AbstractOptions(Options):
    ...
    def putObject(self, optionName: typing.Union[java.lang.String, str], newValue: java.lang.Object, type: OptionType) -> None:
        ...

    def registerOptionsEditor(self, categoryPath: typing.Union[java.lang.String, str], editorSupplier: java.util.function.Supplier[OptionsEditor]) -> None:
        ...

    def setCategoryHelpLocation(self, categoryPath: typing.Union[java.lang.String, str], helpLocation: ghidra.util.HelpLocation) -> None:
        ...
...
class Options(java.lang.Object):
    ...
    def createAlias(self, aliasName: typing.Union[java.lang.String, str], options: Options, optionsName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def putObject(self, optionName: typing.Union[java.lang.String, str], obj: java.lang.Object) -> None:
        """
    ...
    @typing.overload
    def registerOption(self, optionName: typing.Union[java.lang.String, str], defaultValue: java.lang.Object, help: ghidra.util.HelpLocation, description: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def registerOption(self, optionName: typing.Union[java.lang.String, str], type: OptionType, defaultValue: java.lang.Object, help: ghidra.util.HelpLocation, description: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def registerOption(self, optionName: typing.Union[java.lang.String, str], type: OptionType, defaultValue: java.lang.Object, help: ghidra.util.HelpLocation, description: typing.Union[java.lang.String, str], editor: java.util.function.Supplier[java.beans.PropertyEditor]) -> None:
        """
        Registers an option with a description, help location, and a optional default value.  With an optional
        default value, an OptionType must be passed as it is otherwise derived from the default value.
        ...
        Note 1: we use a *supplier* of a custom editor, instead of a custom editor, to avoid
    ...
    def registerOption(self, optionName: typing.Union[java.lang.String, str], type: OptionType, defaultValue: java.lang.Object, help: ghidra.util.HelpLocation, description: typing.Union[java.lang.String, str], editor: java.beans.PropertyEditor) -> None:
        """
        Use instead
    ...
    @typing.overload
    def registerOptionsEditor(self, editor: java.util.function.Supplier[OptionsEditor]) -> None:
        """
    ...
    def registerOptionsEditor(self, editor: OptionsEditor) -> None:
        """
    ...
    def registerThemeColorBinding(self, optionName: typing.Union[java.lang.String, str], colorId: typing.Union[java.lang.String, str], help: ghidra.util.HelpLocation, description: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def registerThemeFontBinding(self, optionName: typing.Union[java.lang.String, str], fontId: typing.Union[java.lang.String, str], help: ghidra.util.HelpLocation, description: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def removeOption(self, optionName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def restoreDefaultValue(self, optionName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setActionTrigger(self, optionName: typing.Union[java.lang.String, str], value: ActionTrigger) -> None:
        """
    ...
    def setBoolean(self, optionName: typing.Union[java.lang.String, str], value: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setByteArray(self, optionName: typing.Union[java.lang.String, str], value: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def setColor(self, optionName: typing.Union[java.lang.String, str], value: java.awt.Color) -> None:
        """
    ...
    def setCustomOption(self, optionName: typing.Union[java.lang.String, str], value: CustomOption) -> None:
        """
    ...
    def setDate(self, optionName: typing.Union[java.lang.String, str], newSetting: java.util.Date) -> None:
        """
    ...
    def setDouble(self, optionName: typing.Union[java.lang.String, str], value: typing.Union[jpype.JDouble, float]) -> None:
        """
    ...
    def setEnum(self, optionName: typing.Union[java.lang.String, str], value: T) -> None:
        """
    ...
    def setFile(self, optionName: typing.Union[java.lang.String, str], value: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def setFloat(self, optionName: typing.Union[java.lang.String, str], value: typing.Union[jpype.JFloat, float]) -> None:
        """
    ...
    def setFont(self, optionName: typing.Union[java.lang.String, str], value: java.awt.Font) -> None:
        """
    ...
    def setInt(self, optionName: typing.Union[java.lang.String, str], value: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setKeyStroke(self, optionName: typing.Union[java.lang.String, str], value: javax.swing.KeyStroke) -> None:
        """
    ...
    def setLong(self, optionName: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setString(self, optionName: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        """
...
class Option(java.lang.Object):
    ...
    def doSetCurrentValue(self, value: java.lang.Object) -> None:
        ...
    ...
    def getLastRegisteredDate(self) -> java.time.LocalDate:
        ...
    ...
    def setCurrentValue(self, value: java.lang.Object) -> None:
        ...

    def setLastRegisteredDate(self, date: java.time.LocalDate) -> None:
        ...

    def wasRegisteredInPreviousSession(self) -> bool:
        ...
    ...
    @property
    def lastRegisteredDate(self) -> java.time.LocalDate:
        ...

    @lastRegisteredDate.setter
    def lastRegisteredDate(self, value: java.time.LocalDate):
        ...
...
class OptionsChangeListener(java.lang.Object):
    ...
    def optionsChanged(self, options: ToolOptions, optionName: typing.Union[java.lang.String, str], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
...
class CustomOption(java.lang.Object):
    ...
    def readState(self, properties: GProperties) -> None:
        """
    ...
    def writeState(self, properties: GProperties) -> None:
        """
...
class ActionTrigger(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, keyStroke: javax.swing.KeyStroke) -> None:
        """
    ...
    @typing.overload
    def __init__(self, mouseBinding: gui.event.MouseBinding) -> None:
        """
    ...
    @typing.overload
    def __init__(self, keyStroke: javax.swing.KeyStroke, mouseBinding: gui.event.MouseBinding) -> None:
        """
    ...
    def writeState(self, saveState: SaveState) -> None:
        """
...
class EditorStateFactory(java.lang.Object):
    ...
    def clear(self, options: Options, name: typing.Union[java.lang.String, str]) -> None:
        ...
...
class EditorState(java.beans.PropertyChangeListener):
    ...
    def __init__(self, options: Options, name: typing.Union[java.lang.String, str]) -> None:
        ...

    def applyNonDefaults(self, save: Options) -> None:
        ...
    ...
    def loadFrom(self, loadFrom: Options) -> None:
        ...
...
class ToolOptions(AbstractOptions):
    ...
    class_: typing.ClassVar[java.lang.Class]
    LAST_REGISTERED_DATE_ATTIBUTE: typing.Final = "LAST_REGISTERED"
    LAST_REGISTERED_DATE_FORMATTER: typing.Final[java.time.format.DateTimeFormatter]
    ...
    @typing.overload
    def __init__(self, root: org.jdom2.Element) -> None:
        """
        Construct a new Options object from the given XML element.
        
        :param org.jdom2.Element root: XML that contains the set of options to restore
        """

    def addOptionsChangeListener(self, l: OptionsChangeListener) -> None:
        """
    ...
    def copyOptions(self, newOptions: Options) -> None:
        """
    ...
    def getXmlRoot(self, includeDefaultBindings: typing.Union[jpype.JBoolean, bool]) -> org.jdom2.Element:
        """
    ...
    def registerOptions(self, oldOptions: ToolOptions) -> None:
        ...

    def removeOptionsChangeListener(self, l: OptionsChangeListener) -> None:
        """
    ...
    def takeListeners(self, oldOptions: ToolOptions) -> None:
        ...
    ...
    @property
    def xmlRoot(self) -> org.jdom2.Element:
        ...
...
class WrappedOption(java.lang.Object):
    ...
    def readState(self, saveState: SaveState) -> None:
        """
...
class ErrorPropertyEditor(java.beans.PropertyEditorSupport):
    ...
    def __init__(self, errorMessage: typing.Union[java.lang.String, str], value: java.lang.Object) -> None:
        ...
...
class FileOptions(AbstractOptions):
    ...
    @typing.overload
    def __init__(self, file: jpype.protocol.SupportsPath) -> None:
        ...
    ...
    def save(self, saveFile: jpype.protocol.SupportsPath) -> None:
        ...
...
class PreferenceState(SaveState):
    ...
    @typing.overload
    def __init__(self, element: org.jdom2.Element) -> None:
        """
        Initializes a new state object from the given element.
        
        :param org.jdom2.Element element: The element from which to initialize.
        """
...
class PropertyBoolean(javax.swing.JCheckBox, java.awt.event.ItemListener):
    ...
    def __init__(self, pe: java.beans.PropertyEditor) -> None:
        """
        Constructor
...
class SubOptions(Options):
    ...
    def __init__(self, options: AbstractOptions, name: typing.Union[java.lang.String, str], prefix: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ThemeColorOption(Option):
    ...
    def __init__(self, optionName: typing.Union[java.lang.String, str], colorId: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], help: ghidra.util.HelpLocation) -> None:
        ...
...
class ThemeFontOption(Option):
    ...
    def __init__(self, optionName: typing.Union[java.lang.String, str], fontId: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], help: ghidra.util.HelpLocation) -> None:
        ...
...
class WrappedCustomOption(WrappedOption):
    ...
    @typing.overload
    def __init__(self, value: CustomOption) -> None:
        ...
...
class AttributedSaveState(SaveState):
    """
    A version of :obj:`SaveState` that allows clients to add attributes to properties in this save
    state.  The following code shows how to use this class:
    ``AttributedSaveState ss = new AttributedSaveState();ss.putBoolean("Happy", true);Map<String, String> attrs = Map.of("MyAttribute", "AttributeValue");ss.addAttrbibutes("Happy", attrs);``
     
     
    In this example, the property "Happy" will be given the attribute "MyAttribute" with the value
    ...
    Usage Note: The given attributes are only supported when writing and reading xml. Json
    is not supported.
    """
    ...
    def addAttributes(self, propertyName: typing.Union[java.lang.String, str], attributes: collections.abc.Mapping) -> None:
        """
        Adds the given map of attribute name/value pairs to this save state.
        
        :param java.lang.String or str propertyName: the property name within this save state that will be attributed
        :param collections.abc.Mapping attributes: the attributes
        """

    def getAttributes(self, propertyName: typing.Union[java.lang.String, str]) -> java.util.Map[java.lang.String, java.lang.String]:
        """
        Gets the attributes currently associated with the given property name
        
        :param java.lang.String or str propertyName: the property name for which to get attributes
        :return: the attributes or null
        :rtype: java.util.Map[java.lang.String, java.lang.String]
        """

    def removeAttributes(self, propertyName: typing.Union[java.lang.String, str]) -> None:
        """
        Removes all attributes associated with the given property name.
        
        :param java.lang.String or str propertyName: the property name within this save state that has the given attributes
        """
...
class SaveState(XmlProperties):
    ...
    *Note: Names for options are assumed to be unique. When a putXXX()
    ...
    def __init__(self) -> None:
        """
        Default Constructor for SaveState; uses UNNAMED as the name of the state.
    ...
    def putSaveState(self, name: typing.Union[java.lang.String, str], value: SaveState) -> None:
        """
    ...
    def saveToFile(self, file: jpype.protocol.SupportsPath) -> None:
        """
...
class GProperties(java.lang.Object):
    ...
    *Note: Names for property names are assumed to be unique. When a putXXX()
    ...
    def __init__(self, root: org.jdom2.Element) -> None:
        ...
        :param org.jdom2.Element root: XML contents of GProperties
        """

    @typing.overload
    def __init__(self, root: com.google.gson.JsonObject) -> None:
        """
    ...
    def getXmlElement(self, name: typing.Union[java.lang.String, str]) -> org.jdom2.Element:
        """
    ...
    def putBoolean(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def putBooleans(self, name: typing.Union[java.lang.String, str], value: jpype.JArray[jpype.JBoolean]) -> None:
        """
    ...
    def putByte(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JByte, int]) -> None:
        """
    ...
    def putBytes(self, name: typing.Union[java.lang.String, str], value: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def putColor(self, name: typing.Union[java.lang.String, str], value: java.awt.Color) -> None:
        """
    ...
    def putDate(self, name: typing.Union[java.lang.String, str], value: java.util.Date) -> None:
        """
    ...
    def putDouble(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JDouble, float]) -> None:
        """
    ...
    def putDoubles(self, name: typing.Union[java.lang.String, str], value: jpype.JArray[jpype.JDouble]) -> None:
        """
        Associates a double value with the given name.
    ...
    def putEnum(self, name: typing.Union[java.lang.String, str], value: java.lang.Enum[typing.Any]) -> None:
        """
    ...
    def putFile(self, name: typing.Union[java.lang.String, str], value: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def putFloat(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JFloat, float]) -> None:
        """
    ...
    def putFloats(self, name: typing.Union[java.lang.String, str], value: jpype.JArray[jpype.JFloat]) -> None:
        """
    ...
    def putFont(self, name: typing.Union[java.lang.String, str], value: java.awt.Font) -> None:
        """
    ...
    def putGProperties(self, name: typing.Union[java.lang.String, str], value: GProperties) -> None:
        """
        Associates a sub SaveState value with the given name.
    ...
    def putInt(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def putInts(self, name: typing.Union[java.lang.String, str], value: jpype.JArray[jpype.JInt]) -> None:
        """
    ...
    def putKeyStroke(self, name: typing.Union[java.lang.String, str], value: javax.swing.KeyStroke) -> None:
        """
    ...
    def putLong(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def putLongs(self, name: typing.Union[java.lang.String, str], value: jpype.JArray[jpype.JLong]) -> None:
        """
    ...
    def putShort(self, name: typing.Union[java.lang.String, str], value: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    def putShorts(self, name: typing.Union[java.lang.String, str], value: jpype.JArray[jpype.JShort]) -> None:
        """
    ...
    def putString(self, name: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def putStrings(self, name: typing.Union[java.lang.String, str], value: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    def putXmlElement(self, name: typing.Union[java.lang.String, str], element: org.jdom2.Element) -> None:
        """
        ...
        :param org.jdom2.Element element: XML element which is the root of an
        XML sub-tree.
        """
    ...
    def saveToJsonFile(self, file: jpype.protocol.SupportsPath) -> None:
        """
    ...
    def saveToXmlFile(self, file: jpype.protocol.SupportsPath) -> None:
        """
    ...
    @property
    def xmlElement(self) -> org.jdom2.Element:
        ...
...
class AutoOptions(java.lang.Object):

    class CategoryAndName(java.lang.Record, java.lang.Comparable[AutoOptions.CategoryAndName]):

        class_: typing.ClassVar[java.lang.Class]

        @typing.overload
        def __init__(self, annotation: ghidra.framework.options.annotation.AutoOptionDefined, plugin: ghidra.framework.plugintool.Plugin) -> None:
            ...

        @typing.overload
        def __init__(self, annotation: ghidra.framework.options.annotation.AutoOptionConsumed, plugin: ghidra.framework.plugintool.Plugin) -> None:
            ...

        @typing.overload
        def __init__(self, category: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class OldValue(java.lang.annotation.Annotation):
        ...
        class_: typing.ClassVar[java.lang.Class]


    class NewValue(java.lang.annotation.Annotation):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    class WiringImpl(AutoOptions.Wiring):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, listener: AutoOptionsListener[typing.Any]) -> None:
            ...
    ...
    @staticmethod
    def getHelpLocation(defaultTopic: typing.Union[java.lang.String, str], annot: ghidra.framework.options.annotation.HelpInfo) -> ghidra.util.HelpLocation:
        ...

    @staticmethod
    def registerOptionsDefined(plugin: ghidra.framework.plugintool.Plugin, cls: java.lang.Class[typing.Any], receiver: java.lang.Object) -> None:
        ...

    @staticmethod
    @typing.overload
    def wireOptions(plugin: ghidra.framework.plugintool.Plugin) -> AutoOptions.Wiring:
        ...

    @staticmethod
    @typing.overload
    def wireOptions(plugin: ghidra.framework.plugintool.Plugin, receiver: java.lang.Object) -> AutoOptions.Wiring:
        ...

    @staticmethod
    def wireOptionsConsumed(plugin: ghidra.framework.plugintool.Plugin, receiver: java.lang.Object) -> AutoOptions.Wiring:
        ...


class AutoOptionsListener(OptionsChangeListener, typing.Generic[R]):

    @typing.type_check_only
    class OptionSetter(java.lang.Object, typing.Generic[R]):

        class_: typing.ClassVar[java.lang.Class]

        def getKey(self) -> AutoOptions.CategoryAndName:
            ...

        def set(self, receiver: R, newValue: java.lang.Object, oldValue: java.lang.Object) -> None:
            ...

        @property
        def key(self) -> AutoOptions.CategoryAndName:
            ...


    @typing.type_check_only
    class FieldOptionSetter(AutoOptionsListener.OptionSetter[R], typing.Generic[R]):

        class_: typing.ClassVar[java.lang.Class]

        @typing.overload
        def __init__(self, field: java.lang.reflect.Field, annotation: ghidra.framework.options.annotation.AutoOptionDefined, plugin: ghidra.framework.plugintool.Plugin) -> None:
            ...

        @typing.overload
        def __init__(self, field: java.lang.reflect.Field, annotation: ghidra.framework.options.annotation.AutoOptionConsumed, plugin: ghidra.framework.plugintool.Plugin) -> None:
            ...

        @typing.overload
        def __init__(self, field: java.lang.reflect.Field, category: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
            ...

        @typing.overload
        def __init__(self, field: java.lang.reflect.Field, key: AutoOptions.CategoryAndName) -> None:
            ...


    @typing.type_check_only
    class ParamOrder(java.lang.Enum[AutoOptionsListener.ParamOrder]):

        class_: typing.ClassVar[java.lang.Class]
        NONE: typing.Final[AutoOptionsListener.ParamOrder]
        NEW_ONLY: typing.Final[AutoOptionsListener.ParamOrder]
        OLD_ONLY: typing.Final[AutoOptionsListener.ParamOrder]
        NEW_OLD: typing.Final[AutoOptionsListener.ParamOrder]
        OLD_NEW: typing.Final[AutoOptionsListener.ParamOrder]

        def populate(self, oldVal: java.lang.Object, newVal: java.lang.Object) -> jpype.JArray[java.lang.Object]:
            ...

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> AutoOptionsListener.ParamOrder:
            ...

        @staticmethod
        def values() -> jpype.JArray[AutoOptionsListener.ParamOrder]:
            ...


    @typing.type_check_only
    class MethodOptionSetter(AutoOptionsListener.OptionSetter[R], typing.Generic[R]):

        class_: typing.ClassVar[java.lang.Class]

        @typing.overload
        def __init__(self, method: java.lang.reflect.Method, annotation: ghidra.framework.options.annotation.AutoOptionConsumed, plugin: ghidra.framework.plugintool.Plugin) -> None:
            ...

        @typing.overload
        def __init__(self, method: java.lang.reflect.Method, category: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
            ...

        @typing.overload
        def __init__(self, method: java.lang.reflect.Method, key: AutoOptions.CategoryAndName) -> None:
            ...


    @typing.type_check_only
    class ReceiverProfile(java.lang.Object, typing.Generic[R]):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, receiverCls: java.lang.Class[R], plugin: ghidra.framework.plugintool.Plugin) -> None:
            ...

        def notifyCurrentValues(self, tool: ghidra.framework.plugintool.PluginTool, receiver: R) -> None:
            ...

        def optionsChanged(self, options: ToolOptions, optionName: typing.Union[java.lang.String, str], oldValue: java.lang.Object, newValue: java.lang.Object, receiver: R) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, receiver: R) -> None:
        ...

    def getCategories(self) -> java.util.Set[java.lang.String]:
        ...

    def notifyCurrentValues(self, tool: ghidra.framework.plugintool.PluginTool) -> None:
        ...

    @property
    def categories(self) -> java.util.Set[java.lang.String]:
        ...



__all__ = ["AbstractOptions", "Options", "Option", "OptionsChangeListener", "OptionsEditor", "OptionType", "CustomOption", "ActionTrigger", "EditorStateFactory", "EditorState", "ToolOptions", "WrappedOption", "CustomOptionsEditor", "EnumEditor", "ErrorPropertyEditor", "FileOptions", "NoRegisteredEditorPropertyEditor", "PreferenceState", "PropertyBoolean", "PropertySelector", "PropertyText", "SubOptions", "ThemeColorOption", "ThemeFontOption", "WrappedActionTrigger", "WrappedColor", "WrappedCustomOption", "WrappedDate", "WrappedFile", "WrappedFont", "WrappedKeyStroke", "AttributedSaveState", "SaveState", "XmlProperties", "GProperties", "JSonProperties", "AutoOptions", "AutoOptionsListener"]
