...
class AboutDomainObjectUtils(java.lang.Object):
    ...
    @staticmethod
    def displayInformation(tool: ghidra.framework.plugintool.PluginTool, domainFile: ghidra.framework.model.DomainFile, metadata: collections.abc.Mapping, title: typing.Union[java.lang.String, str], additionalInfo: typing.Union[java.lang.String, str], helpLocation: ghidra.util.HelpLocation) -> None:
        """
