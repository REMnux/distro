...
class LoadCommand(ghidra.app.util.bin.StructConverter):
    ...
    def markup(self, program: ghidra.program.model.listing.Program, header: ghidra.app.util.bin.format.macho.MachHeader, source: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor, log: ghidra.app.util.importer.MessageLog) -> None:
        """
...
class SegmentCommand(LoadCommand):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, is32bit: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setFileOffset(self, fileOffset: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setFileSize(self, fileSize: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setSegmentName(self, name: typing.Union[java.lang.String, str]) -> None:
        ...

    def setVMaddress(self, vmaddr: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setVMsize(self, vmSize: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class DynamicLibrary(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, command: LoadCommand) -> None:
        ...
...
class NList(ghidra.app.util.bin.StructConverter):
    ...
    def initString(self, reader: ghidra.app.util.bin.BinaryReader, stringTableOffset: typing.Union[jpype.JLong, int]) -> None:
        """
...
class BuildVersionCommand(LoadCommand):
    ...
    class BuildToolVersion(ghidra.app.util.bin.StructConverter):
        ...
        def __init__(self, tool: typing.Union[jpype.JInt, int], version: typing.Union[jpype.JInt, int]) -> None:
            ...
...
class CorruptLoadCommand(LoadCommand):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, t: java.lang.Throwable) -> None:
        ...
...
class ExportTrie(java.lang.Object):
    ...
    class ExportEntry(java.lang.Record):
        ...
        def __init__(self, name: typing.Union[java.lang.String, str], address: typing.Union[jpype.JLong, int], flags: typing.Union[jpype.JLong, int], other: typing.Union[jpype.JLong, int], importName: typing.Union[java.lang.String, str]) -> None:
            ...
...
class DynamicLibraryModule(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, header: ghidra.app.util.bin.format.macho.MachHeader) -> None:
        ...
...
class SymbolTableCommand(LoadCommand):
    ...
    def __init__(self, loadCommandReader: ghidra.app.util.bin.BinaryReader, dataReader: ghidra.app.util.bin.BinaryReader, header: ghidra.app.util.bin.format.macho.MachHeader) -> None:
        """
    ...
    def addSymbols(self, list: java.util.List[NList]) -> None:
        """
...
__all__ = ["LoadCommand", "SegmentCommand", "DynamicLibraryCommand", "DynamicLibrary", "LoadCommandString", "NList", "BuildVersionCommand", "CodeSignatureCommand", "LinkEditDataCommand", "CorruptLoadCommand", "DataInCodeCommand", "DataInCodeEntry", "DyldChainedFixupsCommand", "DyldInfoCommandConstants", "DyldExportsTrieCommand", "ExportTrie", "DyldInfoCommand", "DynamicLibraryModule", "DynamicLibraryReference", "DynamicLinkerCommand", "DynamicSymbolTableCommand", "TableOfContents", "DynamicSymbolTableConstants", "EncryptedInformationCommand", "EntryPointCommand", "FileSetEntryCommand", "FixedVirtualMemoryFileCommand", "FixedVirtualMemorySharedLibraryCommand", "ObsoleteCommand", "FunctionStartsCommand", "IdentCommand", "LinkerOptionCommand", "LoadCommandTypes", "LoadCommandFactory", "NListConstants", "PrebindChecksumCommand", "PreboundDynamicLibraryCommand", "RoutinesCommand", "RunPathCommand", "SegmentConstants", "SegmentNames", "SourceVersionCommand", "SubClientCommand", "SubFrameworkCommand", "SubLibraryCommand", "SubUmbrellaCommand", "SymbolCommand", "SymbolTableCommand", "TwoLevelHint", "TwoLevelHintsCommand", "UnsupportedLoadCommand", "UuidCommand", "VersionMinCommand"]
