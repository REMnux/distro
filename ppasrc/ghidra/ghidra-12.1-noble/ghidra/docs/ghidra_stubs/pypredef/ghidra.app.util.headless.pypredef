...
class AnalyzeHeadless(ghidra.GhidraLaunchable):
    ...
    class Arg(java.lang.Enum[AnalyzeHeadless.Arg]):
        ...
        MIRROR: typing.Final[AnalyzeHeadless.Arg]
    ...
    @staticmethod
    def usage(execCmd: typing.Union[java.lang.String, str]) -> None:
        """
...
class HeadlessOptions(java.lang.Object):
    ...
    def enableAnalysis(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def enableMirroring(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Enables/disables mirroring of the imported file(s) filesystem path in the project.
        
        :param jpype.JBoolean or bool enabled: True if filesystem mirroring should happen; otherwise, false.
        """

    def enableOverwriteOnConflict(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def enableReadOnlyProcessing(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def enableRecursiveProcessing(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def enableRecursiveProcessing(self, enabled: typing.Union[jpype.JBoolean, bool], depth: typing.Union[java.lang.Integer, int]) -> None:
        """
        This method can be used to enable recursive processing of files during
        ``-import`` or ``-process`` modes.  In order for recursive processing of 
        files to occur, the user must have specified a project folder to process or a directory or 
    ...
    def setClientCredentials(self, userID: typing.Union[java.lang.String, str], keystorePath: typing.Union[java.lang.String, str], allowPasswordPrompt: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setCommitFiles(self, commit: typing.Union[jpype.JBoolean, bool], comment: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setDeleteCreatedProjectOnClose(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setLanguageAndCompiler(self, languageId: typing.Union[java.lang.String, str], compilerSpecId: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setLoader(self, loaderName: typing.Union[java.lang.String, str]) -> None:
        """
        ...
        :param java.lang.String or str loaderName: The name (simple class name) of the loader to use (could be null)
        :raises InvalidInputException: if an invalid loader name was specified
        """

    def setLoaderArgs(self, loaderArgs: java.util.List[generic.stl.Pair[java.lang.String, java.lang.String]]) -> None:
        """
    ...
    def setMaxCpu(self, cpu: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setOkToDelete(self, deleteOk: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def setPerFileAnalysisTimeout(self, stringInSecs: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setPerFileAnalysisTimeout(self, secs: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setPostScripts(self, postScripts: java.util.List[java.lang.String]) -> None:
        """
    ...
    def setPostScriptsWithArgs(self, postScripts: java.util.List[generic.stl.Pair[java.lang.String, jpype.JArray[java.lang.String]]]) -> None:
        """
        Set the ordered list of scripts to execute immediately following import and
        and analysis of a program.  If import not performed,
        these scripts will execute once following any pre-scripts.
    ...
    def setPreScripts(self, preScripts: java.util.List[java.lang.String]) -> None:
        """
        Set the ordered list of scripts to execute immediately following import and
    ...
    def setPreScriptsWithArgs(self, preScripts: java.util.List[generic.stl.Pair[java.lang.String, jpype.JArray[java.lang.String]]]) -> None:
        """
    ...
    @typing.overload
    def setPropertiesFileDirectories(self, newPaths: java.util.List[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def setPropertiesFileDirectories(self, paths: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setPropertiesFileDirectory(self, path: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setRunScriptsNoImport(self, runScriptsOnly: typing.Union[jpype.JBoolean, bool], filename: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setScriptDirectories(self, newPaths: java.util.List[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def setScriptDirectories(self, paths: typing.Union[java.lang.String, str]) -> None:
        """
...
class HeadlessScript(ghidra.app.script.GhidraScript):
    ...
    def enableHeadlessAnalysis(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setHeadlessContinuationOption(self, option: HeadlessScript.HeadlessContinuationOption) -> None:
        """
    ...
    def setHeadlessImportDirectory(self, importDir: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def storeHeadlessValue(self, key: typing.Union[java.lang.String, str], value: java.lang.Object) -> None:
        """
...
class HeadlessAnalyzer(java.lang.Object):
    ...
    * Used by another tool as a library to perform headless analysis.
    ...
    def processLocal(self, projectLocation: typing.Union[java.lang.String, str], projectName: typing.Union[java.lang.String, str], rootFolderPath: typing.Union[java.lang.String, str], filesToImport: java.util.List[java.io.File]) -> None:
        """
    ...
    def processURL(self, ghidraURL: java.net.URL, filesToImport: java.util.List[java.io.File]) -> None:
        """
        Process the optional import file/directory list and process each imported file:
        ...
        :raises URISyntaxException: specified URL is invalid
        """
...
__all__ = ["AnalyzeHeadless", "HeadlessOptions", "GhidraScriptRunner", "HeadlessScript", "HeadlessAnalyzer", "HeadlessErrorLogger", "HeadlessTimedTaskMonitor"]
