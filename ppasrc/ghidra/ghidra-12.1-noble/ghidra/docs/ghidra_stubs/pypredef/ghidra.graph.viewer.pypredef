...
class VisualVertex(ghidra.graph.GVertex):
    ...
    def setAlpha(self, alpha: typing.Union[jpype.JDouble, float]) -> None:
        """
    ...
    def setEmphasis(self, emphasisLevel: typing.Union[jpype.JDouble, float]) -> None:
        """
    ...
    def setFocused(self, focused: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setHovered(self, hovered: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class VisualEdge(ghidra.graph.GEdge[V], typing.Generic[V]):
    ...
    def setArticulationPoints(self, points: java.util.List[java.awt.geom.Point2D]) -> None:
        """
    ...
    def setInFocusedVertexPath(self, inPath: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setInHoveredVertexPath(self, inPath: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class GraphComponent(java.lang.Object, typing.Generic[V, E, G]):
    ...
    class KeyForwardingKeyAdapter(java.awt.event.KeyAdapter):
        ...
        def __init__(self, g: ghidra.graph.VisualGraph[V, E], viewer: edu.uci.ics.jung.visualization.VisualizationViewer[V, E]) -> None:
            ...
    ...
    class VertexPickingListener(ghidra.graph.viewer.event.picking.PickListener[V]):
        ...
        def __init__(self, g: ghidra.graph.VisualGraph[V, E]) -> None:
            ...
    ...
    def __init__(self, graph: G) -> None:
        ...
    ...
    def setGraphPerspective(self, info: GraphPerspectiveInfo[V, E]) -> None:
        ...

    def setGraphViewStale(self, isStale: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setPopupsVisible(self, visible: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setSatelliteDocked(self, docked: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setSatellitePosition(self, position: GraphComponent.SatellitePosition) -> None:
        ...

    def setSatelliteVisible(self, visible: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setVertexClickListener(self, l: ghidra.graph.viewer.vertex.VertexClickListener[V, E]) -> None:
        ...

    def setVertexFocusListener(self, l: ghidra.graph.viewer.vertex.VertexFocusListener[V]) -> None:
        ...

    def setVertexFocusPathHighlightMode(self, mode: PathHighlightMode) -> None:
        ...

    def setVertexFocused(self, vertex: V) -> None:
        """
    ...
    def setVertexHoverPathHighlightMode(self, mode: PathHighlightMode) -> None:
        ...

    def setVerticesSelected(self, vertices: collections.abc.Sequence) -> None:
        ...

    def twinkleVertex(self, twinkleVertex: V) -> None:
        ...
...
class VisualGraphView(java.lang.Object, typing.Generic[V, E, G]):
    ...
    **Implementation Note:**
    ...
    def addSatelliteListener(self, l: GraphSatelliteListener) -> None:
        ...

    def arePopupsEnabled(self) -> bool:
        ...

    def arePopupsVisible(self) -> bool:
        ...
    ...
    def setGraph(self, graph: G) -> None:
        ...

    def setGraphPerspective(self, newPerspective: GraphPerspectiveInfo[V, E]) -> None:
        """
    ...
    def setLayoutProvider(self, newLayoutProvider: ghidra.graph.viewer.layout.LayoutProvider[V, E, G]) -> None:
        """
    ...
    def setTooltipProvider(self, provider: ghidra.graph.viewer.event.mouse.VertexTooltipProvider[V, E]) -> None:
        ...
    ...
    def showErrorView(self, errorMessage: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def zoomToVertex(self, v: V) -> None:
        ...
...
class GraphViewer(edu.uci.ics.jung.visualization.VisualizationViewer[V, E], typing.Generic[V, E]):
    ...
    def __init__(self, layout: ghidra.graph.viewer.layout.VisualGraphLayout[V, E], size: java.awt.Dimension) -> None:
        ...
    ...
    def setVertexFocusPathHighlightMode(self, focusMode: PathHighlightMode) -> None:
        ...

    def setVertexHoverPathHighlightMode(self, hoverMode: PathHighlightMode) -> None:
        ...

    def setVertexTooltipProvider(self, vertexTooltipProvider: ghidra.graph.viewer.event.mouse.VertexTooltipProvider[V, E]) -> None:
        ...

    def setViewerInitializedListener(self, listener: java.util.function.Consumer[GraphViewer[V, E]]) -> None:
        ...
...
class GraphViewerUtils(java.lang.Object):
    ...
    * View Space - the coordinate system of Java 2D rendering; scaling (zooming) transformations
    ...
    @staticmethod
    def addPaddingToRectangle(padding: typing.Union[jpype.JInt, int], rectangle: java.awt.Rectangle) -> None:
        ...

    @staticmethod
    def adjustEdgePickSizeForZoom(viewer: edu.uci.ics.jung.visualization.VisualizationServer[V, E]) -> None:
        ...
    ...
    @staticmethod
    def setGraphScale(viewer: edu.uci.ics.jung.visualization.VisualizationServer[V, E], scale: typing.Union[jpype.JDouble, float]) -> None:
        ...
...
class VisualGraphViewUpdater(java.lang.Object, typing.Generic[V, E]):
    ...
    def __init__(self, primaryViewer: GraphViewer[V, E], graph: ghidra.graph.VisualGraph[V, E]) -> None:
        ...
    ...
    def ensureVertexAreaVisible(self, vertex: V, area: java.awt.Rectangle, callbackListener: ghidra.util.task.BusyListener) -> None:
        ...

    def ensureVertexVisible(self, vertex: V, area: java.awt.Rectangle) -> None:
        ...
    ...
    @typing.overload
    def fitGraphToViewerLater(self, theViewer: edu.uci.ics.jung.visualization.VisualizationServer[V, E]) -> None:
        ...
    ...
    @typing.overload
    def fitGraphToViewerNow(self, theViewer: edu.uci.ics.jung.visualization.VisualizationServer[V, E]) -> None:
        ...
    ...
    @typing.overload
    def moveVertexToCenterTopWithAnimation(self, vertex: V) -> None:
        ...

    @typing.overload
    def moveVertexToCenterTopWithAnimation(self, vertex: V, callbackListener: ghidra.util.task.BusyListener) -> None:
        ...

    def moveVertexToCenterTopWithoutAnimation(self, vertex: V) -> None:
        ...

    @typing.overload
    def moveVertexToCenterWithAnimation(self, vertex: V) -> None:
        ...

    @typing.overload
    def moveVertexToCenterWithAnimation(self, vertex: V, callbackListener: ghidra.util.task.BusyListener) -> None:
        ...

    def moveVertexToCenterWithoutAnimation(self, vertex: V) -> None:
        ...

    def moveViewerLocationWithoutAnimation(self, translation: java.awt.Point) -> None:
        ...

    def relayoutGraph(self) -> None:
        ...

    def scheduleViewChangeJob(self, job: ghidra.graph.job.GraphJob) -> None:
        ...

    def setGraphPerspective(self, graphInfo: GraphPerspectiveInfo[V, E]) -> None:
        ...

    def setGraphScale(self, scale: typing.Union[jpype.JDouble, float]) -> None:
        ...
    ...
    def twinkeVertex(self, vertex: V) -> None:
        ...

    def updateEdgeShapes(self, edges: collections.abc.Sequence) -> None:
        ...
    ...
    @typing.overload
    def zoomInCompletely(self, centerOnVertex: V) -> None:
        ...
...
class SatelliteGraphViewer(edu.uci.ics.jung.visualization.control.SatelliteVisualizationViewer[V, E], typing.Generic[V, E]):
    ...
    def __init__(self, master: GraphViewer[V, E], preferredSize: java.awt.Dimension) -> None:
        ...
    ...
    def setDocked(self, docked: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class GraphPerspectiveInfo(java.lang.Object, typing.Generic[V, E]):
    ...
    @typing.overload
    def __init__(self, renderContext: edu.uci.ics.jung.visualization.RenderContext[V, E], zoom: typing.Union[jpype.JDouble, float]) -> None:
        ...

    @typing.overload
    def __init__(self, saveState: ghidra.framework.options.SaveState) -> None:
        ...
...
class GraphSatelliteListener(java.lang.Object):
    ...
    def satelliteVisibilityChanged(self, docked: typing.Union[jpype.JBoolean, bool], visible: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
__all__ = ["VisualVertex", "VisualEdge", "GraphComponent", "VisualGraphView", "GraphViewer", "GraphViewerUtils", "VisualGraphViewUpdater", "PathHighlightMode", "SatelliteGraphViewer", "GraphPerspectiveInfo", "GraphSatelliteListener", "VisualGraphLayeredPaneButton", "VisualGraphScalingControl"]
