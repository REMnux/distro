...
class AssemblySyntaxException(AssemblyException):
    ...
    @typing.overload
    def __init__(self, errors: java.util.Set[ghidra.app.plugin.assembler.sleigh.parse.AssemblyParseResult]) -> None:
        """
...
class AssemblySemanticException(AssemblyException):
    ...
    @typing.overload
    def __init__(self, errors: java.util.Set[ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedError]) -> None:
        """
...
class AssemblySelector(java.lang.Object):
    ...
    class Selection(java.lang.Record):
        ...
        def __init__(self, ins: ghidra.app.plugin.assembler.sleigh.sem.AssemblyPatternBlock, ctx: ghidra.app.plugin.assembler.sleigh.sem.AssemblyPatternBlock) -> None:
            ...
...
class AssemblyBuffer(java.lang.Object):
    ...
    def __init__(self, asm: Assembler, entry: ghidra.program.model.address.Address) -> None:
        """
...
__all__ = ["Assembler", "GenericAssembler", "AssemblySyntaxException", "AssemblyException", "AssemblySemanticException", "AssemblerBuilder", "GenericAssemblerBuilder", "AssemblySelector", "Assemblers", "AssemblyBuffer", "AssemblyError", "AssemblySelectionError"]
