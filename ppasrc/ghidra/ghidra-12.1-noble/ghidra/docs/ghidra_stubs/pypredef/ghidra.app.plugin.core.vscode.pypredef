...
class VSCodeLauncherTask(ghidra.util.task.Task):
    ...
    def __init__(self, vscodeService: ghidra.app.services.VSCodeIntegrationService, file: jpype.protocol.SupportsPath) -> None:
        """
...
__all__ = ["VSCodeIntegrationOptionsPlugin", "VSCodeIntegrationPlugin", "VSCodeLauncherTask"]
