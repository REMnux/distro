...
class IntPropertyMapDB(PropertyMapDB[java.lang.Integer], ghidra.program.model.util.IntPropertyMap):
    ...
    def __init__(self, dbHandle: db.DBHandle, openMode: ghidra.framework.data.OpenMode, errHandler: db.util.ErrorHandler, changeMgr: ghidra.program.util.ChangeManager, addrMap: ghidra.program.database.map.AddressMap, name: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class PropertyMapDB(ghidra.program.database.DatabaseObject, ghidra.program.model.util.PropertyMap[T], typing.Generic[T]):
    ...
    def setCacheSize(self, size: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DBPropertyMapManager(ghidra.program.model.util.PropertyMapManager, ghidra.program.database.ManagerDB):
    ...
    def __init__(self, handle: db.DBHandle, changeMgr: ghidra.program.util.ChangeManager, addrMap: ghidra.program.database.map.AddressMap, openMode: ghidra.framework.data.OpenMode, lock: ghidra.util.Lock, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class PropertiesDBAdapter(java.lang.Object):
    ...
    def putRecord(self, propertyName: typing.Union[java.lang.String, str], type: typing.Union[jpype.JByte, int], objClassName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def removeRecord(self, propertyName: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["IntPropertyMapDB", "PropertyMapDB", "DBPropertyMapManager", "PropertiesDBAdapter", "GenericSaveable", "LongPropertyMapDB", "ObjectPropertyMapDB", "PropertiesDBAdapterV0", "StringPropertyMapDB", "UnsupportedMapDB", "VoidPropertyMapDB"]
