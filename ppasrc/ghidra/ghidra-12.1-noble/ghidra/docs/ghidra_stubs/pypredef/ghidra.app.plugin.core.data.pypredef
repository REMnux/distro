...
class AbstractSettingsDialog(docking.DialogComponentProvider):
    ...
    class SettingsTable(ghidra.util.table.GhidraTable):
        ...
        def __init__(self, settingsTableModel: AbstractSettingsDialog.SettingsTableModel) -> None:
            ...
...
class ChooseDataTypeAction(ghidra.app.context.ListingContextAction):
    ...
    def __init__(self, plugin: DataPlugin) -> None:
        ...
...
class DataAction(ghidra.app.context.ListingContextAction):
    ...
    @typing.overload
    def __init__(self, dataType: ghidra.program.model.data.DataType, plugin: DataPlugin) -> None:
        ...

    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], group: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, plugin: DataPlugin) -> None:
        """
        Constructor
...
class CreateStructureDialog(docking.ReusableDialogComponentProvider):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, program: ghidra.program.model.listing.Program) -> None:
        """
...
class DataSettingsDialog(AbstractSettingsDialog):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, sel: ghidra.program.util.ProgramSelection) -> None:
        """
...
class DataTypeSettingsDialog(AbstractSettingsDialog):
    ...
    def __init__(self, dataType: ghidra.program.model.data.DataType, settingsDefinitions: jpype.JArray[ghidra.docking.settings.SettingsDefinition]) -> None:
        """
...
class EditDataFieldDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, dtmService: ghidra.app.services.DataTypeManagerService, composite: ghidra.program.model.data.Composite, program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, ordinal: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
    ...
    def setCommentText(self, newComment: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setNameText(self, newName: typing.Union[java.lang.String, str]) -> None:
        """
...
class RenameDataFieldDialog(docking.DialogComponentProvider):
    ...
    def setDataComponent(self, program: ghidra.program.model.listing.Program, component: ghidra.program.model.data.DataTypeComponent, name: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ProgramStructureProviderContext(ghidra.program.model.lang.DataTypeProviderContext):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, loc: ghidra.program.util.ProgramLocation) -> None:
        ...

    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, struct: ghidra.program.model.data.Structure, myOffset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["AbstractSettingsDialog", "ChooseDataTypeAction", "DataPlugin", "DataAction", "CreateStructureAction", "CreateArrayAction", "CreateStructureDialog", "CycleGroupAction", "DataSettingsDialog", "DataTypeSettingsDialog", "EditDataFieldDialog", "PointerDataAction", "RecentlyUsedAction", "RenameDataFieldDialog", "ProgramProviderContext", "ProgramStructureProviderContext"]
