...
class IndexedScrollable(java.lang.Object):
    ...
    def addIndexScrollListener(self, listener: IndexScrollListener) -> None:
        """
    ...
    def mouseWheelMoved(self, preciseWheelRotation: typing.Union[jpype.JDouble, float], isHorizontal: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def removeIndexScrollListener(self, listener: IndexScrollListener) -> None:
        """
    ...
    def showIndex(self, index: java.math.BigInteger, verticalOffset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class IndexScrollListener(java.lang.Object):
    ...
    def indexModelChanged(self) -> None:
        ...

    def indexModelDataChanged(self, start: java.math.BigInteger, end: java.math.BigInteger) -> None:
        ...

    def indexRangeChanged(self, startIndex: java.math.BigInteger, endIndex: java.math.BigInteger, yStart: typing.Union[jpype.JInt, int], yEnd: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DefaultViewToIndexMapper(ViewToIndexMapper):
    ...
    def __init__(self, model: IndexedScrollable, screenHeight: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ViewToIndexMapper(java.lang.Object):
    ...
    def setVisibleViewHeight(self, height: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class IndexedScrollPane(javax.swing.JPanel, IndexScrollListener):
    ...
    def __init__(self, comp: javax.swing.JComponent) -> None:
        ...
    ...
    def setColumnHeader(self, header: javax.swing.JViewport) -> None:
        ...

    def setColumnHeaderComp(self, comp: javax.swing.JComponent) -> None:
        ...

    def setHorizontalScrollBarPolicy(self, policy: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setNeverScroll(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setScrollbarSideKickComponent(self, component: javax.swing.JComponent) -> None:
        ...

    def setVerticalScrollBarPolicy(self, policy: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setWheelScrollingEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def viewportStateChanged(self) -> None:
        ...
...
class PreMappedViewToIndexMapper(ViewToIndexMapper):
    ...
    def __init__(self, model: IndexedScrollable) -> None:
        ...
...
class UniformViewToIndexMapper(ViewToIndexMapper):
    ...
    def __init__(self, scrollable: IndexedScrollable) -> None:
        ...



__all__ = ["IndexedScrollable", "IndexScrollListener", "DefaultViewToIndexMapper", "ViewToIndexMapper", "IndexedScrollPane", "PreMappedViewToIndexMapper", "UniformViewToIndexMapper"]
