...
class GhidraApplicationConfiguration(HeadlessGhidraApplicationConfiguration):
    ...
    def setShowSplashScreen(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ToolUtils(java.lang.Object):
    ...
    @staticmethod
    def renameToolTemplate(toolTemplate: ghidra.framework.model.ToolTemplate, newName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ApplicationConfiguration(java.lang.Object):
    ...
    def setApplicationLogFile(self, logFile: jpype.protocol.SupportsPath) -> None:
        ...

    def setInitializeLogging(self, initializeLogging: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setScriptLogFile(self, scriptLogFile: jpype.protocol.SupportsPath) -> None:
        ...
...
class Application(java.lang.Object):
    ...
    @staticmethod
    def initializeApplication(layout: utility.application.ApplicationLayout, configuration: ApplicationConfiguration) -> None:
        """
    ...
    @staticmethod
    def initializeLogging(logFile: jpype.protocol.SupportsPath, scriptLogFile: jpype.protocol.SupportsPath) -> None:
        """
...
class OSFileNotFoundException(java.io.FileNotFoundException):
    ...
    @typing.overload
    def __init__(self, platform: Platform, moduleName: typing.Union[java.lang.String, str], fileName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, platform: Platform, fileName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, moduleName: typing.Union[java.lang.String, str], fileName: typing.Union[java.lang.String, str]) -> None:
        """
...
class GenericRunInfo(java.lang.Object):
    ...
    @staticmethod
    def setProjectsDirPath(path: typing.Union[java.lang.String, str]) -> None:
        """
...
class ShutdownHookRegistry(java.lang.Object):
    ...
    @staticmethod
    def removeShutdownHook(hook: ShutdownHookRegistry.ShutdownHook) -> None:
        """
...
class GModule(java.lang.Object):
    ...
    def __init__(self, appRoots: collections.abc.Sequence, moduleRoot: generic.jar.ResourceFile) -> None:
        ...

    def accumulateDataFilesByExtension(self, accumulator: java.util.List[generic.jar.ResourceFile], extension: typing.Union[java.lang.String, str]) -> None:
        ...

    def collectExistingModuleDirs(self, accumulator: java.util.List[generic.jar.ResourceFile], moduleRelativePath: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ApplicationProperties(java.util.Properties):
    ...
    * 3: Introduced with Ghidra 11.2. Ghidra no longer finds external modules by examining 
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], version: typing.Union[java.lang.String, str], releaseName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, appPropertiesFile: generic.jar.ResourceFile) -> None:
        """
    ...
    @typing.overload
    def __init__(self, applicationRootDirs: collections.abc.Sequence) -> None:
        """
...
class ApplicationIdentifier(java.lang.Object):
    ...
    * ghidra-7.4_DEV
    ...
    @typing.overload
    def __init__(self, identifier: typing.Union[java.lang.String, str]) -> None:
        """
...
class ApplicationVersion(java.lang.Comparable[ApplicationVersion]):
    ...
    * 7.4.1-BETA
    ...
    def __init__(self, version: typing.Union[java.lang.String, str]) -> None:
        """
...
class PluggableServiceRegistry(java.lang.Object):
    ...
    @staticmethod
    def registerPluggableService(pluggableServiceClass: java.lang.Class[T], replacementInstance: T) -> None:
        ...
...
class PluggableServiceRegistryException(java.lang.RuntimeException):
    ...
    def __init__(self, pluggableServiceClass: java.lang.Class[java.lang.Object], alreadyRegisteredPluggableServiceClass: java.lang.Class[java.lang.Object], pluggableServiceReplacementInstanceClass: java.lang.Class[java.lang.Object]) -> None:
        ...



__all__ = ["GhidraApplicationConfiguration", "HeadlessGhidraApplicationConfiguration", "ToolUtils", "ModuleInitializer", "ApplicationConfiguration", "Application", "OSFileNotFoundException", "Platform", "Architecture", "GenericRunInfo", "Log4jErrorLogger", "LoggingInitialization", "ShutdownHookRegistry", "ShutdownPriority", "TestApplicationUtils", "GModule", "ApplicationProperties", "ApplicationIdentifier", "ApplicationVersion", "OperatingSystem", "PluggableServiceRegistry", "PluggableServiceRegistryException"]
