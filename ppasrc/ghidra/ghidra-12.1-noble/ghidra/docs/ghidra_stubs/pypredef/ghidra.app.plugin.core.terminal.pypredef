...
class DefaultTerminal(ghidra.app.services.Terminal):
    ...
    def __init__(self, provider: TerminalProvider) -> None:
        ...
...
class TerminalFinder(java.lang.Object):
    ...
    class TextTerminalFinder(TerminalFinder):
        ...
        def __init__(self, model: TerminalLayoutModel, cur: docking.widgets.fieldpanel.support.FieldLocation, forward: typing.Union[jpype.JBoolean, bool], text: typing.Union[java.lang.String, str], options: java.util.Set[TerminalPanel.FindOptions]) -> None:
            """
    ...
    class RegexTerminalFinder(TerminalFinder):
        ...
        def __init__(self, model: TerminalLayoutModel, cur: docking.widgets.fieldpanel.support.FieldLocation, forward: typing.Union[jpype.JBoolean, bool], pattern: typing.Union[java.lang.String, str], options: java.util.Set[TerminalPanel.FindOptions]) -> None:
            """
...
class TerminalPanel(javax.swing.JPanel, docking.widgets.fieldpanel.listener.FieldLocationListener, docking.widgets.fieldpanel.listener.FieldSelectionListener, docking.widgets.fieldpanel.listener.LayoutListener, ghidra.app.plugin.core.terminal.vt.AnsiColorResolver, generic.theme.ThemeListener):
    ...
    def addTerminalListener(self, listener: TerminalListener) -> None:
        ...
    ...
    def paste(self, text: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def processInput(self, buffer: java.nio.ByteBuffer) -> None:
        """
    ...
    def removeTerminalListener(self, listener: TerminalListener) -> None:
        ...

    def reportCursorPos(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def selectWordAt(self, location: docking.widgets.fieldpanel.support.FieldLocation, trigger: docking.widgets.EventTrigger) -> None:
        """
    ...
    def setClipboardService(self, clipboardService: ghidra.app.services.ClipboardService) -> None:
        ...
    ...
    def setFixedTerminalSize(self, cols: typing.Union[jpype.JShort, int], rows: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    def setOutputCallback(self, outputCb: ghidra.app.plugin.core.terminal.vt.VtOutput) -> None:
        """
...
class TerminalProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, plugin: TerminalPlugin, charset: java.nio.charset.Charset, helpPlugin: ghidra.framework.plugintool.Plugin) -> None:
        ...
...
class TerminalListener(java.lang.Object):
    ...
    def resized(self, cols: typing.Union[jpype.JShort, int], rows: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    def retitled(self, title: typing.Union[java.lang.String, str]) -> None:
        """
...
class TerminalLayoutModel(docking.widgets.fieldpanel.LayoutModel, ghidra.app.plugin.core.terminal.vt.VtHandler):
    ...
    def __init__(self, panel: TerminalPanel, charset: java.nio.charset.Charset, metrics: java.awt.FontMetrics, colors: ghidra.app.plugin.core.terminal.vt.AnsiColorResolver) -> None:
        """
        Create a model
    ...
    def setFontMetrics(self, metrics: java.awt.FontMetrics, fontSizeAdjustment: typing.Union[jpype.JFloat, float]) -> None:
        ...

    def setMaxScrollBackSize(self, rows: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class TerminalClipboardProvider(ghidra.app.services.ClipboardContentProviderService):
    ...
    def selectionChanged(self, selection: docking.widgets.fieldpanel.support.FieldSelection) -> None:
        ...
...
class TerminalAwtEventEncoder(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, charset: java.nio.charset.Charset) -> None:
        ...
    ...
    def keyPressed(self, e: java.awt.event.KeyEvent, cursorKeyMode: ghidra.app.plugin.core.terminal.vt.VtHandler.KeyMode, keypadMode: ghidra.app.plugin.core.terminal.vt.VtHandler.KeyMode) -> None:
        ...

    def keyTyped(self, e: java.awt.event.KeyEvent) -> None:
        ...

    def mousePressed(self, e: java.awt.event.MouseEvent, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int]) -> None:
        ...

    def mouseReleased(self, e: java.awt.event.MouseEvent, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int]) -> None:
        ...

    def mouseWheelMoved(self, e: java.awt.event.MouseWheelEvent, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int]) -> None:
        ...

    def sendChar(self, c: typing.Union[jpype.JChar, int, str]) -> None:
        ...

    def sendText(self, text: java.lang.CharSequence) -> None:
        ...
...
class TerminalLayout(docking.widgets.fieldpanel.support.SingleRowLayout):
    ...
    def __init__(self, line: ghidra.app.plugin.core.terminal.vt.VtLine, metrics: java.awt.FontMetrics, fontSizeAdjustment: typing.Union[jpype.JFloat, float], colors: ghidra.app.plugin.core.terminal.vt.AnsiColorResolver) -> None:
        ...
...
class TerminalTextFieldElement(docking.widgets.fieldpanel.field.FieldElement):
    ...
    class SaveTransform(java.lang.AutoCloseable):
        ...
        def __init__(self, g: java.awt.Graphics) -> None:
            ...
...
class ThreadedTerminal(DefaultTerminal):
    ...
    def __init__(self, provider: TerminalProvider, in_: java.io.InputStream) -> None:
        """
...
__all__ = ["DefaultTerminal", "TerminalFinder", "TerminalPanel", "TerminalProvider", "TerminalListener", "TerminalPlugin", "TerminalLayoutModel", "TerminalClipboardProvider", "TerminalAwtEventEncoder", "TerminalLayout", "TerminalTextField", "TerminalTextFieldElement", "ThreadedTerminal"]
