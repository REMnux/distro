...
class MutableInt(java.lang.Object):
    ...
    def add(self, amount: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def set(self, i: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class MutableLong(java.lang.Object):
    ...
    def add(self, amount: typing.Union[jpype.JLong, int]) -> None:
        ...
    ...
    def set(self, i: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class Utils(java.lang.Object):
    ...
    @staticmethod
    def calc_maskword(location: ghidra.sleigh.grammar.Location, sbit: typing.Union[jpype.JInt, int], ebit: typing.Union[jpype.JInt, int], num: MutableInt, shift: MutableInt, mask: MutableInt) -> None:
        ...
...
class WeakHashMap2(java.util.AbstractMap[K, V], typing.Generic[K, V]):
    ...
    @typing.overload
    def __init__(self, initialCapacity: typing.Union[jpype.JInt, int], loadFactor: typing.Union[jpype.JFloat, float]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, t: collections.abc.Mapping) -> None:
        """
...
__all__ = ["MutableInt", "AddrSpaceToIdSymmetryMap", "MutableLong", "Utils", "WeakHashMap2"]
