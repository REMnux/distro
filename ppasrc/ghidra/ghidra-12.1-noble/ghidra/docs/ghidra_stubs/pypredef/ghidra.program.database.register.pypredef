...
class AddressRangeObjectMap(java.lang.Object, typing.Generic[T]):
    ...
    def setObject(self, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address, object: T) -> None:
        """
...
class AddressValueRange(java.lang.Comparable[AddressValueRange[T]], typing.Generic[T]):
    ...
    def __init__(self, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address, value: T) -> None:
        """
...
class DatabaseRangeMapAdapter(ghidra.program.util.RangeMapAdapter):
    ...
    def __init__(self, register: ghidra.program.model.lang.Register, dbHandle: db.DBHandle, addrMap: ghidra.program.database.map.AddressMap, lock: ghidra.util.Lock, errorHandler: db.util.ErrorHandler) -> None:
        ...
...
class IndexToAddressRangeIteratorAdapter(ghidra.program.model.address.AddressRangeIterator):
    ...
    def __init__(self, addressMap: ghidra.program.database.map.AddressMap, it: ghidra.util.datastruct.IndexRangeIterator) -> None:
        """
...
class OldProgramContextDB(ghidra.program.model.listing.ProgramContext, ghidra.program.model.listing.DefaultProgramContext, ghidra.program.database.ManagerDB):
    ...
    def __init__(self, dbHandle: db.DBHandle, errHandler: db.util.ErrorHandler, language: ghidra.program.model.lang.Language, addrMap: ghidra.program.database.map.AddressMap, lock: ghidra.util.Lock) -> None:
        """
    ...
    def set(self, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address, reg: ghidra.program.model.lang.Register, value: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class RegisterValueRange(java.lang.Object):
    ...
    def __init__(self, startAddr: ghidra.program.model.address.Address, endAddr: ghidra.program.model.address.Address, value: ghidra.program.model.lang.RegisterValue) -> None:
        """
    ...
    def setEndAddress(self, addr: ghidra.program.model.address.Address) -> None:
        """
    ...
    def setStartAddress(self, addr: ghidra.program.model.address.Address) -> None:
        """
        Set the end address of the range.
...
class SimpleAddressRangeIterator(ghidra.program.model.address.AddressRangeIterator):
    ...
    def __init__(self, valueRanges: jpype.JArray[RegisterValueRange]) -> None:
        ...
...
__all__ = ["AddressRangeObjectMap", "AddressValueRange", "DatabaseRangeMapAdapter", "InMemoryRangeMapAdapter", "IndexToAddressRangeIteratorAdapter", "OldProgramContextDB", "RegisterValueRange", "SimpleAddressRangeIterator", "ProgramRegisterContextDB"]
