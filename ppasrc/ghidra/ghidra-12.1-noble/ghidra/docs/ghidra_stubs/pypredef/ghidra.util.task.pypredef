...
class TaskMonitorComponent(javax.swing.JPanel, TaskMonitor):
    ...
    @typing.overload
    def __init__(self, includeTextField: typing.Union[jpype.JBoolean, bool], includeCancelButton: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
    ...
    def setCancelButtonVisibility(self, visible: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setTaskName(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def showProgress(self, show: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def showProgressIcon(self, visible: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class CachingSwingWorker(CachingLoader[T], typing.Generic[T]):
    ...
    class WorkerTaskMonitor(TaskMonitorAdapter):
        ...
        def add(self, monitor: TaskMonitor) -> None:
            ...

        def clear(self) -> None:
            ...

        def setBlockingMonitor(self, monitor: TaskMonitor) -> None:
            ...
    ...
    class SwingWorkerCompletionWaiter(java.beans.PropertyChangeListener):
        ...
        def __init__(self, dialog: docking.DialogComponentProvider) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, name: typing.Union[java.lang.String, str], hasProgress: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setTaskDialogDelay(self, delay: typing.Union[jpype.JInt, int]) -> None:
        """
...
class TaskDialog(docking.DialogComponentProvider, TaskMonitor):
    ...
    **API Usage Note: **If this dialog is used outside of the task API, then the client must
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], canCancel: typing.Union[jpype.JBoolean, bool], isModal: typing.Union[jpype.JBoolean, bool], hasProgress: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], canCancel: typing.Union[jpype.JBoolean, bool], isModal: typing.Union[jpype.JBoolean, bool], hasProgress: typing.Union[jpype.JBoolean, bool], finished: java.util.concurrent.CountDownLatch) -> None:
        """
        Constructor
    ...
    def show(self, delay: typing.Union[jpype.JInt, int]) -> None:
        """
...
class RunManager(java.lang.Object):
    ...
    class RunnerJob(ghidra.util.worker.Job):
        ...
        class SwingRunner(java.lang.Runnable):
            ...
            def __init__(self, cancelledWhileRunning: typing.Union[jpype.JBoolean, bool]) -> None:
                ...
    ...
    @typing.overload
    def __init__(self, listener: TaskListener) -> None:
        ...

    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], defaultComponent: java.awt.Component) -> None:
        ...

    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], defaultComponent: java.awt.Component, listener: TaskListener) -> None:
        ...
    ...
    def runLater(self, runnable: MonitoredRunnable, taskName: typing.Union[java.lang.String, str], showProgressDelay: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def runNext(self, runnable: MonitoredRunnable, taskName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def runNext(self, runnable: MonitoredRunnable, taskName: typing.Union[java.lang.String, str], showProgressDelay: typing.Union[jpype.JInt, int]) -> None:
        """
        Allows any currently running runnable to finish, clears any queued runnables,
        and then queues the given runnable to be run after the current runnable finishes.
    ...
    @typing.overload
    def runNow(self, runnable: MonitoredRunnable, taskName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def runNow(self, runnable: MonitoredRunnable, taskName: typing.Union[java.lang.String, str], showProgressDelay: typing.Union[jpype.JInt, int]) -> None:
        """
        Cancels any currently running runnable, clears any queued runnables, and then runs the given
        runnable.
    ...
    def showCancelButton(self, showCancel: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def showProgressBar(self, showProgress: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def waitForNotBusy(self, maxWaitMillis: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class TaskBuilder(java.lang.Object):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], runnable: MonitoredRunnable) -> None:
        """
        Constructor
    ...
    def launchInBackground(self, monitor: TaskMonitor) -> None:
        """
...
class TaskLauncher(java.lang.Object):
    ...
    **Modal Usage**
    ...
    @typing.overload
    def __init__(self, task: Task, parent: java.awt.Component) -> None:
        """
        Constructor for TaskLauncher
    ...
    @typing.overload
    def __init__(self, task: Task, parent: java.awt.Component, delayMs: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, task: Task, parent: java.awt.Component, delayMs: typing.Union[jpype.JInt, int], dialogWidth: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a new TaskLauncher
    ...
    @staticmethod
    @typing.overload
    def launchModal(title: typing.Union[java.lang.String, str], runnable: MonitoredRunnable) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def launchModal(title: typing.Union[java.lang.String, str], runnable: java.lang.Runnable) -> None:
        """
    ...
    @staticmethod
    def launchNonModal(title: typing.Union[java.lang.String, str], runnable: MonitoredRunnable) -> None:
        """
        A convenience method to directly run a :obj:`MonitoredRunnable` in a separate
        thread as a :obj:`Task`, displaying a non-modal progress dialog.
...
class TaskListener(java.lang.Object):
    ...
    def taskCancelled(self, task: Task) -> None:
        """
    ...
    def taskCompleted(self, task: Task) -> None:
        """
...
class Task(MonitoredRunnable):
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], canCancel: typing.Union[jpype.JBoolean, bool], hasProgress: typing.Union[jpype.JBoolean, bool], isModal: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], canCancel: typing.Union[jpype.JBoolean, bool], hasProgress: typing.Union[jpype.JBoolean, bool], isModal: typing.Union[jpype.JBoolean, bool], waitForTaskCompleted: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a new Task.
    ...
    def addTaskListener(self, listener: TaskListener) -> None:
        """
    ...
    def monitoredRun(self, monitor: TaskMonitor) -> None:
        """
    ...
    def setHasProgress(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class BufferedSwingRunner(AbstractSwingUpdateManager):
    ...
    @typing.overload
    def __init__(self, minDelay: typing.Union[jpype.JInt, int], maxDelay: typing.Union[jpype.JInt, int]) -> None:
        """
...
class CompoundTask(Task):
    ...
    def __init__(self, tasks: jpype.JArray[Task], title: typing.Union[java.lang.String, str]) -> None:
        """
...
class SwingRunnable(MonitoredRunnable):
    ...
    def swingRun(self, isCancelled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class SwingUpdateManager(AbstractSwingUpdateManager):
    ...
    * Non-blocking update now - this is a conceptual use-case, where the client wishes to perform an
    ...
    @typing.overload
    def __init__(self, minDelay: typing.Union[jpype.JInt, int], r: java.lang.Runnable) -> None:
        """
        Constructs a new SwingUpdateManager
    ...
    @typing.overload
    def __init__(self, minDelay: typing.Union[jpype.JInt, int], maxDelay: typing.Union[jpype.JInt, int], r: java.lang.Runnable) -> None:
        """
        Constructs a new SwingUpdateManager
    ...
    @typing.overload
    def __init__(self, minDelay: typing.Union[jpype.JInt, int], maxDelay: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str], r: java.lang.Runnable) -> None:
        """
        Constructs a new SwingUpdateManager
...
class UnknownProgressWrappingTaskMonitor(WrappingTaskMonitor):
    ...
    @typing.overload
    def __init__(self, delegate: TaskMonitor) -> None:
        ...

    @typing.overload
    def __init__(self, delegate: TaskMonitor, startMaximum: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class WrappingTaskMonitor(TaskMonitor):
    ...
    **Synchronization Policy**:
    ...
    def setDelegate(self, newDelegate: TaskMonitor) -> None:
        """
...
class TaskMonitorAdapter(TaskMonitor):
    ...
    @typing.overload
    def __init__(self, cancelEnabled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def getMinimum(self) -> int:
        ...

    def setMinimum(self, min: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class TaskMonitorSplitter(java.lang.Object):
    ...
    class SubTaskMonitor(TaskMonitor, CancelledListener):
        ...
        def __init__(self, parent: TaskMonitor, subSize: typing.Union[jpype.JDouble, float], notDoneYetSet: java.util.Set[TaskMonitorSplitter.SubTaskMonitor]) -> None:
            ...
...
class TaskMonitor(java.lang.Object):
    ...
    def addCancelledListener(self, listener: CancelledListener) -> None:
        """
    ...
    @typing.overload
    def increment(self, incrementAmount: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def initialize(self, max: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def initialize(self, max: typing.Union[jpype.JLong, int], message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def removeCancelledListener(self, listener: CancelledListener) -> None:
        """
    ...
    def setCancelEnabled(self, enable: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setProgress(self, value: typing.Union[jpype.JLong, int]) -> None:
        """
...
class CancellableIterator(java.util.Iterator[T], typing.Generic[T]):
    ...
    def __init__(self, delegate: java.util.Iterator[T], monitor: TaskMonitor) -> None:
        ...
...
__all__ = ["TaskMonitorComponent", "BackgroundThreadTaskLauncher", "BasicTaskMonitor", "CachingLoader", "CachingSwingWorker", "TaskDialog", "ChompingBitsAnimationPanel", "HourglassAnimationPanel", "RunManager", "TaskBuilder", "TaskLauncher", "TaskRunner", "AbstractSwingUpdateManager", "TaskListener", "Task", "BufferedSwingRunner", "CompoundTask", "DummyCancellableTaskMonitor", "SwingRunnable", "SwingUpdateManager", "UnknownProgressWrappingTaskMonitor", "BusyListener", "CancelOnlyWrappingTaskMonitor", "WrappingTaskMonitor", "ConsoleTaskMonitor", "TaskMonitorAdapter", "MonitoredRunnable", "PreserveStateWrappingTaskMonitor", "TaskMonitorSplitter", "TimeoutTaskMonitor", "TaskMonitor", "CancelledListener", "CancellableIterator", "IssueListener", "StubTaskMonitor"]
