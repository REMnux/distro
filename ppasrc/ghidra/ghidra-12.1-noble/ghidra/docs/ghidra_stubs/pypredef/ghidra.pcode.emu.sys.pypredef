...
class AnnotatedEmuSyscallUseropLibrary(ghidra.pcode.exec_.AnnotatedPcodeUseropLibrary[T], EmuSyscallLibrary[T], typing.Generic[T]):
    ...
    class EmuSyscall(java.lang.annotation.Annotation):
        ...
        :obj:`@PcodeUserop <ghidra.pcode.exec.AnnotatedPcodeUseropLibrary.PcodeUserop>`.
        """
    ...
    def __init__(self, machine: ghidra.pcode.emu.PcodeMachine[T], program: ghidra.program.model.listing.Program) -> None:
        """
    ...
    def newBoundSyscall(self, number: typing.Union[jpype.JLong, int], opdef: ghidra.pcode.exec_.PcodeUseropLibrary.PcodeUseropDefinition[T], convention: ghidra.program.model.lang.PrototypeModel) -> UseropEmuSyscallDefinition[T]:
        """
        Export a userop as a system call
        
        :param jpype.JLong or int number: the opIndex assigned to the userop
        :param ghidra.pcode.exec_.PcodeUseropLibrary.PcodeUseropDefinition[T] opdef: the userop
        :param ghidra.program.model.lang.PrototypeModel convention: the syscall calling convention for the emulated platform
...
class EmuSyscallLibrary(ghidra.pcode.exec_.PcodeUseropLibrary[T], typing.Generic[T]):
    ...
    class SyscallPcodeUseropDefinition(ghidra.pcode.exec_.PcodeUseropLibrary.PcodeUseropDefinition[T], typing.Generic[T]):
        ...
        def __init__(self, syslib: EmuSyscallLibrary[T]) -> None:
            ...
    ...
    class EmuSyscallDefinition(java.lang.Object, typing.Generic[T]):
        ...
        def invoke(self, executor: ghidra.pcode.exec_.PcodeExecutor[T], library: ghidra.pcode.exec_.PcodeUseropLibrary[T]) -> None:
            """
    ...
    def syscall(self, executor: ghidra.pcode.exec_.PcodeExecutor[T], library: ghidra.pcode.exec_.PcodeUseropLibrary[T]) -> None:
        """
...
class EmuInvalidSystemCallException(EmuSystemException):
    ...
    @typing.overload
    def __init__(self, number: typing.Union[jpype.JLong, int]) -> None:
        """
...
class EmuSystemException(ghidra.pcode.exec_.PcodeExecutionException):
    ...
    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], frame: ghidra.pcode.exec_.PcodeFrame) -> None:
        ...

    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], frame: ghidra.pcode.exec_.PcodeFrame, cause: java.lang.Throwable) -> None:
        ...
...
class UseropEmuSyscallDefinition(EmuSyscallLibrary.EmuSyscallDefinition[T], typing.Generic[T]):
    ...
    def __init__(self, number: typing.Union[jpype.JLong, int], opdef: ghidra.pcode.exec_.PcodeUseropLibrary.PcodeUseropDefinition[T], program: ghidra.program.model.listing.Program, convention: ghidra.program.model.lang.PrototypeModel, dtMachineWord: ghidra.program.model.data.DataType) -> None:
        """
        Construct a syscall definition
        
        :param jpype.JLong or int number: the opIndex assigned to this userop
...
class EmuProcessExitedException(EmuSystemException):
    ...
    def __init__(self, arithmetic: ghidra.pcode.exec_.PcodeArithmetic[T], status: T) -> None:
        """
...
class PairedEmuFileContents(EmuFileContents[org.apache.commons.lang3.tuple.Pair[L, R]], typing.Generic[L, R]):
    ...
    def __init__(self, left: EmuFileContents[L], right: EmuFileContents[R]) -> None:
        """
...
__all__ = ["AnnotatedEmuSyscallUseropLibrary", "EmuSyscallLibrary", "EmuIOException", "EmuInvalidSystemCallException", "EmuSystemException", "UseropEmuSyscallDefinition", "BytesEmuFileContents", "EmuFileContents", "EmuProcessExitedException", "PairedEmuFileContents"]
