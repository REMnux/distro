...
class AbstractTranslateAction(docking.action.DockingAction):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], codeViewerMenuData: docking.action.MenuData, dataListMenuData: docking.action.MenuData) -> None:
        ...
...
class ManualStringTranslationService(ghidra.app.services.StringTranslationService):
    ...
    @staticmethod
    def setTranslatedValue(program: ghidra.program.model.listing.Program, stringLocation: ghidra.program.util.ProgramLocation, newValue: typing.Union[java.lang.String, str]) -> None:
        """
...
class TranslateAction(AbstractTranslateAction):
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], service: ghidra.app.services.StringTranslationService) -> None:
        ...
...
__all__ = ["AbstractTranslateAction", "ClearTranslationAction", "ManualStringTranslationService", "ToggleShowTranslationAction", "TranslateAction", "TranslateStringsPlugin"]
