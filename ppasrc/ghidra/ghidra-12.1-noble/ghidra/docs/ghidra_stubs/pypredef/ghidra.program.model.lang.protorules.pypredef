...
class ModelRule(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, op2: ModelRule, res: ghidra.program.model.lang.ParamListStandard) -> None:
        """
        Copy constructor
    ...
    @typing.overload
    def __init__(self, typeFilter: DatatypeFilter, action: AssignAction, res: ghidra.program.model.lang.ParamListStandard) -> None:
        """
...
class AssignAction(java.lang.Object):
    ...
    def __init__(self, res: ghidra.program.model.lang.ParamListStandard) -> None:
        ...
    ...
    @staticmethod
    def justifyPieces(pieces: java.util.ArrayList[ghidra.program.model.pcode.Varnode], offset: typing.Union[jpype.JInt, int], isBigEndian: typing.Union[jpype.JBoolean, bool], consumeMostSig: typing.Union[jpype.JBoolean, bool], justifyRight: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    @staticmethod
    def restorePreconditionXml(parser: ghidra.xml.XmlPullParser, res: ghidra.program.model.lang.ParamListStandard) -> AssignAction:
        """
        ...
        :param ghidra.xml.XmlPullParser parser: is the stream parser
        :param ghidra.program.model.lang.ParamListStandard res: is the resource set for the new precondition
        :return: the new precondition, or null if no more preconditions are in the stream
        :rtype: AssignAction
        :raises XmlParseException: if the precondition XML is malformed
        """
...
class AndFilter(QualifierFilter):
    ...
    @typing.overload
    def __init__(self, qualifierList: java.util.ArrayList[QualifierFilter]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, op: AndFilter) -> None:
        ...
...
class ConsumeAs(AssignAction):
    ...
    def __init__(self, store: ghidra.program.model.lang.StorageClass, res: ghidra.program.model.lang.ParamListStandard) -> None:
        ...
...
class ConsumeExtra(AssignAction):
    ...
    def __init__(self, store: ghidra.program.model.lang.StorageClass, match: typing.Union[jpype.JBoolean, bool], res: ghidra.program.model.lang.ParamListStandard) -> None:
        ...
...
class ExtraStack(AssignAction):
    ...
    @typing.overload
    def __init__(self, res: ghidra.program.model.lang.ParamListStandard, val: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, storage: ghidra.program.model.lang.StorageClass, offset: typing.Union[jpype.JInt, int], res: ghidra.program.model.lang.ParamListStandard) -> None:
        ...
...
class HiddenReturnAssign(AssignAction):
    ...
    def __init__(self, res: ghidra.program.model.lang.ParamListStandard, code: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class HomogeneousAggregate(SizeRestrictedFilter):
    ...
    class_: typing.ClassVar[java.lang.Class]
    NAME_FLOAT: typing.Final = "homogeneous-float-aggregate"
    DEFAULT_MAX_PRIMITIVES: typing.Final = 4

    @typing.overload
    def __init__(self, nm: typing.Union[java.lang.String, str], meta: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, nm: typing.Union[java.lang.String, str], meta: typing.Union[jpype.JInt, int], maxPrim: typing.Union[jpype.JInt, int], minSize: typing.Union[jpype.JInt, int], maxSize: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, op2: HomogeneousAggregate) -> None:
        """
        Copy constructor
...
class SizeRestrictedFilter(DatatypeFilter):
    ...
    @typing.overload
    def __init__(self, op2: SizeRestrictedFilter) -> None:
        """
        Copy constructor
...
class MetaTypeFilter(SizeRestrictedFilter):
    ...
    @typing.overload
    def __init__(self, meta: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor for use with decode().
    ...
    @typing.overload
    def __init__(self, meta: typing.Union[jpype.JInt, int], min: typing.Union[jpype.JInt, int], max: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, op2: MetaTypeFilter) -> None:
        """
        Copy constructor
...
class MultiMemberAssign(AssignAction):
    ...
    def __init__(self, store: ghidra.program.model.lang.StorageClass, stack: typing.Union[jpype.JBoolean, bool], mostSig: typing.Union[jpype.JBoolean, bool], res: ghidra.program.model.lang.ParamListStandard) -> None:
        ...
...
class PrimitiveExtractor(java.lang.Object):
    ...
    class Primitive(java.lang.Object):
        ...
        def __init__(self, d: ghidra.program.model.data.DataType, off: typing.Union[jpype.JInt, int]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, dt: ghidra.program.model.data.DataType, unionIllegal: typing.Union[jpype.JBoolean, bool], offset: typing.Union[jpype.JInt, int], max: typing.Union[jpype.JInt, int]) -> None:
        """
...
class MultiSlotDualAssign(AssignAction):
    ...
    def __init__(self, baseStore: ghidra.program.model.lang.StorageClass, altStore: ghidra.program.model.lang.StorageClass, stack: typing.Union[jpype.JBoolean, bool], mostSig: typing.Union[jpype.JBoolean, bool], justRight: typing.Union[jpype.JBoolean, bool], fillAlt: typing.Union[jpype.JBoolean, bool], res: ghidra.program.model.lang.ParamListStandard) -> None:
        """
        Constructor
        
        :param ghidra.program.model.lang.StorageClass baseStore: resource list from which to consume general tiles
        :param ghidra.program.model.lang.StorageClass altStore: resource list form which to consume alternate tiles
        :param jpype.JBoolean or bool stack: true if resources can be consumed from the stack
        :param jpype.JBoolean or bool mostSig: true if resources are consumed starting with most significant bytes
        :param jpype.JBoolean or bool justRight: true if initial bytes are padding for odd data-type sizes
        :param jpype.JBoolean or bool fillAlt: true if a single primitive needs to fill an alternate tile
        :param ghidra.program.model.lang.ParamListStandard res: is the new resource set to associate with this action
        :raises InvalidInputException: if the required elements are not available in the resource list
        """
...
class VarargsFilter(QualifierFilter):
    ...
    @typing.overload
    def __init__(self, first: typing.Union[jpype.JInt, int], last: typing.Union[jpype.JInt, int]) -> None:
        ...



__all__ = ["ModelRule", "DatatypeFilter", "QualifierFilter", "AssignAction", "AndFilter", "ConsumeAs", "ConsumeExtra", "ConsumeRemaining", "ConvertToPointer", "DatatypeMatchFilter", "ExtraStack", "GotoStack", "HiddenReturnAssign", "HomogeneousAggregate", "SizeRestrictedFilter", "MetaTypeFilter", "MultiMemberAssign", "MultiSlotAssign", "PrimitiveExtractor", "MultiSlotDualAssign", "PositionMatchFilter", "VarargsFilter"]
