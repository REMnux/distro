...
class PreprocessorDefinitions(java.lang.Object):
    ...
    def set(self, key: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        ...

    def undefine(self, key: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ConsistencyChecker(java.lang.Object):
    ...
    @typing.type_check_only
    class UniqueState(java.lang.Object):
    ...
    def __init__(self, cp: SleighCompile, rt: ghidra.pcodeCPort.slghsymbol.SubtableSymbol, unnecessary: typing.Union[jpype.JBoolean, bool], warndead: typing.Union[jpype.JBoolean, bool], warnlargetemp: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def optimizeAll(self) -> None:
        ...

    def testLargeTemporary(self) -> None:
        ...
...
class SleighCompile(ghidra.pcodeCPort.sleighbase.SleighBase):
    ...
    def addTokenField(self, location: ghidra.sleigh.grammar.Location, sym: ghidra.pcodeCPort.slghsymbol.TokenSymbol, qual: FieldQuality) -> None:
        ...

    def addUserOp(self, names: generic.stl.VectorSTL[java.lang.String], locations: generic.stl.VectorSTL[ghidra.sleigh.grammar.Location]) -> None:
        ...

    def attachNames(self, symlist: generic.stl.VectorSTL[ghidra.pcodeCPort.slghsymbol.SleighSymbol], locations: generic.stl.VectorSTL[ghidra.sleigh.grammar.Location], names: generic.stl.VectorSTL[java.lang.String]) -> None:
        ...

    def attachValues(self, symlist: generic.stl.VectorSTL[ghidra.pcodeCPort.slghsymbol.SleighSymbol], locations: generic.stl.VectorSTL[ghidra.sleigh.grammar.Location], numlist: generic.stl.VectorSTL[java.lang.Long]) -> None:
        ...

    def attachVarnodes(self, symlist: generic.stl.VectorSTL[ghidra.pcodeCPort.slghsymbol.SleighSymbol], locations: generic.stl.VectorSTL[ghidra.sleigh.grammar.Location], varlist: generic.stl.VectorSTL[ghidra.pcodeCPort.slghsymbol.SleighSymbol]) -> None:
        ...

    def buildConstructor(self, big: ghidra.pcodeCPort.slghsymbol.Constructor, pateq: ghidra.pcodeCPort.slghpatexpress.PatternEquation, contvec: generic.stl.VectorSTL[ghidra.pcodeCPort.slghsymbol.ContextChange], vec: SectionVector) -> None:
        ...

    def buildMacro(self, sym: ghidra.pcodeCPort.slghsymbol.MacroSymbol, rtl: ghidra.pcodeCPort.semantics.ConstructTpl) -> None:
        ...

    def calcContextLayout(self) -> None:
        ...

    def compareMacroParams(self, sym: ghidra.pcodeCPort.slghsymbol.MacroSymbol, param: generic.stl.VectorSTL[ExprTree]) -> None:
        ...
    ...
    def contextSet(self, vec: generic.stl.VectorSTL[ghidra.pcodeCPort.slghsymbol.ContextChange], sym: ghidra.pcodeCPort.slghsymbol.TripleSymbol, cvar: ghidra.pcodeCPort.slghsymbol.ContextSymbol) -> None:
        ...
    ...
    def defineBitrange(self, location: ghidra.sleigh.grammar.Location, name: typing.Union[java.lang.String, str], sym: ghidra.pcodeCPort.slghsymbol.VarnodeSymbol, bitoffset: typing.Union[jpype.JInt, int], numb: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def defineOperand(self, location: ghidra.sleigh.grammar.Location, sym: ghidra.pcodeCPort.slghsymbol.OperandSymbol, patexp: ghidra.pcodeCPort.slghpatexpress.PatternExpression) -> None:
        ...
    ...
    def defineVarnodes(self, spacesym: ghidra.pcodeCPort.slghsymbol.SpaceSymbol, off: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], names: generic.stl.VectorSTL[java.lang.String], locations: generic.stl.VectorSTL[ghidra.sleigh.grammar.Location]) -> None:
        ...

    @staticmethod
    def entry(name: typing.Union[java.lang.String, str], *args: java.lang.Object) -> None:
        ...
    ...
    def newOperand(self, location: ghidra.sleigh.grammar.Location, ct: ghidra.pcodeCPort.slghsymbol.Constructor, nm: typing.Union[java.lang.String, str]) -> None:
        ...

    def newSpace(self, location: ghidra.sleigh.grammar.Location, qual: SpaceQuality) -> None:
        ...
    ...
    def pushWith(self, ss: ghidra.pcodeCPort.slghsymbol.SubtableSymbol, pateq: ghidra.pcodeCPort.slghpatexpress.PatternEquation, contvec: generic.stl.VectorSTL[ghidra.pcodeCPort.slghsymbol.ContextChange]) -> None:
        ...
    ...
    @typing.overload
    def reportError(self, location: ghidra.sleigh.grammar.Location, msg: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def reportError(self, location: ghidra.sleigh.grammar.Location, msg: typing.Union[java.lang.String, str], t: java.lang.Throwable) -> None:
        ...

    def reportWarning(self, location: ghidra.sleigh.grammar.Location, msg: typing.Union[java.lang.String, str]) -> None:
        ...

    def run_compilation(self, filein: typing.Union[java.lang.String, str], fileout: typing.Union[java.lang.String, str]) -> int:
        ...

    def selfDefine(self, sym: ghidra.pcodeCPort.slghsymbol.OperandSymbol) -> None:
        ...

    def setAlignment(self, val: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setAllNopWarning(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setDeadTempWarning(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setDebugOutput(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setEndian(self, end: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setEnforceLocalKeyWord(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setInsensitiveDuplicateError(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setLenientConflict(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setLocalCollisionWarning(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setPreprocValue(self, nm: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        ...

    def setUnnecessaryPcodeWarning(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setUnusedFieldWarning(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class OptimizeRecord(java.lang.Object):
    ...
    def copyFromExcludingSize(self, that: OptimizeRecord) -> None:
        ...

    def updateCombine(self, that: OptimizeRecord) -> None:
        ...

    def updateExport(self) -> None:
        ...

    def updateRead(self, i: typing.Union[jpype.JInt, int], inslot: typing.Union[jpype.JInt, int], secNum: typing.Union[jpype.JInt, int]) -> None:
        ...

    def updateWrite(self, i: typing.Union[jpype.JInt, int], secNum: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class PcodeCompile(java.lang.Object):
    ...
    def appendOp(self, location: ghidra.sleigh.grammar.Location, opc: ghidra.pcodeCPort.opcodes.OpCode, res: ExprTree, constval: typing.Union[jpype.JLong, int], constsz: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def enterSection(self, where: ghidra.sleigh.grammar.Location) -> ghidra.pcodeCPort.semantics.ConstructTpl:
        ...
    ...
    def fillinZero(self, op: ghidra.pcodeCPort.semantics.OpTpl, ops: generic.stl.VectorSTL[ghidra.pcodeCPort.semantics.OpTpl]) -> None:
        ...
    ...
    def matchSize(self, j: typing.Union[jpype.JInt, int], op: ghidra.pcodeCPort.semantics.OpTpl, inputonly: typing.Union[jpype.JBoolean, bool], ops: generic.stl.VectorSTL[ghidra.pcodeCPort.semantics.OpTpl]) -> None:
        ...

    @typing.overload
    def newLocalDefinition(self, location: ghidra.sleigh.grammar.Location, varname: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def newLocalDefinition(self, location: ghidra.sleigh.grammar.Location, varname: typing.Union[java.lang.String, str], size: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def setEnforceLocalKey(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class SectionVector(java.lang.Object):
    ...
    def __init__(self, rtl: ghidra.pcodeCPort.semantics.ConstructTpl, scope: ghidra.pcodeCPort.slghsymbol.SymbolScope) -> None:
        ...

    def append(self, rtl: ghidra.pcodeCPort.semantics.ConstructTpl, scope: ghidra.pcodeCPort.slghsymbol.SymbolScope) -> None:
        ...
    ...
    def setNextIndex(self, i: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class FieldQuality(java.lang.Object):
    ...
    def __init__(self, nm: typing.Union[java.lang.String, str], location: ghidra.sleigh.grammar.Location, l: typing.Union[jpype.JLong, int], h: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class SpaceQuality(java.lang.Object):
    ...
    def __init__(self, nm: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ExprTree(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, vn: ghidra.pcodeCPort.semantics.VarnodeTpl) -> None:
        ...

    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, op: ghidra.pcodeCPort.semantics.OpTpl) -> None:
        ...

    def setOutput(self, newLocation: ghidra.sleigh.grammar.Location, newout: ghidra.pcodeCPort.semantics.VarnodeTpl) -> None:
        ...
...
class RtlPair(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, sec: ghidra.pcodeCPort.semantics.ConstructTpl, sc: ghidra.pcodeCPort.slghsymbol.SymbolScope) -> None:
        ...
...
class StarQuality(java.lang.Object):
    ...
    def setId(self, id: ghidra.pcodeCPort.semantics.ConstTpl) -> None:
        ...

    def setSize(self, size: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DirectoryVisitor(java.lang.Iterable[java.io.File]):
    ...
    class BreadthFirstDirectoryVisitor(java.util.Iterator[java.io.File]):
        ...
        def __init__(self, startingDirectories: collections.abc.Sequence, directoryFilter: java.io.FileFilter, filter: java.io.FileFilter, compareCase: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, startingDirectory: jpype.protocol.SupportsPath, filter: java.io.FileFilter) -> None:
        ...

    @typing.overload
    def __init__(self, startingDirectory: jpype.protocol.SupportsPath, filter: java.io.FileFilter, compareCase: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, startingDirectory: jpype.protocol.SupportsPath, directoryFilter: java.io.FileFilter, filter: java.io.FileFilter) -> None:
        ...

    @typing.overload
    def __init__(self, startingDirectory: jpype.protocol.SupportsPath, directoryFilter: java.io.FileFilter, filter: java.io.FileFilter, compareCase: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, startingDirectories: collections.abc.Sequence, filter: java.io.FileFilter) -> None:
        ...

    @typing.overload
    def __init__(self, startingDirectories: collections.abc.Sequence, filter: java.io.FileFilter, compareCase: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, startingDirectories: collections.abc.Sequence, directoryFilter: java.io.FileFilter, filter: java.io.FileFilter) -> None:
        ...
...
class MacroBuilder(ghidra.pcodeCPort.semantics.PcodeBuilder):
    ...
    def __init__(self, sl: SleighCompile, loc: ghidra.sleigh.grammar.Location, ovec: generic.stl.VectorSTL[ghidra.pcodeCPort.semantics.OpTpl], lbcnt: typing.Union[jpype.JInt, int]) -> None:
        ...

    def hasError(self) -> bool:
        ...

    def setMacroOp(self, macroop: ghidra.pcodeCPort.semantics.OpTpl) -> None:
        ...
...
class ParseException(java.lang.Exception):
    ...
    @typing.overload
    def __init__(self, currentTokenVal: Token, expectedTokenSequencesVal: jpype.JArray[jpype.JArray[jpype.JInt]], tokenImageVal: jpype.JArray[java.lang.String]) -> None:
        """
...
class SleighCompilePreprocessorDefinitionsAdapater(PreprocessorDefinitions):
    ...
    def __init__(self, sleighCompile: SleighCompile) -> None:
        ...



__all__ = ["PreprocessorDefinitions", "ConsistencyChecker", "SleighCompile", "OptimizeRecord", "PcodeCompile", "FieldContext", "SectionVector", "FieldQuality", "SpaceQuality", "ExprTree", "space_class", "RtlPair", "StarQuality", "DirectoryVisitor", "ErrorWarningReporter", "MacroBuilder", "ParseException", "Token", "Yylval", "SemanticEnvironment", "SleighCompileLauncher", "SleighCompilePreprocessorDefinitionsAdapater"]
