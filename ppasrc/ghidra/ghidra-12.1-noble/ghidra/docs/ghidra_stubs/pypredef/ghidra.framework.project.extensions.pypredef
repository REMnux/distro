...
class ExtensionDetailsPanel(ghidra.framework.plugintool.dialog.AbstractDetailsPanel):
    ...
    def setDescription(self, details: ghidra.util.extensions.ExtensionDetails) -> None:
        """
...
class ExtensionTablePanel(javax.swing.JPanel):
    ...
    def setExtensions(self, extensions: java.util.Set[ghidra.util.extensions.ExtensionDetails]) -> None:
        """
...
class ExtensionTableModel(docking.widgets.table.threaded.ThreadedTableModel[ghidra.util.extensions.ExtensionDetails, java.lang.Object]):
    ...
    def setModelData(self, model: java.util.List[ghidra.util.extensions.ExtensionDetails]) -> None:
        """
...
__all__ = ["ExtensionDetailsPanel", "ExtensionTablePanel", "ExtensionTableModel", "ExtensionInstaller", "ExtensionTableProvider"]
