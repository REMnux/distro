...
class ResourceDirectory(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, index: typing.Union[jpype.JInt, int], resourceBase: typing.Union[jpype.JInt, int], isFirstLevel: typing.Union[jpype.JBoolean, bool], ntHeader: ghidra.app.util.bin.format.pe.NTHeader) -> None:
        ...
...
class ResourceInfo(java.lang.Comparable[ResourceInfo]):
    ...
    def __init__(self, address: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str], size: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor.
    ...
    def setID(self, id: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setName(self, name: typing.Union[java.lang.String, str]) -> None:
        ...

    def setTypeID(self, typeID: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ResourceDirectoryEntry(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, index: typing.Union[jpype.JInt, int], resourceBase: typing.Union[jpype.JInt, int], isNameEntry: typing.Union[jpype.JBoolean, bool], isFirstLevel: typing.Union[jpype.JBoolean, bool], ntHeader: ghidra.app.util.bin.format.pe.NTHeader) -> None:
        """
        Constructor.
...
class ResourceStringInfo(java.lang.Object):
    ...
    def __init__(self, address: typing.Union[jpype.JInt, int], string: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor.
...
__all__ = ["ResourceDirectory", "ResourceInfo", "VS_VERSION_CHILD", "ResourceDirectoryEntry", "ResourceDirectoryStringU", "ResourceDataEntry", "ResourceDirectoryString", "ResourceStringInfo", "VS_VERSION_INFO"]
