...
class AddBitFieldAction(CompositeEditorTableAction):
    ...
    def __init__(self, provider: CompositeEditorProvider[typing.Any, typing.Any]) -> None:
        ...
...
class CompositeEditorTableAction(docking.action.DockingAction):
    ...
    def __init__(self, provider: CompositeEditorProvider[typing.Any, typing.Any], name: typing.Union[java.lang.String, str], group: typing.Union[java.lang.String, str], popupPath: jpype.JArray[java.lang.String], menuPath: jpype.JArray[java.lang.String], icon: javax.swing.Icon) -> None:
        ...
...
class CompositeEditorProvider(ghidra.framework.plugintool.ComponentProviderAdapter, EditorProvider, EditorActionListener, typing.Generic[T, M]):
    ...
    def selectField(self, fieldName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class EditorProvider(java.lang.Object):
    ...
    def addEditorListener(self, listener: EditorListener) -> None:
        """
...
class EditorActionListener(java.lang.Object):
    ...
    def actionsAdded(self, actions: jpype.JArray[CompositeEditorTableAction]) -> None:
        """
    ...
    def actionsRemoved(self, actions: jpype.JArray[CompositeEditorTableAction]) -> None:
        """
...
class CompositeEditorModel(CompositeViewerModel[T], typing.Generic[T]):
    ...
    def addCompositeEditorModelListener(self, listener: CompositeEditorModelListener) -> None:
        """
    ...
    def cycleDataType(self, cycleGroup: ghidra.program.model.data.CycleGroup) -> None:
        ...
    ...
    def removeCompositeEditorModelListener(self, listener: CompositeEditorModelListener) -> None:
        """
    ...
    def setSelection(self, rows: jpype.JArray[jpype.JInt]) -> None:
        """
    ...
    def setValueAt(self, aValue: java.lang.Object, rowIndex: typing.Union[jpype.JInt, int], modelColumnIndex: typing.Union[jpype.JInt, int]) -> None:
        """
...
class CompositeViewerModel(javax.swing.table.AbstractTableModel, ghidra.program.model.data.DataTypeManagerChangeListener, typing.Generic[T]):
    ...
    def addCompositeViewerModelListener(self, listener: CompositeViewerModelListener) -> None:
        """
    ...
    def displayNumbersInHex(self, showHex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def removeCompositeViewerModelListener(self, listener: CompositeViewerModelListener) -> None:
        """
    ...
    def setRow(self, row: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def setStatus(self, status: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setStatus(self, status: typing.Union[java.lang.String, str], beep: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class CompositeEditorPanel(javax.swing.JPanel, CompositeEditorModelListener, ComponentCellEditorListener, docking.dnd.Droppable, typing.Generic[T, M]):
    ...
    class CompositeEditorTable(docking.widgets.table.GTable):
        ...
        def __init__(self, model: javax.swing.table.TableModel) -> None:
            ...
    ...
    def __init__(self, model: M, provider: CompositeEditorProvider[T, M]) -> None:
        ...

    def addAtPoint(self, p: java.awt.Point, dt: ghidra.program.model.data.DataType) -> None:
        """
    ...
    def addEditorModelListener(self, listener: CompositeEditorModelListener) -> None:
        ...

    def compositeEditStateChanged(self, type: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def dragUnderFeedback(self, ok: typing.Union[jpype.JBoolean, bool], e: java.awt.dnd.DropTargetDragEvent) -> None:
        """
    ...
    def insertAtPoint(self, p: java.awt.Point, dt: ghidra.program.model.data.DataType) -> None:
        """
        Add the object to the droppable component. The DragSrcAdapter calls this method from its
        drop() method.
    ...
    def moveCellEditor(self, direction: typing.Union[jpype.JInt, int], value: typing.Union[java.lang.String, str]) -> None:
        """
        BEGIN ComponentCellEditorListener methods
        """

    def removeEditorModelListener(self, listener: CompositeEditorModelListener) -> None:
        ...
...
class CompositeEditorModelListener(CompositeViewerModelListener):
    ...
    def showUndefinedStateChanged(self, showUndefinedBytes: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class CompositeViewerModelListener(java.lang.Object):
    ...
    def statusChanged(self, message: typing.Union[java.lang.String, str], beep: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class EditorListener(java.lang.Object):
    ...
    def closed(self, editor: EditorProvider) -> None:
        """
...
class CompositeEditorActionManager(java.lang.Object):
    ...
    def addEditorActionListener(self, listener: EditorActionListener) -> None:
        """
    ...
    def removeEditorActionListener(self, listener: EditorActionListener) -> None:
        """
    ...
    def setEditorActions(self, actions: jpype.JArray[CompositeEditorTableAction]) -> None:
        """
...
class CycleGroupAction(CompositeEditorTableAction):
    ...
    def __init__(self, provider: CompositeEditorProvider[typing.Any, typing.Any], cycleGroup: ghidra.program.model.data.CycleGroup) -> None:
        ...
...
class DndTableCellRenderer(javax.swing.table.TableCellRenderer):
    ...
    class DndBorder(javax.swing.border.AbstractBorder):
        ...
        def __init__(self, borders: typing.Union[jpype.JInt, int], thickness: typing.Union[jpype.JInt, int], color: java.awt.Color, under: javax.swing.border.Border) -> None:
            ...

        def addBorders(self, border: typing.Union[jpype.JInt, int]) -> None:
            ...

        def clrBorders(self) -> None:
            ...

        def delBorders(self, border: typing.Union[jpype.JInt, int]) -> None:
            ...
        ...
        def setUnderBorder(self, under: javax.swing.border.Border) -> None:
            ...
    ...
    def __init__(self, orig: javax.swing.table.TableCellRenderer, table: javax.swing.JTable) -> None:
        ...

    def getBorderColor(self) -> java.awt.Color:
        ...

    def selectRange(self, isInsert: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setBorderColor(self, color: java.awt.Color) -> None:
        ...
...
class SearchControlPanel(javax.swing.JPanel):
    ...
    def __init__(self, editorPanel: CompositeEditorPanel[typing.Any, typing.Any]) -> None:
        ...
...
class CompositeViewerDataTypeManager(ghidra.program.model.data.StandAloneDataTypeManager, db.util.ErrorHandler, typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, rootName: typing.Union[java.lang.String, str], originalDTM: ghidra.program.model.data.DataTypeManager) -> None:
        """
    ...
    @typing.overload
    def __init__(self, rootName: typing.Union[java.lang.String, str], originalComposite: T, changeCallback: utility.function.Callback, restoredCallback: utility.function.Callback) -> None:
        """
    ...
    def clearUndoOnChange(self) -> None:
        """
...
class CompositeChangeListener(java.lang.Object):
    ...
    def componentChanged(self, ordinal: typing.Union[jpype.JInt, int]) -> None:
        """
...
class BitFieldPlacementComponent(javax.swing.JPanel, javax.swing.Scrollable):
    ...
    def setComposite(self, composite: ghidra.program.model.data.Composite) -> None:
        """
    ...
    def setShowOffsetsInHex(self, useHex: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class CompEditorModel(CompositeEditorModel[T], typing.Generic[T]):
    ...
    def setAlignmentType(self, alignmentType: ghidra.program.model.data.AlignmentType, explicitValue: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setPackingType(self, packingType: ghidra.program.model.data.PackingType, explicitValue: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    @typing.overload
    def setSelection(self, selection: docking.widgets.fieldpanel.support.FieldSelection) -> None:
        """
...
class CompEditorPanel(CompositeEditorPanel[T, M], typing.Generic[T, M]):
    ...
    def setCategoryName(self, name: typing.Union[java.lang.String, str]) -> None:
        """
...
class ComponentCellEditor(docking.widgets.table.GTableTextCellEditor):
    ...
    def __init__(self, field: javax.swing.JTextField) -> None:
        ...
...
class ComponentProgramActionContext(ghidra.app.context.ProgramActionContext, ComponentContext):
    ...
    def __init__(self, compositeEditorProvider: CompositeEditorProvider[typing.Any, typing.Any], program: ghidra.program.model.listing.Program, component: ghidra.program.model.data.DataTypeComponent) -> None:
        ...
...
class ComponentStandAloneActionContext(docking.DefaultActionContext, ComponentContext):
    ...
    def __init__(self, compositeEditorProvider: CompositeEditorProvider[typing.Any, typing.Any], component: ghidra.program.model.data.DataTypeComponent) -> None:
        ...
...
class CompositeEditorLockListener(java.lang.Object):
    ...
    def lockStateChanged(self, type: typing.Union[jpype.JInt, int]) -> None:
        """
...
class CreateInternalStructureAction(CompositeEditorTableAction):
    ...
    def __init__(self, provider: StructureEditorProvider) -> None:
        ...
...
class StructureEditorProvider(CompositeEditorProvider[ghidra.program.model.data.Structure, StructureEditorModel]):
    ...
    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, structureDataType: ghidra.program.model.data.Structure, showHexNumbers: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class StructureEditorModel(CompEditorModel[ghidra.program.model.data.Structure]):
    ...
    def unpackage(self, rowIndex: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class DataTypeCellRenderer(docking.widgets.table.GTableCellRenderer):
    ...
    def __init__(self, originalDataTypeManager: ghidra.program.model.data.DataTypeManager) -> None:
        ...
...
class EditorModelListener(java.lang.Object):
    ...
    def editStateChanged(self, type: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class FavoritesAction(CompositeEditorTableAction):
    ...
    def __init__(self, provider: CompositeEditorProvider[typing.Any, typing.Any], dt: ghidra.program.model.data.DataType) -> None:
        """
...
class OriginalCompositeListener(java.lang.Object):
    ...
    def originalCategoryChanged(self, newPath: ghidra.program.model.data.CategoryPath) -> None:
        """
    ...
    def originalNameChanged(self, newName: typing.Union[java.lang.String, str]) -> None:
        """
...
class StructureEditorPanel(CompEditorPanel[ghidra.program.model.data.Structure, StructureEditorModel]):
    ...
    def __init__(self, model: StructureEditorModel, provider: StructureEditorProvider) -> None:
        ...
...
class UnionEditorProvider(CompositeEditorProvider[ghidra.program.model.data.Union, UnionEditorModel]):
    ...
    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, unionDataType: ghidra.program.model.data.Union, showInHex: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class UnionEditorPanel(CompEditorPanel[ghidra.program.model.data.Union, UnionEditorModel]):
    ...
    def __init__(self, model: UnionEditorModel, provider: CompositeEditorProvider[ghidra.program.model.data.Union, UnionEditorModel]) -> None:
        ...
...
__all__ = ["AddBitFieldAction", "CompositeEditorTableAction", "CompositeEditorProvider", "EditorProvider", "EditorActionListener", "CompositeEditorModel", "CompositeViewerModel", "CompositeEditorPanel", "CompositeEditorModelListener", "CompositeViewerModelListener", "ComponentCellEditorListener", "EditorListener", "CompositeEditorActionManager", "CycleGroupAction", "DndTableCellRenderer", "SearchControlPanel", "CompositeViewerDataTypeManager", "IDMapDB", "ApplyAction", "ArrayAction", "BitFieldEditorDialog", "CompositeChangeListener", "BitFieldPlacementComponent", "BitFieldEditorPanel", "ClearAction", "CompEditorModel", "CompEditorPanel", "ComponentCellEditor", "ComponentContext", "ComponentProgramActionContext", "ComponentStandAloneActionContext", "CompositeEditorLockListener", "DataTypeHelper", "CompositeEditorModelAdapter", "CompositeModelDataListener", "CompositeModelSelectionListener", "CompositeModelStatusListener", "CreateInternalStructureAction", "StructureEditorProvider", "StructureEditorModel", "DataTypeCellRenderer", "DeleteAction", "DuplicateAction", "DuplicateMultipleAction", "EditBitFieldAction", "EditComponentAction", "EditFieldAction", "EditorModelListener", "FavoritesAction", "FindReferencesToStructureFieldAction", "HexNumbersAction", "InsertUndefinedAction", "MoveDownAction", "MoveUpAction", "OriginalCompositeListener", "PointerAction", "RedoChangeAction", "ShowComponentPathAction", "ShowDataTypeInTreeAction", "StructureEditorPanel", "UndoChangeAction", "UnionEditorModel", "UnionEditorProvider", "UnionEditorPanel", "UnpackageAction"]
