...
class RichHeaderRecord(java.lang.Object):
    ...
    def __init__(self, recordIndex: typing.Union[jpype.JInt, int], compid: typing.Union[jpype.JInt, int], count: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class MSRichProductBuildNumberDataType(ghidra.program.model.data.DataTypeImpl):
    ...
    @typing.overload
    def __init__(self, compid: CompId) -> None:
        ...

    @typing.overload
    def __init__(self, compid: CompId, dtm: ghidra.program.model.data.DataTypeManager) -> None:
        ...
...
class PERichTableDataType(ghidra.program.model.data.DynamicDataType):
    ...
    class PERichDanSDataType(ghidra.program.model.data.BuiltIn):
        ...
        @typing.overload
        def __init__(self, mask: typing.Union[jpype.JInt, int]) -> None:
            ...

        @typing.overload
        def __init__(self, dtm: ghidra.program.model.data.DataTypeManager, mask: typing.Union[jpype.JInt, int]) -> None:
            ...
...
class RichProduct(java.lang.Object):
    ...
    def __init__(self, compid: typing.Union[jpype.JInt, int], version: typing.Union[java.lang.String, str], type: MSProductType) -> None:
        ...
...
class RichObjectCountDataType(ghidra.program.model.data.DataTypeImpl):
    ...
    @typing.overload
    def __init__(self, count: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, count: typing.Union[jpype.JInt, int], dtm: ghidra.program.model.data.DataTypeManager) -> None:
        ...
...
class RichTableRecordDataType(ghidra.program.model.data.StructureDataType):
    ...
    @typing.overload
    def __init__(self, record: RichHeaderRecord) -> None:
        ...

    @typing.overload
    def __init__(self, dtm: ghidra.program.model.data.DataTypeManager, record: RichHeaderRecord) -> None:
        ...



__all__ = ["RichHeaderRecord", "CompId", "MSProductType", "MSRichProductBuildNumberDataType", "MSRichProductIDDataType", "MSRichProductInfoDataType", "PERichTableDataType", "RichHeaderUtils", "RichProduct", "RichObjectCountDataType", "RichProductIdLoader", "RichTableRecordDataType"]
