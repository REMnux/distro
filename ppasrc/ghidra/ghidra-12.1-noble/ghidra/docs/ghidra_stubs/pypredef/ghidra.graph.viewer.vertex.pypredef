...
class VertexFocusListener(java.lang.Object, typing.Generic[V]):
    ...
    def vertexFocused(self, v: V) -> None:
        ...
...
class AbstractVisualVertexRenderer(edu.uci.ics.jung.visualization.renderers.BasicVertexRenderer[V, E], typing.Generic[V, E]):
    ...
    def setVertexFillPaintTransformer(self, transformer: com.google.common.base.Function[V, java.awt.Paint]) -> None:
        """
...
class DockingVisualVertex(AbstractVisualVertex):
    ...
    def setMaxWidth(self, width: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["VertexFocusListener", "VertexClickListener", "VisualGraphVertexShapeTransformer", "AbstractVisualVertexRenderer", "AbstractVisualVertex", "DockingVisualVertex", "VertexShapeProvider", "VisualVertexRenderer"]
