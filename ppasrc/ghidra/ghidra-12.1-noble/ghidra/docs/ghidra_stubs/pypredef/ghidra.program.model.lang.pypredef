...
class PrototypeModel(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], model: PrototypeModel) -> None:
        """
    ...
    def assignParameterStorage(self, proto: PrototypePieces, dtManager: ghidra.program.model.data.DataTypeManager, res: java.util.ArrayList[ParameterPieces], addAutoParams: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def encode(self, encoder: ghidra.program.model.pcode.Encoder, injectLibrary: PcodeInjectLibrary) -> None:
        """
    ...
    def restoreXml(self, parser: ghidra.xml.XmlPullParser, cspec: CompilerSpec) -> None:
        """
...
class ParamList(java.lang.Object):
    ...
    def assignMap(self, proto: PrototypePieces, dtManage: ghidra.program.model.data.DataTypeManager, res: java.util.ArrayList[ParameterPieces], addAutoParams: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def encode(self, encoder: ghidra.program.model.pcode.Encoder, isInput: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class PrototypePieces(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, model: PrototypeModel, oldList: jpype.JArray[ghidra.program.model.data.DataType], injectedThis: ghidra.program.model.data.DataType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, model: PrototypeModel, outType: ghidra.program.model.data.DataType) -> None:
        """
...
class ParameterPieces(java.lang.Object):
    ...
    def assignAddressFromPieces(self, pieces: java.util.ArrayList[ghidra.program.model.pcode.Varnode], mostToLeast: typing.Union[jpype.JBoolean, bool], onePieceJoin: typing.Union[jpype.JBoolean, bool], language: Language) -> None:
        """
    ...
    def swapMarkup(self, op: ParameterPieces) -> None:
        """
...
class InjectPayload(java.lang.Object):
    ...
    class InjectParameter(java.lang.Object):
        ...
        def __init__(self, nm: typing.Union[java.lang.String, str], sz: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def inject(self, context: InjectContext, emit: ghidra.app.plugin.processors.sleigh.PcodeEmit) -> None:
        """
...
class PcodeInjectLibrary(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, l: ghidra.app.plugin.processors.sleigh.SleighLanguage) -> None:
        ...

    @typing.overload
    def __init__(self, op2: PcodeInjectLibrary) -> None:
        """
...
class Language(java.lang.Object):
    ...
    def getMaximumInstructionLength(self) -> java.util.OptionalInt:
        """
        ...
        needed when determining an *inst_next2* location for a given instruction.
        
        :return: maximum instruction length in bytes if specified.
        :rtype: java.util.OptionalInt
        """
    ...
    @property
    def maximumInstructionLength(self) -> java.util.OptionalInt:
        ...
...
class Register(java.io.Serializable, java.lang.Comparable[Register]):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], address: ghidra.program.model.address.Address, numBytes: typing.Union[jpype.JInt, int], bigEndian: typing.Union[jpype.JBoolean, bool], typeFlags: typing.Union[jpype.JInt, int]) -> None:
        """
...
class RegisterValue(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, register: Register, value: java.math.BigInteger) -> None:
        """
    ...
    @typing.overload
    def __init__(self, register: Register, value: java.math.BigInteger, mask: java.math.BigInteger) -> None:
        """
    ...
    @typing.overload
    def __init__(self, register: Register, bytes: jpype.JArray[jpype.JByte]) -> None:
        """
...
class Processor(java.lang.Comparable[Processor]):
    ...
    class RegisterHook(java.lang.Object):
        ...
        def register(self, name: typing.Union[java.lang.String, str]) -> None:
            ...
...
class ProcessorContext(ProcessorContextView):
    ...
    def clearRegister(self, register: Register) -> None:
        """
    ...
    def setRegisterValue(self, value: RegisterValue) -> None:
        """
    ...
    def setValue(self, register: Register, value: java.math.BigInteger) -> None:
        """
...
class ProcessorContextView(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def dumpContextValue(value: RegisterValue, indent: typing.Union[java.lang.String, str], buf: java.lang.StringBuilder) -> None:
        ...
...
class InstructionPrototype(java.lang.Object):
    ...
    def getAddress(self, operandIndex: typing.Union[jpype.JInt, int], context: InstructionContext) -> ghidra.program.model.address.Address:
        """
        :return: the :obj:`Address` value of a specific operand, or null if its value is not an
        :obj:`Address`
    ...
    def getFallThrough(self, context: InstructionContext) -> ghidra.program.model.address.Address:
        """
        :return: the :obj:`Address` for fall-through flow after this instruction, or null if flow
    ...
    def getFlows(self, context: InstructionContext) -> jpype.JArray[ghidra.program.model.address.Address]:
        """
        :return: the :obj:`Address`es for all flows other than a fall-through, or null if no flows
        ...
        :obj:`Address.NO_ADDRESS` to indicate flow to an address that could not be evaluated, e.g.,
        to ``inst_next2`` when the skipped instruction could not be parsed.
    ...
    def getInputObjects(self, context: InstructionContext) -> jpype.JArray[java.lang.Object]:
        ...
        Each element should probably only be one of :obj:`Address` or :obj:`Register`.
    ...
    def getInstructionMask(self) -> Mask:
        """
        :return: the :obj:`Mask` that describe which bits of this instruction determine the opcode,
        or null if unknown
        :rtype: Mask
        """
    ...
    def getOpObjects(self, operandIndex: typing.Union[jpype.JInt, int], context: InstructionContext) -> jpype.JArray[java.lang.Object]:
        """
        ...
        Each element is one of :obj:`Address`, :obj:`Register`, :obj:`Scalar`, or
        :obj:`VariableOffset`.
    ...
    def getOpRepresentationList(self, operandIndex: typing.Union[jpype.JInt, int], context: InstructionContext) -> java.util.ArrayList[java.lang.Object]:
        """
        ...
        Each element is one of :obj:`Address`, :obj:`Register`, :obj:`Scalar`,
        :obj:`VariableOffset`, :obj:`Character`, or null. This method may also return null (as in
    ...
    def getOpType(self, operandIndex: typing.Union[jpype.JInt, int], context: InstructionContext) -> int:
        """
    ...
    def getOperandRefType(self, operandIndex: typing.Union[jpype.JInt, int], context: InstructionContext, override: ghidra.program.model.pcode.PcodeOverride) -> ghidra.program.model.symbol.RefType:
        """
        ...
        :param jpype.JInt or int operandIndex: the 0-up index of the operand
        :param InstructionContext context: the instruction context
        :param ghidra.program.model.pcode.PcodeOverride override: if not null, steers local overrides of p-code generation
        """

    def getOperandValueMask(self, operandIndex: typing.Union[jpype.JInt, int]) -> Mask:
        """
        :return: the :obj:`Mask` that describe which bits of this instruction determine a specific
    ...
    def getParserContext(self, buf: ghidra.program.model.mem.MemBuffer, processorContext: ProcessorContextView) -> ParserContext:
        """
        :return: a new instance of an instruction :obj:`ParserContext`
        :rtype: ParserContext
        
        
        :param ghidra.program.model.mem.MemBuffer buf: the memory from which this prototype was parsed, or an equivalent cache
        :param ProcessorContextView processorContext: the (incoming) processor context during parse
        :raises MemoryAccessException: if the memory buffer cannot be accessed
        """
    ...
    def getPcode(self, context: InstructionContext, override: ghidra.program.model.pcode.PcodeOverride) -> jpype.JArray[ghidra.program.model.pcode.PcodeOp]:
        ...
        :param InstructionContext context: the instruction context
        :param ghidra.program.model.pcode.PcodeOverride override: if not null, may indicate that different elements of the pcode generation are
                    overridden
        """

    @typing.overload
    def getPcode(self, context: InstructionContext, operandIndex: typing.Union[jpype.JInt, int]) -> jpype.JArray[ghidra.program.model.pcode.PcodeOp]:
        """
    ...
    def getPcodePacked(self, encoder: ghidra.program.model.pcode.PatchEncoder, context: InstructionContext, override: ghidra.program.model.pcode.PcodeOverride) -> None:
        """
        Does the same as :meth:`getPcode(InstructionContext, PcodeOverride) <.getPcode>` but emits the
    ...
    def getPseudoParserContext(self, address: ghidra.program.model.address.Address, buffer: ghidra.program.model.mem.MemBuffer, processorContext: ProcessorContextView) -> ParserContext:
        """
        :return: a ParserContext by parsing bytes outside of the normal disassembly process
        :rtype: ParserContext
        
        
        :param ghidra.program.model.address.Address address: where the ParserContext is needed, i.e., the first address of an instruction
                    to be parsed
        :param ghidra.program.model.mem.MemBuffer buffer: of actual bytes
        :param ProcessorContextView processorContext: the (incoming) processor context
        :raises InsufficientBytesException: if not enough bytes are in the buffer
        :raises UnknownInstructionException: if the bytes do not constitute a valid instruction
        :raises UnknownContextException: if contextual dependencies, e.g. ``crossbuild``
                    instructions, are not available
        :raises MemoryAccessException: if the memory buffer cannot be accessed
        """

    def getRegister(self, operandIndex: typing.Union[jpype.JInt, int], context: InstructionContext) -> Register:
        """
        :return: the :obj:`Register` value of a specific operand, or null if its value is not an
        :obj:`Register`
        :rtype: Register
    ...
    def getScalar(self, operandIndex: typing.Union[jpype.JInt, int], context: InstructionContext) -> ghidra.program.model.scalar.Scalar:
        """
        :return: the :obj:`Scalar` value of a specific operand, or null if its value is not an
        :obj:`Scalar`
    ...
    def getSeparator(self, operandIndex: typing.Union[jpype.JInt, int]) -> str:
        ...
        In particular, the separator string for operand 0 are the characters *before* the
        first operand. The separator string for ``numOperands`` are the characters *after*
        the last operand. A null return value is equivalent to an empty string.
        
        :param jpype.JInt or int operandIndex: valid values are 0 thru ``numOperands``, inclusive
        """

    def hasCrossBuildDependency(self) -> bool:
        """
        :return: true if instruction semantics have a ``crossbuild`` instruction dependency which
        may require a robust :obj:`InstructionContext` with access to preceding instructions
        :rtype: bool
        """
    ...
    def hasDelimeter(self, operandIndex: typing.Union[jpype.JInt, int]) -> bool:
        """
    ...
    def hasNext2Dependency(self) -> bool:
        """
        :return: true if instruction semantics contain a reference to ``inst_next2``
        :rtype: bool
        .
        """
...
class AddressLabelInfo(java.lang.Comparable[AddressLabelInfo]):
    ...
    def __init__(self, addr: ghidra.program.model.address.Address, sizeInBytes: typing.Union[java.lang.Integer, int], label: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], isPrimary: typing.Union[jpype.JBoolean, bool], isEntry: typing.Union[jpype.JBoolean, bool], type: ghidra.program.model.util.ProcessorSymbolType, isVolatile: typing.Union[java.lang.Boolean, bool]) -> None:
        ...
        :raises AddressOverflowException: if sizeInBytes cause an overflow relative to address
        :raises InvalidInputException: if an invalid label name is specified
        """
...
class CompilerSpecNotFoundException(java.io.IOException):
    ...
    @typing.overload
    def __init__(self, languageId: LanguageID, compilerSpecID: CompilerSpecID) -> None:
        ...

    @typing.overload
    def __init__(self, languageId: LanguageID, compilerSpecID: CompilerSpecID, resourceFileName: typing.Union[java.lang.String, str], e: java.lang.Throwable) -> None:
        ...
...
class LanguageNotFoundException(java.io.IOException):
    ...
    @typing.overload
    def __init__(self, languageID: LanguageID, majorVersion: typing.Union[jpype.JInt, int], minorVersion: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, languageID: LanguageID) -> None:
        """
        Language not found
    ...
    @typing.overload
    def __init__(self, languageID: LanguageID, msg: typing.Union[java.lang.String, str]) -> None:
        """
        Language not found
...
class LanguageVersionException(ghidra.util.exception.VersionException):
    ...
    @typing.overload
    def __init__(self, msg: typing.Union[java.lang.String, str], upgradable: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, oldLanguage: Language, languageTranslator: ghidra.program.util.LanguageTranslator) -> None:
        """
...
class InstructionSet(java.lang.Iterable[InstructionBlock]):
    ...
    def addBlock(self, block: InstructionBlock) -> None:
        """
...
class InstructionBlock(java.lang.Iterable[ghidra.program.model.listing.Instruction]):
    ...
    def __init__(self, startAddr: ghidra.program.model.address.Address) -> None:
        ...

    def addBlockFlow(self, blockFlow: InstructionBlockFlow) -> None:
        """
    ...
    def setCodeUnitConflict(self, codeUnitAddr: ghidra.program.model.address.Address, newInstrAddr: ghidra.program.model.address.Address, flowFromAddr: ghidra.program.model.address.Address, isInstruction: typing.Union[jpype.JBoolean, bool], isOffcut: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setInstructionError(self, type: InstructionError.InstructionErrorType, intendedInstructionAddress: ghidra.program.model.address.Address, conflictAddress: ghidra.program.model.address.Address, flowFromAddress: ghidra.program.model.address.Address, message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setInstructionMemoryError(self, instrAddr: ghidra.program.model.address.Address, flowFromAddr: ghidra.program.model.address.Address, errorMsg: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setInstructionsAddedCount(self, count: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setParseConflict(self, conflictAddress: ghidra.program.model.address.Address, contextValue: RegisterValue, flowFromAddress: ghidra.program.model.address.Address, message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setStartOfFlow(self, isStart: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class InstructionBlockFlow(java.lang.Comparable[InstructionBlockFlow]):
    ...
    def __init__(self, address: ghidra.program.model.address.Address, flowFrom: ghidra.program.model.address.Address, type: InstructionBlockFlow.Type) -> None:
        ...
...
class Mask(java.lang.Object):
    ...
    @typing.overload
    def applyMask(self, cde: jpype.JArray[jpype.JByte], cdeOffset: typing.Union[jpype.JInt, int], results: jpype.JArray[jpype.JByte], resultsOffset: typing.Union[jpype.JInt, int]) -> None:
        """
        Apply the mask to a byte array.
...
class InjectPayloadSleigh(InjectPayload):
    ...
    def __init__(self, nm: typing.Union[java.lang.String, str], tp: typing.Union[jpype.JInt, int], sourceName: typing.Union[java.lang.String, str]) -> None:
        """
...
class ConstantPool(java.lang.Object):
    ...
    class Record(java.lang.Object):
        ...
        def encode(self, encoder: ghidra.program.model.pcode.Encoder, ref: typing.Union[jpype.JLong, int], dtmanage: ghidra.program.model.pcode.PcodeDataTypeManager) -> None:
            ...

        def setUTF8Data(self, val: typing.Union[java.lang.String, str]) -> None:
            ...
...
class BasicCompilerSpecDescription(CompilerSpecDescription):
    ...
    def __init__(self, id: CompilerSpecID, name: typing.Union[java.lang.String, str]) -> None:
        ...
...
class BasicCompilerSpec(CompilerSpec):
    ...
    @typing.overload
    def __init__(self, description: CompilerSpecDescription, language: ghidra.app.plugin.processors.sleigh.SleighLanguage, stream: java.io.InputStream) -> None:
        """
    ...
    @typing.overload
    def __init__(self, description: CompilerSpecDescription, language: ghidra.app.plugin.processors.sleigh.SleighLanguage, cspecFile: generic.jar.ResourceFile) -> None:
        """
    ...
    @typing.overload
    def __init__(self, op2: BasicCompilerSpec) -> None:
        """
...
class RegisterBuilder(java.lang.Object):
    ...
    @typing.overload
    def addRegister(self, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], address: ghidra.program.model.address.Address, numBytes: typing.Union[jpype.JInt, int], bigEndian: typing.Union[jpype.JBoolean, bool], typeFlags: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class BasicLanguageDescription(LanguageDescription):
    ...
    @typing.overload
    def __init__(self, id: LanguageID, processor: Processor, endian: Endian, instructionEndian: Endian, size: typing.Union[jpype.JInt, int], variant: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], version: typing.Union[jpype.JInt, int], minorVersion: typing.Union[jpype.JInt, int], deprecated: typing.Union[jpype.JBoolean, bool], compilerSpec: CompilerSpecDescription, externalNames: collections.abc.Mapping) -> None:
        ...

    @typing.overload
    def __init__(self, id: LanguageID, processor: Processor, endian: Endian, instructionEndian: Endian, size: typing.Union[jpype.JInt, int], variant: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], version: typing.Union[jpype.JInt, int], minorVersion: typing.Union[jpype.JInt, int], deprecated: typing.Union[jpype.JBoolean, bool], compilerSpecs: java.util.List[CompilerSpecDescription], externalNames: collections.abc.Mapping) -> None:
        ...
...
class ContextSetting(java.lang.Object):
    ...
    def __init__(self, register: Register, value: java.math.BigInteger, startAddr: ghidra.program.model.address.Address, endAddr: ghidra.program.model.address.Address) -> None:
        ...
    ...
    @staticmethod
    def encodeContextData(encoder: ghidra.program.model.pcode.Encoder, ctxList: java.util.List[ContextSetting]) -> None:
        ...
    ...
    @staticmethod
    def parseContextData(resList: java.util.List[ContextSetting], parser: ghidra.xml.XmlPullParser, cspec: CompilerSpec) -> None:
        ...

    @staticmethod
    def parseContextSet(resList: java.util.List[ContextSetting], parser: ghidra.xml.XmlPullParser, cspec: CompilerSpec) -> None:
        ...
...
class RegisterManager(java.lang.Object):
    ...
    class RegisterSizeKey(java.lang.Object):
        ...
        def __init__(self, addr: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> None:
            ...
...
class LanguageCompilerSpecPair(java.lang.Comparable[LanguageCompilerSpecPair]):
    ...
    @typing.overload
    def __init__(self, languageID: typing.Union[java.lang.String, str], compilerSpecID: typing.Union[java.lang.String, str]) -> None:
        """
...
class LanguageCompilerSpecQuery(java.lang.Object):
    ...
    def __init__(self, processor: Processor, endian: Endian, size: typing.Union[java.lang.Integer, int], variant: typing.Union[java.lang.String, str], compilerSpecID: CompilerSpecID) -> None:
        """
...
class ExternalLanguageCompilerSpecQuery(java.lang.Object):
    ...
    def __init__(self, externalProcessorName: typing.Union[java.lang.String, str], externalTool: typing.Union[java.lang.String, str], endian: Endian, size: typing.Union[java.lang.Integer, int], compilerSpecID: CompilerSpecID) -> None:
        ...
...
class DisassemblerContext(ProcessorContext):
    ...
    @typing.overload
    def setFutureRegisterValue(self, address: ghidra.program.model.address.Address, value: RegisterValue) -> None:
        """
    ...
    @typing.overload
    def setFutureRegisterValue(self, fromAddr: ghidra.program.model.address.Address, toAddr: ghidra.program.model.address.Address, value: RegisterValue) -> None:
        """
        Combines ``value`` with any previously saved future
...
class DynamicVariableStorage(ghidra.program.model.listing.VariableStorage):
    ...
    @typing.overload
    def __init__(self, program: ProgramArchitecture, autoParamType: ghidra.program.model.listing.AutoParameterType, address: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ProgramArchitecture, autoParamType: ghidra.program.model.listing.AutoParameterType, *varnodes: ghidra.program.model.pcode.Varnode) -> None:
        """
        Construct dynamic variable storage with an optional auto-parameter type
    ...
    @typing.overload
    def __init__(self, program: ProgramArchitecture, forcedIndirect: typing.Union[jpype.JBoolean, bool], address: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ProgramArchitecture, forcedIndirect: typing.Union[jpype.JBoolean, bool], *varnodes: ghidra.program.model.pcode.Varnode) -> None:
        """
        Construct dynamic variable storage
...
class GhidraLanguagePropertyKeys(java.lang.Object):
    ...
    class_: typing.ClassVar[java.lang.Class]
    MAXIMUM_INSTRUCTION_LENGTH: typing.Final = "maximumInstructionLength"
    """
    ...
    by :obj:`PseudoInstruction` in support of Sleigh ``inst_next2`` processing.  If
    not specified a computed estimate is used by each instruction parse.  If the
    Sleigh ``inst_next2`` instruction is used with variable length instructions, it
    is highly recommended that this property be specified.
     
    NOTE: It is the language (i.e., ``slaspec/pspec``) author who needs to manually 
    ...
    NOTE: This property is currently only used by Ghidra when ``inst_next2`` is used 
    within the correspond ``slaspec``.
    """
    ...
    USEROP_LIBS: typing.Final = "useropLibs"
    """
    USEROP_LIBS is a string property that indicates keys for matching one or more
    ``PcodeUseropLibaryFactory``s, which will be composed to form the library of custom
    userop implementations available to an emulator. The default is empty. NOTE: This is
    *not* the name of a class, but a comma-separated list of IDs. Each factory is also
...
class InjectPayloadCallfixup(InjectPayloadSleigh):
    ...
    def __init__(self, sourceName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class InjectPayloadCallfixupError(InjectPayloadCallfixup):
    ...
    @typing.overload
    def __init__(self, addrFactory: ghidra.program.model.address.AddressFactory, failedPayload: InjectPayloadCallfixup) -> None:
        ...

    @typing.overload
    def __init__(self, addrFactory: ghidra.program.model.address.AddressFactory, nm: typing.Union[java.lang.String, str]) -> None:
        ...
...
class InjectPayloadCallotherError(InjectPayloadCallother):
    ...
    @typing.overload
    def __init__(self, addrFactory: ghidra.program.model.address.AddressFactory, failedPayload: InjectPayloadCallother) -> None:
        """
...
class InjectPayloadJumpAssist(InjectPayloadSleigh):
    ...
    def __init__(self, bName: typing.Union[java.lang.String, str], sourceName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class InjectPayloadSegment(InjectPayloadSleigh):
    ...
    def __init__(self, source: typing.Union[java.lang.String, str]) -> None:
        ...
...
class MaskImpl(Mask, java.io.Serializable):
    ...
    def __init__(self, msk: jpype.JArray[jpype.JByte]) -> None:
        """
...
class ParamEntry(java.lang.Object):
    ...
    def __init__(self, grp: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    @typing.overload
    def getAddrBySlot(self, slotnum: typing.Union[jpype.JInt, int], sz: typing.Union[jpype.JInt, int], typeAlign: typing.Union[jpype.JInt, int], res: ParameterPieces, justifyRight: typing.Union[jpype.JBoolean, bool]) -> int:
        """
        Assign the storage address when allocating something of size -sz- assuming -slotnum- slots
        have already been assigned.  Set the address to null if the -sz- is too small or if
        there are not enough slots left
        ...
        :param jpype.JInt or int typeAlign: required byte alignment for the parameter
        :param ParameterPieces res: will hold the final storage address
        :param jpype.JBoolean or bool justifyRight: true if initial bytes are padding for odd data-type sizes
        :return: slotnum plus the number of slots used
        :rtype: int
        """
    ...
    @staticmethod
    def orderWithinGroup(entry1: ParamEntry, entry2: ParamEntry) -> None:
        """
    ...
    def restoreXml(self, parser: ghidra.xml.XmlPullParser, cspec: CompilerSpec, curList: java.util.List[ParamEntry], grouped: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class PcodeParser(ghidra.pcodeCPort.slgh_compile.PcodeCompile):
    ...
    class PcodeTranslate(ghidra.pcodeCPort.sleighbase.SleighBase):
        ...
        def __init__(self, language: ghidra.app.plugin.processors.sleigh.SleighLanguage, ubase: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    def addOperand(self, loc: ghidra.sleigh.grammar.Location, name: typing.Union[java.lang.String, str], index: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ProcessorNotFoundException(java.lang.RuntimeException):
    ...
    def __init__(self, processorName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ProgramProcessorContext(ProcessorContext):
    ...
    def __init__(self, context: ghidra.program.model.listing.ProgramContext, addr: ghidra.program.model.address.Address) -> None:
        """
...
class PrototypeModelError(PrototypeModel):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], copyModel: PrototypeModel) -> None:
        ...
...
class PrototypeModelMerged(PrototypeModel):
    ...
    class ScoreProtoModel(java.lang.Object):
        ...
        def __init__(self, isinput: typing.Union[jpype.JBoolean, bool], mod: PrototypeModel, numparam: typing.Union[jpype.JInt, int]) -> None:
            ...

        def addParameter(self, addr: ghidra.program.model.address.Address, sz: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def restoreXml(self, parser: ghidra.xml.XmlPullParser, modelList: java.util.List[PrototypeModel]) -> None:
        ...
...
class ReadOnlyProcessorContext(ProcessorContext):
    ...
    def __init__(self, context: ProcessorContextView) -> None:
        ...
...
class RegisterTranslator(java.lang.Object):
    ...
    def __init__(self, oldLang: Language, newLang: Language) -> None:
        ...
...
class RegisterTree(java.lang.Comparable[RegisterTree]):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], regs: jpype.JArray[Register]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], tree: RegisterTree) -> None:
        """
    ...
    def add(self, tree: RegisterTree) -> None:
        """
    ...
    def remove(self, reg: Register) -> None:
        """
...
__all__ = ["ProgramArchitecture", "PrototypeModel", "ParamList", "InputListType", "PrototypePieces", "ParameterPieces", "InjectPayload", "PcodeInjectLibrary", "CompilerSpec", "Language", "CompilerSpecDescription", "CompilerSpecID", "Register", "DecompilerLanguage", "RegisterValue", "LanguageID", "LanguageDescription", "ParallelInstructionLanguageHelper", "Processor", "ProcessorContext", "ProcessorContextView", "InstructionPrototype", "InsufficientBytesException", "UnknownInstructionException", "AddressLabelInfo", "CompilerSpecNotFoundException", "LanguageNotFoundException", "InstructionError", "LanguageVersionException", "Endian", "InstructionSet", "InstructionBlock", "InstructionContext", "ParserContext", "UnknownContextException", "InstructionBlockFlow", "Mask", "IncompatibleMaskException", "InjectPayloadSleigh", "InjectContext", "ConstantPool", "BasicCompilerSpecDescription", "BasicCompilerSpec", "RegisterBuilder", "SleighLanguageDescription", "BasicLanguageDescription", "ContextSetting", "RegisterManager", "LanguageCompilerSpecPair", "LanguageService", "LanguageCompilerSpecQuery", "ExternalLanguageCompilerSpecQuery", "DisassemblerContext", "DataTypeProviderContext", "LanguageProvider", "NestedDelaySlotException", "UndefinedValueException", "DisassemblerContextAdapter", "DynamicVariableStorage", "GhidraLanguagePropertyKeys", "InjectPayloadCallfixup", "InjectPayloadCallfixupError", "InjectPayloadCallother", "InjectPayloadCallotherError", "InjectPayloadJumpAssist", "InjectPayloadSegment", "InvalidPrototype", "MaskImpl", "OldLanguageMappingService", "OperandType", "ParamEntry", "StorageClass", "ParamListRegisterOut", "ParamListStandardOut", "ParamListStandard", "PcodeParser", "ProcessorContextImpl", "ProcessorNotFoundException", "ProgramProcessorContext", "PrototypeModelError", "PrototypeModelMerged", "ReadOnlyProcessorContext", "RegisterTranslator", "RegisterTree", "SpaceNames", "UnknownDataException", "UnknownRegister", "VersionedLanguageService"]
