...
class ReferenceListingHover(ghidra.app.plugin.core.hover.AbstractReferenceHover, ListingHoverService):
    ...
    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, codeFormatSvc: ghidra.app.services.CodeFormatService) -> None:
        ...
...
__all__ = ["ReferenceListingHover", "ListingHoverService", "DataTypeListingHover", "TruncatedTextListingHover", "LabelListingHover", "DataTypeListingHoverPlugin", "FunctionSignatureListingHover", "FunctionSignatureListingHoverPlugin", "LabelListingHoverPlugin", "ProgramAddressRelationshipListingHover", "ProgramAddressRelationshipListingHoverPlugin", "ReferenceListingHoverPlugin", "ScalarOperandListingHover", "ScalarOperandListingHoverPlugin", "TruncatedTextListingHoverPlugin"]
