...
class GScheduledTask(java.lang.Comparable[GScheduledTask]):
    ...
    def __init__(self, group: GTaskGroup, task: GTask, priority: typing.Union[jpype.JInt, int]) -> None:
        """
...
class GTaskGroup(java.lang.Object):
    ...
    def __init__(self, description: typing.Union[java.lang.String, str], startNewTransaction: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class GTaskListener(java.lang.Object):
    ...
    def suspendedStateChanged(self, suspended: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def taskCompleted(self, task: GScheduledTask, result: GTaskResult) -> None:
        """
    ...
    def taskGroupCompleted(self, taskGroup: GTaskGroup) -> None:
        """
    ...
    def taskGroupScheduled(self, group: GTaskGroup) -> None:
        """
    ...
    def taskGroupStarted(self, taskGroup: GTaskGroup) -> None:
        """
    ...
    def taskScheduled(self, scheduledTask: GScheduledTask) -> None:
        """
    ...
    def taskStarted(self, task: GScheduledTask) -> None:
        """
...
class GTaskResult(java.lang.Object):
    ...
    def __init__(self, group: GTaskGroup, task: GScheduledTask, e: java.lang.Exception, transactionID: typing.Union[java.lang.Integer, int]) -> None:
        """
...
class GTaskManager(java.lang.Object):
    ...
    def __init__(self, domainObject: ghidra.framework.model.DomainObject, threadPool: generic.concurrent.GThreadPool) -> None:
        """
    ...
    def addTaskListener(self, listener: GTaskListener) -> None:
        """
    ...
    def cancelRunningGroup(self, group: GTaskGroup) -> None:
        """
    ...
    def removeTaskListener(self, listener: GTaskListener) -> None:
        """
    ...
    @typing.overload
    def scheduleTask(self, task: GTask, priority: typing.Union[jpype.JInt, int], groupName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def scheduleTaskGroup(self, group: GTaskGroup) -> None:
        """
    ...
    def setSuspended(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class GTaskManagerPanel(javax.swing.JPanel):
    ...
    def __init__(self, taskMgr: GTaskManager) -> None:
        ...
    ...
    def showResultPanel(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class MulticastTaskListener(GTaskListener):
    ...
    def __init__(self, a: GTaskListener, b: GTaskListener) -> None:
        ...
...
__all__ = ["GScheduledTask", "GTask", "GTaskGroup", "GTaskMonitor", "GTaskListener", "GTaskResult", "GTaskListenerAdapter", "GTaskManager", "GTaskManagerFactory", "GTaskManagerPanel", "MulticastTaskListener"]
