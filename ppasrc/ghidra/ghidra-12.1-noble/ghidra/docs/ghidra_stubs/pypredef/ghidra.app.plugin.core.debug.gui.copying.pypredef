...
class DebuggerCopyPlan(java.lang.Object):
    ...
    class Copier(java.lang.Object):
        ...
        def copy(self, from_: ghidra.trace.model.program.TraceProgramView, fromRange: ghidra.program.model.address.AddressRange, into: ghidra.program.model.listing.Program, intoAddress: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> None:
            ...
    ...
    def execute(self, from_: ghidra.trace.model.program.TraceProgramView, fromRange: ghidra.program.model.address.AddressRange, into: ghidra.program.model.listing.Program, intoAddress: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
    ...
    def syncCopiersEnabled(self, from_: ghidra.trace.model.program.TraceProgramView, dest: ghidra.program.model.listing.Program) -> None:
        ...
...
class DebuggerCopyIntoProgramDialog(docking.ReusableDialogComponentProvider):
    ...
    class RangeEntry(java.lang.Object):
        ...
        def setBlockName(self, blockName: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class CopyDestination(java.lang.Object):
        ...
        def saveIfApplicable(self, program: ghidra.program.model.listing.Program) -> None:
            ...
    ...
    def setCapture(self, capture: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def setDestination(self, program: ghidra.program.model.listing.Program) -> None:
        ...

    @typing.overload
    def setDestination(self, dest: DebuggerCopyIntoProgramDialog.CopyDestination) -> None:
        ...

    def setProgramManager(self, programManager: ghidra.app.services.ProgramManager) -> None:
        ...

    def setRelocate(self, relocate: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setSource(self, source: ghidra.trace.model.program.TraceProgramView, set: ghidra.program.model.address.AddressSetView) -> None:
        ...

    def setStaticMappingService(self, staticMappingService: ghidra.app.services.DebuggerStaticMappingService) -> None:
        ...

    def setTargetService(self, targetService: ghidra.app.services.DebuggerTargetService) -> None:
        ...

    def setUseOverlays(self, useOverlays: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["DebuggerCopyActionsPlugin", "DebuggerCopyPlan", "DebuggerCopyIntoProgramDialog"]
