...
class DisconnectedSymbolTreeProvider(SymbolTreeProvider):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, plugin: SymbolTreePlugin, program: ghidra.program.model.listing.Program) -> None:
        ...
...
class SymbolTreeProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, plugin: SymbolTreePlugin) -> None:
        ...
    ...
    def selectSymbol(self, symbol: ghidra.program.model.symbol.Symbol) -> None:
        ...

    def setClipboardContents(self, symbolTreeNodeTransferable: docking.widgets.tree.support.GTreeNodeTransferable) -> None:
        ...
...
class SymbolTreePlugin(ghidra.framework.plugintool.Plugin, SymbolTreeService):
    ...
    @typing.overload
    def goTo(self, symbol: ghidra.program.model.symbol.Symbol) -> None:
        ...

    @typing.overload
    def goTo(self, extLoc: ghidra.program.model.symbol.ExternalLocation) -> None:
        ...
...
class SymbolGTree(docking.widgets.tree.GTree):
    ...
    def __init__(self, root: docking.widgets.tree.GTreeNode, plugin: SymbolTreePlugin) -> None:
        ...
...
class EditExternalLocationDialog(docking.DialogComponentProvider):
    ...
    @typing.overload
    def __init__(self, externalLocation: ghidra.program.model.symbol.ExternalLocation) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, externalLibraryName: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["DisconnectedSymbolTreeProvider", "SymbolTreeProvider", "SymbolTreePlugin", "SymbolTreeService", "SymbolCategory", "SymbolGTree", "EditExternalLocationDialog", "EditExternalLocationPanel", "SymbolGTreeDragNDropHandler", "SymbolTreeActionContext"]
