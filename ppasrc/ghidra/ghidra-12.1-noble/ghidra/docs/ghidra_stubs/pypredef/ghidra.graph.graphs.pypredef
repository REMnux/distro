...
class FilteringVisualGraph(DefaultVisualGraph[V, E], typing.Generic[V, E]):
    ...
    * 
    ...
    def filterEdges(self, toFilter: collections.abc.Sequence) -> None:
        ...

    def filterVertices(self, toFilter: collections.abc.Sequence) -> None:
        ...
    ...
    def unfilterEdges(self, toUnfilter: collections.abc.Sequence) -> None:
        """
    ...
    def unfilterVertices(self, toUnfilter: collections.abc.Sequence) -> None:
        """
...
__all__ = ["DefaultVisualGraph", "JungDirectedVisualGraph", "FilteringVisualGraph", "GroupingVisualGraph"]
