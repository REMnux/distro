...
class ByteMappingScheme(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, mappedByteCount: typing.Union[jpype.JInt, int], mappedSourceByteCount: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, mappingScheme: typing.Union[java.lang.String, str]) -> None:
        """
        Construct byte mapping scheme specified as a ratio of mapped bytes to source bytes.
...
class FileBytes(java.lang.Object):
    ...
    def __init__(self, adapter: FileBytesAdapter, record: db.DBRecord) -> None:
        ...
...
class MemoryMapDB(ghidra.program.model.mem.Memory, ghidra.program.database.ManagerDB):
    ...
    def __init__(self, handle: db.DBHandle, addrMap: ghidra.program.database.map.AddressMapDB, openMode: ghidra.framework.data.OpenMode, isBigEndian: typing.Union[jpype.JBoolean, bool], lock: ghidra.util.Lock, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class AddressSourceInfo(java.lang.Object):
    ...
    def __init__(self, memory: ghidra.program.model.mem.Memory, address: ghidra.program.model.address.Address, block: ghidra.program.model.mem.MemoryBlock) -> None:
        ...
...
class SubMemoryBlock(java.lang.Comparable[SubMemoryBlock]):
    ...
    def putByte(self, memBlockOffset: typing.Union[jpype.JLong, int], b: typing.Union[jpype.JByte, int]) -> None:
        """
...
class MemoryMapDBAdapterV3(MemoryMapDBAdapter):
    ...
    def __init__(self, handle: db.DBHandle, memMap: MemoryMapDB, maxSubBlockSize: typing.Union[jpype.JLong, int], create: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["ByteMappingScheme", "FileBytes", "FileBytesAdapter", "MemoryMapDB", "MemoryMapDBAdapter", "MemoryBlockDB", "AddressSourceInfo", "SubMemoryBlock", "BitMappedSubMemoryBlock", "BufferSubMemoryBlock", "ByteMappedSubMemoryBlock", "FileBytesAdapterNoTable", "FileBytesAdapterV0", "FileBytesSubMemoryBlock", "MemoryBlockInputStream", "MemoryBlockSourceInfoDB", "MemoryMapDBAdapterV0", "MemoryMapDBAdapterV1", "MemoryMapDBAdapterV2", "MemoryMapDBAdapterV3", "UninitializedSubMemoryBlock"]
