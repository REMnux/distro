...
class VertexMouseInfo(java.lang.Object, typing.Generic[V, E]):
    ...
    def __init__(self, originalMouseEvent: java.awt.event.MouseEvent, vertex: V, vertexBasedClickPoint: java.awt.geom.Point2D, viewer: ghidra.graph.viewer.GraphViewer[V, E]) -> None:
        ...
    ...
    def getVertexRelativeClickPoint(self) -> java.awt.geom.Point2D:
        ...
    ...
    def selectVertex(self, addToSelection: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @property
    def vertexRelativeClickPoint(self) -> java.awt.geom.Point2D:
        ...
...
class JungPickingGraphMousePlugin(edu.uci.ics.jung.visualization.control.AbstractGraphMousePlugin, java.awt.event.MouseListener, java.awt.event.MouseMotionListener, typing.Generic[V, E]):
    ...
    @typing.overload
    def __init__(self, selectionModifiers: typing.Union[jpype.JInt, int], addToSelectionModifiers: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setLocked(self, locked: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class VisualGraphAbstractGraphMousePlugin(edu.uci.ics.jung.visualization.control.AbstractGraphMousePlugin, java.awt.event.MouseListener, java.awt.event.MouseMotionListener, VisualGraphMousePlugin[V, E], typing.Generic[V, E]):
    ...
    * We clear state on mouseReleased() and mouseExited(), since we will get 
    ...
    @typing.overload
    def __init__(self, selectionModifiers: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class VisualGraphEventForwardingGraphMousePlugin(edu.uci.ics.jung.visualization.control.AbstractGraphMousePlugin, java.awt.event.MouseListener, java.awt.event.MouseMotionListener, VisualGraphMousePlugin[V, E], typing.Generic[V, E]):
    ...
    @typing.overload
    def __init__(self, modifiers: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class VisualGraphHoverMousePlugin(edu.uci.ics.jung.visualization.control.AbstractGraphMousePlugin, java.awt.event.MouseMotionListener, java.awt.event.MouseListener, VisualGraphMousePlugin[V, E], typing.Generic[V, E]):
    ...
    def __init__(self, graphComponent: ghidra.graph.viewer.GraphComponent[V, E, typing.Any], viewer: edu.uci.ics.jung.visualization.VisualizationViewer[V, E], otherViewer: edu.uci.ics.jung.visualization.VisualizationViewer[V, E]) -> None:
        ...
...
class VisualGraphMouseTrackingGraphMousePlugin(edu.uci.ics.jung.visualization.control.AbstractGraphMousePlugin, java.awt.event.MouseListener, java.awt.event.MouseMotionListener, VisualGraphMousePlugin[V, E], typing.Generic[V, E]):
    ...
    def __init__(self, viewer: ghidra.graph.viewer.GraphViewer[V, E]) -> None:
        ...
...
__all__ = ["VertexTooltipProvider", "VisualGraphPluggableGraphMouse", "VertexMouseInfo", "VisualGraphMousePlugin", "JungPickingGraphMousePlugin", "VisualGraphAbstractGraphMousePlugin", "VisualGraphAnimatedPickingGraphMousePlugin", "VisualGraphCursorRestoringGraphMousePlugin", "VisualGraphEdgeSelectionGraphMousePlugin", "VisualGraphEventForwardingGraphMousePlugin", "VisualGraphHoverMousePlugin", "VisualGraphMouseTrackingGraphMousePlugin", "VisualGraphPickingGraphMousePlugin", "VisualGraphPopupMousePlugin", "VisualGraphSatelliteAbstractGraphMousePlugin", "VisualGraphSatelliteGraphMouse", "VisualGraphSatelliteNavigationGraphMousePlugin", "VisualGraphSatelliteScalingGraphMousePlugin", "VisualGraphSatelliteTranslatingGraphMousePlugin", "VisualGraphScalingGraphMousePlugin", "VisualGraphScreenPositioningPlugin", "VisualGraphScrollWheelPanningPlugin", "VisualGraphTranslatingGraphMousePlugin", "VisualGraphZoomingPickingGraphMousePlugin"]
