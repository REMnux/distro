...
class FormatManager(ghidra.framework.options.OptionsChangeListener):
    ...
    def __init__(self, displayOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> None:
        """
    ...
    def addFormatModelListener(self, listener: FormatModelListener) -> None:
        """
    ...
    def getFormatHighlightProvider(self) -> ghidra.app.util.ListingHighlightProvider:
        """
        Returns the :obj:`ListingHighlightProvider` that should be used when creating 
        :obj:`FieldFactory` objects.
        
        :return: the provider
        :rtype: ghidra.app.util.ListingHighlightProvider
        """
    ...
    def getQuickToggleFieldNames(self) -> java.util.List[java.lang.String]:
        """
    ...
    def modelChanged(self, model: FieldFormatModel) -> None:
        """
    ...
    def removeFormatModleListener(self, listener: FormatModelListener) -> None:
        """
    ...
    def setDefaultFormat(self, modelID: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def toggleField(self, name: typing.Union[java.lang.String, str]) -> None:
        """
        Toggle the enablement for the field with the given name.
        
        :param java.lang.String or str name: the of the field to toggle
        """
    ...
    @property
    def quickToggleFieldNames(self) -> java.util.List[java.lang.String]:
        ...
...
class FieldFormatModel(java.lang.Object):
    ...
    def addFactory(self, factory: ghidra.app.util.viewer.field.FieldFactory, rowIndex: typing.Union[jpype.JInt, int], colIndex: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def addLayouts(self, list: java.util.List[docking.widgets.fieldpanel.support.RowLayout], index: typing.Union[jpype.JInt, int], proxy: ghidra.app.util.viewer.proxy.ProxyObj[typing.Any]) -> None:
        """
    ...
    def addRow(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
        Adds new empty row at the given position.  The position must be in the
        interval [0,numRows].
        
        :param jpype.JInt or int index: the index to add a new row
    ...
    def getFactorys(self, row: typing.Union[jpype.JInt, int]) -> jpype.JArray[ghidra.app.util.viewer.field.FieldFactory]:
        ...
        :param jpype.JInt or int row: the row to factories for
    ...
    def getNumFactorys(self, row: typing.Union[jpype.JInt, int]) -> int:
        ...
        :param jpype.JInt or int row: the row to get the number of factories for
    ...
    def moveFactory(self, oldRowIndex: typing.Union[jpype.JInt, int], oldColIndex: typing.Union[jpype.JInt, int], newRowIndex: typing.Union[jpype.JInt, int], newColIndex: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeFactory(self, rowIndex: typing.Union[jpype.JInt, int], colIndex: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeRow(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def restoreFromXml(self, root: org.jdom2.Element) -> None:
        ...
        :param org.jdom2.Element root: the root XML element from which to get the format information.
        """
    ...
    def setBaseRowID(self, id: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def updateRow(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
...
class FormatModelListener(java.lang.Object):
    ...
    @deprecated("not used")
    def formatModelAdded(self, model: FieldFormatModel) -> None:
        """
    ...
    def formatModelChanged(self, model: FieldFormatModel) -> None:
        """
    ...
    @deprecated("not used")
    def formatModelRemoved(self, model: FieldFormatModel) -> None:
        """
...
class Row(java.lang.Object):
    ...
    def addField(self, ff: ghidra.app.util.viewer.field.FieldFactory) -> None:
        ...

    def displayOptionsChanged(self, options: ghidra.framework.options.Options, name: typing.Union[java.lang.String, str], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        ...

    def fieldOptionsChanged(self, options: ghidra.framework.options.Options, name: typing.Union[java.lang.String, str], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        ...
    ...
    def insertField(self, ff: ghidra.app.util.viewer.field.FieldFactory, colIndex: typing.Union[jpype.JInt, int]) -> None:
        ...

    def layoutFields(self) -> None:
        ...
...
class FieldHeader(javax.swing.JTabbedPane, javax.swing.event.ChangeListener):
    ...
    def __init__(self, formatMgr: FormatManager, scroller: docking.widgets.indexedscrollpane.IndexedScrollPane, panel: docking.widgets.fieldpanel.FieldPanel) -> None:
        """
    ...
    def setTabLock(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class FieldHeaderComp(javax.swing.JPanel):
    ...
    def __init__(self, headerPanel: FieldHeader, modelNumber: typing.Union[jpype.JInt, int]) -> None:
        """
...
class FieldHeaderLocation(java.lang.Object):
    ...
    def __init__(self, model: FieldFormatModel, factory: ghidra.app.util.viewer.field.FieldFactory, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int]) -> None:
        """
...
__all__ = ["FormatManager", "FieldFormatModel", "FormatModelListener", "Row", "FieldHeader", "FieldHeaderComp", "FieldHeaderLocation", "FieldFactoryNameMapper"]
