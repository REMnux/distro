...
class Version(java.io.Serializable):
    ...
    def __init__(self, version: typing.Union[jpype.JInt, int], createTime: typing.Union[jpype.JLong, int], user: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor.
...
class ItemCheckoutStatus(java.io.Serializable):
    ...
    def __init__(self, checkoutId: typing.Union[jpype.JLong, int], checkoutType: CheckoutType, user: typing.Union[java.lang.String, str], version: typing.Union[jpype.JInt, int], time: typing.Union[jpype.JLong, int], projectPath: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor.
...
class FileSystemListener(java.lang.Object):
    ...
    def folderCreated(self, parentPath: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def folderDeleted(self, parentPath: typing.Union[java.lang.String, str], folderName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def folderMoved(self, parentPath: typing.Union[java.lang.String, str], folderName: typing.Union[java.lang.String, str], newParentPath: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def folderRenamed(self, parentPath: typing.Union[java.lang.String, str], oldFolderName: typing.Union[java.lang.String, str], newFolderName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def itemChanged(self, parentPath: typing.Union[java.lang.String, str], itemName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def itemCreated(self, parentPath: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def itemDeleted(self, folderPath: typing.Union[java.lang.String, str], itemName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def itemMoved(self, parentPath: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], newParentPath: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def itemRenamed(self, folderPath: typing.Union[java.lang.String, str], oldItemName: typing.Union[java.lang.String, str], newItemName: typing.Union[java.lang.String, str]) -> None:
        """
...
class DataFileHandle(java.lang.Object):
    ...
    @typing.overload
    def read(self, b: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    @typing.overload
    def read(self, b: jpype.JArray[jpype.JByte], off: typing.Union[jpype.JInt, int], len: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def seek(self, pos: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setLength(self, newLength: typing.Union[jpype.JLong, int]) -> None:
        """
...
class FolderItem(java.lang.Object):
    ...
    def delete(self, version: typing.Union[jpype.JInt, int], user: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def output(self, outputFile: jpype.protocol.SupportsPath, version: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def setCheckout(self, checkoutId: typing.Union[jpype.JLong, int], exclusive: typing.Union[jpype.JBoolean, bool], checkoutVersion: typing.Union[jpype.JInt, int], localVersion: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setContentTypeVersion(self, version: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def terminateCheckout(self, checkoutId: typing.Union[jpype.JLong, int], notify: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def updateCheckoutVersion(self, checkoutId: typing.Union[jpype.JLong, int], checkoutVersion: typing.Union[jpype.JInt, int], user: typing.Union[java.lang.String, str]) -> None:
        """
...
class FileSystem(java.lang.Object):
    ...
    def addFileSystemListener(self, listener: FileSystemListener) -> None:
        """
    ...
    def createFolder(self, parentPath: typing.Union[java.lang.String, str], folderName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def createTextDataItem(self, parentPath: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], fileID: typing.Union[java.lang.String, str], contentType: typing.Union[java.lang.String, str], textData: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str], user: typing.Union[java.lang.String, str]) -> TextDataItem:
        """
        ...
        :param java.lang.String or str comment: file comment (may be null, only used if versioning is enabled)
        :param java.lang.String or str user: name of user creating item (required for local versioned item)
        :return: new data file
        :rtype: TextDataItem
        :raises DuplicateFileException: Thrown if a folderItem with that name already exists.
        :raises InvalidNameException: if the name has illegal characters.
    ...
    def deleteFolder(self, folderPath: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def isSupportedItemType(self, folderItem: FolderItem) -> bool:
        """
        ...
        to a :obj:`LocalFileSystem` but may not be supported by a connected :obj:`RemoteFileSystem`.
        
        :param FolderItem folderItem: folder item
    ...
    def moveFolder(self, parentPath: typing.Union[java.lang.String, str], folderName: typing.Union[java.lang.String, str], newParentPath: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def moveItem(self, folderPath: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], newFolderPath: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
        ...
        :param java.lang.String or str newFolderPath: path of folder where item is to be moved to.
        :param java.lang.String or str newName: new item name to be applied
    ...
    @staticmethod
    def normalizePath(path: typing.Union[java.lang.String, str]) -> str:
        """
        ...
        :param java.lang.String or str path: absolute filesystem path which may contain "." or ".." path elements.
        :return: normalized path
        :rtype: str
        :raises java.lang.IllegalArgumentException: if an absolute path starting with :obj:`.SEPARATOR`
        was not specified or an illegal path was specified.
        """

    def removeFileSystemListener(self, listener: FileSystemListener) -> None:
        """
        Removes a file system listener from being notified of file system changes.
        
        :param FileSystemListener listener: file system listener
        """

    def renameFolder(self, parentPath: typing.Union[java.lang.String, str], folderName: typing.Union[java.lang.String, str], newFolderName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @property
    def supportedItemType(self) -> jpype.JBoolean:
        ...
...
class FileSystemEventManager(FileSystemListener):
    ...
    def __init__(self, enableAsynchronousDispatching: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
    ...
    def add(self, listener: FileSystemListener) -> None:
        """
    ...
    def remove(self, listener: FileSystemListener) -> None:
        """
...
class FileSystemSynchronizer(java.lang.Object):
    ...
    @staticmethod
    def setSynchronizing(b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class UnknownFolderItem(FolderItem):
    """
    ...
    def getFileType(self) -> int:
        ...
        * :obj:`FolderItem.DATABASE_FILE_TYPE`
        * :obj:`FolderItem.DATAFILE_FILE_TYPE`
        * :obj:`FolderItem.LINK_FILE_TYPE`
        
        
        :return: file type or :obj:`FolderItem.UNKNOWN_FILE_TYPE` (-1) if unknown
        :rtype: int
        """
...
__all__ = ["Version", "CheckoutType", "ItemCheckoutStatus", "FileSystemListener", "DataFileHandle", "DataFileItem", "FolderItem", "DatabaseItem", "ExclusiveCheckoutException", "FileIDFactory", "FileSystem", "TextDataItem", "FileSystemEventManager", "FileSystemInitializer", "FileSystemSynchronizer", "FolderNotEmptyException", "LockException", "UnknownFolderItem"]
