...
class ImagePanelDockingAction(docking.action.DockingAction):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], imagePanel: docking.widgets.imagepanel.ImagePanel) -> None:
        ...
...
class ResetTranslationAction(ImagePanelDockingAction):
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], imagePanel: docking.widgets.imagepanel.ImagePanel) -> None:
        ...
...
__all__ = ["ImagePanelDockingAction", "ResetTranslationAction", "SaveImageAction", "ZoomInAction", "ZoomOutAction", "ZoomResetAction"]
