...
class DemangledObject(Demangled):
    ...
    def setBackupPlateComment(self, plateComment: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setBasedName(self, basedName: typing.Union[java.lang.String, str]) -> None:
        ...

    def setConst(self, isConst: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setMemberScope(self, memberScope: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def setOriginalDemangled(self, originalDemangled: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setPointer64(self, isPointer64: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setRawDemangledString(self, s: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setSpecialPrefix(self, special: typing.Union[java.lang.String, str]) -> None:
        ...

    def setStatic(self, isStatic: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setStorageClass(self, storageClass: typing.Union[java.lang.String, str]) -> None:
        ...

    def setThunk(self, isThunk: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setUnaligned(self) -> None:
        ...

    def setVirtual(self, isVirtual: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setVisibilty(self, visibility: typing.Union[java.lang.String, str]) -> None:
        ...

    def setVolatile(self, isVolatile: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class Demangled(java.lang.Object):
    ...
    def setMangledContext(self, mangledContextArg: MangledContext) -> None:
        """
    ...
    def setNamespace(self, ns: Demangled) -> None:
        """
...
class DemanglerOptions(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, copy: DemanglerOptions) -> None:
        ...
    ...
    def setApplyCallingConvention(self, applyCallingConvention: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setApplySignature(self, applySignature: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setDemangleOnlyKnownPatterns(self, demangleOnlyKnownPatterns: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setDoDisassembly(self, doDisassembly: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DemangledException(java.lang.Exception):
    ...
    @typing.overload
    def __init__(self, invalidMangledName: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class MangledContext(java.lang.Object):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, options: DemanglerOptions, mangled: typing.Union[java.lang.String, str], address: ghidra.program.model.address.Address) -> None:
        """
...
class DemangledType(Demangled):
    ...
    def __init__(self, mangled: typing.Union[java.lang.String, str], originalDemangled: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def setTemplate(self, template: DemangledTemplate) -> None:
        ...
...
class DemangledTemplate(java.lang.Object):
    ...
    def addParameter(self, parameter: DemangledDataType) -> None:
        ...
...
class DemangledDataType(DemangledType):
    ...
    def __init__(self, mangled: typing.Union[java.lang.String, str], originaDemangled: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def setArray(self, dimensions: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    @typing.overload
    def setEnumType(self, enumType: typing.Union[java.lang.String, str]) -> None:
        ...
...
class AbstractDemangledFunctionDefinitionDataType(DemangledDataType):
    ...
    def setCallingConvention(self, callingConvention: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setModifier(self, modifier: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setReturnType(self, returnType: DemangledDataType) -> None:
        """
...
class DemangledAddressTable(DemangledObject):
    ...
    def __init__(self, mangled: typing.Union[java.lang.String, str], originalDemangled: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], calculateLength: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
...
class DemangledFunction(DemangledObject):
    ...
    def addParameter(self, parameter: DemangledParameter) -> None:
        ...

    def addParameters(self, params: java.util.List[DemangledParameter]) -> None:
        ...
    ...
    def setOverloadedOperator(self, isOverloadedOperator: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setTemplatedConstructorType(self, type: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setThrowAttribute(self, throwAttribute: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DemangledParameter(java.lang.Object):
    ...
    def __init__(self, type: DemangledDataType) -> None:
        """
...
class DemangledFunctionIndirect(AbstractDemangledFunctionDefinitionDataType):
    ...
    def __init__(self, mangled: typing.Union[java.lang.String, str], originalDemangled: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DemangledFunctionPointer(AbstractDemangledFunctionDefinitionDataType):
    ...
    def setDisplayDefaultFunctionPointerSyntax(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DemangledList(java.util.ArrayList[Demangled], Demangled):
    ...
    def __init__(self, demangledList: java.util.List[Demangled]) -> None:
        """
...
class DemangledString(DemangledObject):
    ...
    def __init__(self, mangled: typing.Union[java.lang.String, str], originalDemangled: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], string: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int], unicode: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DemangledStructure(DemangledDataType):
    ...
    class Field(java.lang.Record):
        ...
        def __init__(self, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], type: DemangledDataType) -> None:
            ...
    ...
    def __init__(self, mangled: typing.Union[java.lang.String, str], originalDemangled: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], categoryPath: typing.Union[java.lang.String, str], packed: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def addField(self, name: typing.Union[java.lang.String, str], type: DemangledDataType) -> None:
        """
    ...
    @typing.overload
    def addField(self, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], type: DemangledDataType) -> None:
        """
...
class DemangledThunk(DemangledObject):
    ...
    def __init__(self, mangled: typing.Union[java.lang.String, str], originalDemangled: typing.Union[java.lang.String, str], thunkedFunctionObject: DemangledFunction) -> None:
        ...

    def setCovariantReturnThunk(self) -> None:
        ...

    def setSignaturePrefix(self, prefix: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DemangledVariable(DemangledObject):
    ...
    def setDatatype(self, datatype: DemangledDataType) -> None:
        ...
...
__all__ = ["DemangledObject", "Demangled", "Demangler", "DemanglerOptions", "DemangledException", "MangledContext", "DemangledType", "DemangledTemplate", "DemangledDataType", "AbstractDemangledFunctionDefinitionDataType", "CharacterIterator", "DemangledAddressTable", "DemangledFunction", "DemangledParameter", "DemangledFunctionIndirect", "DemangledFunctionPointer", "DemangledFunctionReference", "DemangledLabel", "DemangledLambda", "DemangledList", "DemangledNamespaceNode", "DemangledString", "DemangledStructure", "DemangledThunk", "DemangledUnknown", "DemangledVariable", "DemanglerUtil"]
