...
class PcodeExecutorStatePiece(java.lang.Object, typing.Generic[A, T]):
    ...
    def checkRange(self, space: ghidra.program.model.address.AddressSpace, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def fork(self, cb: PcodeStateCallbacks) -> PcodeExecutorStatePiece[A, T]:
        """
        Create a deep copy of this state
        
        :param PcodeStateCallbacks cb: callbacks to receive emulation events
        :return: the copy
    ...
    @typing.overload
    def getNextEntryInternal(self, space: ghidra.program.model.address.AddressSpace, offset: A) -> java.util.Map.Entry[A, T]:
        """
        ...
        :return: the entry
        :rtype: java.util.Map.Entry[A, T]
        """

    @typing.overload
    def getNextEntryInternal(self, space: ghidra.program.model.address.AddressSpace, offset: typing.Union[jpype.JLong, int]) -> java.util.Map.Entry[java.lang.Long, T]:
        """
        ...
        *must* be for the given space. If no such entry exists, return ``null``.
        
        :param ghidra.program.model.address.AddressSpace space: the address space
        :param jpype.JLong or int offset: the offset within the space
        :return: the entry or null
        :rtype: java.util.Map.Entry[java.lang.Long, T]
        """
    ...
    @typing.overload
    def getVarInternal(self, space: ghidra.program.model.address.AddressSpace, offset: A, size: typing.Union[jpype.JInt, int], reason: PcodeExecutorStatePiece.Reason) -> T:
        """
    ...
    @typing.overload
    def getVarInternal(self, space: ghidra.program.model.address.AddressSpace, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], reason: PcodeExecutorStatePiece.Reason) -> T:
        """
        Get the value of a variable without issuing callbacks
    ...
    def inspectBigInteger(self, address: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> java.math.BigInteger:
        """
        Convenience to inspect the concrete value of a variable as a :obj:`BigInteger`
        
        :param ghidra.program.model.address.Address address: the address in memory
        :param jpype.JInt or int size: the number of bytes to inspect
        :return: the value
        :rtype: java.math.BigInteger
        :raises ConcretionError: if the value cannot be made concrete
        """

    def inspectByte(self, address: ghidra.program.model.address.Address) -> int:
        """
    ...
    def inspectConcrete(self, address: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> jpype.JArray[jpype.JByte]:
        """
    ...
    def inspectInt(self, address: ghidra.program.model.address.Address) -> int:
        """
    ...
    def inspectLong(self, address: ghidra.program.model.address.Address) -> int:
        """
    ...
    def inspectRegisterValue(self, register: ghidra.program.model.lang.Register) -> ghidra.program.model.lang.RegisterValue:
        """
        Convenience to inspect the concrete value of a register variable as a :obj:`RegisterValue`
    ...
    def inspectShort(self, address: ghidra.program.model.address.Address) -> int:
        """
    ...
    def setBigInteger(self, address: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int], value: java.math.BigInteger) -> None:
        """
        Convenience to set a variable to a concrete value as a :obj:`BigInteger`
        
        :param ghidra.program.model.address.Address address: the address is memory
        :param jpype.JInt or int size: the size of the variable (in bytes)
        :param java.math.BigInteger value: the value
        """

    def setByte(self, address: ghidra.program.model.address.Address, value: typing.Union[jpype.JByte, int]) -> None:
        """
        Convenience to set a variable to a concrete value as a ``byte``
        
        :param ghidra.program.model.address.Address address: the address is memory
        :param jpype.JByte or int value: the value
        """

    def setConcrete(self, address: ghidra.program.model.address.Address, value: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def setInt(self, address: ghidra.program.model.address.Address, value: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setLong(self, address: ghidra.program.model.address.Address, value: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def setRegisterValue(self, register: ghidra.program.model.lang.Register, value: ghidra.program.model.lang.RegisterValue) -> None:
        """
        Convenience to set a register variable to a concrete value as a :obj:`RegisterValue`
        ...
        **NOTE:** The register from the given value does not have to match the given register, but
        ...
        :param ghidra.program.model.lang.Register register: the register
        :param ghidra.program.model.lang.RegisterValue value: the value
        """
    ...
    def setShort(self, address: ghidra.program.model.address.Address, value: typing.Union[jpype.JShort, int]) -> None:
        """
        Convenience to set a variable to a concrete value as a ``short``
        
        :param ghidra.program.model.address.Address address: the address is memory
        :param jpype.JShort or int value: the value
        """

    @typing.overload
    def setVar(self, reg: ghidra.program.model.lang.Register, val: T) -> None:
        """
    ...
    @typing.overload
    def setVar(self, var: ghidra.program.model.pcode.Varnode, val: T) -> None:
        """
    ...
    @typing.overload
    def setVar(self, space: ghidra.program.model.address.AddressSpace, offset: A, size: typing.Union[jpype.JInt, int], quantize: typing.Union[jpype.JBoolean, bool], val: T) -> None:
        """
        Set the value of a variable
    ...
    @typing.overload
    def setVar(self, space: ghidra.program.model.address.AddressSpace, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], quantize: typing.Union[jpype.JBoolean, bool], val: T) -> None:
        """
        Set the value of a variable
    ...
    @typing.overload
    def setVar(self, address: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int], quantize: typing.Union[jpype.JBoolean, bool], val: T) -> None:
        """
        Set the value of a variable
    ...
    @typing.overload
    def setVarInternal(self, space: ghidra.program.model.address.AddressSpace, offset: A, size: typing.Union[jpype.JInt, int], val: T) -> None:
        """
    ...
    @typing.overload
    def setVarInternal(self, space: ghidra.program.model.address.AddressSpace, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], val: T) -> None:
        """
        Set the value of a variable without issuing callbacks
    ...
    def streamPieces(self) -> java.util.stream.Stream[PcodeExecutorStatePiece[typing.Any, typing.Any]]:
        """
        ...
        :return: the stream
        :rtype: java.util.stream.Stream[PcodeExecutorStatePiece[typing.Any, typing.Any]]
        """
...
class PcodeArithmetic(java.lang.Object, typing.Generic[T]):
    ...
    class Purpose(java.lang.Enum[PcodeArithmetic.Purpose]):
        ...
        BY_DEF: typing.Final[PcodeArithmetic.Purpose]
        """
    ...
    @typing.overload
    def fromConst(self, address: ghidra.program.model.address.Address) -> T:
        """
    ...
    def getDomain(self) -> java.lang.Class[T]:
        """
    ...
    def sizeOfAbstract(self, value: T) -> T:
        ...
        The returned size should have a size of :obj:`.SIZEOF_SIZEOF`.
    ...
    def toAddress(self, value: T, space: ghidra.program.model.address.AddressSpace, purpose: PcodeArithmetic.Purpose) -> ghidra.program.model.address.Address:
        """
        Convert, if possible, the given abstract value to a concrete address in the given space
        
        :param T value: the abstract value
        :param ghidra.program.model.address.AddressSpace space: the destination address space
        :param PcodeArithmetic.Purpose purpose: the reason why the emulator needs a concrete value
        :return: the address
    ...
    @property
    def domain(self) -> java.lang.Class[T]:
        ...
...
class PcodeStateCallbacks(java.lang.Object):
    """
    ...
    :obj:`PcodeEmulationCallbacks` instead. See :obj:`PcodeEmulator` for advice regarding extension
    versus integration. In particular, these callbacks were introduced to avert the need to extend
    :obj:`PcodeExecutorState`s and/or :obj:`PcodeExecutorStatePiece`s just to introduce
    ...
    :meth:`readUninitialized(PcodeExecutorStatePiece, AddressSetView, Reason) <.readUninitialized>` or
    :meth:`PcodeEmulationCallbacks.readUninitialized(PcodeThread, PcodeExecutorStatePiece, AddressSetView, Reason) <PcodeEmulationCallbacks.readUninitialized>`
    callback rather than extending :obj:`BytesPcodeExecutorStatePiece`.
    """

    class NoPcodeStateCallbacks(java.lang.Enum[PcodeStateCallbacks.NoPcodeStateCallbacks], PcodeStateCallbacks):
        """
        A singleton implementation of the callbacks that does nothing.
        """

        class_: typing.ClassVar[java.lang.Class]
        INSTANCE: typing.Final[PcodeStateCallbacks.NoPcodeStateCallbacks]
        """
        ...
        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> PcodeStateCallbacks.NoPcodeStateCallbacks:
            ...

        @staticmethod
        def values() -> jpype.JArray[PcodeStateCallbacks.NoPcodeStateCallbacks]:
            ...


    class_: typing.ClassVar[java.lang.Class]
    NONE: typing.Final[PcodeStateCallbacks]
    """
    Callbacks that do nothing
    """
    ...
    @staticmethod
    def checkValueDomain(piece: PcodeExecutorStatePiece[A, typing.Any], domain: java.lang.Class[T]) -> PcodeExecutorStatePiece[A, T]:
        """
        Check that the given piece has a required value domain
        
        :param A: the piece's address domain:param T: the piece's value domain:param PcodeExecutorStatePiece[A, typing.Any] piece: the piece
        :param java.lang.Class[T] domain: the required value domain
    ...
    @typing.overload
    def dataWritten(self, piece: PcodeExecutorStatePiece[A, T], space: ghidra.program.model.address.AddressSpace, offset: A, length: typing.Union[jpype.JInt, int], value: T) -> None:
        """
        Data was written into the given state piece (abstract addressing.)
        
        :param A: the piece's address domain:param T: the piece's value domain:param PcodeExecutorStatePiece[A, T] piece: the state piece
    ...
    @typing.overload
    def dataWritten(self, piece: PcodeExecutorStatePiece[A, T], address: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int], value: T) -> None:
        """
    ...
    @typing.overload
    def delegateDataWritten(self, piece: PcodeExecutorStatePiece[A, T], space: ghidra.program.model.address.AddressSpace, offset: A, length: typing.Union[jpype.JInt, int], value: T) -> None:
        """
        Typically used from within
        :meth:`dataWritten(PcodeExecutorStatePiece, AddressSpace, Object, int, Object) <.dataWritten>` to forward
        the call to the callback for concrete addressing
        :meth:`dataWritten(PcodeExecutorStatePiece, Address, int, Object) <.dataWritten>`.
    ...
    @typing.overload
    def delegateDataWritten(self, piece: PcodeExecutorStatePiece[A, T], address: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int], value: T) -> None:
        """
        Typically used from within
        :meth:`dataWritten(PcodeExecutorStatePiece, Address, int, Object) <.dataWritten>` to forward the call to
        the callback for abstract addressing
        :meth:`dataWritten(PcodeExecutorStatePiece, AddressSpace, Object, int, Object) <.dataWritten>`.
    ...
    @typing.overload
    def delegateReadUninitialized(self, piece: PcodeExecutorStatePiece[A, T], space: ghidra.program.model.address.AddressSpace, offset: A, length: typing.Union[jpype.JInt, int], reason: PcodeExecutorStatePiece.Reason) -> int:
        """
        Typically used from within
        :meth:`readUninitialized(PcodeExecutorStatePiece, AddressSpace, Object, int, Reason) <.readUninitialized>` to
        forward to the callback for concrete addressing
        :meth:`readUninitialized(PcodeExecutorStatePiece, AddressSetView, Reason) <.readUninitialized>`.
        
        :param A: the piece's address domain:param T: the piece's value domain:param PcodeExecutorStatePiece[A, T] piece: the state piece
        :param ghidra.program.model.address.AddressSpace space: the address space of the operand
        :param A offset: the offset of the operand
        :param jpype.JInt or int length: the size of the operand
        :param PcodeExecutorStatePiece.Reason reason: the reason for reading
        :return: the length of the operand just initialized, typically 0 or ``length``
        :rtype: int
        """

    @typing.overload
    def delegateReadUninitialized(self, piece: PcodeExecutorStatePiece[A, T], set: ghidra.program.model.address.AddressSetView, reason: PcodeExecutorStatePiece.Reason) -> ghidra.program.model.address.AddressSetView:
        """
        Typically used from within
        :meth:`readUninitialized(PcodeExecutorStatePiece, AddressSetView, Reason) <.readUninitialized>` to forward to the
        callback for abstract addressing
        :meth:`readUninitialized(PcodeExecutorStatePiece, AddressSpace, Object, int, Reason) <.readUninitialized>`.
    ...
    @typing.overload
    def readUninitialized(self, piece: PcodeExecutorStatePiece[A, T], space: ghidra.program.model.address.AddressSpace, offset: A, length: typing.Union[jpype.JInt, int], reason: PcodeExecutorStatePiece.Reason) -> int:
        """
    ...
    @typing.overload
    def readUninitialized(self, piece: PcodeExecutorStatePiece[A, T], set: ghidra.program.model.address.AddressSetView, reason: PcodeExecutorStatePiece.Reason) -> ghidra.program.model.address.AddressSetView:
        """
        The executor is preparing to read from uninitialized portions of the given state piece
        (concrete addressing).
    ...
    @staticmethod
    def rngSet(space: ghidra.program.model.address.AddressSpace, offset: typing.Union[jpype.JLong, int], length: typing.Union[jpype.JInt, int]) -> ghidra.program.model.address.AddressSet:
        """
        A convenience for constructing an address set from a varnode-like triple
        
        :param ghidra.program.model.address.AddressSpace space: the address space
        :param jpype.JLong or int offset: the offset
        :param jpype.JInt or int length: the size in bytes, at least 1
        :return: the address set
        :rtype: ghidra.program.model.address.AddressSet
        """


class AnnotatedPcodeUseropLibrary(DefaultPcodeUseropLibrary[T], typing.Generic[T]):
    """
    ...
    class ParamAnnotProc(java.lang.Enum[AnnotatedPcodeUseropLibrary.ParamAnnotProc]):
        ...
        @typing.type_check_only
        class MatchedClassWithArgs(java.lang.Record):
            ...
            def paramCls(self) -> java.lang.Class[typing.Any]:
                ...

            def toString(self) -> str:
                ...

            def typeArgs(self) -> java.util.Map[java.lang.reflect.TypeVariable[typing.Any], java.lang.reflect.Type]:
                ...
        ...
        OP: typing.Final[AnnotatedPcodeUseropLibrary.ParamAnnotProc]
    ...
    class AnnotatedPcodeUseropDefinition(PcodeUseropLibrary.PcodeUseropDefinition[T], typing.Generic[T]):
        ...
        def __init__(self, library: AnnotatedPcodeUseropLibrary[T], opType: java.lang.reflect.Type, lookup: java.lang.invoke.MethodHandles.Lookup, method: java.lang.reflect.Method, annot: AnnotatedPcodeUseropLibrary.PcodeUserop) -> None:
            ...
    ...
    class FixedArgsAnnotatedPcodeUseropDefinition(AnnotatedPcodeUseropLibrary.AnnotatedPcodeUseropDefinition[T], typing.Generic[T]):
        ...
        @typing.type_check_only
        class IntArrayUseropInputParam(java.lang.Record, AnnotatedPcodeUseropLibrary.FixedArgsAnnotatedPcodeUseropDefinition.UseropInputParam):
    ...
    class OpOutput(java.lang.annotation.Annotation):
        ...
        The annotated parameter must have type :obj:`Varnode` (or ``int[]`` for direct
    ...
    class OpOp(java.lang.annotation.Annotation):
        """
        An annotation to receive the CALLOTHER p-code op into a parameter
         
         
        
        The annotated parameter must have type :obj:`PcodeOp`).
        """
...
class PcodeUseropLibrary(java.lang.Object, typing.Generic[T]):
    ...
    class PcodeUseropDefinition(java.lang.Object, typing.Generic[T]):
        ...
        @typing.overload
        def execute(self, executor: PcodeExecutor[T], library: PcodeUseropLibrary[T], op: ghidra.program.model.pcode.PcodeOp, outVar: ghidra.program.model.pcode.Varnode, inVars: java.util.List[ghidra.program.model.pcode.Varnode]) -> None:
            """
        ...
        @typing.overload
        def execute(self, executor: PcodeExecutor[T], library: PcodeUseropLibrary[T], op: ghidra.program.model.pcode.PcodeOp) -> None:
            """
        ...
        def getOutputType(self) -> java.lang.Class[typing.Any]:
            """
            If this userop is defined as a java callback, get the type of the output
             
             
            
            If the method has a ``@``:obj:`OpOutput` annotation, this is the type of the output
        ...
        @property
        def outputType(self) -> java.lang.Class[typing.Any]:
            ...
    ...
    @typing.overload
    def compose(self, lib: PcodeUseropLibrary[T], override: typing.Union[jpype.JBoolean, bool]) -> PcodeUseropLibrary[T]:
        """
        Compose this and the given library into a new library.
        
        :param PcodeUseropLibrary[T] lib: the other library
        :param jpype.JBoolean or bool override: allow the given library to override userops from this library
...
class DefaultPcodeUseropLibrary(PcodeUseropLibrary[T], typing.Generic[T]):
    """
    The default implemenation of a userop library
     
     
    
    Userops are added by calling :meth:`putOp(PcodeUseropDefinition) <.putOp>`, usually in the constructor.
    """
...
class PcodeExecutor(java.lang.Object, typing.Generic[T]):
    ...
    def __init__(self, language: ghidra.app.plugin.processors.sleigh.SleighLanguage, arithmetic: PcodeArithmetic[T], state: PcodeExecutorState[T], reason: PcodeExecutorStatePiece.Reason) -> None:
        """
    ...
    def executeBranch(self, op: ghidra.program.model.pcode.PcodeOp, frame: PcodeFrame) -> None:
        """
        Execute a branch
    ...
    def executeCall(self, op: ghidra.program.model.pcode.PcodeOp, frame: PcodeFrame, library: PcodeUseropLibrary[T]) -> None:
        """
        Execute a call
    ...
    def executeCallother(self, op: ghidra.program.model.pcode.PcodeOp, frame: PcodeFrame, library: PcodeUseropLibrary[T]) -> None:
        """
    ...
    def executeConditionalBranch(self, op: ghidra.program.model.pcode.PcodeOp, frame: PcodeFrame) -> None:
        """
    ...
    def executeIndirectBranch(self, op: ghidra.program.model.pcode.PcodeOp, frame: PcodeFrame) -> None:
        """
    ...
    def executeIndirectCall(self, op: ghidra.program.model.pcode.PcodeOp, frame: PcodeFrame) -> None:
        """
    ...
    def executeReturn(self, op: ghidra.program.model.pcode.PcodeOp, frame: PcodeFrame) -> None:
        """
        Execute a return
    ...
    def executeSleigh(self, source: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def finish(self, frame: PcodeFrame, library: PcodeUseropLibrary[T]) -> None:
        """
    ...
    def skip(self, frame: PcodeFrame) -> None:
        """
    ...
    def step(self, frame: PcodeFrame, library: PcodeUseropLibrary[T]) -> None:
        """
    ...
    def stepOp(self, op: ghidra.program.model.pcode.PcodeOp, frame: PcodeFrame, library: PcodeUseropLibrary[T]) -> None:
        """
        Step one p-code op
...
class PcodeProgram(java.lang.Object):
    ...
    class MyAppender(ghidra.app.util.pcode.AbstractAppender[java.lang.String]):
        ...
        def __init__(self, program: PcodeProgram, language: ghidra.program.model.lang.Language, numberOps: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def endLine(self) -> None:
            ...

        def getOpIdx(self) -> int:
            ...

        @property
        def opIdx(self) -> jpype.JInt:
            ...
    ...
    class MyFormatter(ghidra.app.util.pcode.AbstractPcodeFormatter[java.lang.String, PcodeProgram.MyAppender]):
        ...
        def __init__(self, program: PcodeProgram, numberOps: typing.Union[jpype.JBoolean, bool]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, program: PcodeProgram, code: java.util.List[ghidra.program.model.pcode.PcodeOp]) -> None:
        """
    ...
    def execute(self, executor: PcodeExecutor[T], library: PcodeUseropLibrary[T]) -> None:
        """
    ...
    def getUseropNumber(self, name: typing.Union[java.lang.String, str]) -> int:
        """
        ...
        .. admonition:: Implementation Note
            ...
            There is no index by name, so this exhaustively searches the language- and
    ...
    @property
    def useropNumber(self) -> jpype.JInt:
        ...
...
class PcodeFrame(java.lang.Object):
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, code: java.util.List[ghidra.program.model.pcode.PcodeOp], useropNames: collections.abc.Mapping) -> None:
        """
    ...
    def branch(self, rel: typing.Union[jpype.JInt, int]) -> None:
        """
...
class BytesPcodeExecutorState(DefaultPcodeExecutorState[jpype.JArray[jpype.JByte]]):
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, cb: PcodeStateCallbacks) -> None:
        """
        Create the state
...
class DefaultPcodeExecutorState(AbstractPcodeExecutorState[T, T], typing.Generic[T]):
    """
    ...
    def __init__(self, piece: PcodeExecutorStatePiece[T, T]) -> None:
        ...


class AbstractPcodeExecutorState(PcodeExecutorState[T], typing.Generic[A, T]):

    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, piece: PcodeExecutorStatePiece[A, T]) -> None:
        ...
...
class AbstractBytesPcodeExecutorStatePiece(AbstractLongOffsetPcodeExecutorStatePiece[jpype.JArray[jpype.JByte], jpype.JArray[jpype.JByte], S], typing.Generic[S]):
    ...
    class StateMemBuffer(ghidra.program.model.mem.MemBufferMixin):
        ...
        def __init__(self, address: ghidra.program.model.address.Address, source: BytesPcodeExecutorStateSpace, reason: PcodeExecutorStatePiece.Reason) -> None:
            """
            Construct a buffer bound to the given space, at the given address
            
            :param ghidra.program.model.address.Address address: the address
            :param BytesPcodeExecutorStateSpace source: the space (null will cause readUninit and re-fetch on read attempts)
    ...
    @typing.overload
    def __init__(self, language: ghidra.program.model.lang.Language, arithmetic: PcodeArithmetic[jpype.JArray[jpype.JByte]], cb: PcodeStateCallbacks) -> None:
        """
...
class AbstractLongOffsetPcodeExecutorStatePiece(PcodeExecutorStatePiece[A, T], typing.Generic[A, T, S]):
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, addressArithmetic: PcodeArithmetic[A], arithmetic: PcodeArithmetic[T], cb: PcodeStateCallbacks) -> None:
        """
        Construct a state piece for the given language and arithmetic
        
        :param ghidra.program.model.lang.Language language: the language (used for its memory model)
        :param PcodeArithmetic[A] addressArithmetic: an arithmetic used to generate default values of ``A``
        :param PcodeArithmetic[T] arithmetic: an arithmetic used to generate default values of ``T``. It must be able
                    to derive concrete sizes, i.e., :meth:`PcodeArithmetic.sizeOf(Object) <PcodeArithmetic.sizeOf>` must always
                    return the correct value.
        :param PcodeStateCallbacks cb: callbacks to receive emulation events
        """


class BytesPcodeExecutorStateSpace(java.lang.Object):
    """
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, space: ghidra.program.model.address.AddressSpace, piece: AbstractBytesPcodeExecutorStatePiece[typing.Any]) -> None:
        """
        ...
        :param ghidra.program.model.address.AddressSpace space: the address space
        :param AbstractBytesPcodeExecutorStatePiece[typing.Any] piece: the owning piece
        """

    def clear(self) -> None:
        ...

    def fork(self, piece: AbstractBytesPcodeExecutorStatePiece[typing.Any]) -> BytesPcodeExecutorStateSpace:
        ...
    ...
    def read(self, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], reason: PcodeExecutorStatePiece.Reason, cb: PcodeStateCallbacks) -> jpype.JArray[jpype.JByte]:
        """
    ...
    def write(self, offset: typing.Union[jpype.JLong, int], val: jpype.JArray[jpype.JByte], srcOffset: typing.Union[jpype.JInt, int], length: typing.Union[jpype.JInt, int], cb: PcodeStateCallbacks) -> None:
        """
...
class BytesPcodeExecutorStatePiece(AbstractBytesPcodeExecutorStatePiece[BytesPcodeExecutorStateSpace]):
    """
...
class DecodePcodeExecutionException(PcodeExecutionException):
    ...
    def __init__(self, message: typing.Union[java.lang.String, str], pc: ghidra.program.model.address.Address) -> None:
        ...
...
class PcodeExecutionException(java.lang.RuntimeException):
    ...
    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], frame: PcodeFrame, cause: java.lang.Throwable) -> None:
        """
    ...
    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], frame: PcodeFrame) -> None:
        ...
...
class PcodeUseropLibraryFactory(ghidra.util.classfinder.ExtensionPoint):
    """
    ...
    class UseropLibrary(java.lang.annotation.Annotation):
        """
        ...
        def value(self) -> str:
            ...
            periods to briefly qualify their names, e.g., ``"com.example.my-userop-lib"``.
    ...
    class_: typing.ClassVar[java.lang.Class]
    KEY_USEROP_LIBS: typing.Final = "useropLibs"
    """
    The property key for useropLib ids in pspec files
    """


    def create(self, language: ghidra.app.plugin.processors.sleigh.SleighLanguage, arithmetic: PcodeArithmetic[T]) -> PcodeUseropLibrary[T]:
        """
        Create the userop library
        
        :param T: the type of values in the emulator:param ghidra.app.plugin.processors.sleigh.SleighLanguage language: the language of the emulator
        :param PcodeArithmetic[T] arithmetic: the arithmetic of the emulator
        :return: the userop library
        :rtype: PcodeUseropLibrary[T]
        """

    @staticmethod
    def createUseropLibraryForLanguage(language: ghidra.app.plugin.processors.sleigh.SleighLanguage, arithmetic: PcodeArithmetic[T]) -> PcodeUseropLibrary[T]:
        """
        ...
        useropLibs property. That property is a comma-separated list of the ids to
        compose.
         
         
        
        See the caveats in
        :meth:`createUseropLibraryFromId(String, SleighLanguage, PcodeArithmetic) <.createUseropLibraryFromId>` regarding
        agreement between language and arithmetic.
        
        :param T: the type of values in the emulator's state:param ghidra.app.plugin.processors.sleigh.SleighLanguage language: the language
        :param PcodeArithmetic[T] arithmetic: the arithmetic
        :return: the userop library
        :rtype: PcodeUseropLibrary[T]
        
        .. admonition:: Implementation Note
        
            currently, duplicate userops (by name) are not permitted. This may change in future
            versions. Thus, we compose libraries in the order listed, in case of that change,
            as it would matter.
        """

    @staticmethod
    def createUseropLibraryFromId(id: typing.Union[java.lang.String, str], language: ghidra.app.plugin.processors.sleigh.SleighLanguage, arithmetic: PcodeArithmetic[T]) -> PcodeUseropLibrary[T]:
        """
        ...
        may exhibit undefined behavior. (The default emulator does *not* guarantee type
        ...
        If the given id cannot be found, an empty library (:meth:`PcodeUseropLibrary.nil() <PcodeUseropLibrary.nil>`) is
        ...
        :param T: the type of values in the emulator's state:param java.lang.String or str id: the id of the userop library
    ...
    def getId(self) -> str:
        ...
        This gets the id from the :obj:`UseropLibrary` annotation. You should not override this
...
class AbstractSleighPcodeUseropDefinition(SleighPcodeUseropDefinition[T], typing.Generic[T]):
    """
    A abstract Sleigh userop definition
    """

    class Builder(SleighPcodeUseropDefinition.BuilderStage1):
        """
        ...
        .. seealso::
            ...
            | :obj:`SleighPcodeUseropDefinition.Factory`
        """
...
class SleighPcodeUseropDefinition(PcodeUseropLibrary.PcodeUseropDefinition[T], typing.Generic[T]):
    ...
    class Factory(java.lang.Object):
        ...
        def __init__(self, language: ghidra.app.plugin.processors.sleigh.SleighLanguage) -> None:
            """
        ...
        def define(self, name: typing.Union[java.lang.String, str]) -> SleighPcodeUseropDefinition.BuilderStage1:
            """
            ...
            :rtype: SleighPcodeUseropDefinition.BuilderStage1
            """


    class BodyFunc(java.lang.Object):
        """
        ...
        def generate(self, args: java.util.List[ghidra.program.model.pcode.Varnode]) -> java.lang.CharSequence:
            """
            ...
            :param java.util.List[ghidra.program.model.pcode.Varnode] args: the varnode argument list
            :return: the generated source
            :rtype: java.lang.CharSequence
            """


    class BuilderStage2(java.lang.Object):
        """
        ...
        def body(self, additionalBody: SleighPcodeUseropDefinition.BodyFunc) -> SleighPcodeUseropDefinition.BuilderStage2:
            """
            Add Sleigh source to the body
            
            :param SleighPcodeUseropDefinition.BodyFunc additionalBody: the additional source
            :return: the builder
            :rtype: SleighPcodeUseropDefinition.BuilderStage2
            """
        ...
        def overload(self) -> SleighPcodeUseropDefinition.BuilderStage1:
            """
    ...
    class BuilderStage1(SleighPcodeUseropDefinition.BuilderStage2):
        """
        ...
        @typing.overload
        def params(self, additionalParams: collections.abc.Sequence) -> SleighPcodeUseropDefinition.BuilderStage1:
            """
        ...
        @typing.overload
        def params(self, *additionalParams: typing.Union[java.lang.String, str]) -> SleighPcodeUseropDefinition.BuilderStage1:
            """
    ...
    class SignatureDef(java.lang.Record):
        """
        ...
        def __init__(self, signature: java.util.List[java.lang.String], body: java.util.List[SleighPcodeUseropDefinition.BodyFunc]) -> None:
            ...

        def body(self) -> java.util.List[SleighPcodeUseropDefinition.BodyFunc]:
            ...
        ...
        @typing.overload
        def generateBody(self, args: java.util.List[ghidra.program.model.pcode.Varnode]) -> str:
            """
            Generate the body's source code for the given arguments
            
            :param java.util.List[ghidra.program.model.pcode.Varnode] args: the argument varnodes
            :return: the body
            :rtype: str
            """

        @typing.overload
        def generateBody(self, *args: ghidra.program.model.pcode.Varnode) -> str:
            """
            Generate the body's source code for the given arguments
            
            :param jpype.JArray[ghidra.program.model.pcode.Varnode] args: the argument varnodes
            :return: the body
            :rtype: str
            """
        ...
        def signature(self) -> java.util.List[java.lang.String]:
            ...
    ...
    EMPTY_ARGS: typing.Final[java.util.List[ghidra.program.model.pcode.Varnode]]

    @typing.overload
    def getBody(self, args: java.util.List[ghidra.program.model.pcode.Varnode]) -> str:
        """
        ...
        the body may vary depending on the *sizes* of the arguments. In cases where it is
    ...
    @typing.overload
    def getBody(self, *args: ghidra.program.model.pcode.Varnode) -> str:
        """
        Get the Sleigh source that defines this userop
    ...
    def programFor(self, args: java.util.List[ghidra.program.model.pcode.Varnode], library: PcodeUseropLibrary[typing.Any]) -> PcodeProgram:
        """
        ...
        :param java.util.List[ghidra.program.model.pcode.Varnode] args: the operands, output at index 0, and inputs following
...
class AccessPcodeExecutionException(PcodeExecutionException):
    ...
    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], cause: java.lang.Exception) -> None:
        ...
...
class ComposedPcodeUseropLibrary(PcodeUseropLibrary[T], typing.Generic[T]):
    ...
    def __init__(self, libraries: collections.abc.Sequence, override: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a composed userop library from the given libraries
         
         
        
        This uses :meth:`composeUserops(Collection, boolean) <.composeUserops>`, so its restrictions apply here, too.
        
        :param jpype.JBoolean or bool override: allow libraries to the right to override userops from libraries to the left
        :param collections.abc.Sequence libraries: the libraries
        """

    @staticmethod
    def composeUserops(libraries: collections.abc.Sequence, override: typing.Union[jpype.JBoolean, bool]) -> java.util.Map[java.lang.String, PcodeUseropLibrary.PcodeUseropDefinition[T]]:
        """
...
class ConcretionError(PcodeExecutionException):
    ...
    def __init__(self, message: typing.Union[java.lang.String, str], purpose: PcodeArithmetic.Purpose) -> None:
        """
...
class FixedSleighPcodeUseropDefinition(AbstractSleighPcodeUseropDefinition[T], typing.Generic[T]):
    """
    ...
    def getSignatureDef(self) -> SleighPcodeUseropDefinition.SignatureDef:
        """
        Get the single signature and definition
        
        :return: the definition
        :rtype: SleighPcodeUseropDefinition.SignatureDef
        """

    @property
    def signatureDef(self) -> SleighPcodeUseropDefinition.SignatureDef:
        ...


class IndependentPairedPcodeExecutorState(PcodeExecutorState[org.apache.commons.lang3.tuple.Pair[L, R]], typing.Generic[L, R]):
    """
    ...
    @typing.overload
    def __init__(self, left: PcodeExecutorStatePiece[L, L], right: PcodeExecutorStatePiece[R, R], arithmetic: PcodeArithmetic[org.apache.commons.lang3.tuple.Pair[L, R]]) -> None:
        ...

    @typing.overload
    def __init__(self, left: PcodeExecutorStatePiece[L, L], right: PcodeExecutorStatePiece[R, R]) -> None:
        """
        Compose a paired state from the given left and right states
        
        :param PcodeExecutorStatePiece[L, L] left: the state backing the left side of paired values ("control")
        :param PcodeExecutorStatePiece[R, R] right: the state backing the right side of paired values ("auxiliary")
        """
    ...
    def getRight(self) -> PcodeExecutorStatePiece[R, R]:
        """
        Get the delegate backing the right side of paired values
        
        :return: the right state
        :rtype: PcodeExecutorStatePiece[R, R]
        """
    ...
    @property
    def right(self) -> PcodeExecutorStatePiece[R, R]:
        ...
...
class InjectionErrorPcodeExecutionException(PcodeExecutionException):
    ...
    def __init__(self, frame: PcodeFrame, cause: java.lang.Throwable) -> None:
        ...
...
class ValueLocation(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, *nodes: ghidra.program.model.pcode.Varnode) -> None:
        """
    ...
    @typing.overload
    def __init__(self, nodes: java.util.List[ghidra.program.model.pcode.Varnode]) -> None:
        """
        Construct a location from a list of varnodes
...
class OverloadedSleighPcodeUseropDefinition(AbstractSleighPcodeUseropDefinition[T], typing.Generic[T]):
    """
    ...
    def getAllSignatures(self) -> java.util.Collection[SleighPcodeUseropDefinition.SignatureDef]:
        """
        Get all the signatures and definitions for this userop
        
        :return: the collection of definitions
        :rtype: java.util.Collection[SleighPcodeUseropDefinition.SignatureDef]
        """

    def getSignatureDef(self, argCount: typing.Union[jpype.JInt, int]) -> SleighPcodeUseropDefinition.SignatureDef:
        """
        Get the signature and definition for the given argument count
        
        :param jpype.JInt or int argCount: the argument (or parameter) count
        :return: the definition, or null if not defined
        :rtype: SleighPcodeUseropDefinition.SignatureDef
        """

    @property
    def allSignatures(self) -> java.util.Collection[SleighPcodeUseropDefinition.SignatureDef]:
        ...
...
class PairedPcodeArithmetic(PcodeArithmetic[org.apache.commons.lang3.tuple.Pair[L, R]], typing.Generic[L, R]):
    ...
    def __init__(self, leftArith: PcodeArithmetic[L], rightArith: PcodeArithmetic[R]) -> None:
        """
...
class PairedPcodeExecutorState(PcodeExecutorState[org.apache.commons.lang3.tuple.Pair[L, R]], typing.Generic[L, R]):
    ...
    @typing.overload
    def __init__(self, piece: PairedPcodeExecutorStatePiece[L, L, R]) -> None:
        ...

    @typing.overload
    def __init__(self, left: PcodeExecutorState[L], right: PcodeExecutorStatePiece[L, R], arithmetic: PcodeArithmetic[org.apache.commons.lang3.tuple.Pair[L, R]]) -> None:
        """
        Compose a paired state from the given left and right states
        ...
        :param PcodeArithmetic[org.apache.commons.lang3.tuple.Pair[L, R]] arithmetic: the arithmetic for the paired values of the state
        """

    @typing.overload
    def __init__(self, left: PcodeExecutorState[L], right: PcodeExecutorStatePiece[L, R]) -> None:
        ...
...
class PairedPcodeExecutorStatePiece(PcodeExecutorStatePiece[A, org.apache.commons.lang3.tuple.Pair[L, R]], typing.Generic[A, L, R]):
    ...
    @typing.overload
    def __init__(self, left: PcodeExecutorStatePiece[A, L], right: PcodeExecutorStatePiece[A, R], addressArithmetic: PcodeArithmetic[A], arithmetic: PcodeArithmetic[org.apache.commons.lang3.tuple.Pair[L, R]]) -> None:
        ...

    @typing.overload
    def __init__(self, left: PcodeExecutorStatePiece[A, L], right: PcodeExecutorStatePiece[A, R]) -> None:
        ...
...
class PcodeExpression(PcodeProgram):
    ...
    class ValueCapturingPcodeUseropLibrary(AnnotatedPcodeUseropLibrary[T], typing.Generic[T]):
        ...
        def ___result(self, result: T) -> None:
            ...
...
class SleighProgramCompiler(java.lang.Enum[SleighProgramCompiler]):
    ...
    class DetailedSleighException(ghidra.app.plugin.processors.sleigh.SleighException):
        ...
        def __init__(self, details: java.util.List[SleighProgramCompiler.PcodeLogEntry]) -> None:
            ...
...
class SleighUtils(java.lang.Enum[SleighUtils]):
    ...
    class SleighParseErrorEntry(java.lang.Record):
        ...
        def __init__(self, header: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str], start: typing.Union[jpype.JInt, int], stop: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    class SleighParseError(java.lang.RuntimeException):
        ...
        def __init__(self, errors: collections.abc.Sequence) -> None:
            ...
    ...
    class AddressOf(java.lang.Record):
        ...
        def __init__(self, space: typing.Union[java.lang.String, str], offset: org.antlr.runtime.tree.Tree) -> None:
            ...
    ...
    @staticmethod
    def match(tree: org.antlr.runtime.tree.Tree, type: typing.Union[jpype.JInt, int], *onChild: java.util.function.Consumer[org.antlr.runtime.tree.Tree]) -> None:
        """
    ...
    @staticmethod
    def matchDereference(tree: org.antlr.runtime.tree.Tree, onSpace: java.util.function.Consumer[org.antlr.runtime.tree.Tree], onSize: java.util.function.Consumer[org.antlr.runtime.tree.Tree], onOffset: java.util.function.Consumer[org.antlr.runtime.tree.Tree]) -> None:
        ...

    @staticmethod
    def matchTree(tree: org.antlr.runtime.tree.Tree, type: typing.Union[jpype.JInt, int], onChildren: java.util.function.Consumer[java.util.List[org.antlr.runtime.tree.Tree]]) -> None:
        """
    ...
    @staticmethod
    def requireCount(count: typing.Union[jpype.JInt, int], list: java.util.List[typing.Any]) -> None:
        """
...
class DebuggerPcodeUtils(java.lang.Enum[DebuggerPcodeUtils]):
    """
    Utilities for evaluating or executing Sleigh/p-code in the Debugger
    """

    class LabelBoundPcodeParser(SleighProgramCompiler.ErrorCollectingPcodeParser):
        """
        A p-code parser that can resolve labels from a trace or its mapped programs.
        """

        @typing.type_check_only
        class ProgSym(java.lang.Record):
        ...
        def __init__(self, provider: ghidra.framework.plugintool.ServiceProvider, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> None:
            """
            ...
            :param ghidra.debug.api.tracemgr.DebuggerCoordinates coordinates: the current coordinates for context
            """
    ...
    class PrettyBytes(java.lang.Record):
        ...
        def __init__(self, bigEndian: typing.Union[jpype.JBoolean, bool], bytes: jpype.JArray[jpype.JByte]) -> None:
            ...

        def bigEndian(self) -> bool:
            ...

        def collectDisplays(self) -> str:
            """
        ...
        def toBigInteger(self, signed: typing.Union[jpype.JBoolean, bool]) -> java.math.BigInteger:
            """
        ...
        def toIntegerString(self) -> str:
            """
            Render the bytes as an unsigned decimal integer
             
             
            
            The endianness is taken from :meth:`bigEndian() <.bigEndian>`
    ...
    class WatchValue(java.lang.Record):
        ...
        def __init__(self, bytes: DebuggerPcodeUtils.PrettyBytes, state: ghidra.trace.model.memory.TraceMemoryState, location: ValueLocation, reads: ghidra.program.model.address.AddressSetView) -> None:
            ...

        def address(self) -> ghidra.program.model.address.Address:
            ...

        def bytes(self) -> DebuggerPcodeUtils.PrettyBytes:
            ...
        ...
        def location(self) -> ValueLocation:
            ...
    ...
    class WatchValuePcodeArithmetic(java.lang.Enum[DebuggerPcodeUtils.WatchValuePcodeArithmetic], PcodeArithmetic[DebuggerPcodeUtils.WatchValue]):
        """
        A p-code arithmetic on watch values
         
         
        
        This is just a composition of four arithmetics. Using ``Pair<A,Pair<B,Pair<C,D>>`` would
        be unwieldy.
        """

        class_: typing.ClassVar[java.lang.Class]
        BIG_ENDIAN: typing.Final[DebuggerPcodeUtils.WatchValuePcodeArithmetic]
        LITTLE_ENDIAN: typing.Final[DebuggerPcodeUtils.WatchValuePcodeArithmetic]

        @staticmethod
        def forEndian(isBigEndian: typing.Union[jpype.JBoolean, bool]) -> DebuggerPcodeUtils.WatchValuePcodeArithmetic:
            ...

        @staticmethod
        def forLanguage(language: ghidra.program.model.lang.Language) -> DebuggerPcodeUtils.WatchValuePcodeArithmetic:
            ...

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> DebuggerPcodeUtils.WatchValuePcodeArithmetic:
            ...

        @staticmethod
        def values() -> jpype.JArray[DebuggerPcodeUtils.WatchValuePcodeArithmetic]:
            ...


    class WatchValuePcodeExecutorStatePiece(PcodeExecutorStatePiece[jpype.JArray[jpype.JByte], DebuggerPcodeUtils.WatchValue]):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, bytesPiece: PcodeExecutorStatePiece[jpype.JArray[jpype.JByte], jpype.JArray[jpype.JByte]], statePiece: PcodeExecutorStatePiece[jpype.JArray[jpype.JByte], ghidra.trace.model.memory.TraceMemoryState], locationPiece: PcodeExecutorStatePiece[jpype.JArray[jpype.JByte], ValueLocation], readsPiece: PcodeExecutorStatePiece[jpype.JArray[jpype.JByte], ghidra.program.model.address.AddressSetView]) -> None:
            ...


    class WatchValuePcodeExecutorState(AbstractPcodeExecutorState[jpype.JArray[jpype.JByte], DebuggerPcodeUtils.WatchValue]):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, piece: PcodeExecutorStatePiece[jpype.JArray[jpype.JByte], DebuggerPcodeUtils.WatchValue]) -> None:
            ...
    ...
    @staticmethod
    def buildWatchExecutor(provider: ghidra.framework.plugintool.ServiceProvider, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> PcodeExecutor[DebuggerPcodeUtils.WatchValue]:
        """
        ...
        :param ghidra.framework.plugintool.ServiceProvider provider: the service provider (usually the tool)
        :param ghidra.debug.api.tracemgr.DebuggerCoordinates coordinates: the coordinates providing context for the evaluation
        :return: an executor for evaluating the watch
        :rtype: PcodeExecutor[DebuggerPcodeUtils.WatchValue]
        """

    @staticmethod
    def buildWatchState(provider: ghidra.framework.plugintool.ServiceProvider, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> DebuggerPcodeUtils.WatchValuePcodeExecutorState:
        ...

    @staticmethod
    def compileExpression(provider: ghidra.framework.plugintool.ServiceProvider, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates, source: typing.Union[java.lang.String, str]) -> PcodeExpression:
        """
        ...
        :meth:`compileProgram(ServiceProvider, DebuggerCoordinates, String, String, PcodeUseropLibrary) <.compileProgram>`
        
        
        .. seealso::
        
            | :obj:`SleighProgramCompiler.compileExpression(PcodeParser, SleighLanguage, String)`
        """

    @staticmethod
    def compileProgram(provider: ghidra.framework.plugintool.ServiceProvider, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates, sourceName: typing.Union[java.lang.String, str], source: typing.Union[java.lang.String, str], library: PcodeUseropLibrary[typing.Any]) -> PcodeProgram:
        """
        ...
        :param ghidra.framework.plugintool.ServiceProvider provider: the service provider (usually the tool)
        :param ghidra.debug.api.tracemgr.DebuggerCoordinates coordinates: the coordinates for the trace (and programs) from which labels can be
                    resolved
        
        .. seealso::
        
            | :obj:`SleighProgramCompiler.compileProgram(PcodeParser, SleighLanguage, String, String,
            PcodeUseropLibrary)`
        """

    @staticmethod
    def executorForCoordinates(provider: ghidra.framework.plugintool.ServiceProvider, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> PcodeExecutor[jpype.JArray[jpype.JByte]]:
        """
        ...
        :return: the executor
        :rtype: PcodeExecutor[jpype.JArray[jpype.JByte]]
        """

    @staticmethod
    def executorStateForCoordinates(provider: ghidra.framework.plugintool.ServiceProvider, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> PcodeExecutorState[jpype.JArray[jpype.JByte]]:
        """
        ...
        :param ghidra.debug.api.tracemgr.DebuggerCoordinates coordinates: the coordinates
        :return: the state
        :rtype: PcodeExecutorState[jpype.JArray[jpype.JByte]]
        """

    @staticmethod
    def valueOf(name: typing.Union[java.lang.String, str]) -> DebuggerPcodeUtils:
        ...

    @staticmethod
    def values() -> jpype.JArray[DebuggerPcodeUtils]:
        ...



__all__ = ["PcodeExecutorStatePiece", "PcodeArithmetic", "PcodeExecutorState", "PcodeStateCallbacks", "AnnotatedPcodeUseropLibrary", "PcodeUseropLibrary", "DefaultPcodeUseropLibrary", "PcodeExecutor", "PcodeProgram", "PcodeFrame", "BytesPcodeExecutorState", "DefaultPcodeExecutorState", "AbstractPcodeExecutorState", "AbstractBytesPcodeExecutorStatePiece", "AbstractLongOffsetPcodeExecutorStatePiece", "BytesPcodeExecutorStateSpace", "BytesPcodeExecutorStatePiece", "DecodePcodeExecutionException", "PcodeExecutionException", "SleighLinkException", "PcodeUseropLibraryFactory", "AbstractSleighPcodeUseropDefinition", "BytesPcodeArithmetic", "SleighPcodeUseropDefinition", "AccessPcodeExecutionException", "AddressesReadPcodeArithmetic", "ComposedPcodeUseropLibrary", "ConcretionError", "FixedSleighPcodeUseropDefinition", "IndependentPairedPcodeExecutorState", "InjectionErrorPcodeExecutionException", "InterruptPcodeExecutionException", "LocationPcodeArithmetic", "ValueLocation", "LocationPcodeExecutorStatePiece", "OverloadedSleighPcodeUseropDefinition", "PairedPcodeArithmetic", "PairedPcodeExecutorState", "PairedPcodeExecutorStatePiece", "PcodeExpression", "SleighProgramCompiler", "SleighUtils", "SuspendedPcodeExecutionException", "DebuggerPcodeUtils"]
