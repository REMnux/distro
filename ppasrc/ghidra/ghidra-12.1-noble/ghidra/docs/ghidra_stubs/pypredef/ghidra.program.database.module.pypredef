...
class TreeManager(ghidra.program.database.ManagerDB):
    ...
    def addMemoryBlock(self, name: typing.Union[java.lang.String, str], range: ghidra.program.model.address.AddressRange) -> None:
        """
    ...
    def imageBaseChanged(self, commit: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setProgramName(self, oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class FragmentDBAdapterV0(FragmentDBAdapter):
    ...
    def __init__(self, handle: db.DBHandle, create: typing.Union[jpype.JBoolean, bool], treeID: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ModuleDBAdapterV0(ModuleDBAdapter, db.RecordTranslator):
    ...
    def __init__(self, handle: db.DBHandle, treeID: typing.Union[jpype.JLong, int], parentChildAdapter: ParentChildDBAdapter) -> None:
        """
...
class ProgramTreeDBAdapterV0(ProgramTreeDBAdapter):
    ...
    def __init__(self, handle: db.DBHandle, create: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
__all__ = ["TreeManager", "ModuleManager", "ProgramTreeDBAdapter", "ModuleDBAdapter", "FragmentDBAdapter", "ParentChildDBAdapter", "ModuleDB", "FragmentDB", "FragmentDBAdapterV0", "ModuleDBAdapterV0", "ModuleDBAdapterV1", "ParentChildDBAdapterV0", "ProgramTreeDBAdapterV0"]
