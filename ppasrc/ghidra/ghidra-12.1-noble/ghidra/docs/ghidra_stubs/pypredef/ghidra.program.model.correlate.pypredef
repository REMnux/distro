...
class Block(java.lang.Object):
    ...
    def __init__(self, codeBlock: ghidra.program.model.block.CodeBlock) -> None:
        ...
...
class InstructHash(java.lang.Object):
    ...
    def __init__(self, inst: ghidra.program.model.listing.Instruction, bl: Block, ind: typing.Union[jpype.JInt, int]) -> None:
        """
...
class Hash(java.lang.Comparable[Hash]):
    ...
    def __init__(self, val: typing.Union[jpype.JInt, int], sz: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class HashStore(java.lang.Object):
    ...
    def __init__(self, a: ghidra.program.model.listing.Function, mon: ghidra.util.task.TaskMonitor) -> None:
        ...

    def calcHashes(self, minLength: typing.Union[jpype.JInt, int], maxLength: typing.Union[jpype.JInt, int], wholeBlock: typing.Union[jpype.JBoolean, bool], matchOnly: typing.Union[jpype.JBoolean, bool], hashCalc: HashCalculator) -> None:
        """
    ...
    @staticmethod
    def extendMatch(nGramSize: typing.Union[jpype.JInt, int], srcInstruct: InstructHash, srcMatch: HashStore.NgramMatch, destInstruct: InstructHash, destMatch: HashStore.NgramMatch, hashCalc: HashCalculator) -> None:
        """
    ...
    def matchHash(self, match: HashStore.NgramMatch, instResult: java.util.List[ghidra.program.model.listing.Instruction], blockResult: java.util.List[ghidra.program.model.block.CodeBlock]) -> None:
        """
    ...
    def removeHash(self, hashEntry: HashEntry) -> None:
        """
...
class HashedFunctionAddressCorrelation(ghidra.program.util.ListingAddressCorrelation):
    ...
    class DisambiguatorEntry(java.lang.Object):
        ...
        def __init__(self, h: Hash, inst: InstructHash) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, leftFunction: ghidra.program.model.listing.Function, rightFunction: ghidra.program.model.listing.Function, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        ...
        :raises CancelledException: if the user cancels1
...
__all__ = ["AllBytesHashCalculator", "HashCalculator", "Block", "InstructHash", "Hash", "HashEntry", "DisambiguateByBytes", "DisambiguateStrategy", "HashStore", "DisambiguateByChild", "DisambiguateByParent", "DisambiguateByParentWithOrder", "HashedFunctionAddressCorrelation", "MnemonicHashCalculator"]
