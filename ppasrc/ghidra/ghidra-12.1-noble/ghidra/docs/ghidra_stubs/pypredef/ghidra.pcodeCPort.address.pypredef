...
class Address(java.lang.Comparable[Address]):
    ...
    @typing.overload
    def __init__(self, id: ghidra.pcodeCPort.space.AddrSpace, off: typing.Union[jpype.JLong, int]) -> None:
        ...
    ...
    @typing.overload
    def __init__(self, ex: Address.mach_extreme) -> None:
        ...
...
class RangeList(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, rangeList: RangeList) -> None:
        ...
    ...
    def insertRange(self, spc: ghidra.pcodeCPort.space.AddrSpace, first: typing.Union[jpype.JLong, int], last: typing.Union[jpype.JLong, int]) -> None:
        ...

    def longestFit(self, addr: Address, maxsize: typing.Union[jpype.JLong, int]) -> int:
        ...

    def printBounds(self, s: java.io.PrintStream) -> None:
        ...

    def removeRange(self, spc: ghidra.pcodeCPort.space.AddrSpace, first: typing.Union[jpype.JLong, int], last: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class Range(java.lang.Comparable[Range]):
    ...
    @typing.overload
    def __init__(self, s: ghidra.pcodeCPort.space.AddrSpace, f: typing.Union[jpype.JLong, int], l: typing.Union[jpype.JLong, int]) -> None:
        ...
...
__all__ = ["Address", "RangeList", "Range", "AddressUtils"]
