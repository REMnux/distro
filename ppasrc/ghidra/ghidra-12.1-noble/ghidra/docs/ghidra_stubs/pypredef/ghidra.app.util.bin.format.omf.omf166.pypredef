...
class Omf166DepList(ghidra.app.util.bin.format.omf.OmfRecord):
    ...
    class InfoEntry(java.lang.Record):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, type: typing.Union[jpype.JByte, int], mark: typing.Union[java.lang.Byte, int], time: typing.Union[java.lang.Integer, int], name: ghidra.app.util.bin.format.omf.OmfString) -> None:
            ...
    ...
    def getInfo(self) -> java.util.List[Omf166DepList.InfoEntry]:
        """
        :return: the :obj:`Omf166DepList` "info"
        :rtype: java.util.List[Omf166DepList.InfoEntry]
        """

    @property
    def info(self) -> java.util.List[Omf166DepList.InfoEntry]:
        ...
...
__all__ = ["Omf166DepList", "Omf166RecordTypes"]
