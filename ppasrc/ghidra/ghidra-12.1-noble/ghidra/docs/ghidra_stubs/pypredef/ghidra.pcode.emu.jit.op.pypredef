...
class JitPhiOp(java.lang.Record, JitDefOp, JitSyntheticOp):
    ...
    @typing.overload
    def __init__(self, block: ghidra.pcode.emu.jit.analysis.JitControlFlowModel.JitBlock, out: ghidra.pcode.emu.jit.var.JitOutVar) -> None:
        """
    ...
    @typing.overload
    def __init__(self, block: ghidra.pcode.emu.jit.analysis.JitControlFlowModel.JitBlock, out: ghidra.pcode.emu.jit.var.JitOutVar, options: org.apache.commons.collections4.BidiMap[ghidra.pcode.emu.jit.analysis.JitControlFlowModel.BlockFlow, ghidra.pcode.emu.jit.var.JitVal]) -> None:
        ...

    def addInputOption(self) -> None:
        """
        Add the :obj:`input <JitInputVar>` option, if not already present
        """

    def addOption(self, flow: ghidra.pcode.emu.jit.analysis.JitControlFlowModel.BlockFlow, option: ghidra.pcode.emu.jit.var.JitVal) -> None:
        """
...
class JitStoreOp(java.lang.Record, JitOp):
    ...
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, space: ghidra.program.model.address.AddressSpace, offset: ghidra.pcode.emu.jit.var.JitVal, value: ghidra.pcode.emu.jit.var.JitVal) -> None:
        ...
...
class JitLoadOp(java.lang.Record, JitDefOp):
    ...
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, out: ghidra.pcode.emu.jit.var.JitOutVar, space: ghidra.program.model.address.AddressSpace, offset: ghidra.pcode.emu.jit.var.JitVal) -> None:
        ...
...
class JitCallOtherOp(java.lang.Record, JitCallOtherOpIf):
    ...
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, userop: ghidra.pcode.exec_.PcodeUseropLibrary.PcodeUseropDefinition[java.lang.Object], args: java.util.List[ghidra.pcode.emu.jit.var.JitVal], inputTypes: java.util.List[ghidra.pcode.emu.jit.analysis.JitTypeBehavior], dfState: ghidra.pcode.emu.jit.analysis.JitDataFlowState.MiniDFState) -> None:
        ...
...
class JitCallOtherDefOp(java.lang.Record, JitCallOtherOpIf, JitDefOp):
    ...
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, out: ghidra.pcode.emu.jit.var.JitOutVar, type: ghidra.pcode.emu.jit.analysis.JitTypeBehavior, userop: ghidra.pcode.exec_.PcodeUseropLibrary.PcodeUseropDefinition[java.lang.Object], args: java.util.List[ghidra.pcode.emu.jit.var.JitVal], inputTypes: java.util.List[ghidra.pcode.emu.jit.analysis.JitTypeBehavior], dfState: ghidra.pcode.emu.jit.analysis.JitDataFlowState.MiniDFState) -> None:
        ...
...
class JitCatenateOp(java.lang.Record, JitDefOp, JitSyntheticOp):
    ...
    def __init__(self, out: ghidra.pcode.emu.jit.var.JitOutVar, parts: java.util.List[ghidra.pcode.emu.jit.var.JitVal]) -> None:
        """
...
class JitSynthSubPieceOp(java.lang.Record, JitDefOp, JitSyntheticOp):
    ...
    def __init__(self, out: ghidra.pcode.emu.jit.var.JitOutVar, offset: typing.Union[jpype.JInt, int], v: ghidra.pcode.emu.jit.var.JitVal) -> None:
        """
        Compact constructor for validation.
...
class JitCBranchOp(java.lang.Record, JitOp):
    ...
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, branch: ghidra.pcode.emu.jit.JitPassage.RBranch, cond: ghidra.pcode.emu.jit.var.JitVal) -> None:
        ...
...
class JitBranchIndOp(java.lang.Record, JitOp):
    ...
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, target: ghidra.pcode.emu.jit.var.JitVal, branch: ghidra.pcode.emu.jit.JitPassage.RIndBranch) -> None:
        ...
...
class JitCallOtherMissingOp(java.lang.Record, JitOp):
    ...
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, opName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class JitBranchOp(java.lang.Record, JitOp):
    ...
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, branch: ghidra.pcode.emu.jit.JitPassage.RBranch) -> None:
        ...
...
class JitBoolAndOp(java.lang.Record, JitBoolBinOp):
    ...
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, out: ghidra.pcode.emu.jit.var.JitOutVar, l: ghidra.pcode.emu.jit.var.JitVal, r: ghidra.pcode.emu.jit.var.JitVal) -> None:
        ...
...
class JitBoolNegateOp(java.lang.Record, JitBoolUnOp):
    ...
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, out: ghidra.pcode.emu.jit.var.JitOutVar, u: ghidra.pcode.emu.jit.var.JitVal) -> None:
        ...
...
class JitSubPieceOp(java.lang.Record, JitIntUnOp):
    ...
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, out: ghidra.pcode.emu.jit.var.JitOutVar, u: ghidra.pcode.emu.jit.var.JitVal, offset: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["JitOp", "JitCallOtherOpIf", "JitPhiOp", "JitDefOp", "JitSyntheticOp", "JitUnOp", "JitBinOp", "JitStoreOp", "JitLoadOp", "JitCallOtherOp", "JitCallOtherDefOp", "JitCatenateOp", "JitSynthSubPieceOp", "JitCBranchOp", "JitBranchIndOp", "JitCallOtherMissingOp", "JitBranchOp", "JitUnimplementedOp", "JitNopOp", "JitBoolAndOp", "JitBoolBinOp", "JitBoolNegateOp", "JitBoolUnOp", "JitBoolOrOp", "JitBoolXorOp", "JitCopyOp", "JitFloatAbsOp", "JitFloatUnOp", "JitFloatAddOp", "JitFloatBinOp", "JitFloatCeilOp", "JitFloatTestOp", "JitFloatDivOp", "JitFloatEqualOp", "JitFloatFloat2FloatOp", "JitFloatFloorOp", "JitFloatInt2FloatOp", "JitFloatLessEqualOp", "JitFloatLessOp", "JitFloatMultOp", "JitFloatNaNOp", "JitFloatNegOp", "JitFloatNotEqualOp", "JitFloatRoundOp", "JitFloatSqrtOp", "JitFloatSubOp", "JitFloatTruncOp", "JitInt2CompOp", "JitIntUnOp", "JitIntAddOp", "JitIntBinOp", "JitIntAndOp", "JitIntCarryOp", "JitIntTestOp", "JitIntDivOp", "JitIntEqualOp", "JitIntLeftOp", "JitIntLessEqualOp", "JitIntLessOp", "JitIntMultOp", "JitIntNegateOp", "JitIntNotEqualOp", "JitIntOrOp", "JitIntRemOp", "JitIntRightOp", "JitIntSBorrowOp", "JitIntSCarryOp", "JitIntSDivOp", "JitIntSExtOp", "JitIntSLessEqualOp", "JitIntSLessOp", "JitIntSRemOp", "JitIntSRightOp", "JitIntSubOp", "JitIntXorOp", "JitIntZExtOp", "JitLzCountOp", "JitPopCountOp", "JitSubPieceOp"]
