...
class ColorValueEditor(ThemeValueEditor[java.awt.Color]):
    ...
    def __init__(self, listener: java.beans.PropertyChangeListener) -> None:
        """
        Constructor
...
class ThemeValueEditor(java.lang.Object, typing.Generic[T]):
    ...
    def editValue(self, themeValue: generic.theme.ThemeValue[T]) -> None:
        """
...
class ExportThemeDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, themeManager: generic.theme.ThemeManager, exportAsZip: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setOutputFile(self, outputFile: jpype.protocol.SupportsPath) -> None:
        ...
...
class GThemeValuesCache(java.lang.Object):
    ...
    def __init__(self, themeManager: generic.theme.ThemeManager) -> None:
        ...
...
class ProtectedIcon(javax.swing.Icon):
    ...
    def __init__(self, delegate: javax.swing.Icon) -> None:
        ...
...
class ThemeColorPaletteTable(ThemeColorTable):
    ...
    def __init__(self, themeManager: generic.theme.ThemeManager, valuesProvider: GThemeValuesCache) -> None:
        ...
...
class ThemeTable(java.lang.Object):
    ...
    def setShowSystemValues(self, show: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ThemeColorTableModel(docking.widgets.table.GDynamicColumnTableModel[generic.theme.ColorValue, java.lang.Object]):
    ...
    def __init__(self, valuesProvider: GThemeValuesCache) -> None:
        ...
...
class ThemeColorTree(javax.swing.JPanel, docking.action.ActionContextProvider):
    ...
    class ColorNode(docking.widgets.tree.GTreeNode):
        ...
        def sort(self, sorter: ColorSorter) -> None:
            ...
    ...
    class ColorValueNode(ThemeColorTree.ColorNode):
        ...
        def __init__(self, colorValue: generic.theme.ColorValue) -> None:
            ...
...
class ThemeEditorDialog(docking.DialogComponentProvider):
    ...
    @staticmethod
    def editTheme(themeManager: generic.theme.ThemeManager) -> None:
        """
...
class ThemeTableContext(docking.DefaultActionContext, typing.Generic[T]):
    ...
    def __init__(self, currentValue: generic.theme.ThemeValue[T], themeValue: generic.theme.ThemeValue[T], themeTable: ThemeTable) -> None:
        ...
...
class ThemeUtils(java.lang.Object):
    ...
    @staticmethod
    def deleteTheme(themeManager: generic.theme.ThemeManager) -> None:
        """
    ...
    @staticmethod
    def exportTheme(themeManager: generic.theme.ThemeManager) -> None:
        """
    ...
    @staticmethod
    def importTheme(themeManager: generic.theme.ThemeManager) -> None:
        """
...
__all__ = ["ColorSorter", "ColorValueEditor", "ThemeValueEditor", "ExportThemeDialog", "FontValueEditor", "GThemeValuesCache", "IconValueEditor", "ProtectedIcon", "ThemeColorPaletteTable", "ThemeColorTable", "ThemeTable", "ThemeColorTableModel", "ThemeColorTree", "ThemeEditorDialog", "ThemeFontTable", "ThemeIconTable", "ThemeTableContext", "ThemeIconTableModel", "ThemeFontTableModel", "ThemeUtils"]
