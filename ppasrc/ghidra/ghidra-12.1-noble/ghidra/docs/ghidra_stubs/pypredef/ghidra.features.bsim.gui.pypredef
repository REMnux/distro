...
class BSimSearchPlugin(ghidra.app.plugin.ProgramPlugin):
    ...
    class OverviewTask(BSimSearchPlugin.AbstractProgramTask, ghidra.features.bsim.query.facade.SFResultsUpdateListener[ghidra.features.bsim.query.protocol.ResponseNearestVector]):
        ...
        def __init__(self, serverCache: ghidra.features.bsim.gui.search.dialog.BSimServerCache, settings: ghidra.features.bsim.gui.search.dialog.BSimSearchSettings, functions: java.util.Set[ghidra.program.database.symbol.FunctionSymbol]) -> None:
            ...
    ...
    def doBSimSearch(self, program: ghidra.program.model.listing.Program, functionAddresses: java.util.List[ghidra.program.model.address.Address], showDialog: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def providerClosed(self, provider: ghidra.features.bsim.gui.search.results.BSimSearchResultsProvider) -> None:
        ...

    @typing.overload
    def providerClosed(self, overviewProvider: ghidra.features.bsim.gui.overview.BSimOverviewProvider) -> None:
        ...
...
class BSimServerManager(java.lang.Object):
    ...
    def addListener(self, listener: ghidra.features.bsim.gui.search.dialog.BSimServerManagerListener) -> None:
        ...

    def addServer(self, newServerInfo: ghidra.features.bsim.query.BSimServerInfo) -> None:
        """
    ...
    def removeListener(self, listener: ghidra.features.bsim.gui.search.dialog.BSimServerManagerListener) -> None:
        ...
...
__all__ = ["BSimSearchPlugin", "BSimServerManager"]
