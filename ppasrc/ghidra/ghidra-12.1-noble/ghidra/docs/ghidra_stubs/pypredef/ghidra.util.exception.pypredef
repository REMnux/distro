...
class VersionException(UsrException):
    ...
    @typing.overload
    def __init__(self, upgradable: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor.
    ...
    @typing.overload
    def __init__(self, versionIndicator: typing.Union[jpype.JInt, int], upgradable: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor.
    ...
    @typing.overload
    def __init__(self, msg: typing.Union[java.lang.String, str], versionIndicator: typing.Union[jpype.JInt, int], upgradable: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor.
    ...
    def setDetailMessage(self, message: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ClosedException(java.io.IOException):
    ...
    @typing.overload
    def __init__(self, resourceName: typing.Union[java.lang.String, str]) -> None:
        """
...
class GraphException(UsrException):
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], cause: java.lang.Throwable) -> None:
        ...
...
class MultipleCauses(java.lang.Throwable):
    ...
    @typing.overload
    def __init__(self, causes: collections.abc.Sequence) -> None:
        """
    ...
    @typing.overload
    def addAllCauses(self, that: MultipleCauses) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def printTree(out: java.io.PrintStream, prefix: typing.Union[java.lang.String, str], e: java.lang.Throwable) -> None:
        ...
...
class AssertException(java.lang.RuntimeException):
    ...
    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], throwable: java.lang.Throwable) -> None:
        """
        Create a new AssertException with the given message.
...
__all__ = ["VersionException", "BadLinkException", "RollbackException", "UserAccessException", "NoValueException", "ClosedException", "CryptoException", "DuplicateFileException", "DuplicateNameException", "FileInUseException", "GraphException", "InvalidInputException", "MultipleCauses", "NotEmptyException", "NotFoundException", "NotYetImplementedException", "PropertyTypeMismatchException", "CancelledException", "UsrException", "UnableToSwingException", "AssertException", "IOCancelledException", "TimeoutException"]
