...
class GhidraApplicationLayout(utility.application.ApplicationLayout):
    ...
    @typing.overload
    def __init__(self, applicationInstallationDir: jpype.protocol.SupportsPath) -> None:
        """
...
class GhidraLaunchable(java.lang.Object):
    ...
    def launch(self, layout: GhidraApplicationLayout, args: jpype.JArray[java.lang.String]) -> None:
        """
...
class GhidraLauncher(java.lang.Object):
    ...
    @staticmethod
    def launch(args: jpype.JArray[java.lang.String]) -> None:
        """
        Launches the given :obj:`GhidraLaunchable` specified in the first command line argument
...
class GhidraTestApplicationLayout(GhidraApplicationLayout):
    ...
    def __init__(self, userSettingsDir: jpype.protocol.SupportsPath) -> None:
        """
...
__all__ = ["GhidraException", "GhidraOptions", "GhidraRun", "GhidraThreadGroup", "JShellRun", "JarRun", "SoftwareModelingInitializer", "MiscellaneousPluginPackage", "ProjectInitializer", "SwingExceptionHandler", "Ghidra", "GhidraApplicationLayout", "GhidraClassLoader", "GhidraJarApplicationLayout", "GhidraLaunchable", "GhidraLauncher", "GhidraTestApplicationLayout"]
