...
class DataTypeMapper(java.lang.AutoCloseable):
    ...
    def addArchiveSearchCategoryPath(self, *paths: ghidra.program.model.data.CategoryPath) -> None:
        """
    ...
    def addProgramSearchCategoryPath(self, *paths: ghidra.program.model.data.CategoryPath) -> None:
        """
        Adds category paths to a search list, used when looking for a data type.
    ...
    def registerStructure(self, clazz: java.lang.Class[T], context: DataTypeMapperContext) -> None:
        """
    ...
    def registerStructures(self, classes: java.util.List[java.lang.Class[typing.Any]], context: DataTypeMapperContext) -> None:
        """
...
class StructureMarkup(java.lang.Object, typing.Generic[T]):
    ...
    def additionalMarkup(self, session: MarkupSession) -> None:
        """
...
class MarkupSession(java.lang.Object):
    ...
    def __init__(self, programContext: DataTypeMapper, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def addReference(self, fieldContext: FieldContext[typing.Any], refDest: ghidra.program.model.address.Address) -> None:
        """
    ...
    @typing.overload
    def appendComment(self, fieldContext: FieldContext[typing.Any], commentType: ghidra.program.model.listing.CommentType, prefix: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str], sep: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def appendComment(self, structureContext: StructureContext[typing.Any], commentType: ghidra.program.model.listing.CommentType, prefix: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str], sep: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def appendComment(self, func: ghidra.program.model.listing.Function, prefix: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    @typing.overload
    def labelAddress(self, addr: ghidra.program.model.address.Address, symbolName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def labelAddress(self, addr: ghidra.program.model.address.Address, symbolName: typing.Union[java.lang.String, str], namespaceName: typing.Union[java.lang.String, str]) -> None:
        """
        Places a label at the specified address.
    ...
    def labelStructure(self, obj: T, symbolName: typing.Union[java.lang.String, str], namespaceName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def logWarningAt(self, addr: ghidra.program.model.address.Address, msg: typing.Union[java.lang.String, str]) -> None:
        ...

    @staticmethod
    @typing.overload
    def logWarningAt(program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, msg: typing.Union[java.lang.String, str]) -> None:
        ...

    def markup(self, obj: T, nested: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def markupAddress(self, addr: ghidra.program.model.address.Address, dt: ghidra.program.model.data.DataType, length: typing.Union[jpype.JInt, int]) -> None:
        """
        Applies the specified :obj:`DataType` to the specified :obj:`Address`.
    ...
    def markupArrayElementReferences(self, arrayAddr: ghidra.program.model.address.Address, elementSize: typing.Union[jpype.JInt, int], targetAddrs: java.util.List[ghidra.program.model.address.Address]) -> None:
        """
    ...
    def markupStructure(self, structureContext: StructureContext[T], nested: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class StructureContext(java.lang.Object, typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, dataTypeMapper: DataTypeMapper, mappingInfo: StructureMappingInfo[T], reader: ghidra.app.util.bin.BinaryReader) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dataTypeMapper: DataTypeMapper, mappingInfo: StructureMappingInfo[T], containingFieldDataType: ghidra.program.model.data.DataType, reader: ghidra.app.util.bin.BinaryReader) -> None:
        """
        Creates an instance of a :obj:`StructureContext`.
...
class StructureMappingInfo(java.lang.Object, typing.Generic[T]):
    ...
    def assignContextFieldValues(self, context: StructureContext[T]) -> None:
        """
    ...
    def readStructure(self, context: StructureContext[T]) -> None:
        """
...
class FieldMappingInfo(java.lang.Object, typing.Generic[T]):
    ...
    def addMarkupFunc(self, func: FieldMarkupFunction[T]) -> None:
        ...
    ...
    def assignField(self, fieldContext: FieldContext[T], value: java.lang.Object) -> None:
        ...
    ...
    def setFieldValueDeserializationInfo(self, fieldReadValueClass: java.lang.Class[FieldReadFunction], structTargetClass: java.lang.Class[typing.Any], setterNameOverride: typing.Union[java.lang.String, str]) -> None:
        ...
...
class FieldContext(java.lang.Record, typing.Generic[T]):
    ...
    def __init__(self, structureContext: StructureContext[T], fieldInfo: FieldMappingInfo[T], dtc: ghidra.program.model.data.DataTypeComponent, reader: ghidra.app.util.bin.BinaryReader) -> None:
        ...
...
class FieldMarkupFunction(java.lang.Object, typing.Generic[T]):
    ...
    def markupField(self, fieldContext: FieldContext[T], markupSession: MarkupSession) -> None:
        """
...
class FieldOutputInfo(java.lang.Object, typing.Generic[T]):
    ...
    def __init__(self, fmi: FieldMappingInfo[T], dataTypeName: typing.Union[java.lang.String, str], isVariableLength: typing.Union[jpype.JBoolean, bool], ordinal: typing.Union[jpype.JInt, int], fieldOffset: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def setOutputFuncClass(self, funcClass: java.lang.Class[FieldOutputFunction], getterName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class StructureMarkupFunction(java.lang.Object, typing.Generic[T]):
    ...
    def markupStructure(self, context: StructureContext[T], markupSession: MarkupSession) -> None:
        """
...
class FieldOutputFunction(java.lang.Object, typing.Generic[T]):
    ...
    def addFieldToStructure(self, context: StructureContext[T], structure: ghidra.program.model.data.Structure, fieldOutputInfo: FieldOutputInfo[T]) -> None:
        """
...
class ReflectionHelper(java.lang.Object):
    ...
    @staticmethod
    def assignField(field: java.lang.reflect.Field, obj: java.lang.Object, value: java.lang.Object) -> None:
        """
    ...
    @staticmethod
    def callSetter(obj: java.lang.Object, setterMethod: java.lang.reflect.Method, value: T) -> None:
        ...
    ...
    @staticmethod
    def invokeMethods(methods: java.util.List[java.lang.reflect.Method], obj: java.lang.Object, *params: java.lang.Object) -> None:
        ...
...
__all__ = ["DataTypeMapper", "DataTypeMapperContext", "StructureMarkup", "MarkupSession", "StructureContext", "StructureMappingInfo", "FieldMappingInfo", "FieldContext", "Signedness", "FieldMarkupFunction", "FieldReadFunction", "FieldOutputInfo", "StructureMarkupFunction", "FieldOutputFunction", "StructureVerifier", "StructureReader", "ReflectionHelper"]
