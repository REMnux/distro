...
class SourceFileRowObject(java.lang.Object):
    ...
    def __init__(self, sourceFile: ghidra.program.database.sourcemap.SourceFile, sourceManager: ghidra.program.model.sourcemap.SourceFileManager) -> None:
        """
        Constructor
...
class SourceFilesTableProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, sourceFilesPlugin: SourceFilesTablePlugin) -> None:
        """
        Constructor
...
class TransformerTableModel(docking.widgets.table.threaded.ThreadedTableModelStub[ghidra.program.model.sourcemap.SourcePathTransformRecord]):
    ...
    def __init__(self, plugin: SourceFilesTablePlugin) -> None:
        """
        Constructor
...
class SourceMapEntryRowObject(java.lang.Object):
    ...
    def __init__(self, baseAddress: ghidra.program.model.address.Address, lineNumber: typing.Union[jpype.JInt, int], length: typing.Union[jpype.JLong, int], count: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
...
__all__ = ["SourceFileRowObject", "SourceFilesTableModel", "SourceFilesTablePlugin", "SourceFilesTableProvider", "TransformerTableModel", "SourceMapEntryRowObject", "SourceMapEntryTableModel", "SourceMapEntryToAddressTableRowMapper", "SourceMapEntryToProgramLocationRowMapper"]
