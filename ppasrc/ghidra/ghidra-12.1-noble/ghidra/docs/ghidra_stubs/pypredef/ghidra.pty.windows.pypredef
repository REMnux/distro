...
class Handle(java.lang.AutoCloseable):
    ...
    def __init__(self, handle: com.sun.jna.platform.win32.WinNT.HANDLE) -> None:
        ...
...
class ConPty(ghidra.pty.Pty):
    ...
    def __init__(self, pipeToChild: Pipe, pipeFromChild: Pipe, pseudoConsoleHandle: PseudoConsoleHandle) -> None:
        ...
...
class PseudoConsoleHandle(Handle):
    ...
    def resize(self, rows: typing.Union[jpype.JShort, int], cols: typing.Union[jpype.JShort, int]) -> None:
        ...
...
class ConPtyParent(ConPtyEndpoint, ghidra.pty.PtyParent):
    ...
    def __init__(self, writeHandle: Handle, readHandle: Handle, pseudoConsoleHandle: PseudoConsoleHandle) -> None:
        ...
...
__all__ = ["Handle", "AnsiBufferedInputStream", "ConPty", "Pipe", "PseudoConsoleHandle", "ConPtyParent", "ConPtyEndpoint", "ConPtyChild", "ConPtyFactory", "HandleInputStream", "HandleOutputStream"]
