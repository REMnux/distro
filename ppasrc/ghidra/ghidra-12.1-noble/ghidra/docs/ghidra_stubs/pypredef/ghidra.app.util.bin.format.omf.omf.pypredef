...
class OmfComdatExternalSymbol(OmfExternalSymbol):
    ...
    class ExternalLookup(java.lang.Record):
        ...
        def __init__(self, nameIndex: typing.Union[jpype.JInt, int], type: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def loadNames(self, nameList: java.util.List[java.lang.String]) -> None:
        ...
...
class OmfExternalSymbol(ghidra.app.util.bin.format.omf.OmfRecord):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, isStatic: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class OmfSymbol(java.lang.Object):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], type: typing.Union[jpype.JInt, int], off: typing.Union[jpype.JLong, int], dT: typing.Union[jpype.JInt, int], bL: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def setSegmentRef(self, val: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class OmfFileHeader(ghidra.app.util.bin.format.omf.OmfRecord):
    ...
    @staticmethod
    def doLinking(startAddress: typing.Union[jpype.JLong, int], segments: java.util.List[OmfSegmentHeader], groups: java.util.List[OmfGroupRecord]) -> None:
        """
...
class OmfSegmentHeader(ghidra.app.util.bin.format.omf.OmfRecord):
    ...
    class SectionStream(java.io.InputStream):
        ...
        def __init__(self, reader: ghidra.app.util.bin.BinaryReader, log: ghidra.app.util.importer.MessageLog) -> None:
            ...
...
class OmfGroupRecord(ghidra.app.util.bin.format.omf.OmfRecord):
    ...
    def resolveNames(self, nameList: java.util.List[java.lang.String]) -> None:
        ...
...
class OmfFixupRecord(ghidra.app.util.bin.format.omf.OmfRecord):
    ...
    def setDataBlock(self, last: OmfData) -> None:
        """
...
class OmfNamesRecord(ghidra.app.util.bin.format.omf.OmfRecord):
    ...
    def appendNames(self, namelist: java.util.List[java.lang.String]) -> None:
        ...
...
__all__ = ["OmfComdatExternalSymbol", "OmfExternalSymbol", "OmfSymbol", "OmfComdefRecord", "OmfCommentRecord", "OmfData", "OmfEnumeratedData", "OmfFileHeader", "OmfSegmentHeader", "OmfGroupRecord", "OmfSymbolRecord", "OmfFixupRecord", "OmfIteratedData", "OmfLibraryRecord", "OmfModuleEnd", "OmfNamesRecord", "OmfRecordTypes", "OmfRecordFactory"]
