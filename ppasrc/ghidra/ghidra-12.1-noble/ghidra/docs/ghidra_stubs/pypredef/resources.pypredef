...
class IconProvider(java.lang.Object):
    ...
    def __init__(self, icon: javax.swing.Icon, url: java.net.URL) -> None:
        ...
...
class Icons(java.lang.Object):
    ...
    CLOSE_ICON: typing.Final[javax.swing.Icon]
...
class MultiIcon(javax.swing.Icon):
    ...
    @typing.overload
    def __init__(self, baseIcon: javax.swing.Icon, disabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new MultiIcon with an initial base icon that will always be drawn first.
    ...
    @typing.overload
    def __init__(self, baseIcon: javax.swing.Icon, *icons: javax.swing.Icon) -> None:
        """
    ...
    @typing.overload
    def __init__(self, baseIcon: javax.swing.Icon, disabled: typing.Union[jpype.JBoolean, bool], width: typing.Union[jpype.JInt, int], height: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def addIcon(self, icon: javax.swing.Icon) -> None:
        """
...
__all__ = ["IconProvider", "Icons", "MultiIcon", "MultiIconBuilder", "QUADRANT", "ResourceManager"]
