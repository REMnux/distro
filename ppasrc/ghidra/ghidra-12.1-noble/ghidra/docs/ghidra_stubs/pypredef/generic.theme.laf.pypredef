...
class LookAndFeelManager(java.lang.Object):
    ...
    def colorsChanged(self) -> None:
        """
        Called when one or more colors have changed.
        """

    def fontsChanged(self, changedFontIds: java.util.Set[java.lang.String]) -> None:
        """
    ...
    def iconsChanged(self, changedIconIds: java.util.Set[java.lang.String], newIcon: javax.swing.Icon) -> None:
        """
    ...
    def installCursorBlinkingProperties(self) -> None:
        ...

    def installLookAndFeel(self) -> None:
        """
    ...
    def resetAll(self, javaDefaults: generic.theme.GThemeValueMap) -> None:
        """
...
class ComponentFontRegistry(java.lang.Object):
    ...
    def __init__(self, fontId: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def addComponent(self, component: java.awt.Component) -> None:
        """
    ...
    @typing.overload
    def addComponent(self, component: java.awt.Component, fontStyle: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeComponent(self, component: java.awt.Component) -> None:
        """
    ...
    def updateComponentFonts(self) -> None:
        """
...
class UiDefaultsMapper(java.lang.Object):
    ...
    * Palette Keys - dynamically generated color palette keys based on the LaF for any colors
    ...
    def installValuesIntoUIDefaults(self, currentValues: generic.theme.GThemeValueMap) -> None:
        """
...
class FlatLookAndFeelManager(LookAndFeelManager):
    ...
    def __init__(self, laf: generic.theme.LafType, themeManager: generic.theme.ApplicationThemeManager) -> None:
        ...
...
class FontChangeListener(java.lang.Object):
    ...
    def fontChanged(self, fontId: typing.Union[java.lang.String, str], f: java.awt.Font) -> None:
        """
...
class FontNonUiResource(java.awt.Font):
    ...
    def __init__(self, font: java.awt.Font) -> None:
        ...
...
class GtkLookAndFeelManager(LookAndFeelManager):
    ...
    def __init__(self, themeManager: generic.theme.ApplicationThemeManager) -> None:
        ...
...
class MacLookAndFeelManager(LookAndFeelManager):
    ...
    class BackgroundBorder(javax.swing.border.EmptyBorder):
        ...
        def __init__(self, color: generic.theme.GColor) -> None:
            ...
...
__all__ = ["LookAndFeelManager", "ComponentFontRegistry", "UiDefaultsMapper", "CustomNimbusLookAndFeel", "FlatDarkUiDefaultsMapper", "FlatUiDefaultsMapper", "FlatLookAndFeelManager", "FontChangeListener", "FontNonUiResource", "GtkLookAndFeelManager", "MacLookAndFeelManager", "MetalLookAndFeelManager", "MotifLookAndFeelManager", "MotifUiDefaultsMapper", "NimbusLookAndFeelManager", "NimbusUiDefaultsMapper", "WindowsClassicLookAndFeelManager", "WindowsLookAndFeelManager"]
