...
class LcsSelectionEvent(java.lang.Object):
    ...
    def __init__(self, selection: ghidra.program.model.lang.LanguageCompilerSpecPair, type: LcsSelectionEvent.Type) -> None:
        ...
...
class NewLanguagePanel(javax.swing.JPanel):
    ...
    def addSelectionListener(self, listener: LcsSelectionListener) -> None:
        ...
    ...
    def removeSelectionListener(self, listener: LcsSelectionListener) -> None:
        ...

    def setAllLcsPairsList(self, allLcsPairsList: java.util.List[ghidra.program.model.lang.LanguageCompilerSpecPair]) -> None:
        ...

    def setFormatText(self, text: typing.Union[java.lang.String, str]) -> None:
        ...

    def setRecommendedLcsPair(self, lcsPair: ghidra.program.model.lang.LanguageCompilerSpecPair) -> None:
        ...

    def setRecommendedLcsPairsList(self, recommendedLcsPairsList: java.util.List[ghidra.program.model.lang.LanguageCompilerSpecPair]) -> None:
        ...

    def setSelectedLcsPair(self, lcsPair: ghidra.program.model.lang.LanguageCompilerSpecPair) -> bool:
        ...

    def setShowAllLcsPairs(self, show: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShowRecommendedCheckbox(self, show: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class LcsSelectionListener(java.lang.Object):
    ...
    def valueChanged(self, e: LcsSelectionEvent) -> None:
        ...
...
class ImporterDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, programManager: ghidra.app.services.ProgramManager, loaderMap: ghidra.app.util.opinion.LoaderMap, byteProvider: ghidra.app.util.bin.ByteProvider, suggestedDestinationPath: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def getDestinationFolder(self) -> ghidra.framework.model.DomainFolder:
        ...
    ...
    def destinationFolder(self, value: ghidra.framework.model.DomainFolder):
        ...
...
class ImporterLanguageDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, loadSpecs: collections.abc.Sequence, tool: ghidra.framework.plugintool.PluginTool, defaultSelectedLanguage: ghidra.program.model.lang.LanguageCompilerSpecPair) -> None:
        ...
...
class ImporterUtilities(java.lang.Object):
    ...
    @staticmethod
    def addContentToProgram(tool: ghidra.framework.plugintool.PluginTool, program: ghidra.program.model.listing.Program, fsrl: ghidra.formats.gfilesystem.FSRL, loadSpec: ghidra.app.util.opinion.LoadSpec, options: java.util.List[ghidra.app.util.Option], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
    ...
    @staticmethod
    def importSingleFile(tool: ghidra.framework.plugintool.PluginTool, programManager: ghidra.app.services.ProgramManager, fsrl: ghidra.formats.gfilesystem.FSRL, projectRootPath: typing.Union[java.lang.String, str], mirrorFsLayout: typing.Union[jpype.JBoolean, bool], loadSpec: ghidra.app.util.opinion.LoadSpec, importName: typing.Union[java.lang.String, str], options: java.util.List[ghidra.app.util.Option], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        ...
        :param java.lang.String or str projectRootPath: The project folder path that all imported things will be saved 
        relative to. If ``null``, "/" will be used.
        ...
        :param java.lang.String or str importName: The import name. Path information that appears at the beginning the name 
        will be appended to the ``projectRootPath`` during the saving process.
    ...
    @staticmethod
    @typing.overload
    def showImportDialog(tool: ghidra.framework.plugintool.PluginTool, programManager: ghidra.app.services.ProgramManager, fsrl: ghidra.formats.gfilesystem.FSRL, destinationFolder: ghidra.framework.model.DomainFolder, suggestedPath: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def showImportDialog(tool: ghidra.framework.plugintool.PluginTool, programManager: ghidra.app.services.ProgramManager, fsrl: ghidra.formats.gfilesystem.FSRL, destinationFolder: ghidra.framework.model.DomainFolder, suggestedPath: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Displays the appropriate import dialog for the specified :obj:`file <FSRL>`.
    ...
    @staticmethod
    def showImportSingleFileDialog(fsrl: ghidra.formats.gfilesystem.FSRL, destinationFolder: ghidra.framework.model.DomainFolder, suggestedPath: typing.Union[java.lang.String, str], tool: ghidra.framework.plugintool.PluginTool, programManager: ghidra.app.services.ProgramManager, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @staticmethod
    def showLoadLibrariesDialog(program: ghidra.program.model.listing.Program, tool: ghidra.framework.plugintool.PluginTool, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Constructs a :obj:`LoadLibrariesOptionsDialog` and shows it in the swing thread. If the 
        given :obj:`Program` does not support library loading, a warning message will be shown
        instead.
        
        :param ghidra.program.model.listing.Program program: The :obj:`Program`
        :param ghidra.framework.plugintool.PluginTool tool: The :obj:`PluginTool`
        :param ghidra.util.task.TaskMonitor monitor: :obj:`TaskMonitor`
        """
...
class LoadLibrariesOptionsDialog(ghidra.app.util.OptionsDialog):
    ...
    def __init__(self, provider: ghidra.app.util.bin.ByteProvider, program: ghidra.program.model.listing.Program, tool: ghidra.framework.plugintool.PluginTool, loadSpec: ghidra.app.util.opinion.LoadSpec, addressFactoryService: ghidra.app.util.AddressFactoryService) -> None:
        """
...
class ProjectIndexService(ghidra.framework.model.DomainFolderChangeListener, java.lang.AutoCloseable):
    ...
    def addIndexListener(self, listener: ProjectIndexService.ProjectIndexListener) -> None:
        ...
    ...
    @staticmethod
    def projectClosed(project: ghidra.framework.model.Project) -> None:
        """
    ...
    def removeIndexListener(self, listener: ProjectIndexService.ProjectIndexListener) -> None:
        ...



__all__ = ["LcsSelectionEvent", "NewLanguagePanel", "LcsSelectionListener", "LanguageSortedTableModel", "AddToProgramDialog", "ImporterDialog", "ImporterLanguageDialog", "ImporterPlugin", "ImporterUtilities", "LoadLibrariesOptionsDialog", "ProjectIndexService"]
