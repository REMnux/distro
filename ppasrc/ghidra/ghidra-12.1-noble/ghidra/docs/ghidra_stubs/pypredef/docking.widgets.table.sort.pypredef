...
class ColumnRenderedValueBackupComparator(java.util.Comparator[java.lang.Object], typing.Generic[T]):
    ...
    def __init__(self, model: docking.widgets.table.DynamicColumnTableModel[T], sortColumn: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class RowBasedColumnComparator(java.util.Comparator[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, model: docking.widgets.table.RowObjectTableModel[T], sortColumn: typing.Union[jpype.JInt, int], comparator: java.util.Comparator[java.lang.Object]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, model: docking.widgets.table.RowObjectTableModel[T], sortColumn: typing.Union[jpype.JInt, int], comparator: java.util.Comparator[java.lang.Object], backupRowComparator: java.util.Comparator[java.lang.Object]) -> None:
        """
...
__all__ = ["ColumnRenderedValueBackupComparator", "DefaultColumnComparator", "RowBasedColumnComparator"]
