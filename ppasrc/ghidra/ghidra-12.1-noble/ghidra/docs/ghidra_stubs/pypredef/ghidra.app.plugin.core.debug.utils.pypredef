...
class BackgroundUtils(java.lang.Enum[BackgroundUtils]):
    ...
    class PluginToolExecutorService(java.util.concurrent.AbstractExecutorService):
        ...
        def __init__(self, tool: ghidra.framework.plugintool.PluginTool, name: typing.Union[java.lang.String, str], obj: ghidra.framework.model.DomainObject, delay: typing.Union[jpype.JInt, int], *opts: BackgroundUtils.PluginToolExecutorService.TaskOpt) -> None:
            ...
...
class AbstractMappedMemoryBytesVisitor(java.lang.Object):
    ...
    def __init__(self, mappingService: ghidra.app.services.DebuggerStaticMappingService, buffer: jpype.JArray[jpype.JByte]) -> None:
        """
...
class DefaultTransactionCoalescer(TransactionCoalescer, typing.Generic[T, U]):
    ...
    def __init__(self, obj: T, factory: TransactionCoalescer.TxFactory[T, U], delayMs: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ManagedDomainObject(java.lang.AutoCloseable):
    ...
    def __init__(self, file: ghidra.framework.model.DomainFile, okToUpgrade: typing.Union[jpype.JBoolean, bool], okToRecover: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class MiscellaneousUtils(java.lang.Enum[MiscellaneousUtils]):
    ...
    @staticmethod
    def rigFocusAndEnter(c: java.awt.Component, runnable: java.lang.Runnable) -> None:
        ...
...
__all__ = ["DebouncedRowWrappedEnumeratedColumnTableModel", "BackgroundUtils", "AbstractMappedMemoryBytesVisitor", "DefaultTransactionCoalescer", "TransactionCoalescer", "ManagedDomainObject", "MiscellaneousUtils", "ProgramLocationUtils", "ProgramURLUtils"]
