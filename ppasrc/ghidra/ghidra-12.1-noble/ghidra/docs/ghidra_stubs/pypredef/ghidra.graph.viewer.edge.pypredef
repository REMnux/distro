...
class VisualGraphPathHighlighter(java.lang.Object, typing.Generic[V, E]):
    ...
    * *All public methods are assumed to be called on the Swing thread
    ...
    def __init__(self, graph: ghidra.graph.VisualGraph[V, E], listener: PathHighlightListener) -> None:
        ...
    ...
    def setFocusedVertex(self, focusedVertex: V) -> None:
        ...

    def setHoveredVertex(self, hoveredVertex: V) -> None:
        ...
    ...
    def setWorkPauser(self, pauser: PathHighlighterWorkPauser) -> None:
        """
...
class PathHighlightListener(java.lang.Object):
    ...
    def pathHighlightChanged(self, hoverChange: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class VisualEdgeRenderer(edu.uci.ics.jung.visualization.renderers.BasicEdgeRenderer[V, E], typing.Generic[V, E]):
    ...
    ********************
    ...
    def setDashingPatternOffset(self, dashingPatterOffset: typing.Union[jpype.JFloat, float]) -> None:
        """
    ...
    def setDrawColorTransformer(self, transformer: com.google.common.base.Function[E, java.awt.Color]) -> None:
        """
    ...
    def setFocusedColorTransformer(self, transformer: com.google.common.base.Function[E, java.awt.Color]) -> None:
        """
    ...
    def setHoveredColorTransformer(self, transformer: com.google.common.base.Function[E, java.awt.Color]) -> None:
        """
    ...
    def setSelectedColorTransformer(self, transformer: com.google.common.base.Function[E, java.awt.Color]) -> None:
        """
...
class VisualGraphEdgeSatelliteRenderer(VisualEdgeRenderer[V, E], typing.Generic[V, E]):
    ...
    def __init__(self, delegate: VisualEdgeRenderer[V, E]) -> None:
        ...
...
class VisualGraphEdgeStrokeTransformer(com.google.common.base.Function[E, java.awt.Stroke], typing.Generic[V, E]):
    ...
    def __init__(self, pickedInfo: edu.uci.ics.jung.visualization.picking.PickedInfo[E], pickedStrokeSize: typing.Union[jpype.JInt, int]) -> None:
        ...



__all__ = ["VisualGraphPathHighlighter", "PathHighlightListener", "PathHighlighterWorkPauser", "AbstractVisualEdge", "BasicEdgeLabelRenderer", "VisualEdgeArrowRenderingSupport", "VisualEdgeRenderer", "VisualGraphEdgeSatelliteRenderer", "VisualGraphEdgeStrokeTransformer"]
