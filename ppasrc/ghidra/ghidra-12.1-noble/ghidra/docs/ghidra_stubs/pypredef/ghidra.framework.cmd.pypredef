...
class BackgroundCommand(Command[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], hasProgress: typing.Union[jpype.JBoolean, bool], canCancel: typing.Union[jpype.JBoolean, bool], isModal: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def run(self, tool: ghidra.framework.plugintool.PluginTool, obj: T) -> None:
        ...
...
class CompoundBackgroundCommand(BackgroundCommand[T], typing.Generic[T]):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], modal: typing.Union[jpype.JBoolean, bool], canCancel: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
    ...
    def add(self, cmd: Command[T]) -> None:
        """
...
__all__ = ["BinaryAnalysisCommand", "Command", "BackgroundCommand", "CompoundBackgroundCommand", "CompoundCmd", "MergeableBackgroundCommand"]
