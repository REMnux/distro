...
class EditReferenceDialog(docking.ReusableDialogComponentProvider):
    ...
    def initDialog(self, cu: ghidra.program.model.listing.CodeUnit, opIndex: typing.Union[jpype.JInt, int], subIndex: typing.Union[jpype.JInt, int], ref: ghidra.program.model.symbol.Reference) -> None:
        ...
...
class InstructionPanelListener(java.lang.Object):
    ...
    def operandSelected(self, opIndex: typing.Union[jpype.JInt, int], subIndex: typing.Union[jpype.JInt, int]) -> None:
        ...

    def selectionDropped(self, set: ghidra.program.model.address.AddressSetView, cu: ghidra.program.model.listing.CodeUnit, opIndex: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class OffsetTableDialog(docking.DialogComponentProvider):
    ...
    def setBaseAddress(self, address: ghidra.program.model.address.Address) -> None:
        ...
...
__all__ = ["CreateDefaultReferenceAction", "ReferencesPlugin", "DeleteReferencesAction", "EditReferencesProvider", "EditReferenceDialog", "ExternalReferencesProvider", "InstructionPanel", "EditMemoryReferencePanel", "EditReferencePanel", "EditExternalReferencePanel", "EditStackReferencePanel", "EditRegisterReferencePanel", "InstructionPanelListener", "EditReferencesModel", "OffsetTableDialog", "OffsetTablePlugin", "ParameterConflictException", "ReservedNameException"]
