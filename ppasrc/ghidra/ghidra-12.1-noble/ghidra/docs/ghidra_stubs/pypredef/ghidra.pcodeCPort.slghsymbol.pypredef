...
class Constructor(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, p: SubtableSymbol) -> None:
        ...

    def addContext(self, vec: generic.stl.VectorSTL[ContextChange]) -> None:
        ...

    def addEquation(self, pe: ghidra.pcodeCPort.slghpatexpress.PatternEquation) -> None:
        ...

    def addInvisibleOperand(self, sym: OperandSymbol) -> None:
        ...

    def addOperand(self, sym: OperandSymbol) -> None:
        ...

    def addSyntax(self, syn: typing.Union[java.lang.String, str]) -> None:
        ...

    def collectLocalExports(self, results: java.util.ArrayList[java.lang.Long]) -> None:
        ...
    ...
    def markSubtableOperands(self, check: generic.stl.VectorSTL[java.lang.Integer]) -> None:
        ...

    def printInfo(self, s: java.io.PrintStream) -> None:
        ...

    def removeTrailingSpace(self) -> None:
        ...

    def setError(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setId(self, i: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setMainSection(self, tpl: ghidra.pcodeCPort.semantics.ConstructTpl) -> None:
        ...

    def setMinimumLength(self, l: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setNamedSection(self, tpl: ghidra.pcodeCPort.semantics.ConstructTpl, id: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setSourceFileIndex(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
...
class SubtableSymbol(TripleSymbol):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str]) -> None:
        ...

    def addConstructor(self, ct: Constructor) -> None:
        ...

    def buildDecisionTree(self, props: DecisionProperties) -> None:
        ...
...
class TripleSymbol(SleighSymbol):
    ...
    def collectLocalValues(self, results: java.util.ArrayList[java.lang.Long]) -> None:
        ...
...
class SleighSymbol(java.lang.Object):
    ...
    def setWasSought(self, wasSought: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class OperandSymbol(SpecificSymbol):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], index: typing.Union[jpype.JInt, int], ct: Constructor) -> None:
        ...
    ...
    @typing.overload
    def defineOperand(self, pe: ghidra.pcodeCPort.slghpatexpress.PatternExpression) -> None:
        ...

    @typing.overload
    def defineOperand(self, tri: TripleSymbol) -> None:
        ...
...
class DecisionNode(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, p: DecisionNode) -> None:
        ...

    def addConstructorPair(self, pat: ghidra.pcodeCPort.slghpattern.DisjointPattern, ct: Constructor) -> None:
        ...

    def dispose(self) -> None:
        ...

    def orderPatterns(self, props: DecisionProperties) -> None:
        ...
...
class DecisionProperties(java.lang.Object):
    ...
    def conflictingPattern(self, pa: ghidra.pcodeCPort.slghpattern.DisjointPattern, a: Constructor, pb: ghidra.pcodeCPort.slghpattern.DisjointPattern, b: Constructor) -> None:
        ...
    ...
    def identicalPattern(self, a: Constructor, b: Constructor) -> None:
        ...
...
class VarnodeSymbol(PatternlessSymbol):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], base: ghidra.pcodeCPort.space.AddrSpace, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class SymbolTable(java.lang.Object):
    ...
    def addGlobalSymbol(self, a: SleighSymbol) -> None:
        ...
    ...
    def replaceSymbol(self, a: SleighSymbol, b: SleighSymbol) -> None:
        ...

    def setCurrentScope(self, scope: SymbolScope) -> None:
        ...
...
class SymbolScope(java.lang.Object):
    ...
    def __init__(self, p: SymbolScope, i: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def removeSymbol(self, a: SleighSymbol) -> None:
        ...
...
class SectionSymbol(SleighSymbol):
    ...
    def __init__(self, loc: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], id: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class MacroSymbol(SleighSymbol):
    ...
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], i: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def setConstruct(self, ct: ghidra.pcodeCPort.semantics.ConstructTpl) -> None:
        ...
...
class TokenSymbol(SleighSymbol):
    ...
    def __init__(self, location: ghidra.sleigh.grammar.Location, t: ghidra.pcodeCPort.context.Token) -> None:
        ...
...
class SpaceSymbol(SleighSymbol):
    ...
    def __init__(self, location: ghidra.sleigh.grammar.Location, spc: ghidra.pcodeCPort.space.AddrSpace) -> None:
        ...
...
class ContextSymbol(ValueSymbol):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], pate: ghidra.pcodeCPort.slghpatexpress.ContextField, v: VarnodeSymbol, l: typing.Union[jpype.JInt, int], h: typing.Union[jpype.JInt, int], flow: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ValueSymbol(FamilySymbol):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], pv: ghidra.pcodeCPort.slghpatexpress.PatternValue) -> None:
        ...
...
class UserOpSymbol(SleighSymbol):
    ...
    def setIndex(self, ind: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ValueMapSymbol(ValueSymbol):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], pv: ghidra.pcodeCPort.slghpatexpress.PatternValue, vt: generic.stl.VectorSTL[java.lang.Long]) -> None:
        ...
...
class NameSymbol(ValueSymbol):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], pv: ghidra.pcodeCPort.slghpatexpress.PatternValue, nt: generic.stl.VectorSTL[java.lang.String]) -> None:
        ...
...
class BitrangeSymbol(SleighSymbol):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], sym: VarnodeSymbol, bitoff: typing.Union[jpype.JInt, int], num: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class VarnodeListSymbol(ValueSymbol):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], pv: ghidra.pcodeCPort.slghpatexpress.PatternValue, vt: generic.stl.VectorSTL[SleighSymbol]) -> None:
        ...
...
class StartSymbol(SpecificSymbol):
    ...
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], cspc: ghidra.pcodeCPort.space.AddrSpace) -> None:
        ...
...
class ContextCommit(ContextChange):
    ...
    @typing.overload
    def __init__(self, s: TripleSymbol, sbit: typing.Union[jpype.JInt, int], ebit: typing.Union[jpype.JInt, int], fl: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ContextOp(ContextChange):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, startbit: typing.Union[jpype.JInt, int], endbit: typing.Union[jpype.JInt, int], pe: ghidra.pcodeCPort.slghpatexpress.PatternExpression) -> None:
        ...
...
class EpsilonSymbol(PatternlessSymbol):
    ...
    @typing.overload
    def __init__(self, location: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], spc: ghidra.pcodeCPort.space.AddrSpace) -> None:
        ...
...
__all__ = ["Constructor", "SubtableSymbol", "TripleSymbol", "SleighSymbol", "OperandSymbol", "SpecificSymbol", "ContextChange", "symbol_type", "DecisionNode", "DecisionProperties", "VarnodeSymbol", "PatternlessSymbol", "SymbolTable", "SymbolScope", "SymbolTree", "SectionSymbol", "MacroSymbol", "TokenSymbol", "SpaceSymbol", "ContextSymbol", "ValueSymbol", "FamilySymbol", "LabelSymbol", "UserOpSymbol", "ValueMapSymbol", "NameSymbol", "BitrangeSymbol", "VarnodeListSymbol", "StartSymbol", "EndSymbol", "Next2Symbol", "ContextCommit", "ContextOp", "EpsilonSymbol", "FlowDestSymbol", "FlowRefSymbol", "SymbolCompare"]
