...
class OperandLabelDialog(docking.DialogComponentProvider):
    ...
    def setOperandLabel(self, context: ghidra.app.context.ListingActionContext) -> None:
        ...
...
class LabelHistoryDialog(docking.DialogComponentProvider, LabelHistoryListener):
    ...
    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, list: java.util.List[ghidra.program.model.symbol.LabelHistory]) -> None:
        ...

    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, program: ghidra.program.model.listing.Program, title: typing.Union[java.lang.String, str], list: java.util.List[ghidra.program.model.symbol.LabelHistory]) -> None:
        ...
...
class LabelHistoryListener(java.lang.Object):
    ...
    def addressSelected(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address) -> None:
        """
...
__all__ = ["AddLabelAction", "LabelMgrPlugin", "OperandLabelDialog", "AllHistoryAction", "EditExternalLabelAction", "EditLabelAction", "LabelHistoryAction", "LabelHistoryDialog", "LabelHistoryListener", "LabelHistoryInputDialog", "LabelHistoryTask", "LabelHistoryPanel", "LabelHistoryTableModel", "RemoveLabelAction", "SetOperandLabelAction"]
