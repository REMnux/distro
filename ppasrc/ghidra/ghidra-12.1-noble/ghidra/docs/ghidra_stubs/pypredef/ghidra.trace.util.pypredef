...
class TraceChangeManager(java.lang.Object):
    ...
    def setChanged(self, event: TraceChangeRecord[typing.Any, typing.Any]) -> None:
        ...
...
class OverlappingObjectIterator(generic.util.AbstractPeekableIterator[org.apache.commons.lang3.tuple.Pair[L, R]], typing.Generic[L, R]):
    ...
    **WARNING:** To avoid heap pollution, this iterator re-uses the same :obj:`Pair` on each call
    ...
    def __init__(self, left: java.util.Iterator[L], leftRanger: OverlappingObjectIterator.Ranger[L], right: java.util.Iterator[R], rightRanger: OverlappingObjectIterator.Ranger[R]) -> None:
        ...
...
class TraceChangeRecord(ghidra.framework.model.DomainObjectChangeRecord, typing.Generic[T, U]):
    ...
    @typing.overload
    def __init__(self, type: TraceEvent[T, U], space: ghidra.program.model.address.AddressSpace, affectedObject: T, oldValue: U, newValue: U) -> None:
        ...

    @typing.overload
    def __init__(self, type: TraceEvent[T, U], space: ghidra.program.model.address.AddressSpace, affectedObject: T, newValue: U) -> None:
        ...

    @typing.overload
    def __init__(self, type: TraceEvent[T, U], space: ghidra.program.model.address.AddressSpace, affectedObject: T) -> None:
        ...

    @typing.overload
    def __init__(self, type: TraceEvent[T, U], space: ghidra.program.model.address.AddressSpace) -> None:
        ...
...
class TypedEventDispatcher(java.lang.Object):
    ...
    class EventRecordHandler(java.lang.Object, typing.Generic[T, U]):
        ...
        def handle(self, record: TraceChangeRecord[T, U]) -> None:
            ...
    ...
    class FullEventRecordHandler(TypedEventDispatcher.EventRecordHandler[T, U], typing.Generic[T, U]):
        ...
        def handle(self, space: ghidra.program.model.address.AddressSpace, affectedObject: T, oldValue: U, newValue: U) -> None:
            ...
    ...
    class AffectedObjectHandler(TypedEventDispatcher.EventRecordHandler[T, java.lang.Void], typing.Generic[T]):
        ...
        def handle(self, space: ghidra.program.model.address.AddressSpace, affectedObject: T) -> None:
            ...
    ...
    class AffectedObjectOnlyHandler(TypedEventDispatcher.EventRecordHandler[T, java.lang.Void], typing.Generic[T]):
        ...
        def handle(self, affectedObject: T) -> None:
            ...
    ...
    class AffectedAndValuesOnlyHandler(TypedEventDispatcher.EventRecordHandler[T, U], typing.Generic[T, U]):
        ...
        def handle(self, affectedObject: T, oldValue: U, newValue: U) -> None:
            ...
    ...
    class SpaceValuesHandler(TypedEventDispatcher.EventRecordHandler[java.lang.Void, U], typing.Generic[U]):
        ...
        def handle(self, space: ghidra.program.model.address.AddressSpace, oldValue: U, newValue: U) -> None:
            ...
    ...
    class ValuesOnlyHandler(TypedEventDispatcher.EventRecordHandler[java.lang.Void, U], typing.Generic[U]):
        ...
        def handle(self, oldValue: U, newValue: U) -> None:
            ...
    ...
    class IgnoreValuesHandler(TypedEventDispatcher.EventRecordHandler[java.lang.Object, java.lang.Object]):
        ...
        def handle(self, space: ghidra.program.model.address.AddressSpace) -> None:
            ...
    ...
    def handleChangeRecord(self, rec: ghidra.framework.model.DomainObjectChangeRecord) -> None:
        ...

    def handleTraceChangeRecord(self, rec: TraceChangeRecord[typing.Any, typing.Any]) -> None:
        ...
...
class MethodProtector(java.lang.Object):
    ...
    def avoid(self, callable: MethodProtector.TemperamentalCallable[E]) -> None:
        ...

    def take(self, callable: MethodProtector.TemperamentalCallable[E]) -> None:
        ...
...
class EnumeratingIterator(java.util.Iterator[T], typing.Generic[T]):
    ...
    class WrappingEnumeratingIterator(EnumeratingIterator[T], typing.Generic[T]):
        ...
        def __init__(self, it: java.util.Iterator[T]) -> None:
            ...
...
class TraceRegisterUtils(java.lang.Enum[TraceRegisterUtils]):
    ...
    @staticmethod
    def requireByteBound(register: ghidra.program.model.lang.Register) -> None:
        ...
...
class TraceViewportSpanIterator(generic.util.AbstractPeekableIterator[ghidra.trace.model.Lifespan]):
    ...
    def __init__(self, trace: ghidra.trace.model.Trace, snap: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class WrappingCodeUnitIterator(ghidra.program.model.listing.CodeUnitIterator):
    ...
    def __init__(self, it: java.util.Iterator[ghidra.program.model.listing.CodeUnit]) -> None:
        ...
...
class WrappingDataIterator(ghidra.program.model.listing.DataIterator):
    ...
    def __init__(self, it: java.util.Iterator[ghidra.program.model.listing.Data]) -> None:
        ...
...
class WrappingFunctionIterator(ghidra.program.model.listing.FunctionIterator):
    ...
    @typing.overload
    def __init__(self, it: java.util.Iterator[ghidra.program.model.listing.Function]) -> None:
        ...
...
class WrappingInstructionIterator(ghidra.program.model.listing.InstructionIterator):
    ...
    def __init__(self, it: java.util.Iterator[ghidra.program.model.listing.Instruction]) -> None:
        ...



__all__ = ["CopyOnWrite", "TraceChangeManager", "TraceSpaceMixin", "OverlappingObjectIterator", "TraceChangeRecord", "TypedEventDispatcher", "TraceEvent", "MemoryAdapter", "DataAdapterMinimal", "DataAdapterFromDataType", "DataAdapterFromSettings", "InstructionAdapterFromPrototype", "MethodProtector", "ByteArrayUtils", "EmptyFunctionIterator", "EnumeratingIterator", "TraceEvents", "TraceRegisterUtils", "TraceViewportSpanIterator", "WrappingCodeUnitIterator", "WrappingDataIterator", "WrappingFunctionIterator", "WrappingInstructionIterator"]
