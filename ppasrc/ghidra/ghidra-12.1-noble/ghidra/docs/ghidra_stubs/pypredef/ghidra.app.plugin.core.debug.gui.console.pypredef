...
class DebuggerConsoleProvider(ghidra.framework.plugintool.ComponentProviderAdapter, docking.actions.PopupActionProvider):
    ...
    class BoundAction(java.lang.Object):
        ...
        def __init__(self, action: docking.action.DockingActionIf, context: docking.ActionContext) -> None:
            ...
    ...
    class MessageLogRow(java.lang.Record, DebuggerConsoleProvider.LogRow[java.lang.String]):
        ...
        def __init__(self, icon: javax.swing.Icon, message: typing.Union[java.lang.String, str], date: java.util.Date, error: java.lang.Throwable, actionContext: docking.ActionContext, actions: DebuggerConsoleProvider.ActionList) -> None:
            ...
    ...
    class MonitorLogRow(java.lang.Record, DebuggerConsoleProvider.LogRow[ghidra.debug.api.progress.MonitorReceiver]):
        ...
        def __init__(self, message: ghidra.debug.api.progress.MonitorReceiver, date: java.util.Date, actionContext: docking.ActionContext, actions: DebuggerConsoleProvider.ActionList) -> None:
            ...
    ...
    class LogTable(ghidra.util.table.GhidraTable):
        ...
        def __init__(self, model: DebuggerConsoleProvider.LogTableModel) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, plugin: DebuggerConsolePlugin) -> None:
        ...
...
class MonitorRowConsoleActionContext(docking.DefaultActionContext):
    ...
    def __init__(self, monitor: ghidra.debug.api.progress.MonitorReceiver) -> None:
        ...
...
__all__ = ["DebuggerConsoleProvider", "ConsoleActionsCellEditor", "DebuggerConsolePlugin", "MonitorRowConsoleActionContext", "ConsoleActionsCellRenderer", "HtmlOrProgressCellRenderer", "MonitorCellRenderer", "LogRowConsoleActionContext"]
