...
class CliAbstractSig(CliBlob, ghidra.app.util.bin.format.pe.cli.CliRepresentable):
    ...
    class CliSigType(ghidra.app.util.bin.format.pe.cli.CliRepresentable):
        ...
        def __init__(self, typeCode: CliAbstractSig.CliElementType) -> None:
            ...
    ...
    class CliTypeArray(CliAbstractSig.CliSigType):
        ...
        def __init__(self, reader: ghidra.app.util.bin.BinaryReader, typeCode: CliAbstractSig.CliElementType) -> None:
            ...
    ...
    class CliTypeBase(ghidra.app.util.bin.format.pe.cli.CliRepresentable):
        ...
        def __init__(self, reader: ghidra.app.util.bin.BinaryReader, isRetType: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def __init__(self, blob: CliBlob) -> None:
        ...
...
class CliBlob(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, streamIndex: typing.Union[jpype.JInt, int], reader: ghidra.app.util.bin.BinaryReader) -> None:
        """
...
class CliBlobCustomAttrib(CliBlob):
    ...
    class CliFixedArg(java.lang.Object):
        ...
        def __init__(self, elem: CliAbstractSig.CliElementType, value: java.lang.Object) -> None:
            ...
    ...
    class CliNamedArg(java.lang.Object):
        ...
        def __init__(self, fieldOrProp: typing.Union[jpype.JInt, int], fieldOrPropType: CliAbstractSig.CliElementType, fieldOrPropName: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    def __init__(self, blob: CliBlob, row: ghidra.app.util.bin.format.pe.cli.tables.CliTableCustomAttribute.CliCustomAttributeRow, metadataStream: ghidra.app.util.bin.format.pe.cli.streams.CliStreamMetadata) -> None:
        ...
...
class CliSigConstant(CliAbstractSig):
    ...
    def __init__(self, blob: CliBlob, elementType: CliAbstractSig.CliElementType) -> None:
        ...
...
__all__ = ["CliAbstractSig", "CliBlob", "CliBlobCustomAttrib", "CliBlobMarshalSpec", "CliSigAssembly", "CliSigAssemblyRef", "CliSigConstant", "CliSigField", "CliSigLocalVar", "CliSigMethodDef", "CliSigMethodRef", "CliSigMethodSpec", "CliSigProperty", "CliSigStandAloneMethod", "CliSigTypeSpec"]
