...
class GList(javax.swing.JList[T], docking.widgets.GComponent, typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, listData: jpype.JArray[T]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, listData: java.util.Vector[T]) -> None:
        """
        Constructs a ``GhidraList`` that displays the elements in
    ...
    @typing.overload
    def __init__(self, dataModel: javax.swing.ListModel[T]) -> None:
        """
...
class ListPanel(javax.swing.JPanel, typing.Generic[T]):
    ...
    def addListSelectionListener(self, listener: javax.swing.event.ListSelectionListener) -> None:
        """
    ...
    def ensureIndexIsVisible(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def issueWarning(self, msg: typing.Union[java.lang.String, str], title: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def refreshList(self, dataList: jpype.JArray[T]) -> None:
        """
    ...
    def removeListSelectionListener(self, listener: javax.swing.event.ListSelectionListener) -> None:
        """
    ...
    def setCellRenderer(self, r: javax.swing.ListCellRenderer[T]) -> None:
        """
    ...
    def setDoubleClickActionListener(self, listener: java.awt.event.ActionListener) -> None:
        """
    ...
    def setKeyListener(self, l: java.awt.event.KeyListener) -> None:
        ...

    def setListData(self, data: jpype.JArray[T]) -> None:
        """
        Sets the list data
    ...
    def setListModel(self, listModel: javax.swing.ListModel[T]) -> None:
        """
    ...
    def setListSelectionListener(self, listener: javax.swing.event.ListSelectionListener) -> None:
        """
    ...
    def setListTitle(self, listTitle: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setMouseListener(self, l: java.awt.event.MouseListener) -> None:
        """
    ...
    def setSelectedIndex(self, i: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setSelectedValue(self, item: T) -> None:
        """
        Selects the item.
...
class GListAutoLookup(docking.widgets.AutoLookup, typing.Generic[T]):
    ...
    def __init__(self, list: GList[T]) -> None:
        ...
...
__all__ = ["GList", "GListCellRenderer", "ListPanel", "GComboBoxCellRenderer", "GListAutoLookup", "ListRendererMouseEventForwarder"]
