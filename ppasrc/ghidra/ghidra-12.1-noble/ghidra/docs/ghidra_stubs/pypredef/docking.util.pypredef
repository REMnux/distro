...
class AnimationPainter(java.lang.Object):
    ...
    def paint(self, glassPane: ghidra.util.bean.GGlassPane, graphics: java.awt.Graphics, value: typing.Union[jpype.JDouble, float]) -> None:
        """
...
class AnimatedIcon(javax.swing.Icon):
    ...
    def __init__(self, icons: java.util.List[javax.swing.Icon], frameDelay: typing.Union[jpype.JInt, int], framesToSkip: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class AnimationRunner(java.lang.Object):
    ...
    def setCurrentValue(self, value: typing.Union[java.lang.Double, float]) -> None:
        """
    ...
    def setDoneCallback(self, c: utility.function.Callback) -> None:
        """
    ...
    def setPainter(self, animationPainter: AnimationPainter) -> None:
        """
    ...
    def setRemovePainterWhenFinished(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setValues(self, *values: typing.Union[java.lang.Double, float]) -> None:
        """
...
class AnimationUtils(java.lang.Object):
    ...
    class SwingAnimationCallbackDriver(java.lang.Object):
        ...
        def setPercentComplete(self, percent: typing.Union[jpype.JDouble, float]) -> None:
            ...
    ...
    class ShakeDriver(java.lang.Object):
        ...
        def setEmphasis(self, emphasis: typing.Union[jpype.JDouble, float]) -> None:
            ...
    ...
    @staticmethod
    def setAnimationEnabled(enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class SwingAnimationCallback(java.lang.Object):
    ...
    def progress(self, percentComplete: typing.Union[jpype.JDouble, float]) -> None:
        """
...
class GGlassPaneMessage(java.lang.Object):
    ...
    def setHideDelay(self, duration: java.time.Duration) -> None:
        """
    ...
    def showBottomMessage(self, newMessage: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def showCenteredMessage(self, newMessage: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def showMessage(self, newMessage: typing.Union[java.lang.String, str], painter: AnimationPainter) -> None:
        ...
...
class GraphicsUtils(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def drawString(c: javax.swing.JComponent, g: java.awt.Graphics, text: typing.Union[java.lang.String, str], x: typing.Union[jpype.JInt, int], y: typing.Union[jpype.JInt, int]) -> None:
        ...

    @staticmethod
    @typing.overload
    def drawString(c: javax.swing.JComponent, g2d: java.awt.Graphics2D, text: typing.Union[java.lang.String, str], x: typing.Union[jpype.JInt, int], y: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class TextShaper(java.lang.Object):
    ...
    def __init__(self, text: typing.Union[java.lang.String, str], displaySize: java.awt.Dimension, g2d: java.awt.Graphics2D) -> None:
        """
    ...
    def drawText(self, g: java.awt.Graphics2D) -> None:
        """
...
__all__ = ["AnimationPainter", "AnimatedIcon", "AnimationRunner", "AnimationUtils", "SwingAnimationCallback", "GGlassPaneMessage", "GraphicsUtils", "TextShaper"]
