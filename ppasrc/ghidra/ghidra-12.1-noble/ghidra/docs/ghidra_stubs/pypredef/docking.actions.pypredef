...
class ToolActions(DockingToolActions, java.beans.PropertyChangeListener):
    ...
    def __init__(self, tool: docking.Tool, actionToGuiHelper: docking.ActionToGuiHelper) -> None:
        """
    ...
    def optionsRebuilt(self) -> None:
        ...

    def registerSharedActionPlaceholder(self, placeholder: SharedDockingActionPlaceholder) -> None:
        """
...
class DockingToolActions(java.lang.Object):
    ...
    def addGlobalAction(self, action: docking.action.DockingActionIf) -> None:
        """
    ...
    @typing.overload
    def removeActions(self, owner: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def removeActions(self, provider: docking.ComponentProvider) -> None:
        """
    ...
    def removeGlobalAction(self, action: docking.action.DockingActionIf) -> None:
        """
...
class ActionAdapter(javax.swing.Action, java.beans.PropertyChangeListener):
    ...
    @typing.overload
    def __init__(self, dockingAction: docking.action.DockingActionIf, provider: docking.action.ActionContextProvider) -> None:
        ...

    def setDefaultAction(self, defaultAction: javax.swing.Action) -> None:
        ...
...
class KeyBindingUtils(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def clearKeyBinding(component: javax.swing.JComponent, action: docking.action.DockingActionIf) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def clearKeyBinding(component: javax.swing.JComponent, keyStroke: javax.swing.KeyStroke) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def clearKeyBinding(component: javax.swing.JComponent, keyStroke: javax.swing.KeyStroke, focusCondition: typing.Union[jpype.JInt, int]) -> None:
        """
        Allows clients to clear Java key bindings. This is useful when your
        application is using tool-level key bindings that share the same
        keystroke as a built-in Java action, such as Ctrl-C for the copy action.
    ...
    @staticmethod
    @typing.overload
    def clearKeyBinding(component: javax.swing.JComponent, actionName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    def exportKeyBindings(keyBindingOptions: ghidra.framework.options.ToolOptions) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def registerAction(component: javax.swing.JComponent, action: docking.action.DockingAction) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def registerAction(component: javax.swing.JComponent, action: docking.action.DockingAction, contextProvider: docking.action.ActionContextProvider) -> None:
        """
        A convenience method to register the given action with the given
        component. This is not usually done, as the action system is usually
        managed by the application's tool. However, for actions that are not
    ...
    @staticmethod
    @typing.overload
    def registerAction(component: javax.swing.JComponent, action: docking.action.DockingAction, contextProvider: docking.action.ActionContextProvider, focusCondition: typing.Union[jpype.JInt, int]) -> None:
        """
        A convenience method to register the given action with the given
        component. This is not usually done, as the action system is usually
        managed by the application's tool. However, for actions that are not
    ...
    @staticmethod
    @typing.overload
    def registerAction(component: javax.swing.JComponent, keyStroke: javax.swing.KeyStroke, action: javax.swing.Action, focusCondition: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    def retargetEvent(newSource: java.awt.Component, e: java.awt.event.KeyEvent) -> None:
        """
...
class KeyBindings(java.lang.Object):
    ...
    class ActionKeyBindingState(java.lang.Object):
        ...
        def apply(self, keyStrokeOptions: ghidra.framework.options.ToolOptions) -> None:
            ...

        def cancelChanges(self) -> None:
            ...
        ...
        def restore(self, options: ghidra.framework.options.ToolOptions) -> None:
            ...

        def setCurrentKeyStroke(self, newKeyStroke: javax.swing.KeyStroke) -> None:
            ...

        def setCurrentMouseBinding(self, newMouseBinding: gui.event.MouseBinding) -> None:
            ...
...
class KeyEntryDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, tool: docking.Tool, action: docking.action.DockingActionIf) -> None:
        ...
...
class SetKeyBindingAction(docking.action.DockingAction):
    ...
    def __init__(self, tool: docking.Tool, keyStroke: javax.swing.KeyStroke) -> None:
        ...
...
class SharedActionRegistry(java.lang.Object):
    ...
    @staticmethod
    def installSharedActions(tool: docking.Tool, toolActions: ToolActions) -> None:
        """
...
__all__ = ["ToolActions", "DockingToolActions", "PopupActionProvider", "SharedStubKeyBindingAction", "SharedDockingActionPlaceholder", "AutoGeneratedDockingAction", "ActionAdapter", "KeyBindingUtils", "KeyBindings", "KeyEntryDialog", "SetKeyBindingAction", "SharedActionRegistry"]
