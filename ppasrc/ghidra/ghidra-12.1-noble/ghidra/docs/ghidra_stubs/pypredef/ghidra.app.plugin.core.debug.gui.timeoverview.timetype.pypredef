...
class TimeTypeOverviewColorService(ghidra.app.plugin.core.debug.gui.timeoverview.TimeOverviewColorService):
    ...
    def setColor(self, type: TimeType, newColor: java.awt.Color) -> None:
        """
...
class TimeTypeOverviewLegendPanel(javax.swing.JPanel):
    ...
    def __init__(self, colorService: TimeTypeOverviewColorService, component: ghidra.app.plugin.core.debug.gui.timeoverview.TimeOverviewColorComponent) -> None:
        ...
...
__all__ = ["TimeType", "TimeSelectionOverviewColorService", "TimeTypeOverviewColorService", "TimeTypeOverviewLegendPanel"]
