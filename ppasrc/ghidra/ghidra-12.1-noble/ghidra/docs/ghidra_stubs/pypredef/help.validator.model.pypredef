...
class TOCItemDefinition(TOCItem):
    ...
    def __init__(self, parentItem: TOCItem, sourceTOCFile: jpype.protocol.SupportsPath, ID: typing.Union[java.lang.String, str], text: typing.Union[java.lang.String, str], target: typing.Union[java.lang.String, str], sortPreference: typing.Union[java.lang.String, str], lineNumber: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class TOCItem(java.lang.Object):
    ...
    def __init__(self, parentItem: TOCItem, sourceFile: jpype.protocol.SupportsPath, ID: typing.Union[java.lang.String, str], lineNumber: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    @typing.overload
    def writeContents(self, linkDatabase: help.validator.LinkDatabase, writer: java.io.PrintWriter, indentLevel: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def writeContents(self, linkDatabase: help.validator.LinkDatabase, writer: java.io.PrintWriter) -> None:
        ...
...
class TOCItemExternal(TOCItem):
    ...
    def __init__(self, parentItem: TOCItem, tocFile: jpype.protocol.SupportsPath, ID: typing.Union[java.lang.String, str], text: typing.Union[java.lang.String, str], target: typing.Union[java.lang.String, str], sortPreference: typing.Union[java.lang.String, str], lineNumber: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class TOCItemReference(TOCItem, java.lang.Comparable[TOCItemReference]):
    ...
    def __init__(self, parentItem: TOCItem, sourceTOCFile: jpype.protocol.SupportsPath, ID: typing.Union[java.lang.String, str], lineNumber: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class HREF(java.lang.Comparable[HREF]):
    ...
    def __init__(self, help: help.validator.location.HelpModuleLocation, sourceFile: jpype.protocol.SupportsPath, href: typing.Union[java.lang.String, str], lineNum: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class IMG(java.lang.Comparable[IMG]):
    ...
    def __init__(self, help: help.validator.location.HelpModuleLocation, sourceFile: jpype.protocol.SupportsPath, imgSrc: typing.Union[java.lang.String, str], lineNumber: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
...
class AnchorDefinition(java.lang.Object):
    ...
    **Warning: ** The ID generated by this class is specific to the JavaHelp system.  It is of 
    ...
    def __init__(self, file: jpype.protocol.SupportsPath, anchorName: typing.Union[java.lang.String, str], lineNum: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class HelpTopic(java.lang.Comparable[HelpTopic]):
    ...
    def __init__(self, help: help.validator.location.HelpModuleLocation, topicDir: jpype.protocol.SupportsPath) -> None:
        ...
...
__all__ = ["TOCItemDefinition", "TOCItem", "TOCItemExternal", "TOCItemReference", "HelpFile", "GhidraTOCFile", "HREF", "IMG", "AnchorDefinition", "HelpTopic"]
