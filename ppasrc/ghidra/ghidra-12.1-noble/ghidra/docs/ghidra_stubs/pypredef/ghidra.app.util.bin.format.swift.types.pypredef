...
__all__ = ["EntryPoint", "BuiltinTypeDescriptor", "FieldDescriptor", "AssociatedTypeDescriptor", "CaptureDescriptor", "MultiPayloadEnumDescriptor", "TargetTypeContextDescriptor", "TargetContextDescriptor", "TargetProtocolDescriptor", "TargetProtocolConformanceDescriptor", "ConformanceFlags", "TargetRelativeContextPointer", "TargetResilientWitnessHeader", "TargetResilientWitness", "TargetGenericWitnessTable", "TargetRelativeProtocolRequirementPointer", "TypeReferenceKind", "TargetGenericRequirementsDescriptor", "TargetProtocolRequirement", "ProtocolRequirementFlags", "ProtocolRequirementKind", "GenericRequirementFlags", "GenericRequirementLayoutKind", "GenericRequirementKind", "ContextDescriptorFlags", "ContextDescriptorKind", "MetadataInitializationKind", "CaptureTypeRecord", "MetadataSourceRecord", "AssociatedTypeRecord", "FieldRecord", "ExtraClassDescriptorFlags", "GenericContextDescriptorFlags", "GenericParamDescriptor", "GenericParamKind", "InvertibleProtocolKind", "InvertibleProtocolSet", "MethodDescriptorFlags", "MethodDescriptorKind", "TargetClassDescriptor", "TargetTypeGenericContextDescriptorHeader", "TargetResilientSuperclass", "TargetSingletonMetadataInitialization", "TargetForeignMetadataInitialization", "TargetVTableDescriptorHeader", "TargetMethodDescriptor", "TargetOverrideTableHeader", "TargetMethodOverrideDescriptor", "TargetObjCResilientClassStubInfo", "TargetGenericContextDescriptorHeader", "TargetEnumDescriptor", "TargetStructDescriptor"]
