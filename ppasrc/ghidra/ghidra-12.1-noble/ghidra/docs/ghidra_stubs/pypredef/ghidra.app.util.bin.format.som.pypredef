...
class SomCompilationUnit(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, symbolStringsLocation: typing.Union[jpype.JLong, int]) -> None:
        """
...
class SomDynamicLoaderHeader(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, textAddr: ghidra.program.model.address.Address, dataAddr: ghidra.program.model.address.Address) -> None:
        """
    ...
    def markup(self, program: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class SomShlibListEntry(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, stringTableLoc: typing.Union[jpype.JLong, int]) -> None:
        """
...
class SomHeader(ghidra.app.util.bin.StructConverter):
    ...
    def markup(self, program: ghidra.program.model.listing.Program, headerAddr: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Marks up this header
...
class SomSpace(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, spaceStringsLocation: typing.Union[jpype.JLong, int]) -> None:
        """
...
__all__ = ["SomAuxHeader", "SomAuxId", "SomAuxHeaderFactory", "SomCompilationUnit", "SomSysClock", "SomConstants", "SomDltEntry", "SomDynamicLoaderHeader", "SomShlibListEntry", "SomImportEntry", "SomExportEntry", "SomDynamicRelocation", "SomPltEntry", "SomExportEntryExt", "SomModuleEntry", "SomExecAuxHeader", "SomHeader", "SomSpace", "SomSubspace", "SomSymbol", "SomLinkerFootprintAuxHeader", "SomProductSpecificsAuxHeader", "SomUnknownAuxHeader"]
