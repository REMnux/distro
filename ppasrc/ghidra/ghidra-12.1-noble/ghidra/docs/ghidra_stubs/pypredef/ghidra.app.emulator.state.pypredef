...
class RegisterState(java.lang.Object):
    ...
    @typing.overload
    def setVals(self, key: typing.Union[java.lang.String, str], vals: jpype.JArray[jpype.JByte], setInitiailized: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def setVals(self, key: typing.Union[java.lang.String, str], val: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JInt, int], setInitiailized: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class FilteredMemoryPageOverlay(ghidra.pcode.memstate.MemoryPageOverlay):
    ...
    def __init__(self, spc: ghidra.program.model.address.AddressSpace, ul: ghidra.pcode.memstate.MemoryBank, writeBack: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class FilteredRegisterBank(ghidra.pcode.memstate.MemoryPageBank):
    ...
    def __init__(self, spc: ghidra.program.model.address.AddressSpace, ps: typing.Union[jpype.JInt, int], initState: RegisterState, lang: ghidra.program.model.lang.Language, writeBack: typing.Union[jpype.JBoolean, bool], faultHandler: ghidra.pcode.memstate.MemoryFaultHandler) -> None:
        ...



__all__ = ["RegisterState", "FilteredMemoryPageOverlay", "DumpMiscState", "FilteredRegisterBank"]
