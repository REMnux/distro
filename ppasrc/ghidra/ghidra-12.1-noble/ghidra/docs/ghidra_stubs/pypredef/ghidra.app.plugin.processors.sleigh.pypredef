...
class SleighLanguage(ghidra.program.model.lang.Language):
    ...
    def encodeTranslator(self, encoder: ghidra.program.model.pcode.Encoder, factory: ghidra.program.model.address.AddressFactory, uniqueOffset: typing.Union[jpype.JLong, int]) -> None:
        """
...
class SleighException(java.lang.RuntimeException):
    ...
    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], e: java.lang.Throwable) -> None:
        ...
...
class PcodeEmit(java.lang.Object):
    ...
    def __init__(self, walk: ParserWalker, ictx: ghidra.program.model.lang.InstructionContext, fallOffset: typing.Union[jpype.JInt, int], override: ghidra.program.model.pcode.PcodeOverride) -> None:
        """
    ...
    def build(self, construct: ghidra.app.plugin.processors.sleigh.template.ConstructTpl, secnum: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ParserWalker(java.lang.Object):
    ...
    * PcodeEmit                                 - for weaving together p-code for an instruction
    ...
    @typing.overload
    def __init__(self, c: SleighParserContext) -> None:
        ...

    @typing.overload
    def __init__(self, c: SleighParserContext, cross: SleighParserContext) -> None:
        """
    ...
    def calcCurrentLength(self, minLength: typing.Union[jpype.JInt, int], numopers: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def pushOperand(self, i: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setConstructor(self, ct: Constructor) -> None:
        ...

    def setCurrentLength(self, len: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setOffset(self, off: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setOutOfBandState(self, ct: Constructor, index: typing.Union[jpype.JInt, int], tempstate: ConstructState, otherwalker: ParserWalker) -> None:
        ...
    ...
    def subTreeState(self, subtree: ConstructState) -> None:
        ...
...
class SleighParserContext(ghidra.program.model.lang.ParserContext):
    ...
    @typing.overload
    def __init__(self, memBuf: ghidra.program.model.mem.MemBuffer, prototype: SleighInstructionPrototype, processorContext: ghidra.program.model.lang.ProcessorContextView) -> None:
        ...

    @typing.overload
    def __init__(self, aAddr: ghidra.program.model.address.Address, nAddr: ghidra.program.model.address.Address, rAddr: ghidra.program.model.address.Address, dAddr: ghidra.program.model.address.Address) -> None:
        """
    ...
    @typing.overload
    def __init__(self, origContext: SleighParserContext, delayByteCount: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def addCommit(self, point: ConstructState, sym: ghidra.app.plugin.processors.sleigh.symbol.TripleSymbol, num: typing.Union[jpype.JInt, int], mask: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def getInstructionBits(self, offset: typing.Union[jpype.JInt, int], startbit: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int]) -> int:
        ...
        :rtype: int
        :raises MemoryAccessException: if no bytes are available at first byte when
    ...
    def getN2addr(self) -> ghidra.program.model.address.Address:
        ...
        :obj:`Address.NO_ADDRESS`, if the next instruction cannot be parsed or if ``inst_next2``
        ...
        .. admonition:: Implementation Note
            ...
            If this is returning :obj:`Address.NO_ADDRESS` unexpectedly in emulation, refer to
            :obj:`PseudoInstruction` and its logic for choosing how many bytes to cache.
        """
    ...
    def setContextWord(self, i: typing.Union[jpype.JInt, int], val: typing.Union[jpype.JInt, int], mask: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ConstructState(java.lang.Object):
    ...
    def __init__(self, parent: ConstructState) -> None:
        ...
...
class Constructor(java.lang.Comparable[Constructor]):
    ...
    def applyContext(self, walker: ParserWalker, debug: SleighDebugLogger) -> None:
        """
    ...
    def decode(self, decoder: ghidra.program.model.pcode.Decoder, sleigh: SleighLanguage) -> None:
        ...
    ...
    def printList(self, walker: ParserWalker, list: java.util.ArrayList[java.lang.Object]) -> None:
        ...
    ...
    def setId(self, val: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ContextChange(java.lang.Object):
    ...
    def decode(self, decoder: ghidra.program.model.pcode.Decoder, lang: SleighLanguage) -> None:
        ...
...
class SleighDebugLogger(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, buf: ghidra.program.model.mem.MemBuffer, context: ghidra.program.model.lang.ProcessorContextView, language: ghidra.program.model.lang.Language, mode: SleighDebugLogger.SleighDebugMode) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, start: ghidra.program.model.address.Address, mode: SleighDebugLogger.SleighDebugMode) -> None:
        """
        Performs a parse debug at the specified memory location within program.
    ...
    def addInstructionPattern(self, offset: typing.Union[jpype.JInt, int], maskvalue: ghidra.app.plugin.processors.sleigh.pattern.PatternBlock) -> None:
        """
    ...
    @typing.overload
    def append(self, value: typing.Union[jpype.JInt, int], startbit: typing.Union[jpype.JInt, int], bitcount: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def append(self, value: jpype.JArray[jpype.JInt], startbit: typing.Union[jpype.JInt, int], bitcount: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def append(self, value: jpype.JArray[jpype.JByte], startbit: typing.Union[jpype.JInt, int], bitcount: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def append(self, str: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def dropIndent(self, levels: typing.Union[jpype.JInt, int]) -> None:
        ...

    def dumpContextPattern(self, maskvec: jpype.JArray[jpype.JInt], valvec: jpype.JArray[jpype.JInt], byteOffset: typing.Union[jpype.JInt, int], pos: SleighParserContext) -> None:
        """
    ...
    def dumpContextSet(self, pos: SleighParserContext, num: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JInt, int], mask: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def dumpGlobalSet(self, pos: SleighParserContext, state: ConstructState, sym: ghidra.app.plugin.processors.sleigh.symbol.TripleSymbol, num: typing.Union[jpype.JInt, int], mask: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def endPatternGroup(self, commit: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def indent(self, levels: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def startPatternGroup(self, name: typing.Union[java.lang.String, str]) -> None:
        """
...
class SleighInstructionPrototype(ghidra.program.model.lang.InstructionPrototype):
    ...
    def __init__(self, lang: SleighLanguage, buf: ghidra.program.model.mem.MemBuffer, context: ghidra.program.model.lang.ProcessorContextView, cache: ContextCache, inDelaySlot: typing.Union[jpype.JBoolean, bool], debug: SleighDebugLogger) -> None:
        ...
...
class ContextCache(java.lang.Object):
    ...
    def getContext(self, ctx: ghidra.program.model.lang.ProcessorContextView, buf: jpype.JArray[jpype.JInt]) -> None:
        ...
    ...
    def setContext(self, ctx: ghidra.program.model.lang.ProcessorContext, addr: ghidra.program.model.address.Address, num: typing.Union[jpype.JInt, int], mask: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class OpTplWalker(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, root: ConstructState, sectionnum: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, tpl: ghidra.app.plugin.processors.sleigh.template.ConstructTpl) -> None:
        """
    ...
    def pushBuild(self, buildnum: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DecisionNode(java.lang.Object):
    ...
    def decode(self, decoder: ghidra.program.model.pcode.Decoder, par: DecisionNode, sub: ghidra.app.plugin.processors.sleigh.symbol.SubtableSymbol) -> None:
        ...
...
class SleighCompilerSpecDescription(ghidra.program.model.lang.BasicCompilerSpecDescription):
    ...
    def __init__(self, id: ghidra.program.model.lang.CompilerSpecID, name: typing.Union[java.lang.String, str], file: generic.jar.ResourceFile) -> None:
        ...
...
class PcodeEmitObjects(PcodeEmit):
    ...
    @typing.overload
    def __init__(self, walk: ParserWalker) -> None:
        """
    ...
    @typing.overload
    def __init__(self, walk: ParserWalker, fallOffset: typing.Union[jpype.JInt, int]) -> None:
        """
        Pcode emitter constructor for producing PcodeOp objects for unimplemented, snippets or empty responses.
...
class PcodeEmitPacked(PcodeEmit):
    ...
    class LabelRef(java.lang.Object):
        ...
        def __init__(self, op: typing.Union[jpype.JInt, int], lab: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int], stream: typing.Union[jpype.JInt, int]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, encoder: ghidra.program.model.pcode.PatchEncoder, walk: ParserWalker, ictx: ghidra.program.model.lang.InstructionContext, fallOffset: typing.Union[jpype.JInt, int], override: ghidra.program.model.pcode.PcodeOverride) -> None:
        """
...
class SleighLanguageValidator(java.lang.Object):
    ...
    class VerifierErrorHandler(org.xml.sax.ErrorHandler):
        ...
        @typing.overload
        def __init__(self, file: generic.jar.ResourceFile) -> None:
            ...

        @typing.overload
        def __init__(self, title: typing.Union[java.lang.String, str], base: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    @typing.overload
    def verify(self, title: typing.Union[java.lang.String, str], document: typing.Union[java.lang.String, str]) -> None:
        """
...
class SpecExtensionEditor(ghidra.framework.options.OptionsEditor, java.beans.PropertyChangeListener):
    ...
    def __init__(self, program: ghidra.program.database.ProgramDB) -> None:
        ...
...
class SpecExtensionPanel(javax.swing.JPanel):
    ...
    class CompilerElement(java.lang.Comparable[SpecExtensionPanel.CompilerElement]):
        ...
        def __init__(self, nm: typing.Union[java.lang.String, str], tp: ghidra.program.database.SpecExtension.Type, st: SpecExtensionPanel.Status) -> None:
            ...
...
__all__ = ["SleighLanguage", "SleighException", "PcodeEmit", "ParserWalker", "SleighParserContext", "ConstructState", "FixedHandle", "Constructor", "ContextChange", "SleighDebugLogger", "SleighInstructionPrototype", "ContextCache", "OpTplWalker", "DecisionNode", "VarnodeData", "SleighCompilerSpecDescription", "ContextOp", "ContextCommit", "ModuleDefinitionsAdapter", "ModuleDefinitionsMap", "PcodeEmitObjects", "PcodeEmitPacked", "SleighLanguageProvider", "SleighLanguageValidator", "SpecExtensionEditor", "SpecExtensionPanel", "UniqueLayout"]
