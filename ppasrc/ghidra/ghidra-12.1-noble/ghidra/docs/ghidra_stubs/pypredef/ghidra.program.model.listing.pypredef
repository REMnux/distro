...
class CodeUnitFormatOptions(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, showBlockName: CodeUnitFormatOptions.ShowBlockName, showNamespace: CodeUnitFormatOptions.ShowNamespace) -> None:
        """
...
class CodeUnitFormat(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, options: CodeUnitFormatOptions) -> None:
        """
...
class Program(ghidra.program.model.data.DataTypeManagerDomainObject, ghidra.program.model.lang.ProgramArchitecture):
    ...
    def deleteAddressSetPropertyMap(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def deleteIntRangeMap(self, name: typing.Union[java.lang.String, str]) -> None:
        """
        Remove the property map from the program.
    ...
    def parseAddress(self, addrStr: typing.Union[java.lang.String, str]) -> jpype.JArray[ghidra.program.model.address.Address]:
        ...
        :meth:`AddressFactory.getAddress(String) <AddressFactory.getAddress>` or :meth:`AddressFactory.getAllAddresses(String) <AddressFactory.getAllAddresses>`
        if block-name based address need not be handled.
         
         
        Supported addresses include (order also indicates precedence):
         
        * Memory block-name based address (e.g., 'MyBlk:abcd', 'MyBlk::abcd' ; only one address 
        will be returned)
        * Default memory space (hex-offset only or with space-name, e.g., 'abcd', '0xabcd')
        * Memory space-name based address (with hex-offset, e.g., 'ram:abc')
        
         
        
        NOTE: Names are case-sensitive.
        
        :param java.lang.String or str addrStr: the string to parse (memory block style addresses are also supported).
    ...
    def parseAddress(self, addrStr: typing.Union[java.lang.String, str], caseSensitive: typing.Union[jpype.JBoolean, bool]) -> jpype.JArray[ghidra.program.model.address.Address]:
        ...
        * Memory space-name based address (with hex-offset, e.g., 'ram:abc')
        ...
        :param java.lang.String or str addrStr: the string to parse (memory block style addresses are also supported).
        :param jpype.JBoolean or bool caseSensitive: whether or not to process space/block names as case sensitive.
        :return: zero length array if addrStr is properly formatted but
        no matching addresses were found or if the address is improperly formatted.
        :rtype: jpype.JArray[ghidra.program.model.address.Address]
        """
    ...
    def renameOverlaySpace(self, overlaySpaceName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setCompiler(self, compiler: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setExecutableFormat(self, format: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setExecutableMD5(self, md5: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setExecutablePath(self, path: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setExecutableSHA256(self, sha256: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setImageBase(self, base: ghidra.program.model.address.Address, commit: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setLanguage(self, language: ghidra.program.model.lang.Language, compilerSpecID: ghidra.program.model.lang.CompilerSpecID, forceRedisassembly: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def setPreferredRootNamespaceCategoryPath(self, categoryPath: typing.Union[java.lang.String, str]) -> None:
        """
...
class VariableStorage(java.lang.Comparable[VariableStorage]):
    ...
    @typing.overload
    def __init__(self, programArch: ghidra.program.model.lang.ProgramArchitecture, *varnodes: ghidra.program.model.pcode.Varnode) -> None:
        """
    ...
    @typing.overload
    def __init__(self, programArch: ghidra.program.model.lang.ProgramArchitecture, *registers: ghidra.program.model.lang.Register) -> None:
        """
    ...
    @typing.overload
    def __init__(self, programArch: ghidra.program.model.lang.ProgramArchitecture, stackOffset: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, programArch: ghidra.program.model.lang.ProgramArchitecture, varnodes: java.util.List[ghidra.program.model.pcode.Varnode]) -> None:
        """
        Construct variable storage
    ...
    @typing.overload
    def __init__(self, programArch: ghidra.program.model.lang.ProgramArchitecture, address: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct variable storage
    ...
    def getRegisterOffset(self, reg: ghidra.program.model.lang.Register) -> int:
        """
        ...
        :param ghidra.program.model.lang.Register reg: :obj:`Register` to search for
    ...
    def getStackOffset(self) -> int:
        ...
        storage where the first or last varnode is stack, see :meth:`hasStackStorage() <.hasStackStorage>`.
        :rtype: int
    ...
    @property
    def registerOffset(self) -> jpype.JLong:
        ...
...
class Variable(java.lang.Comparable[Variable]):
    ...
    @typing.overload
    def setDataType(self, type: ghidra.program.model.data.DataType, storage: VariableStorage, force: typing.Union[jpype.JBoolean, bool], source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    @typing.overload
    def setDataType(self, type: ghidra.program.model.data.DataType, alignStack: typing.Union[jpype.JBoolean, bool], force: typing.Union[jpype.JBoolean, bool], source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    def setName(self, name: typing.Union[java.lang.String, str], source: ghidra.program.model.symbol.SourceType) -> None:
        """
...
class Listing(java.lang.Object):
    ...
    def clearAll(self, clearContext: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def clearCodeUnits(self, startAddr: ghidra.program.model.address.Address, endAddr: ghidra.program.model.address.Address, clearContext: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def clearCodeUnits(self, startAddr: ghidra.program.model.address.Address, endAddr: ghidra.program.model.address.Address, clearContext: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Clears any code units in the given range returning everything to "db"s,
        and removing any references in the affected area. Note that the module
        and fragment structure is unaffected. If part of a code unit is contained
    ...
    def removeUserDefinedProperty(self, propertyName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def renameTree(self, oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setComment(self, address: ghidra.program.model.address.Address, commentType: typing.Union[jpype.JInt, int], comment: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setComment(self, address: ghidra.program.model.address.Address, type: CommentType, comment: typing.Union[java.lang.String, str]) -> None:
        """
        Set the comment for the given comment type at the specified address.
...
class ProgramUserData(ghidra.framework.model.UserData):
    ...
    def endTransaction(self, transactionID: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setStringProperty(self, propertyName: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        """
...
class FunctionManager(ghidra.program.database.ManagerDB):
    ...
    def createThunkFunction(self, name: typing.Union[java.lang.String, str], nameSpace: ghidra.program.model.symbol.Namespace, entryPoint: ghidra.program.model.address.Address, body: ghidra.program.model.address.AddressSetView, thunkedFunction: Function, source: ghidra.program.model.symbol.SourceType) -> Function:
        ...
        :raises OverlappingFunctionException: if the address set of the body overlaps an existing
                    function
        :raises UnsupportedOperationException: if this method is invoked on an external entryPoint
                    address.
        """
    ...
    def invalidateCache(self, all: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class BookmarkManager(java.lang.Object):
    ...
    def isDefinedType(self, type: typing.Union[java.lang.String, str]) -> bool:
        ...
        :meth:`defineType(String, Icon, Color, int) <.defineType>`.  This allows clients to know whether the
        given type should be displayed.
        
        :param java.lang.String or str type: the type to check
        :return: true if defined
        :rtype: bool
        """

    def removeBookmark(self, bookmark: Bookmark) -> None:
        """
        Remove bookmark
    ...
    @typing.overload
    def removeBookmarks(self, type: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def removeBookmarks(self, type: typing.Union[java.lang.String, str], category: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def removeBookmarks(self, set: ghidra.program.model.address.AddressSetView, type: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def removeBookmarks(self, set: ghidra.program.model.address.AddressSetView, type: typing.Union[java.lang.String, str], category: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class ProgramContext(java.lang.Object):
    ...
    def setValue(self, register: ghidra.program.model.lang.Register, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address, value: java.math.BigInteger) -> None:
        """
...
class DataTypeChangeSet(ghidra.framework.model.ChangeSet):
    ...
    def categoryAdded(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
        adds the data type category id to the list of categories that have been added.
        """

    def categoryChanged(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
        adds the data type category id to the list of categories that have changed.
        """

    def dataTypeAdded(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def dataTypeChanged(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def sourceArchiveAdded(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def sourceArchiveChanged(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ProgramTreeChangeSet(ghidra.framework.model.ChangeSet):
    ...
    def programTreeAdded(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
        adds the program tree id to the list of trees that have been added.
        """

    def programTreeChanged(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
...
class SymbolChangeSet(ghidra.framework.model.ChangeSet):
    ...
    def symbolAdded(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
        adds the symbols id to the list of symbols that have been added.
        """

    def symbolChanged(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
...
class FunctionTagChangeSet(ghidra.framework.model.ChangeSet):
    ...
    def tagChanged(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def tagCreated(self, id: typing.Union[jpype.JLong, int]) -> None:
        """
...
class Bookmark(java.lang.Comparable[Bookmark]):
    ...
    def set(self, category: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> None:
        """
...
class Function(ghidra.program.model.symbol.Namespace):
    ...
    @deprecated("The use of this method is discouraged.  The function signature should generally be \n adjusted with a single call to updateFunction(String, Variable, List, FunctionUpdateType, boolean, SourceType)")
    def removeParameter(self, ordinal: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeTag(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def removeVariable(self, var: Variable) -> None:
        """
    ...
    @typing.overload
    def replaceParameters(self, params: java.util.List[Variable], updateType: Function.FunctionUpdateType, force: typing.Union[jpype.JBoolean, bool], source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    @typing.overload
    def replaceParameters(self, updateType: Function.FunctionUpdateType, force: typing.Union[jpype.JBoolean, bool], source: ghidra.program.model.symbol.SourceType, *params: Variable) -> None:
        """
        Replace all current parameters with the given list of parameters.
        The :meth:`VariableUtilities.checkVariableConflict(Function, Variable, VariableStorage, boolean) <VariableUtilities.checkVariableConflict>` 
        method may be used to check and remove conflicting variables which already exist in the function.
    ...
    def setCallFixup(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setCallingConvention(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setCustomVariableStorage(self, hasCustomVariableStorage: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setInline(self, isInline: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setRepeatableComment(self, comment: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setReturn(self, type: ghidra.program.model.data.DataType, storage: VariableStorage, source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    def setStackPurgeSize(self, purgeSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setThunkedFunction(self, thunkedFunction: Function) -> None:
        """
        ...
        :raises UnsupportedOperationException: if this method is invoked on an external function.
        """
    ...
    @typing.overload
    def updateFunction(self, callingConvention: typing.Union[java.lang.String, str], returnValue: Variable, updateType: Function.FunctionUpdateType, force: typing.Union[jpype.JBoolean, bool], source: ghidra.program.model.symbol.SourceType, *newParams: Variable) -> None:
        """
    ...
    @typing.overload
    def updateFunction(self, callingConvention: typing.Union[java.lang.String, str], returnVar: Variable, newParams: java.util.List[Variable], updateType: Function.FunctionUpdateType, force: typing.Union[jpype.JBoolean, bool], source: ghidra.program.model.symbol.SourceType) -> None:
        """
        Replace all current parameters with the given list of parameters and optionally change the 
        calling convention and function return.
        The :meth:`VariableUtilities.checkVariableConflict(Function, Variable, VariableStorage, boolean) <VariableUtilities.checkVariableConflict>` 
...
class StackFrame(java.lang.Object):
    ...
    def clearVariable(self, offset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setLocalSize(self, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setReturnAddressOffset(self, offset: typing.Union[jpype.JInt, int]) -> None:
        """
...
class AutoParameterImpl(ParameterImpl):
    ...
    def __init__(self, dataType: ghidra.program.model.data.DataType, ordinal: typing.Union[jpype.JInt, int], storage: VariableStorage, function: Function) -> None:
        ...
...
class ParameterImpl(VariableImpl, Parameter):
    ...
    @typing.overload
    def __init__(self, param: Parameter, program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, program: Program, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        """
        Construct a parameter which has no specific storage specified.
        Ordinal assignment is not established (UNASSIGNED_ORDINAL).
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, stackOffset: typing.Union[jpype.JInt, int], program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, stackOffset: typing.Union[jpype.JInt, int], program: Program, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        """
        Construct a stack parameter at the specified stack offset.
        Ordinal assignment is not established (UNASSIGNED_ORDINAL).
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, register: ghidra.program.model.lang.Register, program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, register: ghidra.program.model.lang.Register, program: Program, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        """
        Construct a register parameter using the specified register.
        Ordinal assignment is not established (UNASSIGNED_ORDINAL).
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, storageAddr: ghidra.program.model.address.Address, program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, storageAddr: ghidra.program.model.address.Address, program: Program, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        """
        Construct a parameter with a single storage element at the specified address.  If address 
        is contained within a register it may get realigned to the register based upon the resolved 
        datatype length.  Variable storage will be aligned to the least-significant portion of the 
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, storage: VariableStorage, program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, storage: VariableStorage, program: Program, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        """
        Construct a parameter with one or more associated storage elements.  Storage elements
        may get slightly modified to adjust for the resolved datatype size.  Ordinal assignment
        is not established (UNASSIGNED_ORDINAL).
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], ordinal: typing.Union[jpype.JInt, int], dataType: ghidra.program.model.data.DataType, storage: VariableStorage, force: typing.Union[jpype.JBoolean, bool], program: Program, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        """
        Construct a parameter with one or more associated storage elements.  Storage elements
...
class VariableFilter(java.lang.Object):
    ...
    class ParameterFilter(VariableFilter):
        ...
        def __init__(self, allowAutoParams: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
...
class VariableSizeException(ghidra.util.exception.InvalidInputException):
    ...
    @typing.overload
    def __init__(self, msg: typing.Union[java.lang.String, str], canForce: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor.
...
class Data(CodeUnit, ghidra.docking.settings.Settings):
    ...
    def getValue(self) -> java.lang.Object:
        """
        Returns the value of this data as determined by the corresponding :obj:`DataType`.
        The value may be an :obj:`Address`, :obj:`Scalar`, a datatype-defined object or null 
        if no value.
...
class CodeUnit(ghidra.program.model.mem.MemBuffer, ghidra.program.model.util.PropertySet):
    ...
    def addOperandReference(self, index: typing.Union[jpype.JInt, int], refAddr: ghidra.program.model.address.Address, type: ghidra.program.model.symbol.RefType, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    def getBytesInCodeUnit(self, buffer: jpype.JArray[jpype.JByte], bufferOffset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeExternalReference(self, opIndex: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeOperandReference(self, index: typing.Union[jpype.JInt, int], refAddr: ghidra.program.model.address.Address) -> None:
        """
    ...
    def setComment(self, commentType: typing.Union[jpype.JInt, int], comment: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setComment(self, type: CommentType, comment: typing.Union[java.lang.String, str]) -> None:
        """
        Set the comment for the given comment type.  Passing ``null`` clears the comment
    ...
    def setCommentAsArray(self, commentType: typing.Union[jpype.JInt, int], comment: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def setCommentAsArray(self, type: CommentType, comment: jpype.JArray[java.lang.String]) -> None:
        """
        Set the comment (with each line in its own string) for the given comment type
    ...
    def setRegisterReference(self, opIndex: typing.Union[jpype.JInt, int], reg: ghidra.program.model.lang.Register, sourceType: ghidra.program.model.symbol.SourceType, refType: ghidra.program.model.symbol.RefType) -> None:
        """
    ...
    def setStackReference(self, opIndex: typing.Union[jpype.JInt, int], offset: typing.Union[jpype.JInt, int], sourceType: ghidra.program.model.symbol.SourceType, refType: ghidra.program.model.symbol.RefType) -> None:
        """
...
class ProgramModule(Group):
    ...
    @typing.overload
    def add(self, module: ProgramModule) -> None:
        """
    ...
    @typing.overload
    def add(self, fragment: ProgramFragment) -> None:
        """
    ...
    def moveChild(self, name: typing.Union[java.lang.String, str], index: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def reparent(self, name: typing.Union[java.lang.String, str], oldParent: ProgramModule) -> None:
        """
...
class DuplicateGroupException(ghidra.util.exception.UsrException):
    ...
    @typing.overload
    def __init__(self, usrMessage: typing.Union[java.lang.String, str]) -> None:
        """
...
class Instruction(CodeUnit, ghidra.program.model.lang.ProcessorContext):
    ...
    def getDefaultFlows(self) -> jpype.JArray[ghidra.program.model.address.Address]:
        """
        Get an array of :obj:`Address`es for all default flows established by the underlying
        instruction prototype.
         
        
        References are ignored. Note the result may include :obj:`Address.NO_ADDRESS` to indicate
        flow to an address that could not be evaluated, e.g., to ``inst_next2`` when the skipped
    ...
    def getDefaultOperandRepresentation(self, operandIndex: typing.Union[jpype.JInt, int]) -> str:
        """
        Get the operand representation for the given operand index without markup.
        
        :param jpype.JInt or int operandIndex: operand index
        :return: operand represented as a string.
        :rtype: str
        """

    def getDefaultOperandRepresentationList(self, operandIndex: typing.Union[jpype.JInt, int]) -> java.util.List[java.lang.Object]:
        """
    ...
    def getFallFrom(self) -> ghidra.program.model.address.Address:
        """
        :return: the :obj:`Address` for the instruction that fell through to this instruction
        :rtype: ghidra.program.model.address.Address
    ...
    def getFlows(self) -> jpype.JArray[ghidra.program.model.address.Address]:
        """
        Get an array of :obj:`Address`es for all flows other than a fall-through.
         
        
        This will include any flow references which have been added to the instruction. Note the
        result may include :obj:`Address.NO_ADDRESS` to indicate flow to an address that could not
        be evaluated, e.g., to ``inst_next2`` when the skipped instruction could not be parsed.
    ...
    def getOpObjects(self, operandIndex: typing.Union[jpype.JInt, int]) -> jpype.JArray[java.lang.Object]:
        """
        Get objects used by this operand (Address, Scalar, Register ...)
        
        :param jpype.JInt or int operandIndex: index of the operand.
        :return: objects used by this operand (Address, Scalar, Register ...)
        :rtype: jpype.JArray[java.lang.Object]
        """

    def getOperandRefType(self, operandIndex: typing.Union[jpype.JInt, int]) -> ghidra.program.model.symbol.RefType:
        """
    ...
    def getOperandType(self, operandIndex: typing.Union[jpype.JInt, int]) -> int:
        """
        Get the type of a specific operand.
        
        :param jpype.JInt or int operandIndex: the index of the operand. (zero based)
    ...
    def getParsedBytes(self) -> jpype.JArray[jpype.JByte]:
        ...
        While this method will generally return the same value as :meth:`getBytes() <.getBytes>`, it will return
        more bytes when :meth:`setLengthOverride(int) <.setLengthOverride>` has been used. In this override situation,
    ...
    def getParsedLength(self) -> int:
        ...
        While this method will generally return the same value as :meth:`getLength() <.getLength>`, its value
        will differ when :meth:`setLengthOverride(int) <.setLengthOverride>` has been used. In addition, it is important
        to note that :meth:`getMaxAddress() <.getMaxAddress>` will always reflect a non-overlapping address which
        reflects :meth:`getLength() <.getLength>`.
    ...
    def getPcode(self, includeOverrides: typing.Union[jpype.JBoolean, bool]) -> jpype.JArray[ghidra.program.model.pcode.PcodeOp]:
        ...
        :param jpype.JBoolean or bool includeOverrides: if true any flow overrides will be factored into generated p-code.
        :return: an array of p-code operations, a zero length array if the language does not support
                p-code
        :rtype: jpype.JArray[ghidra.program.model.pcode.PcodeOp]
        """
    ...
    @typing.overload
    def getPcode(self, operandIndex: typing.Union[jpype.JInt, int]) -> jpype.JArray[ghidra.program.model.pcode.PcodeOp]:
        """
        Get an array of p-code operations (micro code) that a particular operand performs to compute
        its value.
        
        :param jpype.JInt or int operandIndex: index of the operand to retrieve p-code
        :return: an array of p-code operations, a zero length array if the language does not support
                p-code
        :rtype: jpype.JArray[ghidra.program.model.pcode.PcodeOp]
        """
    ...
    def getRegister(self, operandIndex: typing.Union[jpype.JInt, int]) -> ghidra.program.model.lang.Register:
        """
        If a specific operand is a pure :obj:`Register`, return it
        
        :param jpype.JInt or int operandIndex: the 0-up index of the operand.
    ...
    def getSeparator(self, operandIndex: typing.Union[jpype.JInt, int]) -> str:
        """
        ...
        :param jpype.JInt or int operandIndex: valid values are 0 thru numOperands+1
    ...
    def setFallThrough(self, addr: ghidra.program.model.address.Address) -> None:
        ...
        :param ghidra.program.model.address.Address addr: the address to be used as this instructions fall-through address. May be null.
        """

    def setFlowOverride(self, flowOverride: FlowOverride) -> None:
        """
    ...
    def setLengthOverride(self, length: typing.Union[jpype.JInt, int]) -> None:
        """
...
class CodeUnitComments(java.lang.Object):
    ...
    def __init__(self, comments: jpype.JArray[java.lang.String]) -> None:
        ...
...
class CommentHistory(java.lang.Object):
    ...
    def __init__(self, addr: ghidra.program.model.address.Address, commentType: CommentType, userName: typing.Union[java.lang.String, str], comments: typing.Union[java.lang.String, str], modificationDate: java.util.Date) -> None:
        """
...
class Library(ghidra.program.model.symbol.Namespace):
    ...
    @staticmethod
    def getContainingLibrary(symbol: ghidra.program.model.symbol.Symbol) -> Library:
        """
        Get the Library which contains the specified external symbol.
        
        :param ghidra.program.model.symbol.Symbol symbol: external symbol
...
class FunctionSignatureImpl(ghidra.program.model.data.FunctionDefinitionDataType):
    ...
    @typing.overload
    def __init__(self, function: Function, formalSignature: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Create a Function Definition based on a Function
...
class LabelString(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, label: typing.Union[java.lang.String, str], type: LabelString.LabelType) -> None:
        ...

    @typing.overload
    def __init__(self, label: typing.Union[java.lang.String, str], symbol: ghidra.program.model.symbol.Symbol, type: LabelString.LabelType) -> None:
        ...
...
class LocalVariableImpl(VariableImpl, LocalVariable):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], firstUseOffset: typing.Union[jpype.JInt, int], dataType: ghidra.program.model.data.DataType, register: ghidra.program.model.lang.Register, program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], firstUseOffset: typing.Union[jpype.JInt, int], dataType: ghidra.program.model.data.DataType, register: ghidra.program.model.lang.Register, program: Program, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], firstUseOffset: typing.Union[jpype.JInt, int], dataType: ghidra.program.model.data.DataType, storageAddr: ghidra.program.model.address.Address, program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], firstUseOffset: typing.Union[jpype.JInt, int], dataType: ghidra.program.model.data.DataType, storageAddr: ghidra.program.model.address.Address, program: Program, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        """
        Construct a variable with a single storage element at the specified address.  If address 
        is contained within a register it may get realigned to the register based upon the resolved 
        datatype length.  Variable storage will be aligned to the least-significant portion of the 
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], firstUseOffset: typing.Union[jpype.JInt, int], dataType: ghidra.program.model.data.DataType, storage: VariableStorage, program: Program) -> None:
        """
        Construct a variable with one or more associated storage elements.  Storage elements
        may get slightly modified to adjust for the resolved datatype size.
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], firstUseOffset: typing.Union[jpype.JInt, int], dataType: ghidra.program.model.data.DataType, storage: VariableStorage, force: typing.Union[jpype.JBoolean, bool], program: Program) -> None:
        """
        Construct a variable with one or more associated storage elements.  Storage elements
        may get slightly modified to adjust for the resolved datatype size.
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], firstUseOffset: typing.Union[jpype.JInt, int], dataType: ghidra.program.model.data.DataType, storage: VariableStorage, force: typing.Union[jpype.JBoolean, bool], program: Program, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        """
        Construct a variable with one or more associated storage elements.  Storage elements
        may get slightly modified to adjust for the resolved datatype size.
...
class ReturnParameterImpl(ParameterImpl):
    ...
    @typing.overload
    def __init__(self, dataType: ghidra.program.model.data.DataType, program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dataType: ghidra.program.model.data.DataType, stackOffset: typing.Union[jpype.JInt, int], program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dataType: ghidra.program.model.data.DataType, register: ghidra.program.model.lang.Register, program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dataType: ghidra.program.model.data.DataType, storageAddr: ghidra.program.model.address.Address, program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dataType: ghidra.program.model.data.DataType, storage: VariableStorage, program: Program) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dataType: ghidra.program.model.data.DataType, storage: VariableStorage, force: typing.Union[jpype.JBoolean, bool], program: Program) -> None:
        """
        Construct a return parameter with one or more associated storage elements.  Storage elements
        may get slightly modified to adjust for the resolved datatype size.
...
class ThunkFunction(Function):
    ...
    def setDestinationFunction(self, function: Function) -> None:
        """
...
class VariableOffset(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, var: Variable, offset: typing.Union[jpype.JLong, int], indirect: typing.Union[jpype.JBoolean, bool], dataAccess: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, ref: ghidra.program.model.symbol.Reference, var: Variable) -> None:
        """
    ...
    @typing.overload
    def setReplacedElement(self, s: ghidra.program.model.scalar.Scalar, includeScalarAdjustment: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class VariableUtilities(java.lang.Object):
    ...
    class StackAttributes(java.lang.Object):
        ...
        def __init__(self, stackAlign: typing.Union[jpype.JInt, int], bias: typing.Union[jpype.JInt, int], rightJustify: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    @staticmethod
    @typing.overload
    def checkStorage(storage: VariableStorage, dataType: ghidra.program.model.data.DataType, allowSizeMismatch: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def checkVariableConflict(function: Function, var: Variable, newStorage: VariableStorage, deleteConflictingVariables: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def checkVariableConflict(existingVariables: java.util.List[Variable], var: Variable, newStorage: VariableStorage, conflictHandler: VariableUtilities.VariableConflictHandler) -> None:
        """
        Check for variable storage conflict and optionally remove conflicting variables.
...
__all__ = ["CodeUnitFormatOptions", "CodeUnitFormat", "FunctionSignature", "Program", "VariableStorage", "Parameter", "Variable", "DefaultProgramContext", "Listing", "ProgramUserData", "FunctionManager", "BookmarkManager", "ProgramContext", "ProgramChangeSet", "DomainObjectChangeSet", "AddressChangeSet", "RegisterChangeSet", "DataTypeChangeSet", "ProgramTreeChangeSet", "SymbolChangeSet", "FunctionTagChangeSet", "FunctionTag", "IncompatibleLanguageException", "CircularDependencyException", "ContextChangeException", "Bookmark", "BookmarkType", "Function", "FunctionTagManager", "FunctionIterator", "StackFrame", "AutoParameterImpl", "ParameterImpl", "VariableImpl", "VariableFilter", "VariableSizeException", "AutoParameterType", "Data", "CodeUnit", "CommentType", "ProgramModule", "Group", "ProgramFragment", "CodeUnitIterator", "DuplicateGroupException", "Instruction", "InstructionIterator", "DataIterator", "CodeUnitComments", "CommentHistory", "FlowOverride", "Library", "GhidraClass", "DataTypeArchive", "DataTypeArchiveChangeSet", "LocalVariable", "BookmarkComparator", "BookmarkTypeComparator", "DataBuffer", "DataStub", "FunctionOverlapException", "FunctionSignatureImpl", "InstructionPcodeOverride", "InstructionStub", "LabelString", "LocalVariableImpl", "OperandRepresentationList", "RepeatableComment", "ReturnParameterImpl", "StackVariableComparator", "StubListing", "ThunkFunction", "VariableOffset", "VariableUtilities"]
