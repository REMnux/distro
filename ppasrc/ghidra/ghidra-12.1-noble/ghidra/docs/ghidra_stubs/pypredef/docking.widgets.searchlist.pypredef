...
class DefaultSearchListModel(javax.swing.AbstractListModel[SearchListEntry[T]], SearchListModel[T], typing.Generic[T]):
    ...
    def add(self, category: typing.Union[java.lang.String, str], items: java.util.List[T]) -> None:
        """
...
class SearchListModel(javax.swing.ListModel[SearchListEntry[T]], typing.Generic[T]):
    ...
    def setFilter(self, filter: java.util.function.BiPredicate[T, java.lang.String]) -> None:
        """
...
class SearchListEntry(java.lang.Record, typing.Generic[T]):
    ...
    def __init__(self, value: T, category: typing.Union[java.lang.String, str], showCategory: typing.Union[jpype.JBoolean, bool], drawSeparator: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class SearchList(javax.swing.JPanel, typing.Generic[T]):
    ...
    def __init__(self, model: SearchListModel[T], chosenItemCallback: java.util.function.BiConsumer[T, java.lang.String]) -> None:
        """
    ...
    def setDisplayNameFunction(self, nameFunction: java.util.function.BiFunction[T, java.lang.String, java.lang.String]) -> None:
        ...
    ...
    def setInitialSelection(self) -> None:
        """
        Resets the selection to the first element
        """

    def setItemRenderer(self, itemRenderer: javax.swing.ListCellRenderer[SearchListEntry[T]]) -> None:
        """
    ...
    def setMouseHoverSelection(self) -> None:
        ...

    def setSelectedItem(self, t: T) -> None:
        ...

    def setSelectionCallback(self, consumer: java.util.function.Consumer[T]) -> None:
        """
    ...
    def setShowCategories(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setSingleClickMode(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
__all__ = ["DefaultSearchListModel", "SearchListModel", "SearchListEntry", "SearchList"]
