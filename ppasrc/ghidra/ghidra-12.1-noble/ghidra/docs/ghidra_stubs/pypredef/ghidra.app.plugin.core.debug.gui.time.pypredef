...
class DebuggerTimeSelectionDialog(docking.DialogComponentProvider):
    ...
    def setScheduleText(self, text: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DebuggerSnapshotTablePanel(javax.swing.JPanel):
    ...
    def setCurrent(self, coords: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> None:
        ...

    def setHideScratchSnapshots(self, hideScratch: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setSelectedSnapshot(self, snap: typing.Union[java.lang.Long, int]) -> None:
        ...
...
class SnapshotRow(java.lang.Object):
    ...
    def __init__(self, snapshot: ghidra.trace.model.time.TraceSnapshot, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> None:
        ...
...
class DebuggerTimeProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, plugin: DebuggerTimePlugin) -> None:
        ...
...
__all__ = ["DebuggerTimeSelectionDialog", "DebuggerSnapshotTablePanel", "SnapshotRow", "DebuggerTimePlugin", "DebuggerTimeProvider"]
