...
class BranchPcodeRow(PcodeRow):
    ...
    def __init__(self, sequence: typing.Union[jpype.JInt, int], fromSeq: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class UniqueRow(java.lang.Object):
    ...
    class ConcretizedState(java.lang.Object, typing.Generic[T]):
        ...
        def __init__(self, state: ghidra.pcode.exec_.PcodeExecutorState[T], arithmetic: ghidra.pcode.exec_.PcodeArithmetic[T]) -> None:
            ...
    ...
    def __init__(self, provider: DebuggerPcodeStepperProvider, language: ghidra.program.model.lang.Language, state: ghidra.pcode.exec_.PcodeExecutorState[T], arithmetic: ghidra.pcode.exec_.PcodeArithmetic[T], vn: ghidra.program.model.pcode.Varnode) -> None:
        ...
...
class DebuggerPcodeStepperProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    class ToPcodeRowsAppender(ghidra.app.util.pcode.AbstractAppender[java.util.List[PcodeRow]]):
        ...
        def __init__(self, language: ghidra.program.model.lang.Language, frame: ghidra.pcode.exec_.PcodeFrame) -> None:
            ...
    ...
    def __init__(self, plugin: DebuggerPcodeStepperPlugin) -> None:
        ...
...
class FallthroughPcodeRow(PcodeRow):
    ...
    def __init__(self, sequence: typing.Union[jpype.JInt, int], isNext: typing.Union[jpype.JBoolean, bool], label: typing.Union[java.lang.String, str]) -> None:
        ...
...
class OpPcodeRow(PcodeRow):
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, op: ghidra.program.model.pcode.PcodeOp, isNext: typing.Union[jpype.JBoolean, bool], label: typing.Union[java.lang.String, str], code: typing.Union[java.lang.String, str]) -> None:
        ...



__all__ = ["BranchPcodeRow", "PcodeRow", "DebuggerPcodeStepperPlugin", "UniqueRow", "DebuggerPcodeStepperProvider", "EnumPcodeRow", "FallthroughPcodeRow", "OpPcodeRow"]
