...
class MultiListingLayoutModel(ghidra.app.util.viewer.listingpanel.ListingModelListener, ghidra.app.util.viewer.format.FormatModelListener):
    ...
    def __init__(self, formatMgr: ghidra.app.util.viewer.format.FormatManager, programs: jpype.JArray[ghidra.program.model.listing.Program], primaryAddrSet: ghidra.program.model.address.AddressSetView) -> None:
        """
    ...
    def setAddressTranslator(self, translator: AddressTranslator) -> None:
        ...
...
class MultiLayout(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, layouts: jpype.JArray[docking.widgets.fieldpanel.Layout], factory: ghidra.app.util.viewer.field.DummyFieldFactory) -> None:
        ...
...
class ListingModelConverter(ghidra.app.util.viewer.listingpanel.ListingModel):
    ...
    def __init__(self, primaryModel: ghidra.app.util.viewer.listingpanel.ListingModel, model: ghidra.app.util.viewer.listingpanel.ListingModel) -> None:
        """
...
__all__ = ["MultiListingLayoutModel", "AddressTranslator", "LayoutCache", "MultiLayout", "ListingModelConverter"]
