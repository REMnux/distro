...
class AbstractDwarfEHDecoder(DwarfEHDecoder):
    ...
    def __init__(self, mode: DwarfEHDataApplicationMode, isIndirect: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DwarfDecodeContext(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, readAddr: ghidra.program.model.address.Address) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, readAddr: ghidra.program.model.address.Address, ehBlock: ghidra.program.model.mem.MemoryBlock) -> None:
        """
        Constructs a Dwarf decode context.
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, readAddr: ghidra.program.model.address.Address, entryPoint: ghidra.program.model.address.Address) -> None:
        """
        Constructs a Dwarf decode context.
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, readAddr: ghidra.program.model.address.Address, function: ghidra.program.model.listing.Function) -> None:
        """
        Constructs a Dwarf decode context.
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, readAddr: ghidra.program.model.address.Address, ehBlock: ghidra.program.model.mem.MemoryBlock, entryPoint: ghidra.program.model.address.Address) -> None:
        """
        Constructs a Dwarf decode context.
    ...
    def getImageBaseAdjustment(self) -> int:
        """
    ...
    def setDecodedValue(self, value: java.lang.Object, encodedLength: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @property
    def imageBaseAdjustment(self) -> jpype.JLong:
        ...
...
class GccAnalysisClass(java.lang.Object):
    ...
    def __init__(self, monitor: ghidra.util.task.TaskMonitor, program: ghidra.program.model.listing.Program) -> None:
        """
...
class GccAnalysisUtils(java.lang.Object):
    ...
    @staticmethod
    def readBytes(program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, buffer: jpype.JArray[jpype.JByte]) -> None:
        """
...
class GccExceptionAnalyzer(ghidra.app.services.AbstractAnalyzer):
    ...
    class TypeInfo(java.lang.Object):
        ...
        def __init__(self, typeInfoAddress: ghidra.program.model.address.Address, actionFilter: typing.Union[jpype.JInt, int]) -> None:
            ...
...
class RegionDescriptor(java.lang.Object):
    ...
    def __init__(self, ehblock: ghidra.program.model.mem.MemoryBlock) -> None:
        """
...
__all__ = ["AbstractDwarfEHDecoder", "DwarfEHDecoder", "DwarfEHDataApplicationMode", "DwarfDecodeContext", "DwarfEHDataDecodeFormat", "DwarfDecoderFactory", "GccAnalysisClass", "GccAnalysisUtils", "GccExceptionAnalyzer", "RegionDescriptor"]
