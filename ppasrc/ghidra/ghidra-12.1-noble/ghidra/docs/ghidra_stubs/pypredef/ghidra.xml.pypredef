...
class XmlParseException(java.lang.Exception):
    ...
    @typing.overload
    def __init__(self, message: typing.Union[java.lang.String, str], t: java.lang.Throwable) -> None:
        ...
...
class NonThreadedXmlPullParserImpl(AbstractXmlPullParser):
    ...
    class DefaultContentHandlerWrapper(org.xml.sax.helpers.DefaultHandler):
        ...
        def __init__(self, errorHandler: org.xml.sax.ErrorHandler, reallyCreateNoncompliantDeprecated: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, file: jpype.protocol.SupportsPath, errHandler: org.xml.sax.ErrorHandler, validate: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, input: typing.Union[java.lang.String, str], inputName: typing.Union[java.lang.String, str], errHandler: org.xml.sax.ErrorHandler, validate: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, input: java.io.InputStream, inputName: typing.Union[java.lang.String, str], errHandler: org.xml.sax.ErrorHandler, validate: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ThreadedXmlPullParserImpl(AbstractXmlPullParser):
    ...
    class DefaultContentHandlerWrapper(org.xml.sax.helpers.DefaultHandler):
        ...
        def __init__(self, errorHandler: org.xml.sax.ErrorHandler) -> None:
            ...
...
class XmlMessageLog(ghidra.app.util.importer.MessageLog):
    ...
    def setParser(self, parser: XmlPullParser) -> None:
        """
        Sets the XML parser.
...
class XmlPullParserFactory(java.lang.Object):
    ...
    @staticmethod
    def setCreateTracingParsers(xmlTracer: XmlTracer) -> None:
        ...
...
class XmlTracer(java.lang.Object):
    ...
    def trace(self, locator: org.xml.sax.Locator, traceMessage: typing.Union[java.lang.String, str], throwableIfAvailable: java.lang.Throwable) -> None:
        """
...
class XmlTreeNode(java.lang.Object):
    ...
    def __init__(self, parser: XmlPullParser) -> None:
        """
    ...
    def deleteChildNode(self, node: XmlTreeNode) -> None:
        """
...
class XmlPullParser(java.lang.Object):
    ...
    def setPullingContent(self, pullingContent: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class XmlElement(java.lang.Object):
    ...
    @typing.overload
    def isStart(self, string: typing.Union[java.lang.String, str]) -> bool:
        ...

    def setAttribute(self, key: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        ...
...
__all__ = ["XmlParseException", "NonThreadedXmlPullParserImpl", "ThreadedXmlPullParserImpl", "XmlMessageLog", "XmlPullParserFactory", "XmlTracer", "XmlTreeNode", "AbstractXmlPullParser", "XmlPullParser", "XmlElement", "XmlElementImpl", "XmlException"]
