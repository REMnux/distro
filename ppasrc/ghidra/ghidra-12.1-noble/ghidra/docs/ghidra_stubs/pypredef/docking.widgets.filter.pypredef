...
class FilterTextField(javax.swing.JPanel):
    ...
    class FilterFieldLayoutManager(ghidra.util.layout.AbstractLayoutManager):
        """
    ...
    @typing.overload
    def __init__(self, component: java.awt.Component) -> None:
        """
    ...
    @typing.overload
    def __init__(self, component: java.awt.Component, columns: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def addFilterListener(self, l: FilterListener) -> None:
        """
    ...
    @typing.overload
    def alert(self, forceAlert: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def removeEnterListener(self, callback: utility.function.Callback) -> None:
        ...

    def removeFilterListener(self, l: FilterListener) -> None:
        ...
...
class FilterListener(java.lang.Object):
    ...
    def filterChanged(self, text: typing.Union[java.lang.String, str]) -> None:
        ...
...
class FilterOptions(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, textFilterStrategy: TextFilterStrategy, allowGlobbing: typing.Union[jpype.JBoolean, bool], caseSensitive: typing.Union[jpype.JBoolean, bool], inverted: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, textFilterStrategy: TextFilterStrategy, allowGlobbing: typing.Union[jpype.JBoolean, bool], caseSensitive: typing.Union[jpype.JBoolean, bool], inverted: typing.Union[jpype.JBoolean, bool], multiTerm: typing.Union[jpype.JBoolean, bool], delimiterCharacter: typing.Union[jpype.JChar, int, str]) -> None:
        ...

    @typing.overload
    def __init__(self, textFilterStrategy: TextFilterStrategy, allowGlobbing: typing.Union[jpype.JBoolean, bool], caseSensitive: typing.Union[jpype.JBoolean, bool], inverted: typing.Union[jpype.JBoolean, bool], usePath: typing.Union[jpype.JBoolean, bool], multiTerm: typing.Union[jpype.JBoolean, bool], delimiterCharacter: typing.Union[jpype.JChar, int, str], mode: MultitermEvaluationMode) -> None:
        ...
    ...
    @staticmethod
    def restoreFromXML(element: org.jdom2.Element) -> FilterOptions:
        ...

    def shouldUsePath(self) -> bool:
        ...

    def toXML(self) -> org.jdom2.Element:
        ...
...
class ClearFilterLabel(docking.widgets.label.GIconLabel):
    ...
    def hideFilterButton(self) -> None:
        ...

    def setTransparency(self, transparency: typing.Union[jpype.JFloat, float]) -> None:
        ...

    def showFilterButton(self) -> None:
        ...
...
class AbstractRegexBasedTermSplitter(TermSplitter):
    ...
    def __init__(self, delimiter: typing.Union[java.lang.String, str]) -> None:
        ...
...
class CharacterTermSplitter(AbstractRegexBasedTermSplitter):
    ...
    def __init__(self, delimiter: typing.Union[jpype.JChar, int, str]) -> None:
        ...
...
class ContainsTextFilter(MatchesPatternTextFilter):
    ...
    def __init__(self, filterText: typing.Union[java.lang.String, str], caseSensitive: typing.Union[jpype.JBoolean, bool], allowGlobbing: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ContainsTextFilterFactory(TextFilterFactory):
    ...
    def __init__(self, caseSensitive: typing.Union[jpype.JBoolean, bool], allowGlobbing: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class FilterOptionsEditorDialog(docking.DialogComponentProvider):
    ...
    class FilterStrategyPanel(javax.swing.JPanel):
        ...
        def setFilterStrategy(self, filterStrategy: TextFilterStrategy) -> None:
            ...
    ...
    class BooleanPanel(javax.swing.JPanel):
        ...
        def setCaseSensitive(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setCaseSensitiveCBEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setGlobbing(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setGlobbingCBEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    class MultiTermPanel(docking.widgets.InlineComponentTitledPanel):
        ...
        def setDelimiter(self, delimiter: typing.Union[jpype.JChar, int, str]) -> None:
            """
        ...
        def setEvalMode(self, evalMode: MultitermEvaluationMode) -> None:
            """
        ...
        def setMultitermEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setOptionsEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def __init__(self, filterOptions: FilterOptions) -> None:
        ...
...
class FindsPatternTextFilter(AbstractPatternTextFilter):
    ...
    def __init__(self, filterText: typing.Union[java.lang.String, str]) -> None:
        ...
...
class InvertedTextFilter(TextFilter):
    ...
    def __init__(self, filter: TextFilter) -> None:
        ...
...
class StartsWithTextFilterFactory(TextFilterFactory):
    ...
    def __init__(self, caseSensitive: typing.Union[jpype.JBoolean, bool], allowGlobing: typing.Union[jpype.JBoolean, bool]) -> None:
        ...



__all__ = ["FilterTextField", "FilterListener", "FilterOptions", "TextFilterStrategy", "MultitermEvaluationMode", "TextFilterFactory", "TermSplitter", "TextFilter", "ClearFilterLabel", "AbstractPatternTextFilter", "AbstractRegexBasedTermSplitter", "CharacterTermSplitter", "ContainsTextFilter", "MatchesPatternTextFilter", "ContainsTextFilterFactory", "FilterOptionsEditorDialog", "FindsPatternTextFilter", "InvertedTextFilter", "MatchesExactlyTextFilter", "MatchesExactlyTextFilterFactory", "RegularExpressionTextFilterFactory", "StartsWithTextFilter", "StartsWithTextFilterFactory"]
