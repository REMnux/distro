...
class FunctionReachabilityProvider(docking.ComponentProvider):
    ...
    def __init__(self, plugin: FunctionReachabilityPlugin) -> None:
        ...
...
__all__ = ["FREdge", "FRVertex", "FRPathsModel", "FunctionReachabilityPlugin", "FunctionReachabilityProvider", "FunctionReachabilityTableModel", "FunctionReachabilityResult"]
