...
class AccessibleField(javax.accessibility.AccessibleContext, javax.accessibility.Accessible, javax.accessibility.AccessibleComponent, javax.accessibility.AccessibleText):
    ...
    def __init__(self, field: docking.widgets.fieldpanel.field.Field, parent: javax.swing.JComponent, indexInParent: typing.Union[jpype.JInt, int], bounds: java.awt.Rectangle) -> None:
        """
        Constructor
    ...
    def setCaretPos(self, caretPos: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setSelected(self, selected: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AccessibleFieldPanelDelegate(java.lang.Object):
    ...
    class AccessibleLayout(java.lang.Object):
        ...
        def __init__(self, layout: docking.widgets.fieldpanel.support.AnchoredLayout, startingFieldNum: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def __init__(self, layouts: java.util.List[docking.widgets.fieldpanel.support.AnchoredLayout], context: javax.accessibility.AccessibleContext, panel: FieldPanel) -> None:
        ...
    ...
    def setCaret(self, newCursorLoc: docking.widgets.fieldpanel.support.FieldLocation, trigger: docking.widgets.EventTrigger) -> None:
        """
    ...
    def setFieldDescriptionProvider(self, provider: FieldDescriptionProvider) -> None:
        """
    ...
    def setLayouts(self, layouts: java.util.List[docking.widgets.fieldpanel.support.AnchoredLayout]) -> None:
        """
    ...
    def setSelection(self, currentSelection: docking.widgets.fieldpanel.support.FieldSelection, trigger: docking.widgets.EventTrigger) -> None:
        """
...
class FieldPanel(javax.swing.JPanel, docking.widgets.indexedscrollpane.IndexedScrollable, docking.widgets.fieldpanel.listener.LayoutModelListener, javax.swing.event.ChangeListener):
    ...
    class AccessibleFieldPanel(javax.swing.JComponent.AccessibleJComponent, javax.accessibility.AccessibleText):
        ...
        def cursorChanged(self, newCursorLoc: docking.widgets.fieldpanel.support.FieldLocation, trigger: docking.widgets.EventTrigger) -> None:
            ...

        def selectionChanged(self, currentSelection: docking.widgets.fieldpanel.support.FieldSelection, trigger: docking.widgets.EventTrigger) -> None:
            ...
    ...
    class KeyAction(java.lang.Object):
        ...
        def handleKeyEvent(self, event: java.awt.event.KeyEvent) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, model: LayoutModel) -> None:
        ...

    @typing.overload
    def __init__(self, model: LayoutModel, name: typing.Union[java.lang.String, str]) -> None:
        ...

    def addFieldInputListener(self, listener: docking.widgets.fieldpanel.listener.FieldInputListener) -> None:
        ...

    def addFieldLocationListener(self, listener: docking.widgets.fieldpanel.listener.FieldLocationListener) -> None:
        ...

    def addFieldMouseListener(self, listener: docking.widgets.fieldpanel.listener.FieldMouseListener) -> None:
        ...

    def addFieldSelectionListener(self, listener: docking.widgets.fieldpanel.listener.FieldSelectionListener) -> None:
        ...

    def addHighlightListener(self, listener: docking.widgets.fieldpanel.listener.FieldSelectionListener) -> None:
        ...

    def addLayoutListener(self, listener: docking.widgets.fieldpanel.listener.LayoutListener) -> None:
        ...

    def addLiveFieldSelectionListener(self, listener: docking.widgets.fieldpanel.listener.FieldSelectionListener) -> None:
        """
    ...
    def addViewListener(self, listener: docking.widgets.fieldpanel.listener.ViewListener) -> None:
        ...

    def center(self, location: docking.widgets.fieldpanel.support.FieldLocation) -> None:
        ...
    ...
    def enableSelection(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def goTo(self, index: java.math.BigInteger, fieldNum: typing.Union[jpype.JInt, int], row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int], alwaysCenterCursor: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def positionCursor(self, offset: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeFieldInputListener(self, listener: docking.widgets.fieldpanel.listener.FieldInputListener) -> None:
        ...

    def removeFieldLocationListener(self, listener: docking.widgets.fieldpanel.listener.FieldLocationListener) -> None:
        ...

    def removeFieldMouseListener(self, listener: docking.widgets.fieldpanel.listener.FieldMouseListener) -> None:
        ...

    def removeFieldSelectionListener(self, listener: docking.widgets.fieldpanel.listener.FieldSelectionListener) -> None:
        ...

    def removeHighlightListener(self, listener: docking.widgets.fieldpanel.listener.FieldSelectionListener) -> None:
        ...

    def removeLayoutListener(self, listener: docking.widgets.fieldpanel.listener.LayoutListener) -> None:
        ...

    def removeLiveFieldSelectionListener(self, listener: docking.widgets.fieldpanel.listener.FieldSelectionListener) -> None:
        """
    ...
    def removeViewListener(self, listener: docking.widgets.fieldpanel.listener.ViewListener) -> None:
        ...

    def scrollTo(self, fieldLocation: docking.widgets.fieldpanel.support.FieldLocation) -> None:
        ...

    def scrollToCursor(self) -> None:
        ...

    def scrollView(self, viewAmount: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setBackgroundColor(self, c: java.awt.Color) -> None:
        """
    ...
    def setBackgroundColorModel(self, model: docking.widgets.fieldpanel.support.BackgroundColorModel) -> None:
        ...

    def setBlinkCursor(self, blinkCursor: typing.Union[java.lang.Boolean, bool]) -> None:
        ...

    def setCursorOn(self, cursorOn: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setFocusedCursorColor(self, color: java.awt.Color) -> None:
        """
    ...
    def setHighlight(self, sel: docking.widgets.fieldpanel.support.FieldSelection) -> None:
        """
    ...
    def setHorizontalScrollingEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setHoverProvider(self, hoverProvider: docking.widgets.fieldpanel.support.HoverProvider) -> None:
        """
    ...
    def setLayoutModel(self, model: LayoutModel) -> None:
        """
    ...
    def setNonFocusCursorColor(self, color: java.awt.Color) -> None:
        """
    ...
    @typing.overload
    def setSelection(self, sel: docking.widgets.fieldpanel.support.FieldSelection) -> None:
        """
    ...
    @typing.overload
    def setSelection(self, sel: docking.widgets.fieldpanel.support.FieldSelection, trigger: docking.widgets.EventTrigger) -> None:
        """
        Sets the current selection.
    ...
    def setViewerPosition(self, index: java.math.BigInteger, xPos: typing.Union[jpype.JInt, int], yPos: typing.Union[jpype.JInt, int]) -> None:
        """
...
class Layout(java.lang.Object):
    ...
    def insertSpaceAbove(self, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def insertSpaceBelow(self, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def paint(self, c: javax.swing.JComponent, g: java.awt.Graphics, context: docking.widgets.fieldpanel.internal.PaintContext, rect: java.awt.Rectangle, layoutColorMap: docking.widgets.fieldpanel.internal.LayoutBackgroundColorManager, cursorLocation: docking.widgets.fieldpanel.support.FieldLocation) -> None:
        """
...
class HoverHandler(java.awt.event.ActionListener):
    ...
    def mouseHovered(self, e: java.awt.event.MouseEvent) -> None:
        ...

    def scroll(self, scrollAmount: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setHoverProvider(self, hoverProvider: docking.widgets.fieldpanel.support.HoverProvider) -> None:
        ...

    def startHover(self, e: java.awt.event.MouseEvent) -> None:
        ...

    def stopHover(self) -> None:
        ...
...
class LayoutModelIterator(java.util.Iterator[Layout]):
    ...
    @typing.overload
    def __init__(self, layoutModel: LayoutModel) -> None:
        ...

    @typing.overload
    def __init__(self, layoutModel: LayoutModel, startIndex: java.math.BigInteger) -> None:
        ...
...
class FieldPanelOverLayoutEvent(java.lang.Object):
    ...
    def __init__(self, field: docking.widgets.fieldpanel.field.Field, loc: docking.widgets.fieldpanel.support.FieldLocation, component: java.awt.Component) -> None:
        """
...
class FieldPanelOverLayoutListener(java.lang.Object):
    ...
    def fieldLayout(self, ev: FieldPanelOverLayoutEvent) -> None:
        """
...
class FieldPanelOverLayoutManager(java.awt.LayoutManager2):
    ...
    def __init__(self, fieldpane: FieldPanel) -> None:
        ...

    def addLayoutListener(self, listener: FieldPanelOverLayoutListener) -> None:
        """
    ...
    def removeLayoutListener(self, listener: FieldPanelOverLayoutListener) -> None:
        """
...
__all__ = ["AccessibleField", "AccessibleFieldPanelDelegate", "FieldPanel", "FieldDescriptionProvider", "Layout", "LayoutModel", "HoverHandler", "LayoutModelIterator", "FieldPanelOverLayoutEvent", "FieldPanelOverLayoutListener", "FieldPanelOverLayoutManager"]
