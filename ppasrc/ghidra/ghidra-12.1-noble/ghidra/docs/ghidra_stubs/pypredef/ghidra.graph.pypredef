...
class ProgramGraphDisplayOptions(ghidra.service.graph.GraphDisplayOptions):
    ...
    def __init__(self, graphType: ProgramGraphType, tool: ghidra.framework.plugintool.PluginTool) -> None:
        """
        constructor
...
class DefaultGEdge(GEdge[V], typing.Generic[V]):
    ...
    def __init__(self, start: V, end: V) -> None:
        ...
...
class GDirectedGraph(GImplicitDirectedGraph[V, E], typing.Generic[V, E]):
    ...
    def removeEdges(self, edges: collections.abc.Sequence) -> None:
        """
    ...
    def removeVertices(self, vertices: collections.abc.Sequence) -> None:
        """
...
class GraphAlgorithms(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def findPaths(g: GDirectedGraph[V, E], start: V, end: V, accumulator: ghidra.util.datastruct.Accumulator[java.util.List[V]], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def findPaths(g: GDirectedGraph[V, E], start: V, end: V, accumulator: ghidra.util.datastruct.Accumulator[java.util.List[V]], monitor: ghidra.util.task.TimeoutTaskMonitor) -> None:
        """
    ...
    @staticmethod
    def printGraph(g: GDirectedGraph[V, E], ps: java.io.PrintStream) -> None:
        """
...
class GraphPathSet(java.lang.Object, typing.Generic[V]):
    ...
    def add(self, path: GraphPath[V]) -> None:
        ...
...
class GraphToTreeAlgorithm(java.lang.Object, typing.Generic[V, E]):
    ...
    def __init__(self, graph: GDirectedGraph[V, E], edgeComparator: java.util.Comparator[E]) -> None:
        """
        Constructor.
...
class MutableGDirectedGraphWrapper(GDirectedGraph[V, E], typing.Generic[V, E]):
    ...
    **Warning: **As mentioned above, this graph is meant for additive operations.  In its
    ...
    class DummyEdge(DefaultGEdge[java.lang.Object]):
        ...
        def __init__(self, start: java.lang.Object, end: java.lang.Object) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, delegate: GDirectedGraph[V, E]) -> None:
        ...
...
class VisualGraph(GDirectedGraph[V, E], typing.Generic[V, E]):
    ...
    * Zooming - zoom level and related events (when zoomed too far, mouse events are 
    ...
    def addGraphChangeListener(self, l: ghidra.graph.event.VisualGraphChangeListener[V, E]) -> None:
        """
    ...
    def removeGraphChangeListener(self, l: ghidra.graph.event.VisualGraphChangeListener[V, E]) -> None:
        """
    ...
    def setSelectedVertices(self, vertices: java.util.Set[V]) -> None:
        """
    ...
    def setVertexFocused(self, v: V, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def vertexLocationChanged(self, v: V, point: java.awt.Point, changeType: ghidra.graph.viewer.layout.LayoutListener.ChangeType) -> None:
        """
...
__all__ = ["BlockFlowGraphType", "ProgramGraphType", "CallGraphType", "CodeFlowGraphType", "DataFlowGraphType", "ProgramGraphDisplayOptions", "DefaultGEdge", "GEdge", "GDirectedGraph", "GImplicitDirectedGraph", "GEdgeWeightMetric", "GVertex", "GWeightedEdge", "GraphAlgorithms", "GraphFactory", "GraphPath", "GraphPathSet", "GraphToTreeAlgorithm", "MutableGDirectedGraphWrapper", "VisualGraph", "VisualGraphComponentProvider"]
