...
class FVEvent(java.lang.Object):
    ...
    def __init__(self, eventType: FVEvent.EventType, arg: java.lang.Object) -> None:
        """
...
class FVEventListener(java.util.Observable):
    ...
    def send(self, evt: FVEvent) -> None:
        """
...
class ArrowDownAction(javax.swing.AbstractAction):
    ...
    def __init__(self, eventListener: FVEventListener) -> None:
        ...
...
__all__ = ["FVEvent", "FVEventListener", "ArrowDownAction", "ArrowDownSelectionAction", "ArrowUpAction", "ArrowUpSelectionAction", "EndAction", "HomeAction", "MouseWheelAction", "PageDownAction", "PageDownSelectionAction", "PageUpAction", "PageUpSelectionAction"]
