...
class OpBehaviorOther(java.lang.Object):
    ...
    def evaluate(self, emu: ghidra.pcode.emulate.Emulate, out: ghidra.program.model.pcode.Varnode, inputs: jpype.JArray[ghidra.program.model.pcode.Varnode]) -> None:
        """
...
__all__ = ["OpBehaviorOther", "OpBehaviorOtherNOP"]
