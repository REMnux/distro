...
class ContextBitRange(java.lang.Object):
    ...
    def __init__(self, sbit: typing.Union[jpype.JInt, int], ebit: typing.Union[jpype.JInt, int]) -> None:
        ...

    def getValue(self, vec: jpype.JArray[jpype.JInt]) -> int:
        ...

    def setValue(self, vec: jpype.JArray[jpype.JInt], val: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["ContextBitRange", "TrackedContext"]
