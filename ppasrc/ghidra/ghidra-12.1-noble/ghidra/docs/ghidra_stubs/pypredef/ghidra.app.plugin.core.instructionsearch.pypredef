...
class InstructionSearchApi(java.lang.Object):
    ...
    @typing.overload
    def loadInstructions(self, addresses: ghidra.program.model.address.AddressSet, tool: ghidra.framework.plugintool.PluginTool) -> None:
        """
    ...
    @typing.overload
    def loadInstructions(self, bytes: typing.Union[java.lang.String, str], tool: ghidra.framework.plugintool.PluginTool) -> None:
        """
...
__all__ = ["InstructionSearchApi", "InstructionSearchPlugin"]
