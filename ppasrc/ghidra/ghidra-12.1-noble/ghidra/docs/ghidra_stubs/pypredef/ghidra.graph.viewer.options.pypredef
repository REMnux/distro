...
class VisualGraphOptions(java.lang.Object):
    ...
    def loadOptions(self, options: ghidra.framework.options.Options) -> None:
        ...

    def registerOptions(self, options: ghidra.framework.options.Options, help: ghidra.util.HelpLocation) -> None:
        ...

    def setUseAnimation(self, useAnimation: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["VisualGraphOptions", "ViewRestoreOption", "RelayoutOption"]
