...
class ThreadedTableModel(docking.widgets.table.GDynamicColumnTableModel[ROW_OBJECT, DATA_SOURCE], docking.widgets.table.RowObjectFilterModel[ROW_OBJECT], typing.Generic[ROW_OBJECT, DATA_SOURCE]):
    ...
    @typing.overload
    def addInitialLoadListener(self, listener: ThreadedTableModelListener) -> None:
        """
    ...
    @typing.overload
    def addInitialLoadListener(self, completedLoadingConsumer: java.util.function.Consumer[java.lang.Boolean]) -> None:
        """
    ...
    def addObject(self, obj: ROW_OBJECT) -> None:
        """
    ...
    def addThreadedTableModelListener(self, listener: ThreadedTableModelListener) -> None:
        """
    ...
    def removeObject(self, obj: ROW_OBJECT) -> None:
        """
    ...
    def removeThreadedTableModelListener(self, listener: ThreadedTableModelListener) -> None:
        ...

    def setIncrementalTaskMonitor(self, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    def setTableFilter(self, tableFilter: docking.widgets.table.TableFilter[ROW_OBJECT]) -> None:
        """
    ...
    def updateObject(self, obj: ROW_OBJECT) -> None:
        """
...
class ThreadedTableModelListener(java.lang.Object):
    ...
    def loadPending(self) -> None:
        """
        Called when the model has new data to be loaded, but has not yet started the load process.
        """

    def loadingFinished(self, wasCancelled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class TableData(java.lang.Iterable[ROW_OBJECT], typing.Generic[ROW_OBJECT]):
    ...
    def insert(self, value: ROW_OBJECT) -> None:
        """
    ...
    def process(self, function: java.util.function.BiFunction[java.util.List[ROW_OBJECT], docking.widgets.table.TableSortingContext[ROW_OBJECT], java.util.List[ROW_OBJECT]]) -> None:
        """
...
class TableAddRemoveStrategy(java.lang.Object, typing.Generic[T]):
    ...
    def process(self, addRemoveList: java.util.List[docking.widgets.table.AddRemoveListItem[T]], tableData: TableData[T], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class TableUpdateJob(java.lang.Object, typing.Generic[T]):
    ...
    def addRemove(self, item: docking.widgets.table.AddRemoveListItem[T], maxAddRemoveCount: typing.Union[jpype.JInt, int]) -> None:
        """
...
class GThreadedTablePanel(javax.swing.JPanel, typing.Generic[T]):
    ...
    class IncrementalLoadingTaskMonitor(ghidra.util.task.TaskMonitorComponent):
        ...
        def __init__(self, defaultMonitor: ghidra.util.task.TaskMonitorComponent) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, model: ThreadedTableModel[T, typing.Any]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, model: ThreadedTableModel[T, typing.Any], minUpdateDelay: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructs a new threaded table panel.
    ...
    @typing.overload
    def __init__(self, model: ThreadedTableModel[T, typing.Any], minUpdateDelay: typing.Union[jpype.JInt, int], maxUpdateDelay: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructs a new threaded table panel.
    ...
    def setModel(self, model: ThreadedTableModel[T, typing.Any]) -> None:
        ...
...
class ThreadedBackupRowComparator(docking.widgets.table.sort.ColumnRenderedValueBackupComparator[T], typing.Generic[T]):
    ...
    def __init__(self, model: ThreadedTableModel[T, typing.Any], sortColumn: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ThreadedTableColumnComparator(docking.widgets.table.sort.RowBasedColumnComparator[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, model: ThreadedTableModel[T, typing.Any], sortColumn: typing.Union[jpype.JInt, int], comparator: java.util.Comparator[java.lang.Object]) -> None:
        """
        Constructs this class with the given column comparator that will get called after the
        given row is converted to the column value for the given sort column
    ...
    @typing.overload
    def __init__(self, model: ThreadedTableModel[T, typing.Any], sortColumn: typing.Union[jpype.JInt, int], comparator: java.util.Comparator[java.lang.Object], backupRowComparator: java.util.Comparator[java.lang.Object]) -> None:
        """
...
class ThreadedTableModelStub(ThreadedTableModel[ROW_OBJECT, java.lang.Object], typing.Generic[ROW_OBJECT]):
    ...
    **
    ...
    @typing.overload
    def __init__(self, modelName: typing.Union[java.lang.String, str], serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> None:
        ...

    @typing.overload
    def __init__(self, modelName: typing.Union[java.lang.String, str], serviceProvider: ghidra.framework.plugintool.ServiceProvider, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    @typing.overload
    def __init__(self, modelName: typing.Union[java.lang.String, str], serviceProvider: ghidra.framework.plugintool.ServiceProvider, monitor: ghidra.util.task.TaskMonitor, loadIncrementally: typing.Union[jpype.JBoolean, bool]) -> None:
        ...



__all__ = ["ThreadedTableModel", "ThreadedTableModelUpdateMgr", "ThreadedTableModelListener", "TableData", "TableAddRemoveStrategy", "IncrementalLoadJob", "IncrementalJobListener", "TableUpdateJob", "GThreadedTablePanel", "AddRemoveJob", "CoalescingAddRemoveStrategy", "FilterJob", "LoadJob", "LoadSpecificDataJob", "NullTableFilter", "SortJob", "ThreadedBackupRowComparator", "ThreadedTableColumnComparator", "ThreadedTableModelListenerAdapter", "ThreadedTableModelStub"]
