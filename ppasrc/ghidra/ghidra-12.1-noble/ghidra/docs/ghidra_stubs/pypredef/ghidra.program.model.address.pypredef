...
class AddressSet(AddressSetView):
    ...
    class AddressRangeIteratorAdapter(AddressRangeIterator):
        ...
        def __init__(self, iterator: java.util.Iterator[ghidra.util.datastruct.RedBlackEntry[Address, Address]]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, range: AddressRange) -> None:
        """
    ...
    @typing.overload
    def __init__(self, start: Address, end: Address) -> None:
        """
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, start: Address, end: Address) -> None:
        """
        Creates a new Address set containing a single range.
    ...
    @typing.overload
    def __init__(self, set: AddressSetView) -> None:
        """
    ...
    @typing.overload
    def add(self, range: AddressRange) -> None:
        """
    ...
    @typing.overload
    def add(self, start: Address, end: Address) -> None:
        """
    ...
    @typing.overload
    def add(self, addressSet: AddressSetView) -> None:
        """
    ...
    @typing.overload
    def addRange(self, start: Address, end: Address) -> None:
        """
        Adds the range to this set
    ...
    @typing.overload
    def addRange(self, program: ghidra.program.model.listing.Program, start: Address, end: Address) -> None:
        """
    ...
    @typing.overload
    def delete(self, range: AddressRange) -> None:
        """
    ...
    @typing.overload
    def delete(self, start: Address, end: Address) -> None:
        """
    ...
    @typing.overload
    def delete(self, addressSet: AddressSetView) -> None:
        """
    ...
    def deleteFromMin(self, toAddr: Address) -> None:
        """
    ...
    def deleteRange(self, start: Address, end: Address) -> None:
        """
        Deletes a range of addresses from this set
    ...
    def deleteToMax(self, fromAddr: Address) -> None:
        """
...
class AddressRange(java.lang.Comparable[AddressRange], java.lang.Iterable[Address]):
    ...
    @staticmethod
    def checkValidRange(start: Address, end: Address) -> None:
        """
...
class AddressSpace(java.lang.Comparable[AddressSpace]):
    ...
    def getSize(self) -> int:
        """
        :return: the number of bits that are used to form the address.
        :rtype: int
        Thus
    ...
    def isValidRange(self, byteOffset: typing.Union[jpype.JLong, int], length: typing.Union[jpype.JLong, int]) -> bool:
        ...
        :param jpype.JLong or int byteOffset: The offset
...
class GenericAddress(Address):
    ...
    class_: typing.ClassVar[java.lang.Class]
    STACK_ADDRESS_PREFIX: typing.Final = "Stack["
    STACK_ADDRESS_SUFFIX: typing.Final = "]"
...
class AddressFactory(java.lang.Object):
    ...
    def getAddressSpace(self, name: typing.Union[java.lang.String, str]) -> AddressSpace:
        ...
        :param java.lang.String or str name: address space name
        """
    ...
    def getAddressSpace(self, spaceID: typing.Union[jpype.JInt, int]) -> AddressSpace:
        ...
        :param jpype.JInt or int spaceID: address space unique ID
        """
    ...
    def getAllAddresses(self, addrString: typing.Union[java.lang.String, str]) -> jpype.JArray[Address]:
        ...
        :meth:`AddressSpace.isLoadedMemorySpace() <AddressSpace.isLoadedMemorySpace>`) will one uniquely specified non-loaded memory 
...
class OverlayAddressSpace(AbstractAddressSpace):
    ...
    def __init__(self, baseSpace: AddressSpace, unique: typing.Union[jpype.JInt, int], orderedKey: typing.Union[java.lang.String, str]) -> None:
        """
...
class AbstractAddressSpace(AddressSpace):
    ...
    def setHasMappedRegisters(self, hasRegisters: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setShowSpaceName(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DefaultAddressFactory(AddressFactory):
    ...
    @typing.overload
    def __init__(self, addrSpaces: jpype.JArray[AddressSpace]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, addrSpaces: jpype.JArray[AddressSpace], defaultSpace: AddressSpace) -> None:
        """
...
class KeyRange(java.lang.Object):
    ...
    def __init__(self, minKey: typing.Union[jpype.JLong, int], maxKey: typing.Union[jpype.JLong, int]) -> None:
        """
...
class OldGenericNamespaceAddress(GenericAddress):
    ...
    def __init__(self, addrSpace: AddressSpace, offset: typing.Union[jpype.JLong, int], namespaceID: typing.Union[jpype.JLong, int]) -> None:
        ...
    ...
    def getMaxAddress(addrSpace: AddressSpace, namespaceID: typing.Union[jpype.JLong, int]) -> Address:
        ...
        :param jpype.JLong or int namespaceID: The namespace ID
...
class GlobalNamespace(ghidra.program.model.symbol.Namespace):
    ...
    def __init__(self, memory: ghidra.program.model.mem.Memory) -> None:
        """
...
class SegmentedAddressSpace(GenericAddressSpace):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], unique: typing.Union[jpype.JInt, int]) -> None:
        """
...
class GenericAddressSpace(AbstractAddressSpace):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], size: typing.Union[jpype.JInt, int], type: typing.Union[jpype.JInt, int], unique: typing.Union[jpype.JInt, int], showSpaceName: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new GenericAddress space with the given name, bit size, type
        and unique value.
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], size: typing.Union[jpype.JInt, int], unitSize: typing.Union[jpype.JInt, int], type: typing.Union[jpype.JInt, int], unique: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructs a new GenericAddress space with the given name, bit size, type
        and unique value.
...
class AddressMapImpl(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, mapID: typing.Union[jpype.JByte, int], addrFactory: AddressFactory) -> None:
        """
        ...
        :param AddressFactory addrFactory: the address factory
        """
...
class AddressIteratorAdapter(AddressIterator):
    ...
    def __init__(self, iterator: java.util.Iterator[Address]) -> None:
        ...
...
class AddressObjectMap(java.lang.Object):
    ...
    @typing.overload
    def addObject(self, obj: java.lang.Object, set: AddressSetView) -> None:
        """
    ...
    @typing.overload
    def addObject(self, obj: java.lang.Object, startAddr: Address, endAddr: Address) -> None:
        """
    ...
    @typing.overload
    def removeObject(self, obj: java.lang.Object, set: AddressSetView) -> None:
        """
    ...
    @typing.overload
    def removeObject(self, obj: java.lang.Object, startAddr: Address, endAddr: Address) -> None:
        """
...
class AddressRangeChunker(java.lang.Iterable[AddressRange]):
    ...
    @typing.overload
    def __init__(self, range: AddressRange, chunkSize: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, start: Address, end: Address, chunkSize: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class AddressRangeImpl(AddressRange, java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, start: Address, length: typing.Union[jpype.JLong, int]) -> None:
        """
...
class AddressRangeSplitter(AddressRangeIterator):
    ...
    def __init__(self, range: AddressRange, splitSize: typing.Union[jpype.JInt, int], forward: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
...
class ImmutableAddressSet(AddressSetView):
    ...
    def __init__(self, addresses: AddressSetView) -> None:
        ...
...
class CachedAddressSetView(AddressSetView):
    """
    ...
    @typing.type_check_only
    class CachedRangeIterator(generic.util.AbstractPeekableIterator[AddressRange], AddressRangeIterator):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, start: Address, forward: typing.Union[jpype.JBoolean, bool]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, delegate: AddressSetView) -> None:
        ...
...
__all__ = ["AddressSet", "AddressSetView", "AddressRange", "Address", "AddressSpace", "AddressFormatException", "AddressOutOfBoundsException", "AddressOverflowException", "GenericAddress", "AddressFactory", "OverlayAddressSpace", "AbstractAddressSpace", "AddressRangeIterator", "AddressIterator", "DefaultAddressFactory", "KeyRange", "OldGenericNamespaceAddress", "GlobalNamespace", "AddressSetCollection", "SegmentedAddress", "SegmentedAddressSpace", "GenericAddressSpace", "AddressMapImpl", "AddressCollectors", "AddressIteratorAdapter", "AddressObjectMap", "Mark", "AddressRangeChunker", "AddressRangeImpl", "AddressRangeSplitter", "AddressRangeToAddressComparator", "AddressSetMapping", "AddressSetViewAdapter", "EmptyAddressIterator", "EmptyAddressRangeIterator", "GlobalSymbol", "ImmutableAddressSet", "ProtectedAddressSpace", "SegmentMismatchException", "SingleAddressSetCollection", "SpecialAddress", "CachedAddressSetView"]
