...
class TraceSchedule(java.lang.Comparable[TraceSchedule]):
    ...
    class StepAndKind(java.lang.Record):
        ...
        def __init__(self, kind: StepKind, step: Step) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, snap: typing.Union[jpype.JLong, int], steps: Sequence, pSteps: Sequence, source: TraceSchedule.Source) -> None:
        """
    ...
    @typing.overload
    def __init__(self, snap: typing.Union[jpype.JLong, int], steps: Sequence, pSteps: Sequence) -> None:
        """
    ...
    def execute(self, trace: ghidra.trace.model.Trace, machine: ghidra.pcode.emu.PcodeMachine[typing.Any], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def finish(self, trace: ghidra.trace.model.Trace, position: TraceSchedule, machine: ghidra.pcode.emu.PcodeMachine[typing.Any], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def validate(self, trace: ghidra.trace.model.Trace) -> None:
        """
...
class Sequence(java.lang.Comparable[Sequence]):
    ...
    @typing.overload
    def advance(self, seq: Sequence) -> None:
        """
    ...
    def coalescePatches(self, language: ghidra.program.model.lang.Language) -> None:
        ...
...
class Stepper(java.lang.Object):
    ...
    def skip(self, thread: ghidra.pcode.emu.PcodeThread[typing.Any]) -> None:
        ...

    def tick(self, thread: ghidra.pcode.emu.PcodeThread[typing.Any]) -> None:
        ...
...
class Step(java.lang.Comparable[Step]):
    ...
    @typing.overload
    def execute(self, emuThread: ghidra.pcode.emu.PcodeThread[typing.Any], stepper: Stepper, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class TickStep(AbstractStep):
    ...
    def __init__(self, threadKey: typing.Union[jpype.JLong, int], tickCount: typing.Union[jpype.JLong, int]) -> None:
        """
...
class AbstractStep(Step):
    ...
    def advance(self, steps: typing.Union[jpype.JLong, int]) -> None:
        """
...
class PatchStep(Step):
    ...
    def __init__(self, threadKey: typing.Union[jpype.JLong, int], sleigh: typing.Union[java.lang.String, str]) -> None:
        ...
...
class Scheduler(java.lang.Object):
    ...
    class RecordRunResult(java.lang.Record, Scheduler.RunResult):
        ...
        def __init__(self, schedule: TraceSchedule, error: java.lang.Throwable) -> None:
            ...
...
__all__ = ["TraceSchedule", "Sequence", "CompareResult", "StepKind", "Stepper", "Step", "TickStep", "AbstractStep", "PatchStep", "Scheduler", "SkipStep"]
