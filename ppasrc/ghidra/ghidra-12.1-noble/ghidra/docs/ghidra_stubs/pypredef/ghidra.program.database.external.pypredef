...
class ExternalLocationDB(ghidra.program.model.symbol.ExternalLocation):
    ...
    def saveOriginalNameIfNeeded(self, oldNamespace: ghidra.program.model.symbol.Namespace, oldName: typing.Union[java.lang.String, str], oldSource: ghidra.program.model.symbol.SourceType) -> None:
        ...



__all__ = ["ExternalManagerDB", "OldExtNameAdapter", "OldExtRefAdapter", "ExternalLocationDB"]
