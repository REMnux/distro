...
class DeleteBlockCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, blockAddresses: jpype.JArray[ghidra.program.model.address.Address], listener: DeleteBlockListener) -> None:
        """
...
class DeleteBlockListener(java.lang.Object):
    ...
    def deleteBlockCompleted(self, cmd: DeleteBlockCmd) -> None:
        """
...
class MoveBlockListener(java.lang.Object):
    ...
    def moveBlockCompleted(self, cmd: MoveBlockTask) -> None:
        """
...
class MoveBlockTask(ghidra.program.util.ProgramTask):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, currentStart: ghidra.program.model.address.Address, newStart: ghidra.program.model.address.Address, listener: MoveBlockListener) -> None:
        """
...
__all__ = ["AbstractAddMemoryBlockCmd", "AddBitMappedMemoryBlockCmd", "AddByteMappedMemoryBlockCmd", "AddFileBytesMemoryBlockCmd", "AddInitializedMemoryBlockCmd", "AddUninitializedMemoryBlockCmd", "DeleteBlockCmd", "DeleteBlockListener", "MoveBlockListener", "MoveBlockTask"]
