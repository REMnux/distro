...
class Relocation(ghidra.app.util.bin.StructConverter):
    ...
    def apply(self, importState: ImportStateCache, relocState: RelocationState, header: ContainerHeader, program: ghidra.program.model.listing.Program, log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class ImportStateCache(java.lang.Object):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, header: ContainerHeader) -> None:
        ...
    ...
    def setMemoryBlockForSection(self, section: SectionHeader, block: ghidra.program.model.mem.MemoryBlock) -> None:
        ...
...
class RelocationState(java.lang.Object):
    ...
    **``sectionD``**
    ...
    def __init__(self, header: ContainerHeader, relocationHeader: LoaderRelocationHeader, program: ghidra.program.model.listing.Program, importState: ImportStateCache) -> None:
        """
    ...
    def incrementRelocationAddress(self, addend: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def relocateMemoryAt(self, address: ghidra.program.model.address.Address, addend: typing.Union[jpype.JInt, int], log: ghidra.app.util.importer.MessageLog) -> None:
        """
    ...
    def setImportIndex(self, importIndex: typing.Union[jpype.JInt, int]) -> None:
        """
...
class PefDebug(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, memory: ghidra.program.model.mem.Memory, address: ghidra.program.model.address.Address) -> None:
        ...
...
__all__ = ["ContainerHeader", "SectionHeader", "LoaderInfoHeader", "LoaderRelocationHeader", "Relocation", "ImportStateCache", "RelocationState", "ImportedLibrary", "ImportedSymbol", "AbstractSymbol", "ExportedSymbolHashSlot", "ExportedSymbolKey", "ExportedSymbol", "SymbolClass", "SectionKind", "SectionShareKind", "PefException", "PackedDataOpcodes", "PefConstants", "PefDebug", "RelocByIndexGroup", "RelocBySectDWithSkip", "RelocIncrPosition", "RelocLgByImport", "RelocLgRepeat", "RelocLgSetOrBySection", "RelocSetPosition", "RelocSmRepeat", "RelocUndefinedOpcode", "RelocValueGroup", "RelocationFactory"]
