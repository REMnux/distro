...
class BasicBlockModel(SimpleBlockModel):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, includeExternals: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class CodeBlockImpl(CodeBlock):
    ...
    def __init__(self, model: CodeBlockModel, starts: jpype.JArray[ghidra.program.model.address.Address], body: ghidra.program.model.address.AddressSetView) -> None:
        """
...
class CodeBlockReferenceImpl(CodeBlockReference):
    ...
    def __init__(self, source: CodeBlock, destination: CodeBlock, flowType: ghidra.program.model.symbol.FlowType, reference: ghidra.program.model.address.Address, referent: ghidra.program.model.address.Address) -> None:
        """
...
class ExtCodeBlockImpl(ghidra.program.model.address.AddressSet, CodeBlock):
    ...
    def __init__(self, model: CodeBlockModel, extAddr: ghidra.program.model.address.Address) -> None:
        ...
...
class FollowFlow(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addressSet: ghidra.program.model.address.AddressSetView, doNotFollow: jpype.JArray[ghidra.program.model.symbol.FlowType]) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addressSet: ghidra.program.model.address.AddressSetView, doNotFollow: jpype.JArray[ghidra.program.model.symbol.FlowType], followIntoFunctions: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, addressSet: ghidra.program.model.address.AddressSet, doNotFollow: jpype.JArray[ghidra.program.model.symbol.FlowType], followIntoFunctions: typing.Union[jpype.JBoolean, bool], includeData: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
...
class SimpleBlockIterator(CodeBlockIterator):
    ...
    @typing.overload
    def __init__(self, model: SimpleBlockModel, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def __init__(self, model: SimpleBlockModel, set: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class SimpleDestReferenceIterator(CodeBlockReferenceIterator):
    ...
    def __init__(self, block: CodeBlock, followIndirectFlows: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class SingleEntSubIterator(CodeBlockIterator):
    ...
    @typing.overload
    def __init__(self, model: OverlapCodeSubModel, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Creates a new iterator that will iterate over the entire
        program starting from its current minimum address.
    ...
    @typing.overload
    def __init__(self, model: OverlapCodeSubModel, set: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Creates a new iterator that will iterate over the
        program within a given address range set. All blocks which 
        overlap the address set will be returned.
...
class SubroutineDestReferenceIterator(CodeBlockReferenceIterator):
    ...
    def __init__(self, block: CodeBlock, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Construct an Iterator over Destination blocks for a CodeBlock.
...
__all__ = ["BasicBlockModel", "SimpleBlockModel", "CodeBlockModel", "CodeBlock", "CodeBlockIterator", "CodeBlockReferenceIterator", "CodeBlockReference", "CodeBlockCache", "CodeBlockImpl", "CodeBlockReferenceImpl", "ExtCodeBlockImpl", "EmptyCodeBlockReferenceIterator", "FollowFlow", "IsolatedEntrySubModel", "OverlapCodeSubModel", "SubroutineBlockModel", "MultEntSubModel", "MultEntSubIterator", "PartitionCodeSubIterator", "PartitionCodeSubModel", "SimpleBlockIterator", "SimpleDestReferenceIterator", "SimpleSourceReferenceIterator", "SingleEntSubIterator", "SubroutineDestReferenceIterator", "SubroutineSourceReferenceIterator"]
