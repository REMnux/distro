...
class ColumnFilterManager(java.lang.Object, typing.Generic[ROW_OBJECT]):
    ...
    class EditFilterActionState(ColumnFilterManager.ColumnFilterActionState):
        ...
        def __init__(self, filter: ColumnBasedTableFilter[ROW_OBJECT]) -> None:
            ...
    ...
    def __init__(self, table: javax.swing.JTable, rowObjectFilterModel: docking.widgets.table.RowObjectFilterModel[ROW_OBJECT], preferenceKey: typing.Union[java.lang.String, str], filterChangedCallback: utility.function.Callback) -> None:
        ...
    ...
    def setFilter(self, newFilter: ColumnBasedTableFilter[ROW_OBJECT]) -> None:
        ...

    def updateSavedFilters(self, filter: ColumnBasedTableFilter[ROW_OBJECT], add: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ColumnBasedTableFilter(docking.widgets.table.TableFilter[R], typing.Generic[R]):
    ...
    def __init__(self, model: docking.widgets.table.RowObjectTableModel[R]) -> None:
        """
    ...
    def addConstraintSet(self, logicalOp: LogicOperation, columnIndex: typing.Union[jpype.JInt, int], constraints: java.util.List[docking.widgets.table.constraint.ColumnConstraint[T]]) -> None:
        """
    ...
    def restore(self, saveState: ghidra.framework.options.SaveState, dataSource: java.lang.Object) -> None:
        """
...
class ColumnConstraintSet(java.lang.Object, typing.Generic[R, T]):
    ...
    @typing.overload
    def __init__(self, model: docking.widgets.table.RowObjectTableModel[R], columnIndex: typing.Union[jpype.JInt, int], constraints: java.util.List[docking.widgets.table.constraint.ColumnConstraint[T]], logicOperation: LogicOperation) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, model: docking.widgets.table.RowObjectTableModel[R], saveState: ghidra.framework.options.SaveState, dataSource: java.lang.Object) -> None:
        """
...
class ColumnFilterSaveManager(java.lang.Object, typing.Generic[R]):
    ...
    def __init__(self, tablePreferenceKey: typing.Union[java.lang.String, str], table: javax.swing.JTable, model: docking.widgets.table.RowObjectTableModel[R], dataSource: java.lang.Object) -> None:
        """
        Constructor
    ...
    def addFilter(self, filter: ColumnBasedTableFilter[R]) -> None:
        """
    ...
    def removeFilter(self, filter: ColumnBasedTableFilter[R]) -> None:
        """
...
__all__ = ["ColumnFilterManager", "ColumnBasedTableFilter", "ColumnConstraintSet", "LogicOperation", "ColumnFilterSaveManager"]
