...
class BigFloat(java.lang.Comparable[BigFloat]):
    ...
    * value = sign * unscaled * 2 ^ (scale-fracbits)
    ...
    @typing.overload
    def add(self, other: BigFloat) -> None:
        """
        ``this+=other``
    ...
    @typing.overload
    def div(self, other: BigFloat) -> None:
        """
        ``this/=other``
    ...
    @typing.overload
    def mul(self, other: BigFloat) -> None:
        """
        ``this*=other``
    ...
    @typing.overload
    def sub(self, other: BigFloat) -> None:
        """
        ``this-=other``
...
class FloatFormat(java.lang.Object):
    ...
    class SmallFloatData(java.lang.Object):
        ...
        def __init__(self, fracbits: typing.Union[jpype.JInt, int], expbits: typing.Union[jpype.JInt, int], kind: FloatKind, sign: typing.Union[jpype.JInt, int], unscaled: typing.Union[jpype.JLong, int], scale: typing.Union[jpype.JInt, int]) -> None:
            """
...
class UnsupportedFloatFormatException(ghidra.pcode.error.LowlevelError):
    ...
    @typing.overload
    def __init__(self, formatSize: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["BigFloat", "FloatKind", "FloatFormat", "UnsupportedFloatFormatException", "FloatFormatFactory"]
