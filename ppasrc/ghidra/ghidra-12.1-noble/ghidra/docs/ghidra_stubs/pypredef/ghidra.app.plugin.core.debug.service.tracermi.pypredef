...
class TraceRmiTarget(ghidra.app.plugin.core.debug.service.target.AbstractTarget):
    ...
    class TraceRmiActionEntry(ghidra.debug.api.target.Target.ActionEntry):
        ...
        def __init__(self, method: ghidra.debug.api.tracermi.RemoteMethod, args: collections.abc.Mapping) -> None:
            ...
    ...
    class RequestCaches(java.lang.Object):
        ...
        def invalidateMemory(self) -> None:
            ...
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, connection: ghidra.debug.api.tracermi.TraceRmiConnection, trace: ghidra.trace.model.Trace) -> None:
        ...
...
class DefaultTraceRmiAcceptor(AbstractTraceRmiListener, ghidra.debug.api.tracermi.TraceRmiAcceptor):
    ...
    def __init__(self, plugin: TraceRmiPlugin, address: java.net.SocketAddress) -> None:
        ...
...
class TraceRmiHandler(AbstractTraceRmiConnection):
    ...
    class VersionMismatchError(ghidra.debug.api.tracermi.TraceRmiError):
        ...
        def __init__(self, remote: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class InvalidTxIdError(ghidra.debug.api.tracermi.TraceRmiError):
        ...
        def __init__(self, id: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    class DoId(java.lang.Record):
        ...
        def __init__(self, oid: ghidra.rmi.trace.TraceRmi.DomObjId) -> None:
            ...
    ...
    class OpenTraceMap(java.lang.Object):
        ...
        def put(self, openTrace: OpenTrace) -> None:
            ...
    ...
    class_: typing.ClassVar[java.lang.Class]
    VERSION: typing.Final = "12.1"
    """
    NOTE: This can't just be :meth:`Application.getApplicationVersion() <Application.getApplicationVersion>`, because the Python
    client only specifies up to the minor, not patch, release.
    """


    def __init__(self, plugin: TraceRmiPlugin, socket: java.net.Socket) -> None:
        """
        Create a handler
    ...
    def registerTerminals(self, terminals: collections.abc.Sequence) -> None:
        ...
...
class DefaultRemoteAsyncResult(java.util.concurrent.CompletableFuture[java.lang.Object], ghidra.debug.api.tracermi.RemoteAsyncResult):
    ...
    @typing.overload
    def __init__(self, open: OpenTrace) -> None:
        ...
...
class OpenTrace(ValueDecoder):
    ...
    def dispose(self, consumer: TraceRmiHandler) -> None:
        ...
...
class RecordRemoteMethod(java.lang.Record, ghidra.debug.api.tracermi.RemoteMethod):
    ...
    def __init__(self, handler: TraceRmiHandler, name: typing.Union[java.lang.String, str], action: ghidra.debug.api.target.ActionName, display: typing.Union[java.lang.String, str], icon: javax.swing.Icon, okText: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], parameters: collections.abc.Mapping, retType: ghidra.trace.model.target.schema.TraceObjectSchema.SchemaName) -> None:
        ...
...
__all__ = ["TraceRmiTarget", "DefaultTraceRmiAcceptor", "AbstractTraceRmiListener", "TraceRmiHandler", "AbstractTraceRmiConnection", "TraceRmiPlugin", "DefaultRemoteMethodRegistry", "DefaultRemoteAsyncResult", "OpenTrace", "ValueDecoder", "RecordRemoteParameter", "ValueSupplier", "TraceRmiServer", "RecordRemoteMethod"]
