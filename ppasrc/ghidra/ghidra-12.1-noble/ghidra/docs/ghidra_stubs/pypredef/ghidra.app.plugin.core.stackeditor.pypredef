...
class StackEditorManagerPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.options.OptionsChangeListener, StackEditorOptionManager):
    ...
    def edit(self, function: ghidra.program.model.listing.Function) -> None:
        ...
...
class StackEditorManager(ghidra.app.plugin.core.compositeeditor.EditorListener):
    ...
    def __init__(self, plugin: StackEditorManagerPlugin) -> None:
        """
        Constructor
...
class StackEditorProvider(ghidra.app.plugin.core.compositeeditor.CompositeEditorProvider[StackFrameDataType, StackEditorModel], ghidra.framework.model.DomainObjectListener):
    ...
    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, function: ghidra.program.model.listing.Function) -> None:
        ...
...
class StackFrameDataType(ghidra.program.model.data.Structure):
    ...
    class StackComponentWrapper(ghidra.program.model.data.DataTypeComponent):
        ...
        def setComment(self, comment: typing.Union[java.lang.String, str]) -> ghidra.program.model.data.DataTypeComponent:
            """
            Unsupported method.  Must use :meth:`StackFrameDataType.setComment(int, String) <StackFrameDataType.setComment>`.
            """

        def setFieldName(self, fieldName: typing.Union[java.lang.String, str]) -> ghidra.program.model.data.DataTypeComponent:
            """
    ...
    def checkNameChange(self, ordinal: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str]) -> str:
        """
        ...
        :rtype: str
        :raises IndexOutOfBoundsException: if specified ordinal is out of range
        :raises InvalidNameException: if an invalid or duplicate name is specified
        """
...
class StackEditorModel(ghidra.app.plugin.core.compositeeditor.CompositeEditorModel[StackFrameDataType]):
    ...
    def setComponentOffset(self, rowIndex: typing.Union[jpype.JInt, int], value: typing.Union[java.lang.String, str]) -> None:
        ...
...
class StackEditorPanel(ghidra.app.plugin.core.compositeeditor.CompositeEditorPanel[StackFrameDataType, StackEditorModel]):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, model: StackEditorModel, provider: StackEditorProvider) -> None:
        ...



__all__ = ["EditStackAction", "StackEditorManagerPlugin", "StackEditorOptionManager", "StackEditorManager", "StackEditorProvider", "StackFrameDataType", "StackEditorModel", "StackEditorPanel"]
