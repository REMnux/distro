...
class Archive(ghidra.app.merge.DataTypeManagerOwner, java.lang.Comparable[Archive]):
    ...
    def saveAs(self, component: java.awt.Component) -> None:
        """
...
class DuplicateIdException(java.lang.Exception):
    ...
    def __init__(self, newArchiveName: typing.Union[java.lang.String, str], existingArchiveName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DataTypeManagerHandler(java.lang.Object):
    ...
    def addArchiveManagerListener(self, listener: ArchiveManagerListener) -> None:
        ...
    ...
    @typing.overload
    def closeArchive(self, archive: Archive) -> None:
        ...
    ...
    def fireArchiveStateChanged(self, archive: Archive) -> None:
        ...

    def fireDataTypeManagerChanged(self, archive: FileArchive) -> None:
        ...
    ...
    @staticmethod
    def handleArchiveFileException(plugin: ghidra.app.plugin.core.datamgr.DataTypeManagerPlugin, archiveFile: generic.jar.ResourceFile, t: java.lang.Throwable) -> None:
        """
    ...
    def removeArchiveManagerListener(self, listener: ArchiveManagerListener) -> None:
        ...

    def removeDataTypeManagerChangeListener(self, listener: ghidra.program.model.data.DataTypeManagerChangeListener) -> None:
        ...

    def removeInvalidArchive(self, archive: InvalidFileArchive) -> None:
        ...

    def restore(self, saveState: ghidra.framework.options.SaveState) -> None:
        ...
    ...
    @typing.overload
    def save(self, domainObject: ghidra.framework.model.DomainObject) -> None:
        ...

    def saveAs(self, domainObject: ghidra.framework.model.DomainObject) -> None:
        ...

    def setRecentlyUsedDataType(self, dataType: ghidra.program.model.data.DataType) -> None:
        ...
...
class DataTypeIndexer(java.lang.Object):
    """
    A class that stores a sorted list of all the :obj:`DataType` and a list of all the 
    :obj:`CategoryPath` objects in the current data type manager plugin.  This class does its work 
    lazily such that no work is done until :meth:`getSortedDataTypeList() <.getSortedDataTypeList>` is called. Even when that
    method is called no work will be done if the state of the data types in the system hasn't 
    changed.
    """

    @typing.type_check_only
    class DataCache(java.lang.Record):

        class_: typing.ClassVar[java.lang.Class]

        def categories(self) -> java.util.List[ghidra.program.model.data.CategoryPath]:
            ...

        def dataTypes(self) -> java.util.List[ghidra.program.model.data.DataType]:
            ...
    ...
    @typing.type_check_only
    class CaseInsensitiveCategoryComparator(java.util.Comparator[ghidra.program.model.data.CategoryPath]):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    def addDataTypeManager(self, dataTypeManager: ghidra.program.model.data.DataTypeManager) -> None:
        ...

    def getSortedCategoryPathList(self) -> java.util.List[ghidra.program.model.data.CategoryPath]:
        """
        Returns a list of the unique Category Paths (:obj:`CategoryPath`) as utilized by the 
        data types open in the current tool.
        
        :return: a list of the :obj:`CategoryPath` associated with the data types open in the 
        current tool.
    ...
    def removeDataTypeManager(self, dataTypeManager: ghidra.program.model.data.DataTypeManager) -> None:
        ...
...
class ArchiveManagerListener(java.lang.Object):
    ...
    def archiveClosed(self, archive: Archive) -> None:
        """
    ...
    def archiveStateChanged(self, archive: Archive) -> None:
        """
...
class FileArchive(Archive):
    ...
    def saveAs(self, file: jpype.protocol.SupportsPath) -> None:
        ...
...
class ArchiveUtils(java.lang.Object):
    ...
    @staticmethod
    def save(component: java.awt.Component, archive: Archive) -> None:
        """
    ...
    @staticmethod
    def saveAs(component: java.awt.Component, archive: FileArchive) -> None:
        """
...
class BuiltInSourceArchive(ghidra.program.model.data.SourceArchive):
    ...
    def setPathname(self, name: typing.Union[java.lang.String, str]) -> None:
        ...
...
__all__ = ["DefaultDataTypeArchiveService", "Archive", "DuplicateIdException", "ProgramArchive", "DomainFileArchive", "DataTypeManagerHandler", "ProjectArchive", "InvalidFileArchive", "DataTypeIndexer", "ArchiveManagerListener", "FileArchive", "ArchiveFileChooser", "ArchiveUtils", "BuiltInArchive", "BuiltInSourceArchive"]
