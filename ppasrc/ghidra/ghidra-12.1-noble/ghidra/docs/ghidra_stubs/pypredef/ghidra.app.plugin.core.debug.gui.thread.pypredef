...
class DebuggerThreadsPanel(ghidra.app.plugin.core.debug.gui.model.AbstractObjectsTableBasedPanel[ghidra.trace.model.thread.TraceThread]):
    ...
    def __init__(self, provider: DebuggerThreadsProvider) -> None:
        ...
...
class DebuggerThreadsProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, plugin: DebuggerThreadsPlugin) -> None:
        ...

    def coordinatesActivated(self, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> None:
        ...

    def setEmulationService(self, emulationService: ghidra.app.services.DebuggerEmulationService) -> None:
        ...
...
__all__ = ["DebuggerTraceFileActionContext", "DebuggerThreadsPanel", "DebuggerThreadsProvider", "DebuggerThreadsPlugin"]
