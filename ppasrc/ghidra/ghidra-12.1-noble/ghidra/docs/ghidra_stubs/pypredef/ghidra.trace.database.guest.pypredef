...
class DBTraceGuestPlatform(ghidra.util.database.DBAnnotatedObject, ghidra.trace.model.guest.TraceGuestPlatform, InternalTracePlatform):
    ...
    def __init__(self, manager: DBTracePlatformManager, store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
        ...
...
class DBTracePlatformManager(ghidra.trace.database.DBTraceManager, ghidra.trace.model.guest.TracePlatformManager):
    ...
    def __init__(self, dbh: db.DBHandle, openMode: ghidra.framework.data.OpenMode, lock: java.util.concurrent.locks.ReadWriteLock, monitor: ghidra.util.task.TaskMonitor, baseCompilerSpec: ghidra.program.model.lang.CompilerSpec, trace: ghidra.trace.database.DBTrace) -> None:
        ...
...
class DBTraceGuestPlatformMappedRange(ghidra.util.database.DBAnnotatedObject, ghidra.trace.model.guest.TraceGuestPlatformMappedRange):
    ...
    def __init__(self, manager: DBTracePlatformManager, s: ghidra.util.database.DBCachedObjectStore[typing.Any], r: db.DBRecord) -> None:
        ...
...
class DBTraceGuestPlatformMappedMemory(ghidra.program.model.mem.Memory):
    ...
    def __init__(self, manager: ghidra.trace.database.memory.DBTraceMemoryManager, guest: DBTraceGuestPlatform, snap: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class DBTraceObjectRegisterSupport(java.lang.Enum[DBTraceObjectRegisterSupport]):
    ...
    def onMappingAddedCheckTransfer(self, mapped: ghidra.trace.model.guest.TraceGuestPlatformMappedRange) -> None:
        ...

    def onMappingAddedCheckTransferMemoryMapped(self, root: ghidra.trace.model.target.TraceObject, mapped: ghidra.trace.model.guest.TraceGuestPlatformMappedRange) -> None:
        ...

    def onSpaceAddedCheckTransfer(self, trace: ghidra.trace.model.Trace, space: ghidra.program.model.address.AddressSpace) -> None:
        ...

    def onSymbolAddedCheckTransfer(self, symbol: ghidra.trace.model.symbol.TraceSymbol) -> None:
        ...

    def onSymbolAddedCheckTransferToLabel(self, label: ghidra.trace.model.symbol.TraceLabelSymbol, isBigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def onValueCreatedCheckTransfer(self, objectValue: ghidra.trace.model.target.TraceObjectValue) -> None:
        ...

    def onValueCreatedTransfer(self, registerValue: ghidra.trace.model.target.TraceObjectValue) -> None:
        ...

    def processEvent(self, event: ghidra.trace.util.TraceChangeRecord[typing.Any, typing.Any]) -> None:
        ...
...
__all__ = ["DBTraceGuestPlatform", "InternalTracePlatform", "DBTracePlatformManager", "DBTraceGuestPlatformMappedRange", "DBTraceGuestPlatformMappedMemory", "DBTraceObjectRegisterSupport"]
