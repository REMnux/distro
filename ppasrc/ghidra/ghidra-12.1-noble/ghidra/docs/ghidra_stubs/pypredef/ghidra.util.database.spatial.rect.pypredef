...
class Abstract2DRStarTree(ghidra.util.database.spatial.AbstractRStarConstraintsTree[DS, DR, NS, NR, T, Q], typing.Generic[X, Y, DS, DR, NS, NR, T, Q]):
    ...
    class AsSpatialMap(ghidra.util.database.spatial.AbstractConstraintsTreeSpatialMap[DS, DR, NS, T, Q], typing.Generic[DS, DR, NS, T, Q]):
        ...
        def __init__(self, tree: ghidra.util.database.spatial.AbstractConstraintsTree[DS, DR, NS, typing.Any, T, Q], query: Q) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, storeFactory: ghidra.util.database.DBCachedObjectStoreFactory, tableName: typing.Union[java.lang.String, str], space: EuclideanSpace2D[X, Y], dataType: java.lang.Class[DR], nodeType: java.lang.Class[NR], upgradable: typing.Union[jpype.JBoolean, bool], maxChildren: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class AbstractRectangle2DQuery(ghidra.util.database.spatial.Query[DS, NS], typing.Generic[X, Y, DS, NS, Q]):
    ...
    def __init__(self, r1: NS, r2: NS, space: EuclideanSpace2D[X, Y], direction: Rectangle2DDirection) -> None:
        ...
...
class ImmutablePoint2D(Point2D[X, Y], typing.Generic[X, Y]):
    ...
    def __init__(self, x: X, y: Y, space: EuclideanSpace2D[X, Y]) -> None:
        ...
...
class ImmutableRectangle2D(Rectangle2D[X, Y, R], typing.Generic[X, Y, R]):
    ...
    def __init__(self, x1: X, x2: X, y1: Y, y2: Y, space: EuclideanSpace2D[X, Y]) -> None:
        ...



__all__ = ["Abstract2DRStarTree", "Rectangle2D", "AbstractRectangle2DQuery", "EuclideanSpace2D", "Point2D", "Rectangle2DDirection", "ImmutablePoint2D", "ImmutableRectangle2D"]
