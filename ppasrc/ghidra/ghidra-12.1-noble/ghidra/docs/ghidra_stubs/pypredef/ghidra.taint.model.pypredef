...
class TaintMark(java.lang.Object):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], tags: java.util.Set[java.lang.String]) -> None:
        """
...
class TaintVec(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, length: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, length: typing.Union[jpype.JInt, int], op: ghidra.program.model.pcode.PcodeOp) -> None:
        """
        Create a new uninitialized taint vector of the given length
        
        :param jpype.JInt or int length: the length
        :param ghidra.program.model.pcode.PcodeOp op: the originating op
        """
    ...
    def getOriginatingOp(self) -> ghidra.program.model.pcode.PcodeOp:
        """
    ...
    @staticmethod
    def of(op: ghidra.program.model.pcode.PcodeOp, *taints: TaintSet) -> TaintVec:
        """
        Create a vector of taint sets
        
        :param ghidra.program.model.pcode.PcodeOp op: the originating p-code op
        :param jpype.JArray[TaintSet] taints: the taint set
        :return: the new vector
        :rtype: TaintVec
        """

    @typing.overload
    def set(self, i: typing.Union[jpype.JInt, int], s: TaintSet) -> None:
        """
    ...
    def withOp(self, op: ghidra.program.model.pcode.PcodeOp) -> TaintVec:
        """
        Supply the originating op
        
        :param ghidra.program.model.pcode.PcodeOp op: originating op
    ...
    @property
    def originatingOp(self) -> ghidra.program.model.pcode.PcodeOp:
        ...



__all__ = ["TaintMark", "TaintSet", "TaintVec"]
