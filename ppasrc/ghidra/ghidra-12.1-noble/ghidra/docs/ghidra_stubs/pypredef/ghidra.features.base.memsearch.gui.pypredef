...
class CombinedMatchTableLoader(MemoryMatchTableLoader):
    ...
    def __init__(self, memSearcher: ghidra.features.base.memsearch.searcher.MemorySearcher[ghidra.features.base.memsearch.matcher.SearchData], previousResults: java.util.List[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]], combiner: ghidra.features.base.memsearch.combiner.Combiner) -> None:
        ...
...
class MemoryMatchTableLoader(java.lang.Object):
    ...
    def loadResults(self, accumulator: ghidra.util.datastruct.Accumulator[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Called by the table model to initiate searching and loading using the threaded table models
        threading infrastructure.
        
        :param ghidra.util.datastruct.Accumulator[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]] accumulator: the accumulator to store results that will appear in the results table
...
class FindOnceTableLoader(MemoryMatchTableLoader):
    ...
    def __init__(self, searcher: ghidra.features.base.memsearch.searcher.MemorySearcher[ghidra.features.base.memsearch.matcher.SearchData], address: ghidra.program.model.address.Address, previousResults: java.util.List[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]], panel: MemorySearchResultsPanel, forward: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class MemorySearchResultsPanel(javax.swing.JPanel):
    ...
    class SearchOnceTask(ghidra.util.task.Task):
        ...
        def __init__(self, forward: typing.Union[jpype.JBoolean, bool], searcher: ghidra.features.base.memsearch.searcher.MemorySearcher[ghidra.features.base.memsearch.matcher.SearchData], start: ghidra.program.model.address.Address) -> None:
            ...
    ...
    class RefreshAndScanTask(ghidra.util.task.Task):
        ...
        @typing.overload
        def __init__(self, byteSource: ghidra.features.base.memsearch.bytesource.AddressableByteSource, scanner: ghidra.features.base.memsearch.scan.Scanner) -> None:
            ...

        @typing.overload
        def __init__(self, byteSource: ghidra.features.base.memsearch.bytesource.AddressableByteSource, scanner: ghidra.features.base.memsearch.scan.Scanner, matches: java.util.List[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]]) -> None:
            ...
    ...
    def getSelectedMatch(self) -> ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]:
        ...
    ...
    @typing.overload
    def refreshAndMaybeScanForChanges(self, byteSource: ghidra.features.base.memsearch.bytesource.AddressableByteSource, scanner: ghidra.features.base.memsearch.scan.Scanner) -> None:
        ...

    @typing.overload
    def refreshAndMaybeScanForChanges(self, byteSource: ghidra.features.base.memsearch.bytesource.AddressableByteSource, scanner: ghidra.features.base.memsearch.scan.Scanner, previousResults: java.util.List[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]]) -> None:
        ...

    def search(self, searcher: ghidra.features.base.memsearch.searcher.MemorySearcher[ghidra.features.base.memsearch.matcher.SearchData], combiner: ghidra.features.base.memsearch.combiner.Combiner) -> None:
        ...

    def searchOnce(self, searcher: ghidra.features.base.memsearch.searcher.MemorySearcher[ghidra.features.base.memsearch.matcher.SearchData], address: ghidra.program.model.address.Address, forward: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @property
    def selectedMatch(self) -> ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]:
        ...
...
class MemoryMatchTableModel(ghidra.util.table.AddressBasedTableModel[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]]):
    """
    Table model for memory search results.
    """

    class MatchBytesColumn(docking.widgets.table.DynamicTableColumnExtensionPoint[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData], java.lang.String, ghidra.program.model.listing.Program]):
    ...
    class MatchValueColumn(docking.widgets.table.DynamicTableColumnExtensionPoint[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData], java.lang.String, ghidra.program.model.listing.Program]):
...
class MemorySearchProvider(ghidra.framework.plugintool.ComponentProviderAdapter, docking.DockingContextListener, ghidra.app.nav.NavigatableRemovalListener, ghidra.framework.model.DomainObjectClosedListener):
    ...
    def __init__(self, plugin: MemorySearchPlugin, navigatable: ghidra.app.nav.Navigatable, settings: SearchSettings, options: MemorySearchOptions, history: SearchHistory) -> None:
        ...

    def generateNewProvider(self, scanner: ghidra.features.base.memsearch.scan.Scanner) -> None:
        ...
    ...
    def getSearchResults(self) -> java.util.List[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]]:
        ...
    ...
    def setSearchCombiner(self, combiner: ghidra.features.base.memsearch.combiner.Combiner) -> None:
        ...

    def setSearchInput(self, input: typing.Union[java.lang.String, str]) -> None:
        ...

    def setSearchSelectionOnly(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setSettings(self, settings: SearchSettings) -> None:
        ...

    def showOptions(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def showScanPanel(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def showSearchPanel(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    @property
    def searchResults(self) -> java.util.List[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]]:
        ...
...
class SearchMarkers(java.lang.Object):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, title: typing.Union[java.lang.String, str], program: ghidra.program.model.listing.Program) -> None:
        ...
...
class SearchHistory(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, maxHistory: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, other: SearchHistory) -> None:
        ...

    def addSearch(self, matcher: ghidra.features.base.memsearch.matcher.UserInputByteMatcher) -> None:
        ...

    def getHistoryAsArray(self) -> jpype.JArray[ghidra.features.base.memsearch.matcher.UserInputByteMatcher]:
        ...

    @property
    def historyAsArray(self) -> jpype.JArray[ghidra.features.base.memsearch.matcher.UserInputByteMatcher]:
        ...
...
class MemorySearchControlPanel(javax.swing.JPanel):
    ...
    class RestrictedInputDocument(javax.swing.text.DefaultStyledDocument):
        ...
        def insertString(self, offs: typing.Union[jpype.JInt, int], str: typing.Union[java.lang.String, str], a: javax.swing.text.AttributeSet) -> None:
            """
            Called before new user input is inserted into the entry text field.  The super
            method is called if the input is accepted.
            """

        def remove(self, offs: typing.Union[jpype.JInt, int], len: typing.Union[jpype.JInt, int]) -> None:
            """
    ...
    @typing.type_check_only
    class SearchHistoryRenderer(docking.widgets.list.GComboBoxCellRenderer[ghidra.features.base.memsearch.matcher.UserInputByteMatcher]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
class MemoryScanControlPanel(javax.swing.JPanel):
    ...
    def setSearchStatus(self, hasResults: typing.Union[jpype.JBoolean, bool], isBusy: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class MemoryMatchHighlighter(ghidra.app.util.ListingHighlightProvider):
    ...
    def __init__(self, navigatable: ghidra.app.nav.Navigatable, model: MemoryMatchTableModel, options: MemorySearchOptions) -> None:
        ...
...
class MemorySearchPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.MemorySearchService):
    ...
    class SearchOnceTask(ghidra.util.task.Task):
        ...
        def __init__(self, navigatable: ghidra.app.nav.Navigatable, forward: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def setShowOptionsPanel(self, show: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setShowScanPanel(self, show: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class SearchGuiModel(java.lang.Object):
    ...
    def __init__(self, settings: SearchSettings, regionChoices: java.util.List[ghidra.features.base.memsearch.bytesource.SearchRegion]) -> None:
        ...

    def addChangeCallback(self, changeCallback: java.util.function.Consumer[SearchSettings]) -> None:
        ...
    ...
    def parse(self, proposedText: typing.Union[java.lang.String, str]) -> ghidra.features.base.memsearch.matcher.UserInputByteMatcher:
        ...

    def selectRegion(self, region: ghidra.features.base.memsearch.bytesource.SearchRegion, selected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setAlignment(self, alignment: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    @typing.overload
    def setAutoRestrictSelection(self, autoRestrictSelection: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setBigEndian(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setCaseSensitive(self, selected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setDecimalByteSize(self, byteSize: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setDecimalUnsigned(self, selected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setHasSelection(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setIncludeDefinedData(self, selected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setIncludeInstructions(self, selected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setIncludeUndefinedData(self, selected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setSettings(self, newSettings: SearchSettings) -> None:
        ...

    def setStringCharset(self, charset: java.nio.charset.Charset) -> None:
        ...

    def setUseEscapeSequences(self, selected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class MemoryMatchToAddressTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData], ghidra.program.model.address.Address]):
    """
...
class MemoryMatchToProgramLocationTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData], ghidra.program.util.ProgramLocation]):
    """
...
class MemoryMatchtToFunctionTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData], ghidra.program.model.listing.Function]):
    """
...
class RefreshResultsTableLoader(MemoryMatchTableLoader):
    ...
    def __init__(self, matches: java.util.List[ghidra.features.base.memsearch.searcher.MemoryMatch[ghidra.features.base.memsearch.matcher.SearchData]]) -> None:
        ...



__all__ = ["SearchSettings", "CombinedMatchTableLoader", "MemoryMatchTableLoader", "EmptyMemoryMatchTableLoader", "FindOnceTableLoader", "MemorySearchResultsPanel", "MemoryMatchTableModel", "MemorySearchProvider", "SearchMarkers", "SearchHistory", "MemorySearchControlPanel", "MemoryScanControlPanel", "MemorySearchOptionsPanel", "MemoryMatchHighlighter", "MemorySearchPlugin", "MemorySearchOptions", "SearchGuiModel", "MemoryMatchToAddressTableRowMapper", "MemoryMatchToProgramLocationTableRowMapper", "MemoryMatchtToFunctionTableRowMapper", "NewSearchTableLoader", "RefreshResultsTableLoader"]
