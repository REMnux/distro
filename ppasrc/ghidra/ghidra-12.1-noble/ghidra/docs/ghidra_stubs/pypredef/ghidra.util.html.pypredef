...
class HTMLElement(java.util.ArrayList[java.lang.Object]):
    ...
    def addHTMLContent(self, htmlContent: typing.Union[java.lang.String, str]) -> None:
        ...
...
__all__ = ["HTMLElement", "HtmlLineSplitter", "WhitespaceHandler", "PreservingWhitespaceHandler", "TrimmingWhitespaceHandler"]
