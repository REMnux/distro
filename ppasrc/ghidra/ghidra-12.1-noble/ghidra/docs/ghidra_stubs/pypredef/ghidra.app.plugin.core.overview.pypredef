...
class AbstractColorOverviewAction(docking.action.DockingAction):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], component: java.awt.Component, help: ghidra.util.HelpLocation) -> None:
        """
        Constructor
...
class OverviewColorComponent(javax.swing.JPanel, ghidra.app.util.viewer.listingpanel.ListingOverviewProvider):
    """
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, overviewColorService: OverviewColorService) -> None:
        """
        Constructor
    ...
    def refresh(self, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address) -> None:
        """
...
class OverviewColorService(ghidra.util.classfinder.ExtensionPoint):
    ...
    def setOverviewComponent(self, component: OverviewColorComponent) -> None:
        """
...
class OverviewColorLegendDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], component: javax.swing.JComponent, help: ghidra.util.HelpLocation) -> None:
        """
...
class OverviewColorPlugin(ghidra.app.plugin.ProgramPlugin):
    ...
    class OverviewToggleAction(docking.action.ToggleDockingAction):
        ...
        def __init__(self, owner: typing.Union[java.lang.String, str], service: OverviewColorService) -> None:
            ...
    ...
    def installOverview(self, overviewColorService: OverviewColorService) -> None:
        """
...
__all__ = ["AbstractColorOverviewAction", "OverviewColorComponent", "OverviewColorService", "OverviewColorLegendDialog", "OverviewColorPlugin"]
