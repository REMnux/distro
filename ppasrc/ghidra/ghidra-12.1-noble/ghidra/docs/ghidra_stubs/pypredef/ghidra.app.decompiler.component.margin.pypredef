...
class DecompilerMarginProvider(java.lang.Object):
    ...
    def setProgram(self, program: ghidra.program.model.listing.Program, model: docking.widgets.fieldpanel.LayoutModel, pixmap: LayoutPixelIndexMap) -> None:
        """
...
__all__ = ["DecompilerMarginProvider", "LineNumberDecompilerMarginProvider", "VerticalLayoutPixelIndexMap", "LayoutPixelIndexMap"]
