...
class MarkerMarginProvider(ghidra.app.util.viewer.listingpanel.ListingMarginProvider):
    """
...
class MarkerOverviewProvider(ghidra.app.util.viewer.listingpanel.ListingOverviewProvider):
    """
    The provider which renders the overview margin, usually placed outside the scrollbar to the right
    of listing :obj:`FieldPanel`s.
...
class MarkerManager(ghidra.app.services.MarkerService):
    ...
    class MarkerSetCacheEntry(java.lang.Object):
        ...
        def __init__(self, cache: MarkerManager.MarkerSetCache, program: ghidra.program.model.listing.Program) -> None:
            ...
    ...
    @typing.overload
    def contains(self, provider: ghidra.app.util.viewer.listingpanel.ListingMarginProvider) -> bool:
        ...

    @typing.overload
    def contains(self, provider: ghidra.app.util.viewer.listingpanel.ListingOverviewProvider) -> bool:
        ...
    ...
    def removeProvider(self, provider: MarkerMarginProvider) -> None:
        ...

    def setGoToService(self, goToService: ghidra.app.services.GoToService) -> None:
        ...
...
class MarkerSetImpl(ghidra.app.services.MarkerSet):
    ...
    def paintMarkers(self, g: java.awt.Graphics, index: typing.Union[jpype.JInt, int], pixMap: ghidra.app.util.viewer.listingpanel.VerticalPixelAddressMap, map: ghidra.app.util.viewer.util.AddressIndexMap) -> None:
        ...

    def paintNavigation(self, g: java.awt.Graphics, height: typing.Union[jpype.JInt, int], width: typing.Union[jpype.JInt, int], map: ghidra.app.util.viewer.util.AddressIndexMap) -> None:
        ...
...
class MarkerManagerPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.ListingMarginProviderService, ghidra.app.services.ListingOverviewProviderService):
...
__all__ = ["MarkerMarginProvider", "MarkerOverviewProvider", "MarkerManager", "NavigationPanel", "MarkerSetImpl", "MarkerPanel", "AreaMarkerSet", "MarginProviderSupplier", "MarkerManagerPlugin", "ModifiableAddressSetCollection", "PointMarkerSet"]
