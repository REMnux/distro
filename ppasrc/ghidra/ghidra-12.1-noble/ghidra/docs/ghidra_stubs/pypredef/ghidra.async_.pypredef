...
class AsyncDebouncer(java.lang.Object, typing.Generic[T]):
    ...
    def __init__(self, timer: AsyncTimer, windowMillis: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def addListener(self, listener: java.util.function.Consumer[T]) -> None:
        """
    ...
    def removeListener(self, listener: java.util.function.Consumer[T]) -> None:
        """
...
class AsyncLazyMap(java.lang.Object, typing.Generic[K, V]):
    ...
    def __init__(self, map: collections.abc.Mapping, function: java.util.function.Function[K, java.util.concurrent.CompletableFuture[V]]) -> None:
        """
    ...
    def retainKeys(self, keys: collections.abc.Sequence) -> None:
        """
...
class AsyncLazyValue(java.lang.Object, typing.Generic[T]):
    ...
    def __init__(self, supplier: java.util.function.Supplier[java.util.concurrent.CompletableFuture[T]]) -> None:
        """
...
class AsyncPairingQueue(java.lang.Object, typing.Generic[T]):
    ...
    @typing.overload
    def give(self, giver: java.util.concurrent.CompletableFuture[T]) -> None:
        ...
...
class AsyncReference(java.lang.Object, typing.Generic[T, C]):
    ...
    class WaitUntilFuture(java.util.concurrent.CompletableFuture[T], typing.Generic[T]):
        ...
        def __init__(self, predicate: java.util.function.Predicate[T]) -> None:
            ...
    ...
    class ChangeRecord(java.lang.Object, typing.Generic[T, C]):
        ...
        def __init__(self, val: T, cause: C) -> None:
            ...
    ...
    class DebouncedAsyncReference(AsyncReference[T, C], typing.Generic[T, C]):
        ...
        class State(java.lang.Runnable, ghidra.util.TriConsumer[T, T, C], typing.Generic[T, C]):
            ...
            def __init__(self, to: java.lang.ref.WeakReference[AsyncReference.DebouncedAsyncReference[T, C]], from_: AsyncReference[T, C], timer: AsyncTimer, windowMillis: typing.Union[jpype.JLong, int]) -> None:
                ...


        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, from_: AsyncReference[T, C], timer: AsyncTimer, windowMillis: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    def addChangeListener(self, listener: ghidra.util.TriConsumer[T, T, C]) -> None:
        """
    ...
    def dispose(self, reason: java.lang.Throwable) -> None:
        """
    ...
    def filter(self, newFilter: AsyncReference.FilterFunction[T, C]) -> None:
        """
    ...
    def removeChangeListener(self, listener: ghidra.util.TriConsumer[T, T, C]) -> None:
        """
...
class DisposedException(java.lang.RuntimeException):
    ...
    def __init__(self, reason: java.lang.Throwable) -> None:
        ...
...
__all__ = ["AsyncDebouncer", "AsyncTimer", "AsyncFence", "AsyncLazyMap", "AsyncLazyValue", "AsyncPairingQueue", "AsyncReference", "AsyncUtils", "DisposedException", "SwingExecutorService"]
