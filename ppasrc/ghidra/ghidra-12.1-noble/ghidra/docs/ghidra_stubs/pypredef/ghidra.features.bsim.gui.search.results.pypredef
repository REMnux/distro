...
class BSimSearchResultsProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, plugin: ghidra.features.bsim.gui.BSimSearchPlugin, tool: ghidra.framework.plugintool.PluginTool, serverInfo: ghidra.features.bsim.query.BSimServerInfo, dbInfo: ghidra.features.bsim.query.description.DatabaseInformation, lshVectorFactory: generic.lsh.vector.LSHVectorFactory, queryInfo: ghidra.features.bsim.query.facade.SFQueryInfo, settings: ghidra.features.bsim.gui.search.dialog.BSimSearchSettings) -> None:
        ...

    def getProgram(self) -> ghidra.program.model.listing.Program:
        ...

    def setFinalQueryResults(self, result: ghidra.features.bsim.query.facade.SFQueryResult) -> None:
        ...
...
class BSimMatchResultsModel(ghidra.util.table.AddressBasedTableModel[BSimMatchResult]):
    ...
    class SelfSignificanceColumn(ghidra.util.table.field.AbstractProgramBasedDynamicTableColumn[BSimMatchResult, java.lang.Double]):
        ...
        def __init__(self, vectorFactory: generic.lsh.vector.LSHVectorFactory) -> None:
            ...
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, info: ghidra.features.bsim.query.description.DatabaseInformation, lshVectorFactory: generic.lsh.vector.LSHVectorFactory) -> None:
        ...
...
class BSimMatchResult(java.lang.Object):
    ...
    def __init__(self, queriedFunction: ghidra.features.bsim.query.description.FunctionDescription, addr: ghidra.program.model.address.Address, similarityNote: ghidra.features.bsim.query.protocol.SimilarityNote) -> None:
        ...
    ...
    def setStatus(self, status: BSimResultStatus) -> None:
        ...
...
class BSimApplyResult(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, result: BSimMatchResult, status: BSimResultStatus, message: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, target: ghidra.program.model.listing.Function, source: ghidra.program.model.listing.Function, status: BSimResultStatus, message: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def __init__(self, target: typing.Union[java.lang.String, str], source: typing.Union[java.lang.String, str], status: BSimResultStatus, address: ghidra.program.model.address.Address, message: typing.Union[java.lang.String, str]) -> None:
        ...
...
class BSimApplyResultsDisplayDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, serviceProvider: ghidra.framework.plugintool.ServiceProvider, results: java.util.List[BSimApplyResult], program: ghidra.program.model.listing.Program) -> None:
        ...
...
class BSimApplyResultsTableModel(ghidra.util.table.AddressBasedTableModel[BSimApplyResult]):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], serviceProvider: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor, results: java.util.List[BSimApplyResult]) -> None:
        ...
...
class BSimSearchInfoDisplayDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, server: ghidra.features.bsim.query.BSimServerInfo, searchSettings: ghidra.features.bsim.gui.search.dialog.BSimSearchSettings, isOverview: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["BSimSearchResultsProvider", "BSimResultStatus", "BSimMatchResultsModel", "BSimMatchResult", "BSimExecutablesSummaryModel", "ExecutableResult", "FunctionComparisonException", "ShowNamespaceSettingsDefinition", "BSimApplyResult", "BSimApplyResultsDisplayDialog", "BSimApplyResultsTableModel", "BSimStatusRenderer", "BSimResultRowObjectToAddressTableRowMapper", "BSimSearchInfoDisplayDialog", "BSimSearchResultsFilterDialog"]
