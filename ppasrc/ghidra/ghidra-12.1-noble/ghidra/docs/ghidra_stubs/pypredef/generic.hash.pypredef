...
class AbstractMessageDigest(MessageDigest):
    ...
    @typing.overload
    def update(self, input: jpype.JArray[jpype.JByte], offset: typing.Union[jpype.JInt, int], len: typing.Union[jpype.JInt, int]) -> None:
        """
        You REALLY want to override this method.
        """

    @typing.overload
    def update(self, input: jpype.JArray[jpype.JByte], offset: typing.Union[jpype.JInt, int], len: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class MessageDigest(java.lang.Object):
    ...
    @typing.overload
    def update(self, input: typing.Union[jpype.JByte, int]) -> None:
        """
    ...
    @typing.overload
    def update(self, input: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    @typing.overload
    def update(self, input: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def update(self, input: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def update(self, input: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    @typing.overload
    def update(self, input: jpype.JArray[jpype.JByte], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class FNV1a32MessageDigest(AbstractMessageDigest):
    ...
    @typing.overload
    def __init__(self, initialVector: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class FNV1a64MessageDigest(AbstractMessageDigest):
    ...
    @typing.overload
    def __init__(self, initialVector: typing.Union[jpype.JLong, int]) -> None:
        ...
...
__all__ = ["AbstractMessageDigest", "MessageDigest", "FNV1a32MessageDigest", "FNV1a32MessageDigestFactory", "MessageDigestFactory", "FNV1a64MessageDigest", "FNV1a64MessageDigestFactory", "HashUtilities", "SimpleCRC32"]
