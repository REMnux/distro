...
class ProgramPlugin(ghidra.framework.plugintool.Plugin):
    ...
    * :meth:`highlightChanged(ProgramSelection) <.highlightChanged>`
    ...
    def __init__(self, plugintool: ghidra.framework.plugintool.PluginTool, consumeLocationChange: typing.Union[jpype.JBoolean, bool], consumeSelectionChange: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    @deprecated("call ProgramPlugin(PluginTool) instead")
    def __init__(self, plugintool: ghidra.framework.plugintool.PluginTool, consumeLocationChange: typing.Union[jpype.JBoolean, bool], consumeSelectionChange: typing.Union[jpype.JBoolean, bool], consumeHighlightChange: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Calling this constructor is works the same as calling :obj:`ProgramPlugin`.
...
__all__ = ["ProgramPlugin", "GenericPluginCategoryNames", "PluginCategoryNames"]
