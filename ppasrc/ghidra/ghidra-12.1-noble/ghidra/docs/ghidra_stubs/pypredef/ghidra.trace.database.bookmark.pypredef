...
class DBTraceBookmarkSpace(ghidra.trace.model.bookmark.TraceBookmarkSpace, ghidra.trace.database.space.DBTraceSpaceBased):
    ...
    def __init__(self, manager: DBTraceBookmarkManager, space: ghidra.program.model.address.AddressSpace) -> None:
        ...
...
class DBTraceBookmarkType(ghidra.trace.model.bookmark.TraceBookmarkType):
    ...
    @typing.overload
    def __init__(self, manager: DBTraceBookmarkManager, name: typing.Union[java.lang.String, str], icon: javax.swing.Icon, color: java.awt.Color, priority: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, manager: DBTraceBookmarkManager, name: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DBTraceBookmark(ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree.AbstractDBTraceAddressSnapRangePropertyMapData[DBTraceBookmark], ghidra.trace.model.bookmark.TraceBookmark):
    ...
    def __init__(self, space: DBTraceBookmarkSpace, tree: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree[DBTraceBookmark, typing.Any], store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
        ...



__all__ = ["DBTraceBookmarkManager", "DBTraceBookmarkSpace", "DBTraceBookmarkType", "DBTraceBookmark"]
