...
class DebuggerTrackedRegisterListingBackgroundColorModel(ghidra.app.plugin.core.debug.gui.colors.DebuggerTrackedRegisterBackgroundColorModel, ghidra.app.util.viewer.listingpanel.ListingBackgroundColorModel):
    ...
    def __init__(self, listingPanel: ghidra.app.util.viewer.listingpanel.ListingPanel) -> None:
        ...
...
class CursorBackgroundColorModel(ghidra.app.util.viewer.listingpanel.ListingBackgroundColorModel):
    ...
    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, listingPanel: ghidra.app.util.viewer.listingpanel.ListingPanel) -> None:
        ...
...
class DebuggerListingActionContext(ghidra.app.context.ListingActionContext, ghidra.app.plugin.core.debug.gui.action.DebuggerProgramLocationActionContext):
    ...
    @typing.overload
    def __init__(self, provider: DebuggerListingProvider) -> None:
        ...

    @typing.overload
    def __init__(self, provider: DebuggerListingProvider, location: ghidra.program.util.ProgramLocation) -> None:
        ...

    @typing.overload
    def __init__(self, provider: DebuggerListingProvider, location: ghidra.program.util.ProgramLocation, selection: ghidra.program.util.ProgramSelection, highlight: ghidra.program.util.ProgramSelection) -> None:
        ...
...
class DebuggerListingProvider(ghidra.app.plugin.core.codebrowser.CodeViewerProvider):
    ...
    def __init__(self, plugin: DebuggerListingPlugin, formatManager: ghidra.app.util.viewer.format.FormatManager, isConnected: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def addTrackingSpecChangeListener(self, listener: ghidra.app.services.DebuggerListingService.LocationTrackingSpecChangeListener) -> None:
        ...
    ...
    def removeTrackingSpecChangeListener(self, listener: ghidra.app.services.DebuggerListingService.LocationTrackingSpecChangeListener) -> None:
        ...

    def setAutoDisassemble(self, auto: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["DebuggerTrackedRegisterListingBackgroundColorModel", "CursorBackgroundColorModel", "DebuggerListingActionContext", "DebuggerListingProvider", "DebuggerListingPlugin", "MemoryStateListingBackgroundColorModel"]
