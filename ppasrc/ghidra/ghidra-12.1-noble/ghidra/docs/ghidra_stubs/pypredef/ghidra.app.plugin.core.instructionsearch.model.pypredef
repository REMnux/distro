...
class MaskSettings(java.lang.Object):
    ...
    def __init__(self, maskAddresses: typing.Union[jpype.JBoolean, bool], maskOperands: typing.Union[jpype.JBoolean, bool], maskScalars: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setMaskAddresses(self, maskAddresses: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setMaskOperands(self, maskOperands: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setMaskScalars(self, maskScalars: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class InstructionSearchData(java.util.Observable):
    ...
    class LoadInstructionsTask(ghidra.util.task.Task):
        ...
        def __init__(self, program: ghidra.program.model.listing.Program, addresses: ghidra.program.model.address.AddressSetView) -> None:
            ...
    ...
    def add(self, program: ghidra.program.model.listing.Program, addresses: ghidra.program.model.address.AddressSetView) -> None:
        """
    ...
    def applyMasks(self, table: ghidra.app.plugin.core.instructionsearch.ui.InstructionTable) -> None:
        """
    ...
    def load(self, program: ghidra.program.model.listing.Program, addressRange: ghidra.program.model.address.AddressRange) -> None:
        """
    ...
    def maskOperandsByType(self, operandType: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def registerForGuiUpdates(self, table: ghidra.app.plugin.core.instructionsearch.ui.InstructionTable) -> None:
        """
    ...
    def setInstructions(self, instructions: java.util.List[InstructionMetadata]) -> None:
        """
...
class InstructionMetadata(java.lang.Object):
    ...
    def __init__(self, maskContainer: MaskContainer) -> None:
        """
    ...
    def setAddr(self, addr: ghidra.program.model.address.Address) -> None:
        ...

    def setIsInstruction(self, instruction: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setMasked(self, mask: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setOperands(self, operands: java.util.List[OperandMetadata]) -> None:
        ...

    def setTextRep(self, textRep: typing.Union[java.lang.String, str]) -> None:
        ...
...
class MaskContainer(java.lang.Object):
    ...
    def __init__(self, mask: jpype.JArray[jpype.JByte], value: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def setMask(self, mask: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def setValue(self, value: jpype.JArray[jpype.JByte]) -> None:
        """
...
class OperandMetadata(java.lang.Object):
    ...
    def setMaskContainer(self, maskContainer: MaskContainer) -> None:
        ...

    def setMasked(self, mask: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setOpType(self, opType: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class InstructionTableDataObject(java.lang.Object):
    ...
    def __init__(self, data: typing.Union[java.lang.String, str], isInstruction: typing.Union[jpype.JBoolean, bool], state: ghidra.app.plugin.core.instructionsearch.ui.AbstractInstructionTable.OperandState) -> None:
        """
        Constructor.
    ...
    def register(self, observer: InstructionTableObserver) -> None:
        ...

    def setData(self, data: typing.Union[java.lang.String, str]) -> None:
        ...

    def setOperandCase(self, operandCase: OperandMetadata) -> None:
        ...

    def setState(self, state: ghidra.app.plugin.core.instructionsearch.ui.AbstractInstructionTable.OperandState, update: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class InstructionTableModel(javax.swing.table.DefaultTableModel, InstructionTableObserver):
    ...
    def __init__(self, tableContentsDO: jpype.JArray[jpype.JArray[InstructionTableDataObject]], colNames: jpype.JArray[java.lang.Object]) -> None:
        """
...
__all__ = ["MaskSettings", "InstructionSearchData", "InstructionMetadata", "MaskContainer", "OperandMetadata", "InstructionTableDataObject", "InstructionTableObserver", "InstructionTableModel"]
