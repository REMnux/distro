...
class AbstractDirectedLongKeyIterator(DirectedLongKeyIterator):
    ...
    def __init__(self, it: db.DBLongIterator) -> None:
        """
...
class KeySpan(generic.Span[java.lang.Long, KeySpan]):
    ...
    class Impl(java.lang.Record, KeySpan):
        ...
        def __init__(self, min: typing.Union[java.lang.Long, int], max: typing.Union[java.lang.Long, int]) -> None:
            ...
...
class AbstractDirectedRecordIterator(DirectedRecordIterator):
    ...
    def __init__(self, it: db.RecordIterator) -> None:
        """
        Wrap the given iterator
...
class FieldSpan(generic.End.EndSpan[db.Field, FieldSpan]):
    ...
    class Impl(java.lang.Record, FieldSpan):
        ...
        def __init__(self, min: generic.End[db.Field], max: generic.End[db.Field]) -> None:
            ...
...
class DBCachedObjectStoreFactory(java.lang.Object):
    ...
    class RecAddress(java.lang.Record):
        ...
        def __init__(self, spaceId: typing.Union[jpype.JInt, int], offset: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    class RecRange(java.lang.Record):
        ...
        def __init__(self, spaceId: typing.Union[jpype.JInt, int], min: typing.Union[jpype.JLong, int], max: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    class DBFieldCodec(java.lang.Object, typing.Generic[VT, OT, FT]):
        ...
        **NOTE:** When changing the implementation of a codec, keep in mind whether or not it
        ...
        def load(self, obj: OT, record: db.DBRecord) -> None:
            """
        ...
        @typing.overload
        def store(self, obj: OT, record: db.DBRecord) -> None:
            """
        ...
        @typing.overload
        def store(self, value: VT, f: FT) -> None:
            """
    ...
    class AbstractDBFieldCodec(DBCachedObjectStoreFactory.DBFieldCodec[VT, OT, FT], typing.Generic[VT, OT, FT]):
        ...
        def __init__(self, valueType: java.lang.Class[VT], objectType: java.lang.Class[OT], fieldType: java.lang.Class[FT], field: java.lang.reflect.Field, column: typing.Union[jpype.JInt, int]) -> None:
            """
            Construct a codec
    ...
    class PrimitiveCodec(java.lang.Object, typing.Generic[T]):
        ...
        class AbstractPrimitiveCodec(DBCachedObjectStoreFactory.PrimitiveCodec[T], typing.Generic[T]):
            ...
            def __init__(self, valueClass: java.lang.Class[T]) -> None:
                ...
        ...
        class SimplePrimitiveCodec(DBCachedObjectStoreFactory.PrimitiveCodec.AbstractPrimitiveCodec[T], typing.Generic[T]):
            ...
            def __init__(self, valueClass: java.lang.Class[T], decode: java.util.function.Function[java.nio.ByteBuffer, T], encode: java.util.function.BiConsumer[java.nio.ByteBuffer, T]) -> None:
                ...
        ...
        class ArrayPrimitiveCodec(DBCachedObjectStoreFactory.PrimitiveCodec.AbstractPrimitiveCodec[T], typing.Generic[E, T]):
            ...
            def __init__(self, valueClass: java.lang.Class[T], elemCodec: DBCachedObjectStoreFactory.PrimitiveCodec[E]) -> None:
                ...
        ...
        class ArrayObjectCodec(DBCachedObjectStoreFactory.PrimitiveCodec.ArrayPrimitiveCodec[E, jpype.JArray[E]], typing.Generic[E]):
            ...
            def __init__(self, elemCodec: DBCachedObjectStoreFactory.PrimitiveCodec[E]) -> None:
                ...
        ...
        class LengthBoundCodec(DBCachedObjectStoreFactory.PrimitiveCodec.AbstractPrimitiveCodec[T], typing.Generic[T]):
            ...
            def __init__(self, unbounded: DBCachedObjectStoreFactory.PrimitiveCodec[T]) -> None:
                ...
        ...
        def encode(self, buffer: java.nio.ByteBuffer, value: T) -> None:
            """
    ...
    def __init__(self, adapter: DBCachedDomainObjectAdapter) -> None:
        """
...
class DBCachedDomainObjectAdapter(ghidra.framework.data.DBDomainObjectSupport):
    ...
    class GhidraLockWrappingLock(java.util.concurrent.locks.Lock):
        ...
        def __init__(self, ghidraLock: ghidra.util.Lock) -> None:
            ...
...
class ObjectKey(java.lang.Comparable[ObjectKey]):
    ...
    def __init__(self, table: db.Table, key: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class DBCachedObjectStoreMap(java.util.NavigableMap[java.lang.Long, T], typing.Generic[T]):
    ...
    def __init__(self, store: DBCachedObjectStore[T], errHandler: db.util.ErrorHandler, lock: java.util.concurrent.locks.ReadWriteLock, direction: DirectedIterator.Direction) -> None:
        ...
...
class DBCachedObjectStoreKeySet(java.util.NavigableSet[java.lang.Long]):
    ...
    def __init__(self, store: DBCachedObjectStore[typing.Any], errHandler: db.util.ErrorHandler, lock: java.util.concurrent.locks.ReadWriteLock, direction: DirectedIterator.Direction) -> None:
        ...
...
class DBCachedObjectStoreFoundKeysValueCollection(java.util.Collection[T], typing.Generic[T]):
    ...
    def __init__(self, store: DBCachedObjectStore[T], errHandler: db.util.ErrorHandler, lock: java.util.concurrent.locks.ReadWriteLock, keys: jpype.JArray[db.Field]) -> None:
        ...
...
class DBCachedObjectStoreEntrySubSet(DBCachedObjectStoreEntrySet[T], typing.Generic[T]):
    ...
    def __init__(self, store: DBCachedObjectStore[T], errHandler: db.util.ErrorHandler, lock: java.util.concurrent.locks.ReadWriteLock, direction: DirectedIterator.Direction, keySpan: KeySpan) -> None:
        ...
...
class DBCachedObjectStoreKeySubSet(DBCachedObjectStoreKeySet):
    ...
    def __init__(self, store: DBCachedObjectStore[typing.Any], errHandler: db.util.ErrorHandler, lock: java.util.concurrent.locks.ReadWriteLock, direction: DirectedIterator.Direction, keySpan: KeySpan) -> None:
        ...
...
class DBBufferInputStream(java.io.InputStream):
    ...
    def __init__(self, buffer: db.DBBuffer) -> None:
        ...
...
class DBBufferOutputStream(java.io.OutputStream):
    ...
    @typing.overload
    def __init__(self, buffer: db.DBBuffer, increment: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DBSynchronizedCollection(java.util.Collection[E], typing.Generic[E]):
    ...
    def __init__(self, delegate: collections.abc.Sequence, lock: java.util.concurrent.locks.ReadWriteLock) -> None:
        ...
...
class DBSynchronizedIterator(java.util.Iterator[T], typing.Generic[T]):
    ...
    def __init__(self, iterator: java.util.Iterator[T], lock: java.util.concurrent.locks.ReadWriteLock) -> None:
        ...
...
class DBSynchronizedSpliterator(java.util.Spliterator[T], typing.Generic[T]):
    ...
    def __init__(self, spliterator: java.util.Spliterator[T], lock: java.util.concurrent.locks.Lock) -> None:
        ...
...
class DomainObjectLockHold(java.lang.AutoCloseable):
    ...
    class DefaultHold(DomainObjectLockHold):
        ...
        def __init__(self, object: ghidra.framework.model.DomainObject) -> None:
            ...
...
class SynchronizedSpliterator(java.util.Spliterator[T], typing.Generic[T]):
    ...
    def __init__(self, spliterator: java.util.Spliterator[T], lock: java.lang.Object) -> None:
        ...



__all__ = ["AbstractDirectedLongKeyIterator", "DirectedLongKeyIterator", "DirectedIterator", "KeySpan", "AbstractDirectedRecordIterator", "DirectedRecordIterator", "FieldSpan", "BackwardLongKeyIterator", "BackwardRecordIterator", "DBCachedObjectStoreFactory", "DBAnnotatedObject", "DBCachedObjectStore", "DBCachedDomainObjectAdapter", "ObjectKey", "DBObjectColumn", "DBAnnotatedObjectFactory", "DBCachedObjectStoreMap", "DBCachedObjectStoreKeySet", "DBCachedObjectStoreValueCollection", "DBCachedObjectStoreEntrySet", "DBCachedObjectIndex", "DBCachedObjectStoreFoundKeysValueCollection", "DBCachedObjectStoreEntrySubSet", "DBCachedObjectStoreKeySubSet", "DBCachedObjectStoreSubMap", "DBCachedObjectStoreValueSubCollection", "DBBufferInputStream", "DBBufferOutputStream", "DBSynchronizedCollection", "DBSynchronizedIterator", "DBSynchronizedSpliterator", "DomainObjectLockHold", "ForwardLongKeyIterator", "ForwardRecordIterator", "SchemaBuilder", "SynchronizedSpliterator"]
