...
class DWARFMacroInfoEntry(java.lang.Object):
    ...
    def __init__(self, opcode: ghidra.app.util.bin.format.dwarf.macro.DWARFMacroOpcode, rawOpcode: typing.Union[jpype.JInt, int], operandValues: jpype.JArray[ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeValue], macroHeader: ghidra.app.util.bin.format.dwarf.macro.DWARFMacroHeader) -> None:
        ...
...
class DWARFMacroDefine(DWARFMacroInfoEntry):
    ...
    class MacroInfo(java.lang.Record):
        ...
        def __init__(self, macro: typing.Union[java.lang.String, str], symbolName: typing.Union[java.lang.String, str], parameters: java.util.List[java.lang.String], isFunctionLike: typing.Union[jpype.JBoolean, bool], definition: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, lineNumber: typing.Union[jpype.JInt, int], defineString: typing.Union[java.lang.String, str], parent: ghidra.app.util.bin.format.dwarf.macro.DWARFMacroHeader) -> None:
        ...

    @typing.overload
    def __init__(self, other: DWARFMacroInfoEntry) -> None:
        ...
...
__all__ = ["DWARFMacroInfoEntry", "DWARFMacroDefine", "DWARFMacroEndFile", "DWARFMacroImport", "DWARFMacroStartFile", "DWARFMacroUndef"]
