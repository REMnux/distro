...
class TraceRegisterContextOperations(java.lang.Object):
    ...
    def clear(self, span: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange) -> None:
        ...
    ...
    def removeValue(self, language: ghidra.program.model.lang.Language, register: ghidra.program.model.lang.Register, span: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange) -> None:
        ...

    def setValue(self, language: ghidra.program.model.lang.Language, value: ghidra.program.model.lang.RegisterValue, lifespan: ghidra.trace.model.Lifespan, range: ghidra.program.model.address.AddressRange) -> None:
        ...
...
__all__ = ["TraceRegisterContextManager", "TraceRegisterContextOperations", "TraceRegisterContextSpace"]
