...
class AbstractHyperBoxQuery(ghidra.util.database.spatial.Query[DS, NS], typing.Generic[P, DS, NS, Q]):
    ...
    def __init__(self, ls: NS, us: NS, space: EuclideanHyperSpace[P, NS], direction: HyperDirection) -> None:
        ...
...
class HyperDirection(java.lang.Record):
    ...
    def __init__(self, dimension: typing.Union[jpype.JInt, int], forward: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class AbstractHyperRStarTree(ghidra.util.database.spatial.AbstractRStarConstraintsTree[DS, DR, NS, NR, T, Q], typing.Generic[P, DS, DR, NS, NR, T, Q]):
    ...
    def __init__(self, storeFactory: ghidra.util.database.DBCachedObjectStoreFactory, tableName: typing.Union[java.lang.String, str], space: EuclideanHyperSpace[P, NS], dataType: java.lang.Class[DR], nodeType: java.lang.Class[NR], upgradeable: typing.Union[jpype.JBoolean, bool], maxChildren: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["AbstractHyperBoxQuery", "HyperPoint", "HyperBox", "HyperDirection", "EuclideanHyperSpace", "Dimension", "AbstractHyperRStarTree", "LongDimension", "StringDimension", "ULongDimension"]
