...
class OldBookmark(ghidra.util.Saveable):
    ...
    @typing.overload
    def __init__(self, type: typing.Union[java.lang.String, str], category: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str], addr: ghidra.program.model.address.Address) -> None:
        """
    ...
    def setCategory(self, category: typing.Union[java.lang.String, str]) -> None:
        ...
...
class BookmarkDBAdapterV2(BookmarkDBAdapterV1):
    ...
    def __init__(self, dbHandle: db.DBHandle, addrMap: ghidra.program.database.map.AddressMap) -> None:
        """
...
class BookmarkDBAdapterV3(BookmarkDBAdapter):
    ...
    def __init__(self, handle: db.DBHandle, create: typing.Union[jpype.JBoolean, bool], typeIDs: jpype.JArray[jpype.JInt], addrMap: ghidra.program.database.map.AddressMap) -> None:
        ...
...
class BookmarkTypeDBAdapterNoTable(BookmarkTypeDBAdapter):
    ...
    def __init__(self, dbHandle: db.DBHandle) -> None:
        """
    ...
    def setOldBookmarkManager(self, oldMgr: OldBookmarkManager) -> None:
        """
...
class BookmarkTypeDBAdapterV0(BookmarkTypeDBAdapter):
    ...
    def __init__(self, dbHandle: db.DBHandle, create: typing.Union[jpype.JBoolean, bool]) -> None:
        ...



__all__ = ["BookmarkDBManager", "BookmarkTypeDBAdapter", "BookmarkDBAdapter", "BookmarkDB", "BookmarkTypeDB", "BookmarkDBAdapterV0", "OldBookmarkManager", "EmptyAddressIterator", "OldBookmark", "BookmarkDBAdapterV1", "BookmarkDBAdapterV2", "BookmarkDBAdapterV3", "BookmarkTypeDBAdapterNoTable", "BookmarkTypeDBAdapterV0"]
