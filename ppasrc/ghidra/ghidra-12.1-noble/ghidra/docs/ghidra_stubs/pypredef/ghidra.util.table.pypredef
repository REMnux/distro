...
class AddressBasedTableModel(GhidraProgramTableModel[ROW_TYPE], typing.Generic[ROW_TYPE]):
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], serviceProvider: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], serviceProvider: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor, loadIncrementally: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class GhidraThreadedTablePanel(docking.widgets.table.threaded.GThreadedTablePanel[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, model: docking.widgets.table.threaded.ThreadedTableModel[T, typing.Any]) -> None:
        ...

    @typing.overload
    def __init__(self, model: docking.widgets.table.threaded.ThreadedTableModel[T, typing.Any], minUpdateDelay: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, model: docking.widgets.table.threaded.ThreadedTableModel[T, typing.Any], minUpdateDelay: typing.Union[jpype.JInt, int], maxUpdateDelay: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class GhidraTableFilterPanel(docking.widgets.table.GTableFilterPanel[ROW_OBJECT], typing.Generic[ROW_OBJECT]):
    ...
    @typing.overload
    def __init__(self, table: javax.swing.JTable, tableModel: docking.widgets.table.RowObjectTableModel[ROW_OBJECT]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, table: javax.swing.JTable, tableModel: docking.widgets.table.RowObjectTableModel[ROW_OBJECT], filterLabel: typing.Union[java.lang.String, str]) -> None:
        ...
...
class SelectionNavigationAction(AbstractSelectionNavigationAction):
    ...
    @typing.overload
    def __init__(self, plugin: ghidra.framework.plugintool.Plugin, table: GhidraTable) -> None:
        """
    ...
    @typing.overload
    def __init__(self, owner: typing.Union[java.lang.String, str], table: GhidraTable) -> None:
        """
        Constructor that relies on an instance of :obj:`GhidraTable` to do the work of
        navigation.  Clients that have :obj:`JTable`s that are not instances of :obj:`GhidraTable`
        can use the super class action and define its :meth:`navigate() <.navigate>` callback method.
...
class GhidraTable(docking.widgets.table.GTable):
    ...
    @typing.overload
    def installNavigation(self, sp: ghidra.framework.plugintool.ServiceProvider, nav: ghidra.app.nav.Navigatable) -> None:
        """
    ...
    @typing.overload
    def installNavigation(self, sp: ghidra.framework.plugintool.ServiceProvider) -> None:
        """
        Sets the service provider to use when navigation is enabled on this table.
    ...
    def navigate(self, row: typing.Union[jpype.JInt, int], column: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setNavigateOnSelectionEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class TableModelLoader(java.lang.Object, typing.Generic[T]):
    ...
    def load(self, accumulator: ghidra.util.datastruct.Accumulator[T], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class PreviewTableCellData(java.lang.Comparable[PreviewTableCellData]):
    ...
    def __init__(self, location: ghidra.program.util.ProgramLocation, codeUnitFormat: ghidra.program.model.listing.CodeUnitFormat) -> None:
        """
        Constructor
...
class GhidraFilterTable(docking.widgets.table.GFilterTable[ROW_OBJECT], typing.Generic[ROW_OBJECT]):
    ...
    def __init__(self, model: docking.widgets.table.RowObjectTableModel[ROW_OBJECT]) -> None:
        ...
    ...
    def setNavigateOnSelectionEnabled(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ReferencesFromTableModel(AddressBasedTableModel[ghidra.util.table.field.ReferenceEndpoint]):
    ...
    @typing.overload
    def __init__(self, refs: collections.abc.Sequence, sp: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program) -> None:
        ...

    @typing.overload
    def __init__(self, refsSupplier: java.util.function.Supplier[java.util.Collection[ghidra.program.model.symbol.Reference]], sp: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program) -> None:
        ...
...
class AddressArrayTableModel(AddressPreviewTableModel):
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], serviceProvider: ghidra.framework.plugintool.ServiceProvider, prog: ghidra.program.model.listing.Program, addrs: jpype.JArray[ghidra.program.model.address.Address], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Constructor.
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], serviceProvider: ghidra.framework.plugintool.ServiceProvider, prog: ghidra.program.model.listing.Program, addrs: jpype.JArray[ghidra.program.model.address.Address]) -> None:
        """
        Constructor.
    ...
    def setAddresses(self, addresses: jpype.JArray[ghidra.program.model.address.Address]) -> None:
        ...
...
class AddressPreviewTableModel(AddressBasedTableModel[ghidra.program.model.address.Address]):
    ...
    def setSelectionSize(self, size: typing.Union[jpype.JInt, int]) -> None:
        """
...
class AddressSetTableModel(AddressPreviewTableModel):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], serviceProvider: ghidra.framework.plugintool.ServiceProvider, prog: ghidra.program.model.listing.Program, addressSet: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class CustomLoadingAddressTableModel(AddressPreviewTableModel):
    ...
    @typing.overload
    def __init__(self, modelName: typing.Union[java.lang.String, str], serviceProvider: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program, loader: TableModelLoader[ghidra.program.model.address.Address], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class EmptyThreadedTableModel(docking.widgets.table.threaded.ThreadedTableModelStub[T], typing.Generic[T]):
    ...
    def __init__(self, modelName: typing.Union[java.lang.String, str], columnNames: jpype.JArray[java.lang.String]) -> None:
        """
...
class IncomingReferencesTableModel(AddressBasedTableModel[ghidra.util.table.field.ReferenceEndpoint]):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], serviceProvider: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program, references: java.util.List[ghidra.util.table.field.OutgoingReferenceEndpoint], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
__all__ = ["AddressBasedTableModel", "GhidraProgramTableModel", "ProgramTableModel", "GhidraThreadedTablePanel", "GhidraTableFilterPanel", "SelectionNavigationAction", "AbstractSelectionNavigationAction", "GhidraTable", "GhidraTableCellRenderer", "ProgramLocationTableRowMapper", "CodeUnitTableCellRenderer", "TableModelLoader", "PreviewTableCellData", "PreviewDataTableCellRenderer", "GhidraFilterTable", "ReferencesFromTableModel", "AddressArrayTableModel", "AddressPreviewTableModel", "AddressSetTableModel", "CompositeGhidraTableCellRenderer", "CustomLoadingAddressTableModel", "EmptyThreadedTableModel", "IncomingReferencesTableModel", "IntObjectCache", "MappedProgramLocationTableColumn", "ProgramMappedTableColumn"]
