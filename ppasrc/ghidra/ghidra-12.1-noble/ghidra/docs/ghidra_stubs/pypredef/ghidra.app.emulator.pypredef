...
class AdaptedEmulator(Emulator):
    ...
    class AdaptedPcodeEmulator(ghidra.pcode.emu.PcodeEmulator):
        ...
        def __init__(self, language: ghidra.program.model.lang.Language, loadImage: ghidra.app.emulator.memory.MemoryLoadImage, faultHandler: ghidra.pcode.memstate.MemoryFaultHandler) -> None:
            ...
    ...
    class AdaptedPcodeThread(ghidra.pcode.emu.BytesPcodeThread):
        ...
        def __init__(self, name: typing.Union[java.lang.String, str], machine: ghidra.pcode.emu.AbstractPcodeMachine[jpype.JArray[jpype.JByte]]) -> None:
            ...


    @typing.type_check_only
    class AdaptedStateCallbacks(ghidra.pcode.exec_.PcodeStateCallbacks):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, loadImage: ghidra.app.emulator.memory.MemoryLoadImage) -> None:
            ...
    ...
    class AdaptedBytesPcodeExecutorState(ghidra.pcode.exec_.BytesPcodeExecutorState):
        ...
        def __init__(self, language: ghidra.program.model.lang.Language, faultHandler: ghidra.pcode.memstate.MemoryFaultHandler, loadImage: ghidra.app.emulator.memory.MemoryLoadImage) -> None:
            ...
    ...
    class AdaptedBytesPcodeExecutorStatePiece(ghidra.pcode.exec_.AbstractBytesPcodeExecutorStatePiece[AdaptedEmulator.AdaptedBytesPcodeExecutorStateSpace]):
        ...
        def __init__(self, language: ghidra.program.model.lang.Language, cb: ghidra.pcode.exec_.PcodeStateCallbacks, faultHandler: ghidra.pcode.memstate.MemoryFaultHandler) -> None:
            ...


    @typing.type_check_only
    class AdaptedBytesPcodeExecutorStateSpace(ghidra.pcode.exec_.BytesPcodeExecutorStateSpace):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, language: ghidra.program.model.lang.Language, space: ghidra.program.model.address.AddressSpace, piece: ghidra.pcode.exec_.AbstractBytesPcodeExecutorStatePiece[typing.Any], faultHandler: ghidra.pcode.memstate.MemoryFaultHandler) -> None:
            ...
    ...
    def __init__(self, config: EmulatorConfiguration) -> None:
        ...


@deprecated("This interface was extracted from what has now been renamed DefaultEmulator\n             and is also deprecated. Please use PcodeEmulator instead.")
class Emulator(java.lang.Object):
    ...
    This interface was extracted from what has now been renamed :obj:`DefaultEmulator`
                and is also deprecated. Please use :obj:`PcodeEmulator` instead.
    """

    class_: typing.ClassVar[java.lang.Class]

    def addMemoryAccessFilter(self, filter: MemoryAccessFilter) -> None:
        """
    ...
    def executeInstruction(self, stopAtBreakpoint: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def setExecuteAddress(self, addressableWordOffset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def setHalt(self, halt: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
@deprecated("Please use PcodeEmulator instead. For similar callbacks, see\n             PcodeEmulationCallbacks")
class MemoryAccessFilter(java.lang.Object):
    ...
    Please use :obj:`PcodeEmulator` instead. For similar callbacks, see
                :obj:`PcodeEmulationCallbacks`
    """
    ...
    def setFilterOnExecutionOnly(self, filterOnExecutionOnly: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class AdaptedMemoryState(ghidra.pcode.memstate.AbstractMemoryState, typing.Generic[T]):
    ...
    def __init__(self, state: ghidra.pcode.exec_.PcodeExecutorState[T], reason: ghidra.pcode.exec_.PcodeExecutorStatePiece.Reason) -> None:
        ...


@deprecated("Please use PcodeEmulator instead.")
class DefaultEmulator(Emulator):
    ...
    Please use :obj:`PcodeEmulator` instead.
    """

    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, cfg: EmulatorConfiguration) -> None:
        ...
...
class EmulatorHelper(ghidra.pcode.memstate.MemoryFaultHandler, EmulatorConfiguration):
    ...
    def enableMemoryWriteTracking(self, enable: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def registerCallOtherCallback(self, pcodeOpName: typing.Union[java.lang.String, str], callback: ghidra.pcode.emulate.BreakCallBack) -> None:
        """
    ...
    @typing.overload
    def setContextRegister(self, ctxReg: ghidra.program.model.lang.Register, value: java.math.BigInteger) -> None:
        """
        Set current context register value. Keep in mind that any non-flowing context values will be
        stripped.
    ...
    def unregisterCallOtherCallback(self, pcodeOpName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def writeMemory(self, addr: ghidra.program.model.address.Address, bytes: jpype.JArray[jpype.JByte]) -> None:
        ...

    def writeMemoryValue(self, addr: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def writeRegister(self, reg: ghidra.program.model.lang.Register, value: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def writeRegister(self, regName: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def writeRegister(self, reg: ghidra.program.model.lang.Register, value: java.math.BigInteger) -> None:
        ...

    @typing.overload
    def writeRegister(self, regName: typing.Union[java.lang.String, str], value: java.math.BigInteger) -> None:
        ...

    @typing.overload
    def writeStackValue(self, relativeOffset: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def writeStackValue(self, relativeOffset: typing.Union[jpype.JInt, int], size: typing.Union[jpype.JInt, int], value: java.math.BigInteger) -> None:
        """
        Write a value onto the stack
...
__all__ = ["AdaptedEmulator", "Emulator", "FilteredMemoryState", "EmulatorConfiguration", "MemoryAccessFilter", "AdaptedMemoryState", "DefaultEmulator", "EmulatorHelper"]
