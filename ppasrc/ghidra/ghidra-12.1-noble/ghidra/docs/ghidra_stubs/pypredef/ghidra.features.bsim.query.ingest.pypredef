...
class BSimLaunchable(ghidra.GhidraLaunchable):
    ...
    @staticmethod
    def initializeApplication(layout: utility.application.ApplicationLayout, type: typing.Union[jpype.JInt, int], connectingUserName: typing.Union[java.lang.String, str], certPath: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def run(self, params: jpype.JArray[java.lang.String], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class BulkSignatures(java.lang.AutoCloseable):
    ...
    class UpdateRepository(IterateRepository):
        ...
        def __init__(self, outdir: jpype.protocol.SupportsPath, rp: typing.Union[java.lang.String, str], owrite: typing.Union[jpype.JBoolean, bool], i: ghidra.features.bsim.query.description.DatabaseInformation, vFactory: generic.lsh.vector.LSHVectorFactory) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, bsimServerInfo: ghidra.features.bsim.query.BSimServerInfo, connectingUserName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, bsimServerInfo: ghidra.features.bsim.query.BSimServerInfo) -> None:
        """
        Constructor
    ...
    def createDatabase(self, configTemplate: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str], trackCall: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def deleteExecutable(self, md5: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def dumpSigs(self, resultFolder: jpype.protocol.SupportsPath, md5: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def installCategory(self, categoryName: typing.Union[java.lang.String, str], isDate: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def installTags(self, tagName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def signatureRepo(self, ghidraURL: java.net.URL, sigsLocation: typing.Union[java.lang.String, str], overwrite: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def updateRepoSignatures(self, ghidraURL: java.net.URL, sigsLocation: typing.Union[java.lang.String, str], overwrite: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class IterateRepository(java.lang.Object):
    ...
    def process(self, ghidraURL: java.net.URL, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
__all__ = ["BSimLaunchable", "BulkSignatures", "IterateRepository", "HeadlessBSimApplicationConfiguration"]
