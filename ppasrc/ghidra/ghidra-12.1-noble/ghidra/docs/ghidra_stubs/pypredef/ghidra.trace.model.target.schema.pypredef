...
class DefaultTraceObjectSchema(TraceObjectSchema, java.lang.Comparable[DefaultTraceObjectSchema]):
    ...
    class DefaultAttributeSchema(TraceObjectSchema.AttributeSchema, java.lang.Comparable[DefaultTraceObjectSchema.DefaultAttributeSchema]):
        ...
        def __init__(self, name: typing.Union[java.lang.String, str], schema: TraceObjectSchema.SchemaName, isRequired: typing.Union[jpype.JBoolean, bool], isFixed: typing.Union[jpype.JBoolean, bool], hidden: TraceObjectSchema.Hidden) -> None:
            ...
    ...
    class AliasResolver(java.lang.Object):
        ...
        def __init__(self, schemas: collections.abc.Mapping, aliases: collections.abc.Mapping, defaultSchema: TraceObjectSchema.AttributeSchema) -> None:
            ...
...
class TraceObjectSchema(java.lang.Object):
    ...
    class Private(java.lang.Object):
        ...
        class BreadthFirst(java.lang.Object, typing.Generic[T]):
            ...
            def __init__(self, seed: java.util.Set[T]) -> None:
                ...
            ...
            def expandAttribute(self, nextLevel: java.util.Set[T], ent: T, schema: TraceObjectSchema, path: ghidra.trace.model.target.path.KeyPath) -> None:
                ...

            def expandAttributes(self, nextLevel: java.util.Set[T], ent: T) -> None:
                ...

            def expandDefaultAttribute(self, nextLevel: java.util.Set[T], ent: T) -> None:
                ...

            def expandDefaultElement(self, nextLevel: java.util.Set[T], ent: T) -> None:
                ...

            def expandElement(self, nextLevel: java.util.Set[T], ent: T, schema: TraceObjectSchema, path: ghidra.trace.model.target.path.KeyPath) -> None:
                ...

            def expandElements(self, nextLevel: java.util.Set[T], ent: T) -> None:
                ...
        ...
        class SearchEntry(java.lang.Object):
            ...
            def __init__(self, path: ghidra.trace.model.target.path.KeyPath, schema: TraceObjectSchema) -> None:
                ...
        ...
        class CanonicalSearchEntry(TraceObjectSchema.Private.SearchEntry):
            ...
            def __init__(self, path: ghidra.trace.model.target.path.KeyPath, parentIsCanonical: typing.Union[jpype.JBoolean, bool], schema: TraceObjectSchema) -> None:
                ...
        ...
        class InAggregateSearch(TraceObjectSchema.Private.BreadthFirst[TraceObjectSchema.Private.SearchEntry]):
            ...
            def __init__(self, seed: TraceObjectSchema) -> None:
                ...
    ...
    def validateRequiredAttributes(self, object: ghidra.trace.model.target.TraceObject, strict: typing.Union[jpype.JBoolean, bool], snap: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def validateTypeAndInterfaces(self, value: java.lang.Object, parentPath: ghidra.trace.model.target.path.KeyPath, key: typing.Union[java.lang.String, str], strict: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DefaultSchemaContext(SchemaContext):
    ...
    def putSchema(self, schema: TraceObjectSchema) -> None:
        ...

    def replaceSchema(self, schema: TraceObjectSchema) -> None:
        ...
...
class SchemaBuilder(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, context: DefaultSchemaContext, name: TraceObjectSchema.SchemaName) -> None:
        ...

    @typing.overload
    def __init__(self, context: DefaultSchemaContext, schema: TraceObjectSchema) -> None:
        ...
...
class XmlSchemaContext(DefaultSchemaContext):
    ...
    @staticmethod
    def aliasToXml(alias: java.util.Map.Entry[java.lang.String, java.lang.String]) -> org.jdom2.Element:
        ...

    @staticmethod
    def attributeSchemaToXml(as_: TraceObjectSchema.AttributeSchema) -> org.jdom2.Element:
        ...

    @staticmethod
    def contextFromXml(contextElem: org.jdom2.Element) -> XmlSchemaContext:
        ...

    @staticmethod
    def contextToXml(ctx: SchemaContext) -> org.jdom2.Element:
        ...
    ...
    def schemaFromXml(self, schemaElem: org.jdom2.Element) -> TraceObjectSchema:
        ...

    @staticmethod
    def schemaToXml(schema: TraceObjectSchema) -> org.jdom2.Element:
        ...
...
__all__ = ["DefaultTraceObjectSchema", "TraceObjectSchema", "SchemaContext", "BadSchemaException", "DefaultSchemaContext", "SchemaBuilder", "PrimitiveTraceObjectSchema", "XmlSchemaContext"]
