...
class IntegerSpinner(java.lang.Object):
    """
    Creates a component for editing Integer values using an :obj:`IntegerTextField` and a
    :obj:`JSpinner`.
    """
    ...
    @typing.overload
    def __init__(self, spinnerModel: javax.swing.SpinnerNumberModel) -> None:
        """
    ...
    @typing.overload
    def __init__(self, spinnerModel: javax.swing.SpinnerNumberModel, columns: typing.Union[jpype.JInt, int]) -> None:
        """
        Creates a new IntegerSpinner using the given spinner model.
        
        :param javax.swing.SpinnerNumberModel spinnerModel: the spinner model to use in the JSpinner.
        :param jpype.JInt or int columns: number of columns to display in in the JTextField
        """
    ...
    def setValue(self, value: java.lang.Number) -> None:
        """
