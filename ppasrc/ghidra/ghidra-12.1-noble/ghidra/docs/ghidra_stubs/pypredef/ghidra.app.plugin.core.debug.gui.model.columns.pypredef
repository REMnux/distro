...
class TracePathLastLifespanPlotColumn(docking.widgets.table.AbstractDynamicTableColumn[ghidra.app.plugin.core.debug.gui.model.PathTableModel.PathRow, generic.Span[java.lang.Long, typing.Any], ghidra.trace.model.Trace]):
    ...
    def setFullRange(self, fullRange: ghidra.trace.model.Lifespan) -> None:
        ...
...
class TraceValueObjectAttributeColumn(TraceValueObjectPropertyColumn[T], typing.Generic[T]):
    ...
    def __init__(self, attributeName: typing.Union[java.lang.String, str], attributeType: java.lang.Class[T]) -> None:
        """
...
class TraceValueObjectPropertyColumn(docking.widgets.table.AbstractDynamicTableColumn[ghidra.app.plugin.core.debug.gui.model.ObjectTableModel.ValueRow, ghidra.app.plugin.core.debug.gui.model.ObjectTableModel.ValueProperty[T], ghidra.trace.model.Trace], typing.Generic[T]):
    ...
    def __init__(self, propertyType: java.lang.Class[T]) -> None:
        ...
...
class EditableColumn(docking.widgets.table.DynamicTableColumn[ROW_TYPE, COLUMN_TYPE, DATA_SOURCE], typing.Generic[ROW_TYPE, COLUMN_TYPE, DATA_SOURCE]):
    ...
    def setValue(self, row: ROW_TYPE, value: COLUMN_TYPE, settings: ghidra.docking.settings.Settings, dataSource: DATA_SOURCE, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> None:
        ...
...
__all__ = ["TracePathValueColumn", "TracePathLastLifespanPlotColumn", "TraceValueLifePlotColumn", "TraceValueObjectAttributeColumn", "TraceValueObjectPropertyColumn", "EditableColumn", "TraceValueKeyColumn", "TraceValueColumnRenderer", "TraceValueValColumn", "AbstractTraceValueObjectAddressColumn", "AbstractTraceValueObjectLengthColumn", "TracePathColumnRenderer", "TracePathLastKeyColumn", "TracePathLastLifespanColumn", "TracePathStringColumn", "TraceValueLifeColumn", "TraceValueObjectEditableAttributeColumn"]
