...
class ControlModeAction(docking.menu.MultiStateDockingAction[ghidra.debug.api.control.ControlMode]):
    ...
    def __init__(self, plugin: DebuggerControlPlugin) -> None:
        ...
...
class DisconnectTask(ghidra.util.task.Task):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, targets: collections.abc.Sequence) -> None:
        ...
...
class TargetActionBuilder(docking.action.builder.AbstractActionBuilder[TargetDockingAction, docking.ActionContext, TargetActionBuilder]):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], owner: ghidra.framework.plugintool.Plugin) -> None:
        ...
...
class TargetDockingAction(docking.action.DockingAction):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], keyBindingType: docking.action.KeyBindingType, tool: ghidra.framework.plugintool.PluginTool, action: ghidra.debug.api.target.ActionName, defaultDescription: typing.Union[java.lang.String, str]) -> None:
        ...
...
class TargetActionTask(ghidra.util.task.Task):
    ...
    class FutureTask(ghidra.util.task.Task):
        ...
        def __init__(self, delegate: ghidra.util.task.Task) -> None:
            ...
    ...
    class FutureAsTask(ghidra.util.task.Task, typing.Generic[T]):
        ...
        def __init__(self, title: typing.Union[java.lang.String, str], canCancel: typing.Union[jpype.JBoolean, bool], hasProgress: typing.Union[jpype.JBoolean, bool], isModal: typing.Union[jpype.JBoolean, bool], futureSupplier: java.util.function.Function[ghidra.util.task.TaskMonitor, java.util.concurrent.CompletableFuture[T]]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, title: typing.Union[java.lang.String, str], entry: ghidra.debug.api.target.Target.ActionEntry, timeout: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
__all__ = ["ControlAction", "ControlModeAction", "DebuggerControlPlugin", "DebuggerMethodActionsPlugin", "DisconnectAction", "DisconnectTask", "EmulateInterruptAction", "InterruptAction", "EmulateResumeAction", "ResumeAction", "EmulateSkipOverAction", "EmulateStepBackAction", "EmulateStepIntoAction", "StepIntoAction", "TargetActionBuilder", "TargetDockingAction", "TargetActionTask", "TargetInterruptAction", "TargetKillAction", "TargetResumeAction", "TargetStepExtAction", "TargetStepIntoAction", "TargetStepOutAction", "TargetStepOverAction", "TraceSnapBackwardAction", "TraceSnapForwardAction"]
