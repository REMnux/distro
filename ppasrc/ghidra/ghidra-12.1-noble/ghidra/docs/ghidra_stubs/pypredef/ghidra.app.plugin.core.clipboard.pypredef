...
class CodeBrowserClipboardProvider(ghidra.app.util.ByteCopier, ghidra.app.services.ClipboardContentProviderService, ghidra.framework.options.OptionsChangeListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, componentProvider: docking.ComponentProvider) -> None:
        ...

    def getStringContent(self) -> str:
        ...

    def setListingLayoutModel(self, model: ghidra.app.util.viewer.listingpanel.ListingModel) -> None:
        ...
    ...
    def setStringContent(self, text: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ClipboardPlugin(ghidra.app.plugin.ProgramPlugin, java.awt.datatransfer.ClipboardOwner, ghidra.app.services.ClipboardService, ghidra.framework.options.OptionsChangeListener):
    ...
    class PasteTask(ghidra.util.task.Task):
        ...
        def __init__(self, clipboard: java.awt.datatransfer.Clipboard, clipboardService: ghidra.app.services.ClipboardContentProviderService) -> None:
            ...
...
class CopyPasteSpecialDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, plugin: ClipboardPlugin, availableTypes: java.util.List[typing.Any], title: typing.Union[java.lang.String, str]) -> None:
        ...
...
__all__ = ["CodeBrowserClipboardProvider", "ClipboardPlugin", "CopyPasteSpecialDialog"]
