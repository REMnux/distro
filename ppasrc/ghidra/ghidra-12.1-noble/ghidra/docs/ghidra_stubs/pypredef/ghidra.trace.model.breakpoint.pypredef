...
class TraceBreakpointKind(java.lang.Enum[TraceBreakpointKind]):
    ...
    class TraceBreakpointKindSet(org.apache.commons.collections4.set.AbstractSetDecorator[TraceBreakpointKind]):
        ...
        def __init__(self, set: java.util.Set[TraceBreakpointKind]) -> None:
            ...
...
class TraceBreakpointLocation(TraceBreakpointCommon):
    ...
    @typing.overload
    def setEmuEnabled(self, lifespan: ghidra.trace.model.Lifespan, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def setEmuEnabled(self, snap: typing.Union[jpype.JLong, int], enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Set whether this breakpoint is enabled or disabled for emulation
    ...
    @typing.overload
    def setEmuSleigh(self, lifespan: ghidra.trace.model.Lifespan, sleigh: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setEmuSleigh(self, snap: typing.Union[jpype.JLong, int], sleigh: typing.Union[java.lang.String, str]) -> None:
        """
...
class TraceBreakpointCommon(ghidra.trace.model.TraceUniqueObject, ghidra.trace.model.target.iface.TraceObjectInterface):
    ...
    @typing.overload
    def setComment(self, lifespan: ghidra.trace.model.Lifespan, comment: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setComment(self, snap: typing.Union[jpype.JLong, int], comment: typing.Union[java.lang.String, str]) -> None:
        """
        Set a comment on this breakpoint
    ...
    @typing.overload
    def setEnabled(self, lifespan: ghidra.trace.model.Lifespan, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def setEnabled(self, snap: typing.Union[jpype.JLong, int], enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Set whether this breakpoint was enabled or disabled
...
class TraceBreakpointSpec(TraceBreakpointCommon):
    ...
    @typing.overload
    def setKinds(self, lifespan: ghidra.trace.model.Lifespan, kinds: collections.abc.Sequence) -> None:
        """
    ...
    @typing.overload
    def setKinds(self, snap: typing.Union[jpype.JLong, int], kinds: collections.abc.Sequence) -> None:
        """
        Set the kinds included in this breakpoint
...
__all__ = ["TraceBreakpointManager", "TraceBreakpointKind", "TraceBreakpointLocation", "TraceBreakpointCommon", "TraceBreakpointSpec"]
