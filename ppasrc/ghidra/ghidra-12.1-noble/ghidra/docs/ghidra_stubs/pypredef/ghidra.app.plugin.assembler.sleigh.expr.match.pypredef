...
class AbstractExpressionMatcher(ExpressionMatcher[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, ops: java.util.Set[java.lang.Class[T]]) -> None:
        ...

    @typing.overload
    def __init__(self, cls: java.lang.Class[T]) -> None:
        ...
...
class BinaryExpressionMatcher(AbstractExpressionMatcher[T], typing.Generic[T]):
    ...
    class Commutative(BinaryExpressionMatcher[T], typing.Generic[T]):
        ...
        @typing.overload
        def __init__(self, ops: java.util.Set[java.lang.Class[T]], leftMatcher: ExpressionMatcher[typing.Any], rightMatcher: ExpressionMatcher[typing.Any]) -> None:
            ...

        @typing.overload
        def __init__(self, cls: java.lang.Class[T], leftMatcher: ExpressionMatcher[typing.Any], rightMatcher: ExpressionMatcher[typing.Any]) -> None:
            ...
...
class FieldSizeMatcher(AbstractExpressionMatcher[ghidra.app.plugin.processors.sleigh.expression.PatternValue]):
    ...
    def __init__(self, sizeMatcher: ExpressionMatcher[typing.Any]) -> None:
        ...
...
class OperandValueMatcher(AbstractExpressionMatcher[ghidra.app.plugin.processors.sleigh.expression.OperandValue]):
    ...
    def __init__(self, defMatcher: ExpressionMatcher[typing.Any]) -> None:
        ...
...
class UnaryExpressionMatcher(AbstractExpressionMatcher[T], typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, ops: java.util.Set[java.lang.Class[T]], unaryMatcher: ExpressionMatcher[typing.Any]) -> None:
        ...

    @typing.overload
    def __init__(self, cls: java.lang.Class[T], unaryMatcher: ExpressionMatcher[typing.Any]) -> None:
        ...



__all__ = ["ExpressionMatcher", "AbstractExpressionMatcher", "AnyMatcher", "BinaryExpressionMatcher", "ConstantValueMatcher", "FieldSizeMatcher", "OperandValueMatcher", "UnaryExpressionMatcher"]
