...
class GhidraJythonInterpreter(org.python.util.InteractiveInterpreter):
    ...
    def clearLocals(self) -> None:
        """
        Clears the interpreter's locals
        """

    def execFile(self, file: generic.jar.ResourceFile, script: JythonScript) -> None:
        """
    ...
    def restoreLocals(self) -> None:
        """
        Restores the locals that were last saved with the :meth:`saveLocals() <.saveLocals>` method, and removes
        them from the stack.
        """

    def saveLocals(self) -> None:
        """
        Saves the interpreter's locals to a stack. These locals can be restored with the 
        :meth:`restoreLocals() <.restoreLocals>` method.
        """
...
class JythonCodeCompletionFactory(java.lang.Object):
    ...
    @staticmethod
    def changeOptions(options: ghidra.framework.options.Options, name: typing.Union[java.lang.String, str], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    @staticmethod
    def setupOptions(plugin: JythonPlugin, options: ghidra.framework.options.Options) -> None:
        """
...
class JythonPlugin(ghidra.app.plugin.ProgramPlugin, ghidra.app.plugin.core.interpreter.InterpreterConnection, ghidra.framework.options.OptionsChangeListener):
    ...
    class JythonInteractiveTaskMonitor(ghidra.util.task.TaskMonitorAdapter):
        ...
        @typing.overload
        def __init__(self, stdOut: java.io.PrintWriter) -> None:
            ...

        @typing.overload
        def __init__(self, stdout: java.io.OutputStream) -> None:
            ...
    ...
    def optionsChanged(self, options: ghidra.framework.options.ToolOptions, optionName: typing.Union[java.lang.String, str], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
...
__all__ = ["GhidraJythonInterpreter", "JythonCodeCompletionFactory", "JythonPlugin", "JythonPluginExecutionThread", "JythonPluginInputThread", "JythonRun", "JythonScript", "JythonScriptExecutionThread", "JythonScriptProvider", "JythonUtils", "PyDevUtils"]
