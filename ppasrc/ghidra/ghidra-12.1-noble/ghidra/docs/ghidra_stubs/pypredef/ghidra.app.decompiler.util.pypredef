...
class FillOutStructureCmd(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, location: ghidra.program.util.ProgramLocation, decompileOptions: ghidra.app.decompiler.DecompileOptions) -> None:
        """
        Constructor.
...
class FillOutStructureHelper(java.lang.Object):
    ...
    class PointerRef(java.lang.Object):
        ...
        def __init__(self, ref: ghidra.program.model.pcode.Varnode, off: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    class OffsetPcodeOpPair(java.lang.Object):
        ...
        def __init__(self, offset: typing.Union[java.lang.Long, int], pcodeOp: ghidra.program.model.pcode.PcodeOp) -> None:
            ...
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Constructor.
...
__all__ = ["FillOutStructureCmd", "FillOutStructureHelper"]
