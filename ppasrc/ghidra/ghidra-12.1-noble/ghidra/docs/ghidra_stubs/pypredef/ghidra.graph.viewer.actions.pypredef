...
class VgActionContext(docking.DefaultActionContext, VisualGraphActionContext):
    ...
    @typing.overload
    def __init__(self, provider: docking.ComponentProvider) -> None:
        ...

    @typing.overload
    def __init__(self, provider: docking.ComponentProvider, contextObject: java.lang.Object) -> None:
        ...
...
class VgVertexContext(VgActionContext, VisualGraphVertexActionContext[V], typing.Generic[V]):
    ...
    def __init__(self, provider: docking.ComponentProvider, v: V) -> None:
        ...
...
__all__ = ["VisualGraphContextMarker", "VgActionContext", "VisualGraphActionContext", "VgSatelliteContext", "VgVertexContext", "VisualGraphVertexActionContext", "VisualGraphSatelliteActionContext"]
