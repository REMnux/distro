...
class GTrableRowModel(java.lang.Object, typing.Generic[T]):
    ...
    def addListener(self, l: GTrableModeRowlListener) -> None:
        """
    ...
    def removeListener(self, l: GTrableModeRowlListener) -> None:
        """
...
class GTrable(javax.swing.JComponent, javax.swing.Scrollable, GTrableModeRowlListener, typing.Generic[T]):
    ...
    def __init__(self, rowModel: GTrableRowModel[T], columnModel: GTrableColumnModel[T]) -> None:
        """
        Constructor
    ...
    def addCellClickedListener(self, listener: GTrableCellClickedListener) -> None:
        """
    ...
    def addSelectedRowConsumer(self, consumer: java.util.function.Consumer[java.lang.Integer]) -> None:
        """
    ...
    def clearSelectedRow(self) -> None:
        """
    ...
    def collapseRow(self, rowIndex: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def expandRow(self, rowIndex: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def expandRowRecursively(self, rowIndex: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeCellClickedListener(self, listener: GTrableCellClickedListener) -> None:
        """
    ...
    def removeSelectedRowConsumer(self, consumer: java.util.function.Consumer[java.lang.Integer]) -> None:
        """
    ...
    def setColumnModel(self, columnModel: GTrableColumnModel[T]) -> None:
        """
    ...
    def setPreferredVisibleRowCount(self, minVisibleRows: typing.Union[jpype.JInt, int], maxVisibleRows: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setRowModel(self, newRowModel: GTrableRowModel[T]) -> None:
        """
    ...
    def setSelectedRow(self, rowIndex: typing.Union[jpype.JInt, int]) -> None:
        """
...
class OpenCloseIcon(javax.swing.Icon):
    ...
    def __init__(self, isOpen: typing.Union[jpype.JBoolean, bool], width: typing.Union[jpype.JInt, int], height: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
...
class GTrableCellClickedListener(java.lang.Object):
    ...
    def cellClicked(self, row: typing.Union[jpype.JInt, int], column: typing.Union[jpype.JInt, int], event: java.awt.event.MouseEvent) -> None:
        """
...
class DefaultGTrableRowModel(AbstractGTrableRowModel[T], typing.Generic[T]):
    ...
    def __init__(self, roots: java.util.List[T]) -> None:
        ...
...
__all__ = ["AbstractGTrableRowModel", "GTrableRowModel", "GTrableModeRowlListener", "DefaultGTrableCellRenderer", "GTrableCellRenderer", "GTrable", "OpenCloseIcon", "GTrableColumnModel", "GTrableCellClickedListener", "GTrableColumn", "DefaultGTrableRowModel", "GTrableRow"]
