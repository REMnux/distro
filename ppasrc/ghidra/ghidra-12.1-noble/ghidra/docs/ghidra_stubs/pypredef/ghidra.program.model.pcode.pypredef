...
class AttributeId(java.lang.Record):
    ...
    ATTRIB_MAX_PRIMITIVES: typing.Final[AttributeId]
    ATTRIB_REVERSESIGNIF: typing.Final[AttributeId]
    ATTRIB_MATCHSIZE: typing.Final[AttributeId]
    ATTRIB_AFTER_BYTES: typing.Final[AttributeId]
    ATTRIB_AFTER_STORAGE: typing.Final[AttributeId]
    ATTRIB_FILL_ALTERNATE: typing.Final[AttributeId]
    ATTRIB_UNKNOWN: typing.Final[AttributeId]

    def __init__(self, name: typing.Union[java.lang.String, str], id: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ElementId(java.lang.Record):
    ...
    ELEM_BITFIELD: typing.Final[ElementId]
    ...
    ELEM_CONSUME_REMAINING: typing.Final[ElementId]
...
class Varnode(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, a: ghidra.program.model.address.Address, sz: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, a: ghidra.program.model.address.Address, sz: typing.Union[jpype.JInt, int], symbolKey: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def encodeRaw(self, encoder: Encoder) -> None:
        """
...
class Encoder(java.lang.Object):
    ...
    nested set of *elements*, with labels corresponding to the ElementId class. A single
    ...
    def writeBool(self, attribId: AttributeId, val: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def writeOpcode(self, attribId: AttributeId, opcode: ghidra.pcodeCPort.opcodes.OpCode) -> None:
        """
        Write a p-code operation opcode into the encoding, associating it with the given annotation.
        The opcode is specified based on the constants defined in :obj:`PcodeOp`.
        
        :param AttributeId attribId: is the given annotation
        :param ghidra.pcodeCPort.opcodes.OpCode opcode: is the opcode constant
        :raises IOException: for errors in the underlying stream
        """

    def writeSignedInteger(self, attribId: AttributeId, val: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def writeSpace(self, attribId: AttributeId, spc: ghidra.program.model.address.AddressSpace) -> None:
        """
    ...
    @typing.overload
    def writeSpace(self, attribId: AttributeId, index: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def writeString(self, attribId: AttributeId, val: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def writeStringIndexed(self, attribId: AttributeId, index: typing.Union[jpype.JInt, int], val: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def writeUnsignedInteger(self, attribId: AttributeId, val: typing.Union[jpype.JLong, int]) -> None:
        """
...
class PcodeOp(java.lang.Object):
    ...
    ZPULL: typing.Final = 71
    POPCOUNT: typing.Final = 72
    LZCOUNT: typing.Final = 73
    SPULL: typing.Final = 74
    PCODE_MAX: typing.Final = 75

    @typing.overload
    def __init__(self, sq: SequenceNumber, op: typing.Union[jpype.JInt, int], numinputs: typing.Union[jpype.JInt, int], out: Varnode) -> None:
        """
    ...
    @typing.overload
    def __init__(self, sq: SequenceNumber, op: typing.Union[jpype.JInt, int], in_: jpype.JArray[Varnode], out: Varnode) -> None:
        """
    ...
    @typing.overload
    def __init__(self, a: ghidra.program.model.address.Address, sequencenumber: typing.Union[jpype.JInt, int], op: typing.Union[jpype.JInt, int], in_: jpype.JArray[Varnode], out: Varnode) -> None:
        """
    ...
    @typing.overload
    def __init__(self, a: ghidra.program.model.address.Address, sequencenumber: typing.Union[jpype.JInt, int], op: typing.Union[jpype.JInt, int], in_: jpype.JArray[Varnode]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, a: ghidra.program.model.address.Address, sequencenumber: typing.Union[jpype.JInt, int], op: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def encodeRaw(self, encoder: Encoder, addrFactory: ghidra.program.model.address.AddressFactory) -> None:
        """
    ...
    def insertInput(self, vn: Varnode, slot: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def removeInput(self, slot: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setInput(self, vn: Varnode, slot: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setOpcode(self, o: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setOrder(self, ord: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setOutput(self, vn: Varnode) -> None:
        """
    ...
    def setTime(self, t: typing.Union[jpype.JInt, int]) -> None:
        """
...
class SequenceNumber(java.lang.Comparable[SequenceNumber]):
    ...
    def __init__(self, instrAddr: ghidra.program.model.address.Address, sequenceNum: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setOrder(self, o: typing.Union[jpype.JInt, int]) -> None:
        """
        Set relative position information of PcodeOps within
        a basic block, may change as basic block is edited.
...
class PcodeBlock(java.lang.Object):
    ...
    class BlockEdge(java.lang.Object):
        ...
        @typing.overload
        def __init__(self, pt: PcodeBlock, lab: typing.Union[jpype.JInt, int], rev: typing.Union[jpype.JInt, int]) -> None:
            ...
        ...
        @typing.overload
        def decode(self, decoder: Decoder, resolver: BlockMap) -> None:
            """
        ...
        @typing.overload
        def decode(self, decoder: Decoder, blockList: java.util.ArrayList[PcodeBlock]) -> None:
            ...
    ...
    def setIndex(self, i: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class Decoder(ByteIngest):
    ...
    def closeElement(self, id: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def closeElementSkipping(self, id: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ByteIngest(java.lang.Object):
    ...
    def ingestBytes(self, byteArray: jpype.JArray[jpype.JByte], off: typing.Union[jpype.JInt, int], sz: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def open(self, max: typing.Union[jpype.JInt, int], desc: typing.Union[java.lang.String, str]) -> None:
        """
...
class PcodeFactory(java.lang.Object):
    ...
    def setAddrTied(self, vn: Varnode, val: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setDataType(self, vn: Varnode, type: ghidra.program.model.data.DataType) -> None:
        """
    ...
    def setMergeGroup(self, vn: Varnode, val: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    def setPersistent(self, vn: Varnode, val: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setUnaffected(self, vn: Varnode, val: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setVolatile(self, vn: Varnode, val: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class PcodeDataTypeManager(java.lang.Object):
    ...
    class TypeMap(java.lang.Object):
        ...
        @typing.overload
        def __init__(self, lang: ghidra.program.model.lang.DecompilerLanguage, d: ghidra.program.model.data.BuiltIn, meta: typing.Union[java.lang.String, str], isChar: typing.Union[jpype.JBoolean, bool], isUtf: typing.Union[jpype.JBoolean, bool], manager: ghidra.program.model.data.DataTypeManager) -> None:
            ...

        @typing.overload
        def __init__(self, d: ghidra.program.model.data.DataType, nm: typing.Union[java.lang.String, str], meta: typing.Union[java.lang.String, str], isChar: typing.Union[jpype.JBoolean, bool], isUtf: typing.Union[jpype.JBoolean, bool], id: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    def __init__(self, prog: ghidra.program.model.listing.Program, simplifier: ghidra.program.model.symbol.NameTransformer) -> None:
        """
        Constructor
        
        :param ghidra.program.model.listing.Program prog: the program for the p-code data type maanger
        :param ghidra.program.model.symbol.NameTransformer simplifier: the name transformer to be used
        """
    ...
    def encodeCompositePlaceholder(self, encoder: Encoder, type: ghidra.program.model.data.DataType) -> None:
        """
    ...
    def encodeCoreTypes(self, encoder: Encoder) -> None:
        """
    ...
    def encodeType(self, encoder: Encoder, type: ghidra.program.model.data.DataType, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def encodeTypeRef(self, encoder: Encoder, type: ghidra.program.model.data.DataType, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def encodeUnion(self, encoder: Encoder, unionType: ghidra.program.model.data.Union) -> None:
        """
    ...
    def setNameTransformer(self, newTransformer: ghidra.program.model.symbol.NameTransformer) -> None:
        ...
        :param ghidra.program.model.symbol.NameTransformer newTransformer: the name transformer to set to this manager
        """
...
class HighSymbol(java.lang.Object):
    ...
    @staticmethod
    def encodeMapSym(encoder: Encoder, sym: HighSymbol) -> None:
        """
    ...
    def setNameLock(self, namelock: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setTypeLock(self, typelock: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class HighFunction(PcodeSyntaxTree):
    ...
    def __init__(self, function: ghidra.program.model.listing.Function, language: ghidra.program.model.lang.Language, compilerSpec: ghidra.program.model.lang.CompilerSpec, dtManager: PcodeDataTypeManager) -> None:
        """
    ...
    @staticmethod
    def createLabelSymbol(symtab: ghidra.program.model.symbol.SymbolTable, addr: ghidra.program.model.address.Address, name: typing.Union[java.lang.String, str], namespace: ghidra.program.model.symbol.Namespace, source: ghidra.program.model.symbol.SourceType, useLocalNamespace: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @staticmethod
    def deleteSymbol(symtab: ghidra.program.model.symbol.SymbolTable, addr: ghidra.program.model.address.Address, name: typing.Union[java.lang.String, str], space: ghidra.program.model.symbol.Namespace) -> None:
        ...

    def encode(self, encoder: Encoder, id: typing.Union[jpype.JLong, int], namespace: ghidra.program.model.symbol.Namespace, entryPoint: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    def encodeNamespace(encoder: Encoder, namespace: ghidra.program.model.symbol.Namespace, transformer: ghidra.program.model.symbol.NameTransformer) -> None:
        """
    ...
    def grabFromFunction(self, overrideExtrapop: typing.Union[jpype.JInt, int], includeDefaultNames: typing.Union[jpype.JBoolean, bool], doOverride: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class PcodeSyntaxTree(PcodeFactory):
    ...
    def __init__(self, afact: ghidra.program.model.address.AddressFactory, dtmanage: PcodeDataTypeManager) -> None:
        ...
    ...
    def delete(self, op: PcodeOp) -> None:
        ...
    ...
    def insertAfter(self, newop: PcodeOp, prev: PcodeOp) -> None:
        ...

    def insertBefore(self, newop: PcodeOp, follow: PcodeOp) -> None:
        ...
    ...
    def setInput(self, op: PcodeOp, vn: Varnode, slot: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setOpcode(self, op: PcodeOp, opc: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setOutput(self, op: PcodeOp, vn: Varnode) -> None:
        ...

    def unInsert(self, op: PcodeOp) -> None:
        ...

    def unSetInput(self, op: PcodeOp, slot: typing.Union[jpype.JInt, int]) -> None:
        ...

    def unSetOutput(self, op: PcodeOp) -> None:
        ...

    def unlink(self, op: PcodeOpAST) -> None:
        ...
...
class SymbolEntry(java.lang.Object):
    ...
    def __init__(self, sym: HighSymbol) -> None:
        """
...
class HighVariable(java.lang.Object):
    ...
    def attachInstances(self, inst: jpype.JArray[Varnode], rep: Varnode) -> None:
        """
...
class FunctionPrototype(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, ls: LocalSymbolMap, func: ghidra.program.model.listing.Function) -> None:
        """
    ...
    @typing.overload
    def __init__(self, proto: ghidra.program.model.listing.FunctionSignature, cspec: ghidra.program.model.lang.CompilerSpec, voidimpliesdotdotdot: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def decodePrototype(self, decoder: Decoder, pcodeFactory: PcodeFactory) -> None:
        """
    ...
    def encodePrototype(self, encoder: Encoder, dtmanage: PcodeDataTypeManager, firstVarArg: typing.Union[jpype.JInt, int]) -> None:
        """
...
class LocalSymbolMap(java.lang.Object):
    ...
    class MappedVarKey(java.lang.Object):
        ...
        @typing.overload
        def __init__(self, addr: ghidra.program.model.address.Address, pcad: ghidra.program.model.address.Address) -> None:
            ...

        @typing.overload
        def __init__(self, store: ghidra.program.model.listing.VariableStorage, pcad: ghidra.program.model.address.Address) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, highFunc: HighFunction, spc: ghidra.program.model.address.AddressSpace) -> None:
        """
    ...
    def decodeScope(self, decoder: Decoder) -> None:
        """
    ...
    def decodeSymbolList(self, decoder: Decoder) -> None:
        """
    ...
    def encodeLocalDb(self, encoder: Encoder, namespace: ghidra.program.model.symbol.Namespace, transformer: ghidra.program.model.symbol.NameTransformer) -> None:
        """
    ...
    def grabFromFunction(self, includeDefaultNames: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class GlobalSymbolMap(java.lang.Object):
    ...
    def __init__(self, f: HighFunction) -> None:
        """
    ...
    def populateAnnotation(self, vn: Varnode) -> None:
        """
...
class JumpTable(java.lang.Object):
    ...
    class BasicOverride(java.lang.Object):
        ...
        def __init__(self, dlist: java.util.ArrayList[ghidra.program.model.address.Address]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, destlist: java.util.ArrayList[ghidra.program.model.address.Address], override: typing.Union[jpype.JBoolean, bool], format: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    @staticmethod
    def getFormatOverride(func: ghidra.program.model.listing.Function, opAddress: ghidra.program.model.address.Address) -> int:
        """
        Get any case format override for this jumptable.
        
        :param ghidra.program.model.listing.Function func: is the function with the jumptable
        :param ghidra.program.model.address.Address opAddress: is the address of the call point using the table
    ...
    @staticmethod
    def writeFormat(func: ghidra.program.model.listing.Function, opAddress: ghidra.program.model.address.Address, displayFormat: typing.Union[jpype.JInt, int]) -> None:
        """
        ...
        :param ghidra.program.model.listing.Function func: is the function containing the switch
        :param ghidra.program.model.address.Address opAddress: is the address of the CALLIND
        :param jpype.JInt or int displayFormat: is the new desired format
        :raises InvalidInputException: for problems writing to the database
        """
...
class DataTypeSymbol(java.lang.Object):
    ...
    def __init__(self, dt: ghidra.program.model.data.DataType, nr: typing.Union[java.lang.String, str], cat: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    @staticmethod
    def deleteSymbols(nmroot: typing.Union[java.lang.String, str], addr: ghidra.program.model.address.Address, symtab: ghidra.program.model.symbol.SymbolTable, space: ghidra.program.model.symbol.Namespace) -> None:
        ...
    ...
    def writeSymbol(self, symtab: ghidra.program.model.symbol.SymbolTable, addr: ghidra.program.model.address.Address, namespace: ghidra.program.model.symbol.Namespace, dtmanage: ghidra.program.model.data.DataTypeManager, clearold: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class HighCodeSymbol(HighSymbol):
    ...
    @typing.overload
    def __init__(self, sym: ghidra.program.database.symbol.CodeSymbol, func: HighFunction) -> None:
        """
    ...
    @typing.overload
    def __init__(self, id: typing.Union[jpype.JLong, int], addr: ghidra.program.model.address.Address, dataType: ghidra.program.model.data.DataType, sz: typing.Union[jpype.JInt, int], func: HighFunction) -> None:
        """
    ...
    @typing.overload
    def __init__(self, id: typing.Union[jpype.JLong, int], nm: typing.Union[java.lang.String, str], data: ghidra.program.model.listing.Data, dtmanage: PcodeDataTypeManager) -> None:
        """
...
class HighParam(HighLocal):
    ...
    @typing.overload
    def __init__(self, high: HighFunction) -> None:
        """
        Constructor for use with restoreXml
    ...
    @typing.overload
    def __init__(self, tp: ghidra.program.model.data.DataType, rep: Varnode, pc: ghidra.program.model.address.Address, slot: typing.Union[jpype.JInt, int], sym: HighSymbol) -> None:
        """
...
class HighLocal(HighVariable):
    ...
    @typing.overload
    def __init__(self, type: ghidra.program.model.data.DataType, vn: Varnode, inst: jpype.JArray[Varnode], pc: ghidra.program.model.address.Address, sym: HighSymbol) -> None:
        ...
...
class EquateSymbol(HighSymbol):
    ...
    @typing.overload
    def __init__(self, func: HighFunction) -> None:
        ...

    @typing.overload
    def __init__(self, uniqueId: typing.Union[jpype.JLong, int], nm: typing.Union[java.lang.String, str], val: typing.Union[jpype.JLong, int], func: HighFunction, addr: ghidra.program.model.address.Address, hash: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def __init__(self, uniqueId: typing.Union[jpype.JLong, int], conv: typing.Union[jpype.JInt, int], val: typing.Union[jpype.JLong, int], func: HighFunction, addr: ghidra.program.model.address.Address, hash: typing.Union[jpype.JLong, int]) -> None:
        ...
    ...
    @staticmethod
    def getFormatStringValue(format: typing.Union[java.lang.String, str]) -> int:
        """
        
        
        :param java.lang.String or str format: is the name of a conversion format
        :return: return the matching conversion type or FORMAT_DEFAULT if there is no matching conversion
        :rtype: int
        """

    @staticmethod
    def getIntegerFormatString(convert: typing.Union[jpype.JInt, int]) -> str:
        """
        
        
        :param jpype.JInt or int convert: is an integer conversion type
...
class PcodeOpBank(java.lang.Object):
    ...
    def changeOpcode(self, op: PcodeOp, newopc: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class VarnodeAST(Varnode):
    ...
    def __init__(self, a: ghidra.program.model.address.Address, sz: typing.Union[jpype.JInt, int], id: typing.Union[jpype.JInt, int]) -> None:
        ...

    def addDescendant(self, op: PcodeOp) -> None:
        ...

    def descendReplace(self, vn: VarnodeAST) -> None:
        """
    ...
    def removeDescendant(self, op: PcodeOp) -> None:
        ...

    def setAddrtied(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setDef(self, op: PcodeOp) -> None:
        ...

    def setFree(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setHigh(self, hi: HighVariable) -> None:
        ...

    def setInput(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setMergeGroup(self, val: typing.Union[jpype.JShort, int]) -> None:
        ...

    def setPersistent(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setUnaffected(self, val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class PcodeOpAST(PcodeOp):
    ...
    @typing.overload
    def __init__(self, sq: SequenceNumber, op: typing.Union[jpype.JInt, int], numinputs: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, a: ghidra.program.model.address.Address, uq: typing.Union[jpype.JInt, int], op: typing.Union[jpype.JInt, int], numinputs: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setBasicIter(self, iter: java.util.Iterator[PcodeOp]) -> None:
        """
    ...
    def setInsertIter(self, iter: java.util.Iterator[java.lang.Object]) -> None:
        """
    ...
    def setParent(self, par: PcodeBlockBasic) -> None:
        """
...
class BlockMap(java.lang.Object):
    ...
    class GotoReference(java.lang.Object):
        ...
        def __init__(self, gblock: PcodeBlock, root: typing.Union[jpype.JInt, int], d: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, fac: ghidra.program.model.address.AddressFactory) -> None:
        ...

    @typing.overload
    def __init__(self, op2: BlockMap) -> None:
        ...

    def addGotoRef(self, gblock: PcodeBlock, root: typing.Union[jpype.JInt, int], depth: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ListLinked(java.lang.Object, typing.Generic[T]):
    ...
    class LinkedIterator(java.util.Iterator[T]):
        ...
        def __init__(self, cur: ListLinked.LinkedNode) -> None:
            ...
    ...
    def remove(self, itr: java.util.Iterator[T]) -> None:
        """
...
class PatchEncoder(CachedEncoder):
    ...
    def writeSpaceId(self, attribId: AttributeId, spaceId: typing.Union[jpype.JLong, int]) -> None:
        """
...
class PackedDecode(Decoder):
    ...
    @typing.overload
    def __init__(self, addrFactory: ghidra.program.model.address.AddressFactory) -> None:
        ...

    @typing.overload
    def __init__(self, stream: java.io.InputStream, desc: typing.Union[java.lang.String, str]) -> None:
        """
...
class PackedEncode(Encoder):
    """
    A byte-based encoder designed to marshal to the decompiler efficiently See ``PackedDecode``
...
class LinkedByteBuffer(java.lang.Object):
    ...
    class Position(java.lang.Object):
        ...
        def advancePosition(self, skip: typing.Union[jpype.JInt, int]) -> None:
            """
        ...
        def copy(self, pos: LinkedByteBuffer.Position) -> None:
            """
    ...
    def __init__(self, max: typing.Union[jpype.JInt, int], pad: typing.Union[jpype.JInt, int], desc: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def getStartPosition(self, position: LinkedByteBuffer.Position) -> None:
        ...
    ...
    def ingestStreamAsNeeded(self, stream: java.io.InputStream, start: LinkedByteBuffer.Position) -> None:
        """
...
class AddressXML(java.lang.Object):
    ...
    * MAY be in the JOIN address space, with physical pieces making up the logical value explicitly provided
    ...
    @typing.overload
    def __init__(self, spc: ghidra.program.model.address.AddressSpace, off: typing.Union[jpype.JLong, int], sz: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, spc: ghidra.program.model.address.AddressSpace, off: typing.Union[jpype.JLong, int], sz: typing.Union[jpype.JInt, int], pieces: jpype.JArray[Varnode]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def encode(encoder: Encoder, addr: ghidra.program.model.address.Address) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def encode(encoder: Encoder, addr: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def encode(encoder: Encoder, varnodes: jpype.JArray[Varnode], logicalsize: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def encodeAttributes(encoder: Encoder, addr: ghidra.program.model.address.Address) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def encodeAttributes(encoder: Encoder, addr: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def encodeAttributes(encoder: Encoder, startAddr: ghidra.program.model.address.Address, endAddr: ghidra.program.model.address.Address) -> None:
        """
...
class BlockGraph(PcodeBlock):
    ...
    def addBlock(self, bl: PcodeBlock) -> None:
        """
    ...
    def addEdge(self, begin: PcodeBlock, end: PcodeBlock) -> None:
        """
    ...
    def transferObjectRef(self, ingraph: BlockGraph) -> None:
        """
...
class BlockCopy(PcodeBlock):
    ...
    @typing.overload
    def __init__(self, r: java.lang.Object, addr: ghidra.program.model.address.Address) -> None:
        ...
...
class BlockGoto(BlockGraph):
    ...
    def setGotoTarget(self, gt: PcodeBlock) -> None:
        ...
...
class BlockIfGoto(BlockGraph):
    ...
    def setGotoTarget(self, bl: PcodeBlock) -> None:
        ...
...
class BlockMultiGoto(BlockGraph):
    ...
    def addGotoTarget(self, target: PcodeBlock) -> None:
        ...
...
class DynamicEntry(SymbolEntry):
    ...
    @typing.overload
    def __init__(self, sym: HighSymbol, addr: ghidra.program.model.address.Address, h: typing.Union[jpype.JLong, int]) -> None:
        """
...
class DynamicHash(java.lang.Object):
    ...
    class ToOpEdge(java.lang.Comparable[DynamicHash.ToOpEdge]):
        ...
        def __init__(self, o: PcodeOp, s: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, root: Varnode, method: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, root: Varnode, fd: PcodeSyntaxTree) -> None:
        """
    ...
    @typing.overload
    def __init__(self, op: PcodeOp, slot: typing.Union[jpype.JInt, int], fd: PcodeSyntaxTree) -> None:
        """
    ...
    @typing.overload
    def __init__(self, op: PcodeOp, inputIndex: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    def gatherFirstLevelVars(varlist: java.util.ArrayList[Varnode], fd: PcodeSyntaxTree, addr: ghidra.program.model.address.Address, h: typing.Union[jpype.JLong, int]) -> None:
        ...

    @staticmethod
    def gatherOpsAtAddress(oplist: java.util.ArrayList[PcodeOp], fd: PcodeSyntaxTree, addr: ghidra.program.model.address.Address) -> None:
        ...
...
class HighConstant(HighVariable):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], type: ghidra.program.model.data.DataType, vn: Varnode, pc: ghidra.program.model.address.Address, func: HighFunction) -> None:
        """
...
class HighExternalSymbol(HighSymbol):
    ...
    def __init__(self, nm: typing.Union[java.lang.String, str], addr: ghidra.program.model.address.Address, resolveAddr: ghidra.program.model.address.Address, dtmanage: PcodeDataTypeManager) -> None:
        """
...
class HighFunctionDBUtil(java.lang.Object):
    ...
    @staticmethod
    def commitLocalNamesToDatabase(highFunction: HighFunction, source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    @staticmethod
    def commitParamsToDatabase(highFunction: HighFunction, useDataTypes: typing.Union[jpype.JBoolean, bool], returnCommit: HighFunctionDBUtil.ReturnCommitOption, source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    @staticmethod
    def updateDBVariable(highSymbol: HighSymbol, name: typing.Union[java.lang.String, str], dataType: ghidra.program.model.data.DataType, source: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    @staticmethod
    def writeUnionFacet(function: ghidra.program.model.listing.Function, dt: ghidra.program.model.data.DataType, fieldNum: typing.Union[jpype.JInt, int], addr: ghidra.program.model.address.Address, hash: typing.Union[jpype.JLong, int], source: ghidra.program.model.symbol.SourceType) -> None:
        """
...
class HighFunctionShellSymbol(HighSymbol):
    ...
    def __init__(self, id: typing.Union[jpype.JLong, int], nm: typing.Union[java.lang.String, str], addr: ghidra.program.model.address.Address, manage: PcodeDataTypeManager) -> None:
        """
...
class HighFunctionSymbol(HighSymbol):
    ...
    def __init__(self, addr: ghidra.program.model.address.Address, size: typing.Union[jpype.JInt, int], function: HighFunction) -> None:
        """
...
class HighGlobal(HighVariable):
    ...
    @typing.overload
    def __init__(self, sym: HighSymbol, vn: Varnode, inst: jpype.JArray[Varnode]) -> None:
        ...
...
class HighLabelSymbol(HighSymbol):
    ...
    def __init__(self, nm: typing.Union[java.lang.String, str], addr: ghidra.program.model.address.Address, dtmanage: PcodeDataTypeManager) -> None:
        """
...
class HighOther(HighVariable):
    ...
    @typing.overload
    def __init__(self, type: ghidra.program.model.data.DataType, vn: Varnode, inst: jpype.JArray[Varnode], pc: ghidra.program.model.address.Address, func: HighFunction) -> None:
        """
...
class HighParamID(PcodeSyntaxTree):
    ...
    def storeParametersToDatabase(self, storeDataTypes: typing.Union[jpype.JBoolean, bool], srctype: ghidra.program.model.symbol.SourceType) -> None:
        """
    ...
    def storeReturnToDatabase(self, storeDataTypes: typing.Union[jpype.JBoolean, bool], srctype: ghidra.program.model.symbol.SourceType) -> None:
        """
        Update any parameters for this Function from parameters defined in this map.
...
class ParamMeasure(java.lang.Object):
    ...
    def decode(self, decoder: Decoder, factory: PcodeFactory) -> None:
        """
...
class MappedDataEntry(MappedEntry):
    ...
    @typing.overload
    def __init__(self, sym: HighSymbol, store: ghidra.program.model.listing.VariableStorage, d: ghidra.program.model.listing.Data) -> None:
        """
...
class MappedEntry(SymbolEntry):
    ...
    @typing.overload
    def __init__(self, sym: HighSymbol, store: ghidra.program.model.listing.VariableStorage, addr: ghidra.program.model.address.Address) -> None:
        """
...
class PackedBytes(java.io.OutputStream):
    ...
    def __init__(self, startlen: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def insertByte(self, streampos: typing.Union[jpype.JInt, int], val: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def write(self, val: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def write(self, byteArray: jpype.JArray[jpype.JByte], off: typing.Union[jpype.JInt, int], len: typing.Union[jpype.JInt, int]) -> None:
        """
...
class PackedDecodeOverlay(PackedDecode):
    ...
    def __init__(self, addrFactory: ghidra.program.model.address.AddressFactory, spc: ghidra.program.model.address.OverlayAddressSpace) -> None:
        ...
...
class PackedEncodeOverlay(PatchPackedEncode):
    ...
    def __init__(self, spc: ghidra.program.model.address.OverlayAddressSpace) -> None:
        ...
...
class UnionFacetSymbol(HighSymbol):
    ...
    def __init__(self, uniqueId: typing.Union[jpype.JLong, int], nm: typing.Union[java.lang.String, str], dt: ghidra.program.model.data.DataType, fldNum: typing.Union[jpype.JInt, int], func: HighFunction) -> None:
        ...
...
class XmlEncode(CachedEncoder):
    ...
    @typing.overload
    def __init__(self, doFormat: typing.Union[jpype.JBoolean, bool]) -> None:
        ...



__all__ = ["AttributeId", "ElementId", "Varnode", "Encoder", "PcodeOp", "SequenceNumber", "PcodeBlockBasic", "PcodeBlock", "Decoder", "ByteIngest", "PcodeFactory", "DecoderException", "PcodeException", "PcodeDataTypeManager", "HighSymbol", "HighFunction", "PcodeSyntaxTree", "SymbolEntry", "HighVariable", "FunctionPrototype", "LocalSymbolMap", "GlobalSymbolMap", "JumpTable", "DataTypeSymbol", "HighCodeSymbol", "HighParam", "HighLocal", "EquateSymbol", "PcodeOpBank", "VarnodeBank", "VarnodeAST", "PcodeOpAST", "BlockMap", "ListLinked", "PcodeOverride", "PatchEncoder", "CachedEncoder", "PackedDecode", "PackedEncode", "LinkedByteBuffer", "AddressXML", "BlockCondition", "BlockGraph", "BlockCopy", "BlockDoWhile", "BlockGoto", "BlockIfElse", "BlockIfGoto", "BlockInfLoop", "BlockList", "BlockMultiGoto", "BlockProperIf", "BlockSwitch", "BlockWhileDo", "DynamicEntry", "DynamicHash", "HighConstant", "HighExternalSymbol", "HighFunctionDBUtil", "HighFunctionShellSymbol", "HighFunctionSymbol", "HighGlobal", "HighLabelSymbol", "HighOther", "HighParamID", "ParamMeasure", "MappedDataEntry", "MappedEntry", "PackedBytes", "PackedDecodeOverlay", "PackedEncodeOverlay", "PatchPackedEncode", "PartialUnion", "StringIngest", "UnionFacetSymbol", "VarnodeTranslator", "XmlEncode"]
