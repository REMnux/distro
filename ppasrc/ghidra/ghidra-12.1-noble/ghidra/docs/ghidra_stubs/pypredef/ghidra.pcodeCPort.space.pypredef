...
class AddrSpace(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, t: ghidra.pcodeCPort.translate.Translate, tp: spacetype, nm: typing.Union[java.lang.String, str], size: typing.Union[jpype.JInt, int], ws: typing.Union[jpype.JInt, int], ind: typing.Union[jpype.JInt, int], fl: typing.Union[jpype.JInt, int], dl: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def __init__(self, t: ghidra.pcodeCPort.translate.Translate, tp: spacetype) -> None:
        ...
    ...
    def printOffset(self, s: java.io.PrintStream, offset: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class ConstantSpace(AddrSpace):
    ...
    def __init__(self, t: ghidra.pcodeCPort.translate.Translate) -> None:
        ...
...
class OtherSpace(AddrSpace):
    ...
    @typing.overload
    def __init__(self, t: ghidra.pcodeCPort.translate.Translate, nm: typing.Union[java.lang.String, str], ind: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class UniqueSpace(AddrSpace):
    ...
    @typing.overload
    def __init__(self, t: ghidra.pcodeCPort.translate.Translate, ind: typing.Union[jpype.JInt, int], fl: typing.Union[jpype.JInt, int]) -> None:
        ...
...
__all__ = ["AddrSpace", "spacetype", "ConstantSpace", "OtherSpace", "UniqueSpace"]
