...
class FrameDescriptionEntry(ghidra.app.plugin.exceptionhandlers.gcc.GccAnalysisClass):
    ...
    def __init__(self, monitor: ghidra.util.task.TaskMonitor, program: ghidra.program.model.listing.Program, cieSource: ghidra.app.plugin.exceptionhandlers.gcc.sections.CieSource) -> None:
        """
...
class Cie(ghidra.app.plugin.exceptionhandlers.gcc.GccAnalysisClass):
    ...
    @typing.overload
    def __init__(self, monitor: ghidra.util.task.TaskMonitor, program: ghidra.program.model.listing.Program, isInDebugFrame: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ExceptionHandlerFrameHeader(java.lang.Object):
    ...
    def __init__(self, monitor: ghidra.util.task.TaskMonitor, curProg: ghidra.program.model.listing.Program) -> None:
        """
...
class DwarfCallFrameOpcodeParser(java.lang.Object):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int]) -> None:
        """
...
class FdeTable(java.lang.Object):
    ...
    def create(self, addr: ghidra.program.model.address.Address, decoder: ghidra.app.plugin.exceptionhandlers.gcc.DwarfEHDecoder, fdeTableCnt: typing.Union[jpype.JLong, int]) -> None:
        """
...
__all__ = ["FrameDescriptionEntry", "Cie", "ExceptionHandlerFrameException", "ExceptionHandlerFrameHeader", "DwarfCallFrameOpcodeParser", "FdeTable"]
