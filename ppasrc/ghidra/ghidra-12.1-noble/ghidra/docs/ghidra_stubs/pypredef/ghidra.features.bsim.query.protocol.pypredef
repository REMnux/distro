...
class BSimQuery(java.lang.Object, typing.Generic[R]):
    ...
    def restoreXml(self, parser: ghidra.xml.XmlPullParser, vectorFactory: generic.lsh.vector.LSHVectorFactory) -> None:
        ...

    def saveXml(self, fwrite: java.io.Writer) -> None:
        ...
...
class ResponseNearest(QueryResponseRecord):
    ...
    def __init__(self, q: QueryNearest) -> None:
        ...
...
class QueryResponseRecord(java.lang.Object):
    ...
    def mergeResults(self, subresponse: QueryResponseRecord) -> None:
        """
...
class ResponseNearestVector(QueryResponseRecord):
    ...
    def __init__(self, q: QueryNearestVector) -> None:
        ...
...
class SimilarityResult(java.lang.Iterable[SimilarityNote]):
    ...
    @typing.overload
    def __init__(self, f: ghidra.features.bsim.query.description.FunctionDescription) -> None:
        ...

    def addNote(self, f: ghidra.features.bsim.query.description.FunctionDescription, similarity: typing.Union[jpype.JDouble, float], significance: typing.Union[jpype.JDouble, float]) -> None:
        ...
    ...
    def restoreXml(self, parser: ghidra.xml.XmlPullParser, qmanage: ghidra.features.bsim.query.description.DescriptionManager, rmanage: ghidra.features.bsim.query.description.DescriptionManager, qMap: collections.abc.Mapping, rMap: collections.abc.Mapping) -> None:
        ...

    def saveXml(self, write: java.io.Writer) -> None:
        ...

    def setTotalCount(self, count: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setTransfer(self, op2: SimilarityResult, qmanage: ghidra.features.bsim.query.description.DescriptionManager, rmanage: ghidra.features.bsim.query.description.DescriptionManager, transsig: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def transfer(self, manage: ghidra.features.bsim.query.description.DescriptionManager, transsig: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class SimilarityNote(java.lang.Comparable[SimilarityNote]):
    ...
    @typing.overload
    def __init__(self, f: ghidra.features.bsim.query.description.FunctionDescription, sm: typing.Union[jpype.JDouble, float], sf: typing.Union[jpype.JDouble, float]) -> None:
        ...
    ...
    def restoreXml(self, parser: ghidra.xml.XmlPullParser, manage: ghidra.features.bsim.query.description.DescriptionManager, exeMap: collections.abc.Mapping) -> None:
        ...

    def saveXml(self, write: java.io.Writer) -> None:
        ...

    def setTransfer(self, op2: SimilarityNote, manage: ghidra.features.bsim.query.description.DescriptionManager, transsig: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class SimilarityVectorResult(java.lang.Object):
    ...
    def addNotes(self, newnotes: java.util.List[ghidra.features.bsim.query.description.VectorResult]) -> None:
        ...
    ...
    def restoreXml(self, parser: ghidra.xml.XmlPullParser, vectorFactory: generic.lsh.vector.LSHVectorFactory, qmanage: ghidra.features.bsim.query.description.DescriptionManager, exeMap: collections.abc.Mapping) -> None:
        ...
...
class PreFilter(java.lang.Object):
    ...
    def addPredicate(self, predicate: java.util.function.BiPredicate[ghidra.program.model.listing.Program, ghidra.features.bsim.query.description.FunctionDescription]) -> None:
        ...
...
class BSimFilter(java.lang.Object):
    ...
    class FilterEntry(java.lang.Record):
        ...
        def __init__(self, filterType: ghidra.features.bsim.gui.filters.BSimFilterType, values: java.util.List[java.lang.String]) -> None:
            ...
    ...
    def addAtom(self, type: ghidra.features.bsim.gui.filters.BSimFilterType, val: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def replaceWith(self, other: BSimFilter) -> None:
        ...
...
class FilterAtom(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, type: ghidra.features.bsim.gui.filters.BSimFilterType, value: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ExeSpecifier(java.lang.Comparable[ExeSpecifier]):
    ...
    def transfer(self, op2: ghidra.features.bsim.query.description.ExecutableRecord) -> None:
        ...
...
class ResponseName(QueryResponseRecord):
    ...
    def printRaw(self, stream: java.io.PrintStream, vectorFactory: generic.lsh.vector.LSHVectorFactory, format: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class QueryExeCount(BSimQuery[ResponseExe]):
    ...
    @typing.overload
    def __init__(self, filterMd5: typing.Union[java.lang.String, str], filterExeName: typing.Union[java.lang.String, str], filterArch: typing.Union[java.lang.String, str], filterCompilerName: typing.Union[java.lang.String, str], includeFakes: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
...
class ResponsePair(QueryResponseRecord):
    ...
    class Accumulator(java.lang.Object):
        ...
        def merge(self, responsePair: ResponsePair) -> None:
            """
    ...
    def fillOutStatistics(self, accumulator: ResponsePair.Accumulator) -> None:
        ...

    def saveXmlTail(self, fwrite: java.io.Writer) -> None:
        ...
...
class QueryDelete(BSimQuery[ResponseDelete]):
    ...
    def addSpecifier(self, spec: ExeSpecifier) -> None:
        ...
...
class ResponseUpdate(QueryResponseRecord):
    ...
    def __init__(self, q: QueryUpdate) -> None:
        ...
...
class ResponseChildren(QueryResponseRecord):
    ...
    def __init__(self, qc: QueryChildren) -> None:
        ...
...
class FunctionEntry(java.lang.Object):
    ...
    def __init__(self, desc: ghidra.features.bsim.query.description.FunctionDescription) -> None:
        ...
...
class ClusterNote(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, f: ghidra.features.bsim.query.description.FunctionDescription, ss: typing.Union[jpype.JInt, int], ms: typing.Union[jpype.JDouble, float], sig: typing.Union[jpype.JDouble, float]) -> None:
        ...
    ...
    def restoreXml(self, parser: ghidra.xml.XmlPullParser, manage: ghidra.features.bsim.query.description.DescriptionManager, xrefMap: collections.abc.Mapping) -> None:
        ...
...
class ExecutableResultWithDeDuping(java.lang.Comparable[ExecutableResultWithDeDuping]):
    ...
    def __init__(self, rec: ghidra.features.bsim.query.description.ExecutableRecord) -> None:
        ...

    def addFunction(self, signif: typing.Union[jpype.JDouble, float]) -> None:
        ...
...
class FunctionStaging(StagingManager):
    ...
    def __init__(self, stagesize: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ResponseCluster(QueryResponseRecord):
    ...
    def __init__(self, q: QueryCluster) -> None:
        ...
...
__all__ = ["QueryNearest", "BSimQuery", "ResponseNearest", "QueryResponseRecord", "QueryNearestVector", "ResponseNearestVector", "StagingManager", "SimilarityResult", "SimilarityNote", "SimilarityVectorResult", "PreFilter", "BSimFilter", "FilterAtom", "ExeSpecifier", "QueryName", "ResponseName", "QueryExeCount", "ResponseExe", "QueryExeInfo", "CreateDatabase", "ResponseInfo", "InstallCategoryRequest", "InstallTagRequest", "InstallMetadataRequest", "AdjustVectorIndex", "ResponseAdjustIndex", "PrewarmRequest", "ResponsePrewarm", "InsertRequest", "ResponseInsert", "QueryPair", "ResponsePair", "QueryVectorId", "ResponseVectorId", "QueryVectorMatch", "ResponseVectorMatch", "QueryDelete", "ResponseDelete", "QueryUpdate", "ResponseUpdate", "DropDatabase", "ResponseDropDatabase", "PasswordChange", "ResponsePassword", "QueryChildren", "ResponseChildren", "QueryInfo", "FunctionEntry", "PairInput", "PairNote", "QueryOptionalExist", "ResponseOptionalExist", "QueryOptionalValues", "ResponseOptionalValues", "InsertOptionalValues", "ChildAtom", "ClusterNote", "ExecutableResultWithDeDuping", "FunctionStaging", "NullStaging", "QueryCluster", "ResponseCluster", "ResponseError"]
