...
class CloneCodeViewerAction(docking.action.DockingAction):
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], provider: ghidra.app.plugin.core.codebrowser.CodeViewerProvider) -> None:
        ...
...
class CollapseAllDataAction(ghidra.app.context.ProgramLocationContextAction):
    ...
    def __init__(self, provider: ghidra.app.plugin.core.codebrowser.CodeViewerProvider) -> None:
        ...
...
__all__ = ["CloneCodeViewerAction", "CollapseAllDataAction", "ExpandAllDataAction", "GotoNextFunctionAction", "GotoPreviousFunctionAction", "ToggleExpandCollapseDataAction"]
