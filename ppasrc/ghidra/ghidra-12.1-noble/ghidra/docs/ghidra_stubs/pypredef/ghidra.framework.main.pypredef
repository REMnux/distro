...
class ConsoleTextPane(javax.swing.JTextPane, ghidra.framework.options.OptionsChangeListener):
    ...
    class MessageWrapper(java.lang.Object):
        ...
        def __init__(self, message: typing.Union[java.lang.String, str], font: java.awt.Font, color: java.awt.Color) -> None:
            ...
    ...
    def addErrorMessage(self, message: typing.Union[java.lang.String, str]) -> None:
        ...

    def addMessage(self, message: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def addPartialMessage(self, message: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def addPartialMessage(self, message: typing.Union[java.lang.String, str], c: java.awt.Color) -> None:
        ...

    def dispose(self) -> None:
        ...

    def setScrollLock(self, lock: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DataTreeDialog(AbstractDataTreeDialog):
    ...
    @typing.overload
    def __init__(self, parent: java.awt.Component, title: typing.Union[java.lang.String, str], type: DataTreeDialogType) -> None:
        """
    ...
    @typing.overload
    def __init__(self, parent: java.awt.Component, title: typing.Union[java.lang.String, str], type: DataTreeDialogType, filter: ghidra.framework.model.DomainFileFilter) -> None:
        """
        ...
        :param ghidra.framework.model.DomainFileFilter filter: filter used to control what is displayed in the data tree.  See static
        implementations provided by :obj:`DomainFileFilter` and a more tailored 
        :obj:`DefaultDomainFileFilter`.
        :raises IllegalArgumentException: if invalid type is specified
        """

    @typing.overload
    def __init__(self, parent: java.awt.Component, title: typing.Union[java.lang.String, str], type: DataTreeDialogType, filter: ghidra.framework.model.DomainFileFilter, project: ghidra.framework.model.Project) -> None:
        """
...
class AbstractDataTreeDialog(docking.DialogComponentProvider, docking.widgets.tree.support.GTreeSelectionListener, java.awt.event.ActionListener):
    ...
    def setNameText(self, name: typing.Union[java.lang.String, str]) -> None:
        ...

    def setSearchText(self, s: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def setTreeSelectionMode(self, mode: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    @property
    def folderText(self) -> java.lang.String:
        ...
...
class DialogProjectDataCollapseAction(ghidra.framework.main.projectdata.actions.ProjectDataCollapseAction[ghidra.framework.main.datatree.DialogProjectTreeContext]):
    ...
    def __init__(self, owner: typing.Union[java.lang.String, str], group: typing.Union[java.lang.String, str]) -> None:
        ...
...
class OpenVersionedFileDialog(AbstractDataTreeDialog, typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, title: typing.Union[java.lang.String, str], domainObjectClass: java.lang.Class[T]) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, title: typing.Union[java.lang.String, str], domainObjectClass: java.lang.Class[T], openDomainObjects: java.util.List[T]) -> None:
        """
        Constructor
...
class ProgramFileChooser(DataTreeDialog):
    """
    :obj:`ProgramFileChooser` facilitates selection of an existing project Program file including
    Program link-files which may link to either internal or external program files.
    This chooser operates in the :obj:`open mode <DataTreeDialogType.OPEN>` for selecting
    ...
    A more taylored :obj:`DataTreeDialog` should be used for case where the file will be written.
    """

    class_: typing.ClassVar[java.lang.Class]
    PROGRAM_FILE_FILTER: typing.Final[ghidra.framework.model.DomainFileFilter]
    """
    ...
    @typing.overload
    def __init__(self, parent: java.awt.Component, title: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, parent: java.awt.Component, title: typing.Union[java.lang.String, str], project: ghidra.framework.model.Project) -> None:
        """
        Construct a new DataTreeDialog for the given project.
...
class AcceptUrlContentTask(ghidra.framework.protocol.ghidra.GhidraURLQueryTask):
    ...
    def __init__(self, url: java.net.URL, followExternalLinks: typing.Union[jpype.JBoolean, bool], plugin: FrontEndPlugin) -> None:
        ...
...
class FrontEndPlugin(ghidra.framework.plugintool.Plugin, FrontEndService, ghidra.framework.client.RemoteAdapterListener, ghidra.framework.model.ProjectViewListener, ProgramaticUseOnly):
    ...
    def showInProjectTree(self, projectData: ghidra.framework.model.ProjectData, path: typing.Union[java.lang.String, str], isFolder: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ProjectRepoConnectAction(ghidra.framework.main.datatable.FrontendProjectTreeAction):
    """
    :obj:`ProjectRepoConnectAction` action allows the user to initiate a shared repository
    connection for a root shared project data tree node that is not currently connected.
    """

    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, plugin: FrontEndPlugin, group: typing.Union[java.lang.String, str]) -> None:
        ...


class ProjectDataFollowLinkAction(ghidra.framework.main.datatable.FrontendProjectTreeAction):
...
class ProjectDataSelectRealFileOrFolderAction(ghidra.framework.main.datatable.FrontendProjectTreeAction):
...
class FrontEndTool(ghidra.framework.plugintool.PluginTool, ghidra.framework.options.OptionsChangeListener):
    ...
    @typing.type_check_only
    class LogWindow(javax.swing.JFrame):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    def __init__(self, pm: ghidra.framework.model.ProjectManager) -> None:
        """
    ...
    @typing.overload
    def checkIn(self, tool: ghidra.framework.plugintool.PluginTool, fileList: java.util.List[ghidra.framework.model.DomainFile], parent: java.awt.Component) -> None:
        """
    ...
    @typing.overload
    def merge(self, tool: ghidra.framework.plugintool.PluginTool, fileList: java.util.List[ghidra.framework.model.DomainFile], taskListener: ghidra.util.task.TaskListener) -> None:
        """
    ...
    def selectFiles(self, files: java.util.Set[ghidra.framework.model.DomainFile]) -> None:
        ...
    ...
    def setBusy(self, busy: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ToolButton(docking.widgets.EmptyBorderButton, docking.dnd.Draggable, docking.dnd.Droppable):
    ...
    class ToolButtonDropTgtAdapter(docking.dnd.DropTgtAdapter):
        ...
        def __init__(self, acceptableDropActions: typing.Union[jpype.JInt, int], acceptableDropFlavors: jpype.JArray[java.awt.datatransfer.DataFlavor]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def launchTool(self, domainFile: ghidra.framework.model.DomainFile) -> None:
        ...
...
class BrokenLinkIcon(javax.swing.Icon):
    """
    ...
    def __init__(self, baseIcon: javax.swing.Icon) -> None:
        """
...
class EditPluginPathDialog(docking.DialogComponentProvider):
    ...
    def show(self, tool: ghidra.framework.plugintool.PluginTool) -> None:
        """
...
class GetDomainObjectTask(ghidra.util.task.Task):
    ...
    @typing.overload
    def __init__(self, consumer: java.lang.Object, domainFile: ghidra.framework.model.DomainFile, versionNumber: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, consumer: java.lang.Object, domainFile: ghidra.framework.model.DomainFile, versionNumber: typing.Union[jpype.JInt, int], immutable: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class MoveImageRunner(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, ghidraGlassPane: ghidra.util.bean.GGlassPane, startBounds: java.awt.Rectangle, endBounds: java.awt.Rectangle, painter: ZoomedImagePainter) -> None:
        ...

    @typing.overload
    def __init__(self, ghidraGlassPane: ghidra.util.bean.GGlassPane, startBounds: java.awt.Rectangle, endBounds: java.awt.Rectangle, painter: ZoomedImagePainter, repaint: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ZoomedImagePainter(ghidra.util.bean.GGlassPanePainter):
    ...
    def __init__(self, targetBounds: java.awt.Rectangle, image: java.awt.Image) -> None:
        ...
    ...
    def setMagnifyFactor(self, factor: typing.Union[jpype.JFloat, float]) -> None:
        ...

    def setTargetBounds(self, containerBounds: java.awt.Rectangle) -> None:
        ...

    def setZoom(self, zoom: typing.Union[jpype.JFloat, float]) -> None:
        ...
...
class ProjectAccessPanel(javax.swing.JPanel):
    ...
    * User Access Panel: Displays all users on the project, and their access permissions
    ...
    class UserAccessPanel(javax.swing.JPanel):
        ...
        def __init__(self, user: typing.Union[java.lang.String, str]) -> None:
            """
    ...
    @typing.overload
    def __init__(self, knownUsers: jpype.JArray[java.lang.String], repository: ghidra.framework.client.RepositoryAdapter, tool: ghidra.framework.plugintool.PluginTool) -> None:
        """
...
class UserAccessTableModel(docking.widgets.table.GDynamicColumnTableModel[ghidra.framework.remote.User, java.util.List[ghidra.framework.remote.User]]):
    ...
    def __init__(self, currentUser: typing.Union[java.lang.String, str], userList: java.util.List[ghidra.framework.remote.User], serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> None:
        """
    ...
    def addUsers(self, addedUsers: java.util.List[ghidra.framework.remote.User]) -> None:
        """
    ...
    def removeUsers(self, removedUsers: java.util.List[ghidra.framework.remote.User]) -> None:
        """
    ...
    def setUserList(self, users: java.util.List[ghidra.framework.remote.User]) -> None:
        """
    ...
    def setValueAt(self, aValue: java.lang.Object, rowIndex: typing.Union[jpype.JInt, int], columnIndex: typing.Union[jpype.JInt, int]) -> None:
        """
...
class SelectPanel(javax.swing.JPanel):
    ...
    def __init__(self, selectAllCallback: java.awt.event.ActionListener, deselectAllCallback: java.awt.event.ActionListener) -> None:
        ...
...
class UserAgreementDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, showAgreementChoices: typing.Union[jpype.JBoolean, bool], exitOnCancel: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ViewProjectAccessPanel(ProjectAccessPanel):
    ...
    @typing.overload
    def __init__(self, repository: ghidra.framework.client.RepositoryAdapter, tool: ghidra.framework.plugintool.PluginTool) -> None:
        """
...
class ZoomImageRunner(java.lang.Object):
    ...
    def __init__(self, glassPane: ghidra.util.bean.GGlassPane, painter: ZoomedImagePainter, icon: javax.swing.Icon) -> None:
        ...

    def addTimingTargetListener(self, newFinishedTarget: org.jdesktop.animation.timing.TimingTarget) -> None:
        """
...
class ConsoleListener(java.lang.Object):
    ...
    def put(self, message: typing.Union[java.lang.String, str], isError: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def putln(self, message: typing.Union[java.lang.String, str], isError: typing.Union[jpype.JBoolean, bool]) -> None:
        ...



__all__ = ["DataTreeDialogType", "ConsoleTextPane", "DataTreeDialog", "AbstractDataTreeDialog", "DialogProjectDataCollapseAction", "DialogProjectDataExpandAction", "DialogProjectDataNewFolderAction", "FixedLengthTextField", "GhidraApplicationInformationDisplayFactory", "InfoPanel", "OpenVersionedFileDialog", "ProgramFileChooser", "ApplicationLevelOnlyPlugin", "ApplicationLevelPlugin", "AcceptUrlContentTask", "FrontEndPlugin", "FrontEndService", "ProgramaticUseOnly", "ProjectToolBar", "WorkspacePanel", "ProjectDataPanel", "LogPanel", "FileActionManager", "ProjectActionManager", "ToolActionManager", "ProjectRepoConnectAction", "ProjectDataFollowLinkAction", "ProjectDataSelectRealFileOrFolderAction", "FrontEndTool", "ToolButton", "ToolConnectionDialog", "ToolConnectionPanel", "ViewInfo", "RepositoryChooser", "ProjectInfoDialog", "ServerInfoComponent", "RunningToolsPanel", "AppInfo", "ApplicationLevelPluginsConfiguration", "BrokenLinkIcon", "EditActionManager", "EditPluginPathDialog", "FrontEndProjectDataCollapseAction", "FrontEndProjectDataExpandAction", "FrontEndProjectDataNewFolderAction", "GetDomainObjectTask", "ImportGhidraToolsDialog", "MoveImageRunner", "ZoomedImagePainter", "PickToolDialog", "ProjectAccessDialog", "ProjectAccessPanel", "UserAccessTableModel", "SaveDataDialog", "SelectPanel", "SetToolAssociationsDialog", "TestFrontEndTool", "ToolButtonTransferable", "UserAgreementDialog", "UtilityPluginPackage", "ViewProjectAccessPanel", "ZoomImageRunner", "ConsoleListener"]
