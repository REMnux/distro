...
class DBTraceMemorySpace(ghidra.trace.model.memory.TraceMemorySpace, InternalTraceMemoryOperations, ghidra.trace.database.space.DBTraceSpaceBased):
    ...
    def __init__(self, manager: DBTraceMemoryManager, dbh: db.DBHandle, space: ghidra.program.model.address.AddressSpace, ent: ghidra.trace.database.space.AbstractDBTraceSpaceBasedManager.DBTraceSpaceEntry) -> None:
        ...

    def checkStateMapIntegrity(self) -> None:
        ...
...
class DBTraceMemoryStateEntry(ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree.AbstractDBTraceAddressSnapRangePropertyMapData[ghidra.trace.model.memory.TraceMemoryState]):
    ...
    def __init__(self, tree: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree[ghidra.trace.model.memory.TraceMemoryState, typing.Any], store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
        ...
...
class DBTraceMemoryBufferEntry(ghidra.util.database.DBAnnotatedObject):
    ...
    def __init__(self, dbh: db.DBHandle, store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
        ...
    ...
    @typing.overload
    def acquireBlock(self, blockNum: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def copyFrom(self, dstBlockNum: typing.Union[jpype.JInt, int], srcBuf: DBTraceMemoryBufferEntry, srcBlockNum: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def releaseBlock(self, blockNum: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DBTraceMemoryBlockEntry(ghidra.util.database.DBAnnotatedObject):
    ...
    def __init__(self, space: DBTraceMemorySpace, store: ghidra.util.database.DBCachedObjectStore[typing.Any], record: db.DBRecord) -> None:
        ...
    ...
    def setLoc(self, location: ghidra.trace.database.DBTraceUtils.OffsetSnap) -> None:
        ...
...
class DBTraceEmptyMemBuffer(ghidra.program.model.mem.MemBufferMixin):
    ...
    def __init__(self, trace: ghidra.trace.database.DBTrace, start: ghidra.program.model.address.Address, byteOrder: java.nio.ByteOrder) -> None:
        ...
...
class DBTraceMemBuffer(ghidra.program.model.mem.MemBufferMixin):
    ...
    def __init__(self, space: DBTraceMemorySpace, snap: typing.Union[jpype.JLong, int], start: ghidra.program.model.address.Address, byteOrder: java.nio.ByteOrder) -> None:
        ...
...
__all__ = ["DBTraceMemoryManager", "InternalTraceMemoryOperations", "DBTraceMemorySpace", "DBTraceMemoryStateEntry", "DBTraceMemoryBufferEntry", "DBTraceMemoryBlockEntry", "DBTraceEmptyMemBuffer", "DBTraceMemBuffer", "DBTraceMemoryRegion", "DBTraceObjectMemory", "DBTraceObjectRegister", "DBTraceObjectRegisterContainer"]
