...
class CloseableTaskMonitor(ghidra.util.task.TaskMonitor, java.lang.AutoCloseable):
    ...
    def reportError(self, error: java.lang.Throwable) -> None:
        """
...
class ProgressListener(java.lang.Object):
    ...
    def attributeUpdated(self, monitor: MonitorReceiver) -> None:
        """
    ...
    def errorReported(self, monitor: MonitorReceiver, error: java.lang.Throwable) -> None:
        """
    ...
    def messageUpdated(self, monitor: MonitorReceiver, message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def monitorCreated(self, monitor: MonitorReceiver) -> None:
        """
    ...
    def monitorDisposed(self, monitor: MonitorReceiver, disposal: ProgressListener.Disposal) -> None:
        """
    ...
    def progressUpdated(self, monitor: MonitorReceiver, progress: typing.Union[jpype.JLong, int]) -> None:
        """
...
__all__ = ["CloseableTaskMonitor", "ProgressListener", "MonitorReceiver"]
