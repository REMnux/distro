...
class PathnameTablePanel(javax.swing.JPanel):
    ...
    @typing.overload
    def __init__(self, paths: jpype.JArray[java.lang.String], enableEdits: typing.Union[jpype.JBoolean, bool], addToTop: typing.Union[jpype.JBoolean, bool], ordered: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, paths: jpype.JArray[java.lang.String], resetCallback: utility.function.Callback, enableEdits: typing.Union[jpype.JBoolean, bool], addToTop: typing.Union[jpype.JBoolean, bool], ordered: typing.Union[jpype.JBoolean, bool], supportsDotPath: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setAddToTop(self, addToTop: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setEditingEnabled(self, enableEdits: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setOrdered(self, ordered: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setPaths(self, paths: jpype.JArray[java.lang.String]) -> None:
        ...
...
class PathManager(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, paths: java.util.List[generic.util.Path], addToTop: typing.Union[jpype.JBoolean, bool], allowOrdering: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct a new PathnameTablePanel.
    ...
    @typing.overload
    def __init__(self, addToTop: typing.Union[jpype.JBoolean, bool], allowOrdering: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def addListener(self, listener: PathManagerListener) -> None:
        ...
    ...
    def removeListener(self, listener: PathManagerListener) -> None:
        ...

    def restoreFromPreferences(self, enablePathKey: typing.Union[java.lang.String, str], defaultEnablePaths: jpype.JArray[generic.util.Path], disabledPathKey: typing.Union[java.lang.String, str]) -> None:
        """
        Restore paths from user Preferences using the specified keys.
        If preferences have never been saved, the specified ``defaultEnablePaths``
    ...
    def restoreState(self, ss: ghidra.framework.options.SaveState) -> None:
        """
    ...
    def saveState(self, ss: ghidra.framework.options.SaveState) -> None:
        """
    ...
    def setPaths(self, paths: java.util.List[generic.util.Path]) -> None:
        ...
...
class PathManagerListener(java.lang.Object):
    ...
    def pathMessage(self, message: typing.Union[java.lang.String, str]) -> None:
        ...
...
__all__ = ["AbstractPathsDialog", "PathnameTablePanel", "PathnameTableModel", "AbstractTypedPropertyEditor", "PathManager", "PathManagerModel", "PathManagerListener"]
