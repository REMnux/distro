...
class DyldCacheUtils(java.lang.Object):
    ...
    class DyldCacheImageRecord(java.lang.Record):
        ...
        def __init__(self, image: ghidra.app.util.bin.format.macho.dyld.DyldCacheImage, splitCacheIndex: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    class SplitDyldCache(java.io.Closeable):
        ...
        @typing.overload
        def __init__(self, baseProvider: ghidra.app.util.bin.ByteProvider, shouldProcessLocalSymbols: typing.Union[jpype.JBoolean, bool], log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> None:
            """
        ...
        @typing.overload
        def __init__(self, providers: java.util.List[ghidra.app.util.bin.ByteProvider], headers: java.util.List[ghidra.app.util.bin.format.macho.dyld.DyldCacheHeader], names: java.util.List[java.lang.String], log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> None:
            """
            Creates a new :obj:`SplitDyldCache`
...
class AbstractProgramLoader(Loader):
    ...
    @staticmethod
    def markAsFunction(program: ghidra.program.model.listing.Program, name: typing.Union[java.lang.String, str], funcStart: ghidra.program.model.address.Address) -> None:
        """
    ...
    @staticmethod
    def setProgramProperties(prog: ghidra.program.model.listing.Program, provider: ghidra.app.util.bin.ByteProvider, executableFormatName: typing.Union[java.lang.String, str]) -> None:
        """
...
class Loader(ghidra.util.classfinder.ExtensionPoint, java.lang.Comparable[Loader]):
    ...
    def loadInto(self, program: ghidra.program.model.listing.Program, settings: Loader.ImporterSettings) -> None:
        """
...
class LoadSpec(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, loader: Loader, imageBase: typing.Union[jpype.JLong, int], languageCompilerSpec: ghidra.program.model.lang.LanguageCompilerSpecPair, isPreferred: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, loader: Loader, imageBase: typing.Union[jpype.JLong, int], languageCompilerSpecQueryResult: QueryResult) -> None:
        """
    ...
    @typing.overload
    def __init__(self, loader: Loader, imageBase: typing.Union[jpype.JLong, int], requiresLanguageCompilerSpec: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class QueryResult(java.lang.Object):
    ...
    def __init__(self, pair: ghidra.program.model.lang.LanguageCompilerSpecPair, preferred: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class Loaded(java.lang.AutoCloseable, typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, domainObject: T, name: typing.Union[java.lang.String, str], fsrl: ghidra.formats.gfilesystem.FSRL, project: ghidra.framework.model.Project, projectRootPath: typing.Union[java.lang.String, str], mirrorFsLayout: typing.Union[jpype.JBoolean, bool], consumer: java.lang.Object) -> None:
        """
    ...
    @typing.overload
    def __init__(self, domainObject: T, settings: Loader.ImporterSettings) -> None:
        """
        Creates a new :obj:`Loaded` object.
    ...
    def apply(self, operation: java.util.function.Consumer[T]) -> None:
        """
    ...
    def setProjectFolderPath(self, projectRootPath: typing.Union[java.lang.String, str]) -> None:
        """
...
class LibrarySymbolTable(java.lang.Object):
    ...
    def applyOrdinalFile(self, ordinalExportsFile: generic.jar.ResourceFile, addMissingOrdinals: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class LoadResults(java.lang.Iterable[Loaded[T]], java.lang.AutoCloseable, typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, loadedList: java.util.List[Loaded[T]]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, loaded: Loaded[T]) -> None:
        """
    ...
    @typing.overload
    @deprecated("Use close() instead")
    def release(self, consumer: java.lang.Object, filter: java.util.function.Predicate[Loaded[T]]) -> None:
        """
    ...
    def releaseNonPrimary(self, consumer: java.lang.Object) -> None:
        """
...
class IntelHexRecord(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, recordLength: typing.Union[jpype.JInt, int], loadOffset: typing.Union[jpype.JInt, int], recordType: typing.Union[jpype.JInt, int], data: jpype.JArray[jpype.JByte], checksum: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, recordLength: typing.Union[jpype.JInt, int], loadOffset: typing.Union[jpype.JInt, int], recordType: typing.Union[jpype.JInt, int], data: jpype.JArray[jpype.JByte]) -> None:
        """
...
class AddressSetPartitioner(java.lang.Iterable[ghidra.program.model.address.AddressRange]):
    ...
    def __init__(self, set: ghidra.program.model.address.AddressSet, rangeMap: collections.abc.Mapping, partitionSet: java.util.Set[ghidra.program.model.address.Address]) -> None:
        ...
...
class BoundedBufferedReader(java.io.Reader):
    ...
    @typing.overload
    def __init__(self, in_: java.io.Reader, sz: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def mark(self, readAheadLimit: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DecompileDebugByteManager(java.lang.Object):
    ...
    def __init__(self, monitor: ghidra.util.task.TaskMonitor, prog: ghidra.program.model.listing.Program, programName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def parse(self, parser: ghidra.xml.XmlPullParser, log: ghidra.xml.XmlMessageLog) -> None:
        """
...
class DecompileDebugDataTypeManager(java.lang.Object):
    ...
    class DataTypeKey(java.lang.Record, java.lang.Comparable[DecompileDebugDataTypeManager.DataTypeKey]):
        ...
        @typing.overload
        def __init__(self, typeRefElement: ghidra.xml.XmlElement) -> None:
            ...

        @typing.overload
        def __init__(self, name: typing.Union[java.lang.String, str], id: typing.Union[java.lang.String, str]) -> None:
            ...

        @typing.overload
        def __init__(self, name: typing.Union[java.lang.String, str], id: typing.Union[java.lang.String, str], val: java.math.BigInteger) -> None:
            ...
    ...
    def __init__(self, monitor: ghidra.util.task.TaskMonitor, prog: ghidra.program.model.listing.Program) -> None:
        """
...
class DecompileDebugFormatManager(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, provider: ghidra.app.util.bin.ByteProvider) -> None:
        """
...
class DecompileDebugFunctionManager(java.lang.Object):
    ...
    def __init__(self, prog: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor, dataTypeManager: DecompileDebugDataTypeManager) -> None:
        """
    ...
    def parseFunctionSignature(self, parser: ghidra.xml.XmlPullParser, scopeMap: collections.abc.Mapping, log: ghidra.xml.XmlMessageLog) -> None:
        """
...
class DyldCacheProgramBuilder(MachoProgramBuilder):
    ...
    class DyldCacheMachoInfo(java.lang.Object):
        ...
        def __init__(self, splitDyldCache: DyldCacheUtils.SplitDyldCache, header: ghidra.app.util.bin.format.macho.MachHeader, headerAddr: ghidra.program.model.address.Address, path: typing.Union[java.lang.String, str]) -> None:
            """
        ...
        def addToProgramTree(self) -> None:
            """
        ...
        def createSymbols(self, processExports: typing.Union[jpype.JBoolean, bool]) -> None:
            """
        ...
        def markupLoadCommandData(self) -> None:
            """
        ...
        def processMemoryBlocks(self) -> None:
            """
    ...
    @staticmethod
    def buildProgram(program: ghidra.program.model.listing.Program, provider: ghidra.app.util.bin.ByteProvider, fileBytes: ghidra.program.database.mem.FileBytes, options: DyldCacheOptions, log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class MachoProgramBuilder(java.lang.Object):
    ...
    UNDEFINED_SYMBOL_SPACING: typing.Final = 256
    """
    The spacing between symbols that get created in the 
    :obj:`EXTERNAL block <MemoryBlock.EXTERNAL_BLOCK_NAME>`. This will allow some room for 
    ...
    @staticmethod
    def fixupExternalLibrary(program: ghidra.program.model.listing.Program, libraryPaths: java.util.List[java.lang.String], libraryOrdinal: typing.Union[jpype.JInt, int], symbol: typing.Union[java.lang.String, str]) -> None:
        """
...
class ElfDataType(ghidra.program.model.data.FactoryStructureDataType):
    ...
    @typing.overload
    def __init__(self, dtm: ghidra.program.model.data.DataTypeManager) -> None:
        ...
...
class IntelHexRecordWriter(java.lang.Object):
    ...
    def __init__(self, maxBytesPerLine: typing.Union[jpype.JInt, int], dropExtraBytes: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructor
    ...
    def addByte(self, address: ghidra.program.model.address.Address, b: typing.Union[jpype.JByte, int]) -> None:
        ...
...
class LoadedOpen(Loaded[T], typing.Generic[T]):
    ...
    def __init__(self, domainObject: T, domainFile: ghidra.framework.model.DomainFile, fsrl: ghidra.formats.gfilesystem.FSRL, consumer: java.lang.Object) -> None:
        """
...
class MachoPrelinkProgramBuilder(MachoProgramBuilder):
    ...
    class MachoInfo(java.lang.Object):
        ...
        def __init__(self, provider: ghidra.app.util.bin.ByteProvider, offset: typing.Union[jpype.JLong, int], headerAddr: ghidra.program.model.address.Address, name: typing.Union[java.lang.String, str]) -> None:
            """
...
class QueryOpinionServiceHandler(java.lang.Object):
    ...
    class FullQuery(java.lang.Object):
        ...
        def __init__(self, fullQuery: QueryOpinionServiceHandler.FullQuery, loader: typing.Union[java.lang.String, str], primary: typing.Union[java.lang.String, str], secondary: typing.Union[java.lang.String, str], query: ghidra.program.model.lang.LanguageCompilerSpecQuery) -> None:
            ...
...
class UnixAoutProgramLoader(java.lang.Object):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, header: ghidra.app.util.bin.format.unixaout.UnixAoutHeader, monitor: ghidra.util.task.TaskMonitor, log: ghidra.app.util.importer.MessageLog) -> None:
        ...

    def loadAout(self, baseAddr: typing.Union[jpype.JLong, int]) -> None:
        ...
...
__all__ = ["DyldCacheUtils", "PeLoader", "AbstractPeDebugLoader", "AbstractOrdinalSupportLoader", "AbstractLibrarySupportLoader", "AbstractProgramLoader", "Loader", "LoadSpec", "QueryResult", "Loaded", "LibrarySymbolTable", "LibraryExportedSymbol", "LoadException", "LoaderTier", "LoadResults", "IntelHexRecord", "LoaderMap", "AbstractProgramWrapperLoader", "AddressSetPartitioner", "BinaryLoader", "BoundedBufferedReader", "CoffLoader", "DbgLoader", "DecompileDebugByteManager", "DecompileDebugDataTypeManager", "DecompileDebugXmlLoader", "DecompileDebugFormatManager", "DecompileDebugFunctionManager", "DefExportLine", "DefLoader", "DyldCacheLoader", "DyldCacheOptions", "DyldCacheProgramBuilder", "MachoProgramBuilder", "ElfDataType", "ElfLoader", "ElfLoaderOptionsFactory", "ElfProgramBuilder", "MemorySectionResolver", "MemorySection", "GdtLoader", "GzfLoader", "IntelHexLoader", "IntelHexMemImage", "IntelHexRecordReader", "IntelHexRecordWriter", "LibraryHints", "LibraryLookupTable", "LibraryPathsDialog", "LoadedOpen", "LoaderOpinionException", "LoaderService", "MSCoffLoader", "MachoLoader", "MachoPrelinkProgramBuilder", "MachoPrelinkUtils", "MapLoader", "MotorolaHexLoader", "MzLoader", "NeLoader", "Omf51Loader", "OmfLoader", "OpinionException", "PeDataType", "PefLoader", "SomLoader", "QueryOpinionService", "QueryOpinionServiceHandler", "UnixAoutLoader", "UnixAoutProgramLoader", "XmlLoader", "TenetLoader"]
