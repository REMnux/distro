...
class DefaultPcodeThread(PcodeThread[T], typing.Generic[T]):
    ...
    class PcodeEmulationLibrary(ghidra.pcode.exec_.AnnotatedPcodeUseropLibrary[T], typing.Generic[T]):
        ...
        def __init__(self, thread: DefaultPcodeThread[T]) -> None:
            """
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], machine: AbstractPcodeMachine[T]) -> None:
        """
...
class PcodeMachine(java.lang.Object, typing.Generic[T]):
    ...
    def addAccessBreakpoint(self, range: ghidra.program.model.address.AddressRange, kind: PcodeMachine.AccessKind) -> None:
        """
    ...
    def addBreakpoint(self, address: ghidra.program.model.address.Address, sleighCondition: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def inject(self, address: ghidra.program.model.address.Address, source: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setSoftwareInterruptMode(self, mode: PcodeMachine.SwiMode) -> None:
        """
    ...
    def setSuspended(self, suspended: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class PcodeThread(java.lang.Object, typing.Generic[T]):
    ...
    @typing.overload
    def stepInstruction(self, count: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def stepPatch(self, sleigh: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def stepPcodeOp(self, count: typing.Union[jpype.JLong, int]) -> None:
        """
...
class PcodeEmulator(AbstractPcodeMachine[jpype.JArray[jpype.JByte]]):
    ...
    **IMPORTANT:** The inject must also return control to the calling function, usually by
    ...
    @typing.overload
    def __init__(self, language: ghidra.program.model.lang.Language, cb: PcodeEmulationCallbacks[jpype.JArray[jpype.JByte]]) -> None:
        """
...
class AbstractPcodeMachine(PcodeMachine[T], typing.Generic[T]):
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, cb: PcodeEmulationCallbacks[T]) -> None:
        """
...
class BytesPcodeThread(ModifiedPcodeThread[jpype.JArray[jpype.JByte]]):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], machine: AbstractPcodeMachine[jpype.JArray[jpype.JByte]]) -> None:
        """
        Construct a new thread
...
class ModifiedPcodeThread(DefaultPcodeThread[T], typing.Generic[T]):
    ...
    class GlueEmulate(ghidra.pcode.emulate.Emulate):
        ...
        def __init__(self, lang: ghidra.app.plugin.processors.sleigh.SleighLanguage, s: ghidra.pcode.memstate.MemoryState, b: ghidra.pcode.emulate.BreakTable) -> None:
            ...
    ...
    class ModifierUseropLibrary(ghidra.pcode.exec_.PcodeUseropLibrary[T]):
        ...
        class ModifierUseropDefinition(ghidra.pcode.exec_.PcodeUseropLibrary.PcodeUseropDefinition[T]):
            ...
            def __init__(self, name: typing.Union[java.lang.String, str], behavior: ghidra.pcode.emulate.callother.OpBehaviorOther) -> None:
                ...
...
class SleighInstructionDecoder(InstructionDecoder):
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, state: ghidra.pcode.exec_.PcodeExecutorState[typing.Any]) -> None:
        """
...
class PcodeEmulationCallbacks(java.lang.Object, typing.Generic[T]):
    ...
    class Wrapper(java.lang.Record, ghidra.pcode.exec_.PcodeStateCallbacks, typing.Generic[T]):
        ...
        def __init__(self, thread: PcodeThread[T], cb: PcodeEmulationCallbacks[T]) -> None:
            ...
    ...
    def afterBranch(self, thread: PcodeThread[T], op: ghidra.program.model.pcode.PcodeOp, target: ghidra.program.model.address.Address) -> None:
        """
    ...
    def afterExecuteInject(self, thread: PcodeThread[T], address: ghidra.program.model.address.Address) -> None:
        """
    ...
    def afterExecuteInstruction(self, thread: PcodeThread[T], instruction: ghidra.program.model.listing.Instruction) -> None:
        """
    ...
    def afterLoad(self, thread: PcodeThread[T], op: ghidra.program.model.pcode.PcodeOp, space: ghidra.program.model.address.AddressSpace, offset: T, size: typing.Union[jpype.JInt, int], value: T) -> None:
        """
    ...
    def afterStepOp(self, thread: PcodeThread[T], op: ghidra.program.model.pcode.PcodeOp, frame: ghidra.pcode.exec_.PcodeFrame) -> None:
        """
    ...
    def afterStore(self, thread: PcodeThread[T], op: ghidra.program.model.pcode.PcodeOp, space: ghidra.program.model.address.AddressSpace, offset: T, size: typing.Union[jpype.JInt, int], value: T) -> None:
        """
    ...
    def beforeDecodeInstruction(self, thread: PcodeThread[T], counter: ghidra.program.model.address.Address, context: ghidra.program.model.lang.RegisterValue) -> None:
        """
    ...
    def beforeExecuteInject(self, thread: PcodeThread[T], address: ghidra.program.model.address.Address, program: ghidra.pcode.exec_.PcodeProgram) -> None:
        """
    ...
    def beforeExecuteInstruction(self, thread: PcodeThread[T], instruction: ghidra.program.model.listing.Instruction, program: ghidra.pcode.exec_.PcodeProgram) -> None:
        """
    ...
    def beforeLoad(self, thread: PcodeThread[T], op: ghidra.program.model.pcode.PcodeOp, space: ghidra.program.model.address.AddressSpace, offset: T, size: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def beforeStepOp(self, thread: PcodeThread[T], op: ghidra.program.model.pcode.PcodeOp, frame: ghidra.pcode.exec_.PcodeFrame) -> None:
        """
    ...
    def beforeStore(self, thread: PcodeThread[T], op: ghidra.program.model.pcode.PcodeOp, space: ghidra.program.model.address.AddressSpace, offset: T, size: typing.Union[jpype.JInt, int], value: T) -> None:
        """
    ...
    @typing.overload
    def dataWritten(self, thread: PcodeThread[T], piece: ghidra.pcode.exec_.PcodeExecutorStatePiece[A, U], space: ghidra.program.model.address.AddressSpace, offset: A, length: typing.Union[jpype.JInt, int], value: U) -> None:
        """
    ...
    @typing.overload
    def dataWritten(self, thread: PcodeThread[T], piece: ghidra.pcode.exec_.PcodeExecutorStatePiece[A, U], address: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int], value: U) -> None:
        """
    ...
    @typing.overload
    def delegateDataWritten(self, thread: PcodeThread[T], piece: ghidra.pcode.exec_.PcodeExecutorStatePiece[A, U], space: ghidra.program.model.address.AddressSpace, offset: A, length: typing.Union[jpype.JInt, int], value: U) -> None:
        """
    ...
    @typing.overload
    def delegateDataWritten(self, thread: PcodeThread[T], piece: ghidra.pcode.exec_.PcodeExecutorStatePiece[A, U], address: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int], value: U) -> None:
        """
        Typically used from within
    ...
    @typing.overload
    def delegateReadUninitialized(self, thread: PcodeThread[T], piece: ghidra.pcode.exec_.PcodeExecutorStatePiece[A, U], space: ghidra.program.model.address.AddressSpace, offset: A, length: typing.Union[jpype.JInt, int], reason: ghidra.pcode.exec_.PcodeExecutorStatePiece.Reason) -> int:
        """
        Typically used from within
        :meth:`readUninitialized(PcodeThread, PcodeExecutorStatePiece, AddressSpace, Object, int, Reason) <.readUninitialized>`
        to forward to the callback for concrete addressing
        :meth:`readUninitialized(PcodeThread, PcodeExecutorStatePiece, AddressSetView, Reason) <.readUninitialized>`.
        ...
        :param A offset: the offset of the operand
        :param jpype.JInt or int length: the size of the operand
        :param ghidra.pcode.exec_.PcodeExecutorStatePiece.Reason reason: the reason for reading
        :return: the length of the operand just initialized, typically 0 or ``length``
        :rtype: int
        """

    @typing.overload
    def delegateReadUninitialized(self, thread: PcodeThread[T], piece: ghidra.pcode.exec_.PcodeExecutorStatePiece[A, U], set: ghidra.program.model.address.AddressSetView, reason: ghidra.pcode.exec_.PcodeExecutorStatePiece.Reason) -> ghidra.program.model.address.AddressSetView:
        """
        Typically used from within
        :meth:`readUninitialized(PcodeThread, PcodeExecutorStatePiece, AddressSetView, Reason) <.readUninitialized>` to
    ...
    def emulatorCreated(self, machine: PcodeMachine[T]) -> None:
        """
    ...
    @typing.overload
    def readUninitialized(self, thread: PcodeThread[T], piece: ghidra.pcode.exec_.PcodeExecutorStatePiece[A, U], space: ghidra.program.model.address.AddressSpace, offset: A, length: typing.Union[jpype.JInt, int], reason: ghidra.pcode.exec_.PcodeExecutorStatePiece.Reason) -> int:
        """
    ...
    @typing.overload
    def readUninitialized(self, thread: PcodeThread[T], piece: ghidra.pcode.exec_.PcodeExecutorStatePiece[A, U], set: ghidra.program.model.address.AddressSetView, reason: ghidra.pcode.exec_.PcodeExecutorStatePiece.Reason) -> ghidra.program.model.address.AddressSetView:
        """
        The emulator is preparing to read from uninitialized portions of the given state piece
        (concrete addressing).
    ...
    def sharedStateCreated(self, machine: PcodeMachine[T]) -> None:
        """
    ...
    def threadCreated(self, thread: PcodeThread[T]) -> None:
        """
...
class PcodeStateInitializer(ghidra.util.classfinder.ExtensionPoint):
    ...
    def initializeMachine(self, machine: PcodeMachine[T]) -> None:
        """
    ...
    def initializeThread(self, thread: PcodeThread[T]) -> None:
        """
...
class ThreadPcodeExecutorState(ghidra.pcode.exec_.PcodeExecutorState[T], typing.Generic[T]):
    ...
    def __init__(self, sharedState: ghidra.pcode.exec_.PcodeExecutorState[T], localState: ghidra.pcode.exec_.PcodeExecutorState[T]) -> None:
        """
...
class ComposedPcodeEmulationCallbacks(PcodeEmulationCallbacks[T], typing.Generic[T]):
    ...
    :meth:`readUninitialized(PcodeThread, PcodeExecutorStatePiece, AddressSetView, Reason) <.readUninitialized>`. For a
    missing userop, it will terminate after the first delegate returns ``true``, in which case it
    also returns ``true``. If all delegates return ``false``, then it returns ``false``.
    ...
    def __init__(self, *delegates: PcodeEmulationCallbacks[T]) -> None:
        """
...
class EmulatorUtilities(java.lang.Enum[EmulatorUtilities]):
    ...
    @staticmethod
    @typing.overload
    def decodeNullTerminatedString(state: ghidra.pcode.exec_.PcodeExecutorState[typing.Any], ptr: ghidra.program.model.address.Address, cs: java.nio.charset.Charset, maxBytes: typing.Union[jpype.JInt, int]) -> str:
        """
        ...
        :param ghidra.pcode.exec_.PcodeExecutorState[typing.Any] state: the memory
        :param ghidra.program.model.address.Address ptr: the starting address
        :param java.nio.charset.Charset cs: the character set
        :param jpype.JInt or int maxBytes: the maximum number of bytes to read
    ...
    @staticmethod
    @typing.overload
    def decodeNullTerminatedString(state: ghidra.pcode.exec_.PcodeExecutorState[typing.Any], ptr: ghidra.program.model.address.Address) -> str:
        """
    ...
    @staticmethod
    @typing.overload
    def initializeForFunction(thread: PcodeThread[T], function: ghidra.program.model.listing.Function, stackSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def initializeForFunction(thread: PcodeThread[T], function: ghidra.program.model.listing.Function) -> None:
        """
    ...
    @staticmethod
    def initializeRegisters(thread: PcodeThread[T], program: ghidra.program.model.listing.Program, pc: ghidra.program.model.address.Address) -> None:
        """
        Initialize the given thread's registers with the given program counter and (optionall)
        program register context.
        
        :param T: the type of values in the emulator:param PcodeThread[T] thread: the thread to initialize
        :param ghidra.program.model.listing.Program program: optionally, the program whose context to read
        :param ghidra.program.model.address.Address pc: the program counter, also used for register context
        """

    @staticmethod
    def inspectStackPointer(thread: PcodeThread[T], cSpec: ghidra.program.model.lang.CompilerSpec) -> ghidra.program.model.address.Address:
        """
        Inspect the value of the stack pointer, and return it as an address
        
        :param T: the type of values in the emulator:param PcodeThread[T] thread: the thread whose stack pointer to inspect
        :param ghidra.program.model.lang.CompilerSpec cSpec: the compiler spec defining the stack register and base space
    ...
    @staticmethod
    @typing.overload
    def loadProgram(machine: PcodeMachine[T], program: ghidra.program.model.listing.Program, blockSize: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def loadProgram(machine: PcodeMachine[typing.Any], program: ghidra.program.model.listing.Program) -> None:
        """
        Copy the bytes from the given program into the given emulator's memory.
...
__all__ = ["DefaultPcodeThread", "PcodeMachine", "PcodeThread", "PcodeEmulator", "AbstractPcodeMachine", "BytesPcodeThread", "ModifiedPcodeThread", "SleighInstructionDecoder", "InstructionDecoder", "PcodeEmulationCallbacks", "PcodeStateInitializer", "SparseAddressRangeMap", "ThreadPcodeExecutorState", "ComposedPcodeEmulationCallbacks", "EmulatorUtilities"]
