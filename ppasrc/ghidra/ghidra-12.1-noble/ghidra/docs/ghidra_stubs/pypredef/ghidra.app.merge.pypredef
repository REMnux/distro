...
class MergeManager(ghidra.framework.data.DomainObjectMergeManager):
    ...
    def __init__(self, resultDomainObject: ghidra.framework.model.DomainObject, myDomainObject: ghidra.framework.model.DomainObject, originalDomainObject: ghidra.framework.model.DomainObject, latestDomainObject: ghidra.framework.model.DomainObject, latestChangeSet: ghidra.program.model.listing.DomainObjectChangeSet, myChangeSet: ghidra.program.model.listing.DomainObjectChangeSet) -> None:
        ...
    ...
    def setCompleted(self, mergePhase: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    def setInProgress(self, mergePhase: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def showBlockingError(title: typing.Union[java.lang.String, str], msg: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def showBlockingError(title: typing.Union[java.lang.String, str], msg: typing.Union[java.lang.String, str], e: java.lang.Exception) -> None:
        """
        Display a blocking error popup.  When used from a :obj:`MergeResolver` task it will 
        prevent that task from exiting/progressing until the error popup is dismissed.
    ...
    def showDefaultMergePanel(self, description: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def showMonitorComponent(self, show: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def showProgressIcon(self, show: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def updateProgress(self, description: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def updateProgress(self, currentProgressPercentage: typing.Union[jpype.JInt, int]) -> None:
        """
        Updates the current phase progress area in the default merge panel.
    ...
    @typing.overload
    def updateProgress(self, currentProgressPercentage: typing.Union[jpype.JInt, int], progressMessage: typing.Union[java.lang.String, str]) -> None:
        """
        Updates the current phase progress area in the default merge panel.
...
class MergeManagerPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.main.ProgramaticUseOnly, ghidra.framework.model.DomainObjectListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, mergeManager: MergeManager, domainObject: ghidra.framework.model.DomainObject) -> None:
        """
    ...
    @typing.overload
    def openDomainObject(self, domainObject: ghidra.framework.model.DomainObject, current: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def openDomainObject(self, domainObject: ghidra.framework.model.DomainObject, state: typing.Union[jpype.JInt, int]) -> None:
        ...

    def releaseDomainObject(self, domainObject: ghidra.framework.model.DomainObject, persistentOwner: java.lang.Object) -> None:
        ...
    ...
    def setSearchPriority(self, domainObject: ghidra.framework.model.DomainObject, priority: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class MergeManagerProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, plugin: MergeManagerPlugin, title: typing.Union[java.lang.String, str]) -> None:
        ...

    def setCurrentProgress(self, currentPercentProgress: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def updateProgressDetails(self, message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def updateProgressTitle(self, newTitle: typing.Union[java.lang.String, str]) -> None:
        """
...
class PhaseProgressPanel(javax.swing.JPanel):
    ...
    def setProgress(self, progressPercentage: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setTitle(self, newTitle: typing.Union[java.lang.String, str]) -> None:
        """
...
class MergeProgressPanel(javax.swing.JPanel):
    ...
    def setCompleted(self, phase: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    def setInProgress(self, phase: jpype.JArray[java.lang.String]) -> None:
        """
        Indicates a particular phase or sub-phase whose status icon is to be changed to 
...
class DataTypeArchiveMergeManagerPlugin(MergeManagerPlugin):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, mergeManager: DataTypeArchiveMergeManager, dataTypeArchive: ghidra.program.model.listing.DataTypeArchive) -> None:
        """
...
class ProgramMergeManagerPlugin(MergeManagerPlugin, ghidra.app.services.ProgramManager):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, mergeManager: ProgramMultiUserMergeManager, program: ghidra.program.model.listing.Program) -> None:
        """
        Constructor for plugin that handles multi-user merge of programs.
    ...
    def setSearchPriority(self, p: ghidra.program.model.listing.Program, priority: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class MergeProgressModifier(java.lang.Object):
    ...
    @typing.overload
    def updateProgress(self, progressMessage: typing.Union[java.lang.String, str]) -> None:
        """
        Updates the current phase progress area in the default merge panel.
...
__all__ = ["DataTypeArchiveMergeManager", "MergeManager", "MergeManagerPlugin", "MergeManagerProvider", "PhaseProgressPanel", "MergeResolver", "MergeProgressPanel", "DataTypeArchiveMergeManagerPlugin", "MergeConstants", "ProgramMergeManagerPlugin", "ProgramMultiUserMergeManager", "MergeNavigatable", "ProgramSpecificAddressTranslator", "DataTypeManagerOwner", "MergeProgressModifier"]
