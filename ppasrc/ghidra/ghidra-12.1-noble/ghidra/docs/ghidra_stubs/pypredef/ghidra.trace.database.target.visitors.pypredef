...
class OrderedSuccessorsVisitor(TreeTraversal.SpanIntersectingVisitor):
    ...
    def __init__(self, path: ghidra.trace.model.target.path.KeyPath, forward: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["TreeTraversal", "AllPathsVisitor", "AncestorsRelativeVisitor", "AncestorsRootVisitor", "CanonicalSuccessorsRelativeVisitor", "OrderedSuccessorsVisitor", "SuccessorsRelativeVisitor"]
