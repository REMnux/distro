...
class MultiSelectionBlendedLayoutBackgroundColorManager(docking.widgets.fieldpanel.internal.LayoutBackgroundColorManager):
    ...
    class ColoredFieldSelection(java.lang.Object):
        ...
        def __init__(self, selection: docking.widgets.fieldpanel.support.FieldSelection, color: java.awt.Color) -> None:
            ...
    ...
    class MultiSelectionBlendedFieldBackgroundColorManager(docking.widgets.fieldpanel.internal.FieldBackgroundColorManager):
        ...
        def __init__(self, index: java.math.BigInteger, fieldNum: typing.Union[jpype.JInt, int], layoutSelection: MultiSelectionBlendedLayoutBackgroundColorManager, selections: java.util.List[MultiSelectionBlendedLayoutBackgroundColorManager.ColoredFieldSelection], backgroundColor: java.awt.Color) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, index: java.math.BigInteger, selections: java.util.List[MultiSelectionBlendedLayoutBackgroundColorManager.ColoredFieldSelection], backgroundColor: java.awt.Color, leftBorderColor: java.awt.Color, rightBorderColor: java.awt.Color) -> None:
        ...
...
class SelectionGenerator(java.lang.Object):
    ...
    def addSelections(self, layoutIndex: java.math.BigInteger, translator: SelectionTranslator, selections: java.util.List[MultiSelectionBlendedLayoutBackgroundColorManager.ColoredFieldSelection]) -> None:
        ...
...
__all__ = ["MultiSelectionBlendedLayoutBackgroundColorManager", "SelectionGenerator", "SelectionTranslator", "DebuggerTrackedRegisterBackgroundColorModel"]
