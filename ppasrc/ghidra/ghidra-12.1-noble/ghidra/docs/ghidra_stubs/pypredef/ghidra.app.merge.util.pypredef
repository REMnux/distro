...
class ConflictCountPanel(javax.swing.JPanel):
    ...
    def updateCount(self, currentCount: typing.Union[jpype.JInt, int], totalCount: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ConflictUtility(java.lang.Object):
    ...
    @staticmethod
    def addCount(buf: java.lang.StringBuffer, value: typing.Union[jpype.JInt, int]) -> None:
        """
...
__all__ = ["ConflictCountPanel", "ConflictUtility", "MergeUtilities"]
