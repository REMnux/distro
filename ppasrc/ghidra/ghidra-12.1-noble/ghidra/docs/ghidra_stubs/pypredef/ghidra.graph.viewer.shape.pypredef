...
class GraphLoopShape(java.lang.Object):
    ...
    def __init__(self, shape: java.awt.Shape, radius: typing.Union[jpype.JFloat, float]) -> None:
        ...
...
class ArticulatedEdgeTransformer(com.google.common.base.Function[E, java.awt.Shape], typing.Generic[V, E]):
    ...
    def setRenderContext(self, context: edu.uci.ics.jung.visualization.RenderContext[V, E]) -> None:
        ...
...
class VisualGraphShapePickSupport(edu.uci.ics.jung.visualization.picking.ShapePickSupport[V, E], typing.Generic[V, E]):
    ...
    def __init__(self, viewer: edu.uci.ics.jung.visualization.VisualizationServer[V, E]) -> None:
        ...
