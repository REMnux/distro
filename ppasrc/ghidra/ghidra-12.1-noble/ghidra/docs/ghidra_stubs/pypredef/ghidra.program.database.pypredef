...
class ProgramBuilder(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], languageName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], languageName: typing.Union[java.lang.String, str], consumer: java.lang.Object) -> None:
        """
        Construct program builder using specified language and default compiler spec
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], languageName: typing.Union[java.lang.String, str], compilerSpecID: typing.Union[java.lang.String, str], consumer: java.lang.Object) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], language: ghidra.program.model.lang.Language) -> None:
        """
    ...
    @typing.overload
    def applyDataType(self, addressString: typing.Union[java.lang.String, str], dt: ghidra.program.model.data.DataType) -> None:
        ...

    @typing.overload
    def applyDataType(self, addressString: typing.Union[java.lang.String, str], dt: ghidra.program.model.data.DataType, n: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def applyFixedLengthDataType(self, addressString: typing.Union[java.lang.String, str], dt: ghidra.program.model.data.DataType, length: typing.Union[jpype.JInt, int]) -> None:
        ...

    def applyStringDataType(self, addressString: typing.Union[java.lang.String, str], dt: ghidra.program.model.data.AbstractStringDataType, n: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def bindExternalLibrary(self, libraryName: typing.Union[java.lang.String, str], pathname: typing.Union[java.lang.String, str]) -> None:
        ...

    def clearCodeUnits(self, startAddressString: typing.Union[java.lang.String, str], endAddressString: typing.Union[java.lang.String, str], clearContext: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    @typing.overload
    def createComment(self, address: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str], commentType: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def createComment(self, address: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str], commentType: ghidra.program.model.listing.CommentType) -> None:
        ...
    ...
    def createEncodedString(self, address: typing.Union[java.lang.String, str], string: typing.Union[java.lang.String, str], encoding: java.nio.charset.Charset, nullTerminate: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def createExternalLibraries(self, *libraryNames: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def createExternalReference(self, fromAddress: typing.Union[java.lang.String, str], libraryName: typing.Union[java.lang.String, str], externalLabel: typing.Union[java.lang.String, str], opIndex: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def createExternalReference(self, fromAddress: typing.Union[java.lang.String, str], libraryName: typing.Union[java.lang.String, str], externalLabel: typing.Union[java.lang.String, str], extAddress: typing.Union[java.lang.String, str], opIndex: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def createExternalReference(self, fromAddress: typing.Union[java.lang.String, str], libraryName: typing.Union[java.lang.String, str], externalLabel: typing.Union[java.lang.String, str], extAddress: typing.Union[java.lang.String, str], opIndex: typing.Union[jpype.JInt, int], refType: ghidra.program.model.symbol.RefType, sourceType: ghidra.program.model.symbol.SourceType) -> None:
        ...

    def createFileBytes(self, size: typing.Union[jpype.JInt, int]) -> ghidra.program.database.mem.FileBytes:
        ...

    def createFragment(self, treeName: typing.Union[java.lang.String, str], modulePath: typing.Union[java.lang.String, str], fragmentName: typing.Union[java.lang.String, str], startAddr: typing.Union[java.lang.String, str], endAddr: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def createFunctionComment(self, entryPointAddress: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def createLocalVariable(self, function: ghidra.program.model.listing.Function, name: typing.Union[java.lang.String, str], dt: ghidra.program.model.data.DataType, stackOffset: typing.Union[jpype.JInt, int]) -> None:
        ...

    def createMappedMemory(self, name: typing.Union[java.lang.String, str], address: typing.Union[java.lang.String, str], size: typing.Union[jpype.JInt, int], mappedAddress: typing.Union[java.lang.String, str]) -> ghidra.program.model.mem.MemoryBlock:
        ...
    ...
    def createProgramTree(self, treeName: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    @typing.overload
    def createString(self, address: typing.Union[java.lang.String, str], string: typing.Union[java.lang.String, str]) -> ghidra.program.model.listing.Data:
        """
        Creates a non-null-terminated ascii string at the given address
        
        :param java.lang.String or str address: the address
        :param java.lang.String or str string: the string
        :return: the new data
        :rtype: ghidra.program.model.listing.Data
        :raises java.lang.Exception: if there is an exception
        """
    ...
    def deleteFunction(self, address: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    @typing.overload
    def disassemble(self, addressString: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def disassemble(self, addressString: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int], followFlows: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    @typing.overload
    def disassemble(self, set: ghidra.program.model.address.AddressSetView, followFlows: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def disassembleArm(self, addressString: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int], thumb: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    @staticmethod
    def disposeAllBuilders() -> None:
        """
        A methods called by :obj:`TestEnv` to cleanup all resources.
        """
    ...
    def putAddress(self, address: typing.Union[java.lang.String, str], pointerAddress: typing.Union[java.lang.String, str]) -> None:
        ...

    def setAnalysisEnabled(self, name: typing.Union[java.lang.String, str], enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    @typing.overload
    def setBytes(self, address: typing.Union[java.lang.String, str], byteString: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setBytes(self, address: typing.Union[java.lang.String, str], byteString: typing.Union[java.lang.String, str], disassemble: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Sets the bytes starting at ``address`` to the values encoded in ``byteString``
    ...
    @typing.overload
    def setBytes(self, stringAddress: typing.Union[java.lang.String, str], bytes: jpype.JArray[jpype.JByte]) -> None:
        ...

    @typing.overload
    def setBytes(self, stringAddress: typing.Union[java.lang.String, str], bytes: jpype.JArray[jpype.JByte], disassemble: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setChanged(self, changed: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setExecute(self, block: ghidra.program.model.mem.MemoryBlock, e: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setFallthrough(self, from_: typing.Union[java.lang.String, str], to: typing.Union[java.lang.String, str]) -> None:
        ...

    def setInt(self, address: typing.Union[java.lang.String, str], value: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setIntProperty(self, address: typing.Union[java.lang.String, str], propertyName: typing.Union[java.lang.String, str], value: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setLong(self, address: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setName(self, name: typing.Union[java.lang.String, str]) -> None:
        ...

    def setObjectProperty(self, address: typing.Union[java.lang.String, str], propertyName: typing.Union[java.lang.String, str], value: ghidra.util.Saveable) -> None:
        ...

    def setProperty(self, name: typing.Union[java.lang.String, str], value: java.lang.Object) -> None:
        ...

    def setRead(self, block: ghidra.program.model.mem.MemoryBlock, r: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setRecordChanges(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setRegisterValue(self, registerName: typing.Union[java.lang.String, str], startAddress: typing.Union[java.lang.String, str], endAddress: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setShort(self, address: typing.Union[java.lang.String, str], value: typing.Union[jpype.JShort, int]) -> None:
        ...

    def setString(self, address: typing.Union[java.lang.String, str], string: typing.Union[java.lang.String, str]) -> None:
        ...

    def setStringProperty(self, address: typing.Union[java.lang.String, str], propertyName: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        ...

    def setWrite(self, block: ghidra.program.model.mem.MemoryBlock, w: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def tx(self, c: utility.function.ExceptionalCallback[E]) -> None:
        ...
...
class ProgramDB(ghidra.framework.data.DomainObjectAdapterDB, ghidra.program.model.listing.Program, ghidra.program.util.ChangeManager):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], language: ghidra.program.model.lang.Language, compilerSpec: ghidra.program.model.lang.CompilerSpec, consumer: java.lang.Object) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dbh: db.DBHandle, openMode: ghidra.framework.data.OpenMode, monitor: ghidra.util.task.TaskMonitor, consumer: java.lang.Object) -> None:
        """
        Constructs a new ProgramDB
    ...
    def categoryAdded(self, categoryID: typing.Union[jpype.JLong, int], eventType: ghidra.program.util.ProgramEvent, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    def categoryChanged(self, categoryID: typing.Union[jpype.JLong, int], eventType: ghidra.program.util.ProgramEvent, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    def dataTypeAdded(self, dataTypeID: typing.Union[jpype.JLong, int], eventType: ghidra.program.util.ProgramEvent, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    def dataTypeChanged(self, dataTypeID: typing.Union[jpype.JLong, int], eventType: ghidra.program.util.ProgramEvent, isAutoChange: typing.Union[jpype.JBoolean, bool], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    def programTreeAdded(self, id: typing.Union[jpype.JLong, int], eventType: ghidra.program.util.ProgramEvent, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    def programTreeChanged(self, id: typing.Union[jpype.JLong, int], eventType: ghidra.program.util.ProgramEvent, affectedObj: java.lang.Object, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    def symbolAdded(self, symbol: ghidra.program.model.symbol.Symbol, eventType: ghidra.program.util.ProgramEvent, addr: ghidra.program.model.address.Address, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    def symbolChanged(self, symbol: ghidra.program.model.symbol.Symbol, eventType: ghidra.program.util.ProgramEvent, addr: ghidra.program.model.address.Address, affectedObj: java.lang.Object, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    def tagChanged(self, tag: ghidra.program.model.listing.FunctionTag, eventType: ghidra.program.util.ProgramEvent, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
...
class ManagerDB(java.lang.Object):
    ...
    def programReady(self, openMode: ghidra.framework.data.OpenMode, currentRevision: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def setProgram(self, program: ProgramDB) -> None:
        """
...
class ProgramOverlayAddressSpace(ghidra.program.model.address.OverlayAddressSpace):
    ...
    def __init__(self, key: typing.Union[jpype.JLong, int], overlayName: typing.Union[java.lang.String, str], baseSpace: ghidra.program.model.address.AddressSpace, unique: typing.Union[jpype.JInt, int], overlayRegionSupplier: OverlayRegionSupplier, factory: ProgramAddressFactory) -> None:
        """
...
class ProgramAddressFactory(ghidra.program.model.address.DefaultAddressFactory):
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, compilerSpec: ghidra.program.model.lang.CompilerSpec, overlayRegionSupplier: OverlayRegionSupplier) -> None:
        """
    ...
    def checkValidOverlaySpaceName(self, name: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ProgramUserDataDB(ghidra.framework.data.DomainObjectAdapterDB, ghidra.program.model.listing.ProgramUserData):
    ...
    @typing.overload
    def __init__(self, program: ProgramDB) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dbh: db.DBHandle, program: ProgramDB, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class DBStringMapAdapter(java.lang.Object):
    ...
    def __init__(self, dbHandle: db.DBHandle, tableName: typing.Union[java.lang.String, str], create: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def delete(self, key: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def put(self, key: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        ...
...
class IntRangeMap(java.lang.Object):
    ...
    @typing.overload
    def setValue(self, addresses: ghidra.program.model.address.AddressSetView, value: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def setValue(self, start: ghidra.program.model.address.Address, end: ghidra.program.model.address.Address, value: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class ProgramDBChangeSet(ghidra.program.model.listing.ProgramChangeSet, ghidra.framework.data.DomainObjectDBChangeSet):
    ...
    def __init__(self, addrMap: ghidra.program.database.map.AddressMap, numUndos: typing.Union[jpype.JInt, int]) -> None:
        """
...
class DBObjectCache(java.lang.Object, typing.Generic[T]):
    ...
    @typing.overload
    def delete(self, keyRanges: java.util.List[ghidra.program.model.address.KeyRange]) -> None:
        """
    ...
    @typing.overload
    def delete(self, key: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def keyChanged(self, oldKey: typing.Union[jpype.JLong, int], newKey: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class ProgramLinkContentHandler(ghidra.framework.data.LinkHandler[ProgramDB]):
    ...
    class_: typing.ClassVar[java.lang.Class]
    INSTANCE: typing.ClassVar[ProgramLinkContentHandler]
...
class SpecExtension(java.lang.Object):
    ...
    * ``<resolveprototype>`` - describing a Prototype Model merged from other models
    ...
    class DocInfo(java.lang.Object):
        ...
        def __init__(self, document: typing.Union[java.lang.String, str]) -> None:
            """
    ...
    def addReplaceCompilerSpecExtension(self, document: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def getCompilerSpecExtension(program: ghidra.program.model.listing.Program, docInfo: SpecExtension.DocInfo) -> str:
        """
        Get the raw string making up an extension, given its :obj:`DocInfo`
        
        :param ghidra.program.model.listing.Program program: is the program to extract the extension from
        :param SpecExtension.DocInfo docInfo: is extension's :obj:`DocInfo`
        :return: the extension string or null
        :rtype: str
        """
    ...
    def removeCompilerSpecExtension(self, optionName: typing.Union[java.lang.String, str], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class DataTypeArchiveDB(ghidra.framework.data.DomainObjectAdapterDB, ghidra.program.model.listing.DataTypeArchive):
    ...
    @typing.overload
    def __init__(self, folder: ghidra.framework.model.DomainFolder, name: typing.Union[java.lang.String, str], consumer: java.lang.Object) -> None:
        """
    ...
    def dataTypeChanged(self, dataTypeID: typing.Union[jpype.JLong, int], eventType: ghidra.program.util.ProgramEvent, isAutoResponseChange: typing.Union[jpype.JBoolean, bool], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
    ...
    def setChanged(self, eventType: ghidra.program.util.ProgramEvent, oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
...
class DataTypeArchiveLinkContentHandler(ghidra.framework.data.LinkHandler[DataTypeArchiveDB]):
    ...
    class_: typing.ClassVar[java.lang.Class]
    INSTANCE: typing.ClassVar[DataTypeArchiveLinkContentHandler]
...
class DataTypeArchiveDBChangeSet(ghidra.program.model.listing.DataTypeArchiveChangeSet, ghidra.framework.data.DomainObjectDBChangeSet):
    ...
    def __init__(self, numUndos: typing.Union[jpype.JInt, int]) -> None:
        """
...
__all__ = ["GhidraDataTypeArchiveMergeManagerFactory", "GhidraProgramMultiUserMergeManagerFactory", "ProgramBuilder", "ProgramDB", "ManagerDB", "ProgramOverlayAddressSpace", "OverlayRegionSupplier", "ProgramAddressFactory", "ListingDB", "ProgramUserDataDB", "DBStringMapAdapter", "OverlaySpaceDBAdapter", "IntRangeMapDB", "IntRangeMap", "ProgramDBChangeSet", "ChangeDiff", "DBObjectCache", "DatabaseObject", "ProgramContentHandler", "ProgramLinkContentHandler", "SpecExtension", "DataTypeArchiveContentHandler", "DataTypeArchiveDB", "DataTypeArchiveLinkContentHandler", "DataTypeArchiveDBChangeSet", "MyChangeDiff", "ProjectDataTypeManager", "DataTypeArchiveMergeManagerFactory", "ObsoleteProgramPropertiesService", "OverlaySpaceDBAdapterV0", "OverlaySpaceDBAdapterV1", "ProgramCompilerSpec", "ProgramMultiUserMergeManagerFactory"]
