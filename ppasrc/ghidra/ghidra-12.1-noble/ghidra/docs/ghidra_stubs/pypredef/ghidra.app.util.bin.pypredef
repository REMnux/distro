...
class StructConverter(java.lang.Object):
    ...
    BOOL: typing.Final[ghidra.program.model.data.DataType]
    """
    ...
    @staticmethod
    def setEndian(data: ghidra.program.model.listing.Data, bigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class BinaryReader(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, provider: ByteProvider, isLittleEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, provider: ByteProvider, converter: ghidra.util.DataConverter, initialIndex: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def readNextString(self, charset: java.nio.charset.Charset, charLen: typing.Union[jpype.JInt, int]) -> str:
        """
        Reads a null terminated string starting at the current index, 
        using a specific :obj:`Charset`, advancing the current index by the length of 
        the string that was found.
        
        :param java.nio.charset.Charset charset: :obj:`Charset`, see :obj:`StandardCharsets`
        :param jpype.JInt or int charLen: number of bytes in each character
        :return: the string
        :rtype: str
        :raises IOException: if an I/O error occurs
        """
    ...
    @typing.overload
    def readNextString(self, charCount: typing.Union[jpype.JInt, int], charset: java.nio.charset.Charset, charLen: typing.Union[jpype.JInt, int]) -> str:
        """
        Reads a fixed length string of ``charCount`` characters
        starting at the current index, using a specific :obj:`Charset`,
        advancing the current index by the length of the string that was found.
        ...
        :param jpype.JInt or int charCount: the number of charLen character elements to read
        :param java.nio.charset.Charset charset: :obj:`Charset`, see :obj:`StandardCharsets`
        :param jpype.JInt or int charLen: number of bytes in each character
        :return: the string
        :rtype: str
    ...
    @typing.overload
    def readString(self, index: typing.Union[jpype.JLong, int], charCount: typing.Union[jpype.JInt, int], charset: java.nio.charset.Charset, charLen: typing.Union[jpype.JInt, int]) -> str:
        """
        Reads a fixed length string of ``charCount`` characters
        starting at ``index``, using a specific :obj:`Charset`.
         
        
        Trailing null terminator characters will be removed.  (suitable for reading
        a string from a fixed length field that is padded with trailing null chars)
        
        :param jpype.JLong or int index: the index where the string begins
        :param jpype.JInt or int charCount: the number of charLen character elements to read
        :param java.nio.charset.Charset charset: :obj:`Charset`, see :obj:`StandardCharsets`
        :param jpype.JInt or int charLen: number of bytes in each character
        :return: the string
    ...
    @typing.overload
    def readString(self, index: typing.Union[jpype.JLong, int], charset: java.nio.charset.Charset, charLen: typing.Union[jpype.JInt, int]) -> str:
        """
        Reads a null-terminated string starting at ``index``, using a specific
        :obj:`Charset`.
    ...
    def setLittleEndian(self, isLittleEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ByteArrayProvider(ByteProvider):
    ...
    @typing.overload
    def __init__(self, bytes: jpype.JArray[jpype.JByte], fsrl: ghidra.formats.gfilesystem.FSRL) -> None:
        """
        Constructs a :obj:`ByteArrayProvider` using the specified byte array
...
class ByteProviderInputStream(java.io.InputStream):
    ...
    class ClosingInputStream(ByteProviderInputStream):
        ...
        def __init__(self, provider: ByteProvider) -> None:
            """
    ...
    @typing.overload
    def __init__(self, provider: ByteProvider, startPosition: typing.Union[jpype.JLong, int]) -> None:
        """
        Creates an InputStream that uses a ByteProvider as its source of bytes.
...
class ByteProviderPaddedInputStream(java.io.InputStream):
    ...
    def __init__(self, provider: ByteProvider, startOffset: typing.Union[jpype.JLong, int], length: typing.Union[jpype.JLong, int], padCount: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ByteProviderWrapper(ByteProvider):
    ...
    @typing.overload
    def __init__(self, provider: ByteProvider, fsrl: ghidra.formats.gfilesystem.FSRL) -> None:
        """
    ...
    @typing.overload
    def __init__(self, provider: ByteProvider, subOffset: typing.Union[jpype.JLong, int], subLength: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, provider: ByteProvider, subOffset: typing.Union[jpype.JLong, int], subLength: typing.Union[jpype.JLong, int], fsrl: ghidra.formats.gfilesystem.FSRL) -> None:
        """
        Constructs a :obj:`ByteProviderWrapper` around the specified :obj:`ByteProvider`,
        constrained to a subsection of the provider.
...
class EmptyByteProvider(ByteProvider):
    ...
    @typing.overload
    def __init__(self, fsrl: ghidra.formats.gfilesystem.FSRL) -> None:
        """
...
class FaultTolerantInputStream(java.io.InputStream):
    ...
    def __init__(self, delegate: java.io.InputStream, length: typing.Union[jpype.JLong, int], errorConsumer: java.util.function.BiConsumer[java.lang.String, java.lang.Throwable]) -> None:
        """
        Creates instance.
...
class FileByteProvider(MutableByteProvider):
    ...
    def __init__(self, file: jpype.protocol.SupportsPath, fsrl: ghidra.formats.gfilesystem.FSRL, accessMode: java.nio.file.AccessMode) -> None:
        """
    ...
    def writeBytes(self, index: typing.Union[jpype.JLong, int], buffer: jpype.JArray[jpype.JByte], offset: typing.Union[jpype.JInt, int], length: typing.Union[jpype.JInt, int]) -> None:
        """
...
class MutableByteProvider(ByteProvider):
    ...
    def writeByte(self, index: typing.Union[jpype.JLong, int], value: typing.Union[jpype.JByte, int]) -> None:
        """
    ...
    def writeBytes(self, index: typing.Union[jpype.JLong, int], values: jpype.JArray[jpype.JByte]) -> None:
        """
...
class FileBytesProvider(ByteProvider):
    ...
    def __init__(self, fileBytes: ghidra.program.database.mem.FileBytes) -> None:
        """
...
class GhidraRandomAccessFile(java.lang.AutoCloseable):
    ...
    def __init__(self, file: jpype.protocol.SupportsPath, mode: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def write(self, b: typing.Union[jpype.JByte, int]) -> None:
        """
    ...
    @typing.overload
    def write(self, b: jpype.JArray[jpype.JByte], offset: typing.Union[jpype.JInt, int], length: typing.Union[jpype.JInt, int]) -> None:
        """
...
class InputStreamByteProvider(ByteProvider):
    ...
    def __init__(self, inputStream: java.io.InputStream, length: typing.Union[jpype.JLong, int]) -> None:
        """
...
class MemBufferByteProvider(ByteProvider):
    ...
    def __init__(self, buffer: ghidra.program.model.mem.MemBuffer) -> None:
        """
        Constructor
...
class MemoryByteProvider(ByteProvider):
    ...
    * To avoid this situation, the caller will need to use information from the program's Memory
    ...
    @typing.overload
    def __init__(self, memory: ghidra.program.model.mem.Memory, space: ghidra.program.model.address.AddressSpace) -> None:
        """
    ...
    @typing.overload
    def __init__(self, memory: ghidra.program.model.mem.Memory, baseAddress: ghidra.program.model.address.Address) -> None:
        """
    ...
    @typing.overload
    def __init__(self, memory: ghidra.program.model.mem.Memory, baseAddress: ghidra.program.model.address.Address, firstBlockOnly: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Constructs a new :obj:`MemoryByteProvider` relative to the specified base address,
    ...
    @typing.overload
    def __init__(self, memory: ghidra.program.model.mem.Memory, baseAddress: ghidra.program.model.address.Address, maxAddress: ghidra.program.model.address.Address) -> None:
        """
...
class ObfuscatedInputStream(java.io.InputStream):
    ...
    def __init__(self, delegate: java.io.InputStream) -> None:
        """
        Creates instance.
...
class ObfuscatedOutputStream(java.io.OutputStream):
    ...
    def __init__(self, delegate: java.io.OutputStream) -> None:
        """
        Creates instance.
...
class RandomAccessByteProvider(ByteProvider):
    ...
    @typing.overload
    def __init__(self, file: jpype.protocol.SupportsPath, fsrl: ghidra.formats.gfilesystem.FSRL) -> None:
        """
    ...
    @typing.overload
    def __init__(self, file: jpype.protocol.SupportsPath, permissions: typing.Union[java.lang.String, str]) -> None:
        """
...
class RangeMappedByteProvider(ByteProvider):
    ...
    def addRange(self, offset: typing.Union[jpype.JLong, int], rangeLen: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def addSparseRange(self, rangeLen: typing.Union[jpype.JLong, int]) -> None:
        """
...
__all__ = ["StructConverter", "BinaryReader", "ByteProvider", "InvalidDataException", "ByteArrayConverter", "LEB128Info", "ByteArrayProvider", "ByteProviderInputStream", "ByteProviderPaddedInputStream", "ByteProviderWrapper", "EmptyByteProvider", "FaultTolerantInputStream", "FileByteProvider", "MutableByteProvider", "FileBytesProvider", "GhidraRandomAccessFile", "InputStreamByteProvider", "MemBufferByteProvider", "MemoryByteProvider", "MemoryMutableByteProvider", "ObfuscatedFileByteProvider", "ObfuscatedInputStream", "ObfuscatedOutputStream", "RandomAccessByteProvider", "RandomAccessMutableByteProvider", "RangeMappedByteProvider", "StructConverterUtil", "SynchronizedByteProvider", "UnlimitedByteProviderWrapper"]
