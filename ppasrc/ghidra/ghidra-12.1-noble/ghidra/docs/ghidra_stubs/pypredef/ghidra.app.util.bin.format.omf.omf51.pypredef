...
class Omf51Content(ghidra.app.util.bin.format.omf.OmfRecord):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, largeSegmentId: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class Omf51ExternalDefsRecord(ghidra.app.util.bin.format.omf.OmfRecord):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, largeExtId: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class Omf51Fixup(java.lang.Object):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, largeBlockId: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class Omf51Library(java.lang.Object):
    ...
    class MemberHeader(java.lang.Record):
        ...
        def __init__(self, offset: typing.Union[jpype.JLong, int], size: typing.Union[jpype.JLong, int], name: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    def __init__(self, factory: Omf51RecordFactory) -> None:
        """
...
__all__ = ["Omf51Content", "Omf51ExternalDef", "Omf51ExternalDefsRecord", "Omf51Fixup", "Omf51FixupRecord", "Omf51Library", "Omf51RecordTypes", "Omf51RecordFactory", "Omf51LibraryDictionaryRecord", "Omf51LibraryHeaderRecord", "Omf51LibraryModuleLocation", "Omf51LibraryModuleLocationsRecord", "Omf51LibraryModuleNamesRecord", "Omf51ModuleEnd", "Omf51ModuleHeader", "Omf51PublicDef", "Omf51PublicDefsRecord", "Omf51Segment", "Omf51SegmentDefs"]
