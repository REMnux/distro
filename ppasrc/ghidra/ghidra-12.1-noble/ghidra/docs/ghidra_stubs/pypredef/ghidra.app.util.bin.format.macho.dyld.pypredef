...
class DyldCacheHeader(ghidra.app.util.bin.StructConverter):
    ...
    def markup(self, program: ghidra.program.model.listing.Program, markupLocalSymbols: typing.Union[jpype.JBoolean, bool], space: ghidra.program.model.address.AddressSpace, monitor: ghidra.util.task.TaskMonitor, log: ghidra.app.util.importer.MessageLog) -> None:
        """
    ...
    def parseFromFile(self, parseLocalSymbols: typing.Union[jpype.JBoolean, bool], log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def parseLocalSymbolsInfo(self, shouldParse: typing.Union[jpype.JBoolean, bool], log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class DyldCacheLocalSymbolsInfo(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, architecture: DyldArchitecture, use64bitOffsets: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DyldCacheLocalSymbolsEntry(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, use64bitOffsets: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class DyldCacheSlideInfoCommon(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, mappingInfo: DyldCacheMappingInfo) -> None:
        """
    ...
    def fixupSlidePointers(self, program: ghidra.program.model.listing.Program, markup: typing.Union[jpype.JBoolean, bool], addRelocations: typing.Union[jpype.JBoolean, bool], log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class DyldFixup(java.lang.Record):
    ...
    def __init__(self, offset: typing.Union[jpype.JLong, int], value: typing.Union[java.lang.Long, int], size: typing.Union[jpype.JInt, int], symbol: typing.Union[java.lang.String, str], libOrdinal: typing.Union[java.lang.Integer, int]) -> None:
        ...
...
class LibObjcOptimization(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, objcOptRoSectionAddr: ghidra.program.model.address.Address) -> None:
        """
...
class LibObjcDylib(java.lang.Object):
    ...
    def __init__(self, libObjcHeader: ghidra.app.util.bin.format.macho.MachHeader, program: ghidra.program.model.listing.Program, space: ghidra.program.model.address.AddressSpace, log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
__all__ = ["DyldCacheHeader", "DyldCacheLocalSymbolsInfo", "DyldCacheImage", "DyldCacheLocalSymbolsEntry", "DyldArchitecture", "DyldCacheMappingInfo", "DyldCacheImageInfo", "DyldCacheSlideInfoCommon", "DyldCacheAccelerateInfo", "DyldCacheImageTextInfo", "DyldSubcacheEntry", "DyldCacheMappingAndSlideInfo", "DyldCacheImageInfoExtra", "DyldCacheAcceleratorInitializer", "DyldCacheAcceleratorDof", "DyldCacheRangeEntry", "DyldFixup", "LibObjcOptimization", "DyldChainedPtr", "DyldCacheSlideInfo1", "DyldCacheSlideInfo2", "DyldCacheSlideInfo3", "DyldCacheSlideInfo4", "DyldCacheSlideInfo5", "DyldChainedStartsOffsets", "LibObjcDylib"]
