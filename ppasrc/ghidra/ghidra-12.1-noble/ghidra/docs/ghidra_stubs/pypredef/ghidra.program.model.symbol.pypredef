...
class Namespace(java.lang.Object):
    ...
    class Type(java.lang.Enum[Namespace.Type]):
        """
        Type of :obj:`Namespace`.
        """

        class_: typing.ClassVar[java.lang.Class]
        NAMESPACE: typing.Final[Namespace.Type]
        LIBRARY: typing.Final[Namespace.Type]
        CLASS: typing.Final[Namespace.Type]
        FUNCTION: typing.Final[Namespace.Type]
        ...
        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> Namespace.Type:
            ...

        @staticmethod
        def values() -> jpype.JArray[Namespace.Type]:
            ...
    ...
    def getName(self) -> str:
        ...
        See :meth:`getName(boolean) <.getName>` for the namespace-qualified variant.
        """
    ...
    def getName(self, includeNamespacePath: typing.Union[jpype.JBoolean, bool]) -> str:
        ...
        :param jpype.JBoolean or bool includeNamespacePath: true to include the namespace path
        (using :obj:`.DELIMITER` as separator) in the returned name
        :return: the simple name if ``includeNamespacePath`` is false, or the full
        namespace-qualified name (e.g., ``"ClassA::InnerClass"``) if true
        :rtype: str
        """
    ...
    def setParentNamespace(self, parentNamespace: Namespace) -> None:
        """
...
class ExternalManager(java.lang.Object):
    ...
    @typing.overload
    def getExternalLocations(self, libraryName: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str]) -> java.util.Set[ExternalLocation]:
        """
        ...
        :rtype: java.util.Set[ExternalLocation]
        """

    @typing.overload
    def getExternalLocations(self, namespace: Namespace, label: typing.Union[java.lang.String, str]) -> java.util.Set[ExternalLocation]:
        """
        ...
        :param Namespace namespace: the external Namespace to search or null
    ...
    def getUniqueExternalLocation(self, libraryName: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str]) -> ExternalLocation:
        ...
        :param java.lang.String or str libraryName: the library name or null
    ...
    def getUniqueExternalLocation(self, namespace: Namespace, label: typing.Union[java.lang.String, str]) -> ExternalLocation:
        ...
        :param Namespace namespace: the namespace or null
        :param java.lang.String or str label: the label of the external location
        :return: the unique external location or null
        :rtype: ExternalLocation
        """
    ...
    def setExternalPath(self, libraryName: typing.Union[java.lang.String, str], pathname: typing.Union[java.lang.String, str], userDefined: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def updateExternalLibraryName(self, oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str], source: SourceType) -> None:
        """
        ...
        :param SourceType source: the source of this external library
        :raises DuplicateNameException: if name conflicts with another symbol.
        :raises InvalidInputException: if an invalid or null name specified (see 
        :obj:`SymbolUtilities.validateName`).
        """
...
class ReferenceManager(java.lang.Object):
    ...
    def addExternalReference(self, fromAddr: ghidra.program.model.address.Address, opIndex: typing.Union[jpype.JInt, int], location: ExternalLocation, source: SourceType, type: RefType) -> Reference:
        ...
        :rtype: Reference
        :raises InvalidInputException: if the input is invalid
        """
    ...
    def addMemoryReference(self, fromAddr: ghidra.program.model.address.Address, toAddr: ghidra.program.model.address.Address, type: RefType, source: SourceType, opIndex: typing.Union[jpype.JInt, int]) -> Reference:
        ...
        :param ghidra.program.model.address.Address fromAddr: address of the code unit where the reference occurs
    ...
    def getFlowReferencesFrom(self, addr: ghidra.program.model.address.Address) -> jpype.JArray[Reference]:
        ...
        :param ghidra.program.model.address.Address addr: the address of the code unit to get all flows from.
    ...
    def getReference(self, fromAddr: ghidra.program.model.address.Address, toAddr: ghidra.program.model.address.Address, opIndex: typing.Union[jpype.JInt, int]) -> Reference:
        ...
        :param ghidra.program.model.address.Address fromAddr: the address of the code unit making the reference.
    ...
    def hasReferencesFrom(self, fromAddr: ghidra.program.model.address.Address, opIndex: typing.Union[jpype.JInt, int]) -> bool:
        ...
        :param ghidra.program.model.address.Address fromAddr: the address of the code unit being tested
    ...
    def removeAllReferencesFrom(self, fromAddr: ghidra.program.model.address.Address) -> None:
        ...
        :param ghidra.program.model.address.Address fromAddr: the address of the code unit from which to remove all references.
        """
    ...
    def removeAssociation(self, ref: Reference) -> None:
        """
    ...
    def setAssociation(self, s: Symbol, ref: Reference) -> None:
        """
    ...
    def setPrimary(self, ref: Reference, isPrimary: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class Symbol(java.lang.Object):
    ...
    def getReferenceCount(self) -> int:
        ...
        NOTE: this method differ from :meth:`hasReferences() <.hasReferences>` behavior for memory symbols since this 
        method will return :meth:`ReferenceManager.getReferenceCountTo(Address) <ReferenceManager.getReferenceCountTo>` if this is the only 
    ...
    def hasReferences(self) -> bool:
        ...
        (see :meth:`Reference.getSymbolID() <Reference.getSymbolID>` which indicates a specific symbol reference).
        :rtype: bool
        """
    ...
    def setName(self, newName: typing.Union[java.lang.String, str], source: SourceType) -> None:
        """
    ...
    def setNameAndNamespace(self, newName: typing.Union[java.lang.String, str], newNamespace: Namespace, source: SourceType) -> None:
        """
    ...
    def setNamespace(self, newNamespace: Namespace) -> None:
        """
    ...
    def setPinned(self, pinned: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setSource(self, source: SourceType) -> None:
        """
...
class SourceType(java.lang.Enum[SourceType]):
    """
    :obj:`SourceType` provides a prioritized indication as to the general source of a specific
    markup made to a :obj:`Program`.  The priority of each defined source type may be used to 
    ...
    * DEFAULT
    ...
    @staticmethod
    def getSourceType(storageId: typing.Union[jpype.JInt, int]) -> SourceType:
        """
        Get the SourceType which corresponds to the specified storage ID.
        
        :param jpype.JInt or int storageId: storage ID
        :return: SourceType
        :rtype: SourceType
        :raises NoSuchElementException: if specified storage ID is not defined.
        """
    ...
    def isHigherOrEqualPriorityThan(self, source: SourceType) -> bool:
        """
    ...
    def isLowerOrEqualPriorityThan(self, source: SourceType) -> bool:
        """
    ...
    @property
    def higherOrEqualPriorityThan(self) -> jpype.JBoolean:
        ...
    ...
    @property
    def lowerOrEqualPriorityThan(self) -> jpype.JBoolean:
        ...

    @property
    def storageId(self) -> jpype.JInt:
        ...
...
class ExternalLocation(java.lang.Object):
    ...
    def setLocation(self, label: typing.Union[java.lang.String, str], addr: ghidra.program.model.address.Address, source: SourceType) -> None:
        """
    ...
    def setName(self, namespace: Namespace, name: typing.Union[java.lang.String, str], sourceType: SourceType) -> None:
        """
...
class Equate(java.lang.Object):
    ...
    @typing.overload
    def addReference(self, refAddr: ghidra.program.model.address.Address, opndPosition: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def addReference(self, dynamicHash: typing.Union[jpype.JLong, int], refAddr: ghidra.program.model.address.Address) -> None:
        """
    ...
    @typing.overload
    def removeReference(self, refAddr: ghidra.program.model.address.Address, opndPosition: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def removeReference(self, dynamicHash: typing.Union[jpype.JLong, int], refAddr: ghidra.program.model.address.Address) -> None:
        """
    ...
    def renameEquate(self, newName: typing.Union[java.lang.String, str]) -> None:
        """
...
class LabelHistory(java.lang.Object):
    ...
    def __init__(self, addr: ghidra.program.model.address.Address, userName: typing.Union[java.lang.String, str], actionID: typing.Union[jpype.JByte, int], labelStr: typing.Union[java.lang.String, str], modificationDate: java.util.Date) -> None:
        """
...
class AddressLabelPair(java.io.Serializable):
    ...
    def __init__(self, addr: ghidra.program.model.address.Address, label: typing.Union[java.lang.String, str]) -> None:
        """
...
class ExternalLocationAdapter(ExternalLocationIterator):
    ...
    def __init__(self, iterator: java.util.Iterator[ExternalLocation]) -> None:
        ...
...
class ExternalPath(java.lang.Object):
    ...
    def __init__(self, *strings: typing.Union[java.lang.String, str]) -> None:
        ...
...
class MemReferenceImpl(Reference):
    ...
    def __init__(self, fromAddr: ghidra.program.model.address.Address, toAddr: ghidra.program.model.address.Address, refType: RefType, sourceType: SourceType, opIndex: typing.Union[jpype.JInt, int], isPrimary: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class ReferenceIteratorAdapter(ReferenceIterator):
    ...
    def __init__(self, iterator: java.util.Iterator[Reference]) -> None:
        ...
...
class ReferenceListener(java.lang.Object):
    ...
    def externalReferenceAdded(self, ref: Reference) -> None:
        """
    ...
    def externalReferenceNameChanged(self, ref: Reference) -> None:
        """
    ...
    def externalReferenceRemoved(self, ref: Reference) -> None:
        """
    ...
    def memReferenceAdded(self, ref: Reference) -> None:
        """
    ...
    def memReferencePrimaryRemoved(self, ref: Reference) -> None:
        """
    ...
    def memReferencePrimarySet(self, ref: Reference) -> None:
        """
    ...
    def memReferenceRemoved(self, ref: Reference) -> None:
        """
    ...
    def memReferenceTypeChanged(self, newRef: Reference, oldRef: Reference) -> None:
        """
    ...
    def stackReferenceAdded(self, ref: Reference) -> None:
        """
    ...
    def stackReferenceRemoved(self, ref: Reference) -> None:
        """
...
class SymbolIteratorAdapter(SymbolIterator):
    ...
    def __init__(self, iterator: java.util.Iterator[Symbol]) -> None:
        ...
...
class SymbolTableListener(java.lang.Object):
    ...
    def associationAdded(self, symbol: SourceType, ref: Reference) -> None:
        """
    ...
    def associationRemoved(self, ref: Reference) -> None:
        """
    ...
    def primarySymbolSet(self, symbol: SourceType) -> None:
        """
    ...
    def symbolAdded(self, symbol: SourceType) -> None:
        """
    ...
    def symbolRemoved(self, addr: ghidra.program.model.address.Address, name: typing.Union[java.lang.String, str], isLocal: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def symbolRenamed(self, symbol: SourceType, oldName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def symbolScopeChanged(self, symbol: SourceType) -> None:
        """
...
class SymbolUtilities(java.lang.Object):
    ...
    @staticmethod
    def getDiffString(diff: typing.Union[jpype.JLong, int]) -> str:
        """
        ...
        :param jpype.JLong or int diff: the address difference
    ...
    @staticmethod
    def validateName(name: typing.Union[java.lang.String, str]) -> None:
        """
...
class ThunkReference(DynamicReference):
    ...
    def __init__(self, thunkAddr: ghidra.program.model.address.Address, thunkedAddr: ghidra.program.model.address.Address) -> None:
        """
...
__all__ = ["Namespace", "SymbolTable", "ExternalManager", "EquateTable", "ReferenceManager", "Symbol", "SymbolType", "Reference", "SourceType", "RefType", "FlowType", "ExternalLocation", "ReferenceIterator", "ExternalReference", "NameTransformer", "EquateReference", "Equate", "ExternalLocationIterator", "SymbolIterator", "LabelHistory", "StackReference", "OffsetReference", "ShiftedReference", "AddressLabelPair", "DataRefType", "DynamicReference", "EntryPointReference", "ExternalLocationAdapter", "ExternalPath", "IdentityNameTransformer", "IllegalCharCppTransformer", "MemReferenceImpl", "RefTypeFactory", "ReferenceIteratorAdapter", "ReferenceListener", "SymbolIteratorAdapter", "SymbolTableListener", "SymbolUtilities", "ThunkReference"]
