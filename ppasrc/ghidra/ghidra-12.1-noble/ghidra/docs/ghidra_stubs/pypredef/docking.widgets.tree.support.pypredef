...
class GTreeSelectionEvent(java.lang.Object):
    ...
    def __init__(self, event: javax.swing.event.TreeSelectionEvent, origin: GTreeSelectionEvent.EventOrigin) -> None:
        ...
...
class GTreeRenderer(javax.swing.tree.DefaultTreeCellRenderer, docking.widgets.GComponent):
    ...
    def setBackgroundNonSelectionColor(self, newColor: java.awt.Color) -> None:
        """
    ...
    def setBackgroundSelectionColor(self, newColor: java.awt.Color) -> None:
        """
    ...
    def setMinIconWidth(self, minIconWidth: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setRendererDropTarget(self, target: java.lang.Object) -> None:
        ...
...
class GTreeDragNDropHandler(GTreeTransferHandler):
    ...
    def drop(self, destUserData: docking.widgets.tree.GTreeNode, transferable: java.awt.datatransfer.Transferable, dropAction: typing.Union[jpype.JInt, int]) -> None:
        """
...
class GTreeSelectionListener(java.lang.Object):
    ...
    def valueChanged(self, e: GTreeSelectionEvent) -> None:
        """
...
class BreadthFirstIterator(java.util.Iterator[docking.widgets.tree.GTreeNode]):
    ...
    NOTE: Iterator will not include children of a node where :meth:`GTreeNode.isAutoExpandPermitted() <GTreeNode.isAutoExpandPermitted>`
    returns false.
    """

    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, node: docking.widgets.tree.GTreeNode) -> None:
        ...
...
class CombinedGTreeFilter(GTreeFilter):
    ...
    def __init__(self, filter1: GTreeFilter, filter2: GTreeFilter) -> None:
        ...
...
class GTreeCellEditor(javax.swing.tree.DefaultTreeCellEditor):
    ...
    def __init__(self, tree: javax.swing.JTree, renderer: javax.swing.tree.DefaultTreeCellRenderer) -> None:
        ...
...
class GTreeNodeTransferable(java.awt.datatransfer.Transferable):
    ...
    def __init__(self, handler: GTreeTransferHandler, selectedData: java.util.List[docking.widgets.tree.GTreeNode]) -> None:
        """
...
class IgnoredNodesGtreeFilter(GTreeFilter):
    ...
    def __init__(self, filter: GTreeFilter, ignoredNodes: java.util.Set[docking.widgets.tree.GTreeNode]) -> None:
        ...
...
__all__ = ["GTreeSelectionEvent", "GTreeRenderer", "GTreeDragNDropHandler", "GTreeTransferHandler", "GTreeFilter", "GTreeSelectionListener", "BreadthFirstIterator", "CombinedGTreeFilter", "DepthFirstIterator", "GTreeCellEditor", "GTreeNodeTransferable", "IgnoredNodesGtreeFilter", "NewTestApp", "FileData", "FileNode", "DirectoryNode", "RootNode", "DragNDropHandler"]
