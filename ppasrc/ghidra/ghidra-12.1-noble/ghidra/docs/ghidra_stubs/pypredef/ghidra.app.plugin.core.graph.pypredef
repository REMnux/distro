...
class AddressBasedGraphDisplayListener(ghidra.service.graph.GraphDisplayListener, ghidra.framework.plugintool.util.PluginEventListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, program: ghidra.program.model.listing.Program, display: ghidra.service.graph.GraphDisplay) -> None:
        ...
...
class GraphDisplayBrokerPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.GraphDisplayBroker, ghidra.framework.options.OptionsChangeListener):
    ...
    class GraphSelectionAction(docking.action.ToggleDockingAction):
        ...
        def __init__(self, owner: typing.Union[java.lang.String, str], provider: ghidra.service.graph.GraphDisplayProvider) -> None:
            ...
    ...
    def setDefaultGraphDisplayProvider(self, provider: ghidra.service.graph.GraphDisplayProvider) -> None:
        ...



__all__ = ["AddressBasedGraphDisplayListener", "GraphDisplayBrokerListener", "GraphDisplayBrokerPlugin"]
