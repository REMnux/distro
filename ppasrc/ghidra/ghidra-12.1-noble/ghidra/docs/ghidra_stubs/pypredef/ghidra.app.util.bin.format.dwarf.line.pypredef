...
class DWARFLineContentType(java.lang.Enum[DWARFLineContentType]):
    ...
    Similar to the :obj:`DWARFAttributeId` enum, both are identifiers of an attribute value 
    ...
    class Def(ghidra.app.util.bin.format.dwarf.attribs.DWARFAttributeDef[DWARFLineContentType]):
        ...
        def __init__(self, attributeId: DWARFLineContentType, rawAttributeId: typing.Union[jpype.JInt, int], attributeForm: ghidra.app.util.bin.format.dwarf.attribs.DWARFForm, implicitValue: typing.Union[jpype.JLong, int]) -> None:
            ...
...
class DWARFLine(java.lang.Object):
    ...
    class SourceFileInfo(java.lang.Record):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, filePath: typing.Union[java.lang.String, str], md5: jpype.JArray[jpype.JByte]) -> None:
            ...
    ...
    class SourceFileAddr(java.lang.Record):
        ...
        def __init__(self, address: typing.Union[jpype.JLong, int], fileName: typing.Union[java.lang.String, str], md5: jpype.JArray[jpype.JByte], lineNum: typing.Union[jpype.JInt, int], isEndSequence: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def getAllSourceFileAddrInfo(self, cu: ghidra.app.util.bin.format.dwarf.DWARFCompilationUnit) -> java.util.List[DWARFLine.SourceFileAddr]:
        ...

    def getAllSourceFileInfos(self) -> java.util.List[DWARFLine.SourceFileInfo]:
        ...
    ...
    def getFile(self, index: typing.Union[jpype.JInt, int]) -> DWARFFile:
        ...
        :param jpype.JInt or int index: index of the file, where index may not be zero based depending on dwarf version
        :return: file :obj:`DWARFFile`
        :rtype: DWARFFile
        :raises IOException: if invalid index
        """

    def getLineProgramExecutor(self, cu: ghidra.app.util.bin.format.dwarf.DWARFCompilationUnit) -> DWARFLineProgramExecutor:
        ...
    ...
    @property
    def allSourceFileInfos(self) -> java.util.List[DWARFLine.SourceFileInfo]:
        ...

    @property
    def allSourceFileAddrInfo(self) -> java.util.List[DWARFLine.SourceFileAddr]:
        ...
    ...
    @property
    def lineProgramExecutor(self) -> DWARFLineProgramExecutor:
        ...
...
class DWARFFile(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], directory_index: typing.Union[jpype.JInt, int], modification_time: typing.Union[jpype.JLong, int], length: typing.Union[jpype.JLong, int], md5: jpype.JArray[jpype.JByte]) -> None:
        """
        ...
        :param jpype.JArray[jpype.JByte] md5: bytes of md5 hash
        """
    ...
    def getPathName(self, parentLine: DWARFLine) -> str:
        ...

    @staticmethod
    def readV4(reader: ghidra.app.util.bin.BinaryReader, cu: ghidra.app.util.bin.format.dwarf.DWARFCompilationUnit) -> DWARFFile:
        """
    ...
    @staticmethod
    def readV5(reader: ghidra.app.util.bin.BinaryReader, defs: java.util.List[DWARFLineContentType.Def], dwarfIntSize: typing.Union[jpype.JInt, int], cu: ghidra.app.util.bin.format.dwarf.DWARFCompilationUnit) -> DWARFFile:
        """
        Reads a DWARFFile entry.
        ...
        :param jpype.JInt or int dwarfIntSize: size of serialized dwarf ints (might be different than the CU's dwarfIntSize)
        :param ghidra.app.util.bin.format.dwarf.DWARFCompilationUnit cu: :obj:`DWARFCompilationUnit`
...
class DWARFLineProgramExecutor(java.io.Closeable):
    ...
    def step(self) -> DWARFLineProgramInstruction:
        ...
        :return: next :obj:`DWARFLineProgramInstruction`
...
class DWARFLineProgramState(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, defaultIsStatement: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, other: DWARFLineProgramState) -> None:
        ...
...
class DWARFLineProgramInstruction(java.lang.Record):
    ...
    def __init__(self, offset: typing.Union[jpype.JLong, int], instr: typing.Union[java.lang.String, str], operands: java.util.List[java.lang.Number], row: DWARFLineProgramState) -> None:
        ...
