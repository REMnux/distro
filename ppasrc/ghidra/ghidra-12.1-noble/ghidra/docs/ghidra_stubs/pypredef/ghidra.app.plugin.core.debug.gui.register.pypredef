...
class AvailableRegisterRow(java.lang.Object):
    ...
    def __init__(self, number: typing.Union[jpype.JInt, int], register: ghidra.program.model.lang.Register) -> None:
        ...
    ...
    def setKnown(self, known: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setSelected(self, select: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DebuggerAvailableRegistersDialog(docking.ReusableDialogComponentProvider):
    ...
    def setKnown(self, known: collections.abc.Sequence) -> None:
        ...

    def setLanguage(self, language: ghidra.program.model.lang.Language) -> None:
        ...

    def setSelection(self, selection: collections.abc.Sequence) -> None:
        ...
...
class DebuggerRegistersProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.app.plugin.core.debug.gui.DebuggerProvider, docking.actions.PopupActionProvider):
    ...
    @staticmethod
    def applyStateColors(renderer: docking.widgets.AbstractGCellRenderer, data: docking.widgets.table.GTableCellRenderingData, isChanged: java.util.function.Predicate[RegisterRow]) -> None:
        ...
    ...
    def getPrevious(self) -> ghidra.debug.api.tracemgr.DebuggerCoordinates:
        ...
    ...
    def setSelectedRow(self, row: RegisterRow) -> None:
        ...
    ...
    @property
    def previous(self) -> ghidra.debug.api.tracemgr.DebuggerCoordinates:
        ...
...
class RegisterRow(java.lang.Object):
    ...
    def setFavorite(self, favorite: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setRepresentation(self, representation: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setValue(self, value: java.math.BigInteger) -> None:
        """
...
class DebuggerRegistersPlugin(ghidra.app.plugin.core.debug.AbstractDebuggerPlugin):
    ...
    @staticmethod
    def readSetsByCSpec(setsByCSpec: collections.abc.Mapping, encoded: typing.Union[java.lang.String, str]) -> None:
        ...
...
class DebuggerRegisterActionContext(docking.DefaultActionContext):
    ...
    def __init__(self, provider: DebuggerRegistersProvider, selected: RegisterRow, source: docking.widgets.table.GTable) -> None:
        ...
...
__all__ = ["AvailableRegisterRow", "DebuggerAvailableRegistersActionContext", "DebuggerAvailableRegistersDialog", "DebuggerRegistersProvider", "RegisterRow", "DebuggerRegistersPlugin", "DebuggerRegisterActionContext", "DebuggerRegisterColumnFactory"]
