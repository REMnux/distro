...
class AbstractNumberInputDialog(docking.DialogComponentProvider):
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], prompt: typing.Union[java.lang.String, str], initialValue: typing.Union[java.lang.Integer, int], min: typing.Union[jpype.JInt, int], max: typing.Union[jpype.JInt, int], showAsHex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], prompt: typing.Union[java.lang.String, str], initialValue: java.math.BigInteger, min: java.math.BigInteger, max: java.math.BigInteger, showAsHex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Show a number input dialog
    ...
    def setDefaultMessage(self, defaultMessage: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setInput(self, value: typing.Union[jpype.JInt, int]) -> None:
        """
...
class InputDialog(docking.DialogComponentProvider):
    ...
    @typing.overload
    def __init__(self, dialogTitle: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dialogTitle: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str], initialValue: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dialogTitle: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str], initialValue: typing.Union[java.lang.String, str], listener: InputDialogListener) -> None:
        """
        Creates a generic input dialog with the specified title, a text field, labeled by the
        specified label. The user should check the value of "isCanceled()" to know whether or not the
        user canceled the operation. Otherwise, use the "getValue()" or "getValues()" to get the
    ...
    @typing.overload
    def __init__(self, dialogTitle: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str], initialValue: typing.Union[java.lang.String, str], isModal: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Creates a generic input dialog with the specified title, a text field, labeled by the
        specified label. The user should check the value of "isCanceled()" to know whether or not the
        user canceled the operation. Otherwise, use the "getValue()" or "getValues()" to get the
    ...
    @typing.overload
    def __init__(self, dialogTitle: typing.Union[java.lang.String, str], labels: jpype.JArray[java.lang.String], initialValues: jpype.JArray[java.lang.String]) -> None:
        """
        Creates a generic input dialog with the specified title, a text field, labeled by the
        specified label. The user should check the value of "isCanceled()" to know whether or not the
        user canceled the operation. Otherwise, use the "getValue()" or "getValues()" to get the
    ...
    @typing.overload
    def __init__(self, dialogTitle: typing.Union[java.lang.String, str], labels: jpype.JArray[java.lang.String], initialValues: jpype.JArray[java.lang.String], listener: InputDialogListener) -> None:
        """
        Creates a generic input dialog with the specified title, a text field, labeled by the
        specified label. The user should check the value of "isCanceled()" to know whether or not the
        user canceled the operation. Otherwise, use the "getValue()" or "getValues()" to get the
    ...
    @typing.overload
    def setValue(self, text: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setValue(self, text: typing.Union[java.lang.String, str], index: typing.Union[jpype.JInt, int]) -> None:
        """
...
class InputWithChoicesDialog(docking.DialogComponentProvider):
    ...
    @typing.overload
    def __init__(self, dialogTitle: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str], optionValues: jpype.JArray[java.lang.String], initialValue: typing.Union[java.lang.String, str], messageIcon: javax.swing.Icon) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dialogTitle: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str], optionValues: jpype.JArray[java.lang.String], initialValue: typing.Union[java.lang.String, str], allowEdits: typing.Union[jpype.JBoolean, bool], messageIcon: javax.swing.Icon) -> None:
        """
        Creates a provider for a generic input dialog with the specified title, a label and a
        editable comboBox pre-populated with selectable values. The user can check the value of
        :meth:`isCanceled() <.isCanceled>` to know whether or not the user canceled the operation. To get the
    ...
    def setValue(self, value: typing.Union[java.lang.String, str]) -> None:
        """
...
class MultiLineInputDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], messageText: typing.Union[java.lang.String, str], initialValue: typing.Union[java.lang.String, str], icon: javax.swing.Icon) -> None:
        ...
...
class MultiLineMessageDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], shortMessage: typing.Union[java.lang.String, str], detailedMessage: typing.Union[java.lang.String, str], messageType: typing.Union[jpype.JInt, int], modal: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @staticmethod
    def showMessageDialog(parent: java.awt.Component, title: typing.Union[java.lang.String, str], shortMessage: typing.Union[java.lang.String, str], detailedMessage: typing.Union[java.lang.String, str], messageType: typing.Union[jpype.JInt, int]) -> None:
        ...

    @staticmethod
    def showModalMessageDialog(parent: java.awt.Component, title: typing.Union[java.lang.String, str], shortMessage: typing.Union[java.lang.String, str], detailedMessage: typing.Union[java.lang.String, str], messageType: typing.Union[jpype.JInt, int]) -> None:
        """
...
class NumberInputDialog(AbstractNumberInputDialog):
    ...
    @typing.overload
    def __init__(self, entryType: typing.Union[java.lang.String, str], initial: typing.Union[jpype.JInt, int], min: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, entryType: typing.Union[java.lang.String, str], initial: typing.Union[jpype.JInt, int], min: typing.Union[jpype.JInt, int], max: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructs a new NumberInputDialog
...
class NumberRangeInputDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ObjectChooserDialog(docking.DialogComponentProvider, typing.Generic[T]):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], objectClass: java.lang.Class[T], choosableObjects: java.util.List[T], *methodsForColumns: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    def setSelectedObject(self, t: T) -> None:
        ...
...
class ReadTextDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], text: typing.Union[java.lang.String, str]) -> None:
        """
...
class SettingsDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, help: ghidra.util.HelpLocation) -> None:
        ...

    def getTable(self) -> docking.widgets.table.GTable:
        ...

    def show(self, parent: java.awt.Component, title: typing.Union[java.lang.String, str], newSettingsDefs: jpype.JArray[ghidra.docking.settings.SettingsDefinition], newSettings: ghidra.docking.settings.Settings) -> None:
        ...
...
class StringChoices(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, values: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, strEnum: StringChoices) -> None:
        """
    ...
    @typing.overload
    def setSelectedValue(self, value: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def setSelectedValue(self, index: typing.Union[jpype.JInt, int]) -> None:
        """
...
class TableChooserDialog(docking.DialogComponentProvider, typing.Generic[T]):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], model: docking.widgets.table.RowObjectTableModel[T], allowMultipleSelection: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
__all__ = ["AbstractNumberInputDialog", "BigIntegerNumberInputDialog", "InputDialog", "InputDialogListener", "InputWithChoicesDialog", "MultiLineInputDialog", "MultiLineMessageDialog", "NumberInputDialog", "NumberRangeInputDialog", "ObjectChooserDialog", "ReadTextDialog", "SettingsDialog", "StringChoices", "TableChooserDialog", "TableSelectionDialog"]
