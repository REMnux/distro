...
class MemviewService(java.lang.Object):
    ...
    def setBoxes(self, boxList: java.util.List[MemoryBox]) -> None:
        ...

    def setProgram(self, currentProgram: ghidra.program.model.listing.Program) -> None:
        ...
...
class MemviewProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, plugin: DebuggerMemviewPlugin) -> None:
        ...

    def addBox(self, box: MemoryBox) -> None:
        ...

    def addBoxes(self, blist: java.util.List[MemoryBox]) -> None:
        ...

    def applyFilter(self) -> None:
        ...

    def changeZoomA(self, changeAmount: typing.Union[jpype.JInt, int]) -> None:
        ...

    def changeZoomT(self, changeAmount: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    @typing.overload
    def goTo(self, x: typing.Union[jpype.JInt, int], y: typing.Union[jpype.JInt, int]) -> None:
        ...

    @typing.overload
    def goTo(self, box: MemoryBox) -> None:
        ...
    ...
    def selectPanelPosition(self, boxes: java.util.Set[MemoryBox]) -> None:
        ...

    def selectTableEntry(self, boxes: java.util.Set[MemoryBox]) -> None:
        ...

    def setBoxes(self, blist: java.util.List[MemoryBox]) -> None:
        ...

    def setBoxesInPanel(self, blist: java.util.List[MemoryBox]) -> None:
        ...
...
class DebuggerMemviewTraceListener(ghidra.trace.model.TraceDomainObjectListener):
    ...
    def __init__(self, provider: MemviewProvider) -> None:
        ...
...
class MemoryBox(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, trace: ghidra.trace.model.Trace, id: typing.Union[java.lang.String, str], type: MemviewBoxType, range: ghidra.program.model.address.AddressRange, tick: typing.Union[jpype.JLong, int], color: java.awt.Color) -> None:
        ...

    @typing.overload
    def __init__(self, trace: ghidra.trace.model.Trace, id: typing.Union[java.lang.String, str], type: MemviewBoxType, range: ghidra.program.model.address.AddressRange, tick: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def __init__(self, trace: ghidra.trace.model.Trace, id: typing.Union[java.lang.String, str], type: MemviewBoxType, range: ghidra.program.model.address.AddressRange, trange: ghidra.trace.model.Lifespan) -> None:
        ...
    ...
    def render(self, g: java.awt.Graphics, vertical: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def renderBA(self, g: java.awt.Graphics, vertical: typing.Union[jpype.JBoolean, bool], sz: typing.Union[jpype.JInt, int]) -> None:
        ...

    def renderBT(self, g: java.awt.Graphics, vertical: typing.Union[jpype.JBoolean, bool], sz: typing.Union[jpype.JInt, int], bound: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setAddressBounds(self, map: MemviewMap, bound: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setColor(self, color: java.awt.Color) -> None:
        ...

    def setCurrent(self, current: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setEnd(self, tick: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setStartAddress(self, val: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setStartTime(self, val: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setStopAddress(self, val: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setStopTime(self, val: typing.Union[jpype.JLong, int]) -> None:
        ...

    def setTimeBounds(self, map: MemviewMap, bound: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class MemviewMap(java.lang.Object):
    ...
    def __init__(self, elems: typing.Union[jpype.JLong, int], pixels: typing.Union[jpype.JLong, int]) -> None:
        ...

    def createMapping(self, mult: typing.Union[jpype.JDouble, float]) -> None:
        ...
...
class MemviewPanel(javax.swing.JPanel, java.awt.event.MouseListener, java.awt.event.MouseMotionListener):
    ...
    def addBoxes(self, boxes: java.util.List[MemoryBox]) -> None:
        ...
    ...
    def scaleCurrentPixelAddr(self, changeAmount: typing.Union[jpype.JDouble, float]) -> None:
        ...

    def scaleCurrentPixelTime(self, changeAmount: typing.Union[jpype.JDouble, float]) -> None:
        ...

    def setBoxes(self, boxes: java.util.List[MemoryBox]) -> None:
        ...

    def setSelection(self, boxes: java.util.Set[MemoryBox]) -> None:
        ...

    def setVerticalMode(self, vertical: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class MemviewTable(java.lang.Object):
    ...
    def addBoxes(self, blist: collections.abc.Sequence) -> None:
        ...
    ...
    def setBoxes(self, blist: collections.abc.Sequence) -> None:
        ...

    def setListingService(self, listingService: ghidra.app.services.DebuggerListingService) -> None:
        ...

    def setProgram(self, program: ghidra.program.model.listing.Program) -> None:
        ...

    def setSelection(self, set: java.util.Set[MemoryBox]) -> None:
        ...
...
class MemviewMapModel(docking.widgets.table.AbstractSortedTableModel[MemoryBox]):
    ...
    class MemoryMapComparator(java.util.Comparator[MemoryBox]):
        ...
        def __init__(self, sortColumn: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def addBoxes(self, boxes: collections.abc.Sequence) -> None:
        ...
    ...
    def setBoxes(self, boxes: collections.abc.Sequence) -> None:
        ...
...
__all__ = ["DebuggerMemviewPlugin", "MemviewService", "MemviewProvider", "DebuggerMemviewTraceListener", "MemoryBox", "MemviewBoxType", "MemviewMap", "MemviewPanel", "MemviewTable", "MemviewMapModel"]
