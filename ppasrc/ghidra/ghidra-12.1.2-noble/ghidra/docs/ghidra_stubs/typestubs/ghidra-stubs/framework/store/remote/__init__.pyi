...
class RemoteTextDataItem(RemoteFolderItem, ghidra.framework.store.TextDataItem):
    ...
    class_: typing.ClassVar[java.lang.Class]


class RemoteUnknownFolderItem(RemoteFolderItem, ghidra.framework.store.UnknownFolderItem):
    ...
    class_: typing.ClassVar[java.lang.Class]
...
class RemoteFileSystem(ghidra.framework.store.FileSystem, ghidra.framework.client.RemoteAdapterListener):
    ...
    def __init__(self, repository: ghidra.framework.client.RepositoryAdapter) -> None:
        """
...
__all__ = ["RemoteFolderItem", "RemoteDatabaseItem", "RemoteTextDataItem", "RemoteUnknownFolderItem", "RemoteFileSystem"]
