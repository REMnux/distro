...
class LibrarySearchPathManager(java.lang.Object):
    ...
    @staticmethod
    def setLibraryPaths(paths: jpype.JArray[java.lang.String]) -> None:
        """
...
class LcsHintLoadSpecChooser(LoadSpecChooser):
    ...
    @typing.overload
    def __init__(self, language: ghidra.program.model.lang.Language, compilerSpec: ghidra.program.model.lang.CompilerSpec) -> None:
        """
    ...
    @typing.overload
    def __init__(self, languageId: ghidra.program.model.lang.LanguageID, compilerSpecId: ghidra.program.model.lang.CompilerSpecID) -> None:
        """
        Creates a new :obj:`LcsHintLoadSpecChooser`.
...
class LoaderArgsOptionChooser(OptionChooser):
    ...
    @deprecated("Use ProgramLoader.Builder.loaderArgs(List) instead")
    def __init__(self, loaderArgs: java.util.List[generic.stl.Pair[java.lang.String, java.lang.String]]) -> None:
        """
...
class DomainFileOption(ghidra.app.util.Option):
    """
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], arg: typing.Union[java.lang.String, str], hidden: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class CsHintLoadSpecChooser(LoadSpecChooser):
    ...
    @typing.overload
    def __init__(self, compilerSpecID: ghidra.program.model.lang.CompilerSpecID) -> None:
        """
    ...
    @typing.overload
    def __init__(self, compilerSpecID: typing.Union[java.lang.String, str]) -> None:
        """
        Creates a new :obj:`CsHintLoadSpecChooser`
...
class SingleLoaderFilter(java.util.function.Predicate[ghidra.app.util.opinion.Loader]):
    ...
    @deprecated("Use ProgramLoader.Builder.loaders(Class) instead")
    def __init__(self, single: java.lang.Class[ghidra.app.util.opinion.Loader]) -> None:
        """
...
class MessageLog(java.lang.Object):
    ...
    @typing.overload
    def appendMsg(self, message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def appendMsg(self, originator: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str]) -> None:
        """
        Appends the message to the log
    ...
    @typing.overload
    def appendMsg(self, lineNum: typing.Union[jpype.JInt, int], message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def copyFrom(self, log: MessageLog) -> None:
        """
    ...
    def error(self, originator: typing.Union[java.lang.String, str], message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def write(self, owner: java.lang.Class[typing.Any], messageHeader: typing.Union[java.lang.String, str]) -> None:
        """
...
__all__ = ["LibrarySearchPathManager", "LibrarySearchPathDummyOption", "MultipleProgramsException", "LcsHintLoadSpecChooser", "LoaderArgsOptionChooser", "ProgramLoader", "OptionChooser", "DomainFileOption", "LoadSpecChooser", "DomainFolderOption", "CsHintLoadSpecChooser", "SingleLoaderFilter", "AutoImporter", "MessageLog"]
