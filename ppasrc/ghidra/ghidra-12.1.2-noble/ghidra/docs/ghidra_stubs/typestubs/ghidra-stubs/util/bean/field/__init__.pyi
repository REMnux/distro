...
class AnnotatedTextFieldElement(docking.widgets.fieldpanel.field.AbstractTextFieldElement):
    ...
    def __init__(self, annotation: ghidra.app.util.viewer.field.Annotation, prototype: docking.widgets.fieldpanel.field.AttributedString, program: ghidra.program.model.listing.Program, row: typing.Union[jpype.JInt, int], column: typing.Union[jpype.JInt, int]) -> None:
        """
