...
class RemoteMethodInvocationDialog(ghidra.app.plugin.core.debug.gui.AbstractDebuggerParameterDialog[ghidra.debug.api.tracermi.RemoteParameter]):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, ctx: ghidra.trace.model.target.schema.SchemaContext, title: typing.Union[java.lang.String, str], buttonText: typing.Union[java.lang.String, str], buttonIcon: javax.swing.Icon) -> None:
        ...
