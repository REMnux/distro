...
class GhidraProject(java.lang.Object):
    ...
    **Note: **Before using this class you must initialize the Ghidra system.  See
    ...
    @typing.overload
    def analyze(self, program: ghidra.program.model.listing.Program, debug: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def execute(self, cmd: ghidra.framework.cmd.Command[ghidra.program.model.listing.Program], program: ghidra.program.model.listing.Program) -> None:
        """
        Executes the give command on the program.
        
        :param ghidra.framework.cmd.Command[ghidra.program.model.listing.Program] cmd: the command to be applied to the program.
    ...
    def importProgram(self, file: jpype.protocol.SupportsPath, language: ghidra.program.model.lang.Language, compilerSpec: ghidra.program.model.lang.CompilerSpec) -> ghidra.program.model.listing.Program:
        ...
        NOTE: It is the responsibility of the caller to release the returned :obj:`Program` 
        with :meth:`Program.release(Object) <Program.release>` when it is no longer needed, with ``this`` 
        :obj:`GhidraProject` instance as the consumer.
        ...
        :return: The imported :obj:`Program`
    ...
    def importProgram(self, file: jpype.protocol.SupportsPath, processor: ghidra.program.model.lang.Processor) -> ghidra.program.model.listing.Program:
        ...
        :param jpype.protocol.SupportsPath file: The :obj:`File` to import
        :param ghidra.program.model.lang.Processor processor: The desired :obj:`Processor`
        :return: The imported :obj:`Program`
        :rtype: ghidra.program.model.listing.Program
        :raises IOException: if there was an IO-related problem loading
        :raises LanguageNotFoundException: if there was a problem getting the language
    ...
    def importProgram(self, file: jpype.protocol.SupportsPath, loaderClass: java.lang.Class[ghidra.app.util.opinion.Loader]) -> ghidra.program.model.listing.Program:
        """
        Automatically imports the given :obj:`File` with the given :obj:`Loader`.
        ...
        :param jpype.protocol.SupportsPath file: The :obj:`File` to import
        :param java.lang.Class[ghidra.app.util.opinion.Loader] loaderClass: The desired :obj:`Loader`
        :return: The imported :obj:`Program`
        :rtype: ghidra.program.model.listing.Program
        :raises IOException: if there was an IO-related problem loading
        :raises LanguageNotFoundException: if there was a problem getting the language
    ...
    def importProgram(self, file: jpype.protocol.SupportsPath, loaderClass: java.lang.Class[ghidra.app.util.opinion.Loader], language: ghidra.program.model.lang.Language, compilerSpec: ghidra.program.model.lang.CompilerSpec) -> ghidra.program.model.listing.Program:
        """
        Automatically imports the given :obj:`File` with the given :obj:`Loader`, :obj:`Language`,
        and :obj:`compiler specification <CompilerSpec>`.
    ...
    def importProgram(self, file: jpype.protocol.SupportsPath) -> ghidra.program.model.listing.Program:
        """
        Automatically imports the given :obj:`File`.
    ...
    def saveAs(self, program: ghidra.program.model.listing.Program, folderPath: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], overWrite: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def saveAsPackedFile(self, program: ghidra.program.model.listing.Program, file: jpype.protocol.SupportsPath, overWrite: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setDeleteOnClose(self, toDelete: typing.Union[jpype.JBoolean, bool]) -> None:
        """
