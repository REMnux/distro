...
class VisualGraphChangeListener(java.lang.Object, typing.Generic[V, E]):
    ...
    def edgesAdded(self, edges: collections.abc.Sequence) -> None:
        """
    ...
    def edgesRemoved(self, edges: collections.abc.Sequence) -> None:
        """
    ...
    def verticesAdded(self, vertices: collections.abc.Sequence) -> None:
        """
    ...
    def verticesRemoved(self, vertices: collections.abc.Sequence) -> None:
        """
