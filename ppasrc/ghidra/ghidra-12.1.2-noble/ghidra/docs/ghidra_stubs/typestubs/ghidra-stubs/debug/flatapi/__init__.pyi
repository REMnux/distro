...
class FlatDebuggerAPI(java.lang.Object):
    ...
    class ExpectingBreakpointChanges(java.lang.AutoCloseable):
        ...
        def __init__(self, flat: FlatDebuggerAPI, service: ghidra.app.services.DebuggerLogicalBreakpointService) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def activateFrame(self, frame: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def refreshMemoryIfLive(self, trace: ghidra.trace.model.Trace, snap: typing.Union[jpype.JLong, int], start: ghidra.program.model.address.Address, length: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def refreshRegistersIfLive(self, platform: ghidra.trace.model.guest.TracePlatform, thread: ghidra.trace.model.thread.TraceThread, frame: typing.Union[jpype.JInt, int], snap: typing.Union[jpype.JLong, int], registers: collections.abc.Sequence) -> None:
        """
    ...
    @typing.overload
    def setControlMode(self, trace: ghidra.trace.model.Trace, mode: ghidra.debug.api.control.ControlMode) -> None:
        """
    ...
    @typing.overload
    def setControlMode(self, mode: ghidra.debug.api.control.ControlMode) -> None:
        """
    ...
    @typing.overload
    def waitForBreak(self, trace: ghidra.trace.model.Trace, timeout: typing.Union[jpype.JLong, int], unit: java.util.concurrent.TimeUnit) -> None:
        """
    ...
    @typing.overload
    def waitForBreak(self, timeout: typing.Union[jpype.JLong, int], unit: java.util.concurrent.TimeUnit) -> None:
        """
