...
class PickListener(java.lang.Object, typing.Generic[V]):
    ...
    def verticesPicked(self, vertices: java.util.Set[V], source: PickListener.EventSource) -> None:
        ...
...
class GPickedState(edu.uci.ics.jung.visualization.picking.PickedState[V], typing.Generic[V]):
    ...
    def __init__(self, pickedState: edu.uci.ics.jung.visualization.picking.MultiPickedState[V]) -> None:
        ...

    def addPickingListener(self, pickListener: PickListener[V]) -> None:
        ...

    def pickToActivate(self, vertex: V) -> None:
        """
    ...
    @typing.overload
    def pickToSync(self, vertex: V) -> None:
        """
    ...
    @typing.overload
    def pickToSync(self, vertex: V, addToSelection: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Picks the given vertex, but signals that the pick is really just to make sure that the 
        vertex is picked in order to match the graph's notion of the current location.  To pick a 
        vertex and signal that the location has changed, call :meth:`pick(Object, boolean) <.pick>`
    ...
    def removePickingListener(self, pickListener: PickListener[V]) -> None:
        ...
