...
class RegisterValueRange(java.lang.Object):
    ...
    def __init__(self, range: ghidra.program.model.address.AddressRange, value: java.math.BigInteger, isDefault: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setEndAddress(self, maxAddress: ghidra.program.model.address.Address) -> None:
        ...
...
class RegisterTreeNode(SearchableRegisterTreeNode):
    ...
    def __init__(self, register: ghidra.program.model.lang.Register) -> None:
        ...
...
class RegisterTree(docking.widgets.tree.GTree):
    ...
    def selectRegister(self, register: ghidra.program.model.lang.Register) -> None:
        ...
...
class RegisterManagerProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def setLocation(self, register: ghidra.program.model.lang.Register, address: ghidra.program.model.address.Address) -> None:
        ...
...
class RegisterTreeRootNode(SearchableRegisterTreeNode):
    ...
    def setRegisters(self, registers: jpype.JArray[ghidra.program.model.lang.Register]) -> None:
        ...
