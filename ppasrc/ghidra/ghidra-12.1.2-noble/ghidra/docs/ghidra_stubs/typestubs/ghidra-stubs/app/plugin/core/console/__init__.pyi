...
class CodeCompletion(java.lang.Comparable[CodeCompletion]):
    ...
    *  charsToRemove: 6 (i.e. the length of "Runscr", 
    ...
    @typing.overload
    def __init__(self, description: typing.Union[java.lang.String, str], insertion: typing.Union[java.lang.String, str], comp: javax.swing.JComponent) -> None:
        """
    ...
    @typing.overload
    def __init__(self, description: typing.Union[java.lang.String, str], insertion: typing.Union[java.lang.String, str], comp: javax.swing.JComponent, charsToRemove: typing.Union[jpype.JInt, int]) -> None:
        """
        Construct a new CodeCompletion.
...
class ConsoleComponentProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.app.services.ConsoleService):
    ...
    class ConsolePrintWriter(ghidra.app.script.DecoratingPrintWriter):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class ColoringConsoleWriter(java.io.Writer):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, error: typing.Union[jpype.JBoolean, bool]) -> None:
            ...
    ...
    def print(self, msg: typing.Union[java.lang.String, str], c: java.awt.Color) -> None:
        ...
...
__all__ = ["ConsolePlugin", "CodeCompletion", "ConsoleComponentProvider", "ConsoleWord"]
