...
class DBTraceOverlaySpaceAdapter(ghidra.trace.database.DBTraceManager):
    ...
    def __init__(self, dbh: db.DBHandle, openMode: ghidra.framework.data.OpenMode, lock: java.util.concurrent.locks.ReadWriteLock, monitor: ghidra.util.task.TaskMonitor, trace: ghidra.trace.database.DBTrace) -> None:
        ...
...
class TraceAddressFactory(ghidra.program.database.ProgramAddressFactory):
    ...
    def __init__(self, language: ghidra.program.model.lang.Language, compilerSpec: ghidra.program.model.lang.CompilerSpec, overlayRegionSupplier: ghidra.program.database.OverlayRegionSupplier) -> None:
        ...
