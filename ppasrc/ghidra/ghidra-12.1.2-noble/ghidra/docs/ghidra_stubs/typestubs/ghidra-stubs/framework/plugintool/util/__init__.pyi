...
class UndoRedoToolState(java.lang.Object):
    ...
    class PluginState(java.lang.Object):
        ...
        def restoreUndoRedoState(self, domainObject: ghidra.framework.model.DomainObject) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, plugins: java.util.List[ghidra.framework.plugintool.Plugin], domainObject: ghidra.framework.model.DomainObject) -> None:
        """
...
class PluginConstructionException(ghidra.util.exception.UsrException):
    ...
    def __init__(self, className: typing.Union[java.lang.String, str], details: typing.Union[java.lang.String, str]) -> None:
        """
...
class TransientToolState(java.lang.Object):
    ...
    def __init__(self, plugins: java.util.List[ghidra.framework.plugintool.Plugin]) -> None:
        """
        Construct a TransientPluginState
...
class PluginUtils(java.lang.Object):
    ...
    @staticmethod
    def assertUniquePluginName(pluginClass: java.lang.Class[ghidra.framework.plugintool.Plugin]) -> None:
        """
...
class AutoServiceListener(ServiceListener, typing.Generic[R]):

    @typing.type_check_only
    class ServiceSetter(java.lang.Object, typing.Generic[R, S]):

        class_: typing.ClassVar[java.lang.Class]

        def getServiceIface(self) -> java.lang.Class[S]:
            ...

        def set(self, receiver: R, service: S) -> None:
            ...

        @property
        def serviceIface(self) -> java.lang.Class[S]:
            ...


    @typing.type_check_only
    class FieldServiceSetter(AutoServiceListener.ServiceSetter[R, S], typing.Generic[R, S]):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, field: java.lang.reflect.Field) -> None:
            ...


    @typing.type_check_only
    class MethodServiceSetter(AutoServiceListener.ServiceSetter[R, S], typing.Generic[R, S]):
    ...
    class ReceiverProfile(java.lang.Object, typing.Generic[R]):
        ...
        def __init__(self, receiverCls: java.lang.Class[R]) -> None:
            ...

        def notifyCurrentServices(self, tool: ghidra.framework.plugintool.PluginTool, receiver: R) -> None:
            ...

        def serviceAdded(self, iface: java.lang.Class[S], service: S, receiver: R) -> None:
            ...

        def serviceRemoved(self, iface: java.lang.Class[typing.Any], receiver: R) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, receiver: R) -> None:
        ...

    def notifyCurrentServices(self, tool: ghidra.framework.plugintool.PluginTool) -> None:
        ...



__all__ = ["DefaultPluginsConfiguration", "PluginPackageState", "UndoRedoToolState", "PluginDescription", "PluginPackage", "PluginConstructionException", "PluginStatus", "PluginEventListener", "TransientToolState", "PluginException", "PluginUtils", "ServiceListener", "AutoServiceListener"]
