...
class Target(java.lang.Object):
    ...
    class ActionEntry(java.lang.Object):
        ...
        def run(self, prompt: typing.Union[jpype.JBoolean, bool]) -> None:
            """
    ...
    def activate(self, prev: ghidra.debug.api.tracemgr.DebuggerCoordinates, coords: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> None:
        """
    ...
    def deleteBreakpoint(self, breakpoint: ghidra.trace.model.breakpoint.TraceBreakpointCommon) -> None:
        """
    ...
    def forciblyCloseTransactions(self) -> None:
        """
    ...
    def placeBreakpoint(self, range: ghidra.program.model.address.AddressRange, kinds: java.util.Set[ghidra.trace.model.breakpoint.TraceBreakpointKind], condition: typing.Union[java.lang.String, str], commands: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def readMemory(self, set: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def readRegisters(self, platform: ghidra.trace.model.guest.TracePlatform, thread: ghidra.trace.model.thread.TraceThread, frame: typing.Union[jpype.JInt, int], registers: java.util.Set[ghidra.program.model.lang.Register]) -> None:
        """
    ...
    @typing.overload
    def readRegisters(self, platform: ghidra.trace.model.guest.TracePlatform, thread: ghidra.trace.model.thread.TraceThread, frame: typing.Union[jpype.JInt, int], guestSet: ghidra.program.model.address.AddressSetView) -> None:
        """
    ...
    def toggleBreakpoint(self, breakpoint: ghidra.trace.model.breakpoint.TraceBreakpointCommon, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def writeMemory(self, address: ghidra.program.model.address.Address, data: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    @typing.overload
    def writeRegister(self, platform: ghidra.trace.model.guest.TracePlatform, thread: ghidra.trace.model.thread.TraceThread, frame: typing.Union[jpype.JInt, int], value: ghidra.program.model.lang.RegisterValue) -> None:
        """
    ...
    @typing.overload
    def writeRegister(self, platform: ghidra.trace.model.guest.TracePlatform, thread: ghidra.trace.model.thread.TraceThread, frame: typing.Union[jpype.JInt, int], address: ghidra.program.model.address.Address, data: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def writeVariable(self, platform: ghidra.trace.model.guest.TracePlatform, thread: ghidra.trace.model.thread.TraceThread, frame: typing.Union[jpype.JInt, int], address: ghidra.program.model.address.Address, data: jpype.JArray[jpype.JByte]) -> None:
        """
...
class ActionName(java.lang.Record):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], show: ActionName.Show, enabler: ActionName.Enabler, display: typing.Union[java.lang.String, str], icon: javax.swing.Icon, okText: typing.Union[java.lang.String, str]) -> None:
        ...
...
class TargetPublicationListener(java.lang.Object):
    ...
    def targetPublished(self, target: Target) -> None:
        """
    ...
    def targetWithdrawn(self, target: Target) -> None:
        """
