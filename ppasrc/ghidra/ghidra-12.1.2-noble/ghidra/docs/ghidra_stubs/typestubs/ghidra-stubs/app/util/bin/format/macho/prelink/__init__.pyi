...
class MachoPrelinkMap(java.lang.Object):
    ...
    @typing.overload
    def put(self, key: typing.Union[java.lang.String, str], value: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def put(self, key: typing.Union[java.lang.String, str], value: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def put(self, key: typing.Union[java.lang.String, str], value: MachoPrelinkMap) -> None:
        ...
...
class MachoPrelinkParser(java.lang.Object):
    ...
    def __init__(self, mainHeader: ghidra.app.util.bin.format.macho.MachHeader, provider: ghidra.app.util.bin.ByteProvider) -> None:
        ...
