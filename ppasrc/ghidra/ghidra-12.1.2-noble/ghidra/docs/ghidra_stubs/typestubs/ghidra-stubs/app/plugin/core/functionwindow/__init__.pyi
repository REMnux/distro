...
class FunctionWindowProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    @typing.type_check_only
    class FunctionWindowActionContext(docking.DefaultActionContext, ghidra.app.context.FunctionSupplierContext, ghidra.app.context.ProgramLocationSupplierContext):
        ...
        class_: typing.ClassVar[java.lang.Class]
