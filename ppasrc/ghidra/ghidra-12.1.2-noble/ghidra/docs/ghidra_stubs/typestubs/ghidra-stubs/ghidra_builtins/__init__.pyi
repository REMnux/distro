...
errorWriter: java.io.PrintWriter
decorateOutput: jpype.JBoolean
...
def cleanup(success: typing.Union[jpype.JBoolean, bool]) -> None:
    """
...
def createDwords(start: ghidra.program.model.address.Address, count: typing.Union[jpype.JInt, int]) -> None:
    """
...
def decorate(message: typing.Union[java.lang.String, str]) -> str:
    """
    Decorates the given message, which is used by the :obj:`GhidraScript` "print" methods during
    logging and :obj:`optionally <.decorateOutput>` when outputting to the 
    :obj:`PrintWriter`s.
    
    :param java.lang.String or str message: The message to decorate
...
def end(commit: typing.Union[jpype.JBoolean, bool]) -> None:
    """
...
def execute(runState: GhidraState, runMonitor: ghidra.util.task.TaskMonitor, runWriter: java.io.PrintWriter) -> None:
    """
...
@typing.overload
def execute(runState: GhidraState, runControls: ScriptControls) -> None:
    """
...
def getControls() -> ScriptControls:
    """
...
def loadPropertiesFile() -> None:
    ...


def loadVariablesFromState() -> None:
    ...
...
def popup(message: typing.Union[java.lang.String, str]) -> None:
    """
...
def printerr(message: typing.Union[java.lang.String, str]) -> None:
    """
...
def printf(message: typing.Union[java.lang.String, str], *args: java.lang.Object) -> None:
    """
...
@typing.overload
def println(message: typing.Union[java.lang.String, str]) -> None:
    """
    Prints the :obj:`optionally <.decorateOutput>` :meth:`decorated <.decorate>` message
...
@typing.overload
def println(message: typing.Union[java.lang.String, str], color: java.awt.Color) -> None:
    """
    Prints the :obj:`optionally <.decorateOutput>` :meth:`decorated <.decorate>` message
    followed by a line feed to this script's ``stdout`` :obj:`PrintWriter`, which is set by 
    :meth:`set(GhidraState, ScriptControls) <.set>`.
...
@typing.overload
def removeEquate(instruction: ghidra.program.model.listing.Instruction, operandIndex: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JLong, int]) -> None:
    """
...
def removeEquates(instruction: ghidra.program.model.listing.Instruction, operandIndex: typing.Union[jpype.JInt, int]) -> None:
    """
...
def resetAnalysisOption(program: ghidra.program.model.listing.Program, analysisOption: typing.Union[java.lang.String, str]) -> None:
    """
...
def resetAnalysisOptions(program: ghidra.program.model.listing.Program, analysisOptions: java.util.List[java.lang.String]) -> None:
    """
...
@typing.overload
def runScript(scriptName: typing.Union[java.lang.String, str]) -> None:
    """
...
@typing.overload
def runScript(scriptName: typing.Union[java.lang.String, str], scriptArguments: jpype.JArray[java.lang.String]) -> None:
    """
...
@typing.overload
def runScript(scriptName: typing.Union[java.lang.String, str], scriptState: GhidraState) -> None:
    """
...
@typing.overload
def runScript(scriptName: typing.Union[java.lang.String, str], scriptArguments: jpype.JArray[java.lang.String], scriptState: GhidraState) -> None:
    """
...
@typing.overload
def saveProgram(program: ghidra.program.model.listing.Program, path: java.util.List[java.lang.String]) -> None:
    """
...
def setAnalysisOption(program: ghidra.program.model.listing.Program, optionName: typing.Union[java.lang.String, str], optionValue: typing.Union[java.lang.String, str]) -> None:
    """
...
def setAnalysisOptions(program: ghidra.program.model.listing.Program, analysisSettings: collections.abc.Mapping) -> None:
    """
...
def setByte(address: ghidra.program.model.address.Address, value: typing.Union[jpype.JByte, int]) -> None:
    """
...
def setBytes(address: ghidra.program.model.address.Address, values: jpype.JArray[jpype.JByte]) -> None:
    """
...
def setDouble(address: ghidra.program.model.address.Address, value: typing.Union[jpype.JDouble, float]) -> None:
    """
...
def setFloat(address: ghidra.program.model.address.Address, value: typing.Union[jpype.JFloat, float]) -> None:
    """
...
def setInt(address: ghidra.program.model.address.Address, value: typing.Union[jpype.JInt, int]) -> None:
    """
...
def setLong(address: ghidra.program.model.address.Address, value: typing.Union[jpype.JLong, int]) -> None:
    """
...
def setPotentialPropertiesFileLocations(locations: java.util.List[generic.jar.ResourceFile]) -> None:
    """
...
def setPropertiesFile(propertiesFile: jpype.protocol.SupportsPath) -> None:
    """
...
def setPropertiesFileLocation(dirLocation: typing.Union[java.lang.String, str], basename: typing.Union[java.lang.String, str]) -> None:
    """
...
@typing.overload
def setReferencePrimary(reference: ghidra.program.model.symbol.Reference, primary: typing.Union[jpype.JBoolean, bool]) -> None:
    """
    Sets the given reference as primary.
...
def setReusePreviousChoices(reuse: typing.Union[jpype.JBoolean, bool]) -> None:
    """
...
def setScriptArgs(scriptArgs: jpype.JArray[java.lang.String]) -> None:
    """
...
def setShort(address: ghidra.program.model.address.Address, value: typing.Union[jpype.JShort, int]) -> None:
    """
...
def setToolStatusMessage(msg: typing.Union[java.lang.String, str], beep: typing.Union[jpype.JBoolean, bool]) -> None:
    """
...
@typing.overload
def show(addresses: jpype.JArray[ghidra.program.model.address.Address]) -> None:
    """
...
@typing.overload
def show(title: typing.Union[java.lang.String, str], addresses: ghidra.program.model.address.AddressSetView) -> None:
    """
