...
class SearchAndReplaceProvider(ghidra.features.base.quickfix.QuickFixTableProvider):
    """
    Subclass of the :obj:`QuickFixTableProvider` that customizes it specifically for search and replace
    operations.
    """

    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, plugin: SearchAndReplacePlugin, program: ghidra.program.model.listing.Program, query: SearchAndReplaceQuery) -> None:
        ...
...
class SearchAndReplaceQuckFixTableLoader(ghidra.features.base.quickfix.TableDataLoader[ghidra.features.base.quickfix.QuickFix]):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, query: SearchAndReplaceQuery) -> None:
        ...
...
class SearchAndReplaceQuery(java.lang.Object):
    ...
    def findAll(self, program: ghidra.program.model.listing.Program, accumulator: ghidra.util.datastruct.Accumulator[ghidra.features.base.quickfix.QuickFix], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class SearchType(java.lang.Comparable[SearchType]):
    ...
    def __init__(self, handler: SearchAndReplaceHandler, name: typing.Union[java.lang.String, str], description: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class RenameQuickFix(ghidra.features.base.quickfix.QuickFix):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, name: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor
...
class SearchAndReplaceDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, searchLimit: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
    ...
    def selectRegEx(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def selectSearchType(self, searchType: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setSarchAndReplaceText(self, searchText: typing.Union[java.lang.String, str], replaceText: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setSearchLimit(self, searchLimit: typing.Union[jpype.JInt, int]) -> None:
        """
...
class SearchAndReplaceHandler(ghidra.util.classfinder.ExtensionPoint):
    ...
    def findAll(self, program: ghidra.program.model.listing.Program, query: SearchAndReplaceQuery, accumulator: ghidra.util.datastruct.Accumulator[ghidra.features.base.quickfix.QuickFix], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
