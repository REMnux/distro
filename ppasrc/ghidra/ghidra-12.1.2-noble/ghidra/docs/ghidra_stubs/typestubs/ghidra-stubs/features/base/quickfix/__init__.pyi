...
class QuickFix(java.lang.Object):
    ...
    @typing.overload
    def setStatus(self, status: QuickFixStatus) -> None:
        """
    ...
    @typing.overload
    def setStatus(self, status: QuickFixStatus, message: typing.Union[java.lang.String, str]) -> None:
        """
...
class QuickFixTableProvider(docking.ComponentProvider):
    """
    ...
    class ApplyItemsTask(ghidra.program.util.ProgramTask):
        ...
        def __init__(self, program: ghidra.program.model.listing.Program, title: typing.Union[java.lang.String, str], quickFixList: java.util.List[QuickFix]) -> None:
            ...
    ...
    class QuickFixGhidraTable(ghidra.util.table.GhidraTable):
        ...
        def __init__(self, model: docking.widgets.table.threaded.ThreadedTableModel[QuickFix, typing.Any]) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, title: typing.Union[java.lang.String, str], owner: typing.Union[java.lang.String, str], program: ghidra.program.model.listing.Program, loader: TableDataLoader[QuickFix]) -> None:
        ...

    def applySelected(self) -> None:
        """
    ...
    def setSelection(self, start: typing.Union[jpype.JInt, int], end: typing.Union[jpype.JInt, int]) -> None:
        """
...
class TableDataLoader(java.lang.Object, typing.Generic[T]):
    ...
    def loadData(self, accumulator: ghidra.util.datastruct.Accumulator[T], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
__all__ = ["QuickFix", "QuickFixTableProvider", "TableDataLoader", "QuickFixTableModel", "QuickFixStatusRenderer", "QuickFixStatus"]
