...
class TripleSymbol(Symbol):
    ...
    def printList(self, walker: ghidra.app.plugin.processors.sleigh.ParserWalker, list: java.util.ArrayList[java.lang.Object]) -> None:
        ...
...
class SymbolScope(java.lang.Object):
    ...
    def addSymbol(self, a: Symbol) -> None:
        ...
