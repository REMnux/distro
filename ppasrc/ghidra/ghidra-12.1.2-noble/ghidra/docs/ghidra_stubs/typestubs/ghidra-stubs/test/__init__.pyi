...
import com.sun.net.httpserver # type: ignore
import docking
...
class AbstractProgramBasedTest(AbstractGhidraHeadedIntegrationTest):
    ...
    def assertCurrentAddress(self, expected: ghidra.program.model.address.Address) -> None:
        ...
    ...
    @typing.overload
    def goTo(self, offset: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def goTo(self, offset: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def goTo(self, a: ghidra.program.model.address.Address) -> None:
        ...

    def modifyProgram(self, callback: utility.function.ExceptionalConsumer[ghidra.program.model.listing.Program, E]) -> None:
        """
        Provides a convenient method for modifying the current program, handling the transaction
        logic.
    ...
    def showProvider(self, name: typing.Union[java.lang.String, str]) -> None:
        ...
...
class TestTool(ghidra.framework.project.tool.GhidraTool):
    ...
    def __init__(self, project: ghidra.framework.model.Project) -> None:
        ...


class MockHttpServerUtils(java.lang.Object):

    class_: typing.ClassVar[java.lang.Class]
    CONTENT_TYPE_HEADER: typing.Final = "Content-Type"

    def __init__(self) -> None:
        ...

    @staticmethod
    def assertContentType(expectedType: typing.Union[java.lang.String, str], httpExchange: com.sun.net.httpserver.HttpExchange) -> None:
        """
        Asserts that the specified :obj:`HttpExchange` has a specific content type header.
        
        :param java.lang.String or str expectedType: example: "application/json"
        :param com.sun.net.httpserver.HttpExchange httpExchange: :obj:`HttpExchange`
        """

    @staticmethod
    def createMockHttpServer() -> com.sun.net.httpserver.HttpServer:
        """
        Creates an HttpServer, listening on localhost and a unique unused port number.
         
        
        Use :meth:`HttpServer.createContext(String, HttpHandler) <HttpServer.createContext>` to add handlers for specific
        paths.
        
        :return: new :obj:`HttpServer`
        :rtype: com.sun.net.httpserver.HttpServer
        :raises IOException: if unused port is not found
        """

    @staticmethod
    @typing.overload
    def createStaticResponseHandler(contentType: typing.Union[java.lang.String, str], resultBody: jpype.JArray[jpype.JByte]) -> com.sun.net.httpserver.HttpHandler:
        """
        Creates a HttpHandler that returns a specified body
        
        :param java.lang.String or str contentType: http content type header value (eg. "text/plain")
        :param jpype.JArray[jpype.JByte] resultBody: bytes to send as body
        :return: new HttpHandler
        :rtype: com.sun.net.httpserver.HttpHandler
        """

    @staticmethod
    @typing.overload
    def createStaticResponseHandler(resultCode: typing.Union[jpype.JInt, int], contentType: typing.Union[java.lang.String, str], resultBody: jpype.JArray[jpype.JByte]) -> com.sun.net.httpserver.HttpHandler:
        """
        Creates a HttpHandler that returns a specified body and result code.
        
        :param jpype.JInt or int resultCode: http result code to return (eg. HTTP_OK / 200 )
        :param java.lang.String or str contentType: http content type header value (eg. "text/plain")
        :param jpype.JArray[jpype.JByte] resultBody: bytes to send as body
        :return: new HttpHandler
        :rtype: com.sun.net.httpserver.HttpHandler
    ...
    @staticmethod
    def getURI(addr: java.net.InetSocketAddress) -> java.net.URI:
        """
        Convert a mock http server's address to a URL
        
        :param java.net.InetSocketAddress addr: :obj:`InetSocketAddress`
        :return: http connection URI, example "http://127.0.0.1:9999"
        :rtype: java.net.URI
        """

    @staticmethod
    def logMockHttp(httpExchange: com.sun.net.httpserver.HttpExchange, msg: typing.Union[java.lang.String, str]) -> None:
        """
        Logs (using Msg.info) a message using information from the http connection as a prefix
        
        :param com.sun.net.httpserver.HttpExchange httpExchange: :obj:`HttpExchange`
        :param java.lang.String or str msg: string message
        """

    @staticmethod
    def mock404Handler(httpExchange: com.sun.net.httpserver.HttpExchange) -> None:
        """
        A handler that always returns a 404.  Use this as the target of a lambda.  This matches
        the :meth:`HttpHandler.handle(HttpExchange) <HttpHandler.handle>` method signature.
    ...
    @staticmethod
    def nextLoopbackServerAddr() -> java.net.InetSocketAddress:
        """
        :return: the next hopefully unused localhost socket addr
        :rtype: java.net.InetSocketAddress
        """

    @staticmethod
    def wrapHandlerWithDelay(delegate: com.sun.net.httpserver.HttpHandler, delayMS: typing.Union[jpype.JInt, int]) -> com.sun.net.httpserver.HttpHandler:
        """
        Adds a delay to a handler.
        
        :param com.sun.net.httpserver.HttpHandler delegate: :obj:`HttpHandler` to wrap
        :param jpype.JInt or int delayMS: milliseconds to delay before allowing the delegate to process the request
        :return: new HttpHandler that wraps the specified delegate
        :rtype: com.sun.net.httpserver.HttpHandler
        """

    @staticmethod
    def wrapHandlerWithRetryError(delegate: com.sun.net.httpserver.HttpHandler, errorCount: typing.Union[jpype.JInt, int], errorStatus: typing.Union[jpype.JInt, int]) -> com.sun.net.httpserver.HttpHandler:
        ...
...
class AbstractGhidraHeadedIntegrationTest(AbstractGhidraHeadlessIntegrationTest):
    ...
    @typing.overload
    def click(self, codeBrowser: ghidra.app.plugin.core.codebrowser.AbstractCodeBrowserPlugin[typing.Any], clickCount: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def click(self, codeBrowser: ghidra.app.plugin.core.codebrowser.AbstractCodeBrowserPlugin[typing.Any], clickCount: typing.Union[jpype.JInt, int], wait: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    @staticmethod
    def waitForBusyTool(tool: ghidra.framework.plugintool.PluginTool) -> None:
        """
    ...
    @staticmethod
    def waitForProgram(program: ghidra.program.model.listing.Program) -> None:
        """
...
class TestProgramManager(java.lang.Object):
    ...
    def removeAllConsumersExcept(self, p: ghidra.program.model.listing.Program, consumer: java.lang.Object) -> None:
        ...

    def removeFromProgramCache(self, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def saveToCache(self, progName: typing.Union[java.lang.String, str], program: ghidra.program.database.ProgramDB, replace: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @staticmethod
    def setDbTestDir(newDbTestDir: jpype.protocol.SupportsPath) -> None:
        ...
...
class TestEnv(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, projectName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor for Ghidra
    ...
    @typing.overload
    def __init__(self, abortTimeout: typing.Union[jpype.JLong, int], projectName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor for Ghidra
        A new test project is established using the specified projectName.
        If it already exists it will first be deleted.
    ...
    @typing.overload
    def closeTool(self, toolToClose: ghidra.framework.plugintool.PluginTool, ignoreChanges: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def removeFromProgramCache(self, programName: typing.Union[java.lang.String, str]) -> None:
        """
        Remove specified program from cache
    ...
    def setAutoSaveEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class AbstractGhidraHeadlessIntegrationTest(docking.test.AbstractDockingTest):
    ...
    def clearSelection(self, tool: ghidra.framework.plugintool.PluginTool, p: ghidra.program.model.listing.Program) -> None:
        ...
    ...
    def debugProgramInTool(self, p: ghidra.program.model.listing.Program, address: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def goTo(self, tool: ghidra.framework.plugintool.PluginTool, p: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address) -> None:
        ...

    @typing.overload
    def goTo(self, tool: ghidra.framework.plugintool.PluginTool, p: ghidra.program.model.listing.Program, addrString: typing.Union[java.lang.String, str]) -> None:
        ...

    @typing.overload
    def makeSelection(self, tool: ghidra.framework.plugintool.PluginTool, p: ghidra.program.model.listing.Program, addrs: java.util.List[ghidra.program.model.address.Address]) -> None:
        ...

    @typing.overload
    def makeSelection(self, tool: ghidra.framework.plugintool.PluginTool, p: ghidra.program.model.listing.Program, from_: ghidra.program.model.address.Address, to: ghidra.program.model.address.Address) -> None:
        ...

    @typing.overload
    def makeSelection(self, tool: ghidra.framework.plugintool.PluginTool, p: ghidra.program.model.listing.Program, *ranges: ghidra.program.model.address.AddressRange) -> None:
        ...

    @typing.overload
    def makeSelection(self, tool: ghidra.framework.plugintool.PluginTool, p: ghidra.program.model.listing.Program, addresses: ghidra.program.model.address.AddressSetView) -> None:
        ...

    @staticmethod
    @typing.overload
    def modifyProgram(p: ghidra.program.model.listing.Program, c: utility.function.ExceptionalCallback[E]) -> None:
        """
        Provides a convenient method for modifying the current program, handling the transaction
    ...
    @staticmethod
    @typing.overload
    def redo(dobj: ghidra.framework.model.DomainObject, wait: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def redo(dobj: ghidra.framework.model.DomainObject) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def redo(dobj: ghidra.framework.model.DomainObject, count: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    def replaceService(tool: ghidra.framework.plugintool.PluginTool, service: java.lang.Class[T], replacement: T) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def tx(dobj: ghidra.framework.model.DomainObject, c: utility.function.ExceptionalCallback[E]) -> None:
        """
        Provides a convenient method for modifying the current program, handling the transaction
        logic.
    ...
    @staticmethod
    @typing.overload
    def tx(dtm: ghidra.program.model.data.DataTypeManager, c: utility.function.ExceptionalCallback[E]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def tx(dobj: ghidra.framework.model.DomainObject, s: utility.function.ExceptionalSupplier[T, E]) -> T:
        """
        Provides a convenient method for modifying the current program, handling the transaction
        logic and returning a result.
        
        :param T: the return type:param E: the exception type:param ghidra.framework.model.DomainObject dobj: the program or other domain object
    ...
    @staticmethod
    @typing.overload
    def undo(dobj: ghidra.framework.model.DomainObject, wait: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def undo(dobj: ghidra.framework.model.DomainObject, name: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def undo(dobj: ghidra.framework.model.DomainObject) -> None:
        """
        Undo the last transaction on the domain object and wait for all events to be flushed.
    ...
    @staticmethod
    @typing.overload
    def undo(dobj: ghidra.framework.model.DomainObject, count: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def waitForScriptCompletion(self, listener: ScriptTaskListener, timeoutMS: typing.Union[jpype.JLong, int]) -> None:
        """
...
class ToyProgramBuilder(ghidra.program.database.ProgramBuilder):
    ...
    def __init__(self) -> None:
        ...
        :raises java.lang.Exception: if there are any exceptions
        """

    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], bigEndian: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], bigEndian: typing.Union[jpype.JBoolean, bool], consumer: java.lang.Object) -> None:
        """
        Construct toy program builder using toy language "builder" variant.
        This builder will be the program consumer and must be disposed
        ...
        :param java.lang.String or str name: program name
        :param jpype.JBoolean or bool bigEndian: language endianness
        :param java.lang.Object consumer: program consumer (if null this builder will be used as consumer and must be 
        disposed to release program)
        :raises java.lang.Exception: if there are any exceptions
        """

    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], bigEndian: typing.Union[jpype.JBoolean, bool], wordAligned: typing.Union[jpype.JBoolean, bool], consumer: java.lang.Object) -> None:
        """
        Construct toy program builder using toy language "builder" variant.
        This builder will be the program consumer and must be disposed
        ...
        :param java.lang.String or str name: program name
        :param jpype.JBoolean or bool bigEndian: language endianness
        :param jpype.JBoolean or bool wordAligned: true if word aligned
        :param java.lang.Object consumer: program consumer (if null this builder will be used as consumer and must be 
        disposed to release program)
        :raises java.lang.Exception: if there are any exceptions
        """
    ...
    @typing.overload
    def addBytesBadInstruction(self, offset: typing.Union[jpype.JLong, int]) -> None:
        """
        ...
        :raises MemoryAccessException: shouldn't happen
        """

    @typing.overload
    def addBytesBadInstruction(self, addr: typing.Union[java.lang.String, str]) -> None:
        """
        Add BAD instruction (consumes 2-bytes).  Location will not be added to
        defined instruction address list.
    ...
    @typing.overload
    def addBytesBranch(self, offset: typing.Union[jpype.JLong, int], dest: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesBranch(self, addr: typing.Union[java.lang.String, str], destAddr: typing.Union[java.lang.String, str]) -> None:
        """
        Add branch (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesBranchConditional(self, offset: typing.Union[jpype.JLong, int], dest: typing.Union[jpype.JLong, int]) -> None:
        """
        Add branch (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesBranchConditional(self, addr: typing.Union[java.lang.String, str], destAddr: typing.Union[java.lang.String, str]) -> None:
        """
        Add branch (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesBranchWithDelaySlot(self, offset: typing.Union[jpype.JLong, int], dest: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesBranchWithDelaySlot(self, addr: typing.Union[java.lang.String, str], destAddr: typing.Union[java.lang.String, str]) -> None:
        """
        Add branch w/ delay slot (consumes 4-bytes)
    ...
    @typing.overload
    def addBytesCall(self, offset: typing.Union[jpype.JLong, int], dest: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesCall(self, offset: typing.Union[java.lang.String, str], dest: typing.Union[jpype.JLong, int]) -> None:
        """
        Add call (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesCall(self, addr: typing.Union[java.lang.String, str], destAddr: typing.Union[java.lang.String, str]) -> None:
        """
        Add call (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesCallWithDelaySlot(self, offset: typing.Union[jpype.JLong, int], dest: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesCallWithDelaySlot(self, addr: typing.Union[java.lang.String, str], destAddr: typing.Union[java.lang.String, str]) -> None:
        """
        Add call w/ delayslot (consumes 4-bytes)
    ...
    @typing.overload
    def addBytesCopInstruction(self, offset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesCopInstruction(self, addr: typing.Union[java.lang.String, str]) -> None:
        """
        Add COP instruction for exercising nfctx context (consumes 2-bytes).  Location will not be added to
        defined instruction address list.
    ...
    @typing.overload
    def addBytesFallthrough(self, offset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesFallthrough(self, addr: typing.Union[java.lang.String, str]) -> None:
        """
        Add simple fall-through (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesFallthroughSetFlowContext(self, offset: typing.Union[jpype.JLong, int], ctxVal: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesFallthroughSetFlowContext(self, addr: typing.Union[java.lang.String, str], ctxVal: typing.Union[jpype.JInt, int]) -> None:
        """
        Add simple fall-through which sets flowing context value on next instruction (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesFallthroughSetNoFlowContext(self, offset: typing.Union[jpype.JLong, int], ctxVal: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesFallthroughSetNoFlowContext(self, addr: typing.Union[java.lang.String, str], ctxVal: typing.Union[jpype.JInt, int]) -> None:
        """
        Add simple fall-through which sets noflow context value on next instruction (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesFallthroughSetNoFlowContext(self, offset: typing.Union[jpype.JLong, int], ctxVal: typing.Union[jpype.JInt, int], target: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesFallthroughSetNoFlowContext(self, addr: typing.Union[java.lang.String, str], ctxVal: typing.Union[jpype.JInt, int], targetAddr: typing.Union[java.lang.String, str]) -> None:
        """
        Add simple fall-through which sets noflow context value on target address (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesLoad(self, offset: typing.Union[jpype.JLong, int], srcRegIndex: typing.Union[jpype.JInt, int], destRegIndex: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesLoad(self, addr: typing.Union[java.lang.String, str], srcRegIndex: typing.Union[jpype.JInt, int], destRegIndex: typing.Union[jpype.JInt, int]) -> None:
        """
        Add load indirect (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesMoveImmediate(self, offset: typing.Union[jpype.JLong, int], imm: typing.Union[jpype.JShort, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesMoveImmediate(self, addr: typing.Union[java.lang.String, str], imm: typing.Union[jpype.JShort, int]) -> None:
        """
        Add move immediate instruction (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesNOP(self, offset: typing.Union[jpype.JLong, int], length: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesNOP(self, addr: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int]) -> None:
        """
        Add NOP instruction bytes of specified byte length
    ...
    @typing.overload
    def addBytesReturn(self, offset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesReturn(self, addr: typing.Union[java.lang.String, str]) -> None:
        """
        Add terminal/return (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesSkipConditional(self, offset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesSkipConditional(self, addr: typing.Union[java.lang.String, str]) -> None:
        """
        Add conditional skip (consumes 2-bytes)
    ...
    @typing.overload
    def addBytesStore(self, offset: typing.Union[jpype.JLong, int], srcRegIndex: typing.Union[jpype.JInt, int], destRegIndex: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def addBytesStore(self, addr: typing.Union[java.lang.String, str], srcRegIndex: typing.Union[jpype.JInt, int], destRegIndex: typing.Union[jpype.JInt, int]) -> None:
        """
        Add store indirect (consumes 2-bytes)
    ...
    @staticmethod
    def buildSimpleProgram(programName: typing.Union[java.lang.String, str], consumer: java.lang.Object) -> ghidra.program.model.listing.Program:
        """
        ...
        :param java.lang.Object consumer: object consumer responsible for releasing the returned program
        :return: new in-memory program instance
        :rtype: ghidra.program.model.listing.Program
        :raises java.lang.Exception: if an error occurs
        """

    def createCallInstruction(self, address: typing.Union[java.lang.String, str], callAddress: typing.Union[java.lang.String, str]) -> None:
        ...

    def createConditionalJmpInstruction(self, address: typing.Union[java.lang.String, str], destAddress: typing.Union[java.lang.String, str]) -> None:
        ...

    def createJmpInstruction(self, address: typing.Union[java.lang.String, str], destAddress: typing.Union[java.lang.String, str]) -> None:
        ...

    def createJmpWithDelaySlot(self, address: typing.Union[java.lang.String, str], destAddress: typing.Union[java.lang.String, str]) -> None:
        ...

    def createNOPInstruction(self, address: typing.Union[java.lang.String, str], size: typing.Union[jpype.JInt, int]) -> None:
        ...

    def createReturnInstruction(self, address: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ClassicSampleX86ProgramBuilder(ghidra.program.database.ProgramBuilder):
    ...
    @typing.overload
    def __init__(self, disableAnalysis: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct sample program builder using the x86 language and default compiler spec.
        A set of predefined memory bytes, code units and functions will be added.
        This builder object will be the program consumer and must be disposed to properly
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], disableAnalysis: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Construct sample program builder using the x86 language and default compiler spec.
        A set of predefined memory bytes, code units and functions will be added.
        This builder object will be the program consumer and must be disposed to properly
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], disableAnalysis: typing.Union[jpype.JBoolean, bool], consumer: java.lang.Object) -> None:
        """
        Construct sample program builder using the x86 language and default compiler spec.
        A set of predefined memory bytes, code units and functions will be added.
...
__all__ = ["AbstractProgramBasedTest", "TestTool", "MockHttpServerUtils", "AbstractGhidraHeadedIntegrationTest", "TestProgramManager", "TestEnv", "TestProcessorConstants", "AbstractGhidraHeadlessIntegrationTest", "ToyProgramBuilder", "ClassicSampleX86ProgramBuilder", "ProjectTestUtils", "ScriptTaskListener"]
