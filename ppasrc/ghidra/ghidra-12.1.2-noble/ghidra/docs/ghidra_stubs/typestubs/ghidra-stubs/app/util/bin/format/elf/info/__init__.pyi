...
class GnuBuildAttribute(ElfInfoItem):
    """
    ...
    class ValueType(java.lang.Enum[GnuBuildAttribute.ValueType]):

        class_: typing.ClassVar[java.lang.Class]
        NUMERIC: typing.Final[GnuBuildAttribute.ValueType]
        STRING: typing.Final[GnuBuildAttribute.ValueType]
        BOOLEAN_FALSE: typing.Final[GnuBuildAttribute.ValueType]
        BOOLEAN_TRUE: typing.Final[GnuBuildAttribute.ValueType]

        def getAbbr(self) -> str:
            ...

        @staticmethod
        def of(ch: typing.Union[jpype.JInt, int]) -> GnuBuildAttribute.ValueType:
            ...

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> GnuBuildAttribute.ValueType:
            ...

        @staticmethod
        def values() -> jpype.JArray[GnuBuildAttribute.ValueType]:
            ...

        @property
        def abbr(self) -> java.lang.String:
            ...


    @typing.type_check_only
    class AttributeId(java.lang.Enum[GnuBuildAttribute.AttributeId]):

        class_: typing.ClassVar[java.lang.Class]
        RESERVED: typing.Final[GnuBuildAttribute.AttributeId]
        VERSION: typing.Final[GnuBuildAttribute.AttributeId]
        STACK_PROT: typing.Final[GnuBuildAttribute.AttributeId]
        RELRO: typing.Final[GnuBuildAttribute.AttributeId]
        STACKSIZE: typing.Final[GnuBuildAttribute.AttributeId]
        TOOL: typing.Final[GnuBuildAttribute.AttributeId]
        ABI: typing.Final[GnuBuildAttribute.AttributeId]
        POSITION_INDEPENDENCE: typing.Final[GnuBuildAttribute.AttributeId]
        SHORT_ENUM: typing.Final[GnuBuildAttribute.AttributeId]
        RESERVED1: typing.Final[GnuBuildAttribute.AttributeId]
        STRINGVAL: typing.Final[GnuBuildAttribute.AttributeId]
        RESERVED2: typing.Final[GnuBuildAttribute.AttributeId]

        def getIdVal(self) -> int:
            ...

        @staticmethod
        def of(idVal: typing.Union[jpype.JInt, int]) -> GnuBuildAttribute.AttributeId:
            ...

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> GnuBuildAttribute.AttributeId:
            ...

        @staticmethod
        def values() -> jpype.JArray[GnuBuildAttribute.AttributeId]:
            ...

        @property
        def idVal(self) -> jpype.JInt:
            ...


    @typing.type_check_only
    class AttributeType(java.lang.Enum[GnuBuildAttribute.AttributeType]):

        class_: typing.ClassVar[java.lang.Class]
        OPEN: typing.Final[GnuBuildAttribute.AttributeType]
        FUNC: typing.Final[GnuBuildAttribute.AttributeType]

        def getDescription(self) -> str:
            ...

        def getTypeInt(self) -> int:
            ...

        @staticmethod
        def of(typeInt: typing.Union[jpype.JInt, int]) -> GnuBuildAttribute.AttributeType:
            ...

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> GnuBuildAttribute.AttributeType:
            ...

        @staticmethod
        def values() -> jpype.JArray[GnuBuildAttribute.AttributeType]:
            ...

        @property
        def typeInt(self) -> jpype.JInt:
            ...
    ...
    class AddressPair(java.lang.Record):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, first: ghidra.program.model.address.Address, second: ghidra.program.model.address.Address) -> None:
            ...

        def equals(self, o: java.lang.Object) -> bool:
            ...

        def first(self) -> ghidra.program.model.address.Address:
            ...

        def hashCode(self) -> int:
            ...

        def second(self) -> ghidra.program.model.address.Address:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, nameLen: typing.Union[jpype.JInt, int], nameBytes: jpype.JArray[jpype.JByte], vendorType: typing.Union[jpype.JInt, int], description: jpype.JArray[jpype.JByte]) -> None:
        ...

    def getAttributeType(self) -> GnuBuildAttribute.AttributeType:
        ...

    def getDescription(self, program: ghidra.program.model.listing.Program) -> str:
        ...

    def getId(self) -> GnuBuildAttribute.AttributeId:
        ...

    def getIdString(self) -> str:
        ...

    def getLabel(self, program: ghidra.program.model.listing.Program) -> str:
        ...

    def getRange(self, program: ghidra.program.model.listing.Program) -> GnuBuildAttribute.AddressPair:
        ...

    def getValue(self, program: ghidra.program.model.listing.Program) -> java.lang.Object:
        ...

    @staticmethod
    def read(reader: ghidra.app.util.bin.BinaryReader) -> GnuBuildAttribute:
        """
        Reads a single :obj:`GnuBuildAttribute` from the specified stream.
        
        :param ghidra.app.util.bin.BinaryReader reader: :obj:`BinaryReader` stream
        :return: new :obj:`GnuBuildAttribute`
        :rtype: GnuBuildAttribute
        :raises IOException: if error reading
        """

    @property
    def attributeType(self) -> GnuBuildAttribute.AttributeType:
        ...

    @property
    def idString(self) -> java.lang.String:
        ...

    @property
    def range(self) -> GnuBuildAttribute.AddressPair:
        ...
    ...
    @property
    def id(self) -> GnuBuildAttribute.AttributeId:
        ...
...
class NoteGnuProperty(ElfNote):
    ...
    class NotePropertyElement(java.lang.Record):
        ...
        def __init__(self, type: typing.Union[jpype.JInt, int], typeName: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str], length: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def __init__(self, nameLen: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str], vendorType: typing.Union[jpype.JInt, int], elements: java.util.List[NoteGnuProperty.NotePropertyElement]) -> None:
        """
...
class NoteAbiTag(ElfNote):
    ...
    def __init__(self, nameLen: typing.Union[jpype.JInt, int], name: typing.Union[java.lang.String, str], vendorType: typing.Union[jpype.JInt, int], abiType: typing.Union[jpype.JInt, int], requiredKernelVersion: jpype.JArray[jpype.JInt]) -> None:
        ...
...
class GnuDebugLink(ElfInfoItem):
    ...
    def __init__(self, filenameLen: typing.Union[jpype.JInt, int], filename: typing.Union[java.lang.String, str], crc: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class GnuDebugAltLink(ElfInfoItem):
    """
    An ELF section (almost like a :obj:`ElfNote`) that contains information about an external
    DWARF debug file.
    ...
    class_: typing.ClassVar[java.lang.Class]
    SECTION_NAME: typing.Final = ".gnu_debugaltlink"

    def __init__(self, filenameLen: typing.Union[jpype.JInt, int], filename: typing.Union[java.lang.String, str], hashBytes: jpype.JArray[jpype.JByte]) -> None:
        ...

    @staticmethod
    def fromProgram(program: ghidra.program.model.listing.Program) -> GnuDebugAltLink:
        """
        Reads a GnuDebugAltLink from the standard ".gnu_debugaltlink" section in the specified Program.
        
        :param ghidra.program.model.listing.Program program: Program to read from
        :return: new instance, or null if not found or data error
        :rtype: GnuDebugAltLink
        """
    ...
    def getHashBytes(self) -> jpype.JArray[jpype.JByte]:
        ...

    @staticmethod
    def read(br: ghidra.app.util.bin.BinaryReader, program: ghidra.program.model.listing.Program) -> GnuDebugAltLink:
        """
    ...
    @property
    def hashBytes(self) -> jpype.JArray[jpype.JByte]:
        ...
    ...
    @property
    def hash(self) -> java.lang.String:
        ...
...
class ElfComment(ElfInfoItem):
    ...
    def __init__(self, commentStrings: java.util.List[java.lang.String], commentStringLengths: java.util.List[java.lang.Integer]) -> None:
        ...
...
class ElfInfoItem(java.lang.Object):
    ...
    class ItemWithAddress(java.lang.Record, typing.Generic[T]):
        ...
        def __init__(self, item: T, address: ghidra.program.model.address.Address) -> None:
            ...
    ...
    @staticmethod
    def markupElfInfoItemSection(program: ghidra.program.model.listing.Program, sectionName: typing.Union[java.lang.String, str], readFunc: ElfInfoItem.ReaderFunc[ElfInfoItem]) -> None:
        """
...
class GnuBuildAttributes(ElfInfoItem):
    """
    Represents a sequence of :obj:`GnuBuildAttribute` elements, typically found in the
    ".gnu.build.attributes" section.
    """

    class AttributeWithOffset(java.lang.Record):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, offset: typing.Union[jpype.JLong, int], attr: GnuBuildAttribute) -> None:
            ...

        def attr(self) -> GnuBuildAttribute:
            ...
    ...
    class_: typing.ClassVar[java.lang.Class]
    SECTION_NAME: typing.Final = ".gnu.build.attributes"

    def __init__(self, items: java.util.List[GnuBuildAttributes.AttributeWithOffset]) -> None:
        ...

    @staticmethod
    def read(reader: ghidra.app.util.bin.BinaryReader, program: ghidra.program.model.listing.Program) -> GnuBuildAttributes:
        """
        Reads a sequence of :obj:`GnuBuildAttribute` elements and returns them as a 
        :obj:`GnuBuildAttributes` instance.
        
        :param ghidra.app.util.bin.BinaryReader reader: :obj:`BinaryReader`
        :param ghidra.program.model.listing.Program program: :obj:`Program`
        :return: :obj:`GnuBuildAttributes`
        :rtype: GnuBuildAttributes
        """



__all__ = ["ElfInfoProducer", "GnuBuildAttribute", "NoteGnuBuildId", "StandardElfInfoProducer", "NoteGnuProperty", "NoteAbiTag", "GnuDebugLink", "ElfNote", "GnuDebugAltLink", "ElfComment", "ElfInfoItem", "GnuBuildAttributes"]
