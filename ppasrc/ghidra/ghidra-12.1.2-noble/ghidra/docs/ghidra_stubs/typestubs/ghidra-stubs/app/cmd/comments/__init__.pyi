...
class AppendCommentCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, commentType: typing.Union[jpype.JInt, int], comment: typing.Union[java.lang.String, str], separator: typing.Union[java.lang.String, str]) -> None:
        """
        Construct command
    ...
    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, commentType: ghidra.program.model.listing.CommentType, comment: typing.Union[java.lang.String, str], separator: typing.Union[java.lang.String, str]) -> None:
        """
        Construct command
...
class SetCommentCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    @typing.overload
    @deprecated("Use SetCommentCmd(Address, CommentType, String) instead")
    def __init__(self, addr: ghidra.program.model.address.Address, commentType: typing.Union[jpype.JInt, int], comment: typing.Union[java.lang.String, str]) -> None:
        """
        Construct command
        ...
        Use :meth:`SetCommentCmd(Address, CommentType, String) <.SetCommentCmd>` instead
        """

    @typing.overload
    def __init__(self, addr: ghidra.program.model.address.Address, commentType: ghidra.program.model.listing.CommentType, comment: typing.Union[java.lang.String, str]) -> None:
        """
        Construct command
    ...
    def createComment(program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, comment: typing.Union[java.lang.String, str], commentType: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def createComment(program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, comment: typing.Union[java.lang.String, str], commentType: ghidra.program.model.listing.CommentType) -> None:
        """
        Creates the specified comment of the specified type at address.  The current comment of
        this commentType will be cleared.
...
class CodeUnitInfoPasteCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, startAddr: ghidra.program.model.address.Address, infoList: java.util.List[ghidra.app.util.CodeUnitInfo], pasteLabels: typing.Union[jpype.JBoolean, bool], pasteComments: typing.Union[jpype.JBoolean, bool]) -> None:
        """
