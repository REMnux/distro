...
class FileSystemFactoryDependencyException(java.io.IOException):
    """
    An :obj:`IOException` that signals that there was a problem opening a file system because
...
class GFileSystemBaseFactory(GFileSystemFactoryByteProvider[ghidra.formats.gfilesystem.GFileSystemBase], GFileSystemProbeByteProvider):
    ...
    def setFileSystemClass(self, fsClass: java.lang.Class[ghidra.formats.gfilesystem.GFileSystemBase]) -> None:
        ...
...
class FileSystemFactoryMgr(java.lang.Object):
    ...
    def test(self, byteProvider: ghidra.app.util.bin.ByteProvider, fsService: ghidra.formats.gfilesystem.FileSystemService, monitor: ghidra.util.task.TaskMonitor) -> bool:
        ...
        :param ghidra.app.util.bin.ByteProvider byteProvider: container :obj:`ByteProvider`
        :param ghidra.formats.gfilesystem.FileSystemService fsService: reference to the :obj:`FileSystemService` instance.
        :param ghidra.util.task.TaskMonitor monitor: :obj:`TaskMonitor` to use for canceling and updating progress.
...
__all__ = ["GFileSystemProbeBytesOnly", "FileSystemFactoryDependencyException", "GFileSystemBaseFactory", "FileSystemFactoryMgr", "GFileSystemProbeByteProvider", "GFileSystemFactory", "GFileSystemFactoryIgnore", "GFileSystemFactoryByteProvider", "GFileSystemProbe", "FileSystemInfoRec"]
