...
class ElfRelocationContext(java.lang.Object, typing.Generic[H]):
    ...
    def markRelocationError(self, relocationAddress: ghidra.program.model.address.Address, typeId: typing.Union[jpype.JInt, int], symbolIndex: typing.Union[jpype.JInt, int], symbolName: typing.Union[java.lang.String, str], msg: typing.Union[java.lang.String, str]) -> None:
        """
...
class ElfRelocationHandler(ghidra.util.classfinder.ExtensionPoint):
    ...
    @staticmethod
    def applyComponentOffsetPointer(program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentOffset: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @staticmethod
    def bookmarkNoHandlerError(program: ghidra.program.model.listing.Program, relocationAddress: ghidra.program.model.address.Address, typeId: typing.Union[jpype.JInt, int], symbolIndex: typing.Union[jpype.JInt, int], symbolName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    def bookmarkUnsupportedRelr(program: ghidra.program.model.listing.Program, relocationAddress: ghidra.program.model.address.Address, symbolIndex: typing.Union[jpype.JInt, int], symbolName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def markAsError(program: ghidra.program.model.listing.Program, relocationAddress: ghidra.program.model.address.Address, typeId: typing.Union[jpype.JLong, int], symbolName: typing.Union[java.lang.String, str], msg: typing.Union[java.lang.String, str], log: ghidra.app.util.importer.MessageLog) -> None:
        """
        Generate error log entry and bookmark at relocationAddress
    ...
    @staticmethod
    @typing.overload
    def markAsError(program: ghidra.program.model.listing.Program, relocationAddress: ghidra.program.model.address.Address, type: typing.Union[java.lang.String, str], symbolName: typing.Union[java.lang.String, str], msg: typing.Union[java.lang.String, str], log: ghidra.app.util.importer.MessageLog) -> None:
        """
        Generate error log entry and bookmark at relocationAddress
    ...
    @staticmethod
    def markAsUnhandled(program: ghidra.program.model.listing.Program, relocationAddress: ghidra.program.model.address.Address, typeId: typing.Union[jpype.JLong, int], symbolIndex: typing.Union[jpype.JLong, int], symbolName: typing.Union[java.lang.String, str], log: ghidra.app.util.importer.MessageLog) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def markAsWarning(program: ghidra.program.model.listing.Program, relocationAddress: ghidra.program.model.address.Address, type: typing.Union[java.lang.String, str], msg: typing.Union[java.lang.String, str], log: ghidra.app.util.importer.MessageLog) -> None:
        """
...
class ElfGotRelocationContext(ElfRelocationContext[H], typing.Generic[H]):
    """
    ...
    def getGotEntryAddress(self, elfSymbol: ghidra.app.util.bin.format.elf.ElfSymbol) -> ghidra.program.model.address.Address:
        """
    ...
    @property
    def gotEntryAddress(self) -> ghidra.program.model.address.Address:
        ...
...
__all__ = ["ElfRelocationContext", "ElfRelocationType", "ElfRelocationHandler", "ElfGotRelocationContext", "ElfRelocationHandlerFactory", "AbstractElfRelocationHandler"]
