...
class TableScoreCaching(ScoreCaching):
    ...
    def __init__(self, d: ghidra.features.bsim.query.FunctionDatabase) -> None:
        ...
...
class IDSQLResolution(java.lang.Object):
    ...
    class ExeCategory(IDSQLResolution):
        ...
        def __init__(self, cat: typing.Union[java.lang.String, str], val: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    class ExternalFunction(IDSQLResolution):
        ...
        def __init__(self, exe: typing.Union[java.lang.String, str], func: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    def resolve(self, columnDatabase: AbstractSQLFunctionDatabase[typing.Any], exe: ghidra.features.bsim.query.description.ExecutableRecord) -> None:
        ...
...
class SQLEffects(java.lang.Object):
    ...
    def addFunctionFilter(self, flag: typing.Union[jpype.JInt, int], val: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def addLink(self, value: typing.Union[java.lang.String, str]) -> None:
        ...

    def addWhere(self, filter: ghidra.features.bsim.gui.filters.BSimFilterType, val: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ExecutableComparison(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, database: ghidra.features.bsim.query.FunctionDatabase, hitCountThreshold: typing.Union[jpype.JInt, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @typing.overload
    def __init__(self, database: ghidra.features.bsim.query.FunctionDatabase, hitCountThreshold: typing.Union[jpype.JInt, int], md5: typing.Union[java.lang.String, str], cache: ScoreCaching, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def addAllExecutables(self, limit: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def addExecutable(self, md5: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def resetThresholds(self, simThreshold: typing.Union[jpype.JDouble, float], sigThreshold: typing.Union[jpype.JDouble, float]) -> None:
        """
...
class ExecutableScorer(java.lang.Object):
    ...
    class FunctionPair(java.lang.Comparable[ExecutableScorer.FunctionPair]):
        ...
        def __init__(self, a: ghidra.features.bsim.query.description.FunctionDescription, b: ghidra.features.bsim.query.description.FunctionDescription, sim: typing.Union[jpype.JDouble, float], sig: typing.Union[jpype.JDouble, float]) -> None:
            ...
    ...
    def resetStorage(self, simThresh: typing.Union[jpype.JDouble, float], sigThresh: typing.Union[jpype.JDouble, float]) -> None:
        """
    ...
    def setSingleExecutable(self, md5: typing.Union[java.lang.String, str]) -> None:
        """
...
class BSimSqlClause(java.lang.Record):
    ...
    def __init__(self, tableClause: typing.Union[java.lang.String, str], whereClause: typing.Union[java.lang.String, str]) -> None:
        ...
...
class RowKeySQL(ghidra.features.bsim.query.description.RowKey):
    ...
    def __init__(self, i: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class AbstractSQLFunctionDatabase(ghidra.features.bsim.query.SQLFunctionDatabase, typing.Generic[VF]):
    ...
    @staticmethod
    def appendEscapedLiteral(buf: java.lang.StringBuilder, str: typing.Union[java.lang.String, str]) -> None:
        """
...
class PostgresFunctionDatabase(AbstractSQLFunctionDatabase[generic.lsh.vector.WeightedLSHCosineVectorFactory]):
    ...
    def __init__(self, postgresUrl: java.net.URL, async_: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class ScoreCaching(java.lang.Object):
    ...
    def commitSelfScore(self, md5: typing.Union[java.lang.String, str], score: typing.Union[jpype.JFloat, float]) -> None:
        """
    ...
    def prefetchScores(self, exeSet: java.util.Set[ghidra.features.bsim.query.description.ExecutableRecord], missing: java.util.List[ghidra.features.bsim.query.description.ExecutableRecord]) -> None:
        """
...
class Configuration(java.lang.Object):
    ...
    def loadTemplate(self, rootPath: generic.jar.ResourceFile, filename: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ExecutableScorerSingle(ExecutableScorer):
    ...
    def __init__(self, cache: ScoreCaching) -> None:
        """
    ...
    def prefetchSelfScores(self, missing: java.util.List[ghidra.features.bsim.query.description.ExecutableRecord]) -> None:
        """
...
__all__ = ["CancelledSQLException", "TableScoreCaching", "TemporaryScoreCaching", "IDSQLResolution", "SQLEffects", "ExecutableComparison", "IdHistogram", "NoDatabaseException", "FileScoreCaching", "ExecutableScorer", "BSimSqlClause", "RowKeySQL", "AbstractSQLFunctionDatabase", "PostgresFunctionDatabase", "ScoreCaching", "Configuration", "ExecutableScorerSingle"]
