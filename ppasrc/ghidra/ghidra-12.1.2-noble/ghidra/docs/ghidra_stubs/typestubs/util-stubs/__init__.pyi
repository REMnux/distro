...
class HistoryList(java.lang.Object, typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, size: typing.Union[jpype.JInt, int], itemSelectedCallback: java.util.function.Consumer[T]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, size: typing.Union[jpype.JInt, int], itemSelectedCallback: java.util.function.BiConsumer[T, T]) -> None:
        """
        The sized passed here limits the size of the list, with the oldest items being dropped
        as the list grows.  The given callback will be called when :meth:`goBack() <.goBack>` or 
        :meth:`goForward() <.goForward>` are called.
    ...
    def setAllowDuplicates(self, allowDuplicates: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setAllowNulls(self, allowNulls: typing.Union[jpype.JBoolean, bool]) -> None:
        """
