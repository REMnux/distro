...
class HelpBuildUtils(java.lang.Object):
    ...
    class HelpFilesFilter(java.io.FileFilter):
        ...
        def __init__(self, *extensions: typing.Union[java.lang.String, str]) -> None:
            ...
    ...
    @staticmethod
    def cleanupHelpFileLinks(helpFile: jpype.protocol.SupportsPath) -> None:
        ...
    ...
    @staticmethod
    def debug(text: typing.Union[java.lang.String, str]) -> None:
        ...
    ...
    @staticmethod
    def relativeTo(targetFS: jpype.protocol.SupportsPath, path: jpype.protocol.SupportsPath) -> java.nio.file.Path:
        ...

    @staticmethod
    def relativeToWorkingDir(path: jpype.protocol.SupportsPath) -> java.nio.file.Path:
        ...
...
class JavaHelpFilesBuilder(java.lang.Object):
    ...
    * Finds unused images
    ...
    def __init__(self, outputDir: jpype.protocol.SupportsPath, moduleName: typing.Union[java.lang.String, str], linkDatabase: help.validator.LinkDatabase) -> None:
        ...

    def generateHelpFiles(self, help: help.validator.location.HelpModuleCollection) -> None:
        ...
...
class HelpService(java.lang.Object):
    ...
    def clearHelp(self, helpObject: java.lang.Object) -> None:
        """
    ...
    def excludeFromHelp(self, helpObject: java.lang.Object) -> None:
        """
    ...
    def registerDynamicHelp(self, helpObject: java.lang.Object, helpLocation: ghidra.util.DynamicHelpLocation) -> None:
        """
        Registers a provider of dynamic help.  See :obj:`DynamicHelpLocation` for more information.
        
        :param java.lang.Object helpObject: the object to associate the specified help location with
        :param ghidra.util.DynamicHelpLocation helpLocation: the dynamic help location
        """

    def registerHelp(self, helpObject: java.lang.Object, helpLocation: ghidra.util.HelpLocation) -> None:
        """
    ...
    @typing.overload
    def showHelp(self, helpObject: java.lang.Object, infoOnly: typing.Union[jpype.JBoolean, bool], parent: java.awt.Component) -> None:
        """
    ...
    @typing.overload
    def showHelp(self, location: ghidra.util.HelpLocation) -> None:
        """
...
class Help(java.lang.Object):
    ...
    @staticmethod
    def installHelpService(service: HelpService) -> None:
        ...
...
class CustomSearchView(javax.help.SearchView):
    ...
    class CustomHelpSearchNavigator(javax.help.JHelpSearchNavigator):
        ...
        def __init__(self, view: javax.help.NavigatorView, model: javax.help.HelpModel) -> None:
            ...
    ...
    class CustomSearchNavigatorUI(javax.help.plaf.basic.BasicSearchNavigatorUI):
        ...
        def __init__(self, navigator: javax.help.JHelpSearchNavigator) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, hs: javax.help.HelpSet, name: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str], locale: java.util.Locale, params: java.util.Hashtable) -> None:
        ...
...
class GHelpTocValidator(java.lang.Object):
    """
...
class GHelpHTMLEditorKit(javax.swing.text.html.HTMLEditorKit):
    ...
    class GHelpImageView(javax.swing.text.html.ImageView):
        ...
        def __init__(self, elem: javax.swing.text.Element) -> None:
            ...
...
class PathKey(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, p: jpype.protocol.SupportsPath) -> None:
        ...
...
class GHelpMsg(java.lang.Object):
    """
    ...
    @staticmethod
    @typing.overload
    def error(message: typing.Union[java.lang.String, str]) -> None:
        ...

    @staticmethod
    @typing.overload
    def error(message: typing.Union[java.lang.String, str], t: java.lang.Throwable) -> None:
        ...
...
class CustomFavoritesView(javax.help.FavoritesView):
    ...
    class CustomFavoritesCellRenderer(javax.help.plaf.basic.BasicFavoritesCellRenderer):
        ...
        def __init__(self, helpModel: javax.help.HelpModel) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, hs: javax.help.HelpSet, name: typing.Union[java.lang.String, str], label: typing.Union[java.lang.String, str], params: java.util.Hashtable) -> None:
        ...
...
class JavaHelpSetBuilder(java.lang.Object):
    ...
    def __init__(self, moduleName: typing.Union[java.lang.String, str], helpMapFile: jpype.protocol.SupportsPath, helpTOCFile: jpype.protocol.SupportsPath, indexerOutputDirectory: jpype.protocol.SupportsPath, helpSetFile2: jpype.protocol.SupportsPath) -> None:
        ...

    def writeHelpSetFile(self) -> None:
        ...
...
class CustomTOCView(javax.help.TOCView):
    ...
    class CustomTOCNavigatorUI(javax.help.plaf.basic.BasicTOCNavigatorUI):
        ...
        def __init__(self, b: javax.help.JHelpTOCNavigator) -> None:
            ...
    ...
    class CustomCellRenderer(javax.help.plaf.basic.BasicTOCCellRenderer):
        ...
        def __init__(self, map: javax.help.Map, view: javax.help.TOCView) -> None:
            ...
    ...
    class CustomTreeItemDecorator(javax.help.TOCItem):
        ...
        def __init__(self, wrappedItem: javax.help.TOCItem) -> None:
            ...
...
class OverlayHelpTree(java.lang.Object):
    ...
    class OverlayNode(java.lang.Object):
        ...
        def __init__(self, parentNode: OverlayHelpTree.OverlayNode, rootItem: help.validator.model.TOCItem) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, tocItemProvider: TOCItemProvider, linkDatabase: help.validator.LinkDatabase) -> None:
        ...

    def printTreeForID(self, outputFile: jpype.protocol.SupportsPath, sourceFileID: typing.Union[java.lang.String, str]) -> None:
        ...

    def validateAllTOCs(self) -> None:
        ...



__all__ = ["HelpRightArrowIcon", "HelpBuildUtils", "JavaHelpFilesBuilder", "GHelpSet", "HelpService", "Help", "ImageLocation", "TOCConverter", "GHelpBroker", "CustomSearchView", "GHelpBuilder", "GHelpTocValidator", "GHelpHTMLEditorKit", "PathKey", "GHelpMsg", "CustomFavoritesView", "JavaHelpSetBuilder", "CustomTOCView", "HelpDescriptor", "TOCItemProvider", "OverlayHelpTree"]
