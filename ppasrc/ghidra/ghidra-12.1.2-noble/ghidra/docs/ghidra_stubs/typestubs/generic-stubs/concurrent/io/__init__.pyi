...
class IOResult(java.lang.Runnable):
    ...
    @typing.overload
    def __init__(self, inception: java.lang.Throwable, input: java.io.InputStream) -> None:
        ...
    ...
    def setConsumer(self, consumer: java.util.function.Consumer[java.lang.String]) -> None:
        ...
