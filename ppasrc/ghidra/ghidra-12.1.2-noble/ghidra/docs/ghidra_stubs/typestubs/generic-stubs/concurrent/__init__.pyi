...
class FutureTaskMonitor(java.util.concurrent.FutureTask[R], ghidra.util.task.TaskMonitor, typing.Generic[I, R]):
    ...
    class ChainedCancelledListener(ghidra.util.task.CancelledListener):
        ...
        def __init__(self, listener1: ghidra.util.task.CancelledListener, listener2: ghidra.util.task.CancelledListener) -> None:
            ...
...
class QItemListener(java.lang.Object, typing.Generic[I, R]):
    ...
    def itemProcessed(self, result: QResult[I, R]) -> None:
        """
...
class ConcurrentQ(java.lang.Object, typing.Generic[I, R]):
    ...
    **builder.setListener(itemListener);**
    ...
    QCallback<ITEM, RESULT> callback = new AbstractQCallback<ITEM, RESULT>() {    public RESULT process(ITEM item, TaskMonitor monitor) {        // do work here and create a RESULT item for later processing...    }};
    ...
    **``concurrentQ.offer(iterator); // this call will block when the queue fills up (100 items or more)``**
    ...
    @typing.overload
    def __init__(self, name: typing.Union[java.lang.String, str], callback: QCallback[I, R]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, callback: QCallback[I, R], queue: java.util.Queue[I], threadPool: GThreadPool, listener: QItemListener[I, R], collectResults: typing.Union[jpype.JBoolean, bool], maxInProgress: typing.Union[jpype.JInt, int], jobsReportProgress: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def add(self, items: collections.abc.Sequence) -> None:
        """
    ...
    @typing.overload
    def add(self, iterator: java.util.Iterator[I]) -> None:
        """
    ...
    def addProgressListener(self, listener: QProgressListener[I]) -> None:
        """
    ...
    @typing.overload
    def cancelAllTasks(self, p: java.util.function.Predicate[I], interruptRunningTasks: typing.Union[jpype.JBoolean, bool]) -> java.util.List[I]:
        """
        ...
        :param java.util.function.Predicate[I] p: the predicate that signals which jobs to cancel
        :param jpype.JBoolean or bool interruptRunningTasks: if true, an attempt will be made to interrupt any currently
        processing thread.
        :return: a list of all items that have not yet been queued to the threadPool.
        :rtype: java.util.List[I]
    ...
    def cancelScheduledJobs(self) -> None:
        ...
    ...
    def offer(self, iterator: java.util.Iterator[I]) -> None:
        """
    ...
    def removeProgressListener(self, listener: QProgressListener[I]) -> None:
        """
    ...
    @typing.overload
    def removeUnscheduledJobs(self, p: java.util.function.Predicate[I]) -> java.util.List[I]:
        """
        Removes all unscheduled jobs matching the given predicate
        
        :param java.util.function.Predicate[I] p: the predicate
        :return: the removed jobs
        :rtype: java.util.List[I]
        """

    def setMonitor(self, monitor: ghidra.util.task.TaskMonitor, cancelClearsAllItems: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class QResult(java.lang.Object, typing.Generic[I, R]):
    ...
    def __init__(self, item: I, future: java.util.concurrent.Future[R]) -> None:
        ...
...
class ReentryGuard(java.lang.Object, typing.Generic[T]):
    ...
    class Guarded(java.lang.AutoCloseable):
        ...
        def __init__(self, guard: ReentryGuard[typing.Any]) -> None:
            ...
...
class QRunnable(java.lang.Object, typing.Generic[I]):
    ...
    def run(self, item: I, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Processes the given item in background thread provided by a GThreadPool.
...
class QProgressListener(java.lang.Object, typing.Generic[I]):
    ...
    def maxProgressChanged(self, id: typing.Union[jpype.JLong, int], item: I, maxProgress: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def progressChanged(self, id: typing.Union[jpype.JLong, int], item: I, currentProgress: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def progressMessageChanged(self, id: typing.Union[jpype.JLong, int], item: I, message: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def progressModeChanged(self, id: typing.Union[jpype.JLong, int], item: I, indeterminate: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def taskEnded(self, id: typing.Union[jpype.JLong, int], item: I, totalCount: typing.Union[jpype.JLong, int], completedCount: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def taskStarted(self, id: typing.Union[jpype.JLong, int], item: I) -> None:
        """
...
class QRunnableAdapter(QCallback[I, java.lang.Object], typing.Generic[I]):
    ...
    def __init__(self, runnable: QRunnable[I]) -> None:
        ...
...
class ConcurrentGraphQ(java.lang.Object, typing.Generic[I]):
    ...
    def __init__(self, runnable: QRunnable[I], graph: ghidra.util.graph.AbstractDependencyGraph[I], pool: GThreadPool, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class GThreadPool(java.lang.Object):
    ...
    class GThreadPoolExecutor(java.util.concurrent.ThreadPoolExecutor):
        ...
        def setMaxThreadCount(self, maxThreadCount: typing.Union[jpype.JInt, int]) -> None:
            ...

        def setMinThreadCount(self, minThreadCount: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def getExecutorService(self) -> java.util.concurrent.ExecutorService:
        """
        Returns the :obj:`ExecutorService` used by this thread pool.
        
         
        Note: normal usage of this thread pool contraindicates accessing the executor service of
        this pool.  For managing your own jobs, you should use the method on this class directly.
        ...
        :rtype: java.util.concurrent.ExecutorService
        """
    ...
    @typing.overload
    def submit(self, futureTask: java.util.concurrent.FutureTask[typing.Any]) -> None:
        """
    ...
    @property
    def executorService(self) -> java.util.concurrent.ExecutorService:
        ...
...
__all__ = ["ConcurrentListenerSet", "FutureTaskMonitor", "QItemListener", "ConcurrentQ", "ProgressTracker", "QResult", "ConcurrentQBuilder", "ReentryGuard", "QCallback", "QRunnable", "QProgressListener", "QRunnableAdapter", "ConcurrentGraphQ", "NamedDaemonThreadFactory", "GThreadPool"]
