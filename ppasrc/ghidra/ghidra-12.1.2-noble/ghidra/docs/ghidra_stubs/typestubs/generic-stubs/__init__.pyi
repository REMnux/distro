...
class Span(java.lang.Comparable[S], typing.Generic[N, S]):
    ...
    class MutableSpanMap(Span.SpanMap[N, S, V], typing.Generic[N, S, V]):
        ...
        def putAll(self, map: Span.SpanMap[N, S, V]) -> None:
            """
    ...
    class MutableSpanSet(Span.SpanSet[N, S], typing.Generic[N, S]):
        ...
        def addAll(self, set: Span.SpanSet[N, S]) -> None:
            """
    ...
    class DefaultSpanMap(Span.MutableSpanMap[N, S, V], typing.Generic[N, S, V]):
        ...
        class Setter(Span.SpanMapSetter[java.util.Map.Entry[N, java.util.Map.Entry[S, V]], N, S, V]):
            ...
            def __init__(self, domain: Span.Domain[N, S]) -> None:
                """
...
class FilteredIterator(java.util.Iterator[T], java.lang.Iterable[T], typing.Generic[T]):
    ...
    def __init__(self, it: java.util.Iterator[T], filter: java.util.function.Predicate[T]) -> None:
        """
...
class ID(java.lang.Object, typing.Generic[T]):
...
class CatenatedCollection(AbstractUnionedCollection[E], typing.Generic[E]):

    class_: typing.ClassVar[java.lang.Class]

    @typing.overload
    def __init__(self, collections: collections.abc.Sequence) -> None:
        ...
...
class AbstractUnionedCollection(java.util.AbstractCollection[E], typing.Generic[E]):
...
class End(java.lang.Object, typing.Generic[T]):
    """
    ...
    necessitating open intervals is no longer discreet, but we can abuse :meth:`dec() <.dec>` and
    :meth:`inc() <.inc>` to compute endpoints of connected intervals. We cannot allow negative epsilon to
    be used on lower bounds and vice versa, though. This is a natural restriction, because such
    intervals wouldn't make sense, but it also overcomes the situation where :meth:`dec() <.dec>` or
    :meth:`inc() <.inc>` would need to change the value. Instead, they need only adjust the use of epsilon.
    """

    class Unbound(java.lang.Enum[End.Unbound], End[java.lang.Void]):
        """
        An enum for the two values of infinity
        """

        class_: typing.ClassVar[java.lang.Class]
        NEG_INF: typing.Final[End.Unbound]
        POS_INF: typing.Final[End.Unbound]

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> End.Unbound:
            ...

        @staticmethod
        def values() -> jpype.JArray[End.Unbound]:
            ...


    class Epsilon(java.lang.Enum[End.Epsilon]):
        """
        An enum for the three allowed coefficients of epsilon
        """

        class_: typing.ClassVar[java.lang.Class]
        NEGATIVE: typing.Final[End.Epsilon]
        """
        ``value - 1*epsilon``, -1 for open upper endpoints
        """

        ZERO: typing.Final[End.Epsilon]
        """
        ``value + 0*epsilon``, 0 for closed enpoints
        """

        POSITIVE: typing.Final[End.Epsilon]
        """
        ...
        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> End.Epsilon:
            ...

        @staticmethod
        def values() -> jpype.JArray[End.Epsilon]:
            ...


    class Point(java.lang.Record, End[T], typing.Generic[T]):
        """
        ...
        def __init__(self, val: T, epsilon: End.Epsilon) -> None:
            ...

        def epsilon(self) -> End.Epsilon:
            ...
    ...
    class EndSpan(Span[End[N], S], typing.Generic[N, S]):
        """
        ...
        def containsPoint(self, n: N) -> bool:
            """
            Check if this interval contains the given value
             
             
            
            This is equivalent to, and a shortcut for, :meth:`contains(Object) <.contains>`, passing
            ``value + 0*epsilon``.
    ...
    class EndDomain(Span.Domain[End[N], S], typing.Generic[N, S]):
        """
        The domain for spans of :obj:`End`
         
         
        
        Because the domain is no longer necessarily discreet, only comparison is necessary to
        implement it. :meth:`dec(End) <.dec>` and :meth:`inc(End) <.inc>` are instead applied to the coefficient
        on epsilon to find connected intervals.
        """

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, comparator: java.util.Comparator[N]) -> None:
            """
            Construct a domain using the given comparator
            
            :param java.util.Comparator[N] comparator: the comparator for values
            """


    class_: typing.ClassVar[java.lang.Class]

    def compareTo(self, that: End[T], comparator: java.util.Comparator[T]) -> int:
        """
        ...
        :param End[T] that: the other endpoint
        :param java.util.Comparator[T] comparator: the value comparator
        :return: the result as in :meth:`Comparator.compare(Object, Object) <Comparator.compare>`
        :rtype: int
        """
    ...
    @staticmethod
    def lower(value: T, inclusive: typing.Union[jpype.JBoolean, bool]) -> End[T]:
        """
        Construct a lower endpoint
        
        :param T: the type of value:param T value: the value
        :param jpype.JBoolean or bool inclusive: whether the endpoint includes the given value
        :return: the endpoint
        :rtype: End[T]
        """

    @staticmethod
    def negativeInfinity() -> End[T]:
        """
        ...
        :param T: the type of values:return: negative "infinity"
        :rtype: End[T]
        """

    @staticmethod
    def positiveInfinity() -> End[T]:
        """
        ...
        :param T: the type of values:return: positive "infinity"
        :rtype: End[T]
        """

    def toMaxString(self, nToString: java.util.function.Function[End[T], java.lang.String]) -> str:
        """
        
        
        :param java.util.function.Function[End[T], java.lang.String] nToString: the endpoint-to-string function
        :return: the string
        :rtype: str
        
        .. seealso::
        
            | :obj:`Domain.toMaxString(Object, Function)`
        """

    def toMinString(self, nToString: java.util.function.Function[End[T], java.lang.String]) -> str:
        """
        ...
        .. seealso::
            ...
            | :obj:`Domain.toMinString(Object, Function)`
        """

    @staticmethod
    def upper(value: T, inclusive: typing.Union[jpype.JBoolean, bool]) -> End[T]:
        """
    ...
    @property
    def validMax(self) -> jpype.JBoolean:
        ...

    @property
    def inclusive(self) -> jpype.JBoolean:
        ...

    @property
    def validMin(self) -> jpype.JBoolean:
        ...



__all__ = ["ULongSpan", "RangeMapSetter", "Span", "Unique", "FilteredIterator", "DominantPair", "ID", "CatenatedCollection", "AbstractUnionedCollection", "End"]
