...
class DockingTabRenderer(javax.swing.JPanel):
    ...
    def __init__(self, tabbedPane: javax.swing.JTabbedPane, fullTitle: typing.Union[java.lang.String, str], tabText: typing.Union[java.lang.String, str], closeListener: java.awt.event.ActionListener) -> None:
        ...

    def getTabText(self) -> str:
        ...

    def installPopupMenu(self, popupMenu: javax.swing.JPopupMenu) -> None:
        ...

    def setIcon(self, icon: javax.swing.Icon) -> None:
        ...

    def setTitle(self, tabText: typing.Union[java.lang.String, str], fullTitle: typing.Union[java.lang.String, str]) -> None:
        ...
