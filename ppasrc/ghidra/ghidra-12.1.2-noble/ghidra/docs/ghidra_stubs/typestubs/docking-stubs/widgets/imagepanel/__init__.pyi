...
class ImagePanel(javax.swing.JPanel):
    ...
    class PanAndZoomComponent(docking.widgets.label.GIconLabel):
        ...
        def __init__(self, image: javax.swing.Icon, horizontalAlignment: typing.Union[jpype.JInt, int]) -> None:
            ...
        ...
        def resetTranslation(self) -> None:
            ...

        def translate(self, dX: typing.Union[jpype.JInt, int], dY: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, image: java.awt.Image) -> None:
        """
    ...
    def resetImageTranslation(self) -> None:
        """
    ...
    def setDefaultZoomFactor(self, zoom: typing.Union[jpype.JFloat, float]) -> None:
        """
    ...
    def setImageBackgroundColor(self, color: java.awt.Color) -> None:
        """
    ...
    def setImageTranslationEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setImageZoomEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    def setZoomFactor(self, zoom: typing.Union[jpype.JFloat, float]) -> None:
        """
    ...
    @typing.overload
    def zoomIn(self, center: java.awt.Point) -> None:
        """
    ...
    @typing.overload
    def zoomOut(self, center: java.awt.Point) -> None:
        """
