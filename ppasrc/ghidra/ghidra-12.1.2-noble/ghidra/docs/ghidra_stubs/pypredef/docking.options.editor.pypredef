...
class SettableColorSwatchChooserPanel(javax.swing.colorchooser.AbstractColorChooserPanel):
    ...
    def installChooserPanel(self, enclosingChooser: javax.swing.JColorChooser) -> None:
        """
        The background color, foreground color, and font are already set to the
        defaults from the defaults table before this method is called.
        """

    def setHistoryColors(self, historyColors: java.util.List[java.awt.Color]) -> None:
        ...

    def setRecentColors(self, recentColors: java.util.List[java.awt.Color]) -> None:
        ...
...
class ScrollableOptionsEditor(ghidra.framework.options.OptionsEditor):
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], optionNames: java.util.List[java.lang.String]) -> None:
        """
...
class StringWithChoicesEditor(java.beans.PropertyEditorSupport):
    ...
    @typing.overload
    def __init__(self, choices: jpype.JArray[java.lang.String]) -> None:
        ...

    @typing.overload
    def __init__(self, choices: java.util.List[java.lang.String]) -> None:
        ...

    def setChoices(self, choices: jpype.JArray[java.lang.String]) -> None:
        ...
...
class OptionsEditorAlignable(java.lang.Object):
    """
    A simple interface for options :obj:`PropertyEditor`s to signal that they provide a custom 
    option editor that would like to be aligned with other options in the same view.
    """

    class_: typing.ClassVar[java.lang.Class]

    def getPreferredAlignmentSize(self) -> java.awt.Dimension:
        """
        :return: Gets the preferred alignment size of this class.
        :rtype: java.awt.Dimension
        """

    def setPreferredAlignmentSize(self, size: java.awt.Dimension) -> None:
        """
        Sets the final preferred alignment size after merging all preferred sizes from all options
        components in the view.
        
        :param java.awt.Dimension size: the size
        """

    @property
    def preferredAlignmentSize(self) -> java.awt.Dimension:
        ...

    @preferredAlignmentSize.setter
    def preferredAlignmentSize(self, value: java.awt.Dimension):
        ...
...
class OptionsEditorPanel(javax.swing.JPanel):
    ...
    def __init__(self, title: typing.Union[java.lang.String, str], options: ghidra.framework.options.Options, optionNames: java.util.List[java.lang.String], editorStateFactory: ghidra.framework.options.EditorStateFactory) -> None:
        """
...
class GhidraColorChooser(javax.swing.JColorChooser):
    ...
    @typing.type_check_only
    class ColorHistoryCache(java.util.LinkedHashMap[java.awt.Color, java.awt.Color], java.lang.Iterable[java.awt.Color]):
        ...
        def addColor(self, color: java.awt.Color) -> None:
            ...
    ...
    @typing.overload
    def __init__(self, initialColor: java.awt.Color) -> None:
        ...

    def addColorToHistory(self, c: java.awt.Color) -> None:
        ...
    ...
    def setActiveTab(self, tabName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setColorHistory(self, colors: java.util.List[java.awt.Color]) -> None:
        ...

    def setRecentColors(self, colors: java.util.List[java.awt.Color]) -> None:
        ...
...
class DefaultOptionComponent(GenericOptionsComponent):
    ...
    def __init__(self, editorState: ghidra.framework.options.EditorState) -> None:
        ...
...
class FileChooserEditor(java.beans.PropertyEditorSupport):
    ...
    @typing.overload
    def __init__(self, fileFilter: ghidra.util.filechooser.GhidraFileFilter) -> None:
        ...
...
class IconPropertyEditor(java.beans.PropertyEditorSupport):
    ...
    class IconChooserPanel(javax.swing.JPanel):
        ...
        def setSelectedIcon(self, icon: javax.swing.Icon) -> None:
            ...
...
class OptionsDialog(docking.ReusableDialogComponentProvider):
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], rootNodeName: typing.Union[java.lang.String, str], options: jpype.JArray[ghidra.framework.options.Options], listener: OptionsEditorListener) -> None:
        """
    ...
    @typing.overload
    def __init__(self, title: typing.Union[java.lang.String, str], rootNodeName: typing.Union[java.lang.String, str], options: jpype.JArray[ghidra.framework.options.Options], listener: OptionsEditorListener, showRestoreDefaultsButton: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def displayCategory(self, category: typing.Union[java.lang.String, str], filterText: typing.Union[java.lang.String, str]) -> None:
        ...

    def getSelectedPath(self) -> javax.swing.tree.TreePath:
        ...

    def setSelectedPath(self, path: javax.swing.tree.TreePath) -> None:
        ...
...
class FontPropertyEditor(java.beans.PropertyEditorSupport):
    ...
    class FontChooserPanel(javax.swing.JPanel):
        ...
        def updateControls(self, font: java.awt.Font) -> None:
            ...
...
class GenericOptionsComponent(javax.swing.JPanel):
    ...
    @staticmethod
    def alignLabels(components: java.util.List[GenericOptionsComponent]) -> None:
        """
...
class OptionsEditorListener(java.lang.Object):
    ...
    def beforeChangesApplied(self) -> None:
        """
        Notification that changes are about to be applied.
        """

    def changesApplied(self) -> None:
        """
...
class DateEditor(java.beans.PropertyEditorSupport):
    ...
    def setDateFormat(self, format: java.text.DateFormat) -> None:
        ...
...
class StringEditor(java.beans.PropertyEditorSupport):
    ...
    def setAsText(self, text: typing.Union[java.lang.String, str]) -> None:
        """
...
class OptionsPanel(javax.swing.JPanel):
    ...
    def __init__(self, rootName: typing.Union[java.lang.String, str], options: jpype.JArray[ghidra.framework.options.Options], showRestoreDefaultsButton: typing.Union[jpype.JBoolean, bool], changeListener: java.beans.PropertyChangeListener) -> None:
        ...
