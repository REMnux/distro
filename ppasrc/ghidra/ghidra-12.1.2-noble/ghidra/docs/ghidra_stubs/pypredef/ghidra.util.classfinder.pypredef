...
class ClassTranslator(java.lang.Object):
    ...
    **Important**: Any class that is indicated by the currentClassPath
    ...
    @staticmethod
    def put(oldClassPath: typing.Union[java.lang.String, str], currentClassPath: typing.Union[java.lang.String, str]) -> None:
        """
...
class ClassFileInfo(java.lang.Record):
    ...
    def __init__(self, path: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], suffix: typing.Union[java.lang.String, str]) -> None:
        ...
...
class ClassExclusionFilter(ClassFilter):
    ...
    def __init__(self, *exclusions: java.lang.Class[typing.Any]) -> None:
        ...
...
class ClassLocation(java.lang.Object):
    ...
    def getClasses(self, list: java.util.List[ClassFileInfo], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
...
class ClassSearcher(java.lang.Object):
    ...
    **Warning: Using the search feature of this class will trigger other classes to be loaded.
    ...
    @staticmethod
    def forNameSafe(name: typing.Union[java.lang.String, str], sup: java.lang.Class[T], loader: java.lang.ClassLoader) -> java.lang.Class[T]:
        """
        ...
        **WARNING:** Do not pass :obj:`Object`, a standard JDK interface, or any interface from a
        ...
        :param T: the super type:param java.lang.String or str name: the class binary name, as in :meth:`Class.forName(String, boolean, ClassLoader) <Class.forName>`.
        :param java.lang.Class[T] sup: the super type
        :param java.lang.ClassLoader loader: the class loader, or ``null`` to use the bootstrap loader.
        :return: the found class as a subclass of the given type
        :rtype: java.lang.Class[T]
        :raises java.lang.ClassNotFoundException: if the class cannot be found
        :raises ClassCastException: if the found class is not a sub type of the given type
        """
