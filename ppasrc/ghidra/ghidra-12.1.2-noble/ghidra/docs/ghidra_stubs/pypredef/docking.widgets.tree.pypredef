...
class InvertedTreeFilter(docking.widgets.tree.support.GTreeFilter):
    ...
    def __init__(self, treeFilter: docking.widgets.tree.support.GTreeFilter) -> None:
        ...
...
class GTreeNode(CoreGTreeNode, java.lang.Comparable[GTreeNode]):
    ...
    * The ``equals()`` method: The GTree has the ability to remember
    ...
    @typing.overload
    def addNode(self, node: GTreeNode) -> None:
        """
    ...
    @typing.overload
    def addNode(self, index: typing.Union[jpype.JInt, int], node: GTreeNode) -> None:
        """
    ...
    def addNodes(self, nodes: java.util.List[GTreeNode]) -> None:
        """
    ...
    def removeNode(self, node: GTreeNode) -> None:
        """
    ...
    def setChildren(self, childList: java.util.List[GTreeNode]) -> None:
        """
    ...
    def valueChanged(self, newValue: java.lang.Object) -> None:
        """
...
class TreeTextFilter(docking.widgets.tree.support.GTreeFilter):
    ...
    def __init__(self, textFilter: docking.widgets.filter.TextFilter, transformer: ghidra.util.FilterTransformer[GTreeNode]) -> None:
        ...
...
class DefaultGTreeFilterProvider(GTreeFilterProvider):
    ...
    def __init__(self, gTree: GTree) -> None:
        ...
    ...
    def setPreferredFilterOptions(self, filterOptions: docking.widgets.filter.FilterOptions) -> None:
        """
...
class GTreeTask(ghidra.util.worker.PriorityJob):
    ...
    class CheckCancelledRunnable(java.lang.Runnable):
        ...
        def __init__(self, runnable: java.lang.Runnable) -> None:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def runOnSwingThread(self, runnable: java.lang.Runnable) -> None:
        ...
...
class TreeTaskMonitor(ghidra.util.task.TaskMonitor):
    ...
    def __init__(self, monitor: ghidra.util.task.TaskMonitor, max: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class GTree(javax.swing.JPanel, ghidra.util.task.BusyListener):
    ...
    class AutoScrollTree(javax.swing.JTree, java.awt.dnd.Autoscroll):
        ...
        def __init__(self, model: javax.swing.tree.TreeModel) -> None:
            ...

        def addMouseListener(self, l: java.awt.event.MouseListener) -> None:
            """
        ...
        def removeMouseListener(self, l: java.awt.event.MouseListener) -> None:
            """
        ...
        def setPaintHandlesForLeafNodes(self, enable: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setRootNodeAllowedToCollapse(self, allowed: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setScrollableUnitIncrement(self, increment: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def __init__(self, root: GTreeNode) -> None:
        """
    ...
    def collapseAll(self, node: GTreeNode) -> None:
        ...
    ...
    def expandAndSelectPaths(self, paths: java.util.List[javax.swing.tree.TreePath]) -> None:
        """
    ...
    @typing.overload
    def expandPath(self, node: GTreeNode) -> None:
        ...
    ...
    @typing.overload
    def expandPaths(self, paths: jpype.JArray[javax.swing.tree.TreePath]) -> None:
        ...

    @typing.overload
    def expandPaths(self, paths: java.util.List[javax.swing.tree.TreePath]) -> None:
        ...

    def expandTree(self, node: GTreeNode) -> None:
        ...
    ...
    @staticmethod
    def printEvent(out: java.io.PrintWriter, name: typing.Union[java.lang.String, str], e: javax.swing.event.TreeModelEvent) -> None:
        """
    ...
    @typing.overload
    def refilterLater(self, newNode: GTreeNode) -> None:
        """
    ...
    def restoreTreeState(self, state: GTreeState) -> None:
        """
    ...
    @typing.overload
    def runTask(self, task: GTreeTask) -> None:
        """
    ...
    def setActiveDropTargetNode(self, node: GTreeNode) -> None:
        ...
    ...
    def setDataTransformer(self, transformer: ghidra.util.FilterTransformer[GTreeNode]) -> None:
        """
    ...
    def setDoubleClickExpansionEnabled(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setEventsEnabled(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setFilterFieldEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setFilterProvider(self, filterProvider: GTreeFilterProvider) -> None:
        ...

    def setFilterText(self, text: typing.Union[java.lang.String, str]) -> None:
        ...

    def setFilterVisible(self, visible: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setFilteringEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setHorizontalScrollPolicy(self, policy: typing.Union[jpype.JInt, int]) -> None:
        ...

    def setNodeEditable(self, child: GTreeNode) -> None:
        ...
    ...
    def setRootNode(self, rootNode: GTreeNode) -> None:
        """
    ...
    def setRootVisible(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setRowHeight(self, rowHeight: typing.Union[jpype.JInt, int]) -> None:
        ...
    ...
    def setSelectedNode(self, node: GTreeNode) -> None:
        ...

    def setSelectedNodeByNamePath(self, namePath: jpype.JArray[java.lang.String]) -> None:
        """
    ...
    @typing.overload
    def setSelectedNodes(self, *nodes: GTreeNode) -> None:
        ...

    @typing.overload
    def setSelectedNodes(self, nodes: collections.abc.Sequence) -> None:
        ...
    ...
    @typing.overload
    def setSelectionPaths(self, paths: jpype.JArray[javax.swing.tree.TreePath]) -> None:
        ...

    @typing.overload
    def setSelectionPaths(self, pathsList: java.util.List[javax.swing.tree.TreePath]) -> None:
        ...

    @typing.overload
    def setSelectionPaths(self, paths: jpype.JArray[javax.swing.tree.TreePath], origin: docking.widgets.tree.support.GTreeSelectionEvent.EventOrigin) -> None:
        ...

    @typing.overload
    def setSelectionPaths(self, paths: java.util.List[javax.swing.tree.TreePath], expandPaths: typing.Union[jpype.JBoolean, bool], origin: docking.widgets.tree.support.GTreeSelectionEvent.EventOrigin) -> None:
        """
    ...
    def setSeletedNodeByName(self, parentNode: GTreeNode, childName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setShowsRootHandles(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
    ...
    @typing.overload
    def startEditing(self, parent: GTreeNode, childName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    @typing.overload
    def startEditing(self, node: GTreeNode) -> None:
        """
    ...
    @typing.overload
    def whenNodeIsReady(self, parent: GTreeNode, matches: java.util.function.Predicate[GTreeNode], consumer: java.util.function.Consumer[GTreeNode]) -> None:
        """
    ...
    @typing.overload
    def whenNodeIsReady(self, parent: GTreeNode, childName: typing.Union[java.lang.String, str], consumer: java.util.function.Consumer[GTreeNode]) -> None:
        """
        A specialized method that will get the child node from the given parent node when it becomes
...
class GTreeRestoreTreeStateTask(GTreeTask):
    ...
    def __init__(self, gTree: GTree, state: GTreeState) -> None:
        ...
...
class MultiTextFilterTreeFilter(docking.widgets.tree.support.GTreeFilter):
    ...
    def __init__(self, filters: java.util.List[docking.widgets.filter.TextFilter], transformer: ghidra.util.FilterTransformer[GTreeNode], evalMode: docking.widgets.filter.MultitermEvaluationMode) -> None:
        ...
...
class GTreeFilterTask(GTreeTask):
    ...
    def __init__(self, tree: GTree, filter: docking.widgets.tree.support.GTreeFilter) -> None:
        ...
...
class GTreeState(java.lang.Object):
    ...
    * If we have to trim the number of items we remember, we need to do so intelligently so
    ...
    @typing.overload
    def __init__(self, tree: GTree, node: GTreeNode) -> None:
        ...
    ...
    def updateStateForMovedNodes(self) -> None:
        ...
...
class GTreeTextFilterFactory(java.lang.Object):
    ...
    def setFilterOptions(self, options: docking.widgets.filter.FilterOptions) -> None:
        ...
...
class GTreeFilterProvider(java.lang.Object):
    ...
    def loadFilterPreference(self, windowManager: docking.DockingWindowManager) -> None:
        """
...
class AnyChangeTreeModelListener(javax.swing.event.TreeModelListener):

    class_: typing.ClassVar[java.lang.Class]

    def treeChanged(self, e: javax.swing.event.TreeModelEvent) -> None:
        ...


class SearchableByObjectGTreeNode(java.lang.Object):

    class_: typing.ClassVar[java.lang.Class]

    def findNodeForObject(self, obj: java.lang.Object) -> GTreeNode:
        ...

    def getObjectNodeMap(self) -> java.util.Map[java.lang.Object, GTreeNode]:
        ...

    @property
    def objectNodeMap(self) -> java.util.Map[java.lang.Object, GTreeNode]:
        ...



__all__ = ["CoreGTreeNode", "InvertedTreeFilter", "GTreeNode", "TreeTextFilter", "DefaultGTreeFilterProvider", "GTreeTask", "GTreeFilterFactory", "GTreeSlowLoadingNode", "TreeTaskMonitor", "GTree", "GTreeRestoreTreeStateTask", "MultiTextFilterTreeFilter", "GTreeRootParentNode", "GTreeFilterTask", "GTreeState", "GTreeTextFilterFactory", "GTreeLazyNode", "GTreeFilterProvider", "AnyChangeTreeModelListener", "SearchableByObjectGTreeNode"]
