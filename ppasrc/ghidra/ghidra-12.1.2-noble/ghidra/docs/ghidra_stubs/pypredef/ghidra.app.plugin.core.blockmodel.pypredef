...
class BlockModelServicePlugin(ghidra.app.plugin.ProgramPlugin, ghidra.app.services.BlockModelService, ghidra.framework.options.OptionsChangeListener):
    ...
    def optionsChanged(self, newOptions: ghidra.framework.options.ToolOptions, optionName: typing.Union[java.lang.String, str], oldValue: java.lang.Object, newValue: java.lang.Object) -> None:
        """
