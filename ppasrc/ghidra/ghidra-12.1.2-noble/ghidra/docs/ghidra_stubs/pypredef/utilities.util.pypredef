...
class FileUtilities(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def copyFile(fromFile: generic.jar.ResourceFile, toFile: jpype.protocol.SupportsPath, append: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def copyFile(fromFile: generic.jar.ResourceFile, toFile: generic.jar.ResourceFile, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Copy the fromFile contents to the toFile.  The toFile will be overwritten or created.
    ...
    @staticmethod
    def copyFileToStream(fromFile: jpype.protocol.SupportsPath, out: java.io.OutputStream, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def forEachFile(path: jpype.protocol.SupportsPath, consumer: java.util.function.Consumer[java.nio.file.Path]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def forEachFile(resourceFile: jpype.protocol.SupportsPath, consumer: java.util.function.Consumer[java.io.File]) -> None:
        """
        A convenience method to list the contents of the given directory path and pass each to the
        given consumer.  If the given path does not represent a directory, nothing will happen.
    ...
    @staticmethod
    @typing.overload
    def forEachFile(resourceFile: generic.jar.ResourceFile, consumer: java.util.function.Consumer[generic.jar.ResourceFile]) -> None:
        """
        A convenience method to list the contents of the given directory path and pass each to the
        given consumer.  If the given path does not represent a directory, nothing will happen.
    ...
    @staticmethod
    def openNative(file: jpype.protocol.SupportsPath) -> None:
        """
    ...
    @staticmethod
    def setOwnerOnlyPermissions(f: jpype.protocol.SupportsPath) -> None:
        """
    ...
    @staticmethod
    def writeBytes(file: jpype.protocol.SupportsPath, bytes: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    @staticmethod
    def writeLinesToFile(file: jpype.protocol.SupportsPath, lines: java.util.List[java.lang.String]) -> None:
        """
    ...
    @staticmethod
    def writeStringToFile(file: jpype.protocol.SupportsPath, s: typing.Union[java.lang.String, str]) -> None:
        """
...
class IDHashed(java.lang.Object, typing.Generic[T]):

    class_: typing.ClassVar[java.lang.Class]
    obj: typing.Final[T]
    hashCode: typing.Final[jpype.JInt]

    def __init__(self, obj: T) -> None:
        ...


class IDKeyed(IDHashed[T], typing.Generic[T]):
...
class ProxyUtilities(java.lang.Enum[ProxyUtilities]):

    @typing.type_check_only
    class ComposedHandler(java.lang.reflect.InvocationHandler):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    @staticmethod
    def areSameMethod(m1: java.lang.reflect.Method, m2: java.lang.reflect.Method) -> bool:
        """
        ...
        :param java.lang.reflect.Method m1: the first method
        :param java.lang.reflect.Method m2: the second method
        :return: true if they are the same, false otherwise;
        :rtype: bool
        """

    @staticmethod
    def composeOnDelegate(iface: java.lang.Class[T], delegate: T, mixins: java.util.List[java.lang.Class[U]], lookup: java.lang.invoke.MethodHandles.Lookup) -> T:
        """
        ...
        :param T: the delegate's and proxy's type:param U: a super interface common to all mixins:param java.lang.Class[T] iface: an interface of the delegate that also defines the proxy's type
        :param T delegate: the delegate, providing implementations of all abstract methods
        :param java.util.List[java.lang.Class[U]] mixins: the mixins
        :param java.lang.invoke.MethodHandles.Lookup lookup: a lookup which has access to the interfaces and their methods
        """

    @staticmethod
    @typing.overload
    def getSuperMethodHandle(method: java.lang.reflect.Method) -> java.lang.invoke.MethodHandle:
        ...

    @staticmethod
    @typing.overload
    def getSuperMethodHandle(method: java.lang.reflect.Method, lookup: java.lang.invoke.MethodHandles.Lookup) -> java.lang.invoke.MethodHandle:
        ...

    @staticmethod
    def valueOf(name: typing.Union[java.lang.String, str]) -> ProxyUtilities:
        ...

    @staticmethod
    def values() -> jpype.JArray[ProxyUtilities]:
        ...


class SuppressableCallback(java.lang.Object, typing.Generic[T]):
    """
    ...
    ``private final SuppressableCallback<Void> cbDoSomething = new SuppressableCallback<>();public boolean doSomething() {    cbDoSomething.invoke(__ -> {        try (Suppression supp = cbDoSomething.supppress(null)) {            // do the thing            return doAnotherThing();        }    }, false);}public boolean doAnotherThing() {    // do the other thing    return doSomething();}``
    ...
    class Suppression(java.lang.AutoCloseable):
        """
    ...
    @typing.type_check_only
    class ListWithView(java.util.LinkedList[T], typing.Generic[T]):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    @typing.overload
    def invoke(self, callback: java.lang.Runnable) -> None:
        """
        ...
        :param java.lang.Runnable callback: the callback
        """

    @typing.overload
    def invoke(self, callback: java.util.function.Supplier[R], fallback: R) -> R:
        """
        Run the given callback, returning its value, unless it has been suppressed
         
         
        
        Works like :meth:`invoke(Runnable) <.invoke>`, except that the callback can return a value. If the
        callback is suppressed, a fallback value is returned instead.
        
        :param R: the return type:param java.util.function.Supplier[R] callback: the callback
        :param R fallback: a fallback value in case of suppression
        :return: the value from the callback, or the fallback value
        :rtype: R
        """

    @typing.overload
    def invokeWithStack(self, callback: java.util.function.Consumer[java.util.List[T]]) -> None:
        """
        ...
        :param java.util.function.Consumer[java.util.List[T]] callback: a method to receive the stack
        """

    @typing.overload
    def invokeWithStack(self, callback: java.util.function.Function[java.util.List[T], R]) -> R:
        """
        Run the given callback with the stack, returning its value
         
         
        
        This works like :meth:`invokeWithStack(Consumer) <.invokeWithStack>`, except that the callback can return a
        ...
        :param R: the return type:param java.util.function.Function[java.util.List[T], R] callback: the callback
        :return: the value from the callback
        :rtype: R
        """

    @typing.overload
    def invokeWithTop(self, callback: java.util.function.Consumer[T]) -> None:
        """
        ...
        on the given value. Not for a ``SuppressableCallback<T>``, this method is useless, as the
        provided value will always be ``null``, whether or not suppressed.
        
        :param java.util.function.Consumer[T] callback: the callback
        """

    @typing.overload
    def invokeWithTop(self, callback: java.util.function.Function[T, R]) -> R:
        """
        Run the given callback with the topmost value, returning its value
         
         
        
        This works like :meth:`invokeWithTop(Consumer) <.invokeWithTop>`, except that the callback can return a
        value. Note that a fallback parameter is not taken, since the callback is always invoked. The
        callback should implement its own fallback logic.
        
        :param R: the return type:param java.util.function.Function[T, R] callback: the callback
        :return: the value from the callback
        :rtype: R
        """

    def suppress(self, value: T) -> SuppressableCallback.Suppression:
        """
        ...
        perhaps to wrap this in another :obj:`AutoCloseable`. The information is usually one of the
        parameters, or perhaps a n-tuple of all parameters. For many use cases, ``null`` is all
        ...
        :rtype: SuppressableCallback.Suppression
        """



__all__ = ["AnnotationUtilities", "FileUtilities", "FileResolutionResult", "IDHashed", "IDKeyed", "ProxyUtilities", "SuppressableCallback"]
