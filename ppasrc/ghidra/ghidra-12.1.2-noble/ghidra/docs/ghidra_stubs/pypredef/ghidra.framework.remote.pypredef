...
class GhidraPrincipal(java.security.Principal, java.io.Serializable):
    ...
    def __init__(self, username: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor.
...
class RepositoryItem(java.io.Serializable):
    ...
    def __init__(self, folderPath: typing.Union[java.lang.String, str], itemName: typing.Union[java.lang.String, str], fileID: typing.Union[java.lang.String, str], itemType: typing.Union[jpype.JInt, int], contentType: typing.Union[java.lang.String, str], version: typing.Union[jpype.JInt, int], versionTime: typing.Union[jpype.JLong, int], textData: typing.Union[java.lang.String, str]) -> None:
        ...
        :param java.lang.String or str textData: related text data (may be null)
        """
...
class RepositoryHandle(java.lang.Object):
    ...
    def createTextDataFile(self, parentPath: typing.Union[java.lang.String, str], itemName: typing.Union[java.lang.String, str], fileID: typing.Union[java.lang.String, str], contentType: typing.Union[java.lang.String, str], textData: typing.Union[java.lang.String, str], comment: typing.Union[java.lang.String, str]) -> None:
        """
        ...
        :param java.lang.String or str itemName: new data file name
        :param java.lang.String or str fileID: unique file ID
        :param java.lang.String or str contentType: application defined content type
        :param java.lang.String or str textData: text data (required)
        :param java.lang.String or str comment: file comment (may be null)
    ...
    def deleteItem(self, parentPath: typing.Union[java.lang.String, str], itemName: typing.Union[java.lang.String, str], version: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def moveFolder(self, oldParentPath: typing.Union[java.lang.String, str], newParentPath: typing.Union[java.lang.String, str], oldFolderName: typing.Union[java.lang.String, str], newFolderName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def moveItem(self, oldParentPath: typing.Union[java.lang.String, str], newParentPath: typing.Union[java.lang.String, str], oldItemName: typing.Union[java.lang.String, str], newItemName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setUserList(self, users: jpype.JArray[User], anonymousAccessAllowed: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def terminateCheckout(self, parentPath: typing.Union[java.lang.String, str], itemName: typing.Union[java.lang.String, str], checkoutId: typing.Union[jpype.JLong, int], notify: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def updateCheckoutVersion(self, parentPath: typing.Union[java.lang.String, str], itemName: typing.Union[java.lang.String, str], checkoutId: typing.Union[jpype.JLong, int], checkoutVersion: typing.Union[jpype.JInt, int]) -> None:
        """
...
class SSHSignatureCallback(javax.security.auth.callback.Callback, java.io.Serializable):
    ...
    def __init__(self, token: jpype.JArray[jpype.JByte], serverSignature: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def sign(self, privateKeyParameters: java.lang.Object) -> None:
        """
...
class RepositoryChangeEvent(java.io.Serializable):
    ...
    def __init__(self, type: typing.Union[jpype.JInt, int], parentPath: typing.Union[java.lang.String, str], name: typing.Union[java.lang.String, str], newParentPath: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str]) -> None:
        """
        Constructor.
...
class AnonymousCallback(javax.security.auth.callback.Callback, java.io.Serializable):
    ...
    def setAnonymousAccessRequested(self, state: typing.Union[jpype.JBoolean, bool]) -> None:
        """
...
class User(java.lang.Comparable[User], java.io.Serializable):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], permission: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor.
...
class RemoteRepositoryServerHandle(RepositoryServerHandle, java.rmi.Remote):
    ...
    IMPORTANT: Methods from :obj:`RepositoryServerHandle` **must** be re-declared here 
    so they may be properly marshalled for remote invocation via RMI.  
    This became neccessary with an OpenJDK 11.0.6 change made to 
    :obj:`RemoteObjectInvocationHandler`.
    """
...
class GhidraObjectInputFilter(java.io.ObjectInputFilter):
    """
    :obj:`GhidraObjectInputFilter` provides global serial input filter for use with Ghidra server
    ...
    Filter files use syntax as supported by :meth:`java.io.ObjectInputFilter.Config.createFilter(String) <java.io.ObjectInputFilter.Config.createFilter>`
    with the addition of ``remoteIf=&lt;remote-classname&gt;`` entries for client filters to 
    specify those :obj:`Remote` interfaces which require the use of dynamic :obj:`Proxy` class
    implementations for RMI stubs.
     
    
    RMI Server applications should invoke :meth:`configureServerSerialFilter(ResourceFile, Supplier) <.configureServerSerialFilter>`
    during early initialization with a suitable filter file, while Ghidra client applications should
    invoke :meth:`configureClientSerialFilter() <.configureClientSerialFilter>` to use all Module data ``*.serial.filter`` files
    to define client deserialization restrictions.
     
    See :meth:`java.io.ObjectInputFilter.Config.createFilter(String) <java.io.ObjectInputFilter.Config.createFilter>` for filter file syntax.
    See :meth:`java.io.ObjectInputFilter.Config.setSerialFilterFactory(java.util.function.BinaryOperator) <java.io.ObjectInputFilter.Config.setSerialFilterFactory>`.
    """
    ...
    @staticmethod
    def configureClientSerialFilter() -> None:
        """
        ...
        filter will be based on the accumulation of all ``data/*.serial.filter`` files found 
        within all Application modules.
         
        
        This filter will make use of the :obj:`GhidraSerialFilterFactory` and ensure that it is
        properly installed.
        
        :raises java.lang.IllegalStateException: if error occurred building or installing serial input filter
        and related filter factory.
        """

    @staticmethod
    def configureServerSerialFilter(filterFile: generic.jar.ResourceFile, sourceNameSupplier: java.util.function.Supplier[java.lang.String]) -> None:
        """
        ...
        :param generic.jar.ResourceFile filterFile: serial filter file
        :param java.util.function.Supplier[java.lang.String] sourceNameSupplier: source name supplied for use during logging, or null.  It 
        ...
        :raises java.lang.IllegalStateException: if error occured building or installing serial input filter
        and related filter factory.
        """
...
class RMIServerPortFactory(java.lang.Object):
    ...
    def __init__(self, basePort: typing.Union[jpype.JInt, int]) -> None:
        """
...
class GhidraServerHandle(java.rmi.Remote):
    ...
    class_: typing.ClassVar[java.lang.Class]
    SERVER_INTERFACE_VERSION: typing.Final = 13
    """
    ...
    MIN_CLIENT_INTERFACE_VERSION: typing.Final = 13
    """
    The minimum server interface version that the client can operate with.
    """

    SERVER_MIN_CLIENT_INTERFACE_VERSION: typing.Final = 11
    """
    The minimum interface version that the server will support for older client versions.  
    When this version is less than :obj:`.MIN_CLIENT_INTERFACE_VERSION` it allows the following:
    ...
    * Current ghidra clients version cannot use an older version server.
    ...
    When this version differs from :obj:`.MIN_CLIENT_INTERFACE_VERSION` the server will bind two
    both :obj:`.BIND_NAME` and GhidraServer9.0.
    ...
    BIND_NAME: typing.Final = "GhidraServer12.0.5"
    """
    ...
    ALT_BIND_NAME: typing.Final = "GhidraServer9.0"
    """
    ...
    and corresponds to :obj:`.SERVER_MIN_CLIENT_INTERFACE_VERSION`.
    """


    def checkCompatibility(self, clientInterfaceVersion: typing.Union[jpype.JInt, int]) -> None:
        """
        Check server interface compatibility with the specified client interface version.
        
        :param jpype.JInt or int clientInterfaceVersion: client/server interface version
        :raises RemoteException: if requested server interface version not available
        """
    ...
    def getAuthenticationCallbacks(self) -> jpype.JArray[javax.security.auth.callback.Callback]:
        ...
        :raises RemoteException: if failure occurs while generating authentication callbacks
    ...
    def getRepositoryServer(self, user: javax.security.auth.Subject, authCallbacks: jpype.JArray[javax.security.auth.callback.Callback]) -> RemoteRepositoryServerHandle:
        ...
        :raises FailedLoginException: if user authentication fails
        :raises RemoteException: failed to create remote handle
...
class RepositoryServerHandle(java.lang.Object):
    ...
    def deleteRepository(self, name: typing.Union[java.lang.String, str]) -> None:
        """
        Delete a repository.
    ...
    def setPassword(self, saltedSHA256PasswordHash: jpype.JArray[jpype.JChar]) -> bool:
        ...
        .. seealso::
            ...
            | :obj:`generic.hash.HashUtilities.getSaltedHash(String, char[])`HashUtilities.getSaltedHash("SHA-256", char[])
        """
...
class GhidraSerialFilterFactory(java.util.function.BinaryOperator[java.io.ObjectInputFilter]):
    """
    :obj:`GhidraSerialFilterFactory` provides the serial filter factory which imposes
    :obj:`GhidraObjectInputFilter` as a global serial input filter.
    ...
    :obj:`global serial filter <GhidraObjectInputFilter>`.
    ...
    def __init__(self) -> None:
        ...
        See :obj:`ObjectInputFilter.Config.setSerialFilterFactory`.
        """
...
class SignatureCallback(javax.security.auth.callback.Callback, java.io.Serializable):
    ...
    def __init__(self, recognizedAuthorities: jpype.JArray[javax.security.auth.x500.X500Principal], token: jpype.JArray[jpype.JByte], serverSignature: jpype.JArray[jpype.JByte]) -> None:
        """
        Construct callback with a random token to be signed by the client.
        ...
        :param jpype.JArray[jpype.JByte] token: random bytes to be signed
        :param jpype.JArray[jpype.JByte] serverSignature: servers signature of token at time of generation
        """

    def getCertificateChain(self) -> jpype.JArray[java.security.cert.X509Certificate]:
        """
        :return: certificate chain used to sign token
        :rtype: jpype.JArray[java.security.cert.X509Certificate]
        """
    ...
    def getRecognizedAuthorities(self) -> jpype.JArray[java.security.Principal]:
        ...
        :rtype: jpype.JArray[java.security.Principal]
        """
    ...
    def sign(self, sigCertChain: jpype.JArray[java.security.cert.X509Certificate], certSignature: jpype.JArray[jpype.JByte]) -> None:
        """
...
__all__ = ["RemoteRepositoryHandle", "GhidraPrincipal", "RepositoryItem", "RepositoryHandle", "SSHSignatureCallback", "RepositoryChangeEvent", "AnonymousCallback", "User", "RemoteRepositoryServerHandle", "GhidraObjectInputFilter", "RMIServerPortFactory", "GhidraServerHandle", "RepositoryServerHandle", "GhidraSerialFilterFactory", "SignatureCallback"]
