...
class MachHeader(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, provider: ghidra.app.util.bin.ByteProvider) -> None:
        ...
        :raises MachException: if an invalid header is detected
        """

    @typing.overload
    def __init__(self, provider: ghidra.app.util.bin.ByteProvider, machHeaderStartIndexInProvider: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, provider: ghidra.app.util.bin.ByteProvider, machHeaderStartIndexInProvider: typing.Union[jpype.JLong, int], isRemainingMachoRelativeToStartIndex: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Creates a new :obj:`MachHeader`.  Assumes the MachHeader starts at index 
        *machHeaderStartIndexInProvider* in the ByteProvider.
        ...
        :param jpype.JLong or int machHeaderStartIndexInProvider: the index into the ByteProvider where the MachHeader 
        begins.
        :param jpype.JBoolean or bool isRemainingMachoRelativeToStartIndex: true if the rest of the Mach-O uses relative 
    ...
    def parse(self) -> MachHeader:
        ...
        :raises MachException: if a problem was detected with the load commands
        """
...
class Section(ghidra.app.util.bin.StructConverter):
    ...
    def setSectionName(self, name: typing.Union[java.lang.String, str]) -> None:
        ...
