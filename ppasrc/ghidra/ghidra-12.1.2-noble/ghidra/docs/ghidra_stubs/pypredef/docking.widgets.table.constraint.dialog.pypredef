...
class ColumnFilterDialog(docking.ReusableDialogComponentProvider, TableFilterDialogModelListener, typing.Generic[R]):
    ...
    def __init__(self, filterManager: docking.widgets.table.columnfilter.ColumnFilterManager[R], table: javax.swing.JTable, tableModel: docking.widgets.table.RowObjectFilterModel[R]) -> None:
        """
        Constructor
    ...
    def filterChanged(self, newFilter: docking.widgets.table.columnfilter.ColumnBasedTableFilter[R]) -> None:
        ...
    ...
    def setCloseCallback(self, callback: utility.function.Callback) -> None:
        """
...
class ColumnFilterDialogModel(java.lang.Object, typing.Generic[R]):
    ...
    def __init__(self, model: docking.widgets.table.RowObjectFilterModel[R], columnModel: javax.swing.table.TableColumnModel, currentColumnTableFilter: docking.widgets.table.columnfilter.ColumnBasedTableFilter[R]) -> None:
        """
    ...
    def addListener(self, listener: TableFilterDialogModelListener) -> None:
        """
    ...
    def deleteFilterRow(self, filterRow: DialogFilterRow) -> None:
        """
    ...
    def removeListener(self, listener: TableFilterDialogModelListener) -> None:
        """
    ...
    def setCurrentlyAppliedFilter(self, tableColumnFilter: docking.widgets.table.columnfilter.ColumnBasedTableFilter[R]) -> None:
        ...
...
class DialogFilterRow(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, dialogModel: ColumnFilterDialogModel[typing.Any], logicOperation: docking.widgets.table.columnfilter.LogicOperation) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dialogModel: ColumnFilterDialogModel[typing.Any], columnFilter: docking.widgets.table.columnfilter.ColumnConstraintSet[typing.Any, T]) -> None:
        """
    ...
    def setColumnData(self, columnData: ColumnFilterData[typing.Any]) -> None:
        """
...
class FilterPanelLayout(java.awt.LayoutManager):
    ...
    def __init__(self, componentWidth: typing.Union[jpype.JInt, int], hgap: typing.Union[jpype.JInt, int]) -> None:
        """
...
class ColumnFilterData(java.lang.Comparable[ColumnFilterData[T]], typing.Generic[T]):
    ...
    def __init__(self, model: docking.widgets.table.RowObjectFilterModel[typing.Any], columnModelIndex: typing.Union[jpype.JInt, int], columnViewIndex: typing.Union[jpype.JInt, int], columnClass: java.lang.Class[T]) -> None:
        """
    ...
    def replace(self, value: docking.widgets.table.constraint.ColumnConstraint[T]) -> None:
        """
    ...
    def setViewIndex(self, viewIndex: typing.Union[jpype.JInt, int]) -> None:
        """
        Sets the viewIndex
...
class DialogFilterCondition(java.lang.Object, typing.Generic[T]):
    ...
    @typing.overload
    def __init__(self, parentCondition: DialogFilterConditionSet[T]) -> None:
        """
        Constructor
    ...
    @typing.overload
    def __init__(self, parent: DialogFilterConditionSet[T], constraint: docking.widgets.table.constraint.ColumnConstraint[T]) -> None:
        """
    ...
    def setSelectedConstraint(self, constraintName: typing.Union[java.lang.String, str]) -> None:
        """
    ...
    def setValue(self, valueString: typing.Union[java.lang.String, str], dataSource: java.lang.Object) -> None:
        """
...
@typing.type_check_only
class ColumnFilterGridLocation(java.lang.Record):
    """
...
class TableFilterDialogModelListener(java.lang.Object):
    ...
    def editorValueChanged(self, editor: docking.widgets.table.constrainteditor.ColumnConstraintEditor[typing.Any]) -> None:
        """
...
__all__ = ["ColumnFilterDialog", "ColumnFilterDialogModel", "ConstraintFilterPanel", "DialogFilterRow", "ColumnFilterArchiveDialog", "FilterPanelLayout", "ColumnFilterData", "DialogFilterCondition", "ColumnFilterGridLocation", "TableFilterDialogModelListener", "DialogFilterConditionSet", "ColumnFilterPanel"]
