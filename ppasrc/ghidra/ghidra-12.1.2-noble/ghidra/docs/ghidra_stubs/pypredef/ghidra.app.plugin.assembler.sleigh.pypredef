...
class SleighAssemblerBuilder(AbstractSleighAssemblerBuilder[ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns, ghidra.app.plugin.assembler.Assembler], ghidra.app.plugin.assembler.AssemblerBuilder):
    """
    An :obj:`AssemblerBuilder` capable of supporting almost any :obj:`SleighLanguage`
     
     
    
    To build an assembler, please use a static method of the :obj:`Assemblers` class.
    ...
    ********
    ...
    are not actually separated by spaces. For example, in the ``ia.sinc`` file, there is JMP, and
    ...
    are rather short. The pre-compute part of this process is implemented in :meth:`buildGrammar() <.buildGrammar>`
    and :meth:`buildParser() <.buildParser>`. Parsing is then encapsulated in :obj:`AssemblyParser`.
    ...
    :obj:`AssemblyConstructStateGenerator`.
    ...
    2. Solve context mutations, in reverse order.
    ...
    :meth:`AssemblyTreeResolver.resolveRootRecursion(AssemblyResolutionResults) <AssemblyTreeResolver.resolveRootRecursion>`.
...
class AbstractSleighAssembler(ghidra.app.plugin.assembler.GenericAssembler[RP], typing.Generic[RP]):

    @typing.type_check_only
    class ListenerForSymbolsRefresh(ghidra.framework.model.DomainObjectListener):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
class SleighAssembler(AbstractSleighAssembler[ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns], ghidra.app.plugin.assembler.Assembler):
    """
    An :obj:`Assembler` for a :obj:`SleighLanguage`.
     
     
    
    For documentation on how the SLEIGH assembler works, see :obj:`SleighAssemblerBuilder`. To use
    the assembler, please use :meth:`Assemblers.getAssembler(Program) <Assemblers.getAssembler>` or similar.
    """

    class_: typing.ClassVar[java.lang.Class]


class AbstractSleighAssemblerBuilder(ghidra.app.plugin.assembler.GenericAssemblerBuilder[RP, A], typing.Generic[RP, A]):
...
__all__ = ["SleighAssemblerBuilder", "AbstractSleighAssembler", "SleighAssembler", "AbstractSleighAssemblerBuilder"]
