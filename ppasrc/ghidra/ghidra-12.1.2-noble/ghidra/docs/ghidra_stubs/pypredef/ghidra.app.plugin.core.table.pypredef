...
class TableComponentProvider(ghidra.framework.plugintool.ComponentProviderAdapter, javax.swing.event.TableModelListener, ghidra.app.nav.NavigatableRemovalListener, typing.Generic[T]):
    ...
    def addActivationListener(self, listener: docking.ComponentProviderActivationListener) -> None:
        ...
    ...
    def removeActivationListener(self, listener: docking.ComponentProviderActivationListener) -> None:
        ...

    def removeAllActions(self) -> None:
        ...

    def setActionContextProvider(self, contextProvider: java.util.function.Function[java.awt.event.MouseEvent, docking.ActionContext]) -> None:
        """
    ...
    def setProgramListener(self, programListener: ghidra.framework.model.DomainObjectListener) -> None:
        """
        ...
        :param ghidra.framework.model.DomainObjectListener programListener: the listener
        """
...
class TableServiceTableChooserDialog(ghidra.app.tablechooser.TableChooserDialog):
    ...
    @typing.overload
    def __init__(self, plugin: TableServicePlugin, executor: ghidra.app.tablechooser.TableChooserExecutor, program: ghidra.program.model.listing.Program, title: typing.Union[java.lang.String, str], navigatable: ghidra.app.nav.Navigatable, isModal: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    @typing.overload
    def __init__(self, plugin: TableServicePlugin, executor: ghidra.app.tablechooser.TableChooserExecutor, program: ghidra.program.model.listing.Program, title: typing.Union[java.lang.String, str], navigatable: ghidra.app.nav.Navigatable) -> None:
        ...
