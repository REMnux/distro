...
class DebuggerSelectPlatformOfferDialog(docking.DialogComponentProvider):
    ...
    class OfferPanel(javax.swing.JPanel):
        ...
        def setFilterRecommended(self, recommendedOnly: typing.Union[jpype.JBoolean, bool]) -> None:
            ...

        def setOffers(self, offers: collections.abc.Sequence) -> None:
            ...

        def setPreferredIDs(self, langID: ghidra.program.model.lang.LanguageID, csID: ghidra.program.model.lang.CompilerSpecID) -> None:
            ...

        def setSelectedOffer(self, offer: ghidra.app.plugin.core.debug.mapping.DebuggerPlatformOffer) -> None:
            ...
