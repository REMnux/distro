...
class AddressIndexMapConverter(AddressIndexMap):
    ...
    def __init__(self, addressIndexMap: AddressIndexMap, mapProgram: ghidra.program.model.listing.Program, otherProgram: ghidra.program.model.listing.Program) -> None:
        ...


class InMemoryOpenCloseManager(OpenCloseManager):
    """
...
class ScrollpaneAlignedHorizontalLayout(java.awt.LayoutManager):
    ...
    def __init__(self, scroller: docking.widgets.indexedscrollpane.IndexedScrollPane) -> None:
        ...


class PersistentOpenCloseManager(OpenCloseManager):
    """
    Address based open/close management that uses the :obj:`ProgramUserData` to persist the 
    ...
    def __init__(self, data: ghidra.program.model.listing.ProgramUserData, owner: typing.Union[java.lang.String, str], propertyName: typing.Union[java.lang.String, str]) -> None:
        ...
...
class FieldNavigator(ghidra.app.services.ButtonPressedListener, ghidra.app.services.FieldMouseHandlerService):
    ...
    def __init__(self, serviceProvider: ghidra.framework.plugintool.ServiceProvider, navigatable: ghidra.app.nav.Navigatable) -> None:
        ...
...
class AddressIndexMap(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, addrSet: ghidra.program.model.address.AddressSetView) -> None:
        """
...
class DataOpenCloseManager(java.lang.Object):
    """
    ...
    def getOpenDataIndex(self, address: ghidra.program.model.address.Address, path: jpype.JArray[jpype.JInt]) -> int:
        """
    ...
    @typing.overload
    def isDataOpen(self, address: ghidra.program.model.address.Address, path: jpype.JArray[jpype.JInt]) -> bool:
        """
    ...
    @typing.overload
    def isDataOpen(self, data: ghidra.program.model.listing.Data) -> bool:
        ...
    ...
    def openData(self, data: ghidra.program.model.listing.Data) -> None:
        """
        Marks the given data as open.  This method notifies listeners of changes.
    ...
    def toggleDataRecursively(self, data: ghidra.program.model.listing.Data, openState: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
    ...
    @property
    def dataOpen(self) -> jpype.JBoolean:
        ...


class ProgramOpenCloseManager(java.lang.Object):
    """
    ...
    def closeDataRecursively(self, data: ghidra.program.model.listing.Data, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...

    def getOpenDataIndex(self, data: ghidra.program.model.listing.Data) -> int:
        """
        Returns the index of the component that is open at the given address.
        
        :param ghidra.program.model.listing.Data data: the data to get the index for
        :return: the index of the component that is open for the given data
        :rtype: int
        """

    @typing.overload
    def isDataOpen(self, address: ghidra.program.model.address.Address) -> bool:
        """
    ...
    def isFunctionOpen(self, functionEntry: ghidra.program.model.address.Address) -> bool:
        """
        Returns true if the function at the given address is open.
        
        :param ghidra.program.model.address.Address functionEntry: the function address to test if the function is open
        :return: true if the function at the given address is open
        :rtype: bool
        """

    def isFunctionVariablesOpen(self, functionEntry: ghidra.program.model.address.Address) -> bool:
        """
        Checks if the function variables are being shown at the given function address.
        
        :param ghidra.program.model.address.Address functionEntry: the address of the function to check
    ...
    def openDataRecursively(self, data: ghidra.program.model.listing.Data, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
    ...
    def setAllFunctionVariablesOpen(self, open: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
        :param jpype.JBoolean or bool open: if true, then the function variables are displayed
        """
    ...
    def setAllFunctionsOpen(self, open: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
        :param jpype.JBoolean or bool open: true to open all functions, false to close them
        """

    def setFunctionOpen(self, functionEntry: ghidra.program.model.address.Address, open: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Sets the function at the given address to be open or closed.
        
        :param ghidra.program.model.address.Address functionEntry: the address of the function to open or close
        :param jpype.JBoolean or bool open: true to open the function, false to close it
        """

    def setFunctionVariablesOpen(self, functionEntry: ghidra.program.model.address.Address, open: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Sets whether or not to display function variables at the given address.
        
        :param ghidra.program.model.address.Address functionEntry: the address of the function
        :param jpype.JBoolean or bool open: true to display function variables, false to to hide them
        """

    def toggleDataOpen(self, data: ghidra.program.model.listing.Data) -> None:
        ...
    ...
    @property
    def functionVariablesOpen(self) -> jpype.JBoolean:
        ...

    @property
    def openDataIndex(self) -> jpype.JInt:
        ...
...
class OpenCloseManager(java.lang.Object):
    ...
    def close(self, address: ghidra.program.model.address.Address) -> None:
        """
        Sets the state at the given address to be "closed".
        
        :param ghidra.program.model.address.Address address: the address to set "closed"
        """
    ...
    def open(self, address: ghidra.program.model.address.Address) -> None:
        """
        Sets the state at the given address to be "open".
        
        :param ghidra.program.model.address.Address address: the address to set "open"
        """
    ...
    @property
    def openByDefault(self) -> jpype.JBoolean:
        ...
...
class VerticalPixelAddressMapImpl(ghidra.app.util.viewer.listingpanel.VerticalPixelAddressMap):
    ...
    def __init__(self, layouts: java.util.List[docking.widgets.fieldpanel.support.AnchoredLayout], map: AddressIndexMap) -> None:
        """
        Constructor.
...
class AddressBasedIndexMapper(docking.widgets.fieldpanel.listener.IndexMapper):
    ...
    def __init__(self, from_: AddressIndexMap, to: AddressIndexMap) -> None:
        ...



__all__ = ["AddressIndexMapConverter", "InMemoryOpenCloseManager", "ScrollpaneAlignedHorizontalLayout", "PersistentOpenCloseManager", "FieldNavigator", "AddressIndexMap", "DataOpenCloseManager", "ProgramOpenCloseManager", "ScrollpanelResizeablePanelLayout", "OpenCloseManager", "VerticalPixelAddressMapImpl", "AddressBasedIndexMapper"]
