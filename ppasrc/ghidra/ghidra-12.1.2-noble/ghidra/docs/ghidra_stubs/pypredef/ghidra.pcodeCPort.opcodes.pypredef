...
class OpCode(java.lang.Enum[OpCode]):
    ...
    def getBooleanFlip(self) -> bool:
        ...
        (or :obj:`.CPUI_MAX` if not boolean.) Set reorder to true if the complimentary operation
    ...
    @staticmethod
    @typing.overload
    def getOpcode(ordinal: typing.Union[jpype.JInt, int]) -> OpCode:
        ...

    @staticmethod
    @typing.overload
    def getOpcode(nm: typing.Union[java.lang.String, str]) -> OpCode:
        ...
