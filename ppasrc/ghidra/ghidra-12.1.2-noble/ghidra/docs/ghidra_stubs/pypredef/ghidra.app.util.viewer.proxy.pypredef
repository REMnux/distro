...
class DataProxy(ProxyObj[ghidra.program.model.listing.Data]):
    ...
    def __init__(self, model: ghidra.app.util.viewer.listingpanel.ListingModel, program: ghidra.program.model.listing.Program, data: ghidra.program.model.listing.Data) -> None:
        """
...
class ClosedVariableProxy(VariableProxy):
    """
    ...
    def __init__(self, model: ghidra.app.util.viewer.listingpanel.ListingModel, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, fun: ghidra.program.model.listing.Function) -> None:
        ...
...
class CodeUnitProxy(ProxyObj[ghidra.program.model.listing.CodeUnit]):
    ...
    def __init__(self, model: ghidra.app.util.viewer.listingpanel.ListingModel, program: ghidra.program.model.listing.Program, cu: ghidra.program.model.listing.CodeUnit) -> None:
        """
...
class FunctionProxy(ProxyObj[ghidra.program.model.listing.Function]):
    ...
    def __init__(self, model: ghidra.app.util.viewer.listingpanel.ListingModel, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, function: ghidra.program.model.listing.Function) -> None:
        """
...
class VariableProxy(ProxyObj[ghidra.program.model.listing.Variable]):
    ...
    def __init__(self, model: ghidra.app.util.viewer.listingpanel.ListingModel, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, fun: ghidra.program.model.listing.Function, var: ghidra.program.model.listing.Variable, isFirst: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        ...
        :param jpype.JBoolean or bool isFirst: true if this is the first parameter or variable
        """
...
class AddressProxy(ProxyObj[ghidra.program.model.address.Address]):
    ...
    def __init__(self, model: ghidra.app.util.viewer.listingpanel.ListingModel, addr: ghidra.program.model.address.Address) -> None:
        """
...
__all__ = ["EmptyProxy", "DataProxy", "ClosedVariableProxy", "CodeUnitProxy", "ProxyObj", "FunctionProxy", "VariableProxy", "AddressProxy"]
