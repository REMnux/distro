...
class AnchoredLayoutHandler(java.lang.Object):
    ...
    def __init__(self, model: docking.widgets.fieldpanel.LayoutModel, viewHeight: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class FieldPanelScrollCoordinator(docking.widgets.fieldpanel.listener.ViewListener):
    """
    ...
    def __init__(self, panels: jpype.JArray[docking.widgets.fieldpanel.FieldPanel]) -> None:
        """
...
class LayoutBackgroundColorManagerAdapter(LayoutBackgroundColorManager):
    ...
    def __init__(self, layoutColorMap: LayoutBackgroundColorManager) -> None:
        ...

    def setRange(self, start: typing.Union[jpype.JInt, int], end: typing.Union[jpype.JInt, int], isLastRow: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class TestBigLayoutModel(docking.widgets.fieldpanel.LayoutModel):
    ...
    def __init__(self, fm: java.awt.FontMetrics, name: typing.Union[java.lang.String, str], numIndexes: java.math.BigInteger) -> None:
        ...
    ...
    def setNumIndexes(self, n: java.math.BigInteger) -> None:
        ...
...
class CursorBlinker(java.lang.Object):
    ...
    def __init__(self, panel: docking.widgets.fieldpanel.FieldPanel) -> None:
        ...
    ...
    def updatePaintArea(self, cursorLayout: docking.widgets.fieldpanel.support.AnchoredLayout, cursorPosition: docking.widgets.fieldpanel.support.FieldLocation) -> None:
        ...
...
class EmptyLayoutBackgroundColorManager(LayoutBackgroundColorManager):
    ...
    def __init__(self, background: java.awt.Color) -> None:
        ...
...
class PaintContext(java.lang.Object):
    ...
    def setCursorColor(self, c: java.awt.Color) -> None:
        ...

    def setCursorFocused(self, isFocused: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setCursorHidden(self, isHidden: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setFocusedCursorColor(self, color: java.awt.Color) -> None:
        ...

    def setForegroundColor(self, c: java.awt.Color) -> None:
        ...

    def setHighlightColor(self, c: java.awt.Color) -> None:
        ...

    def setNotFocusedCursorColor(self, color: java.awt.Color) -> None:
        ...

    def setPrinting(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setSelectionColor(self, c: java.awt.Color) -> None:
        ...

    def setTextCopying(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class DefaultBackgroundColorModel(docking.widgets.fieldpanel.support.BackgroundColorModel):
    ...
    def __init__(self, backgroundColor: java.awt.Color) -> None:
        ...
...
class MixedFieldBackgroundColorManager(FieldBackgroundColorManager):
    ...
    def __init__(self, index: java.math.BigInteger, fieldNum: typing.Union[jpype.JInt, int], layoutSelection: MixedLayoutBackgroundColorManager, selectionColor: java.awt.Color, backgroundColor: java.awt.Color) -> None:
        ...
...
class MixedLayoutBackgroundColorManager(LayoutBackgroundColorManager):
    ...
    def __init__(self, index: java.math.BigInteger, selection: docking.widgets.fieldpanel.support.FieldSelection, highlight: docking.widgets.fieldpanel.support.FieldSelection, backgroundColor: java.awt.Color, selectionColor: java.awt.Color, highlightColor: java.awt.Color, mixedColor: java.awt.Color, leftBorderColor: java.awt.Color, rightBorderColor: java.awt.Color) -> None:
        ...
...
class FullySelectedFieldBackgroundColorManager(FieldBackgroundColorManager):
    ...
    def __init__(self, selectionColor: java.awt.Color) -> None:
        ...


class LineLockedFieldPanelScrollCoordinator(FieldPanelScrollCoordinator):
    """
    ...
    def lockLines(self, *newLockedLines: java.math.BigInteger) -> None:
        """
...
class ColorRangeMap(java.lang.Object):
    ...
    @typing.overload
    def clear(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int]) -> None:
        ...
    ...
    def color(self, start: typing.Union[jpype.JLong, int], end: typing.Union[jpype.JLong, int], c: java.awt.Color) -> None:
        ...
...
class LayoutLockedFieldPanelScrollCoordinator(LineLockedFieldPanelScrollCoordinator):
    """
    ...
    def __init__(self, *panels: docking.widgets.fieldpanel.FieldPanel) -> None:
        """
...
__all__ = ["AnchoredLayoutHandler", "FieldBackgroundColorManager", "LayoutColorMapFactory", "FieldPanelScrollCoordinator", "LayoutBackgroundColorManagerAdapter", "TestBigLayoutModel", "EmptyBigLayoutModel", "LayoutBackgroundColorManager", "CursorBlinker", "EmptyLayoutBackgroundColorManager", "EmptyFieldBackgroundColorManager", "PaintContext", "DefaultBackgroundColorModel", "MixedFieldBackgroundColorManager", "MixedLayoutBackgroundColorManager", "FullySelectedFieldBackgroundColorManager", "LineLockedFieldPanelScrollCoordinator", "ColorRangeMap", "LayoutLockedFieldPanelScrollCoordinator"]
