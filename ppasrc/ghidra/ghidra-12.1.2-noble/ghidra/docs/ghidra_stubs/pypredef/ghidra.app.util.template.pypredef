...
class TemplateSimplifier(ghidra.program.model.symbol.NameTransformer):
    ...
    def setEnabled(self, doSimplify: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    def setMaxTemplateLength(self, maxLength: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setMinimumTemplateLength(self, minLength: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    def setNestingDepth(self, depth: typing.Union[jpype.JInt, int]) -> None:
        """
