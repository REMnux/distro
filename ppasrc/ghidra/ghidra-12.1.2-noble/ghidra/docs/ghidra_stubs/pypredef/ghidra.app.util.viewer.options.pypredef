...
class ScreenElement(java.lang.Object):
    ...
    def setStyle(self, style: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class OptionsGui(javax.swing.JPanel):
    ...
    FUN_PARAM_CUSTOM: typing.Final[ScreenElement]
    FUN_PARAM_DYNAMIC: typing.Final[ScreenElement]
    FUN_VARIABLE: typing.Final[ScreenElement]
    ...
    COLLAPSED_CODE: typing.Final[ScreenElement]
    ...
    SEPARATOR_LINE: typing.Final[ScreenElement]
    ...
    def __init__(self, font: java.awt.Font, listener: java.beans.PropertyChangeListener) -> None:
        """
        Constructor
