...
class DWARFSectionProviderFactory(java.lang.Object):
    ...
    def createSectionProviderFor(program: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor) -> DWARFSectionProvider:
        ...
        that can successfully retrieve the :obj:`minimal <DWARFSectionId.MINIMAL_DWARF_SECTIONS>` 
...
class DWARFSectionId(java.lang.Enum[DWARFSectionId]):
    """
    Enum specifying common DWARF sections
    """

    class_: typing.ClassVar[java.lang.Class]
    DEBUG_INFO: typing.Final[DWARFSectionId]
    DEBUG_TYPES: typing.Final[DWARFSectionId]
    DEBUG_ABBREV: typing.Final[DWARFSectionId]
    DEBUG_ARRANGES: typing.Final[DWARFSectionId]
    DEBUG_LINE: typing.Final[DWARFSectionId]
    DEBUG_LINE_STR: typing.Final[DWARFSectionId]
    DEBUG_FRAME: typing.Final[DWARFSectionId]
    DEBUG_LOC: typing.Final[DWARFSectionId]
    DEBUG_LOCLISTS: typing.Final[DWARFSectionId]
    DEBUG_STR: typing.Final[DWARFSectionId]
    DEBUG_STROFFSETS: typing.Final[DWARFSectionId]
    DEBUG_RANGES: typing.Final[DWARFSectionId]
    DEBUG_RNGLISTS: typing.Final[DWARFSectionId]
    DEBUG_PUBNAMES: typing.Final[DWARFSectionId]
    DEBUG_PUBTYPES: typing.Final[DWARFSectionId]
    DEBUG_MACINFO: typing.Final[DWARFSectionId]
    DEBUG_MACRO: typing.Final[DWARFSectionId]
    DEBUG_ADDR: typing.Final[DWARFSectionId]
    ...
    @staticmethod
    def valueOf(name: typing.Union[java.lang.String, str]) -> DWARFSectionId:
        ...

    @staticmethod
    def values() -> jpype.JArray[DWARFSectionId]:
        ...
...
class CompressedSectionProvider(DWARFSectionProvider):
    ...
    def __init__(self, sp: DWARFSectionProvider) -> None:
        ...
...
class DSymSectionProvider(DWARFSectionProvider):
    ...
    def __init__(self, dsymFile: jpype.protocol.SupportsPath) -> None:
        ...
...
class DWARFSectionProvider(java.io.Closeable):
    ...
    DWARFSectionProviderFactory's ``sectionProviderFactoryFuncs`` and should implement the 
    static method:
...
__all__ = ["ExternalDebugFileSectionProvider", "NullSectionProvider", "BaseSectionProvider", "DWARFSectionProviderFactory", "DWARFSectionId", "CompressedSectionProvider", "DSymSectionProvider", "DWARFSectionProvider"]
