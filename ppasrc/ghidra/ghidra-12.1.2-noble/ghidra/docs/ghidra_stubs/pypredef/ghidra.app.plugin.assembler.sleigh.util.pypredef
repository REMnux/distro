...
class TableEntryKey(java.lang.Comparable[TableEntryKey]):
    ...
    def __init__(self, state: typing.Union[jpype.JInt, int], sym: ghidra.app.plugin.assembler.sleigh.symbol.AssemblySymbol) -> None:
        """
...
class TableEntry(TableEntryKey, typing.Generic[T]):
    ...
    def __init__(self, state: typing.Union[jpype.JInt, int], sym: ghidra.app.plugin.assembler.sleigh.symbol.AssemblySymbol, value: T) -> None:
        """
