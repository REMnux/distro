...
class ModuleManifestFile(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, moduleRootDir: jpype.protocol.SupportsPath) -> None:
        ...

    @typing.overload
    def __init__(self, moduleRootDir: generic.jar.ResourceFile) -> None:
        ...
...
class ClasspathFilter(java.util.function.Predicate[ghidra.framework.GModule]):
    ...
    @typing.overload
    def __init__(self, additionalPaths: java.util.function.Predicate[java.nio.file.Path]) -> None:
        """
