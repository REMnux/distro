...
class VarnodeContext(ghidra.program.model.lang.ProcessorContext):
    ...
    def __init__(self, program: ghidra.program.model.listing.Program, programContext: ghidra.program.model.listing.ProgramContext, spaceProgramContext: ghidra.program.model.listing.ProgramContext, trackStartEndState: typing.Union[jpype.JBoolean, bool]):
        ...
    ...
    def getEndRegisterVarnodeValue(self, reg: ghidra.program.model.lang.Register, fromAddr: ghidra.program.model.address.Address, toAddr: ghidra.program.model.address.Address, signed: typing.Union[jpype.JBoolean, bool]) -> ghidra.program.model.pcode.Varnode:
        ...
        :rtype: ghidra.program.model.pcode.Varnode
        :raises UnsupportedOperationException: trackStartEndState == false at construction
        """
...
class SymbolicPropogator(java.lang.Object):
    ...
    @typing.overload
    def __init__(self, program: ghidra.program.model.listing.Program, trackStartEndState: typing.Union[jpype.JBoolean, bool]):
        """
        Create symbolic propagation on program
        
        :param ghidra.program.model.listing.Program program: program
        :param jpype.JBoolean or bool trackStartEndState: - true to track the each register at the start/end of each instruction
