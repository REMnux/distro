...
class RGB32EncodingSettingsDefinition(ghidra.docking.settings.EnumSettingsDefinition, TypeDefSettingsDefinition):
    ...
    def setRGBEncoding(self, settings: ghidra.docking.settings.Settings, encoding: RGB32EncodingSettingsDefinition.RGB32Encoding):
        ...
...
class RGB16EncodingSettingsDefinition(ghidra.docking.settings.EnumSettingsDefinition, TypeDefSettingsDefinition):
    ...
    def setRGBEncoding(self, settings: ghidra.docking.settings.Settings, encoding: RGB16EncodingSettingsDefinition.RGB16Encoding):
        ...
...
class DataTypeManager(java.lang.Object):
    ...
    @typing.overload
    def remove(self, dataTypes: java.util.List[DataType], monitor: ghidra.util.task.TaskMonitor):
        """
